...
export function createWsAuth(deps: WsAuthDeps): WsAuthHandlers {
  ...
  async function authenticateWebSocket(
    ...
    // Required capability, checked before any database work so an incompatible
    // client costs nothing. Exact numeric equality, like the optional
    // negotiators below.
    if (msg.movementWire !== MOVEMENT_WIRE_VERSION) {
