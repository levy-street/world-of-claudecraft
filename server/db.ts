...
export interface ClientPerfReportInsert {
  ...
  // The GPU model dimensions (server/gpu_model_bucket.ts). Kept as their own
  // block so they read as one unit: the raw string, its parsed family and form
  // factor, and the WebGPU high-performance adapter's family beside them.
