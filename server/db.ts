...
import { CLIENT_PERF_SCHEMA } from './client_perf_db';
import {
...
export async function ensureSchema(): Promise<void> {
  ...
  try {
    ...
    // Client-perf reports FK-reference accounts/characters from the core
    // schema, so this additive schema runs right after it (extracted to
    // server/client_perf_db.ts; see its header for the circular-import note).
