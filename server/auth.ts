...
import { RegExpMatcher, englishDataset, englishRecommendedTransformers, parseRawPattern } from 'obscenity';
...
// gate every player-visible name passes (accounts, characters, guilds, and —
// in the SNS PR — subdomain labels), important because player-owned names can't
// be reclaimed on-chain after the fact.
