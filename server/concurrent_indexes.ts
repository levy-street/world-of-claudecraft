...
export const CONCURRENT_INDEX_MIGRATIONS: readonly ConcurrentIndexMigration[] = [
  ...
  {
    name: 'content_moderation_actions_owner',
    createSql: CONTENT_MODERATION_OWNER_CONCURRENT_INDEX_SQL,
    checkSql: CONTENT_MODERATION_OWNER_INVALID_INDEX_CHECK_SQL,
    dropSql: CONTENT_MODERATION_OWNER_INVALID_INDEX_DROP_SQL,
  },
