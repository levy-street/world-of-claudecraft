...
// The per-entity wire serializers live in their own sibling (see its header); wireEntity is
// re-exported because tests and tooling resolve it on this module.
export { wireEntity } from './entity_wire';
...
// Interest scoping (radii, hysteresis, the battleground widening, the landmark widening)
// lives in one sibling so its three enforcement points cannot drift apart. INTEREST_DROP_RADIUS
// is re-exported because consumers and tests resolve it on this module.
export {
...
export class GameServer {
  ...
  private bcVisits = 0;
  /** Live world-boss landmarks, rescanned on a slow cadence (server/interest_scope.ts). */
