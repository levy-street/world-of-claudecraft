...
| Meshy prop models (yumi_powerup_box, the Protect Yumi mystery power-up crate, in `public/models/props/`) | World of ClaudeCraft | Project-generated via Meshy AI (image-to-3D from project concept art; meshopt + webp optimized), owned under the Meshy paid-plan license | Project asset |
