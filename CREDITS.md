...
| Generated creature model and animations (asmon_hermit) | World of ClaudeCraft | User-guided concept, generated single-subject reference, Tripo P2-20260801 mesh and bind rig, locally authored Blender 5.2 animations; meshopt and KTX2 shipping assets. Provenance: `scripts/assets/specs/roach_king.provenance.json` | Project asset | With the project only |
| Generated creature model and animations (roach_king) | World of ClaudeCraft | User-guided concept, generated single-subject reference, Tripo P2-20260801 mesh and bind rig, locally authored Blender 5.2 animations; meshopt and KTX2 shipping assets. Provenance: `scripts/assets/specs/roach_king.provenance.json` | Project asset | With the project only |
| Generated creature model and animations (roachling) | World of ClaudeCraft | User-guided concept, generated single-subject reference, Tripo P2-20260801 mesh and bind rig, locally authored Blender 5.2 animations; meshopt and KTX2 shipping assets. Provenance: `scripts/assets/specs/roach_king.provenance.json` | Project asset | With the project only |
| Generated creature model and animations (garbage_beetle) | World of ClaudeCraft | User-guided concept, generated single-subject reference, Tripo P2-20260801 mesh and bind rig, locally authored Blender 5.2 animations; meshopt and KTX2 shipping assets. Provenance: `scripts/assets/specs/roach_king.provenance.json` | Project asset | With the project only |
