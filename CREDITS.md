...
| Level-20 armor-set icons (`public/ui/armor-sets/<class>.webp`, all 9 classes; shown on the armor-set toggle in the character sheet's chroma row) | World of ClaudeCraft | Maintainer-provided original art, re-encoded to WebP at 256px | Project asset, rights reserved | **No, permission required** |
