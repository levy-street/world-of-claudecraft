...
| Source Cave prop models (source_server_rack, dev_code_desk, in `public/models/props/`) | World of ClaudeCraft | Project-generated via `scripts/asset_pipeline` (Tripo AI 3D) | Project asset, rights reserved | **No, permission required** |
| Source Cave weapon models + icons (commit_blade_sword, bug_squasher_hammer, keyboard_sword, in `public/models/weapons/` and `public/ui/weapons/`) | World of ClaudeCraft | Project-generated via `scripts/asset_pipeline` (Tripo AI 3D) | Project asset, rights reserved | **No, permission required** |
| Source Cave character models (skin-models coder_hunter, hacker_druid; creature-models dev_gamer, dev_hacker, dev_noob) | World of ClaudeCraft | Project-generated via `scripts/asset_pipeline` (gpt-image-2 redesign + Tripo build/rig/retarget) | Project asset, rights reserved | **No, permission required** |
