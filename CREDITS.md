...
| Forest Nature Pack, free tier (vale forest trees and bushes, `public/models/foliage/forest_*.glb`) | Kay Lousberg (KayKit) | https://kaylousberg.itch.io/kaykit-forest | CC0 1.0 |
