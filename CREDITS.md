...
| Crafting-station ambience loops (`public/audio/sfx/amb_kitchens.mp3`, `amb_apothecary.mp3`, `amb_tannery.mp3`, `amb_loom.mp3`, `amb_toolworks.mp3`) | World of ClaudeCraft | Project-generated deterministic seeded synthesis via `scripts/gen_station_ambience.mjs` | Project asset | With the project only |
