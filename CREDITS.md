...
| Masterwrought material icons (`public/ui/items/{wyrmfall_core,sundered_essence,makers_ember}.webp`, the `woc_original_svg` overriding-licence entries in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated procedurally rasterized SVG placeholders, pending a commissioned painted icon in the profession-materials style; provenance per icon in `public/ui/items/mapping.json` | Project asset, rights reserved | **No, permission required** |
| Masterwrought jewelcrafting icons (`public/ui/items/{hammered_copper_band,polished_copper_loop,coiled_copper_torc,riveted_iron_signet,etched_iron_loop,iron_link_choker,weighted_thorium_band,gleaming_thorium_loop,burnished_thorium_amulet}.webp`, the `woc_original_svg` overriding-licence entries in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated procedurally rasterized SVG placeholders, pending a commissioned painted icon in the profession-materials style; provenance per icon in `public/ui/items/mapping.json` | Project asset, rights reserved | **No, permission required** |
| Masterwrought inscription icons (`public/ui/items/{silverleaf_primer,goldleaf_folio,sunpetal_grimoire,silverleaf_scroll,goldleaf_scroll,sunpetal_scroll}.webp`, the `masterwrought-phase06-inscription` `woc_original_svg` batch in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated procedurally rasterized SVG placeholders, pending a commissioned painted icon in the profession-materials style; committed SVG sources, the rasterizer, and accepted hashes in `docs/achievements/masterwrought-phase06-art/` | Project asset, rights reserved | **No, permission required** |
| Masterwrought intermediate material icons (`public/ui/items/{duskforged_billet,forgefold_plating,wyrmhide_cording,sunspun_bolt,prismglass_setting,precision_chassis,quickening_catalyst,seasoned_stock,lucent_reagent,sablewax_vellum}.webp`, the `woc_original_svg` overriding-licence entries in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated procedurally rasterized SVG placeholders, pending a commissioned painted icon in the profession-materials style; committed SVG sources, the rasterizer, and accepted hashes in `docs/achievements/masterwrought-phase07-art/` | Project asset, rights reserved | **No, permission required** |
| Masterwrought apex armor icons (`public/ui/items/{spiritweld_girdle,forgefold_legguards,wardspeaker_sabatons,briarstep_jerkin,fenbloom_breeches,barksong_handguards,sunspun_vestments,sunspun_leggings,sunspun_handwraps,sunspun_haversack}.webp`, the `woc_original_svg` overriding-licence entries in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated procedurally rasterized SVG placeholders, pending a commissioned painted icon in the profession-materials style; committed SVG sources, the rasterizer, and accepted hashes in `docs/achievements/masterwrought-phase08-art/` | Project asset, rights reserved | **No, permission required** |
| Masterwrought apex weapon, jewelry, and tool icons (`public/ui/items/{duskforged_warblade,duskforged_bulwark,ridgebreaker,wyrmfall_pendant,warhewn_signet,prismglass_loop,makers_charm,gyrelens_array,masters_field_forge,voidbound_grimoire}.webp`, the `masterwrought-phase09-art` `woc_original_svg` batch in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated procedurally rasterized SVG placeholders, pending a commissioned painted icon in the profession-materials style; committed SVG sources, the rasterizer, and accepted hashes in `docs/achievements/masterwrought-phase09-art/` | Project asset, rights reserved | **No, permission required** |
| Masterwrought apex consumable and station icons (`public/ui/items/{ironhusk_flask,warboar_flask,runewater_flask,stonepot_stew,warspice_skewers,sageleaf_chowder,grand_cauldron,laden_hearth}.webp`, the `woc_original_svg` overriding-licence entries in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated procedurally rasterized SVG placeholders, pending a commissioned painted icon in the profession-materials style; committed SVG sources, the rasterizer, and accepted hashes in `docs/achievements/masterwrought-phase10-art/` | Project asset, rights reserved | **No, permission required** |
| Masterwrought apex recipe pattern icons (`public/ui/items/{pattern_spiritweld_girdle,pattern_forgefold_legguards,pattern_wardspeaker_sabatons,pattern_briarstep_jerkin,pattern_fenbloom_breeches,pattern_barksong_handguards,pattern_sunspun_vestments,pattern_sunspun_leggings,pattern_sunspun_handwraps,pattern_sunspun_haversack,pattern_duskforged_warblade,pattern_ridgebreaker,pattern_duskforged_bulwark,pattern_wyrmfall_pendant,pattern_warhewn_signet,pattern_prismglass_loop,pattern_gyrelens_array,pattern_masters_field_forge,pattern_makers_charm,pattern_voidbound_grimoire,pattern_ironhusk_flask,pattern_warboar_flask,pattern_runewater_flask,pattern_stonepot_stew,pattern_warspice_skewers,pattern_sageleaf_chowder,pattern_grand_cauldron,pattern_laden_hearth}.webp`, the `woc_original_svg` overriding-licence entries in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated procedurally rasterized SVG placeholders, pending a commissioned painted icon in the profession-materials style; committed SVG sources, the rasterizer, and accepted hashes in `docs/achievements/masterwrought-phase11-art/` | Project asset, rights reserved | **No, permission required** |
