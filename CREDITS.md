...
| SwordMaster ability and specialization icons (`public/ui/skills/swordmaster/*.webp`, `public/ui/specs/swordmaster/*.webp`) | World of ClaudeCraft | Original atlas generated for this game with OpenAI image generation, then cropped and normalized locally to 128px WebP; cell provenance is recorded in `public/ui/skills/swordmaster/mapping.json` | Project asset |
