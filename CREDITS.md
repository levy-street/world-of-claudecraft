...
| Rift course kit (`public/models/props/rift_launch_pad.glb`, `rift_gem_crystal.glb`, `rift_waybrazier.glb`) | World of ClaudeCraft | Original procedural project art (no external reference); deterministic factory, exporter, and source fingerprint committed under `scripts/assets/rift_course_kit/` | Project asset | With the project only |
