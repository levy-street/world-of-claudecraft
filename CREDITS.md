...
| Drakelands rebuild kit props (`public/models/drakelands_kit/*.glb`: town buildings, church, barracks, stables, market stall, fences, gravestones, signage, racks, cart, well, dragon statue) | World of ClaudeCraft | Project-generated from the maintainer's environment drop, owned under the generator's paid-plan license, optimized to KTX2/meshopt via `scripts/assets/build_drakelands_kit.mjs` | Project asset | With the project only |
