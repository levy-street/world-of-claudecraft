...
| Social tray character and ivory crown assets (`public/site/social-tray/character.webp`, `public/site/social-tray/ivory-crown.webp`) | World of ClaudeCraft | OpenAI image generation | Project asset |
| Community quest-card scenes (`public/site/community/community-world-forge*.webp`, `public/site/community/community-guild-hall*.webp`) | World of ClaudeCraft | OpenAI image generation using project-provided visual references | Project asset |
| Community realm backdrops (`public/site/community/community-realm-backdrop*.webp`) | World of ClaudeCraft | OpenAI image generation using project-provided paladin and party visual references | Project asset |
| Homepage journey backgrounds (`public/site/journey/realm-dawn-cartoon-v2*.webp`) | World of ClaudeCraft | OpenAI image generation using project-provided cartoon style references | Project asset |
| Homepage final moongate backgrounds (`public/site/final-moongate-cartoon-v1*.webp`) | World of ClaudeCraft | OpenAI image generation using project-provided cartoon style references | Project asset |
| Mobile patch-notes frame (`public/site/patch-note-frame-mobile-v1.webp`) | World of ClaudeCraft | OpenAI image generation using the project patch-notes frame as a visual reference | Project asset |
| Header music note icon (`public/site/header-music-note.png`) | World of ClaudeCraft | Project-maintainer-supplied artwork | Project asset |
| Responsive highscores frames (`public/site/highscores-frame-desktop-v5.webp`, `public/site/highscores-frame-mobile-v5.webp`) | World of ClaudeCraft | OpenAI image generation using the project leaderboard and frame styling as visual references | Project asset |
