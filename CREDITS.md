...
| Frostrend Battlegear item icons (`public/ui/items/frostrend_*.webp`, 9 icons, provenance rows under sourcePack `woc_generated` in `public/ui/items/mapping.json`) | World of ClaudeCraft | Project-generated via OpenAI gpt-image (Codex CLI), converted to 128px WebP with `npm run assets:items` | Project asset, rights reserved | **No, permission required** |
