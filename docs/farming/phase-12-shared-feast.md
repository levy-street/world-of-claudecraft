...
report-first) to read and summarize: docs/farming/state.md,
docs/farming/progress.md (the Phase 11 and Phase 11 QA records
...
docs/farming/implementation-plan.md (expected for this diff:
...
Update docs/farming/progress.md (the Phase 12 status row, the
...
stand-in for the PR body) and the docs/farming/state.md ledgers (the
...
swept into this file AND docs/farming/phase-12-qa.md in the same pass.
...
session (docs/farming/phase-12-qa.md).
