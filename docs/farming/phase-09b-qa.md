...
- READ docs/farming/state.md's head block, the (bn) CLOSED record whole, the NEW
  ...
  list; docs/farming/phase-09b-bed-verbs.md whole (the EXECUTED block is the
...
(docs/farming/phase-10-celebrations.md; its Phase 9 QA note is retired, but
