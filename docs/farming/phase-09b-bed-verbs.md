...
this prompt ADOPTS the phase the Phase 9 QA proposed (docs/farming/
...
- ADOPTION, the first docs edit on the branch: strike the PROPOSED labels in
  docs/farming/phase-09b-bed-verbs.md (its STATUS paragraph), the 9b row of
  docs/farming/implementation-plan.md's phase table, and the README list line;
...
- READ docs/farming/state.md's head block, deviation (bn) whole (the finding, its
  ...
  docs/farming/phase-09b-bed-verbs.md whole (the seams paragraph and the acceptance
  list are the spec); docs/farming/progress.md's Phase 9 QA notes (the live-client
...
struck, (bo) untouched), docs/farming/phase-09b-bed-verbs.md (an EXECUTED block plus
the acceptance list checked), docs/farming/phase-09-world-presence.md (a note that
its Live-surface note is met as of 9b), docs/farming/phase-10-celebrations.md (retire
the PHASE 9 QA NOTE's 9b clause), and WRITE the QA twin docs/farming/phase-09b-qa.md
...
(docs/farming/phase-09b-qa.md, which you wrote), then Phase 10.
```
