...
| 1 | Room layouts + shallow/deep water tiers + jump-dodge | NOT STARTED |
| 2 | Render: shallow/deep visuals + marsh dead-tree/plank assets | NOT STARTED |
| 3 | Boss: Tolling Bells line projectiles + knockback | NOT STARTED |
