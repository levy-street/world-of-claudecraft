...
docs/prd/masterwrought/farming/state.md is the authority; if this file contradicts it, state.md wins and this
...
docs/prd/masterwrought/farming/phase-10-qa.md's QA EXECUTED block and progress.md.
...
- READ docs/prd/masterwrought/farming/state.md's head block, D12 / D13 / D17 / D22, deviation
  ...
  docs/prd/masterwrought/farming/phase-10-celebrations.md whole (this file: the sync note above
...
this file's EXECUTED block, and docs/prd/masterwrought/farming/phase-10-qa.md swept in the same
...
hand off to the Phase 10 QA (docs/prd/masterwrought/farming/phase-10-qa.md).
```
