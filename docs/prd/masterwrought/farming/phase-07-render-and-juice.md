...
`docs/prd/masterwrought/farming/implementation-plan.md`): farming must never ship blind. Art follows D19
...
- docs/prd/masterwrought/farming/state.md (whole file; D2, D3, D19 and the seam reference matter most
  here) and docs/prd/masterwrought/farming/progress.md (Phase 1 to 6 notes, deviations, name
  refinements).
- docs/prd/masterwrought/farming/phase-07-render-and-juice.md (this phase file).
...
- Update docs/prd/masterwrought/farming/progress.md: the Phase 7 status row, the acceptance list above
  copied with its check states, and a Notes block (surprises, deviations, deferrals
  with reasons).
- Update the docs/prd/masterwrought/farming/state.md ledgers (new i18n keys if any, refined file
  names, and the collider or pad decision).
- Any deviation decided in-phase gets swept into
  docs/prd/masterwrought/farming/phase-07-render-and-juice.md AND docs/prd/masterwrought/farming/phase-07-qa.md in the
  same pass.
