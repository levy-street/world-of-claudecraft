...
docs/prd/masterwrought/farming/progress.md Phase 7 notes (including any recorded deviation); the
promises in docs/prd/masterwrought/farming/phase-07-render-and-juice.md (Live-surface note,
...
STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 7 QA row and a Notes block) and
