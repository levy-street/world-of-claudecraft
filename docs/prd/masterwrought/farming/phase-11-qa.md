...
- READ the PHASE EXECUTED block at the head of this file; then
  docs/prd/masterwrought/farming/state.md deviations (bx)/(by)/(bz) and the amended (bw)
  ...
  the flags exist, never re-tune); then docs/prd/masterwrought/farming/progress.md's Phase
...
to summarize: docs/prd/masterwrought/farming/state.md (the (bx)/(by)/(bz)/(bw) entries and
the OPEN list), the docs/prd/masterwrought/farming/progress.md Phase 11 section, the
promises in docs/prd/masterwrought/farming/phase-11-well-fed-food.md (STEP 5 acceptance,
...
docs/prd/masterwrought/farming/implementation-plan.md that the phase diff matches, plus
...
STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 11 QA record) and
docs/prd/masterwrought/farming/state.md (drift, ledger corrections). Any deviation gets
swept into docs/prd/masterwrought/farming/phase-11-well-fed-food.md AND this QA twin in the
...
12 (docs/prd/masterwrought/farming/phase-12-shared-feast.md; the wellfed parity-scenario
