...
The design authority is `docs/prd/masterwrought/farming/state.md`; the promises under audit are
`docs/prd/masterwrought/farming/phase-03-growth-engine.md`.
...
STEP 1 - LOAD CONTEXT
Spawn ONE Explore agent to read and summarize: docs/prd/masterwrought/farming/state.md (locked
decisions, especially D3 through D7 and the tick and hook points), the Phase 3 notes
in docs/prd/masterwrought/farming/progress.md (including the decided draw counts, stage count, and
tuning constants), the promises in docs/prd/masterwrought/farming/phase-03-growth-engine.md
...
- Verify every deliverable and every acceptance criterion in
  docs/prd/masterwrought/farming/phase-03-growth-engine.md is actually met, against the real code.
...
STEP 4 - DOC UPDATES
- docs/prd/masterwrought/farming/progress.md: fill the Phase 3 QA row (status, dates) and append QA
  findings, including the mutation-probe outcome, to the Phase 3 Notes block.
- docs/prd/masterwrought/farming/state.md: record any drift discovered (ledger corrections, deviations,
