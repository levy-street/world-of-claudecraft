...
Phase 10 notes, the promises in docs/prd/masterwrought/farming/phase-10-celebrations.md (acceptance list,
...
the real path, then the smallest green change). Run the docs/prd/masterwrought/farming/state.md validation
...
STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 10 QA row plus Notes) and
docs/prd/masterwrought/farming/state.md (drift, ledger corrections). Any deviation gets swept into
docs/prd/masterwrought/farming/phase-10-celebrations.md AND this QA twin in the same pass.
