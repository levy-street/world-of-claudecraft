...
is `docs/prd/masterwrought/farming/state.md` (D1, D23, the blast-radius reference); this file cites it
...
- docs/prd/masterwrought/farming/state.md (all of it: locked decisions, the blast-radius reference, the
  validation matrix) and docs/prd/masterwrought/farming/progress.md.
- This phase file, docs/prd/masterwrought/farming/phase-01-foundation.md.
...
- docs/prd/masterwrought/farming/progress.md: flip the Phase 1 row to done with dates, copy the STEP 5
  acceptance list here with its check states, add a Notes block (surprises,
  deviations, deferrals with reasons).
- docs/prd/masterwrought/farming/state.md: append to the per-phase ledgers (new i18n keys this phase;
  the other ledgers stay empty). Any deviation decided in-phase gets a "Locked
  deviations" line AND gets swept into docs/prd/masterwrought/farming/phase-01-foundation.md and
  docs/prd/masterwrought/farming/phase-01-qa.md in the same pass.
