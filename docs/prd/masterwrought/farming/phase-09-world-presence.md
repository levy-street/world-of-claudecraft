...
(docs/prd/masterwrought/farming/phase-09b-bed-verbs.md, maintainer adopts or strikes); the alternative
...
- docs/prd/masterwrought/farming/state.md (whole file; D9, D11, D17, D20, D21, D23, the seam
  reference on vendors and quests, and the OPEN items list matter most) and
  docs/prd/masterwrought/farming/progress.md (Phase 1 to 8 notes, deviations, and which Phase 4 gate
  and Phase 5 stocking pieces were left dormant and how).
- docs/prd/masterwrought/farming/phase-09-world-presence.md (this phase file).
...
- Update docs/prd/masterwrought/farming/progress.md: the Phase 9 status row, the acceptance list
...
- Update the docs/prd/masterwrought/farming/state.md ledgers: new items and quest, new i18n keys and
...
- Any deviation decided in-phase gets swept into
  docs/prd/masterwrought/farming/phase-09-world-presence.md AND docs/prd/masterwrought/farming/phase-09-qa.md in the
  same pass.
