...
commits. The design authority is `docs/prd/masterwrought/farming/state.md`; the promises under audit are
`docs/prd/masterwrought/farming/phase-01-foundation.md`.
...
docs/prd/masterwrought/farming/progress.md, the promises in docs/prd/masterwrought/farming/phase-01-foundation.md (its
...
- Verify every deliverable and every acceptance criterion in
  docs/prd/masterwrought/farming/phase-01-foundation.md is actually met, against the real code, not the
  PR description.
...
STEP 4 - DOC UPDATES
- docs/prd/masterwrought/farming/progress.md: fill the Phase 1 QA row (status, dates) and append QA
