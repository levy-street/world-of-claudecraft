...
STEP 1 - LOAD CONTEXT
Spawn one Explore agent to read and summarize: docs/prd/masterwrought/farming/state.md, the Phase 4
notes in docs/prd/masterwrought/farming/progress.md, the promises in docs/prd/masterwrought/farming/phase-04-knobs.md
...
the docs/prd/masterwrought/farming/state.md validation matrix rows the fix diff demands. Land fixes as
separate Conventional Commits with explicit paths, never git add -A, no session links
or Claude attribution.

STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 4 QA row plus Notes: findings, fixes,
