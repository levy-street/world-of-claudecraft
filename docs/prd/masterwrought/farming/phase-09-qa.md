...
- [AMENDED per D22, the Phase 1 QA precedent: no PR exists. The phase lands
  ...
  own audit. QA fix commits land on a fix/farming-phase-09-qa branch off
...
STEP 1 - LOAD CONTEXT
Spawn one Explore agent to read and summarize: docs/prd/masterwrought/farming/state.md; the
docs/prd/masterwrought/farming/progress.md Phase 9 notes (including the NPC names, the work-order
crops chosen, and any recorded deviation); the promises in
docs/prd/masterwrought/farming/phase-09-world-presence.md (Live-surface note, deliverables,
...
docs/prd/masterwrought/farming/implementation-plan.md that match the phase diff (expected:
...
test, then the smallest change that turns it green. Run the docs/prd/masterwrought/farming/state.md
...
STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 9 QA row and a Notes block) and
docs/prd/masterwrought/farming/state.md (any drift found: ledger corrections, decision records).
