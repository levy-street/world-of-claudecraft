...
authority is `docs/prd/masterwrought/farming/state.md` (Phase 2 deviations lettered (h) to (m) there);
the promises under audit are `docs/prd/masterwrought/farming/phase-02-patches-and-plots.md`.
...
docs/prd/masterwrought/farming/progress.md, the promises in docs/prd/masterwrought/farming/phase-02-patches-and-plots.md
...
- Verify every deliverable and every acceptance criterion in
  docs/prd/masterwrought/farming/phase-02-patches-and-plots.md is actually met, against the real code.
...
STEP 4 - DOC UPDATES
- docs/prd/masterwrought/farming/progress.md: fill the Phase 2 QA row (status, dates) and append QA
  findings to the Phase 2 Notes block.
- docs/prd/masterwrought/farming/state.md: record any drift discovered (ledger corrections, the actual
