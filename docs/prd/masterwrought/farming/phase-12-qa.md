...
report-first; budget one nudge round) to summarize: docs/prd/masterwrought/farming/
...
the played proof, the gate record), docs/prd/masterwrought/farming/phase-12-shared-feast
...
docs/prd/masterwrought/farming/implementation-plan.md that the phase diff matches
...
docs/prd/masterwrought/farming/state.md validation matrix rows the diff demands. Separate
...
STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 12 QA row plus Notes) and
docs/prd/masterwrought/farming/state.md (drift, ledger corrections, residuals with
owners). Any deviation decided in-QA gets swept into
docs/prd/masterwrought/farming/phase-12-shared-feast.md AND this file in the same pass.
...
(docs/prd/masterwrought/farming/phase-13-integration-polish.md).
