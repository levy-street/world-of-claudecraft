...
docs/prd/masterwrought/farming/progress.md, docs/prd/masterwrought/farming/phase-06-economy-hooks.md, and these source
...
Update docs/prd/masterwrought/farming/progress.md (Phase 6 status row, the copied acceptance list with
check states, a Notes block) and the docs/prd/masterwrought/farming/state.md ledgers (new recipes, new
...
docs/prd/masterwrought/farming/phase-06-economy-hooks.md AND docs/prd/masterwrought/farming/phase-06-qa.md in the same
