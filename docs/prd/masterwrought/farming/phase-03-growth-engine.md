...
design authority is `docs/prd/masterwrought/farming/state.md` (D3 through D7, the tick and hook points,
...
- docs/prd/masterwrought/farming/state.md (all of it, especially D3 through D7, the tick and hook
  points, and the seam reference) and docs/prd/masterwrought/farming/progress.md (the Phase 1 and
  Phase 2 Notes, including the final PlotState shape).
- This phase file, docs/prd/masterwrought/farming/phase-03-growth-engine.md.
...
Dispatch Matrix rows in docs/prd/masterwrought/farming/implementation-plan.md that match the diff.
...
- docs/prd/masterwrought/farming/progress.md: flip the Phase 3 row to done with dates, copy the STEP 5
...
- docs/prd/masterwrought/farming/state.md: append to the per-phase ledgers (new IWorld members:
  ...
  docs/prd/masterwrought/farming/phase-03-growth-engine.md and docs/prd/masterwrought/farming/phase-03-qa.md in the same
  pass.
