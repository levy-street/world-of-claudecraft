...
STEP 1 - LOAD CONTEXT
Spawn one Explore agent to read and summarize: docs/prd/masterwrought/farming/state.md, the Phase 5
notes in docs/prd/masterwrought/farming/progress.md, the promises in
docs/prd/masterwrought/farming/phase-05-crops-and-tools.md (deliverables, acceptance checklist, any
...
STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 5 QA row plus Notes: findings, fixes,
deferrals) and docs/prd/masterwrought/farming/state.md (any drift discovered, ledger corrections, the
