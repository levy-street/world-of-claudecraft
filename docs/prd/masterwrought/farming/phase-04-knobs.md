...
STEP 1 - LOAD CONTEXT
Spawn one Explore agent to read and summarize: docs/prd/masterwrought/farming/state.md,
docs/prd/masterwrought/farming/progress.md, docs/prd/masterwrought/farming/phase-04-knobs.md, and these source files as
...
matching rows of the Review Dispatch Matrix in docs/prd/masterwrought/farming/implementation-plan.md.
...
- [ ] docs/prd/masterwrought/farming/progress.md and docs/prd/masterwrought/farming/state.md ledgers are updated

STEP 6 - DOC UPDATES + MEMORY
Update docs/prd/masterwrought/farming/progress.md (Phase 4 status row, the copied acceptance list with
check states, a Notes block) and the docs/prd/masterwrought/farming/state.md ledgers (new IWorld
...
docs/prd/masterwrought/farming/phase-04-knobs.md AND docs/prd/masterwrought/farming/phase-04-qa.md in the same pass, plus
