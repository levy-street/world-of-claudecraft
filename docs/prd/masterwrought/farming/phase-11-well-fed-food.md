...
give the produce ladder a consumer at every rung. docs/prd/masterwrought/farming/state.md is the authority;
...
The full record: docs/prd/masterwrought/farming/progress.md Phase 11 and the state.md ledgers.
...
- READ docs/prd/masterwrought/farming/state.md's head block, D15 / D17 / D22, deviations
  ...
  docs/prd/masterwrought/farming/phase-11-well-fed-food.md whole; docs/prd/masterwrought/farming/phase-11-qa.md;
  progress.md's Phase 6, Phase 10, and Phase 10 QA notes (the tier-3
  domination flag and the dish naming already shipped).

STEP 1 - LOAD CONTEXT
Spawn one Explore agent (thorough) to read and summarize: docs/prd/masterwrought/farming/state.md,
docs/prd/masterwrought/farming/progress.md, docs/prd/masterwrought/farming/phase-11-well-fed-food.md, and these sources:
...
Update docs/prd/masterwrought/farming/progress.md (the Phase 11 status row, the acceptance list above
copied with its check states, a Notes block including the timing decision and the
proposed magnitudes) and the docs/prd/masterwrought/farming/state.md ledgers (new items and recipes, new
...
docs/prd/masterwrought/farming/phase-11-well-fed-food.md AND docs/prd/masterwrought/farming/phase-11-qa.md in the same pass.
...
(docs/prd/masterwrought/farming/phase-11-qa.md). Screenshots: the buff bar and tooltip are
