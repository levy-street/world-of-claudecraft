...
Phase 3) never leave the server. The design authority is `docs/prd/masterwrought/farming/state.md`
...
- docs/prd/masterwrought/farming/state.md (all of it) and docs/prd/masterwrought/farming/progress.md (including the
  Phase 1 Notes).
- This phase file, docs/prd/masterwrought/farming/phase-02-patches-and-plots.md.
...
- docs/prd/masterwrought/farming/progress.md: flip the Phase 2 row to done with dates, copy the STEP 5
...
- docs/prd/masterwrought/farming/state.md: append to the per-phase ledgers (new IWorld members:
  ...
  deviations" line AND gets swept into docs/prd/masterwrought/farming/phase-02-patches-and-plots.md and
  docs/prd/masterwrought/farming/phase-02-qa.md in the same pass.
