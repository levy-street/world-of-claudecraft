...
docs/prd/masterwrought/farming/progress.md, docs/prd/masterwrought/farming/phase-05-crops-and-tools.md, and these source
...
Update docs/prd/masterwrought/farming/progress.md (Phase 5 status row, the copied acceptance list with
check states, a Notes block) and the docs/prd/masterwrought/farming/state.md ledgers (new
...
docs/prd/masterwrought/farming/phase-05-crops-and-tools.md AND docs/prd/masterwrought/farming/phase-05-qa.md in the same
