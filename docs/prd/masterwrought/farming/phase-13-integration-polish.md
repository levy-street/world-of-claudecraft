...
docs/prd/masterwrought/farming/qa-checklist.md. docs/prd/masterwrought/farming/state.md is the authority; if this file
...
- Re-resolve the NEWEST release/** branch: git fetch origin --prune, then
  ...
  docs/prd/masterwrought/farming/phase-06b-release-sync.md's shape as its own mid-phase BEFORE this
...
STEP 1 - LOAD CONTEXT
Spawn one Explore agent (very thorough) to read and summarize: docs/prd/masterwrought/farming/state.md,
docs/prd/masterwrought/farming/progress.md (EVERY phase's Notes block, for the deferral sweep),
docs/prd/masterwrought/farming/phase-13-integration-polish.md, docs/prd/masterwrought/farming/qa-checklist.md, and these
...
- The docs/prd/masterwrought/farming/qa-checklist.md rows and what evidence each demands.
...
- Agent B, the handoff and the photographs (docs plus screenshots):
  ...
  teardown; it must not reference any docs/prd/masterwrought/farming/ path. Then the full-journey
...
- Agent C, the sweep and the audit (docs): the deferral sweep: every progress.md Notes
  deferral collected into the docs/prd/masterwrought/farming/state.md handoff table and recorded in the
  progress.md Phase 13 Notes block (the D22 amendment above), none lost.
  Then the full execution of docs/prd/masterwrought/farming/qa-checklist.md, including the anti-chore
...
- The packet teardown (Phase 13 QA offers it to the user; never delete docs/prd/masterwrought/farming/
  here).
...
- The full docs/prd/masterwrought/farming/qa-checklist.md matrix with evidence per row (Agent C's record;
...
docs/prd/masterwrought/farming/implementation-plan.md the residual diff matches; if the diff is
...
- [ ] The manifest references no docs/prd/masterwrought/farming/ path (it must survive teardown intact).
...
- [ ] docs/prd/masterwrought/farming/qa-checklist.md is executed in full, anti-chore audit included, with
...
Update docs/prd/masterwrought/farming/progress.md (the Phase 13 status row, the acceptance list above
copied with its check states, a Notes block holding the qa-checklist evidence and any
last deferrals) and the docs/prd/masterwrought/farming/state.md ledgers (the swept deferrals, any final
drift). Any deviation decided in-phase gets swept into
docs/prd/masterwrought/farming/phase-13-integration-polish.md AND docs/prd/masterwrought/farming/phase-13-qa.md in the same
