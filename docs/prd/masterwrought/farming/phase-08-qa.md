...
docs/prd/masterwrought/farming/progress.md Phase 8 notes (including any recorded deviation and the
open-surface decision); the promises in docs/prd/masterwrought/farming/phase-08-harvest-journal.md
...
STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 8 QA row and a Notes block) and
