...
- [AMENDED per D22, the Phase 1 QA precedent: no PR exists. The phase landed as
  ...
  plus the docs commits. Phase 6b (docs/prd/masterwrought/farming/phase-06b-release-sync.md, the
...
STEP 1 - LOAD CONTEXT
Spawn one Explore agent to read and summarize: docs/prd/masterwrought/farming/state.md, the Phase 6
notes in docs/prd/masterwrought/farming/progress.md, the promises in
docs/prd/masterwrought/farming/phase-06-economy-hooks.md (deliverables, acceptance checklist, any
...
the docs/prd/masterwrought/farming/state.md validation matrix rows the fix diff demands (content
...
STEP 4 - DOC UPDATES
Update docs/prd/masterwrought/farming/progress.md (the Phase 6 QA row plus Notes: findings, fixes,
deferrals) and docs/prd/masterwrought/farming/state.md (any drift discovered, ledger corrections).
