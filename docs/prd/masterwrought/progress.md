...
| 19 | The rulings gate (every open maintainer decision answered in-session and executed) | in progress: the 150-row table is answered and the seven execution waves are open; 19A and 19B are complete, 19C to 19G pending | 2026-09-01 | |
