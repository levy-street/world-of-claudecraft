// Phase 10 apex consumables and their crafting stations: hand-authored
// original SVG compositions (one committed <id>.svg source per item in this
// directory), rasterized to 512x512 fully-opaque sRGB PNG masters for the item
// icon converter (npm run assets:items). woc-item-icon-v1 register: single
// centered subject at roughly 70 percent fill, opaque dark painted vignette,
// warm top-left key light, cool lower-right shadow, grounded contact shadow, no
// text or frames. Like the phase 08 and 09 siblings, this rasterizer READS the
