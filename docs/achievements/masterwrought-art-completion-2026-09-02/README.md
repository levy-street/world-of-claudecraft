...
- One Farming profession emblem, one Well Fed aura, one farm-patch map marker, and two primary
  launcher icons.
- Historical-to-current item closure: 1125 - 84 + 165 = 1206 exact painted item files.
...
- `final-item-art-audit-verdict.json` binds the complete 1,206-file live item catalog to its
