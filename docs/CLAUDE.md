...
| `professions-and-crafting.md` | Tradeskill framework + full roster (cloth/First Aid foundation, then gathering + production professions); two-tier skill cap (Apprentice 50 / Journeyman 100), three-PR rollout. |
