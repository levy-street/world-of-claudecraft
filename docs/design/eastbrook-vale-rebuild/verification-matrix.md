...
| SRC-01 | Current town source remains deterministic                      | `tests/eastbrook_town_assets.test.ts`                                                      | Source fingerprint `4d024c2fbe74b73f3e4a46ee17aca9858e9cacd29760abd2789f46a80874541e`                                                                      | PASS   |
...
| GLB-10 | Current bank rebuild                               | `52,504` bytes; `3,104` triangles (`2,928` opaque, `176` emissive); SHA `e3f1556331a8edaae40671642b4fa341bcc302a7094d2cf3f0cbb0afecd165c7`; exact `7 x 7.8 x 5.5` bounds | PASS |
