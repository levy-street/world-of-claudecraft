...
| SRC-01 | Current town source remains deterministic                      | `tests/eastbrook_town_assets.test.ts`                                                      | Source fingerprint `46e1d67e363309fa96bdd1d8ecbc7cbca428fa700798a56d341369936f80ffe5`                                                                      | PASS   |
...
| GLB-10 | Current bank rebuild                               | `52,504` bytes; `3,104` triangles (`2,928` opaque, `176` emissive); SHA `dd665a7f89cd14acc9b4e984449f17bbc29184f94ab23867f26aa2aceac6908d`; exact `7 x 7.8 x 5.5` bounds | PASS |
