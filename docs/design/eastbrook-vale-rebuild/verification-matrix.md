...
| SRC-01 | Rebuild-v1 town source remains deterministic                   | `tests/eastbrook_town_assets.test.ts`                                                      | Historical town source fingerprint remains `928d47dde04c667cafc33cf6c68f9c41cfb08059586f271c912abb64619f4e2b`                                                   | PASS   |
| SRC-02 | Shared atlas remains deterministic                             | `build_surface_atlas.mjs --check` contract                                                 | Fingerprint `bfe3a8e8fbe3c307e9ed549b655f0d214b91488a19bc17c445980dd5d290c817`; shipping SHA `d66f2fab603aa83e6c73c6fc4bdde2d545a6d8c1a0d4a58d42a3fb227e5a3f9b` | PASS   |
| SRC-03 | New mailbox source is fingerprinted                            | `tests/eastbrook_mailbox_asset.test.ts`                                                    | `90901267687b92150d375277477aede5f9a103b72ef45b86bdbe72d46c5e86bb`                                                                                              | PASS   |
| SRC-04 | New noticeboard source is fingerprinted                        | `tests/eastbrook_noticeboard_asset.test.ts`                                                | `de34fb8ce9003495bde3e1404731bda83dc615bf8e80f6e79effc3eb65bfed7c`                                                                                              | PASS   |
...
| ------ | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------ |
| GLB-01 | Ravenpost mailbox bytes and hash                   | `32,884`; SHA `9b326e301c92d2b55c365ebf3d31f875aef88640d00d3b9dee920d134e7cc392`                                               | PASS                           |
| GLB-02 | Ravenpost mailbox topology                         | `1.65 x 2.9 x 1.05`; `1,640` triangles (`1,336` opaque, `304` metal); `2/2`; two sockets                                       | PASS                           |
| GLB-03 | Noticeboard bytes and hash                         | `24,684`; SHA `c1117d948a52fc56cc75e5469bd583b68095bed3836378b674be159a8eeefa99`                                               | PASS                           |
