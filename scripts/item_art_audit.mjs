...
const build = await buildItemArtAudit({
  ...
  expected: {
    ...
    // + this candidate's two vehicle-mount reins icons (Goblin Rocket Sled,
    // Rallycart RXT), retained with their provenance records.
    ...
    // bank-storage painted bags, + all five merged mount reins.
    liveItemCount: 1061,
