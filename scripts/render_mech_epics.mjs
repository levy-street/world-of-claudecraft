...
const html = `<!doctype html><html><head><meta charset="utf8"><style>html,body{margin:0;background:#000}</style></head><body>${ktx2Tag}<script>${readFileSync(BUNDLE, 'utf8')}</script></body></html>`;
