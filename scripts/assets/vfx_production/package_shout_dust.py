...
python package_shout_dust.py --input-dir tmp/shout-dust-v25-final
...
def package(directory):
    ...
    for frame in range(64):
        source = directory / 'shout_dust_frames' / ('shout_dust_%03d.png' % (frame+1))
    ...
    master = directory / 'shout_dust_atlas.png'
    runtime = directory / 'shout_dust.webp'
