...
import { createWeirdoCreamTruck } from './model.js';
...
window.exportWeirdoCreamTruck = async (stage, sourceFingerprint) => {
  const { root, animations } = createWeirdoCreamTruck({ stage, sourceFingerprint });
