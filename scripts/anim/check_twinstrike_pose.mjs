...
const clip = indexClip(root, 'Fury_Twinstrike');
function apply(time) {
...
assert(compression > 0.04, `Missing two loaded cutting stances: ${compression}`);
const end = samplePose(clip, 0.66);
for (const [key, values] of samplePose(clip, 0)) {
