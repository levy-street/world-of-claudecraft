...
| Cinematics | `cinematic_contact_sheet.mjs` (`cinematic:contact-sheet`) captures deterministic per-cut review sheets under `docs/screenshots/cinematics`; pure plan and HTML logic lives in `lib/cinematic_contact_sheet_*_core.mjs`. | dev |
