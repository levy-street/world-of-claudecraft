...
const MOB_KEYS: Record<string, string> = {
  ...
  palisade_warden: 'valdris_warden',
  lastwater_wellguard: 'valdris_warden',
  greyweir_bailiff: 'valdris_warden',
  rimeshaft_picket_warden: 'valdris_warden',
  tollroad_carter: 'valdris_carter',
  seat_water_bearer: 'valdris_carter',
  veth_ledger_courier: 'valdris_carter',
  paychest_porter: 'valdris_carter',
  granary_militia_deserter: 'mob_legion_deserter',
  maren_house_duelist: 'mob_veth_cutthroat',
  frosthelm_rimeclaw: 'mob_ember_cat',
  legion_oathguard_veteran: 'mob_legion_deserter',
  rimebound_elemental: 'mob_granite_elemental',
  assessor_maldrek: 'mob_twilight_revenant',
  purse_warden_grulk: 'mob_highland_ogre',
  twilight_moth: 'mob_pale_widow',
  feralrun_smuggler: 'mob_river_skulker',
  vessik_the_turncoat: 'mob_veth_cutthroat',
  frostpine_icecaller: 'mob_frost_troll',
  forsworn_blade: 'mob_veth_cutthroat',
  forsworn_shadowcaster: 'mob_twilight_revenant',
  broodmother_veskal: 'mob_pale_widow',
  unlit_broodling: 'mob_pale_widow',
  mistfather_ghorvul: 'mob_fog_horror',
  mist_shamble: 'mob_fog_horror',
  temple_sentinel: 'mob_granite_elemental',
  heretic_sandpriest: 'mob_tombrobber',
  ashkerat_the_warden: 'mob_granite_elemental',
  duneglass_colossus: 'mob_dust_elemental',
  heretic_flameseer: 'mob_ossara_judge',
  duskwater_raider: 'mob_veth_cutthroat',
  cartographers_shade: 'mob_twilight_revenant',
