...
export class CharacterVisual {
  ...
  setSkin(skinIndex: number): void {
    ...
    this.skinIndex = skinIndex;
    // Selecting a numeric skin clears any creator-skin overlay.
    ...
    if (pending) {
      void pending
        .then(() => {
          ...
          // material map). Also guard that this is still the requested skin and no
          // creator overlay has since been applied.
