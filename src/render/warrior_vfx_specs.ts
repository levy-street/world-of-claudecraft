...
export const WARRIOR_CHOREOGRAPHY: Readonly<Record<string, PhysicalChoreography>> = {
  ...
  breachmaker: motion('thrust', 3.1, 0.12, 1.05, 0.35, 1.2, 'steel', one, 0),
  ...
  revenge: motion('reap', 2.6, 0.12, 0.7, -0.65, 1.1, 'steel', [0, 0.28], 0),
  ...
  whirlwind: motion('spin', 3.4, 0.12, 0.65, 0.7, 1, 'steel', [0, 0.23, 0.49], 'both'),
  bladestorm: motion('spin', 4.1, 0.16, 0.9, 1.25, 1.35, 'steel', [0, 0.24, 0.5, 0.75], 'both'),
  thunder_clap: motion('fault', 5.8, 0.1, 0.035, 0.4, 1.2, 'steel', [0, 0.12, 0.28]),
  faultline: motion('fault', 7.2, 0.16, 0.045, -0.3, 1.55, 'stone', [0, 0.16, 0.34, 0.55]),
  ...
  raised_guard: motion('shield', 1.4, 0.07, 0.6, -0.2, 0.6, 'steel', [0, 0.2], 1),
  iron_resolve: motion('inward', 1.4, 0.09, 0.45, 0, 0.9, 'steel', [0, 0.27, 0.58]),
  defensive_stance: motion('shield', 0.9, 0.045, 0.55, 0.4, 0.4, 'steel', one, 1),
  die_by_sword: motion('parry', 1.8, 0.08, 0.7, -0.4, 1, 'steel', [0, 0.25, 0.55], 'both'),
  ...
  bloodrage: motion('inward', 1.9, 0.09, 0.6, 0.5, 0.75, 'blood', [0, 0.25]),
  berserker_rage: motion('inward', 2.3, 0.07, 1.05, -0.5, 0.85, 'blood', [0, 0.14, 0.35]),
  recklessness: motion('parry', 2.4, 0.1, 0.8, 0.65, 1.2, 'blood', [0, 0.3, 0.5, 0.64], 'both'),
  ...
  avatar: motion('inward', 2.6, 0.13, 0.2, 0.4, 1.4, 'stone', [0, 0.25, 0.55, 0.9]),
  furious_mending: motion('restore', 1.85, 0.07, 0.1, 0.2, 0.6, 'blood', [0, 0.3, 0.65]),
