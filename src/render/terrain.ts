...
const biomePalettes: Record<BiomeId, (typeof zonePalettes)[number]> = {
  ...
  shadowwood: makeBiomePalette('shadowwood'),
  highlands: makeBiomePalette('highlands'),
  scorched: makeBiomePalette('scorched'),
  salt: makeBiomePalette('salt'),
};
