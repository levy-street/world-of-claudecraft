...
export const en = {
  armory: {
    ...
    intro: "Look up any character to see their class, gear, talents and progress, then share the link.",
    searchPlaceholder: "Character name",
    search: "Search",
    loading: "Loading {name}...",
    notFound: "No character named {name} was found.",
    lifetimeXp: "Lifetime XP",
    arena: "Arena",
    equipment: "Equipment",
    talents: "Talents",
    ...
    empty: "Empty",
    level: "Level {level}",
    noSpec: "No specialization yet",
    specLine: "{spec} spec · {points} points spent",
    pointsOnly: "{points} talent points spent",
    mastery: "Mastery",
...
export const es: typeof en = {
  armory: {
    navTab: "Armería",
    title: "Armería de personajes",
    intro: "Busca cualquier personaje para ver su clase, equipo, talentos y progreso, y comparte el enlace.",
    searchPlaceholder: "Nombre del personaje",
    search: "Buscar",
    loading: "Cargando {name}...",
    notFound: "No se encontró ningún personaje llamado {name}.",
    lifetimeXp: "EXP de por vida",
    arena: "Arena",
    equipment: "Equipo",
    talents: "Talentos",
    ...
    empty: "Vacío",
    level: "Nivel {level}",
    noSpec: "Sin especialización todavía",
    specLine: "Especialización {spec} · {points} puntos gastados",
    pointsOnly: "{points} puntos de talento gastados",
    mastery: "Maestría",
...
export const fr_FR: typeof en = {
  armory: {
    navTab: "Armurerie",
    title: "Armurerie des personnages",
    intro: "Recherchez n'importe quel personnage pour voir sa classe, son équipement, ses talents et sa progression, puis partagez le lien.",
    searchPlaceholder: "Nom du personnage",
    search: "Rechercher",
    loading: "Chargement de {name}...",
    notFound: "Aucun personnage nommé {name} n'a été trouvé.",
    ...
    specLine: "Spécialisation {spec} · {points} points dépensés",
    pointsOnly: "{points} points de talent dépensés",
    mastery: "Maîtrise",
...
export const it_IT: typeof en = {
  armory: {
    navTab: "Armeria",
    title: "Armeria dei personaggi",
    intro: "Cerca un personaggio per vedere classe, equipaggiamento, talenti e progressi, poi condividi il link.",
    searchPlaceholder: "Nome del personaggio",
    search: "Cerca",
    loading: "Caricamento di {name}...",
    notFound: "Nessun personaggio chiamato {name} trovato.",
    ...
    specLine: "Specializzazione {spec} · {points} punti spesi",
    pointsOnly: "{points} punti talento spesi",
    mastery: "Maestria",
    copyLink: "Copia link",
    copied: "Copiato!",
  },
...
export const de_DE: typeof en = {
  armory: {
    navTab: "Arsenal",
    title: "Charakter-Arsenal",
    intro: "Suche einen beliebigen Charakter, um Klasse, Ausrüstung, Talente und Fortschritt zu sehen, und teile den Link.",
    searchPlaceholder: "Charaktername",
    search: "Suchen",
    loading: "Lade {name}...",
    notFound: "Kein Charakter mit dem Namen {name} gefunden.",
    lifetimeXp: "Gesamt-EP",
    arena: "Arena",
    equipment: "Ausrüstung",
    talents: "Talente",
    mainhand: "Waffenhand",
    ...
    empty: "Leer",
    level: "Stufe {level}",
    noSpec: "Noch keine Spezialisierung",
    specLine: "{spec}-Spezialisierung · {points} Punkte vergeben",
    pointsOnly: "{points} Talentpunkte vergeben",
...
export const zh_CN: typeof en = {
  armory: {
    navTab: "军械库",
    title: "角色军械库",
    intro: "查找任意角色，查看其职业、装备、天赋与进度，并分享链接。",
    searchPlaceholder: "角色名称",
    search: "搜索",
    loading: "正在加载 {name}...",
    notFound: "未找到名为 {name} 的角色。",
    lifetimeXp: "终生经验",
    arena: "竞技场",
    equipment: "装备",
    talents: "天赋",
    ...
    level: "等级 {level}",
    noSpec: "尚无专精",
    specLine: "{spec} 专精 · 已用 {points} 点",
    pointsOnly: "已用 {points} 天赋点",
    mastery: "精通",
    copyLink: "复制分享链接",
    copied: "已复制！",
  },
...
export const zh_TW: typeof en = {
  armory: {
    navTab: "軍械庫",
    title: "角色軍械庫",
    intro: "查找任意角色，查看其職業、裝備、天賦與進度，並分享連結。",
    searchPlaceholder: "角色名稱",
    search: "搜尋",
    loading: "正在載入 {name}...",
    notFound: "找不到名為 {name} 的角色。",
    lifetimeXp: "終生經驗",
    arena: "競技場",
    equipment: "裝備",
    talents: "天賦",
    ...
    level: "等級 {level}",
    noSpec: "尚無專精",
    specLine: "{spec} 專精 · 已用 {points} 點",
    pointsOnly: "已用 {points} 天賦點",
    mastery: "精通",
    copyLink: "複製分享連結",
    copied: "已複製！",
  },
...
export const ko_KR: typeof en = {
  armory: {
    navTab: "병기고",
    title: "캐릭터 병기고",
    intro: "아무 캐릭터나 검색하여 직업, 장비, 특성, 진행 상황을 확인하고 링크를 공유하세요.",
    searchPlaceholder: "캐릭터 이름",
    search: "검색",
    loading: "{name} 불러오는 중...",
    notFound: "{name}(이)라는 캐릭터를 찾을 수 없습니다.",
    lifetimeXp: "누적 경험치",
    arena: "투기장",
    equipment: "장비",
    talents: "특성",
    ...
    level: "레벨 {level}",
    noSpec: "아직 전문화 없음",
    specLine: "{spec} 전문화 · {points}포인트 사용",
    pointsOnly: "특성 {points}포인트 사용",
    mastery: "특화",
    copyLink: "공유 링크 복사",
    copied: "복사됨!",
  },
...
export const ja_JP: typeof en = {
  armory: {
    navTab: "アーモリー",
    title: "キャラクターアーモリー",
    intro: "任意のキャラクターを検索して、職業・装備・タレント・進行状況を確認し、リンクを共有しましょう。",
    searchPlaceholder: "キャラクター名",
    search: "検索",
    loading: "{name} を読み込み中...",
    notFound: "{name} という名前のキャラクターは見つかりませんでした。",
    lifetimeXp: "累計経験値",
    arena: "アリーナ",
    equipment: "装備",
    talents: "タレント",
    ...
    level: "レベル {level}",
    noSpec: "専門化なし",
    specLine: "{spec} 専門化 ・ {points} ポイント使用",
    pointsOnly: "タレント {points} ポイント使用",
    mastery: "マスタリー",
    copyLink: "共有リンクをコピー",
    copied: "コピーしました！",
  },
...
export const pt_BR: typeof en = {
  armory: {
    navTab: "Armaria",
    title: "Armaria de personagens",
    intro: "Procure qualquer personagem para ver classe, equipamento, talentos e progresso, e compartilhe o link.",
    searchPlaceholder: "Nome do personagem",
    search: "Buscar",
    loading: "Carregando {name}...",
    notFound: "Nenhum personagem chamado {name} foi encontrado.",
    lifetimeXp: "XP total",
    arena: "Arena",
    equipment: "Equipamento",
    talents: "Talentos",
    ...
    empty: "Vazio",
    level: "Nível {level}",
    noSpec: "Sem especialização ainda",
    specLine: "Especialização {spec} · {points} pontos gastos",
    pointsOnly: "{points} pontos de talento gastos",
    mastery: "Maestria",
...
export const ru_RU: typeof en = {
  armory: {
    navTab: "Арсенал",
    title: "Арсенал персонажей",
    intro: "Найдите любого персонажа, чтобы увидеть его класс, снаряжение, таланты и прогресс, и поделитесь ссылкой.",
    searchPlaceholder: "Имя персонажа",
    search: "Поиск",
    loading: "Загрузка {name}...",
    notFound: "Персонаж с именем {name} не найден.",
    lifetimeXp: "Всего опыта",
    arena: "Арена",
    equipment: "Снаряжение",
    talents: "Таланты",
    ...
    empty: "Пусто",
    level: "Уровень {level}",
    noSpec: "Нет специализации",
    specLine: "Специализация {spec} · потрачено {points} очк.",
    pointsOnly: "Потрачено {points} очк. талантов",
    mastery: "Мастерство",
