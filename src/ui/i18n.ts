...
const classAbilityNamesEn = {
  entities: {
    abilities: abilityTranslations([
      ...
      ["fireball", "Fireball", "Hurls a fiery ball that causes {damage} Fire damage plus {overTime} additional damage over time."],
      ...
      ["flame_shock", "Flame Shock", "Sears the target with fire for {damage} damage plus {overTime} over 12 sec."],
      ...
      ["immolate", "Immolate", "Burns the enemy for {damage} Fire damage and an additional {overTime} over 15 sec."],
      ...
      ["moonfire", "Moonfire", "Burns the enemy with moonfire for {damage} Arcane damage plus {overTime} damage over time."],
      ...
      ["regrowth", "Regrowth", "Heals a friendly target for {damage} and an additional {overTime} over 21 sec."],
  ...
  es: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "Bola de Fuego", "Lanza una bola ígnea que causa {damage} de daño de Fuego y {overTime} de daño adicional en el tiempo."],
        ...
        ["flame_shock", "Choque de llamas", "Abrasa al objetivo con fuego por {damage} de daño más {overTime} durante 12 s."],
        ...
        ["immolate", "Inmolar", "Quema al enemigo por {damage} de daño de Fuego y {overTime} adicionales durante 15 s."],
        ...
        ["moonfire", "Fuego lunar", "Quema al enemigo con fuego lunar por {damage} de daño Arcano y {overTime} de daño en el tiempo."],
        ...
        ["regrowth", "Recrecimiento", "Sana a un objetivo amistoso por {damage} y {overTime} adicionales durante 21 s."],
  ...
  fr_FR: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "Boule de feu", "Lance une boule enflammée qui inflige {damage} points de dégâts de Feu plus {overTime} points de dégâts supplémentaires sur la durée."],
        ...
        ["flame_shock", "Horion de flammes", "Brûle la cible par le feu pour {damage} points de dégâts plus {overTime} en 12 s."],
        ...
        ["immolate", "Immolation", "Brûle l'ennemi pour {damage} points de dégâts de Feu et {overTime} points supplémentaires en 15 s."],
        ...
        ["moonfire", "Éclat lunaire", "Brûle l'ennemi par un feu lunaire pour {damage} points de dégâts des Arcanes plus {overTime} points de dégâts sur la durée."],
        ...
        ["regrowth", "Rétablissement", "Rend {damage} points de vie à une cible alliée plus {overTime} points supplémentaires en 21 s."],
  ...
  it_IT: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "Palla di Fuoco", "Scaglia una palla infuocata che infligge {damage} danni da Fuoco più {overTime} danni aggiuntivi nel tempo."],
        ...
        ["flame_shock", "Folgore del Fuoco", "Brucia il bersaglio con il fuoco per {damage} danni più {overTime} in 12 s."],
        ...
        ["immolate", "Immolazione", "Brucia il nemico per {damage} danni da Fuoco e altri {overTime} in 15 s."],
        ...
        ["moonfire", "Fuoco Lunare", "Brucia il nemico con fuoco lunare per {damage} danni Arcani più {overTime} danni nel tempo."],
        ...
        ["regrowth", "Ricrescita", "Cura un bersaglio alleato di {damage} e di altri {overTime} in 21 s."],
  ...
  de_DE: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "Feuerball", "Schleudert einen feurigen Ball, der {damage} Feuerschaden sowie {overTime} zusätzlichen Schaden über Zeit verursacht."],
        ...
        ["flame_shock", "Flammenschock", "Versengt das Ziel mit Feuer für {damage} Schaden plus {overTime} über 12 Sek."],
        ...
        ["immolate", "Feuerbrand", "Verbrennt den Gegner für {damage} Feuerschaden und zusätzlich {overTime} über 15 Sek."],
        ...
        ["moonfire", "Mondfeuer", "Verbrennt den Gegner mit Mondfeuer für {damage} Arkanschaden plus {overTime} Schaden über Zeit."],
        ...
        ["regrowth", "Nachwachsen", "Heilt ein freundliches Ziel um {damage} und zusätzlich {overTime} über 21 Sek."],
  ...
  zh_CN: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "火球术", "投掷一团火球，造成 {damage} 点火焰伤害，并附加 {overTime} 点持续伤害。"],
        ...
        ["flame_shock", "烈焰震击", "用火焰灼烧目标，造成 {damage} 点伤害，并在 12 秒内额外造成 {overTime}。"],
        ...
        ["immolate", "献祭", "灼烧敌人，造成 {damage} 点火焰伤害，并在 15 秒内额外造成 {overTime}。"],
        ...
        ["moonfire", "月火术", "以月火灼烧敌人，造成 {damage} 点奥术伤害，并附加 {overTime} 点持续伤害。"],
        ...
        ["regrowth", "愈合", "为一个友方目标恢复 {damage} 点生命值，并在 21 秒内额外恢复 {overTime} 点。"],
  ...
  zh_TW: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "火球術", "投擲一團火球，造成 {damage} 點火焰傷害，並附加 {overTime} 點持續傷害。"],
        ...
        ["flame_shock", "烈焰震擊", "用火焰灼燒目標，造成 {damage} 點傷害，並在 12 秒內額外造成 {overTime}。"],
        ...
        ["immolate", "獻祭", "灼燒敵人，造成 {damage} 點火焰傷害，並在 15 秒內額外造成 {overTime}。"],
        ...
        ["moonfire", "月火術", "以月火灼燒敵人，造成 {damage} 點秘法傷害，並附加 {overTime} 點持續傷害。"],
        ...
        ["regrowth", "癒合", "為一個友方目標恢復 {damage} 點生命值，並在 21 秒內額外恢復 {overTime} 點。"],
  ...
  ko_KR: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "화염구", "불덩이를 날려 {damage}의 화염 피해와 추가로 {overTime}의 지속 피해를 입힙니다."],
        ...
        ["flame_shock", "화염 충격", "대상을 불태워 {damage}의 피해를 입히고 12초에 걸쳐 추가로 {overTime}의 피해를 입힙니다."],
        ...
        ["immolate", "제물", "적을 불태워 {damage}의 화염 피해를 입히고 15초에 걸쳐 추가로 {overTime}의 피해를 입힙니다."],
        ...
        ["moonfire", "달빛 섬광", "달빛불로 적을 태워 {damage}의 비전 피해와 추가로 {overTime}의 지속 피해를 입힙니다."],
        ...
        ["regrowth", "재생", "아군 대상의 생명력을 {damage}만큼 회복시키고 21초에 걸쳐 추가로 {overTime}만큼 회복시킵니다."],
  ...
  ja_JP: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "ファイアボール", "炎の球を放ち、{damage} の火炎ダメージと追加で {overTime} の継続ダメージを与えます。"],
        ...
        ["flame_shock", "フレイムショック", "対象を炎で焼き、{damage}ダメージに加えて12秒間で {overTime} のダメージを与えます。"],
        ...
        ["immolate", "イモレート", "敵を燃やして{damage}の火炎ダメージを与え、15秒間で追加の {overTime} を与えます。"],
        ...
        ["moonfire", "ムーンファイア", "月の炎で敵を焼き、{damage} の秘術ダメージと追加で {overTime} の継続ダメージを与えます。"],
        ...
        ["regrowth", "リグロース", "味方対象の体力を {damage} 回復し、さらに21秒間で追加で {overTime} 回復します。"],
  ...
  pt_BR: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "Bola de Fogo", "Arremessa uma bola flamejante que causa {damage} de dano de Fogo e {overTime} de dano adicional ao longo do tempo."],
        ...
        ["flame_shock", "Choque Flamejante", "Queima o alvo com fogo, causando {damage} de dano mais {overTime} ao longo de 12 s."],
        ...
        ["immolate", "Imolar", "Queima o inimigo com {damage} de dano de Fogo e mais {overTime} ao longo de 15 s."],
        ...
        ["moonfire", "Fogo Lunar", "Queima o inimigo com fogo lunar, causando {damage} de dano Arcano e {overTime} de dano ao longo do tempo."],
        ...
        ["regrowth", "Recrescimento", "Cura um alvo aliado em {damage} e em mais {overTime} ao longo de 21 s."],
  ...
  ru_RU: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["fireball", "Огненный шар", "Бросает огненный шар, наносящий {damage} ед. урона от огня и дополнительно {overTime} периодического урона."],
        ...
        ["flame_shock", "Огненный шок", "Обжигает цель огнем, нанося {damage} ед. урона и еще {overTime} за 12 сек."],
        ...
        ["immolate", "Жертвенный огонь", "Сжигает врага, нанося {damage} ед. урона от огня и еще {overTime} за 15 сек."],
        ...
        ["moonfire", "Лунный огонь", "Сжигает врага лунным огнем, нанося {damage} ед. урона от тайной магии и {overTime} периодического урона."],
        ...
        ["regrowth", "Восстановление", "Исцеляет дружественную цель на {damage} и дополнительно на {overTime} в течение 21 сек."],
...
const mergeExtraEn = {
    abilities: abilityTranslations([
      ...
      ["rake", "Rake", "A stealth opener that rakes the enemy for weapon damage plus {damage} and causes {overTime} bleeding damage over 9 sec. Awards 1 combo point. Wolf Form only."],
...
const mergeExtra = {
  ...
  es: {
    abilities: abilityTranslations([
      ...
      ["rake", "Zarpazo", "Una apertura sigilosa que desgarra al enemigo causando el daño del arma más {damage} y provoca {overTime} de daño por sangrado durante 9 s. Otorga 1 punto de combo. Solo en Forma de lobo."],
  ...
  fr_FR: {
    abilities: abilityTranslations([
      ...
      ["rake", "Lacérer", "Une attaque d'ouverture en camouflage qui lacère l'ennemi pour les dégâts de l'arme plus {damage} et inflige {overTime} dégâts de saignement sur 9 sec. Octroie 1 point de combo. Forme de loup uniquement."],
  ...
  it_IT: {
    abilities: abilityTranslations([
      ...
      ["rake", "Sventramento", "Un'apertura furtiva che dilania il nemico infliggendo danno dell'arma più {damage} e provoca {overTime} danni da sanguinamento per 9 sec. Conferisce 1 punto combo. Solo in Forma del Lupo."],
  ...
  de_DE: {
    abilities: abilityTranslations([
      ...
      ["rake", "Krallenhieb", "Ein Schleicheröffner, der den Gegner für Waffenschaden plus {damage} aufreißt und über 9 Sek. {overTime} Blutungsschaden verursacht. Gewährt 1 Combopunkt. Nur in Wolfsgestalt."],
  ...
  zh_CN: {
    abilities: abilityTranslations([
      ...
      ["rake", "撕抓", "一记潜行起手技，以武器伤害外加{damage}撕抓敌人，并造成持续9秒共 {overTime} 的流血伤害。获得1点连击点数。仅限狼形态使用。"],
  ...
  zh_TW: {
    abilities: abilityTranslations([
      ...
      ["rake", "撕裂", "一招隱匿起手技，以武器傷害外加 {damage} 撕裂敵人，並造成持續 9 秒共 {overTime} 的流血傷害。給予 1 點連擊點數。僅限狼形態。"],
  ...
  ko_KR: {
    abilities: abilityTranslations([
      ...
      ["rake", "할퀴기", "은신 상태에서 적을 할퀴어 무기 피해에 더해 {damage}의 피해를 입히고 9초에 걸쳐 {overTime}의 출혈 피해를 줍니다. 연계 점수 1을 부여합니다. 늑대 변신 상태에서만 사용 가능."],
  ...
  ja_JP: {
    abilities: abilityTranslations([
      ...
      ["rake", "切り裂き", "ステルス状態からの先制攻撃で、武器ダメージに加えて{damage}のダメージを与え、9秒かけて {overTime} の出血ダメージを与える。コンボポイントを1獲得する。ウルフフォーム時のみ使用可能。"],
  ...
  pt_BR: {
    abilities: abilityTranslations([
      ...
      ["rake", "Dilacerar", "Um golpe de abertura furtivo que dilacera o inimigo causando dano de arma mais {damage} e provoca {overTime} de sangramento ao longo de 9 seg. Concede 1 ponto de combo. Apenas na Forma de Lobo."],
  ...
  ru_RU: {
    abilities: abilityTranslations([
      ...
      ["rake", "Раздирание", "Скрытная атака из засады, наносящая врагу урон оружием плюс {damage} и вызывающая {overTime} урона от кровотечения в течение 9 сек. Даёт 1 очко серии приёмов. Только в облике волка."],
