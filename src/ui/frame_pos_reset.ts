...
// timestamp, so a targeted clear is impossible: this v0.26 migration clears
// BOTH unit-frame position keys once per client, keyed by an epoch marker. It
// deliberately also resets a newer saved position on the first upgraded load;
// that one-time cost restores a known classic default for every affected client.
// Bump
