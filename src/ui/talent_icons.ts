...
const DEMON_HUNTER_TALENT_ABILITY_ICON: Record<string, string> = {
  ...
  dh_demonic_resilience: 'demon_ascendance',
  dh_weapon_mastery: 'blade_dance',
  dh_dark_arts: 'eye_beam',
  dh_elusiveness: 'blur',
  dh_metamorphosis: 'demon_ascendance',
