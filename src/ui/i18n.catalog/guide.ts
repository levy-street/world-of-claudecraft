...
export const guideStrings = {
  ...
  professions: {
    ...
    stationsBody:
      "Six typed stations serve the eight station-bound crafts, spread across the three town hubs. Eastbrook holds the forge (Weaponcrafting, Armorcrafting, and Jewelcrafting all share it), the kitchens, the loom, and the toolworks; Fenbridge keeps the tannery, and Highwatch the apothecary. Each station has a resident master beside it who trains recipes, posts work orders, and offers the unbind service.\n\nThe working radius is 20 yards, roughly the station's own yard, so you craft standing at the anvil rather than from across town. Inscription and Enchanting have no station: the first awaits its recipes, and Enchanting works anywhere by design.",
    deedsHeading: 'Deeds that remember the journey',
    deedsBody:
      'The Book of Deeds walks beside every step of this. Your first attunement earns Craftsworn and your first masterwork earns Masterwright, both wearable as titles. Eight of the nine earnable crafts mark a milestone deed at 50 skill and crown their caps with a Grandmaster title (Jewelcrafting instead marks Polished to Brilliance for a first rare-tier piece; its milestone pages wait with its archetype pairs), while Fishing gets Old Salt at 100 proficiency and the Master Angler title at 200.\n\nThere are quieter pages too: deeds for your first harvest and first craft, for the rare finds luck turns up in the field, and for taking up salvage. All of it is cosmetic, titles and Renown only. A deed never grants power; it only proves you were there.',
