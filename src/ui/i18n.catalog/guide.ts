...
export const guideStrings = {
  ...
  professions: {
    ...
    deedsBody:
      'The Book of Deeds walks beside every step of this. Your first attunement earns Craftsworn and your first masterwork earns Masterwright, both wearable as titles. All nine earnable crafts mark a milestone deed at 50 skill and crown their caps with a Grandmaster title (Jewelcrafting marks Polished to Brilliance for a first rare-tier piece besides), while Fishing gets Old Salt at 100 proficiency and the Master Angler title at 200.\n\nThere are quieter pages too: deeds for your first harvest and first craft, for the rare finds luck turns up in the field, and for taking up salvage. All of it is cosmetic, titles and Renown only. A deed never grants power; it only proves you were there.',
