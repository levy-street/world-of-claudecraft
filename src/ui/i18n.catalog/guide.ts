...
export const guideStrings = {
  ...
  abilityHook: {
    ...
    // Classic Warrior (the pre-overhaul PTR class): its cw_ signature clones behave
    // like their base warrior abilities, so each hook reuses the base wording
    // verbatim (identical English keeps the existing per-locale fills reusable).
