...
export const shellStrings = {
  ...
  zh_CN: {
    ...
    woc: {
      linkWalletFirst: '请连接并绑定 Solana 钱包以使用 $WOC 支付。',
      quoting: '正在准备你的 $WOC 支付...',
      approveBurn: '请在钱包中批准烧毁 {amount} $WOC...',
      confirming: '正在确认链上烧毁...',
      finalizing: '正在等待 Solana 最终确认...',
  ...
  zh_TW: {
    ...
    woc: {
      linkWalletFirst: '請連接並綁定 Solana 錢包以使用 $WOC 支付。',
      quoting: '正在準備你的 $WOC 支付...',
      approveBurn: '請在錢包中批准燒毀 {amount} $WOC...',
      confirming: '正在確認鏈上燒毀...',
      finalizing: '正在等待 Solana 最終確認...',
  ...
  ko_KR: {
    ...
    errors: {
      ...
      api: {
        ...
        linkWalletFirst: '먼저 Solana 지갑을 연결하고 연동하세요.',
        nameReserved: '해당 이름은 예약되어 있습니다.',
    ...
    woc: {
      linkWalletFirst: '$WOC로 결제하려면 Solana 지갑을 연결하고 계정에 연동하세요.',
      quoting: '$WOC 결제를 준비하는 중...',
      approveBurn: '지갑에서 {amount} $WOC 소각을 승인하세요...',
      confirming: '온체인 소각을 확인하는 중...',
  ...
  ja_JP: {
    ...
    errors: {
      ...
      api: {
        ...
        linkWalletFirst: 'まず Solana ウォレットを接続して連携してください。',
    ...
    woc: {
      linkWalletFirst: '$WOC で支払うには Solana ウォレットを接続して連携してください。',
      quoting: '$WOC の支払いを準備しています...',
      approveBurn: 'ウォレットで {amount} $WOC のバーンを承認してください...',
      confirming: 'オンチェーンでバーンを確認しています...',
      finalizing: 'Solana のファイナライズを待っています...',
      confirmFailed: '$WOC の支払いを確認できませんでした。',
      finalizeTimeout:
  ...
  ru_RU: {
    ...
    errors: {
      ...
      api: {
        ...
        quoteExpired: 'Срок действия платежной заявки истек. Начните заново.',
    ...
    woc: {
      ...
      confirming: 'Подтверждение сжигания в сети...',
