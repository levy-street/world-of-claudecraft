...
export const shellStrings = {
  en: {
    ...
    landing: {
      ...
      heroBody:
        'Play free in your browser, build a hero across nine classes, or train an agent against the real game.',
      ...
      newsBody:
        'Follow the latest from World of ClaudeCraft and discover stories from behind the world.',
      newsXTitle: 'Latest on X',
      newsXIntro: 'Official posts from @WoClaudecraft',
      newsXConsentTitle: 'X feed needs permission',
      newsXConsentBody:
        'This live feed needs permission to connect to X. X may receive information about your visit.',
      ...
      newsXUnavailableBody:
        'It may be blocked by your browser, an extension, or a temporary issue with X.',
      newsXHiddenTitle: 'Live feed unavailable here',
      newsXHiddenBody:
        "The embedded X feed isn't available on smaller screens or in the app. Open @WoClaudecraft on X to see the latest posts.",
      newsXPrivacy:
        'Loading this feed connects to X and may allow X to receive information about your visit.',
      ...
      newsXUnavailable:
        'The X feed could not be loaded. You can still view every post directly on X.',
      ...
      newsPressPrimaryTitle:
        'The First Vibe Coded MMORPG Is Free, Open Source, and Surprisingly Complete',
      newsPressPrimaryBody:
        'MMORPG.com explores the open world, shared adventures, and fast-moving experiment behind World of ClaudeCraft.',
      ...
      introBody:
        'The browser MMO, the authoritative online world, and AI training all run on the same deterministic simulation. Players and agents face the same combat, quests, dungeons, and consequences.',
      ...
      worldBody:
        'Begin among Eastbrook Vale campfires, descend into haunted crypts, and climb through the storms of Thornpeak. Every road leads deeper into a world that keeps moving.',
      eastbrookTitle: 'Eastbrook Vale',
      eastbrookBody: 'A shared frontier of first quests, roaming enemies, and unlikely allies.',
      eastbrookAlt:
        'A party of adventurers travels the long road from Eastbrook Vale toward Thornpeak',
      hollowTitle: 'The Hollow Crypt',
      hollowBody:
        'Party combat beneath cold blue torches, where the restless dead gather in force.',
      ...
      classesBody:
        'Stand in the shield wall, command fire and frost, stalk from the shadows, or keep your party alive. Build a hero, master a specialization, and carry that story into the shared world.',
      ...
      streamBody:
        "World of ClaudeCraft's resident AI streamer plays the world live, 24 hours a day.",
      ...
      streamHostBody:
        'Join Yuumiii as she explores every corner of World of ClaudeCraft, day and night.',
      ...
      streamOffline:
        'The viewing portal is reconnecting. Open the Twitch channel to keep watching.',
      streamCompact: 'Open the Twitch channel to watch Yuumiii on this screen.',
      streamUnavailable:
        'The viewing portal is unavailable. Open the Twitch channel to keep watching.',
      communityEyebrow: 'GATHER AT THE FORGE',
      communityHeading: 'Claudemoon is made together.',
      communityBody:
        'Bring your craft, your curiosity, or simply your company\u2014the guild has room at its table.',
      openEyebrow: 'OPEN WORLD. OPEN CODE.',
      openHeading: 'Host your own world. Bring your friends.',
      openBody:
        'Explore the source, host your own private world, and invite your friends to adventure together on a server you control.',
      supportEyebrow: 'KEEP THE REALM RUNNING',
      supportHeading: 'Build, play, and support the next chapter.',
      supportBody:
        'World of ClaudeCraft grows in the open. Join the community, follow the living world, or support ongoing development.',
      xCta: 'Follow on X',
