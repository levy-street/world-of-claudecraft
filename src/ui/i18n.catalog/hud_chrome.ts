...
export const hudChromeStrings = {
  ...
  pokerPlaytest: {
    title: 'Poker',
    close: 'Close Poker',
    reconnecting: 'Reconnecting to the poker server...',
    ...
    playerTurn: '{name} is acting',
    timeRemaining: '{seconds}s remaining',
    wagerAmount: '{action} amount',
    rake: 'Rake: {amount}',
    error: {
      ...
      rebuy_not_allowed: 'You cannot rebuy right now.',
      seat_conflict: 'That seat was just taken.',
      stale_action: 'The hand changed before that action arrived.',
      table_not_found: 'That poker table no longer exists.',
      watch_conflict: 'Leave your current table before watching another.',
    },
    chips: '{amount} chips',
    pot: 'Pot: {amount}',
    noCards: 'No cards',
