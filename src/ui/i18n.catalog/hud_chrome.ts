...
export const hudChromeStrings = {
  ...
  // Aldrin Club membership panel (PR #938, aldrin_club_window.ts). Perk ids
  // mirror server/aldrin_club.ts ALDRIN_PERKS; every perk is cosmetic,
  // convenience, or access only (the no-pay-to-win rule).
  aldrin: {
    entryLabel: 'Aldrin Club',
    title: 'The Aldrin Club',
    intro:
      'A monthly membership. Every perk is cosmetic, convenience, or access: nothing in the club grants power.',
    loading: 'Loading...',
    ...
    reason: {
      ...
      walletCannotSign:
        'Unavailable: the linked wallet verifies by message signature only and cannot sign transactions.',
    ...
    railsNotice:
      'Payments are disabled in this build pending operator keys and final sign-off. No transaction will be sent from this window.',
