...
export const hudChromeStrings = {
  ...
  // The Trading Bots window (trading_bots_window.ts) and its bag footer
  // launcher: rent a SOL/WOC trading bot, fund its vault, and run it. $WOC,
  // SOL, Claudium, Jupiter, and Solana are brand terms and stay untranslated
  // inside otherwise-localized values. SKU names/blurbs and param labels are
  // client-side by stable id (the service config carries only ids + numbers).
  tradingBots: {
    title: 'Trading Bots',
    ...
    custody:
      'Deposits go to a capped vault the trading service manages for you. Only your linked wallet can receive withdrawals, and you can withdraw at any time.',
    riskNote:
      'Automated trading can lose value. Rental fees are not refunded. This is not financial advice.',
    catalogIntro:
      'Rent a bot by the month, fund it with a SOL and $WOC pair, and it trades for you on the DEX.',
    skuGridName: 'Grid Golem',
    skuGridBlurb:
      'Places alternating buys and sells around the market price, earning the spread while prices wander.',
    skuDcaName: 'Drip Sprite',
    skuDcaBlurb:
      'Steadily converts SOL into $WOC on a fixed schedule, spreading your entries over time.',
    skuMomentumName: 'Momentum Wisp',
    skuMomentumBlurb:
      'Leans the pair toward the trending side and rotates back when the trend fades.',
    ...
    withdrawBody:
      'Withdrawing pauses the bot and returns the vault balances to your linked wallet.',
