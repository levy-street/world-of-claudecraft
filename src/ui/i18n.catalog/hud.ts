...
const hudStringsEn = {
  hud: {
    ...
    mounts: {
      ...
      noWallet:
        'Hold at least {amount} $WOC — 0.1% of supply — on a linked wallet to earn your first travel mount.',
      ...
      mint: 'Mint Charter',
      mintHint:
        'Strike a tradeable Charter for this mount — sell it for gold so a non-holder can earn it.',
  ...
  es: {
    hud: {
      ...
      mounts: {
        ...
        noWallet:
          'Mantén al menos {amount} $WOC —el 0,1% del suministro— en una cartera vinculada para ganar tu primera montura de viaje.',
        ...
        mint: 'Acuñar título',
        mintHint:
          'Acuña un título negociable de esta montura: véndelo por oro para que alguien sin $WOC pueda ganarla.',
      ...
      wager: {
        ...
        inviteCharter:
          '{name} abre una carrera apostada: apuesta {money} + un título de montura. ¿Igualas?',
  ...
  fr_FR: {
    hud: {
      ...
      mounts: {
        ...
        noWallet:
          "Détenez au moins {amount} $WOC — 0,1% de l'offre — sur un portefeuille lié pour gagner votre première monture de voyage.",
        ...
        mintHint:
          "Frappez un titre négociable pour cette monture — vendez-le contre de l'or pour qu'un non-détenteur puisse la gagner.",
      ...
      wager: {
        ...
        inviteCharter:
          '{name} ouvre une course pariée — misez {money} + un titre de monture. Vous suivez ?',
