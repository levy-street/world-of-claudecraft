...
export const en = {
  ...
  entities: {
    ...
    items: {
      ...
      deathless_heartwood_heroic: { name: 'Heartwood of the Deathless Crown' },
      kingsbane_last_oath: { name: 'Thronebane, Last Oath of Thornpeak' },
      kingsbane_last_oath_heroic: { name: 'Thronebane, Last Oath of Thornpeak' },
      crownforged_dreadhelm: { name: 'Bonewrought Dreadhelm' },
      crownforged_dreadhelm_heroic: { name: 'Bonewrought Dreadhelm' },
      crownforged_warspaulders: { name: 'Bonewrought Warspaulders' },
      crownforged_warspaulders_heroic: { name: 'Bonewrought Warspaulders' },
      nighttalon_crown: { name: 'Direfang Crown' },
      nighttalon_crown_heroic: { name: 'Direfang Crown' },
      nighttalon_shoulderguards: { name: 'Direfang Shoulderguards' },
      nighttalon_shoulderguards_heroic: { name: 'Direfang Shoulderguards' },
      soulflame_cowl: { name: 'Wraithfire Cowl' },
      soulflame_cowl_heroic: { name: 'Wraithfire Cowl' },
      soulflame_mantle: { name: 'Wraithfire Mantle' },
      soulflame_mantle_heroic: { name: 'Wraithfire Mantle' },
