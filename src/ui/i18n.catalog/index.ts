...
export const en = {
  ...
  marketplace: {
    ...
    modeUpload: "Upload",
    modeLink: "Self-host",
    uploadIntro: "Upload your own 1024x1024 PNG atlas. We pin it to IPFS and host it for you.",
    linkIntro: "Link a PNG atlas you host yourself. We proxy it, so buyers never see your URL. Free.",
    uploadFile: "Skin PNG (1024x1024)",
    linkUrl: "Atlas URL",
    quotaMeter: "Hosted {used}/{quota} slots",
    trustedBadge: "Trusted creator (instant-live)",
    selfHostedFreeNote: "Self-hosting is free and unlimited (within the listing cap).",
    hostingUnavailable: "Hosted uploads are temporarily unavailable.",
    listedReview: "Submitted for review — it lists once an operator approves it.",
    ...
    finishes: { matte: "Matte", satin: "Satin", metallic: "Metallic" },
    densities: { low: "Sparse", medium: "Normal", high: "Dense" },
    glow: "Glow",
    glowColor: "Glow color",
    noGlow: "No glow",
    randomize: "Randomize",
    nameLabel: "Name",
    namePlaceholder: "e.g. Emerald Dragonscale",
    descLabel: "Description",
    descPlaceholder: "A short description buyers will see",
    priceLabel: "Price (USDC)",
    preview: "Live preview",
    list: "List for sale",
    listing: "Listing…",
    listed: "Listed — it's live now. Equip it from your owned skins.",
    listFailed: "Could not list",
    listConnectFirst: "Connect a wallet to list (you receive 70% here).",
    payoutHint: "You receive 70% • 30% buys & burns $WOC",
    patterns: {
      solid: "Solid",
      scales: "Scales",
      stripes: "Stripes",
