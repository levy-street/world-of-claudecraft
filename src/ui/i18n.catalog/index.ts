...
export const en = {
  ...
  marketplace: {
    title: 'Creator Skins',
    subtitle:
      'Player-made cosmetics, paid in USDC. 70% goes to the creator; 30% buys and burns $WOC.',
    ...
    designIntro:
      'Recolor and pattern a body — it renders the same for everyone, no files to upload.',
    modeDesign: 'Design',
    modeUpload: 'Upload',
    modeLink: 'Self-host',
    uploadIntro: 'Upload your own 1024x1024 PNG atlas. We pin it to IPFS and host it for you.',
    linkIntro:
      'Link a PNG atlas you host yourself. We proxy it, so buyers never see your URL. Free.',
