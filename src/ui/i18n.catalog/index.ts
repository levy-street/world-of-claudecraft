...
export const en = {
  ...
  entities: {
    ...
    items: {
      ...
      // Emberdeep Foundry
      warcamp_dispatch: { name: 'Emberpact Dispatch' },
      slag_heart: { name: 'Slag Heart' },
      emberpact_sigil: { name: 'Emberpact Sigil' },
      kilnborn_core: { name: "Ashmaw's Core" },
      forgehand_gauntlets: { name: 'Forgehand Gauntlets' },
      forgehand_handwraps: { name: 'Forgehand Handwraps' },
      forgehand_grips: { name: 'Forgehand Grips' },
      emberstep_warboots: { name: 'Emberstep Warboots' },
      emberstep_slippers: { name: 'Emberstep Slippers' },
      emberstep_treads: { name: 'Emberstep Treads' },
      slagrend_cleaver: { name: 'Slagrend Cleaver' },
      slagfire_scepter: { name: 'Slagfire Scepter' },
      slagglass_shiv: { name: 'Slagglass Shiv' },
      vorrs_kilnplates: { name: "Vorr's Kilnplates" },
      slagforged_legguards: { name: 'Slagforged Legguards' },
      forgelord_warhelm: { name: 'Forgelord Warhelm' },
      emberweave_cowl: { name: 'Emberweave Cowl' },
      slagstalker_hood: { name: 'Slagstalker Hood' },
      slag_chunk: { name: 'Slag Chunk' },
      ember_grit: { name: 'Ember Grit' },
      cult_brand: { name: 'Emberpact Brand' },
    },
