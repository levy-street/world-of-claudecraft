...
export const en = {
  ...
  // The in-game wallet panel (send / hire / jobs), opened from the bag balance
  // chip. Rendered through t() from the openWalletPanel closure in src/main.ts.
  walletPanel: {
    title: 'Wallet',
    closeAria: 'Close',
    ...
    sendNote:
      'Sent directly wallet-to-wallet on Solana. Non-custodial: the game never holds your funds. Network fees apply.',
    send: 'Send',
    sending: 'Sending…',
    ...
    destinationHint:
      'Destination ({x}, {z}), travel off, then have your guard bring you back here.',
    hireLogin: 'Enter a realm online to hire a player.',
    escrowNote:
      "The reward is locked in on-chain escrow and released to the helper automatically when the server confirms the goal, or refunded to you if it isn't met before the deadline.",
