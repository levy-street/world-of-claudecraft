...
export const en = {
  ...
  // Playable races of Valdris, four per faction (character creation screen).
  races: {
    ...
    // One passive racial trait per race (see src/sim/content/races.ts; the
    // numbers baked into the copy mirror RacialEffects there).
