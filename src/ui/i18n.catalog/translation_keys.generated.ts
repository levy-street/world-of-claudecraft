...
export type TranslationKeyFlat =
  ...
  | 'sim.rift.orbSealed'
  | 'sim.rift.orbWakes'
  | 'sim.rift.place.citadelPlan'
  | 'sim.rift.place.hoardEntrance'
  | 'sim.rift.place.hoardFloor'
  | 'sim.rift.place.hoardPlan'
  | 'sim.rift.place.infernalCitadel'
  | 'sim.rift.place.noun.abyssal'
  | 'sim.rift.place.noun.ash'
  | 'sim.rift.place.noun.blood'
  | 'sim.rift.place.noun.bone'
  | 'sim.rift.place.noun.bramble'
  | 'sim.rift.place.noun.brimstone'
  | 'sim.rift.place.noun.burrow'
  | 'sim.rift.place.noun.cinder'
  | 'sim.rift.place.noun.coffer'
  | 'sim.rift.place.noun.delve'
  | 'sim.rift.place.noun.drowned'
  | 'sim.rift.place.noun.dusk'
  | 'sim.rift.place.noun.echo'
  | 'sim.rift.place.noun.ember'
  | 'sim.rift.place.noun.frost'
  | 'sim.rift.place.noun.gale'
  | 'sim.rift.place.noun.gilt'
  | 'sim.rift.place.noun.glacier'
  | 'sim.rift.place.noun.grave'
  | 'sim.rift.place.noun.guano'
  | 'sim.rift.place.noun.hoarfrost'
  | 'sim.rift.place.noun.hollow'
  | 'sim.rift.place.noun.iron'
  | 'sim.rift.place.noun.loam'
  | 'sim.rift.place.noun.magma'
  | 'sim.rift.place.noun.marrow'
  | 'sim.rift.place.noun.mould'
  | 'sim.rift.place.noun.mycelium'
  | 'sim.rift.place.noun.ossuary'
  | 'sim.rift.place.noun.pactbound'
  | 'sim.rift.place.noun.pitfire'
  | 'sim.rift.place.noun.rime'
  | 'sim.rift.place.noun.roost'
  | 'sim.rift.place.noun.shadow'
  | 'sim.rift.place.noun.skull'
  | 'sim.rift.place.noun.spider'
  | 'sim.rift.place.noun.spore'
  | 'sim.rift.place.noun.storm'
  | 'sim.rift.place.noun.strongbox'
  | 'sim.rift.place.noun.sunken'
  | 'sim.rift.place.noun.tempest'
  | 'sim.rift.place.noun.thorn'
  | 'sim.rift.place.noun.thunder'
  | 'sim.rift.place.noun.tide'
  | 'sim.rift.place.noun.tithe'
  | 'sim.rift.place.noun.toadstool'
  | 'sim.rift.place.noun.tunnel'
  | 'sim.rift.place.noun.umbral'
  | 'sim.rift.place.noun.venom'
  | 'sim.rift.place.noun.void'
  | 'sim.rift.place.noun.war'
  | 'sim.rift.place.reachesFloor'
  | 'sim.rift.place.riftPlan'
  | 'sim.rift.place.sanctumFloor'
  | 'sim.rift.place.suffix.abyss'
  | 'sim.rift.place.suffix.depths'
  | 'sim.rift.place.suffix.descent'
  | 'sim.rift.place.suffix.hollow'
  | 'sim.rift.place.suffix.labyrinth'
  | 'sim.rift.place.suffix.rift'
  | 'sim.rift.place.suffix.sanctum'
  | 'sim.rift.place.suffix.warren'
  | 'sim.rift.place.theme.bone'
  | 'sim.rift.place.theme.brute'
  | 'sim.rift.place.theme.burrow'
  | 'sim.rift.place.theme.ember'
  | 'sim.rift.place.theme.frost'
  | 'sim.rift.place.theme.infernal'
  | 'sim.rift.place.theme.mimic'
  | 'sim.rift.place.theme.roost'
  | 'sim.rift.place.theme.spore'
  | 'sim.rift.place.theme.storm'
  | 'sim.rift.place.theme.tide'
  | 'sim.rift.place.theme.venom'
  | 'sim.rift.place.theme.void'
  | 'sim.rift.place.upgradedFloor'
  ...
  | 'sim.rift.yell.arcaneBigCast'
  | 'sim.rift.yell.arcaneDeathZoneCast'
  | 'sim.rift.yell.arcaneDeathZoneStrike'
  | 'sim.rift.yell.arcaneEngage'
  | 'sim.rift.yell.arcaneEnrage'
  | 'sim.rift.yell.batEngage'
  | 'sim.rift.yell.batSummon'
  | 'sim.rift.yell.bruteBigCast'
  | 'sim.rift.yell.bruteDeathZoneCast'
  | 'sim.rift.yell.bruteDeathZoneStrike'
  | 'sim.rift.yell.bruteEngage'
  | 'sim.rift.yell.bruteEnrage'
  | 'sim.rift.yell.emberBigCast'
  | 'sim.rift.yell.emberDeathZoneCast'
  | 'sim.rift.yell.emberDeathZoneStrike'
  | 'sim.rift.yell.emberEngage'
  | 'sim.rift.yell.emberEnrage'
  | 'sim.rift.yell.emberSummon'
  | 'sim.rift.yell.frostBigCast'
  | 'sim.rift.yell.frostDeathZoneCast'
  | 'sim.rift.yell.frostDeathZoneStrike'
  | 'sim.rift.yell.frostEngage'
  | 'sim.rift.yell.frostEnrage'
  | 'sim.rift.yell.mimicEngage'
  | 'sim.rift.yell.mimicSummon'
  | 'sim.rift.yell.moleEngage'
  | 'sim.rift.yell.moleSummon'
  | 'sim.rift.yell.mushroomEngage'
  | 'sim.rift.yell.mushroomSummon'
  | 'sim.rift.yell.necroBigCast'
  | 'sim.rift.yell.necroDeathZoneCast'
  | 'sim.rift.yell.necroDeathZoneStrike'
  | 'sim.rift.yell.necroEngage'
  | 'sim.rift.yell.necroSummon'
  | 'sim.rift.yell.pitlordBigCast'
  | 'sim.rift.yell.pitlordEngage'
  | 'sim.rift.yell.pitlordEnrage'
  | 'sim.rift.yell.ritualistBigCast'
  | 'sim.rift.yell.ritualistEngage'
  | 'sim.rift.yell.ritualistSummon'
  | 'sim.rift.yell.stormBigCast'
  | 'sim.rift.yell.stormDeathZoneCast'
  | 'sim.rift.yell.stormDeathZoneStrike'
  | 'sim.rift.yell.stormEngage'
  | 'sim.rift.yell.stormEnrage'
  | 'sim.rift.yell.tideDeathZoneCast'
  | 'sim.rift.yell.tideDeathZoneStrike'
  | 'sim.rift.yell.tideEngage'
  | 'sim.rift.yell.tideSummon'
  | 'sim.rift.yell.venomBigCast'
  | 'sim.rift.yell.venomDeathZoneCast'
  | 'sim.rift.yell.venomDeathZoneStrike'
  | 'sim.rift.yell.venomEngage'
  | 'sim.rift.yell.venomSummon'
  | 'skinEvent.close'
  | 'skinEvent.lockIn'
  | 'skinEvent.locked'
