...
export type TranslationKeyFlat =
  ...
  | 'entities.items.fenwright_grips.name'
  ...
  | 'entities.items.foremans_barrowmaul.name'
  | 'entities.items.foremans_wage_band.name'
  ...
  | 'entities.items.loomshard_eye.name'
  ...
  | 'entities.items.mirelight_locket.name'
  | 'entities.items.mirestone_stride.name'
  ...
  | 'entities.items.skerrits_shardpike.name'
  ...
  | 'entities.zones.mirefen_marsh.pois.9.label'
  ...
  | 'hudChrome.worldBoss.sleep'
  | 'hudChrome.worldBoss.spawn'
  | 'hudChrome.worldBoss.wake'
  | 'itemUi.bags.close'
