...
export type TranslationKeyFlat =
  ...
  | 'entities.itemSets.crownforged.bonus5'
  ...
  | 'entities.itemSets.nighttalon.bonus5'
  ...
  | 'entities.items.band_of_the_ninth_quench.name'
  ...
  | 'entities.items.crownforged_heartplate.name'
  ...
  | 'entities.items.footwraps_of_the_waking_floor.name'
  | 'entities.items.forest_pink_armor_plate.name'
  | 'entities.items.forgeheat_cinch.name'
  ...
  | 'entities.items.magmastrider_greaves.name'
  ...
  | 'entities.items.moltenheart_chroma.name'
  ...
  | 'entities.items.nighttalon_emberweave.name'
  ...
  | 'entities.items.soulflame_vestments.name'
  ...
  | 'entities.items.stormcallers_hauberk.name'
  ...
  | 'entities.items.the_last_restraint.name'
  ...
  | 'entities.items.volzharrs_knucklestone.name'
