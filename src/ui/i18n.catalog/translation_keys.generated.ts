...
export type TranslationKeyFlat =
  ...
  | 'entities.items.ashcoil_signet.name'
  ...
  | 'entities.items.bloodember_band.name'
  ...
  | 'entities.items.brand_of_the_first_flame.name'
  ...
  | 'entities.items.cinderhide_vest.name'
  ...
  | 'entities.items.emberforged_girdle.name'
  | 'entities.items.emberforged_hauberk.name'
  | 'entities.items.emberforged_legguards.name'
  | 'entities.items.emberforged_vambraces.name'
  | 'entities.items.emberglass_warstaff.name'
  | 'entities.items.emberseal_of_the_covenant.name'
  ...
  | 'entities.items.moltencore_maul.name'
