...
export const gameStrings = {
  ...
  talents: {
    ...
    choicesTab: "Choices", rowUnlockToast: "New talent choice available!",
...
export const gameStringsEs: typeof gameStrings = {
  ...
  talents: {
    title: "Talentos",
    classTab: "Clase",
    specTab: "Especialización", choicesTab: "Elecciones", rowUnlockToast: "¡Nueva elección de talento disponible!", rowUnlocks: "Se desbloquea al nivel {level}",
    ...
    unlockHint: "Hay elecciones de talento disponibles: presiona N para abrir Talentos.",
    copy: "Copiar",
    close: "Cerrar",
    cancel: "Cancelar",
    ...
    comingSoonBody: "Esta clase aún no tiene árboles de talentos. Puedes seguir jugando normalmente; los árboles completos llegarán en una actualización futura.", readout: { noTree: "Tu clase aún no tiene árbol de talentos.", locked: "Aún no has desbloqueado los talentos; comienzan en el nivel {level}.", noSpec: "sin especialización", rowsSummary: "Talentos: {head}, {picked}/{unlocked} filas de elección seleccionadas.", specLocked: " Las especializaciones se desbloquean en el nivel {level}.", summary: "Talentos: {head} — {spent}/{total} puntos gastados ({breakdown}).", breakdownClass: "Clase {classPts}", breakdownSpec: "Clase {classPts}, {spec} {specPts}", unspent: " {count} sin gastar." },
  },
};
...
export const gameStringsFrFR: typeof gameStrings = {
  ...
  talents: {
    title: "Talents",
    classTab: "Classe",
    specTab: "Spécialisation", choicesTab: "Choix", rowUnlockToast: "Nouveau choix de talent disponible !", rowUnlocks: "Se débloque au niveau {level}",
    available: "Disponibles",
    spent: "Dépensés",
...
export const gameStringsZhTW: typeof gameStrings = {
  ...
  talents: {
    title: "天賦",
    classTab: "職業",
    specTab: "專精", choicesTab: "抉擇", rowUnlockToast: "新的天賦抉擇已解鎖！", rowUnlocks: "在 {level} 級解鎖",
    available: "可用",
    spent: "已用",
    ...
    comingSoonBody: "此職業還沒有天賦樹。你可以繼續正常遊玩；完整天賦樹會在未來更新中到來。", readout: { noTree: "你的職業尚無天賦樹。", locked: "你尚未解鎖天賦，天賦將在 {level} 級開啟。", noSpec: "未選擇專精", rowsSummary: "天賦：{head}，已選擇 {picked}/{unlocked} 列選項。", specLocked: " 專精將在 {level} 級解鎖。", summary: "天賦：{head} — 已用 {spent}/{total} 點（{breakdown}）。", breakdownClass: "職業 {classPts}", breakdownSpec: "職業 {classPts}，{spec} {specPts}", unspent: " 剩餘 {count} 點未用。" },
  },
};
...
export const gameStringsPtBR: typeof gameStrings = {
  ...
  talents: {
    title: "Talentos",
    classTab: "Classe",
    specTab: "Especialização", choicesTab: "Escolhas", rowUnlockToast: "Nova escolha de talento disponível!", rowUnlocks: "Desbloqueia no nível {level}",
    ...
    comingSoonBody: "Esta classe ainda não tem árvores de talentos. Você pode continuar jogando normalmente; as árvores completas chegarão em uma atualização futura.", readout: { noTree: "Sua classe ainda não tem árvore de talentos.", locked: "Você ainda não desbloqueou os talentos; eles começam no nível {level}.", noSpec: "sem especialização", rowsSummary: "Talentos: {head}, {picked}/{unlocked} linhas de escolha selecionadas.", specLocked: " Especializações desbloqueiam no nível {level}.", summary: "Talentos: {head} — {spent}/{total} pontos gastos ({breakdown}).", breakdownClass: "Classe {classPts}", breakdownSpec: "Classe {classPts}, {spec} {specPts}", unspent: " {count} não gastos." },
  },
};
