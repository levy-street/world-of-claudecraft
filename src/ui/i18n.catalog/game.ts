...
export const gameStringsEs: typeof gameStrings = {
  ...
  talents: {
    title: "Talentos",
    classTab: "Clase",
    specTab: "Especialización", choicesTab: "Elecciones", rowUnlocks: "Se desbloquea al nivel {level}",
...
export const gameStringsFrFR: typeof gameStrings = {
  ...
  talents: {
    title: "Talents",
    classTab: "Classe",
    specTab: "Spécialisation", choicesTab: "Choix", rowUnlocks: "Se débloque au niveau {level}",
    available: "Disponibles",
    spent: "Dépensés",
...
export const gameStringsZhTW: typeof gameStrings = {
  ...
  talents: {
    title: "天賦",
    classTab: "職業",
    specTab: "專精", choicesTab: "抉擇", rowUnlocks: "在 {level} 級解鎖",
    available: "可用",
    spent: "已用",
...
export const gameStringsPtBR: typeof gameStrings = {
  ...
  talents: {
    title: "Talentos",
    classTab: "Classe",
    specTab: "Especialização", choicesTab: "Escolhas", rowUnlocks: "Desbloqueia no nível {level}",
