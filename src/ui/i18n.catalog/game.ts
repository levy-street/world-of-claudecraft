...
export const gameStringsEs: typeof gameStrings = {
  ...
  talents: {
    ...
    comingSoonBody: "Esta clase aún no tiene árboles de talentos. Puedes seguir jugando normalmente; los árboles completos llegarán en una actualización futura.", readout: { noTree: "Tu clase aún no tiene árbol de talentos.", locked: "Aún no has desbloqueado los talentos; comienzan en el nivel {level}.", noSpec: "sin especialización", rowsSummary: "Talents: {head}, {picked}/{unlocked} choice rows picked.", specLocked: " Specializations unlock at level {level}.", summary: "Talentos: {head} — {spent}/{total} puntos gastados ({breakdown}).", breakdownClass: "Clase {classPts}", breakdownSpec: "Clase {classPts}, {spec} {specPts}", unspent: " {count} sin gastar." },
  },
};
...
export const gameStringsZhTW: typeof gameStrings = {
  ...
  talents: {
    ...
    comingSoonBody: "此職業還沒有天賦樹。你可以繼續正常遊玩；完整天賦樹會在未來更新中到來。", readout: { noTree: "你的職業尚無天賦樹。", locked: "你尚未解鎖天賦，天賦將在 {level} 級開啟。", noSpec: "未選擇專精", rowsSummary: "Talents: {head}, {picked}/{unlocked} choice rows picked.", specLocked: " Specializations unlock at level {level}.", summary: "天賦：{head} — 已用 {spent}/{total} 點（{breakdown}）。", breakdownClass: "職業 {classPts}", breakdownSpec: "職業 {classPts}，{spec} {specPts}", unspent: " 剩餘 {count} 點未用。" },
  },
};
...
export const gameStringsPtBR: typeof gameStrings = {
  ...
  talents: {
    ...
    comingSoonBody: "Esta classe ainda não tem árvores de talentos. Você pode continuar jogando normalmente; as árvores completas chegarão em uma atualização futura.", readout: { noTree: "Sua classe ainda não tem árvore de talentos.", locked: "Você ainda não desbloqueou os talentos; eles começam no nível {level}.", noSpec: "sem especialização", rowsSummary: "Talents: {head}, {picked}/{unlocked} choice rows picked.", specLocked: " Specializations unlock at level {level}.", summary: "Talentos: {head} — {spent}/{total} pontos gastos ({breakdown}).", breakdownClass: "Classe {classPts}", breakdownSpec: "Classe {classPts}, {spec} {specPts}", unspent: " {count} não gastos." },
  },
};
