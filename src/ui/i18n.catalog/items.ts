...
const ITEM_ENTITY_IDS = [
  ...
  // Allied Faction World Quest rewards and toys
  'allied_hearthstone',
  ...
  // Treasure maps and the ink that redraws them (content/items.ts)
  'treasure_map_common',
  'treasure_map_rare',
  'treasure_map_epic',
  'treasure_map_legendary',
  'cartographers_ink',
  // Buried Hoard boss drops (content/hoard_loot.ts): 32 pieces, three tiers each.
...
const APPENDED_ITEM_NAMES: Partial<Record<ItemEntityId, string>> = {
  ...
  allied_hearthstone: 'Allied Hearthstone',
  allied_vanguard_duffel: 'Allied Vanguard Duffel',
  rift_feather_glider: 'Rift Feather Glider',
  formula_enchant_feet_shadowstride: 'Formula: Enchant Boots - Shadowstride',
  recipe_potion_of_invisibility: 'Recipe: Potion of Invisibility',
  potion_of_invisibility: 'Potion of Invisibility',
  pattern_reinforced_armor_kit: 'Pattern: Reinforced Armor Kit',
  reinforced_armor_kit: 'Reinforced Armor Kit',
  dawn_battle_standard: 'Dawn Battle Standard',
  formula_enchant_offhand_spirit: 'Formula: Enchant Off-Hand - Spirit',
  recipe_elixir_of_mana_regeneration: 'Recipe: Elixir of Mana Regeneration',
  elixir_of_mana_regeneration: 'Elixir of Mana Regeneration',
  clockwork_target_dummy: 'Clockwork Target Dummy',
  schematic_clockwork_shock_bomb: 'Schematic: Clockwork Shock Bomb',
  clockwork_shock_bomb: 'Clockwork Shock Bomb',
  plans_dense_sharpening_stone: 'Plans: Dense Sharpening Stone',
  dense_sharpening_stone: 'Dense Sharpening Stone',
  formula_enchant_gloves_forged_might: 'Formula: Enchant Gloves - Forged Might',
  // Treasure maps and the ink that redraws them (content/items.ts)
  treasure_map_common: 'Weathered Treasure Map',
  treasure_map_rare: 'Inked Treasure Map',
  treasure_map_epic: 'Gilded Treasure Map',
  treasure_map_legendary: 'Sovereign Treasure Map',
  cartographers_ink: "Cartographer's Ink",
  // Buried Hoard boss drops (content/hoard_loot.ts)
  collapsar_band_of_nyxaris: 'Collapsar Band of Nyxaris',
  rare_collapsar_band_of_nyxaris: 'Tarnished Collapsar Band of Nyxaris',
  legendary_collapsar_band_of_nyxaris: 'Sovereign Collapsar Band of Nyxaris',
  orb_collapsing_void: 'Orb of Collapsing Void',
  rare_orb_collapsing_void: 'Tarnished Orb of Collapsing Void',
  legendary_orb_collapsing_void: 'Sovereign Orb of Collapsing Void',
  cowl_of_event_horizon: 'Cowl of the Event Horizon',
  rare_cowl_of_event_horizon: 'Tarnished Cowl of the Event Horizon',
  legendary_cowl_of_event_horizon: 'Sovereign Cowl of the Event Horizon',
  mantle_of_singularity: 'Mantle of Singularity',
  rare_mantle_of_singularity: 'Tarnished Mantle of Singularity',
  legendary_mantle_of_singularity: 'Sovereign Mantle of Singularity',
  glacier_hewn_bulwark: 'Glacier-Hewn Bulwark',
  rare_glacier_hewn_bulwark: 'Tarnished Glacier-Hewn Bulwark',
  legendary_glacier_hewn_bulwark: 'Sovereign Glacier-Hewn Bulwark',
  permafrost_legguards: 'Permafrost Legguards',
  rare_permafrost_legguards: 'Tarnished Permafrost Legguards',
  legendary_permafrost_legguards: 'Sovereign Permafrost Legguards',
  frostbitten_rime_slippers: 'Frostbitten Rime Slippers',
  rare_frostbitten_rime_slippers: 'Tarnished Frostbitten Rime Slippers',
  legendary_frostbitten_rime_slippers: 'Sovereign Frostbitten Rime Slippers',
  rime_crusted_grips: 'Rime-Crusted Grips',
  rare_rime_crusted_grips: 'Tarnished Rime-Crusted Grips',
  legendary_rime_crusted_grips: 'Sovereign Rime-Crusted Grips',
  ember_wrought_crown: 'Ember-Wrought Crown',
  rare_ember_wrought_crown: 'Tarnished Ember-Wrought Crown',
  legendary_ember_wrought_crown: 'Sovereign Ember-Wrought Crown',
  cinder_stitched_robes: 'Cinder-Stitched Robes',
  rare_cinder_stitched_robes: 'Tarnished Cinder-Stitched Robes',
  legendary_cinder_stitched_robes: 'Sovereign Cinder-Stitched Robes',
  chained_ember_choker: 'Chained Ember Choker',
  rare_chained_ember_choker: 'Tarnished Chained Ember Choker',
  legendary_chained_ember_choker: 'Sovereign Chained Ember Choker',
  molten_clinker_girdle: 'Molten Clinker Girdle',
  rare_molten_clinker_girdle: 'Tarnished Molten Clinker Girdle',
  legendary_molten_clinker_girdle: 'Sovereign Molten Clinker Girdle',
  storm_tuned_buckler: 'Storm-Tuned Buckler',
  rare_storm_tuned_buckler: 'Tarnished Storm-Tuned Buckler',
  legendary_storm_tuned_buckler: 'Sovereign Storm-Tuned Buckler',
  hauberk_tempest_gale: 'Hauberk of the Tempest Gale',
  rare_hauberk_tempest_gale: 'Tarnished Hauberk of the Tempest Gale',
  legendary_hauberk_tempest_gale: 'Sovereign Hauberk of the Tempest Gale',
  gale_strider_boots: 'Gale-Strider Boots',
  rare_gale_strider_boots: 'Tarnished Gale-Strider Boots',
  legendary_gale_strider_boots: 'Sovereign Gale-Strider Boots',
  tempest_strike_grips: 'Tempest-Strike Grips',
  rare_tempest_strike_grips: 'Tarnished Tempest-Strike Grips',
  legendary_tempest_strike_grips: 'Sovereign Tempest-Strike Grips',
  breastplate_tectonic_might: 'Breastplate of Tectonic Might',
  rare_breastplate_tectonic_might: 'Tarnished Breastplate of Tectonic Might',
  legendary_breastplate_tectonic_might: 'Sovereign Breastplate of Tectonic Might',
  band_mountains_weight: "Band of the Mountain's Weight",
  rare_band_mountains_weight: "Tarnished Band of the Mountain's Weight",
  legendary_band_mountains_weight: "Sovereign Band of the Mountain's Weight",
  monolithic_shoulderguards: 'Monolithic Shoulderguards',
  rare_monolithic_shoulderguards: 'Tarnished Monolithic Shoulderguards',
  legendary_monolithic_shoulderguards: 'Sovereign Monolithic Shoulderguards',
  earthshaker_warboots: 'Earthshaker Warboots',
  rare_earthshaker_warboots: 'Tarnished Earthshaker Warboots',
  legendary_earthshaker_warboots: 'Sovereign Earthshaker Warboots',
  silkstalker_woven_vest: 'Woven Vest of the Silkstalker',
  rare_silkstalker_woven_vest: 'Tarnished Woven Vest of the Silkstalker',
  legendary_silkstalker_woven_vest: 'Sovereign Woven Vest of the Silkstalker',
  spun_venom_spaulders: 'Spun-Venom Spaulders',
  rare_spun_venom_spaulders: 'Tarnished Spun-Venom Spaulders',
  legendary_spun_venom_spaulders: 'Sovereign Spun-Venom Spaulders',
  broodmother_chitin_cowl: 'Chitin Cowl of the Broodmother',
  rare_broodmother_chitin_cowl: 'Tarnished Chitin Cowl of the Broodmother',
  legendary_broodmother_chitin_cowl: 'Sovereign Chitin Cowl of the Broodmother',
  venom_etched_waistcord: 'Venom-Etched Waistcord',
  rare_venom_etched_waistcord: 'Tarnished Venom-Etched Waistcord',
  legendary_venom_etched_waistcord: 'Sovereign Venom-Etched Waistcord',
  bone_studded_pauldrons: 'Bone-Studded Pauldrons',
  rare_bone_studded_pauldrons: 'Tarnished Bone-Studded Pauldrons',
  legendary_bone_studded_pauldrons: 'Sovereign Bone-Studded Pauldrons',
  legguards_of_the_ossuary: 'Legguards of the Ossuary',
  rare_legguards_of_the_ossuary: 'Tarnished Legguards of the Ossuary',
  legendary_legguards_of_the_ossuary: 'Sovereign Legguards of the Ossuary',
  seal_of_the_cryptwalker: 'Seal of the Cryptwalker',
  rare_seal_of_the_cryptwalker: 'Tarnished Seal of the Cryptwalker',
  legendary_seal_of_the_cryptwalker: 'Sovereign Seal of the Cryptwalker',
  ossuary_bone_crown: 'Ossuary Bone Crown',
  rare_ossuary_bone_crown: 'Tarnished Ossuary Bone Crown',
  legendary_ossuary_bone_crown: 'Sovereign Ossuary Bone Crown',
  chalice_of_living_tides: 'Chalice of the Living Tides',
  rare_chalice_of_living_tides: 'Tarnished Chalice of the Living Tides',
  legendary_chalice_of_living_tides: 'Sovereign Chalice of the Living Tides',
  pendant_continuous_flow: 'Pendant of Continuous Flow',
  rare_pendant_continuous_flow: 'Tarnished Pendant of Continuous Flow',
  legendary_pendant_continuous_flow: 'Sovereign Pendant of Continuous Flow',
  coral_encrusted_girdle: 'Coral-Encrusted Girdle',
  rare_coral_encrusted_girdle: 'Tarnished Coral-Encrusted Girdle',
  legendary_coral_encrusted_girdle: 'Sovereign Coral-Encrusted Girdle',
  riptide_handwraps: 'Riptide Handwraps',
  rare_riptide_handwraps: 'Tarnished Riptide Handwraps',
  legendary_riptide_handwraps: 'Sovereign Riptide Handwraps',
};
