...
const itemNamesEn = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      'Mirror Shard',
      'Ghostly Mirrorblade',
      'Ghostly Shroudmantle',
      'Ghostly Wraithjerkin',
      'Ghostly Palegrips',
      'Ghostly Hushboots',
      'Ghostly Glasscord',
      'Warden Sigil',
  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Cuerno Espiritual',
        'Capucha Negra',
        'Bebedizo del Sueño Profundo',
        'Esquirla de Espejo',
        'Espadaespejo Fantasmal',
        'Mantomortaja Fantasmal',
        'Coraza Espectral',
        'Guantes Pálidos Fantasmales',
        'Botas Silentes Fantasmales',
        'Cíngulo de Vidrio Fantasmal',
        'Sigilo del Guardián',
        'Lumen Ahogado',
      ]),
    },
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Corne spectrale',
        'Capuche noire',
        'Philtre de Rêve profond',
        'Éclat de Miroir',
        'Lame-miroir spectrale',
        'Manteceau spectral',
        'Justaucorps spectral',
        'Poignes blêmes spectrales',
        'Bottes feutrées spectrales',
        'Cordelière de verre spectrale',
        'Sceau du gardien',
        'Lumen noyé',
      ]),
    },
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Corno Spirituale',
        'Cappuccio Nero',
        'Intruglio del Sonno Profondo',
        'Scheggia di Specchio',
        'Spadaspecchio Spettrale',
        'Mantospoglia Spettrale',
        'Farsetto Spettrale',
        'Presa Pallida Spettrale',
        'Stivali Ovattati Spettrali',
        'Cordone di Vetro Spettrale',
  ...
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Tieftraum-Trank',
        'Spiegelsplitter',
        'Geisterhafte Spiegelklinge',
        'Geisterhafter Leichentuchmantel',
        'Geisterhaftes Wichtwams',
        'Geisterhafte Bleichgriffe',
        'Geisterhafte Stillstiefel',
        'Geisterhafte Glasschnur',
        'Wächtersigel',
        'Ertrunkenes Lumen',
      ]),
    },
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Chifre Espiritual',
        'Capuz Preto',
        'Beberagem do Sono Profundo',
        'Fragmento de Espelho',
        'Lâmina-espelho Fantasmal',
        'Mantomortalha Fantasmal',
        'Gibão Espectral',
        'Manoplas Pálidas Fantasmais',
        'Botas Silentes Fantasmais',
        'Cinta de Vidro Fantasmal',
        'Sigilo do Guardião',
        'Lúmen Afogado',
      ]),
    },
  ...
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Отвар глубокого сна',
        'Зеркальный осколок',
        'Призрачный зеркальный клинок',
        'Призрачная саванная мантия',
        'Призрачный колет',
        'Призрачные бледные хваты',
        'Призрачные тихие сапоги',
        'Призрачный стеклянный пояс',
        'Печать стража',
        'Утонувший люмен',
      ]),
    },
