...
const ITEM_ENTITY_IDS = [
  ...
  'bramblehide_jerkin',
  'monarch_crown_helm',
  // Mount Charters - one tradeable deed per Charter-eligible mount (tiers 1-10).
  'charter_ashmane',
  'charter_emberhoof',
  'charter_bronzeflank',
  'charter_silvermane',
...
const itemNamesEn = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      'Bramblehide Jerkin',
      "Monarch's Crown",
      // Mount Charters (tiers 1-10)
      'Charter: Ashmane Courser',
      'Charter: Emberhoof Charger',
      'Charter: Bronzeflank Destrier',
      'Charter: Silvermane Stallion',
      'Charter: Stormhoof Charger',
      'Charter: Goldcrest Skystrider',
      'Charter: Verdant Wildwing',
      'Charter: Voidwing Strider',
      'Charter: Celestial Seraph',
      "Charter: Worldbearer's Roc",
    ]),
  },
};
