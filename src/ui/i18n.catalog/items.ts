  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Barra de estaño',
        'Barra de bronce',
        'Guanteletes con broches de bronce',
        'Daga de espolón de garra',
        'Barra de hierro',
        'Barra de torio',
        'Hierba hoja de plata',
        'Hierba espinazarza',
        'Piel curtida basta',
        'Piel curtida firme',
        'Glándula de seda',
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Lingot d étain',
        'Lingot de bronze',
        'Gantelets à fermoir de bronze',
        'Dague à ergot',
        'Barre de fer',
        'Barre de thorium',
        'Herbe feuille argentée',
        'Herbe roncevigne',
        'Peau brute',
        'Peau ferme',
        'Glande à soie',
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Lingotto di stagno',
        'Lingotto di bronzo',
        'Guanti con fibbie di bronzo',
        'Pugnale a sperone',
        'Barra di ferro',
        'Barra di torio',
        'Erba foglia d argento',
        'Erba rovo spinoso',
        'Pelle grezza',
        'Pelle robusta',
        'Ghiandola di seta',
  ...
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Zinnbarren',
        'Bronzebarren',
        'Bronzeschließen-Panzerhandschuhe',
        'Klauensporn-Dolch',
        'Eisenbarren',
        'Thoriumbarren',
        'Silberblattkraut',
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Barra de estanho',
        'Barra de bronze',
        'Manoplas com fechos de bronze',
        'Adaga de espora de garra',
        'Barra de ferro',
        'Barra de tório',
        'Erva folha-prata',
        'Erva espinheira',
  ...
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Оловянный слиток',
        'Бронзовый слиток',
        'Латные рукавицы с бронзовыми застёжками',
        'Кинжал Когтевой шип',
        'Железный слиток',
        'Ториевый слиток',
        'Трава серебролист',
