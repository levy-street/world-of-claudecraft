...
/** Allocation-free steady-state cache for the HUD's localized resource warning. */
export class LowResourceViewCache {
  private resource = Number.NaN;
  private maxResource = Number.NaN;
  private resourceType: ResourceType | null | undefined;
  private i18nRevision = -1;
  private readonly view: LowResourceView = {
    active: false,
    opacity: 0,
    pulseSeconds: 0,
    label: '',
  ...
  resolve(
    ...
    return lowResourceViewInto(this.view, resource, maxResource, resourceType);
  }
}
