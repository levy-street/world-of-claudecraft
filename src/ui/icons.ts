...
const ABILITY_RECIPES: Record<string, IconRecipe> = {
  ...
  elemental_demand: r('storm', 'sky', ['roar', { p: 'lightning', ...BR }], ['arcs']),
  earth_shield: r('earth', 'earthBrown', ['shield', { p: 'gem', ...BR }], ['crack', 'glow']),
  unleash_weapon: r('storm', 'sky', ['sword', { p: 'sunburst', ...TR }], ['arcs', 'glow']),
