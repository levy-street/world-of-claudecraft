...
const ABILITY_RECIPES: Record<string, IconRecipe> = {
  ...
  felblade: r('shadow', 'leafGreen', [{ p: 'dagger', x: -8, s: 0.9, rot: -0.35 }, { p: 'bolt', x: 10, s: 0.72 }, { p: 'flame', ...BR }], ['motion', 'glow']),
  ...
  demon_ascendance: r('shadow', 'arcanePink', ['skull', { p: 'wing', ...BIG }], ['glow']),
  // rogue
...
const AURA_RECIPES: Record<string, IconRecipe> = {
  ...
  aura_buff_lifesteal: r('shadow', 'leafGreen', ['heart', { p: 'claw_slash', ...BR }], ['drips', 'glow']),
