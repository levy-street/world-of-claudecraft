...
const ITEM_RECIPES: Record<string, IconRecipe> = {
  ...
  sumpfkraut: r('nature', 'leafGreen', [{ p: 'tendrils', pal: 'leafGreen' }]),
  silver_leaf_tea: r('nature', 'leafGreen', ['leaf', { p: 'droplet', ...BR }]),
  campfire_flatbread: r('fire', 'ember', ['bread'], ['glow']),
  bogroot_paste: r('nature', 'venom', [{ p: 'tendrils', pal: 'venom' }], ['drips']),
  fenberry_muffin: r('food', 'gold', [{ p: 'bread', x: -6, s: 0.8 }, { p: 'gem', ...BR }], ['sparkle']),
  highland_spice_loaf: r('food', 'gold', ['bread'], ['glow']),
  crag_elk_ribs: r('food', 'ember', ['meat'], ['glow']),
  glacial_mint_tea: r('frost', 'ice', [{ p: 'potion', pal: 'ice' }], ['sparkle']),
...
const AURA_RECIPES: Record<string, IconRecipe> = {
  ...
  aura_buff_spi: r('nature', 'leafGreen', ['heart'], ['sparkle']),
  aura_buff_str: r('fury', 'gold', ['fist'], ['glow']),
  aura_buff_agi: r('storm', 'sky', ['lightning'], ['motion']),
  ...
  aura_buff_mana_regen: r('nature', 'leafGreen', ['leaf'], ['glow', 'sparkle']),
