...
const ITEM_RECIPES: Record<string, IconRecipe> = {
  ...
  crypt_refinement_shard: r('shadow', 'bone', ['gem', { p: 'sigil_rune', x: 0, y: 4, s: 0.45 }], ['sparkle']),
  bastion_ward_core: r('arcane', 'arcanePink', ['sigil_rune', { p: 'gem', x: 0, y: -4, s: 0.55 }], ['glow']),
  gravewyrm_ember: r('fire', 'gold', [{ p: 'flame', pal: 'gold' }, { p: 'gem', x: 0, y: -6, s: 0.4 }], ['glow', 'sparkle']),
