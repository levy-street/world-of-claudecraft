...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.rift_arcane_strike': 'Arkane Vernichtung',
  'abilityUi.cast.rift_brute_execution': 'Erdspalter',
  'abilityUi.cast.rift_brute_strike': 'Endgültiges Urteil',
  'abilityUi.cast.rift_ember_execution': 'Magmabrunnen',
  ...
  'abilityUi.cast.rift_tide_execution': 'Abgründiger Schlund',
  'abilityUi.cast.rift_tide_strike': 'Brechtiefe',
  ...
  'hud.combat.healOtherAbsorbed': 'Deine {ability} wird von der Seuche auf {target} verschlungen.',
  'hud.combat.healSelfAbsorbed':
    'Deine {Fähigkeit} wird durch die Seuche verschlungen, die auf dir lastet. {ability}',
  'hud.core.riftLabel': '{name}',
  'hud.core.riftLabelRanked': '{name} ({rank})',
  'entities.dungeons.the_last_keep.enterText':
    'Du betrittst die kalten, stillen Hallen der Letzten Festung.',
  'entities.dungeons.the_last_keep.leaveText':
    'Du ziehst die Tür des Bergfrieds zu und trittst zurück in den Wind der Drakelands.',
  'entities.dungeons.the_last_keep.name': 'Die letzte Festung',
  'entities.dungeons.wildheart_basin.enterText':
    'Warmer Regen zischt auf altem Stein. Das Wildheart Basin öffnet sich vor Ihnen.',
  'entities.dungeons.wildheart_basin.leaveText':
    'Du gehst unter den Steinzähnen zurück in die Sonne von Palmreach.',
  'entities.dungeons.wildheart_basin.name': 'Das Wildheart Basin',
  'entities.items.abyssal_loop.name': 'Abgrundschleife',
  'entities.items.abysswrought_band.name': 'Uebersetzt: Abysswrought Band',
  'entities.items.amberfall_sap_bucket.name': 'Sap-Tap Eimer',
  'entities.items.ashbone_war_brand.name': 'Ashbone-Kriegsmarke',
  'entities.items.aurora_mote.name': 'Aurora-Partikel',
  'entities.items.barrow_grave_offering.name': 'Verstreute Grabbeigaben',
  'entities.items.barrowshade_mantle.name': 'Barrowshade-Mantel',
  'entities.items.bonelord_mantle.name': 'Mantel des Knochenfürsten',
  'entities.items.breakscarred_steel.name': 'Bruchvernarbter Stahl',
  'entities.items.bridgemere_toll_chest.name': 'Versunkene Mauttruhe',
  'entities.items.broodmother_carapace.name': 'Brutmutterpanzer',
  'entities.items.canopy_silk_hank.name': 'Baldachin-Seidenhank',
  'entities.items.cinderwalk_treads.name': 'Cinderwalk-Treads',
  'entities.items.eelskin_mudwaders.name': 'Aalleder-Schlammstiefel',
  'entities.items.emberforge_gauntlets.name': 'Emberforge-Stulpen',
  'entities.items.emberforged_bulwark.name': 'Glutgeschmiedetes Bollwerk',
  'entities.items.emberwing_scale.name': 'Glutflügelschuppe',
  'entities.items.evergarden_bloom_clipping.name': 'Beschnittener Blütenausschnitt',
  'entities.items.evergarden_statue_rubbing.name': 'Statuenreiben',
  'entities.items.farshore_salt_moss.name': 'Farshore-Salzmoos',
  'entities.items.fenway_mooring_line.name': 'Festmacherleine durchtrennen',
  'entities.items.fountain_court_mantle.name': 'Mantel des Fountain Court',
  'entities.items.frostmane_mantle.name': 'Mantel der Frostmähne',
  'entities.items.galecrest_ram_wool.name': 'Fettige Widderwolle',
  'entities.items.gallowmere_grave_candle.name': 'Grabkerze',
  'entities.items.gilded_sap_clot.name': 'Vergoldetes Saftgerinnsel',
  'entities.items.gloamfield_nightbloom.name': 'Nachtblütenblüte',
  'entities.items.graskbreaker_girdle.name': 'Graskbreaker-Gürtel',
  'entities.items.gravebound_silk_wraps.name': 'Grabgebundene Seidentücher',
  'entities.items.gullhaven_watchbell.name': 'Küstenwachtglocke',
  'entities.items.heart_of_the_rift.name': 'Herz des Risses',
  'entities.items.hearth_ember_cache.name': 'Glut-Cache',
  'entities.items.hearthlined_treads.name': 'Mit Feuerstellen ausgekleidete Stufen',
  'entities.items.hedgewick_shears.name': 'Gestohlene Heckenschere',
  'entities.items.hedgewick_tool_cart.name': 'Verschütteter Werkzeugwagen',
  'entities.items.hoarfrost_edge.name': 'Raureifkante',
  'entities.items.last_keep_signet.name': 'Siegel der letzten Festung',
  'entities.items.lilybed_mantle.name': 'Mantel des Lilienbetts',
  'entities.items.mantle_of_the_meredark.name': 'Mantel des Meredark',
  'entities.items.mantle_of_the_unbroken_shore.name': 'Mantel der ungebrochenen Küste',
  'entities.items.mantle_of_the_unhorsed.name': 'Mantel des Unpferden',
  'entities.items.mawscale_pauldrons.name': 'Schulterstücke der Schlundschuppen',
  'entities.items.mere_ferry_lantern.name': 'Fährenlaterne',
  'entities.items.moonfleece_mitts.name': 'Moonfleece-Handschuhe',
  'entities.items.moonfleece_tuft.name': 'Moonfleece Büschel',
  'entities.items.orchard_sapbinder_grips.name': 'Sapbinder-Griffe',
  'entities.items.pactbound_vestments.name': 'Paktgebundene Gewänder',
  'entities.items.pearlwake_cargo_crate.name': 'Pearlwake-Frachtkiste',
  'entities.items.pitlords_cleaver.name': 'Beil des Grubenlords',
  'entities.items.plump_fen_eel.name': 'Praller Mooraal',
  'entities.items.riding_training.name': 'Reittraining',
  'entities.items.rift_essence.name': 'Rissessenz',
  'entities.items.rift_gem_azure.name': 'Azure Rift-Juwel',
  'entities.items.rift_gem_crimson.name': 'Crimson Rift-Juwel',
  'entities.items.rift_gem_verdant.name': 'Grüner Rift-Juwel',
  'entities.items.riftbound_band_of_guile.name': 'Rissgebundenes Band der List',
  'entities.items.riftbound_band_of_insight.name': 'Rissgebundenes Band der Einsicht',
  'entities.items.riftbound_band_of_might.name': 'Rissgebundenes Band der Macht',
  'entities.items.saltforged_grips.name': 'Salzgeschmiedete Griffe',
  'entities.items.saltwalker_sandals.name': 'Saltwalker Sandalen',
  'entities.items.scorched_supply_crate.name': 'Verbrannte Vorratskiste',
  'entities.items.shear_storm_lantern.name': 'Übergossene Sturmlaterne',
  'entities.items.shearkeeper_gloves.name': 'Scherenhandschuhe',
  'entities.items.silkbound_remains.name': 'Seidengebundene Überreste',
  'entities.items.sprung_trap.name': 'Gesprungene Fen-Falle',
  'entities.items.stormscale_treads.name': 'Sturmschuppenstufen',
  'entities.items.stormsunder_hood.name': 'Uebersetzt: Stormsunder Hood',
  'entities.items.sunken_idol_mantle.name': 'Mantel des versunkenen Idols',
  'entities.items.sunken_offering_bowl.name': 'Nachgefüllte Opferschale',
  'entities.items.thick_winter_pelt.name': 'Dickes Winterfell',
  'entities.items.vigil_star_chart.name': 'Vigil-Sternenkarte',
  'entities.items.voidscar_handwraps.name': 'Voidscar-Handwickel',
  'entities.items.voidsong_dirk.name': 'Voidsong, Dolch vom Zerrissenen Schleier',
  'entities.items.voidweave_mantle.name': 'Leerengewebter Mantel',
  'entities.items.wickspun_treads.name': 'Dochtgesponnene Laufflächen',
  'entities.items.widowsilk_skein.name': 'Witwenseidenstrang',
  'entities.items.wildheart_fangknife.name': 'Fangmesser von Zulgar',
  'entities.items.wildheart_hexwood_staff.name': 'Hexwood-Stab des Beckens',
  'entities.items.wildheart_tuskblade.name': 'Wildherz-Stoßzahnklinge',
  'entities.items.wisplight_globe.name': 'Irrlicht-Globus',
  'entities.items.wreck_wardens_mantle.name': 'Mantel des Wrackwächters',
  'entities.items.wreckfield_flotsam_crate.name': 'Treibgutkiste',
  'entities.items.wyrmwatch_warning_banner.name': 'Wyrmwatch-Warnbanner',
  'entities.mobs.ancient_guardian.name': 'Alter Wächter',
  'entities.mobs.apprentice_wren.name': 'Lehrling Wren',
  'entities.mobs.ashbone_raider.name': 'Uebersetzt: Ashbone Raider',
  'entities.mobs.ashbone_warcaller.name': 'Aschenknochen-Kriegsrufer',
  'entities.mobs.aurelhorn.name': 'Aurelhorn, Erster der Herde',
  'entities.mobs.barrow_king.name': 'Der Barrow King',
  'entities.mobs.barrow_wight.name': 'Uebersetzt: Barrow Wight',
  'entities.mobs.bogtoad.name': 'Sumpfkröte',
  'entities.mobs.breach_wretch.name': 'Uebersetzt: Breach Wretch',
  'entities.mobs.canopy_weaver.name': 'Baldachinweber',
  'entities.mobs.castaway_navigator.name': 'Uebersetzt: Navigator Suli',
  'entities.mobs.cindraleth_maw_matriarch.name': 'Cindraleth die Maw-Matriarchin',
  'entities.mobs.corrupted_sporeling.name': 'Verderbter Sporeling',
  'entities.mobs.downs_bandit.name': 'Uebersetzt: Downs Bandit',
  'entities.mobs.drowned_deckhand.name': 'Ertrunkener Decksmann',
  'entities.mobs.drowsy_croaker.name': 'Der schläfrige Croaker',
  'entities.mobs.dune_troll.name': 'Dünentroll',
  'entities.mobs.duskwisp.name': 'Dämmerungswisp',
  'entities.mobs.emberwing_drake.name': 'Glutschwingender Drache',
  'entities.mobs.fen_sprite.name': 'Fenn-Sprite',
  'entities.mobs.fisher_bram.name': 'Uebersetzt: Fisher Bram',
  'entities.mobs.frostmane_yeti.name': 'Frostmähnen-Yeti',
  'entities.mobs.gale_wisp.name': 'Uebersetzt: Gale Wisp',
  'entities.mobs.gilded_stag.name': 'Vergoldeter Hirsch',
  'entities.mobs.gleamstag.name': 'Der Gleamstag',
  'entities.mobs.glimmerwisp.name': 'Uebersetzt: Glimmerwisp',
  'entities.mobs.gloam_fox.name': 'Uebersetzt: Gloam Fox',
  'entities.mobs.gloam_strider.name': 'Uebersetzt: Gloam Strider',
  'entities.mobs.gravedigger_mosley.name': 'Totengräber Mosley',
  'entities.mobs.gravenbark_shambler.name': 'Uebersetzt: Gravenbark Shambler',
  'entities.mobs.harvest_sprite.name': 'Ernte-Sprite',
  'entities.mobs.hedge_gnome.name': 'Heckenzwerg',
  'entities.mobs.hedge_knight.name': 'Dawnhold-Ritter',
  'entities.mobs.ice_wisp.name': 'Eisfetzen',
  'entities.mobs.idol_guardian.name': 'Der Idol-Wächter',
  'entities.mobs.lily_wisp.name': 'Uebersetzt: Lily Wisp',
  'entities.mobs.mere_lurker.name': 'Bloßer Lurker',
  'entities.mobs.moonfleece_grazer.name': 'Uebersetzt: Moonfleece Grazer',
  'entities.mobs.moor_ram.name': 'Moorbock',
  'entities.mobs.mushroom_pixie.name': 'Uebersetzt: Gleamfolk Pixie',
  'entities.mobs.nightkin_stargazer.name': 'Nachtkin-Sterngucker',
  'entities.mobs.old_marrowshell.name': 'Alte Markschale',
  'entities.mobs.orchard_treant.name': 'Obstgarten Treant',
  'entities.mobs.pale_huntsman.name': 'Der blasse Jäger',
  'entities.mobs.rift_boneclad.name': 'Knochenbekleideter Krieger',
  'entities.mobs.rift_bonewalker.name': 'Auferstandener Knochenwandler',
  'entities.mobs.rift_boss_arcane.name': 'Uebersetzt: Archon Nyxaris',
  'entities.mobs.rift_boss_brute.name': 'Kriegsherr Grask',
  'entities.mobs.rift_boss_ember.name': 'Glutschmiede-Tyrann',
  'entities.mobs.rift_boss_frost.name': 'Raureifwächter',
  'entities.mobs.rift_boss_necro.name': 'Knochenlord Xarreth',
  'entities.mobs.rift_boss_pitlord.name': 'Azgorath, Herr der Grube',
  'entities.mobs.rift_boss_ritualist.name': "Magus Vel'Kor der Paktgebundene",
  'entities.mobs.rift_boss_storm.name': 'Sturm Vharok',
  'entities.mobs.rift_boss_tide.name': 'Abgründiger Schlund',
  'entities.mobs.rift_boss_venom.name': 'Brutmutter Vysska',
  'entities.mobs.rift_deep_lurker.name': 'Tiefer Schleicher',
  'entities.mobs.rift_dread_stalker.name': 'Schreckenspirscher',
  'entities.mobs.rift_ember_fiend.name': 'Glutteufel',
  'entities.mobs.rift_frost_revenant.name': 'Frostgebundener Wiedergänger',
  'entities.mobs.rift_hellguard.name': 'Höllenwächter',
  'entities.mobs.rift_magma_brute.name': 'Uebersetzt: Magma Brute',
  'entities.mobs.rift_marrow_troll.name': 'Mark-Troll',
  'entities.mobs.rift_pact_acolyte.name': 'Pakt-Akolyth',
  'entities.mobs.rift_rime_elemental.name': 'Rime Elementar',
  'entities.mobs.rift_spawnling.name': 'Uebersetzt: Rift Spawnling',
  'entities.mobs.rift_stone_ogre.name': 'Steinoger',
  'entities.mobs.rift_storm_caller.name': 'Sturmrufer',
  'entities.mobs.rift_stormscale.name': 'Sturmschuppendrache',
  'entities.mobs.rift_thornback.name': 'Dornenrückenpirscher',
  'entities.mobs.rift_tide_thrall.name': 'Gezeiten-Thrall',
  'entities.mobs.rift_venom_weaver.name': 'Giftweber',
  'entities.mobs.rift_void_acolyte.name': 'Akolyth der Leerennarbe',
  'entities.mobs.riftspawn.name': 'Uebersetzt: Riftspawn',
  'entities.mobs.rime_elemental.name': 'Rime Elementar',
  'entities.mobs.shoal_scuttler.name': 'Uebersetzt: Shoal Scuttler',
  'entities.mobs.snowdrift_wolf.name': 'Schneewehenwolf',
  'entities.mobs.sporeling_gatherer.name': 'Sporenlingssammler',
  'entities.mobs.sundered_horror.name': 'Der entzweite Horror',
  'entities.mobs.terrace_howler.name': 'Terrassenheuler',
  'entities.mobs.the_meredark.name': 'Der Meredark',
  'entities.mobs.the_topiary_bull.name': 'Der Topiary Bull',
  'entities.mobs.the_wreck_warden.name': 'Der Wrackwächter',
  'entities.mobs.thicket_boar.name': 'Dickichtschwein',
  'entities.mobs.tide_scuttler.name': 'Gezeitenschiffer',
  'entities.mobs.topiary_stag.name': 'Topiary Hirsch',
  'entities.mobs.topiary_wolf.name': 'Uebersetzt: Topiary Wolf',
  'entities.mobs.treant_elder.name': 'Uebersetzt: Treant Elder',
  'entities.mobs.veiled_doe.name': 'Verschleiertes Reh',
  ...
  'entities.mobs.widowsilk_spinner.name': 'Witwenseidenspinnerin',
  'entities.mobs.wildheart_beastmaster.name': 'Fanglord Bestienmeister',
  'entities.mobs.wildheart_hexcaller.name': 'Sonnenknochen-Hexrufer',
  'entities.mobs.wildheart_high_priest.name': 'Zulgar, Stimme des Beckens',
  'entities.mobs.wildheart_ravager.name': 'Blutmähnenverwüster',
  'entities.mobs.wildheart_stalker.name': 'Rankenklauenpirscher',
  'entities.mobs.willow_sprite.name': 'Uebersetzt: Willow Sprite',
  'entities.mobs.wood_wraith.name': 'Holzgeist',
  'entities.mobs.wreck_thief.name': 'Wreckfield-Dieb',
  'entities.npcs.archivist_tullo.greeting':
    'Die Denkmäler da draußen haben seit Ewigkeiten mit niemandem gesprochen. Vielleicht warteten sie auf neue Ohren.',
  ...
  'entities.npcs.astronomer_cassian.greeting':
    'Schweigen Sie jetzt. Der Himmel dämmert hier nie, also hört er auch nie auf zu reden.',
  'entities.npcs.astronomer_cassian.name': 'Astronom Cassian',
  'entities.npcs.astronomer_cassian.title': 'Wächter bei der Mahnwache',
  'entities.npcs.aurorist_veyla.greeting':
    'Still. Die Lichter sprechen heute Abend, und sie wiederholen sich nicht.',
  'entities.npcs.aurorist_veyla.name': 'Auroristin Veyla',
  'entities.npcs.aurorist_veyla.title': 'Leser der Lichter',
  'entities.npcs.bellkeeper_tam.greeting':
    'Die Glocke ist die einzige Warnung, die uns die Pausen geben, {className}. Eine Maut für die Felder, zwei für die Klippen, drei, wenn es nah genug ist, dass Laufen nicht hilft. Behalten Sie es im Auge, vielleicht hält es Sie gesund.',
  'entities.npcs.bellkeeper_tam.name': 'Glockenwart Tam',
  'entities.npcs.bellkeeper_tam.title': 'Wachglockenwächter',
  'entities.npcs.bridgewright_alden.greeting':
    'Jedes Brett in dieser Stadt gehört mir und das Moor nagt an allen.',
  'entities.npcs.bridgewright_alden.name': 'Uebersetzt: Bridgewright Alden',
  'entities.npcs.bridgewright_alden.title': 'Meister des Fenway',
  'entities.npcs.ferrymaster_caddow.greeting':
    'Auf dem Mere liegt wieder Nebel. Wenn die Laternen auf dem Wasser ausgehen, bleiben weise Leute an Land.',
  ...
  'entities.npcs.fisher_nell.greeting':
    'Es öffnete sich genau dort, wo die Netze trocknen. Genau dort, wo ich jeden Morgen meines Lebens stand. Ich gehe nicht mehr ans Ufer. Ich gehe kaum noch irgendwo hin.',
  'entities.npcs.fisher_nell.name': 'Verängstigte Nell',
  'entities.npcs.fisher_nell.title': 'Uebersetzt: Gullhaven Fisher',
  'entities.npcs.gardener_yew.greeting':
    'Geben Sie mir bitte den Karren, ja? Diese Rasenflächen gehen nicht von selbst, was auch immer der Weiler denkt.',
  'entities.npcs.gardener_yew.name': 'Gärtnereibe',
  'entities.npcs.gardener_yew.title': 'Der letzte Gärtner',
  'entities.npcs.gatecaptain_brannoc.greeting':
    'Wyrmwatch hält das Tor. Hat es vierzig Jahre lang gehalten. Es wird es heute Abend halten.',
  'entities.npcs.gatecaptain_brannoc.name': 'Uebersetzt: Gatecaptain Brannoc',
  'entities.npcs.gatecaptain_brannoc.title': 'Kommandant von Wyrmwatch',
  'entities.npcs.gatewarden_pell.greeting':
    'Achten Sie darauf, wie Sie sich auf dem Rasen bewegen. Im Garten werden sie gepflegt, und er mag es, wenn sie aufgeräumt sind.',
  'entities.npcs.gatewarden_pell.name': 'Torwart Pell',
  'entities.npcs.gatewarden_pell.title': 'Hüter des Gartentors',
  'entities.npcs.harbormaster_odile.greeting':
    'Jedes Boot in dieser Bucht verdankt dem Old Beacon seinen Kiel. Sprich schnell, die Flut wird nicht warten.',
  'entities.npcs.harbormaster_odile.name': 'Hafenmeisterin Odile',
  'entities.npcs.harbormaster_odile.title': 'Hafenmeister von Wickharbor',
  'entities.npcs.head_gardener_amaranth.greeting':
    'Die Schatten unter meinen Augen machen mir nichts aus. Jemand muss wach bleiben, während der Garten träumt.',
  'entities.npcs.head_gardener_amaranth.name': 'Chefgärtner Amaranth',
  'entities.npcs.head_gardener_amaranth.title': 'Obergärtner des Evergarden',
  'entities.npcs.hearthkeeper_maeve.greeting':
    'Komm raus aus der Kälte. Das Feuer in der Hütte erlischt nie, solange ich atme.',
  'entities.npcs.hearthkeeper_maeve.name': 'Herdwächterin Maeve',
  'entities.npcs.hearthkeeper_maeve.title': 'Hüter der Hearth-Lodge',
  'entities.npcs.hermit_okku.greeting':
    'Jetzt ist es ruhig. Die Trommeln zählen alles, was unter den Bäumen läuft, und dich haben sie bereits gezählt.',
  'entities.npcs.hermit_okku.name': 'Uebersetzt: Okku',
  'entities.npcs.hermit_okku.title': 'Der Mann, der hineinging',
  'entities.npcs.huntsman_deral.greeting':
    'Jetzt ist es ruhig. Die Herde kennt jedes Geräusch, das dieses Tal macht, und ich auch.',
  'entities.npcs.huntsman_deral.name': 'Jäger Deral',
  'entities.npcs.huntsman_deral.title': 'Hüter der Herden',
  'entities.npcs.keeper_bram.greeting':
    'Neununddreißig Jahre hat diese Lampe unter meiner Aufsicht gebrannt. Bei Ihnen wird es nicht dunkel.',
  ...
  'entities.npcs.keeper_saelwyn.greeting':
    'Nur wenige Ihrer Art haben unter diesen Zweigen gestanden, {className}. Gehen Sie sanft und seien Sie willkommen.',
  'entities.npcs.keeper_saelwyn.name': 'Hüter Saelwyn',
  'entities.npcs.keeper_saelwyn.title': 'Hüter des Hollows',
  'entities.npcs.lamplighter_sorrel.greeting':
    'Pass auf die Lampen auf, Freund. Hinter diesem Tor gibt die Sonne auf und die Blumen übernehmen die Oberhand.',
  'entities.npcs.lamplighter_sorrel.name': 'Lampenanzünder Sauerampfer',
  'entities.npcs.lamplighter_sorrel.title': 'Hüter des Nachttors',
  'entities.npcs.lampman_cobb.greeting':
    'Bleib im Lampenlicht, Freund. Der Wald zählt jeden, der das Tor passiert.',
  'entities.npcs.lampman_cobb.name': 'Uebersetzt: Lampman Cobb',
  'entities.npcs.lampman_cobb.title': 'Hüter der Crowgate-Laternen',
  'entities.npcs.lira_dewsong.greeting':
    'Willkommen in Moonrest, wo die Blumen für uns die Morgendämmerung bewirken.',
  'entities.npcs.lira_dewsong.name': 'Uebersetzt: Lira Dewsong',
  'entities.npcs.lira_dewsong.title': 'Nachtgärtner von Mondruh',
  'entities.npcs.loremother_bryn.greeting':
    'Jedes Licht in diesem Tal erinnert sich an etwas, {playerName}. Hilf mir zuzuhören.',
  'entities.npcs.loremother_bryn.name': 'Uebersetzt: Loremother Bryn',
  'entities.npcs.loremother_bryn.title': 'Stimme des Schreins',
  'entities.npcs.mender_saul.greeting':
    'Ich habe in diesem einen Monat mehr Knochen gesetzt als in zehn Jahren, in denen ich Angelstürze repariert habe. Die Pausen lassen nicht viel von dem übrig, was sie mitnehmen. Komm ganz zu mir zurück, wenn du es schaffst.',
  'entities.npcs.mender_saul.name': 'Uebersetzt: Mender Saul',
  'entities.npcs.mender_saul.title': 'Feldchirurg',
  'entities.npcs.mother_sedge.greeting':
    'Die Weiden sagten mir, dass du kommst, bevor deine Stiefel die Brücke verließen.',
  'entities.npcs.mother_sedge.name': 'Mutter Segge',
  'entities.npcs.mother_sedge.title': 'Moorhexe von Willowweep',
  'entities.npcs.netter_maris.greeting':
    'Riechen Sie das? Geräucherter Aal. Die halbe Stadt steht auf Stelzen, die ich damit gekauft habe.',
  'entities.npcs.netter_maris.name': 'Uebersetzt: Netter Maris',
  'entities.npcs.netter_maris.title': 'Aalnetzter von Bridgemere',
  'entities.npcs.orchardist_pomeline.greeting':
    'Achten Sie darauf, wohin Sie treten. Jede Wurzel in diesen Reihen ist älter als die Stadt, und sie erinnern sich.',
  'entities.npcs.orchardist_pomeline.name': 'Obstgärtner Pomeline',
  'entities.npcs.orchardist_pomeline.title': 'Hüter der vergoldeten Reihen',
  'entities.npcs.pearlmother_isha.greeting':
    'Das Meer gibt, der Sand hält und der Dschungel nimmt. Bleib am Strand, Fremder.',
  'entities.npcs.pearlmother_isha.name': 'Perlenmutter Isha',
  'entities.npcs.pearlmother_isha.title': 'Ältester der Taucher',
  'entities.npcs.provisioner_fenna.greeting':
    'Brot noch warm, Wasser noch süß. The Hollow sorgt dafür, und ich auch.',
  'entities.npcs.provisioner_fenna.name': 'Versorger Fenna',
  'entities.npcs.provisioner_fenna.title': 'Eldergleam-Versorger',
  'entities.npcs.quartermaster_edda.greeting':
    'Stahl und Salz, {className}, das ist alles, was ich noch verteilen kann. Nehmen Sie es und lassen Sie die Pausen bereuen, die ich geöffnet habe, wo ich sie erreichen könnte.',
  'entities.npcs.quartermaster_edda.name': 'Quartiermeister Edda',
  'entities.npcs.quartermaster_edda.title': 'Redoubt-Waffenschmied',
  'entities.npcs.quartermaster_sela.greeting':
    'Jede Kiste in diesem Hof hat vierzig Meilen Asche überquert, um hierher zu gelangen. Behandle sie freundlich.',
  'entities.npcs.quartermaster_sela.name': 'Quartiermeister Sela',
  'entities.npcs.quartermaster_sela.title': 'Hüter der Garnisonsläden',
  'entities.npcs.reeve_ottoline.greeting':
    'Willkommen in Lanternmere, wo die Ernte nie endet und die Arbeit auch nicht endet.',
  'entities.npcs.reeve_ottoline.name': 'Uebersetzt: Reeve Ottoline',
  'entities.npcs.reeve_ottoline.title': 'Reeve von Lanternmere',
  'entities.npcs.riftwatch_ollun.greeting':
    'Jede Pause singt, bevor sie sich öffnet, wenn man das Ohr dafür hat. Ich kann gerade hören, wie sich drei von ihnen auf der Insel bewegen, und einer von ihnen ist ganz in der Nähe.',
  'entities.npcs.riftwatch_ollun.name': 'Uebersetzt: Riftwatch Ollun',
  'entities.npcs.riftwatch_ollun.title': 'Breach-Gelehrter',
  'entities.npcs.salvage_boss_ryna.greeting':
    'Ein {className} mit funktionierenden Waffen, gut. Die Wracklinie zahlt sich gut aus, wenn die Krabben einem genug Finger lassen, um sie zu zählen.',
  'entities.npcs.salvage_boss_ryna.name': 'Bergungsboss Ryna',
  'entities.npcs.salvage_boss_ryna.title': 'Herrin der Wracklinie',
  'entities.npcs.salvager_edda.greeting':
    'Wrackholz, Seile und die Ladung toter Männer. Das Meer zahlt meinen Lohn, wenn der Aufseher es zulässt.',
  'entities.npcs.salvager_edda.name': 'Bergungshelfer Edda',
  'entities.npcs.salvager_edda.title': 'Uebersetzt: Wreckfield Salvager',
  'entities.npcs.scout_einna.greeting':
    'Du bist lebend über den Pass gegangen. Gut. Icemantle sollte davon erfahren.',
  'entities.npcs.scout_einna.name': 'Kundschafterin Einna',
  'entities.npcs.scout_einna.title': 'Uebersetzt: Snowline Scout',
  'entities.npcs.scout_yerrin.greeting':
    'Halten Sie sich zurück. Geräusche werden auf seltsame Weise vom Glas übertragen, und das Tor darunter hat Ohren.',
  'entities.npcs.scout_yerrin.name': 'Späher Yerrin',
  'entities.npcs.scout_yerrin.title': 'Ferndünenwächter',
  'entities.npcs.sexton_marrow.greeting':
    'Wir begraben sie hier tief und läuten die Glocken, damit sie daran denken, unten zu bleiben.',
  'entities.npcs.sexton_marrow.name': 'Küstermark',
  'entities.npcs.sexton_marrow.title': 'Küster von Gallowmere',
  'entities.npcs.strandwatcher_pell.greeting':
    'Endlich raus aus den schwarzen Bäumen. Atme, Fremder, die Sonne hält diese Seite des Passes.',
  'entities.npcs.strandwatcher_pell.name': 'Strandwächter Pell',
  'entities.npcs.strandwatcher_pell.title': 'Wächter des Tanglemouth',
  'entities.npcs.trapper_brosk.greeting':
    'Fen hat diese Woche drei meiner Zeilen übernommen. Fen hat in den letzten zwanzig Jahren nie eine Linie betreten.',
  'entities.npcs.trapper_brosk.name': 'Uebersetzt: Trapper Brosk',
  'entities.npcs.trapper_brosk.title': 'Shiverfen-Fänger',
  'entities.npcs.vicar_creel.greeting':
    'Die Kapelle ist vor Jahren eingestürzt. Die Toten darunter bemerkten es nicht, und so blieb ich.',
  'entities.npcs.vicar_creel.name': 'Pfarrer Creel',
  'entities.npcs.vicar_creel.title': 'Letzter Pfarrer des Trauersteins',
  'entities.npcs.warden_coalfast.greeting':
    'Den Pausen ist es egal, dass Gullhaven klein ist, {className}. Wir halten dieses Ufer, oder es gibt kein Ufer mehr, das wir halten können. Steh uns bei und ich werde es nicht vergessen.',
  'entities.npcs.warden_coalfast.name': 'Wächter Coalfast',
  'entities.npcs.warden_coalfast.title': 'Redoutenkommandant',
  'entities.npcs.warden_kaldra.greeting':
    'Pass auf die Bänke auf, Fremder. Der Schnee behält, was er braucht.',
  'entities.npcs.warden_kaldra.name': 'Aufseherin Kaldra',
  'entities.npcs.warden_kaldra.title': 'Wächter von Icemantle',
  'entities.npcs.wardsmith_orun.greeting':
    'Diese Schmieden erkalten vor Jahrhunderten, {className}, aber ihre Arbeit ist immer noch von Vorteil.',
  'entities.npcs.wardsmith_orun.name': 'Schutzschmied Orun',
  'entities.npcs.wardsmith_orun.title': 'Hüter der Alten Schmieden',
  'entities.npcs.watcher_maren.greeting':
    'Achten Sie darauf, dass Sie am Tor vorbeigehen. Der Wind hier oben nimmt zuerst Hüte und stellt niemals Fragen.',
  'entities.npcs.watcher_maren.name': 'Wächterin Maren',
  'entities.npcs.watcher_maren.title': 'Die Windway-Uhr',
  'entities.npcs.waykeeper_pell.greeting':
    'Die Stufen hinunter und hinein ins sanfte Land. Achten Sie darauf, wo Sie Ihre Stiefel platzieren.',
  'entities.npcs.waykeeper_pell.name': 'Wegwächter Pell',
  'entities.npcs.waykeeper_pell.title': 'Hüter der Amberfen-Treppe',
  'entities.npcs.waywatcher_sorrel.greeting':
    'Schnee hinter dir, Gold vor dir. Nur wenige gehen den Goldmelt zweimal entlang, also lohnt sich die Überquerung.',
  'entities.npcs.waywatcher_sorrel.name': 'Wegwächter Sauerampfer',
  'entities.npcs.waywatcher_sorrel.title': 'Wächter der Goldschmelze',
  'entities.npcs.weaver_amelle.greeting':
    'Spüren Sie das? Moonfleece auf dem Webstuhl. Wärmer als jedes Feuer, neben dem du gesessen hast.',
  'entities.npcs.weaver_amelle.name': 'Weberin Amelle',
  'entities.npcs.weaver_amelle.title': 'Mondfleece-Weber',
  'entities.npcs.wickmother_sorrel.greeting':
    'Treten Sie ein, setzen Sie sich, auf dem Feuer steht Likör. Behalten Sie einfach alles Eisen im Griff: Die Zwerge sind in letzter Zeit leichtfingrig.',
  'entities.npcs.wickmother_sorrel.name': 'Wickmother Sauerampfer',
  'entities.npcs.wickmother_sorrel.title': 'Hüter des Hedgewick Inn',
  'entities.npcs.widow_tansy.greeting':
    'Eine Kerze für jedes Grab, und keine darf ausgehen. Nicht einer, hörst du mich?',
  'entities.npcs.widow_tansy.name': 'Witwe Tansy',
  'entities.npcs.widow_tansy.title': 'Kerzenmacher von Gallowmere',
  'entities.quests.q_af_amber_from_the_herd.completion':
    'Sechs Klumpen, sauber wie eingegossener Honig. Diese Handschuhe sind mit der letzten Charge, {playerName}, genäht: mit Saft versteift und wärmer als sie aussehen.',
  'entities.quests.q_af_amber_from_the_herd.objectives.0.label': 'Vergoldetes Saftgerinnsel',
  'entities.quests.q_af_amber_from_the_herd.text':
    'Die vergoldeten Hirsche schlafen unter meinen ältesten Bäumen, und der Saft tropft die ganze Nacht über Gold in ihre Mäntel. Gekämmte Klumpen davon sind der reinste Bernstein im Wald. Bring mir sechs, {playerName}. Die Hirsche werden es Ihnen nicht danken, aber es wird ihnen auch nicht entgehen.',
  'entities.quests.q_af_amber_from_the_herd.title': 'Amber von der Herde',
  'entities.quests.q_af_foxes_in_the_lamplight.completion':
    'Zehn, und die Geschäfte blieben gestern Abend zum ersten Mal in dieser Saison unberührt. Die Lampenanzünder bedanken sich, {playerName}.',
  'entities.quests.q_af_foxes_in_the_lamplight.objectives.0.label': 'Gloam Fox getötet',
  'entities.quests.q_af_foxes_in_the_lamplight.text':
    'Die Dämmerungsfüchse haben erfahren, was die Laternenläden wert sind, {playerName}. In jeder Abenddämmerung brechen sie über die Zäune und tragen den Talg weg, den wir für die Fährlampen holen. Weiche Pfoten, weicheres Gewissen. Töte zehn von ihnen und der Rest wird daran denken, die Stadt zu fürchten.',
  'entities.quests.q_af_foxes_in_the_lamplight.title': 'Füchse im Lampenlicht',
  'entities.quests.q_af_goldmelt_road.completion':
    'Stille am Goldmelt und ein Reisender mit Schnee im Haar als Beweis dafür. Sauerampfer hält ihre Wache zu gut, um leere Worte zu überbringen. Seien Sie willkommen in Lanternmere, {playerName}. Die Laternen brennen für dich.',
  'entities.quests.q_af_goldmelt_road.objectives.0.label': 'Bericht an Reeve Ottoline',
  'entities.quests.q_af_goldmelt_road.text':
    'Du bist über den Goldmelt gekommen, {playerName}, immer noch Schnee auf deinen Stiefeln. Ich behalte diesen Schrein, damit Lanternmere weiß, wer vor der Kälte hereinkommt, und in letzter Zeit habe ich wenig zu berichten. Nehmen Sie die Goldstraße hinunter in die Stadt, suchen Sie Reeve Ottoline am Brunnen und sagen Sie ihr, dass der Pass ruhig ist.',
  'entities.quests.q_af_goldmelt_road.title': 'Der goldene Weg nach unten',
  'entities.quests.q_af_lanterns_on_the_water.completion':
    'Alle drei und immer noch brennend. Fährlaternen gehen im Wasser nicht aus, {playerName}. Das ist der Sinn von ihnen. Was mich beunruhigt, ist, was sie losgelassen hat.',
  'entities.quests.q_af_lanterns_on_the_water.objectives.0.label': 'Ferry Lantern erholt',
  'entities.quests.q_af_lanterns_on_the_water.text':
    'Jede Fähre auf dem Mere trägt eine Hecklaterne, {playerName}, und drei meiner Boote kamen im Morgengrauen ohne ihre zurück. Der Nebel hat sie mitgenommen, oder irgendetwas im Nebel hat sie mitgenommen. Wenn der Wind dreht, werden sie an die Ostküste gespült. Gehen Sie die Uferstraße entlang und bringen Sie meine Laternen nach Hause.',
  'entities.quests.q_af_lanterns_on_the_water.title': 'Laternen auf dem Wasser',
  'entities.quests.q_af_orchard_call.completion':
    'Die Reeve zählt ihre Karren, nicht wahr? Nun, sie kann damit rechnen, dass sie noch eine Weile vermisst werden. Schau dir meine Reihen an, {playerName}. Ich habe größere Probleme als eine verspätete Lieferung.',
  'entities.quests.q_af_orchard_call.objectives.0.label': 'Finden Sie Orchardist Pomeline',
  'entities.quests.q_af_orchard_call.text':
    'Obstgärtnerin Pomeline betreibt den Gilded Orchard an der Weststraße und ihre Saftkarren sind drei Tage überfällig. Die ganze Stadt lebt von diesem Bernsteinsaft, {playerName}: Lampenharz, Süßungsmittel, das Erntebier. Gehen Sie die Weststraße entlang und finden Sie heraus, was sie hält.',
  'entities.quests.q_af_orchard_call.title': 'Ein Karren für den Obstgarten',
  'entities.quests.q_af_sprites_and_spigots.completion':
    'Vier Eimer wieder an den Haken und in den Reihen ist es still geworden. Du hast ein besseres Händchen mit Sprites als ich, {playerName}, und heute bin ich froh darüber.',
  'entities.quests.q_af_sprites_and_spigots.objectives.0.label': 'Harvest Sprite vertrieben',
  'entities.quests.q_af_sprites_and_spigots.objectives.1.label': 'Sap-Tap Bucket wiederhergestellt',
  'entities.quests.q_af_sprites_and_spigots.text':
    'Erntegeister, {playerName}. Sie lösen meine Safthähne aus den Stämmen, um an die Süße darin zu gelangen, und werfen die Eimer ins Gras. Vertreibe acht der kleinen Diebe und bringe vier meiner Eimer zurück, und schon rollen die Karren wieder.',
  'entities.quests.q_af_sprites_and_spigots.title': 'Sprites und Spigots',
  'entities.quests.q_af_the_meredark.completion':
    'Der Nebel lichtete sich heute Morgen über dem Mere, {playerName}, und die ganze Stadt sah es. Die Fähren werden die Nachtüberfahrt wieder durchführen und jede Laterne auf dem Wasser wird in Ihrem Namen brennen. Nehmen Sie Folgendes: Es wurde vom versunkenen Steg ausgebaggert, und niemand hat ein besseres Recht, es zu tragen.',
  'entities.quests.q_af_the_meredark.objectives.0.label': 'Der Meredark getötet',
  ...
  'entities.quests.q_af_the_meredark.title': 'Der Meredark',
  'entities.quests.q_af_what_took_the_moorings.completion':
    'Acht Formen weniger im Flachwasser, und die Überfahrt verlief heute zum ersten Mal seit zwei Wochen pünktlich. Aber mutige Lauerer sind getriebene Lauerer, {playerName}. Etwas unter dem Mere bewegt sie.',
  'entities.quests.q_af_what_took_the_moorings.objectives.0.label': 'Bloßer Lurker getötet',
  'entities.quests.q_af_what_took_the_moorings.text':
    'Jetzt sage ich Ihnen, was ich vor der Stadt nicht gesagt habe. Die Verankerungen waren nicht verrutscht, sie waren durchgebissen. Bloße Lauerer, jede Nacht mutiger, die an den Seilen und Rudern zerren. Setze acht von ihnen endgültig wieder unter Wasser, {playerName}, bevor ein Fährmann mit ihnen geht.',
  'entities.quests.q_af_what_took_the_moorings.title': 'Was die Liegeplätze beanspruchte',
  'entities.quests.q_calming_the_deep.completion':
    'Du hast getan, was ich nicht ertragen konnte. Die Sammler singen immer noch in den Südringen; Wegen dir werden sie weiter singen.',
  'entities.quests.q_calming_the_deep.objectives.0.label':
    'Verdorbener Sporeling zur letzten Ruhe gelegt',
  'entities.quests.q_calming_the_deep.text':
    'Die Sporenlinge der Glänzenden Tiefe waren sanfte Menschen, bevor die Träne ihre Ringe berührte. Was die Korruption nimmt, gibt sie nicht zurück. Gewährt den Verdorbenen Ruhe, {playerName}: zehn von ihnen, im Norden der Tiefe.',
  'entities.quests.q_calming_the_deep.title': 'Die Tiefe beruhigen',
  'entities.quests.q_dk_ash_on_the_wind.completion':
    'Zehn Klingen weniger in den Dünen, und die Sammelfeuer brannten letzte Nacht tiefer. Meine Wachen schliefen, was sie seit einer Woche nicht mehr getan hatten. Gut gemacht, {playerName}.',
  'entities.quests.q_dk_ash_on_the_wind.objectives.0.label': 'Ashbone Raider getötet',
  'entities.quests.q_dk_ash_on_the_wind.text':
    'Schauen Sie von der Palisade nach Süden, {playerName}. Bei diesen Feuern in den Dünen handelt es sich nicht um Troll-Kochfeuer, sondern um Ascheknochenfeuer, und jede Nacht gibt es mehr. Die Toten kommen mit Sand in den Zähnen aus den Knochenfeldern. Erledige zehn Räuber, bevor sie eine Straße zu meinem Tor abschneiden.',
  'entities.quests.q_dk_ash_on_the_wind.title': 'Asche im Wind',
  'entities.quests.q_dk_banners_over_the_dunes.completion':
    'Drei Banner schnappen im heißen Wind, genau dort, wo mein Glas sie finden kann. Da fünf Kriegsrufer zum Schweigen gebracht wurden, wird die Antwort auf ihren Ruf langsamer kommen. Du hast uns Zeit verschafft, {playerName}.',
  'entities.quests.q_dk_banners_over_the_dunes.objectives.0.label': 'Ashbone Warcaller getötet',
  'entities.quests.q_dk_banners_over_the_dunes.objectives.1.label': 'Warnbanner platziert',
  'entities.quests.q_dk_banners_over_the_dunes.text':
    'Die Ashbone-Sammlung an den alten Bonefield-Gräbern, {playerName}, und meine Patrouillen können die Dünen nicht so lesen, wie sie eine Mauer lesen. Tötet fünf ihrer Kriegsrufer, die die Toten aufrichten, und pflanzt auf jedem Sammelplatz ein Warnbanner auf, damit meine Wachen ihn vom Bergrücken aus markieren können.',
  'entities.quests.q_dk_banners_over_the_dunes.title': 'Banner über den Dünen',
  'entities.quests.q_dk_marrow_and_ash.completion':
    'Sechs Marken und jeweils ein Zeichen eingebrannt. Dies ist kein Schlachtzugsmuster, {playerName}. Jeder Heer in den Dünen antwortet dem Kriegstor unter uns, die Trolle nennen es Orkadia, und keine fünf Soldaten, mit denen ich jemals gedient habe, könnten die Trommeln hinter dieser Tür zerbrechen. Vielleicht fünf wie du.',
  'entities.quests.q_dk_marrow_and_ash.objectives.0.label': 'Ashbone-Kriegsmarke',
  'entities.quests.q_dk_marrow_and_ash.text':
    'Jeder Ashbone Raider trägt ein Kriegsmal, {playerName}: eine verbrannte Markierung des Heeres, unter dem er marschiert. Ich habe von diesem Bergrücken aus vier Heerscharen gezählt, aber Vermutungen sind keine Erkenntnisse. Bringt mir sechs Marken der Räuber und ihrer Kriegsrufer, und ich werde Brannoc die Form des bevorstehenden Krieges geben.',
  'entities.quests.q_dk_marrow_and_ash.title': 'Mark und Asche',
  'entities.quests.q_dk_matriarch_of_the_maw.completion':
    'Der Himmel über dem Drachenschlund ist seit zwei Tagen leer, und jetzt gehst du mit dem Blut einer Matriarchin auf deinen Stiefeln durch mein Tor. Wyrmwatch hat vierzig Jahre lang genau darauf gewartet, {playerName}. Nimm diese Schulterstücke, Schlundschuppe, gefertigt von unserem eigenen Schmied. Tragen Sie sie dort, wo die Drachen sie sehen können.',
  'entities.quests.q_dk_matriarch_of_the_maw.objectives.0.label':
    'Cindraleth, die Matriarchin des Schlunds, getötet',
  'entities.quests.q_dk_matriarch_of_the_maw.text':
    'Die Waage hat es wahr gesagt, {playerName}. Ich kletterte im Morgengrauen auf den Rand und sah sie auf dem Kraterboden: Cindraleth, die Matriarchin, unter der jede Glut an diesem Himmel geschlüpft war, gold wie eine Kohle, die kurz vor dem Fang stand. Während sie grübelt, werden die Drachen immer mutiger und Wyrmwatch kann weder gegen Drachen noch gegen den Eschenknochen kämpfen. Erledigen Sie sie in ihrem Krater und überbringen Sie die Nachricht dann zu Gatecaptain Brannoc. Gehen Sie nicht alleine.',
  'entities.quests.q_dk_matriarch_of_the_maw.title': 'Matriarchin des Schlunds',
  'entities.quests.q_dk_scales_of_the_maw.completion':
    'Schauen Sie sich die Unterseite dieses Exemplars an, {playerName}: spiralförmig versengt, und nur eines nistet sich in Kreisen ein. Diese Drachen sind Brutwächter. Etwas im Drachenschlund ist eine Mutter.',
  'entities.quests.q_dk_scales_of_the_maw.objectives.0.label': 'Glutschwingenschuppe',
  'entities.quests.q_dk_scales_of_the_maw.text':
    'Wenn der Wind den Drakemaw abdreht, reiten die glutenden Drachen damit über mein Lager, so tief, dass sie ihre Zähne zählen können, {playerName}. Sie wandern jeden Tag weiter, und irgendetwas in diesem Krater treibt sie an. Bringt mir drei ihrer Waagen. Schuppen erinnern sich an Hitze, und ich kann lesen, wo sich an der Brandstelle ein Erpel niedergelassen hat.',
  'entities.quests.q_dk_scales_of_the_maw.title': 'Schuppen des Schlunds',
  'entities.quests.q_dk_scorched_stores.completion':
    'Versengt schwarz und jeder Riegel hält noch. Der Schmied bekommt seine Nägel, der Fletcher seine Saiten, und du bekommst die Stiefel, die ich für denjenigen aufgehoben habe, der meine Kisten zurückgebracht hat, {playerName}.',
  'entities.quests.q_dk_scorched_stores.objectives.0.label': 'Verbrannte Versorgungskiste geborgen',
  'entities.quests.q_dk_scorched_stores.text':
    'Der letzte Wagen ist niedergebrannt, {playerName}, aber mit Eisen umwickelte Kisten brennen nicht durch. Vier von ihnen liegen immer noch versengt an der Dünenstraße, mit Salz, Nägeln und Bogensehnen darin. Bring meine Läden nach Hause, bevor die Trolle herausfinden, wie sie sie öffnen können.',
  'entities.quests.q_dk_scorched_stores.title': 'Verbrannte Geschäfte',
  'entities.quests.q_dk_trolls_on_the_road.completion':
    'Acht, und meine Fahrer haben aufgehört, vor jeder Fahrt Abschiedsbriefe zu schreiben. Die Garnison frisst wegen dir, {playerName}.',
  'entities.quests.q_dk_trolls_on_the_road.objectives.0.label': 'Dünentroll getötet',
  'entities.quests.q_dk_trolls_on_the_road.text':
    'Die Dünentrolle haben das Geräusch eines Versorgungswagens gelernt, {playerName}. Sie fuhren diesen Monat dreimal auf der Straße nach Cinder Dunes, und der letzte Fahrer kam nur mit den Zügeln in der Hand. Acht Trolle von der Straße und meine Wagen rollen wieder.',
  ...
  'entities.quests.q_dk_watcher_at_the_wargate.completion':
    'Brannoc hat dich geschickt? Dann hat es mein letzter Läufer nie geschafft. Halte deine Stimme leise und setz dich, {playerName}. Sehen Sie das Tor unten? Zählen Sie die Kriegsbanner davor und Sie werden verstehen, warum ich aufgehört habe, Dinge aufzuschreiben.',
  'entities.quests.q_dk_watcher_at_the_wargate.objectives.0.label': 'Finde Scout Yerrin',
  'entities.quests.q_dk_watcher_at_the_wargate.text':
    'Irgendetwas zieht den Aschenknochen nach Osten, {playerName}, und ich habe mein Bestes geschickt, um herauszufinden, was. Späher Yerrin hat einen Monat lang in den fernen Dünen hinter Trollmoot sein Lager aufgeschlagen, in Sichtweite eines Tores, das zu meinen Lebzeiten niemand gebaut hat. Ihre Berichte wurden vor zehn Tagen eingestellt. Finden Sie ihr Lager und besorgen Sie mir ihre Augen.',
  'entities.quests.q_dk_watcher_at_the_wargate.title': 'Der Wächter am Wargate',
  'entities.quests.q_eg_bloom_clippings.completion':
    'Schauen Sie hier: Die Blätter kräuseln sich in sich selbst, jeder Schnitt ist gleich. Der Garten hat Angst, {playerName}. In hundert Jahren habe ich nicht ein einziges Mal Angst gehabt.',
  'entities.quests.q_eg_bloom_clippings.objectives.0.label': 'Beschnittener Blütenausschnitt',
  'entities.quests.q_eg_bloom_clippings.text':
    'Du willst diesen Garten verstehen? Dann lesen Sie es so, wie ich es tue. Die Hirsche, die auf den Rasen grasen, wachsen im wahrsten Sinne des Wortes grün: Jedes Blatt auf ihnen ist eine Seite. Bringt mir sechs frische Ausschnitte der Topiary-Hirsche, {playerName}. Sie werden Ihnen den Schnitt nicht danken, aber sie werden nachwachsen. Hier wächst alles nach.',
  'entities.quests.q_eg_bloom_clippings.title': 'Ausschnitte aus dem Living Green',
  'entities.quests.q_eg_bull_of_the_court.completion':
    'Ich habe es hier gespürt, als er auseinanderfiel. Hundert Jahre Arbeit, und Sie hatten Recht, sie zu beenden. Nehmt diesen Mantel: Ich habe ihn für denjenigen gereicht, der sich als stärker erwiesen hat als ich. Der Platz ist heute Abend nur ein Brunnen, {playerName}, und der Garten ist nur ein Garten. Vielleicht können der Obergärtner und ich jetzt beide schlafen.',
  'entities.quests.q_eg_bull_of_the_court.objectives.0.label': 'Der Topiary Bull ungemacht',
  'entities.quests.q_eg_bull_of_the_court.text':
    'Nun die Wahrheit, {playerName}. Der Stier im Herzen des Labyrinths war mein Meisterwerk: Ich habe ihn dazu geformt, den Brunnenhof zu bewachen, und das hat er hundert Jahre lang getan. Aber die Angst im Grünen hat ihn erreicht, und er bewacht jetzt nichts mehr, er jagt. Das Labyrinth ernährt jeden, der hineinwandert. Ich bin zu alt, um ihn aufzulösen, und es muss mit Stumpf und Stiel aufgelöst werden. Bringen Sie einen Freund mit, gehen Sie durch das Labyrinth zum Hof ​​und erlegen Sie meinen Stier.',
  'entities.quests.q_eg_bull_of_the_court.title': 'Der Bulle vom Fountain Court',
  'entities.quests.q_eg_four_statues.completion':
    'Vier Reibereien, vier Schwestern, und keine von ihnen weinte Marmor. Der Garten hat Ihr Maß angenommen, {playerName}, und es fehlten Ihnen nichts. Jetzt kann ich Sie dorthin schicken, wo das Problem wirklich liegt.',
  'entities.quests.q_eg_four_statues.objectives.0.label': 'Gartenstatue besucht',
  'entities.quests.q_eg_four_statues.text':
    'Als der Garten noch jung war, züchteten die ersten Gärtner vier Marmorschwestern, um seine Quartiere zu bewachen: eine über der Rose Wilds, eine auf dem Teichweg östlich des Labyrinths, eine auf dem westlichen Rasen, wo die Zwerge ihr Gehege halten, und eine auf dem südlichen Rasen hinter den Hecken. Zwischen ihnen entstand ein Labyrinth, und die meisten Leute sehen nie alle vier. Gehen Sie durch das Viertel, {playerName}, und drücken Sie Ihre Handfläche auf jede Schwester. Wenn der Garten Sie von allen vier Seiten betrachtet hat, öffnet er Orte, die er vor Fremden schützt.',
  'entities.quests.q_eg_four_statues.title': 'Die vier stillen Schwestern',
  'entities.quests.q_eg_gate_report.completion':
    'Umgezogen, nicht wahr? Pell berichtet das jede Woche, und jede Woche hat er Recht. Vergib mir meine Augen, {playerName}, ich habe seit Jahren keine ganze Nacht mehr geschlafen: Jemand muss auf den Garten aufpassen, der auf uns aufpasst. Willkommen in Hedgewick.',
  'entities.quests.q_eg_gate_report.objectives.0.label':
    'Melden Sie sich beim Obergärtner Amaranth',
  'entities.quests.q_eg_gate_report.text':
    'Die Rasenflächen hinter diesem Tor haben sich hundert Jahre lang selbst gepflegt, {playerName}, und in letzter Zeit haben sie damit begonnen, Besucher zu beschneiden. Obergärtner Amaranth bewahrt die Bücher in Hedgewick auf, die Straße hinauf, hinter den Torrasen. Sagen Sie ihr, dass ein anderer Reisender vorbeigekommen ist, und sagen Sie ihr, dass die Hecken am Tor letzte Nacht verschoben wurden.',
  'entities.quests.q_eg_gate_report.title': 'Wort durch das Tor',
  'entities.quests.q_eg_gnomes_in_the_green.completion':
    'Drei Karren zurück und die Heringe wieder voll. Lassen Sie die kleinen Teufel in ihren Hecken schmollen: Hedgewick bearbeitet auch diese Rasenflächen.',
  'entities.quests.q_eg_gnomes_in_the_green.objectives.0.label': 'Heckenzwerg vertrieben',
  'entities.quests.q_eg_gnomes_in_the_green.objectives.1.label': 'Werkzeugwagen wiederhergestellt',
  'entities.quests.q_eg_gnomes_in_the_green.text':
    'Die Schere war nur der Anfang, {playerName}. Letzte Nacht haben die Zwerge unsere Werkzeugwagen ins Grüne gekippt, einen bei ihrem Gehege westlich des Labyrinths, einen sauber quer durch den Garten auf dem Teichweg, und hundert Jahre gutes Eisen im Gras verstreut. Vertreibe acht der kleinen Teufel und trage die verschütteten Karren nach Hause.',
  ...
  'entities.quests.q_eg_hungry_shapes.objectives.0.label': 'Topiary Wolf getötet',
  'entities.quests.q_eg_hungry_shapes.text':
    'Wer auch immer diesen Garten gestaltet, ist nachlässig oder grausam geworden. Die Wolfsgestalten draußen in der Rosenwildnis wurden zur Schau gestellt, doch in letzter Zeit jagen sie: grüne Kiefer, keine Bäuche und kein Grund, jemals damit aufzuhören. Schneiden Sie zehn Formgehölze ab, {playerName}, und lassen Sie die Rasenflächen für eine Weile wieder Rasenflächen sein.',
  'entities.quests.q_eg_hungry_shapes.title': 'Auf Hunger gestutzt',
  'entities.quests.q_eg_stolen_shears.completion':
    'Sechs Paare, und mein eigenes darunter, ich würde die Kerbe in der Klinge überall erkennen. Hier wurden diese Handschuhe für Schnittarbeiten gestrickt. Warme Hände sorgen für eine stabile Schere.',
  'entities.quests.q_eg_stolen_shears.objectives.0.label': 'Gestohlene Heckenschere',
  'entities.quests.q_eg_stolen_shears.text':
    'Jede Schere in Hedgewick ist innerhalb von vierzehn Tagen verschwunden, {playerName}: von den Stangen, aus verschlossenen Schuppen, eine Schere aus meiner eigenen Schürze, während ich döste. Es sind die Heckenzwerge, die kleinen Platzwarte, die es hassen, wenn wir über ihren Rasen gehen. Holen Sie sich sechs Paar zurück, bevor das ganze Dorf nur noch Küchenmesser hat.',
  'entities.quests.q_eg_stolen_shears.title': 'Die gestohlene Schere',
  'entities.quests.q_eg_who_trims_the_hedges.completion':
    'Also hat das Haus endlich jemanden geschickt. Hundert Jahre lang bin ich auf diesen Rasenflächen, {playerName}, und im Garten herumgelaufen und habe eine Einsicht: Ich schneide, was getrimmt werden will. Sitzen. Die Hecken können Ihnen eine Stunde ersparen.',
  'entities.quests.q_eg_who_trims_the_hedges.objectives.0.label':
    'Finden Sie den Gärtner am Lily Basin',
  'entities.quests.q_eg_who_trims_the_hedges.text':
    'Ich habe die Hauptbücher dreißig Jahre lang geführt, {playerName}, und zehn davon nicht richtig geschlafen, weil die Summen nicht geschlossen werden können. Gras muss geschnitten werden und Hecken müssen in Form gebracht werden, und das tut auch niemand hier, und doch steht der Garten jeden Morgen im Morgengrauen beschnitten da. In letzter Zeit schwören die Waldbewohner, dass sie auf den Rasenflächen im äußersten Süden, hinter dem Labyrinth am Lily Basin, einen alten Mann mit einem Karren gesehen haben. Finde ihn. Wenn er echt ist, kann ich endlich schlafen. Wenn nicht, werde ich es wohl nie tun.',
  'entities.quests.q_eg_who_trims_the_hedges.title': 'Wer die Hecken schneidet',
  'entities.quests.q_fs_bell_at_the_landing.completion':
    'Der Damm hält, und Tam hat immer noch genug Atem, um über die drei Mautstellen zu scherzen. Gut. Wir sind eine belagerte Insel, {playerName}, und jedes Paar Hände, das diese Sandbank überquert, ist ein Paar, das die Brüche überwinden müssen, bevor sie mein Volk erreichen. Willkommen in Gullhaven.',
  'entities.quests.q_fs_bell_at_the_landing.objectives.0.label':
    'Melden Sie sich bei Aufseher Coalfast',
  'entities.quests.q_fs_bell_at_the_landing.text':
    'Du bist über den Ferrywalk gekommen, {playerName}? Dann sind Sie der Erste in einer Woche und der Aufseher wird Sie untersuchen wollen. Gullhaven liegt an der Uferstraße, hinter den Wäscheständern kümmert sich niemand mehr darum. Sagen Sie dem Aufseher Coalfast, dass der Damm noch steht und dass Tam heute keine Drei-Maut-Maut gegeben hat. Noch.',
  'entities.quests.q_fs_bell_at_the_landing.title': 'Die Glocke am Landungsplatz',
  'entities.quests.q_fs_bram_come_home.completion':
    'Bram! Du hast ihn im Ganzen zu mir zurückgebracht, {playerName}. Wir haben beide geweint und keiner von uns schämt sich. Was auch immer die Pausen von dieser Insel als nächstes mit sich bringen, meine Familie kriegen sie nicht mit. Nicht mehr.',
  'entities.quests.q_fs_bram_come_home.objectives.0.label':
    'Fisher Bram wurde sicher nach Hause in Gullhaven gebracht',
  ...
  'entities.quests.q_fs_bram_come_home.title': 'Bram Komm nach Hause',
  'entities.quests.q_fs_hold_the_riftfields.completion':
    'Zehn weniger, und die Feldarbeiter streiten bereits darüber, wer zuerst rausgeht. Es wird nicht lange dauern, die Pausen ruhen nie lange, aber eine Stadt, die isst, ist eine Stadt, die hält.',
  'entities.quests.q_fs_hold_the_riftfields.objectives.0.label': 'Breach Wretch getötet',
  'entities.quests.q_fs_hold_the_riftfields.text':
    'Östlich der Stadt sind die Getreidefelder zerstört, und die Unglücklichen, die durch die Riftfields-Bruch kamen, ernten sie jetzt sauber. Meine Leute können kein Feld bewirtschaften, auf dem sie nicht stehen können, {playerName}. Töte zehn dieser Unglücklichen und gib den Bauern ihr Land zurück.',
  'entities.quests.q_fs_hold_the_riftfields.title': 'Halten Sie die Riftfields',
  'entities.quests.q_fs_moss_and_mending.completion':
    'Moos auf der einen Seite und eine ruhigere Küste auf der anderen Seite. Du hast meine gesamte Praxis wieder aufgefüllt, {playerName}. Seien Sie mir so freundlich, nicht mein nächster Patient zu werden.',
  'entities.quests.q_fs_moss_and_mending.objectives.0.label': 'Riftspawn getötet',
  'entities.quests.q_fs_moss_and_mending.objectives.1.label': 'Farshore-Salzmoos',
  'entities.quests.q_fs_moss_and_mending.text':
    'Das Salzmoos, das entlang der Gezeitenlinie wächst, ist die beste Wundpackung, die ich kenne, und die Riftspawn haben jeden Küstenabschnitt beansprucht, an dem sie wachsen. Sie tragen ausgerechnet Büschel davon auf ihren Häuten. Räumt sechs von ihnen im Osten ab, {playerName}, und holt mir vier gute Handvoll Moos von dem, was sie zertrampelt haben.',
  'entities.quests.q_fs_moss_and_mending.title': 'Moos und Reparatur',
  'entities.quests.q_fs_song_before_the_break.completion':
    'Der Aufseher hat Sie geschickt? Gut. Das bedeutet, dass die Stadt endlich begonnen hat, zuzuhören. Jetzt sei noch einen Moment, {playerName}. Hörst du es dort im Wind? Die Klippen singen, und die Melodie gefällt mir nicht.',
  'entities.quests.q_fs_song_before_the_break.objectives.0.label': 'Finden Sie Riftwatch Ollun',
  'entities.quests.q_fs_song_before_the_break.text':
    'Es gibt einen Mann, der die Bremsen hört, bevor sie sich öffnen. Riftwatch Ollun: ein Gelehrter oder ein Verrückter, und in letzter Zeit kann ich mir den Unterschied nicht mehr leisten. Er hält seine Wache auf der Wachwiese, die Straße südöstlich der Stadt hinauf. Finden Sie ihn, {playerName}, und fragen Sie ihn, was die Insel als nächstes mit uns machen wird.',
  'entities.quests.q_fs_song_before_the_break.title': 'Das Lied vor der Pause',
  'entities.quests.q_fs_stalkers_off_the_light.completion':
    'Acht Nächte umrunden, endeten in einer. Die Feuer brennen schon stabiler, vielleicht liegt das auch nur an meinen Händen. So oder so gehört die Wiese wieder mir und ich kann die Insel denken hören.',
  'entities.quests.q_fs_stalkers_off_the_light.objectives.0.label': 'Void Stalker getötet',
  'entities.quests.q_fs_stalkers_off_the_light.text':
    'Die Stalker jagen die Dunkelheit zwischen den Wachfeuern und jede Nacht umkreisen sie meine Wiese ein wenig näher. Sie sind nicht geistlos, {playerName}, sie sind geduldig, und Geduld ist das Einzige, was ich nicht überleben kann. Töte acht und dränge die Dunkelheit zurück zu den Klippen, durch die sie gekommen ist.',
  'entities.quests.q_fs_stalkers_off_the_light.title': 'Stalker aus dem Licht',
  'entities.quests.q_fs_steel_for_the_redoubt.completion':
    'Salznarbig und bruchnarbig, und es wird trotzdem einen scharfen Rand behalten. Hier habe ich diese Griffe selbst ausgekleidet. Stahl gegen Stahl, {playerName}: Es ist der einzige Handel, den Farshore heutzutage betreibt.',
  ...
  'entities.quests.q_fs_steel_for_the_redoubt.text':
    'Jede Klinge, die ich verteile, ist eine, die das Meer zurückgegeben hat, oder eine, die ich den Toten entrissen habe, {playerName}. Die Kerle tragen Schrott durch die Brüche, Scharniere, Haken, zerbrochenen Schwertstahl, Elsterkram, aber es hämmert richtig. Bringt mir sechs Teile ihres erbeuteten Stahls und die Barrikadenlinie bekommt ihre Zähne zurück.',
  'entities.quests.q_fs_steel_for_the_redoubt.title': 'Stahl für die Redoute',
  'entities.quests.q_fs_the_great_break.completion':
    'Ollun schickte eine Nachricht: Der Gesang hörte auf. Meine ganze Stadt hörte die Stille, {playerName}, und die Hälfte von ihnen weinte, als sie überhaupt nichts hörte. Tragen Sie diesen Mantel. Das Farshore vergisst nicht, wer sein Ufer hielt.',
  'entities.quests.q_fs_the_great_break.objectives.0.label': 'Der gespaltene Schrecken getötet',
  ...
  'entities.quests.q_fs_the_great_break.title': 'Der große Bruch',
  'entities.quests.q_fs_the_three_bells.completion':
    'Drei Stimmen, drei Antworten, klar über das Wasser getragen. Schlafe heute Nacht in Gullhaven, {playerName}, und wisse, dass eine Glocke, die dich weckt, rechtzeitig von meiner Hand kommen wird.',
  'entities.quests.q_fs_the_three_bells.objectives.0.label': 'Wachglocke läutete',
  ...
  'entities.quests.q_fv_aurora_motes.completion':
    'Sechs Partikel, immer noch leuchtend. Schau sie dir an, {playerName}: Sie pulsieren im Takt miteinander. Die Lichter sind kein Wetter. Sie sind ein Signal.',
  'entities.quests.q_fv_aurora_motes.objectives.0.label': 'Aurora-Stäubchen',
  'entities.quests.q_fv_aurora_motes.text':
    'Die Irrlichter, die diese Stufen treiben, werden von den Lichtern selbst ausgesendet, und jedes trägt einen Partikel der Aurora in seinem Herzen. Ich brauche sechs, um zu lesen, was der Himmel schreibt, {playerName}. Die Irrlichter wehren sich nicht. Ob das die Arbeit erleichtert oder erschwert, liegt bei Ihnen und Ihrem Gewissen.',
  'entities.quests.q_fv_aurora_motes.title': 'Partikel der Aurora',
  'entities.quests.q_fv_ember_caches.completion':
    'Immer noch warm, alle zusammen. Du hast der Lodge einen ganzen Winter voller Gnade geschenkt, {playerName}.',
  'entities.quests.q_fv_ember_caches.objectives.0.label': 'Ember Cache wiederhergestellt',
  'entities.quests.q_fv_ember_caches.text':
    'Gestern Abend ist auf der Tarnstraße ein Schlitten voller Glutlager umgekippt: Eisenkessel, die ein angestautes Feuer einen Monat lang am Leben halten. Drei von ihnen liegen immer noch im Schnee, {playerName}, und die Hütte kann nicht entbehren, was sie haben. Bringen Sie das Feuer nach Hause.',
  'entities.quests.q_fv_ember_caches.title': 'Glut auf der Tarn Road',
  'entities.quests.q_fv_frostmane_tyrant.completion':
    'Als der Wind letzte Nacht nachließ, hörte das ganze Dorf die Stille dort, wo einst die Frostmähne war. Der Reach schuldet dir eine Schuld, die er erst nach Jahren begleichen muss, {playerName}. Tragen Sie dies und jede Tür in Icemantle steht Ihnen offen.',
  'entities.quests.q_fv_frostmane_tyrant.objectives.0.label': 'Der Frostmähnen getötet',
  'entities.quests.q_fv_frostmane_tyrant.text':
    'Die Heuler waren nicht auf der Jagd, als sie die Terrassen herunterkamen. Sie waren auf der Flucht. Ein Yeti hat die Anhöhe beansprucht, die Bergbewohner nennen sie Frostmähnen, und nicht einmal die Rudel teilen sich einen Hang mit ihr. Es muss ein Ende haben, {playerName}, bevor der Winter es in meine Mauern treibt. Bringen Sie einen Freund mit. Bringen Sie zwei mit.',
  'entities.quests.q_fv_frostmane_tyrant.title': 'Der Frostmähnen-Tyrann',
  'entities.quests.q_fv_howl_above.completion':
    'Acht, und der Abendchor ist dafür dünner. Aber Heuler verlassen die Gipfel nicht umsonst. Etwas dort oben hat sie bewegt, und ich fürchte, es hat einen Namen.',
  'entities.quests.q_fv_howl_above.objectives.0.label': 'Terrassenheuler getötet',
  'entities.quests.q_fv_howl_above.text':
    'Du hörst es in der Dämmerung, {playerName}: ein Heulen von den Heulenden Terrassen, das nicht von den Schneewehen herrührt. Größere Kehlen. Die Terrassenheuler sind zum ersten Mal, seit meine Großmutter diesen Posten innehatte, von den Gipfeln heruntergekommen, und sie haben die Wölfe auf meine Straße getrieben. Achte darauf und schiebe sie zurück.',
  'entities.quests.q_fv_howl_above.title': 'Das Heulen auf den Terrassen',
  'entities.quests.q_fv_lights_over_steps.completion':
    'Kaldra hat dich geschickt? Dann macht sie sich endlich Sorgen, und das hat auch recht. Setz dich, {playerName}. Beobachte mit mir eine Weile den Himmel.',
  'entities.quests.q_fv_lights_over_steps.objectives.0.label': 'Finden Sie Auroristin Veyla',
  'entities.quests.q_fv_lights_over_steps.text':
    'Das Polarlicht hat diesen Monat jede Nacht grün gebrannt, und die alten Leute werden nicht darunter gehen. Eine Frau weiß vielleicht, warum: Veyla, die Auroristin. Sie lagert allein auf den Aurora-Stufen, südöstlich hinter dem Bergsee. Finde ihr Lager, {playerName}, und höre, was die Lichter ihr gesagt haben.',
  'entities.quests.q_fv_lights_over_steps.title': 'Lichter über den Stufen',
  'entities.quests.q_fv_rime_unbound.completion':
    'Die Nacht fühlt sich schon dünner an. Was auch immer sie weckt, es ist noch nicht geschehen, aber Sie haben den Stufen etwas Ruhe verschafft.',
  'entities.quests.q_fv_rime_unbound.objectives.0.label': 'Rime-Elementar getötet',
  'entities.quests.q_fv_rime_unbound.text':
    'Wenn das Polarlicht so hell brennt, steht die Kälte auf und wandelt: Reif-Elementare, dem Frost wird ein Wille gegeben. Sie versammeln sich dort, wo die Lichter die Bänke berühren, und wandern jede Nacht näher an mein Lager heran. Zerbrich acht von ihnen, {playerName}, bevor einer von ihnen mich zerbricht.',
  'entities.quests.q_fv_rime_unbound.title': 'Raureif ungebunden',
  'entities.quests.q_fv_seeing_wren_home.completion':
    'Das Mädchen ist drinnen, in die Hälfte meiner Decken gehüllt und spricht die Sterne vom Himmel. Du hast heute etwas Gutes getan, {playerName}. The Reach sieht nicht viele davon.',
  'entities.quests.q_fv_seeing_wren_home.objectives.0.label':
    'Lehrling Wren wird sicher zur Aurora-Stufe gebracht',
  'entities.quests.q_fv_seeing_wren_home.text':
    'Mein Lehrling Wren ist vor zwei Tagen losgegangen, um die Goldmelt-Linie zu begehen, und ist nie zurückgekommen. Ich habe ihre Spuren gefunden. Sie hat sich unter den Straßenmarkierungen südwestlich der Aurora-Stufen versteckt und hat zu viel Angst vor den Wölfen, um sich zu bewegen. Ich kann das Moor nicht verlassen, {playerName}. Begleite sie zu Veylas Lager auf der Treppe. Unter den Lichtern wird sie sicher sein.',
  'entities.quests.q_fv_seeing_wren_home.title': 'Wren Home sehen',
  'entities.quests.q_fv_silent_trapline.completion':
    'Maeve hat dich geschickt? Ha. Elf Jahre und die Frau glaubt immer noch, dass das Moor mich fressen wird. Nun... dieses Jahr könnte sie recht haben. Schauen Sie sich an, was es mit meinen Zeilen gemacht hat.',
  'entities.quests.q_fv_silent_trapline.objectives.0.label': 'Finden Sie Trapper Brosk',
  'entities.quests.q_fv_silent_trapline.text':
    'Der alte Brosk arbeitet an der Shiverfen-Falle westlich von hier und hat elf Jahre lang jede Woche ein Bündel Pelze mit dem Holzschlitten hinaufgeschickt. Jetzt zwei Wochen, nichts. Er ist zu stur, um zu erfrieren, und zu vorsichtig, um zu ertrinken, {playerName}, also stimmt etwas anderes nicht. Finden Sie sein Lager im Moor und sehen Sie, wie er atmet.',
  'entities.quests.q_fv_silent_trapline.title': 'Die stille Falle',
  'entities.quests.q_fv_snowline_report.completion':
    'Der Pass gilt also. Einna sitzt in diesem Zwischenlager trotz Stürmen, die die Straßenmarkierungen begraben, und sie hat mir kein einziges Mal leere Nachrichten geschickt. Willkommen bei Icemantle, {playerName}.',
  'entities.quests.q_fv_snowline_report.objectives.0.label':
    'Melden Sie sich bei Aufseherin Kaldra',
  'entities.quests.q_fv_snowline_report.text':
    'Jede Seele, die aus den Drakelands aufsteigt, kommt an meinem Feuer vorbei, {playerName}, und jede Woche klettern weniger. Aufseherin Kaldra hält Icemantle an der Nordstraße fest. Sagen Sie ihr, dass der Pass noch offen ist, und sagen Sie ihr, dass ein Fremder ihn alleine bewältigt hat.',
  'entities.quests.q_fv_snowline_report.title': 'Wort von der Schneegrenze',
  'entities.quests.q_fv_sprung_traps.completion':
    'Vier gute Fallen zurück und das Schilf ist still geworden. Du fällst mit einer schwereren Hand als ich, {playerName}, aber ich kann den Ergebnissen nicht widersprechen.',
  'entities.quests.q_fv_sprung_traps.objectives.0.label': 'Fen Sprite vertrieben',
  'entities.quests.q_fv_sprung_traps.objectives.1.label': 'Falle wiederhergestellt',
  'entities.quests.q_fv_sprung_traps.text':
    'Fen-Sprites, {playerName}. Die kleinen Teufel stellen zum Spaß meine Fallen auf und verstreuen das Eisen im Schilf. Vertreibe sie, acht sollten den Rest unterrichten und einsammeln, was von meinen Fallen übrig geblieben ist, während du da draußen bist.',
  'entities.quests.q_fv_sprung_traps.title': 'Sprites in den Fallen',
  'entities.quests.q_fv_winter_pelts.completion':
    'Pelz wie dieser ist das einzige Argument, auf das der Winter hört. Nehmen Sie diese Stufen, sie sind mit der letzten Charge ausgekleidet.',
  'entities.quests.q_fv_winter_pelts.objectives.0.label': 'Dickes Winterfell',
  'entities.quests.q_fv_winter_pelts.text':
    'Brennholz hält einen Körper am Leben, {playerName}, aber Wolle macht diese Kälte nicht so kalt, nur Wolfspelz schon. Sechs dicke Winterwolken prasseln von den Schneeverwehungen ab und ich kann Schlafsäcke für alle in den Hüttenunterkünften auslegen.',
  'entities.quests.q_fv_winter_pelts.title': 'Felle für die Lodge',
  'entities.quests.q_fv_wolves_at_the_door.completion':
    'Zehn Schatten weniger zwischen hier und dem Tarn. Die Holzfäller streiten bereits darüber, wer zuerst rausgeht.',
  'entities.quests.q_fv_wolves_at_the_door.objectives.0.label': 'Schneewehenwolf getötet',
  'entities.quests.q_fv_wolves_at_the_door.text':
    'Früher hielten sich die Triebschneepakete auf den Hochbänken auf. Jetzt überqueren sie die Tarnstraße bei Tageslicht und meine Holzfäller werden die Mauern nicht verlassen. Reduziert die Packungen, {playerName}, zehn davon, und die Straße ist wieder eine Straße.',
  'entities.quests.q_fv_wolves_at_the_door.title': 'Wölfe vor der Tür',
  'entities.quests.q_gc_dead_mens_cargo.completion':
    'Sechs Besatzungen leiser und drei Kisten hoch und trocken. Du rettest mit einer schwereren Hand als ich, {playerName}, aber dem Hauptbuch ist das egal. Die Hälfte davon gehört per Gesetz Ihnen, und per Gesetz meine ich, dass ich es sage.',
  'entities.quests.q_gc_dead_mens_cargo.objectives.0.label': 'Ertrunkener Decksmann beigesetzt',
  'entities.quests.q_gc_dead_mens_cargo.objectives.1.label': 'Treibgutkiste geborgen',
  'entities.quests.q_gc_dead_mens_cargo.text':
    'Das Bergungsgesetz ist einfach, {playerName}: Was das Meer dem Strand gibt, gehört mir. Die ertrunkenen Decksleute sind anderer Meinung. Sie erheben sich aus ihren Schiffsrümpfen und ziehen jede Kiste, die ich stapele, zurück unter die Wasserlinie. Legen Sie sechs davon endgültig nieder, und während der Strand ruhig ist, holen Sie drei Strandgutkisten ein, bevor die Flut Gegenklage erhebt.',
  'entities.quests.q_gc_dead_mens_cargo.title': 'Fracht der toten Männer',
  'entities.quests.q_gc_down_the_windway.completion':
    'Über den Pass zu Fuß, bei diesem Wetter? Maren schickt mir nur wenige Namen, und noch weniger kommen herein, um für sich selbst zu antworten. Willkommen in Wickharbor, {playerName}. Schließen Sie die Tür des Gasthauses hinter sich.',
  'entities.quests.q_gc_down_the_windway.objectives.0.label':
    'Melden Sie sich bei Hafenmeisterin Odile',
  'entities.quests.q_gc_down_the_windway.text':
    'Du hast den Aufstieg geschafft, {playerName}, also hat der Wind beschlossen, dich festzuhalten. Wickharbor liegt östlich entlang der Downs Road, versteckt im Windschatten seiner Bucht. Hafenmeisterin Odile zählt jede Seele, die über den Pass kommt, und sie wird dich zählen wollen. Sag ihr, dass der Windway noch offen ist.',
  'entities.quests.q_gc_down_the_windway.title': 'Den Windweg hinunter',
  'entities.quests.q_gc_keeper_of_the_flame.completion':
    'Odile hat dich den ganzen Weg geschickt, um zu sehen, ob der Wind mich mitgenommen hat? Ha. Sag ihr, dass die Lampe brennt und ich auch. Aber da du den Aufstieg geschafft hast, {playerName}, bleib noch einen Moment. Das Leuchtfeuer hat eine Aufgabe, zu der nur ein Fremder fähig zu sein scheint.',
  'entities.quests.q_gc_keeper_of_the_flame.objectives.0.label': 'Finden Sie Hüter Bram',
  'entities.quests.q_gc_keeper_of_the_flame.text':
    'Der alte Bram hält das Beacon auf der Anhöhe nordöstlich der Stadt und ist seit zwei Wochen nicht mehr hierhergekommen, um seine Vorräte zu holen. Die Lampe brennt noch, also lebt er, aber ein Mann seines Alters allein auf diesem Kopf in diesem Wind, {playerName}. Steigen Sie die Leuchtturmstraße hinauf und sehen Sie ihn stehen.',
  'entities.quests.q_gc_keeper_of_the_flame.title': 'Der Hüter der Flamme',
  'entities.quests.q_gc_lanterns_on_the_shear.completion':
    'Vier Lichtpunkte auf der Klippenstraße, genau dort, wo sie hingehören. Von hier oben sieht es so aus, als hätte die Küste ihre Augen wieder geöffnet. Du hast das Zeug zum Torwart, {playerName}.',
  'entities.quests.q_gc_lanterns_on_the_shear.objectives.0.label': 'Sturmlaterne relit',
  ...
  'entities.quests.q_gc_lanterns_on_the_shear.title': 'Laternen auf der Schere',
  'entities.quests.q_gc_scuttlers_in_the_pots.completion':
    'Zehn Granaten weniger auf meiner Straße, und die Töpfe waren heute Morgen voll. Die Potmen nennen dich ein gutes Omen, {playerName}. In Wickharbor ist das so herzlich, wie Lob nur sein kann.',
  'entities.quests.q_gc_scuttlers_in_the_pots.objectives.0.label': 'Shoal Scuttler getötet',
  'entities.quests.q_gc_scuttlers_in_the_pots.text':
    'Die Untiefenfänger haben gelernt, die Klippenstraße hinaufzusteigen und unsere Krabbentöpfe auf den Steinen aufzubrechen, {playerName}. Die Hälfte des Fangs ist diese Woche weg, und ein Potman hat eine Hand, die er einen Monat lang nicht benutzen wird. Zerbrich zehn von ihnen und der Rest wird sich daran erinnern, warum sie an den Untiefen geblieben sind.',
  'entities.quests.q_gc_scuttlers_in_the_pots.title': 'Uebersetzt: Scuttlers in the Pots',
  'entities.quests.q_gc_the_far_shore.completion':
    'Bram beobachtet mein Ufer jetzt von seinem Turm aus, oder? Der alte Mann hat Recht, sich Sorgen zu machen, {playerName}. Die Toten wandeln nachts auf ihren eigenen Wracks herum, und in letzter Zeit ist es ihnen egal, ob die Sonne scheint.',
  'entities.quests.q_gc_the_far_shore.objectives.0.label': 'Finden Sie Bergungsarbeiterin Edda',
  'entities.quests.q_gc_the_far_shore.text':
    'Von diesem Lampenraum aus kann ich die ganze Küste sehen, {playerName}, und was ich im Norden sehe, gefällt mir nicht. Grüne Lichter laufen bei Ebbe durch die Wrackfelder, Rumpf für Rumpf. Eine Frau arbeitet allein an diesem Ufer: Edda, die Bergungsarbeiterin. Folgen Sie der Klippenstraße nach Norden, vorbei an der Shear, bis die Wracks beginnen, und sehen Sie, dass sie immer noch atmet.',
  'entities.quests.q_gc_the_far_shore.title': 'Die ferne Küste',
  'entities.quests.q_gc_the_wreck_warden.completion':
    'Am Strand wurde es still, als er fiel, {playerName}. Das erste Schweigen, das ich an diesem Ufer seit zehn Jahren gehört habe. Die Besatzungen sind jetzt nur noch Knochen, ruhende Knochen. Nehmen Sie den Mantel oben vom Hort ab, er würde immer besser zu einem lebenden Hinterteil passen.',
  'entities.quests.q_gc_the_wreck_warden.objectives.0.label': 'Der Wrackwärter fiel',
  'entities.quests.q_gc_the_wreck_warden.text':
    'Jetzt wissen Sie, warum die Decksleute aufstehen, {playerName}. Etwas trägt die Seepockenplatte des ersten Wracks, das jemals an dieser Küste zerbrochen ist, und es bewacht jeden Rumpf am Strand wie einen Friedhof, für dessen Bewahrung es gemietet wurde. Es birgt einen Schatz, den ich seit zehn Jahren begehre, und eine Besatzung, die ich lieber ruhen sehen würde. Beende den Wrackwächter. Bring einen Freund mit, die Toten passen gut auf.',
  'entities.quests.q_gc_the_wreck_warden.title': 'Der Wrackwächter',
  'entities.quests.q_gc_wind_against_the_wick.completion':
    'Die Lampe ist letzte Nacht zum ersten Mal seit einem Monat nicht einmal ausgelaufen. Der Wind hasst uns immer noch, {playerName}, aber er hasst uns wieder aufrichtig.',
  'entities.quests.q_gc_wind_against_the_wick.objectives.0.label': 'Gale Wisp zerstreut',
  'entities.quests.q_gc_wind_against_the_wick.text':
    'Die Sturmfetzen sind der bösartige Wind, {playerName}. Sie versammeln sich hoch oben am Mirror Tarn, und jede Flamme, die sie finden, löschen sie aus, eine Laterne, einen Herd, eines Tages diese Lampe. Neununddreißig Jahre lang habe ich dafür gesorgt, dass das Leuchtfeuer brennt, und ich werde es nicht mit Groll an die Witterung verlieren. Streuen Sie acht davon.',
  'entities.quests.q_gc_wind_against_the_wick.title': 'Wind gegen den Docht',
  'entities.quests.q_gc_wool_off_the_downs.completion':
    'Fleece wie dieses ist der Grund, warum die Widder da draußen fett und selbstgefällig stehen bei Wetter, das Menschen tötet. Die Spinner werden bei Lampenlicht dabei sein. Nimm diese Stufen, {playerName}, sie sind vom letzten Scheren gefüttert.',
  ...
  'entities.quests.q_gc_wool_off_the_downs.text':
    'Meine Bootsbesatzungen rudern in einen Sturm, der Ölzeug wie Papier durchschneidet, {playerName}. Nur eines dreht diesen Wind: die fettige Wolle der Moorböcke, dick gesponnen auf Wickharbor-Art. Die Herden grasen auf den Howling Downs westlich der Stadt. Sechs gute Fleecejacken und jede Crew wärmt diese Saison.',
  'entities.quests.q_gc_wool_off_the_downs.title': 'Wolle aus den Daunen',
  'entities.quests.q_gleaming_antlers.completion':
    'Schauen Sie, wie sie das Licht halten! Keine Flamme, kein Rauch, nur das Leuchten. The Hollow bietet.',
  'entities.quests.q_gleaming_antlers.objectives.0.label': 'Glänzendes Geweih',
  'entities.quests.q_gleaming_antlers.text':
    'Die verschleierten Hirsche spenden dort Licht, wo sie grasen, und ihr gegossenes Geweih hält es jahrelang. Fünf von ihnen, von den Herden auf der offenen Lichtung im Herzen des Tals, und meine Laternen brennen den Winter über ohne Öl. Den Hirschen muss kein Schaden zugefügt werden, aber sie trennen sich nicht so leicht von ihnen.',
  'entities.quests.q_gleaming_antlers.title': 'Glänzende Geweihe',
  'entities.quests.q_grove_menace.completion':
    'Der Nachtmarkt kann wieder öffnen. Sie haben einen Kunden auf Lebenszeit oder zumindest einen Rabatt.',
  'entities.quests.q_grove_menace.objectives.0.label': 'Dämmerungswisp zerstreut',
  'entities.quests.q_grove_menace.text':
    'Dämmerungswisps treiben nach Einbruch der Dunkelheit zwischen meinen Ständen vorbei, {playerName}, und ihre Kälte verdirbt alles, was sie berührt. Verteile sie für mich: Zehn davon, wo auch immer der Schleier zerrissen ist.',
  'entities.quests.q_grove_menace.title': 'Bedrohung auf der Lichtung',
  'entities.quests.q_hollow_first_of_the_herd.completion':
    'So fällt das Erste auf das Letzte. Die Herde ist schon ruhiger, spüren Sie das? Du hast dem Hollow heute eine Gefälligkeit erwiesen, auch wenn es nicht danach aussieht.',
  'entities.quests.q_hollow_first_of_the_herd.objectives.0.label': 'Aurelhorn erhielt Frieden',
  'entities.quests.q_hollow_first_of_the_herd.text':
    'Der zweite Name ist schwieriger auszusprechen. Aurelhorn führte diese Herden an, als meine Großmutter Wache hielt, und was auch immer im Hollow erwachte, weckte ihn falsch. Er zertrampelt, was er einst beschützt hat, und die Herde wird seinen Wahnsinn nicht überleben. Er durchstreift die Wiesen in der Nähe der alten Hofstraßen. Beende ihn mit Gnade, {playerName}, und bring einen Freund mit, der die Last der Sache mit dir teilt.',
  'entities.quests.q_hollow_first_of_the_herd.title': 'Erster der Herde',
  'entities.quests.q_hollow_old_marrowshell.completion':
    'Die Untiefen sind wieder nur Wasser. Ich habe gesehen, wie diese Granate bessere Jäger als mich zerschmettert hat, {playerName}. Nicht du.',
  'entities.quests.q_hollow_old_marrowshell.objectives.0.label': 'Old Marrowshell getötet',
  'entities.quests.q_hollow_old_marrowshell.text':
    'Der Vorname ist Old Marrowshell, eine Krabbe von der Größe eines Karrens, die die östlichen Untiefen jagte, schon bevor Eldergleam ein Tor hatte. Es wandert, {playerName}, also musst du am Ufer entlang laufen, bis du seine Spur kreuzst. Gehen Sie nicht allein und vertrauen Sie nicht seiner Stille.',
  'entities.quests.q_hollow_old_marrowshell.title': 'Die alte Muschel der Untiefen',
  ...
  'entities.quests.q_hollow_the_huntsman.objectives.0.label': 'Finden Sie Jäger Deral',
  'entities.quests.q_hollow_the_huntsman.text':
    'Du siehst aus wie jemand, der mit mehr als Irrlichtern umgehen kann, {playerName}. Jäger Deral hält Ausschau zwischen den Hirschwiesen östlich von hier und sucht seit Wochen nach fähigen Händen. Was auch immer er da draußen aufspürt, er wird es im Dorf nicht laut aussprechen.',
  'entities.quests.q_hollow_the_huntsman.title': 'Der Hüter der Herden',
  'entities.quests.q_monument_tour.completion':
    'Ein Aussichtspunkt, ein Hof und eine vergessene Ecke... und alle drei Verse des Siegelliedes, zum ersten Mal seit seiner Singung zusammen. Sie haben einem alten Leser eine große Freude gemacht.',
  'entities.quests.q_monument_tour.objectives.0.label': 'Das Overlook-Denkmal gelesen',
  'entities.quests.q_monument_tour.objectives.1.label': 'Das Gerichtsdenkmal lautete',
  'entities.quests.q_monument_tour.objectives.2.label': 'Das vergessene Denkmal gelesen',
  'entities.quests.q_monument_tour.text':
    'Drei Denkmäler stehen noch aus der Zeit vor der Versiegelung: eines am Duskfall Overlook, eines im Sunken Court und eines verloren im äußersten Nordosten, wo niemand geht. Lies sie für mich, {playerName}. Meine Knie haben vor zwei Jahrhunderten beim Treppensteigen nachgegeben.',
  'entities.quests.q_monument_tour.title': 'Woran sich die Steine erinnern',
  'entities.quests.q_nb_charts_of_the_stones.completion':
    'Es besteht kein Zweifel mehr. Jede Richtung hat sich auf den Schlaflosen Grabhügel zubewegt, als würde sich der Himmel selbst über diesen Hügel neigen, um ihn zu beobachten. Die alten Könige wurden aus einem bestimmten Grund unter ausgerichteten Sternen begraben: {playerName}.',
  ...
  'entities.quests.q_nb_eyes_on_the_vigil.completion':
    'Lira hat dich geschickt? Dann spüren es auch die Gärten. Setz dich einen Moment an die Glasscheibe, {playerName}. Die Sterne sind seit einem Monat unruhig, und jede Karte, die ich zeichne, zeigt nach Norden in Richtung Hügelgrab.',
  'entities.quests.q_nb_eyes_on_the_vigil.objectives.0.label':
    'Finden Sie den Astronomen Cassian bei der ständigen Mahnwache',
  'entities.quests.q_nb_eyes_on_the_vigil.text':
    'Etwas macht die Wanderer kühn und die Herden unruhig, {playerName}, und ich kann es in den Blumen nicht erkennen. Cassian kann es am Himmel lesen. Er unterhält sein Observatoriumslager bei der Standing Vigil östlich von hier, wo die Nachtkin zwischen den Steinen umhertreibt. Finden Sie ihn und fragen Sie, was die Sterne sagen.',
  'entities.quests.q_nb_eyes_on_the_vigil.title': 'Augen auf die Mahnwache',
  'entities.quests.q_nb_night_gardens.completion':
    'Immer noch leuchtend, jedes Blütenblatt. Der Schrein wird eine Woche lang nach Nacht riechen und Moonrest schläft dadurch leichter.',
  'entities.quests.q_nb_night_gardens.objectives.0.label': 'Nightbloom Blossom gesammelt',
  'entities.quests.q_nb_night_gardens.text':
    'Die Nachtblüte öffnet sich nur unter diesem Himmel, und Gloamfield beherbergt die ältesten Beete im Reich. Ich brauche vier frische Blüten für die Schreingirlanden, {playerName}. Schneiden Sie sie vorsichtig: Ein Bett erinnert sich eine Saison lang an eine raue Hand.',
  'entities.quests.q_nb_night_gardens.title': 'Die Nachtgärten',
  'entities.quests.q_nb_restless_mounds.completion':
    'Grabgold, noch kalt vom Boden. Die Wights erheben sich nicht von selbst, {playerName}: Etwas unter dem großen Hügel ruft sie auf, und ich fürchte, die Karten haben uns bereits seinen Namen verraten.',
  'entities.quests.q_nb_restless_mounds.objectives.0.label': 'Barrow Wight getötet',
  'entities.quests.q_nb_restless_mounds.objectives.1.label': 'Grabbeigabe geborgen',
  'entities.quests.q_nb_restless_mounds.text':
    'Die Karten waren eine Warnung, und das Grabhügelfeld beweist es: Die Hügel öffnen sich von unten. Wights gehen mit den alten Ehren durch die Grabreihen, und die Opfergaben, die ihnen den Schlaf ermöglichten, liegen verstreut im Gras. Lege acht davon ab, {playerName}, und sammle vier der Opfergaben zu mir zurück.',
  'entities.quests.q_nb_restless_mounds.title': 'Die Restless Mounds',
  'entities.quests.q_nb_road_of_lanterns.completion':
    'Die Lampen brennen immer noch und die Straße trägt immer noch Fremde zu uns. Sauerampfer hat dieses Tor länger bewacht, als sich irgendjemand in Moonrest erinnern kann. Willkommen, {playerName}, im Reich, das niemals anbricht.',
  'entities.quests.q_nb_road_of_lanterns.objectives.0.label': 'Finden Sie Lira Dewsong in Mondruh',
  'entities.quests.q_nb_road_of_lanterns.text':
    'Hier oben folgt die Sonne nie, {playerName}, nur die Lampen, die ich beim Aufstieg brenne. Moonrest liegt im Norden, wo sich das Blumenlicht sammelt. Finden Sie Lira Dewsong in ihren Gärten und sagen Sie ihr, dass die Nachttorlampen noch brennen.',
  'entities.quests.q_nb_road_of_lanterns.title': 'Die Straße der Laternen',
  'entities.quests.q_nb_striders_in_the_dark.completion':
    'Zehn Läufer weniger und die Herden grasen bereits leichter. Die Gärten haben ihre eigenen Stunden, aber heute Nacht bewahren sie sie in Frieden.',
  'entities.quests.q_nb_striders_in_the_dark.objectives.0.label': 'Gloam Strider getötet',
  'entities.quests.q_nb_striders_in_the_dark.text':
    'Die Düsterschreiter waren schon immer geduldige Jäger, {playerName}, aber in letzter Zeit schlüpfen sie direkt in die Blumenbeete und erbeuten Mondfleece-Lämmer unter unseren Laternen. Töte zehn von ihnen und gib den Tiefen ihre Ruhe zurück.',
  'entities.quests.q_nb_striders_in_the_dark.title': 'Läufer im Dunkeln',
  'entities.quests.q_nb_the_barrow_king.completion':
    'Die Stars haben sich zum ersten Mal in einer Saison niedergelassen, {playerName}. Die Hügel sind geschlossen, die Nachtverwandten stehen still vor ihren Steinen und der König schläft wieder unten. Tragen Sie diesen Mantel: Moonrest hat ihn für denjenigen geschaffen, dem die Nacht endlich vertraut hat.',
  'entities.quests.q_nb_the_barrow_king.objectives.0.label':
    'Der Barrow King wird zur Ruhe gebracht',
  'entities.quests.q_nb_the_barrow_king.text':
    'Jede Richtung, jeder ruhelose Stern, jeder geöffnete Hügel weist auf eines hin: Der Hügelgrabkönig erwacht unter dem großen Hügel, und dieses Reich hat keine Morgendämmerung, die ihn zurückhalten könnte. Er muss zur Ruhe gebracht werden, bevor er sich an seine Krone erinnert, {playerName}. Gehen Sie nicht alleine: Bringen Sie einen Freund mit und behalten Sie das Blumenlicht im Rücken.',
  'entities.quests.q_nb_the_barrow_king.title': 'Der Barrow King erwacht',
  'entities.quests.q_nb_wool_by_moonlight.completion':
    'Silbern wie Sternenlicht und doppelt so weich. Hier, {playerName}: Fäustlinge aus der letzten Charge, übrigens nur mit Moonfleece-Linien gefüttert.',
  'entities.quests.q_nb_wool_by_moonlight.objectives.0.label': 'Moonfleece Büschel',
  'entities.quests.q_nb_wool_by_moonlight.text':
    'Nichts wärmt so gut wie Moonfleece, {playerName}, und nichts dreht sich so gut. Die Weidetiere tragen ihre Silberwolle lose in Büscheln, während sie durch die Daunen treiben. Bring mir sechs gute Büschel der Herden und ich werde dir etwas weben, das einen Spaziergang wert ist.',
  'entities.quests.q_nb_wool_by_moonlight.title': 'Wolle von Moonlight',
  'entities.quests.q_pr_boars_in_the_gardens.completion':
    'Die Regale stehen und die Gärten können neu bepflanzt werden. Die Wildschweine haben es sich nicht ausgesucht, auf den Sand zu kommen, {playerName}. Denken Sie daran: Etwas hat sie bewegt.',
  'entities.quests.q_pr_boars_in_the_gardens.objectives.0.label': 'Dickichtschwein vertrieben',
  'entities.quests.q_pr_boars_in_the_gardens.text':
    'Was auch immer sich im tiefen Grün regt, es treibt die Dickichtschweine auf unseren Strand hinaus. Sie haben diese Woche zweimal die Gartenterrassen entwurzelt und als nächstes werden sie die Trockengestelle haben. Zehn Eber, {playerName}, und den Rest zurück unter die Bäume schieben.',
  'entities.quests.q_pr_boars_in_the_gardens.title': 'Eber in den Gärten',
  'entities.quests.q_pr_canopy_silk.completion':
    'Gute, starke Seide. Meine Glocken werden noch eine Weile singen, und nachts geht nichts auf diesen Wegen, ohne dass ich es weiß, {playerName}. In letzter Zeit ist etwas oft gelaufen.',
  'entities.quests.q_pr_canopy_silk.objectives.0.label': 'Baldachin-Seidenstrang',
  'entities.quests.q_pr_canopy_silk.text':
    'Schau nach, {playerName}. Jeder Baldachin von hier bis zum Idol ist mit Schwimmhäuten versehen wie ein Fischernetz, und die Weber werden von Saison zu Saison mutiger. Ich spanne ihre eigenen Seidenglöckchen über die Wege, Tripline-Glocken, damit der Dschungel nicht an mich herankriechen kann. Sechs gute Stränge von den Baumkronenwebern werden meine Leinen neu bespannen.',
  'entities.quests.q_pr_canopy_silk.title': 'Seide vom Baldachin',
  'entities.quests.q_pr_down_to_drifthaven.completion':
    'Pell hat dich geschickt? Dann bist du die ganze Tanglemouth-Straße alleine gelaufen, und das ist für mich Referenz genug. Willkommen in Drifthaven, {playerName}. Schnapp dir ein Seil, wir sind unterbesetzt.',
  'entities.quests.q_pr_down_to_drifthaven.objectives.0.label':
    'Melden Sie sich bei Bergungsboss Ryna',
  'entities.quests.q_pr_down_to_drifthaven.text':
    'Raus aus den schwarzen Bäumen und rein in die Sonne, {playerName}. Folgen Sie der Uferstraße nach Norden und Sie werden Drifthaven erreichen, bevor sich die Flut wendet. Fragen Sie nach Bergungsbossin Ryna, sie hat seit dem Sturm Arbeit für alle Hände, und sagen Sie ihr, dass die Straße nach Tanglemouth noch offen ist.',
  'entities.quests.q_pr_down_to_drifthaven.title': 'Runter nach Drifthaven',
  'entities.quests.q_pr_idol_guardian.completion':
    'Du hast etwas gefällt, was der Dschungel selbst nicht berühren würde. Schauen Sie dort hinter dem Idol: Der Wächter hat nie die Säulen bewacht, {playerName}, er hat die Stufen darunter bewacht. Die Trommeln sind heute Abend still geworden. Was auch immer unter dem Wildheart Basin schläft, kennt jetzt Ihren Namen.',
  'entities.quests.q_pr_idol_guardian.objectives.0.label': 'Der Idol-Wächter ist kaputt',
  ...
  'entities.quests.q_pr_idol_guardian.title': 'Der Idol-Wächter',
  'entities.quests.q_pr_scuttler_cull.completion':
    'Zehn Krallen weniger in der Brandung. Meine Mannschaften marschieren bereits wieder hinaus und keiner von ihnen hat sich bedankt, also werde ich mich bei Ihnen bedanken, {playerName}.',
  'entities.quests.q_pr_scuttler_cull.objectives.0.label': 'Tide Scuttler geknackt',
  'entities.quests.q_pr_scuttler_cull.text':
    'Jedes Wrack an dieser Küste lockt die Flutdampfer an, und die Pearlwake hat das halbe Riff angezogen. Meine Bergungsmannschaften werden mit diesen Krallen im seichten Wasser keine Leine ziehen können. Knacke zehn davon, {playerName}, und die Wracklinie gehört wieder uns.',
  'entities.quests.q_pr_scuttler_cull.title': 'Panzerdiebe',
  'entities.quests.q_pr_the_lost_navigator.completion':
    'Suli steht am Feuer und schwört immer noch, sie hätte darin schwimmen können. Du hast den einzigen Kartenleser an dieser Küste zurückgebracht, {playerName}. Diese stammen mit ihrem Segen aus ihrer Seekiste.',
  'entities.quests.q_pr_the_lost_navigator.objectives.0.label':
    'Navigator Suli sicher nach Drifthaven gebracht',
  'entities.quests.q_pr_the_lost_navigator.text':
    'Wir haben alle Hände von der Pearlwake abgezogen, bis auf eine: Navigatorin Suli, die zum anderen Strand schwamm und nie hineinkam. Ein Taucher entdeckte sie versteckt im Bugwrack hinter der Palmstrand, lebendig und zu erschöpft, um den Spießrutenlauf allein zu bewältigen. Begleite sie entlang der Uferstraße nach Hause, {playerName}. Den Krabben wird es nicht gefallen, und dem Dschungel gefällt es weniger.',
  'entities.quests.q_pr_the_lost_navigator.title': 'Der verlorene Navigator',
  'entities.quests.q_pr_the_man_who_went_in.completion':
    'Isha hat dich geschickt? Die Perlenmutter hat meinen Namen seit Jahren nicht mehr ausgesprochen. Setz dich außerhalb der Reichweite der Ranken, {playerName}, und ich sage dir, was ich weiß: Die Trommeln sind nicht die Gefahr. Sie sind die Warnung.',
  'entities.quests.q_pr_the_man_who_went_in.objectives.0.label': 'Finden Sie Okku am Vinefall',
  'entities.quests.q_pr_the_man_who_went_in.text':
    'Die Taucher werden die Baumgrenze nicht überschreiten, {playerName}, und ich werde sie auch nicht darum bitten. Mittlerweile haben Sie die Trommeln gehört: Am zweiten Abend hören es alle. Ein Mann auf dieser Insel ging jemals auf diesen Klang zu und kam zurück. Okku. Er lagert unter den großen Banyanbäumen am Vinefall, tief oben an der Tangle Road. Finden Sie ihn und fragen Sie ihn, was das Grün verbirgt.',
  ...
  'entities.quests.q_pr_what_the_drums_guard.completion':
    'Moos, Perlenmuschel und Eberblut, von den Fingern gepackt. Etwas in dieser Ruine behält noch immer seine Rituale bei, {playerName}, und der Wächter hält alles andere draußen. Es ist an der Zeit, klar darüber zu sprechen.',
  'entities.quests.q_pr_what_the_drums_guard.objectives.0.label': 'Canopy Weaver abgeholzt',
  'entities.quests.q_pr_what_the_drums_guard.objectives.1.label':
    'Nachgefüllte Opferschale eingesammelt',
  'entities.quests.q_pr_what_the_drums_guard.text':
    'Ich bin dem versunkenen Götzenbild so nahe gegangen, wie es ein lebender Mensch wagt, und habe zwei Dinge gesehen: Die Weber haben die Götzenstraße mit einem Netz bedeckt, und die alten Opferschalen entlang der Straße wurden wieder gefüllt. Ganz frisch, {playerName}. Haltet acht Weber von der Straße fern und bringt mir drei dieser Opfergaben. Ich würde wissen, welche Hand einen toten Gott noch ernährt.',
  'entities.quests.q_pr_what_the_drums_guard.title': 'Was zum Drums Guard',
  'entities.quests.q_pr_wreck_line_cargo.completion':
    'Salzfleckig, aber gesund, alle drei. Die Taucher essen diesen Monat wegen dir, {playerName}.',
  ...
  'entities.quests.q_pr_wreck_line_cargo.text':
    'Der Sturm vor drei Nächten trieb die Pearlwake auf das Riff, und ihre Ladung ist über die gesamte Länge der Wracklinie zwischen hier und dem Palmstrand verstreut. Drei Kisten mit Handelswaren liegen immer noch in der Brandung, {playerName}. Bringen Sie sie vor der Flut herein, oder die Krabben holen sich den Rest.',
  'entities.quests.q_pr_wreck_line_cargo.title': 'Die Wracklinie',
  'entities.quests.q_seal_restored.completion':
    'Ich fühlte es von hier aus ganz nah, sanft wie die Dämmerung. The Hollow erinnert sich an seine Freunde, {playerName}. Egal wie weit Sie reisen, unter dem großen Baum wird es immer ein Licht für Sie geben.',
  'entities.quests.q_seal_restored.objectives.0.label': 'Das im Siegelstein eingelassene Siegel',
  'entities.quests.q_seal_restored.text':
    'Bringen Sie das Siegel des Aufsehers zum Siegelstein im Herzen des Hofes und legen Sie es dort zurück, wo es losgeschlagen wurde. Dann kann das Hollow beginnen zu heilen, und du, {playerName}, wirst getan haben, was noch niemand deiner Art zuvor getan hat.',
  'entities.quests.q_seal_restored.title': 'Das Siegel wiederhergestellt',
  'entities.quests.q_shards_of_starfall.completion':
    'Schauen Sie sich die Streifen an! Herbst. The Hollow wurde im Herbst versiegelt. Zweihundert Jahre Streit, beigelegt durch sechs kleine Steine.',
  'entities.quests.q_shards_of_starfall.objectives.0.label': 'Sternenfallsplitter',
  'entities.quests.q_shards_of_starfall.text':
    'Wenn die Dämmerungsstreifen über die Kristallfelder ziehen, haften Splitter alten Sternenlichts wie Kletten an ihnen. Sechs Scherben, {playerName}, und ich kann die Versiegelung genau in die Zeit datieren, in der sie gesungen wurde.',
  'entities.quests.q_shards_of_starfall.title': 'Splitter von Starfall',
  'entities.quests.q_spore_hearts.completion':
    'Da. Gereinigt und ruhig. Jedes weist das gleiche Zeichen auf: Der Schatten fließt VOM versunkenen Hof. Sag es Saelwyn.',
  'entities.quests.q_spore_hearts.objectives.0.label': 'Sporenherz',
  'entities.quests.q_spore_hearts.text':
    'Wenn ein Sporeling in die Dunkelheit fällt, schlägt sein Herz mit geliehenem Schatten weiter. Vier dieser Herzen, die am Schrein gereinigt wurden, könnten uns zeigen, wie sich die Verderbnis ausbreitet. Es ist eine düstere Arbeit, {playerName}, aber es ist eine Reparaturarbeit.',
  'entities.quests.q_spore_hearts.title': 'Herzen des Rings',
  'entities.quests.q_spore_tide.completion':
    'Die Ringe im Norden singen heute Abend wieder. Leise, aber singend.',
  'entities.quests.q_spore_tide.objectives.0.label':
    'Der verdorbene Sporeling wurde zur letzten Ruhe gelegt',
  'entities.quests.q_spore_tide.text':
    'Die Salbe hält den Hain, aber die Verderbnis drückt mit jeder Dämmerung stärker auf die Tiefe. Zwölf weitere Verderbte müssen zur letzten Ruhe gebettet werden, bevor die Sammler ihre Nordringe zurückerobern können, {playerName}.',
  'entities.quests.q_spore_tide.title': 'Gegen die Sporenflut',
  'entities.quests.q_sunken_court.completion':
    'Acht Wächter, still. Ich erinnere mich an die Zeit, als sie großgezogen wurden, {playerName}. Schauen Sie nicht so überrascht; The Hollow hält seine Wächter lange Zeit gefangen.',
  'entities.quests.q_sunken_court.objectives.0.label': 'Der alte Wächter ist still',
  'entities.quests.q_sunken_court.text':
    'Bryn las die Herzen wahr: Die Träne läuft durch den alten Hof im Osten, und seine Wächter sind falsch aufgewacht. Sie wurden gebaut, um das Siegel zu schützen; Jetzt werden sie jeden vernichten, der sich ihm nähert. Räumen Sie acht davon aus den Ruinen.',
  'entities.quests.q_sunken_court.title': 'Der versunkene Hof',
  'entities.quests.q_treant_accord.completion':
    'Dick und solide, alle vier. Es wird eine Woche dauern, bis die Salbe gebraut ist, und hundert Jahre, bis sie ihre Wirkung vollendet hat. Bäume messen Freundlichkeit anders.',
  'entities.quests.q_treant_accord.objectives.0.label': 'Uebersetzt: Elder Bark',
  'entities.quests.q_treant_accord.text':
    'Die Ältesten des Hains werfen ihre äußere Rinde ab, während die Verderbnis an ihren Wurzeln nagt. Vier Längen davon, und ich kann eine Salbe für den ganzen Hain brauen. Sie werden es dir nicht danken, während du es losbrichst, {playerName}, aber sie werden noch ein Jahrhundert länger dafür stehen.',
  'entities.quests.q_treant_accord.title': 'Das Treant-Abkommen',
  'entities.quests.q_veil_thinned.completion':
    'Kalt, jeder von ihnen. The Hollow hat vielleicht noch eine Saison, bevor aus dem Riss ein Riss wird. Wir haben Arbeit zu erledigen, du und ich.',
  'entities.quests.q_veil_thinned.objectives.0.label': 'Dämmerungsessenz',
  'entities.quests.q_veil_thinned.text':
    'So öffnete sich die Höhle für dich. Dann ist das Siegel schwächer als ich befürchtet habe, {playerName}. Wo der Schleier zerreißt, werden die Irrlichter dunkel und kalt. Bringt mir acht Essenzen aus den Dämmerlichtern und ich werde lesen, wie tief die Wunde reicht.',
  'entities.quests.q_veil_thinned.title': 'Der verdünnte Schleier',
  'entities.quests.q_waking_warden.completion':
    'Der Klang seiner Stimme ist still. Ich fühlte es von hier aus, als würde eine Last vom ganzen Tal genommen.',
  'entities.quests.q_waking_warden.objectives.0.label': 'Der Erwachende Wächter besiegt',
  'entities.quests.q_waking_warden.text':
    'Das Gericht ist ruhig, sein Herr jedoch nicht. Der Wächter, der das Siegel hält, ist verdreht aufgewacht, und während er steht, kann das Siegel nicht repariert werden. Es wird nicht leicht fallen; Bringen Sie einen Freund mit, wenn Sie einen finden können, {playerName}. Bringen Sie zwei mit, wenn Sie zwei finden können.',
  'entities.quests.q_waking_warden.title': 'Der erwachende Wächter',
  'entities.quests.q_wardens_echoes.completion':
    'Das Echo wird jedes Mal schwächer. Bald wird es auf dem Hof ​​nur noch Wind und Efeu geben, so wie es sich für eine Ruine gehört.',
  'entities.quests.q_wardens_echoes.objectives.0.label': 'Der alte Wächter ist still',
  'entities.quests.q_wardens_echoes.text':
    'Auch wenn ihr Herr zum Schweigen gebracht wurde, wiederholen die Hofwächter ihren letzten Befehl wie ein Echo, das nicht verklingen wird. Bis das Siegel zurückgesetzt wird, werden sie weiter aufwachen, {playerName}. Noch zehn weitere, damit die Maurer den Siegelstein erreichen können.',
  'entities.quests.q_wardens_echoes.title': 'Echos des Wächters',
  'entities.quests.q_wf_across_the_fenway.completion':
    'Pell lässt das Feuer durch jeden Nebel brennen, den das Moor ihr entgegenwehen kann. Wenn sie sagt, dass die Stufen offen sind, dann sind sie offen. Willkommen in Bridgemere, {playerName}. Pass auf, wie du auf meinen Brettern trittst, dann werden wir gut miteinander auskommen.',
  'entities.quests.q_wf_across_the_fenway.objectives.0.label': 'Bericht an Bridgewright Alden',
  'entities.quests.q_wf_across_the_fenway.text':
    'Ein sanftes Land, das Willowfen, aber sanft ist nicht dasselbe wie sicher, {playerName}. Folgen Sie der Straße nach Norden bis zum Fenway-Damm und überqueren Sie die Straße nach Bridgemere. Sagen Sie Bridgewright Alden, dass die Treppe offen ist und das Lagerfeuer angezündet ist.',
  'entities.quests.q_wf_across_the_fenway.title': 'Über den Fenway',
  'entities.quests.q_wf_croakers_hush.completion':
    'Hören Sie, {playerName}. Nichts. Das erste wirkliche Schweigen über diesem Moor seit dreißig Jahren, und die halbe Stadt wird heute Nacht vor lauter Seltsamkeit nicht schlafen. Die Weiden sagen Danke, auf ihre Art. Tragen Sie dies, geflochten aus seinem eigenen Lilienbeet, und das Moor wird Sie als Freund erkennen, wohin auch immer das Wasser reicht.',
  'entities.quests.q_wf_croakers_hush.objectives.0.label': 'Der schläfrige Croaker getötet',
  'entities.quests.q_wf_croakers_hush.text':
    'Jetzt kennen Sie den Namen des Schnarchers, {playerName}: der Drowsy Croaker, der alte Krötenkönig in den Drowsy Flats. Jedes Jahr wird sein Krächzen lauter und jedes Jahr vergessen mehr Moorbewohner aufzuwachen. Die Reize werden Ihre Augen offen halten, aber seine Masse ist eine andere Sache: Bringen Sie einen Freund mit und kämpfen Sie nicht mit ihm im Wasser. Bringen Sie den alten König in einen ruhigeren Schlaf.',
  'entities.quests.q_wf_croakers_hush.title': 'Die Stille des Croakers',
  'entities.quests.q_wf_eels_for_the_smokehouse.completion':
    'Sechs gute Aale, kaum verletzt. Am nächsten Morgen wird die Räucherei nach Geld riechen. Hier, diese Wathose gehörte mir, als ich noch schneller war: Aalleder hält die Nässe ab wie nichts anderes.',
  'entities.quests.q_wf_eels_for_the_smokehouse.objectives.0.label': 'Praller Mooraal',
  'entities.quests.q_wf_eels_for_the_smokehouse.text':
    'Die Sumpfkröten fressen nicht nur meine Seile, {playerName}, sie fressen auch meinen Fang: Sie verschlingen die Aale im Ganzen, direkt aus den Fallen. Schneiden Sie sechs dicke Stücke von den gierigen Dingern ab, bevor das Fleisch verdirbt, und das Räuchereifeuer bleibt angezündet.',
  'entities.quests.q_wf_eels_for_the_smokehouse.title': 'Aale für die Räucherei',
  'entities.quests.q_wf_mind_the_moorings.completion':
    'Schauen Sie sich das an: saubere Bisse, alle, aber es ist noch genug Seil zum Spleißen übrig. Du hast mir einen Monat Münzen erspart und den Nettingern einen Monat Murren, {playerName}.',
  ...
  'entities.quests.q_wf_mind_the_moorings.text':
    'Gutes Seil ist hier draußen teuer, {playerName}: Jede Leine, durch die die Kröten beißen, ist eine Woche Aalgeld weg. Die abgeschnittenen Enden liegen noch immer am Grabenufer, wo sie von den Booten versenkt wurden. Gehen Sie über die Promenaden und bringen Sie mir vier Leinen zurück, und ich kann sie so gut wie neu verbinden.',
  'entities.quests.q_wf_mind_the_moorings.title': 'Achten Sie auf die Liegeplätze',
  'entities.quests.q_wf_rope_chewers.completion':
    'Zehn Zähne weniger in meinem Burggraben. Zum ersten Mal seit einem Monat blieben die Boote die ganze Nacht an ihren Liegeplätzen, {playerName}. Ihnen gebührt der Dank aller netter Menschen in der Stadt.',
  'entities.quests.q_wf_rope_chewers.objectives.0.label': 'Sumpfkröte getötet',
  'entities.quests.q_wf_rope_chewers.text':
    'Bogtoads, {playerName}. Nachts holen sie sich aus dem Wassergraben und fressen sich durch meine Festmacherleinen, als wären sie Schilfhalme. Letzte Woche trieben drei Boote ab und eines davon hatte meine gute Winde an Bord. Dünnen Sie sie aus, zehn der dicken Dinger, und die Boote bleiben dort, wo wir sie festmachen.',
  'entities.quests.q_wf_rope_chewers.title': 'Die Seilkauer',
  'entities.quests.q_wf_toll_and_tangle.completion':
    'Drei Truhen, und die Münze darin ist noch trocken. Die Kobolde werden eine Woche lang im Widerrist schmollen, {playerName}, und die Stadt schuldet dir ihr Winterbrot.',
  'entities.quests.q_wf_toll_and_tangle.objectives.0.label': 'Willow Sprite vertrieben',
  'entities.quests.q_wf_toll_and_tangle.objectives.1.label': 'Toll-Chest wiederhergestellt',
  'entities.quests.q_wf_toll_and_tangle.text':
    'Die Weidengeister halten es für ein schönes Spiel, eine Fähre loszuschneiden, {playerName}, und letzte Woche ist das Mautboot auf der Oststrecke mit einer Saison Brückenmaut an Bord gelaufen. Die Truhen sanken ins seichte Wasser und die Kobolde tanzen auf den Promenaden, als ob sie ihnen gehörten. Fahren Sie um acht los und schleppen Sie drei Mautkisten hoch, und Bridgemere isst diesen Winter.',
  'entities.quests.q_wf_toll_and_tangle.title': 'Toll und Tangle',
  'entities.quests.q_wf_wisplight_charms.completion':
    'Sechs Kugeln, immer noch warm vom Träumen. Gib mir bis zum Mondaufgang und ich werde Zauber für dich und jeden, der mutig genug ist, an deiner Seite zu stehen, weben lassen.',
  'entities.quests.q_wf_wisplight_charms.objectives.0.label': 'Irrlicht-Globus',
  'entities.quests.q_wf_wisplight_charms.text':
    'Die Irrlichter über den Teichen sind das laut träumende Moor, {playerName}, und ihr Licht ist das Einzige, was der Flaute des Croaker standhält. Ich webe daraus Weidenanhänger: einen um deinen Hals und das Schnarchen kann deine Augenlider nicht nach unten ziehen. Bringt mir sechs Irrlichtkugeln. Die Irrlichter werden nicht um sie kämpfen, was es zu einer Freundlichkeit oder einem Diebstahl macht, je nachdem, wie man es trägt.',
  'entities.quests.q_wf_wisplight_charms.title': 'Wisplight-Amulette',
  'entities.quests.q_wf_witch_of_willowweep.completion':
    'Alden hat Sie hierher geschickt, um nach dem Schnarchen zu fragen? Dann hören die Brückenleute endlich zu. Setz dich aus der Feuchtigkeit, {playerName}. Dieses Geräusch hat einen Namen und eine Kehle, und ich habe auf jemanden gewartet, der dumm genug ist, mir zu helfen, es zum Schweigen zu bringen.',
  'entities.quests.q_wf_witch_of_willowweep.objectives.0.label': 'Finden Sie Mutter-Segge',
  'entities.quests.q_wf_witch_of_willowweep.text':
    'Du hast es inzwischen gehört, {playerName}: das Schnarchen. Langsam und schwer, vorbei an den Drowsy Flats, als würde sich das Moor selbst im Schlaf umkippen. Die Kröten, die Kobolde, die mittags brennenden Irrlichter: Alles begann mit diesem Geräusch. Eine Seele könnte wissen, was es ist. Mutter Segge unterhält ein Lager in Willowweep, westlich rund um den Wassergraben und am anderen Ufer. Finde sie und frage sie, was mitten in meinem Moor schläft.',
  'entities.quests.q_wf_witch_of_willowweep.title': 'Die Hexe von Willowweep',
  'entities.quests.q_wisp_lights.completion':
    'Weich wie die ersten Sterne. Stellt sie hier neben den Altar; Der Schrein wird den Rest erledigen.',
  'entities.quests.q_wisp_lights.objectives.0.label': 'Irrlichtpartikel',
  'entities.quests.q_wisp_lights.text':
    'Die Glimmerwisps tragen Partikel des alten Sternenlichts, das hierher fiel, als das Hollow versiegelt wurde. Sechs Partikel, und die Schreinlampen werden ein Jahr lang brennen. Nimm nur von denen, die verblassen; Das Hollow gibt genug ohne Gier.',
  'entities.quests.q_wisp_lights.title': 'Lichter der Untiefen',
  'entities.quests.q_ww_bells_of_gallowmere.completion':
    'Cobb hat dich die Straße hochgeschickt, oder? Guter Mann. Er hat die Torlaternen dreißig Jahre lang brennen lassen, und der Wald ist ihm kein einziges Mal entgangen. Willkommen in Gallowmere, {playerName}. Achten Sie auf die Glocken.',
  'entities.quests.q_ww_bells_of_gallowmere.objectives.0.label': 'Bericht an Sexton Marrow',
  'entities.quests.q_ww_bells_of_gallowmere.text':
    'Hören Sie das Läuten, {playerName}? Das ist Gallowmere, die Nordstraße hinauf, und läutet seine Toten in den Schlaf. Sexton Marrow zählt jede Seele unter dem Baldachin, ob lebend oder begraben. Geh und lass dich zählen, bevor der Wald dich selbst zählt.',
  ...
  'entities.quests.q_ww_candles_at_the_bounds.completion':
    'Alle vier brennen? Dann atme, {playerName}. Man hörte es nicht, aber das ganze Dorf hörte es: Die Glocken läuteten leichter, sobald der letzte Docht schnappte.',
  'entities.quests.q_ww_candles_at_the_bounds.objectives.0.label': 'Grabkerze relit',
  'entities.quests.q_ww_candles_at_the_bounds.text':
    'Vier Grenzsteine umgeben Gallowmere, {playerName}, einer an jeder Straße hinaus, und auf jedem Stein brennt eine Grabkerze. Während sie brennen, bleiben die Begrabenen begraben. Der Nieselregen hat sie alle vier ertränkt, und ich bin zu alt, um alleine über die Grenzen zu gehen. Nimm meine Kerze und zünde sie schnell wieder an.',
  ...
  'entities.quests.q_ww_horn_of_the_huntsman.completion':
    'Das Horn verstummte mitten in der Note. Jede Glocke in Gallowmere läutete einmal für sich, und dann wurde der Wald so leise, wie ich es seit dreißig Jahren nicht mehr gehört habe. Du hast den Ritus durchgeführt, den ich nicht durchführen konnte, {playerName}. Tragen Sie dies und gehen Sie ohne Angst unter dem Baldachin hindurch.',
  'entities.quests.q_ww_horn_of_the_huntsman.objectives.0.label': 'Der bleiche Jäger ohne Pferd',
  'entities.quests.q_ww_horn_of_the_huntsman.text':
    'Du hast inzwischen das Horn gehört, {playerName}, dünn und weit weg, der Klang, für den der ganze Wald den Atem anhält. Der bleiche Jäger reitet auf seiner Lichtung nördlich von hier und jedes Grab, an dem er vorbeikommt, wird flacher. Er war einmal ein Mann, und er wurde falsch beerdigt, und ich habe es satt, so zu tun, als ob ein Gebet das bewirken würde. Nimm einen Freund, nimm zwei und lass ihn vom Pferd.',
  'entities.quests.q_ww_horn_of_the_huntsman.title': 'Das Horn des Jägers',
  'entities.quests.q_ww_silk_in_the_eaves.completion':
    'Zehn Weber weniger in der Traufe. Die Lampenanzünder werden heute Abend ihre Runden machen, ohne aufzuschauen, und das ist hier mehr wert, als Sie ahnen.',
  'entities.quests.q_ww_silk_in_the_eaves.objectives.0.label': 'Witwenseidenspinnerin getötet',
  'entities.quests.q_ww_silk_in_the_eaves.text':
    'Schauen Sie nach oben, wenn Sie die Weststraße entlanggehen, {playerName}, und Sie werden sie sehen: eingehüllte Gestalten im Blätterdach, die sich dahin wiegen, wo kein Wind hinkommt. Die Witwenseidenspinnerinnen sind aus dem Dickicht gekrochen und haben ihre Speisekammern über meinen Laternen aufgehängt. Töte zehn, und die Straße ist wieder eine Straße.',
  'entities.quests.q_ww_silk_in_the_eaves.title': 'Seide in der Traufe',
  'entities.quests.q_ww_the_last_vicar.completion':
    'Marrow macht sich Sorgen um mich? Das ist neu. Sagen Sie ihm, dass der Trauerstein in gewisser Weise steht, und ich auch. Bleiben Sie eine Weile, {playerName}. Der Tarn hat geflüstert, und ich möchte lieber nicht alleine zuhören.',
  'entities.quests.q_ww_the_last_vicar.objectives.0.label': 'Finden Sie Pfarrer Creel',
  'entities.quests.q_ww_the_last_vicar.text':
    'Südlich von hier verrottet die Trauersteinkapelle an ihrem schwarzen See, und ein Mann pflegt sie immer noch: Pfarrer Creel, der nicht gehen wollte, als das Dach einstürzte. Er kennt die alten Riten besser als meine Glocken, {playerName}, und er hat seit einem Monat keine Nachricht geschickt. Gehen Sie die Kapellenstraße entlang und sehen Sie ihn atmen.',
  'entities.quests.q_ww_the_last_vicar.title': 'Der letzte Pfarrer',
  'entities.quests.q_ww_walking_mosley_home.completion':
    'Er kam auf eigenen Beinen durch das Tor und schwor, von nun an nichts tiefer als ein Rübenbeet zu graben. Er wird am Sonntag wieder auf dem Hof ​​sein, das sind sie immer. Vielen Dank, {playerName}. Gallowmere behält sein Volk, das ist unser ganzes Gesetz.',
  'entities.quests.q_ww_walking_mosley_home.objectives.0.label':
    'Totengräber Mosley ging sicher zurück nach Gallowmere',
  ...
  'entities.quests.q_ww_walking_mosley_home.title': 'Zu Fuß nach Hause',
  'entities.quests.q_ww_what_the_bark_holds.completion':
    'Drei Seelen zurück unter ehrlicher Erde vor Einbruch der Dunkelheit. Die Schlingpflanzen werden nachwachsen, die Rinde wächst immer, aber heute Nacht bleibt die Lichtung leer, und das reicht.',
  'entities.quests.q_ww_what_the_bark_holds.objectives.0.label': 'Gravenbark Shambler gefällt',
  'entities.quests.q_ww_what_the_bark_holds.objectives.1.label': 'Silkbound bleibt abgeschnitten',
  'entities.quests.q_ww_what_the_bark_holds.text':
    'Auf der Hängenden Lichtung östlich von Gallowmere hängen die Spinner ihre in Seide gehüllten Toten an die Zweige, und die Grabenrindenschlurfer stehen darunter Wache wie geduldige Sargträger. Das sind unsere Leute da oben, {playerName}. Zerbrich fünf Trümmer, schneide drei der eingewickelten Toten nieder und bringe sie nach Hause in die Erde.',
  'entities.quests.q_ww_what_the_bark_holds.title': 'Was die Rinde enthält',
  'entities.quests.q_ww_widows_skeins.completion':
    'Sechs Stränge, sanft wie ein angehaltener Atem. Die Toten werden darin leichter liegen. Nehmen Sie diese Wraps, ich habe sie aus der letzten Charge genäht, und das Holz hat sie noch nie durchgebissen.',
  'entities.quests.q_ww_widows_skeins.objectives.0.label': 'Witwenseidenstrang',
  'entities.quests.q_ww_widows_skeins.text':
    'Die Spinner nehmen unsere Toten als ihre Speisekammern, {playerName}, also nehme ich ihre Seide für unsere Leichentücher. Es brennt sauber und hat eine bessere Wirkung als Leinen. Bringt mir sechs Stränge Witwenseide, und die nächste Seele, die wir begraben, geht eingewickelt und geschützt zu Boden.',
  'entities.quests.q_ww_widows_skeins.title': 'Die Stränge der Witwe',
  'entities.quests.q_ww_wraiths_of_the_tarn.completion':
    'Acht Wächter wurden endlich niedergelegt. Ich würde es bei Tageslicht nicht als Gnade bezeichnen, aber zwischen uns, {playerName}, war es eine.',
  'entities.quests.q_ww_wraiths_of_the_tarn.objectives.0.label': 'Wood Wraith getötet',
  'entities.quests.q_ww_wraiths_of_the_tarn.text':
    'Die Waldgeister waren einst die Wächter der Kapelle, {playerName}, gewachsen aus Bäumen, die über den geehrten Toten gepflanzt wurden. Seit der Tarn schwarz geworden ist, haben sie ihr Amt vergessen, und jetzt treiben sie durch meinen Friedhof und zerren an der Erde. Brechen Sie acht von ihnen auseinander, bevor sie zu Ende bringen, was sie begonnen haben.',
  'entities.quests.q_ww_wraiths_of_the_tarn.title': 'Geister des Tarn',
  'entities.zones.amberfall.name': 'Der Amberfall',
  'entities.zones.amberfall.pois.0.label': 'Uebersetzt: Lanternmere',
  'entities.zones.amberfall.pois.1.label': 'Der Goldmelt',
  'entities.zones.amberfall.pois.2.label': 'Der vergoldete Obstgarten',
  'entities.zones.amberfall.pois.3.label': 'Uebersetzt: Harvest Hollow',
  'entities.zones.amberfall.pois.4.label': 'Der Große Mere',
  'entities.zones.amberfall.pois.5.label': 'Uebersetzt: Cindermaple Rise',
  'entities.zones.amberfall.pois.6.label': 'Der schiefe Monolith',
  'entities.zones.amberfall.welcome':
    'Jedes Blatt hier brennt Gold und Rot, doch keines fällt jemals. Die Laternen von Lanternmere werden für Sie angezündet.',
  'entities.zones.drakelands.name': 'Die Drakelands',
  'entities.zones.drakelands.pois.0.label': 'Uebersetzt: Wyrmwatch',
  'entities.zones.drakelands.pois.1.label': 'Der Gatewood',
  'entities.zones.drakelands.pois.2.label': 'Schlackendünen',
  'entities.zones.drakelands.pois.3.label': 'Uebersetzt: Trollmoot',
  'entities.zones.drakelands.pois.4.label': 'Die letzte Festung',
  ...
  'entities.zones.drakelands.welcome':
    'Heißer Wind weht von der vor uns liegenden Wüste. Drachen kreisen über dem Drachenschlund und in den Dünen brennen Trollfeuer.',
  'entities.zones.eastbrook_vale.pois.11.label': 'Der Farshore Causeway',
  'entities.zones.evergarden.name': 'Der Evergarden',
  'entities.zones.evergarden.pois.0.label': 'Uebersetzt: Hedgewick',
  'entities.zones.evergarden.pois.1.label': 'Das Gartentor',
  'entities.zones.evergarden.pois.2.label': 'Der Parterre-Spaziergang',
  'entities.zones.evergarden.pois.3.label': 'Burg Dawnhold',
  'entities.zones.evergarden.pois.4.label': 'Der Blütenteich',
  'entities.zones.evergarden.pois.5.label': 'Das große Labyrinth',
  'entities.zones.evergarden.pois.6.label': 'Der Fountain Court',
  'entities.zones.evergarden.pois.7.label': 'Die alte Mühle',
  'entities.zones.evergarden.pois.8.label': 'Die Nordwache',
  'entities.zones.evergarden.pois.9.label': 'Das Lilienbecken',
  'entities.zones.evergarden.welcome':
    'Jemand schneidet immer noch die Hecken, obwohl seit hundert Jahren kein Gärtner mehr gesehen wurde. Passen Sie auf das Labyrinth auf: Es erinnert Sie daran.',
  'entities.zones.farshore_isle.name': 'Das ferne Ufer',
  'entities.zones.farshore_isle.pois.0.label': 'Uebersetzt: Gullhaven',
  'entities.zones.farshore_isle.pois.1.label': 'Die Landung',
  'entities.zones.farshore_isle.pois.2.label': 'Die Wachwiese',
  'entities.zones.farshore_isle.pois.3.label': 'Die zersplitterten Klippen',
  'entities.zones.farshore_isle.pois.4.label': 'Die Riftfields',
  'entities.zones.farshore_isle.welcome':
    'Überqueren Sie die Sandbank und Gullhavens Glocke wird Sie finden, bevor die Stadt es tut. Die Brüche reißen ohne Vorwarnung auf, und die Schanze hält sich gegen alles, was hindurchströmt. Sie haben schon lange auf jemanden wie dich gewartet.',
  'entities.zones.frostveil.name': 'Die Frostschleierregion',
  'entities.zones.frostveil.pois.0.label': 'Eismantel',
  'entities.zones.frostveil.pois.1.label': 'Die Schneegrenze',
  'entities.zones.frostveil.pois.2.label': 'Gletschertarn',
  'entities.zones.frostveil.pois.3.label': 'Die Aurora-Stufen',
  'entities.zones.frostveil.pois.4.label': 'Das Shiverfen',
  'entities.zones.frostveil.pois.5.label': 'Die heulenden Terrassen',
  'entities.zones.frostveil.welcome':
    'Schnee verschluckt jedes Geräusch. Unter den tanzenden Lichtern fühlt sich die Kälte selbst wach an.',
  'entities.zones.galecrest.name': 'Der Galecrest',
  'entities.zones.galecrest.pois.0.label': 'Uebersetzt: Wickharbor',
  'entities.zones.galecrest.pois.1.label': 'Der Windweg',
  'entities.zones.galecrest.pois.2.label': 'Die heulenden Tiefen',
  'entities.zones.galecrest.pois.3.label': 'Das alte Leuchtfeuer',
  'entities.zones.galecrest.pois.4.label': 'Die Schere',
  'entities.zones.galecrest.pois.5.label': 'Die Wreckfields',
  'entities.zones.galecrest.pois.6.label': 'Der Spiegelsee',
  'entities.zones.galecrest.pois.7.label': 'Die Galecrest-Ställe',
  'entities.zones.galecrest.welcome':
    'Der Wind hat hier noch nie aufgehört und der Old Beacon ist noch nie ausgegangen. Wickharbor bittet Sie lediglich darum, die Tür des Gasthauses hinter sich zu schließen.',
  'entities.zones.nightbloom.name': 'Die Nachtblüte',
  'entities.zones.nightbloom.pois.0.label': 'Mondruhe',
  'entities.zones.nightbloom.pois.1.label': 'Das Nachttor',
  'entities.zones.nightbloom.pois.2.label': 'Der Mondbrunnen',
  'entities.zones.nightbloom.pois.3.label': 'Uebersetzt: Gloamfield',
  'entities.zones.nightbloom.pois.4.label': 'Die ständige Mahnwache',
  'entities.zones.nightbloom.pois.5.label': 'Der schlaflose Hügelgrab',
  'entities.zones.nightbloom.welcome':
    'Hinter dem Nachttor träumt die Luft selbst. Folgen Sie dem Blumenlicht zur Mondruhe und achten Sie auf die schlafende Welt, die am Himmel hängt.',
  'entities.zones.palmreach.name': 'Der Palmenreich',
  'entities.zones.palmreach.pois.0.label': 'Uebersetzt: Drifthaven',
  'entities.zones.palmreach.pois.1.label': 'Das Tanglemouth',
  'entities.zones.palmreach.pois.2.label': 'Der Palmstrand',
  'entities.zones.palmreach.pois.3.label': 'Das Smaragdgewirr',
  'entities.zones.palmreach.pois.4.label': 'Der Vinefall',
  ...
  'entities.zones.palmreach.welcome':
    'Warmer Sand, laute Vögel und ein Dschungel, der den Horizont verschlingt. Drifthaven brennt für Sie ein Feuer am Strand.',
  'entities.zones.veiled_hollow.name': 'Die verschleierte Höhle',
  'entities.zones.veiled_hollow.pois.0.label': 'Uebersetzt: Eldergleam',
  'entities.zones.veiled_hollow.pois.1.label': 'Dämmerungsfallhöhle',
  'entities.zones.veiled_hollow.pois.2.label': 'Aussichtspunkt Dämmerungsfall',
  'entities.zones.veiled_hollow.pois.3.label': 'Uebersetzt: Elder Grove',
  'entities.zones.veiled_hollow.pois.4.label': 'Starfall-Becken',
  ...
  'entities.zones.veiled_hollow.pois.7.label': 'Die glänzende Tiefe',
  'entities.zones.veiled_hollow.welcome':
    'Die Luft summt vor alter Magie. Suchen Sie Bewahrer Saelwyn unter dem großen Baum von Eldergleam.',
  'entities.zones.willowfen.name': 'Das Willowfen',
  'entities.zones.willowfen.pois.0.label': 'Uebersetzt: Bridgemere',
  'entities.zones.willowfen.pois.1.label': 'Die Amberfen-Treppe',
  'entities.zones.willowfen.pois.2.label': 'Die Lilymoors',
  'entities.zones.willowfen.pois.3.label': 'Uebersetzt: Bogshine Pools',
  'entities.zones.willowfen.pois.4.label': 'Weidenweep',
  'entities.zones.willowfen.pois.5.label': 'Die Drowsy Flats',
  'entities.zones.willowfen.welcome':
    'Im Moor wimmelt es von Libellen und Bienen. Überqueren Sie die Brücke nach Bridgemere und ruhen Sie sich eine Weile aus.',
  'entities.zones.wraithwood.name': 'Der Wraithwood',
  'entities.zones.wraithwood.pois.0.label': 'Uebersetzt: Gallowmere',
  'entities.zones.wraithwood.pois.1.label': 'Das Crowgate',
  'entities.zones.wraithwood.pois.2.label': 'Witwendickicht',
  'entities.zones.wraithwood.pois.3.label': 'Die hängende Lichtung',
  'entities.zones.wraithwood.pois.4.label': 'Die Trauersteinkapelle',
  'entities.zones.wraithwood.pois.5.label': 'Die Lichtung des Jägers',
  'entities.zones.wraithwood.welcome':
    'Das Vordach schließt sich wie ein Deckel über der Straße. Bleiben Sie bei den Laternen von Gallowmere und antworten Sie nicht, wenn der Wald Ihren Namen ruft.',
  'fiesta.augment.cardAria': '() – {name} {category} {description}',
  'guide.dungeonsPage.wildheartBody':
    'Eine regennasse Dschungel-Caldera, in der zwei erhöhte Jagdpfade eine Jade-Cenote umrunden. Durchqueren Sie Tierhöhlen und Ahnenruinen und erklimmen Sie dann die Ritualpyramide, um sich Zulgar zu stellen.',
  'guide.family.demon.desc':
    'Eindringlinge von jenseits der Risse, alles Feuer und Bosheit. Wo man steht, ist ein Bruch nie weit.',
  'guide.family.demon.name': 'Dämonen',
  'guide.family.kobold.desc':
    'Umherhuschende Aasfresser und Kobolde von Lichtungen und Hecken, mehr Ärgernis als Bedrohung, bis sie sich in großer Zahl versammeln.',
  'guide.family.kobold.name': 'Schurken',
  'guide.family.murloc.desc':
    'Quakendes Fischvolk am Seeufer und im Gezeitentümpel, das schnell alles umschwärmt, was ihm zu nahe kommt.',
  'guide.family.murloc.name': 'Uebersetzt: Croakfins',
  'guide.home.world.amberBlurb':
    'Hinter den westlichen Klippen ein Herbst, der nie endet, und Laternen auf einem goldenen See.',
  'guide.home.world.amberName': 'Der Amberfall',
  'guide.home.world.duskBlurb':
    'Ein Reich, das unter den Bergen versiegelt ist, wenn das Flüstern eines Zugangs wahr ist.',
  'guide.home.world.duskName': 'Die verschleierte Höhle',
  'guide.home.world.emberBlurb':
    'Auf der anderen Seite des Pale Causeway weicht das Grün der Asche, und etwas Altes beherrscht die Wüste.',
  'guide.home.world.emberName': 'Die Drakelands',
  'guide.home.world.fenBlurb':
    'Vorbei an der Herbstkrone, einem hellen Moor aus Weiden und stillem Wasser und einer Stadt hinter einem Wassergraben.',
  'guide.home.world.fenName': 'Das Willowfen',
  'guide.home.world.frostBlurb':
    'Eine schneebedeckte Höhe jenseits jeder Karte, die nur in den tanzenden Lichtern zu erkennen ist.',
  'guide.home.world.frostName': 'Die Frostschleierregion',
  'guide.worldPage.amberBlurb':
    'Ein ewiger Herbst aus goldenen und roten Blättern, die niemals fallen, versammelt sich rund um die von Laternen beleuchtete Stadt Lanternmere.',
  'guide.worldPage.amberGreeter': 'Der Laternenbauer, Lanternmere',
  'guide.worldPage.amberGreeting':
    'Jedes Blatt hier brennt Gold und Rot, doch keines fällt jemals. Die Laternen sind für dich angezündet; Achten Sie auf dem Weg nach oben auf den Goldmelt.',
  'guide.worldPage.amberPlaceNotes':
    'Lanternmere erstrahlt im Herzen der Ernte. Der Goldmelt ist der bernsteinfarbene Übergang; Im Gilded Orchard und Harvest Hollow gibt es die süßesten Ernten und die kühnsten Diebe. das Great Mere spiegelt die brennenden Blätter wider; Cindermaple Rise ist am höchsten und am rötlichsten; und der schiefe Monolith erinnert sich an etwas, das älter als der Herbst ist.',
  'guide.worldPage.duskBlurb':
    'Ein Tal der permanenten Dämmerung unter dem großen Baum von Eldergleam, wo Kristallruinen leuchten und die Luft von alter Magie summt.',
  'guide.worldPage.duskGreeter': 'Hüter Saelwyn, Eldergleam',
  'guide.worldPage.duskGreeting':
    'Nur wenige Ihrer Art haben unter diesen Zweigen gestanden. Gehen Sie sanft und seien Sie willkommen.',
  ...
  'guide.worldPage.emberBlurb':
    'Vom Sturm erleuchtete Wüsten aus Asche und Blutglas, in denen Drachen über die Caldera kreisen und Trollfeuer in den Dünen brennen, beobachtet von der Torstadt Wyrmwatch.',
  'guide.worldPage.emberGreeter': 'Der Torhüter, Wyrmwatch',
  'guide.worldPage.emberGreeting':
    'Heißer Wind aus der Wüste, Drachen über dem Drachenschlund und Trollfeuer in den Dünen. Trinken Sie, bevor Sie da rausgehen.',
  'guide.worldPage.emberPlaceNotes':
    'Wyrmwatch hält das Tor. Der Gatewood ist das letzte Grün vor der Wüste; die Aschendünen treiben mit Asche und Schlimmerem; Im Trollmoot sammeln die Dünentrolle ihre Feuer; die Blutglasfelder glitzern vor Rasiermesserscherben; und die Drakemaw-Caldera ist die rauchende Krone, die die Drachen umkreisen.',
  'guide.worldPage.fenBlurb':
    'Ein helles, summendes Feuchtgebiet aus Lilien und langsamem Wasser, das auf alten Promenaden von der Brückenstadt Bridgemere aus durchquert wird.',
  'guide.worldPage.fenGreeter': 'Der Brückenwächter, Bridgemere',
  'guide.worldPage.fenGreeting':
    'Im Moor wimmelt es von Libellen und Bienen. Überqueren Sie die Brücke, ruhen Sie Ihre Füße eine Weile aus und bleiben Sie auf den Brettern hinter den Becken.',
  'guide.worldPage.fenPlaceNotes':
    'Bridgemere sitzt rittlings auf dem langsamen Wasser. Die Amberfen-Stufen führen vom Ernteland herab. die Lilymoors und Bogshine Pools glitzern vor Irrlichtern und Libellen; Willowweep zieht seine Zweige ins Nichts; und die Drowsy Flats sind so sanft, wie dieses Land nur sein kann.',
  'guide.worldPage.frostBlurb':
    'Eine Stille aus Schnee und dunklen Kiefern unter dem Polarlicht, wo sich die Kälte selbst wach anfühlt und Icemantle seine Feuer am Brennen hält.',
  'guide.worldPage.frostGreeter': 'Der Herdwächter, Icemantle',
  'guide.worldPage.frostGreeting':
    'Schnee verschluckt jedes Geräusch hinter der Wand. Wenn die Lichter zu tanzen beginnen, halten Sie Ihre Stimme leise und zünden Sie Ihr Feuer an.',
  'guide.worldPage.frostPlaceNotes':
    'Icemantle hält den letzten warmen Herd. Die Schneegrenze markiert, wo die Verwehungen die Oberhand gewinnen; Glacier Tarn ist schwarz, unter dem Eis steht stilles Wasser; die Aurora-Stufen steigen unter den tanzenden Lichtern empor; das Shiverfen ist ein gefrorener Sumpf, der nie ganz schläft; und die Howling Terraces verdienen jeden Abend ihren Namen.',
  'guide.worldPage.galeBlurb':
    'Meeresklippen und heulende Abgründe, wo der Wind niemals ruht, das Old Beacon nie erlischt und Wickharbor seine Tore fest verschließt.',
  'guide.worldPage.galeGreeter': 'Der Leuchtturmwärter, Wickharbor',
  'guide.worldPage.galeGreeting':
    'Der Wind hat hier noch nie aufgehört, und der Old Beacon ist noch nie ausgegangen. Schließen Sie die Tür des Gasthauses hinter sich.',
  'guide.worldPage.galePlaceNotes':
    'Wickharbor lehnt sich in den Wind. Der Windway ist die Klippenstraße in; die Howling Downs rollen baumlos im Sturm dahin; das Old Beacon brennt schon so lange, wie man sagen kann; die Schere fällt steil ins Wasser; die Wreckfields halten die Küste ehrlich; und der Mirror Tarn ist das Einzige, das im ganzen Reich still ist.',
  'guide.worldPage.gardenBlurb':
    'Ein Gartenreich mit Heckenlabyrinth, das noch immer von keinem Gärtner, den jemand je gesehen hat, beschnitten wurde, betrat Hedgewick und seine Brunnenhöfe.',
  'guide.worldPage.gardenGreeter': 'Der Pförtner, Hedgewick',
  'guide.worldPage.gardenGreeting':
    'Jemand schneidet immer noch die Hecken, obwohl seit hundert Jahren kein Gärtner mehr gesehen wurde. Passen Sie auf das Labyrinth auf: Es erinnert Sie daran.',
  'guide.worldPage.gardenPlaceNotes':
    'Hedgewick wartet am Gartentor. Der Parterre Walk blüht in gestutzten Farben; Dawnhold Castle trainiert seine Ritter hinter neuen Mauern; Der Petal Pond ist das ganze Jahr über rosa. die Alte Mühle dreht ihre eigenen Ringbetten um; das Große Labyrinth ordnet seine Manieren für jeden Gast neu, seine Bögen werden von grünen Füchsen bewacht; die North Watch behält die Ausfahrtsstraße; das Lily Basin liegt darüber hinaus; und der Fountain Court verläuft immer noch klar im Herzen des Gartens.',
  'guide.worldPage.hauntBlurb':
    'Ein verwunschener Wald unter riesigen Baumkronen, in dem die Laternen von Gallowmere das einzige ehrliche Licht auf der Straße sind.',
  'guide.worldPage.hauntGreeter': 'Der Lampenanzünder, Gallowmere',
  'guide.worldPage.hauntGreeting':
    'Bleiben Sie bei den Laternen, Reisender. Und wenn der Wald von der Straße aus deinen Namen ruft, antworte nicht.',
  'guide.worldPage.hauntPlaceNotes':
    'Gallowmere drängt sich in seine Laternen. Das Crowgate ist die düstere Eingangstür des Waldes; Das Witwendickicht ist voller Spinnweben; die Hängende Lichtung und die Trauersteinkapelle bewahren die ältesten Sorgen des Waldes; und die Lichtung des Jägers gehört dem, was dort noch jagt.',
  'guide.worldPage.jungleBlurb':
    'Ein tropisches Gewirr aus Palmen, weißem Sand und lauten Vögeln, wobei die Strandstadt Drifthaven am Strand ein Feuer entzündet.',
  'guide.worldPage.jungleGreeter': 'Die Hafenmeisterin, Drifthaven',
  'guide.worldPage.jungleGreeting':
    'Warmer Sand, laute Vögel und ein Dschungel, der den Horizont verschlingt. Wir zünden am Strand ein Feuer an; Versuchen Sie, darauf zurückzukommen.',
  'guide.worldPage.junglePlaceNotes':
    'Drifthaven hält sein Feuer am Strand. Im Tanglemouth trifft der Fluss auf die grüne Wand. der Palmenstrand verläuft weiß und warm an der Brandung entlang; das Emerald Tangle und der Vinefall verschlingen das Innere; die Saphirlagune leuchtet klar und tief; und das versunkene Idol schaut unter Wasser zu.',
  'guide.worldPage.nightBlurb':
    'Ein Reich sternenklarer Mitternacht, in dem Blumen die Wege erhellen und Moonrest unter einem träumenden Himmel still wacht.',
  'guide.worldPage.nightGreeter': 'Der Wächter Moonrest',
  'guide.worldPage.nightGreeting':
    'Hinter dem Nachttor träumt die Luft selbst. Folgen Sie dem Blumenlicht und achten Sie auf die schlafende Welt, die am Himmel hängt.',
  'guide.worldPage.nightPlaceNotes':
    'Moonrest hält Wache. Das Nachttor ist der Weg in das Mitternachtsland; Der Mondbrunnen enthält Sternenlicht, neben dem Sie stehen können. Gloamfield blüht im Dunkeln; die Ständige Wache schaut zu, ohne sich jemals zu bewegen; und der Sleepless Barrow ist der einzige Ort hier, der niemals träumt.',
  'hudChrome.continentMap.levels': 'Ebenen {min} bis {max}',
  'hudChrome.continentMap.summary':
    'Weltkarte. Wählen Sie eine Zone aus, um deren Karte zu öffnen.',
  'hudChrome.continentMap.title': 'Weltkarte',
  'hudChrome.continentMap.toWorld': 'Weltkarte',
  'hudChrome.continentMap.toZone': 'Zonenkarte',
  'hudChrome.continentMap.toggleAria': 'Wechseln Sie zwischen der Weltkarte und der Zonenkarte',
  'hudChrome.itemTooltip.riftSockets': 'Rift-Edelsteine {used}/{total}',
  'hudChrome.itemTooltip.riftTier': 'Rift-Gegenstand mit {tier}-Rang',
  ...
  'hudChrome.meters.petAbility': ': {Fähigkeit} {pet} {ability}',
  'hudChrome.mountRace.cancelButton': 'Rennen abbrechen',
  'hudChrome.mountRace.finished': 'Fertig in s! {seconds}',
  'hudChrome.mountRace.go': 'LOS!',
  'hudChrome.mountRace.progress': 'Gates {n} von {total}',
  'hudChrome.mountRace.start': 'Los! Bewältige jeden Sprung und reite dann durch den Bogen zurück.',
  'hudChrome.mountRace.startButton': 'Rennen starten',
  'hudChrome.mountRace.timeLeft': 's {seconds}',
  'hudChrome.mountRace.timeout': 'Rennen fehlgeschlagen',
  'hudChrome.mountRace.toFinish': 'Reite durch den Bogen zurück!',
  'hudChrome.mountTraining.begin': 'Lektion beginnen',
  'hudChrome.mountTraining.mountPrompt':
    'Drücken Sie die, um das Trainings-Valorross zu besteigen. {key}',
  'hudChrome.mountTraining.ownedMountPrompt':
    'Ihre Zügel sind in Ihren Taschen. Benutze sie zum Reiten.',
  'hudChrome.mountTraining.returnToMarla':
    'Kehren Sie zu Marla im Stall zurück, um Ihre Valorsteed-Zügel für 10 g zu kaufen.',
  'hudChrome.mountTraining.ridePrompt':
    'Folgen Sie der leuchtenden Markierung bis zur Startlinie und drücken Sie dann „Rennen starten“.',
  'hudChrome.mountTraining.success': 'Du hast das Tapferkeitsross gezähmt.',
  'hudChrome.mounts.useToRide': 'Benutzen Sie es, um dieses Reittier zu beschwören.',
  'hudChrome.unstuck.alreadyActive': 'Unstuck läuft bereits herunter.',
  'hudChrome.unstuck.alreadySafe':
    'Sie befinden sich bereits in einer sicheren, erreichbaren Position.',
  'hudChrome.unstuck.busy': 'Beenden Sie Ihre aktuelle Aktion, bevor Sie Unstuck verwenden.',
  'hudChrome.unstuck.cancelledBusy':
    'Unstuck abgebrochen, weil Sie eine andere Aktion gestartet haben.',
  'hudChrome.unstuck.cancelledCombat':
    '„Unstuck“ wurde abgebrochen, weil Sie in den Kampf eingetreten sind.',
  'hudChrome.unstuck.cancelledDamaged':
    '„Unstuck“ wurde abgebrochen, weil du Schaden erlitten hast.',
  'hudChrome.unstuck.cancelledDisconnected':
    'Unstuck abgebrochen, weil Sie die Verbindung getrennt haben.',
  'hudChrome.unstuck.cancelledMoved': '„Unstuck“ wurde abgebrochen, weil Sie umgezogen sind.',
  'hudChrome.unstuck.cancelledState': 'Unstuck abgebrochen, da sich Ihr Status geändert hat.',
  'hudChrome.unstuck.combat': 'Sie können „Unstuck“ während des Kampfes nicht verwenden.',
  'hudChrome.unstuck.completed': 'Zum nächsten erreichbaren sicheren Ort verschoben.',
  'hudChrome.unstuck.completedAtGraveyard':
    'Dein Geist ist zum nächsten Friedhof zurückgekehrt. Sprechen Sie mit dem blassen Hüter, um den Zoll des Hüters anzunehmen.',
  'hudChrome.unstuck.controlled':
    'Sie können „Unstuck“ nicht verwenden, solange die Bewegung eingeschränkt ist.',
  'hudChrome.unstuck.cooldown': 'Unstuck ist in {seconds} Sekunden fertig.',
  'hudChrome.unstuck.countdown': 'Nicht hängen geblieben: {seconds}',
  'hudChrome.unstuck.dead':
    'Du kannst Unstuck nicht verwenden, während du tot oder in Geisterform bist.',
  'hudChrome.unstuck.help':
    'Wiederherstellung: /unstuck startet einen stationären Countdown, um Sie zu einem nahegelegenen, erreichbaren sicheren Ort zu bringen.',
  'hudChrome.unstuck.helpAtGraveyard':
    "Wiederherstellung: /unstuck startet einen stationären Countdown und schickt Ihren Geist dann zum nächsten Friedhof. Für die Rückkehr durch den Pale Keeper ist The Keeper's Toll erforderlich.",
  'hudChrome.unstuck.menuButton': 'Nicht mehr stecken',
  'hudChrome.unstuck.noSafePosition':
    'Es wurde kein erreichbarer sicherer Ort in der Nähe gefunden. Du wurdest nicht bewegt.',
  'hudChrome.unstuck.revivedAtGraveyard':
    'Du wurdest zum nächstgelegenen Friedhof zurückgebracht und wiederbelebt. Der Wächterzoll lastet auf Ihnen.',
  'hudChrome.unstuck.standStill': 'Stehen Sie auf festem Boden, bevor Sie „Unstuck“ verwenden.',
  'hudChrome.unstuck.standStillAnywhere': 'Stehen Sie still, bevor Sie „Unstuck“ verwenden.',
  'hudChrome.unstuck.started':
    'In {seconds} Sekunden gelöst. Durch Bewegen, Kämpfen, Erleiden von Schaden oder Starten einer anderen Aktion wird die Aktion abgebrochen.',
  'hudChrome.unstuck.unavailable': 'Unstuck ist in Ihrem aktuellen Status nicht verfügbar.',
  'sim.rift.allUnstable': 'Alle Risse sind derzeit instabil. Versuchen Sie es bald noch einmal.',
  'sim.rift.alreadyCleared': 'Dieser Riss wurde bereits von {names} geklärt.',
  'sim.rift.deadEntry': 'Du kannst keinen Riss betreten, während du tot bist.',
  'sim.rift.deadEntryCombat':
    'Ihre Gruppe befindet sich immer noch im Kampf. Sobald die Kämpfe aufhören, können die Toten wieder eintreten.',
  'sim.rift.descendFloor': 'Du tauchst tiefer in ein. {name}',
  'sim.rift.detonateAbsoluteZero': 'Der absolute Nullpunkt bricht aus!',
  'sim.rift.detonateAbyssalMaw': 'Abyssal Maw schließt!',
  'sim.rift.detonateArcaneAnnihilation': 'Arkane Vernichtung bricht aus!',
  'sim.rift.detonateBloodRite': 'Blood Rite fällt!',
  'sim.rift.detonateBroodmothersMark': "Broodmother's Mark explodiert!",
  'sim.rift.detonateCoreMeltdown': 'Kernschmelze explodiert!',
  'sim.rift.detonateCrushingDepth': 'Crushing Depth zerschmettert!',
  'sim.rift.detonateDeathSentence': 'Todesurteil fällt!',
  'sim.rift.detonateEarthshatter': 'Earthshatter explodiert!',
  'sim.rift.detonateFinalJudgment': 'Das endgültige Urteil fällt!',
  'sim.rift.detonateGlacialGrave': 'Gletschergrab explodiert!',
  'sim.rift.detonateHellfireBrand': 'Hellfire Brand explodiert!',
  'sim.rift.detonateLightningRod': 'Blitzableiter schlägt ein!',
  'sim.rift.detonateMagmaWell': 'Magmabrunnen bricht aus!',
  'sim.rift.detonatePactSeal': 'Paktsiegel explodiert!',
  'sim.rift.detonatePitSentence': 'Grubenurteil explodiert!',
  'sim.rift.detonateSoulGrave': 'Soul Grave explodiert!',
  'sim.rift.detonateStormcallersWrath': 'Der Zorn des Sturmrufers bricht aus!',
  'sim.rift.detonateVenomPool': 'Venom Pool bricht aus!',
  'sim.rift.detonateVoidRift': 'Void Rift explodiert!',
  'sim.rift.enterFloor': 'Du trittst durch den Spalt in hinein. {name}',
  'sim.rift.exitOpens': 'Der Spalt erbebt. Hinter den Gefallenen öffnet sich ein Weg nach Hause.',
  'sim.rift.forgeEnchanted': 'Rift-Verzauberung für abgeschlossen. {name}',
  'sim.rift.forgeSocketed': 'Rift-Edelstein für eingefasst. {name}',
  'sim.rift.forgeUpgraded': 'Rift-Upgrade für {name} abgeschlossen.',
  'sim.rift.gateOpen': 'Das Tor öffnet sich.',
  'sim.rift.iceGoalLit': 'Das Frostsiegel lodert. Der Weg bewegt sich.',
  'sim.rift.levelGate': 'Nur Abenteurer der Stufe {level} oder höher dürfen diesen Riss betreten.',
  'sim.rift.orbOpensGate': 'Die Blutkugel flammt auf. Die Tore des Tempels öffnen sich.',
  'sim.rift.orbSealed': 'Die Kugel wird durch das folgende Ritual versiegelt.',
  'sim.rift.orbWakes': 'Die Flamme des Pentagramms erlischt. Etwas erwacht auf dem Altar.',
  'sim.rift.portalCollapses': 'Die {tier}-Rang-Kluft in {zone} bricht zusammen.',
  'sim.rift.portalOpens': 'In {zone} reißt ein {tier}-Rang-Riss auf!',
  'sim.rift.portalSealed': 'Der {tier}-Rang-Riss in {zone} wurde versiegelt.',
  'sim.rift.pylonLit': 'Ein Runenpylon erwacht zum Leben ({lit}/{total}).',
  'sim.rift.raceLost': 'Der Riss wurde bereits von {names} geräumt. Dein Lauf endet.',
  'sim.rift.raceLostBanner': 'Rift bereits gelöscht',
  'sim.rift.raceWinBanner': 'Rift Race gewonnen – {seconds}s',
  'sim.rift.raceWorldWin': '{names} hat das {tier}-Rang-Rift-Rennen in s gewonnen! {seconds}',
  'sim.rift.seqProgress': 'Die Runen antworten der Reihe nach ({step}/{total}).',
  'sim.rift.seqReset': 'Die Runen werden dunkel. Beginnen Sie noch einmal.',
  'sim.rift.socketsShut': 'Die Steckdosen knirschen zu. Der Weg bewegt sich.',
  'sim.rift.stepBack': 'Sie treten durch den Spalt zurück.',
  'sim.rift.wayDownOpens': 'Der Weg nach unten reißt auf.',
};
