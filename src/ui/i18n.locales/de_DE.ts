...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'questUi.dialog.brewDraught': 'Braue mir einen Tieftraum-Trank.',
  'questUi.dialog.brewDraughtAria': '{name} bitten, einen Tieftraum-Trank zu brauen',
  'questUi.dialog.gargoyleBow': 'Sich verneigen.',
  'questUi.dialog.gargoyleBowAria': 'Sich vor {name} verneigen',
  'questUi.dialog.gargoyleAttack': 'Angreifen.',
  'questUi.dialog.gargoyleAttackAria': '{name} angreifen',
  'questUi.dialog.gargoyleShimmer': 'Die Statue flimmert vor Energie...',
  'hud.core.deepdreamZone': 'Der Tieftraum',
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'Das Spiegeltor',
  'entities.zones.mirror_world.name': 'Die Spiegelwelt',
  'entities.zones.mirror_world.welcome':
    'Das Glas erinnert sich an dich. Achte darauf, auf welcher Seite du gehst.',
  'entities.zones.mirror_world.pois.0.label': 'Die Spiegelwelt',
  'entities.zones.mirror_world.pois.1.label': 'Spiegeltor-Platz',
  'entities.zones.mirror_world.pois.2.label': 'Die Lumenkrone',
  'entities.zones.mirror_world.pois.3.label': 'Der Verschleierte Markt',
  'entities.zones.mirror_world.pois.4.label': 'Das Stille Archiv',
  'entities.zones.mirror_world.pois.5.label': 'Der Spiegelsee',
  'entities.zones.mirror_world.pois.6.label': 'Das Nebelfenn',
  'entities.zones.mirror_world.pois.7.label': 'Hexenmulde',
  'entities.zones.mirror_world.pois.8.label': 'Spiegel von Eastbrook',
  'entities.zones.mirror_world.pois.9.label': 'Spiegel von Fenbridge',
  'entities.mobs.poverty_ghost.name': 'Armutsgeist',
  'entities.mobs.spirit_unicorn.name': 'Geist-Einhorn',
  'entities.mobs.hooded_reaper.name': 'Schnitter',
  'entities.mobs.gloomhulk.name': 'Düsterkoloss',
  'entities.mobs.mirrorbound_sentry.name': 'Spiegelwächter',
  'entities.mobs.voidfang_stalker.name': 'Falzahn-Pirscher',
  'entities.npcs.dread_sentinel_a.name': 'Grauenswache',
  'entities.npcs.dread_sentinel_a.title': 'Wärter des Düsterspiegels',
  'entities.npcs.dread_sentinel_a.greeting': 'Dein Tod erwartet dich.',
  'entities.npcs.dread_sentinel_b.name': 'Grauenswache',
  'entities.npcs.dread_sentinel_b.title': 'Wärter des Düsterspiegels',
  'entities.npcs.dread_sentinel_b.greeting': 'Im Leben hielten wir den Damm. Wir halten ihn noch.',
  'entities.npcs.dread_sentinel_c.name': 'Grauenswache',
  'entities.npcs.dread_sentinel_c.title': 'Wärter des Düsterspiegels',
  'entities.npcs.dread_sentinel_c.greeting':
    'Kehr um. Das schwarze Glas ist nicht für die Lebenden - noch war es das je für uns.',
  'entities.quests.q_gargoyle_south.title': 'Der Zoll des Wächters',
  'entities.quests.q_gargoyle_south.text':
    'Das Schimmern wird zu Worten hinter deinen Augen: die Schnitter drängen sich an meinem Glas, {playerName}. Lichte sie, und der Weg nach Highwatch gehört dir.',
  'entities.quests.q_gargoyle_south.completion':
    'Der Stein summt einmal, zufrieden. Dahinter klart der Spiegel auf wie ein endlich losgelassener Atem.',
  'entities.quests.q_gargoyle_south.objectives.0.label': 'Schnitter erlegt',
  'entities.quests.q_gargoyle_west.title': 'Ein Zoll aus Laken',
  'entities.quests.q_gargoyle_west.text':
    'Das Schimmern wird zu Worten hinter deinen Augen: bring mir vier weiße Laken von den armen Toten, {playerName}. Der Weg nach Eastbrook öffnet sich dem, der in Tuch zahlt.',
  'entities.quests.q_gargoyle_west.completion':
    'Die Laken sinken in den Stein und sind fort. Der Spiegel dahinter erwacht im Licht.',
  'entities.quests.q_gargoyle_west.objectives.0.label': 'Weißes Laken',
  'entities.quests.q_gargoyle_north.title': 'Geerntetes Leuchten',
  'entities.quests.q_gargoyle_north.text':
    'Das Schimmern wird zu Worten hinter deinen Augen: die Geisterherden brennen dem Glas zu hell, {playerName}. Erlege fünf, und Fenbridge ist nur einen Schritt entfernt.',
  'entities.quests.q_gargoyle_north.completion':
    'Der Stein trinkt das Licht, das du vergossen hast. Der Spiegel dahinter öffnet sich wie ein Auge.',
  'entities.quests.q_gargoyle_north.objectives.0.label': 'Geist-Einhorn erlegt',
  'entities.zones.mirror_world.pois.10.label': 'die Schwarze Schlucht',
  'entities.mobs.gargoyle_awakened.name': 'Gargoyle-Wache',
  'entities.mobs.mistshade_lurker.name': 'Nebelschatten-Lauerer',
  'entities.mobs.gloaming_maw.name': 'Der Dämmerschlund',
  'entities.mobs.player_echo.name': 'Echo',
  'entities.npcs.keeper_nerissa.name': 'Nerissa die Ruhelose',
  'entities.npcs.keeper_nerissa.title': 'Geist-Bewahrerin der Lumenkrone',
  ...
  'entities.quests.q_relight_the_lumen_crown.objectives.1.label': 'Ertrunkenes Lumen',
  'entities.quests.q_relight_the_lumen_crown.objectives.2.label': 'Düsterkoloss zerschmettert',
  'entities.npcs.veilwright_ollo.name': 'Schleierwirker Ollo',
  'entities.npcs.veilwright_ollo.title': 'Schleiermarkt-Händler',
  ...
  'entities.npcs.gargoyle_sentinel_south.name': 'Gargoyle-Wache',
  'entities.npcs.gargoyle_sentinel_south.title': 'Hüter des Spiegels',
  'entities.npcs.gargoyle_sentinel_south.greeting':
    'Steinerne Augen knirschen zu dir herüber. Es hört zu.',
  'entities.npcs.gargoyle_sentinel_west.name': 'Gargoyle-Wache',
  'entities.npcs.gargoyle_sentinel_west.title': 'Hüter des Spiegels',
  'entities.npcs.gargoyle_sentinel_west.greeting':
    'Steinerne Augen knirschen zu dir herüber. Es hört zu.',
  'entities.npcs.gargoyle_sentinel_north.name': 'Gargoyle-Wache',
  'entities.npcs.gargoyle_sentinel_north.title': 'Hüter des Spiegels',
  ...
  'entities.items.black_hood.name': 'Schwarze Kapuze',
  'entities.items.deepdream_draught.name': 'Tieftraum-Trank',
  'entities.items.mirror_shard.name': 'Spiegelsplitter',
  'entities.items.ghostly_mirrorblade.name': 'Geisterhafte Spiegelklinge',
  'entities.items.ghostly_shroudmantle.name': 'Geisterhafter Leichentuchmantel',
  'entities.items.ghostly_wraithjerkin.name': 'Geisterhaftes Wichtwams',
  'entities.items.ghostly_palegrips.name': 'Geisterhafte Bleichgriffe',
  'entities.items.ghostly_hushboots.name': 'Geisterhafte Stillstiefel',
  'entities.items.ghostly_glasscord.name': 'Geisterhafte Glasschnur',
