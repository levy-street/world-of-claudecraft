...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.readyCheck.start': "Bereitschaftscheck",
  'hudChrome.readyCheck.startAria': "Bereitschaftscheck starten",
  'hudChrome.readyCheck.ready': "Bereit",
  'hudChrome.readyCheck.notReady': "Nicht bereit",
  'hudChrome.readyCheck.waiting': "Wartet",
  'hudChrome.readyCheck.status': "{ready}/{total} bereit",
