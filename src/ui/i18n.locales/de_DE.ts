...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.meters.loot': 'Beute',
  'hud.meters.lootShort': 'Beute',
  'hud.meters.lootHistory': 'Verlauf',
  'hud.meters.noLoot': 'Noch keine Beute aufgezeichnet.',
  'hud.meters.recentAwards': '{count} neue Beutevergaben',
  'hud.meters.methodReturned': 'Gepasst',
  'hud.meters.methodMaster': 'Meister',
  'hud.meters.methodPersonal': 'Persönlich',
  'hud.meters.methodDelve': 'Erkundung',
  'hud.meters.methodLooted': 'Erbeutet',
  'hud.meters.noWinner': 'Kein Gewinner',
  'hud.meters.rollDetail': 'Wurf {roll}',
