...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Eschenholzstab',
  'entities.items.gravecaller_cloth_handwraps.name': 'Gravecaller-Stoffhandwickel',
  'entities.items.gravecaller_cloth_hood.name': 'Gravecaller-Stoffkapuze',
  'entities.items.gravecaller_cloth_leggings.name': 'Gravecaller-Stoffbeinlinge',
  'entities.items.gravecaller_cloth_mantle.name': 'Gravecaller-Stoffmantel',
  'entities.items.gravecaller_cloth_raiment.name': 'Gravecaller-Stoffgewand',
  'entities.items.gravecaller_cloth_sash.name': 'Gravecaller-Stoffschärpe',
  'entities.items.gravecaller_cloth_slippers.name': 'Gravecaller-Stoffschuhe',
  'entities.items.gravecaller_focus.name': 'Gravecaller-Fokus',
  'entities.items.gravecaller_pendant.name': 'Gravecaller-Anhänger',
  'entities.items.gravecaller_ring.name': 'Gravecaller-Ring',
  'entities.items.gravecaller_wand.name': 'Gravecaller-Zauberstab',
  'entities.items.iron_broadsword.name': 'Eisenbreitschwert',
  'entities.items.iron_flanged_mace.name': 'Eisenflanschstreitkolben',
  'entities.items.mirefen_dirk.name': 'Mirefen-Dolch',
  'entities.items.mirefen_hunting_bow.name': 'Mirefen-Jagdbogen',
  'entities.items.mirefen_leather_belt.name': 'Mirefen-Ledergürtel',
  'entities.items.mirefen_leather_boots.name': 'Mirefen-Lederstiefel',
  'entities.items.mirefen_leather_gloves.name': 'Mirefen-Lederhandschuhe',
  'entities.items.mirefen_leather_hood.name': 'Mirefen-Lederkapuze',
  'entities.items.mirefen_leather_jerkin.name': 'Mirefen-Lederwams',
  'entities.items.mirefen_leather_leggings.name': 'Mirefen-Lederbeinlinge',
  'entities.items.mirefen_leather_shoulderguards.name': 'Mirefen-Lederschulterschützer',
  'entities.items.thornpeak_bulwark.name': 'Thornpeak-Bollwerk',
  'entities.items.thornpeak_crossbow.name': 'Thornpeak-Armbrust',
  'entities.items.thornpeak_mail_chest.name': 'Thornpeak-Kettenbrustpanzer',
  'entities.items.thornpeak_mail_gauntlets.name': 'Thornpeak-Kettenstulpen',
  'entities.items.thornpeak_mail_girdle.name': 'Thornpeak-Kettengurt',
  'entities.items.thornpeak_mail_helm.name': 'Thornpeak-Kettenhelm',
  'entities.items.thornpeak_mail_legguards.name': 'Thornpeak-Kettenbeinschützer',
  'entities.items.thornpeak_mail_pauldrons.name': 'Thornpeak-Kettenschulterplatten',
  'entities.items.thornpeak_mail_sabatons.name': 'Thornpeak-Kettensabatons',
  'entities.items.thornpeak_polearm.name': 'Thornpeak-Stangenwaffe',
  'entities.items.thornpeak_war_axe.name': 'Thornpeak-Kriegsaxt',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Bedarf ist nicht verfügbar, weil deine Klasse diesen Gegenstand nicht ausrüsten kann.',
  'itemUi.lootRoll.needUnavailablePower':
    'Bedarf ist nicht verfügbar, weil diese legendäre Macht einer anderen Klasse vorbehalten ist.',
  'itemUi.procedural.advancedDetailsHint':
    'Halte {key} gedrückt, um die möglichen Wurfbereiche anzuzeigen.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Jeder vierte Gloom-Blitz markiert sein Ziel für zusätzlichen Schattenschaden.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Siegel des Aschenbinders',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Jeder zweite Schadenszauber ertönt rings um das Ziel.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Glocke des Neunten Schlags',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    '15 Meter Bewegung gewähren kurzzeitig erhöhte Bewegungsgeschwindigkeit.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Stiefel des Ungebrochenen Weges',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Jeder dritte Feuerball versengt Gegner in der Nähe des Ziels.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Krone des Letzten Scheiterhaufens',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Heilendes Licht schützt sein Ziel mit einem Schild in Höhe eines Teils der Heilung.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Siegel der Morgenwacht',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Jeder dritte Wildblitz stellt die Primärressource wieder her.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Wilder Mondverschluss',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Jeder dritte Waffentreffer lässt das Ziel bluten und stellt etwas Ressource wieder her.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Graukiefers Schneide',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Langer Zug oder Finsterer Schuss können ihr Ziel kurzzeitig zum Schweigen bringen.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Langbogen des Stillholzes',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Unter 35% Gesundheit gewährt eine kurze defensive Schutzwirkung.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Mantel der Gestohlenen Stunden',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Ein Todesstoß gewährt kurzzeitig Tempo.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Nachtglasfang',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Jeder vierte Lichtbogenblitz springt auf Gegner in der Nähe über.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Idol des Sturmerwachens',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Kritische Heilung erschafft kurzzeitig eine heilende Bodenfläche.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Ysoleis Wacht',
  'itemUi.procedural.legendaryLimit': 'Einzigartig angelegt: {count} legendäre Macht',
  'itemUi.procedural.legendaryPower': 'Legendäre Macht',
  'itemUi.procedural.nameFragment.deft': 'Geschickt',
  'itemUi.procedural.nameFragment.mighty': 'Mächtig',
  'itemUi.procedural.nameFragment.of_alacrity': 'der Eile',
  'itemUi.procedural.nameFragment.of_focus': 'des Fokus',
  'itemUi.procedural.nameFragment.of_precision': 'der Präzision',
  'itemUi.procedural.nameFragment.of_reaping': 'der Ernte',
  'itemUi.procedural.nameFragment.of_remembrance': 'der Erinnerung',
  'itemUi.procedural.nameFragment.of_striking': 'des Zuschlagens',
  'itemUi.procedural.nameFragment.sages': 'des Weisen',
  'itemUi.procedural.nameFragment.spiritual': 'Geistvoll',
  'itemUi.procedural.nameFragment.stalwart': 'Standhaft',
  'itemUi.procedural.nameFragment.warded': 'Geschützt',
  'itemUi.procedural.powerRollMilliseconds': 'Machtwurf: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Machtwurf: {value}',
  'itemUi.procedural.powerRollPercent': 'Machtwurf: {value}%',
  'itemUi.procedural.powerRollResource': 'Machtwurf: {value} Ressource',
  'itemUi.procedural.rareWord.ashen': 'Aschgrau',
  'itemUi.procedural.rareWord.bite': 'Biss',
  'itemUi.procedural.rareWord.blackfen': 'Schwarzmoor',
  'itemUi.procedural.rareWord.brand': 'Brandmal',
  'itemUi.procedural.rareWord.doom': 'Verderben',
  'itemUi.procedural.rareWord.grave': 'Grab',
  'itemUi.procedural.rareWord.mire': 'Morast',
  'itemUi.procedural.rareWord.oath': 'Eid',
  'itemUi.procedural.rareWord.promise': 'Versprechen',
  'itemUi.procedural.rareWord.storm': 'Sturm',
  'itemUi.procedural.rareWord.thorn': 'Dorn',
  'itemUi.procedural.rareWord.thread': 'Faden',
  'itemUi.procedural.rareWord.vigil': 'Wacht',
  'itemUi.procedural.rareWord.ward': 'Schutz',
  'itemUi.procedural.rareWord.whisper': 'Flüstern',
  'itemUi.procedural.rareWord.wyrm': 'Lindwurm',
  'itemUi.procedural.rarity.common': 'Gewöhnlich',
  'itemUi.procedural.rarity.epic': 'Episch',
  'itemUi.procedural.rarity.legendary': 'Legendär',
  'itemUi.procedural.rarity.magic': 'Magisch',
  'itemUi.procedural.rarity.mythic': 'Mythisch',
  'itemUi.procedural.rarity.rare': 'Selten',
  'itemUi.procedural.rollRangeAria': 'Möglicher Wurf von {min} bis {max}',
  'itemUi.stats.blockValue': 'Blockwert',
  'itemUi.stats.healthOnKill': 'Gesundheit bei Tötung',
  'itemUi.stats.manaOnKill': 'Mana bei Tötung',
  ...
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}, {rarity}, Gegenstandsstufe {level}, Menge {count}, verzaubertes Exemplar',
  ...
  'hudChrome.finder.raidItemLevels':
    'Gegenstandsstufe: Selten {rare} · Episch {epic} · Legendär {legendary}',
  'hudChrome.finder.raidRarityLine': 'Selten {rare}% · Episch {epic}% · Legendär {legendary}%',
  'hudChrome.finder.raidRewards': 'Vorschau der Nythraxis-Belohnungen',
