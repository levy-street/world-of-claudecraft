...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberforged_hauberk.name': 'Glutgeschmiedeter Kettenpanzer',
  'entities.items.emberforged_legguards.name': 'Glutgeschmiedete Beinschienen',
  'entities.items.emberforged_girdle.name': 'Glutgeschmiedeter Gürtel',
  'entities.items.cinderhide_vest.name': 'Weste aus Aschenleder',
  'entities.items.moltencore_maul.name': 'Schmelzkern-Streitkolben',
  'entities.items.brand_of_the_first_flame.name': 'Zeichen der Ersten Flamme',
  'entities.items.emberseal_of_the_covenant.name': 'Glutsiegel des gebrochenen Bundes',
  'entities.items.bloodember_band.name': 'Blutglut-Ring',
  'entities.items.ashcoil_signet.name': 'Aschenschlangen-Siegelring',
