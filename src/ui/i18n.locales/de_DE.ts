...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.mobile.customize": "Anpassen",
  "hudChrome.mobile.customizeTitle": "Steuerung anpassen",
  "hudChrome.mobile.customizeSlotAttack": "Standardangriff",
  "hudChrome.mobile.customizeSlotSkill": "Fähigkeit {n}",
  "hudChrome.mobile.customizeSlotUtility": "Unterstützung",
  "hudChrome.mobile.customizeDefault": "Klassenstandard",
  "hudChrome.mobile.customizeResetSlot": "Diesen Platz zurücksetzen",
  "hudChrome.mobile.customizeResetAll": "Alles auf Klassenstandard zurücksetzen",
  "hudChrome.mobile.customizeUpdated": "{slot} aktualisiert.",
  "hudChrome.mobile.customizeAllReset": "Steuerung auf Klassenstandard zurückgesetzt.",
  "hudChrome.options.touchControls": "Touch-Steuerung",
  "hudChrome.options.clusterHold": "Haltedauer zum Bearbeiten",
  "hudChrome.options.clusterHoldNote": "Wie lange eine Aktionsschaltfläche auf dem Bildschirm gehalten werden muss, bevor der Belegungs-Editor öffnet. Erhöhe den Wert, wenn der Editor beim schnellen Wirken von Fähigkeiten aufgeht.",
  "hudChrome.options.targetPriority": "Angriffsziel-Priorität",
  "hudChrome.options.targetPriorityNearest": "Nächstes",
  "hudChrome.options.targetPriorityLowestHp": "Niedrigste Gesundheit",
  "hudChrome.options.targetPriorityCurrent": "Aktuelles zuerst",
  "hudChrome.options.targetPriorityNote": "Was die Angriffs-Schaltfläche anvisiert, wenn du kein gültiges Ziel hast: den nächsten Gegner, den Gegner mit der niedrigsten Gesundheit in Reichweite oder behalte dein aktuelles Ziel, solange es gültig bleibt.",
  "hudChrome.options.aimAssist": "Intelligentes Wirken",
  "hudChrome.options.aimAssistNote": "Drücke eine offensive Fähigkeit, um sie auf dein Ziel zu wirken – oder auf den besten Gegner in der Nähe, falls du keins hast – und drehe dich zu ihm. Halte die Schaltfläche, um die Reichweite anzuzeigen; lass mit dem Finger neben der Schaltfläche los, um abzubrechen.",
  "hudChrome.options.touchReset": "Touch-Steuerung zurücksetzen",
  "hudChrome.options.touchResetDone": "Touch-Steuerung auf Standard zurückgesetzt.",
