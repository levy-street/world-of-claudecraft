...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Aschenwanderer-Sandalen',
  'entities.items.cinderarc_odrenns_rod.name': 'Glutbogen, Odrenns Rute',
  'entities.items.cindertoad_signet.name': 'Glutkröten-Siegelring',
  'entities.items.coalglow_band.name': 'Kohlenglut-Reif',
  'entities.items.crownforged_warleggings.name': 'Kronengeschmiedete Kriegsbeinkleider',
  'entities.items.glassblowers_shiv.name': 'Glasbläser-Shiv',
  'entities.items.glasswalker_treads.name': 'Glaswanderer-Tritte',
  'entities.items.nighttalon_prowlers.name': 'Nachtkrallen-Pirschstiefel',
  'entities.items.quenchsilk_cord.name': 'Härterseiden-Schnur',
  'entities.items.ring_of_the_first_quench.name': 'Ring der ersten Abschreckung',
  'entities.items.saans_stoking_iron.name': 'Saans Schüreisen',
  'entities.items.slag_tempered_sabatons.name': 'Schlackengehärtete Sabatons',
  'entities.items.slakeleather_belt.name': 'Löschledergürtel',
  'entities.items.sluicebearer.name': 'Schleusenträger',
  'entities.items.soulflame_kilt.name': 'Seelenflammen-Kilt',
  'entities.items.stokebrand_striders.name': 'Schürbrand-Tritte',
  'entities.items.stormcallers_legwraps.name': 'Beinwickel des Sturmberufers',
  'entities.items.the_even_temper.name': 'Das ausgeglichene Gemüt',
  'entities.items.twice_fired_slippers.name': 'Zweifach gebrannte Pantoffeln',
  'entities.items.twicetempered_girdle.name': 'Doppelt gehärteter Gürtel',
  'entities.items.crownforged_heartplate.name': 'Kronengeschmiedeter Herzpanzer',
  'entities.items.nighttalon_emberweave.name': 'Nachtkrallen-Glutgewebe',
  'entities.items.soulflame_vestments.name': 'Seelenflammengewänder',
  'entities.items.stormcallers_hauberk.name': 'Hauberk des Sturmberufers',
  'entities.items.volzharrs_knucklestone.name': 'Volzharrs Knöchelstein',
  'entities.items.magmastrider_greaves.name': 'Magmaschreiter-Beinschienen',
  'entities.items.footwraps_of_the_waking_floor.name': 'Fußwickel des erwachenden Bodens',
  'entities.items.forgeheat_cinch.name': 'Schmiedehitze-Gurt',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Kernbrecher, Herz des Unterbergs',
  'entities.items.the_last_restraint.name': 'Die letzte Fessel',
  'entities.items.band_of_the_ninth_quench.name': 'Band der neunten Abschreckung',
  'entities.items.moltenheart_chroma.name': 'Schmelzherz',
  'entities.itemSets.crownforged.bonus5': 'Erhöht die kritische Trefferchance um 3 %.',
  'entities.itemSets.nighttalon.bonus5': 'Erhöht die kritische Trefferchance um 3 %.',
  'entities.itemSets.soulflame.bonus5': 'Erhöht die kritische Zaubertrefferchance um 3 %.',
  'entities.itemSets.stormcallers.bonus5': 'Erhöht die kritische Zaubertrefferchance um 3 %.',
};
