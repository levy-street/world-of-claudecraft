...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.basic_mining_pick.name': 'Einfache Bergbauspitzhacke',
  'entities.items.basic_logging_axe.name': 'Einfache Holzfälleraxt',
  'entities.items.basic_herbalists_sickle.name': 'Einfache Kräutersichel',
