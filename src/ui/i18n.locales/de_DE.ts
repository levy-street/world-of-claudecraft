...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.dune_prowler_pelt.name': 'Fell des Dünenstreuners',
  'entities.items.glasswind_stinger.name': 'Glaswindstachel',
  'entities.items.stolen_relic.name': 'Gestohlenes Relikt',
  'entities.items.nameless_burial_shroud.name': 'Namenloses Grabtuch',
  'entities.items.storm_glass_core.name': 'Sturmglaskern',
  'entities.items.verdict_seal.name': 'Urteilssiegel',
  'entities.items.glasswind_husk.name': 'Glaswindpanzer',
  'entities.items.mirage_stalker_eye.name': 'Auge des Trugbildpirschers',
  'entities.items.dig_manifest.name': 'Grabungsmanifest',
  'entities.items.tomb_censer.name': 'Grabräuchergefäß',
  'entities.items.sentence_tablet.name': 'Urteilstafel',
  'entities.items.duststorm_heart.name': 'Staubsturmherz',
  'entities.items.ravager_hide.name': 'Verheererhaut',
  'entities.items.aqueduct_bronze.name': 'Bronzebeschlag des Aquädukts',
  'entities.items.judge_regalia.name': 'Ornat des Ersten Gerichts',
  'entities.items.sunbleached_fang.name': 'Sonnengebleichter Fangzahn',
  'entities.items.cracked_scarab_shell.name': 'Gesprungener Skarabäuspanzer',
  'entities.items.emberjaw_pelt.name': 'Fell der Glutmaul-Matriarchin',
  'entities.items.karns_funeral_mask.name': 'Karns Totenmaske',
  'entities.items.qesh_flatbread.name': 'Qesh-Fladenbrot',
  'entities.items.oasis_waterskin.name': 'Oasenwasserschlauch',
  'entities.items.spiced_scarab_skewer.name': 'Gewürzter Skarabäusspieß',
  'entities.items.duneweave_robe.name': 'Dünenweberobe',
  'entities.items.caravan_guard_hauberk.name': 'Karawanenwachen-Kettenhemd',
  'entities.items.prowlerhide_vest.name': 'Streunerhautweste',
  'entities.items.sandwalker_treads.name': 'Sandläufertritte',
  'entities.items.dunewatch_legguards.name': 'Dünenwacht-Beinschienen',
  'entities.items.qesh_khopesh.name': 'Qesh-Khopesch',
  'entities.items.judgestaff_of_ossara.name': 'Richterstab von Ossara',
  'entities.items.glasswind_talon.name': 'Glaswindklaue',
  'entities.items.emberjaw_prowlgrips.name': 'Glutmaul-Pirschgriffe',
  'entities.items.unburied_gravewraps.name': 'Grabwickel des Unbestatteten',
  'entities.items.sandmaw_scale_cuirass.name': 'Sandschlund-Schuppenharnisch',
  'entities.items.tyrantfang_edge.name': 'Tyrannenzahnklinge',
  'entities.items.palewidow_silk.name': 'Bleichwitwenseide',
  'entities.items.waterlogged_ledger.name': 'Durchnässtes Kontobuch',
  'entities.items.guildless_sigil.name': 'Siegel der Gildenlosen',
  'entities.items.silent_court_seal.name': 'Siegel des Stillen Hofes',
  'entities.items.duskmane_pelt_strip.name': 'Fellstreifen der Dämmermähne',
  'entities.items.palewidow_venom_sac.name': 'Giftdrüse der Bleichwitwe',
  'entities.items.quay_manifest.name': 'Durchnässtes Kaimanifest',
  'entities.items.wisplight_essence.name': 'Irrlichtessenz',
  'entities.items.drowned_toll_coin.name': 'Ertrunkene Zollmünze',
  'entities.items.cutthroat_contract.name': 'Halsabschneidervertrag',
  'entities.items.court_ledger_page.name': 'Seite aus dem Hofregister',
  'entities.items.frostpine_war_totem.name': 'Kriegstotem der Frostkiefer',
  'entities.items.rimeclaw_pelt.name': 'Reifklauenfell',
  'entities.items.duskmane_tuft.name': 'Dämmermähnenbüschel',
  'entities.items.guttering_wisp_mote.name': 'Flackerndes Irrlichtstäubchen',
  'entities.items.frostpine_charm.name': 'Frostkiefernamulett',
  'entities.items.palefang_pelt.name': 'Fell von Bleichzahn dem Stillen',
  'entities.items.grelnoks_frozen_idol.name': 'Grelnoks gefrorener Götze',
  'entities.items.nighthollow_black_bread.name': 'Nachthöhlen-Schwarzbrot',
  'entities.items.pinefrost_tea.name': 'Kiefernfrosttee',
  'entities.items.smoked_blackmere_eel.name': 'Geräucherter Schwarzsee-Aal',
  'entities.items.wispweave_robe.name': 'Irrlichtweberobe',
  'entities.items.quayguard_hauberk.name': 'Kaiwachen-Kettenhemd',
  'entities.items.duskstalker_vest.name': 'Dämmerpirscherweste',
  'entities.items.nightpath_treads.name': 'Nachtpfadtritte',
  'entities.items.blackriver_legguards.name': 'Schwarzfluss-Beinschienen',
  'entities.items.terracewatch_leggings.name': 'Terrassenwacht-Gamaschen',
  'entities.items.quays_cutlass.name': 'Kai-Entermesser',
  'entities.items.wispcaller_staff.name': 'Irrlichtrufer-Stab',
  'entities.items.whispersteel_stiletto.name': 'Flüsterstahl-Stilett',
  'entities.items.palefang_grips.name': 'Bleichzahngriffe',
  'entities.items.hoarbound_bindings.name': 'Fesseln des Reifgebundenen',
  'entities.items.forsworn_lamellar.name': 'Lamellenharnisch des Eidbrüchigen',
  'entities.items.forsworn_edge.name': 'Klinge des Eidbrüchigen',
  'entities.items.stolen_tithe_ledger.name': 'Gestohlenes Zehntbuch',
  'entities.items.granite_core_shard.name': 'Granitkernsplitter',
  'entities.items.legion_deserter_insignia.name': 'Abzeichen des Legionsdeserteurs',
  'entities.items.chewed_tithe_scrip.name': 'Zerkauter Zehntschein',
  'entities.items.candle_tax_tally.name': 'Kerzensteuer-Kerbholz',
  'entities.items.assay_office_seal.name': 'Siegel der Prüfkammer',
  'entities.items.legion_pay_manifest.name': 'Soldmanifest der Legion',
  'entities.items.prime_wolf_pelt.name': 'Erstklassiger Wolfspelz',
  'entities.items.wendigo_gallstone.name': 'Wendigo-Gallenstein',
  'entities.items.icehowler_ruff.name': 'Eisheuler-Halskrause',
  'entities.items.legion_quarrel_bundle.name': 'Bolzenbündel der Legion',
  'entities.items.clipped_imperial_coin.name': 'Beschnittene Reichsmünze',
  'entities.items.rimewoven_hide.name': 'Reifgewobene Haut',
  'entities.items.sellsword_pig_iron.name': 'Söldner-Roheisen',
  'entities.items.lean_wolf_haunch.name': 'Magere Wolfskeule',
  'entities.items.pilfered_ration_pack.name': 'Entwendetes Rationspaket',
  'entities.items.sellsword_requisition_chit.name': 'Söldner-Requisitionsschein',
  'entities.items.frostbrush_wolf_fang.name': 'Wolfszahn von Frostbusch',
  'entities.items.bent_legion_buckle.name': 'Verbogene Legionsschnalle',
  'entities.items.ogre_knuckle_dice.name': 'Ogerknöchel-Würfel',
  'entities.items.hoarfang_pelt.name': 'Fell des Reifzahn-Leittiers',
  'entities.items.kazriks_brass_whistle.name': 'Kazriks Messingpfeife',
  'entities.items.kaelspire_barley_loaf.name': 'Kaelspitz-Gerstenlaib',
  'entities.items.silverbrook_spring_water.name': 'Silberbach-Quellwasser',
  'entities.items.imperial_field_ration.name': 'Kaiserliche Feldration',
  'entities.items.imperial_clerks_robe.name': 'Robe des Reichsschreibers',
  'entities.items.kael_infantry_hauberk.name': 'Kael-Infanterie-Kettenhemd',
  'entities.items.wolfsward_hunting_jerkin.name': 'Wolfswart-Jagdwams',
  'entities.items.tithe_road_marchboots.name': 'Zehntstraßen-Marschstiefel',
  'entities.items.imperial_marcher_legguards.name': 'Beinschienen des Reichsmarschierers',
  'entities.items.kael_arming_sword.name': 'Kael-Anderthalbhänder',
  'entities.items.frosthelm_warstaff.name': 'Frosthelm-Kriegsstab',
  'entities.items.wolfsward_skinner.name': 'Wolfswart-Abhäuter',
  'entities.items.prefects_sealed_mantle.name': 'Versiegelter Mantel des Präfekten',
  'entities.items.huntmasters_winter_hood.name': 'Winterkapuze des Jagdmeisters',
  'entities.items.hoarfang_clawgrips.name': 'Reifzahn-Krallengriffe',
  'entities.items.overseers_candlewraps.name': 'Kerzenwickel des Aufsehers',
  'entities.items.oathbreakers_battleplate.name': 'Schlachtplatte des Eidbrechers',
  'entities.items.oathbreakers_greatblade.name': 'Großklinge des Eidbrechers',
  'entities.items.grey_shale_chip.name': 'Grauschiefersplitter',
  'entities.items.smuggled_trinket.name': 'Geschmuggelter Tand',
  'entities.items.barbed_thorn_husk.name': 'Widerhakige Dornenhülse',
  'entities.items.thornfen_tusk.name': 'Trollhauer des Dornenfenns',
  'entities.items.torn_caravan_banner.name': 'Zerrissenes Karawanenbanner',
  'entities.items.ironpass_rubble_core.name': 'Schuttkern des Eisenpasses',
  'entities.items.wyvern_tail_barb.name': 'Wyvernschwanzstachel',
  'entities.items.reagent_gland.name': 'Reagenziengeschwollene Drüse',
  'entities.items.fogged_lantern_glass.name': 'Beschlagenes Laternenglas',
  'entities.items.river_worn_idol.name': 'Flussgeschliffener Götze',
  'entities.items.gull_picked_bone.name': 'Möwenzerpickter Knochen',
  'entities.items.underway_hardtack.name': 'Unterweg-Hartkeks',
  'entities.items.smugglers_black_brew.name': 'Schmuggler-Schwarzgebräu',
  'entities.items.thornberry_loaf.name': 'Dornbeerenlaib',
  'entities.items.palisade_pine_tea.name': 'Palisaden-Kieferntee',
  'entities.items.tollhouse_stew.name': 'Zollhaus-Eintopf',
  'entities.items.ironpass_mulled_cider.name': 'Eisenpass-Glühmost',
  'entities.items.lanternfen_eel_skewer.name': 'Laternenfenn-Aalspieß',
  'entities.items.fogberry_tonic.name': 'Nebelbeerentonikum',
  'entities.items.bridgewatch_rations.name': 'Brückenwacht-Rationen',
  'entities.items.nameless_river_water.name': 'Wasser des namenlosen Flusses',
  'entities.items.smuggler_kings_softsteps.name': 'Leisetreter des Schmugglerkönigs',
  'entities.items.briarfather_bark_mitts.name': 'Borkenfäustlinge des Dornenvaters',
  'entities.items.skarns_war_harness.name': 'Skarns Kriegsgeschirr',
  'entities.items.colossus_mireheart_girdle.name': 'Schlammherz-Gürtel',
  'entities.items.bridgekeepers_tollstaff.name': 'Zollstab des Brückenwächters',
  'entities.items.melted_ration_tin.name': 'Geschmolzene Rationsdose',
  'entities.items.ashcaked_fang.name': 'Aschverkrusteter Fangzahn',
  'entities.items.ember_glass_shard.name': 'Glutglasscherbe',
  'entities.items.saltglass_shard.name': 'Salzglasscherbe',
  'entities.items.salt_crusted_chitin.name': 'Salzverkrustetes Chitin',
  'entities.items.bleached_bone_charm.name': 'Gebleichter Knochenanhänger',
  'entities.items.tarnished_prewar_coin.name': 'Angelaufene Vorkriegsmünze',
  'entities.items.sewer_silk_wad.name': 'Kanalseidenknäuel',
  'entities.items.gutter_hound_pelt.name': 'Gossenhundfell',
  'entities.items.cracked_salamander_scale.name': 'Gesprungene Salamanderschuppe',
  'entities.items.cooled_magma_bead.name': 'Erkaltete Magmaperle',
  'entities.items.slag_nugget.name': 'Schlackenklumpen',
  'entities.items.rusted_deserter_badge.name': 'Verrostetes Deserteurabzeichen',
  'entities.items.redspire_rock_shard.name': 'Rotspitz-Felssplitter',
  'entities.items.spire_stalker_claw.name': 'Klaue des Spitzenpirschers',
  'entities.items.cinderrest_ashcake.name': 'Aschekuchen von Glutrast',
  'entities.items.boiled_cistern_water.name': 'Abgekochtes Zisternenwasser',
  'entities.items.brinehollow_salt_jerky.name': 'Salzhöhlen-Dörrfleisch',
  'entities.items.desalted_waterskin.name': 'Entsalzter Wasserschlauch',
  'entities.items.gutter_stew.name': 'Gosseneintopf vom Exilmarkt',
  'entities.items.black_market_tea.name': 'Schwarzmarkttee',
  'entities.items.forgefall_hardtack.name': 'Schmiedefall-Hartkeks',
  'entities.items.coalfire_stout.name': 'Kohlenfeuer-Stout',
  'entities.items.waymeet_marching_bread.name': 'Wegtreff-Marschbrot',
  'entities.items.bitterroot_brew.name': 'Bitterwurzgebräu',
  'entities.items.revenant_cinderguard.name': 'Aschenwacht des Wiedergängers',
  'entities.items.marrowhide_leggings.name': 'Markhaut-Gamaschen',
  'entities.items.scavenger_kings_shiv.name': 'Schäbige Klinge des Aaskönigs',
  'entities.items.forgewyrm_scale_helm.name': 'Schmiedewyrm-Schuppenhelm',
  'entities.items.mantle_of_the_last_muster.name': 'Mantel des Letzten Aufgebots',
  'entities.items.scorched_banner_scrap.name': 'Versengter Bannerfetzen',
  'entities.items.melted_signet_ring.name': 'Geschmolzener Siegelring',
  'entities.items.cracked_horror_horn.name': 'Gesprungenes Schreckenshorn',
  'entities.items.bastion_hardtack.name': 'Bastion-Hartkeks',
  'entities.items.trucewater_flask.name': 'Waffenstillstandsflasche',
  'entities.items.ashguard_robe.name': 'Aschenwacht-Robe',
  'entities.items.breachwalker_jerkin.name': 'Breschengänger-Wams',
  'entities.items.bastion_plated_hauberk.name': 'Plattiertes Bastion-Kettenhemd',
  'entities.items.bastion_arming_sword.name': 'Bastion-Anderthalbhänder',
  'entities.items.mercenary_greatblade.name': 'Söldner-Großklinge',
  'entities.items.tithe_collectors_grasps.name': 'Griffe des Zehnteintreibers',
  ...
  'entities.items.forged_levy_papers.name': 'Gefälschte Aushebungspapiere',
  'entities.items.amnesty_petition.name': 'Nicht abgelegtes Amnestiegesuch',
  'entities.items.fort_pattern_kettle.name': 'Kessel nach Fortmuster',
  'entities.items.garnished_pay_pouch.name': 'Gepfändeter Soldbeutel',
  'entities.items.fault_line_core.name': 'Verwerfungskern',
  'entities.items.unstamped_duel_permit.name': 'Ungestempelte Duellerlaubnis',
  'entities.items.rimeclaw_tallow.name': 'Reifkrallentalg',
  'entities.items.rimeclaw_marrowbone.name': 'Reifkrallen-Markknochen',
  'entities.items.oathguard_plate_scrap.name': 'Plattenfragment der Eidwache',
  'entities.items.ninth_muster_roll.name': 'Geborgene Musterungsrolle',
  'entities.items.icehowler_haunch.name': 'Eisheuler-Keule',
  'entities.items.rimebound_core_ice.name': 'Reifgebundenes Kerneis',
  'entities.items.glacial_quench_ice.name': 'Gletscher-Abschreckeis',
  'entities.items.maren_calling_card.name': 'Visitenkarte des Hauses Maren',
  'entities.items.maldreks_route_ledger.name': 'Maldreks Routenbuch',
  'entities.items.grulks_iron_strongbox.name': 'Grulks Eisenschatulle',
  'entities.items.maren_duelling_mantle.name': 'Maren-Duellmantel',
  'entities.items.final_notice_wraps.name': 'Wickel der letzten Mahnung',
  'entities.items.pay_wardens_shoulderguards.name': 'Schulterschutz des Soldwarts',
  'entities.items.rimeshaft_foremans_cap.name': 'Kappe des Rimeshaft-Vorarbeiters',
  'entities.items.quarter_close_vestments.name': 'Gewänder des Quartalsabschlusses',
  'entities.items.assessors_lead_greaves.name': 'Bleierne Beinschienen des Schätzers',
  'entities.items.purse_wardens_coinbelt.name': 'Münzgurt des Beutelwarts',
  'entities.items.mothwing_dust.name': 'Mottenflügelstaub',
  'entities.items.silt_eel.name': 'Schlickaal',
  'entities.items.barge_chit.name': 'Durchweichte Kahnmarke',
  'entities.items.ferry_lantern_mote.name': 'Fährlaternenfunke',
  'entities.items.smugglers_tally_knot.name': 'Zählknoten des Schmugglers',
  'entities.items.forged_weir_pass.name': 'Gefälschter Wehrpass',
  'entities.items.sunken_ration_tin.name': 'Versunkene Rationsdose',
  'entities.items.hollow_toll_scrip.name': 'Hohler Zollschein',
  'entities.items.rimeclaw_haunch.name': 'Reifkrallen-Keule',
  'entities.items.rimebound_fetish.name': 'Reifgebundener Fetisch',
  'entities.items.frostpine_tallow.name': 'Frostkieferntalg',
  'entities.items.forsworn_oath_knife.name': 'Eidmesser der Abgeschworenen',
  'entities.items.shadowbound_cipher.name': 'Schattengebundene Chiffre',
  'entities.items.vessiks_little_book.name': 'Vessiks Büchlein',
  'entities.items.weirwatch_wraps.name': 'Wickel der Wehrwacht',
  'entities.items.lodgewalk_boots.name': 'Logenstiefel',
  'entities.items.unbroken_wardstone.name': 'Unversehrter Wardstein',
  'entities.items.vault_ward_core.name': 'Gewölbe-Wardkern',
  'entities.items.temple_offering_bowl.name': 'Opferschale des Tempels',
  'entities.items.graven_name_stone.name': 'Gravierter Namensstein',
  'entities.items.stalker_haunch.name': 'Pirscher-Keule',
  'entities.items.heretic_creed_page.name': 'Verbrannte Credoseite',
  'entities.items.heretic_brand_iron.name': 'Ketzer-Brandeisen',
  'entities.items.heretic_writ.name': 'Ketzerschrift',
  'entities.items.first_court_sigil.name': 'Siegel des Ersten Hofes',
  'entities.items.duneglass_heart.name': 'Dünenglasherz',
  'entities.items.unshattered_fulgurite.name': 'Unzerbrochener Fulgurit',
  'entities.items.flameseer_ash_creed.name': 'Tafel des Aschencredos',
  'entities.items.flameseer_ember_phial.name': 'Glutphiole',
  'entities.items.dawnward_censer.name': 'Morgenwacht-Räuchergefäß',
  'entities.items.stolen_water_cask.name': 'Versiegeltes Wasserfass',
  'entities.items.duskwater_oathmark.name': 'Duskwater-Eidmarke',
  'entities.items.caravan_toll_tally.name': 'Versiegelte Zollkerbe',
  'entities.items.tyrant_spoor.name': 'Spurenabguss des Tyrannen',
  'entities.items.oxbone_toll.name': 'Ochsenknochen-Zollkerbe',
  'entities.items.cartographers_map.name': 'Die Karte des Ersten Kartographen',
  'entities.items.templestone_shard.name': 'Tempelsteinscherbe',
  'entities.items.fulgurite_splinter.name': 'Fulguritsplitter',
  'entities.items.charred_censer_chain.name': 'Verkohlte Räucherkette',
  'entities.items.wardens_stone_heart.name': 'Ashkerats Steinherz',
  'entities.items.first_meridian_compass.name': 'Kompass des Ersten Meridians',
  'entities.items.seatstone_flatbread.name': 'Fladenbrot des Sitzes',
  'entities.items.seatwell_waterskin.name': 'Wasserschlauch des Sitzbrunnens',
  'entities.items.lastwater_jerky.name': 'Letztwasser-Dörrfleisch',
  'entities.items.lastwater_skin.name': 'Letztwasser-Schlauch',
  'entities.items.vaultkeepers_handwraps.name': 'Handwickel des Gewölbewarts',
  'entities.items.sahrs_penitent_leggings.name': 'Sahrs Büßer-Beinlinge',
  'entities.items.wardens_granite_edge.name': 'Granitschneide des Wardens',
  'entities.items.staff_of_the_sunken_court.name': 'Stab des Versunkenen Hofes',
  'entities.items.duneglass_shiv.name': 'Dünenglas-Schiene',
  'entities.items.lastwater_roadmail.name': 'Letztwasser-Wegkette',
  'entities.items.duskwatch_robe.name': 'Robe der Dämmerwacht',
  'entities.items.raiders_dust_jerkin.name': 'Staubiger Räuberwams',
  'entities.items.ashkerat_greaves.name': 'Ashkerats Beinschienen',
  'entities.items.cartographers_windwraps.name': 'Windwickel des Kartographen',
  'entities.items.unlit_silk_gland.name': 'Lichtlose Seidendrüse',
  'entities.items.veskals_fang.name': 'Veskals Fangzahn',
  'entities.items.broodmother_carapace_guard.name': 'Brutmutter-Panzerwehr',
  'entities.items.condensed_mist_heart.name': 'Verdichtetes Nebelherz',
  'entities.items.mistfathers_knot.name': 'Der Knoten des Nebelvaters',
  'entities.items.fogwalker_treads.name': 'Nebelgänger-Tritte',
