...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'loading.reconnecting': "Verbindung verloren. Verbindung wird wiederhergestellt...",
  'hudChrome.crafting.close': "Herstellung schließen",
  'hudChrome.crafting.craft': "Herstellen",
  'hudChrome.crafting.craftedToast': "Hergestellt: {name}",
  'hudChrome.crafting.empty': "Noch keine Rezepte bekannt.",
  'hudChrome.crafting.insufficientMaterials': "Ihr habt die Materialien dafür nicht.",
  'hudChrome.crafting.reagentLine': "{name} x{have}/{required}",
  'hudChrome.crafting.reagentsNeeded': "Benötigt:",
  'hudChrome.crafting.resultAria': "{name} herstellen",
  'hudChrome.crafting.title': "Herstellung",
  ...
  'hudChrome.mobile.actionRing': "Kampfaktionen",
  'hudChrome.mobile.spellbookPageLabel': "Seite {page}",
  'hudChrome.mobile.targetCycle': "Ziel wechseln",
  'hudChrome.mobile.targetCycleShort': "Ziel",
  'hudChrome.options.mobileCameraJoystick': "Kamera-Joystick",
  'hudChrome.options.mobileLeftHanded': "Linkshändiges Layout",
};
