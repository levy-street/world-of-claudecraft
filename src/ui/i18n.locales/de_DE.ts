...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.boundstone_bulwark.name': 'Bollwerk aus gebundenem Stein',
  'entities.items.drownedmoon_aegis.name': 'Ägis des ertrunkenen Mondes',
  'entities.items.gravewyrm_bulwark.name': 'Bollwerk des Grabwyrms',
