...
export const it_IT: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Sandali Passacenere',
  'entities.items.cinderarc_odrenns_rod.name': 'Arco di Brace, verga di Odrenn',
  'entities.items.cindertoad_signet.name': 'Sigillo del Rospo di Brace',
  'entities.items.coalglow_band.name': 'Anello del Bagliore di Carbone',
  'entities.items.crownforged_warleggings.name': 'Gambali da Guerra Forgiacorona',
  'entities.items.glassblowers_shiv.name': 'Stiletto del Soffiatore di Vetro',
  'entities.items.glasswalker_treads.name': 'Calzari Passavetro',
  'entities.items.nighttalon_prowlers.name': 'Calzari Artiglio Notturno',
  'entities.items.quenchsilk_cord.name': 'Cordone di Seta Temprata',
  'entities.items.ring_of_the_first_quench.name': 'Anello della Prima Tempra',
  'entities.items.saans_stoking_iron.name': 'Attizzatoio di Saan',
  'entities.items.slag_tempered_sabatons.name': 'Calzari Temprati nella Scoria',
  'entities.items.slakeleather_belt.name': 'Cintura di Cuoio Temprato',
  'entities.items.sluicebearer.name': 'Portachiusa',
  'entities.items.soulflame_kilt.name': 'Gonnellino Fiammanima',
  'entities.items.stokebrand_striders.name': 'Calzari del Marchio Ardente',
  'entities.items.stormcallers_legwraps.name': 'Fasce da gamba del Chiamatempeste',
