...
export const it_IT: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Bastone di frassino',
  'entities.items.gravecaller_cloth_handwraps.name': 'Fasce per mani di stoffa del Gravecaller',
  'entities.items.gravecaller_cloth_hood.name': 'Cappuccio di stoffa del Gravecaller',
  'entities.items.gravecaller_cloth_leggings.name': 'Gambali di stoffa del Gravecaller',
  'entities.items.gravecaller_cloth_mantle.name': 'Mantello di stoffa del Gravecaller',
  'entities.items.gravecaller_cloth_raiment.name': 'Vesti di stoffa del Gravecaller',
  'entities.items.gravecaller_cloth_sash.name': 'Fascia di stoffa del Gravecaller',
  'entities.items.gravecaller_cloth_slippers.name': 'Pantofole di stoffa del Gravecaller',
  'entities.items.gravecaller_focus.name': 'Focus del Gravecaller',
  'entities.items.gravecaller_pendant.name': 'Pendente del Gravecaller',
  'entities.items.gravecaller_ring.name': 'Anello del Gravecaller',
  'entities.items.gravecaller_wand.name': 'Bacchetta del Gravecaller',
  'entities.items.iron_broadsword.name': 'Spadone di ferro',
  'entities.items.iron_flanged_mace.name': 'Mazza flangiata di ferro',
  'entities.items.mirefen_dirk.name': 'Pugnale di Mirefen',
  'entities.items.mirefen_hunting_bow.name': 'Arco da caccia di Mirefen',
  'entities.items.mirefen_leather_belt.name': 'Cintura di cuoio di Mirefen',
  'entities.items.mirefen_leather_boots.name': 'Stivali di cuoio di Mirefen',
  'entities.items.mirefen_leather_gloves.name': 'Guanti di cuoio di Mirefen',
  'entities.items.mirefen_leather_hood.name': 'Cappuccio di cuoio di Mirefen',
  'entities.items.mirefen_leather_jerkin.name': 'Giaco di cuoio di Mirefen',
  'entities.items.mirefen_leather_leggings.name': 'Gambali di cuoio di Mirefen',
  'entities.items.mirefen_leather_shoulderguards.name': 'Spallacci di cuoio di Mirefen',
  'entities.items.thornpeak_bulwark.name': 'Baluardo di Thornpeak',
  'entities.items.thornpeak_crossbow.name': 'Balestra di Thornpeak',
  'entities.items.thornpeak_mail_chest.name': 'Corazza di maglia di Thornpeak',
  'entities.items.thornpeak_mail_gauntlets.name': "Guanti d'arme di maglia di Thornpeak",
  'entities.items.thornpeak_mail_girdle.name': 'Cinturone di maglia di Thornpeak',
  'entities.items.thornpeak_mail_helm.name': 'Elmo di maglia di Thornpeak',
  'entities.items.thornpeak_mail_legguards.name': 'Gambali di maglia di Thornpeak',
  'entities.items.thornpeak_mail_pauldrons.name': 'Spallacci di maglia di Thornpeak',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Bisogno non è disponibile perché la tua classe non può equipaggiare questo oggetto.',
  'itemUi.lootRoll.needUnavailablePower':
    'Bisogno non è disponibile perché questo potere leggendario è riservato a un’altra classe.',
  'itemUi.procedural.advancedDetailsHint':
    'Tieni premuto {key} per mostrare i possibili intervalli dei tiri.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Ogni quarto Dardo di Tenebra marchia il bersaglio, aumentando i danni da Ombra subiti.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Sigillo del Vincolacenere',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Ogni secondo incantesimo che infligge danni rintocca attorno al bersaglio.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Campana del Nono Rintocco',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Percorrere 15 iarde conferisce un breve aumento della velocità di movimento.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name':
    'Stivali della Strada Ininterrotta',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Ogni terzo Dardo di Braci brucia i nemici vicini al bersaglio.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Corona dell’Ultima Pira',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Luce Risanatrice protegge il destinatario con uno scudo pari a una parte delle cure.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Sigillo dell’Alba',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Ogni terzo Dardo Silvano ripristina la risorsa primaria.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Fermaglio della Luna Ferale',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Ogni terzo colpo con arma fa sanguinare il bersaglio e ripristina un po’ di risorsa.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Lama di Mascellagrigia',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Tiro Teso o Tiro Nefasto possono silenziare brevemente il bersaglio.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Arco Lungo del Bosco Muto',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Scendere sotto il 35% di salute conferisce una breve protezione difensiva.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Manto delle Ore Rubate',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Un’uccisione conferisce un breve aumento della celerità.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Zanna di Vetro Notturno',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Ogni quarto Dardo Folgorante si propaga ai nemici vicini.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Idolo del Risveglio della Tempesta',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Una cura critica crea per breve tempo un’area ristoratrice sul terreno.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Veglia di Ysolei',
  'itemUi.procedural.legendaryLimit': 'Unico equipaggiabile: {count} potere leggendario',
  'itemUi.procedural.legendaryPower': 'Potere leggendario',
  'itemUi.procedural.nameFragment.deft': 'Abile',
  'itemUi.procedural.nameFragment.mighty': 'Possente',
  'itemUi.procedural.nameFragment.of_alacrity': 'della Prontezza',
  'itemUi.procedural.nameFragment.of_focus': 'della Concentrazione',
  'itemUi.procedural.nameFragment.of_precision': 'della Precisione',
  'itemUi.procedural.nameFragment.of_reaping': 'della Mietitura',
  'itemUi.procedural.nameFragment.of_remembrance': 'del Ricordo',
  'itemUi.procedural.nameFragment.of_striking': 'dei Colpi',
  'itemUi.procedural.nameFragment.sages': 'del Saggio',
  'itemUi.procedural.nameFragment.spiritual': 'Spirituale',
  'itemUi.procedural.nameFragment.stalwart': 'Saldo',
  'itemUi.procedural.nameFragment.warded': 'Protetto',
  'itemUi.procedural.powerRollMilliseconds': 'Tiro del potere: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Tiro del potere: {value}',
  'itemUi.procedural.powerRollPercent': 'Tiro del potere: {value}%',
  'itemUi.procedural.powerRollResource': 'Tiro del potere: {value} risorsa',
  'itemUi.procedural.rareWord.ashen': 'Cinereo',
  'itemUi.procedural.rareWord.bite': 'Morso',
  'itemUi.procedural.rareWord.blackfen': 'Palude Nera',
  'itemUi.procedural.rareWord.brand': 'Marchio',
  'itemUi.procedural.rareWord.doom': 'Sventura',
  'itemUi.procedural.rareWord.grave': 'Tomba',
  'itemUi.procedural.rareWord.mire': 'Pantano',
  'itemUi.procedural.rareWord.oath': 'Giuramento',
  'itemUi.procedural.rareWord.promise': 'Promessa',
  'itemUi.procedural.rareWord.storm': 'Tempesta',
  'itemUi.procedural.rareWord.thorn': 'Spina',
  'itemUi.procedural.rareWord.thread': 'Filo',
  'itemUi.procedural.rareWord.vigil': 'Veglia',
  'itemUi.procedural.rareWord.ward': 'Protezione',
  'itemUi.procedural.rareWord.whisper': 'Sussurro',
  'itemUi.procedural.rareWord.wyrm': 'Dragone',
  'itemUi.procedural.rarity.common': 'Comune',
  'itemUi.procedural.rarity.epic': 'Epico',
  'itemUi.procedural.rarity.legendary': 'Leggendario',
  'itemUi.procedural.rarity.magic': 'Magico',
  'itemUi.procedural.rarity.mythic': 'Mitico',
  'itemUi.procedural.rarity.rare': 'Raro',
  'itemUi.procedural.rollRangeAria': 'Tiro possibile da {min} a {max}',
  'itemUi.stats.blockValue': 'Valore di blocco',
  'itemUi.stats.healthOnKill': 'Salute per uccisione',
  'itemUi.stats.manaOnKill': 'Mana per uccisione',
  'itemUi.stats.weaponDps': 'Danni dell’arma al secondo',
  'itemUi.stats.weaponMax': 'Danni massimi dell’arma',
  'itemUi.stats.weaponMin': 'Danni minimi dell’arma',
  ...
  'hudChrome.enchanting.replaceConfirmKeeps': 'Conservato: {kept}',
  'hudChrome.enchanting.replaceConfirmKeepsBond': 'Legame su commissione',
  'hudChrome.enchanting.replaceConfirmKeepsMasterwork': 'Bonus capolavoro',
  'hudChrome.enchanting.replaceConfirmKeepsSigner': "Marchio dell'artigiano",
  'hudChrome.enchanting.salvagedYield': 'Smantelli {item} ottenendo {material}.',
  'hudChrome.enchanting.salvagedYieldQty': 'Smantelli {item} ottenendo {material} x{qty}.',
  'hudChrome.gathering.harvestLine': 'Prelevi: {name}.',
  'hudChrome.gathering.harvestLineQty': 'Prelevi: {name} x{qty}.',
