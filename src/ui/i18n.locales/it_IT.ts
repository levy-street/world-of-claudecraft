...
export const it_IT: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.boundstone_bulwark.name': 'Baluardo di pietra vincolata',
  'entities.items.drownedmoon_aegis.name': 'Egida della Luna Sommersa',
  'entities.items.gravewyrm_bulwark.name': 'Baluardo del dragone sepolcrale',
