...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Cajado de freixo',
  'entities.items.gravecaller_cloth_handwraps.name':
    'Munhequeiras de tecido do Chamador de Túmulos',
  'entities.items.gravecaller_cloth_hood.name': 'Capuz de tecido do Chamador de Túmulos',
  'entities.items.gravecaller_cloth_leggings.name': 'Calças de tecido do Chamador de Túmulos',
  'entities.items.gravecaller_cloth_mantle.name': 'Manto de tecido do Chamador de Túmulos',
  'entities.items.gravecaller_cloth_raiment.name': 'Vestes de tecido do Chamador de Túmulos',
  'entities.items.gravecaller_cloth_sash.name': 'Faixa de tecido do Chamador de Túmulos',
  'entities.items.gravecaller_cloth_slippers.name': 'Sapatilhas de tecido do Chamador de Túmulos',
  'entities.items.gravecaller_focus.name': 'Foco do Chamador de Túmulos',
  'entities.items.gravecaller_pendant.name': 'Pingente do Chamador de Túmulos',
  'entities.items.gravecaller_ring.name': 'Anel do Chamador de Túmulos',
  'entities.items.gravecaller_wand.name': 'Varinha do Chamador de Túmulos',
  'entities.items.iron_broadsword.name': 'Espadão de ferro',
  'entities.items.iron_flanged_mace.name': 'Maça flangeada de ferro',
  'entities.items.mirefen_dirk.name': 'Punhal de Mirefen',
  'entities.items.mirefen_hunting_bow.name': 'Arco de caça de Mirefen',
  'entities.items.mirefen_leather_belt.name': 'Cinto de couro de Mirefen',
  'entities.items.mirefen_leather_boots.name': 'Botas de couro de Mirefen',
  'entities.items.mirefen_leather_gloves.name': 'Luvas de couro de Mirefen',
  'entities.items.mirefen_leather_hood.name': 'Capuz de couro de Mirefen',
  'entities.items.mirefen_leather_jerkin.name': 'Gibão de couro de Mirefen',
  'entities.items.mirefen_leather_leggings.name': 'Calças de couro de Mirefen',
  'entities.items.mirefen_leather_shoulderguards.name': 'Ombreiras de couro de Mirefen',
  'entities.items.thornpeak_bulwark.name': 'Baluarte de Thornpeak',
  'entities.items.thornpeak_crossbow.name': 'Besta de Thornpeak',
  'entities.items.thornpeak_mail_chest.name': 'Peitoral de malha de Thornpeak',
  'entities.items.thornpeak_mail_gauntlets.name': 'Manoplas de malha de Thornpeak',
  'entities.items.thornpeak_mail_girdle.name': 'Cinturão de malha de Thornpeak',
  'entities.items.thornpeak_mail_helm.name': 'Elmo de malha de Thornpeak',
  'entities.items.thornpeak_mail_legguards.name': 'Guarda-pernas de malha de Thornpeak',
  'entities.items.thornpeak_mail_pauldrons.name': 'Espaldeiras de malha de Thornpeak',
  'entities.items.thornpeak_mail_sabatons.name': 'Escarpes de malha de Thornpeak',
  'entities.items.thornpeak_polearm.name': 'Arma de haste de Thornpeak',
  'entities.items.thornpeak_war_axe.name': 'Machado de guerra de Thornpeak',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Necessidade está indisponível porque sua classe não pode equipar este item.',
  'itemUi.lootRoll.needUnavailablePower':
    'Necessidade está indisponível porque este poder lendário é restrito a outra classe.',
  'itemUi.procedural.advancedDetailsHint':
    'Segure {key} para mostrar os intervalos de rolagem possíveis.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Cada quarto Raio Lúgubre marca o alvo para receber dano de Sombra adicional.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Selo do Vinculacinzas',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Cada segundo feitiço de dano ressoa ao redor do alvo.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Sino do Nono Toque',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Percorrer 15 jardas concede um breve aumento de velocidade de movimento.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Botas da Estrada Inquebrável',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Cada terceiro Raio de Brasa incendeia os inimigos próximos do alvo.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Coroa da Última Pira',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Luz Restauradora protege o alvo com um escudo equivalente a uma parte da cura.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Sinete da Alvorada',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Cada terceiro Raio Selvagem restaura o recurso primário.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Fecho da Lua Feral',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Cada terceiro acerto com arma faz o alvo sangrar e restaura um pouco de recurso.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Gume de Maxilacinzento',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Puxada Longa ou Tiro Vil podem silenciar brevemente o alvo.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Arco Longo da Mata Silente',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Ficar abaixo de 35% de vida concede uma breve proteção defensiva.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Manto das Horas Roubadas',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Uma morte concede um breve aumento de aceleração.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Presa de Vidro Noturno',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Cada quarto Raio em Arco salta para inimigos próximos.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Ídolo do Despertar da Tempestade',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Uma cura crítica cria brevemente uma área restauradora no chão.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Vigília de Ysolei',
  'itemUi.procedural.legendaryLimit': 'Único equipado: {count} poder lendário',
  'itemUi.procedural.legendaryPower': 'Poder lendário',
  'itemUi.procedural.nameFragment.deft': 'Hábil',
  'itemUi.procedural.nameFragment.mighty': 'Poderoso',
  'itemUi.procedural.nameFragment.of_alacrity': 'da Presteza',
  'itemUi.procedural.nameFragment.of_focus': 'do Foco',
  'itemUi.procedural.nameFragment.of_precision': 'da Precisão',
  'itemUi.procedural.nameFragment.of_reaping': 'da Colheita',
  'itemUi.procedural.nameFragment.of_remembrance': 'da Lembrança',
  'itemUi.procedural.nameFragment.of_striking': 'do Golpe',
  'itemUi.procedural.nameFragment.sages': 'do Sábio',
  'itemUi.procedural.nameFragment.spiritual': 'Espiritual',
  'itemUi.procedural.nameFragment.stalwart': 'Resoluto',
  'itemUi.procedural.nameFragment.warded': 'Protegido',
  'itemUi.procedural.powerRollMilliseconds': 'Rolagem de poder: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Rolagem de poder: {value}',
  'itemUi.procedural.powerRollPercent': 'Rolagem de poder: {value}%',
  'itemUi.procedural.powerRollResource': 'Rolagem de poder: {value} de recurso',
  'itemUi.procedural.rareWord.ashen': 'Cinzento',
  'itemUi.procedural.rareWord.bite': 'Mordida',
  'itemUi.procedural.rareWord.blackfen': 'Pântano Negro',
  'itemUi.procedural.rareWord.brand': 'Marca',
  'itemUi.procedural.rareWord.doom': 'Perdição',
  'itemUi.procedural.rareWord.grave': 'Túmulo',
  'itemUi.procedural.rareWord.mire': 'Lamaçal',
  'itemUi.procedural.rareWord.oath': 'Juramento',
  'itemUi.procedural.rareWord.promise': 'Promessa',
  'itemUi.procedural.rareWord.storm': 'Tempestade',
  'itemUi.procedural.rareWord.thorn': 'Espinho',
  'itemUi.procedural.rareWord.thread': 'Fio',
  'itemUi.procedural.rareWord.vigil': 'Vigília',
  'itemUi.procedural.rareWord.ward': 'Proteção',
  'itemUi.procedural.rareWord.whisper': 'Sussurro',
  'itemUi.procedural.rareWord.wyrm': 'Serpe',
  'itemUi.procedural.rarity.common': 'Comum',
  'itemUi.procedural.rarity.epic': 'Épico',
  'itemUi.procedural.rarity.legendary': 'Lendário',
  'itemUi.procedural.rarity.magic': 'Mágico',
  'itemUi.procedural.rarity.mythic': 'Mítico',
  'itemUi.procedural.rarity.rare': 'Raro',
  'itemUi.procedural.rollRangeAria': 'Rolagem possível de {min} a {max}',
  'itemUi.stats.blockValue': 'Valor de bloqueio',
  'itemUi.stats.healthOnKill': 'Vida ao matar',
  'itemUi.stats.manaOnKill': 'Mana ao matar',
  'itemUi.stats.weaponDps': 'Dano de arma por segundo',
  'itemUi.stats.weaponMax': 'Dano máximo da arma',
  'itemUi.stats.weaponMin': 'Dano mínimo da arma',
  ...
  'hudChrome.enchanting.replaceConfirmKeeps': 'Mantido: {kept}',
  'hudChrome.enchanting.replaceConfirmKeepsBond': 'Vínculo de encomenda',
  'hudChrome.enchanting.replaceConfirmKeepsMasterwork': 'Bônus de obra-prima',
  'hudChrome.enchanting.replaceConfirmKeepsSigner': 'Marca do artesão',
  'hudChrome.enchanting.salvagedYield': 'Você desmonta {item} e obtém {material}.',
  'hudChrome.enchanting.salvagedYieldQty': 'Você desmonta {item} e obtém {material} x{qty}.',
  'hudChrome.gathering.harvestLine': 'Você colhe: {name}.',
  'hudChrome.gathering.harvestLineQty': 'Você colhe: {name} x{qty}.',
