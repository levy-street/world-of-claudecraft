...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Sandálias Anda-Cinzas',
  'entities.items.cinderarc_odrenns_rod.name': 'Arco de Brasa, Bastão de Odrenn',
  'entities.items.cindertoad_signet.name': 'Sinete do Sapo de Brasa',
  'entities.items.coalglow_band.name': 'Anel do Brilho de Carvão',
  'entities.items.crownforged_warleggings.name': 'Perneiras de Guerra Forjacoroa',
  'entities.items.glassblowers_shiv.name': 'Faca do Soprador de Vidro',
  'entities.items.glasswalker_treads.name': 'Botas Anda-Vidro',
  'entities.items.nighttalon_prowlers.name': 'Botas de Espreita Garra Noturna',
  'entities.items.quenchsilk_cord.name': 'Cordão de Seda Temperada',
  'entities.items.ring_of_the_first_quench.name': 'Anel da Primeira Têmpera',
  'entities.items.saans_stoking_iron.name': 'Atiçador de Saan',
  'entities.items.slag_tempered_sabatons.name': 'Escarpes Temperados em Escória',
  'entities.items.slakeleather_belt.name': 'Cinto de Couro Temperado',
  'entities.items.sluicebearer.name': 'Portador da Comporta',
  'entities.items.soulflame_kilt.name': "Kilt Chama d'Alma",
  'entities.items.stokebrand_striders.name': 'Botas Marca de Braseiro',
  'entities.items.stormcallers_legwraps.name': 'Faixas de Perna do Chamatormenta',
  'entities.items.the_even_temper.name': 'A Têmpera Equilibrada',
  'entities.items.twice_fired_slippers.name': 'Pantufas de Dupla Queima',
  'entities.items.twicetempered_girdle.name': 'Cinturão de Dupla Têmpera',
  'entities.items.crownforged_heartplate.name': 'Peitoral Coração Forjacoroa',
  'entities.items.nighttalon_emberweave.name': 'Trama de Brasas Garra Noturna',
  'entities.items.soulflame_vestments.name': 'Vestes Chama da Alma',
  'entities.items.stormcallers_hauberk.name': 'Cota do Invocador de Tempestades',
  'entities.items.volzharrs_knucklestone.name': 'Pedra de Punho de Volzharr',
  'entities.items.magmastrider_greaves.name': 'Grevas Passomagma',
  'entities.items.footwraps_of_the_waking_floor.name': 'Faixas do Chão Desperto',
  'entities.items.forgeheat_cinch.name': 'Cinturão Calor da Forja',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Quebra-núcleo, Coração do Submonte',
  'entities.items.the_last_restraint.name': 'A Última Restrição',
  'entities.items.band_of_the_ninth_quench.name': 'Anel da Nona Têmpera',
  'entities.items.moltenheart_chroma.name': 'Coração Fundido',
  'entities.itemSets.crownforged.bonus5': 'Aumenta em 3% a chance de acerto crítico.',
