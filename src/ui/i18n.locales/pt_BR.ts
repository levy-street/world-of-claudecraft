...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberforged_hauberk.name': 'Cota de Malha Forjada em Brasas',
  'entities.items.emberforged_legguards.name': 'Perneiras Forjadas em Brasas',
  'entities.items.emberforged_girdle.name': 'Cinto Forjado em Brasas',
  'entities.items.cinderhide_vest.name': 'Colete de Couro de Cinzas',
  'entities.items.moltencore_maul.name': 'Maça do Núcleo Fundido',
  'entities.items.brand_of_the_first_flame.name': 'Tição da Primeira Chama',
  'entities.items.emberseal_of_the_covenant.name': 'Selo de Brasas do Pacto Rompido',
  'entities.items.bloodember_band.name': 'Anel de Brasa Sangrenta',
  'entities.items.ashcoil_signet.name': 'Anel-Sinete da Espiral de Cinzas',
