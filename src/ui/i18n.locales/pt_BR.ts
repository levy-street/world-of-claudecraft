...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.boundstone_bulwark.name': 'Baluarte de Pedra Vinculada',
  'entities.items.drownedmoon_aegis.name': 'Égide da Lua Afogada',
  'entities.items.gravewyrm_bulwark.name': 'Baluarte da Serpe Sepulcral',
