...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Dép Bộ Hành Tro',
  'entities.items.cinderarc_odrenns_rod.name': 'Cung Than Hồng, Trượng của Odrenn',
  'entities.items.cindertoad_signet.name': 'Ấn Nhẫn Cóc Than Hồng',
  'entities.items.coalglow_band.name': 'Nhẫn Ánh Than',
  'entities.items.crownforged_warleggings.name': 'Giáp Chân Chiến Trận Rèn Vương Miện',
  'entities.items.glassblowers_shiv.name': 'Dao Găm của Thợ Thổi Thủy Tinh',
  'entities.items.glasswalker_treads.name': 'Giày Bộ Hành Kính',
  'entities.items.nighttalon_prowlers.name': 'Giày Rình Dạ Trảo',
  'entities.items.quenchsilk_cord.name': 'Dây Lụa Tôi',
  'entities.items.ring_of_the_first_quench.name': 'Nhẫn Lần Tôi Đầu Tiên',
  'entities.items.saans_stoking_iron.name': 'Que Khều Lò của Saan',
  'entities.items.slag_tempered_sabatons.name': 'Ủng Thép Tôi Bằng Xỉ',
  'entities.items.slakeleather_belt.name': 'Thắt Lưng Da Tôi',
  'entities.items.sluicebearer.name': 'Kẻ Mang Cửa Cống',
  'entities.items.soulflame_kilt.name': 'Váy Hồn Hỏa',
  'entities.items.stokebrand_striders.name': 'Giày Dấu Khều Lửa',
  'entities.items.stormcallers_legwraps.name': 'Vải Quấn Chân của Triệu Bão Sư',
  'entities.items.the_even_temper.name': 'Độ Tôi Cân Bằng',
  'entities.items.twice_fired_slippers.name': 'Dép Nung Hai Lần',
  'entities.items.twicetempered_girdle.name': 'Đai Tôi Hai Lần',
  'entities.items.crownforged_heartplate.name': 'Giáp Ngực Tim Rèn Vương Miện',
  'entities.items.nighttalon_emberweave.name': 'Vải Dệt Than Hồng Móng Đêm',
  'entities.items.soulflame_vestments.name': 'Lễ Phục Lửa Linh Hồn',
  'entities.items.stormcallers_hauberk.name': 'Áo Giáp Lưới Người Gọi Bão',
  'entities.items.volzharrs_knucklestone.name': 'Đá Đấm Tay của Volzharr',
  'entities.items.magmastrider_greaves.name': 'Giáp Chân Bước Dung Nham',
  'entities.items.footwraps_of_the_waking_floor.name': 'Vải Quấn Chân của Sàn Thức Tỉnh',
  'entities.items.forgeheat_cinch.name': 'Đai Nhiệt Lò Rèn',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Kẻ Phá Lõi, Trái Tim Dưới Núi',
  'entities.items.the_last_restraint.name': 'Gông Xiềng Cuối Cùng',
  'entities.items.band_of_the_ninth_quench.name': 'Nhẫn Tôi Luyện Thứ Chín',
  'entities.items.moltenheart_chroma.name': 'Trái Tim Nóng Chảy',
  'entities.itemSets.crownforged.bonus5': 'Tăng 3% cơ hội chí mạng.',
  'entities.itemSets.nighttalon.bonus5': 'Tăng 3% cơ hội chí mạng.',
  'entities.itemSets.soulflame.bonus5': 'Tăng 3% cơ hội chí mạng của phép thuật.',
  'entities.itemSets.stormcallers.bonus5': 'Tăng 3% cơ hội chí mạng của phép thuật.',
};
