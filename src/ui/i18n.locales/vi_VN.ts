...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Trượng gỗ tần bì',
  'entities.items.gravecaller_cloth_handwraps.name': 'Băng tay vải của Kẻ Gọi Mộ',
  'entities.items.gravecaller_cloth_hood.name': 'Mũ trùm vải của Kẻ Gọi Mộ',
  'entities.items.gravecaller_cloth_leggings.name': 'Quần vải của Kẻ Gọi Mộ',
  'entities.items.gravecaller_cloth_mantle.name': 'Áo choàng vai vải của Kẻ Gọi Mộ',
  'entities.items.gravecaller_cloth_raiment.name': 'Lễ phục vải của Kẻ Gọi Mộ',
  'entities.items.gravecaller_cloth_sash.name': 'Đai vải của Kẻ Gọi Mộ',
  'entities.items.gravecaller_cloth_slippers.name': 'Dép vải của Kẻ Gọi Mộ',
  'entities.items.gravecaller_focus.name': 'Pháp khí của Kẻ Gọi Mộ',
  'entities.items.gravecaller_pendant.name': 'Mặt dây của Kẻ Gọi Mộ',
  'entities.items.gravecaller_ring.name': 'Nhẫn của Kẻ Gọi Mộ',
  'entities.items.gravecaller_wand.name': 'Đũa phép của Kẻ Gọi Mộ',
  'entities.items.iron_broadsword.name': 'Trọng kiếm sắt',
  'entities.items.iron_flanged_mace.name': 'Chùy sắt có vành',
  'entities.items.mirefen_dirk.name': 'Dao găm Mirefen',
  'entities.items.mirefen_hunting_bow.name': 'Cung săn Mirefen',
  'entities.items.mirefen_leather_belt.name': 'Thắt lưng da Mirefen',
  'entities.items.mirefen_leather_boots.name': 'Ủng da Mirefen',
  'entities.items.mirefen_leather_gloves.name': 'Găng tay da Mirefen',
  'entities.items.mirefen_leather_hood.name': 'Mũ trùm da Mirefen',
  'entities.items.mirefen_leather_jerkin.name': 'Áo gi-lê da Mirefen',
  'entities.items.mirefen_leather_leggings.name': 'Quần da Mirefen',
  'entities.items.mirefen_leather_shoulderguards.name': 'Giáp vai da Mirefen',
  'entities.items.thornpeak_bulwark.name': 'Thành lũy Thornpeak',
  'entities.items.thornpeak_crossbow.name': 'Nỏ Thornpeak',
  'entities.items.thornpeak_mail_chest.name': 'Giáp ngực xích Thornpeak',
  'entities.items.thornpeak_mail_gauntlets.name': 'Găng giáp xích Thornpeak',
  'entities.items.thornpeak_mail_girdle.name': 'Đai giáp xích Thornpeak',
  'entities.items.thornpeak_mail_helm.name': 'Mũ giáp xích Thornpeak',
  'entities.items.thornpeak_mail_legguards.name': 'Giáp chân xích Thornpeak',
  'entities.items.thornpeak_mail_pauldrons.name': 'Giáp vai xích Thornpeak',
  'entities.items.thornpeak_mail_sabatons.name': 'Ủng giáp xích Thornpeak',
  'entities.items.thornpeak_polearm.name': 'Vũ khí cán dài Thornpeak',
  'entities.items.thornpeak_war_axe.name': 'Rìu chiến Thornpeak',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Không thể chọn Cần Dùng vì lớp nhân vật của bạn không thể trang bị vật phẩm này.',
  'itemUi.lootRoll.needUnavailablePower':
    'Không thể chọn Cần Dùng vì sức mạnh Huyền Thoại này chỉ dành cho lớp nhân vật khác.',
  'itemUi.procedural.advancedDetailsHint': 'Giữ {key} để hiển thị các khoảng chỉ số có thể nhận.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Mỗi Tia U Ám thứ tư đánh dấu mục tiêu để chịu thêm sát thương Bóng Tối.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Ấn của Kẻ Buộc Tro',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Mỗi phép gây sát thương thứ hai ngân vang quanh mục tiêu.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Chuông Ngân Thứ Chín',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Di chuyển 15 thước giúp tăng tốc độ di chuyển trong thời gian ngắn.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Ủng Con Đường Bất Đoạn',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Mỗi Tia Tàn Lửa thứ ba thiêu đốt kẻ địch gần mục tiêu.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Vương Miện Giàn Hỏa Cuối Cùng',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Thánh Quang Chữa Lành tạo lá chắn cho người nhận bằng một phần lượng hồi phục.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Nhẫn Ấn Canh Giữ Bình Minh',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Mỗi Tia Hoang Dã thứ ba hồi phục tài nguyên chính.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Khuy Cài Trăng Hoang Dã',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Mỗi đòn vũ khí thứ ba khiến mục tiêu chảy máu và hồi một ít tài nguyên.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Lưỡi Cạnh Hàm Xám',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Kéo Cung Dài hoặc Bắn Tà Ác có thể khiến mục tiêu câm lặng trong thời gian ngắn.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Cung Dài Rừng Tĩnh Lặng',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Khi máu giảm dưới 35%, nhận một lớp bảo hộ phòng thủ ngắn.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Áo Choàng Những Giờ Bị Đánh Cắp',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Hạ gục một kẻ địch giúp tăng nhanh nhẹn trong thời gian ngắn.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Nanh Thủy Tinh Đêm',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Mỗi Tia Hồ Quang thứ tư lan sang kẻ địch ở gần.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Thần Tượng Bão Thức Tỉnh',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Hồi phục chí mạng tạo một vùng phục hồi ngắn trên mặt đất.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Canh Thức của Ysolei',
  'itemUi.procedural.legendaryLimit': 'Trang bị duy nhất: {count} sức mạnh Huyền Thoại',
  'itemUi.procedural.legendaryPower': 'Sức mạnh Huyền Thoại',
  'itemUi.procedural.nameFragment.deft': 'Khéo Léo',
  'itemUi.procedural.nameFragment.mighty': 'Hùng Mạnh',
  'itemUi.procedural.nameFragment.of_alacrity': 'của Nhanh Nhẹn',
  'itemUi.procedural.nameFragment.of_focus': 'của Tập Trung',
  'itemUi.procedural.nameFragment.of_precision': 'của Chính Xác',
  'itemUi.procedural.nameFragment.of_reaping': 'của Gặt Hái',
  'itemUi.procedural.nameFragment.of_remembrance': 'của Tưởng Nhớ',
  'itemUi.procedural.nameFragment.of_striking': 'của Đả Kích',
  'itemUi.procedural.nameFragment.sages': 'của Hiền Giả',
  'itemUi.procedural.nameFragment.spiritual': 'Tâm Linh',
  'itemUi.procedural.nameFragment.stalwart': 'Kiên Cường',
  'itemUi.procedural.nameFragment.warded': 'Được Bảo Hộ',
  'itemUi.procedural.powerRollMilliseconds': 'Chỉ số sức mạnh: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Chỉ số sức mạnh: {value}',
  'itemUi.procedural.powerRollPercent': 'Chỉ số sức mạnh: {value}%',
  'itemUi.procedural.powerRollResource': 'Chỉ số sức mạnh: {value} tài nguyên',
  'itemUi.procedural.rareWord.ashen': 'Tro Tàn',
  'itemUi.procedural.rareWord.bite': 'Vết Cắn',
  'itemUi.procedural.rareWord.blackfen': 'Đầm Đen',
  'itemUi.procedural.rareWord.brand': 'Dấu Ấn',
  'itemUi.procedural.rareWord.doom': 'Diệt Vong',
  'itemUi.procedural.rareWord.grave': 'Mộ Phần',
  'itemUi.procedural.rareWord.mire': 'Bùn Lầy',
  'itemUi.procedural.rareWord.oath': 'Lời Thề',
  'itemUi.procedural.rareWord.promise': 'Lời Hứa',
  'itemUi.procedural.rareWord.storm': 'Bão Tố',
  'itemUi.procedural.rareWord.thorn': 'Gai Nhọn',
  'itemUi.procedural.rareWord.thread': 'Sợi Chỉ',
  'itemUi.procedural.rareWord.vigil': 'Canh Thức',
  'itemUi.procedural.rareWord.ward': 'Bảo Hộ',
  'itemUi.procedural.rareWord.whisper': 'Lời Thì Thầm',
  'itemUi.procedural.rareWord.wyrm': 'Cự Long',
  'itemUi.procedural.rarity.common': 'Thường',
  'itemUi.procedural.rarity.epic': 'Sử Thi',
  'itemUi.procedural.rarity.legendary': 'Huyền Thoại',
  'itemUi.procedural.rarity.magic': 'Ma Thuật',
  'itemUi.procedural.rarity.mythic': 'Thần Thoại',
  'itemUi.procedural.rarity.rare': 'Hiếm',
  'itemUi.procedural.rollRangeAria': 'Chỉ số có thể từ {min} đến {max}',
  'itemUi.stats.blockValue': 'Giá trị chặn',
  'itemUi.stats.healthOnKill': 'Máu khi hạ gục',
  'itemUi.stats.manaOnKill': 'Năng lượng khi hạ gục',
  ...
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}, {rarity}, cấp vật phẩm {level}, số lượng {count}, bản sao được phù phép',
  ...
  'hudChrome.finder.raidItemLevels':
    'Cấp vật phẩm: Hiếm {rare} · Sử Thi {epic} · Huyền Thoại {legendary}',
  'hudChrome.finder.raidRarityLine': 'Hiếm {rare}% · Sử Thi {epic}% · Huyền Thoại {legendary}%',
  'hudChrome.finder.raidRewards': 'Xem trước phần thưởng Nythraxis',
  'hudChrome.finder.raidSharedDrop':
    'Xác cuối cùng thêm một vật phẩm theo thủ tục dùng chung để cả nhóm đột kích cùng gieo xúc xắc.',
  'hudChrome.finder.raidSignatures': 'Sức mạnh Huyền Thoại đặc trưng: {signatures}',
  ...
  'hudChrome.enchanting.plainTag': 'Chưa khắc phép',
  'hudChrome.enchanting.replaceConfirmKeeps': 'Được giữ lại: {kept}',
  'hudChrome.enchanting.replaceConfirmKeepsBond': 'Ràng buộc đơn đặt hàng',
  'hudChrome.enchanting.replaceConfirmKeepsMasterwork': 'Thưởng kiệt tác',
  'hudChrome.enchanting.replaceConfirmKeepsSigner': 'Dấu của người chế tác',
  ...
  'hudChrome.gathering.harvestSpecimenLine': 'Bạn cũng thu hồi {name}.',
};
