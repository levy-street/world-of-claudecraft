...
export const id_ID: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Tongkat kayu ash',
  'entities.items.gravecaller_cloth_handwraps.name': 'Kain pembungkus tangan Pemanggil Makam',
  'entities.items.gravecaller_cloth_hood.name': 'Tudung kain Pemanggil Makam',
  'entities.items.gravecaller_cloth_leggings.name': 'Pelindung kaki kain Pemanggil Makam',
  'entities.items.gravecaller_cloth_mantle.name': 'Mantel kain Pemanggil Makam',
  'entities.items.gravecaller_cloth_raiment.name': 'Jubah kain Pemanggil Makam',
  'entities.items.gravecaller_cloth_sash.name': 'Selempang kain Pemanggil Makam',
  'entities.items.gravecaller_cloth_slippers.name': 'Selop kain Pemanggil Makam',
  'entities.items.gravecaller_focus.name': 'Fokus Pemanggil Makam',
  'entities.items.gravecaller_pendant.name': 'Liontin Pemanggil Makam',
  'entities.items.gravecaller_ring.name': 'Cincin Pemanggil Makam',
  'entities.items.gravecaller_wand.name': 'Tongkat sihir Pemanggil Makam',
  'entities.items.iron_broadsword.name': 'Pedang lebar besi',
  'entities.items.iron_flanged_mace.name': 'Gada besi berflensa',
  'entities.items.mirefen_dirk.name': 'Belati Mirefen',
  'entities.items.mirefen_hunting_bow.name': 'Busur berburu Mirefen',
  'entities.items.mirefen_leather_belt.name': 'Sabuk kulit Mirefen',
  'entities.items.mirefen_leather_boots.name': 'Sepatu bot kulit Mirefen',
  'entities.items.mirefen_leather_gloves.name': 'Sarung tangan kulit Mirefen',
  'entities.items.mirefen_leather_hood.name': 'Tudung kulit Mirefen',
  'entities.items.mirefen_leather_jerkin.name': 'Jaket kulit Mirefen',
  'entities.items.mirefen_leather_leggings.name': 'Pelindung kaki kulit Mirefen',
  'entities.items.mirefen_leather_shoulderguards.name': 'Pelindung bahu kulit Mirefen',
  'entities.items.thornpeak_bulwark.name': 'Benteng Thornpeak',
  'entities.items.thornpeak_crossbow.name': 'Busur silang Thornpeak',
  'entities.items.thornpeak_mail_chest.name': 'Zirah dada rantai Thornpeak',
  'entities.items.thornpeak_mail_gauntlets.name': 'Sarung tangan rantai Thornpeak',
  'entities.items.thornpeak_mail_girdle.name': 'Korset rantai Thornpeak',
  'entities.items.thornpeak_mail_helm.name': 'Helm rantai Thornpeak',
  'entities.items.thornpeak_mail_legguards.name': 'Pelindung kaki rantai Thornpeak',
  'entities.items.thornpeak_mail_pauldrons.name': 'Pelindung bahu rantai Thornpeak',
  'entities.items.thornpeak_mail_sabatons.name': 'Sepatu zirah rantai Thornpeak',
  'entities.items.thornpeak_polearm.name': 'Senjata galah Thornpeak',
  'entities.items.thornpeak_war_axe.name': 'Kapak perang Thornpeak',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Pilihan Butuh tidak tersedia karena kelasmu tidak dapat memakai barang ini.',
  'itemUi.lootRoll.needUnavailablePower':
    'Pilihan Butuh tidak tersedia karena kekuatan Legendaris ini terbatas untuk kelas lain.',
  'itemUi.procedural.advancedDetailsHint':
    'Tahan {key} untuk menampilkan kemungkinan rentang guliran.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Setiap Panah Suram keempat menandai target agar menerima tambahan kerusakan Bayangan.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Segel Pengikat Abu',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Setiap mantra perusak kedua berdentang di sekitar target.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Lonceng Dentang Kesembilan',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Bergerak 15 yard memberikan peningkatan singkat kecepatan gerak.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Sepatu Jalan Tak Terputus',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Setiap Panah Bara ketiga membakar musuh di dekat target.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Mahkota Tumpukan Api Terakhir',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Cahaya Pemulih melindungi penerimanya dengan perisai senilai sebagian penyembuhan.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Cincin Meterai Penjaga Fajar',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Setiap Panah Liar ketiga memulihkan sumber daya utama.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Pengait Bulan Liar',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Setiap serangan senjata ketiga membuat target berdarah dan memulihkan sedikit sumber daya.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Mata Pedang Rahang Kelabu',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Tarikan Panjang atau Tembakan Bengis dapat membungkam target sejenak.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Busur Panjang Kayu Sunyi',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Turun di bawah 35% kesehatan memberikan perlindungan defensif singkat.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Mantel Jam Curian',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Satu pembunuhan memberikan peningkatan singkat kecepatan serang.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Taring Kaca Malam',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Setiap Sambaran Busur keempat melompat ke musuh di sekitar.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Berhala Bangkitnya Badai',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Penyembuhan kritis menciptakan area pemulihan singkat di tanah.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Vigili Ysolei',
  'itemUi.procedural.legendaryLimit': 'Unik dipakai: {count} kekuatan Legendaris',
  'itemUi.procedural.legendaryPower': 'Kekuatan Legendaris',
  'itemUi.procedural.nameFragment.deft': 'Tangkas',
  'itemUi.procedural.nameFragment.mighty': 'Perkasa',
  'itemUi.procedural.nameFragment.of_alacrity': 'Ketangkasan',
  'itemUi.procedural.nameFragment.of_focus': 'Fokus',
  'itemUi.procedural.nameFragment.of_precision': 'Ketepatan',
  'itemUi.procedural.nameFragment.of_reaping': 'Penuaian',
  'itemUi.procedural.nameFragment.of_remembrance': 'Kenangan',
  'itemUi.procedural.nameFragment.of_striking': 'Serangan',
  'itemUi.procedural.nameFragment.sages': 'Milik Sang Bijak',
  'itemUi.procedural.nameFragment.spiritual': 'Rohani',
  'itemUi.procedural.nameFragment.stalwart': 'Teguh',
  'itemUi.procedural.nameFragment.warded': 'Terlindungi',
  'itemUi.procedural.powerRollMilliseconds': 'Guliran kekuatan: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Guliran kekuatan: {value}',
  'itemUi.procedural.powerRollPercent': 'Guliran kekuatan: {value}%',
  'itemUi.procedural.powerRollResource': 'Guliran kekuatan: {value} sumber daya',
  'itemUi.procedural.rareWord.ashen': 'Kelabu Abu',
  'itemUi.procedural.rareWord.bite': 'Gigitan',
  'itemUi.procedural.rareWord.blackfen': 'Rawa Hitam',
  'itemUi.procedural.rareWord.brand': 'Cap',
  'itemUi.procedural.rareWord.doom': 'Malapetaka',
  'itemUi.procedural.rareWord.grave': 'Makam',
  'itemUi.procedural.rareWord.mire': 'Rawa',
  'itemUi.procedural.rareWord.oath': 'Sumpah',
  'itemUi.procedural.rareWord.promise': 'Janji',
  'itemUi.procedural.rareWord.storm': 'Badai',
  'itemUi.procedural.rareWord.thorn': 'Duri',
  'itemUi.procedural.rareWord.thread': 'Benang',
  'itemUi.procedural.rareWord.vigil': 'Vigili',
  'itemUi.procedural.rareWord.ward': 'Perlindungan',
  'itemUi.procedural.rareWord.whisper': 'Bisikan',
  'itemUi.procedural.rareWord.wyrm': 'Naga',
  'itemUi.procedural.rarity.common': 'Umum',
  'itemUi.procedural.rarity.epic': 'Epik',
  'itemUi.procedural.rarity.legendary': 'Legendaris',
  'itemUi.procedural.rarity.magic': 'Magis',
  'itemUi.procedural.rarity.mythic': 'Mitologis',
  'itemUi.procedural.rarity.rare': 'Langka',
  'itemUi.procedural.rollRangeAria': 'Kemungkinan guliran dari {min} sampai {max}',
  'itemUi.stats.blockValue': 'Nilai tangkisan',
  'itemUi.stats.healthOnKill': 'Kesehatan saat membunuh',
  'itemUi.stats.manaOnKill': 'Mana saat membunuh',
