...
export const id_ID: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Sandal Penapak Abu',
  'entities.items.cinderarc_odrenns_rod.name': 'Busur Bara, Tongkat Odrenn',
  'entities.items.cindertoad_signet.name': 'Cincin Meterai Katak Bara',
  'entities.items.coalglow_band.name': 'Cincin Cahaya Arang',
  'entities.items.crownforged_warleggings.name': 'Celana Perang Tempaan Mahkota',
  'entities.items.glassblowers_shiv.name': 'Belati Peniup Kaca',
  'entities.items.glasswalker_treads.name': 'Sepatu Penapak Kaca',
  'entities.items.nighttalon_prowlers.name': 'Sepatu Pengendap Cakar Malam',
  'entities.items.quenchsilk_cord.name': 'Tali Sutra Pendingin',
  'entities.items.ring_of_the_first_quench.name': 'Cincin Pendinginan Pertama',
  'entities.items.saans_stoking_iron.name': 'Besi Pengobar Saan',
  'entities.items.slag_tempered_sabatons.name': 'Sepatu Baja Tempa Terak',
  'entities.items.slakeleather_belt.name': 'Sabuk Kulit Pendingin',
  'entities.items.sluicebearer.name': 'Pembawa Pintu Air',
  'entities.items.soulflame_kilt.name': 'Rok Api Jiwa',
  'entities.items.stokebrand_striders.name': 'Sepatu Cap Pengobar',
  'entities.items.stormcallers_legwraps.name': 'Balutan Kaki Pemanggil Badai',
  'entities.items.the_even_temper.name': 'Temperamen Seimbang',
  'entities.items.twice_fired_slippers.name': 'Selop Bakar Dua Kali',
  'entities.items.twicetempered_girdle.name': 'Sabuk Tempa Ganda',
  'entities.items.crownforged_heartplate.name': 'Pelindung Dada Tempa Mahkota',
  'entities.items.nighttalon_emberweave.name': 'Tenun Bara Cakar Malam',
  'entities.items.soulflame_vestments.name': 'Jubah Api Jiwa',
  'entities.items.stormcallers_hauberk.name': 'Baju Zirah Pemanggil Badai',
  'entities.items.volzharrs_knucklestone.name': 'Batu Buku Jari Volzharr',
  'entities.items.magmastrider_greaves.name': 'Pelindung Kaki Pelangkah Magma',
  'entities.items.footwraps_of_the_waking_floor.name': 'Balutan Kaki Lantai yang Bangkit',
  'entities.items.forgeheat_cinch.name': 'Ikat Pinggang Panas Tempa',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Pemecah Inti, Jantung Bawah Gunung',
  'entities.items.the_last_restraint.name': 'Kekang Terakhir',
  'entities.items.band_of_the_ninth_quench.name': 'Cincin Pendinginan Kesembilan',
  'entities.items.moltenheart_chroma.name': 'Jantung Lebur',
  'entities.itemSets.crownforged.bonus5': 'Meningkatkan peluang serangan kritis sebesar 3%.',
  'entities.itemSets.nighttalon.bonus5': 'Meningkatkan peluang serangan kritis sebesar 3%.',
  'entities.itemSets.soulflame.bonus5': 'Meningkatkan peluang serangan kritis mantra sebesar 3%.',
  'entities.itemSets.stormcallers.bonus5':
    'Meningkatkan peluang serangan kritis mantra sebesar 3%.',
};
