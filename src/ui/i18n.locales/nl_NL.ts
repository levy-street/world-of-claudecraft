...
export const nl_NL: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberforged_hauberk.name': 'Sintelgesmede Maliënkolder',
  'entities.items.emberforged_legguards.name': 'Sintelgesmede Beenplaten',
  'entities.items.emberforged_girdle.name': 'Sintelgesmede Gordel',
  'entities.items.cinderhide_vest.name': 'Vest van Sintelleer',
  'entities.items.moltencore_maul.name': 'Strijdknots van de Gesmolten Kern',
  'entities.items.brand_of_the_first_flame.name': 'Brandmerk van de Eerste Vlam',
  'entities.items.emberseal_of_the_covenant.name': 'Sintelzegel van het Verbroken Verbond',
  'entities.items.bloodember_band.name': 'Ring van Bloedsintel',
  'entities.items.ashcoil_signet.name': 'Zegelring van de Askronkel',
