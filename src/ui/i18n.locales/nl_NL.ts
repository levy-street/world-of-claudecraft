...
export const nl_NL: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Essenhouten staf',
  'entities.items.gravecaller_cloth_handwraps.name': 'Gravecaller-stoffen handwikkels',
  'entities.items.gravecaller_cloth_hood.name': 'Gravecaller-stoffen kap',
  'entities.items.gravecaller_cloth_leggings.name': 'Gravecaller-stoffen beenstukken',
  'entities.items.gravecaller_cloth_mantle.name': 'Gravecaller-stoffen mantel',
  'entities.items.gravecaller_cloth_raiment.name': 'Gravecaller-stoffen gewaad',
  'entities.items.gravecaller_cloth_sash.name': 'Gravecaller-stoffen sjerp',
  'entities.items.gravecaller_cloth_slippers.name': 'Gravecaller-stoffen sloffen',
  'entities.items.gravecaller_focus.name': 'Gravecaller-focus',
  'entities.items.gravecaller_pendant.name': 'Gravecaller-hanger',
  'entities.items.gravecaller_ring.name': 'Gravecaller-ring',
  'entities.items.gravecaller_wand.name': 'Gravecaller-toverstaf',
  'entities.items.iron_broadsword.name': 'IJzeren slagzwaard',
  'entities.items.iron_flanged_mace.name': 'IJzeren flensknots',
  'entities.items.mirefen_dirk.name': 'Mirefen-dolk',
  'entities.items.mirefen_hunting_bow.name': 'Mirefen-jachtboog',
  'entities.items.mirefen_leather_belt.name': 'Mirefen-leren riem',
  'entities.items.mirefen_leather_boots.name': 'Mirefen-leren laarzen',
  'entities.items.mirefen_leather_gloves.name': 'Mirefen-leren handschoenen',
  'entities.items.mirefen_leather_hood.name': 'Mirefen-leren kap',
  'entities.items.mirefen_leather_jerkin.name': 'Mirefen-leren wambuis',
  'entities.items.mirefen_leather_leggings.name': 'Mirefen-leren beenstukken',
  'entities.items.mirefen_leather_shoulderguards.name': 'Mirefen-leren schouderbeschermers',
  'entities.items.thornpeak_bulwark.name': 'Thornpeak-bolwerk',
  'entities.items.thornpeak_crossbow.name': 'Thornpeak-kruisboog',
  'entities.items.thornpeak_mail_chest.name': 'Thornpeak-maliënkolder',
  'entities.items.thornpeak_mail_gauntlets.name': 'Thornpeak-maliënhandschoenen',
  'entities.items.thornpeak_mail_girdle.name': 'Thornpeak-maliëngordel',
  'entities.items.thornpeak_mail_helm.name': 'Thornpeak-maliënhelm',
  'entities.items.thornpeak_mail_legguards.name': 'Thornpeak-maliënbeenplaten',
  'entities.items.thornpeak_mail_pauldrons.name': 'Thornpeak-maliënschouderplaten',
  'entities.items.thornpeak_mail_sabatons.name': 'Thornpeak-maliënschoenen',
  'entities.items.thornpeak_polearm.name': 'Thornpeak-stokwapen',
  'entities.items.thornpeak_war_axe.name': 'Thornpeak-strijdbijl',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Nodig is niet beschikbaar omdat je klasse dit voorwerp niet kan uitrusten.',
  'itemUi.lootRoll.needUnavailablePower':
    'Nodig is niet beschikbaar omdat deze legendarische kracht tot een andere klasse is beperkt.',
  'itemUi.procedural.advancedDetailsHint':
    'Houd {key} ingedrukt om de mogelijke worpbereiken te tonen.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Elke vierde Duisterbout markeert zijn doelwit voor extra Schaduwschade.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Zegel van de Asbinder',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Elke tweede schadelijke spreuk galmt rond het doelwit.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Bel van de Negende Slag',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    '15 meter bewegen geeft kort een hogere bewegingssnelheid.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Laarzen van de Ongebroken Weg',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Elke derde Sintelbout verschroeit vijanden in de buurt van het doelwit.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Kroon van de Laatste Brandstapel',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Helend Licht beschermt de ontvanger met een schild voor een deel van de genezing.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Zegelring van de Dageraad',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Elke derde Wildbout herstelt de primaire hulpbron.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Gesp van de Wilde Maan',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Elke derde wapentreffer laat het doelwit bloeden en herstelt een beetje hulpbron.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Snede van Grijskaak',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Lange Trek of Boosaardig Schot kan het doelwit kort het zwijgen opleggen.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Langboog van het Stille Woud',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Onder 35% gezondheid komen geeft kort een defensieve bescherming.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Mantel van Gestolen Uren',
  'itemUi.procedural.legendary.nightglass_fang.description': 'Een gedode vijand geeft kort haast.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Nachtglastand',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Elke vierde Boogbliksem springt over naar vijanden in de buurt.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Idool van Stormontwaken',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Kritieke genezing maakt kort een herstellend gebied op de grond.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Ysoleis Wake',
  'itemUi.procedural.legendaryLimit': 'Uniek uitgerust: {count} legendarische kracht',
  'itemUi.procedural.legendaryPower': 'Legendarische kracht',
  'itemUi.procedural.nameFragment.deft': 'Bedreven',
  'itemUi.procedural.nameFragment.mighty': 'Machtig',
  'itemUi.procedural.nameFragment.of_alacrity': 'van Voortvarendheid',
  'itemUi.procedural.nameFragment.of_focus': 'van Focus',
  'itemUi.procedural.nameFragment.of_precision': 'van Precisie',
  'itemUi.procedural.nameFragment.of_reaping': 'van de Oogst',
  'itemUi.procedural.nameFragment.of_remembrance': 'van Herinnering',
  'itemUi.procedural.nameFragment.of_striking': 'van Slagkracht',
  'itemUi.procedural.nameFragment.sages': 'van de Wijze',
  'itemUi.procedural.nameFragment.spiritual': 'Spiritueel',
  'itemUi.procedural.nameFragment.stalwart': 'Standvastig',
  'itemUi.procedural.nameFragment.warded': 'Beschermd',
  'itemUi.procedural.powerRollMilliseconds': 'Krachtworp: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Krachtworp: {value}',
  'itemUi.procedural.powerRollPercent': 'Krachtworp: {value}%',
  'itemUi.procedural.powerRollResource': 'Krachtworp: {value} hulpbron',
  'itemUi.procedural.rareWord.ashen': 'Asgrauw',
  'itemUi.procedural.rareWord.bite': 'Beet',
  'itemUi.procedural.rareWord.blackfen': 'Zwartveen',
  'itemUi.procedural.rareWord.brand': 'Brandmerk',
  'itemUi.procedural.rareWord.doom': 'Doem',
  'itemUi.procedural.rareWord.grave': 'Graf',
  'itemUi.procedural.rareWord.mire': 'Moeras',
  'itemUi.procedural.rareWord.oath': 'Eed',
  'itemUi.procedural.rareWord.promise': 'Belofte',
  'itemUi.procedural.rareWord.storm': 'Storm',
  'itemUi.procedural.rareWord.thorn': 'Doorn',
  'itemUi.procedural.rareWord.thread': 'Draad',
  'itemUi.procedural.rareWord.vigil': 'Wake',
  'itemUi.procedural.rareWord.ward': 'Bescherming',
  'itemUi.procedural.rareWord.whisper': 'Fluistering',
  'itemUi.procedural.rareWord.wyrm': 'Wyrm',
  'itemUi.procedural.rarity.common': 'Gewoon',
  'itemUi.procedural.rarity.epic': 'Episch',
  'itemUi.procedural.rarity.legendary': 'Legendarisch',
  'itemUi.procedural.rarity.magic': 'Magisch',
  'itemUi.procedural.rarity.mythic': 'Mythisch',
  'itemUi.procedural.rarity.rare': 'Zeldzaam',
  'itemUi.procedural.rollRangeAria': 'Mogelijke worp van {min} tot {max}',
  'itemUi.stats.blockValue': 'Blokkeerwaarde',
  'itemUi.stats.healthOnKill': 'Gezondheid bij doden',
  'itemUi.stats.manaOnKill': 'Mana bij doden',
  ...
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}, {rarity}, itemniveau {level}, aantal {count}, betoverd exemplaar',
  ...
  'hudChrome.finder.raidItemLevels':
    'Itemniveau: Zeldzaam {rare} · Episch {epic} · Legendarisch {legendary}',
  'hudChrome.finder.raidRarityLine':
    'Zeldzaam {rare}% · Episch {epic}% · Legendarisch {legendary}%',
  'hudChrome.finder.raidRewards': 'Voorbeeld van Nythraxis-beloningen',
