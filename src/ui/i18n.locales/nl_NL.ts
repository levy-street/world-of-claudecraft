...
export const nl_NL: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Asloper-sandalen',
  'entities.items.cinderarc_odrenns_rod.name': 'Sintelboog, Odrenns roede',
  'entities.items.cindertoad_signet.name': 'Sintelpadsignet',
  'entities.items.coalglow_band.name': 'Koolgloedband',
  'entities.items.crownforged_warleggings.name': 'Kroongesmede oorlogsbeenkappen',
  'entities.items.glassblowers_shiv.name': 'Glasblazersmes',
  'entities.items.glasswalker_treads.name': 'Glasloper-schoenen',
  'entities.items.nighttalon_prowlers.name': 'Nachtklauwsluipers',
  'entities.items.quenchsilk_cord.name': 'Koelzijdesnoer',
  'entities.items.ring_of_the_first_quench.name': 'Ring van de eerste afkoeling',
  'entities.items.saans_stoking_iron.name': 'Saans pookijzer',
  'entities.items.slag_tempered_sabatons.name': 'Slakgetemperde laarzen',
  'entities.items.slakeleather_belt.name': 'Koellederen riem',
  'entities.items.sluicebearer.name': 'Sluisdrager',
  'entities.items.soulflame_kilt.name': 'Zielsvlamkilt',
  'entities.items.stokebrand_striders.name': 'Pookbrand-stappers',
  'entities.items.stormcallers_legwraps.name': 'Beenwikkels van de Stormroeper',
  'entities.items.the_even_temper.name': 'Het Gelijkmatige Temperament',
  'entities.items.twice_fired_slippers.name': 'Dubbelgebakken pantoffels',
  'entities.items.twicetempered_girdle.name': 'Dubbelgetemperde gordel',
  'entities.items.crownforged_heartplate.name': 'Kroon gesmede hartplaat',
  'entities.items.nighttalon_emberweave.name': 'Nachtklauw-gloedweefsel',
  'entities.items.soulflame_vestments.name': 'Zielvlamgewaden',
  'entities.items.stormcallers_hauberk.name': 'Stormroepers maliënkolder',
  'entities.items.volzharrs_knucklestone.name': 'Volzharrs knokkelsteen',
  'entities.items.magmastrider_greaves.name': 'Magmawandelaar-scheenplaten',
  'entities.items.footwraps_of_the_waking_floor.name': 'Voetwindsels van de Ontwakende Vloer',
  'entities.items.forgeheat_cinch.name': 'Smederijhitte-gordel',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Kernbreker, Hart van de Onderberg',
  'entities.items.the_last_restraint.name': 'De Laatste Boei',
  'entities.items.band_of_the_ninth_quench.name': 'Ring van de Negende Koeling',
  'entities.items.moltenheart_chroma.name': 'Smelthart',
  'entities.itemSets.crownforged.bonus5': 'Verhoogt de kans op een kritieke treffer met 3%.',
  'entities.itemSets.nighttalon.bonus5': 'Verhoogt de kans op een kritieke treffer met 3%.',
  'entities.itemSets.soulflame.bonus5': 'Verhoogt de kans op een kritieke spreuktreffer met 3%.',
  'entities.itemSets.stormcallers.bonus5': 'Verhoogt de kans op een kritieke spreuktreffer met 3%.',
};
