...
export const es: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.boundstone_bulwark.name': 'Baluarte de piedra vinculada',
  'entities.items.drownedmoon_aegis.name': 'Égida de la Luna Ahogada',
  'entities.items.gravewyrm_bulwark.name': 'Baluarte de la sierpe sepulcral',
