...
export const es: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.itemAriaProceduralBound':
    '{item}, {rarity}, nivel de objeto {level}, cantidad {count}, copia vinculada',
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}, {rarity}, nivel de objeto {level}, cantidad {count}, copia encantada',
  ...
  'hudChrome.finder.raidItemLevels':
    'Nivel de objeto: Raro {rare} · Épico {epic} · Legendario {legendary}',
  'hudChrome.finder.raidRarityLine': 'Raro {rare}% · Épico {epic}% · Legendario {legendary}%',
  'hudChrome.finder.raidRewards': 'Vista previa de las recompensas de Nythraxis',
  'hudChrome.finder.raidSharedDrop':
    'El cadáver del jefe final añade un objeto procedimental compartido para que la banda tire por él.',
  'hudChrome.finder.raidSignatures': 'Poderes Legendarios distintivos: {signatures}',
  ...
  'entities.items.ashwood_staff.name': 'Bastón de fresno',
  'entities.items.gravecaller_cloth_handwraps.name': 'Vendas de tela de Gravecaller',
  'entities.items.gravecaller_cloth_hood.name': 'Capucha de tela de Gravecaller',
  'entities.items.gravecaller_cloth_leggings.name': 'Leotardos de tela de Gravecaller',
  'entities.items.gravecaller_cloth_mantle.name': 'Manto de tela de Gravecaller',
  'entities.items.gravecaller_cloth_raiment.name': 'Vestiduras de tela de Gravecaller',
  'entities.items.gravecaller_cloth_sash.name': 'Fajín de tela de Gravecaller',
  'entities.items.gravecaller_cloth_slippers.name': 'Zapatillas de tela de Gravecaller',
  'entities.items.gravecaller_focus.name': 'Foco de Gravecaller',
  'entities.items.gravecaller_pendant.name': 'Colgante de Gravecaller',
  'entities.items.gravecaller_ring.name': 'Anillo de Gravecaller',
  'entities.items.gravecaller_wand.name': 'Varita de Gravecaller',
  'entities.items.iron_broadsword.name': 'Mandoble de hierro',
  'entities.items.iron_flanged_mace.name': 'Maza de hierro con rebordes',
  'entities.items.mirefen_dirk.name': 'Daga de Mirefen',
  'entities.items.mirefen_hunting_bow.name': 'Arco de caza de Mirefen',
  'entities.items.mirefen_leather_belt.name': 'Cinturón de cuero de Mirefen',
  'entities.items.mirefen_leather_boots.name': 'Botas de cuero de Mirefen',
  'entities.items.mirefen_leather_gloves.name': 'Guantes de cuero de Mirefen',
  'entities.items.mirefen_leather_hood.name': 'Capucha de cuero de Mirefen',
  'entities.items.mirefen_leather_jerkin.name': 'Jubón de cuero de Mirefen',
  'entities.items.mirefen_leather_leggings.name': 'Leotardos de cuero de Mirefen',
  'entities.items.mirefen_leather_shoulderguards.name': 'Hombreras de cuero de Mirefen',
  'entities.items.thornpeak_bulwark.name': 'Baluarte de Thornpeak',
  'entities.items.thornpeak_crossbow.name': 'Ballesta de Thornpeak',
  'entities.items.thornpeak_mail_chest.name': 'Coraza de malla de Thornpeak',
  'entities.items.thornpeak_mail_gauntlets.name': 'Guanteletes de malla de Thornpeak',
  'entities.items.thornpeak_mail_girdle.name': 'Faja de malla de Thornpeak',
  'entities.items.thornpeak_mail_helm.name': 'Yelmo de malla de Thornpeak',
  'entities.items.thornpeak_mail_legguards.name': 'Guardapiernas de malla de Thornpeak',
  'entities.items.thornpeak_mail_pauldrons.name': 'Espaldares de malla de Thornpeak',
  'entities.items.thornpeak_mail_sabatons.name': 'Escarpes de malla de Thornpeak',
  'entities.items.thornpeak_polearm.name': 'Arma de asta de Thornpeak',
  'entities.items.thornpeak_war_axe.name': 'Hacha de guerra de Thornpeak',
  ...
  'itemUi.lootRoll.needUnavailable':
    'No puedes elegir Necesidad porque tu clase no puede equipar este objeto.',
  'itemUi.lootRoll.needUnavailablePower':
    'No puedes elegir Necesidad porque este poder legendario está restringido a otra clase.',
  'itemUi.procedural.advancedDetailsHint':
    'Mantén pulsado {key} para ver los intervalos posibles de las tiradas.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Cada cuarta Descarga de Penumbra marca a su objetivo para que reciba daño de las Sombras adicional.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Sello del Vinculacenizas',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Cada segundo hechizo dañino tañe alrededor del objetivo.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Campana del Noveno Tañido',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Recorrer 15 yardas otorga un breve aumento de velocidad de movimiento.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Botas del Camino Inquebrantable',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Cada tercera Descarga de Ascuas abrasa a los enemigos cercanos al objetivo.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Corona de la Última Pira',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Luz Reparadora protege a quien la recibe con un escudo equivalente a una parte de la sanación.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Sello del Alba',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Cada tercera Descarga Silvestre restaura el recurso principal.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Broche de Luna Feral',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Cada tercer golpe de arma hace sangrar al objetivo y restaura un poco de recurso.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Filo de Quijada Gris',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Tensado Largo o Disparo Funesto pueden silenciar brevemente al objetivo.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Arco Largo del Bosque Silente',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Al caer por debajo del 35% de salud, obtienes una breve protección defensiva.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Manto de las Horas Robadas',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Matar a un enemigo otorga un breve aumento de celeridad.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Colmillo de Vidrio Nocturno',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Cada cuarto Arco Eléctrico salta a los enemigos cercanos.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Ídolo del Despertar de la Tormenta',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Una sanación crítica crea brevemente una zona restauradora en el suelo.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Vigilia de Ysolei',
  'itemUi.procedural.legendaryLimit': 'Único equipado: {count} poder legendario',
  'itemUi.procedural.legendaryPower': 'Poder legendario',
  'itemUi.procedural.nameFragment.deft': 'Diestro',
  'itemUi.procedural.nameFragment.mighty': 'Poderoso',
  'itemUi.procedural.nameFragment.of_alacrity': 'de Prontitud',
  'itemUi.procedural.nameFragment.of_focus': 'de Concentración',
  'itemUi.procedural.nameFragment.of_precision': 'de Precisión',
  'itemUi.procedural.nameFragment.of_reaping': 'de Siega',
  'itemUi.procedural.nameFragment.of_remembrance': 'del Recuerdo',
  'itemUi.procedural.nameFragment.of_striking': 'de Golpeo',
  'itemUi.procedural.nameFragment.sages': 'del Sabio',
  'itemUi.procedural.nameFragment.spiritual': 'Espiritual',
  'itemUi.procedural.nameFragment.stalwart': 'Firme',
  'itemUi.procedural.nameFragment.warded': 'Protegido',
  'itemUi.procedural.powerRollMilliseconds': 'Tirada de poder: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Tirada de poder: {value}',
  'itemUi.procedural.powerRollPercent': 'Tirada de poder: {value}%',
  'itemUi.procedural.powerRollResource': 'Tirada de poder: {value} de recurso',
  'itemUi.procedural.rareWord.ashen': 'Ceniciento',
  'itemUi.procedural.rareWord.bite': 'Mordisco',
  'itemUi.procedural.rareWord.blackfen': 'Ciénaga Negra',
  'itemUi.procedural.rareWord.brand': 'Marca',
  'itemUi.procedural.rareWord.doom': 'Condena',
  'itemUi.procedural.rareWord.grave': 'Tumba',
  'itemUi.procedural.rareWord.mire': 'Cieno',
  'itemUi.procedural.rareWord.oath': 'Juramento',
  'itemUi.procedural.rareWord.promise': 'Promesa',
  'itemUi.procedural.rareWord.storm': 'Tormenta',
  'itemUi.procedural.rareWord.thorn': 'Espina',
  'itemUi.procedural.rareWord.thread': 'Hilo',
  'itemUi.procedural.rareWord.vigil': 'Vigilia',
  'itemUi.procedural.rareWord.ward': 'Protección',
  'itemUi.procedural.rareWord.whisper': 'Susurro',
  'itemUi.procedural.rareWord.wyrm': 'Sierpe',
  'itemUi.procedural.rarity.common': 'Común',
  'itemUi.procedural.rarity.epic': 'Épico',
  'itemUi.procedural.rarity.legendary': 'Legendario',
  'itemUi.procedural.rarity.magic': 'Mágico',
  'itemUi.procedural.rarity.mythic': 'Mítico',
  'itemUi.procedural.rarity.rare': 'Raro',
  'itemUi.procedural.rollRangeAria': 'Tirada posible de {min} a {max}',
  'itemUi.stats.blockValue': 'Valor de bloqueo',
  'itemUi.stats.healthOnKill': 'Salud al matar',
  'itemUi.stats.manaOnKill': 'Maná al matar',
  'itemUi.stats.weaponDps': 'Daño de arma por segundo',
  'itemUi.stats.weaponMax': 'Daño máximo de arma',
  'itemUi.stats.weaponMin': 'Daño mínimo de arma',
  ...
  'hudChrome.enchanting.plainTag': 'Sin encantamiento',
  'hudChrome.enchanting.replaceConfirmKeeps': 'Se conserva: {kept}',
  ...
  'hudChrome.enchanting.replaceConfirmKeepsSigner': 'Marca del creador',
  'hudChrome.enchanting.salvagedYield': 'Desguazas {item} y obtienes {material}.',
  'hudChrome.enchanting.salvagedYieldQty': 'Desguazas {item} y obtienes {material} x{qty}.',
  'hudChrome.gathering.harvestLine': 'Cosechas: {name}.',
  'hudChrome.gathering.harvestLineQty': 'Cosechas: {name} x{qty}.',
