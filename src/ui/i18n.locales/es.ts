...
export const es: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Sandalias Caminaceniza',
  'entities.items.cinderarc_odrenns_rod.name': 'Arco de Ascua, vara de Odrenn',
  'entities.items.cindertoad_signet.name': 'Sello del Sapo de Ascua',
  'entities.items.coalglow_band.name': 'Sortija de Rescoldo',
  'entities.items.crownforged_warleggings.name': 'Perneras de guerra Forjacorona',
  'entities.items.glassblowers_shiv.name': 'Navaja del Soplador de Vidrio',
  'entities.items.glasswalker_treads.name': 'Botas Caminacristal',
  'entities.items.nighttalon_prowlers.name': 'Botas de Acecho Garra Nocturna',
  'entities.items.quenchsilk_cord.name': 'Cordón de Seda Templada',
  'entities.items.ring_of_the_first_quench.name': 'Anillo del Primer Temple',
  'entities.items.saans_stoking_iron.name': 'Atizador de Saan',
  'entities.items.slag_tempered_sabatons.name': 'Escarpes Templados en Escoria',
  'entities.items.slakeleather_belt.name': 'Cinturón de Cuero Templado',
  'entities.items.sluicebearer.name': 'Portador de la Esclusa',
  'entities.items.soulflame_kilt.name': 'Falda Llama de Alma',
  'entities.items.stokebrand_striders.name': 'Botas Marca de Ascua',
  'entities.items.stormcallers_legwraps.name': 'Vendas de piernas del Invocatormentas',
