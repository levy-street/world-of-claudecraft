...
export const fr_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.enchanting.disenchantedYield': 'Vous désenchantez {item} pour obtenir {material}.',
  'hudChrome.enchanting.disenchantedYieldQty':
    'Vous désenchantez {item} pour obtenir {material} x{qty}.',
  ...
  'hudChrome.enchanting.replaceConfirmKeepsMasterwork': "Bonus de chef-d'œuvre",
  'hudChrome.enchanting.replaceConfirmKeepsSigner': "Marque de l'artisan",
  ...
  'hudChrome.gathering.harvestLine': 'Vous récoltez : {name}.',
  'hudChrome.gathering.harvestLineQty': 'Vous récoltez : {name} x{qty}.',
  'hudChrome.gathering.harvestSpecimenLine': 'Vous récupérez également {name}.',
};
