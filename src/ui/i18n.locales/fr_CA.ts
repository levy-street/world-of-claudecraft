...
export const fr_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'loading.reconnecting': "Connexion interrompue. Reconnexion...",
  'hudChrome.crafting.close': "Fermer la fabrication",
  'hudChrome.crafting.craft': "Confectionner",
  'hudChrome.crafting.craftedToast': "Confectionné: {name}",
  'hudChrome.crafting.empty': "Vous ne connaissez pas encore de recettes.",
  'hudChrome.crafting.insufficientMaterials': "Il vous manque les matériaux nécessaires.",
  'hudChrome.crafting.reagentLine': "{name}: {have}/{required}",
  'hudChrome.crafting.reagentsNeeded': "Nécessite:",
  'hudChrome.crafting.resultAria': "Confectionner {name}",
  'hudChrome.crafting.title': "Fabrication",
  'hudChrome.crafting.unknownRecipe': "Cette recette est introuvable.",
  'hudChrome.mobile.actionPageIndicator': "p. {page}",
  'hudChrome.mobile.actionPageToggle': "Basculer la page d’actions",
  'hudChrome.mobile.actionRing': "Actions en combat",
  'hudChrome.mobile.spellbookPageLabel': "p. {page}",
  'hudChrome.mobile.targetCycle': "Alterner la cible",
  'hudChrome.mobile.targetCycleShort': "Objectif",
  'hudChrome.options.mobileCameraJoystick': "Manette de caméra",
  'hudChrome.options.mobileLeftHanded': "Disposition pour gauchers",
};
