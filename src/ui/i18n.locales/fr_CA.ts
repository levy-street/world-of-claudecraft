...
export const fr_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Souliers marchecendre',
  'entities.items.cinderarc_odrenns_rod.name': 'Sillage-de-braise, bâton d’Odrenn',
  'entities.items.cindertoad_signet.name': 'Bague crapaud-de-braise',
  'entities.items.coalglow_band.name': 'Jonc lueur-de-charbon',
  'entities.items.crownforged_warleggings.name': 'Pantalon de guerre Forgécouronne',
  'entities.items.glassblowers_shiv.name': 'Couteau du souffleur de verre',
  'entities.items.glasswalker_treads.name': 'Souliers marcheverre',
  'entities.items.nighttalon_prowlers.name': 'Souliers de rôdeur Serre-de-nuit',
  'entities.items.quenchsilk_cord.name': 'Corde de soie trempée',
  'entities.items.ring_of_the_first_quench.name': 'Bague de la première trempe',
  'entities.items.saans_stoking_iron.name': 'Fer à attiser de Saan',
  'entities.items.slag_tempered_sabatons.name': 'Bottes de plaque trempées dans le laitier',
  'entities.items.slakeleather_belt.name': 'Courroie en cuir trempé',
  'entities.items.sluicebearer.name': 'Gardien de l’écluse',
  'entities.items.soulflame_kilt.name': 'Jupe écossaise Flamme-d’âme',
  'entities.items.stokebrand_striders.name': 'Souliers marque-braise',
  'entities.items.stormcallers_legwraps.name': 'Jambières d’Appel-tempête',
  'entities.items.the_even_temper.name': 'Le Calme égal',
  'entities.items.twice_fired_slippers.name': 'Pantoufles cuites deux fois',
  'entities.items.twicetempered_girdle.name': 'Ceinture à double trempe',
  'entities.items.crownforged_heartplate.name': 'Plastron Cœur de Forgécouronne',
  'entities.items.nighttalon_emberweave.name': 'Tisse-braise Serre-de-nuit',
  'entities.items.soulflame_vestments.name': 'Vêtements de Flamme-d’âme',
  'entities.items.stormcallers_hauberk.name': 'Cotte de l’Invocateur de tempête',
  'entities.items.volzharrs_knucklestone.name': 'Pierre à poing de Volzharr',
  'entities.items.magmastrider_greaves.name': 'Jambières Arpente-magma',
  'entities.items.footwraps_of_the_waking_floor.name': 'Bandages du Sol en éveil',
  'entities.items.forgeheat_cinch.name': 'Ceinturon de chaleur de forge',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Brise-noyau, Cœur du Sous-mont',
  'entities.items.the_last_restraint.name': 'La Dernière Retenue',
  'entities.items.band_of_the_ninth_quench.name': 'Jonc de la Neuvième Trempe',
  'entities.items.moltenheart_chroma.name': 'Cœur fondu',
  'entities.itemSets.crownforged.bonus5': 'Accroît de 3 % les chances de coup critique.',
  'entities.itemSets.nighttalon.bonus5': 'Accroît de 3 % les chances de coup critique.',
  'entities.itemSets.soulflame.bonus5': 'Accroît de 3 % les chances de coup critique des sorts.',
  'entities.itemSets.stormcallers.bonus5': 'Accroît de 3 % les chances de coup critique des sorts.',
};
