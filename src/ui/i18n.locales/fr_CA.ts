...
export const fr_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.crownforged_heartplate.name': 'Cuirasse du Cœur Forgé-couronne',
  'entities.items.nighttalon_emberweave.name': 'Tissebraise Serre-de-nuit',
  'entities.items.soulflame_vestments.name': 'Habits Flamme-d’âme',
  'entities.items.stormcallers_hauberk.name': 'Haubert de l’Appel-tempête',
  'entities.items.volzharrs_knucklestone.name': 'Pierre de poing de Volzharr',
  'entities.items.magmastrider_greaves.name': 'Grèves Marche-magma',
  'entities.items.footwraps_of_the_waking_floor.name': 'Bandelettes du Sol éveillé',
  'entities.items.forgeheat_cinch.name': 'Ceinture Chaleur de forge',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Brise-cœur, Cœur du Sous-mont',
  'entities.items.the_last_restraint.name': 'La Dernière Entrave',
  'entities.items.band_of_the_ninth_quench.name': 'Anneau de la Neuvième Trempe',
  'entities.items.moltenheart_chroma.name': 'Cœur en fusion',
  'entities.itemSets.crownforged.bonus5': 'Augmente de 3 % les chances de coup critique.',
  'entities.itemSets.nighttalon.bonus5': 'Augmente de 3 % les chances de coup critique.',
  'entities.itemSets.soulflame.bonus5': 'Augmente de 3 % les chances de coup critique des sorts.',
  'entities.itemSets.stormcallers.bonus5':
    'Augmente de 3 % les chances de coup critique des sorts.',
};
