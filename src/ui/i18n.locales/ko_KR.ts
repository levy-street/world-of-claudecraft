...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.scene.waitingFor': '{name} 님을 기다리는 중',
  'hudChrome.mountTraining.buyReinsPrompt':
    '승마를 배웠습니다. 말라에게서 용맹마 고삐를 10골드에 구입한 뒤 사용하면 탈 수 있습니다.',
  'lb.fixture.ferry': '파쇼어 연락선',
  'lb.fixture.tidemill': '타이드밀',
  'lb.fixture.breach': '균열',
  'lb.speaker.tam': '종지기 탐',
  'lb.speaker.coalfast': '감시관 콜패스트',
  'lb.speaker.ollun': '균열감시자 올룬',
  'lb.speaker.edda': '병참장교 에다',
  'lb.speaker.saul': '치유사 사울',
  'lb.fare.promptOut': '파쇼어행 요금: {price}코퍼.',
  'lb.fare.promptBack': '본토행 요금: {price}코퍼.',
  'lb.fare.pay': '요금을 낸다.',
  'lb.fare.decline': '오늘은 됐어.',
  'lb.q0.scene.harbor':
    '분주한 항구다. 그물이 마르고 있고, 별유리 인양 상자에는 본토 구매자의 표식이 찍혀 있다.',
  'lb.q0.scene.plinth':
    '항구 계단 위에서 청동 감시관이 내륙을 바라본다. 받침대의 가장 최근 이름조차 백 년 전 것이다. 감시관 헤일. 그 아래에는 더 많은 이름을 새길 자리가 남아 있다.',
  'lb.q0.scene.toll':
    '종이 한 번 울린다. 거리의 모두가 걸음을 멈추고 수를 센다. 더는 아무 소리도 없자, 거리 전체가 한꺼번에 숨을 내쉰다.',
  'lb.q0.tam.stretchers':
    '지난번 그놈 하나 때문에 경비대 전원이 오전을 다 쓰고 들것도 두 개나 필요했지.',
  'lb.q0.coalfast.look':
    '회색 옷의 남자는 죽은 추적자를 본 뒤, 당신을 조금 더 오래 바라본다. 그리고 절벽 쪽으로 돌아간다.',
  'editor.cinematic.title': '시네마틱',
  'editor.cinematic.show': '패널 표시',
  'editor.cinematic.hide': '패널 숨기기',
  'editor.cinematic.scene': '장면',
  'editor.cinematic.pause': '일시 정지',
  'editor.cinematic.authoredCamera': '연출 카메라',
  'editor.cinematic.letterboxOn': '레터박스: 켜짐',
  'editor.cinematic.letterboxOff': '레터박스: 꺼짐',
  'editor.cinematic.violations': '위반 사항',
  'editor.cinematic.noViolations': '현재 위반 사항 없음',
  'editor.cinematic.capture': '키프레임 캡처',
  'editor.cinematic.copy': '블록 복사',
  'editor.cinematic.output': '생성된 카메라 캡처',
  'editor.cinematic.unavailable': '3D 뷰포트 불러오는 중',
  'editor.cinematic.seedMismatch': '캡처에는 배포용 월드 시드가 필요합니다',
  'editor.cinematic.captureSavedCopied': '저장하고 복사했습니다',
  'editor.cinematic.captureSaved': '저장했습니다. 아래에 블록이 준비되었습니다',
  'editor.cinematic.captureCopyOnly': '복사했습니다. 개발용 기록기를 사용할 수 없습니다',
  'editor.cinematic.captureReady': '아래에 블록이 준비되었습니다',
  'entities.mobs.lb_actor_coalfast.name': '감시관 콜패스트',
  'entities.mobs.lb_actor_ollun.name': '균열감시자 올룬',
  'entities.mobs.lb_actor_edda.name': '병참장교 에다',
  'entities.mobs.lb_actor_saul.name': '치유사 사울',
  'entities.mobs.lb_actor_tam.name': '종지기 탐',
  'entities.mobs.tidemill_stalker.name': '타이드밀 추적자',
  'entities.npcs.ferryman_ewald.name': '뱃사공 에발트',
  'entities.npcs.ferryman_ewald.title': '파쇼어 항로',
  'entities.npcs.ferryman_ewald.greeting':
    '파쇼어로 가나? 이제 낚시하러 건너는 사람은 아무도 없네, 친구. 준비되면 배에 오르고, 도착하면 종소리를 잘 들어. 이 마을 사람들은 날씨를 살피듯 그 소리를 듣거든.',
  'entities.npcs.ferryman_ewald_gullhaven.name': '뱃사공 에발트',
  'entities.npcs.ferryman_ewald_gullhaven.title': '파쇼어 항로',
  'entities.npcs.ferryman_ewald_gullhaven.greeting':
    '파쇼어로 가나? 이제 낚시하러 건너는 사람은 아무도 없네, 친구. 준비되면 배에 오르고, 도착하면 종소리를 잘 들어. 이 마을 사람들은 날씨를 살피듯 그 소리를 듣거든.',
  'entities.npcs.sergeant_marsh.name': '마시 병장',
  'entities.npcs.sergeant_marsh.title': '마을 민병대',
  'entities.npcs.sergeant_marsh.greeting':
    '훈련은 받았나? 그럼 오늘 밤 일을 설명하지. 우리 전열이 길을 지킨다. 균열에서 우리가 쓰러뜨릴 수 없는 게 나오면 자네에게 맡기겠다. 방앗간은 자네 몫이다. 아무것도 자네를 따라 들어가게 하지 말고, 우리를 지나 마을로 가게도 하지 마. 가게.',
  'entities.quests.q_lb_q0_ashore.title': '상륙',
  'entities.quests.q_lb_q0_ashore.text':
    '걸헤이븐은 밤낮으로 충격을 견디면서도 버티고 있다. 그들과 함께 설 생각이라면 마을이 피 흘리는 곳에서 시작하라. 항구 계단과 오래된 동상을 지나 동쪽 감시 초원의 민병대 전선으로 가라.',
  'entities.quests.q_lb_q0_ashore.completion':
    '방앗간의 사냥감은 자네 혼자 쓰러뜨렸고, 탐의 들것 이야기도 과장이 아니었군. 정찰병은 모자라고 지킬 들판은 넘친다. 오늘 밤 자네는 자신의 땅도 아닌 곳을 지켰다. 그게 이 일의 전부다. 경비대에 온 걸 환영한다.',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': '감시 초원의 마시 병장에게 보고',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': '균열 피조물 처치',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': '타이드밀 안의 존재 처치',
  'entities.zones.farshore_isle.pois.5.label': '균열',
  'entities.zones.farshore_isle.pois.6.label': '잔해 벌판',
  'entities.dungeons.lb_tidemill.name': '타이드밀',
  'entities.dungeons.lb_tidemill.enterText':
    '방앗간 문이 열린다. 안에서는 어둠이 귀를 기울이고 있다.',
  'entities.dungeons.lb_tidemill.leaveText': '타이드밀을 나와 저녁 공기 속으로 들어선다.',
  'entities.dungeons.lb_riftline.enterText':
    '순찰대 뒤로 초원 문이 닫힌다. 오늘 밤은 이 전선의 것이다.',
  'entities.dungeons.lb_riftline.leaveText': '균열 전선을 새벽 경비대에 맡긴다.',
  'entities.dungeons.lb_vault.name': '가라앉은 첫 보루',
  ...
  'entities.dungeons.lb_council.leaveText': '보루 밖으로 나선다.',
  'entities.dungeons.lb_landing.name': '밤의 상륙',
  'entities.dungeons.lb_landing.enterText':
    '유도 불빛이 해변을 따라 타오른다. 함대는 여울 너머에서 기다린다.',
  'entities.dungeons.lb_landing.leaveText': '상륙 해변을 뒤로한다.',
  'entities.dungeons.lb_riftfields.name': '균열 벌판 진입로',
  'entities.dungeons.lb_riftfields.enterText':
    '네 개의 결계 지점이 균열을 둘러싼다. 의식은 열두 세기 동안 그것을 닫아 두었다.',
  'entities.dungeons.lb_riftfields.leaveText': '균열 벌판에서 다시 내려온다.',
  'entities.dungeons.lb_breach.name': '균열 내부',
  'entities.dungeons.lb_breach.enterText':
    '빛이 이상하고 하늘은 더 나쁘다. 핵은 앞쪽 공터에 놓여 있다.',
  ...
  'entities.dungeons.lb_lastwatch.enterText':
    '보루는 깨끗하고 텅 비었다. 누군가는 이 경계를 끝내야 한다.',
  'entities.dungeons.lb_lastwatch.leaveText': '등 뒤로 보루 문을 닫는다.',
  'entities.dungeons.lb_willowfen.name': '윌로위프',
