...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolbeltTitle': '공구 벨트',
  'hudChrome.bags.toolbeltNone': '착용한 공구 벨트 없음',
  'hudChrome.bags.toolbeltRemoveHint': '클릭하여 이 공구 벨트를 벗기',
  'hudChrome.bags.toolbeltFilled': '도구 {used}/{total}',
  'hudChrome.bags.toolSlotLabel': '도구 슬롯 {slot}',
  'hudChrome.bags.toolSlotEmpty': '비어 있음',
  'hudChrome.bags.toolSlotStowHint': '클릭하여 {name} 보관',
  'hudChrome.bags.toolSlotTakeHint': '클릭하여 이 도구를 꺼내기',
  'hudChrome.bags.toolSlotNoTool': '보관할 도구가 없습니다',
  'itemUi.kind.toolbelt': '공구 벨트',
  'entities.items.basic_toolbelt.name': '기본 공구 벨트',
  'entities.items.reinforced_toolbelt.name': '보강된 공구 벨트',
  'entities.items.artisans_toolbelt.name': '장인의 공구 벨트',
  'itemUi.tooltip.toolbeltSlots': '도구를 {slots}개 수납할 수 있습니다',
