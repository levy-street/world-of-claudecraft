...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.mobs.tower_imp.name': '잿불 꼬마악마',
  'entities.mobs.tower_hellhound.name': '지옥사냥개',
  'entities.mobs.tower_pact_reaver.name': '계약 약탈자',
  'entities.mobs.tower_brimstone_zealot.name': '유황 광신도',
  'entities.mobs.tower_soulbinder.name': '영혼결속자',
  'entities.mobs.tower_iron_defiler.name': '강철 모독자',
  'entities.mobs.tower_abyss_knight.name': '심연 기사',
  'entities.mobs.tower_dread_harbinger.name': '공포의 전령',
  'entities.mobs.tower_gloom_bat.name': '어둠박쥐',
  'entities.mobs.tower_cinder_crawler.name': '잿불 포복자',
  'entities.mobs.tower_bone_acolyte.name': '뼈 수행사제',
  'entities.mobs.tower_shade_dancer.name': '그림자 무희',
  'entities.mobs.tower_flame_herald.name': '화염 전령',
  'entities.mobs.tower_rot_hulk.name': '부패 거한',
  'entities.mobs.tower_blood_matron.name': '피의 대모',
  'entities.mobs.tower_void_sentinel.name': '공허 파수꾼',
  'entities.mobs.tower_boss_flesh_shaper.name': '살점성형자 골',
  'entities.mobs.tower_boss_ash_tyrant.name': '재의 폭군 신더락스',
  'entities.mobs.tower_boss_gatekeeper.name': '관문지기 바스카르',
  'entities.mobs.tower_boss_demon_lord.name': '해방된 탑의 말그라스',
  'sim.rift.towerWave': '악마의 핵이 울부짖습니다. {total}개 중 {wave}번째 공세.',
  'sim.rift.ascendFloor': '{name}(으)로 올라갑니다.',
  'sim.rift.towerBossWave': '핵이 갈라지며 훨씬 끔찍한 존재가 걸어 나옵니다.',
  'sim.rift.towerFloorClear': '악마의 핵이 깨졌습니다. 위로 가는 길이 열렸습니다.',
  'sim.rift.towerCleared': '악마의 핵이 어두워졌습니다. 탑은 이제 당신의 것입니다.',
  'worldContent.demonTowerName': '악마의 탑',
  'worldContent.demonTowerBloodforgeName': '악마의 탑: 피의 대장간',
  'worldContent.demonTowerOssuaryName': '악마의 탑: 사슬 납골당',
  'worldContent.demonTowerVoidCrownName': '악마의 탑: 공허의 왕관',
  'worldContent.demonTowerCoreName': '악마의 핵',
  'worldContent.demonTowerAscentName': '탑의 승강로',
};
