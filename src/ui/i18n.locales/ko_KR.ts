...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.meters.loot': '전리품',
  'hud.meters.lootShort': '전리품',
  'hud.meters.lootHistory': '기록',
  'hud.meters.noLoot': '아직 기록된 전리품이 없습니다.',
  'hud.meters.recentAwards': '최근 획득 {count}개',
  'hud.meters.methodReturned': '포기',
  'hud.meters.methodMaster': '마스터',
  'hud.meters.methodPersonal': '개인',
  'hud.meters.methodDelve': '탐험',
  'hud.meters.methodLooted': '획득',
  'hud.meters.noWinner': '승자 없음',
  'hud.meters.rollDetail': '주사위 {roll}',
