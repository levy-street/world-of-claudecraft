...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.reviewLine':
    '{pay} {rail}을(를) 지불하고 {claudium} 클라우디움 ({usd})을(를) 받습니다.',
  ...
  'hudChrome.claudium.confirmPending':
    '온체인 확인을 기다리는 중입니다. 잠시 시간이 걸릴 수 있습니다.',
  ...
  'hudChrome.claudium.disclosure':
    '클라우디움은 일방향 소프트 화폐입니다. 돈으로 구매하여 치장 아이템에 사용합니다. 환급, 전송, 현금화는 불가능합니다.',
  'hudChrome.claudium.buyTitle': '클라우디움 구매',
  'hudChrome.claudium.railLabel': '결제 수단',
  'hudChrome.claudium.railStripe': '카드',
  'hudChrome.claudium.railWocUnavailable': 'WOC 가격을 현재 이용할 수 없습니다.',
  'hudChrome.claudium.amountLabel': '금액',
  'hudChrome.claudium.skuRow': '{usd}로 {claudium} 클라우디움',
  'hudChrome.claudium.buyButton': '구매',
  'hudChrome.claudium.buyUnavailable': '구매를 현재 이용할 수 없습니다.',
  'hudChrome.claudium.storeTitle': '치장 상점',
  'hudChrome.claudium.storeEmpty': '현재 이용 가능한 치장 아이템이 없습니다.',
  ...
  'hudChrome.claudium.tabsLabel': '클라우디움 탭',
  'hudChrome.claudium.tabBuy': '구매',
  'hudChrome.claudium.tabRedeem': '교환',
  'hudChrome.claudium.railDisabled': '이 결제 수단은 현재 사용할 수 없습니다.',
  'hudChrome.claudium.oracleUnavailable':
    '실시간 가격을 현재 사용할 수 없습니다. 잠시 후 다시 시도해 주세요.',
  'hudChrome.claudium.quoteButton': '견적 받기',
  'hudChrome.claudium.amountRow': '{usd}로 {claudium} 클라우디움',
  'hudChrome.claudium.sendExactly': '정확히 {amount} {rail} 전송',
  'hudChrome.claudium.addressLabel': '받는 주소',
  'hudChrome.claudium.memoLabel': '메모 (필수)',
  'hudChrome.claudium.splitBurn': '{amount} {rail} 소각',
  'hudChrome.claudium.splitTreasury': '{amount} {rail} 재무고로',
  'hudChrome.claudium.expiresIn': '견적은 {time} 후 만료됩니다',
  'hudChrome.claudium.quoteExpired': '이 견적은 만료되었습니다. 새로 받으세요.',
  'hudChrome.claudium.payNote':
    '본인 지갑에서 메모와 함께 정확한 금액을 전송한 다음 거래 서명을 붙여넣어 확인하세요. 서비스가 온체인에서 검증한 후 적립합니다.',
  'hudChrome.claudium.signatureLabel': '거래 서명',
  'hudChrome.claudium.signaturePlaceholder': '서명 붙여넣기',
  'hudChrome.claudium.confirmButton': '결제 확인',
  'hudChrome.claudium.confirmCredited': '{amount} 클라우디움이 적립되었습니다.',
  'hudChrome.claudium.confirmFailed':
    '아직 이 결제를 확인할 수 없습니다. 잠시 후 다시 시도해 주세요.',
  'hudChrome.claudium.redeemTitle': '기프트 카드 교환',
  'hudChrome.claudium.enterCode': '기프트 카드 코드를 입력하세요',
  'hudChrome.claudium.redeemButton': '교환',
  'hudChrome.claudium.redeemed': '{amount} 클라우디움을 교환했습니다. 새 잔액: {balance}.',
  'hudChrome.claudium.redeemFailed':
    '이 코드를 교환할 수 없습니다. 코드를 확인하고 다시 시도하세요.',
  'hudChrome.claudium.back': '뒤로',
  'hudChrome.claudium.tabHistory': '내역',
  'hudChrome.claudium.giftTitle': '기프트 카드 선물하기',
  'hudChrome.claudium.giftDenominationLabel': '금액',
  'hudChrome.claudium.giftRecipientLabel': '받는 사람',
  'hudChrome.claudium.giftToSelf': '나에게',
  'hudChrome.claudium.giftToOther': '다른 사람에게',
  'hudChrome.claudium.giftEmailLabel': '받는 사람 이메일',
  'hudChrome.claudium.giftEmailInvalid': '유효한 이메일 주소를 입력하세요.',
  'hudChrome.claudium.giftOccasionLabel': '상황',
  'hudChrome.claudium.giftMessageLabel': '개인 메시지',
  'hudChrome.claudium.giftMessagePlaceholder': '짧은 메시지 추가 (선택)',
  'hudChrome.claudium.giftDeliveryLabel': '전달 방법',
  'hudChrome.claudium.giftScheduleLabel': '전달 예약 (선택)',
  'hudChrome.claudium.giftReviewButton': '선물 확인',
  'hudChrome.claudium.giftReviewSelf': '이 기프트 카드는 본인이 교환할 수 있습니다.',
  'hudChrome.claudium.giftReviewEmail': '이 기프트 카드를 {email}(으)로 보내드립니다.',
  'hudChrome.claudium.giftReviewShared': '이 기프트 카드를 공유할 링크를 받게 됩니다.',
  'hudChrome.claudium.giftReviewScheduled': '선택한 날짜에 전달됩니다.',
  'hudChrome.claudium.giftConfirmButton': '확인 후 결제',
  'hudChrome.claudium.giftAnotherButton': '하나 더 선물하기',
  'hudChrome.claudium.giftPending': '기프트 카드를 발급하고 있습니다. 잠시 걸릴 수 있습니다.',
  'hudChrome.claudium.giftIssued': '기프트 카드를 공유할 수 있습니다.',
  'hudChrome.claudium.giftFailed': '기프트 카드를 발급할 수 없습니다. 잠시 후 다시 시도하세요.',
  'hudChrome.claudium.giftDeclined': '결제가 거절되었습니다. 기프트 카드가 발급되지 않았습니다.',
  'hudChrome.claudium.giftLinkLabel': '기프트 카드 링크',
  'hudChrome.claudium.giftQrAlt': '기프트 카드 교환 링크 QR 코드',
  'hudChrome.claudium.giftTerms':
    '기프트 카드는 클라우디움으로만 교환할 수 있습니다. 현금으로 교환하거나 환불할 수 없습니다.',
  'hudChrome.claudium.deliveryEmail': '이메일',
  'hudChrome.claudium.deliveryLink': '링크 공유',
  'hudChrome.claudium.deliveryReveal': '지금 표시',
  'hudChrome.claudium.occasionBirthday': '생일',
  'hudChrome.claudium.occasionHoliday': '기념일',
  'hudChrome.claudium.occasionCongrats': '축하',
  'hudChrome.claudium.occasionThankyou': '감사',
  'hudChrome.claudium.occasionGeneric': '그냥',
  'hudChrome.claudium.reasonPurchaseStripe': '구매 (카드)',
  'hudChrome.claudium.reasonPurchaseSol': '구매 (SOL)',
  'hudChrome.claudium.reasonPurchaseUsdc': '구매 (USDC)',
  'hudChrome.claudium.reasonPurchaseWoc': '구매 (WOC)',
  'hudChrome.claudium.reasonGiftcardRedeem': '기프트 카드 교환',
  'hudChrome.claudium.reasonSpend': '장식 구매',
  'hudChrome.claudium.reasonRefund': '환불',
  'hudChrome.claudium.reasonChargeback': '지불 거절',
  'hudChrome.claudium.reasonGiftcardVoid': '기프트 카드 무효화',
  'hudChrome.claudium.historyTitle': '거래 내역',
  'hudChrome.claudium.historyLoading': '내역을 불러오는 중...',
  'hudChrome.claudium.historyError': '내역을 불러올 수 없습니다. 다시 시도하세요.',
  'hudChrome.claudium.historyEmpty': '아직 클라우디움 거래가 없습니다.',
  'hudChrome.claudium.historyLoadMore': '더 보기',
  'hudChrome.claudium.historyFilterLabel': '유형별 필터',
  'hudChrome.claudium.historyFilterAll': '모든 유형',
  'hudChrome.claudium.historyExplorer': 'Solana Explorer에서 보기',
  'hudChrome.claudium.historyReceipt': '카드 구매',
  'hudChrome.claudium.historyGiftNote': '기프트 카드',
  'hudChrome.claudium.timeJustNow': '방금',
  ...
  'hudChrome.claudium.tryOnActiveNote':
    '내 캐릭터에 미리 착용해보는 중입니다. 소유가 부여되지 않습니다.',
  'hudChrome.claudium.tabSupply': '공급량',
  'hudChrome.claudium.supplyTitle': '현존하는 클라우디움',
  'hudChrome.claudium.supplyLoading': '공급량을 불러오는 중...',
  'hudChrome.claudium.supplyError': '공급량을 불러오지 못했습니다. 다시 시도해 주세요.',
  'hudChrome.claudium.supplyUnavailable': '현재 공급량 정보를 사용할 수 없습니다.',
  'hudChrome.claudium.supplyInExistence': '현존 {amount}',
  'hudChrome.claudium.supplyUsdValue': '가치 {amount}',
  'hudChrome.claudium.supplyIssued': '총 발행량',
  'hudChrome.claudium.supplySunk': '총 사용 및 취소량',
  'hudChrome.claudium.supplyHolders': '{n}개 계정이 보유',
  'hudChrome.claudium.supplyChangeUp': '이 기간 동안 {amount} 증가',
  'hudChrome.claudium.supplyChangeDown': '이 기간 동안 {amount} 감소',
  'hudChrome.claudium.supplyChangeFlat': '이 기간 동안 변동 없음',
  'hudChrome.claudium.supplyChartLabel': '선택한 기간의 클라우디움 공급량',
  'hudChrome.claudium.supplyChartEmpty': '이 기간에는 공급량 변동이 없습니다.',
  'hudChrome.claudium.supplyRangeLabel': '차트 기간',
  'hudChrome.claudium.supplyFootnote':
    '모든 계정이 보유한 클라우디움 전체를 원장에서 실시간으로 집계합니다.',
};
