...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.professions.endgameMaterialsBodyAnyRaid':
    '세 가지 공유 재료가 사슬 전체를 먹인다. 낙룡의 핵은 거래되는 촉매다. 가장 깊은 최종 콘텐츠의 최종 승리마다 기여가 인정된 캐릭터에게 핵 1개에서 3개를 지급하며, 출처마다 하루 한 번이다. 최상위 균열 완주는 같은 일일 시계로 정해진 수를 지급하고, 영웅 병참장교는 불운의 안전판으로 영웅 징표 12개에 하나를 판다. 핵은 자유롭게 거래된다. 갈라진 정수는 귀속이며, 가르기가 유일한 출처다. 어떤 캐릭터든 전문 기술 없이 가를 수 있고, 그 시전은 공격대에서 얻은 서사 아이템 하나를, 어느 공격대의 것이든 일반이든 영웅 난이도든 가리지 않고, 갈라 정확히 정수 하나로 만들며, 대가는 그 아이템 자체다. 장인의 불씨도 귀속이고, 이 사슬의 시계다. 캐릭터마다 일주일에 하나, 그 주 첫 번째 자격 있는 최종 완주에서 주어지며, 놓친 주는 사라지지 않는다. 불씨는 쌓였다가 다음 완주에서 한꺼번에 지급된다.',
  ...
  'guide.profPages.toolsNoteThreeRods':
    '모든 채집물에는 해당 전문 기술의 도구가 가방에 있어야 하며, 1단계도 예외가 아닙니다. 곡괭이가 없으면 광석도 없고, 낚싯대가 없으면 물고기도 없습니다. 상인 사다리는 세 중심 거점에 걸쳐 1단계부터 3단계까지를 다룹니다. 1단계 도구는 세 곳 모두에서 팔리고, 그 위 단계는 그것을 쓰는 지형이 시작되는 곳에서 팔리며(Fenbridge가 2단계를, Highwatch가 3단계를 더합니다), 그 너머의 젊은 정착지에는 도구가 아예 없으니 떠나기 전에 갖추십시오. 어느 판매대든 자기가 갖춘 단은 조건 없이 팔고, 어떤 도구든 직접 거래로 건넬 수 있습니다. 20동짜리 육상 입문 도구 셋을 뺀 모든 단은 시장에도 올라가고 우편으로도 오갑니다. 그 셋은 판매대에서 사거나 손에서 손으로 건넬 뿐, 되팔거나 부치거나 등록할 수 없습니다. 제한이 걸리는 것은 사용입니다. 1단계 위의 육상 도구는 해당 전문 기술의 숙련도가 그것을 벌어야 비로소 작동합니다. 2단계는 {tier2Prof}, 3단계는 {tier3Prof}, 제작 단 둘은 85와 100이 필요하며, 판매 항목과 툴팁과 아래 표가 모두 그 조건을 먼저 알려 줍니다. 그때까지 미리 사 둔 도구는 가방에서 기다리기만 할 뿐, 지형을 열지도 속도를 사지도 고급 등급을 찍지도 않다가, 숙련도가 그 숫자에 닿는 순간 쓰이기 시작합니다. 낚싯대만은 예외입니다. 어떤 낚싯대에도 사용 조건이 없고, Eastbrook의 Trader Wilkes는 미리 사 두려는 낚시꾼을 위해 2단계와 3단계 낚싯대를 일부러 갖춰 둡니다. 도구는 장비 칸도 차지하지 않고 닳지도 않으므로 한 번만 사면 되며, 제한에 관여하는 것은 단계뿐입니다. 같은 단계에서 더 희귀한 도구라고 해서 더 열리는 것은 없습니다. 다만 희귀도가 색깔만인 것은 아닙니다. 장착한 도구 효과가 더 오래가고, 낚싯대라면 낚아채는 시간도 넓어집니다.\n\n더 좋은 도구는 두 가지가 아니라 세 가지를 줍니다. 더 높은 단계의 지형을 열고, 채집 시간을 줄이고, 나오는 것을 좋게 합니다. 그 지역 자체의 재료보다 높은 단계의 도구로 광맥을 캐면 평범한 재료 대신 고급 등급이 나옵니다. 대상은 그 지역의 완전 등급 광맥이어야 하므로, 여행자를 위해 남겨둔 쉬운 광맥에서는 여전히 평범한 재료가 나옵니다. 고급 재료는 제작 도구 제조법이 소모하는 것이며, 제조법이나 작업 지시가 평범한 판본을 요구하는 곳이라면 어디서든 고급 등급이 그것을 대신합니다. 그러니 장비를 올린다고 막히는 일은 없습니다. 구리 광석이 고급 구리 광석으로 들어올 뿐입니다.\n\n상인 사다리 위로는 각 육상 전문 기술마다 4단계와 5단계의 제작 도구가 둘 있습니다. 도구 공방에서 만들거나(육상 제조법은 모든 캐릭터가 알고 있으며, 그 작업으로 오르는 기술은 기계공학의 것입니다), 공략 조건을 채웠다면 익사한 연도의 상점에서 탐굴 증표로 살 수 있습니다. 아래 표에 증표 가격과 각 단이 요구하는 공략 횟수가 적혀 있습니다. 어떤 상인도 동전으로는 팔지 않습니다. 낚시에는 자체 도구가 셋 있고, 이 문단의 이야기 전부에서 예외입니다. 도구 장인이 4단계 폭풍릴 낚싯대와 5단계 조수벼림 낚싯대를 가르치고, 6단계 태엽릴 낚싯대는 그 대신 도안으로 만들며, 셋 모두 기술만으로는 결코 닿을 수 없는 어획 구간을 엽니다. 그러니 물 위에서 최상위 단이 사는 것은 편의가 아니라 접근 권한입니다. 육상 전문 기술 쪽은 오늘날 3단계를 넘게 요구하는 채집물이 없으므로, 그쪽의 4단계와 5단계 도구가 사는 것은 여전히 접근 권한이 아니라 속도와 등급이며, 더 높은 단계의 지형이 나오면 그것들이 입장권이 될 것입니다.',
