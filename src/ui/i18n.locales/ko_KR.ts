...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'game.leaderboard.guildCol': '길드',
  'game.leaderboard.members': '구성원',
  'game.leaderboard.topLevel': '최고 레벨',
  'game.leaderboard.totalXp': '총 경험치',
  'game.leaderboard.tabPlayers': '플레이어',
  'game.leaderboard.tabGuilds': '길드',
