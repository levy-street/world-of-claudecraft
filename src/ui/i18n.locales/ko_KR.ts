...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolSlotStowHint': '클릭하여 최고의 {type} 도구를 보관',
  'hudChrome.bags.toolSlotTakeHint': '클릭하여 이 도구를 꺼내기',
  'hudChrome.bags.toolSlotNoTool': '{type} 도구를 소지하고 있지 않습니다',
  'hudChrome.bags.toolType.mining': '채광',
  'hudChrome.bags.toolType.logging': '벌목',
  'hudChrome.bags.toolType.herbalism': '약초학',
