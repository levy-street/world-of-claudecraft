...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.invertX': '카메라 반전(X축)',
  'hudChrome.controller.invertMoveX': '이동 반전(X축)',
  'hudChrome.controller.invertMoveY': '이동 반전(Y축)',
  'hudChrome.controller.cameraAutoFollow': '카메라 자동 따라가기',
