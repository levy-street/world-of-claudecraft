...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.chat.categories.hide': '전체 보기에서 {category} 메시지 숨기기',
  'hudChrome.chat.categories.show': '전체 보기에서 {category} 메시지 표시',
  'hudChrome.chat.categories.game': '게임',
  'hudChrome.chat.categories.loot': '전리품',
  'hudChrome.chat.categories.xp': '경험치',
  'hudChrome.chat.categories.quest': '퀘스트',
  'hudChrome.chat.categories.event': '이벤트',
  'hudChrome.chat.categories.public': '공개',
  'hudChrome.chat.categories.party': '파티',
  'hudChrome.chat.categories.guild': '길드',
  'hudChrome.chat.categories.channels': '채널',
  'hudChrome.chat.categories.whispers': '귓속말',
