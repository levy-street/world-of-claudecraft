...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.rift_arcane_execution': '공허의 균열',
  'abilityUi.cast.rift_arcane_strike': '아케인 파멸',
  'abilityUi.cast.rift_brute_execution': '대지분쇄',
  'abilityUi.cast.rift_brute_strike': '최종 판결',
  'abilityUi.cast.rift_ember_execution': '마그마웰',
  'abilityUi.cast.rift_ember_strike': '코어 붕괴',
  'abilityUi.cast.rift_frost_execution': '빙하의 무덤',
  'abilityUi.cast.rift_frost_strike': '절대영도',
  'abilityUi.cast.rift_necro_execution': '영혼의 무덤',
  'abilityUi.cast.rift_necro_strike': '사형 선고',
  'abilityUi.cast.rift_storm_execution': '피뢰침',
  'abilityUi.cast.rift_storm_strike': '폭풍소환사의 분노',
  'abilityUi.cast.rift_tide_execution': '심연의 아귀',
  'abilityUi.cast.rift_tide_strike': '분쇄 깊이',
  'abilityUi.cast.rift_venom_execution': '베놈 풀',
  'abilityUi.cast.rift_venom_strike': '무리어미의 징표',
  'hud.core.riftLabel': '{이름} {name}',
  'hud.core.riftLabelRanked': '{이름} ({순위}) {name} {rank}',
  'fiesta.augment.cardAria': '{이름} ({범주}) - {설명} {name} {category} {description}',
  'hudChrome.continentMap.toZone': '구역 지도',
  'hudChrome.meters.breakdownRow': '{값}({퍼센트}) {value} {percent}',
  'hudChrome.meters.breakdownSummary': '{탭}: {값} {tab} {value}',
  'hudChrome.meters.percent': '{값}% {value}',
  'hudChrome.meters.petAbility': '{애완동물}: {능력} {pet} {ability}',
  'hudChrome.mountRace.go': '가세요!',
  'hudChrome.mountRace.timeLeft': '{초}초 {seconds}',
};
