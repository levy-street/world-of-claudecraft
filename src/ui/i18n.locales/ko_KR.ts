...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'landing.heroEyebrow': '세계는 이미 움직이고 있습니다',
  'landing.heroHeading': '플레이어와 AI 모험가가 같은 세계에 맞서는 살아 있는 클래식 MMO입니다.',
  'landing.heroBody':
    '브라우저에서 무료로 플레이하고, 아홉 직업 중 하나로 영웅을 키우거나 실제 게임에서 에이전트를 훈련하세요.',
  'landing.heroStatus': '월드 온라인',
  'landing.heroPlayers': '명의 등록 모험가',
  'landing.communityLinks': '커뮤니티 링크',
  'landing.followSocials': '소셜에서 팔로우',
  'landing.socialDiscord': 'Discord 커뮤니티',
  'landing.socialTwitch': 'Twitch 방송',
  'landing.socialInstagram': 'Instagram 공식 계정',
  'landing.socialReddit': 'Reddit 커뮤니티',
  'landing.browserCta': '브라우저에서 플레이',
  'landing.playNowBody': '브라우저에서 바로 플레이하세요. 다운로드할 필요가 없습니다.',
  'landing.playWayBody': '원하는 플랫폼을 선택하고 모험에 참여하세요.',
  'landing.syncProgress': '모든 플랫폼에서 진행 상황 동기화',
  'landing.explore': '세계 탐험',
  'landing.platformsEyebrow': '어디서든 모험을 시작하세요',
  'landing.appStoreAria': 'App Store에서 World of ClaudeCraft 다운로드',
  'landing.googlePlayAria': 'Google Play에서 World of ClaudeCraft 받기',
  'landing.steamAria': 'World of ClaudeCraft Steam 버전 출시 예정',
  'landing.comingSoon': '출시 예정',
  'landing.introEyebrow': '하나의 세계, 하나의 규칙',
  'landing.introHeading': '모든 모험가가 실제 게임을 플레이합니다.',
  'landing.introBody':
    '브라우저 MMO, 권한형 온라인 월드, AI 훈련은 모두 같은 결정론적 시뮬레이션에서 실행됩니다. 플레이어와 에이전트는 같은 전투, 퀘스트, 던전, 결과를 마주합니다.',
  'landing.statClasses': '플레이 가능한 9개 직업',
  'landing.statModes': '온라인 및 오프라인 월드',
  'landing.statBroadcast': '연중무휴 AI 방송',
  'landing.statSource': '오픈 소스',
  'landing.worldEyebrow': 'Claudemoon을 가로지르는 여정',
  'landing.worldHeading': '긴 여정과 위험한 밤을 위해 만들어진 세계.',
  'landing.worldBody':
    'Eastbrook Vale의 모닥불에서 시작해 유령이 깃든 지하묘지로 내려가고, 폭풍 치는 Thornpeak을 오르세요. 모든 길은 계속 움직이는 세계의 더 깊은 곳으로 이어집니다.',
  'landing.eastbrookTitle': '이스트브룩 골짜기',
  'landing.eastbrookBody': '첫 퀘스트와 떠도는 적, 뜻밖의 동료가 만나는 공동의 변경입니다.',
  'landing.eastbrookAlt': '모험가 일행이 이스트브룩 골짜기에서 쏜피크 고원으로 이어지는 긴 길을 여행하는 모습',
  'landing.hollowTitle': 'Hollow Crypt',
  'landing.hollowBody': '차가운 푸른 횃불 아래에서 무리 지어 모이는 언데드와 파티 전투를 벌이세요.',
  'landing.hollowAlt': 'Hollow Crypt 안에서 적과 맞서는 파티',
  'landing.thornpeakTitle': '쏜피크 고원',
  'landing.thornpeakBody': '구름 위에서 눈과 고대 유적, 최종 단계의 위협이 기다립니다.',
  'landing.thornpeakAlt': 'Thornpeak Heights에 내리는 눈',
  'landing.classesEyebrow': '당신의 전설을 선택하세요',
  'landing.classesHeading': '아홉 개의 길, 끝없는 전투 방식.',
  'landing.classesBody':
    '방패벽을 지키고, 불과 서리를 다루고, 그림자 속에서 기습하거나 파티를 살려 내세요. 영웅을 키우고 전문화를 숙달해 그 이야기를 공동 세계로 이어 가세요.',
  'landing.streamEyebrow': '연중무휴 생방송',
  'landing.streamNetwork': 'WOC 방송 네트워크',
  'landing.streamFeed': 'YUUMIII // 라이브 피드',
  'landing.streamMonogram': 'Y',
  'landing.streamHeading': 'Yuumiii는 절대 로그아웃하지 않습니다.',
  'landing.streamBody':
    'World of ClaudeCraft의 상주 AI 스트리머가 연중무휴로 이 세계를 플레이하며 생방송합니다.',
  'landing.streamWatch': 'Twitch에서 시청',
  'landing.streamLoading': '관측 포털을 여는 중...',
  'landing.streamReady': '관측 포털이 준비되었습니다. 재생을 눌러 Yuumiii를 시청하세요.',
  'landing.streamOnline': 'Yuumiii가 지금 생방송 중입니다.',
  'landing.streamOffline':
    '관측 포털을 다시 연결하고 있습니다. Twitch 채널을 열어 계속 시청하세요.',
  'landing.streamCompact': 'Twitch 채널을 열어 이 화면에서 Yuumiii를 시청하세요.',
  'landing.streamUnavailable':
    '관측 포털을 사용할 수 없습니다. Twitch 채널을 열어 계속 시청하세요.',
  'landing.openEyebrow': '열린 세계, 열린 코드',
  'landing.openHeading': '세계를 포크하고 모험가를 훈련하세요.',
  'landing.openBody':
    '소스를 살펴보고, 나만의 세계를 호스팅하거나, 플레이어가 매일 입장하는 같은 결정론적 게임에 Gymnasium 호환 에이전트를 연결하세요.',
  'landing.supportEyebrow': '세계를 계속 움직이게 하세요',
  'landing.supportHeading': '만들고, 플레이하고, 다음 장을 지원하세요.',
  'landing.supportBody':
    'World of ClaudeCraft는 열린 협업 속에서 성장합니다. 커뮤니티에 참여하고 살아 있는 세계를 지켜보거나 지속적인 개발을 지원하세요.',
  'landing.xCta': 'X에서 팔로우',
  'landing.patchNotesLabel': '패치 노트',
  'landing.patchNotesTitle': '패치 노트',
  'landing.patchNotesDesc': '최신 게임플레이 변경 사항, 수정 사항 및 릴리스 세부 정보를 확인하세요.',
  'landing.patchNotesLoading': '최신 패치 노트를 불러오는 중…',
  'landing.patchNotesError': '패치 노트를 불러오지 못했습니다. 나중에 다시 시도해 주세요.',
  'landing.patchNotesEmpty': '아직 패치 노트가 없습니다. 곧 다시 확인해 주세요.',
  'landing.patchNotesPrerelease': '사전 출시',
  'landing.patchNotesViewOnGithub': 'GitHub에서 릴리스 보기',
  'landing.newsEyebrow': '세계의 소식',
  'landing.newsTitle': 'Claudemoon 소식',
  'landing.newsBody': 'World of ClaudeCraft의 최신 소식과 이 세계 뒤편의 이야기를 만나보세요.',
  'landing.newsXTitle': 'X 최신 소식',
  'landing.newsXIntro': '@WoClaudecraft의 공식 게시물',
  'landing.newsXPrivacy': '이 피드를 불러오면 X에 연결되며 X가 방문 정보를 받을 수 있습니다.',
  'landing.newsXLoad': 'X 피드 불러오기',
  'landing.newsXRetry': '다시 시도',
  'landing.newsXHide': 'X 피드 숨기기',
  'landing.newsXOpen': 'X에서 @WoClaudecraft 열기',
  'landing.newsXNewTab': '새 탭에서 열립니다',
  'landing.newsXLoading': 'X 피드를 여는 중…',
  'landing.newsXUnavailable': 'X 피드를 불러오지 못했습니다. 모든 게시물은 X에서 직접 볼 수 있습니다.',
  'landing.newsXIframeTitle': 'X의 @WoClaudecraft 최신 게시물',
  'landing.newsBlogEyebrow': 'CLAUDEMOON 연대기',
  'landing.newsBlogTitle': '최신 이야기',
  'landing.newsBlogEmptyTitle': '첫 번째 이야기를 쓰고 있습니다',
  'landing.newsBlogEmptyBody': '뉴스와 비하인드 스토리가 곧 여기에 게시됩니다.',
  'landing.newsXOpenAria': 'X에서 @WoClaudecraft를 새 탭으로 열기',
  'landing.newsXLoaded': 'X 피드를 불러왔습니다.',
  'landing.newsXHidden': 'X 피드가 숨겨져 있습니다. 프로필은 X에서 직접 열 수 있습니다.',
  'landing.twitchCategoryCta': 'World of ClaudeCraft 방송 둘러보기',
  'landing.finalEyebrow': '당신의 이야기는 관문에서 시작됩니다',
  'landing.finalHeading': 'Claudemoon으로 들어갈 방법을 선택하세요.',
  'landing.finalBody':
    '지금 브라우저에서 플레이하고 모바일에서 이어 가거나 Steam 출시를 기다리세요.',
  ...
  'nav.donate': '후원',
  'stats.title': '월드 상태',
  'stats.accountsCreated': '전체 플레이어 수',
  ...
  'mode.onlineDesc': '라이브 서버에서 플레이합니다. 캐릭터는 온라인에 저장됩니다.',
  'mode.onlineAria': '온라인 플레이: 지속적으로 공유되는 월드에 로그인합니다',
  'mode.offlineTitle': '오프라인 플레이',
  'mode.offlineDesc':
    '브라우저에서 로컬 오프라인 월드를 플레이합니다. 진행 상황은 저장되지 않습니다.',
  ...
  'mode.serverAria': '서버 모드 선택: 서버 온라인 또는 서버 오프라인',
  'mode.serverLabel': '월드를 선택하세요',
  'mode.serverOffline': '서버 오프라인',
  'mode.serverOfflineSub': '로컬 오프라인 월드',
  'mode.serverOnline': '서버 온라인',
  ...
  'landing.streamWatchSub': 'Yuumiii 라이브에 참여',
  'landing.streamExplore': '세계 탐험',
  'landing.streamExploreSub': '클로드문 발견하기',
  'landing.streamHeroSubtitle': '상주 AI 스트리머가 24시간 세계를 모험합니다.',
  'landing.streamMeet': '가이드 소개',
  'landing.streamHostTitle': '상주 AI 스트리머',
  'landing.streamHostBody': 'Yuumiii와 함께 밤낮없이 World of ClaudeCraft의 모든 곳을 탐험하세요.',
  'landing.streamPortraitAlt': 'World of ClaudeCraft의 상주 AI 스트리머 Yuumiii',
  'landing.streamAlwaysTitle': '24시간 라이브',
  'landing.streamAlwaysBody': '언제나 접속 중. 모험은 멈추지 않습니다.',
  'landing.streamAiTitle': 'AI 스트리머',
  'landing.streamAiBody': 'AI가 선사하는 생생한 반응과 끝없는 재미.',
  'landing.streamCommunityTitle': '커뮤니티',
  'landing.streamCommunityBody': '채팅과 퀘스트, 놀라움이 기다립니다.',
  'landing.streamWorldTitle': '진짜 세계',
  'landing.streamWorldBody': '하나의 지속적인 세계. 무한한 이야기.',
  'hudChrome.privacyConsent.bannerTitle': 'Claudemoon에서의 개인정보 보호',
  'hudChrome.privacyConsent.bannerOptIn': '선택 서비스를 불러올지 선택하세요. 필수 서비스는 항상 활성화됩니다.',
  'hudChrome.privacyConsent.bannerOptOut':
    '선택 서비스가 활성화되어 있습니다. 「선택 서비스 거부」를 눌러 타겟 광고를 위한 정보 판매 또는 공유를 거부하거나, 불러올 항목을 직접 선택하세요.',
  'hudChrome.privacyConsent.bannerGpc': '브라우저의 Global Privacy Control 신호를 존중합니다. 분석 및 마케팅 기능은 비활성 상태로 유지됩니다.',
  'hudChrome.privacyConsent.acceptAll': '모두 허용',
  'hudChrome.privacyConsent.rejectAll': '선택 서비스 거부',
  'hudChrome.privacyConsent.customize': '직접 설정',
  'hudChrome.privacyConsent.launcher': '개인정보 설정',
  'hudChrome.privacyConsent.dialogTitle': '개인정보 설정',
  'hudChrome.privacyConsent.dialogIntro':
    'World of ClaudeCraft에서 사용할 수 있는 선택 서비스를 고르세요. 이 설정은 언제든지 변경할 수 있습니다.',
  'hudChrome.privacyConsent.close': '개인정보 설정 닫기',
  'hudChrome.privacyConsent.necessaryTitle': '필수',
  'hudChrome.privacyConsent.necessaryBody': '보안, 환경 설정 저장, 인증 및 핵심 게임 기능에 필요합니다.',
  'hudChrome.privacyConsent.analyticsTitle': '분석',
  'hudChrome.privacyConsent.analyticsBody': '사이트 이용 현황을 파악하고 게임 성능 문제를 진단하는 데 도움이 됩니다.',
  'hudChrome.privacyConsent.marketingTitle': '마케팅',
  'hudChrome.privacyConsent.marketingBody': 'Meta Pixel 등의 서비스를 통해 캠페인 성과를 측정합니다.',
  'hudChrome.privacyConsent.xTitle': 'X 피드',
  'hudChrome.privacyConsent.xBody': '뉴스 페이지에 삽입된 @WoClaudecraft 타임라인을 불러올 수 있게 합니다.',
  'hudChrome.privacyConsent.twitchTitle': 'Twitch 플레이어',
  'hudChrome.privacyConsent.twitchBody': '삽입된 Yuumiii 라이브 방송 플레이어를 불러올 수 있게 합니다.',
  'hudChrome.privacyConsent.alwaysOn': '항상 사용',
  'hudChrome.privacyConsent.save': '설정 저장',
  'hudChrome.privacyConsent.cookiePolicy': 'Cookie 정책 읽기',
  'hudChrome.privacyConsent.twitchBlocked': '개인정보 설정에서 Twitch를 허용할 때까지 Twitch 플레이어가 일시 중지됩니다.',
  'hudChrome.privacyConsent.twitchEnable': 'Twitch 개인정보 설정 선택',
  'nav.communityBuilt': '커뮤니티 제작',
  'footer.cookies': 'Cookie 안내',
  'footer.privacyChoices': '개인정보 설정',
  'landing.newsXConsentTitle': 'X 피드를 불러오려면 허가가 필요합니다',
  'landing.newsXConsentBody': '이 라이브 피드를 X에 연결하려면 허가가 필요합니다. X에서 방문 관련 정보를 받을 수 있습니다.',
  'landing.newsXConsentNote': '개인정보 설정에서 X 콘텐츠를 활성화하세요. 이 설정은 언제든지 변경할 수 있습니다.',
  'landing.newsXPrivacyChoices': '개인정보 설정',
  'landing.newsXUnavailableTitle': 'X 피드를 불러오지 못했습니다',
  'landing.newsXUnavailableBody': '브라우저나 확장 프로그램에서 차단했거나 X에 일시적인 문제가 발생했을 수 있습니다.',
  'landing.newsXHiddenTitle': '여기서는 라이브 피드를 이용할 수 없습니다',
  'landing.newsXHiddenBody': '삽입된 X 피드는 작은 화면이나 앱에서 이용할 수 없습니다. 최신 게시물을 보려면 X에서 @WoClaudecraft를 여세요.',
  'landing.newsPressPrimaryTitle': '최초의 바이브 코딩 MMORPG는 무료·오픈 소스이며 놀랄 만큼 완성도 높다',
  'landing.newsPressPrimaryBody': 'MMORPG.com은 World of ClaudeCraft의 오픈 월드와 함께하는 모험, 빠르게 발전하는 실험을 살펴봅니다.',
  'landing.newsPressRead': '기사 읽기',
  'landing.newsPressLinkAria': '새 탭에서 MMORPG.com 기사 읽기',
  'landing.newsPressPrimaryAlt': 'World of ClaudeCraft의 Eastbrook Vale을 탐험하는 모험가들',
  'landing.communityHeading': 'Claudemoon은 함께 만들어집니다.',
  'landing.communityBody': '솜씨든 호기심이든, 그저 함께하고 싶은 마음이든 가져오세요. 길드의 식탁에는 여러분을 위한 자리가 있습니다.',
};
