...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.mounts.title': '탈것',
  'hud.mounts.subtitle': '$WOC 여행 탈것',
  'hud.mounts.close': '탈것 닫기',
  'hud.mounts.summon': '소환',
  'hud.mounts.dismount': '내리기',
  'hud.mounts.summoning': '{name} 소환 중…',
  'hud.mounts.riding': '탑승 중',
  'hud.mounts.flies': '비행',
  'hud.mounts.locked': '잠김',
  'hud.mounts.speed': '이동 속도 +{percent}%',
  'hud.mounts.unlockAt': '{amount} $WOC에서 해금',
  'hud.mounts.supplyShare': '공급량의 {percent}',
  'hud.mounts.qualifyHeader': '여행 탈것 {total}종 중 {count}종의 자격을 갖추었습니다.',
  'hud.mounts.holdingHint': '{amount} $WOC 보유 중.',
  'hud.mounts.noWallet':
    '연결된 지갑에 최소 {amount} $WOC(공급량의 0.1%)를 보유하면 첫 여행 탈것을 얻습니다.',
  'hud.mounts.cantInCombat': '전투 중에는 탈 수 없습니다.',
  'hud.mounts.cantSwimming': '수영 중에는 탈 수 없습니다.',
  'hud.mounts.cantDead': '사망 상태에서는 탈 수 없습니다.',
  'hud.mounts.notEligible': '$WOC 보유량이 아직 그 탈것에 미치지 못합니다.',
  'hud.mounts.summonedBanner': '{name}을(를) 소환합니다.',
  'hud.mounts.summonAria': '{name} 소환',
  'hud.mounts.dismountAria': '{name}에서 내리기',
  'hud.mounts.lockedAria': '{name}: 잠김; {amount} $WOC에서 해금',
  'hud.mounts.activeAria': '{name}: 현재 활성',
  'hud.mounts.owned': '소유함',
  'hud.mounts.mint': '증서 발행',
  'hud.mounts.mintHint':
    '이 탈것의 거래 가능한 증서를 발행하세요. 금에 팔아 보유자가 아닌 이도 얻게 하세요.',
  'hud.mounts.mintAria': '{name}의 거래 가능한 증서 발행',
  'hud.mounts.mintedBanner': '{name}의 증서를 발행합니다.',
  'hud.mounts.earnedBanner': '{name}을(를) 얻었습니다. 영원히 당신의 것입니다.',
  'hud.mounts.alreadyOwnErr': '이미 그 탈것을 소유하고 있습니다.',
  'hud.mounts.charterVoidErr': '그 증서는 무효입니다.',
  'hud.mounts.noCharterErr': '그 탈것은 증서를 발행할 수 없습니다.',
  'hud.mounts.holdingsShortErr': '보유량으로는 그 탈것을 감당할 수 없습니다.',
  'hud.course.skytrials': '하늘 시련',
  'hud.course.skytrialsHint': '비행 탈것을 타고 시간 제한 고리 경로를 비행하세요.',
  'hud.course.needFlyer': '하늘 시련을 비행하려면 비행 탈것을 소환하세요.',
  'hud.course.laps': '{count}바퀴',
  'hud.course.starting': '첫 고리를 통과해 시간을 시작하세요',
  'hud.course.finish': '완주!',
  'hud.course.failed': '주행 종료: 탈것에서 내렸습니다',
  'hud.course.aborted': '주행 포기',
  'hud.course.newBest': '신기록!',
  'hud.course.board': '순위판',
  'hud.course.boardTitle': '{name}: 최고 기록',
  'hud.course.noTimes': '아직 기록이 없습니다. 첫 번째가 되세요.',
  'hud.course.loadingBoard': '불러오는 중…',
  'hud.course.racePartyHint': '파티와 경주하세요. 가장 먼저 고리를 통과한 자가 이깁니다.',
  'hud.course.getReady': '준비',
  'hud.course.racing': '경주 중',
  'hud.wager.start': '내기 경주',
  'hud.wager.title': '내기 경주',
  'hud.wager.inviteGold':
    '{name}님이 내기 경주를 엽니다. 참가하려면 {money}을(를) 거세요. 받으시겠습니까?',
  'hud.wager.inviteCharter':
    '{name}님이 내기 경주를 엽니다. {money} + 탈것 증서를 거세요. 받으시겠습니까?',
  'hud.wager.accept': '내기 받기',
  'hud.wager.potCharter': '판돈 {money} + 증서 {count}×',
  'hud.wager.racers': '참가자 ({count})',
  'hud.wager.launch': '경주 시작',
  'hud.wager.cancel': '취소',
  'hud.wager.leave': '나가기',
  'hud.wager.waiting': '판돈을 받을 도전자를 기다리는 중…',
  'hud.wager.won': '내기에서 이겼습니다, {money}!',
  'hud.wager.wonCharter': '내기에서 이겼습니다, {money} + 증서 {count}×!',
  'hud.wager.lost': '내기에서 졌습니다.',
  'hud.wager.refunded': '내기가 취소되었습니다. 건 판돈을 돌려받습니다.',
  'hud.wager.antePrompt': '이 경주에 금을 얼마나 거시겠습니까? (동화 기준)',
  'hud.wager.open': '내기 열기',
  'hud.wager.stakeCharter': '탈것 증서도 함께 걸기 (승자가 차지함)',
  'hud.wager.errCourse': '그 경로는 내기를 걸 수 없습니다.',
  'hud.wager.errFlyer': '내기를 걸려면 비행 탈것을 타고 있어야 합니다.',
  'hud.wager.errBusy': '이미 내기에 참여하고 있습니다.',
  'hud.wager.errAnte': '최소 동화 1개 이상의 내기를 거세요.',
  'hud.wager.errStake': '그것은 내기로 걸 수 없습니다.',
  'hud.wager.errAfford': '그 내기를 감당할 수 없습니다.',
  'hud.wager.errExpired': '그 내기 제안은 만료되었습니다.',
  'hud.wager.errGone': '그 내기는 더 이상 열려 있지 않습니다.',
  'hud.wager.errHost': '주최자만 내기를 시작할 수 있습니다.',
  'entities.items.charter_ashmane.name': '증서: 잿빛갈기 준마',
  'entities.items.charter_emberhoof.name': '증서: 불씨굽 군마',
  'entities.items.charter_bronzeflank.name': '증서: 청동옆구리 전마',
  'entities.items.charter_silvermane.name': '증서: 은빛갈기 종마',
  'entities.items.charter_stormhoof.name': '증서: 폭풍굽 군마',
  'entities.items.charter_goldcrest.name': '증서: 금빛볏 하늘걸음이',
  'entities.items.charter_verdant.name': '증서: 푸른들 야생날개',
  'entities.items.charter_voidstrider.name': '증서: 공허날개 활보자',
  'entities.items.charter_celestial.name': '증서: 천상의 세라프',
  'entities.items.charter_worldbearer.name': '증서: 세계를 짊어진 자의 로크',
  'entities.npcs.skytrial_master.name': '하늘지기 베일',
  'entities.npcs.skytrial_master.title': '하늘 시련의 수호자',
  'entities.npcs.skytrial_master.greeting':
    '하늘은 감히 걸으려는 이가 드문 길입니다, {className}. 그것을 얻으면, 하늘이 그대를 실어 나릅니다.',
  'entities.quests.q_skyward_first_flight.title': '첫 비행',
  'entities.quests.q_skyward_first_flight.text':
    '땅 위에서는 날개 달린 탈것을 곧잘 다루는군요, {playerName}. 이제 하늘로 올리세요. 골짜기 하늘 시련을 비행하십시오: 한 바퀴 도는 길에 여덟 개의 고리. 아직 시간을 쫓지는 마세요. 그저 떠 있으면서 모든 고리를 꿰십시오.',
  'entities.quests.q_skyward_first_flight.completion':
    '떨어지지 않았군요. 첫 바퀴에 대부분이 해내는 것보다 더한 일입니다. 하늘은 계속 돌아오는 자를 기억합니다.',
  'entities.quests.q_skyward_first_flight.objectives.0.label': '골짜기 하늘 시련 완료',
  'entities.quests.q_skyward_time_trial.title': '시간을 이겨라',
  'entities.quests.q_skyward_time_trial.text':
    '이제 의지를 담아 해내십시오. 골짜기 하늘 시련을 다시 비행하되, {playerName}, 모래가 다하기 전에 끝내세요. 모든 고리를 깔끔한 선으로, 허비되는 공기 없이. 당황이 아니라 정밀함으로.',
  'entities.quests.q_skyward_time_trial.completion':
    '고리에서 고리로, 깔끔한 선이었습니다. 그대는 더 이상 하늘을 타고 있는 것이 아닙니다. 하늘을 날고 있습니다.',
  'entities.quests.q_skyward_time_trial.objectives.0.label': '골짜기 하늘 시련 기준 시간 내 비행',
  'entities.quests.q_skyward_ascendant.title': '비상하는 자',
  'entities.quests.q_skyward_ascendant.text':
    '한 가지 시련이 남았습니다, {playerName}: 골짜기 순환로. 긴 고리를 세 바퀴, 기준 시간 내에 비행하십시오. 운이 아니라 오직 기량으로. 그것을 통달하면 가장자리에서 가장자리까지 드넓은 하늘이 그대의 것입니다.',
  'entities.quests.q_skyward_ascendant.completion':
    '하늘로 올라, 꺾이지 않았습니다. 이제 하늘은 그대의 것입니다, {playerName}. 이 증서를 받으십시오. 사지 않고 얻어 낸 창공의 탈것이, 그대가 향하려는 어디로든 실어 나를 것입니다.',
  'entities.quests.q_skyward_ascendant.objectives.0.label': '골짜기 순환로 기준 시간 내 비행',

  // Skytrial course + race HUD short labels (par/lap/ring/time/place/pot).
  'hud.mounts.cardAria': '{name}: {flavor}',
  'hud.course.start': '비행',
  'hud.course.give_up': '포기',
  'hud.course.par': '기준 {time}',
  'hud.course.onePass': '1바퀴',
  'hud.course.gate': '링 {n}/{total}',
  'hud.course.lap': '바퀴 {n}/{total}',
  'hud.course.time': '시간',
  'hud.course.beatPar': '기준보다 {time} 빠름',
  'hud.course.offPar': '기준보다 {time} 느림',
  'hud.course.best': '최고 {time}',
  'hud.course.you': '(나)',
  'hud.course.race': '경주',
  'hud.course.go': '출발!',
  'hud.course.dnf': '미완주',
  'hud.course.placeOf': '{total}명 중 #{place}',
  'hud.wager.pot': '상금 {money}',
  ...
  'character.renamePaidButton': '{amount} $WOC 지불하고 이름 변경',
  'character.renamePriceHint': '자발적 이름 변경은 {amount} $WOC를 소각합니다.',
  'character.renameCancel': '취소',
  'character.mintSolName': '.sol 이름 받기',
  'character.mintSolButton': '{amount} $WOC 소각하고 민트',
  'character.mintSolHint':
    '플레이어 소유의 ‹이름›.worldofclaudecraft.sol을 {amount} $WOC로 민트하세요. 온체인에서 당신의 것입니다.',
  'woc.linkWalletFirst': '$WOC로 지불하려면 Solana 지갑을 연결하고 링크하세요.',
  'woc.quoting': '$WOC 결제를 준비하는 중…',
  'woc.approveBurn': '지갑에서 {amount} $WOC 소각을 승인하세요…',
  'woc.confirming': '온체인에서 소각을 확인하는 중…',
  'woc.finalizing': 'Solana 최종 확정을 기다리는 중…',
  'woc.confirmFailed': '$WOC 결제를 확인할 수 없습니다.',
  'woc.finalizeTimeout':
    '최종 확정 대기가 시간 초과되었습니다. $WOC가 소각되었다면 다시 열어 재시도하세요. 결제는 최종 확정되면 정산됩니다.',
  'woc.renameSuccess': '{name}(으)로 이름을 변경했습니다.',
  'woc.mintSuccess': '{domain}을 민트했습니다. 온체인에서 당신의 것입니다.',
  'woc.guildRenameSuccess': '길드 이름을 {name}(으)로 변경했습니다.',
  'woc.reserveSuccess': '{name} 이름을 예약했습니다.',
  'walletPanel.title': '지갑',
  'walletPanel.closeAria': '닫기',
  'walletPanel.notConnected': '지갑이 연결되지 않음',
  'walletPanel.connect': '연결',
  'walletPanel.connectedStatus': '연결됨 {address}',
  'walletPanel.linkedBadge': '링크됨',
  'walletPanel.tabSend': '보내기',
  'walletPanel.tabHire': '고용',
  'walletPanel.tabJobs': '의뢰',
  'walletPanel.sendSection': '플레이어에게 보내기',
  'walletPanel.currency': '통화',
  'walletPanel.playerName': '플레이어 이름',
  'walletPanel.recipientPlaceholder': '누구에게 보내시겠어요?',
  'walletPanel.amount': '금액',
  'walletPanel.max': '최대',
  'walletPanel.balanceEmpty': '잔액: -',
  'walletPanel.balanceLoading': '잔액: …',
  'walletPanel.balanceUnavailable': '잔액: 확인 불가',
  'walletPanel.balance': '잔액: {amount}',
  'walletPanel.balanceExceeds': '잔액: {amount} (잔액 초과)',
  'walletPanel.connectForBalance': '잔액을 보려면 지갑을 연결하세요.',
  'walletPanel.sendNote':
    'Solana에서 지갑 간에 직접 전송됩니다. 논커스터디얼: 게임은 자금을 보관하지 않습니다. 네트워크 수수료가 부과됩니다.',
  'walletPanel.send': '보내기',
  'walletPanel.sending': '보내는 중…',
  'walletPanel.loginToSend': '플레이어에게 보내려면 로그인 후 월드에 입장하세요.',
  'walletPanel.lookingUp': '플레이어 찾는 중…',
  'walletPanel.ownWallet': '(이것은 본인의 지갑입니다)',
  'walletPanel.noVerifiedWallet': '해당 이름의 플레이어에게 인증된 지갑이 없습니다.',
  'walletPanel.approveTransfer': '지갑에서 전송을 승인하세요…',
  'walletPanel.sent': '{name}에게 {amount} {currency}을(를) 보냈습니다.',
  'walletPanel.viewTransaction': '트랜잭션 보기',
  'walletPanel.sendFailedWith': '전송 실패: {message}',
  'walletPanel.sendFailed': '전송에 실패했습니다.',
  'walletPanel.hireSection': '도우미 고용',
  'walletPanel.hireOffline': '도우미를 고용하려면 온라인으로 월드에 입장하세요.',
  'walletPanel.helperPlaceholder': '누가 도와줄까요?',
  'walletPanel.rewardCurrency': '보상 통화',
  'walletPanel.reward': '보상',
  'walletPanel.goalLabel': '목표, 서버가 확인하면 지급됩니다',
  'walletPanel.goalReachLevel': '레벨 달성',
  'walletPanel.goalClearDungeon': '레이드 공략',
  'walletPanel.goalQuest': '퀘스트',
  'walletPanel.goalBodyguard': '경호',
  'walletPanel.goalEscort': '호위',
  'walletPanel.targetLevel': '목표 레벨',
  'walletPanel.targetLevelPlaceholder': '2에서 20',
  'walletPanel.raidDungeon': '레이드 / 던전',
  'walletPanel.questOwn': '퀘스트 (진행 중인 것)',
  'walletPanel.noActiveQuests':
    '도움을 요청할 진행 중인 퀘스트가 없습니다. 먼저 퀘스트를 받으세요.',
  'walletPanel.protectMinutes': '보호 시간 (분)',
  'walletPanel.minutesPlaceholder': '예: 10',
  'walletPanel.escortDestination': '호위 목적지',
  'walletPanel.useCurrentSpot': '현재 위치 사용',
  'walletPanel.destinationSet': '목적지 설정됨: ({x}, {z})',
  'walletPanel.noDestination': '아직 목적지가 설정되지 않았습니다.',
  'walletPanel.destinationHint':
    '목적지 ({x}, {z}), 이동한 뒤 경호원이 이곳으로 데려다주게 하세요.',
  'walletPanel.hireLogin': '플레이어를 고용하려면 온라인으로 월드에 입장하세요.',
  'walletPanel.escrowNote':
    '보상은 온체인 에스크로에 잠기며 서버가 목표를 확인하면 도우미에게 자동으로 지급됩니다. 기한 내에 달성되지 않으면 회원님께 환불됩니다.',
  'walletPanel.post': '보상 게시 및 잠금',
  'walletPanel.posting': '게시 중…',
  'walletPanel.setGoalFirst': '먼저 유효한 목표를 설정하세요.',
  'walletPanel.preparingEscrow': '에스크로 준비 중…',
  'walletPanel.approveDeposit': '지갑에서 보상 입금을 승인하세요…',
  'walletPanel.lockingReward': '보상을 온체인에 잠그는 중…',
  'walletPanel.waitingFinalization': '최종 확정을 기다리는 중…',
  'walletPanel.confirmTimeout':
    '입금 확인이 시간 초과되었습니다. 보상이 잠겼다면 최종 확정 후에 정산됩니다.',
  'walletPanel.jobPosted':
    '의뢰 게시됨: {amount} {currency}이(가) {name}을(를) 위해 에스크로에 잠겼습니다.',
  'walletPanel.postFailed': '의뢰 게시에 실패했습니다.',
  'walletPanel.failedWith': '실패: {message}',
  'walletPanel.jobsSection': '내 의뢰',
  'walletPanel.loading': '불러오는 중…',
  'walletPanel.jobsOffline': '의뢰를 관리하려면 온라인으로 월드에 입장하세요.',
  'walletPanel.jobsEmpty': '아직 의뢰가 없습니다. 고용 탭에서 플레이어에게 도움을 의뢰해 보세요.',
  'walletPanel.youHired': '{name}을(를) 고용했습니다',
  'walletPanel.hiredYou': '{name}이(가) 당신을 고용했습니다',
  'walletPanel.acceptJob': '의뢰 수락',
  'walletPanel.cancelRefund': '취소 및 환불',
  'walletPanel.viewPayout': '지급 내역 보기',
  'walletPanel.actionFailed': '작업에 실패했습니다.',
  'walletPanel.status.awaitingDeposit': '입금 대기 중',
  'walletPanel.status.offered': '당신에게 제안됨, 수락하면 시작됩니다',
  'walletPanel.status.open': '공개됨, 도우미의 수락 대기 중',
  'walletPanel.status.active': '진행 중',
  'walletPanel.status.completed': '완료, 도우미에게 지급됨',
  'walletPanel.status.expired': '만료, 환불됨',
  'walletPanel.status.failedDied': '실패 (당신이 사망), 환불됨',
  'walletPanel.status.cancelled': '취소됨, 환불됨',
  'walletPanel.status.refunded': '환불됨',
};
