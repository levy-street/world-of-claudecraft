...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.keybinds.battleground': '전장 (그레이브마치)',
  'hudChrome.bg.zoneName': '그레이브마치',
  'hudChrome.bg.teamA': '잉걸불 부대',
  'hudChrome.bg.teamB': '창백한 부대',
  'hudChrome.bg.mobileLabel': '전장',
  'hudChrome.bg.indicator.queued': '그레이브마치 대기 중',
  'hudChrome.bg.indicator.queuedDetail': '{position}번째, {time} 대기',
  'hudChrome.bg.indicator.queuedAria':
    '그레이브마치 대기 중: {position}번째, {time} 대기. 전장 창을 엽니다.',
  'hudChrome.bg.indicator.live': '그레이브마치 전투 진행 중',
  'hudChrome.bg.indicator.liveDetail': '{time}, {killsA} 대 {killsB}',
  'hudChrome.bg.indicator.liveAria':
    '그레이브마치에서 전투가 진행 중입니다: {time}, {killsA} 대 {killsB}. 전장 창을 열어 관전하세요.',
  'hudChrome.bg.indicator.watch': '관전',
  'hudChrome.bg.window.title': '전장',
  'hudChrome.bg.window.subtitle': '그레이브마치: 두 갈래 길, 네 개의 보루, 하나의 전쟁석.',
  'hudChrome.bg.window.close': '전장 창 닫기',
  'hudChrome.bg.window.offlineNote': '진영이 아직 집결 중입니다. 서버와 연결되면 전장이 열립니다.',
  'hudChrome.bg.window.enterQueue': '그레이브마치 참가',
  'hudChrome.bg.window.leaveQueue': '대기열 나가기',
  'hudChrome.bg.window.queued': '{position}번째, {time} 대기 ({count}명 집결)',
  'hudChrome.bg.window.queueNote':
    '모든 용사는 전장 표준 레벨과 직업 기본 특성으로 싸웁니다. 혼자 대기하거나, 최대 다섯 명의 파티를 파티장이 이끌고 대기하세요.',
  'hudChrome.bg.window.partyNote': '{count}명의 파티가 함께 대기열에 들어갑니다.',
  'hudChrome.bg.window.leaderNote': '파티장만 파티를 대기열에 넣을 수 있습니다.',
  'hudChrome.bg.window.deserter':
    '탈영병의 조종이 당신을 위해 울리고 있습니다. {time} 후에 다시 대기할 수 있습니다.',
  'hudChrome.bg.window.inMatch': '전투가 시작되었습니다.',
  'hudChrome.bg.window.liveHeading': '진행 중인 전투',
  'hudChrome.bg.window.matchLine':
    '{teamA} {killsA} 대 {teamB} {killsB}, {time}, {players}명 교전 중',
  'hudChrome.bg.window.watch': '관전',
  'hudChrome.bg.window.watchAria': '진행 중인 전투 관전 ({time})',
  'hudChrome.bg.window.noLive': '지금은 전투가 없습니다.',
  'hudChrome.bg.window.practice': '그레이브마치 연습',
  'hudChrome.bg.window.practiceNote':
    '훈련된 봇 전원을 소집해 길을 익히세요. 연습전은 점수에 반영되지 않습니다.',
  'hudChrome.bg.spectate.stop': '관전 중지',
  'hudChrome.bg.hud.knellUp': '조종 수호자 등장 중',
  'hudChrome.bg.hud.knellSpawns': '조종 수호자까지 {time}',
  'hudChrome.bg.hud.knellSilenced': '{team}이(가) 조종을 잠재움, {seconds}초',
  'hudChrome.bg.hud.stripAria': '{teamA} {killsA}, {teamB} {killsB}, {time} 남음',
  'hudChrome.bg.hud.countdownTitle': '망자들이 대열을 갖춥니다',
  'hudChrome.bg.hud.respawnTitle': '당신은 쓰러졌습니다.',
  'hudChrome.bg.hud.respawnSub': '전장은 아직 당신을 놓아주지 않았습니다.',
  'hudChrome.bg.hud.returning': '{seconds}초 후 세계로 귀환',
  'hudChrome.bg.banner.found': '그레이브마치에 전투가 소집되었습니다!',
  'hudChrome.bg.banner.countdown': '{seconds}초 후 전투 시작...',
  'hudChrome.bg.banner.start': '군기가 오릅니다. 싸우세요!',
  'hudChrome.bg.banner.bulwarkWestOuter': '{team}의 서쪽 길 외곽 보루가 무너졌습니다.',
  'hudChrome.bg.banner.bulwarkWestInner': '{team}의 서쪽 길 내곽 보루가 무너졌습니다.',
  'hudChrome.bg.banner.bulwarkEastOuter': '{team}의 동쪽 길 외곽 보루가 무너졌습니다.',
  'hudChrome.bg.banner.bulwarkEastInner': '{team}의 동쪽 길 내곽 보루가 무너졌습니다.',
  'hudChrome.bg.banner.warstoneDown': '{team}의 전쟁석이 산산이 부서졌습니다!',
  'hudChrome.bg.banner.knell': '{team}이(가) 조종을 잠재웠습니다!',
  'hudChrome.bg.banner.warstoneThreat': '아군 전쟁석이 공격받고 있습니다!',
  'hudChrome.bg.log.queued': '그레이브마치 대기열에 들어갔습니다 ({position}번째).',
  'hudChrome.bg.log.unqueued': '그레이브마치 대기열에서 나왔습니다.',
  'hudChrome.bg.log.roster': '{team} 집결: {allies} 대 {enemies}.',
  'hudChrome.bg.log.kill': '{killer}이(가) {victim}을(를) 처치했습니다!',
  'hudChrome.bg.log.down': '당신은 쓰러졌습니다. 전장이 {seconds}초 후 전쟁석으로 되돌려 보냅니다.',
  'hudChrome.bg.end.win': '승리! 적의 전쟁석이 부서졌습니다.',
  'hudChrome.bg.end.loss': '패배. 아군의 전쟁석이 부서졌습니다.',
  'hudChrome.bg.end.draw': '전장이 침묵에 잠깁니다. 무승부.',
  'hudChrome.bg.end.rating': '점수 {rating} ({delta}).',
  'hudChrome.bg.err.level10': '그레이브마치에 참가하려면 최소 10레벨이어야 합니다.',
  'hudChrome.bg.err.deserter': '탈영병의 조종이 울리는 동안에는 대기할 수 없습니다.',
  ...
  'guide.bgPage.intro':
    '그레이브마치는 5 대 5 전장입니다. 두 용사 부대가 되살아난 병사들의 종대를 두 갈래 옛길로 진군시키고, 적의 탑을 부수고, 상대 군세를 계속 행군하게 하는 전쟁석을 산산조각 냅니다. 어디서든 대기열에 들어가면 나머지는 전장이 맡습니다.',
  'guide.bgPage.storyHeading': '잠들지 않는 전장',
  'guide.bgPage.storyBody':
    '무덤고룡 성소 아래 망령 벌판에는 쏜피크를 노린 마지막 군대의 선봉이 잠들어 있습니다. 해질녘마다 옛 전투가 깨어나고, 잿빛 콜로세움의 수호자들은 군기를 든 자가 그 죽은 자들을 부린다는 것을 알아냈습니다. 그래서 콜로세움은 전쟁 놀이를 승인했습니다. 그레이브마치에서는 누구도 진정으로 죽지 않습니다. 전장이 그것을 거부하기 때문입니다.',
  'guide.bgPage.companiesHeading': '두 부대, 각자의 깃발',
  'guide.bgPage.companiesBody':
    '용사들은 잉걸불 부대 또는 창백한 부대의 깃발을 듭니다. 혼자 대기하거나 파티로 참가하면 전장이 다섯 명의 부대로 편성합니다. 진영은 투기장처럼 일시적입니다. 영구적인 세력은 없으며, 플레이어 간 전투는 언제나 스스로 선택하는 것입니다.',
  'guide.bgPage.fairNote':
    '그레이브마치는 설계부터 공정합니다. 모든 용사가 전장 표준 레벨과 직업 기본 특성으로 싸우므로, 승부는 장비나 레벨이 아니라 실력으로 갈립니다.',
  'guide.bgPage.fieldHeading': '전장 읽기',
  'guide.bgPage.fieldBody':
    '두 기지 사이에는 서쪽의 방패 길, 동쪽의 창 길, 그 사이 무너진 고분 지대가 펼쳐지고, 전장 한가운데에는 부서진 종 예배당이 서 있습니다. 도식 지도에는 길, 탑, 아군, 그리고 조종이 표시됩니다.',
  'guide.bgPage.roadsTitle': '두 갈래 길',
  'guide.bgPage.roadsBody':
    '뼈갑옷 망령의 종대가 각 길을 따라 적 기지로 진군합니다. 길을 막는 자와 싸우고 방어 시설을 두드립니다. 종대와 함께 진군하는 것이 곧 땅을 얻는 길입니다.',
  'guide.bgPage.bulwarksTitle': '보루',
  'guide.bgPage.bulwarksBody':
    '각 길은 육중한 탑 수호자가 지키며, 부대마다 외곽과 내곽 하나씩입니다. 제 식솔을 괴롭히는 용사를 응징하고, 외곽이 무너지기 전에는 내곽을 건드릴 수 없습니다. 길 하나를 열어젖히면 적의 전쟁석이 드러납니다.',
  'guide.bgPage.knellTitle': '조종',
  'guide.bgPage.knellBody':
    '예배당에는 이 군대를 깨운 종, 조종과 그 지킴이인 조종 수호자가 있습니다. 수호자를 쓰러뜨린 부대는 잠시 조종을 잠재우고, 그 종대는 한층 거세게 진군합니다.',
  'guide.bgPage.deathHeading': '그레이브마치에서 쓰러지면',
  'guide.bgPage.deathBody':
    '전장은 죽음을 거부합니다. 쓰러진 용사는 잠시 물러났다가 자신의 전쟁석에서 깨어나며, 깨어남은 매번 조금씩 느려집니다. 시체 달리기는 없고 잃는 것도 없습니다. 대가는 전장을 비우는 시간뿐입니다.',
  'guide.bgPage.watchHeading': '전투 관전',
  'guide.bgPage.watchBody':
    '서버에서 진행 중인 어떤 전투든 관전할 수 있습니다. 미니맵 옆 배지가 전투를 알리고, 전장 창에는 모든 경기와 관전 버튼이 나열됩니다. 관전자는 한 부대와 동행하며 경기 정보를 보고, 언제든 관전을 멈출 수 있습니다.',
  'guide.bgPage.ladderHeading': '순위표',
  'guide.bgPage.ladderBody':
    '점수제 그레이브마치는 투기장처럼 자체 순위를 유지합니다. 전장 창에는 당신의 점수와 전적, 접속 중인 점수제 용사들의 순위표가 표시됩니다. 봇으로 채워진 경기는 점수에 반영되지 않으며 오프라인 연습도 마찬가지입니다.',
};
