...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'character.respec': '특성 초기화',
  'character.respecHint':
    '$WOC를 소각하여 특성을 초기화하거나 추가 로드아웃 슬롯을 잠금 해제합니다.',
  'character.respecPaidButton': '{amount} $WOC로 특성 초기화',
  'character.loadoutSlotPaidButton': '{amount} $WOC로 로드아웃 슬롯 잠금 해제',
  'character.respecCancel': '취소',
  'character.respecSuccess': '특성이 초기화되었습니다.',
  'character.loadoutSlotSuccess': '로드아웃 슬롯이 잠금 해제되었습니다.',
  'errors.api.linkWalletFirst': '먼저 Solana 지갑을 연결하고 링크하세요.',
  'errors.api.nameReserved': '그 이름은 예약되어 있습니다.',
  'errors.api.quoteExpired': '결제 견적이 만료되었습니다. 다시 시작하세요.',
  'errors.api.paymentUsed': '이 결제는 이미 사용되었습니다.',
