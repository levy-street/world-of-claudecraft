...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'itemUi.tooltip.flaskThroughDeath': '이 효과는 죽어도 유지되지만, 접속을 종료하면 사라집니다. 등급전은 아무 효과도 없는 상태에서 시작합니다.',
