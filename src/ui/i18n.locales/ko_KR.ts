...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  // The Exchange Vault (docs/prd/woc/marketplace.md, "Selling without a wallet: the Vault").
  'hudChrome.wocMarket.vaultTitle': '거래소 금고',
  'hudChrome.wocMarket.vaultBody': '지갑을 연결하지 않아도 판매할 수 있으며, 수익은 $WOC로 이곳에 보관됩니다. 즉시 구매 매물에 사용하거나, 언제든 지갑을 연결해 출금하세요.',
  'hudChrome.wocMarket.vaultBalance': '금고에 {tokens} $WOC 보관 중',
  'hudChrome.wocMarket.vaultBalanceUsd': '현재 가격으로 약 {usd}. 추정치일 뿐입니다. 금고에는 $WOC가 보관되며, 달러 가치는 시장에 따라 변동합니다.',
  'hudChrome.wocMarket.vaultEmpty': '금고가 비어 있습니다.',
  'hudChrome.wocMarket.vaultWithdraw': '지갑으로 출금',
  'hudChrome.wocMarket.vaultWithdrawAria': '{tokens} $WOC를 연결된 지갑으로 출금',
  'hudChrome.wocMarket.vaultNeedsWallet': '금고 잔액을 출금하려면 지갑을 연결하세요.',
  'hudChrome.wocMarket.vaultWithdrawn': '{tokens} $WOC를 지갑으로 출금했습니다.',
  'hudChrome.wocMarket.vaultSellHint': '연결된 지갑 없음: 이 판매의 수익은 거래소 금고에 보관됩니다.',
  'hudChrome.wocMarket.vaultBuyWith': '금고 잔액으로 구매',
  'hudChrome.wocMarket.vaultPaysNote': '이 구매는 거래소 금고 잔액에서 결제됩니다.',
  'hudChrome.wocMarket.quoteSignVault': '금고에서 결제',
  'apiError.woc_market.held_disabled': '이 서버에서는 거래소 금고를 이용할 수 없습니다.',
  'apiError.woc_market.held_insufficient': '금고 잔액이 이 구매 금액에 미치지 못합니다.',
  'apiError.woc_market.held_empty': '금고가 비어 있습니다.',
  'apiError.woc_market.held_withdraw_failed': '출금을 완료하지 못했습니다. 잔액은 금고에 그대로 남아 있으니 나중에 다시 시도하세요.',
  'wallet.reauthListTitle': '등록 확인',
  'wallet.reauthListHelp': '연결된 지갑이 없으므로 지갑 서명 대신 계정 비밀번호로 이 등록을 승인합니다.',
  'apiError.woc_market.account_proof_required': '이 등록을 승인하려면 계정 비밀번호를 입력하세요.',
  'apiError.woc_market.account_proof_two_factor': '계정에 2단계 인증이 켜져 있습니다. 이 등록을 승인하려면 코드를 입력하세요.',
  'apiError.woc_market.account_proof_no_password': '이 계정에는 비밀번호가 없습니다. 먼저 계정 설정에서 비밀번호를 설정하세요.',
  'apiError.woc_market.account_proof_invalid': '비밀번호 또는 코드가 승인되지 않았습니다. 다시 시도하세요.',
  'apiError.woc_market.account_proof_throttled': '실패 횟수가 너무 많습니다. 나중에 다시 시도하세요.',
};
