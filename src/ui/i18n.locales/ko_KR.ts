...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  // same-change non-Latin fills on the shipped glossary.
  'entities.items.lastflame_core.name': '마지막 불꽃의 핵',
  'entities.items.forgefathers_ember.name': '대장장이의 불씨',
  'entities.items.cruciblewrought_warhelm.name': '도가니 단조 전투투구',
  'entities.items.emberveil_legguards.name': '불씨 장막 다리보호구',
  'entities.items.vestment_of_the_last_spring.name': '마지막 샘의 예복',
  'entities.items.forgefathers_requiem.name': '대장장이의 진혼곡',
  'entities.items.plans_cruciblewrought_warhelm.name': '설계도: 도가니 단조 전투투구',
  'entities.items.pattern_emberveil_legguards.name': '도안: 불씨 장막 다리보호구',
  'entities.items.pattern_vestment_of_the_last_spring.name': '도안: 마지막 샘의 예복',
  'entities.items.formula_lastflame_zeal.name': '공식: 마지막 불꽃의 열의',
  'entities.quests.q_forgefathers_requiem.title': '대장장이의 진혼곡',
  'entities.quests.q_forgefathers_requiem.text': '발쿨의 망치는 그가 가슴에 품어 지키던 것에 응답했습니다. 아직도 타오르는 마지막 샘의 불씨에 말입니다. 그 불씨를 제게 가져다주십시오. 기예의 정점에 오른 대장장이라면, 그가 감히 빚지 못한 것을 빚어낼 수 있을 것입니다.',
  'entities.quests.q_forgefathers_requiem.completion': '아직도 노래하고 있군요. 대장장이여, 이것은 재료가 아닙니다. 그가 사슬로 묶은 샘의 목소리 그 자체입니다. 벼리는 법은 제가 보여드리지요. 그의 손이 끝내 이루지 못한 일을, 당신의 손이 이룰 것입니다.',
  'entities.quests.q_forgefathers_requiem.objectives.0.label': '대장장이의 불씨 회수',
  'entities.quests.q_requiem_at_the_forge.title': '화로 앞의 진혼곡',
  'entities.quests.q_requiem_at_the_forge.text': '벼리는 일은 오롯이 당신의 몫입니다. 마지막 불꽃의 핵 열다섯, 최상급 토륨과 엘더우드, 그리고 그 중심에 놓일 불씨. 그 이름에 걸맞은 화로에서 진혼곡을 벼려내어, 샘이 간수에게 답하게 하십시오.',
  'entities.quests.q_requiem_at_the_forge.completion': '이렇게 진혼곡이 쇠로 불려졌습니다. 잘 지니십시오, 대장장이여. 이것에 비견할 것을 벼려낼 손은 다시는 없을 것입니다.',
  'entities.quests.q_requiem_at_the_forge.objectives.0.label': '대장장이의 진혼곡 단조',
  'hudChrome.enchanting.formulaNotLearned': '아직 그 공식을 배우지 못했습니다.',
  'hudChrome.enchantName.enchant_weapon_lastflame_zeal': '무기 마법부여 - 마지막 불꽃의 열의',
  'hudChrome.itemProc.selfBuff': '{duration}초 동안 {name}({value})을 부여합니다',
  'hudChrome.itemProc.selfHeal': '또한 생명력을 {total} 회복합니다',
  'itemUi.kind.recipe': '제조법',
};
