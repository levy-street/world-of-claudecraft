...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.combatTextStyle': '전투 텍스트 스타일',
  'hudChrome.options.combatTextClassic': '클래식',
  'hudChrome.options.combatTextEnhanced': '강화',
  ...
  'hud.combat.parried': '{target}이 {ability}을 무기로 막았습니다.',
