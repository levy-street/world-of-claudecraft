...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'itemUi.vendor.repairAll': '모두 수리',
  'itemUi.vendor.repairAllAria': '{price}(으)로 모든 장비 수리',
  'itemUi.vendor.repairAllHint': '착용 중인 모든 무기와 방어구의 내구도를 완전히 수리합니다. 반지와 목걸이는 마모되지 않습니다.',
  'itemUi.vendor.repairAllUnaffordable': '이 수리 비용을 지불할 수 없습니다.',
  ...
  'hudChrome.itemTooltip.durability': '내구도 {current} / {max}',
