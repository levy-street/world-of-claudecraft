...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.interactPrompt.interact': '상호작용',
  'hudChrome.interactPrompt.gather': '채집',
  'hudChrome.interactPrompt.enter': '입장',
  'hudChrome.interactPrompt.leave': '나가기',
  'hudChrome.interactPrompt.name.lockedChest': '잠긴 상자',
  'hudChrome.interactPrompt.name.rewardChest': '보상 상자',
  'hudChrome.interactPrompt.name.reliquary': '물에 잠긴 성물함',
  'hudChrome.interactPrompt.name.bellShrine': '종의 제단',
  'hudChrome.interactPrompt.name.candleShrine': '촛불의 제단',
  'hudChrome.interactPrompt.name.reedShrine': '갈대의 제단',
  'hudChrome.interactPrompt.name.skullShrine': '해골의 제단',
  'hudChrome.options.showInteractPrompt': '상호작용 안내 표시',
  'hudChrome.options.interactHighlight': '마우스를 올린 대상 강조',
};
