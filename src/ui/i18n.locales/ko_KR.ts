...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'questUi.dialog.brewDraught': '깊은 꿈의 물약을 만들어 주세요.',
  'questUi.dialog.brewDraughtAria': '{name}에게 깊은 꿈의 물약을 만들어 달라고 요청',
  'questUi.dialog.gargoyleBow': '절하기.',
  'questUi.dialog.gargoyleBowAria': '{name}에게 절하기',
  'questUi.dialog.gargoyleAttack': '공격하기.',
  'questUi.dialog.gargoyleAttackAria': '{name} 공격하기',
  'questUi.dialog.gargoyleShimmer': '석상이 에너지로 일렁인다...',
  'hud.core.deepdreamZone': '깊은 꿈',
  ...
  'entities.zones.thornpeak_heights.pois.10.label': '거울 관문',
  'entities.zones.mirror_world.name': '거울 세계',
  'entities.zones.mirror_world.welcome': '유리는 너를 기억한다. 네가 그 어느 쪽을 걷는지 조심하라.',
  'entities.zones.mirror_world.pois.0.label': '거울 세계',
  'entities.zones.mirror_world.pois.1.label': '거울문 광장',
  'entities.zones.mirror_world.pois.2.label': '루멘 왕관',
  'entities.zones.mirror_world.pois.3.label': '장막 시장',
  'entities.zones.mirror_world.pois.4.label': '침묵의 기록고',
  'entities.zones.mirror_world.pois.5.label': '거울호수',
  'entities.zones.mirror_world.pois.6.label': '안개 늪',
  'entities.zones.mirror_world.pois.7.label': '마녀의 골짜기',
  'entities.zones.mirror_world.pois.8.label': '이스트브룩의 거울',
  'entities.zones.mirror_world.pois.9.label': '펜브리지의 거울',
  'entities.mobs.poverty_ghost.name': '가난의 유령',
  'entities.mobs.spirit_unicorn.name': '영혼 유니콘',
  'entities.mobs.hooded_reaper.name': '수확자',
  'entities.mobs.gloomhulk.name': '어둠거인',
  'entities.mobs.mirrorbound_sentry.name': '거울결속 파수꾼',
  'entities.mobs.voidfang_stalker.name': '창백송곳니 추적자',
  'entities.npcs.dread_sentinel_a.name': '공포의 파수꾼',
  'entities.npcs.dread_sentinel_a.title': '어둠의 거울의 감시자',
  'entities.npcs.dread_sentinel_a.greeting': '너의 죽음이 기다린다.',
  'entities.npcs.dread_sentinel_b.name': '공포의 파수꾼',
  'entities.npcs.dread_sentinel_b.title': '어둠의 거울의 감시자',
  'entities.npcs.dread_sentinel_b.greeting': '살아서 둑길을 지켰다. 지금도 지킨다.',
  'entities.npcs.dread_sentinel_c.name': '공포의 파수꾼',
  'entities.npcs.dread_sentinel_c.title': '어둠의 거울의 감시자',
  'entities.npcs.dread_sentinel_c.greeting':
    '돌아가라. 검은 유리는 산 자를 위한 것이 아니다... 우리를 위한 것도 결코 아니었다.',
  'entities.quests.q_gargoyle_south.title': '감시자의 통행료',
  'entities.quests.q_gargoyle_south.text':
    '어른거림이 네 눈 뒤에서 말이 된다: 수확자들이 내 유리를 메우고 있다, {playerName}. 그들을 솎아내라, 그러면 Highwatch로 가는 길이 네 것이 되리라.',
  'entities.quests.q_gargoyle_south.completion':
    '돌이 한 번 만족스레 울린다. 그 뒤로 거울이, 마침내 놓아준 참았던 숨결처럼 맑아진다.',
  'entities.quests.q_gargoyle_south.objectives.0.label': '수확자 처치',
  'entities.quests.q_gargoyle_west.title': '천의 통행료',
  'entities.quests.q_gargoyle_west.text':
    '어른거림이 네 눈 뒤에서 말이 된다: 가난한 죽은 자들에게서 흰 천 넷을 가져오라, {playerName}. 천으로 값을 치르는 자에게 Eastbrook으로 가는 길이 열린다.',
  'entities.quests.q_gargoyle_west.completion':
    '천이 돌 속으로 가라앉아 사라진다. 그 뒤의 거울이 빛과 함께 깨어난다.',
  'entities.quests.q_gargoyle_west.objectives.0.label': '흰 천',
  'entities.quests.q_gargoyle_north.title': '거두어진 광휘',
  'entities.quests.q_gargoyle_north.text':
    '어른거림이 네 눈 뒤에서 말이 된다: 영혼의 무리가 유리에게는 너무 밝게 탄다, {playerName}. 다섯을 솎아내라, 그러면 Fenbridge가 한 걸음이다.',
  'entities.quests.q_gargoyle_north.completion':
    '돌이 네가 흘린 빛을 마신다. 그 뒤의 거울이 눈처럼 열린다.',
  'entities.quests.q_gargoyle_north.objectives.0.label': '영혼 유니콘 처치',
  'entities.zones.mirror_world.pois.10.label': '검은 협곡',
  'entities.mobs.gargoyle_awakened.name': '가고일 파수꾼',
  'entities.mobs.mistshade_lurker.name': '안개그림자 잠복꾼',
  'entities.mobs.gloaming_maw.name': '황혼의 아가리',
  'entities.mobs.player_echo.name': '메아리',
  'entities.npcs.keeper_nerissa.name': '잠들지 못하는 네리사',
  'entities.npcs.keeper_nerissa.title': '루멘 왕관의 유령 수호자',
  'entities.npcs.keeper_nerissa.greeting':
    '나는 살아서 루멘 왕관을 지켰고, 왕관은 이 유리를 정직하게 지킨다 - 이 골짜기의 모든 거울은 진실을 비추나, 오직 하나만은 아니다. 죽음도 나를 이 자리에서 놓아주지 않았다, {playerName}, 그 하나가 아직 밀어붙이기를 멈추지 않았기에. 왕관의 빛이 사위어 가고, 그 빛이 스러지는 곳에서 골짜기가 배어 나온다. 유리의 어느 쪽을 걷는지 마음 쓰라. 요즘은 그조차 분간하기 어려우니.',
  'entities.items.warden_sigil.name': '파수꾼의 인장',
  'entities.items.drowned_lumen.name': '가라앉은 루멘',
  'entities.quests.q_the_failing_radiance.title': '사위어 가는 광휘',
  'entities.quests.q_the_failing_radiance.text':
    '그대는 나의 냉기를 느끼고 나를 옛이야기로 여기지. 나는 하나의 초소다, {playerName}. 내가 지킨 루멘 왕관은 황금 고리가 아니라 이곳 모든 거울에 깃든 빛, 산 자와 죽은 자를 서로 다른 상(像)에 붙들어 어느 쪽도 다른 쪽을 삼키지 못하게 하는 이음매다. 그 빛이 스러지고, 그것은 거울결속 파수병들에게서 보인다. 한때는 왕관의 광휘 그 자체가 보초를 섰으나, 이제는 훔친 빛으로 가득 찬 유리일 뿐, 이음매가 더는 설 자리를 일러 주지 않아 북쪽 폐허에 몰려 있다. 여덟을 부수어라. 그대가 흩뜨리는 파편 하나하나가 돌아온 한 줌의 빛이요, 나머지를 그대에게 맡겨도 좋다는 한 줌의 증거다.',
  'entities.quests.q_the_failing_radiance.completion':
    '파편들이 위로 내리는 눈처럼 우물 쪽으로 떠 돌아가고, 한 호흡 동안 골짜기 전체가 한 결 밝아진다. 오래가진 않으리. 허나 그대는 이음매를 끊는 대신 꿰맨다, {playerName} - 이곳에선 그대 생각보다 드문 일이다. 그대는 다른 왕관도 부수었지? 손피크 아래의 무쇠 왕관을. 그렇다면 삼백 년 만에 처음으로, 이 빛이 돌아올지도 모른다. 머물러라. 이 골짜기는 상처를 닫는 손을 오래 기다려 왔다.',
  'entities.quests.q_the_failing_radiance.objectives.0.label': '거울결속 파수병 분쇄',
  'entities.quests.q_what_the_poor_keep.title': '가난한 자가 아직 지닌 것',
  'entities.quests.q_what_the_poor_keep.text':
    '남쪽 물가의 가난한 망령들은 살아서 아무것도 없었다, {playerName} - 교구가 관을 마련할 수 없어 그들을 감싼 수의 말고는 아무것도. 이제 왕관의 빛이 너무 여려 그들의 움켜쥠을 풀지 못하고, 그들은 한때나마 제 것이었던 단 하나를 부여잡고 떠돈다. 이를 잔혹이라 여기지 마라; 둘 곳 없는 사랑이니. 그들의 수의 다섯을 가져오라. 하나씩 우물에 뉘고, 새겨지기엔 너무 가난했던 이름을 부르리라. 의식의 전부가 그것이다 - 가난하고, 죽었으되, 여전히 이름으로 불리는 것.',
  'entities.quests.q_what_the_poor_keep.completion':
    '수의 다섯, 이름 다섯. 그것을 우물에 대고 읊으니, 물은 잠든 아이에게서 어미가 외투를 걷어 올리듯 그것을 받아 간다. 물가의 망령들이 오늘 밤 줄었다, {playerName} - 죽인 게 아니라 놓아준 것이다. 온전했던 왕관이 하던 일이 이것이었다: 놓아줄 수 있을 만큼 죽은 자를 가까이 붙든 것. 이제는 손으로 한다, 그대와 내가, 한 번에 다섯 이름씩. 더디다. 허나 헛되지는 않다.',
  'entities.quests.q_what_the_poor_keep.objectives.0.label': '하얀 수의',
  'entities.quests.q_the_wardens_names.title': '파수꾼들의 이름',
  'entities.quests.q_the_wardens_names.text':
    '검은 협곡을 거니는 셋을, 그들에게서 달아나는 자들은 공포의 파수병이라 부른다. 한때 나는 그들을 이름으로 불렀다 - 그들은 나의 기사단이었다, {playerName}, 살아서 검은담비 거울의 둑길을 지킨 마지막 사내들. 심장이 멈춘 뒤에도 자리를 뜨지 않았다. 이제 어떤 칼도 그들을 놓아주지 못한다; 검은 유리가 너무 깊이 올라타 쓰러질 수조차 없다. 허나 그 유리가 파수꾼들에게서 둑길에 몰린 사신들에게로 번졌고, 긴 세월 사신들은 파수꾼의 인장을 뜯어냈다. 협곡의 사신에게서 벤 셋을 가져오라. 세 이름을 마지막으로 소리 내어 부를 수 있도록.',
  'entities.quests.q_the_wardens_names.completion':
    '코윈. 앨더스. 브레나. 이로써 - 말해졌다. 그리고 말하는 일은, 여태 붙들고 있던 것보다 훨씬 가볍다. 머지않아 그들은 멈출 수 있으리; 그건 내가 맡으마. 허나 다가오는 것을 경계하라, {playerName}: 인장이 뜯겨 나갔다는 건 저 둑길의 유리가 얇아지고 있다는 뜻이요, 그 끝의 상처는 바로 이때를 기다려 왔다. 저편의 무언가가 문이 훤히 드러난 걸 알아채기 전에, 나는 왕관에 다시 불을 밝히고 검은담비 거울을 받쳐야 한다. 마지막으로 필요한 것이 하나 있다 - 검은 물 아래에 잠겨 있지.',
  'entities.quests.q_the_wardens_names.objectives.0.label': '파수꾼의 인장',
  'entities.quests.q_what_the_glass_wants.title': '유리가 원하는 것',
  ...
  'entities.quests.q_relight_the_lumen_crown.objectives.1.label': '가라앉은 루멘',
  'entities.quests.q_relight_the_lumen_crown.objectives.2.label': '음울한 거구 분쇄',
  'entities.npcs.veilwright_ollo.name': '장막장인 올로',
  'entities.npcs.veilwright_ollo.title': '장막 시장 상인',
  'entities.npcs.veilwright_ollo.greeting':
    '죽은 이의 외투, 병에 담긴 한숨, 정직한 값 - 장막이 내어주지. 내 좌판의 것은 모두 이제 아무것도 지니지 못한 이가 내려놓은 것. 요령은 죽은 자가 끝낸 것과 아직 움켜쥔 것을 가려내는 데 있다. 틀리면 한밤에 좌판으로 찾아오지. 슬픈 이야기가 궁금하거든 우물의 빛에 대해 파수꾼께 여쭤라. 나는 그저 외투를 팔 뿐이다.',
  'entities.npcs.gargoyle_sentinel_south.name': '가고일 파수꾼',
  'entities.npcs.gargoyle_sentinel_south.title': '거울의 수호자',
  'entities.npcs.gargoyle_sentinel_south.greeting': '돌 눈이 삐걱거리며 너를 향한다. 듣고 있다.',
  'entities.npcs.gargoyle_sentinel_west.name': '가고일 파수꾼',
  'entities.npcs.gargoyle_sentinel_west.title': '거울의 수호자',
  'entities.npcs.gargoyle_sentinel_west.greeting': '돌 눈이 삐걱거리며 너를 향한다. 듣고 있다.',
  'entities.npcs.gargoyle_sentinel_north.name': '가고일 파수꾼',
  'entities.npcs.gargoyle_sentinel_north.title': '거울의 수호자',
  'entities.npcs.gargoyle_sentinel_north.greeting': '돌 눈이 삐걱거리며 너를 향한다. 듣고 있다.',
  ...
  'entities.items.black_hood.name': '검은 두건',
  'entities.items.deepdream_draught.name': '깊은 꿈의 물약',
  'entities.items.mirror_shard.name': '거울 조각',
  'entities.items.ghostly_mirrorblade.name': '유령 거울칼날',
  'entities.items.ghostly_shroudmantle.name': '유령 수의 망토',
  'entities.items.ghostly_wraithjerkin.name': '유령 원귀 가죽갑옷',
  'entities.items.ghostly_palegrips.name': '유령 창백한 장갑',
  'entities.items.ghostly_hushboots.name': '유령 고요한 장화',
  'entities.items.ghostly_glasscord.name': '유령 유리 허리끈',
