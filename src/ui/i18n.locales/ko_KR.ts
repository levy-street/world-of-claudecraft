...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaEnd.victory': '승리',
  'hudChrome.arenaEnd.defeat': '패배',
  'hudChrome.arenaEnd.draw': '무승부',
  'hudChrome.arenaEnd.colName': '이름',
  'hudChrome.arenaEnd.colKills': '처치',
  'hudChrome.arenaEnd.colDamage': '피해량',
  'hudChrome.arenaEnd.colHealing': '치유량',
  'hudChrome.arenaEnd.colRating': '평점',
  'hudChrome.arenaEnd.colChange': '변동',
  'hudChrome.arenaEnd.yourRating': '내 평점: {before}에서 {after}로',
  'hudChrome.arenaEnd.honorEarned': '+{honor} 명예',
  'hudChrome.arenaEnd.leave': '나가기',
  'hudChrome.arenaEnd.close': '닫기',
