...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.gpuBackendNote':
    '자동: 시작할 때 Vulkan을 한 번 시도하고 정상 동작하면 계속 사용합니다. 그 경우 셰이더 로딩으로 인한 끊김이 크게 줄어듭니다. 드라이버가 지원하지 않으면 OpenGL로 돌아갑니다. Vulkan 또는 OpenGL을 선택한 뒤 다시 자동을 선택하면 한 번 더 시도합니다. 다음에 게임을 시작할 때 적용됩니다.',
