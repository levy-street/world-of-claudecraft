...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'marketplace.title': '크리에이터 스킨',
  'marketplace.subtitle':
    '플레이어가 제작한 외형. USDC로 구매합니다. 70%는 크리에이터에게, 30%는 $WOC를 매수해 소각합니다.',
  'marketplace.loading': '스킨 불러오는 중…',
  'marketplace.empty': '판매 중인 크리에이터 스킨이 아직 없습니다.',
  'marketplace.connectFirst': '구매하려면 지갑을 연결하세요.',
  'marketplace.purchasing': '구매 중…',
  'marketplace.owned': '보유함 — 장착됨',
  'marketplace.failed': '구매 실패',
  'marketplace.close': '닫기',
  ...
  'marketplace.tabBrowse': '둘러보기',
  'marketplace.tabCreate': '제작 및 판매',
  'marketplace.search': '스킨 검색',
  'marketplace.anyClass': '모든 직업',
  ...
  'marketplace.designIntro':
    '몸체의 색과 패턴을 바꿔 보세요. 모두에게 동일하게 표시되며 파일 업로드가 필요 없습니다.',
  'marketplace.modeDesign': '디자인',
  'marketplace.modeUpload': '업로드',
  'marketplace.modeLink': '자체 호스팅',
  'marketplace.uploadIntro':
    '직접 만든 1024x1024 PNG 아틀라스를 업로드하세요. IPFS에 고정해 대신 호스팅해 드립니다.',
  'marketplace.linkIntro':
    '직접 호스팅하는 PNG 아틀라스를 연결하세요. 프록시를 거치므로 구매자는 URL을 볼 수 없습니다. 무료입니다.',
  'marketplace.linkUrl': '아틀라스 URL',
  'marketplace.quotaMeter': '호스팅 슬롯 {used}/{quota} 사용 중',
  'marketplace.trustedBadge': '신뢰받는 창작자(즉시 게시)',
  'marketplace.selfHostedFreeNote': '자체 호스팅은 무료이며 제한이 없습니다(등록 상한 내에서).',
  'marketplace.hostingUnavailable': '호스팅 업로드를 일시적으로 사용할 수 없습니다.',
  'marketplace.listedReview': '심사에 제출되었습니다. 운영자가 승인하면 등록됩니다.',
  'marketplace.baseColor': '기본 색상',
  'marketplace.patternColor': '패턴 색상',
  'marketplace.accentColor': '강조 색상',
  'marketplace.pattern': '패턴',
  'marketplace.finishLabel': '마감',
  'marketplace.densityLabel': '밀도',
  'marketplace.finishes.matte': '무광',
  'marketplace.finishes.satin': '새틴',
  'marketplace.finishes.metallic': '메탈릭',
  'marketplace.densities.low': '성김',
  'marketplace.densities.medium': '보통',
  'marketplace.densities.high': '조밀',
  'marketplace.glowColor': '발광 색상',
  'marketplace.noGlow': '발광 없음',
  'marketplace.randomize': '무작위',
  'marketplace.namePlaceholder': '예: 에메랄드 용비늘',
  'marketplace.descLabel': '설명',
  'marketplace.descPlaceholder': '구매자에게 표시될 짧은 설명',
  'marketplace.priceLabel': '가격(USDC)',
  'marketplace.preview': '실시간 미리보기',
  'marketplace.list': '판매 등록',
  'marketplace.listing': '등록 중…',
  'marketplace.listed': '등록되었습니다. 바로 판매가 시작됩니다. 보유 스킨에서 장착하세요.',
  'marketplace.listFailed': '등록할 수 없습니다',
  'marketplace.listConnectFirst': '등록하려면 지갑을 연결하세요(수익의 70%를 받습니다).',
  'marketplace.payoutHint': '창작자 몫 70% • 30%는 $WOC 매입 및 소각',
  'marketplace.patterns.solid': '단색',
  'marketplace.patterns.scales': '비늘',
  'marketplace.patterns.stripes': '줄무늬',
  'marketplace.patterns.diamond': '다이아몬드',
  'marketplace.patterns.spots': '점박이',
  'marketplace.patterns.runes': '룬 문양',
  'entities.npcs.skin_artisan.name': '스킨 장인 핍',
  'entities.npcs.skin_artisan.title': '창작자 스킨 게시판',
  'entities.npcs.skin_artisan.greeting':
    '새로운 모습이 필요하신가요, {className}? 플레이어가 만든 치장용 스킨을 둘러보거나 직접 디자인해 판매해 보세요. 결제는 USDC로 하며, 일부는 $WOC 매입과 소각에 쓰입니다.',
  'hudChrome.nftSkins.intro': 'PFP NFT 소유를 증명하고 착용하세요. 트레잇이 몸의 외형을 결정하고 그 아트가 초상화가 됩니다. NFT를 보유하는 동안 유지됩니다.',
  'hudChrome.nftSkins.connectEthereum': 'Ethereum 지갑 연결',
  'hudChrome.nftSkins.connectSolana': 'Solana 지갑 연결',
  'hudChrome.nftSkins.ethereumLinked': 'Ethereum 지갑: {address}',
  'hudChrome.nftSkins.solanaLinked': 'Solana 지갑: {address}',
  'hudChrome.nftSkins.notLinked': '연결 안 됨',
  'hudChrome.nftSkins.collectionsTitle': '지원 컬렉션',
  'hudChrome.nftSkins.noCollections': '아직 이용 가능한 컬렉션이 없습니다. 곧 다시 확인해 주세요.',
  'hudChrome.nftSkins.tokenIdPlaceholder': '토큰 ID',
  'hudChrome.nftSkins.mintPlaceholder': '민트 주소',
  'hudChrome.nftSkins.claim': '신청',
  'hudChrome.nftSkins.claiming': '신청 중...',
  'hudChrome.nftSkins.claimed': '신청하고 장착했습니다. 스킨 브라우저에서 언제든지 확인할 수 있습니다.',
  'hudChrome.nftSkins.needWallet': '먼저 해당 지갑을 연결하세요.',
  'hudChrome.nftSkins.close': '닫기',
  'hudChrome.nftSkins.errorNotOwner': '해당 지갑은 이 토큰을 소유하고 있지 않습니다.',
  'hudChrome.nftSkins.errorUnverified': '지금은 소유권을 확인할 수 없습니다. 잠시 후 다시 시도하세요.',
  'hudChrome.nftSkins.errorCollection': '지원하지 않는 컬렉션입니다.',
  'hudChrome.nftSkins.errorTooMany': 'NFT 스킨 한도에 도달했습니다.',
  'hudChrome.nftSkins.errorMetadata': '지금은 이 NFT를 읽을 수 없습니다. 잠시 후 다시 시도하세요.',
  'hudChrome.nftSkins.errorGeneric': '이 NFT 스킨을 신청할 수 없습니다.',
  'hudChrome.nftSkins.walletError': '지갑 연결에 실패했습니다.',
};
