...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.title': '호드릭 성',
  'hudChrome.hc.close': '건틀릿 창 닫기',
  'hudChrome.hc.zoneName': '호드릭 성',
  'hudChrome.hc.offlineNote': '건틀릿 접수처가 아직 동기화되지 않았습니다. 잠시만 기다려 주세요.',
  'hudChrome.hc.joinQueue': '건틀릿 참가',
  'hudChrome.hc.leaveQueue': '대기열 나가기',
  'hudChrome.hc.queuedAt': '대기 순번 {position}. 열 명이 모이면 경주가 시작됩니다.',
  'hudChrome.hc.inMatchNote': '경주 중입니다. 앞만 보고 달리세요!',
  'hudChrome.hc.practice': '궁정 기사단과 연습',
  'hudChrome.hc.practiceNote': '호드릭 경의 궁정 기사단과 겨루기: 도전자 아홉 명, 대기 없음.',
  'hudChrome.hc.record': '우승 {wins} / 참가 {races}',
  'hudChrome.hc.bestTime': '최고 기록 {seconds}초',
  'hudChrome.hc.bestNone': '아직 완주 기록이 없습니다',
  'hudChrome.hc.rank': '순위 {rank} / {total}',
  'hudChrome.hc.finishPlace': '{place}위로 완주',
  'hudChrome.hc.overWon': '왕관은 당신의 것이다!',
  'hudChrome.hc.overPlaced': '경주 종료: {place}위',
  'hudChrome.hc.howto':
    '3라운드, 10명의 레이서, 왕관은 하나. 호드릭 경은 매 라운드마다 건틀릿을 새로 짓습니다. 매번 탈락을 피하고(6명, 그다음 3명 통과) 결승에서 우승하세요. 추락해도 시간만 잃을 뿐입니다.',
  'hudChrome.hc.round': '라운드 {round}/{rounds}',
  'hudChrome.hc.advance': '{count}명 통과',
  'hudChrome.hc.spectating': '갤러리에서 관전 중',
  'hudChrome.hc.intermissionRebuild': '호드릭 경이 건틀릿을 새로 짓습니다!',
  'hudChrome.hc.intermissionQualified': '통과! 곧 다음 라운드입니다.',
  'hudChrome.hc.intermissionEliminated': '탈락! 갤러리 경치를 즐기세요.',
  'hudChrome.hc.section.hammer_bridge': '해머 다리',
  'hudChrome.hc.section.rotor_court': '회전 통나무 안뜰',
  'hudChrome.hc.section.boulder_climb': '바위 언덕',
  'hudChrome.hc.section.piston_ledge': '피스톤 절벽길',
  'hudChrome.hc.section.spinner_court': '회전판 광장',
  'hudChrome.hc.section.landing': '착지장',
  'hudChrome.hc.banner.round': '라운드 {round}!',
  'hudChrome.hc.banner.qualified': '통과!',
  'hudChrome.hc.banner.eliminated': '탈락',
  'hudChrome.hc.log.qualified': '다음 라운드에 진출했습니다.',
  'hudChrome.hc.log.eliminated': '{round}라운드에서 탈락했습니다. 갤러리에는 간식이 있답니다.',
  'hudChrome.hc.flavor.rebuild': '호드릭 경이 건틀릿을 새로 지었습니다. 새 코스, 같은 왕관!',
  'hudChrome.hc.section.start_yard': '출발 광장',
  'hudChrome.hc.section.axe_walk': '도끼 회랑',
  'hudChrome.hc.section.drawspan': '도개교',
  'hudChrome.hc.section.red_ascent': '붉은 경사로',
  'hudChrome.hc.section.finish_keep': '결승 성채',
  'hudChrome.hc.banner.found': '건틀릿이 부른다!',
  'hudChrome.hc.banner.go': '출발!',
  'hudChrome.hc.banner.finish': '{place}위로 완주!',
  'hudChrome.hc.banner.crown': '호드릭의 왕관을 차지했다!',
  'hudChrome.hc.log.queued': '건틀릿 대기열에 참가했습니다 (순번 {position}).',
  'hudChrome.hc.log.unqueued': '건틀릿 대기열에서 나갔습니다.',
  'hudChrome.hc.log.fall': '심연이 당신을 삼켰습니다. 체크포인트로 돌아갑니다.',
  'hudChrome.hc.log.checkpoint': '체크포인트 {index} 통과.',
  'hudChrome.hc.log.placed': '건틀릿을 {place}위로 완주했습니다.',
  'hudChrome.hub.enter': '일렁이는 차원문을 통과해 시련의 장으로 들어선다.',
  'hudChrome.hub.leave': '당신은 이스트브룩 골짜기로 돌아온다.',
  'hudChrome.hub.zoneName': '시련의 서고',
  'hudChrome.hc.flavor.queueJoin':
    '건틀릿 대기열에 참가했습니다. 호드릭 경이 당신을 위해 도리깨에 기름을 칩니다.',
  'hudChrome.hc.flavor.gatesOpen': '호드릭 성의 문이 삐걱이며 열린다. 왕관을 향해 달려라!',
  'hudChrome.hc.flavor.go': '출발! 건틀릿이 열렸다!',
  'hudChrome.hc.err.legsOnly': '건틀릿에서는 다리만 쓸 수 있습니다: 스킬 사용이 금지됩니다.',
  'hudChrome.hc.err.inMatch': '이미 건틀릿에 참가 중입니다.',
  'hudChrome.hc.err.dead': '사망 상태에서는 건틀릿에 참가할 수 없습니다.',
  'hudChrome.hc.err.arenaConflict': '건틀릿에 참가하려면 먼저 콜로세움을 나가세요.',
  ...
  'entities.npcs.hodrics_herald.name': '전령 오스릭',
  'entities.npcs.hodrics_herald.title': '호드릭 건틀릿 전령',
  'entities.npcs.hodrics_herald.greeting':
    '호드릭 경이 모든 도전자에게 길을 연다! 건틀릿에 도전하여 도리깨를 피하고 왕관을 차지하라!',
  ...
  'guide.nav.hodricsCastle': '호드릭 성',
  'guide.hodricsCastlePage.heading': '호드릭 성',
  'guide.hodricsCastlePage.intro':
    '호드릭 경은 어떤 도전자에게든 성의 통로를 열어준다. 그의 옛 방어선으로 이루어진 시련을 돌파하여 왕관을 차지하라. 당신이 누구이든, 레벨이 무엇이든 상관없다.',
  'guide.hodricsCastlePage.heraldHeading': '전령',
  'guide.hodricsCastlePage.heraldBody':
    '이스트브룩 외곽에서 전령 오스릭을 찾아 건틀릿 대기열에 참가하세요. 열 명의 도전자(실제 플레이어와 호드릭 경의 궁정 기사단 모두)가 모이면 경주가 시작되므로, 경주는 언제나 금방 시작됩니다.',
  'guide.hodricsCastlePage.courseHeading': '3라운드, 왕관은 하나',
  'guide.hodricsCastlePage.courseBody':
    '건틀릿은 서바이벌 쇼입니다. 10명이 1라운드를 시작해 6명이 살아남고, 3명이 결승에 오르며, 1명이 왕관을 차지합니다. 호드릭 경은 매 라운드마다 코스를 새로 짓기에 같은 경주는 두 번 없습니다. 해머 다리, 회전 통나무 안뜰, 도끼 회랑, 미닫이 다리, 바위 언덕, 피스톤 절벽길, 회전판까지, 그날 영주님 기분에 따라 순서가 정해집니다. 모든 장애물은 정해진 시계태엽 리듬으로 흔들리고 돌고 구르며, 무작위가 아니므로 주의 깊은 눈은 언제나 안전한 틈을 찾을 수 있습니다.',
  'guide.hodricsCastlePage.fairnessHeading': '오직 다리로만',
  'guide.hodricsCastlePage.fairnessBody':
    '여기서는 아무도 주문을 쓰지 않습니다: 경주 내내 스킬 사용이 금지되며, 모든 참가자는 같은 속도로 달립니다. 건틀릿의 승부는 오직 배짱과 타이밍으로 결정되며, 장비나 레벨과는 무관합니다.',
  'guide.hodricsCastlePage.fallsHeading': '추락은 시간만 잃을 뿐',
  'guide.hodricsCastlePage.fallsBody':
    '장애물에 맞거나 심연으로 떨어져도 마지막 체크포인트로 돌아갈 뿐입니다. 이 성에서는 아무도 죽지 않습니다. 추락의 대가는 따라잡는 데 걸리는 몇 초뿐입니다. 라운드가 끝나고 탈락한 이들은 멋지게 갤러리 발코니로 날아가, 간식과 함께 남은 쇼를 관전합니다.',
  'guide.hodricsCastlePage.standingsHeading': '왕관',
  'guide.hodricsCastlePage.standingsBody':
    '결승 라운드 결승선을 가장 먼저 통과한 자가 그 쇼의 호드릭 왕관을 차지합니다. 출전 횟수, 우승, 결승 최고 기록은 줄을 설 때마다 쌓여 갑니다.',
  ...
  'hudChrome.gauntlet.joinQueue': '대기열 참가',
  'hudChrome.gauntlet.leaveQueue': '대기열 나가기',
  'hudChrome.gauntlet.queuePosition': '대기열 순서: {n}',
  'hudChrome.gauntlet.spectate': '관전',
  'hudChrome.gauntlet.stopSpectating': '관전 종료',
  'hudChrome.gauntlet.practice': '연습',
  ...
  'hudChrome.gauntlet.phaseLobby': '도전자 모집 중',
  'hudChrome.gauntlet.phaseStaging': '자리에 서라',
  'hudChrome.gauntlet.phaseTrial': '횡단 시작',
  'hudChrome.gauntlet.phaseTrialSigils': '각인 시작',
  'hudChrome.gauntlet.phaseTrialPull': '밧줄을 잡아라',
  'hudChrome.gauntlet.phaseTrialEcho': '파수꾼의 메아리가 시작됩니다',
  'hudChrome.gauntlet.phaseTrialSpan': '부서지는 다리를 건너라',
  'hudChrome.gauntlet.phaseTrialCourt': '최후의 결투장',
  'hudChrome.gauntlet.phaseInterlude': '시련 통과',
  'hudChrome.gauntlet.phasePodium': '시련의 관문, 승자가 결정되었다',
  'hudChrome.gauntlet.greenLight': '초록 불!',
  'hudChrome.gauntlet.redLight': '빨간 불!',
  'hudChrome.gauntlet.vitalityLost': '생명력을 {amount} 잃었다.',
  'hudChrome.gauntlet.survivorsLeft': '{count}명 생존',
  'hudChrome.gauntlet.spectating': '관전 중',
  'hudChrome.gauntlet.leave': '나가기',
  'hudChrome.gauntlet.victory': '승리',
  'hudChrome.gauntlet.podiumTitle': '최종 순위',
  ...
  'hudChrome.gauntlet.hint.court':
    '상대와 결투하세요. 안쪽 끝의 왕관에 도달하거나 상대를 링 밖으로 밀어내세요. 역할은 일정 시간마다 바뀝니다.',
  ...
  'entities.npcs.gauntlet_watcher.name': '돌의 감시자',
  'entities.npcs.gauntlet_watcher.title': '횡단의 수호자',
  'entities.npcs.gauntlet_watcher.greeting': '감시자는 눈을 깜빡이지 않는다.',
  'entities.npcs.gauntlet_contestant.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant.title': '참가자',
  'entities.npcs.gauntlet_contestant.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_warrior.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_warrior.title': '참가자',
  'entities.npcs.gauntlet_contestant_warrior.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_paladin.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_paladin.title': '참가자',
  'entities.npcs.gauntlet_contestant_paladin.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_hunter.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_hunter.title': '참가자',
  'entities.npcs.gauntlet_contestant_hunter.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_rogue.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_rogue.title': '참가자',
  'entities.npcs.gauntlet_contestant_rogue.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_priest.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_priest.title': '참가자',
  'entities.npcs.gauntlet_contestant_priest.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_mage.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_mage.title': '참가자',
  'entities.npcs.gauntlet_contestant_mage.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_warlock.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_warlock.title': '참가자',
  'entities.npcs.gauntlet_contestant_warlock.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_shaman.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_shaman.title': '참가자',
  'entities.npcs.gauntlet_contestant_shaman.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
  'entities.npcs.gauntlet_contestant_druid.name': '시련의 관문 참가자',
  'entities.npcs.gauntlet_contestant_druid.title': '참가자',
  'entities.npcs.gauntlet_contestant_druid.greeting': '앞을 보라. 감시자가 지켜보고 있다.',
