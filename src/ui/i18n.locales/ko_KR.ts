...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.itemAccountBound': '계정 귀속',
  'hudChrome.mailbox.clickAttachAccountBound': '클릭하면 편지에 첨부됩니다. 계정 귀속: 당신 자신의 캐릭터만 받을 수 있습니다.',
  'hudChrome.mailbox.result.noMailAccountBound': '계정 귀속 아이템은 당신 자신의 캐릭터에게만 우편으로 보낼 수 있습니다.',
  'hudChrome.trade.woc.ineligibleReasonAccountBound': '계정 귀속 아이템, 퀘스트 아이템, 잠긴 아이템, 그리고 거래소 범주 밖의 아이템은 $WOC로 판매할 수 없습니다.',
  'guide.glossary.accountBoundTerm': '계정 귀속',
  'guide.glossary.accountBoundDef': '얻는 순간부터 당신의 계정에 묶이는 아이템입니다. 거래하거나 상인에게 팔거나 시장에 올릴 수 없으며, 편지로는 당신 자신의 다른 캐릭터에게만 보낼 수 있습니다.',
  'guide.gear.accountBoundTitle': '계정 귀속: 당신의 어느 캐릭터에게든 당신의 것',
  'guide.gear.accountBoundBody': '몇몇 특별한 보상은 계정 귀속으로, 얻는 순간부터 당신의 계정에 묶입니다. 계정 귀속 아이템은 거래하거나 상인에게 팔거나 시장에 올리거나 길드 은행에 보관할 수 없고, 다른 플레이어에게 보내는 편지에도 실리지 않습니다. 열려 있는 유일한 문은 당신 자신의 캐릭터들 사이를 오가는 까마귀 우편입니다. 한 캐릭터에게 더는 필요 없는 귀속 장비를 같은 계정의 다른 캐릭터에게 부칠 수 있고, 직업 전용 장비도 포함되므로 알맞은 직업의 부캐릭터가 입을 수 있습니다. 이는 영웅의 징표 같은 보상 토큰을 지키며, 명예로 산 모든 워페어 장비에도 적용됩니다. 세상에서 얻는 대부분의 장비는 여전히 자유롭게 거래하고 팔고 나눌 수 있습니다.',
  'guide.economy.mailHowAccountBound': '받는 것도 똑같이 거꾸로 하면 됩니다. 어느 석주 앞에서든 편지를 읽고, 담긴 것을 지갑과 가방으로 옮기세요. 평범한 편지는 시간이 지나면 사라지지만, 동전이나 물건이 담긴 편지는 아무리 오래 걸려도 당신을 기다립니다. 우편이 딱 잘라 거절하는 것이 몇 가지 있습니다. 퀘스트 물품, 이미 귀속되었거나 거래로 귀속될 물건, 그리고 하나뿐인 외형 토큰은 당신과 함께 다니거나 아예 다니지 않으며, 계정 귀속 아이템은 까마귀가 당신 자신의 다른 캐릭터에게만 날라다 줍니다. 그리고 보람찬 퀘스트 완료 뒤에는 석주를 눈여겨보세요. 편지를 쓰는 퀘스트 제공자들도 있으니까요.',
  'guide.economy.buyingBodyAccountBound': '상인에게 말을 걸어 물건을 둘러보기로 하면, 그들의 상점이 하나의 창으로 열립니다. 갖춘 모든 물건이 한 목록에 있어, 형편이 닿는다면 클릭 한 번에 당신의 것이 됩니다. 물건 위의 수량 띠로 클릭마다 몇 개를 살지 정할 수 있습니다. 하나, 다섯, 열, 또는 직접 정한 수량이지만, 탈것을 비롯한 몇몇 특별한 물건은 언제나 한 번에 하나씩만 팝니다. 동전으로 값을 매긴 겹칠 수 있는 물건에는 줄 옆에 두 번째 제안이 있어, 가진 동전으로 살 수 있는 만큼을 최대 한 묶음까지 한 번에 살 수 있습니다. 파는 것도 그만큼 간단합니다. 상점이 열린 동안 가방의 아이템을 클릭하면 그 자리에서 팔리고, 퀘스트 물품이나 계정 귀속 물건처럼 상인이 받지 않는 것은 그대로 남습니다. 후회할 물건을 넘겼다면, 상점이 최근 판매 내역을 되사기 목록에 남겨 두어 받았던 동전으로 다시 사들일 수 있습니다.',
  'guide.social.guildBankRulesBodyAccountBound': '물품 창고는 처음에 닫혀 있습니다. 장교가 자기 주머니를 털어 열고, 이후에는 금고에서 비용을 치러 넓힐 수 있습니다. 퀘스트 물품과 계정 귀속된 물건, 시장이 받지 않는 장비는 시장과 마찬가지로 들어가지 못하므로, 길드 은행은 아직 플레이어 사이에서 주인이 바뀔 수 있는 물건을 위한 곳입니다.',
  'guide.arenaPage.honorFinalNoteAccountBound': '명예로 산 물건은 되돌릴 수 없습니다. 동전으로 산 물건은 상인의 되사기 목록에서 되찾을 수 있지만, 명예로 산 물건은 그 목록에 결코 오르지 않습니다. 게다가 워페어 장비는 구매하는 순간 계정 귀속되어 거래도 되팔기도 영영 할 수 없고, 오직 당신 자신의 다른 캐릭터에게 부칠 수만 있습니다. 상점이 굳이 한 번 더 확인을 묻는 이유가 그것이니, 누르기 전에 장비를 찬찬히 읽어 보세요.',
};
