...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.undermount_wing2.name': '언더마운트: 뜨임',
  'entities.dungeons.undermount_wing2.enterText': '망치질 소리가 뜨임 금고에 울려 퍼집니다.',
  'entities.dungeons.undermount_wing2.leaveText': '당신은 울리는 화로길에서 물러납니다.',
  'entities.dungeons.undermount_wing3.name': '언더마운트: 깨어남',
  'entities.dungeons.undermount_wing3.enterText': '묻힌 용광로가 깊은 곳에서 꿈틀거립니다.',
  'entities.dungeons.undermount_wing3.leaveText': '당신은 깨어나는 열기에서 물러납니다.',
  ...
  'entities.quests.q_undermount_heat.text':
    '이 균열 주변의 돌은 목탄이 번질 만큼 뜨겁습니다, {playerName}. 교단이 다시 묻기 전에 드러난 세 룬 면을 탁본해 오십시오. 무늬가 반복되면 아래에 무엇이 있는지 알 수 있습니다.',
  'entities.quests.q_undermount_heat.completion':
    '선이 모두 안쪽으로 향합니다. 대장장이의 작업 표식이 아닙니다, {playerName}. 결계이며, 무언가가 아래에서 베어 내고 있습니다.',
  'entities.quests.q_undermount_heat.objectives.0.label': '룬 탁본 채취',
  'entities.quests.q_undermount_ledger.title': '교단이 묻은 것',
  'entities.quests.q_undermount_ledger.text':
    '발굴 감독은 작업 장부를 몸에 지니고 야영지의 광신도들이 지킵니다. 가져오십시오, {playerName}. 모든 주괴와 식량과 임금이 어디로 가는지 알고 싶습니다.',
  'entities.quests.q_undermount_ledger.completion':
    '아래입니다. 모든 주괴와 잿불이 우리 발밑에서 쓰입니다, {playerName}. 용광로는 지상에 아무것도 만들지 않습니다. 산이 묻은 존재를 먹이고 있습니다.',
  'entities.quests.q_undermount_ledger.objectives.0.label': 'Wyrmcult 발굴 감독 처치',
  'entities.quests.q_undermount_ledger.objectives.1.label': 'Wyrmcult 경비병 처치',
  'entities.quests.q_undermount_ledger.objectives.2.label': '감독의 장부 회수',
  'entities.quests.q_undermount_descent.title': '언더마운트로',
  'entities.quests.q_undermount_descent.text':
    '장부는 발굴지 아래의 두 번째 작업장을 확인해 주며 모든 운송품이 아래를 향합니다. 준비되면 말하십시오, {playerName}. 저도 하강에 합류하겠습니다.',
  'entities.quests.q_undermount_descent.completion':
    '이 등불을 가져가십시오. 마법은 없고 흔들리지 않는 불꽃뿐이지만 아래에서는 정직한 빛이 필요합니다. 이 연속 퀘스트를 건너뛰어도 공격대 입구는 열려 있습니다.',
  'entities.quests.q_undermount_descent.objectives.0.label': '룬추적자 매린과 대화',
  ...
  'entities.items.undermount_rune_rubbing.name': '언더마운트 룬 탁본',
  ...
  'entities.mobs.wyrmcult_dig_foreman.name': '고룡교단 발굴 감독관',
  'entities.items.cindertoad_signet.name': '불씨두꺼비 인장',
  'entities.items.coalglow_band.name': '숯불빛 반지',
  'entities.items.crownforged_warleggings.name': '왕관벼림 전투 다리갑옷',
  'entities.items.glassblowers_shiv.name': '유리장이의 칼',
  'entities.items.glasswalker_treads.name': '유리길 장화',
  'entities.items.nighttalon_prowlers.name': '밤발톱 잠행화',
  'entities.items.quenchsilk_cord.name': '뜨임비단 끈',
  'entities.items.ring_of_the_first_quench.name': '첫 뜨임의 반지',
  'entities.items.saans_stoking_iron.name': '사안의 화로 부지깽이',
  'entities.items.slag_tempered_sabatons.name': '광재뜨임 철갑장화',
  'entities.items.slakeleather_belt.name': '식힘가죽 허리띠',
  'entities.items.sluicebearer.name': '수문지기',
  'entities.items.soulflame_kilt.name': '영혼불꽃 킬트',
  'entities.items.stokebrand_striders.name': '화부낙인 장화',
  'entities.items.stormcallers_legwraps.name': '폭풍소환사의 다리싸개',
  'entities.items.the_even_temper.name': '고른 뜨임',
  'entities.items.twice_fired_slippers.name': '두 번 구운 덧신',
  'entities.items.twicetempered_girdle.name': '두 번 뜨인 요대',
  'entities.items.crownforged_heartplate.name': '왕관벼림 심장갑옷',
  'entities.items.nighttalon_emberweave.name': '밤갈퀴 잿불매듭',
  'entities.items.soulflame_vestments.name': '영혼불꽃 예복',
  'entities.items.stormcallers_hauberk.name': '폭풍소환사의 사슬갑옷',
  'entities.items.volzharrs_knucklestone.name': '볼자르의 주먹돌',
  'entities.items.magmastrider_greaves.name': '용암걸음 경갑',
  'entities.items.footwraps_of_the_waking_floor.name': '깨어나는 바닥의 발싸개',
  'entities.items.forgeheat_cinch.name': '용광로 열기 허리띠',
  'entities.items.corebreaker_heart_of_the_undermount.name': '핵파괴자, 산아래의 심장',
  'entities.items.the_last_restraint.name': '마지막 구속',
  'entities.items.band_of_the_ninth_quench.name': '아홉 번째 담금질의 고리',
  'entities.items.moltenheart_chroma.name': '용융심장',
  'entities.itemSets.crownforged.bonus5': '치명타 확률이 3% 증가합니다.',
  'entities.itemSets.nighttalon.bonus5': '치명타 확률이 3% 증가합니다.',
  'entities.itemSets.soulflame.bonus5': '주문 치명타 확률이 3% 증가합니다.',
  'entities.itemSets.stormcallers.bonus5': '주문 치명타 확률이 3% 증가합니다.',
};
