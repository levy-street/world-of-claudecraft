...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'yumi.log.teamBlue': '당신은 청팀입니다!',
  'yumi.log.teamRed': '당신은 홍팀입니다!',
  'yumi.log.powerupGrabbed': '{player}님이 {name} 파워업을 획득했습니다!',
  'yumi.hud.powerupIn': '파워업까지 {s}초',
  'yumi.hud.powerupReady': '파워업 준비 완료!',
  'yumi.banner.powerupSpawn': '미스터리 파워업이 나타났습니다!',
  'yumi.powerup.invuln.name': '무적',
  'yumi.powerup.stealth.name': '베일스텝',
  'yumi.powerup.endless_mana.name': '무한 마나',
  'yumi.powerup.berserk.name': '워피버',
