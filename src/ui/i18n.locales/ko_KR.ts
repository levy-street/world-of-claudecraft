...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.cosmetics.mountsIntro': '탈것 스킨은 이 캐릭터가 타는 어떤 탈것 위에도 덧입혀집니다. 속도는 바뀌지 않습니다.',
  'hudChrome.cosmetics.mechIntro': '전투 메카는 이 캐릭터의 몸을 대체합니다. 한 번에 하나의 크로마만 착용합니다.',
};
