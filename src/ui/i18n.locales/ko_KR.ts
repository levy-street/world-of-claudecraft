...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.merch.title': '굿즈 스토어',
  'hudChrome.merch.subtitle': '공식 World of ClaudeCraft 굿즈를 전 세계로 배송합니다.',
  'hudChrome.merch.loading': '스토어를 불러오는 중…',
  'hudChrome.merch.unavailable':
    '굿즈 스토어를 지금은 이용할 수 없습니다. 주문과 결제에는 영향이 없습니다. 잠시 후 다시 시도해 주세요.',
  'hudChrome.merch.disclosure':
    '굿즈는 인쇄 파트너가 주문 제작하여 배송합니다. 굿즈 구매에 사용한 Claudium은 Claudium으로 환불되지 않으며, 카드 및 Solana 결제는 서비스 약관의 환불 정책을 따릅니다.',
  'hudChrome.merch.catalogTitle': '카탈로그',
  'hudChrome.merch.catalogEmpty': '지금은 구매할 수 있는 굿즈가 없습니다.',
  'hudChrome.merch.variantLabel': '스타일 및 사이즈',
  'hudChrome.merch.addToCart': '장바구니에 추가',
  'hudChrome.merch.outOfStock': '품절',
  'hudChrome.merch.cartTitle': '장바구니',
  'hudChrome.merch.cartEmpty': '장바구니가 비어 있습니다.',
  'hudChrome.merch.removeFromCart': '장바구니에서 제거',
  'hudChrome.merch.totalLabel': '합계',
  'hudChrome.merch.totalNote': '배송비와 세금은 결제 시 추가되며, 최종 금액은 서버에서 확정됩니다.',
  'hudChrome.merch.claudiumPrice': '{amount} Claudium',
  'hudChrome.merch.checkoutTitle': '결제',
  'hudChrome.merch.loginRequired': '결제하려면 계정에 로그인하세요.',
  'hudChrome.merch.shipping.name': '이름',
  'hudChrome.merch.shipping.address1': '주소',
  'hudChrome.merch.shipping.address2': '주소 2행(선택)',
  'hudChrome.merch.shipping.city': '도시',
  'hudChrome.merch.shipping.state': '주/도',
  'hudChrome.merch.shipping.zip': '우편번호',
  'hudChrome.merch.shipping.country': '국가',
  'hudChrome.merch.shipping.email': '주문 알림용 이메일',
  'hudChrome.merch.shippingIncomplete': '필수 배송 정보를 모두 입력해 주세요.',
  'hudChrome.merch.railLabel': '결제 수단',
  'hudChrome.merch.railStripe': '카드',
  'hudChrome.merch.railSol': 'SOL',
  'hudChrome.merch.railClaudium': 'Claudium',
  'hudChrome.merch.payNow': '주문하기',
  'hudChrome.merch.checkoutPending':
    '주문을 처리 중입니다. 결제를 완료하고 이 페이지를 열어 두세요.',
  'hudChrome.merch.checkoutFailed': '결제를 시작할 수 없습니다. 다시 시도해 주세요.',
  'hudChrome.merch.checkoutUnavailable': '해당 주문은 지금 이용할 수 없습니다.',
  'hudChrome.merch.checkoutNotSettled':
    '트랜잭션은 전송되었지만 주문이 아직 확인되지 않았습니다. 잠시 후 주문 내역을 확인해 주세요.',
  'hudChrome.merch.orderPlaced':
    '주문 {orderId}이(가) 접수되었습니다. 아래 주문 내역에서 추적할 수 있습니다.',
  'hudChrome.merch.paymentPending':
    '주문 {orderId}이(가) 카드 결제를 기다리고 있습니다. 결제가 완료되면 주문 목록에 표시됩니다.',
  'hudChrome.merch.ordersTitle': '주문 내역',
  'hudChrome.merch.trackOrder': '추적',
  'hudChrome.merch.status.pendingPayment': '결제 대기',
  'hudChrome.merch.status.paid': '결제 완료',
  'hudChrome.merch.status.submitted': '생산 요청됨',
  'hudChrome.merch.status.inProduction': '생산 중',
  'hudChrome.merch.status.shipped': '배송됨',
  'hudChrome.merch.status.delivered': '배송 완료',
  'hudChrome.merch.status.paymentFailed': '결제 실패',
  'hudChrome.merch.status.expired': '만료됨',
  'hudChrome.merch.status.canceled': '취소됨',
  'hudChrome.merch.status.refunded': '환불됨',
  'hudChrome.merch.status.fulfillmentFailed': '배송 처리 실패',
  'hudChrome.merch.status.unknown': '처리 중',
