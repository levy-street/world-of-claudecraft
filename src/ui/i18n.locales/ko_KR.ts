...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mobileHudEditor.launcher': '모바일 레이아웃 사용자 정의',
  'hudChrome.mobileHudEditor.title': '모바일 레이아웃 편집기',
  'hudChrome.mobileHudEditor.dialogLabel': '모바일 컨트롤 사용자 정의',
  'hudChrome.mobileHudEditor.dragHandleLabel': '편집기 패널 이동',
  'hudChrome.mobileHudEditor.dragHandleHint':
    '드래그하거나 화살표 키로 이동하고 Home 키로 가운데에 맞추세요.',
  'hudChrome.mobileHudEditor.locked': '잠김',
  'hudChrome.mobileHudEditor.unlocked': '잠금 해제됨',
  'hudChrome.mobileHudEditor.lock': '잠금 레이아웃',
  'hudChrome.mobileHudEditor.unlock': '레이아웃 잠금 해제',
  'hudChrome.mobileHudEditor.sceneLabel': '미리보기 장면',
  'hudChrome.mobileHudEditor.contextLabel': '미리보기 상태',
  'hudChrome.mobileHudEditor.profileLabel': '장치 프로필',
  'hudChrome.mobileHudEditor.profilePhone': '핸드폰',
  'hudChrome.mobileHudEditor.profileTablet': '태블릿',
  'hudChrome.mobileHudEditor.save': '저장',
  'hudChrome.mobileHudEditor.cancel': '취소',
  'hudChrome.mobileHudEditor.showFailingLayout': '실패한 레이아웃 표시',
  'hudChrome.mobileHudEditor.previousFailure': '이전 실패',
  'hudChrome.mobileHudEditor.nextFailure': '다음 실패',
  'hudChrome.mobileHudEditor.runtimeFallback':
    '{profile} 레이아웃은 이 표시 영역에 맞지 않습니다. 내장된 기본값은 일시적으로 활성화됩니다.',
  'hudChrome.mobileHudEditor.storageError':
    '모바일 레이아웃을 저장할 수 없습니다. 초안이 아직 열려 있습니다.',
  'hudChrome.mobileHudEditor.invalidSave': '저장하기 전에 모든 레이아웃 오류를 수정하세요.',
  'hudChrome.mobileHudEditor.failureWithContext': '{message} ({context})',
  'hudChrome.mobileHudEditor.failureWithFixture': '{message} ({context}; {profile}; {viewport})',
  'hudChrome.mobileHudEditor.scene.world': '세계',
  'hudChrome.mobileHudEditor.scene.arenaStandard': '아레나 스탠다드',
  'hudChrome.mobileHudEditor.scene.arenaFiesta': '아레나 피에스타',
  'hudChrome.mobileHudEditor.scene.arenaYumi': '아레나 유미',
  'hudChrome.mobileHudEditor.scene.valeCupBriefing': '베일 컵 브리핑',
  'hudChrome.mobileHudEditor.scene.valeCupMatch': '베일컵 경기',
  'hudChrome.mobileHudEditor.scene.valeCupSpectator': '베일 컵 관중',
  'hudChrome.mobileHudEditor.scene.delve': '탐굴',
  'hudChrome.mobileHudEditor.context.worldBase': '세계',
  'hudChrome.mobileHudEditor.context.worldValeCupIndicator': 'Vale Cup 표시가 있는 세계',
  'hudChrome.mobileHudEditor.context.arenaStandard': '아레나 스탠다드',
  'hudChrome.mobileHudEditor.context.arenaFiestaBase': '피에스타 경기',
  'hudChrome.mobileHudEditor.context.arenaFiestaPending': '피에스타 보류중',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawn': '피에스타 부활',
  'hudChrome.mobileHudEditor.context.arenaFiestaOffer': 'Fiesta 강화 제안',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawnOffer': 'Fiesta 부활 및 강화 제안',
  'hudChrome.mobileHudEditor.context.arenaYumiBase': '유미매치',
  'hudChrome.mobileHudEditor.context.arenaYumiRespawn': '유미 부활',
  'hudChrome.mobileHudEditor.context.arenaYumiReturning': '돌아오는 유미',
  'hudChrome.mobileHudEditor.context.valeCupBriefing': '베일 컵 브리핑',
  'hudChrome.mobileHudEditor.context.valeCupMatch': '베일 컵 경기',
  'hudChrome.mobileHudEditor.context.valeCupMatchCharge': '베일컵 차지샷',
  'hudChrome.mobileHudEditor.context.valeCupSpectatorBetting': 'Vale Cup 관중 베팅',
  'hudChrome.mobileHudEditor.context.instanceDelve': '탐굴',
  'hudChrome.mobileHudEditor.surface.actionA1': '액션 A1',
  'hudChrome.mobileHudEditor.surface.actionA2': '액션 A2',
  'hudChrome.mobileHudEditor.surface.actionA3': '액션 A3',
  'hudChrome.mobileHudEditor.surface.actionA4': '액션 A4',
  'hudChrome.mobileHudEditor.surface.actionA5': '액션 A5',
  'hudChrome.mobileHudEditor.surface.actionAttack': '공격',
  'hudChrome.mobileHudEditor.surface.actionTarget': '목표',
  'hudChrome.mobileHudEditor.surface.actionJumpUse': '점프 또는 사용',
  'hudChrome.mobileHudEditor.surface.actionPage': '작업 페이지 스위치',
  'hudChrome.mobileHudEditor.surface.controlMovement': '움직임',
  'hudChrome.mobileHudEditor.surface.controlView': '시점',
  'hudChrome.mobileHudEditor.surface.utilityConsumables': '소모품',
  'hudChrome.mobileHudEditor.surface.petCommands': '애완동물 명령',
  'hudChrome.mobileHudEditor.surface.party': '파티',
  'hudChrome.mobileHudEditor.surface.menuTop': '톱 메뉴',
  'hudChrome.mobileHudEditor.surface.minimapCluster': '미니맵',
  'hudChrome.mobileHudEditor.surface.frameTarget': '대상 프레임',
  'hudChrome.mobileHudEditor.surface.framePlayer': '플레이어 프레임',
  'hudChrome.mobileHudEditor.surface.playerBuffs': '플레이어 버프',
  'hudChrome.mobileHudEditor.surface.playerDebuffs': '플레이어 디버프',
  'hudChrome.mobileHudEditor.surface.statusArenaGeneric': '투기장 현황',
  'hudChrome.mobileHudEditor.surface.statusFiestaScore': '피에스타 점수',
  'hudChrome.mobileHudEditor.surface.statusFiestaPending': 'Fiesta 보류 상태',
  'hudChrome.mobileHudEditor.surface.protectedFiestaRespawn': 'Fiesta 부활 프롬프트',
  'hudChrome.mobileHudEditor.surface.protectedFiestaOffer': 'Fiesta 강화 제안',
  'hudChrome.mobileHudEditor.surface.statusYumi': '유미상태',
  'hudChrome.mobileHudEditor.surface.protectedYumiRespawn': '유미 부활 프롬프트',
  'hudChrome.mobileHudEditor.surface.statusValeCupIndicator': '베일 컵 표시기',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBriefing': '베일 컵 브리핑',
  'hudChrome.mobileHudEditor.surface.statusValeCupMatch': '베일 컵 경기 상황',
  'hudChrome.mobileHudEditor.surface.statusValeCupCharge': '베일컵 슛 차지',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBetting': 'Vale Cup 베팅 패널',
  'hudChrome.mobileHudEditor.surface.trackerDelve': '탐굴 추적기',
  'hudChrome.mobileHudEditor.surface.protectedCenterMessage': '센터 메시지',
  'hudChrome.mobileHudEditor.control.nudgeUp': '위로 이동',
  'hudChrome.mobileHudEditor.control.nudgeDown': '아래로 이동',
  'hudChrome.mobileHudEditor.control.nudgeLeft': '왼쪽으로 이동',
  'hudChrome.mobileHudEditor.control.nudgeRight': '오른쪽으로 이동',
  'hudChrome.mobileHudEditor.control.decreaseScale': '크기 줄이기',
  'hudChrome.mobileHudEditor.control.increaseScale': '크기 늘리기',
  'hudChrome.mobileHudEditor.control.orientation': '정위',
  'hudChrome.mobileHudEditor.control.horizontal': '수평의',
  'hudChrome.mobileHudEditor.control.vertical': '수직의',
  'hudChrome.mobileHudEditor.control.order': '순서',
  'hudChrome.mobileHudEditor.control.normalOrder': '기본 순서',
  'hudChrome.mobileHudEditor.control.reverseOrder': '역순',
  'hudChrome.mobileHudEditor.control.openingDirection': '열리는 방향',
  'hudChrome.mobileHudEditor.control.openLeft': '왼쪽으로 펼치기',
  'hudChrome.mobileHudEditor.control.openRight': '오른쪽으로 펼치기',
  'hudChrome.mobileHudEditor.control.openUp': '위로 펼치기',
  'hudChrome.mobileHudEditor.control.openDown': '아래로 펼치기',
  'hudChrome.mobileHudEditor.control.resetSelected': '선택 재설정',
  'hudChrome.mobileHudEditor.control.resetAll': '모두 재설정',
  'hudChrome.mobileHudEditor.status.noSelection': '편집하려면 컨트롤을 선택하세요.',
  'hudChrome.mobileHudEditor.status.selected': '선택됨: {surface}',
  'hudChrome.mobileHudEditor.status.scale': '크기: {scale}',
  'hudChrome.mobileHudEditor.status.valid': '레이아웃을 저장할 준비가 되었습니다.',
  'hudChrome.mobileHudEditor.status.invalid': '레이아웃에 {count}개의 차단 오류가 있습니다.',
  'hudChrome.mobileHudEditor.status.failurePosition': '{count}개 중 실패 {index}개',
  'hudChrome.mobileHudEditor.failure.invalidPlacement': '{surface}에 잘못된 게재위치가 있습니다.',
  'hudChrome.mobileHudEditor.failure.unsupportedCapability':
    '{surface}는 지원되지 않는 레이아웃 옵션을 사용합니다.',
  'hudChrome.mobileHudEditor.failure.scaleOutOfRange': '{surface} 크기가 허용 범위를 벗어났습니다.',
  'hudChrome.mobileHudEditor.failure.targetTooSmall':
    '{surface}은(는) 너무 작아서 안전하게 사용할 수 없습니다.',
  'hudChrome.mobileHudEditor.failure.outOfBounds': '{surface}은(는) 안전 영역 밖에 있습니다.',
  'hudChrome.mobileHudEditor.failure.overlap': '{surface}이(가) {other}과(와) 겹칩니다.',
  'hudChrome.mobileHudEditor.failure.viewIntrusion': '{surface}는 뷰 영역과 겹칩니다.',
  'hudChrome.mobileHudEditor.failure.protectedOverlap': '{surface}가 {other}와 겹칩니다.',
  'hudChrome.mobileHudEditor.discard.title': '레이아웃 변경사항을 삭제하시겠습니까?',
  'hudChrome.mobileHudEditor.discard.body': '저장되지 않은 모바일 레이아웃 변경사항은 손실됩니다.',
  'hudChrome.mobileHudEditor.discard.confirm': '변경사항 취소',
  'hudChrome.mobileHudEditor.discard.continueEditing': '계속 편집',
