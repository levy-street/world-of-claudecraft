...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'heroicShop.tuneConfirmBody':
    '이 {item} 개체를 죽지 않는 파편 {fragments}개와 영웅 징표 {marks}개로 조율하시겠습니까? 두 번 중 더 좋은 결과를 유지하며, 위력은 낮아지지 않지만 그대로일 수 있습니다.',
  'hudChrome.finder.raidSharedDrop':
    '마지막 시체에 공격대가 함께 주사위를 굴릴 절차 생성 아이템 한 개가 추가됩니다.',
  'hudChrome.finder.raidForgedLegendary':
    '영웅 전설 위력은 공격대 제련 상태이며, 설정된 수치 범위의 상위 절반이 보장됩니다.',
  'itemUi.lootRoll.needUnavailable':
    '현재 직업으로 이 아이템을 착용할 수 없어 필요 주사위를 선택할 수 없습니다.',
  ...
  'hudChrome.bags.itemAriaProcedural': '{item}, {rarity}, 아이템 레벨 {level}, 수량 {count}',
  'hudChrome.bags.itemAriaProceduralMasterwork':
    '{item}, {rarity}, 아이템 레벨 {level}, 수량 {count}, 걸작',
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}, {rarity}, 아이템 레벨 {level}, 수량 {count}, 마법부여된 사본',
  'hudChrome.bags.itemAriaProceduralSigned':
    '{item}, {rarity}, 아이템 레벨 {level}, 수량 {count}, 제작자 서명 사본',
  'hudChrome.bags.itemAriaProceduralBound':
    '{item}, {rarity}, 아이템 레벨 {level}, 수량 {count}, 귀속 사본',
  'itemUi.stats.weaponMin': '최소 무기 피해',
  'itemUi.stats.weaponMax': '최대 무기 피해',
  'itemUi.stats.weaponDps': '초당 무기 피해',
  'itemUi.stats.healthOnKill': '처치 시 생명력',
  'itemUi.stats.manaOnKill': '처치 시 마나',
  'itemUi.stats.blockValue': '방패 막기 수치',
  'itemUi.procedural.rollRangeAria': '가능한 수치 범위: {min}~{max}',
  'itemUi.procedural.advancedDetailsHint': '가능한 수치 범위를 보려면 {key} 키를 누르세요.',
  'itemUi.procedural.powerRollPercent': '능력 변동값: {value}%',
  'itemUi.procedural.powerRollMilliseconds': '능력 변동값: {value} ms',
  'itemUi.procedural.powerRollResource': '능력 변동값: 자원 {value}',
  'itemUi.procedural.powerRollNumber': '능력 변동값: {value}',
  'itemUi.procedural.legendaryPower': '전설 능력',
  'itemUi.procedural.legendaryLimit': '고유 장착: 전설 능력 {count}개',
  'itemUi.procedural.rarity.common': '일반',
  'itemUi.procedural.rarity.magic': '마법',
  'itemUi.procedural.rarity.rare': '희귀',
  'itemUi.procedural.rarity.epic': '영웅',
  'itemUi.procedural.rarity.legendary': '전설',
  'itemUi.procedural.rarity.mythic': '신화',
  'itemUi.procedural.nameFragment.mighty': '강력한',
  'itemUi.procedural.nameFragment.deft': '날렵한',
  'itemUi.procedural.nameFragment.stalwart': '굳건한',
  'itemUi.procedural.nameFragment.sages': '현자의',
  'itemUi.procedural.nameFragment.spiritual': '영적인',
  'itemUi.procedural.nameFragment.of_focus': '집중의',
  'itemUi.procedural.nameFragment.of_striking': '일격의',
  'itemUi.procedural.nameFragment.of_alacrity': '기민함의',
  'itemUi.procedural.nameFragment.of_precision': '정밀함의',
  'itemUi.procedural.nameFragment.warded': '수호받는',
  'itemUi.procedural.nameFragment.of_reaping': '수확의',
  'itemUi.procedural.nameFragment.of_remembrance': '기억의',
  'itemUi.procedural.rareWord.ashen': '잿빛',
  'itemUi.procedural.rareWord.blackfen': '검은늪',
  'itemUi.procedural.rareWord.doom': '파멸',
  'itemUi.procedural.rareWord.grave': '무덤',
  'itemUi.procedural.rareWord.mire': '수렁',
  'itemUi.procedural.rareWord.storm': '폭풍',
  'itemUi.procedural.rareWord.thorn': '가시',
  'itemUi.procedural.rareWord.wyrm': '용',
  'itemUi.procedural.rareWord.bite': '송곳니',
  'itemUi.procedural.rareWord.brand': '낙인',
  'itemUi.procedural.rareWord.promise': '약속',
  'itemUi.procedural.rareWord.thread': '실',
  'itemUi.procedural.rareWord.vigil': '파수',
  'itemUi.procedural.rareWord.ward': '수호',
  'itemUi.procedural.rareWord.whisper': '속삭임',
  'itemUi.procedural.rareWord.oath': '서약',
  'itemUi.procedural.legendary.crown_last_pyre.name': '최후 장작불의 왕관',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    '세 번째 Cinderbolt마다 대상 주변의 적들을 불태웁니다.',
  'itemUi.procedural.legendary.greyjaws_edge.name': '회색턱의 칼날',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    '세 번째 무기 공격마다 대상에게 출혈을 일으키고 주 자원을 조금 회복합니다.',
  'itemUi.procedural.legendary.hushwood_longbow.name': '침묵숲 장궁',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Long Draw 또는 Fell Shot이 대상을 잠시 침묵시킬 수 있습니다.',
  'itemUi.procedural.legendary.nightglass_fang.name': '밤유리 송곳니',
  'itemUi.procedural.legendary.nightglass_fang.description':
    '적을 처치하면 잠시 가속이 증가합니다.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': '이솔레이의 파수',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    '치유가 치명타로 적중하면 잠시 회복의 지대를 만듭니다.',
  'itemUi.procedural.legendary.stormwake_idol.name': '폭풍의 여운 우상',
  'itemUi.procedural.legendary.stormwake_idol.description':
    '네 번째 Arc Bolt마다 주변 적들에게 연쇄됩니다.',
  'itemUi.procedural.legendary.ashbinders_seal.name': '잿불결속자의 인장',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    '네 번째 Gloom Bolt마다 대상에게 추가 암흑 피해를 받는 징표를 남깁니다.',
  'itemUi.procedural.legendary.dawnward_signet.name': '새벽수호 인장',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Mending Light가 치유량의 일부만큼 대상을 보호막으로 감쌉니다.',
  'itemUi.procedural.legendary.feral_moonclasp.name': '야성의 달고리',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    '세 번째 Lunar Tempest마다 주 자원을 회복합니다.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': '아홉 번째 울림의 종',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    '두 번째 공격 주문마다 대상 주변에 종소리가 울립니다.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': '훔친 시간의 어깨망토',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    '생명력이 35% 아래로 떨어지면 잠시 방어 수호막을 얻습니다.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': '끊이지 않는 길의 장화',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    '15야드를 이동하면 잠시 이동 속도가 증가합니다.',
  'entities.items.ashwood_staff.name': '물푸레나무 지팡이',
  'entities.items.gravecaller_cloth_handwraps.name': '무덤소환사 천 손목싸개',
  'entities.items.gravecaller_cloth_hood.name': '무덤소환사 천 두건',
  'entities.items.gravecaller_cloth_leggings.name': '무덤소환사 천 다리보호구',
  'entities.items.gravecaller_cloth_mantle.name': '무덤소환사 천 어깨덧옷',
  'entities.items.gravecaller_cloth_raiment.name': '무덤소환사 천 예복',
  'entities.items.gravecaller_cloth_sash.name': '무덤소환사 천 허리띠',
  'entities.items.gravecaller_cloth_slippers.name': '무덤소환사 천 덧신',
  'entities.items.gravecaller_focus.name': '무덤소환사 마력집중기',
  'entities.items.gravecaller_pendant.name': '무덤소환사 목걸이',
  'entities.items.gravecaller_ring.name': '무덤소환사 반지',
  'entities.items.gravecaller_wand.name': '무덤소환사 마법봉',
  'entities.items.iron_broadsword.name': '철제 대검',
  'entities.items.iron_flanged_mace.name': '철제 플랜지 철퇴',
  'entities.items.mirefen_dirk.name': '수렁늪 단검',
  'entities.items.mirefen_hunting_bow.name': '수렁늪 사냥활',
  'entities.items.mirefen_leather_belt.name': '수렁늪 가죽 허리띠',
  'entities.items.mirefen_leather_boots.name': '수렁늪 가죽 장화',
  'entities.items.mirefen_leather_gloves.name': '수렁늪 가죽 장갑',
  'entities.items.mirefen_leather_hood.name': '수렁늪 가죽 두건',
  'entities.items.mirefen_leather_jerkin.name': '수렁늪 가죽 조끼',
  'entities.items.mirefen_leather_leggings.name': '수렁늪 가죽 다리보호구',
  'entities.items.mirefen_leather_shoulderguards.name': '수렁늪 가죽 어깨보호대',
  'entities.items.thornpeak_bulwark.name': '가시봉우리 방벽',
  'entities.items.thornpeak_crossbow.name': '가시봉우리 석궁',
  'entities.items.thornpeak_mail_chest.name': '가시봉우리 사슬 흉갑',
  'entities.items.thornpeak_mail_gauntlets.name': '가시봉우리 사슬 건틀릿',
  'entities.items.thornpeak_mail_girdle.name': '가시봉우리 사슬 허리띠',
  'entities.items.thornpeak_mail_helm.name': '가시봉우리 사슬 투구',
  'entities.items.thornpeak_mail_legguards.name': '가시봉우리 사슬 다리보호대',
  'entities.items.thornpeak_mail_pauldrons.name': '가시봉우리 사슬 견갑',
  'entities.items.thornpeak_mail_sabatons.name': '가시봉우리 사슬 철갑장화',
  'entities.items.thornpeak_polearm.name': '가시봉우리 장창',
  'entities.items.thornpeak_war_axe.name': '가시봉우리 전투도끼',
