...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  "hud.mounts.noWallet": "연결된 지갑에 최소 {amount} $WOC(공급량의 0.1%)를 보유하면 첫 여행 탈것을 얻습니다.",
  ...
  "hud.mounts.mintHint": "이 탈것의 거래 가능한 증서를 발행하세요. 금에 팔아 보유자가 아닌 이도 얻게 하세요.",
  ...
  "hud.wager.inviteGold": "{name}님이 내기 경주를 엽니다. 참가하려면 {money}을(를) 거세요. 받으시겠습니까?",
  "hud.wager.inviteCharter": "{name}님이 내기 경주를 엽니다. {money} + 탈것 증서를 거세요. 받으시겠습니까?",
  ...
  "entities.npcs.skytrial_master.greeting": "하늘은 감히 걸으려는 이가 드문 길입니다, {className}. 그것을 얻으면, 하늘이 그대를 실어 나릅니다.",
  "entities.quests.q_skyward_first_flight.title": "첫 비행",
  "entities.quests.q_skyward_first_flight.text": "땅 위에서는 날개 달린 탈것을 곧잘 다루는군요, {playerName}. 이제 하늘로 올리세요. 골짜기 하늘 시련을 비행하십시오: 한 바퀴 도는 길에 여덟 개의 고리. 아직 시간을 쫓지는 마세요. 그저 떠 있으면서 모든 고리를 꿰십시오.",
  "entities.quests.q_skyward_first_flight.completion": "떨어지지 않았군요. 첫 바퀴에 대부분이 해내는 것보다 더한 일입니다. 하늘은 계속 돌아오는 자를 기억합니다.",
  "entities.quests.q_skyward_first_flight.objectives.0.label": "골짜기 하늘 시련 완료",
  "entities.quests.q_skyward_time_trial.title": "시간을 이겨라",
  "entities.quests.q_skyward_time_trial.text": "이제 의지를 담아 해내십시오. 골짜기 하늘 시련을 다시 비행하되, {playerName}, 모래가 다하기 전에 끝내세요. 모든 고리를 깔끔한 선으로, 허비되는 공기 없이. 당황이 아니라 정밀함으로.",
  "entities.quests.q_skyward_time_trial.completion": "고리에서 고리로, 깔끔한 선이었습니다. 그대는 더 이상 하늘을 타고 있는 것이 아닙니다. 하늘을 날고 있습니다.",
  ...
  "entities.quests.q_skyward_ascendant.text": "한 가지 시련이 남았습니다, {playerName}: 골짜기 순환로. 긴 고리를 세 바퀴, 기준 시간 내에 비행하십시오. 운이 아니라 오직 기량으로. 그것을 통달하면 가장자리에서 가장자리까지 드넓은 하늘이 그대의 것입니다.",
  "entities.quests.q_skyward_ascendant.completion": "하늘로 올라, 꺾이지 않았습니다. 이제 하늘은 그대의 것입니다, {playerName}. 이 증서를 받으십시오. 사지 않고 얻어 낸 창공의 탈것이, 그대가 향하려는 어디로든 실어 나를 것입니다.",
