...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberfall_edge.name': '잿불낙하의 칼날',
  'entities.items.crown_of_the_thornpeak_scourge.name': '가시봉우리 재앙의 왕관',
  'entities.items.thunzharrs_stormheart.name': '툰자르의 폭풍심장',
  'entities.items.sealed_vault_signet_crypt.name': '공허한 지하묘의 봉인 인장',
  'entities.items.sealed_vault_signet_bastion.name': '가라앉은 요새의 봉인 인장',
  'entities.items.sealed_vault_signet_temple.name': '물에 잠긴 신전의 봉인 인장',
  'entities.items.sealed_vault_signet_sanctum.name': '무덤벌레 성소의 봉인 인장',
