...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.professions.harvestBodyFamilies': '채집은 노드에서 끝나지 않는다. 쓰러뜨린 짐승 상당수는 시체에서 곧바로 한 번씩, 선착순으로 채집할 수 있어 가죽과 송곳니, 발톱, 엄니, 뿔, 아가미, 비단실, 독, 천, 고기가 평범한 전리품과 나란히 나온다. 한 번 누르면 둘이 함께 열린다. 짐승이 쓸 만한 부위를 둘 이상 지녔다면 선택은 당신 몫이다. 그 시체가 내줄 수 있는 것을 전부 가져가거나, 더 적은 부위에 집중해 실제로 얻는 것을 눈에 띄게 더 좋은 등급으로 가져가거나.\n\n표본이 나오는 계열에서 희귀 이상 판정이 뜨면 평범한 산출물 위에 서명된 완벽한 표본(Pristine Hide, Pristine Silk, Pristine Venom Gland, Pristine Claw, Prime Cut)이 하나 더 주어지고, 업적의 서에 A Perfect Specimen이 기록된다. 채집에는 훈련이 필요 없어 어떤 캐릭터든 할 수 있으며, 지니고 있는 채집 도구는 어느 전문직의 것이든 최상급 재료 판정에 반영된다.',
  ...
  'entities.items.forgefathers_ember.name': "대장장이의 불씨",
  'entities.quests.q_forgefathers_requiem.title': "대장장이의 진혼곡",
  'entities.quests.q_forgefathers_requiem.text': "발쿨은 심장에 마지막 샘의 불씨를 품고 있었어. 그에게서 불씨를 되찾아 내게 가져와. 무기 제작 숙련도가 125라면 화로파괴자를 직접 벼리는 법을 배울 수 있어. 이 임무를 진행하는 동안에는 어느 난이도에서든 그를 쓰러뜨리면 불씨를 얻을 수 있어.",
  'entities.quests.q_forgefathers_requiem.completion': "아직 노래하고 있구나. 불씨는 간직해. 네 망치에는 그 목소리가 필요하니까. 화로파괴자를 단 한 번 벼리는 법을 가르쳐 주었어. 불씨와 그 지식은 제작에 성공할 때만 소모돼.",
  'entities.quests.q_forgefathers_requiem.objectives.0.label': "대장장이의 불씨 회수",
  'entities.quests.q_requiem_at_the_forge.title': "대장간의 진혼곡",
  'entities.quests.q_requiem_at_the_forge.text': "불씨, 마지막 불꽃의 핵 15개, 상급 오스뮴 광석과 상급 고산솔 통나무를 대장간으로 가져가. 화로파괴자를 직접 벼린 다음, 가방에 넣거나 장착하고 내게 돌아와. 망치는 네가 간직하며 너에게 귀속돼. 이 방법으로 만들 수 있는 망치는 하나뿐이야.",
  'entities.quests.q_requiem_at_the_forge.completion': "샘의 목소리가 쇠를 타고 울려 퍼지는구나. 발쿨이 사슬로 묶었던 것을 네 손이 풀어 주었어. 화로파괴자를 잘 간직하렴, 대장장이여.",
  'entities.quests.q_requiem_at_the_forge.objectives.0.label': "화로파괴자를 제작하여 소지",
