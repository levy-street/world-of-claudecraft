...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'wallet.guardianTierTitle': '{tier} 유동성 수호자',
  'wallet.guardianTiers.wader.name': '물결 걷는 자',
  'wallet.guardianTiers.wader.title': '얕은 여울을 걷는 자',
  'wallet.guardianTiers.tidewatcher.name': '조수 감시자',
  'wallet.guardianTiers.tidewatcher.title': '밀물의 감시자',
  'wallet.guardianTiers.currentkeeper.name': '해류 지킴이',
  'wallet.guardianTiers.currentkeeper.title': '해류의 관리인',
  'wallet.guardianTiers.stormwarden.name': '폭풍 수호대',
  'wallet.guardianTiers.stormwarden.title': '폭풍의 파수꾼',
  'wallet.guardianTiers.abyssguard.name': '심연 경비병',
  'wallet.guardianTiers.abyssguard.title': '심연의 보초',
  ...
  'hudChrome.wocSeason.title': '$WOC 보상 시즌',
  'hudChrome.wocSeason.subtitle': '트레저리 자금으로 상위 플레이어에게 지급',
  'hudChrome.wocSeason.close': '닫기',
  'hudChrome.wocSeason.none': '현재 진행 중인 보상 시즌이 없습니다.',
  'hudChrome.wocSeason.noneHint': '아레나 레이크와 바이백이 풀에 자금을 공급하기 시작하면 시즌이 열립니다.',
  'hudChrome.wocSeason.statusActive': '진행 중',
  'hudChrome.wocSeason.statusEnded': '종료됨',
  'hudChrome.wocSeason.ended': '이번 시즌이 종료되었습니다.',
  'hudChrome.wocSeason.openEnded': '기한 없음',
  'hudChrome.wocSeason.poolLabel': '사용 가능한 보상 풀',
  'hudChrome.wocSeason.emittedLabel': '지금까지 풀의 {pct}% 지급됨',
  'hudChrome.wocSeason.sinkLabel': '자금 조달됨',
  'hudChrome.wocSeason.invariant': '지급액은 시즌 수입을 초과할 수 없습니다. 매수 > 매도, 온체인에서 강제됩니다.',
  'hudChrome.wocSeason.standingsTitle': '예상 상위 획득자',
  'hudChrome.wocSeason.colPlayer': '플레이어',
  'hudChrome.wocSeason.colRating': '레이팅',
  'hudChrome.wocSeason.colReward': '보상($WOC)',
  'hudChrome.wocSeason.projectedNote': '현재 풀과 아레나 랭킹 기준 예측이며, 최종 지급은 시즌 종료 시 확정됩니다.',
};
