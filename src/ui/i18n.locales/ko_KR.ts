...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  'editor.vfx.raid': '공격대 연습 (사망하지 않음)',
  'editor.vfx.title': '효과 스튜디오',
  'editor.vfx.library': '능력 목록',
  'editor.vfx.inspector': '효과 설정',
  'editor.vfx.search': '능력 검색',
  'editor.vfx.class': '직업',
  'editor.vfx.scene': '전투 장면',
  'editor.vfx.sandbox': '훈련 파티',
  'editor.vfx.duel': '플레이어 결투',
  'editor.vfx.loading': '게임 세계 준비 중...',
  'editor.vfx.ready': '게임 엔진 실행 중',
  'editor.vfx.failed': '스튜디오를 시작하지 못했습니다. 새로고침해 주세요.',
  'editor.vfx.cast': '능력 시전',
  'editor.vfx.target': '대상',
  'editor.vfx.pause': '정지 화면',
  'editor.vfx.resume': '계속',
  'editor.vfx.step': '한 단계',
  'editor.vfx.reset': '장면 초기화',
  'editor.vfx.replay': '명령 재생',
  'editor.vfx.recover': '자원 회복',
  'editor.vfx.move': '달리기',
  'editor.vfx.stop': '정지',
  'editor.vfx.speed': '재생 속도',
  'editor.vfx.audio': '세계 음향',
  'editor.vfx.tint': '본체 색상',
  'editor.vfx.accent': '강조 색상',
  'editor.vfx.power': '강도',
  'editor.vfx.sparks': '불꽃',
  'editor.vfx.apply': '초안 적용',
  'editor.vfx.original': '원본 사용',
  'editor.vfx.export': '초안 내보내기',
  'editor.vfx.import': '초안 가져오기',
  'editor.vfx.exportTake': '세션 내보내기',
  'editor.vfx.invalid': '초안이 잘못되었거나 지원하지 않는 능력이 포함되어 있습니다.',
  'editor.vfx.applied': '초안이 적용되었습니다',
  'editor.vfx.noSpec': '이 능력은 별도의 효과 시스템을 사용합니다.',
  'editor.vfx.castTime': '시전 시간',
  'editor.vfx.cooldown': '재사용 대기시간',
  'editor.vfx.seconds': '{value}초',
  'editor.vfx.timeline': '전투 타임라인',
  'editor.vfx.empty': '능력을 시전하면 기록을 시작합니다.',
  'editor.vfx.current': '시간: {value}초',
  'editor.vfx.events': '이벤트 {count}개',
  'editor.vfx.controls': '카메라 조작',
  'editor.vfx.orbitLeft': '왼쪽으로 회전',
  'editor.vfx.orbitRight': '오른쪽으로 회전',
  'editor.vfx.closer': '확대',
  'editor.vfx.farther': '축소',
  'editor.vfx.hide': '패널 숨기기',
  'editor.vfx.show': '패널 표시',
  'editor.vfx.status': '활성 효과',
  'editor.vfx.help':
    '화면을 드래그해 회전하고 스크롤해 확대하거나 축소하세요. 정지 화면은 현재 프레임을 유지합니다.',
  'editor.vfx.note':
    '시전에는 일반 전투 규칙이 적용됩니다. 재생은 명령을 반복하며 장식용 무작위 효과는 달라질 수 있습니다.',
  'editor.vfx.castFailed':
    '시전이 거부되었습니다. 대상, 거리, 자원과 재사용 대기시간을 확인하세요.',
  'editor.vfx.draftNote': '변경 사항은 현재 세션에만 유지됩니다. 저장하려면 내보내세요.',
  'editor.vfx.snapshot': '프레임 캡처',
  ...
  'guide.settingsPage.ifPartyHealthText':
    '파티 막대에 무엇을 적을지 정합니다. 표시하지 않음, 백분율, 현재 생명력, 또는 현재와 최대치 중에서 고릅니다.',
  ...
  'guide.settingsPage.keybindsBody':
    '그 패널에서 키 목록은 절반에 지나지 않습니다. 그 위에는 마우스가 게임을 어떻게 조종할지 정하는 스위치들이 놓여 있습니다. 마우스 카메라, 회전하는 동안 커서를 고정할지, 클릭 이동과 그것을 실행할 마우스 버튼, 공격 이동, 왼손잡이용 터치 배치, 그리고 채팅 비속어 필터까지 있습니다.',
  ...
  'editor.vfx.artView': '감상 모드',
  'editor.vfx.exitArtView': '감상 모드 종료',
  'editor.vfx.previous': '이전 능력',
  'editor.vfx.next': '다음 능력',
  'editor.vfx.repeat': '반복 시전',
  'editor.vfx.favourite': '즐겨찾기에 추가',
  'editor.vfx.unfavourite': '즐겨찾기에서 제거',
  'editor.vfx.favourites': '즐겨찾기만 표시',
  'editor.vfx.saved': '저장됨',
  'editor.vfx.updating': '미리보기 업데이트 중...',
  'editor.vfx.shortcuts':
    'Space: 시전. [ / ]: 이전 / 다음 능력. R: 반복 시전. F: 즐겨찾기. A: 감상 모드.',
  'editor.vfx.buildTools': '특성, 장면 및 조명',
  'editor.vfx.noTalent': '선택한 특성 없음',
  'editor.vfx.talentLevel': '레벨 {level}',
  'editor.vfx.seed': '장면 시드',
  'editor.vfx.graphics': '그래픽 품질',
  'editor.vfx.environment': '미리보기 환경',
  'editor.vfx.studioEnvironment': '스튜디오 무대',
  'editor.vfx.worldEnvironment': '세계 풍경',
  'editor.vfx.lighting': '무대 조명',
  'editor.vfx.neutralLighting': '중립',
  'editor.vfx.brightLighting': '밝게',
  'editor.vfx.savedGraphics': '게임 설정 사용',
  'editor.vfx.medium': '중간',
  'editor.vfx.ultra': '울트라',
  'editor.vfx.cinematic': '시네마틱 (최고 디테일)',
  'editor.vfx.reduceMotion': '움직임 줄이기',
  'editor.vfx.cinematicResponse': '영화 같은 카메라 연출',
  'editor.vfx.darkLighting': '어둡게',
  'editor.vfx.low': '낮음',
  'editor.vfx.high': '높음',
};
