...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.character.tabs.equipment': '장비',
  'hudChrome.character.tabs.overview': '개요',
  'hudChrome.character.balances.claudium': '클라우디움',
  'hudChrome.character.bagSocket': '가방 슬롯: {name}',
  'hudChrome.character.sections.attributes': '능력치',
  'hudChrome.character.sections.combat': '전투',
  'hudChrome.character.sections.defense': '방어',
  'hudChrome.character.spec.choose': '선택',
  'hudChrome.character.spec.change': '변경',
  'hudChrome.character.bags.openFull': '가방 창 열기',
  'hudChrome.character.bags.container': '가방 {n}',
  'hudChrome.character.bags.emptySpaces': '빈 공간',
  'hudChrome.character.bags.emptySummary': '+{count}개 빈 공간',
  'character.sortBy': '정렬',
