...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.errors.tradeBusy': '그 플레이어는 이미 거래 중입니다.',
  'hud.errors.tradeUsage': '누구와 거래하시겠습니까? 사용법: /trade <이름>',
  'hud.errors.claudiumTradeOff': 'Claudium 거래를 현재 이용할 수 없습니다.',
  'hud.errors.wocTradeOff': 'WOC 거래를 현재 이용할 수 없습니다.',
  'hud.errors.wocTradeLink': 'WOC를 거래하려면 지갑을 연결하세요.',
  'hud.errors.wocTradePartnerLink': '거래 상대방이 지갑을 연결하지 않았습니다.',
  'hud.errors.wocTradeOneSide': '거래에서 WOC는 한쪽만 제안할 수 있습니다.',
  'hud.errors.tradeSettleTimeout':
    '거래가 취소되었습니다: 결제 대기 시간이 만료되어 물품이 반환되었습니다.',
  'hud.errors.tradeSettleCancelled': '거래가 취소되었습니다. 물품이 반환되었습니다.',
  'hud.errors.tradeSettleUnavailable': '거래를 정산할 수 없습니다. 물품이 반환되었습니다.',
  ...
  'hud.logs.tradeDeclined': '{name}님이 거래 요청을 거절했습니다.',
  ...
  'hud.trade.cancel': '취소',
  'hud.trade.settlingTitle': '거래 정산 중...',
  'hud.trade.legYourWoc': '내 WOC 결제',
  'hud.trade.legTheirWoc': '상대방의 WOC 결제',
  'hud.trade.statusPending': '대기 중',
  'hud.trade.wocPayPrompt': '연결된 지갑에서 {amount} WOC를 보내 거래를 완료하세요.',
  'hud.trade.openInWallet': '지갑에서 열기',
  'hud.trade.copyLink': '결제 링크 복사',
  'hud.trade.copiedLink': '결제 링크가 복사되었습니다.',
  'hud.trade.instanceSignedBy': '서명자: {name}',
  'hud.trade.instanceUnique': '고유한 사본',
  ...
  'itemUi.market.sortLabel': '정렬',
  'itemUi.market.sortNewest': '최신순',
  'itemUi.market.sortPrice': '가격순',
  'itemUi.market.sortTimeLeft': '남은 시간순',
  'itemUi.market.timeLeft': '{time} 남음',
  'itemUi.market.yourBidBadge': '내 입찰',
  'itemUi.market.currentBidLabel': '입찰가:',
  'itemUi.market.noBidsYet': '아직 입찰 없음',
  'itemUi.market.minNextBid': '최소 입찰가 {money}',
  'itemUi.market.buyoutLabel': '즉시구매가 {money}',
  'itemUi.market.auctionBadge': '경매',
  'itemUi.market.leadingBid': '현재 최고 입찰자입니다',
  'itemUi.market.bidInputAria': '{item}에 대한 입찰 금액',
  'itemUi.market.bidButton': '입찰',
  'itemUi.market.bidAria': '{item}에 입찰',
  'itemUi.market.buyoutButton': '즉시구매',
  'itemUi.market.buyoutAria': '{item}을(를) {price}에 즉시구매',
  'itemUi.market.buyQuantityAria': '구매할 {item} 수량',
  'itemUi.market.listingTypeLabel': '등록 방식',
  'itemUi.market.listingTypeFixed': '정가 판매',
  'itemUi.market.listingTypeAuction': '경매',
  'itemUi.market.durationLabel': '등록 기간',
  'itemUi.market.durationOption': '{hours}시간',
  'itemUi.market.startingBidLabel': '시작 입찰가',
  'itemUi.market.buyoutOptionalLabel': '즉시구매가 (선택)',
  'itemUi.market.totalLabel': '합계',
  'itemUi.market.depositPreviewLabel': '등록 보증금',
  'itemUi.market.cancelConfirmTitle': '등록 회수',
  'itemUi.market.cancelConfirmBody':
    '{item}을(를) 시장에서 회수하시겠습니까? 보증금 {money}이(가) 몰수됩니다.',
  'itemUi.market.cancelConfirmBodyNoDeposit': '{item}을(를) 시장에서 회수하시겠습니까?',
  'itemUi.market.cancelConfirmDismiss': '취소',
  'itemUi.market.outbidToast':
    '{item}에 대한 입찰이 다른 사람에게 밀렸습니다. {money}이(가) 수거함으로 반환되었습니다.',
  'itemUi.market.wonToast': '{item} 경매에서 낙찰되었습니다! 상인에게서 수령하세요.',
  'itemUi.market.soldToast': '{item}이(가) {money}에 판매되었습니다. 상인에게서 수령하세요.',
  'itemUi.market.expiredToast':
    '{item} 등록이 판매되지 않고 만료되었습니다. 상인에게서 수령하세요.',
  'itemUi.market.denomLabel': '통화',
  'itemUi.market.denomGold': '골드',
  'itemUi.market.auctionGoldOnly': '입찰은 골드로만 가능합니다.',
  'itemUi.market.claudiumPriceEach': '개당 가격(Claudium)',
  'itemUi.market.wocPriceLot': '전체 가격(WOC)',
  'itemUi.market.claudiumEach': '개당 {amount} Claudium',
  'itemUi.market.claudiumMinError': '가격은 최소 1 Claudium 이상이어야 합니다.',
  'itemUi.market.awaitingPayment': '결제 대기 중',
  'itemUi.market.buyExternalTitle': '구매 확인',
  'itemUi.market.buyClaudiumConfirmBody':
    '{item}을(를) {amount} Claudium에 구매하시겠습니까? 결제는 Claudium 잔액에서 이루어집니다.',
  'itemUi.market.buyWocConfirmBody':
    '{item}을(를) {amount} WOC에 구매하시겠습니까? 연결된 지갑에서 결제하며, 입금이 확인되면 물품이 전달됩니다.',
  'itemUi.market.buyClaudiumAria': '{item}을(를) Claudium으로 구매',
  'itemUi.market.buyWocAria': '{item}을(를) WOC로 구매',
  'itemUi.market.pendingClaudium': '{item} 구매를 처리하고 있습니다.',
  'itemUi.market.pendingPreparing': '{item}의 결제 요청을 준비하고 있습니다.',
  'itemUi.market.wocPayPrompt': '연결된 지갑에서 {amount} WOC를 보내면 {item} 구매가 완료됩니다.',
  'itemUi.market.paymentExpiredToast':
    '{item}의 결제 시간이 만료되었습니다. 해당 물품은 다시 구매할 수 있습니다.',
  'itemUi.market.soldWalletToast':
    '당신의 {item}이(가) {amount} WOC에 판매되었습니다. 대금은 연결된 지갑으로 지급되었으며, 보증금은 상인에게서 수령하세요.',
  'itemUi.market.soldAccountToast':
    '당신의 {item}이(가) {amount} Claudium에 판매되었습니다. 대금은 Claudium 잔액으로 지급되었으며, 보증금은 상인에게서 수령하세요.',
  ...
  'itemUi.logs.postedAuction': '{item}을(를) 경매에 등록했습니다 (시작가 {money}).',
  'itemUi.logs.bidPlaced': '입찰함: {item}에 {money}.',
  'itemUi.logs.listedClaudium': '{item}을(를) {amount} Claudium에 세계 시장에 등록했습니다.',
  'itemUi.logs.listedWoc': '{item}을(를) {amount} WOC에 세계 시장에 등록했습니다.',
  ...
  'itemUi.errors.minStartingBid': '시작 입찰가는 최소 1구리로 설정하세요.',
  'itemUi.errors.buyoutTooLow': '즉시구매가는 시작 입찰가보다 높아야 합니다.',
  'itemUi.errors.chooseDuration': '등록 기간을 12시간, 24시간, 48시간 중에서 선택하세요.',
  'itemUi.errors.cannotAffordDeposit': '등록 보증금을 지불할 수 없습니다.',
  'itemUi.errors.bidsOnly': '이 물품은 입찰만 가능합니다.',
  'itemUi.errors.notAuction': '이 물품은 경매 등록이 아닙니다.',
  'itemUi.errors.cannotBidOwnLot': '자신의 등록 물품에는 입찰할 수 없습니다.',
  'itemUi.errors.alreadyHighBidder': '이미 최고 입찰자입니다.',
  'itemUi.errors.bidTooLow': '최소 {min} 이상 입찰하세요.',
  'itemUi.errors.bidsGoldOnly': '입찰은 골드로만 가능합니다.',
  'itemUi.errors.claudiumUnavailable': 'Claudium 등록은 이용할 수 없습니다.',
  'itemUi.errors.wocUnavailable': 'WOC 등록은 이용할 수 없습니다.',
  'itemUi.errors.wocLinkToList': 'WOC로 등록하려면 지갑을 연결하세요.',
  ...
  'guide.economy.marketBrowse':
    '둘러보기: 목록을 넘겨 보거나 이름으로 검색해 무엇이 매물로 나와 있는지 찾으세요. 각 매물에는 물품, 판매자, 남은 시간, 그리고 나눠서 살 수 있는 묶음의 개당 가격이나 경매 물품의 현재 입찰가가 표시됩니다.',
  ...
  'guide.economy.marketPost':
    '등록하기: 가방에서 묶음을 고르고 등록 기간(12시간, 24시간, 48시간)을 선택해 개당 가격을 매기거나, 경매로 전환해 시작 입찰가와 선택적인 즉시구매가를 설정하세요. 등록에는 기간에 비례하는 보증금이 필요하지만 물품이 팔릴 때마다 돌려받으며, 팔리지 않은 만큼만 몰수됩니다. 누군가 살 때까지, 또는 경매가 끝날 때까지 물품은 상인이 보관하며, 마음이 바뀌면 일찍 되찾을 수도 있습니다.',
  'guide.economy.marketBidding':
    '경매: 일부 매물은 고정 가격 대신 입찰을 받습니다. 입찰가는 공시된 최소 금액 이상이어야 하며, 당신의 입찰이 밀리면 이전 입찰 금액은 전액 반환됩니다. 판매자가 즉시구매가를 설정한 경우, 그 금액에 도달하는 입찰이 있으면 그 자리에서 낙찰됩니다.',
  'guide.economy.marketCurrencies':
    '활성화된 경우 등록 물품을 Claudium이나 WOC로도 가격을 매길 수 있습니다. 구매자는 계정 간 또는 지갑 간에 직접 지불하고, 상인은 결제가 확인될 때까지 물품을 보관하며, 등록 보증금은 그대로 골드입니다.',
  ...
  'entities.letters.market_outbid.sender': '상인',
  'entities.letters.market_outbid.subject': '입찰이 밀렸습니다',
  'entities.letters.market_outbid.body':
    '다른 구매자가 당신이 노리던 물품의 입찰가를 올렸습니다. 당신의 구리는 세계 시장의 수거함에서 기다리고 있습니다. 찾아와서 회수하거나 다시 입찰하세요.\n\n- 상인',
  'entities.letters.market_won.sender': '상인',
  'entities.letters.market_won.subject': '낙찰 소식',
  'entities.letters.market_won.body':
    '경매봉이 내려졌고 이 물품은 이제 당신의 것입니다. 당신의 물건은 세계 시장의 수거함에서 기다리고 있습니다. 찾아와서 수령하세요.\n\n- 상인',
  'entities.letters.market_sold.sender': '상인',
  'entities.letters.market_sold.subject': '물품이 판매되었습니다',
  'entities.letters.market_sold.body':
    '구매자가 당신의 물건을 가져갔습니다. 판매 수익은 세계 시장의 수거함에서 기다리고 있습니다. 찾아와서 수령하세요.\n\n- 상인',
  'entities.letters.market_expired.sender': '상인',
  'entities.letters.market_expired.subject': '등록이 만료되었습니다',
  'entities.letters.market_expired.body':
    '등록 기간이 끝날 때까지 구매자가 나타나지 않았습니다. 물건은 세계 시장의 수거함에서 기다리고 있습니다. 찾아와서 회수하세요.\n\n- 상인',
  'entities.letters.market_sold_wallet.sender': '상인',
  'entities.letters.market_sold_wallet.subject': '물품이 판매되었습니다',
  'entities.letters.market_sold_wallet.body':
    '구매자가 당신의 물건을 가져갔습니다. 대금은 요청하신 대로 연결된 지갑으로 바로 지급되었고, 세계 시장의 수거함에는 등록 보증금만 남아 있습니다. 찾아와서 수령하세요.\n\n- 상인',
  'entities.letters.market_sold_account.sender': '상인',
  'entities.letters.market_sold_account.subject': '물품이 판매되었습니다',
  'entities.letters.market_sold_account.body':
    '구매자가 당신의 물건을 가져갔습니다. 대금은 당신의 Claudium 잔액으로 바로 지급되었고, 세계 시장의 수거함에는 등록 보증금만 남아 있습니다. 찾아와서 수령하세요.\n\n- 상인',
  'entities.letters.trade_delivery.sender': '레이븐포스트',
  'entities.letters.trade_delivery.subject': '거래 물품 도착',
  'entities.letters.trade_delivery.body':
    '거래로 받은 물품이 도착했습니다. 가방에 들어가지 않은 것은 까마귀가 대신 날라 왔습니다.',
  'entities.letters.trade_refund.sender': '레이븐포스트',
  'entities.letters.trade_refund.subject': '거래 물품 반환',
  'entities.letters.trade_refund.body':
    '거래가 성사되지 않았습니다. 제시했던 모든 것을 돌려받았습니다.',
