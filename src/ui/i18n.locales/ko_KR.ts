...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'races.sectionTitle': '진영과 종족',
  'races.factionKael': '카엘 제국',
  'races.factionVeth': '베스 연맹',
  'races.factionOssara': '오사라 영지',
  'races.human': '인간',
  'races.dwarf': '드워프',
  'races.gnome': '노움',
  'races.elf_exile': '추방된 엘프',
  'races.elf': '엘프',
  'races.dark_fae': '어둠 요정',
  'races.frost_kin': '서리 일족',
  'races.shadow_walker': '그림자 방랑자',
  'races.desert_clan': '사막 부족',
  'races.sand_mage': '모래 마법사',
  'races.nomad': '유목민',
  'races.stone_warden': '돌 수호자',
  'races.humanAria': '인간 종족',
  'races.dwarfAria': '드워프 종족',
  'races.gnomeAria': '노움 종족',
  'races.elf_exileAria': '추방된 엘프 종족',
  'races.elfAria': '엘프 종족',
  'races.dark_faeAria': '어둠 요정 종족',
  'races.frost_kinAria': '서리 일족 종족',
  'races.shadow_walkerAria': '그림자 방랑자 종족',
  'races.desert_clanAria': '사막 부족 종족',
  'races.sand_mageAria': '모래 마법사 종족',
  'races.nomadAria': '유목민 종족',
  'races.stone_wardenAria': '돌 수호자 종족',
  'races.raceLabel': '종족',
  'races.racialLabel': '종족 특성',
  'races.levelRaceClass': '{level}레벨 {race} {className}',
  'races.racialName_human': '상륙의 약속',
  'races.racialDesc_human': '휴식 경험치가 25% 더 빨리 쌓입니다.',
  'races.racialName_dwarf': '돌의 피',
  'races.racialDesc_dwarf': '방어도가 5% 증가합니다.',
  'races.racialName_gnome': '톱니의 지혜',
  'races.racialDesc_gnome': '지능이 5% 증가합니다.',
  'races.racialName_elf_exile': '유배자의 수련',
  'races.racialDesc_elf_exile': '시전 밀림이 20% 감소합니다.',
  'races.racialName_elf': '황혼의 우아함',
  'races.racialDesc_elf': '회피율이 1% 증가합니다.',
  'races.racialName_dark_fae': '요정의 교활함',
  'races.racialDesc_dark_fae': '치명타 확률이 1% 증가합니다.',
  'races.racialName_frost_kin': '겨울 가죽',
  'races.racialDesc_frost_kin': '체력이 3% 증가합니다.',
  'races.racialName_shadow_walker': '소리 없는 칼날',
  'races.racialDesc_shadow_walker': '민첩성이 3% 증가합니다.',
  'races.racialName_desert_clan': '태양에 단련된 몸',
  'races.racialDesc_desert_clan': '최대 생명력이 3% 증가합니다.',
  'races.racialName_sand_mage': '유리 조율',
  'races.racialDesc_sand_mage': '주문력이 5% 증가합니다.',
  'races.racialName_nomad': '끝없는 행군',
  'races.racialDesc_nomad': '정신력이 5% 증가합니다.',
  'races.racialName_stone_warden': '채석장의 힘',
  'races.racialDesc_stone_warden': '힘이 3% 증가합니다.',
  // Valdris continent (v0.19): item names
  'entities.items.dune_prowler_pelt.name': '모래언덕 배회자 가죽',
  'entities.items.glasswind_stinger.name': '유리바람 독침',
  'entities.items.stolen_relic.name': '도난당한 성물',
  'entities.items.nameless_burial_shroud.name': '이름 없는 매장 수의',
  'entities.items.storm_glass_core.name': '폭풍유리 핵',
  'entities.items.verdict_seal.name': '판결 인장',
  'entities.items.glasswind_husk.name': '유리바람 껍데기',
  'entities.items.mirage_stalker_eye.name': '신기루 추적자의 눈',
  'entities.items.dig_manifest.name': '발굴 목록',
  'entities.items.tomb_censer.name': '무덤 향로',
  'entities.items.sentence_tablet.name': '선고 석판',
  'entities.items.duststorm_heart.name': '모래폭풍의 심장',
  'entities.items.ravager_hide.name': '유린자 가죽',
  'entities.items.aqueduct_bronze.name': '수도교 청동 이음쇠',
  'entities.items.judge_regalia.name': '제1법정 예복',
  'entities.items.sunbleached_fang.name': '햇빛에 바랜 송곳니',
  'entities.items.cracked_scarab_shell.name': '금 간 풍뎅이 껍데기',
  'entities.items.emberjaw_pelt.name': '불꽃아귀 우두머리의 가죽',
  'entities.items.karns_funeral_mask.name': '카른의 장례 가면',
  'entities.items.qesh_flatbread.name': '케쉬 납작빵',
  'entities.items.oasis_waterskin.name': '오아시스 물주머니',
  'entities.items.spiced_scarab_skewer.name': '향신료 풍뎅이 꼬치',
  'entities.items.duneweave_robe.name': '모래언덕 직조 로브',
  'entities.items.caravan_guard_hauberk.name': '대상 호위병 사슬갑옷',
  'entities.items.prowlerhide_vest.name': '배회자 가죽 조끼',
  'entities.items.sandwalker_treads.name': '모래걸음꾼의 신',
  'entities.items.dunewatch_legguards.name': '모래언덕 감시자의 다리보호구',
  'entities.items.qesh_khopesh.name': '케쉬 코페쉬',
  'entities.items.judgestaff_of_ossara.name': '오사라 재판관의 지팡이',
  'entities.items.glasswind_talon.name': '유리바람 갈퀴발톱',
  'entities.items.emberjaw_prowlgrips.name': '불꽃아귀 사냥 장갑',
  'entities.items.unburied_gravewraps.name': '묻히지 못한 자의 무덤붕대',
  'entities.items.sandmaw_scale_cuirass.name': '모래아귀 비늘 흉갑',
  'entities.items.tyrantfang_edge.name': '폭군니 칼날',
  'entities.items.palewidow_silk.name': '창백거미 명주실',
  'entities.items.waterlogged_ledger.name': '물에 젖은 장부',
  'entities.items.guildless_sigil.name': '길드 없는 자의 인장',
  'entities.items.silent_court_seal.name': '침묵 법정의 인장',
  'entities.items.duskmane_pelt_strip.name': '황혼갈기 가죽끈',
  'entities.items.palewidow_venom_sac.name': '창백거미 독주머니',
  'entities.items.quay_manifest.name': '물에 젖은 부두 목록',
  'entities.items.wisplight_essence.name': '도깨비불 정수',
  'entities.items.drowned_toll_coin.name': '물에 잠긴 통행료 동전',
  'entities.items.cutthroat_contract.name': '목따개의 계약서',
  'entities.items.court_ledger_page.name': '법정 장부 한 장',
  'entities.items.frostpine_war_totem.name': '서리소나무 전쟁 토템',
  'entities.items.rimeclaw_pelt.name': '서리발톱 가죽',
  'entities.items.duskmane_tuft.name': '황혼갈기 털뭉치',
  'entities.items.guttering_wisp_mote.name': '깜박이는 도깨비불 티끌',
  'entities.items.frostpine_charm.name': '서리소나무 부적',
  'entities.items.palefang_pelt.name': '고요한 창백니의 가죽',
  'entities.items.grelnoks_frozen_idol.name': '그렐노크의 얼어붙은 우상',
  'entities.items.nighthollow_black_bread.name': '밤골 흑빵',
  'entities.items.pinefrost_tea.name': '솔서리 차',
  'entities.items.smoked_blackmere_eel.name': '검은호수 훈제 장어',
  'entities.items.wispweave_robe.name': '도깨비불 직조 로브',
  'entities.items.quayguard_hauberk.name': '부두 경비병 사슬갑옷',
  'entities.items.duskstalker_vest.name': '황혼 추적자 조끼',
  'entities.items.nightpath_treads.name': '밤길의 신',
  'entities.items.blackriver_legguards.name': '검은강 다리보호구',
  'entities.items.terracewatch_leggings.name': '계단밭 감시자의 각반',
  'entities.items.quays_cutlass.name': '부두의 커틀러스',
  'entities.items.wispcaller_staff.name': '도깨비불 부름꾼의 지팡이',
  'entities.items.whispersteel_stiletto.name': '속삭임강철 단검',
  'entities.items.palefang_grips.name': '창백니 장갑',
  'entities.items.hoarbound_bindings.name': '서리묶인 자의 결박구',
  'entities.items.forsworn_lamellar.name': '맹세배반자의 미늘 갑옷',
  'entities.items.forsworn_edge.name': '맹세배반자의 칼날',
  'entities.items.stolen_tithe_ledger.name': '도난당한 십일조 장부',
  'entities.items.granite_core_shard.name': '화강암 핵 조각',
  'entities.items.legion_deserter_insignia.name': '군단 탈영병 휘장',
  'entities.items.chewed_tithe_scrip.name': '씹다 만 십일조 전표',
  'entities.items.candle_tax_tally.name': '양초세 계산패',
  'entities.items.assay_office_seal.name': '검정소 인장',
  'entities.items.legion_pay_manifest.name': '군단 급여 목록',
  'entities.items.prime_wolf_pelt.name': '최상급 늑대 가죽',
  'entities.items.wendigo_gallstone.name': '웬디고 담석',
  'entities.items.icehowler_ruff.name': '얼음울음꾼 목털',
  'entities.items.legion_quarrel_bundle.name': '군단 쇠뇌살 묶음',
  'entities.items.clipped_imperial_coin.name': '깎아낸 제국 주화',
  'entities.items.rimewoven_hide.name': '서리로 짠 가죽',
  'entities.items.sellsword_pig_iron.name': '용병의 무쇠',
  'entities.items.lean_wolf_haunch.name': '기름기 없는 늑대 뒷다리',
  'entities.items.pilfered_ration_pack.name': '훔친 배급 꾸러미',
  'entities.items.sellsword_requisition_chit.name': '용병 징발 전표',
  'entities.items.frostbrush_wolf_fang.name': '서리덤불 늑대 송곳니',
  'entities.items.bent_legion_buckle.name': '휘어진 군단 버클',
  'entities.items.ogre_knuckle_dice.name': '오우거 손가락뼈 주사위',
  'entities.items.hoarfang_pelt.name': '서리송곳니 우두머리의 가죽',
  'entities.items.kazriks_brass_whistle.name': '카즈리크의 놋쇠 호루라기',
  'entities.items.kaelspire_barley_loaf.name': '카엘첨탑 보리빵',
  'entities.items.silverbrook_spring_water.name': '은시내 샘물',
  'entities.items.imperial_field_ration.name': '제국 야전 배급식',
  'entities.items.imperial_clerks_robe.name': '제국 서기 로브',
  'entities.items.kael_infantry_hauberk.name': '카엘 보병 사슬갑옷',
  'entities.items.wolfsward_hunting_jerkin.name': '늑대수비대 사냥 가죽옷',
  'entities.items.tithe_road_marchboots.name': '십일조 길 행군화',
  'entities.items.imperial_marcher_legguards.name': '제국 행군병 다리보호구',
  'entities.items.kael_arming_sword.name': '카엘 기사검',
  'entities.items.frosthelm_warstaff.name': '서리투구 전쟁지팡이',
  'entities.items.wolfsward_skinner.name': '늑대수비대 가죽칼',
  'entities.items.prefects_sealed_mantle.name': '집정관의 봉인된 망토',
  'entities.items.huntmasters_winter_hood.name': '사냥단장의 겨울 두건',
  'entities.items.hoarfang_clawgrips.name': '서리송곳니 발톱 장갑',
  'entities.items.overseers_candlewraps.name': '감독관의 양초 붕대',
  'entities.items.oathbreakers_battleplate.name': '맹세파괴자의 전투판금',
  'entities.items.oathbreakers_greatblade.name': '맹세파괴자의 대검',
  'entities.items.grey_shale_chip.name': '회색 혈암 조각',
  'entities.items.smuggled_trinket.name': '밀수된 장신구',
  'entities.items.barbed_thorn_husk.name': '가시돋친 꼬투리',
  'entities.items.thornfen_tusk.name': '가시늪 트롤 엄니',
  'entities.items.torn_caravan_banner.name': '찢어진 대상 깃발',
  'entities.items.ironpass_rubble_core.name': '무쇠고개 잔해 핵',
  'entities.items.wyvern_tail_barb.name': '와이번 꼬리 가시',
  'entities.items.reagent_gland.name': '시약으로 부푼 분비선',
  'entities.items.fogged_lantern_glass.name': '김서린 등불 유리',
  'entities.items.river_worn_idol.name': '강물에 닳은 우상',
  'entities.items.gull_picked_bone.name': '갈매기가 쪼아먹은 뼈',
  'entities.items.underway_hardtack.name': '지하길 건빵',
  'entities.items.smugglers_black_brew.name': '밀수꾼의 검은 술',
  'entities.items.thornberry_loaf.name': '가시열매 빵',
  'entities.items.palisade_pine_tea.name': '방책 소나무 차',
  'entities.items.tollhouse_stew.name': '통행소 스튜',
  'entities.items.ironpass_mulled_cider.name': '무쇠고개 뜨거운 사과주',
  'entities.items.lanternfen_eel_skewer.name': '등불늪 장어 꼬치',
  'entities.items.fogberry_tonic.name': '안개열매 강장제',
  'entities.items.bridgewatch_rations.name': '다리감시 배급식',
  'entities.items.nameless_river_water.name': '이름 없는 강물',
  'entities.items.smuggler_kings_softsteps.name': '밀수왕의 사뿐걸음 신',
  'entities.items.briarfather_bark_mitts.name': '가시아버지의 나무껍질 장갑',
  'entities.items.skarns_war_harness.name': '스카른의 전쟁 마구',
  'entities.items.colossus_mireheart_girdle.name': '진창심장 허리띠',
  'entities.items.bridgekeepers_tollstaff.name': '다리지기의 통행 지팡이',
  'entities.items.melted_ration_tin.name': '녹아버린 배급 깡통',
  'entities.items.ashcaked_fang.name': '재가 눌어붙은 송곳니',
  'entities.items.ember_glass_shard.name': '불씨유리 조각',
  'entities.items.saltglass_shard.name': '소금유리 조각',
  'entities.items.salt_crusted_chitin.name': '소금이 굳은 키틴',
  'entities.items.bleached_bone_charm.name': '바랜 뼈 부적',
  'entities.items.tarnished_prewar_coin.name': '빛바랜 전쟁 전 주화',
  'entities.items.sewer_silk_wad.name': '하수도 명주 뭉치',
  'entities.items.gutter_hound_pelt.name': '시궁창 사냥개 가죽',
  'entities.items.cracked_salamander_scale.name': '금 간 화염도롱뇽 비늘',
  'entities.items.cooled_magma_bead.name': '식은 용암 구슬',
  'entities.items.slag_nugget.name': '광재 덩어리',
  'entities.items.rusted_deserter_badge.name': '녹슨 탈영병 배지',
  'entities.items.redspire_rock_shard.name': '붉은첨탑 바위 조각',
  'entities.items.spire_stalker_claw.name': '첨탑 추적자의 발톱',
  'entities.items.cinderrest_ashcake.name': '잿불쉼터 재과자',
  'entities.items.boiled_cistern_water.name': '끓인 저수조 물',
  'entities.items.brinehollow_salt_jerky.name': '소금골 육포',
  'entities.items.desalted_waterskin.name': '담수 물주머니',
  'entities.items.gutter_stew.name': '유배자 시장 시궁창 스튜',
  'entities.items.black_market_tea.name': '암시장 차',
  'entities.items.forgefall_hardtack.name': '용광로몰락 건빵',
  'entities.items.coalfire_stout.name': '석탄불 흑맥주',
  'entities.items.waymeet_marching_bread.name': '길목 행군빵',
  'entities.items.bitterroot_brew.name': '쓴뿌리 술',
  'entities.items.revenant_cinderguard.name': '망령의 재수호 갑옷',
  'entities.items.marrowhide_leggings.name': '골수가죽 각반',
  'entities.items.scavenger_kings_shiv.name': '약탈왕의 조잡한 칼',
  'entities.items.forgewyrm_scale_helm.name': '단조 지렁이 비늘 투구',
  'entities.items.mantle_of_the_last_muster.name': '최후 소집의 망토',
  'entities.items.scorched_banner_scrap.name': '그을린 깃발 조각',
  'entities.items.melted_signet_ring.name': '녹아내린 인장 반지',
  'entities.items.cracked_horror_horn.name': '금 간 공포의 뿔',
  'entities.items.bastion_hardtack.name': '요새 건빵',
  'entities.items.trucewater_flask.name': '휴전수 물병',
  'entities.items.ashguard_robe.name': '재수호 로브',
  'entities.items.breachwalker_jerkin.name': '틈새를 걷는 자의 가죽옷',
  'entities.items.bastion_plated_hauberk.name': '요새 판금 사슬갑옷',
  'entities.items.bastion_arming_sword.name': '요새 기사검',
  'entities.items.mercenary_greatblade.name': '용병 대검',
  'entities.items.tithe_collectors_grasps.name': '십일조 징수관의 장갑',
  'entities.items.craterheart_mantle.name': '분화구심장 망토',
  'entities.items.butchers_chainguard.name': '도살자의 사슬보호구',
  ...
  'hudChrome.envoys.title': '사절의 전당',
  'hudChrome.envoys.prompt': '진영과, 함께 설 종족을 선택하십시오.',
  'hudChrome.envoys.permanent':
    '이 맹세는 되돌릴 수 없습니다. 진영이 고향과 아군, 그리고 영원한 전쟁의 적을 결정합니다.',
  'hudChrome.envoys.confirm': '맹세하기',
  'hudChrome.envoys.travelTitle': '통행',
  'hudChrome.envoys.travelBody': '지금 떠나시겠습니까? 이동은 순식간입니다.',
  'hudChrome.envoys.travelGo': '떠나기',
  'hudChrome.envoys.travelStay': '머무르기',
  'hudChrome.defense.start': '전선을 사수하라! 수비대가 대비하고 있습니다.',
  'hudChrome.defense.wave': '{total}차 중 {wave}차 공세 격퇴!',
  ...
  'entities.items.conjured_water4.name': '마법 수정 생수',
  'entities.items.conjured_water5.name': '마법 빙하수',
  'entities.items.conjured_water6.name': '마법 산악수',
  ...
  'entities.items.forged_levy_papers.name': '위조된 징집 서류',
  'entities.items.amnesty_petition.name': '미접수 사면 청원서',
  'entities.items.fort_pattern_kettle.name': '요새 규격 주전자',
  'entities.items.garnished_pay_pouch.name': '압류된 급여 주머니',
  'entities.items.fault_line_core.name': '단층 핵',
  'entities.items.unstamped_duel_permit.name': '날인 없는 결투 허가증',
  'entities.items.rimeclaw_tallow.name': '서리발톱 수지',
  'entities.items.rimeclaw_marrowbone.name': '서리발톱 골수뼈',
  'entities.items.oathguard_plate_scrap.name': '서약수호대 판금 조각',
  'entities.items.ninth_muster_roll.name': '회수한 소집 명부',
  'entities.items.icehowler_haunch.name': '얼음울음꾼 뒷다리살',
  'entities.items.rimebound_core_ice.name': '서리결속 핵빙',
  'entities.items.glacial_quench_ice.name': '빙하 담금질 얼음',
  'entities.items.maren_calling_card.name': '마렌 가문 방문패',
  'entities.items.maldreks_route_ledger.name': '말드렉의 경로 장부',
  'entities.items.grulks_iron_strongbox.name': '그룰크의 무쇠 금고',
  'entities.items.maren_duelling_mantle.name': '마렌 결투 망토',
  'entities.items.final_notice_wraps.name': '최후 통첩 손싸개',
  'entities.items.pay_wardens_shoulderguards.name': '급여 감독관의 어깨보호구',
  'entities.items.rimeshaft_foremans_cap.name': '라임샤프트 십장의 모자',
  'entities.items.quarter_close_vestments.name': '분기 결산 예복',
  'entities.items.assessors_lead_greaves.name': '사정관의 납 다리보호구',
  'entities.items.purse_wardens_coinbelt.name': '돈주머니 감독관의 동전 허리띠',
  'entities.items.mothwing_dust.name': '나방날개 가루',
  'entities.items.silt_eel.name': '침니 뱀장어',
  'entities.items.barge_chit.name': '물에 분 바지선 표',
  'entities.items.ferry_lantern_mote.name': '나룻배 등불 티끌',
  'entities.items.smugglers_tally_knot.name': '밀수꾼의 계산 매듭',
  'entities.items.forged_weir_pass.name': '위조된 보 통행증',
  'entities.items.sunken_ration_tin.name': '가라앉은 배급 깡통',
  'entities.items.hollow_toll_scrip.name': '부도난 통행세 어음',
  'entities.items.rimeclaw_haunch.name': '서리발톱 뒷다리살',
  'entities.items.rimebound_fetish.name': '서리결속 주물',
  'entities.items.frostpine_tallow.name': '서리소나무 수지',
  'entities.items.forsworn_oath_knife.name': '맹세를 저버린 자의 서약 칼',
  'entities.items.shadowbound_cipher.name': '그림자결속 암호문',
  'entities.items.vessiks_little_book.name': '베시크의 작은 책',
  'entities.items.weirwatch_wraps.name': '보 감시대 손싸개',
  'entities.items.lodgewalk_boots.name': '산장길 장화',
  'entities.items.unbroken_wardstone.name': '온전한 수호석',
  'entities.items.vault_ward_core.name': '금고 수호핵',
  'entities.items.temple_offering_bowl.name': '신전 봉헌 그릇',
  'entities.items.graven_name_stone.name': '이름 새긴 돌',
  'entities.items.stalker_haunch.name': '잠복자 뒷다리살',
  'entities.items.heretic_creed_page.name': '불탄 신조 낱장',
  'entities.items.heretic_brand_iron.name': '이단자 낙인 인두',
  'entities.items.heretic_writ.name': '이단 판결문',
  'entities.items.first_court_sigil.name': '제1법정 인장',
  'entities.items.duneglass_heart.name': '사구유리 심장',
  'entities.items.unshattered_fulgurite.name': '온전한 섬전암',
  'entities.items.flameseer_ash_creed.name': '재의 신조 석판',
  'entities.items.flameseer_ember_phial.name': '불씨 약병',
  'entities.items.dawnward_censer.name': '새벽 감시 향로',
  'entities.items.stolen_water_cask.name': '봉인된 물통',
  'entities.items.duskwater_oathmark.name': '황혼수 서약 표식',
  'entities.items.caravan_toll_tally.name': '봉인된 통행세 부신',
  'entities.items.tyrant_spoor.name': '폭군 발자국 주형',
  'entities.items.oxbone_toll.name': '소뼈 통행세 부신',
  'entities.items.cartographers_map.name': '첫 지도제작자의 지도',
  'entities.items.templestone_shard.name': '신전석 조각',
  'entities.items.fulgurite_splinter.name': '섬전암 파편',
  'entities.items.charred_censer_chain.name': '그을린 향로 사슬',
  'entities.items.wardens_stone_heart.name': '아쉬케라트의 돌심장',
  'entities.items.first_meridian_compass.name': '제1자오선 나침반',
  'entities.items.seatstone_flatbread.name': '좌석돌 납작빵',
  'entities.items.seatwell_waterskin.name': '좌석우물 물주머니',
  'entities.items.lastwater_jerky.name': '라스트워터 육포',
  'entities.items.lastwater_skin.name': '라스트워터 물주머니',
  'entities.items.vaultkeepers_handwraps.name': '금고지기의 손싸개',
  'entities.items.sahrs_penitent_leggings.name': '사르의 고행 다리옷',
  'entities.items.wardens_granite_edge.name': '감시자의 화강암 칼날',
  'entities.items.staff_of_the_sunken_court.name': '가라앉은 법정의 지팡이',
  'entities.items.duneglass_shiv.name': '사구유리 단도',
  'entities.items.lastwater_roadmail.name': '라스트워터 여행 사슬갑옷',
  'entities.items.duskwatch_robe.name': '황혼 감시 로브',
  'entities.items.raiders_dust_jerkin.name': '약탈자의 흙먼지 가죽옷',
  'entities.items.ashkerat_greaves.name': '아쉬케라트의 다리보호구',
  'entities.items.cartographers_windwraps.name': '지도제작자의 바람 손싸개',
  'entities.items.unlit_silk_gland.name': '빛없는 명주샘',
  'entities.items.veskals_fang.name': '베스칼의 송곳니',
  'entities.items.broodmother_carapace_guard.name': '수렁어미 갑각 가슴막이',
  'entities.items.condensed_mist_heart.name': '응축된 안개 심장',
  'entities.items.mistfathers_knot.name': '안개아버지의 매듭',
  'entities.items.fogwalker_treads.name': '안개걷는 자의 발걸음',
