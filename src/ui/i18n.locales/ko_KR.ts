...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.voice_echo_npc.title': '기억된 목소리',
  'entities.npcs.voice_echo_npc.greeting':
    '모닥불 너머에서 들려오는 목소리... 그래, 나도 한때 저런 목소리였지.',
  'entities.quests.q_echo_of_you.text': '근처에서 내 소중한 것을 잃어버렸다. 가서 찾아와 주겠나?',
  ...
  'hudChrome.voiceNpc.consentLabel':
    '녹음된 내 목소리가 제3자 AI 음성 서비스에 의해 복제되는 것에 동의합니다.',
  'hudChrome.voiceNpc.displayNameLabel': 'NPC 표시 이름',
  'hudChrome.voiceNpc.displayNamePlaceholder': '당신의 에코를 뭐라고 부를까요?',
  'hudChrome.voiceNpc.recordStart': '샘플 녹음',
  'hudChrome.voiceNpc.recordStop': '녹음 중지',
  'hudChrome.voiceNpc.recordingHint': '녹음 중... 최대 30초 동안 자연스럽게 말하세요.',
  'hudChrome.voiceNpc.priceLabel': '가격: {price} $WOC',
  'hudChrome.voiceNpc.burnLabel': '$WOC 소각 후 확정',
  'hudChrome.voiceNpc.burnNotWired':
    '이 드래프트 빌드에서는 온체인 소각 서명이 아직 연결되지 않았습니다.',
  'hudChrome.voiceNpc.needWallet': '먼저 Solana 지갑을 연결하세요.',
  'hudChrome.voiceNpc.needName': 'NPC의 표시 이름을 입력하세요.',
  'hudChrome.voiceNpc.needConsent': '샘플을 녹음하거나 업로드하기 전에 동의해야 합니다.',
  'hudChrome.voiceNpc.micError': '마이크에 접근할 수 없습니다.',
  'hudChrome.voiceNpc.uploadError': '음성 샘플을 업로드할 수 없습니다.',
  'hudChrome.voiceNpc.quoteError': '가격 견적을 가져올 수 없습니다.',
  'hudChrome.voiceNpc.confirmError': '결제를 확인할 수 없습니다.',
  'hudChrome.voiceNpc.statusPendingSample':
    '샘플이 녹음되었습니다. 견적과 $WOC 소각 준비가 되었습니다.',
  'hudChrome.voiceNpc.statusPendingClone':
    '결제가 확인되었습니다. 음성 복제 시작을 기다리는 중입니다.',
  'hudChrome.voiceNpc.statusCloning': '목소리를 복제하는 중...',
  'hudChrome.voiceNpc.statusGenerating': '대사를 생성하는 중...',
  'hudChrome.voiceNpc.statusReady': '보이스 NPC가 준비되었습니다!',
  'hudChrome.voiceNpc.statusFailed': '문제가 발생했습니다: {error}',
  'hudChrome.voiceNpc.statusPollFailed': '상태를 확인할 수 없습니다. 이 패널을 다시 열어 주세요.',
};
