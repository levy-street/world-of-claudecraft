...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.faq.a6':
    '아홉 가지 공용 야외 제작법과 여섯 가지 제작 육상 도구 제작법은 처음부터 누구나 알고 있다. 작업장에 묶인 세 가지 상급 제작법(가마비늘 망토, 워드위브 두건, 더스크하이드 손목보호대)도 마찬가지여서 스승은 필요 없지만 그 작업장은 있어야 한다. 나머지는 모두 세 거점 마을의 각 작업장에 있는 스승이 가르친다. 대부분은 이스트브룩에 있고, 무두장이는 펜브릿지의 무두질 작업장에, 연금술사는 하이워치의 약방에 있다.\n\n스승의 제작법은 단계로 나뉜다. 장비와 소모품 제작 기술은 숙련 0, 25, 50 단계이며 일회성 비용으로 각각 무료, 은 25, 금 1이다. 그리고 모든 제작 기술이 그 위에 자기 작업장에서 가르치는 75 단계의 중급 제작법을 하나씩 더한다(마법부여의 것은 광휘 시약으로, 25 단계의 두 부적 제작법 곁에 있다). 도구 장인은 제작 낚싯대 둘도 75와 125 단계에서 각각 금 4와 금 16에 가르친다. 스승은 그 제작 기술에서 당신의 등급이 제작법 자체의 등급에 이르면 가르쳐 주고, 배우려면 스승의 작업장에 서 있어야 한다. 이동식 작업장은 인정되지 않는다.',
