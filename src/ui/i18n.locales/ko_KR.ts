...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.governance.disabled': '거버넌스 투표를 현재 사용할 수 없습니다.',
  'apiError.governance.forbidden': '제안을 생성할 권한이 없습니다.',
  'apiError.governance.not_found': '해당 제안을 찾을 수 없습니다.',
  'apiError.governance.invalid_input': '제안 항목을 확인한 뒤 다시 시도하세요.',
  'apiError.governance.wallet_not_linked': '투표하기 전에 지갑을 연결하세요.',
  'apiError.governance.wallet_mismatch': '해당 지갑은 계정에 연결되어 있지 않습니다.',
  'apiError.governance.window_closed': '이 제안의 투표가 종료되었습니다.',
  'apiError.governance.already_voted': '이 지갑은 이미 이 제안에 투표했습니다.',
  'apiError.governance.challenge_invalid': '투표 요청이 만료되었습니다. 다시 시도하세요.',
  'apiError.governance.bad_signature': '지갑 서명을 확인할 수 없습니다.',
  'apiError.governance.balance_unavailable': '$WOC 잔액을 읽을 수 없습니다. 다시 시도하세요.',
  ...
  'hudChrome.governance.title': '거버넌스',
  'hudChrome.governance.close': '거버넌스 닫기',
  'hudChrome.governance.subtitle': '$WOC 보유자 자문 투표',
  'hudChrome.governance.loading': '제안을 불러오는 중……',
  'hudChrome.governance.error': '거버넌스 제안을 불러올 수 없습니다.',
  'hudChrome.governance.empty': '아직 제안이 없습니다.',
  'hudChrome.governance.refresh': '새로 고침',
  'hudChrome.governance.open': '진행 중',
  'hudChrome.governance.closed': '종료됨',
  'hudChrome.governance.closesAt': '{date}에 종료',
  'hudChrome.governance.closedAt': '{date}에 종료됨',
  'hudChrome.governance.quorum': '정족수: {needed} $WOC 중 {current}',
  'hudChrome.governance.quorumReached': '정족수 도달',
  'hudChrome.governance.category.content': '콘텐츠',
  'hudChrome.governance.category.cosmetic': '외형',
  'hudChrome.governance.category.treasury': '재정',
  'hudChrome.governance.tally.for': '찬성',
  'hudChrome.governance.tally.against': '반대',
  'hudChrome.governance.tally.abstain': '기권',
  'hudChrome.governance.tally.voters': '투표자 {count}명',
  'hudChrome.governance.vote.for': '찬성 투표',
  'hudChrome.governance.vote.against': '반대 투표',
  'hudChrome.governance.vote.abstain': '기권',
  'hudChrome.governance.vote.needWallet': '투표하려면 지갑을 연결하세요.',
  'hudChrome.governance.vote.alreadyVoted': '투표함: {choice}',
  'hudChrome.governance.vote.signing': '지갑에서 서명하세요……',
  'hudChrome.governance.vote.submitting': '투표 제출 중……',
  'hudChrome.governance.vote.success': '투표가 기록되었습니다.',
  'hudChrome.governance.vote.failed': '투표를 기록할 수 없습니다.',
