...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.effectWellFed': '식사를 마치면 배부름: {minutes}분간 {stat} +{value}.',
