...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.cameraMode.title': '카메라 선택',
  'hudChrome.cameraMode.body': '카메라를 어떻게 조작하시겠습니까?',
  'hudChrome.cameraMode.classicLabel': '클래식',
  'hudChrome.cameraMode.classicDesc':
    '마우스 오른쪽 버튼을 누른 채로 카메라를 돌리고, 놓으면 커서가 자유로워집니다.',
  'hudChrome.cameraMode.mouseLabel': '마우스 카메라',
  'hudChrome.cameraMode.mouseDesc': '마우스가 항상 카메라를 조종하는 부드럽고 현대적인 자유 시점입니다.',
  'hudChrome.cameraMode.recommended': '추천',
  'hudChrome.cameraMode.note': '이 설정은 나중에 Esc의 키 바인딩에서 변경할 수 있습니다.',
  'hudChrome.cameraMode.confirm': '확인',
  'hudChrome.cameraMode.dismiss': '닫기',
