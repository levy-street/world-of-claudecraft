...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.unitFrameHealthText': '유닛 프레임 생명력 텍스트',
  'hudChrome.options.unitFrameDamageTrail': '지연 피해 흔적',
  'hudChrome.options.unitFramePortraitEffects': '초상화 반응',
  ...
  'hudChrome.unitFrame.targetOfTargetNamedLabel': '대상의 대상: {name}',
  'hudChrome.unitFrame.auraOverflowShort': '+{count}',
  'hudChrome.unitFrame.auraOverflowLabel': '추가 강화 효과 {count}개',
