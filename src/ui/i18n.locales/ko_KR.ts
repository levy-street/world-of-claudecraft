...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.pokerPlaytest.title': '포커',
  'hudChrome.pokerPlaytest.close': '포커 닫기',
  'hudChrome.pokerPlaytest.reconnecting': '포커 서버에 다시 연결하는 중...',
  'hudChrome.pokerPlaytest.disabled': '현재 포커를 이용할 수 없습니다.',
  'hudChrome.pokerPlaytest.tables': '테이블',
  'hudChrome.pokerPlaytest.refresh': '새로 고침',
  'hudChrome.pokerPlaytest.noTables': '이용 가능한 포커 테이블이 없습니다.',
  'hudChrome.pokerPlaytest.join': '참가',
  'hudChrome.pokerPlaytest.watch': '관전',
  'hudChrome.pokerPlaytest.stopWatching': '관전 종료',
  'hudChrome.pokerPlaytest.rebuy': '리바이',
  'hudChrome.pokerPlaytest.leave': '나가기',
  'hudChrome.pokerPlaytest.chooseSeat': '좌석 선택',
  'hudChrome.pokerPlaytest.seat': '{seat}번 좌석',
  'hudChrome.pokerPlaytest.seated': '{count}명 착석',
  'hudChrome.pokerPlaytest.watchers': '{count}명 관전',
  'hudChrome.pokerPlaytest.watching': '관전 중',
  'hudChrome.pokerPlaytest.tableFull': '빈 좌석 없음',
  'hudChrome.pokerPlaytest.inHand': '핸드 진행 중',
  'hudChrome.pokerPlaytest.betweenHands': '핸드 사이',
  'hudChrome.pokerPlaytest.unknownPlayer': '플레이어',
  'hudChrome.pokerPlaytest.waiting': '다음 핸드를 기다리는 중',
  'hudChrome.pokerPlaytest.playerTurn': '{name}님이 행동 중',
  'hudChrome.pokerPlaytest.timeRemaining': '{seconds}초 남음',
  'hudChrome.pokerPlaytest.wagerAmount': '{action} 금액',
  'hudChrome.pokerPlaytest.rake': '레이크: {amount}',
  'hudChrome.pokerPlaytest.error.busy': '테이블이 처리 중입니다. 다시 시도하세요.',
  'hudChrome.pokerPlaytest.error.disabled': '현재 포커를 이용할 수 없습니다.',
  'hudChrome.pokerPlaytest.error.invalid_action': '허용되지 않는 행동입니다.',
  'hudChrome.pokerPlaytest.error.insufficient_funds':
    '참가하거나 리바이하려면 Copper가 더 필요합니다.',
  'hudChrome.pokerPlaytest.error.participation_suspended': '이 계정의 포커 참가가 정지되었습니다.',
  'hudChrome.pokerPlaytest.error.invalidAmount': '허용 범위 안의 정수를 입력하세요.',
  'hudChrome.pokerPlaytest.error.rebuy_not_allowed': '지금은 리바이할 수 없습니다.',
  'hudChrome.pokerPlaytest.error.seat_conflict': '해당 좌석은 이미 사용 중입니다.',
  'hudChrome.pokerPlaytest.error.stale_action': '행동이 도착하기 전에 핸드가 변경되었습니다.',
  'hudChrome.pokerPlaytest.error.table_not_found': '해당 포커 테이블이 존재하지 않습니다.',
  'hudChrome.pokerPlaytest.error.watch_conflict':
    '다른 테이블을 관전하기 전에 현재 테이블에서 나가세요.',
  'hudChrome.pokerPlaytest.chips': '{amount}칩',
  'hudChrome.pokerPlaytest.pot': '팟: {amount}',
  'hudChrome.pokerPlaytest.noCards': '카드 없음',
  'hudChrome.pokerPlaytest.emptySeat': '빈 좌석',
  'hudChrome.pokerPlaytest.dealerButton': '딜러 버튼',
  'hudChrome.pokerPlaytest.dealerMarker': 'D',
  'hudChrome.pokerPlaytest.smallBlind': '스몰 블라인드',
  'hudChrome.pokerPlaytest.smallBlindMarker': 'SB',
  'hudChrome.pokerPlaytest.bigBlind': '빅 블라인드',
  'hudChrome.pokerPlaytest.bigBlindMarker': 'BB',
  'hudChrome.pokerPlaytest.yourTurn': '당신의 차례입니다',
  'hudChrome.pokerPlaytest.winner': '{name}님이 {amount} 획득',
  'hudChrome.pokerPlaytest.winnerWithHand': '{name}님이 {hand}(으)로 {amount} 획득',
  'hudChrome.pokerPlaytest.highlightedHand': '{name}: {hand}',
  'hudChrome.pokerPlaytest.hand.highCard': '하이 카드',
  'hudChrome.pokerPlaytest.hand.pair': '원 페어',
  'hudChrome.pokerPlaytest.hand.twoPair': '투 페어',
  'hudChrome.pokerPlaytest.hand.threeOfAKind': '트리플',
  'hudChrome.pokerPlaytest.hand.straight': '스트레이트',
  'hudChrome.pokerPlaytest.hand.flush': '플러시',
  'hudChrome.pokerPlaytest.hand.fullHouse': '풀 하우스',
  'hudChrome.pokerPlaytest.hand.fourOfAKind': '포카드',
  'hudChrome.pokerPlaytest.hand.straightFlush': '스트레이트 플러시',
  'hudChrome.pokerPlaytest.actionWithAmount': '{action} {amount}',
  'hudChrome.pokerPlaytest.action.fold': '폴드',
  'hudChrome.pokerPlaytest.action.check': '체크',
  'hudChrome.pokerPlaytest.action.call': '콜',
  'hudChrome.pokerPlaytest.action.bet': '벳',
  'hudChrome.pokerPlaytest.action.raise': '레이즈',
  'hudChrome.pokerPlaytest.action.all-in': '올인',
  'hudChrome.pokerPlaytest.street.preflop': '프리플롭',
  'hudChrome.pokerPlaytest.street.flop': '플롭',
  'hudChrome.pokerPlaytest.street.turn': '턴',
  'hudChrome.pokerPlaytest.street.river': '리버',
