...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.endsInDays.one': '{count}일 후 종료',
  'hudChrome.arenaSeason.endsInDays.few': '{count}일 후 종료',
  'hudChrome.arenaSeason.endsInDays.many': '{count}일 후 종료',
  'hudChrome.arenaSeason.endsInDays.other': '{count}일 후 종료',
  'hudChrome.arenaSeason.endsInHours.one': '{count}시간 후 종료',
  'hudChrome.arenaSeason.endsInHours.few': '{count}시간 후 종료',
  'hudChrome.arenaSeason.endsInHours.many': '{count}시간 후 종료',
  'hudChrome.arenaSeason.endsInHours.other': '{count}시간 후 종료',
  'hudChrome.arenaSeason.endsInMinutes.one': '{count}분 후 종료',
  'hudChrome.arenaSeason.endsInMinutes.few': '{count}분 후 종료',
  'hudChrome.arenaSeason.endsInMinutes.many': '{count}분 후 종료',
  'hudChrome.arenaSeason.endsInMinutes.other': '{count}분 후 종료',
  'hudChrome.arenaSeason.opensInDays.one': '{count}일 후 시작',
  'hudChrome.arenaSeason.opensInDays.few': '{count}일 후 시작',
  'hudChrome.arenaSeason.opensInDays.many': '{count}일 후 시작',
  'hudChrome.arenaSeason.opensInDays.other': '{count}일 후 시작',
  'hudChrome.arenaSeason.opensInHours.one': '{count}시간 후 시작',
  'hudChrome.arenaSeason.opensInHours.few': '{count}시간 후 시작',
  'hudChrome.arenaSeason.opensInHours.many': '{count}시간 후 시작',
  'hudChrome.arenaSeason.opensInHours.other': '{count}시간 후 시작',
  'hudChrome.arenaSeason.opensInMinutes.one': '{count}분 후 시작',
  'hudChrome.arenaSeason.opensInMinutes.few': '{count}분 후 시작',
  'hudChrome.arenaSeason.opensInMinutes.many': '{count}분 후 시작',
  'hudChrome.arenaSeason.opensInMinutes.other': '{count}분 후 시작',
