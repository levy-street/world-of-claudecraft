...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'character.mintSolHint': '플레이어 소유의 ‹이름›.worldofclaudecraft.sol을 {amount} $WOC로 민트하세요. 온체인에서 당신의 것입니다.',
  ...
  'woc.finalizeTimeout': '최종 확정 대기가 시간 초과되었습니다. $WOC가 소각되었다면 다시 열어 재시도하세요. 결제는 최종 확정되면 정산됩니다.',
