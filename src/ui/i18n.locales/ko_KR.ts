...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.itemSets.spiritbinder.bonus3': '지능이 10, 체력이 10만큼 증가합니다.',
  'entities.itemSets.spiritbinder.bonus4':
    '주문 사용 시 10% 확률로 선명한 시전이 발동하여 다음 주문을 무료로 시전합니다.',
  'entities.items.spiritbinder_hauberk.name': '정령결속 사슬갑옷',
