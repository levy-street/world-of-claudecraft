...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.source_cave_mantle.name': '근원의 망토',
  'entities.items.conflictbreaker_breastplate.name': '충돌파괴자 흉갑',
  'entities.items.cherry_pickers_gauntlets.name': '체리피커 건틀릿',
  'entities.items.maintainers_crown.name': '메인테이너의 왕관',
  'entities.items.commit_blade.name': '커밋의 검',
  'entities.items.bug_squasher.name': '버그 분쇄기',
  'entities.items.mech_keyboard.name': '키스트로크',
  ...
  'worldContent.sourceCaveWellName': '열린 근원',
  'worldContent.sourceCaveReboot': '이 버튼을 누르지 마시오',
  'worldContent.sourceCaveRebootYell': '대체 무슨 짓을 한 거야?!',
  'worldContent.sourceCaveRebootYellWhatsGoingOn': '이봐, 무슨 일이야?',
  'worldContent.sourceCaveRebootYellServerDown': '얘들아, 서버가 다운됐어!',
  'worldContent.sourceCaveBanterIssue': '제발 이슈를 하나 만들어 주세요.',
  'worldContent.sourceCaveBanterPullRequest': '주저하지 말고 풀 리퀘스트를 보내 주세요.',
  'worldContent.sourceCaveBanterConflicts': '충돌은 정말 싫어...',
  'worldContent.sourceCaveBanterContribute': '물론이죠, 이 프로젝트에 기여할 수 있어요!',
  'worldContent.sourceCaveBanterFocused': '미안하지만 지금은 집중하고 있어요',
  'worldContent.sourceCaveBanterNextRelease': '다음 릴리스는 끝내줄 거예요!',
  'worldContent.sourceCaveBanterRefresh': '음? 새로고침해 보세요',
  ...
  'entities.dungeons.source_cave.name': '근원의 동굴',
  'entities.dungeons.source_cave.enterText': '당신은 근원의 동굴로 발을 들입니다.',
  'entities.dungeons.source_cave.leaveText': '당신은 근원의 동굴을 떠납니다.',
  ...
  'sim.dungeon.levelRequired': '{name}에 들어가려면 레벨 {level}에 도달해야 합니다.',
  'sim.sourceCave.locked': '{name}에 대한 입장이 잠겨 있습니다.',
  'sim.sourceCave.enter': '당신은 근원의 동굴로 발을 들입니다.',
  'sim.sourceCave.leave': '당신은 근원의 동굴을 떠납니다.',
  'sim.sourceCave.rebootConfirm':
    '정말 계속하시겠습니까? 누르기 전에 필요한 자원을 모두 모아 두세요.',
  'sim.sourceCave.killProgress':
    '{name}이(가) 쓰러졌습니다. (근원의 동굴에서 {total}명 중 {killed}명 처치)',
  'sim.sourceCave.cleared': '근원의 동굴을 정복했습니다.',
  ...
  'sim.sourceCave.wellBanter3': '난 그냥 평범한 우물이라고! 봐, 두레박도 있잖아!',
  'sim.sourceCave.wellBanter4': '여전히 그냥 우물일 뿐이야. 마법 같은 건 없다고.',
  'sim.sourceCave.wellBanter5': '근원에 대해 누가 알려줬어? 클로드였어?',
  'sim.sourceCave.wellBanter6': '오, 넌 절대 저 아래로 내려가고 싶지 않을걸.',
  'sim.sourceCave.wellBanter7': '경비원! 플레이어가 소스 코드에 침입하려 하고 있어!',
  'sim.sourceCave.wellBanter8': '있잖아, 저 아래는 갈등의 근원이거든.',
  'sim.sourceCave.wellBanter9': '내가 열어주면, 이제 좀 날 내버려둘 거야?',
  'sim.sourceCave.wellBanter10': '좋아, 들어와. 먼저 부츠부터 닦고.',
