...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.tin_ore.name': '주석 광석',
  'entities.items.iron_ore.name': '철 광석',
  'entities.items.copper_bar.name': '구리 주괴',
  'entities.items.tin_bar.name': '주석 주괴',
  'entities.items.bronze_bar.name': '청동 주괴',
  'entities.items.bronzeclasp_gauntlets.name': '청동걸쇠 건틀릿',
  'entities.items.clawspur_dirk.name': '발톱가시 단검',
  'entities.items.iron_bar.name': '철 주괴',
  'entities.items.thorium_bar.name': '토륨 주괴',
  ...
  'entities.items.beast_claw.name': '야수 발톱',
  'entities.items.boar_tusk.name': '멧돼지 엄니',
