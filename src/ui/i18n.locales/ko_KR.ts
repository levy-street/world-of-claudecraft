...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.object.mining_cracked_wall': '갈라진 벽',
  'delveUi.object.herbalism_toxic_growth': '독성 증식',
  'delveUi.board.companion.roleLabel': '동료 역할',
  'delveUi.companionRole.healer': '치유',
  'delveUi.companionRole.tank': '방어',
  'delveUi.companionRole.damage': '공격',
  'delveUi.tracker.companionRole': '동료 역할: {role}',
  'delveUi.shortcut.miningReady': '채광: 갈라진 벽 열기',
  'delveUi.shortcut.miningFallback': '지름길: 갈라진 벽 깎기',
  'delveUi.shortcut.herbalismReady': '약초채집: 독성 증식 정화',
  'delveUi.shortcut.herbalismFallback': '지름길: 독성 증식 치우기',
  ...
  'sim.delve.miningShortcut': '채광으로 약한 지점을 찾았습니다. 갈라진 벽이 열립니다.',
  'sim.delve.miningShortcutFallback':
    '갈라진 벽을 깎아냅니다. 채광이 있으면 더 빨리 열 수 있습니다.',
  'sim.delve.miningShortcutFallbackComplete': '꾸준히 두드린 끝에 갈라진 벽이 무너집니다.',
  'sim.delve.herbalismShortcut': '약초채집으로 독성 증식을 빠르게 시들게 합니다.',
  'sim.delve.herbalismShortcutFallback':
    '독성 증식을 밀어냅니다. 약초채집이 있으면 더 빨리 정화할 수 있습니다.',
  'sim.delve.herbalismShortcutFallbackComplete': '꾸준히 치운 끝에 독성 증식이 무너집니다.',
