...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.castBar.casting': '시전 중',
  'hudChrome.castBar.channeling': '정신 집중 중',
  'hudChrome.castBar.complete': '완료',
  'hudChrome.castBar.interrupted': '차단됨',
  'hudChrome.castBar.failed': '실패',
  'hudChrome.castBar.interruptible': '차단 가능',
  'hudChrome.castBar.cannotInterrupt': '차단 불가',
  'hudChrome.castBar.danger': '위험',
  'hudChrome.castBar.pet': '소환수',
  'hudChrome.castBar.secondsShort': '{seconds}초',
  'hudChrome.castBar.labelWithCue': '{cue}: {label}',
  'hudChrome.castBar.ariaStatus': '{bar}: {status} {label}, {seconds} 남음',
  'hudChrome.castBar.ariaOutcome': '{bar}: {status} {label}',
  'hudChrome.petAction.auto': '자동',
  'hudChrome.petAction.cooldownTitle': '{action}: {seconds} 남음',
  'hudChrome.petAction.cooldownAutoAria': '{action}: {seconds} 남음, {auto}',
  'hudChrome.petAction.autoAria': '{action}: {auto}',
