...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.cinematic.fade': '페이드: {percent}%',
  ...
  'editor.cinematic.play': '재생',
  'editor.cinematic.scene': '장면',
  'editor.cinematic.sceneOption': '{id} ({seconds}초)',
  'editor.cinematic.seedMismatch': '캡처에는 정식 월드 시드가 필요합니다',
  'editor.cinematic.show': '패널 표시',
  'editor.cinematic.time': '시간',
  'editor.cinematic.timeReadout': '{current} / {duration}초',
  'editor.cinematic.title': '시네마틱',
  'editor.cinematic.unavailable': '3D 뷰포트 불러오는 중',
  'editor.cinematic.violationRow': '{check} | 작업 {opIndex} | {measured}',
  'editor.cinematic.violations': '위반 항목',
  'entities.dungeons.lb_breach.enterText': '빛이 이상하고, 하늘은 더 이상하다. 심장은 앞쪽 트인 땅에 놓여 있다.',
  ...
  'entities.npcs.ferryman_ewald.greeting': '먼바다 해안으로 가나? 친구, 요즘은 고기잡이하러 바다를 건너는 사람이 없다네. 준비되면 배에 오르게. 내리면 종소리를 잘 듣게. 자네가 날씨를 살피듯, 마을 사람들은 종소리를 듣는다네.',
  'entities.npcs.ferryman_ewald.name': '뱃사공 에발트',
  'entities.npcs.ferryman_ewald.title': '건너편 해안 나루',
  'entities.npcs.ferryman_ewald_gullhaven.greeting': '먼바다 해안으로 가나? 친구, 요즘은 고기잡이하러 바다를 건너는 사람이 없다네. 준비되면 배에 오르게. 내리면 종소리를 잘 듣게. 자네가 날씨를 살피듯, 마을 사람들은 종소리를 듣는다네.',
  'entities.npcs.ferryman_ewald_gullhaven.name': '뱃사공 에발트',
  'entities.npcs.ferryman_ewald_gullhaven.title': '건너편 해안 나루',
  'entities.npcs.sergeant_marsh.greeting': '훈련은 마쳤나? 그럼 오늘 밤 일은 이렇다. 내 대열이 길을 지킨다. 균열이 우리가 감당 못 할 것을 토해 내면, 나는 자네를 가리킨다. 물방앗간은 자네 몫이다. 아무것도 자네를 따라 들어가게 하지 말고, 아무것도 우리를 지나 마을로 가게 하지 마라. 가라.',
  'entities.npcs.sergeant_marsh.name': '마시 중사',
  'entities.npcs.sergeant_marsh.title': '마을 민병대',
  'entities.quests.q_lb_q0_ashore.completion': '물방앗간 사냥은 오롯이 자네 혼자 해낸 일이고, 탐의 들것 이야기도 과장이 아니다. 정찰병은 모자라고 지킬 들판은 너무 많다. 오늘 밤 자네는 자네 몫이 아니었던 땅을 지켜 냈고, 그것이 이 일의 전부다. 감시대에 온 것을 환영한다.',
  ...
  'entities.quests.q_lb_q0_ashore.text': '걸헤이븐은 밤낮으로 균열의 습격을 받으면서도 버텨 낸다. 그들과 함께 서고자 한다면, 마을이 피 흘리는 곳에서 시작하라. 감시 초원의 민병 방어선이다. 항구 계단과 오래된 조각상 동쪽에 있다.',
  ...
  'hudChrome.memorial.close': '기념비 닫기',
  'hudChrome.memorial.dedication': '봉인을 지니고 균열 속으로 들어가 끝내 돌아오지 못한 걸헤이븐의 워든들에게. 마을은 그들을 위해 이 종을 지킨다.',
  'hudChrome.memorial.rollHeading': '명예의 명부({count})',
  'hudChrome.memorial.roomRemaining': '마지막 이름 아래 돌판은 아직 비워 둔 채다.',
  'hudChrome.memorial.title': '기념비',
  'hudChrome.mountTraining.buyReinsPrompt': '기수술을 익혔다. 마를라에게서 10골드에 발러스티드 고삐를 구입한 뒤, 사용해 탑승하자.',
  ...
  'lb.q0.coalfast.look': '잿빛 사내는 쓰러진 추적자를 바라보고, 그다음 당신을, 조금 더 오래 바라본다. 그리고 절벽 쪽으로 걸어간다.',
  'lb.q0.scene.harbor': '일하는 항구다. 그물이 마르고, 본토 구매자 앞으로 표기된 별유리 인양 상자들이 쌓여 있다.',
  'lb.q0.scene.plinth': '항구 계단 위, 청동 워든이 내륙을 향해 서 있다. 대좌에 새겨진 가장 새로운 이름도 백 년 전 것이다. 워든 헤일. 그 아래에는 아직 이름을 새길 자리가 남아 있다.',
  'lb.q0.scene.toll': '종이 한 번 울린다. 거리의 모든 사람이 걸음을 멈추고 수를 센다. 아무 일도 이어지지 않고, 거리 전체가 한꺼번에 숨을 내쉰다.',
