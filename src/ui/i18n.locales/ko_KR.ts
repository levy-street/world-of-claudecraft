...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.frostrend_hauberk.name': '서리절단 사슬갑옷',
  'entities.items.frostrend_girdle.name': '서리절단 허리띠',
  'entities.items.frostrend_legguards.name': '서리절단 다리보호구',
  'entities.items.frostrend_gauntlets.name': '서리절단 장갑',
  'entities.items.frostrend_sabatons.name': '서리절단 전투화',
  'entities.items.frostrend_choker.name': '서리절단 목걸이',
  'entities.items.frostrend_band.name': '서리절단 반지',
  'entities.npcs.frostreach_quartermaster.name': '바엘카 서리감시자',
  'entities.npcs.frostreach_quartermaster.title': '서리절경 병참장교',
  'entities.npcs.frostreach_quartermaster.greeting':
    '프론티어는 피와 서리로 값을 치른다. 영웅 점수를 현명하게 쓰라.',
