...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.secondBar': '두 번째 행동 단축바',
  'hudChrome.actionBar.barScale': '행동 단축바 크기',
  'hudChrome.actionBar.editKeys': '행동 단축바 키 편집',
  'hudChrome.actionBar.bindModeTitle': '행동 단축바 키 설정',
  'hudChrome.actionBar.bindModeHint': '칸을 클릭한 다음 지정할 키를 누르세요. 끝나면 "완료"를 클릭하세요.',
  'hudChrome.actionBar.bindReset': '초기화',
  'hudChrome.actionBar.bindResetConfirmTitle': '행동 단축바 키를 초기화할까요?',
  'hudChrome.actionBar.bindResetConfirmBody': '첫 번째 단축바는 기본 키로 돌아가고 두 번째 단축바는 미지정 상태가 됩니다. 이 작업은 되돌릴 수 없습니다.',
