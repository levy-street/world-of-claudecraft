...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bank.depositAllTooltip':
    '가방에 있는 모든 제작 재료(툴팁에 "재료"라고 표시된 모든 아이템)를 한 번에 은행에 보관합니다. 채집 도구, 퀘스트 아이템, 소모품, 회색 아이템을 포함한 나머지는 모두 가방에 남습니다.',
