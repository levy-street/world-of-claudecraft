...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.basic_mining_pick.name': 'Simpel minehakke',
  'entities.items.basic_logging_axe.name': 'Simpel skovhuggerøkse',
  'entities.items.basic_herbalists_sickle.name': 'Simpel urtesegl',
