...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberforged_hauberk.name': 'Gløddesmedet brynje',
  'entities.items.emberforged_legguards.name': 'Gløddesmedede benskinner',
  'entities.items.emberforged_girdle.name': 'Gløddesmedet bælte',
  'entities.items.cinderhide_vest.name': 'Vest af glødlæder',
  'entities.items.moltencore_maul.name': 'Smeltekernens stridskølle',
  'entities.items.brand_of_the_first_flame.name': 'Den Første Flammes brændemærke',
  'entities.items.emberseal_of_the_covenant.name': 'Den brudte pagts glødsegl',
  'entities.items.bloodember_band.name': 'Blodgløddens ring',
  'entities.items.ashcoil_signet.name': 'Askehvirvlens signetring',
