...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.readyCheck.start': "Klarhedstjek",
  'hudChrome.readyCheck.startAria': "Start klarhedstjek",
  'hudChrome.readyCheck.ready': "Klar",
  'hudChrome.readyCheck.notReady': "Ikke klar",
  'hudChrome.readyCheck.waiting': "Venter",
  'hudChrome.readyCheck.status': "{ready}/{total} klar",
