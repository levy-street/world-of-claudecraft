...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.mobile.customize": "Tilpas",
  "hudChrome.mobile.customizeTitle": "Tilpas kontroller",
  "hudChrome.mobile.customizeSlotAttack": "Grundangreb",
  "hudChrome.mobile.customizeSlotSkill": "Evne {n}",
  "hudChrome.mobile.customizeSlotUtility": "Nytte",
  "hudChrome.mobile.customizeDefault": "Klassestandard",
  "hudChrome.mobile.customizeResetSlot": "Nulstil denne plads",
  "hudChrome.mobile.customizeResetAll": "Nulstil alt til klassestandard",
  "hudChrome.mobile.customizeUpdated": "{slot} opdateret.",
  "hudChrome.mobile.customizeAllReset": "Kontroller nulstillet til klassestandard.",
  "hudChrome.options.touchControls": "Berøringsstyring",
  "hudChrome.options.clusterHold": "Redigér holdetid",
  "hudChrome.options.clusterHoldNote": "Hvor længe du skal holde en handlingsknap på skærmen, før dens bindingsredigering åbnes. Øg den, hvis du udløser redigeringen, mens du spammer evner.",
  "hudChrome.options.targetPriority": "Angrebsmålprioritet",
  "hudChrome.options.targetPriorityNearest": "Nærmeste",
  "hudChrome.options.targetPriorityLowestHp": "Lavest liv",
  "hudChrome.options.targetPriorityCurrent": "Nuværende først",
  "hudChrome.options.targetPriorityNote": "Hvad Angreb-knappen målretter, når du ikke har et gyldigt mål: den nærmeste fjende, fjenden med lavest liv inden for rækkevidde, eller behold dit nuværende mål, så længe det er gyldigt.",
  "hudChrome.options.aimAssist": "Smart evnekast",
  "hudChrome.options.aimAssistNote": "Tryk på en offensiv evne for at bruge den mod dit mål, eller den bedste fjende i nærheden, hvis du ingen har, og vend dig mod den. Hold knappen for at se evnens rækkevidde; slip med fingeren væk fra knappen for at annullere.",
  "hudChrome.options.touchReset": "Nulstil berøringsstyring",
  "hudChrome.options.touchResetDone": "Berøringsstyring gendannet til standard.",
