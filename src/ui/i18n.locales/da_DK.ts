...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Askevandrerens sandaler',
  'entities.items.cinderarc_odrenns_rod.name': 'Glødebue, Odrenns stav',
  'entities.items.cindertoad_signet.name': 'Glødetudsens signet',
  'entities.items.coalglow_band.name': 'Kulglødsring',
  'entities.items.crownforged_warleggings.name': 'Kronesmedede krigsbenklæder',
  'entities.items.glassblowers_shiv.name': 'Glaspusterens daggert',
  'entities.items.glasswalker_treads.name': 'Glasvandrerens støvler',
  'entities.items.nighttalon_prowlers.name': 'Nattekloens snigestøvler',
  'entities.items.quenchsilk_cord.name': 'Hærdningssilkesnor',
  'entities.items.ring_of_the_first_quench.name': 'Den første hærdnings ring',
  'entities.items.saans_stoking_iron.name': 'Saans ildrager',
  'entities.items.slag_tempered_sabatons.name': 'Slaggehærdede sabatons',
  'entities.items.slakeleather_belt.name': 'Hærdet læderbælte',
  'entities.items.sluicebearer.name': 'Slusebæreren',
  'entities.items.soulflame_kilt.name': 'Sjæleflammekilt',
  'entities.items.stokebrand_striders.name': 'Ildmærkets vandrestøvler',
  'entities.items.stormcallers_legwraps.name': 'Stormkalderens benvikler',
