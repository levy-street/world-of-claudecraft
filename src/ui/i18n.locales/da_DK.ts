...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Asketræsstav',
  'entities.items.gravecaller_cloth_handwraps.name': 'Gravkalderens stofhåndvikler',
  'entities.items.gravecaller_cloth_hood.name': 'Gravkalderens stofhætte',
  'entities.items.gravecaller_cloth_leggings.name': 'Gravkalderens stofbenklæder',
  'entities.items.gravecaller_cloth_mantle.name': 'Gravkalderens stofkappe',
  'entities.items.gravecaller_cloth_raiment.name': 'Gravkalderens stofdragt',
  'entities.items.gravecaller_cloth_sash.name': 'Gravkalderens stofskærf',
  'entities.items.gravecaller_cloth_slippers.name': 'Gravkalderens stoffutter',
  'entities.items.gravecaller_focus.name': 'Gravkalderens fokus',
  'entities.items.gravecaller_pendant.name': 'Gravkalderens vedhæng',
  'entities.items.gravecaller_ring.name': 'Gravkalderens ring',
  'entities.items.gravecaller_wand.name': 'Gravkalderens tryllestav',
  'entities.items.iron_broadsword.name': 'Jernbredsværd',
  'entities.items.iron_flanged_mace.name': 'Jernflangekølle',
  'entities.items.mirefen_dirk.name': 'Mirefen-dolk',
  'entities.items.mirefen_hunting_bow.name': 'Mirefen-jagtbue',
  'entities.items.mirefen_leather_belt.name': 'Mirefen-læderbælte',
  'entities.items.mirefen_leather_boots.name': 'Mirefen-læderstøvler',
  'entities.items.mirefen_leather_gloves.name': 'Mirefen-læderhandsker',
  'entities.items.mirefen_leather_hood.name': 'Mirefen-læderhætte',
  'entities.items.mirefen_leather_jerkin.name': 'Mirefen-lædervams',
  'entities.items.mirefen_leather_leggings.name': 'Mirefen-læderbenklæder',
  'entities.items.mirefen_leather_shoulderguards.name': 'Mirefen-læderskulderværn',
  'entities.items.thornpeak_bulwark.name': 'Thornpeak-bolværk',
  'entities.items.thornpeak_crossbow.name': 'Thornpeak-armbrøst',
  'entities.items.thornpeak_mail_chest.name': 'Thornpeak-ringbrynje',
  'entities.items.thornpeak_mail_gauntlets.name': 'Thornpeak-ringhandsker',
  'entities.items.thornpeak_mail_girdle.name': 'Thornpeak-ringbælte',
  'entities.items.thornpeak_mail_helm.name': 'Thornpeak-ringhjelm',
  'entities.items.thornpeak_mail_legguards.name': 'Thornpeak-ringbenværn',
  'entities.items.thornpeak_mail_pauldrons.name': 'Thornpeak-ringskulderplader',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Behov er ikke tilgængeligt, fordi din klasse ikke kan udstyre denne genstand.',
  'itemUi.lootRoll.needUnavailablePower':
    'Behov er ikke tilgængeligt, fordi denne legendariske kraft er begrænset til en anden klasse.',
  'itemUi.procedural.advancedDetailsHint': 'Hold {key} nede for at vise de mulige rulintervaller.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Hvert fjerde Dysterlyn mærker sit mål for yderligere Skyggeskade.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Askebinderens segl',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Hver anden skadevoldende besværgelse ringer omkring målet.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Klokken med det niende slag',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'At bevæge sig 15 yards giver kortvarigt øget bevægelseshastighed.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Støvlerne fra den ubrudte vej',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Hvert tredje Glødlyn svider fjender nær målet.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Det sidste ligbåls krone',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Lægende Lys beskytter modtageren med et skjold svarende til en del af helingen.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Daggryvagtens signet',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Hvert tredje Vildlyn genopretter den primære ressource.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Vildmånens spænde',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Hvert tredje våbentræf får målet til at bløde og genopretter lidt ressource.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Gråkæbes æg',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Langt Optræk eller Grumt Skud kan gøre målet tavst i kort tid.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Stilskovens langbue',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'At falde under 35% helbred giver kortvarig defensiv beskyttelse.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'De stjålne timers kappe',
  'itemUi.procedural.legendary.nightglass_fang.description': 'Et drab giver kortvarigt hast.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Natglastand',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Hvert fjerde Lysbuelyn springer til fjender i nærheden.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Stormvækkelsens afgud',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Kritisk heling skaber kortvarigt et genoprettende område på jorden.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Ysoleis vågen',
  'itemUi.procedural.legendaryLimit': 'Unikt udstyret: {count} legendarisk kraft',
  'itemUi.procedural.legendaryPower': 'Legendarisk kraft',
  'itemUi.procedural.nameFragment.deft': 'Behændig',
  'itemUi.procedural.nameFragment.mighty': 'Mægtig',
  'itemUi.procedural.nameFragment.of_alacrity': 'af Hurtighed',
  'itemUi.procedural.nameFragment.of_focus': 'af Fokus',
  'itemUi.procedural.nameFragment.of_precision': 'af Præcision',
  'itemUi.procedural.nameFragment.of_reaping': 'af Høst',
  'itemUi.procedural.nameFragment.of_remembrance': 'af Erindring',
  'itemUi.procedural.nameFragment.of_striking': 'af Slagkraft',
  'itemUi.procedural.nameFragment.sages': 'Den Vises',
  'itemUi.procedural.nameFragment.spiritual': 'Åndelig',
  'itemUi.procedural.nameFragment.stalwart': 'Standhaftig',
  'itemUi.procedural.nameFragment.warded': 'Beskyttet',
  'itemUi.procedural.powerRollMilliseconds': 'Kraftrul: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Kraftrul: {value}',
  'itemUi.procedural.powerRollPercent': 'Kraftrul: {value}%',
  'itemUi.procedural.powerRollResource': 'Kraftrul: {value} ressource',
  'itemUi.procedural.rareWord.ashen': 'Askegrå',
  'itemUi.procedural.rareWord.bite': 'Bid',
  'itemUi.procedural.rareWord.blackfen': 'Sortkær',
  'itemUi.procedural.rareWord.brand': 'Brændemærke',
  'itemUi.procedural.rareWord.doom': 'Undergang',
  'itemUi.procedural.rareWord.grave': 'Grav',
  'itemUi.procedural.rareWord.mire': 'Mose',
  'itemUi.procedural.rareWord.oath': 'Ed',
  'itemUi.procedural.rareWord.promise': 'Løfte',
  'itemUi.procedural.rareWord.storm': 'Storm',
  'itemUi.procedural.rareWord.thorn': 'Torn',
  'itemUi.procedural.rareWord.thread': 'Tråd',
  'itemUi.procedural.rareWord.vigil': 'Vågen',
  'itemUi.procedural.rareWord.ward': 'Værn',
  'itemUi.procedural.rareWord.whisper': 'Hvisken',
  'itemUi.procedural.rareWord.wyrm': 'Drageorm',
  'itemUi.procedural.rarity.common': 'Almindelig',
  ...
  'itemUi.procedural.rarity.rare': 'Sjælden',
  'itemUi.procedural.rollRangeAria': 'Muligt rul fra {min} til {max}',
  'itemUi.stats.blockValue': 'Blokeringsværdi',
  'itemUi.stats.healthOnKill': 'Helbred ved drab',
  'itemUi.stats.manaOnKill': 'Mana ved drab',
  ...
  'hudChrome.enchanting.replaceConfirmKeeps': 'Beholdt: {kept}',
  'hudChrome.enchanting.replaceConfirmKeepsBond': 'Bestillingsbinding',
  ...
  'hudChrome.enchanting.salvagedYield': 'Du genvinder {material} fra {item}.',
  'hudChrome.enchanting.salvagedYieldQty': 'Du genvinder {material} x{qty} fra {item}.',
