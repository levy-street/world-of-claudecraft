...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.dune_prowler_pelt.name': 'Klitstrejferpels',
  'entities.items.glasswind_stinger.name': 'Glasvindsbrod',
  'entities.items.stolen_relic.name': 'Stjålet relikvie',
  'entities.items.nameless_burial_shroud.name': 'Navnløst gravklæde',
  'entities.items.storm_glass_core.name': 'Stormglaskerne',
  'entities.items.verdict_seal.name': 'Domssegl',
  'entities.items.glasswind_husk.name': 'Glasvindsskal',
  'entities.items.mirage_stalker_eye.name': 'Luftspejlingslurerens øje',
  'entities.items.dig_manifest.name': 'Udgravningsmanifest',
  'entities.items.tomb_censer.name': 'Gravrøgelseskar',
  'entities.items.sentence_tablet.name': 'Domstavle',
  'entities.items.duststorm_heart.name': 'Støvstormhjerte',
  'entities.items.ravager_hide.name': 'Hærgerhud',
  'entities.items.aqueduct_bronze.name': 'Bronzebeslag fra akvædukten',
  'entities.items.judge_regalia.name': 'Den Første Domstols skrud',
  'entities.items.sunbleached_fang.name': 'Solbleget hugtand',
  'entities.items.cracked_scarab_shell.name': 'Revnet skarabæskal',
  'entities.items.emberjaw_pelt.name': 'Gløderkæbe-matriarkens pels',
  'entities.items.karns_funeral_mask.name': 'Karns gravmaske',
  'entities.items.qesh_flatbread.name': 'Qesh-fladbrød',
  'entities.items.oasis_waterskin.name': 'Oaselæderflaske',
  'entities.items.spiced_scarab_skewer.name': 'Krydret skarabæspyd',
  'entities.items.duneweave_robe.name': 'Klitvævningskåbe',
  'entities.items.caravan_guard_hauberk.name': 'Karavanevagtens brynje',
  'entities.items.prowlerhide_vest.name': 'Strejferhudsvest',
  'entities.items.sandwalker_treads.name': 'Sandvandrertrin',
  'entities.items.dunewatch_legguards.name': 'Klitvagtens benskinner',
  'entities.items.qesh_khopesh.name': 'Qesh-khopesh',
  'entities.items.judgestaff_of_ossara.name': 'Ossaras dommerstav',
  'entities.items.glasswind_talon.name': 'Glasvindsklo',
  'entities.items.emberjaw_prowlgrips.name': 'Gløderkæbens jagtgreb',
  'entities.items.unburied_gravewraps.name': 'Den Ubegravedes gravsvøb',
  'entities.items.sandmaw_scale_cuirass.name': 'Sandgabets skælkyras',
  'entities.items.tyrantfang_edge.name': 'Tyranklinge',
  'entities.items.palewidow_silk.name': 'Blegenkesilke',
  'entities.items.waterlogged_ledger.name': 'Gennemblødt regnskabsbog',
  'entities.items.guildless_sigil.name': 'De lavløses segl',
  'entities.items.silent_court_seal.name': 'Den Tavse Domstols segl',
  'entities.items.duskmane_pelt_strip.name': 'Skumringsmanke-pelsstrimmel',
  'entities.items.palewidow_venom_sac.name': 'Blegenkens giftsæk',
  'entities.items.quay_manifest.name': 'Gennemblødt kajmanifest',
  'entities.items.wisplight_essence.name': 'Lygtemandsessens',
  'entities.items.drowned_toll_coin.name': 'Druknet vejafgiftsmønt',
  'entities.items.cutthroat_contract.name': 'Halsafskærerkontrakt',
  'entities.items.court_ledger_page.name': 'Side af domstolsbogen',
  'entities.items.frostpine_war_totem.name': 'Frostfyrrens krigstotem',
  'entities.items.rimeclaw_pelt.name': 'Rimklopels',
  'entities.items.duskmane_tuft.name': 'Skumringsmanketot',
  'entities.items.guttering_wisp_mote.name': 'Flakkende lygtemandsstøv',
  'entities.items.frostpine_charm.name': 'Frostfyrreamulet',
  'entities.items.palefang_pelt.name': 'Blegtand den Tavses pels',
  'entities.items.grelnoks_frozen_idol.name': 'Grelnoks frosne gudebillede',
  'entities.items.nighthollow_black_bread.name': 'Nathulens sorte brød',
  'entities.items.pinefrost_tea.name': 'Fyrrefrost-te',
  'entities.items.smoked_blackmere_eel.name': 'Røget Sortsø-ål',
  'entities.items.wispweave_robe.name': 'Lygtemandsvævet kåbe',
  'entities.items.quayguard_hauberk.name': 'Kajvagtens brynje',
  'entities.items.duskstalker_vest.name': 'Skumringsluskerens vest',
  'entities.items.nightpath_treads.name': 'Natstitrin',
  'entities.items.blackriver_legguards.name': 'Sortflodens benskinner',
  'entities.items.terracewatch_leggings.name': 'Terrassevagtens bukser',
  'entities.items.quays_cutlass.name': 'Kajens huggert',
  'entities.items.wispcaller_staff.name': 'Lygtemandskalderens stav',
  'entities.items.whispersteel_stiletto.name': 'Hviskestålstilet',
  'entities.items.palefang_grips.name': 'Blegtandsgreb',
  'entities.items.hoarbound_bindings.name': 'Den Rimbundnes lænker',
  'entities.items.forsworn_lamellar.name': 'Edsbryderens lamelkyras',
  'entities.items.forsworn_edge.name': 'Edsbryderens klinge',
  'entities.items.stolen_tithe_ledger.name': 'Stjålet tiendebog',
  'entities.items.granite_core_shard.name': 'Granitkerneskår',
  'entities.items.legion_deserter_insignia.name': 'Legionsdesertørens emblem',
  'entities.items.chewed_tithe_scrip.name': 'Tygget tiendeseddel',
  'entities.items.candle_tax_tally.name': 'Lysskattens regnskabsbrik',
  'entities.items.assay_office_seal.name': 'Prøvekammerets segl',
  'entities.items.legion_pay_manifest.name': 'Legionens lønningsliste',
  'entities.items.prime_wolf_pelt.name': 'Førsteklasses ulvepels',
  'entities.items.wendigo_gallstone.name': 'Wendigo-galdesten',
  'entities.items.icehowler_ruff.name': 'Ishylerens halskrave',
  'entities.items.legion_quarrel_bundle.name': 'Bundt legionsbolte',
  'entities.items.clipped_imperial_coin.name': 'Beklippet kejsermønt',
  'entities.items.rimewoven_hide.name': 'Rimvævet hud',
  'entities.items.sellsword_pig_iron.name': 'Lejesvends råjern',
  'entities.items.lean_wolf_haunch.name': 'Mager ulvekølle',
  'entities.items.pilfered_ration_pack.name': 'Rapset rationspakke',
  'entities.items.sellsword_requisition_chit.name': 'Lejesvends rekvisitionsseddel',
  'entities.items.frostbrush_wolf_fang.name': 'Frostkrats ulvetand',
  'entities.items.bent_legion_buckle.name': 'Bøjet legionsspænde',
  'entities.items.ogre_knuckle_dice.name': 'Ogre-knoterninger',
  'entities.items.hoarfang_pelt.name': 'Rimtand-alfaens pels',
  'entities.items.kazriks_brass_whistle.name': 'Kazriks messingfløjte',
  'entities.items.kaelspire_barley_loaf.name': 'Kaelspir-bygbrød',
  'entities.items.silverbrook_spring_water.name': 'Sølvbæk-kildevand',
  'entities.items.imperial_field_ration.name': 'Kejserlig feltration',
  'entities.items.imperial_clerks_robe.name': 'Kejserskriverens kåbe',
  'entities.items.kael_infantry_hauberk.name': 'Kael-infanteribrynje',
  'entities.items.wolfsward_hunting_jerkin.name': 'Ulvevagtens jagttrøje',
  'entities.items.tithe_road_marchboots.name': 'Tiendevejens marchstøvler',
  'entities.items.imperial_marcher_legguards.name': 'Kejsermarchørens benskinner',
  'entities.items.kael_arming_sword.name': 'Kael-ridderssværd',
  'entities.items.frosthelm_warstaff.name': 'Frosthjelms krigsstav',
  'entities.items.wolfsward_skinner.name': 'Ulvevagtens flåkniv',
  'entities.items.prefects_sealed_mantle.name': 'Præfektens forseglede kappe',
  'entities.items.huntmasters_winter_hood.name': 'Jagtmesterens vinterhætte',
  'entities.items.hoarfang_clawgrips.name': 'Rimtandens klogreb',
  'entities.items.overseers_candlewraps.name': 'Opsynsmandens lysbind',
  'entities.items.oathbreakers_battleplate.name': 'Edsbryderens kamppanser',
  'entities.items.oathbreakers_greatblade.name': 'Edsbryderens storklinge',
  'entities.items.grey_shale_chip.name': 'Gråskiferflis',
  'entities.items.smuggled_trinket.name': 'Smuglet nipsgenstand',
  'entities.items.barbed_thorn_husk.name': 'Modhaget tornebælg',
  'entities.items.thornfen_tusk.name': 'Tornemosens troldetand',
  'entities.items.torn_caravan_banner.name': 'Iturevet karavanebanner',
  'entities.items.ironpass_rubble_core.name': 'Jernpassets murbrokkekerne',
  'entities.items.wyvern_tail_barb.name': 'Wyvernhalebrod',
  'entities.items.reagent_gland.name': 'Reagensbullen kirtel',
  'entities.items.fogged_lantern_glass.name': 'Dugget lygteglas',
  'entities.items.river_worn_idol.name': 'Flodslebet gudebillede',
  'entities.items.gull_picked_bone.name': 'Mågehakket knogle',
  'entities.items.underway_hardtack.name': 'Undervejens beskøjt',
  'entities.items.smugglers_black_brew.name': 'Smuglerens sorte bryg',
  'entities.items.thornberry_loaf.name': 'Tornebærbrød',
  'entities.items.palisade_pine_tea.name': 'Palisadens fyrrete',
  'entities.items.tollhouse_stew.name': 'Bomhusets sammenkogte ret',
  'entities.items.ironpass_mulled_cider.name': 'Jernpassets varme cider',
  'entities.items.lanternfen_eel_skewer.name': 'Lygtemosens ålespyd',
  'entities.items.fogberry_tonic.name': 'Tågebærtonikum',
  'entities.items.bridgewatch_rations.name': 'Brovagtens rationer',
  'entities.items.nameless_river_water.name': 'Den navnløse flods vand',
  'entities.items.smuggler_kings_softsteps.name': 'Smuglerkongens listesko',
  'entities.items.briarfather_bark_mitts.name': 'Tornefaderens barkluffer',
  'entities.items.skarns_war_harness.name': 'Skarns krigsseletøj',
  'entities.items.colossus_mireheart_girdle.name': 'Dyndhjertebælte',
  'entities.items.bridgekeepers_tollstaff.name': 'Brovogterens vejafgiftsstav',
  'entities.items.melted_ration_tin.name': 'Smeltet rationsdåse',
  'entities.items.ashcaked_fang.name': 'Askeskorpet hugtand',
  'entities.items.ember_glass_shard.name': 'Gløderglasskår',
  'entities.items.saltglass_shard.name': 'Saltglasskår',
  'entities.items.salt_crusted_chitin.name': 'Saltskorpet kitin',
  'entities.items.bleached_bone_charm.name': 'Bleget knogleamulet',
  'entities.items.tarnished_prewar_coin.name': 'Anløben førkrigsmønt',
  'entities.items.sewer_silk_wad.name': 'Kloaksilkenøgle',
  'entities.items.gutter_hound_pelt.name': 'Rendestenshundepels',
  'entities.items.cracked_salamander_scale.name': 'Revnet salamanderskæl',
  'entities.items.cooled_magma_bead.name': 'Afkølet magmaperle',
  'entities.items.slag_nugget.name': 'Slaggeklump',
  'entities.items.rusted_deserter_badge.name': 'Rusten desertørplade',
  'entities.items.redspire_rock_shard.name': 'Rødspir-klippeskår',
  'entities.items.spire_stalker_claw.name': 'Spirluskerens klo',
  'entities.items.cinderrest_ashcake.name': 'Gløderhvilens askekage',
  'entities.items.boiled_cistern_water.name': 'Kogt cisternevand',
  'entities.items.brinehollow_salt_jerky.name': 'Salthulens saltkød',
  'entities.items.desalted_waterskin.name': 'Afsaltet læderflaske',
  'entities.items.gutter_stew.name': 'Eksilmarkedets rendestensret',
  'entities.items.black_market_tea.name': 'Sortbørste',
  'entities.items.forgefall_hardtack.name': 'Smedefaldets beskøjt',
  'entities.items.coalfire_stout.name': 'Kulilds-stout',
  'entities.items.waymeet_marching_bread.name': 'Vejmødets marchbrød',
  'entities.items.bitterroot_brew.name': 'Bitterrodsbryg',
  'entities.items.revenant_cinderguard.name': 'Genfærdets askevogter',
  'entities.items.marrowhide_leggings.name': 'Marvhudsbukser',
  'entities.items.scavenger_kings_shiv.name': 'Ådselkongens skærv',
  'entities.items.forgewyrm_scale_helm.name': 'Smedeormens skælhjelm',
  'entities.items.mantle_of_the_last_muster.name': 'Den Sidste Mønstrings kappe',
  'entities.items.scorched_banner_scrap.name': 'Svedet bannerlas',
  'entities.items.melted_signet_ring.name': 'Smeltet signetring',
  'entities.items.cracked_horror_horn.name': 'Revnet rædselshorn',
  'entities.items.bastion_hardtack.name': 'Bastionens beskøjt',
  'entities.items.trucewater_flask.name': 'Våbenhvileflaske',
  'entities.items.ashguard_robe.name': 'Askevogterkåbe',
  'entities.items.breachwalker_jerkin.name': 'Breche-vandrerens trøje',
  'entities.items.bastion_plated_hauberk.name': 'Bastionens pladebrynje',
  'entities.items.bastion_arming_sword.name': 'Bastionens riddersværd',
  'entities.items.mercenary_greatblade.name': 'Lejesvends storklinge',
  'entities.items.tithe_collectors_grasps.name': 'Tiendeopkræverens greb',
  'entities.items.craterheart_mantle.name': 'Kraterhjertekappe',
  'entities.items.butchers_chainguard.name': 'Slagterens kædeværn',
