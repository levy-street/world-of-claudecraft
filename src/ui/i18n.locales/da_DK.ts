...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.meters.loot': 'Bytte',
  'hud.meters.lootShort': 'Bytte',
  'hud.meters.lootHistory': 'Historik',
  'hud.meters.noLoot': 'Intet bytte registreret endnu.',
  'hud.meters.recentAwards': '{count} seneste tildelinger',
  'hud.meters.methodReturned': 'Sprunget over',
  'hud.meters.methodMaster': 'Mester',
  'hud.meters.methodPersonal': 'Personlig',
  'hud.meters.methodDelve': 'Delve',
  'hud.meters.methodLooted': 'Plyndret',
  'hud.meters.noWinner': 'Ingen vinder',
