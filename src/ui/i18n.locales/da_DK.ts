...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'loading.reconnecting': "Forbindelsen blev afbrudt. Genopretter...",
  'hudChrome.crafting.close': "Luk fremstilling",
  'hudChrome.crafting.craft': "Fremstil",
  'hudChrome.crafting.craftedToast': "Fremstillet: {name}",
  'hudChrome.crafting.empty': "Ingen opskrifter kendt endnu.",
  'hudChrome.crafting.insufficientMaterials': "Du har ikke materialerne til det.",
  'hudChrome.crafting.reagentLine': "{name} x{have}/{required}",
  'hudChrome.crafting.reagentsNeeded': "Kræver:",
  'hudChrome.crafting.resultAria': "Fremstil {name}",
  'hudChrome.crafting.title': "Fremstilling",
  ...
  'hudChrome.mobile.targetCycle': "Skift mål",
  'hudChrome.mobile.targetCycleShort': "Mål",
  'hudChrome.options.mobileCameraJoystick': "Kamerajoystick",
  'hudChrome.options.mobileLeftHanded': "Venstrehåndslayout",
};
