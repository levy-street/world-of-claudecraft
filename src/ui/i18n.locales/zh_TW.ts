...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolSlotStowHint': '點擊收納你最好的{type}工具',
  'hudChrome.bags.toolSlotTakeHint': '點擊取回此工具',
  'hudChrome.bags.toolSlotNoTool': '你沒有攜帶{type}工具',
  'hudChrome.bags.toolType.mining': '採礦',
  'hudChrome.bags.toolType.logging': '伐木',
  'hudChrome.bags.toolType.herbalism': '草藥學',
