...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'landing.heroEyebrow': '世界早已開始運轉',
  'landing.heroHeading': '一個鮮活的經典 MMO，玩家與 AI 冒險者共同面對同一世界。',
  'landing.heroBody': '在瀏覽器中免費遊玩，從九大職業中塑造英雄，或讓代理在真實遊戲中訓練。',
  'landing.heroStatus': '世界在線',
  'landing.heroPlayers': '名已註冊冒險者',
  'landing.communityLinks': '社群連結',
  'landing.followSocials': '關注我們的社群媒體',
  'landing.socialDiscord': 'Discord 社群',
  'landing.socialTwitch': 'Twitch 實況',
  'landing.socialInstagram': 'Instagram 官方帳號',
  'landing.socialReddit': 'Reddit 社群',
  'landing.browserCta': '在瀏覽器中遊玩',
  'landing.playNowBody': '開啟瀏覽器即可遊玩，無需下載。',
  'landing.playWayBody': '選擇你的平台，加入這場冒險。',
  'landing.syncProgress': '在所有平台間同步遊戲進度',
  'landing.explore': '探索這個世界',
  'landing.platformsEyebrow': '隨時隨地踏上冒險',
  'landing.appStoreAria': '在 App Store 下載 World of ClaudeCraft',
  'landing.googlePlayAria': '在 Google Play 取得 World of ClaudeCraft',
  'landing.steamAria': 'World of ClaudeCraft 即將登上 Steam',
  'landing.comingSoon': '即將推出',
  'landing.introEyebrow': '同一個世界，同一套規則',
  'landing.introHeading': '每位冒險者都在真實遊戲中戰鬥。',
  'landing.introBody':
    '瀏覽器 MMO、權威線上世界和 AI 訓練都運行於同一個確定性模擬中。玩家與代理面對相同的戰鬥、任務、地城和後果。',
  'landing.statClasses': '9 個可玩職業',
  'landing.statModes': '線上與離線世界',
  'landing.statBroadcast': '全天候 AI 直播',
  'landing.statSource': '開放原始碼',
  'landing.worldEyebrow': '穿越 Claudemoon',
  'landing.worldHeading': '一個為漫漫長路與危機四伏的夜晚而生的世界。',
  'landing.worldBody':
    '從 Eastbrook Vale 的營火旁啟程，深入鬧鬼的地穴，再攀上 Thornpeak 的風暴之巔。每條道路都通往這個不斷運轉的世界深處。',
  'landing.eastbrookTitle': '東溪谷',
  'landing.eastbrookBody': '一片共享的邊境，初次任務、遊蕩敵人與意外盟友都在此相遇。',
  'landing.eastbrookAlt': '冒險者隊伍沿著從東溪谷通往荊棘峰高地的漫長道路前行',
  'landing.hollowTitle': 'Hollow Crypt',
  'landing.hollowBody': '在冰冷的藍色火炬下並肩作戰，不安的亡者正成群聚集。',
  'landing.hollowAlt': '一支隊伍在 Hollow Crypt 中迎戰敵人',
  'landing.thornpeakTitle': '荊棘峰高地',
  'landing.thornpeakBody': '雲層之上，白雪、古老廢墟與終局威脅正在等待。',
  'landing.thornpeakAlt': '雪花飄落在 Thornpeak Heights',
  'landing.classesEyebrow': '選擇你的傳奇',
  'landing.classesHeading': '九種道路，無數戰鬥方式。',
  'landing.classesBody':
    '堅守盾牆，駕馭烈焰與寒霜，潛行於陰影，或守護隊友。塑造英雄，精通專精，並把這段故事帶入共享世界。',
  'landing.streamEyebrow': '全天候直播',
  'landing.streamNetwork': 'WOC 直播網路',
  'landing.streamFeed': 'YUUMIII // 直播畫面',
  'landing.streamMonogram': 'Y',
  'landing.streamHeading': 'Yuumiii 永不下線。',
  'landing.streamBody': 'World of ClaudeCraft 的常駐 AI 實況主全天候直播遊玩這個世界。',
  'landing.streamWatch': '在 Twitch 觀看',
  'landing.streamLoading': '正在開啟觀景傳送門...',
  'landing.streamReady': '觀景傳送門已就緒。按下播放即可觀看 Yuumiii。',
  'landing.streamOnline': 'Yuumiii 正在直播。',
  'landing.streamOffline': '觀景傳送門正在重新連線。開啟 Twitch 頻道即可繼續觀看。',
  'landing.streamCompact': '開啟 Twitch 頻道，在此螢幕上觀看 Yuumiii。',
  'landing.streamUnavailable': '觀景傳送門暫時無法使用。開啟 Twitch 頻道即可繼續觀看。',
  'landing.openEyebrow': '開放世界，開放程式碼',
  'landing.openHeading': '複製這個世界，訓練一名冒險者。',
  'landing.openBody':
    '探索原始碼，託管自己的世界，或將相容 Gymnasium 的代理接入玩家每天進入的同一個確定性遊戲。',
  'landing.supportEyebrow': '讓這個世界繼續運轉',
  'landing.supportHeading': '創造、遊玩，並支持下一篇章。',
  'landing.supportBody':
    'World of ClaudeCraft 在開放協作中成長。加入社群，關注鮮活世界，或支持持續開發。',
  'landing.xCta': '在 X 上關注',
  'landing.patchNotesLabel': '更新說明',
  'landing.patchNotesTitle': '更新說明',
  'landing.patchNotesDesc': '查看最新的玩法變更、問題修正和版本詳情。',
  'landing.patchNotesLoading': '正在載入最新更新說明…',
  'landing.patchNotesError': '無法載入更新說明，請稍後再試。',
  'landing.patchNotesEmpty': '目前沒有更新說明，請稍後再回來查看。',
  'landing.patchNotesPrerelease': '預先發佈版',
  'landing.patchNotesViewOnGithub': '在 GitHub 上查看版本',
  'landing.newsEyebrow': '來自世界的消息',
  'landing.newsTitle': 'Claudemoon 新聞',
  'landing.newsBody': '關注 World of ClaudeCraft 的最新動態，探索這個世界背後的故事。',
  'landing.newsXTitle': 'X 最新動態',
  'landing.newsXIntro': '@WoClaudecraft 的官方貼文',
  'landing.newsXPrivacy': '載入此動態消息將連線至 X，X 可能會收到與你此次瀏覽相關的資訊。',
  'landing.newsXLoad': '載入 X 動態消息',
  'landing.newsXRetry': '再試一次',
  'landing.newsXHide': '隱藏 X 動態消息',
  'landing.newsXOpen': '在 X 上開啟 @WoClaudecraft',
  'landing.newsXNewTab': '在新分頁中開啟',
  'landing.newsXLoading': '正在開啟 X 動態消息…',
  'landing.newsXUnavailable': '無法載入 X 動態消息。你仍可直接前往 X 查看所有貼文。',
  'landing.newsXIframeTitle': 'X 上 @WoClaudecraft 的最新貼文',
  'landing.newsBlogEyebrow': 'CLAUDEMOON 紀事',
  'landing.newsBlogTitle': '最新故事',
  'landing.newsBlogEmptyTitle': '第一篇故事正在撰寫',
  'landing.newsBlogEmptyBody': '新聞和幕後故事即將發佈在這裡。',
  'landing.newsXOpenAria': '在新分頁中開啟 X 上的 @WoClaudecraft',
  'landing.newsXLoaded': 'X 動態消息已載入。',
  'landing.newsXHidden': 'X 動態消息已隱藏。你仍可直接在 X 上開啟該帳號頁面。',
  'landing.twitchCategoryCta': '探索 World of ClaudeCraft 實況',
  'landing.finalEyebrow': '你的故事始於大門',
  'landing.finalHeading': '選擇你進入 Claudemoon 的方式。',
  'landing.finalBody': '立即在瀏覽器中遊玩，在行動裝置上繼續冒險，或等待 Steam 版本。',
  ...
  'mode.onlineDesc': '在即時伺服器上遊玩。你的角色將在線上保存。',
  'mode.onlineAria': '線上遊玩：登入持久共享的世界',
  'mode.offlineTitle': '單機試玩',
  'mode.offlineDesc': '在瀏覽器中遊玩本機離線世界。進度不會保存。',
  ...
  'mode.serverAria': '選擇伺服器模式：伺服器線上或伺服器離線',
  'mode.serverLabel': '選擇你的世界',
  'mode.serverOffline': '伺服器離線',
  'mode.serverOfflineSub': '本機離線世界',
  'mode.serverOnline': '伺服器線上',
  ...
  'landing.streamExploreSub': '探索克勞德之月',
  'landing.streamHeroSubtitle': '你的常駐 AI 主播，全天候探索這個世界。',
  'landing.streamMeet': '認識你的嚮導',
  'landing.streamHostTitle': '常駐 AI 主播',
  'landing.streamHostBody': '與 Yuumiii 一起日夜探索 World of ClaudeCraft 的每一個角落。',
  'landing.streamPortraitAlt': 'World of ClaudeCraft 的常駐 AI 主播 Yuumiii',
  'landing.streamAlwaysTitle': '24/7 直播',
  'landing.streamAlwaysBody': '始終在線，永不停下冒險。',
  'landing.streamAiTitle': 'AI 主播',
  'landing.streamAiBody': '由 AI 驅動，帶來真實反應和無盡樂趣。',
  'landing.streamCommunityTitle': '社群',
