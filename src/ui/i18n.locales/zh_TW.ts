...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.character.tabs.equipment': '裝備',
  'hudChrome.character.tabs.overview': '總覽',
  'hudChrome.character.balances.claudium': '克勞迪姆',
  'hudChrome.character.bagSocket': '背包欄位：{name}',
  'hudChrome.character.sections.attributes': '屬性',
  'hudChrome.character.sections.combat': '戰鬥',
  'hudChrome.character.sections.defense': '防禦',
  'hudChrome.character.spec.choose': '選擇',
  'hudChrome.character.spec.change': '更改',
  'hudChrome.character.bags.openFull': '開啟背包視窗',
  'hudChrome.character.bags.container': '背包 {n}',
  'hudChrome.character.bags.emptySpaces': '空位',
  'hudChrome.character.bags.emptySummary': '+{count} 個空位',
  'character.sortBy': '排序',
