...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.tin_ore.name': '錫礦石',
  'entities.items.iron_ore.name': '鐵礦石',
  'entities.items.copper_bar.name': '銅錠',
  'entities.items.tin_bar.name': '錫錠',
  'entities.items.bronze_bar.name': '青銅錠',
  'entities.items.bronzeclasp_gauntlets.name': '青銅扣護手',
  'entities.items.clawspur_dirk.name': '爪刺匕首',
  'entities.items.iron_bar.name': '鐵錠',
  'entities.items.thorium_bar.name': '釷錠',
  ...
  'entities.items.beast_claw.name': '野獸利爪',
  'entities.items.boar_tusk.name': '野豬獠牙',
