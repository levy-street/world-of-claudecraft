...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_undermount_heat.text':
    '狂信徒在掘石旁蜂擁，我就讀不懂那些石頭，{playerName}。Wyrmcult 日夜經營這道裂隙，岩石在離任何火焰百步外都還發熱。削弱他們，給我買來一小時清靜。',
  'entities.quests.q_undermount_heat.completion':
    '很好。現在我能幹活了。這些不是鐵匠的工印，{playerName}。它們是結界，而且有什麼東西一直在切開它們。',
  'entities.quests.q_undermount_heat.objectives.0.label': '已擊殺 Wyrmcult 狂信徒',
  'entities.quests.q_undermount_ledger.title': '邪教埋藏之物',
  'entities.quests.q_undermount_ledger.text':
    '死靈法師記錄著鍛爐產出了什麼。打垮足夠多的他們，我就能拼出真相。我想知道這些熱量究竟流向何處。',
  'entities.quests.q_undermount_ledger.completion':
    '向下。每一塊錠，每一點餘燼，全都耗在我們腳下，{playerName}。他們不是在這裡製造東西。鍛爐是一只蓋子。',
  'entities.quests.q_undermount_ledger.objectives.0.label': '已擊殺 Wyrmcult 死靈法師',
  'entities.quests.q_undermount_descent.title': '進入地底山',
  'entities.quests.q_undermount_descent.text':
    '還有一個儀式首領掌控著內圈。放倒他，在你抵達底部之前，邪教就無法完成他們開頭的事。',
  'entities.quests.q_undermount_descent.completion':
    '從來沒有什麼工廠，{playerName}。從來只有他，以及一層非常高明的偽裝。我要和你一起下去。無論他們讓什麼東西沉睡，我們都要提前喚醒它。',
  'entities.quests.q_undermount_descent.objectives.0.label': '已擊殺 Wyrmcult 儀式首領',
