...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.playtestBack': '返回編輯器',
  'editor.playtestBackTitle': '返回地圖編輯器（試玩開始時地圖已儲存）',
  'hudChrome.deepglass.bout': '每方{n}人',
  'hudChrome.deepglass.boutAria': '開始一場深球比賽，每方{n}人',
  'hudChrome.deepglass.gossip': '帶我下到深玻璃',
  'hudChrome.deepglass.gossipAria': '前往深玻璃並開始一場深球比賽',
  'hudChrome.keybinds.ballMarker': '球標記（深球）',
  'hudChrome.keybinds.boost': '燃燒器（深球）',
  'hudChrome.plotSign.boughtLog': '{name}的地契歸你所有。',
  'hudChrome.plotSign.buy': '以{price}購買',
  'hudChrome.plotSign.close': '關閉',
  'hudChrome.plotSign.price': '售價 {price}',
  'hudChrome.plotSign.purse': '你身上有 {purse}。',
  'hudChrome.plotSign.size': '{size}地塊，{w}乘{d}碼',
  'hudChrome.plotSign.sizes.large': '大',
  'hudChrome.plotSign.sizes.medium': '中',
  'hudChrome.plotSign.sizes.small': '小',
  'hudChrome.plotSign.sold': '已售出。{name}持有這份地契。',
  'hudChrome.plotSign.title': '待售住宅地塊',
  'hudChrome.plotSign.yours': '你持有這份地契。',
  'hudChrome.portalWizard.gossipDeepglass': '為我打開通往深玻璃的路',
  'hudChrome.portalWizard.gossipDeepglassAria': '請巴爾德馬開啟通往深玻璃的傳送門',
  'hudChrome.portalWizard.gossipHome': '為我打開回家的路',
  'hudChrome.portalWizard.gossipHomeAria': '請巴爾德馬開啟回到你所在城鎮的傳送門',
  'hudChrome.portalWizard.portalOpen': '傳送門已開啟。走進去吧。',
  'entities.npcs.deepglass_marshal.greeting':
    '鐘內水暖清澈，{className}。說出你要的賽制，我就吹哨開賽：單打讓你獨佔球，或是三對三讓你有人可以怪罪。',
  'entities.npcs.deepglass_marshal.name': '元帥伊薇特·珊瑚醒',
  'entities.npcs.deepglass_marshal.title': '哨令守護者',
  'entities.npcs.dg_stallkeeper_favors.greeting':
    '贏了裝錢用小袋，輸了裝愁緒用大袋。親愛的，買小袋吧，那才是樂觀的選擇。',
  'entities.npcs.dg_stallkeeper_favors.name': '旗婆溫恩',
  'entities.npcs.dg_stallkeeper_favors.title': '紀念品與旗幟',
  'entities.npcs.dg_stallkeeper_pies.greeting':
    '熱派餅、冷水，還有比排隊還耐放的肉乾。朋友，趁哨聲響起前吃完吧，下半場可不等你的肚子。',
  'entities.npcs.dg_stallkeeper_pies.name': '派餅匠羅爾多',
  'entities.npcs.dg_stallkeeper_pies.title': '比賽日補給',
  'entities.npcs.dg_stallkeeper_tonics.greeting':
    '瘀傷藥劑、鎮定藥劑，還有一小杯專治堤道墜落驚魂的烈酒。前兩樣是選手買的，第三樣是觀眾買的。',
  'entities.npcs.dg_stallkeeper_tonics.name': '賽拉·藥瓶',
  'entities.npcs.dg_stallkeeper_tonics.title': '藥劑與烈酒',
  'entities.npcs.portal_wizard_bridgemere.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_bridgemere.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_bridgemere.title': '光頭大法師',
  'entities.npcs.portal_wizard_deepglass.greeting':
    '早說了我會先到。禿頭走得輕快，{className}。好好享受鐘裡的樂趣，小心玻璃，等你想念家鄉的草地時，說一聲就好：回去的路，只差一個閃亮的念頭。',
  'entities.npcs.portal_wizard_deepglass.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_deepglass.title': '光頭大法師',
  'entities.npcs.portal_wizard_drifthaven.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_drifthaven.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_drifthaven.title': '光頭大法師',
  'entities.npcs.portal_wizard_eastbrook.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_eastbrook.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_eastbrook.title': '光頭大法師',
  'entities.npcs.portal_wizard_eldergleam.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_eldergleam.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_eldergleam.title': '光頭大法師',
  'entities.npcs.portal_wizard_fenbridge.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_fenbridge.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_fenbridge.title': '光頭大法師',
  'entities.npcs.portal_wizard_gallowmere.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_gallowmere.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_gallowmere.title': '光頭大法師',
  'entities.npcs.portal_wizard_gullhaven.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_gullhaven.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_gullhaven.title': '光頭大法師',
  'entities.npcs.portal_wizard_hedgewick.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_hedgewick.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_hedgewick.title': '光頭大法師',
  'entities.npcs.portal_wizard_highwatch.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_highwatch.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_highwatch.title': '光頭大法師',
  'entities.npcs.portal_wizard_icemantle.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_icemantle.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_icemantle.title': '光頭大法師',
  'entities.npcs.portal_wizard_lanternmere.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_lanternmere.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_lanternmere.title': '光頭大法師',
  'entities.npcs.portal_wizard_moonrest.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_moonrest.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_moonrest.title': '光頭大法師',
  'entities.npcs.portal_wizard_wickharbor.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_wickharbor.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_wickharbor.title': '光頭大法師',
  'entities.npcs.portal_wizard_wyrmwatch.greeting':
    '沒錯，頭頂是光的，也不，不是山風吹的。頭髮是錨，{className}：每一根髮絲都把靈魂繫在一方土地上。我把我的全都換成了通往世界各地的門。開口吧，我會為你開啟通往深玻璃的路。我的另一個自己已經在那裡了，正摩挲著他的頭討個好運。',
  'entities.npcs.portal_wizard_wyrmwatch.name': '光頭巴爾德馬',
  'entities.npcs.portal_wizard_wyrmwatch.title': '光頭大法師',
  'entities.npcs.th_armourer.greeting':
    '巡防隊所需的一切裝備，還有一些不該有的。守護官出錢，你付得更少。',
  'entities.npcs.th_armourer.name': '軍需官魯克·阿德林',
  'entities.npcs.th_armourer.title': '大軍械庫',
  'entities.npcs.th_banker.greeting':
    '與其讓錢幣留在你口袋裡冒五十碼高空墜落的風險，不如放進岩石裡更安全，{className}。',
  'entities.npcs.th_banker.name': '錢庫守護者安塞爾·潮',
  'entities.npcs.th_banker.title': '深玻璃寶庫',
  'entities.npcs.th_clerk.greeting': '陳情放左邊，賽程爭議放右邊，有關堤道欄杆的一切都放我桌上。',
  'entities.npcs.th_clerk.name': '書記官奧托琳·維克斯',
  'entities.npcs.th_clerk.title': '守護官廳',
  'entities.npcs.th_fountain_keeper.greeting':
    '噴泉裡流的是鐘的自有活水，{className}，若你相信守護官們所言，是從堤道底下引上來的。巴爾德馬喜歡讓水花噴在他頭上，他說這樣能讓禿頭保持閃亮。',
  'entities.npcs.th_fountain_keeper.name': '噴泉總管布林·卡多克',
  'entities.npcs.th_fountain_keeper.title': '守護官噴泉看守人',
  'entities.npcs.th_gate_captain.greeting':
    '潮堡守護著鐘，{className}，而我守護著潮堡。堤道暢通，市集熱鬧，守護官也在。回程下坡時，小心欄杆。',
  'entities.npcs.th_gate_captain.name': '城門隊長伊索德·布拉克',
  'entities.npcs.th_gate_captain.title': '潮門守衛',
  'entities.npcs.th_innkeeper.greeting':
    '床鋪、餐食，還有一扇面向鐘的窗。比賽夜你不會想睡，反正你也不想睡。若想找同伴，門邊的告示板上有消息。',
  'entities.npcs.th_innkeeper.name': '客棧老闆多夫·馬羅',
  'entities.npcs.th_innkeeper.title': '鍍金海鷗',
  'entities.npcs.th_lamplighter.greeting':
    '從堤道到守護官座，每一盞燈都歸我管，天黑前都得照看一遍。想的話跟我上去看看，這是全城最好走的一段路。',
  'entities.npcs.th_lamplighter.name': '點燈人昂德里',
  'entities.npcs.th_lamplighter.title': '水晶燈守護者',
  'entities.npcs.th_market_bags.greeting':
    '玻璃市場的東西可不是用手捧得回家的，{className}。問我怎麼知道的就對了。',
  'entities.npcs.th_market_bags.name': '行囊師赫斯特',
  'entities.npcs.th_market_bags.title': '背包與繩結',
  'entities.npcs.th_market_pies.greeting':
    '剛從守護官街爐灶出爐的，{className}。趁熱在這裡吃吧，帶出露台一半都會被風吹走。',
  'entities.npcs.th_market_pies.name': '瑪拉·鹽湖',
  'entities.npcs.th_market_pies.title': '麵包與鹽滷',
  'entities.npcs.th_market_reagents.greeting':
    '守護官街鍛造出來的一切，都是靠人背著堤道扛上來的。多半是我的背。',
  'entities.npcs.th_market_reagents.name': '礦石商鄧恩',
  'entities.npcs.th_market_reagents.title': '礦、錠與花',
  'entities.npcs.th_market_tonics.greeting':
    '瘀傷藥劑、鎮定藥劑，還有專治墜落的。深球選手是我最好的顧客。',
  'entities.npcs.th_market_tonics.name': '藥劑師蕾恩·菲爾',
  'entities.npcs.th_market_tonics.title': '藥劑與烈酒',
  'entities.npcs.th_merchant.greeting':
    '半個王國的貨物都為了賽事送上這裡來。買賣自便，排隊請守秩序。',
  'entities.npcs.th_merchant.name': '商務官伊瑟兒·珊瑚醒',
  'entities.npcs.th_merchant.title': '守護市場',
  'entities.npcs.th_priest.greeting': '我們在祭壇上供著一碗鐘的自有活水，從未混濁過一次。',
  'entities.npcs.th_priest.name': '潮語者哈洛倫',
  'entities.npcs.th_priest.title': '靜水禮拜堂',
  'entities.npcs.th_seneschal.greeting':
    '守護官在沙漏轉動之際接見陳情者。而這座城市的沙漏，相當巨大。',
  'entities.npcs.th_seneschal.name': '家宰奧德里克·池',
  'entities.npcs.th_seneschal.title': '守護官座',
  'entities.npcs.th_smith.greeting':
    '玻璃是守護官的事。鋼鐵才是我的，玻璃撐不住時，我的鋼鐵撐得住。',
  'entities.npcs.th_smith.name': '鍛爐守衛耶拉·鹽水',
  'entities.npcs.th_smith.title': '潮堡鍛造坊',
  'entities.npcs.th_stablemaster.greeting':
    '沒有長翅膀的，沒有噴火裝置的。只有從沒從堤道上摔下去過的老實馬匹。',
  'entities.npcs.th_stablemaster.name': '馬廄總管科林·韋恩',
  'entities.npcs.th_stablemaster.title': '潮堡馬廄',
  'entities.npcs.th_warden.greeting':
    '你爬了整條堤道就為了看我，{className}？鐘就在你身後，那才是這裡唯一值得你爬上來的東西。去裡面玩吧，我們留著它就是為了這個。',
  'entities.npcs.th_warden.name': '守護官凱西亞·深玻璃',
  'entities.npcs.th_warden.title': '鐘之守護官',
  'entities.npcs.dg_spectator_pace1.greeting': '聽說球被打得夠重時會唱歌。我是來聽的。',
  'entities.npcs.dg_spectator_pace1.name': '梅莉·薩洛',
  'entities.npcs.dg_spectator_pace1.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_pace2.greeting':
    '賽前我坐不住，從來都坐不住。問我老婆就知道，她在看台上頭。',
  'entities.npcs.dg_spectator_pace2.name': '喬森·布里爾',
  'entities.npcs.dg_spectator_pace2.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_pace3.greeting':
    '沿邊道走三趟來回，正好耗盡一場比賽的緊張。我算過了。',
  'entities.npcs.dg_spectator_pace3.name': '佩塔·浪峰',
  'entities.npcs.dg_spectator_pace3.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_pace4.greeting':
    '沿邊道走，留意矮牆。露台邊緣踏出的第一步，可長得很。',
  'entities.npcs.dg_spectator_pace4.name': '譚姆·湧浪',
  'entities.npcs.dg_spectator_pace4.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier1.greeting':
    '整座碗形賽場裡最好的座位。你能看到整座鐘被擊中時渾身顫抖。',
  'entities.npcs.dg_spectator_tier1.name': '貝拉·霜璃',
  'entities.npcs.dg_spectator_tier1.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier10.greeting':
    '賽前那些塔柱會嗡嗡作響。把手放上去，你能感覺到賽事將至。',
  'entities.npcs.dg_spectator_tier10.name': '丹娜·海藻辮',
  'entities.npcs.dg_spectator_tier10.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier11.greeting':
    '十六盞燈，一隻飛蛾都沒有。我看這是全世界最高的燈了。',
  'entities.npcs.dg_spectator_tier11.name': '馬洛·浪沫',
  'entities.npcs.dg_spectator_tier11.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier12.greeting':
    '我是為了看游泳來的。留下不走，是因為回程的堤道太長了。',
  'entities.npcs.dg_spectator_tier12.name': '溫娜·潮紗',
  'entities.npcs.dg_spectator_tier12.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier2.greeting': '我從破曉就佔著這一排，會一直守到終場哨聲。',
  'entities.npcs.dg_spectator_tier2.name': '費林·鹽桶',
  'entities.npcs.dg_spectator_tier2.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier3.greeting': '開球前水面靜止的那一刻，整座場館也跟著屏住呼吸。',
  'entities.npcs.dg_spectator_tier3.name': '尼姆·珠戀',
  'entities.npcs.dg_spectator_tier3.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier4.greeting': '我丈夫以為我在神殿，神殿又以為我跟丈夫在一起。',
  'entities.npcs.dg_spectator_tier4.name': '艾爾德大嬸',
  'entities.npcs.dg_spectator_tier4.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier5.greeting':
    '我航遍了天下所有的海，而我見過最奇怪的水，就懸在那上頭。',
  'entities.npcs.dg_spectator_tier5.name': '船長維爾',
  'entities.npcs.dg_spectator_tier5.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier6.greeting':
    '看台愈高，空氣愈薄，視野愈好。爬上來也算門票的一部分。',
  'entities.npcs.dg_spectator_tier6.name': '伊沃·燈痕',
  'entities.npcs.dg_spectator_tier6.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier7.greeting':
    '球每次換手，我就織一排。上一場比賽下來，我織完了一整條圍巾。',
  'entities.npcs.dg_spectator_tier7.name': '茉德·針線',
  'entities.npcs.dg_spectator_tier7.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier8.greeting': '上次比賽把嗓子喊啞了。值得。今天還要再喊一次。',
  'entities.npcs.dg_spectator_tier8.name': '啞嗓佩洛',
  'entities.npcs.dg_spectator_tier8.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_tier9.greeting':
    '球門倒下時，別站在鐘的下面。至少第一句話你要相信我。',
  'entities.npcs.dg_spectator_tier9.name': '莉娃·暗流',
  'entities.npcs.dg_spectator_tier9.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_yard1.greeting':
    '我年輕那會兒，水更冷，球門更小。除此之外，其他一切我都認可。',
  'entities.npcs.dg_spectator_yard1.name': '老鸕鶿',
  'entities.npcs.dg_spectator_yard1.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_yard2.greeting': '我押了三銀幣在客隊身上。派餅是我撐下去的方法。',
  'entities.npcs.dg_spectator_yard2.name': '哈羅·芬奇',
  'entities.npcs.dg_spectator_yard2.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_yard3.greeting':
    '一位光頭法師賣我一趟傳送門，直達這裡。這是我花過最值得的一枚銅幣。',
  'entities.npcs.dg_spectator_yard3.name': '科賓·艾許凡恩',
  'entities.npcs.dg_spectator_yard3.title': '深玻璃觀眾',
  'entities.npcs.dg_spectator_yard4.greeting':
    '只有比賽日，裂谷的風裡才會飄著炸麵包的香氣。跟著鼻子走準沒錯。',
  'entities.npcs.dg_spectator_yard4.name': '賽西·鹽滷',
  'entities.npcs.dg_spectator_yard4.title': '深玻璃觀眾',
  'entities.npcs.th_bridge_watch_0.greeting':
    '一百三十碼的石橋橫跨黑冰之上，我的職責就是那道欄杆。想往下看就看吧，每個人都會看一次。',
  'entities.npcs.th_bridge_watch_0.name': '橋衛凱提爾·沃斯',
  'entities.npcs.th_bridge_watch_1.greeting':
    '一百三十碼的石橋橫跨黑冰之上，我的職責就是那道欄杆。想往下看就看吧，每個人都會看一次。',
  'entities.npcs.th_bridge_watch_1.name': '橋衛瑪拉·霜',
  'entities.npcs.th_dockhand_0.greeting':
    '船隻在這裡繫泊上岩，懸在冰面之上。你會習慣的，不然就得順著堤道回去。',
  'entities.npcs.th_dockhand_0.name': '碼頭總管費羅·凱爾',
  'entities.npcs.th_dockhand_0.title': '繫泊區',
  'entities.npcs.th_dockhand_1.greeting':
    '船隻在這裡繫泊上岩，懸在冰面之上。你會習慣的，不然就得順著堤道回去。',
  'entities.npcs.th_dockhand_1.name': '索具匠西娜·塔爾',
  'entities.npcs.th_dockhand_1.title': '繫泊區',
  'entities.npcs.th_gate_watch_0.greeting': '繼續走吧。結界很安靜，我希望它一直這樣。',
  'entities.npcs.th_gate_watch_0.name': '守衛薩伯·奎斯特',
  'entities.npcs.th_gate_watch_0.title': '城門守衛',
  'entities.npcs.th_gate_watch_1.greeting': '繼續走吧。結界很安靜，我希望它一直這樣。',
  'entities.npcs.th_gate_watch_1.name': '守衛托馬斯·瑞爾',
  'entities.npcs.th_gate_watch_1.title': '城門守衛',
  'entities.npcs.th_keep_guard_0.greeting': '大門依守護官之令敞開。鐘聲若響，留意那道閘門。',
  'entities.npcs.th_keep_guard_0.name': '衛兵奧塔',
  'entities.npcs.th_keep_guard_0.title': '守護官衛隊',
  'entities.npcs.th_keep_guard_1.greeting': '朋友，待在庭院裡。大廳是守護官的，高塔才是我們的。',
  'entities.npcs.th_keep_guard_1.name': '衛兵麗絲貝特',
  'entities.npcs.th_keep_guard_1.title': '守護官衛隊',
  'entities.npcs.th_keep_guard_2.greeting':
    '守護官正在裡面理政。擦擦你的靴子，那塊地毯可是從金冠嶺運來的。',
  'entities.npcs.th_keep_guard_2.name': '衛兵凡斯',
  'entities.npcs.th_keep_guard_2.title': '守護官衛隊',
  'entities.npcs.th_keep_guard_3.greeting': '陳情者去大廳，送貨的去廚房側翼。你是哪一種？',
  'entities.npcs.th_keep_guard_3.name': '衛兵梅璘',
  'entities.npcs.th_keep_guard_3.title': '守護官衛隊',
  'entities.npcs.th_market_folk_0.greeting':
    '比賽日，整個露台的人都跑上來採買。顧好你的錢包，也顧好你的手肘。',
  'entities.npcs.th_market_folk_0.name': '妮塔·哈洛威',
  'entities.npcs.th_market_folk_0.title': '玻璃商',
  'entities.npcs.th_market_folk_1.greeting':
    '比賽日，整個露台的人都跑上來採買。顧好你的錢包，也顧好你的手肘。',
  'entities.npcs.th_market_folk_1.name': '布拉姆·卡洛克',
  'entities.npcs.th_market_folk_1.title': '製繩匠',
  'entities.npcs.th_market_folk_2.greeting':
    '比賽日，整個露台的人都跑上來採買。顧好你的錢包，也顧好你的手肘。',
  'entities.npcs.th_market_folk_2.name': '修女伊沃·瑪恩',
  'entities.npcs.th_market_folk_2.title': '潮境施賑者',
  'entities.npcs.th_market_folk_3.greeting':
    '比賽日，整個露台的人都跑上來採買。顧好你的錢包，也顧好你的手肘。',
  'entities.npcs.th_market_folk_3.name': '賽利斯·碼頭',
  'entities.npcs.th_market_folk_3.title': '渡船代理商',
  'entities.npcs.th_market_folk_4.greeting':
    '比賽日，整個露台的人都跑上來採買。顧好你的錢包，也顧好你的手肘。',
  'entities.npcs.th_market_folk_4.name': '老佩林',
  'entities.npcs.th_market_folk_4.title': '賽事掮客',
  'entities.npcs.th_market_folk_5.greeting':
    '比賽日，整個露台的人都跑上來採買。顧好你的錢包，也顧好你的手肘。',
  'entities.npcs.th_market_folk_5.name': '燕娜·科爾',
  'entities.npcs.th_market_folk_5.title': '補網匠',
  'entities.npcs.th_row_folk_0.greeting': '在這上頭，風一停就能聽見鐘聲。全城最好的地段。',
  'entities.npcs.th_row_folk_0.name': '學士伊爾凡·多斯',
  'entities.npcs.th_row_folk_0.title': '守護官家眷',
  'entities.npcs.th_row_folk_1.greeting': '在這上頭，風一停就能聽見鐘聲。全城最好的地段。',
  'entities.npcs.th_row_folk_1.name': '普瑞爾大嬸',
  'entities.npcs.th_row_folk_2.greeting': '在這上頭，風一停就能聽見鐘聲。全城最好的地段。',
  'entities.npcs.th_row_folk_2.name': '安瑟姆·科伊',
  'entities.npcs.th_row_folk_2.title': '玻璃匠',
  'entities.npcs.th_row_folk_3.greeting': '在這上頭，風一停就能聽見鐘聲。全城最好的地段。',
  'entities.npcs.th_row_folk_3.name': '小鷦鷯',
};
