...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.secondBar': '第二動作列',
  'hudChrome.actionBar.barScale': '動作列大小',
  'hudChrome.actionBar.editKeys': '編輯動作列按鍵',
  'hudChrome.actionBar.bindModeTitle': '動作列按鍵設定',
  'hudChrome.actionBar.bindModeHint': '點擊一個格子，然後按下要綁定的按鍵。完成後點擊「完成」。',
  'hudChrome.actionBar.bindReset': '重設',
  'hudChrome.actionBar.bindResetConfirmTitle': '重設動作列按鍵？',
  'hudChrome.actionBar.bindResetConfirmBody': '第一條動作列恢復為預設按鍵，第二條動作列變為未綁定。此操作無法復原。',
