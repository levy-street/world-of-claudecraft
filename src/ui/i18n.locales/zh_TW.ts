...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bg.doubleHonorLine': '雙倍榮譽日:今日荊谷原野榮譽獎勵均為{mult}倍',
  ...
  'hudChrome.calendar.events.doubleHonor.title': '雙倍榮譽日',
  'hudChrome.calendar.events.doubleHonor.note': '戰營吹響集結號：每日重置前，荊谷原野榮譽獎勵加倍。',
