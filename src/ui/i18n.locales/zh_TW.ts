...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.undermount_wing2.enterText': '蒸汽從前方被水淹沒的鍛爐中捲起。',
  'entities.dungeons.undermount_wing2.leaveText': '你把淬火大廳拋在身後。',
  'entities.dungeons.undermount_wing3.name': '地底山: 回火',
  'entities.dungeons.undermount_wing3.enterText': '錘擊聲在回火寶庫中迴盪。',
  'entities.dungeons.undermount_wing3.leaveText': '你從鳴響的爐道撤退。',
  'entities.dungeons.undermount_wing4.name': '地底山: 甦醒',
  'entities.dungeons.undermount_wing4.enterText': '被埋的熔爐在深處躁動。',
  'entities.dungeons.undermount_wing4.leaveText': '你從甦醒的熱浪中撤離。',
  'entities.mobs.vosh_the_glazier.name': '玻匠沃什',
  'entities.mobs.saan_the_stoker.name': '司爐薩安',
  'entities.mobs.the_forge_heart.name': '鍛爐之心',
