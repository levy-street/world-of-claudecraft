...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.shardpike.braceTooltip': '將矛尾插入地面，矛尖朝上。你的橫移鍵就是平衡桿：光束會自行漂移，他每次砸地都會把它踢偏。讓它離開兩端軌道並保持 {set} 秒即可架穩長矛。需要堅實的地面，且不能在坐騎上。',
  'hudChrome.shardpike.thrustLabel': '織影核心突刺',
  'hudChrome.shardpike.thrustTooltip': '將架穩的長矛刺入眼中，造成 {damage} 點傷害。沒有任何東西能加成它：等級、攻擊強度、長矛本身都不行。它會使工頭失明並剝離石塚之皮，讓泥沼中其他所有武器終於能咬進去。只有架穩的長矛才能送出這一擊，射程 {reach} 碼，窗口持續 {seconds} 秒。',
  'hudChrome.shardpike.releaseLabel': '放下碎晶長矛',
  'hudChrome.shardpike.releaseTooltip': '把長矛收起。中途放棄沒有懲罰：你失去的是架勢，不是這次機會，{rest} 秒後即可重新架起。',
  ...
  'entities.npcs.socketwright_skerrit.greeting': '四十年前我磨好那顆眼珠，把它嵌進他的眼窩，一天工錢都沒拿到。你想讓工頭吃點苦頭，{className}？那就衝著我的手藝去。',
  'entities.quests.q_socketwrights_due.title': '鑲嵌匠的欠帳',
  'entities.quests.q_socketwrights_due.text': '織影核心是我親手嵌進那眼窩的：磨好透鏡，安放到位，楔緊對齊。塚主們一個銅板都沒付過我，如今我的手藝卻在泥沼裡四處踏平一切。拿走我的碎晶長矛。矛尾插地，穩住矛尖，需要多久就撐多久，等你手臂篤定了，就把它送進那隻眼睛。他披的那層皮與那塊晶石相連，{playerName}：戳瞎他，泥沼裡的每一把刀刃終於都能咬進去。',
  'entities.quests.q_socketwrights_due.completion': '你感覺到它鬆了，是吧？四十年的利息，從那眼窩裡付清了。長矛歸你了，朋友。他會復原的，他總是會，所以你什麼時候想再來收帳都行。',
