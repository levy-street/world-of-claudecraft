...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaEnd.defeat': '失敗',
  'hudChrome.arenaEnd.draw': '平手',
  'hudChrome.arenaEnd.colName': '名稱',
  'hudChrome.arenaEnd.colKills': '擊殺',
  'hudChrome.arenaEnd.colDamage': '傷害輸出',
  'hudChrome.arenaEnd.colHealing': '治療量',
  'hudChrome.arenaEnd.colRating': '評分',
  'hudChrome.arenaEnd.colChange': '變化',
  'hudChrome.arenaEnd.yourRating': '你的評分：{before} 至 {after}',
  'hudChrome.arenaEnd.honorEarned': '+{honor} 榮譽',
  'hudChrome.arenaEnd.leave': '離開',
  'hudChrome.arenaEnd.close': '關閉',
