...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolbeltTitle': '工具腰帶',
  'hudChrome.bags.toolbeltNone': '未佩戴工具腰帶',
  'hudChrome.bags.toolbeltRemoveHint': '點擊卸下此工具腰帶',
  'hudChrome.bags.toolbeltFilled': '{used}/{total} 件工具',
  'hudChrome.bags.toolSlotLabel': '工具欄位 {slot}',
  'hudChrome.bags.toolSlotEmpty': '空',
  'hudChrome.bags.toolSlotStowHint': '點擊收納{name}',
  'hudChrome.bags.toolSlotTakeHint': '點擊取回此工具',
  'hudChrome.bags.toolSlotNoTool': '你沒有可收納的工具',
  'itemUi.kind.toolbelt': '工具腰帶',
  'entities.items.basic_toolbelt.name': '基礎工具腰帶',
  'entities.items.reinforced_toolbelt.name': '強化工具腰帶',
  'entities.items.artisans_toolbelt.name': '工匠的工具腰帶',
  'itemUi.tooltip.toolbeltSlots': '可容納 {slots} 件工具',
