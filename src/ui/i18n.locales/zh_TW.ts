...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.voice_echo_npc.title': '被銘記的聲音',
  'entities.npcs.voice_echo_npc.greeting':
    '營火彼端傳來的聲音......是啊,我記得自己曾經也是這樣的嗓音。',
  'entities.quests.q_echo_of_you.text': '我有件東西遺失在附近。你願意替我去找回來嗎?',
  ...
  'hudChrome.voiceNpc.displayNameLabel': 'NPC 顯示名稱',
  'hudChrome.voiceNpc.displayNamePlaceholder': '給你的回聲取個名字吧?',
  'hudChrome.voiceNpc.recordStart': '錄製樣本',
  'hudChrome.voiceNpc.recordStop': '停止錄音',
  'hudChrome.voiceNpc.recordingHint': '錄音中......自然地說話,最長 30 秒。',
  'hudChrome.voiceNpc.priceLabel': '價格: {price} $WOC',
  'hudChrome.voiceNpc.burnLabel': '燃燒 $WOC 並確認',
  'hudChrome.voiceNpc.burnNotWired': '此草稿版本尚未接入鏈上燃燒簽名。',
  'hudChrome.voiceNpc.needWallet': '請先連接 Solana 錢包。',
  'hudChrome.voiceNpc.needName': '請輸入 NPC 的顯示名稱。',
  'hudChrome.voiceNpc.needConsent': '錄製或上傳樣本前必須先同意。',
  'hudChrome.voiceNpc.micError': '無法存取你的麥克風。',
  'hudChrome.voiceNpc.uploadError': '無法上傳語音樣本。',
  'hudChrome.voiceNpc.quoteError': '無法取得報價。',
  'hudChrome.voiceNpc.confirmError': '無法確認付款。',
  'hudChrome.voiceNpc.statusPendingSample': '樣本已錄製。可以報價並燃燒 $WOC 了。',
  'hudChrome.voiceNpc.statusPendingClone': '付款已確認。等待語音複製開始。',
  'hudChrome.voiceNpc.statusCloning': '正在複製你的聲音......',
  'hudChrome.voiceNpc.statusGenerating': '正在生成對白......',
  'hudChrome.voiceNpc.statusReady': '你的語音 NPC 已就緒!',
  'hudChrome.voiceNpc.statusFailed': '出了點問題: {error}',
  'hudChrome.voiceNpc.statusPollFailed': '無法查詢狀態。請重新開啟此面板。',
};
