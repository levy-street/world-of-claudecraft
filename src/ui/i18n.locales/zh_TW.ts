...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.items.bolt_of_linen.name": "亞麻布卷",
  "entities.items.bolt_of_silk.name": "絲綢布卷",
  "entities.items.bolt_of_woolen.name": "羊毛布卷",
  "entities.items.coarse_thread.name": "粗線",
  "entities.items.cured_heavy_hide.name": "硝製厚革",
  "entities.items.cured_leather_pants.name": "硝製皮褲",
  "entities.items.cured_light_hide.name": "硝製輕革",
  "entities.items.cured_medium_hide.name": "硝製中革",
  "entities.items.direhide_legguards.name": "厄獸皮護腿",
  "entities.items.fine_thread.name": "細線",
  "entities.items.heavy_hide.name": "厚革",
  "entities.items.heavy_leather.name": "厚皮",
  "entities.items.heavy_leather_straps.name": "厚皮帶",
  "entities.items.heavy_leather_vest.name": "厚皮背心",
  "entities.items.heavy_linen_bandage.name": "厚亞麻繃帶",
  "entities.items.heavy_silk_bandage.name": "厚絲綢繃帶",
  "entities.items.heavy_wool_bandage.name": "厚羊毛繃帶",
  "entities.items.light_hide.name": "輕革",
  "entities.items.light_leather.name": "輕皮",
  "entities.items.light_leather_boots.name": "輕皮靴",
  "entities.items.light_leather_straps.name": "輕皮帶",
  "entities.items.light_leather_vest.name": "輕皮背心",
  "entities.items.linen_bandage.name": "亞麻繃帶",
  "entities.items.linen_boots.name": "亞麻布靴",
  "entities.items.linen_cloth.name": "亞麻布",
  "entities.items.linen_pants.name": "亞麻布褲",
  "entities.items.linen_robe.name": "亞麻布長袍",
  "entities.items.medium_hide.name": "中革",
  "entities.items.medium_leather.name": "中皮",
  "entities.items.medium_leather_boots.name": "中皮靴",
  "entities.items.medium_leather_pants.name": "中皮褲",
  "entities.items.medium_leather_vest.name": "中皮背心",
  "entities.items.rough_thread.name": "粗糙線",
  "entities.items.ruined_leather_scraps.name": "破損的皮革碎片",
  "entities.items.salt.name": "精鹽",
  "entities.items.silk_bandage.name": "絲綢繃帶",
  "entities.items.silk_brocade_robe.name": "絲綢織錦長袍",
  "entities.items.silk_cloth.name": "絲綢",
  "entities.items.silk_leggings.name": "絲綢護腿",
  "entities.items.silk_scrap.name": "絲綢碎布",
  "entities.items.silk_slippers.name": "絲綢便鞋",
  "entities.items.studded_leather_vest.name": "鑲釘皮背心",
  "entities.items.wool_bandage.name": "羊毛繃帶",
  "entities.items.wool_cloth.name": "羊毛布",
  "entities.items.wool_scrap.name": "羊毛碎布",
  "entities.items.woolen_leggings.name": "羊毛護腿",
