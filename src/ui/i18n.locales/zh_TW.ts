...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.dex_swap.disabled': '目前無法在遊戲內購買 $WOC。',
  'apiError.dex_swap.input_not_allowed': '不支援該支付代幣。',
  'apiError.dex_swap.invalid_amount': '請輸入有效的數量。',
  'apiError.dex_swap.invalid_slippage': '不允許該滑價設定。',
  'apiError.dex_swap.invalid_public_key': '請先連接 Solana 錢包。',
  'apiError.dex_swap.quote_tampered': '該報價與本次兌換不符，請重新取得報價。',
  'apiError.dex_swap.no_route': '目前沒有適用於該數量的交易路徑。',
  'apiError.dex_swap.rate_limited': '請求過於頻繁。請稍候再試。',
  'apiError.dex_swap.upstream_error': '兌換服務暫時無法使用，請稍後再試。',
  // The in-game Buy $WOC window (M16 non-Latin fill)
  'hudChrome.dexSwap.title': '購買 $WOC',
  'hudChrome.dexSwap.close': '關閉購買 $WOC',
  'hudChrome.dexSwap.launcher': '購買',
  'hudChrome.dexSwap.launcherAria': '用 SOL 或 USDC 購買 $WOC',
  'hudChrome.dexSwap.nonCustodial':
    '兌換透過 Jupiter DEX 聚合器路由，由你自己的錢包簽署並送出。遊戲絕不保管你的金鑰或資金。',
  'hudChrome.dexSwap.amountLabel': '你支付',
  'hudChrome.dexSwap.tokenAria': '支付代幣',
  'hudChrome.dexSwap.quoteButton': '取得報價',
  'hudChrome.dexSwap.quoting': '正在尋找最佳路徑...',
  'hudChrome.dexSwap.amountInvalid': '請輸入有效的數量。',
  'hudChrome.dexSwap.slippage': '最大滑價：{percent}%',
  'hudChrome.dexSwap.receiveLine': '你將獲得約 {amount} $WOC',
  'hudChrome.dexSwap.payLine': '你支付 {amount} {symbol}',
  'hudChrome.dexSwap.priceImpact': '價格影響：{percent}%',
  'hudChrome.dexSwap.minReceived': '最少獲得：{amount} $WOC',
  'hudChrome.dexSwap.buyButton': '購買 $WOC',
  'hudChrome.dexSwap.quoteStale': '報價已過期。購買前請重新取得報價。',
  'hudChrome.dexSwap.feeLine': '包含 {percent}% 平台手續費',
  'hudChrome.dexSwap.cooldown': '請求過於頻繁。{seconds}秒後可重試。',
  'hudChrome.dexSwap.requoted': '該報價已過期，已為你取得新報價。請確認後再次點擊購買。',
  'hudChrome.dexSwap.signing': '請在錢包中核准該交易...',
  'hudChrome.dexSwap.sentTitle': '兌換已送出',
  'hudChrome.dexSwap.sentBody': '你的錢包已簽署並送出兌換。網路確認後你的 $WOC 餘額將更新。',
  'hudChrome.dexSwap.signatureLabel': '交易簽章：{signature}',
  'hudChrome.dexSwap.viewOnExplorer': '在 Solana Explorer 上檢視',
  'hudChrome.dexSwap.buyMore': '再購買 $WOC',
  'hudChrome.dexSwap.errWalletFeature':
    '你連接的錢包無法從遊戲內送出交易。請嘗試其他 Solana 錢包。',
  'hudChrome.dexSwap.errSignFailed': '交易未送出。可能已在你的錢包中被拒絕。',
  'hudChrome.dexSwap.errNoWallet': '請先連接 Solana 錢包。',
  // The rentable trading bots (M16 non-Latin fill)
  'apiError.trading_bots.disabled': '交易機器人目前無法使用。',
  'apiError.trading_bots.unknown_sku': '目錄中沒有該機器人。',
  'apiError.trading_bots.invalid_pay_currency': '不支援該支付貨幣。',
  'apiError.trading_bots.already_subscribed': '你已經租用了一個交易機器人。',
  'apiError.trading_bots.subscription_required': '請先租用一個交易機器人。',
  'apiError.trading_bots.subscription_expired': '你的機器人租期已到期。請續租或提領資金。',
  'apiError.trading_bots.insufficient_claudium': 'Claudium 不足。',
  'apiError.trading_bots.invalid_amount': '請輸入有效的數量。',
  'apiError.trading_bots.deposit_out_of_bounds': '該存入金額超出此機器人允許的範圍。',
  'apiError.trading_bots.invalid_public_key': '請先連接 Solana 錢包。',
  'apiError.trading_bots.invalid_params': '不允許這些機器人設定。',
  'apiError.trading_bots.payment_not_found': '找不到該筆付款。請重新開始。',
  'apiError.trading_bots.payment_unverified': '該筆付款尚未確認。請稍候再試。',
  'apiError.trading_bots.vault_busy': '機器人金庫正忙。請稍候再試。',
  'apiError.trading_bots.rate_limited': '請求過於頻繁。請稍候再試。',
  'apiError.trading_bots.upstream_error': '交易機器人服務暫時無法使用，請稍後再試。',
  'hudChrome.tradingBots.title': '交易機器人',
  'hudChrome.tradingBots.close': '關閉交易機器人',
  'hudChrome.tradingBots.launcher': '機器人',
  'hudChrome.tradingBots.launcherAria': '租用 SOL 與 $WOC 交易機器人',
  'hudChrome.tradingBots.loading': '正在載入交易機器人...',
  'hudChrome.tradingBots.custody':
    '存款將進入由交易服務代你管理、設有上限的金庫。提領只能發送到你已綁定的錢包，且你隨時可以提領。',
  'hudChrome.tradingBots.riskNote': '自動交易可能造成虧損。租金不予退還。這不是投資建議。',
  'hudChrome.tradingBots.catalogIntro':
    '按月租用機器人，用 SOL 和 $WOC 組成的資金對注入金庫，它就會在 DEX 上替你交易。',
  'hudChrome.tradingBots.skuGridName': '網格魔像',
  'hudChrome.tradingBots.skuGridBlurb': '在市場價格上下交替掛出買單和賣單，在價格波動時賺取價差。',
  'hudChrome.tradingBots.skuDcaName': '滴流精靈',
  'hudChrome.tradingBots.skuDcaBlurb': '按固定排程把 SOL 穩步兌換成 $WOC，分散你的買入時機。',
  'hudChrome.tradingBots.skuMomentumName': '動量幽光',
  'hudChrome.tradingBots.skuMomentumBlurb': '將資金對傾向趨勢較強的一側，趨勢減弱時再調回平衡。',
  ...
  'hudChrome.tradingBots.claudiumBalance': 'Claudium 餘額：{amount}',
  'hudChrome.tradingBots.approvePayment': '請在錢包中核准租金支付...',
  'hudChrome.tradingBots.confirmingPayment': '正在網路上確認你的付款...',
  'hudChrome.tradingBots.subscribedBody': '機器人已租用。為金庫注資即可開始交易。',
  'hudChrome.tradingBots.activeUntil': '有效期至 {date}',
  'hudChrome.tradingBots.fundTitle': '為金庫注資',
  'hudChrome.tradingBots.solAmountLabel': '存入的 SOL',
  'hudChrome.tradingBots.wocAmountLabel': '存入的 $WOC',
  'hudChrome.tradingBots.depositBounds': '介於 {min} 與 {max} 之間',
  'hudChrome.tradingBots.depositButton': '存入',
  'hudChrome.tradingBots.approveDeposit': '請在錢包中核准該筆存款...',
  'hudChrome.tradingBots.confirmingDeposit': '正在網路上確認你的存款...',
  'hudChrome.tradingBots.amountInvalid': '請輸入有效的數量。',
  'hudChrome.tradingBots.vaultLine': '金庫：{sol} SOL，{woc} $WOC',
  'hudChrome.tradingBots.stateRunning': '運行中',
  'hudChrome.tradingBots.statePaused': '已暫停',
  'hudChrome.tradingBots.startButton': '啟動',
  'hudChrome.tradingBots.pauseButton': '暫停',
  'hudChrome.tradingBots.paramsTitle': '策略設定',
  'hudChrome.tradingBots.paramGridSpacingBps': '網格間距（{percent}%）',
  'hudChrome.tradingBots.paramOrderSizeBps': '訂單規模（{percent}%）',
  'hudChrome.tradingBots.paramDcaIntervalMinutes': '買入間隔（分鐘）',
  'hudChrome.tradingBots.paramMomentumLookbackMinutes': '趨勢回看（分鐘）',
  'hudChrome.tradingBots.saveParams': '儲存設定',
  'hudChrome.tradingBots.recentTrades': '最近交易',
  'hudChrome.tradingBots.noTrades': '暫無交易。',
  'hudChrome.tradingBots.tradeBuy': '買入',
  'hudChrome.tradingBots.tradeSell': '賣出',
  'hudChrome.tradingBots.pnlLine': '損益（{days} 天）：{amount} $WOC（{percent}%）',
  'hudChrome.tradingBots.withdrawButton': '全部提領',
  'hudChrome.tradingBots.withdrawTitle': '提領金庫資金',
  'hudChrome.tradingBots.withdrawBody': '提領會暫停機器人，並將金庫餘額返還到你綁定的錢包。',
  'hudChrome.tradingBots.approveWithdraw': '請在錢包中核准該筆提領...',
  'hudChrome.tradingBots.withdrawPending': '提領正在進行中。網路確認後餘額將更新。',
  'hudChrome.tradingBots.cooldown': '請求過於頻繁。{seconds}秒後可重試。',
  'hudChrome.tradingBots.errWalletFeature':
    '你連接的錢包無法從遊戲內送出交易。請嘗試其他 Solana 錢包。',
  'hudChrome.tradingBots.errSignFailed': '交易未送出。可能已在你的錢包中被拒絕。',
  'hudChrome.tradingBots.errNoWallet': '請先連接 Solana 錢包。',
