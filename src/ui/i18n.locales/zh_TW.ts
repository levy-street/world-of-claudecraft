...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.scene.skipHint': '跳過過場動畫（Esc）',
  'hudChrome.scene.waitingFor': '正在等待 {name}',
  'hudChrome.mountTraining.buyReinsPrompt':
    '騎術已學會。向瑪拉購買價值 10 金幣的勇武戰馬韁繩，然後使用它即可騎乘。',
  'lb.fixture.ferry': '遠岸渡船',
  'lb.fixture.tidemill': '潮汐磨坊',
  'lb.fixture.breach': '裂隙',
  'lb.speaker.tam': '守鐘人塔姆',
  'lb.speaker.coalfast': '守望者科爾法斯特',
  'lb.speaker.ollun': '裂隙守衛奧倫',
  'lb.speaker.edda': '軍需官埃達',
  'lb.speaker.saul': '醫者索爾',
  'lb.fare.promptOut': '前往遠岸的船費：{price} 銅幣。',
  'lb.fare.promptBack': '返回大陸的船費：{price} 銅幣。',
  'lb.fare.pay': '支付船費。',
  'lb.fare.decline': '今天不了。',
  'lb.q0.scene.harbor': '一座繁忙的港口：漁網正在晾曬，星玻璃打撈箱上印著大陸買家的標記。',
  'lb.q0.scene.plinth':
    '港口階梯上方，一尊青銅守望者面朝內陸。基座上最新的名字已有百年：守望者黑爾。下方還留有刻寫更多名字的空位。',
  'lb.q0.scene.toll':
    '鐘聲響了一下。街上的每個人都停下腳步，默默計數。再無聲響，整條街才一同鬆了口氣。',
  'lb.q0.tam.stretchers': '上次那種東西讓整支守衛隊忙了一上午，還搭上了兩副擔架。',
  'lb.q0.coalfast.look': '灰衣人看看死去的潛獵者，又稍久地看了你一眼。隨後他轉身走回懸崖方向。',
  'editor.cinematic.title': '過場動畫',
  'editor.cinematic.show': '顯示面板',
  'editor.cinematic.hide': '隱藏面板',
  'editor.cinematic.scene': '場景',
  'editor.cinematic.pause': '暫停',
  'editor.cinematic.authoredCamera': '編排鏡頭',
  'editor.cinematic.letterboxOn': '黑邊：開啟',
  'editor.cinematic.letterboxOff': '黑邊：關閉',
  'editor.cinematic.violations': '違規項目',
  'editor.cinematic.noViolations': '目前沒有違規項目',
  'editor.cinematic.capture': '擷取關鍵影格',
  'editor.cinematic.copy': '複製程式碼區塊',
  'editor.cinematic.output': '產生的鏡頭擷取',
  'editor.cinematic.unavailable': '三維視埠正在載入',
  'editor.cinematic.seedMismatch': '擷取需要使用正式世界種子',
  'editor.cinematic.captureSavedCopied': '已儲存並複製',
  'editor.cinematic.captureSaved': '已儲存；程式碼區塊已在下方準備好',
  'editor.cinematic.captureCopyOnly': '已複製；開發寫入器無法使用',
  'editor.cinematic.captureReady': '程式碼區塊已在下方準備好',
  'entities.mobs.lb_actor_coalfast.name': '守望者科爾法斯特',
  'entities.mobs.lb_actor_ollun.name': '裂隙守衛奧倫',
  'entities.mobs.lb_actor_edda.name': '軍需官埃達',
  'entities.mobs.lb_actor_saul.name': '醫者索爾',
  'entities.mobs.lb_actor_tam.name': '守鐘人塔姆',
  'entities.mobs.tidemill_stalker.name': '潮汐磨坊潛獵者',
  'entities.npcs.ferryman_ewald.name': '船夫埃瓦爾德',
  'entities.npcs.ferryman_ewald.title': '遠岸渡口',
  'entities.npcs.ferryman_ewald.greeting':
    '要去遠岸嗎？如今已經沒人是為了釣魚而過海了，朋友。準備好就上船，抵岸後留心鐘聲：鎮上的人聽它，就像你聽天氣一樣。',
  'entities.npcs.ferryman_ewald_gullhaven.name': '船夫埃瓦爾德',
  'entities.npcs.ferryman_ewald_gullhaven.title': '遠岸渡口',
  'entities.npcs.ferryman_ewald_gullhaven.greeting':
    '要去遠岸嗎？如今已經沒人是為了釣魚而過海了，朋友。準備好就上船，抵岸後留心鐘聲：鎮上的人聽它，就像你聽天氣一樣。',
  'entities.npcs.sergeant_marsh.name': '馬什中士',
  'entities.npcs.sergeant_marsh.title': '城鎮民兵',
  'entities.npcs.sergeant_marsh.greeting':
    '受過訓練？那就聽好今晚的安排。我的防線守住道路。若裂隙吐出我們解決不了的東西，我會指向你。磨坊歸你管：不許任何東西跟你進去，也不許任何東西越過我們進鎮。去吧。',
  'entities.quests.q_lb_q0_ashore.title': '登岸',
  'entities.quests.q_lb_q0_ashore.text':
    '鷗港日夜承受衝擊，卻始終屹立。若你真想與他們並肩，就從鎮上流血的地方開始：越過港口階梯和舊雕像，向東前往守望草地的民兵防線。',
  'entities.quests.q_lb_q0_ashore.completion':
    '磨坊裡的獵殺全靠你一人，塔姆也沒有誇大擔架的事。我缺一名斥候，卻有太多田野要守。今晚你守住了一塊本不屬於你的陣地，而這正是這份工作的全部。歡迎加入守衛隊。',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': '前往守望草地向馬什中士報到',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': '消滅裂隙生物',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': '解決潮汐磨坊裡的東西',
  'entities.zones.farshore_isle.pois.5.label': '裂隙',
  'entities.zones.farshore_isle.pois.6.label': '殘骸原',
  'entities.dungeons.lb_tidemill.name': '潮汐磨坊',
  'entities.dungeons.lb_tidemill.enterText': '磨坊的門讓開了。裡面，黑暗正在傾聽。',
  'entities.dungeons.lb_tidemill.leaveText': '你走出潮汐磨坊，回到暮色中的空氣裡。',
  'entities.dungeons.lb_riftline.enterText': '巡邏隊身後的草地大門關閉了。今夜屬於這道防線。',
  'entities.dungeons.lb_riftline.leaveText': '你把裂隙防線交給黎明守衛。',
  'entities.dungeons.lb_vault.name': '沉沒的第一堡壘',
  'entities.dungeons.lb_vault.enterText': '繩索向黑暗中放下。下方，古老堡壘沉睡在墜落之處。',
  'entities.dungeons.lb_vault.leaveText': '你沿懸崖繩索攀回日光之中。',
  'entities.dungeons.lb_council.name': '堡壘議會',
  'entities.dungeons.lb_council.enterText': '議會廳裡擺著六把椅子，其中一把空著。',
  'entities.dungeons.lb_council.leaveText': '你走出堡壘。',
  'entities.dungeons.lb_landing.name': '夜間登陸',
  'entities.dungeons.lb_landing.enterText': '引航火焰沿海灘燃燒。艦隊在淺灘外等待。',
  'entities.dungeons.lb_landing.leaveText': '你把登陸海灘留在身後。',
  'entities.dungeons.lb_riftfields.name': '裂隙原入口',
  'entities.dungeons.lb_riftfields.enterText': '四處結界環繞裂口。這場儀式已將它封閉了十二個世紀。',
  'entities.dungeons.lb_riftfields.leaveText': '你從裂隙原走回山下。',
  'entities.dungeons.lb_breach.name': '裂隙之內',
  'entities.dungeons.lb_breach.enterText': '光線不對，天空更糟。核心就位於前方的開闊地。',
  'entities.dungeons.lb_breach.leaveText': '你跨過門檻，回到尋常的夜色空氣中。',
  'entities.dungeons.lb_lastwatch.name': '最後守望',
  'entities.dungeons.lb_lastwatch.enterText': '堡壘乾淨而空曠。總得有人結束這場守望。',
  'entities.dungeons.lb_lastwatch.leaveText': '你在身後關上堡壘大門。',
  'entities.dungeons.lb_willowfen.name': '垂柳泣澤',
  'entities.dungeons.lb_willowfen.enterText': '柳樹紋絲不動，水面也是。',
  'entities.dungeons.lb_willowfen.leaveText': '你離開柳樹，讓它繼續沉默。',
