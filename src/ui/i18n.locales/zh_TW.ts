...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.mobile.customize": "自訂",
  "hudChrome.mobile.customizeTitle": "自訂操作",
  "hudChrome.mobile.customizeSlotAttack": "普通攻擊",
  "hudChrome.mobile.customizeSlotSkill": "技能 {n}",
  "hudChrome.mobile.customizeSlotUtility": "輔助",
  "hudChrome.mobile.customizeDefault": "職業預設",
  "hudChrome.mobile.customizeResetSlot": "重設此槽位",
  "hudChrome.mobile.customizeResetAll": "全部重設為職業預設",
  "hudChrome.mobile.customizeUpdated": "已更新{slot}。",
  "hudChrome.mobile.customizeAllReset": "操作已重設為職業預設。",
  "hudChrome.options.touchControls": "觸控操作",
  "hudChrome.options.clusterHold": "編輯長按延遲",
  "hudChrome.options.clusterHoldNote": "長按螢幕上的操作按鈕多久後才會開啟其綁定編輯器。若你在連續使用技能時誤觸發編輯器，請調高此值。",
  "hudChrome.options.targetPriority": "攻擊目標優先順序",
  "hudChrome.options.targetPriorityNearest": "最近",
  "hudChrome.options.targetPriorityLowestHp": "生命最低",
  "hudChrome.options.targetPriorityCurrent": "優先當前目標",
  "hudChrome.options.targetPriorityNote": "當你沒有有效目標時，攻擊按鈕的鎖定對象：最近的敵人、範圍內生命最低的敵人，或在當前目標仍有效時保持不變。",
  "hudChrome.options.aimAssist": "智慧施法",
  "hudChrome.options.aimAssistNote": "按下攻擊技能會對你的目標施放，若沒有目標則對附近最合適的敵人施放，並轉身面向它。按住按鈕可預覽技能範圍；將手指移開按鈕後放開即可取消。",
  "hudChrome.options.touchReset": "重設觸控操作",
  "hudChrome.options.touchResetDone": "觸控操作已恢復為預設設定。",
