...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.endsInDays.one': '{count} 天後結束',
  'hudChrome.arenaSeason.endsInDays.few': '{count} 天後結束',
  'hudChrome.arenaSeason.endsInDays.many': '{count} 天後結束',
  'hudChrome.arenaSeason.endsInDays.other': '{count} 天後結束',
  'hudChrome.arenaSeason.endsInHours.one': '{count} 小時後結束',
  'hudChrome.arenaSeason.endsInHours.few': '{count} 小時後結束',
  'hudChrome.arenaSeason.endsInHours.many': '{count} 小時後結束',
  'hudChrome.arenaSeason.endsInHours.other': '{count} 小時後結束',
  'hudChrome.arenaSeason.endsInMinutes.one': '{count} 分鐘後結束',
  'hudChrome.arenaSeason.endsInMinutes.few': '{count} 分鐘後結束',
  'hudChrome.arenaSeason.endsInMinutes.many': '{count} 分鐘後結束',
  'hudChrome.arenaSeason.endsInMinutes.other': '{count} 分鐘後結束',
  'hudChrome.arenaSeason.opensInDays.one': '{count} 天後開啟',
  'hudChrome.arenaSeason.opensInDays.few': '{count} 天後開啟',
  'hudChrome.arenaSeason.opensInDays.many': '{count} 天後開啟',
  'hudChrome.arenaSeason.opensInDays.other': '{count} 天後開啟',
  'hudChrome.arenaSeason.opensInHours.one': '{count} 小時後開啟',
  'hudChrome.arenaSeason.opensInHours.few': '{count} 小時後開啟',
  'hudChrome.arenaSeason.opensInHours.many': '{count} 小時後開啟',
  'hudChrome.arenaSeason.opensInHours.other': '{count} 小時後開啟',
  'hudChrome.arenaSeason.opensInMinutes.one': '{count} 分鐘後開啟',
  'hudChrome.arenaSeason.opensInMinutes.few': '{count} 分鐘後開啟',
  'hudChrome.arenaSeason.opensInMinutes.many': '{count} 分鐘後開啟',
  'hudChrome.arenaSeason.opensInMinutes.other': '{count} 分鐘後開啟',
