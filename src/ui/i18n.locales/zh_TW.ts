...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.farshore_isle.welcome':
    '踏下渡船，鷗港的鐘聲會先於城鎮尋著你。裂隙無預警地撕裂而開，這座據點便死守著自己的海岸，抵擋一切從中傾湧而出之物。他們已等候像你這樣的人許久了。',
  ...
  'entities.zones.eastbrook_vale.pois.11.label': '遠岸渡口',
  ...
  'entities.quests.q_fs_bell_at_the_landing.text':
    '你是搭渡船過來的，{playerName}？那你是這一週來的頭一個，守望者會想親自打量你。鷗港就在碼頭往上，過了那些再沒人照管的曬網架。告訴守望者煤堅，航路還通著，塔姆今天還沒敲響過三響警鐘。眼下還沒有。',
  'entities.quests.q_fs_bell_at_the_landing.completion':
    '航路還通著，塔姆也還有力氣拿三響警鐘說笑。很好。我們是一座被圍攻的島，{playerName}，渡船載來的每一雙手，都是裂口要先闖過才碰得到我子民的一道關。歡迎來到鷗港。',
  ...
  'lb.q0.scene.plinth':
    '港口石階之上，青銅守望者面向內陸。基座上最新的名字已有百年：守望者黑爾。名字下面，還留著空位。',
  ...
  'entities.npcs.sergeant_marsh.greeting':
    '受過訓練？那就聽好今晚的規矩。我的防線守住道路。裂隙要是吐出我們解決不了的東西，我就指給你。磨坊歸你：什麼都不許跟你進去，也什麼都不許越過我們進鎮。去吧。',
  'entities.quests.q_lb_q0_ashore.title': '上岸',
  'entities.quests.q_lb_q0_ashore.text':
    '鷗港日夜承受裂隙侵襲，卻依然堅守。若你真想與他們並肩，就從城鎮流血之處開始：穿過港口臺階和老雕像，向東去守望草甸的民兵防線。',
  'entities.quests.q_lb_q0_ashore.completion':
    '磨坊裡的怪物是你獨自殺掉的，塔姆對擔架的事也沒有誇大。我缺一個斥候，卻有守不完的田野。今晚你守住了本不屬於你的陣地，而這就是這份差事的全部。歡迎加入守望。',
