...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'marketplace.title': '創作者外觀',
  'marketplace.subtitle': '玩家製作的外觀，使用 USDC 購買。70% 歸創作者；30% 用於買入並銷毀 $WOC。',
  'marketplace.loading': '正在載入外觀…',
  'marketplace.empty': '目前沒有在售的創作者外觀。',
  'marketplace.connectFirst': '請先連接錢包以購買。',
  'marketplace.purchasing': '購買中…',
  'marketplace.owned': '已擁有 — 已裝備',
  'marketplace.failed': '購買失敗',
  ...
  'marketplace.tabBrowse': '瀏覽',
  'marketplace.tabCreate': '創作與出售',
  'marketplace.search': '搜尋造型',
  'marketplace.anyClass': '任何職業',
  ...
  'marketplace.modeDesign': '設計',
  'marketplace.modeUpload': '上傳',
  'marketplace.modeLink': '自行託管',
  'marketplace.uploadIntro': '上傳你自己的 1024x1024 PNG 圖集。我們會將其固定到 IPFS 並為你託管。',
  'marketplace.linkIntro':
    '連結你自行託管的 PNG 圖集。我們會代理存取,買家永遠不會看到你的網址。免費。',
  'marketplace.linkUrl': '圖集網址',
  'marketplace.quotaMeter': '已託管 {used}/{quota} 個欄位',
  'marketplace.trustedBadge': '可信賴創作者(即時上架)',
  'marketplace.selfHostedFreeNote': '自行託管免費且不限數量(在上架數量上限內)。',
  'marketplace.hostingUnavailable': '託管上傳暫時無法使用。',
  'marketplace.listedReview': '已送交審核,待營運人員核准後即會上架。',
  'marketplace.baseColor': '底色',
  'marketplace.patternColor': '圖案顏色',
  'marketplace.accentColor': '點綴色',
  'marketplace.pattern': '圖案',
  'marketplace.finishLabel': '質感',
  'marketplace.densityLabel': '密度',
  'marketplace.finishes.matte': '霧面',
  'marketplace.finishes.satin': '緞面',
  'marketplace.finishes.metallic': '金屬',
  'marketplace.densities.low': '稀疏',
  'marketplace.densities.medium': '正常',
  'marketplace.densities.high': '密集',
  'marketplace.glowColor': '發光顏色',
  'marketplace.noGlow': '無發光',
  'marketplace.randomize': '隨機',
  'marketplace.namePlaceholder': '例如:翡翠龍鱗',
  'marketplace.descLabel': '描述',
  'marketplace.descPlaceholder': '買家將看到的簡短描述',
  'marketplace.priceLabel': '價格(USDC)',
  'marketplace.preview': '即時預覽',
  'marketplace.list': '上架出售',
  'marketplace.listing': '上架中…',
  'marketplace.listed': '已上架,現已生效。可從你擁有的造型中裝備它。',
  'marketplace.listFailed': '無法上架',
  'marketplace.listConnectFirst': '連接錢包後即可上架(你在此獲得 70% 收益)。',
  'marketplace.payoutHint': '你獲得 70% • 30% 用於回購並銷毀 $WOC',
  'marketplace.patterns.solid': '純色',
  'marketplace.patterns.scales': '鱗片',
  'marketplace.patterns.stripes': '條紋',
  'marketplace.patterns.diamond': '菱形',
  'marketplace.patterns.spots': '斑點',
  'marketplace.patterns.runes': '符文',
  'entities.npcs.skin_artisan.name': '造型工匠皮普',
  'entities.npcs.skin_artisan.title': '創作者造型看板',
  'entities.npcs.skin_artisan.greeting':
    '想換個新造型嗎,{className}?來逛逛玩家打造的外觀造型,或自己設計一款出售。以 USDC 結算;其中一部分用於回購並銷毀 $WOC。',
  'hudChrome.nftSkins.intro': '證明你擁有 PFP NFT 即可穿戴：其特徵塑造你的角色外觀，原作則成為你的頭像。持有該 NFT 期間一直有效。',
  'hudChrome.nftSkins.connectEthereum': '連接 Ethereum 錢包',
  'hudChrome.nftSkins.connectSolana': '連接 Solana 錢包',
  'hudChrome.nftSkins.ethereumLinked': 'Ethereum 錢包: {address}',
  'hudChrome.nftSkins.solanaLinked': 'Solana 錢包: {address}',
  'hudChrome.nftSkins.notLinked': '未綁定',
  'hudChrome.nftSkins.collectionsTitle': '支援的收藏集',
  'hudChrome.nftSkins.noCollections': '暫無可用的收藏集，請稍後再來查看。',
  'hudChrome.nftSkins.tokenIdPlaceholder': '代幣 ID',
  'hudChrome.nftSkins.mintPlaceholder': '鑄造地址',
  'hudChrome.nftSkins.claim': '領取',
  'hudChrome.nftSkins.claiming': '領取中...',
  'hudChrome.nftSkins.claimed': '已領取並裝備。可隨時在皮膚瀏覽器中查看。',
  'hudChrome.nftSkins.needWallet': '請先綁定對應的錢包。',
  'hudChrome.nftSkins.close': '關閉',
  'hudChrome.nftSkins.errorNotOwner': '該錢包不擁有此代幣。',
  'hudChrome.nftSkins.errorUnverified': '暫時無法驗證所有權，請稍後重試。',
  'hudChrome.nftSkins.errorCollection': '不支援該收藏集。',
  'hudChrome.nftSkins.errorTooMany': '已達到 NFT 皮膚上限。',
  'hudChrome.nftSkins.errorMetadata': '暫時無法讀取此 NFT，請稍後重試。',
  'hudChrome.nftSkins.errorGeneric': '無法領取此 NFT 皮膚。',
  'hudChrome.nftSkins.walletError': '錢包連接失敗。',
};
