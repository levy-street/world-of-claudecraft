...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.invertX': '反轉鏡頭（X軸）',
  'hudChrome.controller.invertMoveX': '反轉移動（X軸）',
  'hudChrome.controller.invertMoveY': '反轉移動（Y軸）',
  'hudChrome.controller.cameraAutoFollow': '鏡頭自動跟隨',
