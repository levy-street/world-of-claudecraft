...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.cruciblewrought_warhelm.name': '熔爐鑄造戰盔',
  'entities.items.emberveil_legguards.name': '燼幕護腿',
  'entities.items.vestment_of_the_last_spring.name': '最後泉源法袍',
  'entities.items.forgefathers_requiem.name': '鍛父的安魂曲',
  'entities.items.plans_cruciblewrought_warhelm.name': '設計圖：熔爐鑄造戰盔',
  'entities.items.pattern_emberveil_legguards.name': '圖樣：燼幕護腿',
  'entities.items.pattern_vestment_of_the_last_spring.name': '圖樣：最後泉源法袍',
  'entities.items.formula_lastflame_zeal.name': '公式：末焰狂熱',
  'entities.quests.q_forgefathers_requiem.title': '鍛父的安魂曲',
  'entities.quests.q_forgefathers_requiem.text': '瓦爾庫爾的鍛鎚聽命於他心口守著的東西：一塊仍在燃燒的最後泉源餘燼。把那塊餘燼帶給我。技藝登峰造極的鐵匠，能鍛出他從不敢鍛造之物。',
  'entities.quests.q_forgefathers_requiem.completion': '它仍在歌唱。鐵匠，這不是尋常材料：這是他所囚禁的泉源之聲。我會教你鍛造之法，你的雙手將完成他永遠無法完成之事。',
  'entities.quests.q_forgefathers_requiem.objectives.0.label': '取回鍛父的餘燼',
  'entities.quests.q_requiem_at_the_forge.title': '爐邊安魂曲',
  'entities.quests.q_requiem_at_the_forge.text': '鍛造由你獨自完成：十五顆末焰之核，最上等的瑟銀與古木，再以那塊餘燼為心。在名副其實的熔爐旁鍛出安魂曲，讓泉源回應它的獄卒。',
  'entities.quests.q_requiem_at_the_forge.completion': '安魂曲就此以鐵鑄成。好好攜帶它，鐵匠：再無他人之手能鍛出與之比肩之物。',
  'entities.quests.q_requiem_at_the_forge.objectives.0.label': '鍛造鍛父的安魂曲',
  'hudChrome.enchanting.formulaNotLearned': '你尚未學會該公式。',
  'hudChrome.enchantName.enchant_weapon_lastflame_zeal': '附魔武器 - 末焰狂熱',
  'hudChrome.itemProc.selfBuff': '為你附上{name}（{value}），持續{duration}秒',
  'hudChrome.itemProc.selfHeal': '並為你恢復{total}點生命值',
