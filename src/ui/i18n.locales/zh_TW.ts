...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'wallet.guardianTierTitle': '{tier}流動性守護者',
  'wallet.guardianTiers.wader.name': '涉水者',
  'wallet.guardianTiers.wader.title': '淺灘涉水者',
  ...
  'wallet.guardianTiers.stormwarden.name': '風暴守衛',
  'wallet.guardianTiers.stormwarden.title': '風暴守望者',
  'wallet.guardianTiers.abyssguard.name': '深淵衛士',
  'wallet.guardianTiers.abyssguard.title': '深淵守衛者',
  ...
  'hudChrome.wocSeason.subtitle': '由金庫出資發放給頂尖玩家',
  'hudChrome.wocSeason.close': '關閉',
  'hudChrome.wocSeason.none': '目前沒有進行中的獎勵賽季。',
  'hudChrome.wocSeason.noneHint': '當競技場抽成與回購開始為獎池注資時，賽季即會開啟。',
  'hudChrome.wocSeason.statusActive': '進行中',
  'hudChrome.wocSeason.statusEnded': '已結束',
  'hudChrome.wocSeason.ended': '本賽季已結束。',
  'hudChrome.wocSeason.openEnded': '無限期',
  'hudChrome.wocSeason.poolLabel': '可用獎勵池',
  'hudChrome.wocSeason.emittedLabel': '迄今已發放獎池的 {pct}%',
  'hudChrome.wocSeason.sinkLabel': '已注資',
  'hudChrome.wocSeason.invariant': '發放永遠不會超過賽季收入：買入 > 賣出，鏈上強制執行。',
  ...
  'hudChrome.wocSeason.projectedNote': '基於目前獎池與競技場排名的預測；最終發放於賽季結束時結算。',
};
