...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.frontier_daily_muster.title': '邊境集結',
  'entities.quests.frontier_daily_muster.text':
    '每個士兵在開戰前都要報到。先向軍需官霜衛領取補給，然後回到我這裡集結，領取你的榮譽。',
  'entities.quests.frontier_daily_muster.completion':
    '很好。邊境又守住了一天。拿好你的榮譽，士兵，在外面小心背後。',
  'entities.quests.frontier_daily_muster.objectives.0.label': '向軍需官霜衛領取補給',
  'hudChrome.warfare.notEnoughHero': '英雄點數不足。',
  'entities.items.frostrend_helm.name': '裂霜頭盔',
  'entities.items.frostrend_spaulders.name': '裂霜肩甲',
  'entities.items.frostrend_hauberk.name': '裂霜鎖甲',
  'entities.items.frostrend_girdle.name': '裂霜腰帶',
  'entities.items.frostrend_legguards.name': '裂霜護腿',
  'entities.items.frostrend_gauntlets.name': '裂霜護手',
  'entities.items.frostrend_sabatons.name': '裂霜戰靴',
  'entities.items.frostrend_choker.name': '裂霜項鍊',
  'entities.items.frostrend_band.name': '裂霜指環',
  'entities.npcs.frostreach_quartermaster.name': '維爾卡·霜衛',
  'entities.npcs.frostreach_quartermaster.title': '霜達軍需官',
  'entities.npcs.frostreach_quartermaster.greeting': '邊境以鮮血與寒霜為報。好好花你的英雄點數。',
  'hudChrome.warfare.reasons.frontierKill': '邊境擊殺',
  'hudChrome.warfare.reasons.frontierRare': '霜達稀有精英',
  'hudChrome.warfare.reasons.frontierDaily': '邊境每日任務',
  'entities.mobs.rimefang_stalker.name': '霜牙潛襲者',
  'entities.mobs.frostbound_revenant.name': '霜縛亡魂',
