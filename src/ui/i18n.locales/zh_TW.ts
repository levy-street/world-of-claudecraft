...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'character.respec': '重置天賦',
  'character.respecHint': '燃燒 $WOC 以重置天賦或解鎖額外的配裝欄位。',
  'character.respecPaidButton': '花費 {amount} $WOC 重置天賦',
  'character.loadoutSlotPaidButton': '花費 {amount} $WOC 解鎖配裝欄位',
  'character.respecCancel': '取消',
  'character.respecSuccess': '天賦已重置。',
  'character.loadoutSlotSuccess': '配裝欄位已解鎖。',
