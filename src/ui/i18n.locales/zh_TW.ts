...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "hud.mounts.noWallet": "在綁定錢包上至少持有 {amount} $WOC（供應量的 0.1%），以贏得你的第一匹旅行坐騎。",
  ...
  "hud.wager.inviteCharter": "{name}開設了一場賭注競速 — 下注 {money} 加一份坐騎憑證即可加入。要應戰嗎？",
  ...
  "entities.npcs.skytrial_master.greeting": "天空是條少有人敢踏上的路，{className}。贏得它，它便會承載你。",
  "entities.quests.q_skyward_first_flight.title": "初次飛行",
  "entities.quests.q_skyward_first_flight.text": "你在地面上騎著有翼戰駒已夠穩了，{playerName} — 現在讓牠升空。飛越谷地天試：一趟環繞的飛行，八個光環。先別追逐計時，只要保持滯空，穿過每一個光環。",
  "entities.quests.q_skyward_first_flight.completion": "你沒有墜落。在第一趟環繞就能做到這點的人不多。天空記得那些不斷回來的人。",
  "entities.quests.q_skyward_first_flight.objectives.0.label": "完成谷地天試",
  "entities.quests.q_skyward_time_trial.title": "與時間賽跑",
  "entities.quests.q_skyward_time_trial.text": "現在帶著意圖再來一次。再飛一趟谷地天試，{playerName}，但要在沙漏流盡前完成。乾淨俐落地穿過每一個光環，不浪費一絲氣流。要精準，別慌亂。",
  "entities.quests.q_skyward_time_trial.completion": "一氣呵成，環環相扣。你不再只是駕馭天空 — 你正在飛翔。",
  "entities.quests.q_skyward_time_trial.objectives.0.label": "於標準時間內飛完谷地天試",
  "entities.quests.q_skyward_ascendant.title": "登天者",
  "entities.quests.q_skyward_ascendant.text": "只剩一項試煉，{playerName}：谷地環道。繞行長環三圈，於標準時間內飛完 — 不靠運氣，只憑技藝。征服它，廣闊天空便任你縱橫，從天際的一端到另一端。",
  "entities.quests.q_skyward_ascendant.completion": "登天而不折。如今天空屬於你了，{playerName}。收下這份憑證 — 一匹御風的戰駒，憑本事贏來而非買來，載你前往任何你心之所向的地方。",
