...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'races.sectionTitle': '陣營與種族',
  'races.factionKael': '凱爾帝國',
  'races.factionVeth': '維斯聯盟',
  'races.factionOssara': '奧薩拉領域',
  'races.human': '人類',
  'races.dwarf': '矮人',
  'races.gnome': '地精',
  'races.elf_exile': '流亡精靈',
  'races.elf': '精靈',
  'races.dark_fae': '暗影妖精',
  'races.frost_kin': '霜族',
  ...
  'races.sand_mage': '沙法師',
  'races.nomad': '遊牧民',
  'races.stone_warden': '石衛',
  'races.humanAria': '人類種族',
  'races.dwarfAria': '矮人種族',
  'races.gnomeAria': '地精種族',
  'races.elf_exileAria': '流亡精靈種族',
  'races.elfAria': '精靈種族',
  'races.dark_faeAria': '暗影妖精種族',
  'races.frost_kinAria': '霜族種族',
  'races.shadow_walkerAria': '影行者種族',
  'races.desert_clanAria': '沙漠氏族種族',
  'races.sand_mageAria': '沙法師種族',
  'races.nomadAria': '遊牧民種族',
  'races.stone_wardenAria': '石衛種族',
  'races.raceLabel': '種族',
  'races.racialLabel': '種族特長',
  'races.levelRaceClass': '{level}級 {race}{className}',
  'races.racialName_human': '登陸之諾',
  'races.racialDesc_human': '休息經驗累積速度提高25%。',
  'races.racialName_dwarf': '石血',
  'races.racialDesc_dwarf': '護甲提高5%。',
  'races.racialName_gnome': '齒輪智慧',
  'races.racialDesc_gnome': '智力提高5%。',
  'races.racialName_elf_exile': '流亡者的自律',
  'races.racialDesc_elf_exile': '施法受擊延遲降低20%。',
  'races.racialName_elf': '暮光之雅',
  'races.racialDesc_elf': '閃躲機率提高1%。',
  'races.racialName_dark_fae': '妖靈狡黠',
  'races.racialDesc_dark_fae': '致命一擊機率提高1%。',
  'races.racialName_frost_kin': '寒冬之膚',
  'races.racialDesc_frost_kin': '耐力提高3%。',
  'races.racialName_shadow_walker': '無聲之刃',
  'races.racialDesc_shadow_walker': '敏捷提高3%。',
  'races.racialName_desert_clan': '烈日鍛軀',
  'races.racialDesc_desert_clan': '最大生命值提高3%。',
  'races.racialName_sand_mage': '琉璃共鳴',
  'races.racialDesc_sand_mage': '法術強度提高5%。',
  'races.racialName_nomad': '不息行軍',
  'races.racialDesc_nomad': '精神提高5%。',
  'races.racialName_stone_warden': '採石之力',
  'races.racialDesc_stone_warden': '力量提高3%。',
  // Valdris continent (v0.19): item names
  'entities.items.dune_prowler_pelt.name': '沙丘掠行者之皮',
  'entities.items.glasswind_stinger.name': '琉璃風之刺',
  'entities.items.stolen_relic.name': '失竊的聖物',
  'entities.items.nameless_burial_shroud.name': '無名者裹屍布',
  'entities.items.storm_glass_core.name': '風暴玻璃核心',
  'entities.items.verdict_seal.name': '裁決印章',
  'entities.items.glasswind_husk.name': '琉璃風甲殼',
  'entities.items.mirage_stalker_eye.name': '蜃影潛伏者之眼',
  'entities.items.dig_manifest.name': '挖掘清單',
  'entities.items.tomb_censer.name': '墓穴香爐',
  'entities.items.sentence_tablet.name': '判決石板',
  'entities.items.duststorm_heart.name': '塵暴之心',
  'entities.items.ravager_hide.name': '蹂躪者皮革',
  'entities.items.aqueduct_bronze.name': '渡槽青銅配件',
  'entities.items.judge_regalia.name': '初代法庭華服',
  'entities.items.sunbleached_fang.name': '日曬白牙',
  'entities.items.cracked_scarab_shell.name': '碎裂的聖甲蟲殼',
  'entities.items.emberjaw_pelt.name': '燃顎族母之皮',
  'entities.items.karns_funeral_mask.name': '卡恩的葬儀面具',
  'entities.items.qesh_flatbread.name': '奇什烤餅',
  'entities.items.oasis_waterskin.name': '綠洲水袋',
  'entities.items.spiced_scarab_skewer.name': '香料聖甲蟲串',
  'entities.items.duneweave_robe.name': '沙丘織袍',
  'entities.items.caravan_guard_hauberk.name': '商隊護衛鎖甲',
  'entities.items.prowlerhide_vest.name': '掠行者皮背心',
  'entities.items.sandwalker_treads.name': '行沙者之靴',
  'entities.items.dunewatch_legguards.name': '沙丘哨衛護腿',
  'entities.items.qesh_khopesh.name': '奇什鐮刀劍',
  'entities.items.judgestaff_of_ossara.name': '奧薩拉裁判杖',
  'entities.items.glasswind_talon.name': '琉璃風之爪',
  'entities.items.emberjaw_prowlgrips.name': '燃顎狩獵護手',
  'entities.items.unburied_gravewraps.name': '未葬者的墓布裹手',
  'entities.items.sandmaw_scale_cuirass.name': '沙顎鱗甲胸鎧',
  'entities.items.tyrantfang_edge.name': '暴君之牙利刃',
  'entities.items.palewidow_silk.name': '蒼白寡婦之絲',
  'entities.items.waterlogged_ledger.name': '浸水的帳簿',
  'entities.items.guildless_sigil.name': '無會者印記',
  'entities.items.silent_court_seal.name': '寂靜法庭之印',
  'entities.items.duskmane_pelt_strip.name': '暮鬃皮條',
  'entities.items.palewidow_venom_sac.name': '蒼白寡婦毒囊',
  'entities.items.quay_manifest.name': '浸水的碼頭清單',
  'entities.items.wisplight_essence.name': '妖光精華',
  'entities.items.drowned_toll_coin.name': '溺亡的過路幣',
  'entities.items.cutthroat_contract.name': '割喉者契約',
  'entities.items.court_ledger_page.name': '法庭帳頁',
  'entities.items.frostpine_war_totem.name': '霜松戰爭圖騰',
  'entities.items.rimeclaw_pelt.name': '霜爪之皮',
  'entities.items.duskmane_tuft.name': '暮鬃毛簇',
  'entities.items.guttering_wisp_mote.name': '搖曳妖火微粒',
  'entities.items.frostpine_charm.name': '霜松護符',
  'entities.items.palefang_pelt.name': '靜默蒼牙之皮',
  'entities.items.grelnoks_frozen_idol.name': '格雷諾克的冰凍神像',
  'entities.items.nighthollow_black_bread.name': '夜穴黑麵包',
  'entities.items.pinefrost_tea.name': '松霜茶',
  'entities.items.smoked_blackmere_eel.name': '黑澤燻鰻',
  'entities.items.wispweave_robe.name': '妖光織袍',
  'entities.items.quayguard_hauberk.name': '碼頭衛兵鎖甲',
  'entities.items.duskstalker_vest.name': '暮色潛行者背心',
  'entities.items.nightpath_treads.name': '夜徑之靴',
  'entities.items.blackriver_legguards.name': '黑河護腿',
  'entities.items.terracewatch_leggings.name': '梯田哨衛護腿',
  'entities.items.quays_cutlass.name': '碼頭彎刀',
  'entities.items.wispcaller_staff.name': '喚妖者法杖',
  'entities.items.whispersteel_stiletto.name': '低語鋼刺劍',
  'entities.items.palefang_grips.name': '蒼牙護手',
  'entities.items.hoarbound_bindings.name': '縛霜者鐐銬',
  'entities.items.forsworn_lamellar.name': '背誓者鱗葉甲',
  'entities.items.forsworn_edge.name': '背誓者之刃',
  'entities.items.stolen_tithe_ledger.name': '失竊的什一稅冊',
  'entities.items.granite_core_shard.name': '花崗岩核心碎片',
  'entities.items.legion_deserter_insignia.name': '軍團逃兵徽記',
  'entities.items.chewed_tithe_scrip.name': '嚼爛的稅券',
  'entities.items.candle_tax_tally.name': '蠟燭稅記帳牌',
  'entities.items.assay_office_seal.name': '檢驗局印章',
  'entities.items.legion_pay_manifest.name': '軍團軍餉清單',
  'entities.items.prime_wolf_pelt.name': '上等狼皮',
  'entities.items.wendigo_gallstone.name': '溫迪戈膽石',
  'entities.items.icehowler_ruff.name': '冰嚎者頸毛',
  'entities.items.legion_quarrel_bundle.name': '軍團弩矢束',
  'entities.items.clipped_imperial_coin.name': '剪邊帝國幣',
  'entities.items.rimewoven_hide.name': '霜織獸皮',
  'entities.items.sellsword_pig_iron.name': '傭兵生鐵',
  'entities.items.lean_wolf_haunch.name': '精瘦狼腿肉',
  'entities.items.pilfered_ration_pack.name': '失竊的口糧包',
  'entities.items.sellsword_requisition_chit.name': '傭兵徵用券',
  'entities.items.frostbrush_wolf_fang.name': '霜灌狼牙',
  'entities.items.bent_legion_buckle.name': '彎折的軍團扣帶',
  'entities.items.ogre_knuckle_dice.name': '食人魔指節骰',
  'entities.items.hoarfang_pelt.name': '霜牙頭狼之皮',
  'entities.items.kazriks_brass_whistle.name': '卡茲里克的黃銅哨',
  'entities.items.kaelspire_barley_loaf.name': '凱爾尖塔大麥麵包',
  'entities.items.silverbrook_spring_water.name': '銀溪泉水',
  'entities.items.imperial_field_ration.name': '帝國野戰口糧',
  'entities.items.imperial_clerks_robe.name': '帝國文書長袍',
  'entities.items.kael_infantry_hauberk.name': '凱爾步兵鎖甲',
  'entities.items.wolfsward_hunting_jerkin.name': '守狼林狩獵皮衣',
  'entities.items.tithe_road_marchboots.name': '什一稅之路行軍靴',
  'entities.items.imperial_marcher_legguards.name': '帝國行軍者護腿',
  'entities.items.kael_arming_sword.name': '凱爾騎士劍',
  'entities.items.frosthelm_warstaff.name': '霜盔戰杖',
  'entities.items.wolfsward_skinner.name': '守狼林剝皮刀',
  'entities.items.prefects_sealed_mantle.name': '長官的封印斗篷',
  'entities.items.huntmasters_winter_hood.name': '狩獵大師的冬帽',
  'entities.items.hoarfang_clawgrips.name': '霜牙爪握護手',
  'entities.items.overseers_candlewraps.name': '監工的燭蠟裹手',
  'entities.items.oathbreakers_battleplate.name': '破誓者戰甲',
  'entities.items.oathbreakers_greatblade.name': '破誓者巨刃',
  'entities.items.grey_shale_chip.name': '灰頁岩碎片',
  'entities.items.smuggled_trinket.name': '走私小飾品',
  'entities.items.barbed_thorn_husk.name': '倒鉤荊棘莢殼',
  'entities.items.thornfen_tusk.name': '荊澤巨魔獠牙',
  'entities.items.torn_caravan_banner.name': '撕裂的商隊旗幟',
  'entities.items.ironpass_rubble_core.name': '鐵隘口瓦礫核心',
  'entities.items.wyvern_tail_barb.name': '雙足飛龍尾刺',
  'entities.items.reagent_gland.name': '鼓脹的藥劑腺體',
  'entities.items.fogged_lantern_glass.name': '霧濛的提燈玻璃',
  'entities.items.river_worn_idol.name': '河磨神像',
  'entities.items.gull_picked_bone.name': '被鷗啄食的骨頭',
  'entities.items.underway_hardtack.name': '地下道乾糧',
  'entities.items.smugglers_black_brew.name': '走私者黑釀',
  'entities.items.thornberry_loaf.name': '荊棘莓麵包',
  'entities.items.palisade_pine_tea.name': '柵壘松茶',
  'entities.items.tollhouse_stew.name': '稅卡燉菜',
  'entities.items.ironpass_mulled_cider.name': '鐵隘口熱蘋果酒',
  'entities.items.lanternfen_eel_skewer.name': '燈沼鰻魚串',
  'entities.items.fogberry_tonic.name': '霧莓補劑',
  'entities.items.bridgewatch_rations.name': '橋哨口糧',
  'entities.items.nameless_river_water.name': '無名河水',
  'entities.items.smuggler_kings_softsteps.name': '走私者之王的軟底靴',
  'entities.items.briarfather_bark_mitts.name': '荊棘之父的樹皮手套',
  'entities.items.skarns_war_harness.name': '斯卡恩的戰爭挽具',
  'entities.items.colossus_mireheart_girdle.name': '泥沼之心束帶',
  'entities.items.bridgekeepers_tollstaff.name': '護橋人的過路杖',
  'entities.items.melted_ration_tin.name': '熔化的口糧罐',
  'entities.items.ashcaked_fang.name': '結灰之牙',
  'entities.items.ember_glass_shard.name': '餘燼玻璃碎片',
  'entities.items.saltglass_shard.name': '鹽玻璃碎片',
  'entities.items.salt_crusted_chitin.name': '鹽殼幾丁質',
  'entities.items.bleached_bone_charm.name': '漂白骨符',
  'entities.items.tarnished_prewar_coin.name': '失澤的戰前硬幣',
  'entities.items.sewer_silk_wad.name': '下水道絲團',
  'entities.items.gutter_hound_pelt.name': '溝渠獵犬之皮',
  'entities.items.cracked_salamander_scale.name': '碎裂的火蜥蜴鱗片',
  'entities.items.cooled_magma_bead.name': '冷卻的岩漿珠',
  'entities.items.slag_nugget.name': '爐渣塊',
  'entities.items.rusted_deserter_badge.name': '鏽蝕的逃兵徽章',
  'entities.items.redspire_rock_shard.name': '紅塔岩石碎片',
  'entities.items.spire_stalker_claw.name': '塔尖潛伏者之爪',
  'entities.items.cinderrest_ashcake.name': '燼歇灰餅',
  'entities.items.boiled_cistern_water.name': '煮沸的蓄水池水',
  'entities.items.brinehollow_salt_jerky.name': '鹽窟鹹肉乾',
  'entities.items.desalted_waterskin.name': '脫鹽水袋',
  'entities.items.gutter_stew.name': '流亡市場溝渠燉菜',
  'entities.items.black_market_tea.name': '黑市茶',
  'entities.items.forgefall_hardtack.name': '落爐乾糧',
  'entities.items.coalfire_stout.name': '煤火黑啤',
  'entities.items.waymeet_marching_bread.name': '路會行軍麵包',
  'entities.items.bitterroot_brew.name': '苦根釀',
  'entities.items.revenant_cinderguard.name': '亡者護灰甲',
  'entities.items.marrowhide_leggings.name': '髓皮護腿',
  'entities.items.scavenger_kings_shiv.name': '拾荒者之王的短刃',
  'entities.items.forgewyrm_scale_helm.name': '鍛爐巨蠕鱗盔',
  'entities.items.mantle_of_the_last_muster.name': '最後動員之斗篷',
  'entities.items.scorched_banner_scrap.name': '燒焦的旗幟殘片',
  'entities.items.melted_signet_ring.name': '熔化的印戒',
  'entities.items.cracked_horror_horn.name': '碎裂的懼獸之角',
  'entities.items.bastion_hardtack.name': '堡壘乾糧',
  'entities.items.trucewater_flask.name': '停戰水壺',
  'entities.items.ashguard_robe.name': '護灰長袍',
  'entities.items.breachwalker_jerkin.name': '裂隙行者皮衣',
  'entities.items.bastion_plated_hauberk.name': '堡壘鑲板鎖甲',
  'entities.items.bastion_arming_sword.name': '堡壘騎士劍',
  'entities.items.mercenary_greatblade.name': '傭兵巨刃',
  'entities.items.tithe_collectors_grasps.name': '什一稅徵收官之爪',
  'entities.items.craterheart_mantle.name': '坑心斗篷',
  'entities.items.butchers_chainguard.name': '屠夫的鎖鏈甲',
  'entities.items.vhorlans_flensing_blade.name': '沃蘭的剝皮利刃',
  'entities.items.warbringers_hellforged_cuirass.name': '戰爭使者的地獄鑄鎧',
  'entities.items.khorvax_warcleaver.name': '庫爾瓦克斯戰爭劈刀',
  'hudChrome.map.worldTitle': '瓦爾德里斯：已知世界',
  'hudChrome.map.theLanding': '登陸之島',
  'hudChrome.map.theBreachRing': '裂隙與爭奪之環',
  'hudChrome.map.clickHint': '點擊區域打開其地圖',
  'hudChrome.map.backHint': '點擊領地進入。右鍵返回上一級',
  'hudChrome.map.sealed': '已封鎖',
  'hudChrome.map.sealedHint': '前方戰線已封鎖，無法通行。',
  'hudChrome.envoys.title': '使節大廳',
  'hudChrome.envoys.prompt': '選擇你的陣營，以及你將與之並肩的種族。',
  'hudChrome.envoys.permanent':
    '此誓言不可更改。你的陣營決定你的家園、盟友，以及永恆之戰中的敵人。',
  'hudChrome.envoys.confirm': '立下誓言',
  'hudChrome.envoys.travelTitle': '通行',
  'hudChrome.envoys.travelBody': '現在啟程嗎？轉瞬即達。',
  'hudChrome.envoys.travelGo': '啟程',
  'hudChrome.envoys.travelStay': '留下',
  'hudChrome.defense.start': '守住陣線！守衛者嚴陣以待。',
  'hudChrome.defense.wave': '已擊退第{wave}波，共{total}波！',
  ...
  'entities.items.conjured_bread5.name': '魔法酸麵包',
  ...
  'entities.items.forged_levy_papers.name': '偽造的徵募文書',
  'entities.items.amnesty_petition.name': '未歸檔的特赦請願書',
  'entities.items.fort_pattern_kettle.name': '要塞制式水壺',
  'entities.items.garnished_pay_pouch.name': '被扣押的餉銀袋',
  'entities.items.fault_line_core.name': '斷層核心',
  'entities.items.unstamped_duel_permit.name': '未蓋印的決鬥許可證',
  'entities.items.rimeclaw_tallow.name': '霜爪獸油脂',
  'entities.items.rimeclaw_marrowbone.name': '霜爪獸髓骨',
  'entities.items.oathguard_plate_scrap.name': '誓衛板甲殘片',
  'entities.items.ninth_muster_roll.name': '搶救回的點名冊',
  'entities.items.icehowler_haunch.name': '冰嚎獸後腿肉',
  'entities.items.rimebound_core_ice.name': '縛霜核心冰',
  'entities.items.glacial_quench_ice.name': '冰川淬火冰',
  'entities.items.maren_calling_card.name': '馬倫家族名帖',
  'entities.items.maldreks_route_ledger.name': '瑪爾德雷克的路線帳簿',
  'entities.items.grulks_iron_strongbox.name': '格魯爾克的鐵保險箱',
  'entities.items.maren_duelling_mantle.name': '馬倫決鬥披風',
  'entities.items.final_notice_wraps.name': '最後通牒裹布',
  'entities.items.pay_wardens_shoulderguards.name': '餉銀典獄官護肩',
  'entities.items.rimeshaft_foremans_cap.name': '霜井工頭便帽',
  'entities.items.quarter_close_vestments.name': '季末結算法衣',
  'entities.items.assessors_lead_greaves.name': '估稅官鉛護脛',
  'entities.items.purse_wardens_coinbelt.name': '錢袋典獄官錢幣腰帶',
  'entities.items.mothwing_dust.name': '蛾翼之塵',
  'entities.items.silt_eel.name': '淤泥鰻',
  'entities.items.barge_chit.name': '泡脹的駁船籌碼',
  'entities.items.ferry_lantern_mote.name': '渡船燈芒',
  'entities.items.smugglers_tally_knot.name': '走私者的計數繩結',
  'entities.items.forged_weir_pass.name': '偽造的堰壩通行證',
  'entities.items.sunken_ration_tin.name': '沉沒的口糧罐',
  'entities.items.hollow_toll_scrip.name': '空頭過路憑單',
  'entities.items.rimeclaw_haunch.name': '霜爪獸後腿肉',
  'entities.items.rimebound_fetish.name': '縛霜物神',
  'entities.items.frostpine_tallow.name': '霜松油脂',
  'entities.items.forsworn_oath_knife.name': '背誓者誓言之刃',
  'entities.items.shadowbound_cipher.name': '縛影密文',
  'entities.items.vessiks_little_book.name': '維西克的小冊子',
  'entities.items.weirwatch_wraps.name': '堰壩哨衛裹布',
  'entities.items.lodgewalk_boots.name': '旅棧長靴',
  'entities.items.unbroken_wardstone.name': '完好的守護石',
  'entities.items.vault_ward_core.name': '地窖守護核心',
  'entities.items.temple_offering_bowl.name': '神廟供碗',
  'entities.items.graven_name_stone.name': '銘名石',
  'entities.items.stalker_haunch.name': '潛獵者後腿肉',
  'entities.items.heretic_creed_page.name': '燒焦的信條書頁',
  'entities.items.heretic_brand_iron.name': '異端烙鐵',
  'entities.items.heretic_writ.name': '異端判書',
  'entities.items.first_court_sigil.name': '第一法庭印記',
  'entities.items.duneglass_heart.name': '沙玻璃之心',
  'entities.items.unshattered_fulgurite.name': '完整的閃電熔岩',
  'entities.items.flameseer_ash_creed.name': '灰燼信條石板',
  'entities.items.flameseer_ember_phial.name': '餘燼小瓶',
  'entities.items.dawnward_censer.name': '晨衛香爐',
  'entities.items.stolen_water_cask.name': '封印的水桶',
  'entities.items.duskwater_oathmark.name': '暮水誓印',
  'entities.items.caravan_toll_tally.name': '封印的通行稅籌',
  'entities.items.tyrant_spoor.name': '暴君足跡鑄模',
  'entities.items.oxbone_toll.name': '牛骨稅籌',
  'entities.items.cartographers_map.name': '第一製圖師的地圖',
  'entities.items.templestone_shard.name': '廟石碎片',
  'entities.items.fulgurite_splinter.name': '閃電熔岩碎屑',
  'entities.items.charred_censer_chain.name': '燒焦的香爐鏈',
  'entities.items.wardens_stone_heart.name': '阿什克拉特的石心',
  'entities.items.first_meridian_compass.name': '第一子午線羅盤',
  'entities.items.seatstone_flatbread.name': '座石薄餅',
  'entities.items.seatwell_waterskin.name': '座井水囊',
  'entities.items.lastwater_jerky.name': '末水鎮肉乾',
  'entities.items.lastwater_skin.name': '末水鎮水囊',
  'entities.items.vaultkeepers_handwraps.name': '地窖看守人手甲',
  'entities.items.sahrs_penitent_leggings.name': '薩爾的苦修護腿',
  'entities.items.wardens_granite_edge.name': '看守人的花崗岩之刃',
  'entities.items.staff_of_the_sunken_court.name': '沉沒法庭之杖',
  'entities.items.duneglass_shiv.name': '沙玻璃刺刀',
  'entities.items.lastwater_roadmail.name': '末水鎮行路鎖甲',
  'entities.items.duskwatch_robe.name': '暮色守望長袍',
  'entities.items.raiders_dust_jerkin.name': '掠奪者的風塵皮甲',
  'entities.items.ashkerat_greaves.name': '阿什克拉特的脛甲',
  'entities.items.cartographers_windwraps.name': '製圖師的御風裹布',
  'entities.items.unlit_silk_gland.name': '無光絲腺',
  'entities.items.veskals_fang.name': '維斯卡爾之牙',
  'entities.items.broodmother_carapace_guard.name': '母巢甲殼護胸',
  'entities.items.condensed_mist_heart.name': '凝結的霧之心',
  'entities.items.mistfathers_knot.name': '霧父之結',
  'entities.items.fogwalker_treads.name': '行霧者之靴',
