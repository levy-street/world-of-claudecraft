...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.governance.disabled': '治理投票目前無法使用。',
  'apiError.governance.forbidden': '你沒有建立提案的權限。',
  'apiError.governance.not_found': '找不到該提案。',
  'apiError.governance.invalid_input': '請檢查提案欄位後再試。',
  'apiError.governance.wallet_not_linked': '投票前請先連結錢包。',
  'apiError.governance.wallet_mismatch': '該錢包未連結到你的帳戶。',
  'apiError.governance.window_closed': '該提案的投票已結束。',
  'apiError.governance.already_voted': '此錢包已對該提案投過票。',
  'apiError.governance.challenge_invalid': '該投票請求已過期，請再試一次。',
  'apiError.governance.bad_signature': '無法驗證錢包簽章。',
  'apiError.governance.balance_unavailable': '無法讀取你的 $WOC 餘額，請重試。',
  ...
  'hudChrome.governance.close': '關閉治理',
  'hudChrome.governance.subtitle': '$WOC 持有者諮詢投票',
  'hudChrome.governance.loading': '正在載入提案……',
  'hudChrome.governance.error': '無法載入治理提案。',
  'hudChrome.governance.empty': '目前沒有提案。',
  'hudChrome.governance.refresh': '重新整理',
  'hudChrome.governance.open': '進行中',
  'hudChrome.governance.closed': '已結束',
  'hudChrome.governance.closesAt': '{date} 結束',
  'hudChrome.governance.closedAt': '{date} 已結束',
  'hudChrome.governance.quorum': '法定票數：{needed} $WOC 中的 {current}',
  'hudChrome.governance.quorumReached': '已達到法定票數',
  'hudChrome.governance.category.content': '內容',
  'hudChrome.governance.category.cosmetic': '外觀',
  'hudChrome.governance.category.treasury': '資金',
  'hudChrome.governance.tally.for': '贊成',
  'hudChrome.governance.tally.against': '反對',
  'hudChrome.governance.tally.abstain': '棄權',
  'hudChrome.governance.tally.voters': '{count} 名投票者',
  'hudChrome.governance.vote.for': '投贊成票',
  'hudChrome.governance.vote.against': '投反對票',
  'hudChrome.governance.vote.abstain': '棄權',
  'hudChrome.governance.vote.needWallet': '連結錢包後即可投票。',
  'hudChrome.governance.vote.alreadyVoted': '你已投票：{choice}',
  'hudChrome.governance.vote.signing': '請在錢包中簽章……',
  'hudChrome.governance.vote.submitting': '正在提交投票……',
  'hudChrome.governance.vote.success': '你的投票已記錄。',
  'hudChrome.governance.vote.failed': '無法記錄你的投票。',
