...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.tabSupply': '供應量',
  'hudChrome.claudium.supplyTitle': '現存克勞迪姆',
  'hudChrome.claudium.supplyLoading': '正在載入供應量...',
  'hudChrome.claudium.supplyError': '無法載入供應量資料。請重試。',
  'hudChrome.claudium.supplyUnavailable': '暫時無法取得供應量資料。',
  'hudChrome.claudium.supplyInExistence': '現存 {amount}',
  'hudChrome.claudium.supplyUsdValue': '價值 {amount}',
  'hudChrome.claudium.supplyIssued': '累計發行總量',
  'hudChrome.claudium.supplySunk': '累計消耗或撤銷',
  'hudChrome.claudium.supplyHolders': '由 {n} 個帳戶持有',
  'hudChrome.claudium.supplyChangeUp': '本期增加 {amount}',
  'hudChrome.claudium.supplyChangeDown': '本期減少 {amount}',
  'hudChrome.claudium.supplyChangeFlat': '本期無變化',
  'hudChrome.claudium.supplyChartLabel': '所選期間的克勞迪姆供應量',
  'hudChrome.claudium.supplyChartEmpty': '本期沒有供應量變動。',
  'hudChrome.claudium.supplyRangeLabel': '圖表週期',
  'hudChrome.claudium.supplyFootnote': '統計所有帳戶持有的全部克勞迪姆，即時彙總自帳本。',
};
