...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.undermount_wing1.enterText': '你下到荊峰之下，進入玻璃般的黑暗。',
  'entities.dungeons.undermount_wing1.leaveText': '你從地底山的下行路爬回。',
  'entities.dungeons.undermount_wing2.name': '地底山: 回火',
  'entities.dungeons.undermount_wing2.enterText': '錘擊聲在回火寶庫中迴盪。',
  'entities.dungeons.undermount_wing2.leaveText': '你從鳴響的爐道撤退。',
  'entities.dungeons.undermount_wing3.name': '地底山: 甦醒',
  'entities.dungeons.undermount_wing3.enterText': '被埋的熔爐在深處躁動。',
  'entities.dungeons.undermount_wing3.leaveText': '你從甦醒的熱浪中撤離。',
  ...
  'entities.npcs.runeseeker_maerin.greeting':
    '他們告訴我這是一個死去邪教的鍛爐，{className}。死物不會燒得這麼熱。下面一定有什麼值得吞下這些煙塵。',
  'entities.quests.q_undermount_heat.title': '不該存在的熱量',
  'entities.quests.q_undermount_heat.text':
    '這道裂隙周圍的石頭熱得足以讓木炭字跡模糊，{playerName}。趁邪教還沒再次掩埋它們，拓下三塊裸露符文面的紋樣。如果圖案重複，我們就能知道下方藏著什麼。',
  'entities.quests.q_undermount_heat.completion':
    '所有線條都向內轉折。這些不是鐵匠的工印，{playerName}。它們是結界，而且有什麼東西正從下方割開它們。',
  ...
  'entities.quests.q_undermount_ledger.text':
    '發掘工頭把工作帳簿貼身保管，營地裡的狂信徒負責守衛。把它帶給我，{playerName}。我要知道每塊錠、每份口糧和每筆工錢都去了哪裡。',
  'entities.quests.q_undermount_ledger.completion':
    '向下。每一塊錠，每一點餘燼，全都耗在我們腳下，{playerName}。鍛爐沒有為地表生產任何東西。它在餵養山中埋藏的存在。',
  'entities.quests.q_undermount_ledger.objectives.0.label': '已擊殺 Wyrmcult 發掘工頭',
  'entities.quests.q_undermount_ledger.objectives.1.label': '已擊殺 Wyrmcult 守衛',
  'entities.quests.q_undermount_ledger.objectives.2.label': '已找回工頭帳簿',
  'entities.quests.q_undermount_descent.title': '進入地底山',
  'entities.quests.q_undermount_descent.text':
    '帳簿證實發掘場下還有第二處工事，每批貨物都指向下方。準備好時來找我，{playerName}。我要加入這次下行。',
  'entities.quests.q_undermount_descent.completion':
    '帶上這盞燈。它沒有附魔，只有穩定的火焰，但我們在下面需要一束誠實的光。無論你是否完成這條任務鏈，團隊入口都會開放。',
  'entities.quests.q_undermount_descent.objectives.0.label': '與尋符者梅林交談',
  ...
  'entities.items.ashwalk_sandals.name': '踏灰涼鞋',
  'entities.items.undermount_rune_rubbing.name': '地底熔爐符文拓片',
  'entities.items.undermount_foreman_ledger.name': '地底熔爐工頭帳簿',
  'entities.items.runeseekers_lantern.name': '尋符者提燈',
  'entities.items.cinderarc_odrenns_rod.name': '燼弧，奧德倫之杖',
  'entities.mobs.wyrmcult_dig_foreman.name': '巨龍教團挖掘監工',
  'entities.items.cindertoad_signet.name': '燼蟾徽戒',
  'entities.items.coalglow_band.name': '煤光指環',
  'entities.items.crownforged_warleggings.name': '冠鑄戰腿甲',
  'entities.items.glassblowers_shiv.name': '玻璃匠短刀',
  'entities.items.glasswalker_treads.name': '踏玻之靴',
  'entities.items.nighttalon_prowlers.name': '夜爪潛行靴',
  'entities.items.quenchsilk_cord.name': '淬火絲繩',
  'entities.items.ring_of_the_first_quench.name': '初淬之戒',
  'entities.items.saans_stoking_iron.name': '薩安撥火棍',
  'entities.items.slag_tempered_sabatons.name': '渣淬護脛',
  'entities.items.slakeleather_belt.name': '淬革腰帶',
  'entities.items.sluicebearer.name': '持閘者',
  'entities.items.soulflame_kilt.name': '魂焰戰裙',
  'entities.items.stokebrand_striders.name': '爐印行靴',
  'entities.items.stormcallers_legwraps.name': '喚雷者裹腿',
  'entities.items.the_even_temper.name': '平衡之淬',
  'entities.items.twice_fired_slippers.name': '二次燒製便鞋',
  'entities.items.twicetempered_girdle.name': '雙淬腰帶',
  'entities.items.crownforged_heartplate.name': '冠鑄心甲',
  'entities.items.nighttalon_emberweave.name': '夜爪燼織衣',
  'entities.items.soulflame_vestments.name': '魂焰法衣',
  'entities.items.stormcallers_hauberk.name': '喚風者鎖甲',
  'entities.items.volzharrs_knucklestone.name': '沃爾扎爾的拳骨石',
  'entities.items.magmastrider_greaves.name': '熔岩行者脛甲',
  'entities.items.footwraps_of_the_waking_floor.name': '甦醒地面的裹足',
  'entities.items.forgeheat_cinch.name': '鍛爐熱力束帶',
  'entities.items.corebreaker_heart_of_the_undermount.name': '碎核者，山下之心',
  'entities.items.the_last_restraint.name': '最後的束縛',
  'entities.items.band_of_the_ninth_quench.name': '第九次淬火之戒',
  'entities.items.moltenheart_chroma.name': '熔火之心',
  'entities.itemSets.crownforged.bonus5': '致命一擊機率提高3%。',
  'entities.itemSets.nighttalon.bonus5': '致命一擊機率提高3%。',
  'entities.itemSets.soulflame.bonus5': '法術致命一擊機率提高3%。',
  'entities.itemSets.stormcallers.bonus5': '法術致命一擊機率提高3%。',
};
