...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.itemCharmHint': '放在背包中即可獲得加成',
  ...
  'entities.items.st_albus_index_finger.name': '聖阿爾布斯的食指',
  'entities.items.st_albus_middle_finger.name': '聖阿爾布斯的中指',
  'entities.items.st_albus_ring_finger.name': '聖阿爾布斯的無名指',
  'entities.items.st_albus_pinkie_finger.name': '聖阿爾布斯的小指',
  'entities.items.st_albus_thumb.name': '聖阿爾布斯的拇指',
  'entities.items.hand_of_st_albus.name': '聖阿爾布斯之手',
  ...
  'hudChrome.itemMenu.assemble': '組合',
