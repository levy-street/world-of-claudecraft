...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.castBar.channeling': '引導中',
  'hudChrome.castBar.complete': '完成',
  'hudChrome.castBar.interrupted': '已打斷',
  'hudChrome.castBar.failed': '失敗',
  'hudChrome.castBar.interruptible': '可打斷',
  'hudChrome.castBar.cannotInterrupt': '不可打斷',
  'hudChrome.castBar.danger': '危險',
  'hudChrome.castBar.pet': '寵物',
  'hudChrome.castBar.secondsShort': '{seconds}秒',
  'hudChrome.castBar.labelWithCue': '{cue}：{label}',
  'hudChrome.castBar.ariaStatus': '{bar}：{status}{label}，剩餘 {seconds}',
  'hudChrome.castBar.ariaOutcome': '{bar}：{status}{label}',
  'hudChrome.petAction.auto': '自動',
  'hudChrome.petAction.cooldownTitle': '{action}：剩餘 {seconds}',
  'hudChrome.petAction.cooldownAutoAria': '{action}：剩餘 {seconds}，{auto}',
