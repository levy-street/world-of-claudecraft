...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.source_cave.enterText': '你走進源初洞穴。',
  'entities.dungeons.source_cave.leaveText': '你離開了源初洞穴。',
  ...
  'sim.sourceCave.enter': '你走進源初洞穴。',
  'sim.sourceCave.leave': '你離開了源初洞穴。',
  'sim.sourceCave.rebootConfirm': '你確定要繼續嗎？按下之前，確保你已集結好所需的資源。',
  'sim.sourceCave.killProgress': '{name}倒下了。（已在源初洞穴擊敗 {killed}/{total}）',
