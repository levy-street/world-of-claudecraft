...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  'editor.vfx.raid': '團隊副本練習（不會死亡）',
  'editor.vfx.title': '特效工作室',
  'editor.vfx.library': '技能庫',
  'editor.vfx.inspector': '特效檢查器',
  'editor.vfx.search': '搜尋技能',
  'editor.vfx.class': '職業',
  'editor.vfx.scene': '戰鬥場景',
  'editor.vfx.sandbox': '訓練小隊',
  'editor.vfx.duel': '玩家對決',
  'editor.vfx.loading': '正在準備遊戲世界...',
  'editor.vfx.ready': '遊戲引擎執行中',
  'editor.vfx.failed': '工作室無法啟動。請重新載入。',
  'editor.vfx.cast': '施放技能',
  'editor.vfx.target': '目標',
  'editor.vfx.pause': '凍結',
  'editor.vfx.resume': '繼續',
  'editor.vfx.step': '單步',
  'editor.vfx.reset': '重設場景',
  'editor.vfx.replay': '重播指令',
  'editor.vfx.recover': '恢復資源',
  'editor.vfx.move': '奔跑',
  'editor.vfx.stop': '停止',
  'editor.vfx.speed': '播放速度',
  'editor.vfx.audio': '世界音效',
  'editor.vfx.tint': '主體顏色',
  'editor.vfx.accent': '點綴顏色',
  'editor.vfx.power': '強度',
  'editor.vfx.sparks': '火花',
  'editor.vfx.apply': '套用草稿',
  'editor.vfx.original': '使用原版',
  'editor.vfx.export': '匯出草稿',
  'editor.vfx.import': '匯入草稿',
  'editor.vfx.exportTake': '匯出工作階段',
  'editor.vfx.invalid': '草稿無效或包含不支援的技能。',
  'editor.vfx.applied': '草稿已套用',
  'editor.vfx.noSpec': '此技能使用獨立特效系統。',
  'editor.vfx.castTime': '施法時間',
  'editor.vfx.cooldown': '冷卻時間',
  'editor.vfx.seconds': '{value} 秒',
  'editor.vfx.timeline': '戰鬥時間軸',
  'editor.vfx.empty': '施放技能以開始錄製。',
  'editor.vfx.current': '時間：{value} 秒',
  'editor.vfx.events': '{count} 個事件',
  'editor.vfx.controls': '鏡頭控制',
  'editor.vfx.orbitLeft': '向左環繞',
  'editor.vfx.orbitRight': '向右環繞',
  'editor.vfx.closer': '拉近',
  'editor.vfx.farther': '拉遠',
  'editor.vfx.hide': '隱藏面板',
  'editor.vfx.show': '顯示面板',
  'editor.vfx.status': '生效中的效果',
  'editor.vfx.help': '拖動場景旋轉鏡頭，捲動縮放。凍結會保留目前畫面。',
  'editor.vfx.note': '施法遵循正常戰鬥規則。重播會重複指令，裝飾性隨機效果可能不同。',
  'editor.vfx.castFailed': '施法遭拒。請檢查目標、距離、資源與冷卻時間。',
  'editor.vfx.draftNote': '變更僅保留於本次工作階段，請匯出以儲存。',
  'editor.vfx.snapshot': '擷取畫面',
  ...
  'editor.vfx.exitArtView': '離開展示模式',
  'editor.vfx.previous': '上一個技能',
  'editor.vfx.next': '下一個技能',
  'editor.vfx.repeat': '重複施放',
  'editor.vfx.favourite': '加入收藏',
  'editor.vfx.unfavourite': '取消收藏',
  'editor.vfx.favourites': '僅顯示收藏',
  'editor.vfx.saved': '已儲存',
  'editor.vfx.updating': '正在更新預覽...',
  'editor.vfx.shortcuts':
    'Space：施放。[ / ]：上一個 / 下一個技能。R：重複施放。F：收藏。A：展示模式。',
  'editor.vfx.buildTools': '天賦、場景與燈光',
  'editor.vfx.noTalent': '未選擇天賦',
  'editor.vfx.talentLevel': '等級 {level}',
  'editor.vfx.seed': '場景種子',
  'editor.vfx.graphics': '畫面品質',
  'editor.vfx.environment': '預覽環境',
  'editor.vfx.studioEnvironment': '工作室舞台',
  'editor.vfx.worldEnvironment': '世界場景',
  'editor.vfx.lighting': '舞台燈光',
  'editor.vfx.neutralLighting': '中性',
  'editor.vfx.brightLighting': '明亮',
  'editor.vfx.savedGraphics': '使用遊戲設定',
  'editor.vfx.medium': '中等',
  'editor.vfx.ultra': '極高',
  'editor.vfx.cinematic': '電影級（最高細節）',
  'editor.vfx.reduceMotion': '減少動態效果',
  'editor.vfx.cinematicResponse': '電影感鏡頭反應',
  'editor.vfx.darkLighting': '暗調',
  'editor.vfx.low': '低',
  'editor.vfx.high': '高',
};
