...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.aldrin.entryLabel': '奧德林俱樂部',
  'hudChrome.aldrin.title': '奧德林俱樂部',
  'hudChrome.aldrin.intro':
    '按月訂閱的會員資格。所有特權僅限外觀、便利或進入權限，絕不提供任何戰鬥力。',
  'hudChrome.aldrin.loading': '載入中...',
  'hudChrome.aldrin.unavailable': '本伺服器尚未開放奧德林俱樂部。',
  'hudChrome.aldrin.memberBadge': '會員',
  'hudChrome.aldrin.notMember': '你還不是會員。',
  'hudChrome.aldrin.memberUntil': '會員有效期至{date}（剩餘{days}天）',
  'hudChrome.aldrin.autoRenew': '透過信用卡訂閱自動續約。',
  'hudChrome.aldrin.priceLine': '每{days}天{amount} USD',
  'hudChrome.aldrin.splitLine': '{treasuryPct}%注入公開金庫，{burnPct}%用於回購並銷毀$WOC。',
  'hudChrome.aldrin.perksTitle': '會員特權',
  'hudChrome.aldrin.perk.aura': '金色會員光環（僅視覺效果）',
  'hudChrome.aldrin.perk.regalia': '奧德林禮服幻化套裝（僅外觀）',
  'hudChrome.aldrin.perk.mount': '俱樂部專屬坐騎外觀',
  'hudChrome.aldrin.perk.title': '「奧德林俱樂部成員」稱號',
  'hudChrome.aldrin.perk.nameColor': '金色名牌顏色',
  'hudChrome.aldrin.perk.lounge': '會員專屬交誼廳與俱樂部聊天頻道',
  'hudChrome.aldrin.perk.wardrobe': '額外的外觀衣櫃欄位',
  'hudChrome.aldrin.perk.queue': '滿員時的優先登入佇列',
  'hudChrome.aldrin.perk.stipend': '每月外觀專用津貼',
  'hudChrome.aldrin.methodsTitle': '付款方式',
  'hudChrome.aldrin.method.stripe': '信用卡（Stripe）',
  'hudChrome.aldrin.reason.clubDisabled': '俱樂部在本伺服器已停用，暫不可用。',
  'hudChrome.aldrin.reason.walletCannotSign': '不可用：綁定的錢包僅支援訊息簽章，無法簽署交易。',
  'hudChrome.aldrin.reason.notConfigured': '本伺服器未設定。',
  'hudChrome.aldrin.quoteTitle': '付款報價：{method}',
  'hudChrome.aldrin.quoteAmount': '金額：{amount} {method}',
  'hudChrome.aldrin.quoteMemo': '備註（付款時必須附帶）：{memo}',
  'hudChrome.aldrin.quoteExpires': '該報價還有約{minutes}分鐘有效。',
  'hudChrome.aldrin.quoteExpired': '該報價已過期，請重新取得。',
  'hudChrome.aldrin.quoteError': '無法取得報價，請稍後再試。',
  'hudChrome.aldrin.railsNotice':
    '在營運金鑰與最終核准就緒前，本版本已停用付款功能。此視窗不會送出任何交易。',
  'hudChrome.aldrin.stripeNotice': '付款啟用後，信用卡結帳將透過Stripe開啟。',
  'hudChrome.aldrin.close': '關閉',
};
