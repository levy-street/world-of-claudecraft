...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocMarket.vaultTitle': '交易所金庫',
  'hudChrome.wocMarket.vaultBody': '未連結錢包也能出售：所得會以 $WOC 形式保存在這裡。可用於購買一口價商品，也可以隨時連結錢包後提領。',
  'hudChrome.wocMarket.vaultBalance': '金庫中有 {tokens} $WOC',
  'hudChrome.wocMarket.vaultBalanceUsd': '依目前價格約合 {usd}。僅為估算：金庫保存的是 $WOC，其美元價值會隨市場波動。',
  'hudChrome.wocMarket.vaultEmpty': '你的金庫是空的。',
  'hudChrome.wocMarket.vaultWithdraw': '提領到錢包',
  'hudChrome.wocMarket.vaultWithdrawAria': '將 {tokens} $WOC 提領到已連結的錢包',
  'hudChrome.wocMarket.vaultNeedsWallet': '連結錢包後即可提領金庫餘額。',
  'hudChrome.wocMarket.vaultWithdrawn': '已將 {tokens} $WOC 提領到你的錢包。',
  'hudChrome.wocMarket.vaultSellHint': '未連結錢包：本次出售的所得將保存在你的交易所金庫中。',
  'hudChrome.wocMarket.vaultBuyWith': '用金庫餘額購買',
  'hudChrome.wocMarket.vaultPaysNote': '本次購買將從你的交易所金庫餘額中支付。',
  'hudChrome.wocMarket.quoteSignVault': '從金庫支付',
  'apiError.woc_market.held_disabled': '本伺服器未開放交易所金庫。',
  'apiError.woc_market.held_insufficient': '你的金庫餘額不足以支付本次購買。',
  'apiError.woc_market.held_empty': '你的金庫是空的。',
  'apiError.woc_market.held_withdraw_failed': '提領未能完成。餘額仍保留在你的金庫中，請稍後再試。',
  'wallet.reauthListTitle': '確認上架',
  'wallet.reauthListHelp': '未連結錢包，因此由你的帳號密碼代替錢包簽章來授權本次上架。',
  'apiError.woc_market.account_proof_required': '請輸入帳號密碼以授權本次上架。',
  'apiError.woc_market.account_proof_two_factor': '你的帳號已啟用兩步驟驗證，請輸入驗證碼以授權本次上架。',
  'apiError.woc_market.account_proof_no_password': '此帳號尚未設定密碼，請先在帳號設定中設定。',
  'apiError.woc_market.account_proof_invalid': '密碼或驗證碼未被接受，請再試一次。',
  'apiError.woc_market.account_proof_throttled': '失敗次數過多，請稍後再試。',
};
