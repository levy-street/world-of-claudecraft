...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberforged_hauberk.name': '餘燼鍛造鎖子甲',
  'entities.items.emberforged_legguards.name': '餘燼鍛造護腿',
  'entities.items.emberforged_girdle.name': '餘燼鍛造腰帶',
  'entities.items.cinderhide_vest.name': '煤燼皮背心',
  'entities.items.moltencore_maul.name': '熔核巨錘',
  'entities.items.brand_of_the_first_flame.name': '初焰烙印',
  'entities.items.emberseal_of_the_covenant.name': '破碎誓約的餘燼封印',
  'entities.items.bloodember_band.name': '血燼指環',
  'entities.items.ashcoil_signet.name': '灰燼盤繞印戒',
