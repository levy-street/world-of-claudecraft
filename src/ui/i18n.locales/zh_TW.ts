...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.object.mining_cracked_wall': '裂牆',
  'delveUi.object.herbalism_toxic_growth': '毒性蔓生',
  'delveUi.board.companion.roleLabel': '同伴職責',
  'delveUi.companionRole.healer': '治療',
  'delveUi.companionRole.tank': '坦克',
  'delveUi.companionRole.damage': '傷害',
  'delveUi.tracker.companionRole': '同伴職責：{role}',
  'delveUi.shortcut.miningReady': '採礦：打開裂牆',
  'delveUi.shortcut.miningFallback': '捷徑：鑿穿裂牆',
  'delveUi.shortcut.herbalismReady': '草藥學：淨化毒性蔓生',
  'delveUi.shortcut.herbalismFallback': '捷徑：清理毒性蔓生',
  ...
  'sim.delve.miningShortcut': '採礦找到了裂縫。裂牆打開了。',
  'sim.delve.miningShortcutFallback': '你鑿擊裂牆。採礦能更快打開它。',
  'sim.delve.miningShortcutFallbackComplete': '持續敲打後，裂牆終於坍開。',
  'sim.delve.herbalismShortcut': '草藥學讓毒性蔓生迅速枯萎。',
  'sim.delve.herbalismShortcutFallback': '你清退毒性蔓生。草藥學能更快淨化它。',
  'sim.delve.herbalismShortcutFallbackComplete': '持續清理後，毒性蔓生塌落。',
