...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.land_steward.greeting': '夢想擁有自己的爐火嗎？家園谷地為每一位備好一塊地，只要你帶著一百金幣，親手簽下地契。',
  'worldContent.homesteadGateName': '家園之門',
  // Player housing (M16 non-Latin fill)
  'hudChrome.housing.buy': '購買家園地契（{price}）',
  'hudChrome.housing.buyAria': '以 {price} 購買家園地契',
  'hudChrome.housing.travel': '前往你的家園',
  'hudChrome.housing.travelAria': '傳送到家園谷地中你的家園',
  'hudChrome.housing.confirmTitle': '家園地契',
  'hudChrome.housing.confirmBuy': '花費 {price} 在谷地簽下屬於你的家園？',
  'hudChrome.housing.confirmOk': '簽署地契',
  'hudChrome.housing.confirmCancel': '再想想',
  'hudChrome.housing.purchasedBanner': '家園谷地在等你。',
  'hudChrome.housing.arrivedBanner': '你的家園',
  'hudChrome.housing.leftBanner': '東溪鎮',
  'hudChrome.housing.result.purchased': '地契歸你了。找管家談談即可造訪你的家園。',
  'hudChrome.housing.result.alreadyOwned': '你已經持有家園地契。',
  'hudChrome.housing.result.cantAfford': '你買不起這份地契。',
  'hudChrome.housing.result.notOwned': '你還沒有家園地契。',
  'hudChrome.housing.result.tooFar': '你必須與土地管家當面交談。',
  'hudChrome.housing.result.glensFull': '谷地眼下有些擁擠。請稍後再試。',
  'hudChrome.housing.result.notHome': '你不在你的家園。',
};
