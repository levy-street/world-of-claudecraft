...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.mounts.title': '坐騎',
  'hud.mounts.subtitle': '$WOC 旅行坐騎',
  'hud.mounts.close': '關閉坐騎',
  'hud.mounts.summon': '召喚',
  'hud.mounts.dismount': '下騎',
  'hud.mounts.summoning': '正在召喚{name}…',
  'hud.mounts.riding': '騎乘中',
  'hud.mounts.flies': '可飛行',
  'hud.mounts.locked': '未解鎖',
  'hud.mounts.speed': '+{percent}% 速度',
  'hud.mounts.unlockAt': '持有 {amount} $WOC 即解鎖',
  'hud.mounts.supplyShare': '供應量的 {percent}',
  'hud.mounts.qualifyHeader': '你符合 {total} 匹旅行坐騎中的 {count} 匹資格。',
  'hud.mounts.holdingHint': '持有 {amount} $WOC。',
  'hud.mounts.noWallet':
    '在綁定錢包上至少持有 {amount} $WOC（供應量的 0.1%），以贏得你的第一匹旅行坐騎。',
  'hud.mounts.cantInCombat': '戰鬥中無法騎乘。',
  'hud.mounts.cantSwimming': '游泳時無法騎乘。',
  'hud.mounts.cantDead': '死亡時無法騎乘。',
  'hud.mounts.notEligible': '你的 $WOC 持有量尚未達到那匹戰駒。',
  'hud.mounts.summonedBanner': '你召喚了{name}。',
  'hud.mounts.summonAria': '召喚{name}',
  'hud.mounts.dismountAria': '從{name}下騎',
  'hud.mounts.lockedAria': '{name} — 未解鎖；持有 {amount} $WOC 即解鎖',
  'hud.mounts.activeAria': '{name} — 目前使用中',
  'hud.mounts.owned': '已擁有',
  'hud.mounts.mint': '鑄造憑證',
  'hud.mounts.mintHint': '為這匹坐騎鑄造一份可交易的憑證 — 賣出換取金幣，讓非持有者也能贏得牠。',
  'hud.mounts.mintAria': '為{name}鑄造一份可交易的憑證',
  'hud.mounts.mintedBanner': '你為{name}鑄造了一份憑證。',
  'hud.mounts.earnedBanner': '你已贏得{name} — 牠永遠屬於你。',
  'hud.mounts.alreadyOwnErr': '你已擁有那匹坐騎。',
  'hud.mounts.charterVoidErr': '那份憑證已作廢。',
  'hud.mounts.noCharterErr': '那匹坐騎無法鑄造憑證。',
  'hud.mounts.holdingsShortErr': '你的持有量不足以涵蓋那匹坐騎。',
  'hud.course.skytrials': '天試',
  'hud.course.skytrialsHint': '騎乘飛行坐騎，飛越計時的光環賽道。',
  'hud.course.needFlyer': '召喚一匹飛行坐騎以挑戰天試。',
  'hud.course.laps': '{count} 圈',
  'hud.course.starting': '飛越第一個光環以開始計時',
  'hud.course.finish': '完成！',
  'hud.course.failed': '挑戰結束 — 你離開了坐騎',
  'hud.course.aborted': '挑戰放棄',
  'hud.course.newBest': '最佳紀錄！',
  'hud.course.board': '排行榜',
  'hud.course.boardTitle': '{name} — 最佳時間',
  'hud.course.noTimes': '尚無紀錄 — 成為第一人。',
  'hud.course.loadingBoard': '載入中…',
  'hud.course.racePartyHint': '與你的隊伍競速 — 率先穿越光環者勝出。',
  'hud.course.getReady': '準備就緒',
  'hud.course.racing': '競速中',
  'hud.wager.start': '賭注競速',
  'hud.wager.title': '賭注競速',
  'hud.wager.inviteGold': '{name}開設了一場賭注競速 — 下注 {money} 即可加入。要應戰嗎？',
  'hud.wager.inviteCharter':
    '{name}開設了一場賭注競速 — 下注 {money} 加一份坐騎憑證即可加入。要應戰嗎？',
  'hud.wager.accept': '應下賭注',
  'hud.wager.potCharter': '彩池 {money} + {count}× 憑證',
  'hud.wager.racers': '參賽者（{count}）',
  'hud.wager.launch': '發動競速',
  'hud.wager.cancel': '取消',
  'hud.wager.leave': '離開',
  'hud.wager.waiting': '等待挑戰者跟注…',
  'hud.wager.won': '你贏得賭注 — {money}！',
  'hud.wager.wonCharter': '你贏得賭注 — {money} + {count}× 憑證！',
  'hud.wager.lost': '你輸掉了賭注。',
  'hud.wager.refunded': '賭注取消 — 你的注金已退還。',
  'hud.wager.antePrompt': '這場競速要下注多少金幣？（以銅幣計）',
  'hud.wager.open': '開設賭注',
  'hud.wager.stakeCharter': '同時押上一份坐騎憑證（贏家全拿）',
  'hud.wager.errCourse': '那條賽道無法下注。',
  'hud.wager.errFlyer': '你必須騎乘飛行坐騎才能下注。',
  'hud.wager.errBusy': '你已身處一場賭注之中。',
  'hud.wager.errAnte': '下注至少 1 銅幣。',
  'hud.wager.errStake': '那無法作為賭注押上。',
  'hud.wager.errAfford': '你無法支付那筆賭注。',
  'hud.wager.errExpired': '那份賭注邀約已過期。',
  'hud.wager.errGone': '那場賭注已不再開放。',
  'hud.wager.errHost': '只有主辦者能發動賭注。',
  'entities.items.charter_ashmane.name': '憑證：灰鬃疾行駒',
  'entities.items.charter_emberhoof.name': '憑證：燼蹄衝鋒駒',
  'entities.items.charter_bronzeflank.name': '憑證：銅脅戰駒',
  'entities.items.charter_silvermane.name': '憑證：銀鬃駿馬',
  'entities.items.charter_stormhoof.name': '憑證：暴蹄衝鋒駒',
  'entities.items.charter_goldcrest.name': '憑證：金冠掠空駒',
  'entities.items.charter_verdant.name': '憑證：碧翠野翼',
  'entities.items.charter_voidstrider.name': '憑證：虛翼行者',
  'entities.items.charter_celestial.name': '憑證：天界熾天使',
  'entities.items.charter_worldbearer.name': '憑證：負世巨鵬',
  'entities.npcs.skytrial_master.name': '天空大師維爾',
  'entities.npcs.skytrial_master.title': '天試守護者',
  'entities.npcs.skytrial_master.greeting':
    '天空是條少有人敢踏上的路，{className}。贏得它，它便會承載你。',
  'entities.quests.q_skyward_first_flight.title': '初次飛行',
  'entities.quests.q_skyward_first_flight.text':
    '你在地面上騎著有翼戰駒已夠穩了，{playerName} — 現在讓牠升空。飛越谷地天試：一趟環繞的飛行，八個光環。先別追逐計時，只要保持滯空，穿過每一個光環。',
  'entities.quests.q_skyward_first_flight.completion':
    '你沒有墜落。在第一趟環繞就能做到這點的人不多。天空記得那些不斷回來的人。',
  'entities.quests.q_skyward_first_flight.objectives.0.label': '完成谷地天試',
  'entities.quests.q_skyward_time_trial.title': '與時間賽跑',
  'entities.quests.q_skyward_time_trial.text':
    '現在帶著意圖再來一次。再飛一趟谷地天試，{playerName}，但要在沙漏流盡前完成。乾淨俐落地穿過每一個光環，不浪費一絲氣流。要精準，別慌亂。',
  'entities.quests.q_skyward_time_trial.completion':
    '一氣呵成，環環相扣。你不再只是駕馭天空 — 你正在飛翔。',
  'entities.quests.q_skyward_time_trial.objectives.0.label': '於標準時間內飛完谷地天試',
  'entities.quests.q_skyward_ascendant.title': '登天者',
  'entities.quests.q_skyward_ascendant.text':
    '只剩一項試煉，{playerName}：谷地環道。繞行長環三圈，於標準時間內飛完 — 不靠運氣，只憑技藝。征服它，廣闊天空便任你縱橫，從天際的一端到另一端。',
  'entities.quests.q_skyward_ascendant.completion':
    '登天而不折。如今天空屬於你了，{playerName}。收下這份憑證 — 一匹御風的戰駒，憑本事贏來而非買來，載你前往任何你心之所向的地方。',
  'entities.quests.q_skyward_ascendant.objectives.0.label': '於標準時間內飛完谷地環道',

  // Skytrial course + race HUD short labels (par/lap/ring/time/place/pot).
  'hud.mounts.cardAria': '{name}：{flavor}',
  'hud.course.start': '起飛',
  'hud.course.give_up': '放棄',
  'hud.course.par': '基準 {time}',
  'hud.course.onePass': '1 圈',
  'hud.course.gate': '光環 {n}/{total}',
  'hud.course.lap': '第 {n}/{total} 圈',
  'hud.course.time': '時間',
  'hud.course.beatPar': '快於基準 {time}',
  'hud.course.offPar': '慢於基準 {time}',
  'hud.course.best': '最佳 {time}',
  'hud.course.you': '（你）',
  'hud.course.race': '競速',
  'hud.course.go': '出發！',
  'hud.course.dnf': '未完成',
  'hud.course.placeOf': '第 {place} 名／共 {total} 名',
  'hud.wager.pot': '彩池 {money}',
  ...
  'character.renamePaidButton': '支付 {amount} $WOC 並改名',
  'character.renamePriceHint': '自願改名將銷毀 {amount} $WOC。',
  'character.renameCancel': '取消',
  'character.mintSolName': '取得 .sol 名稱',
  'character.mintSolButton': '銷毀 {amount} $WOC 並鑄造',
  'character.mintSolHint':
    '以 {amount} $WOC 鑄造玩家自有的‹名稱›.worldofclaudecraft.sol，鏈上歸你所有。',
  'woc.linkWalletFirst': '連接並綁定 Solana 錢包後即可用 $WOC 支付。',
  'woc.quoting': '正在準備 $WOC 支付…',
  'woc.approveBurn': '請在錢包中批准銷毀 {amount} $WOC…',
  'woc.confirming': '正在鏈上確認銷毀…',
  'woc.finalizing': '等待 Solana 最終確認…',
  'woc.confirmFailed': '無法驗證 $WOC 支付。',
  'woc.finalizeTimeout':
    '等待最終確認逾時。如果 $WOC 已銷毀，請重新開啟並重試：支付將在最終確認後結算。',
  'woc.renameSuccess': '已改名為 {name}。',
  'woc.mintSuccess': '已鑄造 {domain}，鏈上歸你所有。',
  'woc.guildRenameSuccess': '公會已改名為 {name}。',
  'woc.reserveSuccess': '已預留名稱 {name}。',
  'walletPanel.title': '錢包',
  'walletPanel.closeAria': '關閉',
  'walletPanel.notConnected': '錢包未連線',
  'walletPanel.connect': '連接',
  'walletPanel.connectedStatus': '已連接 {address}',
  'walletPanel.linkedBadge': '已連結',
  'walletPanel.tabSend': '轉帳',
  'walletPanel.tabHire': '僱用',
  'walletPanel.tabJobs': '委託',
  'walletPanel.sendSection': '轉帳給玩家',
  'walletPanel.currency': '貨幣',
  'walletPanel.playerName': '玩家名稱',
  'walletPanel.recipientPlaceholder': '你要轉給誰？',
  'walletPanel.amount': '金額',
  'walletPanel.max': '最大',
  'walletPanel.balanceEmpty': '餘額: -',
  'walletPanel.balanceLoading': '餘額: …',
  'walletPanel.balanceUnavailable': '餘額: 無法取得',
  'walletPanel.balance': '餘額: {amount}',
  'walletPanel.balanceExceeds': '餘額: {amount}（超出餘額）',
  'walletPanel.connectForBalance': '連接錢包以查看餘額。',
  'walletPanel.sendNote':
    '在 Solana 上錢包對錢包直接轉帳。非託管: 遊戲絕不保管你的資金。需支付網路費用。',
  'walletPanel.send': '傳送',
  'walletPanel.sending': '傳送中…',
  'walletPanel.loginToSend': '登入並進入世界後才能轉帳給玩家。',
  'walletPanel.lookingUp': '正在尋找玩家…',
  'walletPanel.ownWallet': '（這是你自己的錢包）',
  'walletPanel.noVerifiedWallet': '沒有該名稱的玩家擁有已驗證的錢包。',
  'walletPanel.approveTransfer': '請在錢包中核准轉帳…',
  'walletPanel.sent': '已向{name}傳送 {amount} {currency}。',
  'walletPanel.viewTransaction': '檢視交易',
  'walletPanel.sendFailedWith': '傳送失敗: {message}',
  'walletPanel.sendFailed': '傳送失敗。',
  'walletPanel.hireSection': '僱用幫手',
  'walletPanel.hireOffline': '上線進入世界後才能僱用幫手。',
  'walletPanel.helperPlaceholder': '誰來幫你？',
  'walletPanel.rewardCurrency': '報酬貨幣',
  'walletPanel.reward': '報酬',
  'walletPanel.goalLabel': '目標，伺服器確認後付款',
  'walletPanel.goalReachLevel': '達到等級',
  'walletPanel.goalClearDungeon': '通關團本',
  'walletPanel.goalQuest': '任務',
  'walletPanel.goalBodyguard': '保鑣',
  'walletPanel.goalEscort': '護送',
  'walletPanel.targetLevel': '目標等級',
  'walletPanel.targetLevelPlaceholder': '2至20',
  'walletPanel.raidDungeon': '團本 / 地下城',
  'walletPanel.questOwn': '任務（你正在進行的）',
  'walletPanel.noActiveQuests': '你沒有可以僱人幫忙的進行中任務，請先接一個任務。',
  'walletPanel.protectMinutes': '保護我（分鐘）',
  'walletPanel.minutesPlaceholder': '例如 10',
  'walletPanel.escortDestination': '護送目的地',
  'walletPanel.useCurrentSpot': '使用我的目前位置',
  'walletPanel.destinationSet': '目的地已設定: ({x}, {z})',
  'walletPanel.noDestination': '尚未設定目的地。',
  'walletPanel.destinationHint': '目的地 ({x}, {z})，先離開，然後讓你的護衛把你帶回這裡。',
  'walletPanel.hireLogin': '上線進入世界後才能僱用玩家。',
  'walletPanel.escrowNote':
    '報酬會鎖定在鏈上託管中，伺服器確認目標後自動發放給幫手，若期限前未達成則退還給你。',
  'walletPanel.post': '發布並鎖定報酬',
  'walletPanel.posting': '發布中…',
  'walletPanel.setGoalFirst': '請先設定有效的目標。',
  'walletPanel.preparingEscrow': '正在準備託管…',
  'walletPanel.approveDeposit': '請在錢包中核准報酬存入…',
  'walletPanel.lockingReward': '正在鏈上鎖定報酬…',
  'walletPanel.waitingFinalization': '等待最終確認…',
  'walletPanel.confirmTimeout': '確認存款逾時。如果報酬已鎖定，最終確認後將自動結算。',
  'walletPanel.jobPosted': '委託已發布: {amount} {currency} 已為{name}鎖定在託管中。',
  'walletPanel.postFailed': '發布委託失敗。',
  'walletPanel.failedWith': '失敗: {message}',
  'walletPanel.jobsSection': '你的委託',
  'walletPanel.loading': '載入中…',
  'walletPanel.jobsOffline': '上線進入世界後才能管理委託。',
  'walletPanel.jobsEmpty': '還沒有委託。使用僱用分頁付錢請玩家幫忙。',
  'walletPanel.youHired': '你僱用了{name}',
  'walletPanel.hiredYou': '{name}僱用了你',
  'walletPanel.acceptJob': '接受委託',
  'walletPanel.cancelRefund': '取消並退款',
  'walletPanel.viewPayout': '檢視支付',
  'walletPanel.actionFailed': '操作失敗。',
  'walletPanel.status.awaitingDeposit': '等待你的存款',
  'walletPanel.status.offered': '已向你發出，接受即可開始',
  'walletPanel.status.open': '開放中，等待幫手接受',
  'walletPanel.status.active': '進行中',
  'walletPanel.status.completed': '已完成，幫手已獲付款',
  'walletPanel.status.expired': '已過期，已退款',
  'walletPanel.status.failedDied': '失敗（你死亡了），已退款',
