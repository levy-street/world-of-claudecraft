...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.cameraMode.title': '選擇你的鏡頭',
  'hudChrome.cameraMode.body': '你想如何控制鏡頭？',
  'hudChrome.cameraMode.classicLabel': '經典',
  'hudChrome.cameraMode.classicDesc': '按住滑鼠右鍵轉動鏡頭，放開即可釋放游標。',
  'hudChrome.cameraMode.mouseLabel': '滑鼠鏡頭',
  'hudChrome.cameraMode.mouseDesc': '滑鼠始終操控鏡頭，實現流暢的現代自由視角。',
  'hudChrome.cameraMode.recommended': '推薦',
  'hudChrome.cameraMode.note': '稍後可在 Esc 的「按鍵綁定」中更改。',
  'hudChrome.cameraMode.confirm': '確認',
  'hudChrome.cameraMode.dismiss': '關閉',
