...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.rift_arcane_execution': '虛空裂縫',
  'abilityUi.cast.rift_arcane_strike': '奧術殲滅',
  'abilityUi.cast.rift_brute_execution': '碎地者',
  'abilityUi.cast.rift_brute_strike': '最終審判',
  'abilityUi.cast.rift_ember_execution': '岩漿井',
  'abilityUi.cast.rift_ember_strike': '核心熔毀',
  'abilityUi.cast.rift_frost_execution': '冰河墳墓',
  'abilityUi.cast.rift_frost_strike': '絕對零',
  'abilityUi.cast.rift_necro_execution': '靈魂墳墓',
  ...
  'abilityUi.cast.rift_venom_strike': '巢母印記',
  'hud.core.riftLabel': '{名稱} {name}',
  'hud.core.riftLabelRanked': '{姓名}（{排名}） {name} {rank}',
  'fiesta.augment.cardAria': '{名稱}（{類別}）- {描述} {name} {category} {description}',
  'hudChrome.continentMap.toZone': '區域地圖',
  'hudChrome.meters.breakdownRow': '{值} ({百分比}) {value} {percent}',
  'hudChrome.meters.breakdownSummary': '{選項卡}：{值} {tab} {value}',
  'hudChrome.meters.percent': '{值}% {value}',
  'hudChrome.meters.petAbility': '{寵物}：{能力} {pet} {ability}',
