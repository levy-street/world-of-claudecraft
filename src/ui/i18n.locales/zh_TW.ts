...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.leaderboard.commits': '提交數',
  ...
  'hudChrome.devBadge.flavors.tinkerer': '你的第一個提交已落地於這片大陸。',
  'hudChrome.devBadge.flavors.artificer': '十次提交之後，世界開始順從你的程式碼。',
  'hudChrome.devBadge.flavors.runesmith': '五十次提交，已熔鑄進執行中的遊戲。',
  'hudChrome.devBadge.flavors.architect': '這片大陸的架構師：已落地 150 次提交。',
  'hudChrome.devBadge.flavors.worldwright': '世界的鑄造者：500 次提交塑造了這款遊戲。',
  ...
  'hudChrome.devBadge.link.benefits':
    '連結你的 GitHub，即可憑你在開源儲存庫中已落地的提交獲得開發者徽章。',
