...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  'editor.cinematic.authoredCamera': '使用編排鏡頭',
  'editor.cinematic.capture': '擷取關鍵影格',
  'editor.cinematic.captureCopyOnly': '已複製，開發寫入器無法使用',
  'editor.cinematic.captureReady': '區塊已在下方產生',
  'editor.cinematic.captureSaved': '已儲存，區塊已在下方產生',
  'editor.cinematic.captureSavedCopied': '已儲存並複製',
  'editor.cinematic.copy': '複製區塊',
  'editor.cinematic.fade': '淡出：{percent}%',
  'editor.cinematic.hide': '隱藏面板',
  'editor.cinematic.letterboxOff': '寬銀幕：關閉',
  'editor.cinematic.letterboxOn': '寬銀幕：開啟',
  'editor.cinematic.noViolations': '目前沒有違規項目',
  'editor.cinematic.output': '已產生的鏡頭擷取',
  'editor.cinematic.pause': '暫停',
  'editor.cinematic.play': '播放',
  'editor.cinematic.scene': '場景',
  'editor.cinematic.sceneOption': '{id}（{seconds} 秒）',
  'editor.cinematic.seedMismatch': '擷取需要正式世界種子',
  'editor.cinematic.show': '顯示面板',
  'editor.cinematic.time': '時間',
  'editor.cinematic.timeReadout': '{current} / {duration} 秒',
  'editor.cinematic.title': '電影場景',
  'editor.cinematic.unavailable': '3D 視埠載入中',
  'editor.cinematic.violationRow': '{check} | 操作 {opIndex} | {measured}',
  'editor.cinematic.violations': '違規項目',
  'entities.dungeons.lb_breach.enterText': '光線不對，天空更糟。那顆核心就在前方的開闊地上。',
  'entities.dungeons.lb_breach.leaveText': '你跨過門檻，回到尋常的夜空之下。',
  'entities.dungeons.lb_breach.name': '裂隙之內',
  'entities.dungeons.lb_council.enterText': '議事廳裡擺著六把椅子。其中一把空著。',
  'entities.dungeons.lb_council.leaveText': '你走出堡壘。',
  'entities.dungeons.lb_council.name': '堡壘議會',
  'entities.dungeons.lb_landing.enterText': '引航火沿海灘漸次燃燒。艦隊在淺灘之外等待。',
  'entities.dungeons.lb_landing.leaveText': '你把登陸海灘留在身後。',
  'entities.dungeons.lb_landing.name': '夜間登陸場',
  'entities.dungeons.lb_lastwatch.enterText': '堡壘乾淨而空蕩。總得有人結束這場守望。',
  'entities.dungeons.lb_lastwatch.leaveText': '你在身後關上堡壘大門。',
  'entities.dungeons.lb_lastwatch.name': '最後守望',
  'entities.dungeons.lb_riftfields.enterText': '四座守衛祭壇環繞著裂口。封裂儀式已經維繫了十二個世紀。',
  'entities.dungeons.lb_riftfields.leaveText': '你從裂隙原向山下走去。',
  'entities.dungeons.lb_riftfields.name': '裂隙原進路',
  'entities.dungeons.lb_riftline.enterText': '草甸大門在巡邏隊身後關閉。今夜屬於這道防線。',
  'entities.dungeons.lb_riftline.leaveText': '你把裂隙防線留給黎明守衛。',
  'entities.dungeons.lb_riftline.name': '暮色裂隙防線',
  'entities.dungeons.lb_tidemill.enterText': '磨坊的門讓開了。裡面，黑暗正在聆聽。',
  'entities.dungeons.lb_tidemill.leaveText': '你走出潮汐磨坊，回到傍晚的空氣中。',
  'entities.dungeons.lb_tidemill.name': '潮汐磨坊',
  'entities.dungeons.lb_vault.enterText': '繩索向黑暗中放下。下方，舊堡壘躺在它墜落之處。',
  'entities.dungeons.lb_vault.leaveText': '你沿懸崖繩索爬回日光之下。',
  'entities.dungeons.lb_vault.name': '沉沒的第一堡壘',
  'entities.dungeons.lb_willowfen.enterText': '柳樹紋絲不動。水面也是。',
  'entities.dungeons.lb_willowfen.leaveText': '你離開柳樹，任它繼續沉寂。',
  'entities.dungeons.lb_willowfen.name': '泣柳澤',
  'entities.mobs.lb_actor_coalfast.name': '守望者 煤堅',
  'entities.mobs.lb_actor_edda.name': '軍需官 艾妲',
  'entities.mobs.lb_actor_ollun.name': '裂隙守望 歐倫',
  'entities.mobs.lb_actor_saul.name': '療者 索爾',
  'entities.mobs.lb_actor_tam.name': '守鐘人 塔姆',
  'entities.mobs.tidemill_stalker.name': '潮汐磨坊潛獵者',
  'entities.npcs.ferryman_ewald.greeting': '去遠岸，是嗎？朋友，如今沒人為了打漁渡海了。準備好了就上船。上岸時留意鐘聲：鎮上的人聽鐘，就像你看天色一樣。',
  'entities.npcs.ferryman_ewald.name': '渡船夫 艾瓦德',
  'entities.npcs.ferryman_ewald.title': '遠岸航線',
  'entities.npcs.ferryman_ewald_gullhaven.greeting': '去遠岸，是嗎？朋友，如今沒人為了打漁渡海了。準備好了就上船。上岸時留意鐘聲：鎮上的人聽鐘，就像你看天色一樣。',
  'entities.npcs.ferryman_ewald_gullhaven.name': '渡船夫 艾瓦德',
  'entities.npcs.ferryman_ewald_gullhaven.title': '遠岸航線',
  'entities.npcs.sergeant_marsh.greeting': '受過訓練？那今晚就這麼辦。我的防線守住大路。要是裂隙吐出我們壓不住的東西，我就指向你。磨坊交給你：別讓任何東西跟著你進去，也別讓任何東西越過我們進鎮。去吧。',
  'entities.npcs.sergeant_marsh.name': '馬許中士',
  'entities.npcs.sergeant_marsh.title': '城鎮民兵',
  'entities.quests.q_lb_q0_ashore.completion': '磨坊那一戰是你獨自打下的，塔姆說的擔架也毫不誇張。我缺一名斥候，田野卻嫌太多。今晚你守住了本不屬於你的陣地，而這正是這份職責的全部。歡迎加入守望隊。',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': '向守望草甸的馬許中士報到',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': '消滅裂隙孽生體',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': '解決潮汐磨坊裡的東西',
  'entities.quests.q_lb_q0_ashore.text': '鷗港日夜承受著裂口的衝擊，卻始終堅守。若你想與他們並肩，就從小鎮流血的地方開始：守望草甸的民兵防線，在港口臺階和舊雕像以東。',
  'entities.quests.q_lb_q0_ashore.title': '上岸',
  'entities.zones.farshore_isle.pois.5.label': '裂口',
  'entities.zones.farshore_isle.pois.6.label': '沉船灘',
  ...
  'hudChrome.memorial.close': '關閉紀念碑',
  'hudChrome.memorial.dedication': '獻給那些帶著封印走進裂口、再未歸來的鷗港守望者。小鎮為他們守著這口鐘。',
  'hudChrome.memorial.rollHeading': '英靈名錄（{count}）',
  'hudChrome.memorial.roomRemaining': '最後一個名字下方的石面仍然空著。',
  'hudChrome.memorial.title': '紀念碑',
  'hudChrome.mountTraining.buyReinsPrompt': '騎術已學會。花10金幣向瑪拉購買英勇戰馬韁繩，使用後即可騎乘。',
  ...
  'hudChrome.scene.skipHint': '跳過場景（Esc）',
  ...
  'lb.fare.pay': '付船錢。',
  'lb.fare.promptBack': '渡海回大陸：{price} 銅幣。',
  'lb.fare.promptOut': '渡海去遠岸：{price} 銅幣。',
  'lb.fixture.breach': '裂口',
  'lb.fixture.ferry': '遠岸渡船',
  'lb.fixture.tidemill': '潮汐磨坊',
  'lb.q0.coalfast.look': '灰髮男人看了看死去的怪物，又看了看你，目光略久。然後他朝崖邊走了回去。',
  'lb.q0.scene.harbor': '一座勞作中的港口：漁網晾曬著，星璃打撈箱上印著大陸買家的戳記。',
  'lb.q0.scene.plinth': '港口臺階上方，一尊青銅守望者面朝內陸。基座上最新的名字已有百年：守望者海爾。名字下方還留有餘位。',
  'lb.q0.scene.toll': '鐘聲響了一下。街上所有人都停下腳步，數著。沒有後續，整條街同時鬆了口氣。',
  'lb.q0.tam.stretchers': '上次出這麼一個，搭進去全體守望一個上午，外加兩副擔架。',
  'lb.speaker.coalfast': '守望者科爾法斯特',
  'lb.speaker.edda': '軍需官艾達',
  'lb.speaker.ollun': '裂隙觀察者奧倫',
  'lb.speaker.saul': '醫者掃羅',
  'lb.speaker.tam': '鐘守塔姆',
