...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.farming.denied.feast_range': '你離盛宴太遠了。',
  ...
  'hudChrome.professions.toolEffectTooltip.bonus.makersCharm': '充能期間每次採集產出+2。',
  ...
  'hudChrome.enchantName.enchant_weapon_lucent_might': '附魔武器 - 瑩光威力',
  'hudChrome.enchantName.enchant_weapon_lucent_spellpower': '附魔武器 - 瑩光法術強度',
  'hudChrome.enchantName.enchant_chest_lucent_stamina': '附魔胸部 - 瑩光耐力',
  'hudChrome.enchantName.enchant_feet_lucent_agility': '附魔腳部 - 瑩光敏捷',
  ...
  'guide.profPages.effectWellFed': '吃完後進入飽足狀態：{stat}+{value}，持續{minutes}分鐘。',
  ...
  'guide.profPages.gatherDeeds.farmingSown':
    '耕作如今在功業之書裡有了自己的一欄。Sow It Begins標記你種下的第一株作物，四頁編年記則標記你在每處田畦所在地的第一次成活收成，從Eastbrook Vale直到Evergarden。一次金色的豐收會記下自己的零聲望收藏印記，而耕作的熟練同樣計入Master Gatherer（任意三項採集行業達到100）。壓卷之作已經寫好：Harvestmaster，這門行業的100熟練頭銜，將隨後續更新的更深田野而觸手可及。功業只有頭銜與聲望，永不賦予力量。',
  'guide.profPages.farm.tableHeading': '從田畦到餐桌',
  'guide.profPages.farm.tableBody':
    '廚房是一季收成得到回報的地方。在日常農家菜之外，每一階作物都有一道更豐盛的菜餚，吃了能獲得飽足：吃完這一餐，一份持久的恩澤便留在你身上，正是隊伍在地下城門前想先吃下的那份底氣。壓軸的是Harvest Feast，廚師直接擺進世界裡的一桌盛宴：在場的每個人各取一份，每人一次，而每一頓吃完的餐食都給出同樣的飽足恩澤，於是一位農夫的一季收成能讓整支隊伍坐上餐桌。這架梯子的頂端，兩道最豐盛的菜餚與盛宴本身，將隨後續更新的更深田野而觸手可及；其下的一切如今都已開火烹煮。\n\n這張餐桌上也留著運氣的位置。你收進的每一次收成都擲出與其他採集行業相同的橫財機率，作物偶爾會結出金色的一茬：產量遠超尋常，整個區域都會聽到這項發現連著你的名字一同宣告，Golden Harvest也會記入你的功業之書。',
