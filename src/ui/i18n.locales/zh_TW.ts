...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.finder.raidForgedLegendary':
    '英雄難度的傳奇威能必定為團隊鍛造，其數值保證位於設計範圍的上半區。',
  'itemUi.lootRoll.needUnavailable': '你的職業無法裝備此物品，因此不能選擇需求。',
  ...
  'entities.letters.nythraxis_rewards.sender': '不死軍需官',
  'entities.letters.nythraxis_rewards.subject': '你應得的不死寶藏',
  'entities.letters.nythraxis_rewards.body':
    '你的戰團擊敗了不死之王，而你當時正在側翼作戰、倒在塵土中，或仍在從墓地返回的漫長路上。你的每日領取資格與他們一同記錄，因此你贏得的個人戰利品會由信鴉送來，而不會遺失。準備好塑造獎勵時，請把碎片帶給英勇軍需官。\n\n- 不死軍需官',
  ...
  'hudChrome.bags.itemAriaProcedural': '{item}，{rarity}，物品等級 {level}，數量 {count}',
  'hudChrome.bags.itemAriaProceduralMasterwork':
    '{item}，{rarity}，物品等級 {level}，數量 {count}，傑作',
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}，{rarity}，物品等級 {level}，數量 {count}，附魔副本',
  'hudChrome.bags.itemAriaProceduralSigned':
    '{item}，{rarity}，物品等級 {level}，數量 {count}，製作者簽名副本',
  'hudChrome.bags.itemAriaProceduralBound':
    '{item}，{rarity}，物品等級 {level}，數量 {count}，綁定副本',
  'itemUi.stats.weaponMin': '最低武器傷害',
  'itemUi.stats.weaponMax': '最高武器傷害',
  'itemUi.stats.weaponDps': '武器每秒傷害',
  'itemUi.stats.healthOnKill': '擊殺恢復生命',
  'itemUi.stats.manaOnKill': '擊殺恢復法力',
  'itemUi.stats.blockValue': '格擋值',
  'itemUi.procedural.rollRangeAria': '可能的數值範圍：{min} 至 {max}',
  'itemUi.procedural.advancedDetailsHint': '按住 {key} 顯示可能的數值範圍。',
  'itemUi.procedural.powerRollPercent': '威能數值：{value}%',
  'itemUi.procedural.powerRollMilliseconds': '威能數值：{value} 毫秒',
  'itemUi.procedural.powerRollResource': '威能數值：{value} 點資源',
  'itemUi.procedural.powerRollNumber': '威能數值：{value}',
  'itemUi.procedural.legendaryPower': '傳奇威能',
  'itemUi.procedural.legendaryLimit': '唯一裝備：{count} 個傳奇威能',
  'itemUi.procedural.rarity.common': '普通',
  'itemUi.procedural.rarity.magic': '魔法',
  'itemUi.procedural.rarity.rare': '稀有',
  'itemUi.procedural.rarity.epic': '史詩',
  'itemUi.procedural.rarity.legendary': '傳奇',
  'itemUi.procedural.rarity.mythic': '神話',
  'itemUi.procedural.nameFragment.mighty': '強力',
  'itemUi.procedural.nameFragment.deft': '靈巧',
  'itemUi.procedural.nameFragment.stalwart': '堅毅',
  'itemUi.procedural.nameFragment.sages': '賢者之',
  'itemUi.procedural.nameFragment.spiritual': '靈性',
  'itemUi.procedural.nameFragment.of_focus': '專注',
  'itemUi.procedural.nameFragment.of_striking': '猛擊',
  'itemUi.procedural.nameFragment.of_alacrity': '迅捷',
  'itemUi.procedural.nameFragment.of_precision': '精準',
  'itemUi.procedural.nameFragment.warded': '守護',
  ...
  'itemUi.procedural.rareWord.doom': '厄運',
  'itemUi.procedural.rareWord.grave': '墓塚',
  'itemUi.procedural.rareWord.mire': '泥沼',
  'itemUi.procedural.rareWord.storm': '風暴',
  'itemUi.procedural.rareWord.thorn': '荊棘',
  'itemUi.procedural.rareWord.wyrm': '巨龍',
  'itemUi.procedural.rareWord.bite': '噬痕',
  'itemUi.procedural.rareWord.brand': '烙印',
  'itemUi.procedural.rareWord.promise': '諾言',
  'itemUi.procedural.rareWord.thread': '絲縷',
  'itemUi.procedural.rareWord.vigil': '守望',
  'itemUi.procedural.rareWord.ward': '護符',
  'itemUi.procedural.rareWord.whisper': '低語',
  ...
  'itemUi.procedural.legendary.crown_last_pyre.description':
    '每第三次施放火球術會灼燒目標附近的敵人。',
  'itemUi.procedural.legendary.greyjaws_edge.name': '灰顎之刃',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    '每第三次武器命中會使目標流血，並恢復少量主要資源。',
  'itemUi.procedural.legendary.hushwood_longbow.name': '寂林長弓',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    '瞄準射擊或秘法射擊可使目標短暫沉默。',
  'itemUi.procedural.legendary.nightglass_fang.name': '夜晶之牙',
  'itemUi.procedural.legendary.nightglass_fang.description': '擊殺敵人會短暫提高加速。',
  'itemUi.procedural.legendary.ysoleis_vigil.name': '伊索蕾的守望',
  'itemUi.procedural.legendary.ysoleis_vigil.description': '暴擊治療會短暫生成一片恢復區域。',
  'itemUi.procedural.legendary.stormwake_idol.name': '喚風神像',
  'itemUi.procedural.legendary.stormwake_idol.description': '每第四次閃電箭會彈射至附近的敵人。',
  'itemUi.procedural.legendary.ashbinders_seal.name': '縛灰者之印',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    '每第四次暗影箭會標記目標，使其受到額外暗影傷害。',
  'itemUi.procedural.legendary.dawnward_signet.name': '晨衛璽戒',
  'itemUi.procedural.legendary.dawnward_signet.description':
    '聖光術會為目標施加護盾，吸收相當於部分治療量的傷害。',
  'itemUi.procedural.legendary.feral_moonclasp.name': '野性月扣',
  'itemUi.procedural.legendary.feral_moonclasp.description': '每第三次月火術會恢復主要資源。',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': '九鳴之鐘',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    '每第二次傷害法術都會在目標周圍敲響鐘聲。',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': '竊時披肩',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    '生命值降至 35% 以下時，會獲得一道短暫的防護結界。',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': '不息之路長靴',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    '移動 15 碼後，移動速度會短暫提高。',
  'entities.items.ashwood_staff.name': '灰木法杖',
  'entities.items.gravecaller_cloth_handwraps.name': '喚墓者布質裹手',
  'entities.items.gravecaller_cloth_hood.name': '喚墓者布帽',
  'entities.items.gravecaller_cloth_leggings.name': '喚墓者布質護腿',
  'entities.items.gravecaller_cloth_mantle.name': '喚墓者布質披肩',
  'entities.items.gravecaller_cloth_raiment.name': '喚墓者布袍',
  'entities.items.gravecaller_cloth_sash.name': '喚墓者布質腰帶',
  'entities.items.gravecaller_cloth_slippers.name': '喚墓者布鞋',
  'entities.items.gravecaller_focus.name': '喚墓者法器',
  'entities.items.gravecaller_pendant.name': '喚墓者吊墜',
  'entities.items.gravecaller_ring.name': '喚墓者指環',
  'entities.items.gravecaller_wand.name': '喚墓者魔杖',
  'entities.items.iron_broadsword.name': '鐵製闊劍',
  'entities.items.iron_flanged_mace.name': '鐵製凸緣釘錘',
  'entities.items.mirefen_dirk.name': '泥沼短匕',
  'entities.items.mirefen_hunting_bow.name': '泥沼獵弓',
  'entities.items.mirefen_leather_belt.name': '泥沼皮帶',
  ...
  'entities.items.mirefen_leather_leggings.name': '泥沼皮護腿',
  'entities.items.mirefen_leather_shoulderguards.name': '泥沼皮護肩',
  'entities.items.thornpeak_bulwark.name': '荊峰壁壘',
  'entities.items.thornpeak_crossbow.name': '荊峰弩',
  'entities.items.thornpeak_mail_chest.name': '荊峰鎖甲胸鎧',
  'entities.items.thornpeak_mail_gauntlets.name': '荊峰鎖甲手鎧',
  'entities.items.thornpeak_mail_girdle.name': '荊峰鎖甲腰帶',
  'entities.items.thornpeak_mail_helm.name': '荊峰鎖甲頭盔',
  'entities.items.thornpeak_mail_legguards.name': '荊峰鎖甲護腿',
  'entities.items.thornpeak_mail_pauldrons.name': '荊峰鎖甲肩鎧',
  'entities.items.thornpeak_mail_sabatons.name': '荊峰鎖甲戰靴',
  'entities.items.thornpeak_polearm.name': '荊峰長柄武器',
  'entities.items.thornpeak_war_axe.name': '荊峰戰斧',
