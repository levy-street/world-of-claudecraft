...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.mobs.tower_imp.name': '燼火幼魔',
  'entities.mobs.tower_hellhound.name': '地獄犬',
  'entities.mobs.tower_pact_reaver.name': '契約劫掠者',
  'entities.mobs.tower_brimstone_zealot.name': '硫火狂信徒',
  'entities.mobs.tower_soulbinder.name': '縛魂者',
  'entities.mobs.tower_iron_defiler.name': '鋼鐵褻瀆者',
  'entities.mobs.tower_abyss_knight.name': '深淵騎士',
  'entities.mobs.tower_dread_harbinger.name': '恐懼先驅',
  'entities.mobs.tower_gloom_bat.name': '幽暗蝠',
  'entities.mobs.tower_cinder_crawler.name': '燼火爬行者',
  ...
  'entities.mobs.tower_rot_hulk.name': '腐化巨軀',
  'entities.mobs.tower_blood_matron.name': '鮮血主母',
  'entities.mobs.tower_void_sentinel.name': '虛空哨兵',
  'entities.mobs.tower_boss_flesh_shaper.name': '塑肉者戈爾',
  'entities.mobs.tower_boss_ash_tyrant.name': '灰燼暴君辛德拉克斯',
  'entities.mobs.tower_boss_gatekeeper.name': '守門者瓦斯卡',
  'entities.mobs.tower_boss_demon_lord.name': '無縛之塔瑪爾格拉斯',
  'sim.rift.towerWave': '惡魔核心發出嚎叫。第{wave}波，共{total}波。',
  'sim.rift.ascendFloor': '你向上進入{name}。',
  'sim.rift.towerBossWave': '核心裂開，一個更加可怕的存在從中走出。',
  'sim.rift.towerFloorClear': '惡魔核心破裂。向上的道路已經開啟。',
  'sim.rift.towerCleared': '惡魔核心黯滅。高塔屬於你了。',
  'worldContent.demonTowerName': '惡魔之塔',
  'worldContent.demonTowerBloodforgeName': '惡魔之塔：血鑄熔爐',
  'worldContent.demonTowerOssuaryName': '惡魔之塔：鎖鏈骨堂',
  'worldContent.demonTowerVoidCrownName': '惡魔之塔：虛空之冠',
  'worldContent.demonTowerCoreName': '惡魔核心',
