...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.stylist_verena.name': '維蕾娜·艾希洛克',
  'entities.npcs.stylist_verena.title': '造型師',
  'entities.npcs.stylist_verena.greeting':
    '請坐，{className}。一把梳子、一面好鏡子，再加上足夠的錢幣，你就能改頭換面地走出去。',
  'apiError.character.no_redesign_credit': '該角色已沒有改造次數。前往東溪谷的造型師處購買。',
  'stylist.buyCredit': '購買一次改造（{price}）',
  'stylist.buyCreditAria': '以 {price} 購買一次角色改造',
  'character.editAppearance': '編輯外觀',
  'character.editAppearanceAria': '編輯 {name} 的外觀',
  'character.editAppearanceHint': '你持有 {count} 次造型師改造。儲存時消耗一次。',
  'character.editAppearanceHintOne': '你持有 1 次造型師改造。儲存時將消耗它。',
  'cardDuel.title': '紙牌對決',
  'cardDuel.close': '關閉',
  'cardDuel.join': '加入隊列',
