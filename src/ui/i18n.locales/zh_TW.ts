...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mobileHudEditor.launcher': '自訂行動佈局',
  'hudChrome.mobileHudEditor.title': '移動佈局編輯器',
  'hudChrome.mobileHudEditor.dialogLabel': '自訂移動控件',
  'hudChrome.mobileHudEditor.dragHandleLabel': '移動編輯器面板',
  'hudChrome.mobileHudEditor.dragHandleHint': '拖曳或使用方向鍵移動，按 Home 鍵可回到中央。',
  'hudChrome.mobileHudEditor.locked': '鎖定',
  'hudChrome.mobileHudEditor.unlocked': '解鎖',
  'hudChrome.mobileHudEditor.lock': '鎖佈局',
  'hudChrome.mobileHudEditor.unlock': '解鎖佈局',
  'hudChrome.mobileHudEditor.sceneLabel': '預覽場景',
  'hudChrome.mobileHudEditor.contextLabel': '預覽狀態',
  'hudChrome.mobileHudEditor.profileLabel': '設備簡介',
  'hudChrome.mobileHudEditor.profilePhone': '手機',
  'hudChrome.mobileHudEditor.profileTablet': '平板電腦',
  'hudChrome.mobileHudEditor.save': '儲存',
  'hudChrome.mobileHudEditor.cancel': '取消',
  'hudChrome.mobileHudEditor.showFailingLayout': '顯示失敗的佈局',
  'hudChrome.mobileHudEditor.previousFailure': '以前的失敗',
  'hudChrome.mobileHudEditor.nextFailure': '下一次失敗',
  'hudChrome.mobileHudEditor.runtimeFallback':
    '{profile} 佈局不適合此視窗。內建預設值暫時處於活動狀態。',
  'hudChrome.mobileHudEditor.storageError': '無法儲存移動佈局。您的草稿仍處於開放狀態。',
  'hudChrome.mobileHudEditor.invalidSave': '在儲存之前修復每個佈局錯誤。',
  ...
  'hudChrome.mobileHudEditor.scene.arenaStandard': '競技場標準',
  'hudChrome.mobileHudEditor.scene.arenaFiesta': '競技場嘉年華',
  'hudChrome.mobileHudEditor.scene.arenaYumi': '競技場由美',
  'hudChrome.mobileHudEditor.scene.valeCupBriefing': '溪谷盃簡報',
  'hudChrome.mobileHudEditor.scene.valeCupMatch': '溪谷盃比賽',
  'hudChrome.mobileHudEditor.scene.valeCupSpectator': '溪谷盃觀戰',
  'hudChrome.mobileHudEditor.scene.delve': '秘探',
  'hudChrome.mobileHudEditor.context.worldBase': '世界',
  'hudChrome.mobileHudEditor.context.worldValeCupIndicator': '顯示溪谷盃提示的世界',
  'hudChrome.mobileHudEditor.context.arenaStandard': '競技場標準',
  'hudChrome.mobileHudEditor.context.arenaFiestaBase': '嘉年華比賽',
  'hudChrome.mobileHudEditor.context.arenaFiestaPending': '嘉年華待定',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawn': '嘉年華重生',
  'hudChrome.mobileHudEditor.context.arenaFiestaOffer': '嘉年華增加優惠',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawnOffer': '嘉年華重生並增強優惠',
  'hudChrome.mobileHudEditor.context.arenaYumiBase': '由美比賽',
  'hudChrome.mobileHudEditor.context.arenaYumiRespawn': '由美重生',
  'hudChrome.mobileHudEditor.context.arenaYumiReturning': '由美歸來',
  'hudChrome.mobileHudEditor.context.valeCupBriefing': '溪谷盃簡報',
  'hudChrome.mobileHudEditor.context.valeCupMatch': '溪谷盃比賽',
  'hudChrome.mobileHudEditor.context.valeCupMatchCharge': '溪谷盃蓄力射擊',
  'hudChrome.mobileHudEditor.context.valeCupSpectatorBetting': '溪谷盃觀戰投注',
  'hudChrome.mobileHudEditor.context.instanceDelve': '秘探',
  'hudChrome.mobileHudEditor.surface.actionA1': '動作A1',
  'hudChrome.mobileHudEditor.surface.actionA2': '動作A2',
  'hudChrome.mobileHudEditor.surface.actionA3': '動作A3',
  'hudChrome.mobileHudEditor.surface.actionA4': '行動A4',
  'hudChrome.mobileHudEditor.surface.actionA5': '行動A5',
  'hudChrome.mobileHudEditor.surface.actionAttack': '攻擊',
  'hudChrome.mobileHudEditor.surface.actionTarget': '目標',
  'hudChrome.mobileHudEditor.surface.actionJumpUse': '跳躍或使用',
  'hudChrome.mobileHudEditor.surface.actionPage': '動作頁面切換',
  'hudChrome.mobileHudEditor.surface.controlMovement': '移動',
  'hudChrome.mobileHudEditor.surface.controlView': '視角',
  'hudChrome.mobileHudEditor.surface.utilityConsumables': '消耗品',
  'hudChrome.mobileHudEditor.surface.petCommands': '寵物命令',
  'hudChrome.mobileHudEditor.surface.party': '隊伍',
  'hudChrome.mobileHudEditor.surface.menuTop': '頂部選單',
  'hudChrome.mobileHudEditor.surface.minimapCluster': '小地圖',
  'hudChrome.mobileHudEditor.surface.frameTarget': '目標框',
  'hudChrome.mobileHudEditor.surface.framePlayer': '玩家框',
  'hudChrome.mobileHudEditor.surface.playerBuffs': '玩家增益',
  'hudChrome.mobileHudEditor.surface.playerDebuffs': '玩家減益效果',
  'hudChrome.mobileHudEditor.surface.statusArenaGeneric': '競技場狀態',
  'hudChrome.mobileHudEditor.surface.statusFiestaScore': '嘉年華分數',
  'hudChrome.mobileHudEditor.surface.statusFiestaPending': '嘉年華待定狀態',
  'hudChrome.mobileHudEditor.surface.protectedFiestaRespawn': '嘉年華重生提示',
  'hudChrome.mobileHudEditor.surface.protectedFiestaOffer': '嘉年華增加優惠',
  'hudChrome.mobileHudEditor.surface.statusYumi': '由美狀態',
  'hudChrome.mobileHudEditor.surface.protectedYumiRespawn': 'Yumi重生提示',
  'hudChrome.mobileHudEditor.surface.statusValeCupIndicator': '溪谷盃提示',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBriefing': '溪谷盃簡報',
  'hudChrome.mobileHudEditor.surface.statusValeCupMatch': '溪谷盃比賽狀態',
  'hudChrome.mobileHudEditor.surface.statusValeCupCharge': '溪谷盃射擊蓄力',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBetting': '溪谷盃投注面板',
  'hudChrome.mobileHudEditor.surface.trackerDelve': '秘探追蹤器',
  'hudChrome.mobileHudEditor.surface.protectedCenterMessage': '中央提示',
  'hudChrome.mobileHudEditor.control.nudgeUp': '向上移動',
  'hudChrome.mobileHudEditor.control.nudgeDown': '下移',
  'hudChrome.mobileHudEditor.control.nudgeLeft': '向左移動',
  'hudChrome.mobileHudEditor.control.nudgeRight': '向右移動',
  'hudChrome.mobileHudEditor.control.decreaseScale': '減小尺寸',
  ...
  'hudChrome.mobileHudEditor.control.order': '順序',
  'hudChrome.mobileHudEditor.control.normalOrder': '正常順序',
  'hudChrome.mobileHudEditor.control.reverseOrder': '反向順序',
  'hudChrome.mobileHudEditor.control.openingDirection': '展開方向',
  'hudChrome.mobileHudEditor.control.openLeft': '向左展開',
  'hudChrome.mobileHudEditor.control.openRight': '向右展開',
  'hudChrome.mobileHudEditor.control.openUp': '向上展開',
  'hudChrome.mobileHudEditor.control.openDown': '向下展開',
  'hudChrome.mobileHudEditor.control.resetSelected': '重置所選內容',
  'hudChrome.mobileHudEditor.control.resetAll': '全部重置',
  'hudChrome.mobileHudEditor.status.noSelection': '選擇一個控制項進行編輯。',
  'hudChrome.mobileHudEditor.status.selected': '已選擇：{surface}',
  'hudChrome.mobileHudEditor.status.scale': '尺寸：{scale}',
  'hudChrome.mobileHudEditor.status.valid': '佈局準備保存。',
  'hudChrome.mobileHudEditor.status.invalid': '佈局有 {count} 個阻塞錯誤。',
  'hudChrome.mobileHudEditor.status.failurePosition': '失敗 {index}，共 {count} 個',
  'hudChrome.mobileHudEditor.failure.invalidPlacement': '{surface} 的展示位置無效。',
  'hudChrome.mobileHudEditor.failure.unsupportedCapability': '{surface} 使用不支援的佈局選項。',
  'hudChrome.mobileHudEditor.failure.scaleOutOfRange': '{surface} 尺寸超出其允許範圍。',
  'hudChrome.mobileHudEditor.failure.targetTooSmall': '{surface} 太小，無法安全使用。',
  'hudChrome.mobileHudEditor.failure.outOfBounds': '{surface} 位於安全區域之外。',
  'hudChrome.mobileHudEditor.failure.overlap': '{surface} 與 {other} 重疊。',
  'hudChrome.mobileHudEditor.failure.viewIntrusion': '{surface} 與視圖區域重疊。',
  'hudChrome.mobileHudEditor.failure.protectedOverlap': '{surface} 與 {other} 重疊。',
  'hudChrome.mobileHudEditor.discard.title': '放棄佈局變更？',
  'hudChrome.mobileHudEditor.discard.body': '您未儲存的移動佈局變更將會遺失。',
  'hudChrome.mobileHudEditor.discard.confirm': '放棄更改',
  'hudChrome.mobileHudEditor.discard.continueEditing': '繼續編輯',
  'hudChrome.mobile.nameplatesOff': '名稱關閉',
  'hudChrome.mobile.musicOff': '音樂關閉',
  'hudChrome.mobile.showMenuButtons': '顯示選單按鈕',
  'hudChrome.mobile.hideMenuButtons': '隱藏選單按鈕',
  'hudChrome.options.mobileActionPages': '最少動作頁數',
  'hudChrome.options.mobileActionPagesTwo': '2 頁',
  'hudChrome.options.mobileActionPagesThree': '3 頁',
  'hudChrome.options.mobileActionPagesFour': '4 頁',
  'hudChrome.bags.itemActionsTitle': '{item}操作',
  'hudChrome.bags.itemActionEquip': '裝備',
  'hudChrome.bags.itemActionEquipBag': '裝備背包',
  'hudChrome.bags.itemActionUse': '使用',
  'hudChrome.bags.itemActionConsume': '食用',
  'hudChrome.bags.itemActionLinkToChat': '連結到聊天',
  'hudChrome.bags.itemActionDestroy': '摧毀',
  'hudChrome.bags.itemActionDetails': '物品詳情',
  'hudChrome.bags.itemActionAssignTitle': '指派到消耗品列',
  'hudChrome.bags.itemActionAssignSlot': '指派到欄位{slot}',
  'hudChrome.bags.itemActionRemoveSlot': '從欄位{slot}移除',
  'hudChrome.bags.itemActionSlotCurrent': '欄位{slot}：{item}',
  'hudChrome.bags.itemActionSlotEmpty': '欄位{slot}：空',
  'hudChrome.bags.itemActionResetAutomatic': '恢復自動排列',
  'hudChrome.bags.itemActionClose': '關閉物品操作',
  'hudChrome.bags.itemActionAssigned': '已將{item}指派到欄位{slot}。',
  'hudChrome.bags.itemActionRemoved': '已將{item}從欄位{slot}移除。',
  'hudChrome.bags.itemActionInvalid': '此物品無法指派。',
  'hudChrome.bags.itemActionFailed': '無法完成此操作。',
  'hudChrome.spellbook.add': '加入',
  'hudChrome.spellbook.remove': '移除',
  'hudChrome.spellbook.mobileChip': '{page} - A{position}',
  'hudChrome.spellbook.desktopChip': '桌面版',
  'hudChrome.spellbook.moveAssignmentAria': '將 {name} 從 {slot} 移動',
  'hudChrome.spellbook.pickerPages': '動作頁',
  'hudChrome.spellbook.pickerDestinations': '動作欄位',
  'hudChrome.spellbook.destinationAria': '第{page}頁，A{position}，{state}',
  'hudChrome.spellbook.empty': '空白',
  'hudChrome.spellbook.closePicker': '關閉欄位',
  'hudChrome.spellbook.assignedStatus': '{name} 已分配到第{page}頁 A{position}',
  'hudChrome.itemTooltip.duration': '持續時間：{duration}',
  'mobilePreflight.androidSamsungInstallStep':
    '在 Samsung Internet 中點選選單，然後選擇安裝應用程式或加入主畫面。',
};
