...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.limitedRelicSupply': '限量聖物：全世界僅有 {count} 件',
  'hudChrome.limitedRelicSerial': '聖物 第 {serial} / {supply} 號',
  'hudChrome.limitedRelicClaim': '{name} 獲得了 {item}，聖物 第 {serial} / {supply} 號。',
  ...
  'entities.items.emberfall_edge.name': '燼落之刃',
  'entities.items.crown_of_the_thornpeak_scourge.name': '荊峰災星之冠',
  'entities.items.thunzharrs_stormheart.name': '圖恩札爾的風暴之心',
  'entities.items.sealed_vault_signet_crypt.name': '空塚密庫封印戒',
  'entities.items.sealed_vault_signet_bastion.name': '沉沒堡壘封印戒',
  'entities.items.sealed_vault_signet_temple.name': '溺亡神廟封印戒',
  'entities.items.sealed_vault_signet_sanctum.name': '墓龍聖所封印戒',
