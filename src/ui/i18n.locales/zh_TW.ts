...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'yumi.log.teamBlue': '你在藍隊！',
  'yumi.log.teamRed': '你在紅隊！',
  'yumi.log.powerupGrabbed': '{player} 獲得了 {name} 強化！',
  'yumi.hud.powerupIn': '強化 {s}秒後出現',
  'yumi.hud.powerupReady': '強化已就緒！',
  'yumi.banner.powerupSpawn': '神祕強化出現了！',
  'yumi.powerup.invuln.name': '無敵',
  'yumi.powerup.stealth.name': '潛行',
  'yumi.powerup.endless_mana.name': '無盡法力',
  'yumi.powerup.berserk.name': '狂暴',
  'yumi.grab.channeling': '拾取中… {s}秒',
  'yumi.grab.aria': '正在拾取神祕強化',
  'hudChrome.arena.windowTitle': '戰場',
  'hudChrome.arena.arenaIntro': '排名競技場：單挑或組隊對決，獲勝可攀升排行榜並提升評分。',
  'hudChrome.arena.yumiHeading': '保護Yumi',
  'hudChrome.arena.yumiIntro': '在迷宮中進行的團隊目標模式，不屬於競技場。無排名，為榮耀而戰而非評分。',
  'hudChrome.arena.desc1v1': '一對一。純粹技巧，沒有隊友可依靠。',
  'hudChrome.arena.desc2v2': '二對二。帶上搭檔，或單人排隊被配成一對。',
  'hudChrome.arena.descFiesta': '喧鬧的二對二混戰，帶有強化和道具。',
  'hudChrome.arena.descYumi3': '三對三。守護你的Yumi貓，獵殺敵隊的。',
  'hudChrome.arena.descYumi5': '五對五，迷宮更大，你的貓擁有更多生命值。',
  'hudChrome.arena.yumiRules':
    '每隊守護一隻被動的Yumi貓，並獵殺敵隊的。兩隻貓每分鐘都會閃現到迷宮的新角落。陣亡的戰士十五秒後重生。神祕強化會出現在地面上：按住互動鍵片刻即可拾取。率先摧毀敵方貓的隊伍獲勝；十分鐘時進入突然死亡，打破僵局。',
  'hudChrome.arena.queueCount': '排隊中 {n} 人',
