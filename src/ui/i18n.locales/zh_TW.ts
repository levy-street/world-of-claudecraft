...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.pokerPlaytest.title': '撲克',
  'hudChrome.pokerPlaytest.close': '關閉撲克',
  'hudChrome.pokerPlaytest.reconnecting': '正在重新連線至撲克伺服器...',
  'hudChrome.pokerPlaytest.disabled': '目前無法使用撲克。',
  'hudChrome.pokerPlaytest.tables': '牌桌',
  'hudChrome.pokerPlaytest.refresh': '重新整理',
  'hudChrome.pokerPlaytest.noTables': '沒有可用的撲克牌桌。',
  'hudChrome.pokerPlaytest.join': '加入',
  'hudChrome.pokerPlaytest.watch': '觀戰',
  'hudChrome.pokerPlaytest.stopWatching': '停止觀戰',
  'hudChrome.pokerPlaytest.rebuy': '補充籌碼',
  'hudChrome.pokerPlaytest.leave': '離桌',
  'hudChrome.pokerPlaytest.chooseSeat': '選擇座位',
  'hudChrome.pokerPlaytest.seat': '座位 {seat}',
  'hudChrome.pokerPlaytest.seated': '{count}人已入座',
  'hudChrome.pokerPlaytest.watchers': '{count}人觀戰',
  'hudChrome.pokerPlaytest.watching': '觀戰中',
  'hudChrome.pokerPlaytest.tableFull': '已滿座',
  'hudChrome.pokerPlaytest.inHand': '牌局進行中',
  'hudChrome.pokerPlaytest.betweenHands': '牌局間歇',
  'hudChrome.pokerPlaytest.unknownPlayer': '玩家',
  'hudChrome.pokerPlaytest.waiting': '等待下一局',
  'hudChrome.pokerPlaytest.playerTurn': '{name}正在行動',
  'hudChrome.pokerPlaytest.timeRemaining': '剩餘{seconds}秒',
  'hudChrome.pokerPlaytest.wagerAmount': '{action}金額',
  'hudChrome.pokerPlaytest.rake': '抽水: {amount}',
  'hudChrome.pokerPlaytest.error.busy': '牌桌正在處理。請重試。',
  'hudChrome.pokerPlaytest.error.disabled': '目前無法使用撲克。',
  'hudChrome.pokerPlaytest.error.invalid_action': '此操作不合法。',
  'hudChrome.pokerPlaytest.error.insufficient_funds': '加入或重新買入需要更多銅幣。',
  'hudChrome.pokerPlaytest.error.participation_suspended': '此帳號的撲克參與權限已被暫停。',
  'hudChrome.pokerPlaytest.error.invalidAmount': '請輸入允許範圍內的整數。',
  'hudChrome.pokerPlaytest.error.rebuy_not_allowed': '目前無法補充籌碼。',
  'hudChrome.pokerPlaytest.error.seat_conflict': '此座位已被占用。',
  'hudChrome.pokerPlaytest.error.stale_action': '操作到達前牌局已發生變化。',
  'hudChrome.pokerPlaytest.error.table_not_found': '此撲克牌桌已不存在。',
  'hudChrome.pokerPlaytest.error.watch_conflict': '觀戰其他牌桌前請先離開目前牌桌。',
  'hudChrome.pokerPlaytest.chips': '{amount}籌碼',
  'hudChrome.pokerPlaytest.pot': '底池: {amount}',
  'hudChrome.pokerPlaytest.noCards': '無牌',
  'hudChrome.pokerPlaytest.emptySeat': '空位',
  'hudChrome.pokerPlaytest.dealerButton': '莊家按鈕',
  ...
  'hudChrome.pokerPlaytest.yourTurn': '輪到你了',
  'hudChrome.pokerPlaytest.winner': '{name}贏得{amount}',
  'hudChrome.pokerPlaytest.winnerWithHand': '{name}以{hand}贏得{amount}',
  'hudChrome.pokerPlaytest.highlightedHand': '{name}: {hand}',
  'hudChrome.pokerPlaytest.hand.highCard': '高牌',
  'hudChrome.pokerPlaytest.hand.pair': '一對',
  'hudChrome.pokerPlaytest.hand.twoPair': '兩對',
  'hudChrome.pokerPlaytest.hand.threeOfAKind': '三條',
  'hudChrome.pokerPlaytest.hand.straight': '順子',
  'hudChrome.pokerPlaytest.hand.flush': '同花',
  'hudChrome.pokerPlaytest.hand.fullHouse': '葫蘆',
  'hudChrome.pokerPlaytest.hand.fourOfAKind': '四條',
  'hudChrome.pokerPlaytest.hand.straightFlush': '同花順',
  'hudChrome.pokerPlaytest.actionWithAmount': '{action} {amount}',
  'hudChrome.pokerPlaytest.action.fold': '棄牌',
  'hudChrome.pokerPlaytest.action.check': '過牌',
  ...
  'hudChrome.pokerPlaytest.street.turn': '轉牌',
