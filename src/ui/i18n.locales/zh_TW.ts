...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.interactPrompt.interact': '互動',
  'hudChrome.interactPrompt.gather': '採集',
  'hudChrome.interactPrompt.enter': '進入',
  'hudChrome.interactPrompt.leave': '離開',
  'hudChrome.interactPrompt.name.lockedChest': '上鎖的箱子',
  'hudChrome.interactPrompt.name.rewardChest': '戰利品箱',
  'hudChrome.interactPrompt.name.reliquary': '沉溺聖匣',
  'hudChrome.interactPrompt.name.bellShrine': '鐘之神龕',
  'hudChrome.interactPrompt.name.candleShrine': '燭之神龕',
  'hudChrome.interactPrompt.name.reedShrine': '葦之神龕',
  'hudChrome.interactPrompt.name.skullShrine': '顱之神龕',
  'hudChrome.options.showInteractPrompt': '顯示互動提示',
  'hudChrome.options.interactHighlight': '滑鼠移過時標示可互動目標',
};
