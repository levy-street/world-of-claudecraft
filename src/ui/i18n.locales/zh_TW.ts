...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.meters.loot': '戰利品',
  'hud.meters.lootShort': '戰利品',
  'hud.meters.lootHistory': '歷史',
  'hud.meters.noLoot': '尚無戰利品紀錄。',
  'hud.meters.recentAwards': '最近獲得 {count} 件',
  'hud.meters.methodReturned': '放棄',
  'hud.meters.methodMaster': '隊長分配',
  'hud.meters.methodPersonal': '個人',
  'hud.meters.methodDelve': '探險',
  'hud.meters.methodLooted': '已拾取',
  'hud.meters.noWinner': '無勝者',
  'hud.meters.rollDetail': '擲骰 {roll}',
