...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.source_cave_mantle.name': '源之披風',
  'entities.items.conflictbreaker_breastplate.name': '衝突終結者胸甲',
  'entities.items.cherry_pickers_gauntlets.name': '揀選者護手',
  'entities.items.maintainers_crown.name': '維護者之冠',
  'entities.items.commit_blade.name': '提交之刃',
  'entities.items.bug_squasher.name': '除蟲大錘',
  'entities.items.mech_keyboard.name': '擊鍵',
  ...
  'worldContent.sourceCaveWellName': '開放之源',
  'worldContent.sourceCaveReboot': '不要按這個按鈕',
  'worldContent.sourceCaveRebootYell': '你都幹了什麼？！',
  'worldContent.sourceCaveRebootYellWhatsGoingOn': '嘿，發生什麼事了？',
  'worldContent.sourceCaveRebootYellServerDown': '各位，伺服器當機了！',
  'worldContent.sourceCaveBanterIssue': '拜託，開個 issue 吧。',
  'worldContent.sourceCaveBanterPullRequest': '別猶豫，歡迎提交 pull request。',
  'worldContent.sourceCaveBanterConflicts': '我討厭衝突……',
  'worldContent.sourceCaveBanterContribute': '當然，你完全可以為這個專案做貢獻！',
  'worldContent.sourceCaveBanterFocused': '抱歉，我現在得專心工作',
  'worldContent.sourceCaveBanterNextRelease': '下個版本會超棒的！',
  'worldContent.sourceCaveBanterRefresh': '嗯？重新整理試試',
  ...
  'entities.dungeons.source_cave.name': '開放之源',
  'entities.dungeons.source_cave.enterText': '你走進開放之源。',
  'entities.dungeons.source_cave.leaveText': '你離開了開放之源。',
  ...
  'sim.dungeon.levelRequired': '你必須達到等級 {level} 才能進入 {name}。',
  'sim.sourceCave.locked': '你已被鎖定，無法進入{name}。',
  'sim.sourceCave.enter': '你走進開放之源。',
  'sim.sourceCave.leave': '你離開了開放之源。',
  'sim.sourceCave.rebootConfirm': '你確定要繼續嗎？按下之前，確保你已集結好所需的資源。',
  'sim.sourceCave.killProgress': '{name}已回歸原始碼。',
  'sim.sourceCave.bossDefeated': '{name}遭遇了致命例外。',
  'sim.sourceCave.cleared': '開放之源現已關閉。恭喜？',
  'sim.sourceCave.accessDenied': '存取被拒絕。',
  'sim.sourceCave.wellBanter1': '這只是一口井，裝水用的。走吧走吧。',
  'sim.sourceCave.wellBanter2': '你幹嘛這樣盯著我的磚頭看？',
  'sim.sourceCave.wellBanter3': '我就是一口普通的井！你看，我還有個水桶呢！',
  'sim.sourceCave.wellBanter4': '還是那句話，就是一口井。沒什麼好看的魔法。',
  'sim.sourceCave.wellBanter5': '是誰跟你說起「源」的事的？是Claude嗎？',
  'sim.sourceCave.wellBanter6': '喔，你絕對不會想下去那裡的。',
  'sim.sourceCave.wellBanter7': '保全！這個玩家想闖入原始碼！',
  'sim.sourceCave.wellBanter8': '跟你說，那下面可是個爭議的源頭。',
  'sim.sourceCave.wellBanter9': '如果我打開了，你能不能終於別煩我了？',
  'sim.sourceCave.wellBanter10': '好吧，進來吧。先把靴子擦乾淨。',
