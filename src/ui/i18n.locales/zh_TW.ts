...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.errors.tradeBusy': '該玩家已在進行其他交易。',
  'hud.errors.tradeUsage': '與誰交易？用法：/trade <名字>。',
  'hud.errors.claudiumTradeOff': 'Claudium 交易目前無法使用。',
  'hud.errors.wocTradeOff': 'WOC 交易目前無法使用。',
  'hud.errors.wocTradeLink': '請先綁定錢包才能交易 WOC。',
  'hud.errors.wocTradePartnerLink': '你的交易對象尚未綁定錢包。',
  'hud.errors.wocTradeOneSide': '一次交易只能由一方提供 WOC。',
  'hud.errors.tradeSettleTimeout': '交易已取消：付款等待逾時，你的物品已退還。',
  'hud.errors.tradeSettleCancelled': '交易已取消，你的物品已退還。',
  'hud.errors.tradeSettleUnavailable': '交易無法結算，你的物品已退還。',
  ...
  'hud.logs.tradeDeclined': '{name} 拒絕了你的交易請求。',
  ...
  'hud.trade.cancel': '取消',
  'hud.trade.settlingTitle': '交易結算中…',
  'hud.trade.legYourWoc': '你的 WOC 付款',
  'hud.trade.legTheirWoc': '對方的 WOC 付款',
  'hud.trade.statusPending': '進行中',
  'hud.trade.wocPayPrompt': '請從你已綁定的錢包發送 {amount} WOC 以完成交易。',
  'hud.trade.openInWallet': '在錢包中開啟',
  'hud.trade.copyLink': '複製付款連結',
  'hud.trade.copiedLink': '付款連結已複製。',
  'hud.trade.instanceSignedBy': '簽名者：{name}',
  'hud.trade.instanceUnique': '獨特的副本',
  ...
  'itemUi.market.sortPrice': '價格',
  'itemUi.market.sortTimeLeft': '剩餘時間',
  'itemUi.market.timeLeft': '剩餘{time}',
  'itemUi.market.yourBidBadge': '你的出價',
  'itemUi.market.currentBidLabel': '出價：',
  'itemUi.market.noBidsYet': '尚無出價',
  'itemUi.market.minNextBid': '最低出價 {money}',
  'itemUi.market.buyoutLabel': '一口價 {money}',
  'itemUi.market.auctionBadge': '拍賣',
  'itemUi.market.leadingBid': '你目前領先',
  'itemUi.market.bidInputAria': '{item} 的出價金額',
  'itemUi.market.bidButton': '出價',
  'itemUi.market.bidAria': '對 {item} 出價',
  'itemUi.market.buyoutButton': '一口價購買',
  'itemUi.market.buyoutAria': '以 {price} 一口價購買 {item}',
  'itemUi.market.buyQuantityAria': '購買 {item} 的數量',
  'itemUi.market.listingTypeLabel': '上架類型',
  'itemUi.market.listingTypeFixed': '一口價',
  'itemUi.market.listingTypeAuction': '拍賣',
  'itemUi.market.durationLabel': '持續時間',
  'itemUi.market.durationOption': '{hours}小時',
  'itemUi.market.startingBidLabel': '起標價',
  'itemUi.market.buyoutOptionalLabel': '一口價（選填）',
  'itemUi.market.totalLabel': '總計',
  'itemUi.market.depositPreviewLabel': '上架保證金',
  'itemUi.market.cancelConfirmTitle': '取回上架物品',
  'itemUi.market.cancelConfirmBody': '從市場取回 {item}？保證金 {money} 將被沒收。',
  'itemUi.market.cancelConfirmBodyNoDeposit': '從市場取回 {item}？',
  'itemUi.market.cancelConfirmDismiss': '取消',
  'itemUi.market.outbidToast': '你對 {item} 的出價已被超過。{money} 已退還至你的領取箱。',
  'itemUi.market.wonToast': '你贏得了 {item} 的拍賣！請到商人處領取。',
  'itemUi.market.soldToast': '你的 {item} 以 {money} 售出。請到商人處領取。',
  'itemUi.market.expiredToast': '你的 {item} 上架已過期未售出。請到商人處領取。',
  'itemUi.market.denomLabel': '貨幣',
  'itemUi.market.denomGold': '金幣',
  'itemUi.market.auctionGoldOnly': '競標僅接受金幣。',
  'itemUi.market.claudiumPriceEach': '單價（Claudium）',
  'itemUi.market.wocPriceLot': '整批價格（WOC）',
  'itemUi.market.claudiumEach': '每件 {amount} Claudium',
  'itemUi.market.claudiumMinError': '價格至少為 1 Claudium。',
  'itemUi.market.awaitingPayment': '等待付款',
  'itemUi.market.buyExternalTitle': '確認購買',
  'itemUi.market.buyClaudiumConfirmBody':
    '以 {amount} Claudium 購買 {item}？款項將從你的 Claudium 餘額中扣除。',
  'itemUi.market.buyWocConfirmBody':
    '以 {amount} WOC 購買 {item}？你將從已綁定的錢包付款，款項到帳後貨物才會交付。',
  'itemUi.market.buyClaudiumAria': '用 Claudium 購買 {item}',
  'itemUi.market.buyWocAria': '用 WOC 購買 {item}',
  'itemUi.market.pendingClaudium': '正在完成 {item} 的購買。',
  'itemUi.market.pendingPreparing': '正在準備 {item} 的付款請求。',
  'itemUi.market.wocPayPrompt': '從已綁定的錢包發送 {amount} WOC 以完成 {item} 的購買。',
  'itemUi.market.paymentExpiredToast': '{item} 的付款時限已過。該拍品重新開放。',
  'itemUi.market.soldWalletToast':
    '你的 {item} 以 {amount} WOC 售出。貨款已直接支付到你綁定的錢包；請到商人處領取保證金。',
  'itemUi.market.soldAccountToast':
    '你的 {item} 以 {amount} Claudium 售出。貨款已計入你的 Claudium 餘額；請到商人處領取保證金。',
  ...
  'itemUi.logs.postedAuction': '已將 {item} 上架拍賣（起標價 {money}）。',
  'itemUi.logs.bidPlaced': '已出價：{money}，競標 {item}。',
  'itemUi.logs.listedClaudium': '已將 {item} 以 {amount} Claudium 上架到世界市場。',
  'itemUi.logs.listedWoc': '已將 {item} 以 {amount} WOC 上架到世界市場。',
  ...
  'itemUi.errors.minStartingBid': '起標價至少為 1 銅幣。',
  'itemUi.errors.buyoutTooLow': '一口價必須高於起標價。',
  'itemUi.errors.chooseDuration': '請選擇 12、24 或 48 小時的上架時長。',
  'itemUi.errors.cannotAffordDeposit': '你無法支付上架保證金。',
  'itemUi.errors.bidsOnly': '該拍品僅接受出價。',
  'itemUi.errors.notAuction': '該拍品並非拍賣品。',
  'itemUi.errors.cannotBidOwnLot': '你不能對自己的拍品出價。',
  'itemUi.errors.alreadyHighBidder': '你已經是目前最高出價者。',
  'itemUi.errors.bidTooLow': '出價至少為 {min}。',
  'itemUi.errors.bidsGoldOnly': '競標僅接受金幣。',
  'itemUi.errors.claudiumUnavailable': 'Claudium 掛單不可用。',
  'itemUi.errors.wocUnavailable': 'WOC 掛單不可用。',
  'itemUi.errors.wocLinkToList': '綁定錢包後才能以 WOC 上架。',
  'itemUi.errors.wocLinkToPay': '綁定錢包後才能用 WOC 付款。',
  'itemUi.errors.wocPriceInvalid': '請輸入有效的 WOC 價格。',
  'itemUi.errors.awaitingPayment': '該拍品正在等待付款。',
  'itemUi.errors.pendingPurchaseFirst': '請先完成待處理的購買。',
  ...
  'guide.economy.marketBrowse':
    '瀏覽：捲動列表或按名稱搜尋，找出待售的商品。每筆刊登都會顯示貨物、賣家、剩餘時間，以及可分批購買的整堆單價，或是拍賣品目前的出價。',
  'guide.economy.marketCollect':
    '收取：當你的貨物售出後，所得款項會在商人處等著你。回去領取錢幣，連同任何未售出而退回的物品。每筆完成的交易，商人都會抽取一小筆費用。',
  'guide.economy.marketPost':
    '刊登：從背包中選一堆物品，選擇上架時長（12、24 或 48 小時）並設定單價，或改為拍賣並設定起標價及可選的一口價。刊登需要繳一筆與時長相關的保證金；物品售出時會隨之退還，只有未售出的部分才會被沒收。在有人買下或拍賣結束之前，貨物會由商人代為保管，若你改變心意，也可以提早取回。',
  'guide.economy.marketBidding':
    '拍賣：部分刊登接受出價而非固定價格。出價必須不低於公告的最低出價，一旦你的出價被超過，先前的出價會全額退還。若賣家設定了一口價，出價達到該金額即可當場買下整批貨物。',
  'guide.economy.marketCurrencies':
    '在啟用的情況下，掛單也可以用 Claudium 或 WOC 定價：買家直接向你付款（帳戶對帳戶或錢包對錢包），商人會保管貨物直到付款確認，而上架保證金仍然是金幣。',
  ...
  'entities.letters.market_sold_wallet.body':
    '買家買走了你的貨物。貨款已按你的要求直接支付到你綁定的錢包；世界市場的領取箱裡只剩你的上架保證金。請來取回。\n\n- 商人',
  ...
  'entities.letters.market_sold_account.body':
    '買家買走了你的貨物。貨款已直接計入你的 Claudium 餘額；世界市場的領取箱裡只剩你的上架保證金。請來取回。\n\n- 商人',
  'entities.letters.trade_delivery.sender': '渡鴉郵驛',
  'entities.letters.trade_delivery.subject': '交易貨品送達',
  'entities.letters.trade_delivery.body':
    '你交易所得的貨品已經送達。渡鴉幫你捎來了背包裝不下的東西。',
  'entities.letters.trade_refund.sender': '渡鴉郵驛',
  'entities.letters.trade_refund.subject': '交易物品已退還',
  'entities.letters.trade_refund.body': '交易未能完成。你提供的一切已經退還給你。',
