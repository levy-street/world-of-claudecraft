...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_logol_sign.text': "要看見不可見之物，你須調校你的眼。走上一程，再回來，我便為你留印。",
  'entities.quests.q_logol_sign.completion': "印記已成。你的眼已就緒。",
  'entities.quests.q_logol_sign.objectives.0.label': "回到先驅處受印",
  'entities.quests.q_logol_seen.title': "所見與不可見",
  'entities.quests.q_logol_seen.text': "大功告成。當你再與披斗篷者相遇，他便會與你交易。去吧，留意世界的邊緣。",
  'entities.quests.q_logol_seen.completion': "現在你能看見他了。他的帳簿向你敞開。花得明智些。",
  'entities.quests.q_logol_seen.objectives.0.label': "接受無名之序的視界",
};
