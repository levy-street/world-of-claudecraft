...
export const es_ES: Partial<Record<TranslationKey, string>> = {
  ...
  'loading.reconnecting': "Se ha perdido la conexión. Reconectando...",
  'hudChrome.crafting.close': "Cerrar artesanía",
  'hudChrome.crafting.craft': "Crear",
  'hudChrome.crafting.craftedToast': "Creado: {name}",
  'hudChrome.crafting.empty': "Todavía no sabes ninguna receta.",
  'hudChrome.crafting.insufficientMaterials': "No cuentas con los materiales necesarios.",
  'hudChrome.crafting.reagentLine': "{name}: {have}/{required}",
  'hudChrome.crafting.reagentsNeeded': "Necesita:",
  'hudChrome.crafting.resultAria': "Crear {name}",
  'hudChrome.crafting.title': "Artesanía",
  'hudChrome.crafting.unknownRecipe': "Esta receta no existe.",
  'hudChrome.mobile.actionPageIndicator': "Pág. {page}",
  'hudChrome.mobile.actionPageToggle': "Cambiar de página de acciones",
  'hudChrome.mobile.actionRing': "Acciones para combatir",
  'hudChrome.mobile.spellbookPageLabel': "Pág. {page}",
  'hudChrome.mobile.targetCycle': "Alternar objetivo",
  'hudChrome.mobile.targetCycleShort': "Blanco",
  'hudChrome.options.mobileCameraJoystick': "Palanca de cámara",
  'hudChrome.options.mobileLeftHanded': "Disposición para zurdos",
};
