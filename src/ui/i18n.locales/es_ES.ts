...
export const es_ES: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Sandalias del Camino de Ceniza',
  'entities.items.cinderarc_odrenns_rod.name': 'Estela de Ascua, cetro de Odrenn',
  'entities.items.cindertoad_signet.name': 'Sortija-sello del Sapo de Brasa',
  'entities.items.coalglow_band.name': 'Anillo del Fulgor del Carbón',
  'entities.items.crownforged_warleggings.name': 'Grebas de guerra Forjacorona',
  'entities.items.glassblowers_shiv.name': 'Puñal del Soplador de Vidrio',
  'entities.items.glasswalker_treads.name': 'Calzado Caminacristal',
  'entities.items.nighttalon_prowlers.name': 'Acechadores Garra Nocturna',
  'entities.items.quenchsilk_cord.name': 'Fajín de Seda de Temple',
  'entities.items.ring_of_the_first_quench.name': 'Sortija de la Primera Templanza',
  'entities.items.saans_stoking_iron.name': 'Hierro Atizador de Saan',
  'entities.items.slag_tempered_sabatons.name': 'Escarpes Templados con Escoria',
  'entities.items.slakeleather_belt.name': 'Faja de Cuero Apagado',
  'entities.items.sluicebearer.name': 'Guardián de la Esclusa',
  'entities.items.soulflame_kilt.name': 'Faldellín Llama de Alma',
  'entities.items.stokebrand_striders.name': 'Zancadores Marcaascua',
  'entities.items.stormcallers_legwraps.name': 'Polainas del Invocatormentas',
  'entities.items.the_even_temper.name': 'La Templanza Ecuánime',
  'entities.items.twice_fired_slippers.name': 'Escarpines de Doble Cocción',
  'entities.items.twicetempered_girdle.name': 'Faja de Doble Temple',
  'entities.items.crownforged_heartplate.name': 'Peto Forjacorona',
  'entities.items.nighttalon_emberweave.name': 'Ascua tejida Garra Nocturna',
  'entities.items.soulflame_vestments.name': 'Ornamentos de Llama de Alma',
  'entities.items.stormcallers_hauberk.name': 'Cota del Clamatormentas',
  'entities.items.volzharrs_knucklestone.name': 'Nudillera pétrea de Volzharr',
  'entities.items.magmastrider_greaves.name': 'Escarpes Zancamagma',
  'entities.items.footwraps_of_the_waking_floor.name': 'Escarpines del Suelo Despierto',
  'entities.items.forgeheat_cinch.name': 'Ceñidor de la Forja Ardiente',
  'entities.items.corebreaker_heart_of_the_undermount.name':
    'Quebrantador del Núcleo, Corazón de la Submontaña',
  'entities.items.the_last_restraint.name': 'El Último Freno',
  'entities.items.band_of_the_ninth_quench.name': 'Banda de la Novena Extinción',
  'entities.items.moltenheart_chroma.name': 'Corazón de Magma',
  'entities.itemSets.crownforged.bonus5': 'Otorga un 3 % más de probabilidad de golpe crítico.',
  'entities.itemSets.nighttalon.bonus5': 'Otorga un 3 % más de probabilidad de golpe crítico.',
  'entities.itemSets.soulflame.bonus5':
    'Otorga un 3 % más de probabilidad de golpe crítico con hechizos.',
