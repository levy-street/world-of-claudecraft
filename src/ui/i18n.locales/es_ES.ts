...
export const es_ES: Partial<Record<TranslationKey, string>> = {
  ...
  'desktop.update.checkingTitle': 'Comprobando si hay actualizaciones...',
  'desktop.update.checkingBody': 'Las versiones nuevas se bajan mientras juegas.',
  'desktop.update.dismiss': 'Cerrar aviso',
  'desktop.update.downloadingBody': 'Puedes seguir jugando; se instalará al cerrar el juego.',
  'desktop.update.uptodateTitle': 'Ya estás en la versión más reciente.',
  'hudChrome.crafting.dialogOption': 'Fabricación',
  'hudChrome.crafting.dialogOptionAria': 'Abrir la ventana de fabricación para {craft}',
