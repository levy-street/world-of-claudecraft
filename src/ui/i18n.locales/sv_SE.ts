...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Askvandrarens sandaler',
  'entities.items.cinderarc_odrenns_rod.name': 'Glödbåge, Odrenns stav',
  'entities.items.cindertoad_signet.name': 'Glödpaddans sigill',
  'entities.items.coalglow_band.name': 'Kolglödsring',
  'entities.items.crownforged_warleggings.name': 'Kronsmidda krigsbyxor',
  'entities.items.glassblowers_shiv.name': 'Glasblåsarens kniv',
  'entities.items.glasswalker_treads.name': 'Glasvandrarens stövlar',
  'entities.items.nighttalon_prowlers.name': 'Nattklons smygstövlar',
  'entities.items.quenchsilk_cord.name': 'Härdningssidenband',
  'entities.items.ring_of_the_first_quench.name': 'Den första härdningens ring',
  'entities.items.saans_stoking_iron.name': 'Saans eldgaffel',
  'entities.items.slag_tempered_sabatons.name': 'Slagghärdade sabatonger',
  'entities.items.slakeleather_belt.name': 'Släckläderbälte',
  'entities.items.sluicebearer.name': 'Slussbäraren',
  'entities.items.soulflame_kilt.name': 'Själslågskilt',
  'entities.items.stokebrand_striders.name': 'Eldmärkesstövlar',
  'entities.items.stormcallers_legwraps.name': 'Stormkallarens benlindor',
  'entities.items.the_even_temper.name': 'Det jämna lynnet',
  'entities.items.twice_fired_slippers.name': 'Dubbelbrända tofflor',
  'entities.items.twicetempered_girdle.name': 'Dubbelhärdat bälte',
  'entities.items.crownforged_heartplate.name': 'Krönsmidd hjärtbröstplåt',
  'entities.items.nighttalon_emberweave.name': 'Nattklons glödväv',
  'entities.items.soulflame_vestments.name': 'Själaflammevestment',
  'entities.items.stormcallers_hauberk.name': 'Stormkallarens ringbrynja',
  'entities.items.volzharrs_knucklestone.name': 'Volzharrs knogsten',
  'entities.items.magmastrider_greaves.name': 'Magmavandrarens benskenor',
  'entities.items.footwraps_of_the_waking_floor.name': 'Fotlindor från det vaknande golvet',
  'entities.items.forgeheat_cinch.name': 'Smedjehettans gördel',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Kärnkrossare, Underbergets hjärta',
  'entities.items.the_last_restraint.name': 'Den sista bojan',
  'entities.items.band_of_the_ninth_quench.name': 'Ringen från den nionde kylningen',
  'entities.items.moltenheart_chroma.name': 'Smälthjärta',
  'entities.itemSets.crownforged.bonus5': 'Ökar chansen för kritiska träffar med 3 %.',
  'entities.itemSets.nighttalon.bonus5': 'Ökar chansen för kritiska träffar med 3 %.',
  'entities.itemSets.soulflame.bonus5': 'Ökar chansen för kritiska besvärjelseeffekter med 3 %.',
  'entities.itemSets.stormcallers.bonus5': 'Ökar chansen för kritiska besvärjelseeffekter med 3 %.',
