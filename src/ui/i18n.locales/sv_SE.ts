...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.meters.loot': 'Byte',
  'hud.meters.lootShort': 'Byte',
  'hud.meters.lootHistory': 'Historik',
  'hud.meters.noLoot': 'Inget byte registrerat än.',
  'hud.meters.recentAwards': '{count} senaste tilldelningar',
  'hud.meters.methodReturned': 'Avstod',
  'hud.meters.methodMaster': 'Mästare',
  'hud.meters.methodPersonal': 'Personligt',
  'hud.meters.methodDelve': 'Delve',
  'hud.meters.methodLooted': 'Plundrat',
  'hud.meters.noWinner': 'Ingen vinnare',
  'hud.meters.rollDetail': 'Kast {roll}',
