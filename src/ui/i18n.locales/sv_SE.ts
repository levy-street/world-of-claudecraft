...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'loading.reconnecting': "Anslutningen bröts. Ansluter igen...",
  'hudChrome.crafting.close': "Stäng tillverkning",
  'hudChrome.crafting.craft': "Tillverka",
  'hudChrome.crafting.craftedToast': "Tillverkat: {name}",
  ...
  'hudChrome.crafting.resultAria': "Tillverka {name}",
  'hudChrome.crafting.title': "Tillverkning",
