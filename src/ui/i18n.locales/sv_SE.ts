...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'Spegelporten',
  'entities.zones.mirror_world.name': 'Spegelvärlden',
  'entities.zones.mirror_world.welcome':
    'Glaset minns dig. Se upp med vilken sida av det du går på.',
  'entities.zones.mirror_world.pois.0.label': 'Spegelvärlden',
  'entities.zones.mirror_world.pois.1.label': 'Spegelportens torg',
  'entities.zones.mirror_world.pois.2.label': 'Lumenkronan',
  'entities.zones.mirror_world.pois.3.label': 'Den Beslöjade Marknaden',
  'entities.zones.mirror_world.pois.4.label': 'Det Tysta Arkivet',
  'entities.zones.mirror_world.pois.5.label': 'Spegelsjön',
  'entities.zones.mirror_world.pois.6.label': 'Dimkärret',
  'entities.zones.mirror_world.pois.7.label': 'Häxans Sänka',
  'entities.zones.mirror_world.pois.8.label': 'Eastbrooks Spegel',
  'entities.zones.mirror_world.pois.9.label': 'Fenbridges Spegel',
  'entities.mobs.poverty_ghost.name': 'Fattigdomsspöke',
  'entities.mobs.spirit_unicorn.name': 'Andeenhörning',
  'entities.mobs.hooded_reaper.name': 'Skördeman',
  'entities.mobs.gloomhulk.name': 'Dysterkoloss',
  'entities.mobs.mirrorbound_sentry.name': 'Spegelbunden Vakt',
  'entities.mobs.voidfang_stalker.name': 'Blektand-Smygare',
  'entities.npcs.dread_sentinel_a.name': 'Fasans Vakt',
  'entities.npcs.dread_sentinel_a.title': 'Väktare av Skuggspegeln',
  'entities.npcs.dread_sentinel_a.greeting': 'Din död väntar dig.',
  'entities.npcs.dread_sentinel_b.name': 'Fasans Vakt',
  'entities.npcs.dread_sentinel_b.title': 'Väktare av Skuggspegeln',
  'entities.npcs.dread_sentinel_b.greeting': 'I livet höll vi vägbanken. Vi håller den än.',
  'entities.npcs.dread_sentinel_c.name': 'Fasans Vakt',
  'entities.npcs.dread_sentinel_c.title': 'Väktare av Skuggspegeln',
  'entities.npcs.dread_sentinel_c.greeting':
    'Vänd om. Det svarta glaset är inte för de levande - inte heller var det någonsin för oss.',
  'entities.quests.q_gargoyle_south.title': 'Väktarens Tull',
  'entities.quests.q_gargoyle_south.text':
    'Skenet blir till ord bakom dina ögon: skördemännen trängs vid mitt glas, {playerName}. Gallra dem, och vägen till Highwatch är din.',
  'entities.quests.q_gargoyle_south.completion':
    'Stenen brummar en gång, nöjd. Bakom den klarnar spegeln som ett äntligen släppt, hållet andetag.',
  'entities.quests.q_gargoyle_south.objectives.0.label': 'Skördeman fälld',
  'entities.quests.q_gargoyle_west.title': 'En Tull av Lakan',
  'entities.quests.q_gargoyle_west.text':
    'Skenet blir till ord bakom dina ögon: hämta mig fyra vita lakan från de fattiga döda, {playerName}. Vägen till Eastbrook öppnas för den som betalar i tyg.',
  'entities.quests.q_gargoyle_west.completion':
    'Lakanen sjunker in i stenen och är borta. Spegeln bakom den vaknar med ljus.',
  'entities.quests.q_gargoyle_west.objectives.0.label': 'Vitt Lakan',
  'entities.quests.q_gargoyle_north.title': 'Skördad Strålglans',
  'entities.quests.q_gargoyle_north.text':
    'Skenet blir till ord bakom dina ögon: andehjordarna brinner för klart för glaset, {playerName}. Fäll fem, och Fenbridge är ett steg bort.',
  'entities.quests.q_gargoyle_north.completion':
    'Stenen dricker ljuset du spillde. Spegeln bakom den öppnar sig som ett öga.',
  'entities.quests.q_gargoyle_north.objectives.0.label': 'Andeenhörning fälld',
  'entities.zones.mirror_world.pois.10.label': 'Den Svarta Ravinen',
  'entities.mobs.gargoyle_awakened.name': 'Gargoylvakt',
  'entities.mobs.mistshade_lurker.name': 'Dimskugge-lurare',
  'entities.mobs.gloaming_maw.name': 'Skymningsgapet',
  'entities.mobs.player_echo.name': 'Eko',
  'entities.npcs.keeper_nerissa.name': 'Nerissa den Rastlösa',
  'entities.npcs.keeper_nerissa.title': 'Spökväktare av Lumenkronan',
  ...
  'entities.quests.q_what_the_poor_keep.completion':
    'Fem lakan, fem namn. Jag säger dem i brunnen och vattnet tar dem som en mor lyfter en rock av ett sovande barn. Vålnaderna vid stranden är färre i natt, {playerName}: inte dräpta, befriade. Detta gjorde hela Kronan: den höll de döda nära nog för att kunna släppa dem. Nu gör vi det för hand, du och jag, fem namn i taget. Det går långsammare. Det är inte ingenting.',
  'entities.quests.q_what_the_poor_keep.objectives.0.label': 'Vitt lakan',
  'entities.quests.q_the_wardens_names.title': 'Väktarnas namn',
  'entities.quests.q_the_wardens_names.text':
    'De tre som vandrar Svarta ravinen kallas Skräckvakter av dem som flyr dem. Jag kallade dem en gång vid namn: de var min orden, {playerName}, de sista män som i livet höll Sobelspegelns vägbank, och de vek aldrig, inte ens när deras hjärtan gjorde det. Ingen klinga befriar dem längre; det svarta glaset rider dem för djupt för att de ska falla. Men det glaset har krupit från väktarna till skördarna som trängs på vägbanken, och genom de långa åren har skördarna slitit loss väktarnas sigill. Hämta mig tre, tagna från ravinens skördare, så att jag säger de tre namnen högt en sista gång.',
  'entities.quests.q_the_wardens_names.completion':
    'Corwin. Aldous. Brenna. Så: sagda, och att säga dem väger lättare än att hålla dem någonsin gjorde. Snart får de sluta; det ska jag se till. Men akta det som nalkas, {playerName}: de lossryckta sigillen betyder att glaset på den vägbanken tunnas, och såret vid dess ände har väntat på just detta. Jag måste tända Kronan på nytt och stötta Sobeln innan något på andra sidan märker att dörren står blottad. Det finns en sista sak jag behöver - och den ligger under det svarta vattnet.',
  'entities.quests.q_the_wardens_names.objectives.0.label': 'Väktarsigill',
  'entities.quests.q_what_the_glass_wants.title': 'Vad glaset vill',
  ...
  'entities.quests.q_relight_the_lumen_crown.objectives.1.label': 'Dränkt lumen',
  'entities.quests.q_relight_the_lumen_crown.objectives.2.label': 'Dysterkoloss krossad',
  'entities.npcs.veilwright_ollo.name': 'Slöjvävaren Ollo',
  'entities.npcs.veilwright_ollo.title': 'Handlare på Slöjmarknaden',
  ...
  'entities.npcs.gargoyle_sentinel_south.name': 'Gargoylvakt',
  'entities.npcs.gargoyle_sentinel_south.title': 'Spegelns Väktare',
  'entities.npcs.gargoyle_sentinel_south.greeting': 'Stenögon gnisslar åt ditt håll. Den lyssnar.',
  'entities.npcs.gargoyle_sentinel_west.name': 'Gargoylvakt',
  'entities.npcs.gargoyle_sentinel_west.title': 'Spegelns Väktare',
  'entities.npcs.gargoyle_sentinel_west.greeting': 'Stenögon gnisslar åt ditt håll. Den lyssnar.',
  'entities.npcs.gargoyle_sentinel_north.name': 'Gargoylvakt',
  'entities.npcs.gargoyle_sentinel_north.title': 'Spegelns Väktare',
  'entities.npcs.gargoyle_sentinel_north.greeting': 'Stenögon gnisslar åt ditt håll. Den lyssnar.',
  ...
  'entities.items.black_hood.name': 'Svart Huva',
  'entities.items.deepdream_draught.name': 'Djupdröm-brygd',
  'entities.items.mirror_shard.name': 'Spegelskärva',
  'entities.items.ghostly_mirrorblade.name': 'Spöklik Spegelklinga',
  'entities.items.ghostly_shroudmantle.name': 'Spöklik Svepningsmantel',
  'entities.items.ghostly_wraithjerkin.name': 'Spöklik Vålnadsväst',
  'entities.items.ghostly_palegrips.name': 'Spöklika Bleka Grepp',
  'entities.items.ghostly_hushboots.name': 'Spöklika Tysta Stövlar',
  'entities.items.ghostly_glasscord.name': 'Spöklik Glassnodd',
  ...
  'questUi.dialog.brewDraught': 'Brygg mig en Djupdröm-brygd.',
  'questUi.dialog.brewDraughtAria': 'Be {name} brygga en Djupdröm-brygd',
  'questUi.dialog.gargoyleBow': 'Buga.',
  'questUi.dialog.gargoyleBowAria': 'Buga för {name}',
  'questUi.dialog.gargoyleAttack': 'Anfall.',
  'questUi.dialog.gargoyleAttackAria': 'Anfall {name}',
  'questUi.dialog.gargoyleShimmer': 'Statyn skimrar av energi...',
  'hud.core.deepdreamZone': 'Djupdrömmen',
