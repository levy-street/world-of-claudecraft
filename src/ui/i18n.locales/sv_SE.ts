...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.basic_mining_pick.name': 'Enkel gruvhacka',
  'entities.items.basic_logging_axe.name': 'Enkel skogshuggaryxa',
  'entities.items.basic_herbalists_sickle.name': 'Enkel örtskära',
