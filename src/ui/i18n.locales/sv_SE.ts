...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.mistcallers_duffel.name': 'Dimkallarens sjösäck',
  ...
  'entities.items.dune_prowler_pelt.name': 'Dynstrykarpäls',
  'entities.items.glasswind_stinger.name': 'Glasvindsgadd',
  'entities.items.stolen_relic.name': 'Stulen relik',
  'entities.items.nameless_burial_shroud.name': 'Namnlös gravsvepning',
  'entities.items.storm_glass_core.name': 'Stormglaskärna',
  'entities.items.verdict_seal.name': 'Domslutssigill',
  'entities.items.glasswind_husk.name': 'Glasvindsskal',
  'entities.items.mirage_stalker_eye.name': 'Hägringssmygarens öga',
  'entities.items.dig_manifest.name': 'Utgrävningsmanifest',
  'entities.items.tomb_censer.name': 'Gravrökelsekar',
  'entities.items.sentence_tablet.name': 'Domslutstavla',
  'entities.items.duststorm_heart.name': 'Stoftstormshjärta',
  'entities.items.ravager_hide.name': 'Härjarhud',
  'entities.items.aqueduct_bronze.name': 'Bronsbeslag från akvedukten',
  'entities.items.judge_regalia.name': 'Första domstolens skrud',
  'entities.items.sunbleached_fang.name': 'Solblekt huggtand',
  'entities.items.cracked_scarab_shell.name': 'Sprucket skarabéskal',
  'entities.items.emberjaw_pelt.name': 'Glödkäftsmatriarkens päls',
  'entities.items.karns_funeral_mask.name': 'Karns gravmask',
  'entities.items.qesh_flatbread.name': 'Qesh-tunnbröd',
  'entities.items.oasis_waterskin.name': 'Oasvattenskinn',
  'entities.items.spiced_scarab_skewer.name': 'Kryddat skarabéspett',
  'entities.items.duneweave_robe.name': 'Dynvävnadssärk',
  'entities.items.caravan_guard_hauberk.name': 'Karavanvaktens brynja',
  'entities.items.prowlerhide_vest.name': 'Strykarhudsväst',
  'entities.items.sandwalker_treads.name': 'Sandvandrarsteg',
  'entities.items.dunewatch_legguards.name': 'Dynvaktens benskenor',
  'entities.items.qesh_khopesh.name': 'Qesh-khopesh',
  'entities.items.judgestaff_of_ossara.name': 'Ossaras domarstav',
  'entities.items.glasswind_talon.name': 'Glasvindsklo',
  'entities.items.emberjaw_prowlgrips.name': 'Glödkäftens jaktgrepp',
  'entities.items.unburied_gravewraps.name': 'Den obegravdes gravlindor',
  'entities.items.sandmaw_scale_cuirass.name': 'Sandgapets fjällkyrass',
  'entities.items.tyrantfang_edge.name': 'Tyranntandsklinga',
  'entities.items.palewidow_silk.name': 'Blekänkesilke',
  'entities.items.waterlogged_ledger.name': 'Genomdränkt liggare',
  'entities.items.guildless_sigil.name': 'De gilleslösas sigill',
  'entities.items.silent_court_seal.name': 'Tysta domstolens sigill',
  'entities.items.duskmane_pelt_strip.name': 'Skymningsman-pälsremsa',
  'entities.items.palewidow_venom_sac.name': 'Blekänkans giftsäck',
  'entities.items.quay_manifest.name': 'Genomdränkt kajmanifest',
  'entities.items.wisplight_essence.name': 'Irrblossessens',
  'entities.items.drowned_toll_coin.name': 'Dränkt vägtullsmynt',
  'entities.items.cutthroat_contract.name': 'Strupskärarkontrakt',
  'entities.items.court_ledger_page.name': 'Blad ur domstolsboken',
  'entities.items.frostpine_war_totem.name': 'Frosttallens krigstotem',
  'entities.items.rimeclaw_pelt.name': 'Rimklopäls',
  'entities.items.duskmane_tuft.name': 'Skymningsmantofs',
  'entities.items.guttering_wisp_mote.name': 'Fladdrande irrblosskorn',
  'entities.items.frostpine_charm.name': 'Frosttallsamulett',
  'entities.items.palefang_pelt.name': 'Blektand den tystes päls',
  'entities.items.grelnoks_frozen_idol.name': 'Grelnoks frusna avgudabild',
  'entities.items.nighthollow_black_bread.name': 'Natthålans svartbröd',
  'entities.items.pinefrost_tea.name': 'Tallfrost-te',
  'entities.items.smoked_blackmere_eel.name': 'Rökt Svartsjöål',
  'entities.items.wispweave_robe.name': 'Irrblossvävd särk',
  'entities.items.quayguard_hauberk.name': 'Kajvaktens brynja',
  'entities.items.duskstalker_vest.name': 'Skymningssmygarväst',
  'entities.items.nightpath_treads.name': 'Nattstigssteg',
  'entities.items.blackriver_legguards.name': 'Svartflodens benskenor',
  'entities.items.terracewatch_leggings.name': 'Terrassvaktens byxor',
  'entities.items.quays_cutlass.name': 'Kajhuggare',
  'entities.items.wispcaller_staff.name': 'Irrblosskallarstav',
  'entities.items.whispersteel_stiletto.name': 'Viskstålsstilett',
  'entities.items.palefang_grips.name': 'Blektandsgrepp',
  'entities.items.hoarbound_bindings.name': 'Den rimbundnes bojor',
  'entities.items.forsworn_lamellar.name': 'Edsbrytarens lamellkyrass',
  'entities.items.forsworn_edge.name': 'Edsbrytarens klinga',
  'entities.items.stolen_tithe_ledger.name': 'Stulen tiondebok',
  'entities.items.granite_core_shard.name': 'Granitkärnskärva',
  'entities.items.legion_deserter_insignia.name': 'Legionsdesertörens emblem',
  'entities.items.chewed_tithe_scrip.name': 'Tuggad tiondesedel',
  'entities.items.candle_tax_tally.name': 'Ljusskattens karvstock',
  'entities.items.assay_office_seal.name': 'Proberkammarens sigill',
  'entities.items.legion_pay_manifest.name': 'Legionens sold-lista',
  'entities.items.prime_wolf_pelt.name': 'Förstklassig vargpäls',
  'entities.items.wendigo_gallstone.name': 'Wendigo-gallsten',
  'entities.items.icehowler_ruff.name': 'Isylarens halskrage',
  'entities.items.legion_quarrel_bundle.name': 'Bunt legionslod',
  'entities.items.clipped_imperial_coin.name': 'Klippt kejsarmynt',
  'entities.items.rimewoven_hide.name': 'Rimvävd hud',
  'entities.items.sellsword_pig_iron.name': 'Legosvens tackjärn',
  'entities.items.lean_wolf_haunch.name': 'Mager vargstek',
  'entities.items.pilfered_ration_pack.name': 'Snattat ransonspaket',
  'entities.items.sellsword_requisition_chit.name': 'Legosvens rekvisitionssedel',
  'entities.items.frostbrush_wolf_fang.name': 'Frostsnårets vargtand',
  'entities.items.bent_legion_buckle.name': 'Böjt legionsspänne',
  'entities.items.ogre_knuckle_dice.name': 'Ogreknogtärningar',
  'entities.items.hoarfang_pelt.name': 'Rimtandsalfans päls',
  'entities.items.kazriks_brass_whistle.name': 'Kazriks mässingsvissla',
  'entities.items.kaelspire_barley_loaf.name': 'Kaelspirans kornlimpa',
  'entities.items.silverbrook_spring_water.name': 'Silverbäckens källvatten',
  'entities.items.imperial_field_ration.name': 'Kejserlig fältranson',
  'entities.items.imperial_clerks_robe.name': 'Riksskrivarens särk',
  'entities.items.kael_infantry_hauberk.name': 'Kael-infanteribrynja',
  'entities.items.wolfsward_hunting_jerkin.name': 'Vargvaktens jaktjacka',
  'entities.items.tithe_road_marchboots.name': 'Tiondevägens marschkängor',
  'entities.items.imperial_marcher_legguards.name': 'Riksmarschörens benskenor',
  'entities.items.kael_arming_sword.name': 'Kael-riddarsvärd',
  'entities.items.frosthelm_warstaff.name': 'Frosthjälms krigsstav',
  'entities.items.wolfsward_skinner.name': 'Vargvaktens flåkniv',
  'entities.items.prefects_sealed_mantle.name': 'Prefektens förseglade mantel',
  'entities.items.huntmasters_winter_hood.name': 'Jaktmästarens vinterhuva',
  'entities.items.hoarfang_clawgrips.name': 'Rimtandens klogrepp',
  'entities.items.overseers_candlewraps.name': 'Uppsyningsmannens ljuslindor',
  'entities.items.oathbreakers_battleplate.name': 'Edsbrytarens stridspansar',
  'entities.items.oathbreakers_greatblade.name': 'Edsbrytarens storklinga',
  'entities.items.grey_shale_chip.name': 'Gråskifferflisa',
  'entities.items.smuggled_trinket.name': 'Smugglat krimskrams',
  'entities.items.barbed_thorn_husk.name': 'Hulling-törnkapsel',
  'entities.items.thornfen_tusk.name': 'Törnkärrstrollets bete',
  'entities.items.torn_caravan_banner.name': 'Sönderrivet karavanbanér',
  'entities.items.ironpass_rubble_core.name': 'Järnpassets bråtekärna',
  'entities.items.wyvern_tail_barb.name': 'Wyverns svansudd',
  'entities.items.reagent_gland.name': 'Reagenssvullen körtel',
  'entities.items.fogged_lantern_glass.name': 'Immig lyktglas',
  'entities.items.river_worn_idol.name': 'Flodslipad avgudabild',
  'entities.items.gull_picked_bone.name': 'Måspickat ben',
  'entities.items.underway_hardtack.name': 'Undervägens skorpa',
  'entities.items.smugglers_black_brew.name': 'Smugglarens svarta brygd',
  'entities.items.thornberry_loaf.name': 'Törnbärslimpa',
  'entities.items.palisade_pine_tea.name': 'Palissadens tall-te',
  'entities.items.tollhouse_stew.name': 'Tullhusgryta',
  'entities.items.ironpass_mulled_cider.name': 'Järnpassets varma cider',
  'entities.items.lanternfen_eel_skewer.name': 'Lyktkärrets ålspett',
  'entities.items.fogberry_tonic.name': 'Dimbärstonikum',
  'entities.items.bridgewatch_rations.name': 'Brovaktens ransoner',
  'entities.items.nameless_river_water.name': 'Den namnlösa flodens vatten',
  'entities.items.smuggler_kings_softsteps.name': 'Smugglarkungens tassemjuka skor',
  'entities.items.briarfather_bark_mitts.name': 'Törnfaderns barkvantar',
  'entities.items.skarns_war_harness.name': 'Skarns krigssele',
  'entities.items.colossus_mireheart_girdle.name': 'Dyhjärtebälte',
  'entities.items.bridgekeepers_tollstaff.name': 'Broväktarens tullstav',
  'entities.items.melted_ration_tin.name': 'Smält ransonburk',
  'entities.items.ashcaked_fang.name': 'Askskorpad huggtand',
  'entities.items.ember_glass_shard.name': 'Glödglasskärva',
  'entities.items.saltglass_shard.name': 'Saltglasskärva',
  'entities.items.salt_crusted_chitin.name': 'Saltskorpat kitin',
  'entities.items.bleached_bone_charm.name': 'Blekt benamulett',
  'entities.items.tarnished_prewar_coin.name': 'Anlupet förkrigsmynt',
  'entities.items.sewer_silk_wad.name': 'Kloaksilkeshärva',
  'entities.items.gutter_hound_pelt.name': 'Rännstenshundpäls',
  'entities.items.cracked_salamander_scale.name': 'Sprucket salamanderfjäll',
  'entities.items.cooled_magma_bead.name': 'Svalnad magmapärla',
  'entities.items.slag_nugget.name': 'Slaggklimp',
  'entities.items.rusted_deserter_badge.name': 'Rostigt desertörmärke',
  'entities.items.redspire_rock_shard.name': 'Rödspirans klippskärva',
  'entities.items.spire_stalker_claw.name': 'Spirsmygarens klo',
  'entities.items.cinderrest_ashcake.name': 'Glödvilans askkaka',
  'entities.items.boiled_cistern_water.name': 'Kokt cisternvatten',
  'entities.items.brinehollow_salt_jerky.name': 'Salthålans saltkött',
  'entities.items.desalted_waterskin.name': 'Avsaltat vattenskinn',
  'entities.items.gutter_stew.name': 'Exilmarknadens rännstensgryta',
  'entities.items.black_market_tea.name': 'Svartabörs-te',
  'entities.items.forgefall_hardtack.name': 'Smidesfallets skorpa',
  'entities.items.coalfire_stout.name': 'Kolelds-stout',
  'entities.items.waymeet_marching_bread.name': 'Vägmötets marschbröd',
  'entities.items.bitterroot_brew.name': 'Bitterrotsbrygd',
  'entities.items.revenant_cinderguard.name': 'Gengångarens askväktare',
  'entities.items.marrowhide_leggings.name': 'Märghudsbyxor',
  'entities.items.scavenger_kings_shiv.name': 'Asätarkungens stickare',
  'entities.items.forgewyrm_scale_helm.name': 'Smidesmaskens fjällhjälm',
  'entities.items.mantle_of_the_last_muster.name': 'Sista mönstringens mantel',
  'entities.items.scorched_banner_scrap.name': 'Svedd banérslarva',
  'entities.items.melted_signet_ring.name': 'Smält sigillring',
  'entities.items.cracked_horror_horn.name': 'Sprucket fasans horn',
  'entities.items.bastion_hardtack.name': 'Bastionens skorpa',
  'entities.items.trucewater_flask.name': 'Vapenvileflaska',
  'entities.items.ashguard_robe.name': 'Askväktarsärk',
  'entities.items.breachwalker_jerkin.name': 'Bräschvandrarjacka',
  'entities.items.bastion_plated_hauberk.name': 'Bastionens pläterade brynja',
  'entities.items.bastion_arming_sword.name': 'Bastionens riddarsvärd',
  'entities.items.mercenary_greatblade.name': 'Legosvens storklinga',
  'entities.items.tithe_collectors_grasps.name': 'Tiondeindrivarens grepp',
  'entities.items.craterheart_mantle.name': 'Kraterhjärtemantel',
  'entities.items.butchers_chainguard.name': 'Slaktarens kedjeskydd',
