...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Askstav',
  'entities.items.gravecaller_cloth_handwraps.name': 'Gravkallarens tyghandlindor',
  'entities.items.gravecaller_cloth_hood.name': 'Gravkallarens tygkapuschong',
  'entities.items.gravecaller_cloth_leggings.name': 'Gravkallarens tygbenkläder',
  'entities.items.gravecaller_cloth_mantle.name': 'Gravkallarens tygmantel',
  'entities.items.gravecaller_cloth_raiment.name': 'Gravkallarens tygskrud',
  'entities.items.gravecaller_cloth_sash.name': 'Gravkallarens tygskärp',
  'entities.items.gravecaller_cloth_slippers.name': 'Gravkallarens tygtofflor',
  'entities.items.gravecaller_focus.name': 'Gravkallarens fokus',
  'entities.items.gravecaller_pendant.name': 'Gravkallarens hänge',
  'entities.items.gravecaller_ring.name': 'Gravkallarens ring',
  'entities.items.gravecaller_wand.name': 'Gravkallarens trollstav',
  'entities.items.iron_broadsword.name': 'Järnbredsvärd',
  'entities.items.iron_flanged_mace.name': 'Järnflänsklubba',
  'entities.items.mirefen_dirk.name': 'Mirefen-dolk',
  'entities.items.mirefen_hunting_bow.name': 'Mirefen-jaktbåge',
  'entities.items.mirefen_leather_belt.name': 'Mirefen-läderbälte',
  'entities.items.mirefen_leather_boots.name': 'Mirefen-läderstövlar',
  'entities.items.mirefen_leather_gloves.name': 'Mirefen-läderhandskar',
  'entities.items.mirefen_leather_hood.name': 'Mirefen-läderhuva',
  'entities.items.mirefen_leather_jerkin.name': 'Mirefen-läderjacka',
  'entities.items.mirefen_leather_leggings.name': 'Mirefen-läderbenkläder',
  'entities.items.mirefen_leather_shoulderguards.name': 'Mirefen-läderaxelskydd',
  'entities.items.thornpeak_bulwark.name': 'Thornpeak-bålverk',
  'entities.items.thornpeak_crossbow.name': 'Thornpeak-armborst',
  'entities.items.thornpeak_mail_chest.name': 'Thornpeak-ringbrynja',
  'entities.items.thornpeak_mail_gauntlets.name': 'Thornpeak-ringhandskar',
  'entities.items.thornpeak_mail_girdle.name': 'Thornpeak-ringbälte',
  'entities.items.thornpeak_mail_helm.name': 'Thornpeak-ringhjälm',
  'entities.items.thornpeak_mail_legguards.name': 'Thornpeak-ringbenskydd',
  'entities.items.thornpeak_mail_pauldrons.name': 'Thornpeak-ringaxelskydd',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Behov är inte tillgängligt eftersom din klass inte kan utrusta föremålet.',
  'itemUi.lootRoll.needUnavailablePower':
    'Behov är inte tillgängligt eftersom den här legendariska kraften är begränsad till en annan klass.',
  'itemUi.procedural.advancedDetailsHint': 'Håll ned {key} för att visa möjliga slagintervall.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Var fjärde Dysterbult märker sitt mål för ytterligare Skuggskada.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Askbindarens sigill',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Varannan skadlig besvärjelse klämtar runt målet.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Nionde klangens klocka',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Att röra sig 15 yard ger en kort ökning av rörelsehastigheten.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Den obrutna vägens stövlar',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Var tredje Glödbult sveder fiender nära målet.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Sista bålets krona',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Lagande ljus skyddar mottagaren med en sköld motsvarande en del av läkningen.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Gryningsvaktens signet',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Var tredje Vildbult återställer den primära resursen.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Vildmånens spänne',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Var tredje vapenträff får målet att blöda och återställer lite resurs.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Gråkäkes egg',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Långt drag eller Ondskeskott kan tysta målet en kort stund.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Tystskogens långbåge',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Att falla under 35% hälsa ger ett kort defensivt skydd.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'De stulna timmarnas mantel',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Ett dödande ger en kort ökning av snabbhet.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Nattglasets huggtand',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Var fjärde Bågblixt hoppar till fiender i närheten.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Stormuppvaknandets avgud',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Kritisk läkning skapar kortvarigt ett återställande område på marken.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Ysoleis vaka',
  'itemUi.procedural.legendaryLimit': 'Unikt utrustad: {count} legendarisk kraft',
  'itemUi.procedural.legendaryPower': 'Legendarisk kraft',
  'itemUi.procedural.nameFragment.deft': 'Skicklig',
  'itemUi.procedural.nameFragment.mighty': 'Mäktig',
  'itemUi.procedural.nameFragment.of_alacrity': 'av Raskhet',
  'itemUi.procedural.nameFragment.of_focus': 'av Fokus',
  'itemUi.procedural.nameFragment.of_precision': 'av Precision',
  'itemUi.procedural.nameFragment.of_reaping': 'av Skörd',
  'itemUi.procedural.nameFragment.of_remembrance': 'av Hågkomst',
  'itemUi.procedural.nameFragment.of_striking': 'av Slagkraft',
  'itemUi.procedural.nameFragment.sages': 'Visemannens',
  'itemUi.procedural.nameFragment.spiritual': 'Andlig',
  'itemUi.procedural.nameFragment.stalwart': 'Ståndaktig',
  'itemUi.procedural.nameFragment.warded': 'Beskyddad',
  'itemUi.procedural.powerRollMilliseconds': 'Kraftslag: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Kraftslag: {value}',
  'itemUi.procedural.powerRollPercent': 'Kraftslag: {value}%',
  'itemUi.procedural.powerRollResource': 'Kraftslag: {value} resurs',
  'itemUi.procedural.rareWord.ashen': 'Askgrå',
  'itemUi.procedural.rareWord.bite': 'Bett',
  'itemUi.procedural.rareWord.blackfen': 'Svartkärr',
  'itemUi.procedural.rareWord.brand': 'Brännmärke',
  'itemUi.procedural.rareWord.doom': 'Undergång',
  'itemUi.procedural.rareWord.grave': 'Grav',
  'itemUi.procedural.rareWord.mire': 'Dy',
  'itemUi.procedural.rareWord.oath': 'Ed',
  'itemUi.procedural.rareWord.promise': 'Löfte',
  'itemUi.procedural.rareWord.storm': 'Storm',
  'itemUi.procedural.rareWord.thorn': 'Törn',
  'itemUi.procedural.rareWord.thread': 'Tråd',
  'itemUi.procedural.rareWord.vigil': 'Vaka',
  'itemUi.procedural.rareWord.ward': 'Skydd',
  'itemUi.procedural.rareWord.whisper': 'Viskning',
  'itemUi.procedural.rareWord.wyrm': 'Drakorm',
  'itemUi.procedural.rarity.common': 'Vanlig',
  'itemUi.procedural.rarity.epic': 'Episk',
  'itemUi.procedural.rarity.legendary': 'Legendarisk',
  'itemUi.procedural.rarity.magic': 'Magisk',
  'itemUi.procedural.rarity.mythic': 'Mytisk',
  'itemUi.procedural.rarity.rare': 'Sällsynt',
  'itemUi.procedural.rollRangeAria': 'Möjligt slag från {min} till {max}',
  'itemUi.stats.blockValue': 'Blockeringsvärde',
  'itemUi.stats.healthOnKill': 'Hälsa vid dödande',
  'itemUi.stats.manaOnKill': 'Mana vid dödande',
  ...
  'hudChrome.enchanting.disenchantedAlso': 'Du återvinner även {material}.',
  'hudChrome.enchanting.disenchantedAlsoQty': 'Du återvinner även {material} x{qty}.',
  ...
  'hudChrome.enchanting.replaceConfirmKeeps': 'Bevarat: {kept}',
  'hudChrome.enchanting.replaceConfirmKeepsBond': 'Beställningsbindning',
  ...
  'hudChrome.enchanting.salvagedYield': 'Du återvinner {material} från {item}.',
  'hudChrome.enchanting.salvagedYieldQty': 'Du återvinner {material} x{qty} från {item}.',
  'hudChrome.gathering.harvestLine': 'Du skördar: {name}.',
  'hudChrome.gathering.harvestLineQty': 'Du skördar: {name} x{qty}.',
  'hudChrome.gathering.harvestSpecimenLine': 'Du återvinner även {name}.',
};
