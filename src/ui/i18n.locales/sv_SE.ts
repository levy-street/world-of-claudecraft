...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.mobile.customize": "Anpassa",
  "hudChrome.mobile.customizeTitle": "Anpassa kontroller",
  "hudChrome.mobile.customizeSlotAttack": "Grundattack",
  "hudChrome.mobile.customizeSlotSkill": "Förmåga {n}",
  "hudChrome.mobile.customizeSlotUtility": "Stöd",
  "hudChrome.mobile.customizeDefault": "Klassens standard",
  "hudChrome.mobile.customizeResetSlot": "Återställ denna plats",
  "hudChrome.mobile.customizeResetAll": "Återställ allt till klassens standard",
  "hudChrome.mobile.customizeUpdated": "{slot} uppdaterad.",
  "hudChrome.mobile.customizeAllReset": "Kontrollerna återställdes till klassens standard.",
  "hudChrome.options.touchControls": "Pekkontroller",
  "hudChrome.options.clusterHold": "Hålltid för redigering",
  "hudChrome.options.clusterHoldNote": "Hur länge du håller en åtgärdsknapp på skärmen innan dess bindningsredigerare öppnas. Höj den om redigeraren öppnas när du spammar förmågor.",
  "hudChrome.options.targetPriority": "Prioritet för attackmål",
  "hudChrome.options.targetPriorityNearest": "Närmaste",
  "hudChrome.options.targetPriorityLowestHp": "Lägst hälsa",
  "hudChrome.options.targetPriorityCurrent": "Nuvarande först",
  "hudChrome.options.targetPriorityNote": "Vad Attack-knappen siktar på när du saknar ett giltigt mål: närmaste fiende, fienden med lägst hälsa inom räckhåll, eller behåll ditt nuvarande mål så länge det är giltigt.",
  "hudChrome.options.aimAssist": "Smart förmågekast",
  "hudChrome.options.aimAssistNote": "Tryck på en offensiv förmåga för att använda den på ditt mål, eller på den bästa fienden i närheten om du saknar mål, och vänd dig mot den. Håll knappen för att förhandsvisa räckvidden; släpp med fingret utanför knappen för att avbryta.",
  "hudChrome.options.touchReset": "Återställ pekkontroller",
  "hudChrome.options.touchResetDone": "Pekkontrollerna återställdes till standard.",
