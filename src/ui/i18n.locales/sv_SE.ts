...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.readyCheck.start': "Redokontroll",
  'hudChrome.readyCheck.startAria': "Starta redokontroll",
  'hudChrome.readyCheck.ready': "Redo",
  'hudChrome.readyCheck.notReady': "Inte redo",
  'hudChrome.readyCheck.waiting': "Vantar",
  'hudChrome.readyCheck.status': "{ready}/{total} redo",
