...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberforged_hauberk.name': 'Haubert forgé dans la braise',
  'entities.items.emberforged_legguards.name': 'Jambières forgées dans la braise',
  'entities.items.emberforged_girdle.name': 'Ceinturon forgé dans la braise',
  'entities.items.cinderhide_vest.name': 'Gilet en cuir de cendre',
  'entities.items.moltencore_maul.name': 'Masse du cœur de magma',
  'entities.items.brand_of_the_first_flame.name': 'Tison de la Première Flamme',
  'entities.items.emberseal_of_the_covenant.name': 'Sceau de braise du pacte brisé',
  'entities.items.bloodember_band.name': 'Anneau de braise sanglante',
  'entities.items.ashcoil_signet.name': 'Chevalière de la spire de cendre',
