...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.meters.loot': 'Butin',
  'hud.meters.lootShort': 'Butin',
  'hud.meters.lootHistory': 'Historique',
  'hud.meters.noLoot': 'Aucun butin enregistré.',
  'hud.meters.recentAwards': '{count} attributions récentes',
  'hud.meters.methodReturned': 'Passé',
  'hud.meters.methodMaster': 'Maître',
  'hud.meters.methodPersonal': 'Personnel',
  'hud.meters.methodDelve': 'Gouffre',
  'hud.meters.methodLooted': 'Ramassé',
  'hud.meters.noWinner': 'Aucun gagnant',
  'hud.meters.rollDetail': 'Jet {roll}',
