...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.itemAriaProceduralEnchanted':
    "{item}, {rarity}, niveau d'objet {level}, quantité {count}, copie enchantée",
  ...
  'hudChrome.finder.raidItemLevels':
    "Niveau d'objet : Rare {rare} · Épique {epic} · Légendaire {legendary}",
  'hudChrome.finder.raidRarityLine': 'Rare {rare}% · Épique {epic}% · Légendaire {legendary}%',
  'hudChrome.finder.raidRewards': 'Aperçu des récompenses de Nythraxis',
  'hudChrome.finder.raidSharedDrop':
    'Le cadavre du boss final ajoute un objet procédural partagé pour lequel le raid peut effectuer un jet.',
  'hudChrome.finder.raidSignatures': 'Pouvoirs légendaires emblématiques : {signatures}',
  ...
  'entities.items.ashwood_staff.name': 'Bâton de frêne',
  'entities.items.gravecaller_cloth_handwraps.name': 'Bandelettes en tissu de Gravecaller',
  'entities.items.gravecaller_cloth_hood.name': 'Capuche en tissu de Gravecaller',
  'entities.items.gravecaller_cloth_leggings.name': 'Jambières en tissu de Gravecaller',
  'entities.items.gravecaller_cloth_mantle.name': 'Mantelet en tissu de Gravecaller',
  'entities.items.gravecaller_cloth_raiment.name': 'Atours en tissu de Gravecaller',
  'entities.items.gravecaller_cloth_sash.name': 'Ceinture en tissu de Gravecaller',
  'entities.items.gravecaller_cloth_slippers.name': 'Chaussons en tissu de Gravecaller',
  'entities.items.gravecaller_focus.name': 'Focalisateur de Gravecaller',
  'entities.items.gravecaller_pendant.name': 'Pendentif de Gravecaller',
  'entities.items.gravecaller_ring.name': 'Anneau de Gravecaller',
  'entities.items.gravecaller_wand.name': 'Baguette de Gravecaller',
  'entities.items.iron_broadsword.name': 'Espadon en fer',
  'entities.items.iron_flanged_mace.name': 'Masse à ailettes en fer',
  'entities.items.mirefen_dirk.name': 'Dague de Mirefen',
  'entities.items.mirefen_hunting_bow.name': 'Arc de chasse de Mirefen',
  'entities.items.mirefen_leather_belt.name': 'Ceinture en cuir de Mirefen',
  'entities.items.mirefen_leather_boots.name': 'Bottes en cuir de Mirefen',
  'entities.items.mirefen_leather_gloves.name': 'Gants en cuir de Mirefen',
  'entities.items.mirefen_leather_hood.name': 'Capuche en cuir de Mirefen',
  'entities.items.mirefen_leather_jerkin.name': 'Pourpoint en cuir de Mirefen',
  'entities.items.mirefen_leather_leggings.name': 'Jambières en cuir de Mirefen',
  'entities.items.mirefen_leather_shoulderguards.name': 'Garde-épaules en cuir de Mirefen',
  'entities.items.thornpeak_bulwark.name': 'Rempart de Thornpeak',
  'entities.items.thornpeak_crossbow.name': 'Arbalète de Thornpeak',
  'entities.items.thornpeak_mail_chest.name': 'Plastron en mailles de Thornpeak',
  'entities.items.thornpeak_mail_gauntlets.name': 'Gantelets en mailles de Thornpeak',
  'entities.items.thornpeak_mail_girdle.name': 'Ceinturon en mailles de Thornpeak',
  'entities.items.thornpeak_mail_helm.name': 'Heaume en mailles de Thornpeak',
  'entities.items.thornpeak_mail_legguards.name': 'Jambières en mailles de Thornpeak',
  'entities.items.thornpeak_mail_pauldrons.name': 'Espauliers en mailles de Thornpeak',
  'entities.items.thornpeak_mail_sabatons.name': 'Solerets en mailles de Thornpeak',
  'entities.items.thornpeak_polearm.name': "Arme d'hast de Thornpeak",
  'entities.items.thornpeak_war_axe.name': 'Hache de guerre de Thornpeak',
  ...
  'itemUi.lootRoll.needUnavailable':
    'L’option Besoin est indisponible, car votre classe ne peut pas équiper cet objet.',
  'itemUi.lootRoll.needUnavailablePower':
    'L’option Besoin est indisponible, car ce pouvoir légendaire est réservé à une autre classe.',
  'itemUi.procedural.advancedDetailsHint':
    'Maintenez {key} pour afficher les plages de jets possibles.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Chaque quatrième Trait de pénombre marque sa cible, qui subit des dégâts d’Ombre supplémentaires.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Sceau du Lieur de cendres',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Un sort de dégâts sur deux résonne autour de la cible.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Cloche du Neuvième Glas',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Parcourir 15 mètres confère une brève accélération de déplacement.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Bottes de la Route ininterrompue',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Chaque troisième Trait de braises brûle les ennemis proches de la cible.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Couronne du Dernier Bûcher',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Lumière guérisseuse protège son bénéficiaire avec un bouclier proportionnel aux soins.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Chevalière de l’Aube',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Chaque troisième Trait sauvage rend de la ressource principale.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Fermoir de Lune farouche',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Un coup d’arme sur trois fait saigner la cible et rend un peu de ressource.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Tranchant de Mâchoire-Grise',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Tir tendu ou Tir funeste peut brièvement réduire sa cible au silence.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Arc long du Bois-sourd',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Passer sous 35% de points de vie confère une brève protection défensive.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Mantelet des Heures volées',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Tuer un ennemi confère une brève accélération.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Croc de Verre nocturne',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Chaque quatrième Éclair d’arc se propage aux ennemis proches.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Idole de l’Éveil de la tempête',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Un soin critique crée brièvement une zone réparatrice au sol.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Veille d’Ysolei',
  'itemUi.procedural.legendaryLimit': 'Unique équipé : {count} pouvoir légendaire',
  'itemUi.procedural.legendaryPower': 'Pouvoir légendaire',
  'itemUi.procedural.nameFragment.deft': 'Habile',
  'itemUi.procedural.nameFragment.mighty': 'Puissant',
  'itemUi.procedural.nameFragment.of_alacrity': 'd’Alacrité',
  'itemUi.procedural.nameFragment.of_focus': 'de Focalisation',
  'itemUi.procedural.nameFragment.of_precision': 'de Précision',
  'itemUi.procedural.nameFragment.of_reaping': 'de Moisson',
  'itemUi.procedural.nameFragment.of_remembrance': 'du Souvenir',
  'itemUi.procedural.nameFragment.of_striking': 'de Frappe',
  'itemUi.procedural.nameFragment.sages': 'du Sage',
  'itemUi.procedural.nameFragment.spiritual': 'Spirituel',
  'itemUi.procedural.nameFragment.stalwart': 'Robuste',
  'itemUi.procedural.nameFragment.warded': 'Protégé',
  'itemUi.procedural.powerRollMilliseconds': 'Jet de pouvoir : {value} ms',
  'itemUi.procedural.powerRollNumber': 'Jet de pouvoir : {value}',
  'itemUi.procedural.powerRollPercent': 'Jet de pouvoir : {value}%',
  'itemUi.procedural.powerRollResource': 'Jet de pouvoir : {value} de ressource',
  'itemUi.procedural.rareWord.ashen': 'Cendré',
  'itemUi.procedural.rareWord.bite': 'Morsure',
  'itemUi.procedural.rareWord.blackfen': 'Marais-Noir',
  'itemUi.procedural.rareWord.brand': 'Marque',
  'itemUi.procedural.rareWord.doom': 'Fléau',
  'itemUi.procedural.rareWord.grave': 'Tombe',
  'itemUi.procedural.rareWord.mire': 'Bourbe',
  'itemUi.procedural.rareWord.oath': 'Serment',
  'itemUi.procedural.rareWord.promise': 'Promesse',
  'itemUi.procedural.rareWord.storm': 'Tempête',
  'itemUi.procedural.rareWord.thorn': 'Épine',
  'itemUi.procedural.rareWord.thread': 'Fil',
  'itemUi.procedural.rareWord.vigil': 'Veille',
  'itemUi.procedural.rareWord.ward': 'Protection',
  'itemUi.procedural.rareWord.whisper': 'Murmure',
  'itemUi.procedural.rareWord.wyrm': 'Wyrm',
  'itemUi.procedural.rarity.common': 'Commun',
  'itemUi.procedural.rarity.epic': 'Épique',
  'itemUi.procedural.rarity.legendary': 'Légendaire',
  'itemUi.procedural.rarity.magic': 'Magique',
  'itemUi.procedural.rarity.mythic': 'Mythique',
  'itemUi.procedural.rarity.rare': 'Rare',
  'itemUi.procedural.rollRangeAria': 'Jet possible de {min} à {max}',
  'itemUi.stats.blockValue': 'Valeur de blocage',
  'itemUi.stats.healthOnKill': 'Points de vie par victime',
  'itemUi.stats.manaOnKill': 'Mana par victime',
  'itemUi.stats.weaponDps': 'Dégâts d’arme par seconde',
  'itemUi.stats.weaponMax': 'Dégâts d’arme maximum',
  'itemUi.stats.weaponMin': 'Dégâts d’arme minimum',
};
