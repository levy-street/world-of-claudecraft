...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.basic_mining_pick.name': 'Pioche de mineur basique',
  'entities.items.basic_logging_axe.name': 'Hache de bûcheron basique',
  'entities.items.basic_herbalists_sickle.name': "Faucille d'herboriste basique",
