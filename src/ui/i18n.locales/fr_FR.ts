...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.dune_prowler_pelt.name': 'Peau de rôdeur des dunes',
  'entities.items.glasswind_stinger.name': 'Dard de vent de verre',
  'entities.items.stolen_relic.name': 'Relique volée',
  'entities.items.nameless_burial_shroud.name': 'Linceul funéraire sans nom',
  'entities.items.storm_glass_core.name': "Cœur de verre d'orage",
  'entities.items.verdict_seal.name': 'Sceau de verdict',
  'entities.items.glasswind_husk.name': 'Carapace de vent de verre',
  'entities.items.mirage_stalker_eye.name': 'Œil de traqueur des mirages',
  'entities.items.dig_manifest.name': 'Manifeste de fouille',
  'entities.items.tomb_censer.name': 'Encensoir de tombeau',
  'entities.items.sentence_tablet.name': 'Tablette de sentence',
  'entities.items.duststorm_heart.name': 'Cœur de tempête de poussière',
  'entities.items.ravager_hide.name': 'Peau de ravageur',
  'entities.items.aqueduct_bronze.name': "Raccord de bronze de l'aqueduc",
  'entities.items.judge_regalia.name': 'Ornements de la Première Cour',
  'entities.items.sunbleached_fang.name': 'Croc blanchi au soleil',
  'entities.items.cracked_scarab_shell.name': 'Carapace de scarabée fendue',
  'entities.items.emberjaw_pelt.name': 'Peau de la matriarche Mâchoire-Braise',
  'entities.items.karns_funeral_mask.name': 'Masque funéraire de Karn',
  'entities.items.qesh_flatbread.name': 'Galette de Qesh',
  'entities.items.oasis_waterskin.name': "Outre de l'oasis",
  'entities.items.spiced_scarab_skewer.name': 'Brochette de scarabée épicée',
  'entities.items.duneweave_robe.name': 'Robe de tissage des dunes',
  'entities.items.caravan_guard_hauberk.name': 'Haubert de garde de caravane',
  'entities.items.prowlerhide_vest.name': 'Gilet en peau de rôdeur',
  'entities.items.sandwalker_treads.name': 'Chausses du marcheur des sables',
  'entities.items.dunewatch_legguards.name': 'Jambières du guet des dunes',
  'entities.items.qesh_khopesh.name': 'Khopesh de Qesh',
  'entities.items.judgestaff_of_ossara.name': "Bâton de juge d'Ossara",
  'entities.items.glasswind_talon.name': 'Serre de vent de verre',
  'entities.items.emberjaw_prowlgrips.name': 'Poignes de chasse de Mâchoire-Braise',
  'entities.items.unburied_gravewraps.name': "Bandages sépulcraux de l'Inhumé",
  'entities.items.sandmaw_scale_cuirass.name': "Cuirasse d'écailles de Gueule-des-Sables",
  'entities.items.tyrantfang_edge.name': 'Lame Croc-de-Tyran',
  'entities.items.palewidow_silk.name': 'Soie de veuve pâle',
  'entities.items.waterlogged_ledger.name': 'Registre détrempé',
  'entities.items.guildless_sigil.name': 'Cachet des sans-guilde',
  'entities.items.silent_court_seal.name': 'Sceau de la Cour silencieuse',
  'entities.items.duskmane_pelt_strip.name': 'Bande de peau de crinière-crépuscule',
  'entities.items.palewidow_venom_sac.name': 'Poche à venin de veuve pâle',
  'entities.items.quay_manifest.name': 'Manifeste détrempé du quai',
  'entities.items.wisplight_essence.name': 'Essence de feu follet',
  'entities.items.drowned_toll_coin.name': 'Pièce de péage noyée',
  'entities.items.cutthroat_contract.name': 'Contrat de coupe-jarret',
  'entities.items.court_ledger_page.name': 'Page du registre de la Cour',
  'entities.items.frostpine_war_totem.name': 'Totem de guerre de Pin-Givre',
  'entities.items.rimeclaw_pelt.name': 'Peau de griffe-de-givre',
  'entities.items.duskmane_tuft.name': 'Touffe de crinière-crépuscule',
  'entities.items.guttering_wisp_mote.name': 'Particule de follet vacillant',
  'entities.items.frostpine_charm.name': 'Charme de Pin-Givre',
  'entities.items.palefang_pelt.name': 'Peau de Croc-Pâle le Silencieux',
  'entities.items.grelnoks_frozen_idol.name': 'Idole gelée de Grelnok',
  'entities.items.nighthollow_black_bread.name': 'Pain noir de Combenuit',
  'entities.items.pinefrost_tea.name': 'Thé de givre des pins',
  'entities.items.smoked_blackmere_eel.name': 'Anguille fumée du Lac Noir',
  'entities.items.wispweave_robe.name': 'Robe de tissage de follet',
  'entities.items.quayguard_hauberk.name': 'Haubert de garde des quais',
  'entities.items.duskstalker_vest.name': 'Gilet de traqueur du crépuscule',
  'entities.items.nightpath_treads.name': 'Chausses du sentier nocturne',
  'entities.items.blackriver_legguards.name': 'Jambières de la Rivière Noire',
  'entities.items.terracewatch_leggings.name': 'Jambières du guet des terrasses',
  'entities.items.quays_cutlass.name': 'Coutelas des quais',
  'entities.items.wispcaller_staff.name': 'Bâton du mande-follets',
  'entities.items.whispersteel_stiletto.name': "Stylet d'acier murmurant",
  'entities.items.palefang_grips.name': 'Poignes de Croc-Pâle',
  'entities.items.hoarbound_bindings.name': 'Liens du Givre-Lié',
  'entities.items.forsworn_lamellar.name': 'Cuirasse lamellaire du Parjure',
  'entities.items.forsworn_edge.name': 'Lame du Parjure',
  'entities.items.stolen_tithe_ledger.name': 'Registre de dîme volé',
  'entities.items.granite_core_shard.name': 'Éclat de cœur de granit',
  'entities.items.legion_deserter_insignia.name': 'Insigne de déserteur de la Légion',
  'entities.items.chewed_tithe_scrip.name': 'Bon de dîme mâché',
  'entities.items.candle_tax_tally.name': 'Registre de la taxe des chandelles',
  'entities.items.assay_office_seal.name': "Sceau du bureau d'essai",
  'entities.items.legion_pay_manifest.name': 'Manifeste de solde de la Légion',
  'entities.items.prime_wolf_pelt.name': 'Peau de loup de premier choix',
  'entities.items.wendigo_gallstone.name': 'Calcul biliaire de wendigo',
  'entities.items.icehowler_ruff.name': 'Collerette de hurleur des glaces',
  'entities.items.legion_quarrel_bundle.name': 'Fagot de carreaux de la Légion',
  'entities.items.clipped_imperial_coin.name': 'Pièce impériale rognée',
  'entities.items.rimewoven_hide.name': 'Peau tissée de givre',
  'entities.items.sellsword_pig_iron.name': 'Fonte de mercenaire',
  'entities.items.lean_wolf_haunch.name': 'Cuissot de loup maigre',
  'entities.items.pilfered_ration_pack.name': 'Paquet de rations dérobé',
  'entities.items.sellsword_requisition_chit.name': 'Bon de réquisition de mercenaire',
  'entities.items.frostbrush_wolf_fang.name': 'Croc de loup de Brosse-Givre',
  'entities.items.bent_legion_buckle.name': 'Boucle tordue de la Légion',
  'entities.items.ogre_knuckle_dice.name': "Dés en phalange d'ogre",
  'entities.items.hoarfang_pelt.name': "Peau de l'alpha Croc-de-Givre",
  'entities.items.kazriks_brass_whistle.name': 'Sifflet en laiton de Kazrik',
  'entities.items.kaelspire_barley_loaf.name': "Miche d'orge de Flèche-de-Kael",
  'entities.items.silverbrook_spring_water.name': "Eau de source de Ruisseau-d'Argent",
  'entities.items.imperial_field_ration.name': 'Ration impériale de campagne',
  'entities.items.imperial_clerks_robe.name': 'Robe de clerc impérial',
  'entities.items.kael_infantry_hauberk.name': "Haubert d'infanterie de Kael",
  'entities.items.wolfsward_hunting_jerkin.name': 'Justaucorps de chasse de Garde-Loups',
  'entities.items.tithe_road_marchboots.name': 'Bottes de marche de la Route de la Dîme',
  'entities.items.imperial_marcher_legguards.name': 'Jambières de marcheur impérial',
  'entities.items.kael_arming_sword.name': "Épée d'armes de Kael",
  'entities.items.frosthelm_warstaff.name': 'Bâton de guerre de Heaume-de-Givre',
  'entities.items.wolfsward_skinner.name': 'Écorcheur de Garde-Loups',
  'entities.items.prefects_sealed_mantle.name': 'Mante scellée du préfet',
  'entities.items.huntmasters_winter_hood.name': "Capuche d'hiver du maître de chasse",
  'entities.items.hoarfang_clawgrips.name': 'Poignes à griffes de Croc-de-Givre',
  'entities.items.overseers_candlewraps.name': 'Bandages de chandelles du contremaître',
  'entities.items.oathbreakers_battleplate.name': 'Plastron de bataille du Brise-Serment',
  'entities.items.oathbreakers_greatblade.name': 'Espadon du Brise-Serment',
  'entities.items.grey_shale_chip.name': 'Éclat de schiste gris',
  'entities.items.smuggled_trinket.name': 'Babiole de contrebande',
  'entities.items.barbed_thorn_husk.name': "Cosse d'épines barbelées",
  'entities.items.thornfen_tusk.name': 'Défense de troll de Fange-aux-Épines',
  'entities.items.torn_caravan_banner.name': 'Bannière de caravane déchirée',
  'entities.items.ironpass_rubble_core.name': 'Cœur de gravats du Pas-de-Fer',
  'entities.items.wyvern_tail_barb.name': 'Ardillon de queue de wyverne',
  'entities.items.reagent_gland.name': 'Glande gorgée de réactifs',
  'entities.items.fogged_lantern_glass.name': 'Verre de lanterne embué',
  'entities.items.river_worn_idol.name': 'Idole polie par la rivière',
  'entities.items.gull_picked_bone.name': 'Os picoré par les goélands',
  'entities.items.underway_hardtack.name': 'Biscuit du Passage-Dessous',
  'entities.items.smugglers_black_brew.name': 'Breuvage noir de contrebandier',
  'entities.items.thornberry_loaf.name': "Miche aux baies d'épines",
  'entities.items.palisade_pine_tea.name': 'Thé de pin de la Palissade',
  'entities.items.tollhouse_stew.name': 'Ragoût de la Maison de Péage',
  'entities.items.ironpass_mulled_cider.name': 'Cidre chaud du Pas-de-Fer',
  'entities.items.lanternfen_eel_skewer.name': "Brochette d'anguille de Fagne-Lanterne",
  'entities.items.fogberry_tonic.name': 'Tonique aux baies de brume',
  'entities.items.bridgewatch_rations.name': 'Rations du Guet-du-Pont',
  'entities.items.nameless_river_water.name': 'Eau de la rivière sans nom',
  'entities.items.smuggler_kings_softsteps.name': 'Pas-feutrés du Roi Contrebandier',
  'entities.items.briarfather_bark_mitts.name': "Mitaines d'écorce du Père des Ronces",
  'entities.items.skarns_war_harness.name': 'Harnais de guerre de Skarn',
  'entities.items.colossus_mireheart_girdle.name': 'Ceinturon Cœur-de-Fange',
  'entities.items.bridgekeepers_tollstaff.name': 'Bâton de péage du Gardien du Pont',
  'entities.items.melted_ration_tin.name': 'Boîte de rations fondue',
  'entities.items.ashcaked_fang.name': 'Croc encroûté de cendre',
  'entities.items.ember_glass_shard.name': 'Éclat de verre de braise',
  'entities.items.saltglass_shard.name': 'Éclat de verre de sel',
  'entities.items.salt_crusted_chitin.name': 'Chitine encroûtée de sel',
  'entities.items.bleached_bone_charm.name': "Charme d'os blanchi",
  'entities.items.tarnished_prewar_coin.name': "Pièce ternie d'avant-guerre",
  'entities.items.sewer_silk_wad.name': "Écheveau de soie d'égout",
  'entities.items.gutter_hound_pelt.name': 'Peau de molosse des ruisseaux',
  'entities.items.cracked_salamander_scale.name': 'Écaille de salamandre fendue',
  'entities.items.cooled_magma_bead.name': 'Perle de magma refroidi',
  'entities.items.slag_nugget.name': 'Pépite de scorie',
  'entities.items.rusted_deserter_badge.name': 'Insigne rouillé de déserteur',
  'entities.items.redspire_rock_shard.name': 'Éclat de roche de Flèche-Rouge',
  'entities.items.spire_stalker_claw.name': 'Griffe de traqueur des flèches',
  'entities.items.cinderrest_ashcake.name': 'Galette de cendre de Repos-des-Braises',
  'entities.items.boiled_cistern_water.name': 'Eau de citerne bouillie',
  'entities.items.brinehollow_salt_jerky.name': 'Viande séchée salée de Creux-Saumure',
  'entities.items.desalted_waterskin.name': "Outre d'eau dessalée",
  'entities.items.gutter_stew.name': "Ragoût des ruisseaux du Marché de l'Exil",
  'entities.items.black_market_tea.name': 'Thé de marché noir',
  'entities.items.forgefall_hardtack.name': 'Biscuit de Chute-de-Forge',
  'entities.items.coalfire_stout.name': 'Bière noire au feu de charbon',
  'entities.items.waymeet_marching_bread.name': 'Pain de marche du Dernier-Relais',
  'entities.items.bitterroot_brew.name': 'Breuvage de racine amère',
  'entities.items.revenant_cinderguard.name': 'Garde-cendres du revenant',
  'entities.items.marrowhide_leggings.name': 'Jambières en peau de moelle',
  'entities.items.scavenger_kings_shiv.name': 'Surin du Roi des Charognards',
  'entities.items.forgewyrm_scale_helm.name': "Heaume d'écailles du ver de forge",
  'entities.items.mantle_of_the_last_muster.name': 'Mante de la Dernière Levée',
  'entities.items.scorched_banner_scrap.name': 'Lambeau de bannière calcinée',
  'entities.items.melted_signet_ring.name': 'Chevalière fondue',
  'entities.items.cracked_horror_horn.name': "Corne d'horreur fendue",
  'entities.items.bastion_hardtack.name': 'Biscuit du Bastion',
  'entities.items.trucewater_flask.name': "Flasque d'eau de trêve",
  'entities.items.ashguard_robe.name': 'Robe garde-cendres',
  'entities.items.breachwalker_jerkin.name': 'Justaucorps du marcheur de la Brèche',
  'entities.items.bastion_plated_hauberk.name': 'Haubert plaqué du Bastion',
  'entities.items.bastion_arming_sword.name': "Épée d'armes du Bastion",
  'entities.items.mercenary_greatblade.name': 'Espadon de mercenaire',
  'entities.items.tithe_collectors_grasps.name': 'Poignes du collecteur de dîme',
  'entities.items.craterheart_mantle.name': 'Mante Cœur-de-Cratère',
  'entities.items.butchers_chainguard.name': 'Cotte du Boucher',
  'entities.items.vhorlans_flensing_blade.name': 'Lame à dépecer de Vhorlan',
  ...
  'entities.items.forged_levy_papers.name': 'Papiers de levée falsifiés',
  'entities.items.amnesty_petition.name': "Pétition d'amnistie non classée",
  'entities.items.fort_pattern_kettle.name': 'Bouilloire réglementaire du fort',
  'entities.items.garnished_pay_pouch.name': 'Bourse de paie saisie',
  'entities.items.fault_line_core.name': 'Noyau de faille',
  'entities.items.unstamped_duel_permit.name': 'Permis de duel non tamponné',
  'entities.items.rimeclaw_tallow.name': 'Suif de griffegivre',
  'entities.items.rimeclaw_marrowbone.name': 'Os à moelle de griffegivre',
  'entities.items.oathguard_plate_scrap.name': 'Fragment de plaque du Garde-serment',
  'entities.items.ninth_muster_roll.name': "Rôle d'appel récupéré",
  'entities.items.icehowler_haunch.name': 'Cuissot de hurleur des glaces',
  'entities.items.rimebound_core_ice.name': 'Glace de cœur givrelié',
  'entities.items.glacial_quench_ice.name': 'Glace de trempe glaciaire',
  'entities.items.maren_calling_card.name': 'Carte de visite de la Maison Maren',
  'entities.items.maldreks_route_ledger.name': 'Registre des routes de Maldrek',
  'entities.items.grulks_iron_strongbox.name': 'Coffre-fort de Grulk',
  'entities.items.maren_duelling_mantle.name': 'Mantelet de duel Maren',
  'entities.items.final_notice_wraps.name': 'Bandages du dernier avis',
  'entities.items.pay_wardens_shoulderguards.name': 'Épaulières du gardien des paies',
  'entities.items.rimeshaft_foremans_cap.name': 'Casquette du contremaître de Rimeshaft',
  'entities.items.quarter_close_vestments.name': 'Vêtements de clôture de trimestre',
  'entities.items.assessors_lead_greaves.name': "Jambières de plomb de l'assesseur",
  'entities.items.purse_wardens_coinbelt.name': 'Ceinture à monnaie du gardien des bourses',
  'entities.items.mothwing_dust.name': "Poussière d'aile de phalène",
  'entities.items.silt_eel.name': 'Anguille de vase',
  'entities.items.barge_chit.name': 'Jeton de barge détrempé',
  'entities.items.ferry_lantern_mote.name': 'Lueur de lanterne du bac',
  'entities.items.smugglers_tally_knot.name': 'Nœud de compte du contrebandier',
  'entities.items.forged_weir_pass.name': 'Laissez-passer de barrage falsifié',
  'entities.items.sunken_ration_tin.name': 'Boîte de rations engloutie',
  'entities.items.hollow_toll_scrip.name': 'Scrip de péage creux',
  'entities.items.rimeclaw_haunch.name': 'Cuissot de griffegivre',
  'entities.items.rimebound_fetish.name': 'Fétiche givrelié',
  'entities.items.frostpine_tallow.name': 'Suif de pin givré',
  'entities.items.forsworn_oath_knife.name': 'Couteau de serment Parjure',
  'entities.items.shadowbound_cipher.name': 'Chiffre lié aux ombres',
  'entities.items.vessiks_little_book.name': 'Petit livre de Vessik',
  'entities.items.weirwatch_wraps.name': 'Bandages de la Garde du barrage',
  'entities.items.lodgewalk_boots.name': 'Bottes de la Loge',
  'entities.items.unbroken_wardstone.name': 'Pierre de garde intacte',
  'entities.items.vault_ward_core.name': 'Cœur de garde du caveau',
  'entities.items.temple_offering_bowl.name': "Bol d'offrandes du temple",
  'entities.items.graven_name_stone.name': 'Pierre aux noms gravée',
  'entities.items.stalker_haunch.name': 'Cuissot de rôdeur',
  'entities.items.heretic_creed_page.name': 'Page de credo brûlée',
  'entities.items.heretic_brand_iron.name': 'Fer à marquer hérétique',
  'entities.items.heretic_writ.name': 'Écrit hérétique',
  'entities.items.first_court_sigil.name': 'Sceau de la Première Cour',
  'entities.items.duneglass_heart.name': 'Cœur de verre des dunes',
  'entities.items.unshattered_fulgurite.name': 'Fulgurite intacte',
  'entities.items.flameseer_ash_creed.name': 'Tablette du Credo des Cendres',
  'entities.items.flameseer_ember_phial.name': 'Fiole de braises',
  'entities.items.dawnward_censer.name': "Encensoir de l'Aube",
  'entities.items.stolen_water_cask.name': "Tonnelet d'eau scellé",
  'entities.items.duskwater_oathmark.name': 'Marque de serment de Crépuseau',
  'entities.items.caravan_toll_tally.name': 'Taille de péage scellée',
  'entities.items.tyrant_spoor.name': 'Moulage de piste du Tyran',
  'entities.items.oxbone_toll.name': 'Taille de péage en os de bœuf',
  'entities.items.cartographers_map.name': 'La carte du Premier Cartographe',
  'entities.items.templestone_shard.name': 'Éclat de pierre du temple',
  'entities.items.fulgurite_splinter.name': 'Écharde de fulgurite',
  'entities.items.charred_censer_chain.name': "Chaîne d'encensoir calcinée",
  'entities.items.wardens_stone_heart.name': "Cœur de pierre d'Ashkerat",
  'entities.items.first_meridian_compass.name': 'Boussole du Premier Méridien',
  'entities.items.seatstone_flatbread.name': 'Galette du Siège',
  'entities.items.seatwell_waterskin.name': 'Outre du puits du Siège',
  'entities.items.lastwater_jerky.name': 'Viande séchée de Dernière Eau',
  'entities.items.lastwater_skin.name': 'Outre de Dernière Eau',
  'entities.items.vaultkeepers_handwraps.name': 'Manchons du gardien du caveau',
  'entities.items.sahrs_penitent_leggings.name': 'Jambières pénitentes de Sahr',
  'entities.items.wardens_granite_edge.name': 'Tranchant de granit du Gardien',
  'entities.items.staff_of_the_sunken_court.name': 'Bâton de la Cour Engloutie',
  'entities.items.duneglass_shiv.name': 'Surin de verre des dunes',
  'entities.items.lastwater_roadmail.name': 'Mailles de route de Dernière Eau',
  'entities.items.duskwatch_robe.name': 'Robe du Guet du Crépuscule',
  'entities.items.raiders_dust_jerkin.name': 'Justaucorps poussiéreux de pillard',
  'entities.items.ashkerat_greaves.name': "Grèves d'Ashkerat",
  'entities.items.cartographers_windwraps.name': 'Bandages de vent du Cartographe',
  'entities.items.unlit_silk_gland.name': 'Glande de soie sans lumière',
  'entities.items.veskals_fang.name': 'Croc de Veskal',
  'entities.items.broodmother_carapace_guard.name': 'Garde de carapace de la Mère de couvée',
  'entities.items.condensed_mist_heart.name': 'Cœur de brume condensée',
  'entities.items.mistfathers_knot.name': 'Le nœud du Père des Brumes',
  'entities.items.fogwalker_treads.name': 'Chaussons du marche-brume',
