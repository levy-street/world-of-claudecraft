...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.mobile.customize": "Personnaliser",
  "hudChrome.mobile.customizeTitle": "Personnaliser les commandes",
  "hudChrome.mobile.customizeSlotAttack": "Attaque de base",
  "hudChrome.mobile.customizeSlotSkill": "Compétence {n}",
  "hudChrome.mobile.customizeSlotUtility": "Utilitaire",
  "hudChrome.mobile.customizeDefault": "Défaut de classe",
  "hudChrome.mobile.customizeResetSlot": "Réinitialiser cet emplacement",
  "hudChrome.mobile.customizeResetAll": "Tout réinitialiser aux défauts de classe",
  "hudChrome.mobile.customizeUpdated": "{slot} mis à jour.",
  "hudChrome.mobile.customizeAllReset": "Commandes réinitialisées aux défauts de classe.",
  "hudChrome.options.touchControls": "Commandes tactiles",
  "hudChrome.options.clusterHold": "Délai de maintien pour éditer",
  "hudChrome.options.clusterHoldNote": "Durée de maintien d’un bouton d’action à l’écran avant l’ouverture de l’éditeur d’assignation. Augmentez-la si vous ouvrez l’éditeur en enchaînant les compétences.",
  "hudChrome.options.targetPriority": "Priorité de cible d’attaque",
  "hudChrome.options.targetPriorityNearest": "Le plus proche",
  "hudChrome.options.targetPriorityLowestHp": "Vie la plus faible",
  "hudChrome.options.targetPriorityCurrent": "Cible actuelle d’abord",
  "hudChrome.options.targetPriorityNote": "Ce que le bouton Attaque cible quand vous n’avez aucune cible valide : l’ennemi le plus proche, l’ennemi à la plus faible vie à portée, ou conservez votre cible actuelle tant qu’elle reste valide.",
  "hudChrome.options.aimAssist": "Lancement intelligent",
  "hudChrome.options.aimAssistNote": "Appuyez sur une compétence offensive pour la lancer sur votre cible, ou sur le meilleur ennemi à proximité si vous n’en avez pas, en vous tournant vers lui. Maintenez le bouton pour prévisualiser la portée; relâchez le doigt hors du bouton pour annuler.",
  "hudChrome.options.touchReset": "Réinitialiser les commandes tactiles",
  "hudChrome.options.touchResetDone": "Commandes tactiles rétablies aux valeurs par défaut.",
