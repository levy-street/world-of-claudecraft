...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.boundstone_bulwark.name': 'Rempart de pierre liée',
  'entities.items.drownedmoon_aegis.name': 'Égide de la Lune noyée',
  'entities.items.gravewyrm_bulwark.name': 'Rempart du wyrm sépulcral',
