...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.crafting.close': "Fermer l’artisanat",
  'hudChrome.crafting.craft': "Fabriquer",
  'hudChrome.crafting.craftedToast': "Fabriqué: {name}",
  'hudChrome.crafting.empty': "Aucune recette connue pour le moment.",
  'hudChrome.crafting.insufficientMaterials': "Vous n’avez pas les matériaux nécessaires.",
  'hudChrome.crafting.reagentLine': "{name} x{have}/{required}",
  'hudChrome.crafting.reagentsNeeded': "Requiert:",
  'hudChrome.crafting.resultAria': "Fabriquer {name}",
  ...
  'hudChrome.mobile.actionPageToggle': "Changer de page d’actions",
  'hudChrome.mobile.actionRing': "Actions de combat",
  'hudChrome.mobile.spellbookPageLabel': "Page {page}",
  'hudChrome.mobile.targetCycle': "Changer de cible",
  'hudChrome.mobile.targetCycleShort': "Cible",
  'hudChrome.options.mobileCameraJoystick': "Joystick de caméra",
