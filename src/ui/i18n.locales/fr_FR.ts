...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.readyCheck.start': "Verification de preparation",
  'hudChrome.readyCheck.startAria': "Lancer la verification de preparation",
  'hudChrome.readyCheck.ready': "Pret",
  'hudChrome.readyCheck.notReady': "Pas pret",
  'hudChrome.readyCheck.waiting': "En attente",
  'hudChrome.readyCheck.status': "{ready}/{total} prets",
