...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Sandales marchecendre',
  'entities.items.cinderarc_odrenns_rod.name': 'Arc-de-braise, bâton d’Odrenn',
  'entities.items.cindertoad_signet.name': 'Chevalière crapaud-de-braise',
  'entities.items.coalglow_band.name': 'Anneau lueur-de-charbon',
  'entities.items.crownforged_warleggings.name': 'Jambières de guerre Forgécouronne',
  'entities.items.glassblowers_shiv.name': 'Surin du souffleur de verre',
  'entities.items.glasswalker_treads.name': 'Bottines marcheverre',
  'entities.items.nighttalon_prowlers.name': 'Bottines de rôdeur Serre-de-nuit',
  'entities.items.quenchsilk_cord.name': 'Cordon de soie trempée',
  'entities.items.ring_of_the_first_quench.name': 'Anneau de la première trempe',
  'entities.items.saans_stoking_iron.name': 'Tisonnier de Saan',
  'entities.items.slag_tempered_sabatons.name': 'Solerets trempés dans le laitier',
  'entities.items.slakeleather_belt.name': 'Ceinture en cuir trempé',
  'entities.items.sluicebearer.name': 'Porte-écluse',
  'entities.items.soulflame_kilt.name': "Kilt Flamme-d'âme",
  'entities.items.stokebrand_striders.name': 'Bottines marque-braise',
  'entities.items.stormcallers_legwraps.name': "Bandelettes d'Appel-tempête",
  'entities.items.the_even_temper.name': 'Le Tempérament égal',
  'entities.items.twice_fired_slippers.name': 'Mules cuites deux fois',
  'entities.items.twicetempered_girdle.name': 'Ceinturon à double trempe',
