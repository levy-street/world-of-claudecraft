...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.itemAriaProcedural': '{item}、{rarity}、アイテムレベル {level}、数量 {count}',
  'hudChrome.bags.itemAriaProceduralMasterwork':
    '{item}、{rarity}、アイテムレベル {level}、数量 {count}、傑作',
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}、{rarity}、アイテムレベル {level}、数量 {count}、エンチャント済み',
  'hudChrome.bags.itemAriaProceduralSigned':
    '{item}、{rarity}、アイテムレベル {level}、数量 {count}、製作者の署名入り',
  'hudChrome.bags.itemAriaProceduralBound':
    '{item}、{rarity}、アイテムレベル {level}、数量 {count}、帰属済み',
  'itemUi.stats.weaponMin': '武器の最小ダメージ',
  'itemUi.stats.weaponMax': '武器の最大ダメージ',
  'itemUi.stats.weaponDps': '武器の秒間ダメージ',
  'itemUi.stats.healthOnKill': '撃破時に体力回復',
  'itemUi.stats.manaOnKill': '撃破時にマナ回復',
  'itemUi.stats.blockValue': 'ブロック値',
  'itemUi.procedural.rollRangeAria': '変動範囲：{min}から{max}',
  'itemUi.procedural.advancedDetailsHint': '{key} を押している間、変動範囲を表示します。',
  'itemUi.procedural.powerRollPercent': 'パワーの変動値：{value}%',
  'itemUi.procedural.powerRollMilliseconds': 'パワーの変動値：{value} ms',
  'itemUi.procedural.powerRollResource': 'パワーの変動値：{value} リソース',
  'itemUi.procedural.powerRollNumber': 'パワーの変動値：{value}',
  'itemUi.procedural.legendaryPower': 'レジェンダリーパワー',
  'itemUi.procedural.legendaryLimit': 'ユニーク装備：レジェンダリーパワー {count} 個',
  'itemUi.procedural.rarity.common': 'コモン',
  'itemUi.procedural.rarity.magic': 'マジック',
  'itemUi.procedural.rarity.rare': 'レア',
  'itemUi.procedural.rarity.epic': 'エピック',
  'itemUi.procedural.rarity.legendary': 'レジェンダリー',
  'itemUi.procedural.rarity.mythic': 'ミシック',
  'itemUi.procedural.nameFragment.mighty': '強力な',
  'itemUi.procedural.nameFragment.deft': '巧みな',
  'itemUi.procedural.nameFragment.stalwart': '堅牢な',
  'itemUi.procedural.nameFragment.sages': '賢者の',
  'itemUi.procedural.nameFragment.spiritual': '霊妙な',
  'itemUi.procedural.nameFragment.of_focus': '集中',
  'itemUi.procedural.nameFragment.of_striking': '強打',
  'itemUi.procedural.nameFragment.of_alacrity': '迅速',
  'itemUi.procedural.nameFragment.of_precision': '精密',
  'itemUi.procedural.nameFragment.warded': '守護された',
  'itemUi.procedural.nameFragment.of_reaping': '刈り取り',
  'itemUi.procedural.nameFragment.of_remembrance': '追憶',
  'itemUi.procedural.rareWord.ashen': '灰燼',
  'itemUi.procedural.rareWord.blackfen': '黒沼',
  'itemUi.procedural.rareWord.doom': '破滅',
  'itemUi.procedural.rareWord.grave': '墓',
  'itemUi.procedural.rareWord.mire': '沼',
  'itemUi.procedural.rareWord.storm': '嵐',
  'itemUi.procedural.rareWord.thorn': '棘',
  'itemUi.procedural.rareWord.wyrm': '竜',
  'itemUi.procedural.rareWord.bite': '牙痕',
  'itemUi.procedural.rareWord.brand': '烙印',
  'itemUi.procedural.rareWord.promise': '約束',
  'itemUi.procedural.rareWord.thread': '糸',
  'itemUi.procedural.rareWord.vigil': '見張り',
  'itemUi.procedural.rareWord.ward': '護符',
  'itemUi.procedural.rareWord.whisper': '囁き',
  'itemUi.procedural.rareWord.oath': '誓い',
  'itemUi.procedural.legendary.crown_last_pyre.name': '最後の葬火の冠',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'ファイアボールを3回使用するごとに、対象の周囲の敵を焼きます。',
  'itemUi.procedural.legendary.greyjaws_edge.name': '灰顎の刃',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    '武器攻撃が3回命中するごとに、対象を出血させ、主リソースを少量回復します。',
  'itemUi.procedural.legendary.hushwood_longbow.name': '静寂の森の長弓',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'エイムショットまたはアーケインショットは、対象を短時間沈黙させることがあります。',
  'itemUi.procedural.legendary.nightglass_fang.name': '夜硝子の牙',
  'itemUi.procedural.legendary.nightglass_fang.description':
    '敵を倒すと、短時間ヘイストが上昇します。',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'イソレイの見張り',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'クリティカル回復が発生すると、短時間持続する回復エリアを作り出します。',
  'itemUi.procedural.legendary.stormwake_idol.name': '嵐呼びの偶像',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'ライトニングボルトを4回使用するごとに、近くの敵へ連鎖します。',
  'itemUi.procedural.legendary.ashbinders_seal.name': '灰縛りの印章',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'シャドウボルトを4回使用するごとに対象へ印を付け、追加の暗黒ダメージを与えます。',
  'itemUi.procedural.legendary.dawnward_signet.name': '暁守りの印章',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'ホーリーライトは、回復量の一部に相当するシールドを対象に付与します。',
  'itemUi.procedural.legendary.feral_moonclasp.name': '野生の月留め',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'ムーンファイアを3回使用するごとに、主リソースを回復します。',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': '九度目の鐘',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'ダメージ呪文を2回使うごとに、対象の周囲で鐘が鳴ります。',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': '奪われた時のマント',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    '体力が35%未満になると、短時間持続する防護の結界を得ます。',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': '果てなき道のブーツ',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    '15ヤード移動すると、移動速度が短時間上昇します。',
  'entities.items.ashwood_staff.name': 'トネリコの杖',
  'entities.items.gravecaller_cloth_handwraps.name': '墓呼びの布手袋',
  'entities.items.gravecaller_cloth_hood.name': '墓呼びの布頭巾',
  'entities.items.gravecaller_cloth_leggings.name': '墓呼びの布脚衣',
  'entities.items.gravecaller_cloth_mantle.name': '墓呼びの布肩衣',
  'entities.items.gravecaller_cloth_raiment.name': '墓呼びの布装束',
  'entities.items.gravecaller_cloth_sash.name': '墓呼びの布帯',
  'entities.items.gravecaller_cloth_slippers.name': '墓呼びの布靴',
  'entities.items.gravecaller_focus.name': '墓呼びの焦点具',
  'entities.items.gravecaller_pendant.name': '墓呼びの首飾り',
  'entities.items.gravecaller_ring.name': '墓呼びの指輪',
  'entities.items.gravecaller_wand.name': '墓呼びの魔杖',
  'entities.items.iron_broadsword.name': '鉄の大剣',
  'entities.items.iron_flanged_mace.name': '鉄のフランジメイス',
  'entities.items.mirefen_dirk.name': '泥沼の短剣',
  'entities.items.mirefen_hunting_bow.name': '泥沼の狩猟弓',
  'entities.items.mirefen_leather_belt.name': '泥沼の革帯',
  'entities.items.mirefen_leather_boots.name': '泥沼の革ブーツ',
  'entities.items.mirefen_leather_gloves.name': '泥沼の革手袋',
  'entities.items.mirefen_leather_hood.name': '泥沼の革頭巾',
  'entities.items.mirefen_leather_jerkin.name': '泥沼の革胴衣',
  'entities.items.mirefen_leather_leggings.name': '泥沼の革脚衣',
  'entities.items.mirefen_leather_shoulderguards.name': '泥沼の革肩当て',
  'entities.items.thornpeak_bulwark.name': '茨峰の防壁',
  'entities.items.thornpeak_crossbow.name': '茨峰のクロスボウ',
  'entities.items.thornpeak_mail_chest.name': '茨峰の鎖帷子',
  'entities.items.thornpeak_mail_gauntlets.name': '茨峰の鎖籠手',
  'entities.items.thornpeak_mail_girdle.name': '茨峰の鎖帯',
  'entities.items.thornpeak_mail_helm.name': '茨峰の鎖兜',
  'entities.items.thornpeak_mail_legguards.name': '茨峰の鎖脚甲',
  'entities.items.thornpeak_mail_pauldrons.name': '茨峰の鎖肩当て',
  'entities.items.thornpeak_mail_sabatons.name': '茨峰の鎖鉄靴',
  'entities.items.thornpeak_polearm.name': '茨峰の長柄武器',
  'entities.items.thornpeak_war_axe.name': '茨峰の戦斧',
