...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.cameraMode.title': 'カメラを選択',
  'hudChrome.cameraMode.body': 'カメラの操作方法を選んでください。',
  'hudChrome.cameraMode.classicLabel': 'クラシック',
  'hudChrome.cameraMode.classicDesc':
    'マウス右ボタンを押している間カメラを回転し、離すとカーソルが解放されます。',
  'hudChrome.cameraMode.mouseLabel': 'マウスカメラ',
  'hudChrome.cameraMode.mouseDesc': 'マウスが常にカメラを操作する、滑らかで現代的なフリールックです。',
  'hudChrome.cameraMode.recommended': 'おすすめ',
  'hudChrome.cameraMode.note': 'この設定は後で Esc の「キー割り当て」から変更できます。',
  'hudChrome.cameraMode.confirm': '決定',
  'hudChrome.cameraMode.dismiss': '閉じる',
