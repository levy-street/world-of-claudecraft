...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.governance.disabled': 'ガバナンス投票は現在利用できません。',
  'apiError.governance.forbidden': '提案を作成する権限がありません。',
  'apiError.governance.not_found': 'その提案は見つかりませんでした。',
  'apiError.governance.invalid_input': '提案の入力内容を確認して再試行してください。',
  'apiError.governance.wallet_not_linked': '投票する前にウォレットを連携してください。',
  ...
  'hudChrome.governance.title': 'ガバナンス',
  'hudChrome.governance.close': 'ガバナンスを閉じる',
  'hudChrome.governance.subtitle': '$WOC 保有者による諮問投票',
  'hudChrome.governance.loading': '提案を読み込み中……',
  'hudChrome.governance.error': 'ガバナンス提案を読み込めませんでした。',
  'hudChrome.governance.empty': 'まだ提案はありません。',
  'hudChrome.governance.refresh': '更新',
  'hudChrome.governance.open': '受付中',
  'hudChrome.governance.closed': '終了',
  'hudChrome.governance.closesAt': '{date} に終了',
  'hudChrome.governance.closedAt': '{date} に終了',
  'hudChrome.governance.quorum': '定足数：{needed} $WOC 中 {current}',
  'hudChrome.governance.quorumReached': '定足数に達しました',
  'hudChrome.governance.category.content': 'コンテンツ',
  'hudChrome.governance.category.cosmetic': '装飾',
  'hudChrome.governance.category.treasury': '財務',
  'hudChrome.governance.tally.for': '賛成',
  'hudChrome.governance.tally.against': '反対',
  'hudChrome.governance.tally.abstain': '棄権',
  'hudChrome.governance.tally.voters': '{count} 人が投票',
  'hudChrome.governance.vote.for': '賛成に投票',
  'hudChrome.governance.vote.against': '反対に投票',
  'hudChrome.governance.vote.abstain': '棄権',
  'hudChrome.governance.vote.needWallet': '投票するにはウォレットを連携してください。',
  'hudChrome.governance.vote.alreadyVoted': '投票済み：{choice}',
  'hudChrome.governance.vote.signing': 'ウォレットで署名してください……',
  'hudChrome.governance.vote.submitting': '投票を送信中……',
  'hudChrome.governance.vote.success': '投票を記録しました。',
  'hudChrome.governance.vote.failed': '投票を記録できませんでした。',
