...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.invertX': 'カメラ反転（X軸）',
  'hudChrome.controller.invertMoveX': '移動反転（X軸）',
  'hudChrome.controller.invertMoveY': '移動反転（Y軸）',
  'hudChrome.controller.cameraAutoFollow': 'カメラ自動追従',
