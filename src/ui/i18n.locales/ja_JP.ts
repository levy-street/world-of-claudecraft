...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'itemUi.kind.charm': '護符',
  'itemUi.kind.artifact': 'アーティファクト',
  ...
  'hudChrome.itemCharmHint': 'バッグに入れておくと効果を得られます',
  ...
  'entities.items.st_albus_index_finger.name': '聖アルバスの人差し指',
  'entities.items.st_albus_middle_finger.name': '聖アルバスの中指',
  'entities.items.st_albus_ring_finger.name': '聖アルバスの薬指',
  'entities.items.st_albus_pinkie_finger.name': '聖アルバスの小指',
  'entities.items.st_albus_thumb.name': '聖アルバスの親指',
  'entities.items.hand_of_st_albus.name': '聖アルバスの手',
  ...
  'hudChrome.itemMenu.assemble': '組み立てる',
