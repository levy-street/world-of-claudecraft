...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.secondBar': '第2アクションバー',
  'hudChrome.actionBar.barScale': 'アクションバーのサイズ',
  'hudChrome.actionBar.editKeys': 'アクションバーのキーを編集',
  'hudChrome.actionBar.bindModeTitle': 'アクションバーのキー設定',
  'hudChrome.actionBar.bindModeHint': 'スロットをクリックし、割り当てたいキーを押します。終わったら「完了」をクリックします。',
  'hudChrome.actionBar.bindReset': 'リセット',
  'hudChrome.actionBar.bindResetConfirmTitle': 'アクションバーのキーをリセットしますか？',
  'hudChrome.actionBar.bindResetConfirmBody': '1本目のバーは既定のキーに戻り、2本目のバーは未設定になります。この操作は取り消せません。',
