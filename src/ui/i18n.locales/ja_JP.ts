...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.tracker.leave': 'デルヴを出る',
  'delveUi.leaveConfirm.title': 'デルヴから出ますか？',
  'delveUi.leaveConfirm.body': 'デルヴの入口に戻りますか？再び入れば、この攻略を続けられます。',
  'delveUi.leaveConfirm.confirm': '出る',
  'delveUi.leaveConfirm.cancel': 'キャンセル',
