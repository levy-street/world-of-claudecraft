...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.rift_arcane_execution': 'ヴォイドリフト',
  'abilityUi.cast.rift_arcane_strike': '秘術の消滅',
  'abilityUi.cast.rift_brute_execution': 'アースシャッター',
  'abilityUi.cast.rift_brute_strike': '最終判決',
  'abilityUi.cast.rift_ember_execution': 'マグマの井戸',
  'abilityUi.cast.rift_ember_strike': '炉心溶融',
  'abilityUi.cast.rift_frost_execution': '氷河の墓',
  'abilityUi.cast.rift_frost_strike': '絶対零度',
  'abilityUi.cast.rift_necro_execution': 'ソウルグレイブ',
  'abilityUi.cast.rift_necro_strike': '死刑判決',
  'abilityUi.cast.rift_storm_execution': '避雷針',
  'abilityUi.cast.rift_storm_strike': 'ストームコーラーの怒り',
  'abilityUi.cast.rift_tide_execution': 'アビサル・マウ',
  'abilityUi.cast.rift_tide_strike': '破砕深度',
  'abilityUi.cast.rift_venom_execution': 'ヴェノム・プール',
  'abilityUi.cast.rift_venom_strike': 'ブルーマザーのマーク',
  'hud.core.riftLabel': '{名前} {name}',
  'hud.core.riftLabelRanked': '{名前} ({ランク}) {name} {rank}',
  'fiesta.augment.cardAria': '{名前} ({カテゴリ}) - {説明} {name} {category} {description}',
  'hudChrome.continentMap.toZone': 'ゾーンマップ',
  'hudChrome.meters.breakdownRow': '{値} ({パーセント}) {value} {percent}',
  'hudChrome.meters.breakdownSummary': '{タブ}: {値} {tab} {value}',
  'hudChrome.meters.percent': '{値}% {value}',
  'hudChrome.meters.petAbility': '{ペット}: {能力} {pet} {ability}',
  'hudChrome.mountRace.go': 'ゴー!',
