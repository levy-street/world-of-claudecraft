...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.aldrin.entryLabel': 'アルドリンクラブ',
  'hudChrome.aldrin.title': 'アルドリンクラブ',
  'hudChrome.aldrin.intro':
    '月額メンバーシップ。特典はすべて見た目、利便性、アクセスのみで、強さに関わるものは一切ありません。',
  'hudChrome.aldrin.loading': '読み込み中...',
  'hudChrome.aldrin.unavailable': 'このレルムではアルドリンクラブは利用できません。',
  'hudChrome.aldrin.memberBadge': 'メンバー',
  'hudChrome.aldrin.notMember': 'まだメンバーではありません。',
  'hudChrome.aldrin.memberUntil': '{date}までメンバー（残り{days}日）',
  'hudChrome.aldrin.autoRenew': 'カードのサブスクリプションで自動更新されます。',
  'hudChrome.aldrin.priceLine': '{days}日ごとに{amount} USD',
  'hudChrome.aldrin.splitLine':
    '{treasuryPct}%は公開トレジャリーへ、{burnPct}%は$WOCの買い戻しとバーンに充てられます。',
  'hudChrome.aldrin.perksTitle': 'メンバー特典',
  'hudChrome.aldrin.perk.aura': '黄金のメンバーオーラ（見た目のみ）',
  'hudChrome.aldrin.perk.regalia': 'アルドリン正装の幻化セット（外見のみ）',
  'hudChrome.aldrin.perk.mount': 'クラブ限定マウントの外見',
  'hudChrome.aldrin.perk.title': '称号「アルドリンクラブの一員」',
  'hudChrome.aldrin.perk.nameColor': '金色のネームプレート',
  'hudChrome.aldrin.perk.lounge': 'メンバーラウンジと専用チャットチャンネル',
  'hudChrome.aldrin.perk.wardrobe': '追加のコスメティック衣装スロット',
  'hudChrome.aldrin.perk.queue': '満員時の優先ログインキュー',
  'hudChrome.aldrin.perk.stipend': '毎月のコスメティック手当',
  'hudChrome.aldrin.methodsTitle': '支払い方法',
  'hudChrome.aldrin.method.stripe': 'カード（Stripe）',
  'hudChrome.aldrin.reason.clubDisabled': 'このレルムではクラブが無効のため利用できません。',
  'hudChrome.aldrin.reason.walletCannotSign':
    '利用不可: 連携ウォレットはメッセージ署名のみ対応で、トランザクションに署名できません。',
  'hudChrome.aldrin.reason.notConfigured': 'このレルムでは設定されていません。',
  'hudChrome.aldrin.quoteTitle': '支払い見積もり: {method}',
  'hudChrome.aldrin.quoteAmount': '金額: {amount} {method}',
  'hudChrome.aldrin.quoteMemo': 'メモ（支払いに必須）: {memo}',
  'hudChrome.aldrin.quoteExpires': 'この見積もりは残り約{minutes}分有効です。',
  'hudChrome.aldrin.quoteExpired': 'この見積もりは期限切れです。新しく取得してください。',
  'hudChrome.aldrin.quoteError': '見積もりを取得できませんでした。後でもう一度お試しください。',
  'hudChrome.aldrin.railsNotice':
    '運営キーと最終承認が整うまで、このビルドでは支払いは無効です。このウィンドウからトランザクションが送信されることはありません。',
  'hudChrome.aldrin.stripeNotice': '支払いが有効になると、カード決済はStripe経由で開きます。',
  'hudChrome.aldrin.close': '閉じる',
};
