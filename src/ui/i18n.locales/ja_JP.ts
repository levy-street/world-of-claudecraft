...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.castBar.casting': '詠唱中',
  'hudChrome.castBar.channeling': 'チャネリング中',
  'hudChrome.castBar.complete': '完了',
  'hudChrome.castBar.interrupted': '中断',
  'hudChrome.castBar.failed': '失敗',
  'hudChrome.castBar.interruptible': '中断可能',
  'hudChrome.castBar.cannotInterrupt': '中断不可',
  'hudChrome.castBar.danger': '危険',
  'hudChrome.castBar.pet': 'ペット',
  'hudChrome.castBar.secondsShort': '{seconds}秒',
  'hudChrome.castBar.labelWithCue': '{cue}：{label}',
  'hudChrome.castBar.ariaStatus': '{bar}：{status} {label}、残り {seconds}',
  'hudChrome.castBar.ariaOutcome': '{bar}：{status} {label}',
  'hudChrome.petAction.auto': '自動',
  'hudChrome.petAction.cooldownTitle': '{action}：残り {seconds}',
  'hudChrome.petAction.cooldownAutoAria': '{action}：残り {seconds}、{auto}',
