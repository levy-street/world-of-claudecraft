...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.gatherDeeds.farmingSown':
    '農耕は今、功績の書に自分の棚を持っています。Sow It Beginsは最初に植えた作物を記し、四つの年代記のページが、Eastbrook ValeからEvergardenまで、それぞれの畑の地での最初の実った収穫を記します。黄金の収穫は名声ゼロの収集印を自ら記し、農耕の熟練もMaster Gatherer（いずれか三職で100）に数えられます。頂の功績はすでに書かれています。Harvestmaster、この職の熟練100の称号は、後の更新が拓くより深い畑とともに手の届くところへ来ます。功績は称号と名声のみで、力は与えません。',
