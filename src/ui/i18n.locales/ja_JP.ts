...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolbeltTitle': 'ツールベルト',
  'hudChrome.bags.toolbeltNone': 'ツールベルトを装備していません',
  'hudChrome.bags.toolbeltRemoveHint': 'クリックしてこのツールベルトを外す',
  'hudChrome.bags.toolbeltFilled': '道具 {used}/{total}',
  'hudChrome.bags.toolSlotLabel': 'ツールスロット {slot}',
  'hudChrome.bags.toolSlotEmpty': '空',
  'hudChrome.bags.toolSlotStowHint': 'クリックして{name}をしまう',
  'hudChrome.bags.toolSlotTakeHint': 'クリックしてこの道具を取り出す',
  'hudChrome.bags.toolSlotNoTool': 'しまえる道具を持っていません',
  'itemUi.kind.toolbelt': 'ツールベルト',
  'entities.items.basic_toolbelt.name': 'ベーシックツールベルト',
  'entities.items.reinforced_toolbelt.name': '強化ツールベルト',
  'entities.items.artisans_toolbelt.name': '職人のツールベルト',
  'itemUi.tooltip.toolbeltSlots': '道具を{slots}個収納できます',
