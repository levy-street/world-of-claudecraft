...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  "hud.mounts.noWallet": "連携した財布で少なくとも{amount} $WOC、総供給量の0.1%を保有して、最初の旅マウントを手に入れましょう。",
  ...
  "hud.mounts.mintHint": "このマウントの取引可能なチャーターを打ち出す — ゴールドで売れば、非保有者がそれを手に入れられます。",
  ...
  "hud.wager.inviteCharter": "{name}が賭けレースを開いた — {money}＋マウントチャーターを賭ける。応じるか？",
  ...
  "entities.npcs.skytrial_master.greeting": "空とは、あえて歩もうとする者の少ない道だ、{className}よ。それを勝ち取れば、空がお前を運んでくれる。",
  "entities.quests.q_skyward_first_flight.title": "初飛行",
  "entities.quests.q_skyward_first_flight.text": "お前は地上では翼ある駿馬をそれなりに乗りこなしている、{playerName}よ — さあ、それを空へ上げてみせろ。ヴェイル・スカイトライアルを飛ぶのだ。ひと巡りの周回で八つのリングを抜ける。まだタイムを追うな。ただ空に留まり、すべてのリングを糸のように通り抜けよ。",
  "entities.quests.q_skyward_first_flight.completion": "落ちなかったな。初めての周回でそれをやり遂げる者はそう多くない。空は、何度も戻ってくる者を覚えている。",
  ...
  "entities.quests.q_skyward_time_trial.text": "今度は意志をもってやり遂げろ。もう一度ヴェイル・スカイトライアルを飛ぶのだ、{playerName}よ。だが砂が尽きる前に飛び終えよ。すべてのリングを貫く一筋の澄んだ軌道、無駄な空気は一切なし。慌てるな、精密にやれ。",
  "entities.quests.q_skyward_time_trial.completion": "リングからリングへ、一筋の澄んだ軌道。お前はもう空に乗っているのではない — 空を飛んでいるのだ。",
  "entities.quests.q_skyward_time_trial.objectives.0.label": "ヴェイル・スカイトライアルを規定タイム以内で飛行",
  "entities.quests.q_skyward_ascendant.title": "天翔ける者",
  "entities.quests.q_skyward_ascendant.text": "残る試練はただ一つ、{playerName}よ。ヴェイル・サーキットだ。長きリングを三周、規定タイム以内で飛び切れ — 運ではなく、ただ技だけで。それを極めれば、果てから果てまで、広き空はお前のものだ。",
  "entities.quests.q_skyward_ascendant.completion": "天高く、揺るぎなく。空は今やお前のものだ、{playerName}よ。このチャーターを取れ — 買ったのではなく勝ち取った空の駿馬、お前が目指すどこへでもお前を運ぶだろう。",
  "entities.quests.q_skyward_ascendant.objectives.0.label": "ヴェイル・サーキットを規定タイム以内で飛行",
