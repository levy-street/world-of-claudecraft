...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'wallet.guardianTierTitle': '{tier} 流動性ガーディアン',
  'wallet.guardianTiers.wader.name': '渚歩き',
  'wallet.guardianTiers.wader.title': '浅瀬の渚歩き',
  'wallet.guardianTiers.tidewatcher.name': '潮見守',
  'wallet.guardianTiers.tidewatcher.title': '潮の見張り番',
  'wallet.guardianTiers.currentkeeper.name': '海流の番人',
  'wallet.guardianTiers.currentkeeper.title': '海流の守り手',
  'wallet.guardianTiers.stormwarden.name': '嵐の守人',
  'wallet.guardianTiers.stormwarden.title': '嵐の監視者',
  'wallet.guardianTiers.abyssguard.name': '深淵の衛士',
  'wallet.guardianTiers.abyssguard.title': '深淵の守護兵',
  ...
  'hudChrome.wocSeason.menu': '$WOCシーズン',
  'hudChrome.wocSeason.title': '$WOC報酬シーズン',
  ...
  'hudChrome.wocSeason.noneHint': 'アリーナのレーキと買い戻しがプールに資金を供給し始めるとシーズンが開始されます。',
  'hudChrome.wocSeason.statusActive': 'アクティブ',
  'hudChrome.wocSeason.statusEnded': '終了',
  'hudChrome.wocSeason.ended': 'このシーズンは終了しました。',
  'hudChrome.wocSeason.openEnded': '期限なし',
  'hudChrome.wocSeason.poolLabel': '利用可能な報酬プール',
  'hudChrome.wocSeason.emittedLabel': 'これまでにプールの{pct}%を支払い済み',
  'hudChrome.wocSeason.sinkLabel': '資金済み',
  'hudChrome.wocSeason.invariant': '支払いがシーズンの収入を超えることはありません。買い > 売り、オンチェーンで強制されます。',
  'hudChrome.wocSeason.standingsTitle': '予想上位獲得者',
  'hudChrome.wocSeason.colPlayer': 'プレイヤー',
  'hudChrome.wocSeason.colRating': 'レーティング',
  'hudChrome.wocSeason.colReward': '報酬($WOC)',
  'hudChrome.wocSeason.projectedNote': '現在のプールとアリーナランキングからの予測。最終支払いはシーズン終了時に確定します。',
};
