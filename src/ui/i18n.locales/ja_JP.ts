...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.source_cave_mantle.name': '根源のマント',
  'entities.items.conflictbreaker_breastplate.name': 'コンフリクトブレイカーの胸当て',
  'entities.items.cherry_pickers_gauntlets.name': 'チェリーピッカーの篭手',
  'entities.items.maintainers_crown.name': 'メンテナーの冠',
  'entities.items.commit_blade.name': 'コミットの刃',
  'entities.items.bug_squasher.name': 'バグ潰しの鎚',
  'entities.items.mech_keyboard.name': 'キーストローク',
  ...
  'worldContent.sourceCaveWellName': '開かれた源',
  'worldContent.sourceCaveReboot': 'このボタンを押さないでください',
  'worldContent.sourceCaveRebootYell': 'なんてことをしたんだ？！',
  'worldContent.sourceCaveRebootYellWhatsGoingOn': 'おい、どうなってるんだ？',
  'worldContent.sourceCaveRebootYellServerDown': 'みんな、サーバーが落ちたぞ！',
  'worldContent.sourceCaveBanterIssue': 'お願いだから、issue を立ててくれ。',
  'worldContent.sourceCaveBanterPullRequest': '遠慮せずプルリクエストを送ってね。',
  'worldContent.sourceCaveBanterConflicts': 'コンフリクトは大嫌いだ……',
  'worldContent.sourceCaveBanterContribute': 'もちろん、このプロジェクトに貢献できるよ！',
  'worldContent.sourceCaveBanterFocused': 'ごめん、今は集中してるんだ',
  'worldContent.sourceCaveBanterNextRelease': '次のリリースはすごいことになるよ！',
  'worldContent.sourceCaveBanterRefresh': 'ん？リロードしてみて',
  ...
  'entities.dungeons.source_cave.name': '源初の洞窟',
  'entities.dungeons.source_cave.enterText': 'あなたは源初の洞窟に足を踏み入れる。',
  'entities.dungeons.source_cave.leaveText': 'あなたは源初の洞窟を後にする。',
  ...
  'sim.dungeon.levelRequired': '{name}に入るにはレベル{level}に達している必要がある。',
  'sim.sourceCave.locked': '{name}への立ち入りがロックされている。',
  'sim.sourceCave.enter': 'あなたは源初の洞窟に足を踏み入れる。',
  'sim.sourceCave.leave': 'あなたは源初の洞窟を後にする。',
  'sim.sourceCave.rebootConfirm':
    '本当に続行しますか？押す前に、必要なリソースを集めておいてください。',
  'sim.sourceCave.killProgress': '{name}が倒れた。（源初の洞窟で{total}体中{killed}体を撃破）',
  'sim.sourceCave.cleared': '源初の洞窟を制圧した。',
  ...
  'sim.sourceCave.wellBanter3': '私はただの普通の井戸だ！ほら、バケツだってあるだろう！',
  'sim.sourceCave.wellBanter4': 'やっぱりただの井戸さ。魔法なんて何もないよ。',
  'sim.sourceCave.wellBanter5': '源のことを誰に聞いたんだ？Claudeか？',
  'sim.sourceCave.wellBanter6': 'ああ、そこには絶対に降りたくないはずだ。',
  'sim.sourceCave.wellBanter7': '警備員！プレイヤーがソースコードに侵入しようとしているぞ！',
  'sim.sourceCave.wellBanter8': 'あの下は争いの種なんだよ。',
  'sim.sourceCave.wellBanter9': '開けたら、もう放っておいてくれるか？',
  'sim.sourceCave.wellBanter10': 'よし、中へどうぞ。先にブーツを拭いてくれ。',
