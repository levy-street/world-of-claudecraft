...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.merch.unavailable':
    'グッズストアは現在ご利用いただけません。ご注文とお支払いに影響はありません。しばらくしてからもう一度お試しください。',
  'hudChrome.merch.disclosure':
    'グッズは印刷パートナーが受注生産で製作・発送します。グッズ購入に使用した Claudium は Claudium として返金できません。カードおよび Solana でのお支払いは利用規約の返金ポリシーに従います。',
  ...
  'hudChrome.merch.totalNote':
    '送料と税金はチェックアウト時に加算されます。最終金額はサーバー側で確定します。',
  ...
  'hudChrome.merch.checkoutPending':
    '注文処理中です。支払いを完了し、このページを開いたままにしてください。',
  ...
  'hudChrome.merch.checkoutNotSettled':
    'トランザクションは送信されましたが、注文はまだ確認されていません。しばらくしてから注文をご確認ください。',
  'hudChrome.merch.orderPlaced': '注文 {orderId} を受け付けました。下の注文一覧で追跡できます。',
  'hudChrome.merch.paymentPending':
    '注文 {orderId} はカード決済の完了待ちです。決済が完了するとご注文一覧に表示されます。',
