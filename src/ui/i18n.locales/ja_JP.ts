...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.tryOnActiveNote':
    'あなたのキャラクターで試着中です。これで入手はできません。',
  'hudChrome.claudium.tabSupply': '供給量',
  'hudChrome.claudium.supplyTitle': '現存するクラウジウム',
  'hudChrome.claudium.supplyLoading': '供給量を読み込んでいます...',
  'hudChrome.claudium.supplyError': '供給量を読み込めませんでした。もう一度お試しください。',
  'hudChrome.claudium.supplyUnavailable': '現在、供給量を取得できません。',
  'hudChrome.claudium.supplyInExistence': '現存 {amount}',
  'hudChrome.claudium.supplyUsdValue': '価値 {amount}',
  'hudChrome.claudium.supplyIssued': '累計発行量',
  'hudChrome.claudium.supplySunk': '累計消費および取消量',
  'hudChrome.claudium.supplyHolders': '{n} アカウントが保有',
  'hudChrome.claudium.supplyChangeUp': 'この期間で {amount} 増加',
  'hudChrome.claudium.supplyChangeDown': 'この期間で {amount} 減少',
  'hudChrome.claudium.supplyChangeFlat': 'この期間で変動なし',
  'hudChrome.claudium.supplyChartLabel': '選択した期間のクラウジウム供給量',
  'hudChrome.claudium.supplyChartEmpty': 'この期間に供給量の変動はありません。',
  'hudChrome.claudium.supplyRangeLabel': 'グラフ期間',
  'hudChrome.claudium.supplyFootnote':
    '全アカウントが保有するクラウジウムの総量を、台帳からリアルタイムに集計しています。',
};
