...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'game.leaderboard.guildCol': 'ギルド',
  'game.leaderboard.members': 'メンバー',
  'game.leaderboard.topLevel': '最高Lv',
  'game.leaderboard.totalXp': '総経験値',
  'game.leaderboard.tabPlayers': 'プレイヤー',
  'game.leaderboard.tabGuilds': 'ギルド',
