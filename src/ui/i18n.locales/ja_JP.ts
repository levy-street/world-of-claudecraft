...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'marketplace.title': 'クリエイタースキン',
  'marketplace.subtitle':
    'プレイヤー制作のコスメ。USDC で購入。70% はクリエイターへ、30% で $WOC を買い戻して焼却します。',
  'marketplace.loading': 'スキンを読み込み中…',
  'marketplace.empty': '販売中のクリエイタースキンはまだありません。',
  'marketplace.connectFirst': '購入するにはウォレットを接続してください。',
  'marketplace.purchasing': '購入中…',
  'marketplace.owned': '所有済み — 装備しました',
  'marketplace.failed': '購入に失敗しました',
  ...
  'marketplace.tabCreate': '作成と販売',
  'marketplace.search': 'スキンを検索',
  'marketplace.anyClass': 'すべてのクラス',
  ...
  'marketplace.designIntro':
    'ボディの色とパターンを変えられます。誰にでも同じように表示され、ファイルのアップロードは不要です。',
  'marketplace.modeDesign': 'デザイン',
  'marketplace.modeUpload': 'アップロード',
  'marketplace.modeLink': 'セルフホスト',
  'marketplace.uploadIntro':
    '自作の 1024x1024 PNG アトラスをアップロード。IPFS にピン留めし、こちらでホストします。',
  'marketplace.linkIntro':
    '自分でホストする PNG アトラスをリンク。プロキシ経由なので購入者に URL は見えません。無料です。',
  'marketplace.linkUrl': 'アトラス URL',
  'marketplace.quotaMeter': 'ホスト枠 {used}/{quota} 使用中',
  'marketplace.trustedBadge': '信頼済みクリエイター(即時公開)',
  'marketplace.selfHostedFreeNote': 'セルフホストは無料かつ無制限です(出品数の上限内)。',
  'marketplace.hostingUnavailable': 'ホスト型アップロードは一時的に利用できません。',
  'marketplace.listedReview': '審査に提出しました。運営者が承認すると出品されます。',
  'marketplace.baseColor': 'ベースカラー',
  'marketplace.patternColor': 'パターンカラー',
  'marketplace.accentColor': 'アクセントカラー',
  'marketplace.pattern': 'パターン',
  'marketplace.finishLabel': '仕上げ',
  'marketplace.densityLabel': '密度',
  'marketplace.finishes.matte': 'マット',
  'marketplace.finishes.satin': 'サテン',
  'marketplace.finishes.metallic': 'メタリック',
  'marketplace.densities.low': 'まばら',
  'marketplace.densities.medium': '普通',
  'marketplace.densities.high': '高密度',
  'marketplace.glowColor': '発光色',
  'marketplace.noGlow': '発光なし',
  'marketplace.randomize': 'ランダム',
  'marketplace.namePlaceholder': '例:エメラルドドラゴンスケイル',
  'marketplace.descLabel': '説明',
  'marketplace.descPlaceholder': '購入者に表示される短い説明',
  'marketplace.priceLabel': '価格(USDC)',
  'marketplace.preview': 'ライブプレビュー',
  'marketplace.list': '出品する',
  'marketplace.listing': '出品中…',
  'marketplace.listed': '出品しました。すぐに購入可能です。所持スキンから装備できます。',
  'marketplace.listFailed': '出品できませんでした',
  'marketplace.listConnectFirst':
    '出品するにはウォレットを接続してください(収益の 70% を受け取れます)。',
  'marketplace.payoutHint': '受け取りは 70% • 30% は $WOC の買い戻しと焼却に',
  'marketplace.patterns.solid': '単色',
  'marketplace.patterns.scales': '鱗',
  'marketplace.patterns.stripes': 'ストライプ',
  'marketplace.patterns.diamond': 'ダイヤ柄',
  'marketplace.patterns.spots': '斑点',
  'marketplace.patterns.runes': 'ルーン',
  'entities.npcs.skin_artisan.name': 'スキン職人ピップ',
  'entities.npcs.skin_artisan.title': 'クリエイタースキン掲示板',
  'entities.npcs.skin_artisan.greeting':
    '新しい見た目はいかがですか、{className}?プレイヤーが作ったコスメティックスキンを眺めるもよし、自分でデザインして販売するもよし。支払いは USDC で、その一部が $WOC の買い戻しと焼却に充てられます。',
  'hudChrome.nftSkins.intro': 'PFP NFTの所有を証明して着用しましょう。トレイトが体の見た目を形作り、そのアートがポートレートになります。NFTを保有している間は使用できます。',
  'hudChrome.nftSkins.connectEthereum': 'Ethereumウォレットを接続',
  'hudChrome.nftSkins.connectSolana': 'Solanaウォレットを接続',
  'hudChrome.nftSkins.ethereumLinked': 'Ethereumウォレット: {address}',
  'hudChrome.nftSkins.solanaLinked': 'Solanaウォレット: {address}',
  'hudChrome.nftSkins.notLinked': '未リンク',
  'hudChrome.nftSkins.collectionsTitle': '対応コレクション',
  'hudChrome.nftSkins.noCollections': '利用可能なコレクションはまだありません。しばらくしてからご確認ください。',
  'hudChrome.nftSkins.tokenIdPlaceholder': 'トークンID',
  'hudChrome.nftSkins.mintPlaceholder': 'ミントアドレス',
  'hudChrome.nftSkins.claim': '申請',
  'hudChrome.nftSkins.claiming': '申請中...',
  'hudChrome.nftSkins.claimed': '申請して装備しました。スキンブラウザからいつでも確認できます。',
  'hudChrome.nftSkins.needWallet': '先に対応するウォレットをリンクしてください。',
  'hudChrome.nftSkins.close': '閉じる',
  'hudChrome.nftSkins.errorNotOwner': 'そのウォレットはこのトークンを所有していません。',
  'hudChrome.nftSkins.errorUnverified': '現在、所有権を確認できません。しばらくしてからもう一度お試しください。',
  'hudChrome.nftSkins.errorCollection': 'そのコレクションには対応していません。',
  'hudChrome.nftSkins.errorTooMany': 'NFTスキンの上限に達しました。',
  'hudChrome.nftSkins.errorMetadata': '現在、このNFTを読み取れません。しばらくしてからもう一度お試しください。',
  'hudChrome.nftSkins.errorGeneric': 'このNFTスキンを申請できませんでした。',
  'hudChrome.nftSkins.walletError': 'ウォレット接続に失敗しました。',
};
