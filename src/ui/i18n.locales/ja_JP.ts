...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mountTraining.buyReinsPrompt':
    '騎乗を習得しました。マーラからヴァラースティードの手綱を10ゴールドで購入し、使用すると騎乗できます。',
  'lb.fixture.ferry': 'ファーショア渡船',
  'lb.fixture.tidemill': 'タイドミル',
  'lb.fixture.breach': '裂け目',
  'lb.speaker.tam': '鐘守タム',
  'lb.speaker.coalfast': 'ウォーデン・コールファスト',
  'lb.speaker.ollun': '裂け目の番人オルン',
  'lb.speaker.edda': '補給官エッダ',
  'lb.speaker.saul': '癒やし手サウル',
  'lb.fare.promptOut': 'ファーショアへの渡航料：{price}カッパー。',
  'lb.fare.promptBack': '本土への帰航料：{price}カッパー。',
  'lb.fare.pay': '渡航料を払う。',
  'lb.fare.decline': '今日はやめておく。',
  'lb.q0.scene.harbor':
    '働き続ける港。網が干され、星硝子の引き揚げ箱には本土の買い手の印が押されている。',
  'lb.q0.scene.plinth':
    '港の階段の上で、青銅のウォーデンが内陸を見つめている。台座で最も新しい名も百年前のものだ。「ウォーデン・ヘイル」。その下には、まだ名を刻む余地がある。',
  'lb.q0.scene.toll':
    '鐘が一度だけ鳴る。通りの誰もが足を止め、数える。続く音はなく、通り全体が一斉に息を吐いた。',
  'lb.q0.tam.stretchers': 'この前の一体には、見張り隊が午前中いっぱいと担架を二つ費やした。',
  'lb.q0.coalfast.look':
    '灰色の男は倒れたストーカーを見て、それから少し長くあなたを見る。そして崖の方へ歩き去った。',
  ...
  'editor.cinematic.violations': '違反',
  'editor.cinematic.noViolations': '現在、違反はありません',
  'editor.cinematic.capture': 'キーフレームを記録',
  'editor.cinematic.copy': 'ブロックをコピー',
  'editor.cinematic.output': '生成されたカメラ記録',
  'editor.cinematic.unavailable': '3Dビューポートを読み込み中',
  'editor.cinematic.seedMismatch': '記録には正式版のワールドシードが必要です',
  'editor.cinematic.captureSavedCopied': '保存してコピーしました',
  'editor.cinematic.captureSaved': '保存しました。下にブロックを用意しました',
  'editor.cinematic.captureCopyOnly': 'コピーしました。開発用ライターは利用できません',
  'editor.cinematic.captureReady': '下にブロックを用意しました',
  'entities.mobs.lb_actor_coalfast.name': 'ウォーデン・コールファスト',
  'entities.mobs.lb_actor_ollun.name': '裂け目の番人オルン',
  'entities.mobs.lb_actor_edda.name': '補給官エッダ',
  'entities.mobs.lb_actor_saul.name': '癒やし手サウル',
  'entities.mobs.lb_actor_tam.name': '鐘守タム',
  'entities.mobs.tidemill_stalker.name': 'タイドミルのストーカー',
  'entities.npcs.ferryman_ewald.name': '渡し守エーヴァルト',
  'entities.npcs.ferryman_ewald.title': 'ファーショア渡航',
  'entities.npcs.ferryman_ewald.greeting':
    'ファーショアへ行くのか？ もう釣りのために渡る者はいないよ。準備ができたら乗りな。着いたら鐘に気をつけろ。この町の者は、天気を聞くように鐘を聞く。',
  'entities.npcs.ferryman_ewald_gullhaven.name': '渡し守エーヴァルト',
  'entities.npcs.ferryman_ewald_gullhaven.title': 'ファーショア渡航',
  'entities.npcs.ferryman_ewald_gullhaven.greeting':
    'ファーショアへ行くのか？ もう釣りのために渡る者はいないよ。準備ができたら乗りな。着いたら鐘に気をつけろ。この町の者は、天気を聞くように鐘を聞く。',
  'entities.npcs.sergeant_marsh.name': 'マーシュ軍曹',
  'entities.npcs.sergeant_marsh.title': '町の民兵隊',
  'entities.npcs.sergeant_marsh.greeting':
    '訓練済みか？ なら今夜の手順を話す。こちらの隊列が道を守る。裂け目から我々に倒せないものが出たら、君に任せる。水車小屋は君の持ち場だ。何も後を追わせず、何も我々を越えて町へ入れるな。行け。',
  'entities.quests.q_lb_q0_ashore.title': '上陸',
  'entities.quests.q_lb_q0_ashore.text':
    'ガルヘイヴンは昼夜を問わず打撃に耐え、それでも持ちこたえている。共に立つつもりなら、町が血を流す場所から始めろ。港の階段と古い像を越えて東へ進み、ウォッチ・メドウの民兵隊に合流するのだ。',
  'entities.quests.q_lb_q0_ashore.completion':
    '水車小屋で仕留めたのは君一人だ。タムが担架の話を大げさにしたわけでもない。斥候は足りず、守る野原は多すぎる。今夜、君は自分のものでもない土地を守った。それこそがこの仕事のすべてだ。見張り隊へようこそ。',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': 'ウォッチ・メドウのマーシュ軍曹に報告する',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': '裂け目の怪物を倒す',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': 'タイドミルに潜むものを倒す',
  'entities.zones.farshore_isle.pois.5.label': '裂け目',
  'entities.zones.farshore_isle.pois.6.label': '残骸原',
  'entities.dungeons.lb_tidemill.name': 'タイドミル',
  'entities.dungeons.lb_tidemill.enterText': '水車小屋の扉が開く。中では、闇が耳を澄ませている。',
  'entities.dungeons.lb_tidemill.leaveText': 'タイドミルを出て、夕暮れの空気へ戻る。',
  'entities.dungeons.lb_riftline.enterText':
    '巡回隊の背後で草原の門が閉じる。今夜はこの戦線のものだ。',
  'entities.dungeons.lb_riftline.leaveText': '裂け目の戦線を夜明けの見張りに任せる。',
  'entities.dungeons.lb_vault.name': '水没した第一砦',
  'entities.dungeons.lb_vault.enterText':
    '縄が闇へ下りていく。下には、落ちた場所に古い砦が横たわっている。',
  'entities.dungeons.lb_vault.leaveText': '崖の縄を登り、陽光の中へ戻る。',
  'entities.dungeons.lb_council.name': '砦の評議会',
  'entities.dungeons.lb_council.enterText': '評議会室には椅子が六脚ある。一脚は空いている。',
  'entities.dungeons.lb_council.leaveText': '砦の外へ出る。',
  'entities.dungeons.lb_landing.name': '夜の上陸',
  'entities.dungeons.lb_landing.enterText':
    '誘導火が浜辺に沿って燃える。艦隊は浅瀬の向こうで待っている。',
  'entities.dungeons.lb_landing.leaveText': '上陸浜を後にする。',
  'entities.dungeons.lb_riftfields.name': '裂け目原への道',
  'entities.dungeons.lb_riftfields.enterText':
    '四つの結界地点が裂け目を囲む。儀式は十二世紀もの間、それを閉じてきた。',
  'entities.dungeons.lb_riftfields.leaveText': '裂け目原を下り、戻っていく。',
  'entities.dungeons.lb_breach.name': '裂け目の内側',
  'entities.dungeons.lb_breach.enterText':
    '光がおかしい。空はもっと悪い。核は前方の開けた場所にある。',
  'entities.dungeons.lb_breach.leaveText': '境界を越え、ありふれた夜気へ戻る。',
  'entities.dungeons.lb_lastwatch.name': '最後の見張り',
  'entities.dungeons.lb_lastwatch.enterText':
    '砦はきれいで空っぽだ。誰かが見張りを終わらせなければならない。',
  'entities.dungeons.lb_lastwatch.leaveText': '背後で砦の扉を閉じる。',
  'entities.dungeons.lb_willowfen.name': 'ウィローウィープ',
  'entities.dungeons.lb_willowfen.enterText': '柳は動かない。水も動かない。',
