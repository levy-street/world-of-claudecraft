...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.bandsBodySplitLadder':
    '熟練度バンドは、陸の専門のカウンターに重なる共通の0/100/200のはしごです。100で越えるバンドは採集の詠唱を速め、陸の上限があるためバンド1が天井になります。釣りは自分だけのはしごを持ち、0、100、150、そして200に三段が重なる六段です。釣りのバンドは詠唱を速めません。釣果表を選び、それぞれに見合う竿を求めます。三段目より先では熟練度の門が動かなくなるため、釣果表がどこまで伸びるかは竿だけが決めます。この登りこそが釣り人を深い水へ引き寄せます。より良い釣果表も、その先の学びも、そこにあるからです。',
