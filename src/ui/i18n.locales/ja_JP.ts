...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.mobile.customize": "カスタマイズ",
  "hudChrome.mobile.customizeTitle": "操作をカスタマイズ",
  "hudChrome.mobile.customizeSlotAttack": "通常攻撃",
  "hudChrome.mobile.customizeSlotSkill": "スキル{n}",
  "hudChrome.mobile.customizeSlotUtility": "補助",
  "hudChrome.mobile.customizeDefault": "クラス既定",
  "hudChrome.mobile.customizeResetSlot": "このスロットをリセット",
  "hudChrome.mobile.customizeResetAll": "すべてクラス既定にリセット",
  "hudChrome.mobile.customizeUpdated": "{slot}を更新しました。",
  "hudChrome.mobile.customizeAllReset": "操作をクラス既定にリセットしました。",
  "hudChrome.options.touchControls": "タッチ操作",
  "hudChrome.options.clusterHold": "編集ホールド時間",
  "hudChrome.options.clusterHoldNote": "画面上のアクションボタンを長押ししてから割り当てエディターが開くまでの時間。スキルを連打中にエディターが開いてしまう場合は長くしてください。",
  "hudChrome.options.targetPriority": "攻撃対象の優先度",
  "hudChrome.options.targetPriorityNearest": "最も近い",
  "hudChrome.options.targetPriorityLowestHp": "体力が最も低い",
  "hudChrome.options.targetPriorityCurrent": "現在の対象を優先",
  "hudChrome.options.targetPriorityNote": "有効な対象がいないときに攻撃ボタンが狙う相手：最も近い敵、射程内で体力が最も低い敵、または有効な間は現在の対象を維持します。",
  "hudChrome.options.aimAssist": "スマートスキル発動",
  "hudChrome.options.aimAssistNote": "攻撃スキルを押すと、対象（いない場合は近くの最適な敵）に向き直って発動します。ボタンを長押しするとスキルの射程をプレビューし、ボタンから指を外して離すとキャンセルします。",
  "hudChrome.options.touchReset": "タッチ操作をリセット",
  "hudChrome.options.touchResetDone": "タッチ操作を既定値に戻しました。",
