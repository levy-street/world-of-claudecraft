...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'character.mintSolHint': 'プレイヤー所有の‹名前›.worldofclaudecraft.solを{amount} $WOCでミント。オンチェーンであなたのものに。',
  ...
  'woc.finalizeTimeout': 'ファイナライズ待ちがタイムアウトしました。$WOCがバーン済みの場合は再度開いてやり直してください。支払いはファイナライズ後に確定します。',
