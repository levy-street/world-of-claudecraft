...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.mobs.tower_imp.name': '熾火の幼魔',
  'entities.mobs.tower_hellhound.name': 'ヘルハウンド',
  'entities.mobs.tower_pact_reaver.name': '契約の略奪者',
  'entities.mobs.tower_brimstone_zealot.name': '硫黄の狂信者',
  'entities.mobs.tower_soulbinder.name': '魂縛り',
  'entities.mobs.tower_iron_defiler.name': '鉄の冒涜者',
  'entities.mobs.tower_abyss_knight.name': '深淵の騎士',
  'entities.mobs.tower_dread_harbinger.name': '恐怖の先触れ',
  'entities.mobs.tower_gloom_bat.name': '暗闇コウモリ',
  'entities.mobs.tower_cinder_crawler.name': '熾火這い',
  'entities.mobs.tower_bone_acolyte.name': '骨の侍祭',
  'entities.mobs.tower_shade_dancer.name': '影の舞手',
  'entities.mobs.tower_flame_herald.name': '炎の伝令',
  'entities.mobs.tower_rot_hulk.name': '腐敗の巨躯',
  'entities.mobs.tower_blood_matron.name': '血の女主',
  'entities.mobs.tower_void_sentinel.name': '虚無の番人',
  'entities.mobs.tower_boss_flesh_shaper.name': '肉造りのゴール',
  'entities.mobs.tower_boss_ash_tyrant.name': '灰の暴君シンダラックス',
  'entities.mobs.tower_boss_gatekeeper.name': '門番ヴァスカー',
  'entities.mobs.tower_boss_demon_lord.name': '塔の枷を解かれしマルグラス',
  'sim.rift.towerWave': '魔核が咆哮する。第{wave}波、全{total}波。',
  'sim.rift.ascendFloor': '{name}へ昇る。',
  'sim.rift.towerBossWave': '核が裂け、はるかに凶悪な何かが現れた。',
  'sim.rift.towerFloorClear': '魔核が砕けた。上への道が開いた。',
  'sim.rift.towerCleared': '魔核の光が消えた。塔はあなたのものだ。',
  'worldContent.demonTowerName': '悪魔の塔',
  'worldContent.demonTowerBloodforgeName': '悪魔の塔：血の鍛冶場',
  'worldContent.demonTowerOssuaryName': '悪魔の塔：鎖の納骨堂',
  'worldContent.demonTowerVoidCrownName': '悪魔の塔：虚無の王冠',
  'worldContent.demonTowerCoreName': '魔核',
  'worldContent.demonTowerAscentName': '塔の昇り道',
};
