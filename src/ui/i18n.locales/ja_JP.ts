...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.pokerPlaytest.title': 'ポーカー',
  'hudChrome.pokerPlaytest.close': 'ポーカーを閉じる',
  'hudChrome.pokerPlaytest.reconnecting': 'ポーカーサーバーに再接続しています...',
  'hudChrome.pokerPlaytest.disabled': '現在ポーカーを利用できません。',
  'hudChrome.pokerPlaytest.tables': 'テーブル',
  'hudChrome.pokerPlaytest.refresh': '更新',
  'hudChrome.pokerPlaytest.noTables': '利用できるポーカーテーブルがありません。',
  'hudChrome.pokerPlaytest.join': '参加',
  'hudChrome.pokerPlaytest.watch': '観戦',
  'hudChrome.pokerPlaytest.stopWatching': '観戦を終了',
  'hudChrome.pokerPlaytest.rebuy': 'リバイ',
  'hudChrome.pokerPlaytest.leave': '退出',
  'hudChrome.pokerPlaytest.chooseSeat': '席を選択',
  'hudChrome.pokerPlaytest.seat': '席 {seat}',
  'hudChrome.pokerPlaytest.seated': '着席 {count}人',
  'hudChrome.pokerPlaytest.watchers': '観戦 {count}人',
  'hudChrome.pokerPlaytest.watching': '観戦中',
  'hudChrome.pokerPlaytest.tableFull': '満席',
  'hudChrome.pokerPlaytest.inHand': 'ハンド進行中',
  'hudChrome.pokerPlaytest.betweenHands': 'ハンド間',
  'hudChrome.pokerPlaytest.unknownPlayer': 'プレイヤー',
  'hudChrome.pokerPlaytest.waiting': '次のハンドを待っています',
  'hudChrome.pokerPlaytest.playerTurn': '{name}がアクション中',
  'hudChrome.pokerPlaytest.timeRemaining': '残り{seconds}秒',
  'hudChrome.pokerPlaytest.wagerAmount': '{action}額',
  'hudChrome.pokerPlaytest.rake': 'レーキ: {amount}',
  'hudChrome.pokerPlaytest.error.busy': 'テーブルが処理中です。もう一度お試しください。',
  'hudChrome.pokerPlaytest.error.disabled': '現在ポーカーを利用できません。',
  'hudChrome.pokerPlaytest.error.invalid_action': 'そのアクションは選択できません。',
  'hudChrome.pokerPlaytest.error.insufficient_funds':
    '参加またはリバイするにはCopperが足りません。',
  'hudChrome.pokerPlaytest.error.participation_suspended':
    'このアカウントのポーカー参加は停止されています。',
  'hudChrome.pokerPlaytest.error.invalidAmount': '許可された範囲の整数を入力してください。',
  'hudChrome.pokerPlaytest.error.rebuy_not_allowed': '現在はリバイできません。',
  'hudChrome.pokerPlaytest.error.seat_conflict': 'その席はすでに使用されています。',
  'hudChrome.pokerPlaytest.error.stale_action': 'アクション到着前にハンドが更新されました。',
  'hudChrome.pokerPlaytest.error.table_not_found': 'そのポーカーテーブルは存在しません。',
  'hudChrome.pokerPlaytest.error.watch_conflict':
    '別のテーブルを観戦する前に現在のテーブルから退出してください。',
  'hudChrome.pokerPlaytest.chips': '{amount}チップ',
  'hudChrome.pokerPlaytest.pot': 'ポット: {amount}',
  'hudChrome.pokerPlaytest.noCards': 'カードなし',
  'hudChrome.pokerPlaytest.emptySeat': '空席',
  'hudChrome.pokerPlaytest.dealerButton': 'ディーラーボタン',
  'hudChrome.pokerPlaytest.dealerMarker': 'D',
  'hudChrome.pokerPlaytest.smallBlind': 'スモールブラインド',
  'hudChrome.pokerPlaytest.smallBlindMarker': 'SB',
  'hudChrome.pokerPlaytest.bigBlind': 'ビッグブラインド',
  'hudChrome.pokerPlaytest.bigBlindMarker': 'BB',
  'hudChrome.pokerPlaytest.yourTurn': 'あなたの手番です',
  'hudChrome.pokerPlaytest.winner': '{name}が{amount}獲得',
  'hudChrome.pokerPlaytest.winnerWithHand': '{name}が{hand}で{amount}獲得',
  'hudChrome.pokerPlaytest.highlightedHand': '{name}: {hand}',
  'hudChrome.pokerPlaytest.hand.highCard': 'ハイカード',
  'hudChrome.pokerPlaytest.hand.pair': 'ワンペア',
  'hudChrome.pokerPlaytest.hand.twoPair': 'ツーペア',
  'hudChrome.pokerPlaytest.hand.threeOfAKind': 'スリーカード',
  'hudChrome.pokerPlaytest.hand.straight': 'ストレート',
  'hudChrome.pokerPlaytest.hand.flush': 'フラッシュ',
  'hudChrome.pokerPlaytest.hand.fullHouse': 'フルハウス',
  'hudChrome.pokerPlaytest.hand.fourOfAKind': 'フォーカード',
  'hudChrome.pokerPlaytest.hand.straightFlush': 'ストレートフラッシュ',
  'hudChrome.pokerPlaytest.actionWithAmount': '{action} {amount}',
  'hudChrome.pokerPlaytest.action.fold': 'フォールド',
  'hudChrome.pokerPlaytest.action.check': 'チェック',
  'hudChrome.pokerPlaytest.action.call': 'コール',
  'hudChrome.pokerPlaytest.action.bet': 'ベット',
  'hudChrome.pokerPlaytest.action.raise': 'レイズ',
  'hudChrome.pokerPlaytest.action.all-in': 'オールイン',
  'hudChrome.pokerPlaytest.street.preflop': 'プリフロップ',
  'hudChrome.pokerPlaytest.street.flop': 'フロップ',
  'hudChrome.pokerPlaytest.street.turn': 'ターン',
  'hudChrome.pokerPlaytest.street.river': 'リバー',
