...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.interactPrompt.interact': '調べる',
  'hudChrome.interactPrompt.gather': '採取',
  'hudChrome.interactPrompt.enter': '入る',
  'hudChrome.interactPrompt.leave': '出る',
  'hudChrome.interactPrompt.name.lockedChest': '施錠された宝箱',
  'hudChrome.interactPrompt.name.rewardChest': '報酬の宝箱',
  'hudChrome.interactPrompt.name.reliquary': '水没した聖遺物箱',
  'hudChrome.interactPrompt.name.bellShrine': '鐘の祠',
  'hudChrome.interactPrompt.name.candleShrine': '蝋燭の祠',
  'hudChrome.interactPrompt.name.reedShrine': '葦の祠',
  'hudChrome.interactPrompt.name.skullShrine': '髑髏の祠',
  'hudChrome.options.showInteractPrompt': 'インタラクト表示を出す',
  'hudChrome.options.interactHighlight': 'カーソルを合わせた対象を強調',
};
