...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bank.depositAllTooltip':
    'カバン内の製作素材（ツールチップに「素材」と表示されるすべてのアイテム）をまとめて銀行に預けます。採集用道具、クエストアイテム、消耗品、灰色アイテムを含め、それ以外はすべてカバンに残ります。',
