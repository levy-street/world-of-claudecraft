...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'races.sectionTitle': '陣営と種族',
  'races.factionKael': 'ケール帝国',
  'races.factionVeth': 'ヴェス連合',
  'races.factionOssara': 'オッサラ領',
  'races.human': 'ヒューマン',
  'races.dwarf': 'ドワーフ',
  'races.gnome': 'ノーム',
  'races.elf_exile': '追放エルフ',
  'races.elf': 'エルフ',
  'races.dark_fae': 'ダークフェイ',
  'races.frost_kin': 'フロストキン',
  'races.shadow_walker': 'シャドウウォーカー',
  'races.desert_clan': '砂漠の氏族',
  'races.sand_mage': '砂の魔導士',
  'races.nomad': '遊牧民',
  'races.stone_warden': '石の守護者',
  'races.humanAria': '種族: ヒューマン',
  'races.dwarfAria': '種族: ドワーフ',
  'races.gnomeAria': '種族: ノーム',
  'races.elf_exileAria': '種族: 追放エルフ',
  'races.elfAria': '種族: エルフ',
  'races.dark_faeAria': '種族: ダークフェイ',
  'races.frost_kinAria': '種族: フロストキン',
  'races.shadow_walkerAria': '種族: シャドウウォーカー',
  'races.desert_clanAria': '種族: 砂漠の氏族',
  'races.sand_mageAria': '種族: 砂の魔導士',
  'races.nomadAria': '種族: 遊牧民',
  'races.stone_wardenAria': '種族: 石の守護者',
  'races.raceLabel': '種族',
  'races.racialLabel': '種族特性',
  'races.levelRaceClass': 'レベル{level} {race}{className}',
  'races.racialName_human': '上陸の誓い',
  'races.racialDesc_human': '休息経験値の蓄積が25%速くなる。',
  'races.racialName_dwarf': '石の血',
  'races.racialDesc_dwarf': '防御力が5%上昇する。',
  'races.racialName_gnome': '歯車の知恵',
  'races.racialDesc_gnome': '知力が5%上昇する。',
  'races.racialName_elf_exile': '流刑者の規律',
  'races.racialDesc_elf_exile': '詠唱の後退が20%軽減される。',
  'races.racialName_elf': '黄昏の優雅',
  'races.racialDesc_elf': '回避率が1%上昇する。',
  'races.racialName_dark_fae': '妖精の狡知',
  'races.racialDesc_dark_fae': 'クリティカル率が1%上昇する。',
  'races.racialName_frost_kin': '冬の皮膚',
  'races.racialDesc_frost_kin': 'スタミナが3%上昇する。',
  'races.racialName_shadow_walker': '静かなる刃',
  'races.racialDesc_shadow_walker': '敏捷性が3%上昇する。',
  'races.racialName_desert_clan': '陽鍛えの体',
  'races.racialDesc_desert_clan': '最大体力が3%上昇する。',
  'races.racialName_sand_mage': '硝子の調律',
  'races.racialDesc_sand_mage': '呪文威力が5%上昇する。',
  'races.racialName_nomad': '果てなき行進',
  'races.racialDesc_nomad': '精神が5%上昇する。',
  'races.racialName_stone_warden': '石切りの膂力',
  'races.racialDesc_stone_warden': '筋力が3%上昇する。',
  // Valdris continent (v0.19): item names
  'entities.items.dune_prowler_pelt.name': '砂丘の徘徊獣の毛皮',
  'entities.items.glasswind_stinger.name': 'ガラス風の毒針',
  'entities.items.stolen_relic.name': '盗まれた聖遺物',
  'entities.items.nameless_burial_shroud.name': '名もなき埋葬布',
  'entities.items.storm_glass_core.name': '嵐硝子の核',
  'entities.items.verdict_seal.name': '裁定の印章',
  'entities.items.glasswind_husk.name': 'ガラス風の甲殻',
  'entities.items.mirage_stalker_eye.name': '蜃気楼の忍び寄る者の眼',
  'entities.items.dig_manifest.name': '発掘目録',
  'entities.items.tomb_censer.name': '墓所の香炉',
  'entities.items.sentence_tablet.name': '宣告の石板',
  'entities.items.duststorm_heart.name': '砂塵嵐の心臓',
  'entities.items.ravager_hide.name': '蹂躙獣の皮',
  'entities.items.aqueduct_bronze.name': '水道橋の青銅金具',
  'entities.items.judge_regalia.name': '第一法廷の礼装',
  'entities.items.sunbleached_fang.name': '日に晒された牙',
  'entities.items.cracked_scarab_shell.name': 'ひび割れたスカラベの殻',
  'entities.items.emberjaw_pelt.name': '燃え顎の女族長の毛皮',
  'entities.items.karns_funeral_mask.name': 'カーンの葬送仮面',
  'entities.items.qesh_flatbread.name': 'ケシュの平焼きパン',
  'entities.items.oasis_waterskin.name': 'オアシスの水袋',
  'entities.items.spiced_scarab_skewer.name': 'スカラベの香辛串焼き',
  'entities.items.duneweave_robe.name': '砂丘織りのローブ',
  'entities.items.caravan_guard_hauberk.name': '隊商護衛のホーバーク',
  'entities.items.prowlerhide_vest.name': '徘徊獣革のベスト',
  'entities.items.sandwalker_treads.name': '砂歩きの沓',
  'entities.items.dunewatch_legguards.name': '砂丘見張りの脚甲',
  'entities.items.qesh_khopesh.name': 'ケシュのコペシュ',
  'entities.items.judgestaff_of_ossara.name': 'オッサラの裁き手の杖',
  'entities.items.glasswind_talon.name': 'ガラス風の鉤爪',
  'entities.items.emberjaw_prowlgrips.name': '燃え顎の狩猟グリップ',
  'entities.items.unburied_gravewraps.name': '埋葬されざる者の墓布',
  'entities.items.sandmaw_scale_cuirass.name': '砂顎の鱗の胸当て',
  'entities.items.tyrantfang_edge.name': '暴君牙の刃',
  'entities.items.palewidow_silk.name': '青白き寡婦の絹糸',
  'entities.items.waterlogged_ledger.name': '水浸しの台帳',
  'entities.items.guildless_sigil.name': 'ギルドなき者の印',
  'entities.items.silent_court_seal.name': '静寂法廷の印章',
  'entities.items.duskmane_pelt_strip.name': '黄昏鬣の毛皮の切れ端',
  'entities.items.palewidow_venom_sac.name': '青白き寡婦の毒嚢',
  'entities.items.quay_manifest.name': '水浸しの埠頭目録',
  'entities.items.wisplight_essence.name': 'ウィスプ光のエッセンス',
  'entities.items.drowned_toll_coin.name': '水没した通行銭',
  'entities.items.cutthroat_contract.name': '人斬りの契約書',
  'entities.items.court_ledger_page.name': '法廷台帳の一頁',
  'entities.items.frostpine_war_totem.name': 'フロストパインの戦のトーテム',
  'entities.items.rimeclaw_pelt.name': '霜爪の毛皮',
  'entities.items.duskmane_tuft.name': '黄昏鬣の房',
  'entities.items.guttering_wisp_mote.name': '揺らめくウィスプの粒',
  'entities.items.frostpine_charm.name': 'フロストパインのお守り',
  'entities.items.palefang_pelt.name': '静かなるペイルファングの毛皮',
  'entities.items.grelnoks_frozen_idol.name': 'グレルノクの凍てつく神像',
  'entities.items.nighthollow_black_bread.name': 'ナイトホロウの黒パン',
  'entities.items.pinefrost_tea.name': '松霜の茶',
  'entities.items.smoked_blackmere_eel.name': 'ブラックミアの燻製ウナギ',
  'entities.items.wispweave_robe.name': 'ウィスプ織りのローブ',
  'entities.items.quayguard_hauberk.name': '埠頭衛兵のホーバーク',
  'entities.items.duskstalker_vest.name': '黄昏の追跡者のベスト',
  'entities.items.nightpath_treads.name': '夜道の沓',
  'entities.items.blackriver_legguards.name': '黒河の脚甲',
  'entities.items.terracewatch_leggings.name': '段丘見張りのレギンス',
  'entities.items.quays_cutlass.name': '埠頭のカットラス',
  'entities.items.wispcaller_staff.name': 'ウィスプ呼びの杖',
  'entities.items.whispersteel_stiletto.name': '囁鋼のスティレット',
  'entities.items.palefang_grips.name': 'ペイルファングのグリップ',
  'entities.items.hoarbound_bindings.name': '霜縛りの拘束具',
  'entities.items.forsworn_lamellar.name': '誓約破りのラメラー鎧',
  'entities.items.forsworn_edge.name': '誓約破りの刃',
  'entities.items.stolen_tithe_ledger.name': '盗まれた十分の一税台帳',
  'entities.items.granite_core_shard.name': '花崗岩の核の欠片',
  'entities.items.legion_deserter_insignia.name': '軍団脱走兵の記章',
  'entities.items.chewed_tithe_scrip.name': '噛み跡のある税切符',
  'entities.items.candle_tax_tally.name': '蝋燭税の勘定札',
  'entities.items.assay_office_seal.name': '検定所の印章',
  'entities.items.legion_pay_manifest.name': '軍団給金目録',
  'entities.items.prime_wolf_pelt.name': '上等な狼の毛皮',
  'entities.items.wendigo_gallstone.name': 'ウェンディゴの胆石',
  'entities.items.icehowler_ruff.name': '氷吠えの襟毛',
  'entities.items.legion_quarrel_bundle.name': '軍団の太矢の束',
  'entities.items.clipped_imperial_coin.name': '刻まれた帝国硬貨',
  'entities.items.rimewoven_hide.name': '霜織りの獣皮',
  'entities.items.sellsword_pig_iron.name': '傭兵の銑鉄',
  'entities.items.lean_wolf_haunch.name': '痩せた狼のもも肉',
  'entities.items.pilfered_ration_pack.name': 'くすねられた糧食袋',
  'entities.items.sellsword_requisition_chit.name': '傭兵の徴発券',
  'entities.items.frostbrush_wolf_fang.name': 'フロストブラッシュの狼牙',
  'entities.items.bent_legion_buckle.name': '曲がった軍団のバックル',
  'entities.items.ogre_knuckle_dice.name': 'オーガの指骨サイコロ',
  'entities.items.hoarfang_pelt.name': 'ホーアファングの頭領の毛皮',
  'entities.items.kazriks_brass_whistle.name': 'カズリクの真鍮の笛',
  'entities.items.kaelspire_barley_loaf.name': 'カエルスパイアの大麦パン',
  'entities.items.silverbrook_spring_water.name': 'シルバーブルックの湧き水',
  'entities.items.imperial_field_ration.name': '帝国野戦糧食',
  'entities.items.imperial_clerks_robe.name': '帝国書記のローブ',
  'entities.items.kael_infantry_hauberk.name': 'カエル歩兵のホーバーク',
  'entities.items.wolfsward_hunting_jerkin.name': 'ウルフスワードの狩猟ジャーキン',
  'entities.items.tithe_road_marchboots.name': '十分の一税街道の行軍靴',
  'entities.items.imperial_marcher_legguards.name': '帝国行軍兵の脚甲',
  'entities.items.kael_arming_sword.name': 'カエルの騎士剣',
  'entities.items.frosthelm_warstaff.name': 'フロストヘルムの戦杖',
  'entities.items.wolfsward_skinner.name': 'ウルフスワードの皮剥ぎ刀',
  'entities.items.prefects_sealed_mantle.name': '長官の封印マント',
  'entities.items.huntmasters_winter_hood.name': '狩猟長の冬用フード',
  'entities.items.hoarfang_clawgrips.name': 'ホーアファングの鉤爪グリップ',
  'entities.items.overseers_candlewraps.name': '監督官の蝋燭包帯',
  'entities.items.oathbreakers_battleplate.name': '誓約破棄者の戦鎧',
  'entities.items.oathbreakers_greatblade.name': '誓約破棄者の大剣',
  'entities.items.grey_shale_chip.name': '灰色頁岩の欠片',
  'entities.items.smuggled_trinket.name': '密輸された小物',
  'entities.items.barbed_thorn_husk.name': '棘だらけの莢',
  'entities.items.thornfen_tusk.name': 'ソーンフェンのトロルの牙',
  'entities.items.torn_caravan_banner.name': '引き裂かれた隊商の旗',
  'entities.items.ironpass_rubble_core.name': 'アイアンパスの瓦礫の核',
  'entities.items.wyvern_tail_barb.name': 'ワイバーンの尾針',
  'entities.items.reagent_gland.name': '試薬で膨れた腺',
  'entities.items.fogged_lantern_glass.name': '曇ったランタンの硝子',
  'entities.items.river_worn_idol.name': '川で磨かれた神像',
  'entities.items.gull_picked_bone.name': 'カモメに啄まれた骨',
  'entities.items.underway_hardtack.name': '地下道の堅パン',
  'entities.items.smugglers_black_brew.name': '密輸業者の黒い醸造酒',
  'entities.items.thornberry_loaf.name': '茨の実のパン',
  'entities.items.palisade_pine_tea.name': '柵壁の松の茶',
  'entities.items.tollhouse_stew.name': '料金所のシチュー',
  'entities.items.ironpass_mulled_cider.name': 'アイアンパスの温スパイスサイダー',
  'entities.items.lanternfen_eel_skewer.name': 'ランタンフェンのウナギ串',
  'entities.items.fogberry_tonic.name': '霧の実の強壮剤',
  'entities.items.bridgewatch_rations.name': '橋見張りの糧食',
  'entities.items.nameless_river_water.name': '名もなき川の水',
  'entities.items.smuggler_kings_softsteps.name': '密輸王の忍び足',
  'entities.items.briarfather_bark_mitts.name': '茨の父の樹皮ミトン',
  'entities.items.skarns_war_harness.name': 'スカーンの戦装具',
  'entities.items.colossus_mireheart_girdle.name': '泥心の帯',
  'entities.items.bridgekeepers_tollstaff.name': '橋守の通行杖',
  'entities.items.melted_ration_tin.name': '溶けた糧食缶',
  'entities.items.ashcaked_fang.name': '灰にまみれた牙',
  'entities.items.ember_glass_shard.name': '燠火硝子の欠片',
  'entities.items.saltglass_shard.name': '塩硝子の欠片',
  'entities.items.salt_crusted_chitin.name': '塩の甲殻',
  'entities.items.bleached_bone_charm.name': '漂白された骨のお守り',
  'entities.items.tarnished_prewar_coin.name': 'くすんだ戦前の硬貨',
  'entities.items.sewer_silk_wad.name': '下水道の絹の塊',
  'entities.items.gutter_hound_pelt.name': 'どぶ犬の毛皮',
  'entities.items.cracked_salamander_scale.name': 'ひび割れたサラマンダーの鱗',
  'entities.items.cooled_magma_bead.name': '冷えた溶岩の玉',
  'entities.items.slag_nugget.name': '鉱滓の塊',
  'entities.items.rusted_deserter_badge.name': '錆びた脱走兵の記章',
  'entities.items.redspire_rock_shard.name': 'レッドスパイアの岩の欠片',
  'entities.items.spire_stalker_claw.name': '尖塔の忍び寄る者の鉤爪',
  'entities.items.cinderrest_ashcake.name': 'シンダーレストの灰菓子',
  'entities.items.boiled_cistern_water.name': '煮沸した貯水槽の水',
  'entities.items.brinehollow_salt_jerky.name': 'ブラインホロウの塩漬け干し肉',
  'entities.items.desalted_waterskin.name': '脱塩した水袋',
  'entities.items.gutter_stew.name': '流刑市場のどぶシチュー',
  'entities.items.black_market_tea.name': '闇市場の茶',
  'entities.items.forgefall_hardtack.name': 'フォージフォールの堅パン',
  'entities.items.coalfire_stout.name': '石炭火のスタウト',
  'entities.items.waymeet_marching_bread.name': 'ウェイミートの行軍パン',
  'entities.items.bitterroot_brew.name': '苦根の醸造酒',
  'entities.items.revenant_cinderguard.name': '亡霊の灰守鎧',
  'entities.items.marrowhide_leggings.name': '髄皮のレギンス',
  'entities.items.scavenger_kings_shiv.name': '漁り王の手製ナイフ',
  'entities.items.forgewyrm_scale_helm.name': '鍛冶ワームの鱗兜',
  'entities.items.mantle_of_the_last_muster.name': '最終召集のマント',
  'entities.items.scorched_banner_scrap.name': '焦げた旗の切れ端',
  'entities.items.melted_signet_ring.name': '溶けた印章指輪',
  'entities.items.cracked_horror_horn.name': 'ひび割れた恐怖の角',
  'entities.items.bastion_hardtack.name': 'バスティオンの堅パン',
  'entities.items.trucewater_flask.name': '休戦の水筒',
  'entities.items.ashguard_robe.name': '灰守のローブ',
  'entities.items.breachwalker_jerkin.name': '裂け目歩きのジャーキン',
  'entities.items.bastion_plated_hauberk.name': 'バスティオンの板金ホーバーク',
  'entities.items.bastion_arming_sword.name': 'バスティオンの騎士剣',
  'entities.items.mercenary_greatblade.name': '傭兵の大剣',
  'entities.items.tithe_collectors_grasps.name': '十分の一税徴収人の篭手',
  'entities.items.craterheart_mantle.name': 'クレーター心のマント',
  'entities.items.butchers_chainguard.name': '屠殺者の鎖帷子',
  ...
  'hudChrome.envoys.title': '使節の広間',
  'hudChrome.envoys.prompt': '陣営と、共に立つ民を選べ。',
  'hudChrome.envoys.permanent':
    'この誓いは取り消せない。陣営が故郷と味方、そして永遠の戦争での敵を決める。',
  'hudChrome.envoys.confirm': '誓いを立てる',
  'hudChrome.envoys.travelTitle': '渡航',
  'hudChrome.envoys.travelBody': '今すぐ渡航するか？移動は一瞬だ。',
  'hudChrome.envoys.travelGo': '渡航する',
  'hudChrome.envoys.travelStay': 'とどまる',
  'hudChrome.defense.start': '戦線を守れ！守り手が構えている。',
  'hudChrome.defense.wave': '第{wave}波を撃退（全{total}波）！',
  ...
  'entities.items.forged_levy_papers.name': '偽造された徴募書類',
  'entities.items.amnesty_petition.name': '未受理の恩赦請願書',
  'entities.items.fort_pattern_kettle.name': '砦規格のやかん',
  'entities.items.garnished_pay_pouch.name': '差し押さえられた給金袋',
  'entities.items.fault_line_core.name': '断層の核',
  'entities.items.unstamped_duel_permit.name': '未捺印の決闘許可証',
  'entities.items.rimeclaw_tallow.name': '霜爪獣の獣脂',
  'entities.items.rimeclaw_marrowbone.name': '霜爪獣の髄骨',
  'entities.items.oathguard_plate_scrap.name': '誓約衛士の板金片',
  'entities.items.ninth_muster_roll.name': '回収された召集名簿',
  'entities.items.icehowler_haunch.name': '氷咆哮獣のもも肉',
  'entities.items.rimebound_core_ice.name': '霜縛りの核氷',
  'entities.items.glacial_quench_ice.name': '氷河焼き入れの氷',
  'entities.items.maren_calling_card.name': 'マレン家の名刺',
  'entities.items.maldreks_route_ledger.name': 'マルドレクの経路台帳',
  'entities.items.grulks_iron_strongbox.name': 'グルルクの鉄金庫',
  'entities.items.maren_duelling_mantle.name': 'マレン決闘マント',
  'entities.items.final_notice_wraps.name': '最終通告の巻き布',
  'entities.items.pay_wardens_shoulderguards.name': '給金看守の肩当て',
  'entities.items.rimeshaft_foremans_cap.name': 'ライムシャフト現場頭の帽子',
  'entities.items.quarter_close_vestments.name': '四半期決算の祭服',
  'entities.items.assessors_lead_greaves.name': '査定官の鉛の脛当て',
  'entities.items.purse_wardens_coinbelt.name': '金袋看守の硬貨ベルト',
  'entities.items.mothwing_dust.name': '蛾の羽の粉',
  'entities.items.silt_eel.name': '泥ウナギ',
  'entities.items.barge_chit.name': 'ふやけたはしけの札',
  'entities.items.ferry_lantern_mote.name': '渡し船の灯りの粒',
  'entities.items.smugglers_tally_knot.name': '密輸人の勘定結び',
  'entities.items.forged_weir_pass.name': '偽造された堰の通行証',
  'entities.items.sunken_ration_tin.name': '沈んだ配給缶',
  'entities.items.hollow_toll_scrip.name': '空手形の通行料切符',
  'entities.items.rimeclaw_haunch.name': '霜爪獣のもも肉',
  'entities.items.rimebound_fetish.name': '霜縛りの呪物',
  'entities.items.frostpine_tallow.name': '霜松の獣脂',
  'entities.items.forsworn_oath_knife.name': '背誓者の誓いの短刀',
  'entities.items.shadowbound_cipher.name': '影縛りの暗号文',
  'entities.items.vessiks_little_book.name': 'ヴェシクの小さな帳面',
  'entities.items.weirwatch_wraps.name': '堰見張りの巻き布',
  'entities.items.lodgewalk_boots.name': '山荘路の長靴',
  'entities.items.unbroken_wardstone.name': '無傷の守り石',
  'entities.items.vault_ward_core.name': '地下庫の守り核',
  'entities.items.temple_offering_bowl.name': '神殿の供物鉢',
  'entities.items.graven_name_stone.name': '名を刻んだ石',
  'entities.items.stalker_haunch.name': '忍び寄る者のもも肉',
  'entities.items.heretic_creed_page.name': '焼けた信条の頁',
  'entities.items.heretic_brand_iron.name': '異端者の焼き印ごて',
  'entities.items.heretic_writ.name': '異端の判決文',
  'entities.items.first_court_sigil.name': '第一法廷の印章',
  'entities.items.duneglass_heart.name': '砂丘ガラスの心臓',
  'entities.items.unshattered_fulgurite.name': '砕けていない閃電岩',
  'entities.items.flameseer_ash_creed.name': '灰の信条の石板',
  'entities.items.flameseer_ember_phial.name': '燠火の小瓶',
  'entities.items.dawnward_censer.name': '暁警めの香炉',
  'entities.items.stolen_water_cask.name': '封印された水樽',
  'entities.items.duskwater_oathmark.name': '宵水の誓印',
  'entities.items.caravan_toll_tally.name': '封印された通行料の割符',
  'entities.items.tyrant_spoor.name': '暴君の足跡の鋳型',
  'entities.items.oxbone_toll.name': '牛骨の通行料割符',
  'entities.items.cartographers_map.name': '初代地図師の地図',
  'entities.items.templestone_shard.name': '神殿石のかけら',
  'entities.items.fulgurite_splinter.name': '閃電岩の破片',
  'entities.items.charred_censer_chain.name': '焦げた香炉の鎖',
  'entities.items.wardens_stone_heart.name': 'アシュケラトの石の心臓',
  'entities.items.first_meridian_compass.name': '第一子午線の羅針盤',
  'entities.items.seatstone_flatbread.name': '座石の平パン',
  'entities.items.seatwell_waterskin.name': '座井戸の水袋',
  'entities.items.lastwater_jerky.name': 'ラストウォーターの干し肉',
  'entities.items.lastwater_skin.name': 'ラストウォーターの水袋',
  'entities.items.vaultkeepers_handwraps.name': '地下庫番の手甲布',
  'entities.items.sahrs_penitent_leggings.name': 'サールの苦行者レギンス',
  'entities.items.wardens_granite_edge.name': '監視者の花崗岩の刃',
  'entities.items.staff_of_the_sunken_court.name': '沈んだ法廷の杖',
  'entities.items.duneglass_shiv.name': '砂丘ガラスの刺し刀',
  'entities.items.lastwater_roadmail.name': 'ラストウォーターの旅路鎖帷子',
  'entities.items.duskwatch_robe.name': '宵闇見張りのローブ',
  'entities.items.raiders_dust_jerkin.name': '略奪者の砂塵胴衣',
  'entities.items.ashkerat_greaves.name': 'アシュケラトの脛当て',
  'entities.items.cartographers_windwraps.name': '地図師の風巻き布',
  'entities.items.unlit_silk_gland.name': '光なき絹腺',
  'entities.items.veskals_fang.name': 'ヴェスカルの牙',
  'entities.items.broodmother_carapace_guard.name': '巣母の甲殻胸当て',
  'entities.items.condensed_mist_heart.name': '凝縮した霧の心臓',
  'entities.items.mistfathers_knot.name': '霧の父の結び目',
  'entities.items.fogwalker_treads.name': '霧渡りの沓',
