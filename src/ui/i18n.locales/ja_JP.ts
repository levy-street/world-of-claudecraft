...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.mounts.title': 'マウント',
  'hud.mounts.subtitle': '$WOC 旅の駿馬',
  'hud.mounts.close': 'マウントを閉じる',
  'hud.mounts.summon': '召喚',
  'hud.mounts.dismount': '降りる',
  'hud.mounts.summoning': '{name}を召喚中…',
  'hud.mounts.riding': '騎乗中',
  'hud.mounts.flies': '飛行可能',
  'hud.mounts.locked': '未解放',
  'hud.mounts.speed': '+{percent}% 速度',
  'hud.mounts.unlockAt': '{amount} $WOC で解放',
  'hud.mounts.supplyShare': '総供給量の{percent}',
  'hud.mounts.qualifyHeader': 'あなたは{total}体中{count}体の旅マウントの資格を満たしています。',
  'hud.mounts.holdingHint': '{amount} $WOC を保有中。',
  'hud.mounts.noWallet':
    '連携した財布で少なくとも{amount} $WOC、総供給量の0.1%を保有して、最初の旅マウントを手に入れましょう。',
  'hud.mounts.cantInCombat': '戦闘中は騎乗できません。',
  'hud.mounts.cantSwimming': '水泳中は騎乗できません。',
  'hud.mounts.cantDead': '死亡中は騎乗できません。',
  'hud.mounts.notEligible': 'あなたの $WOC 保有量はまだその駿馬に届きません。',
  'hud.mounts.summonedBanner': '{name}を召喚した。',
  'hud.mounts.summonAria': '{name}を召喚',
  'hud.mounts.dismountAria': '{name}から降りる',
  'hud.mounts.lockedAria': '{name} — 未解放。{amount} $WOC で解放',
  'hud.mounts.activeAria': '{name} — 現在使用中',
  'hud.mounts.owned': '所有済み',
  'hud.mounts.mint': 'チャーターを発行',
  'hud.mounts.mintHint':
    'このマウントの取引可能なチャーターを打ち出す — ゴールドで売れば、非保有者がそれを手に入れられます。',
  'hud.mounts.mintAria': '{name}の取引可能なチャーターを発行',
  'hud.mounts.mintedBanner': '{name}のチャーターを打ち出した。',
  'hud.mounts.earnedBanner': '{name}を獲得した — 永久にあなたのものだ。',
  'hud.mounts.alreadyOwnErr': 'そのマウントはすでに所有しています。',
  'hud.mounts.charterVoidErr': 'そのチャーターは無効です。',
  'hud.mounts.noCharterErr': 'そのマウントにはチャーターを打ち出せません。',
  'hud.mounts.holdingsShortErr': 'あなたの保有量ではそのマウントに届きません。',
  'hud.course.skytrials': 'スカイトライアル',
  'hud.course.skytrialsHint': '飛行マウントでタイム制のリングコースを飛びます。',
  'hud.course.needFlyer': 'スカイトライアルを飛ぶには飛行マウントを召喚してください。',
  'hud.course.laps': '{count}周',
  'hud.course.starting': '最初のリングを通り抜けて計測を開始',
  'hud.course.finish': 'フィニッシュ！',
  'hud.course.failed': '走行終了 — マウントを離れました',
  'hud.course.aborted': '走行を放棄しました',
  'hud.course.newBest': '自己ベスト更新！',
  'hud.course.board': 'ボード',
  'hud.course.boardTitle': '{name} — トップタイム',
  'hud.course.noTimes': 'まだ記録がありません — 最初の一人になろう。',
  'hud.course.loadingBoard': '読み込み中…',
  'hud.course.racePartyHint': 'パーティと競争 — 最初にリングを抜けた者が勝つ。',
  'hud.course.getReady': '準備せよ',
  'hud.course.racing': 'レース中',
  'hud.wager.start': '賭けレース',
  'hud.wager.title': '賭けレース',
  'hud.wager.inviteGold': '{name}が賭けレースを開いた — 参加には{money}を賭ける。応じるか？',
  'hud.wager.inviteCharter':
    '{name}が賭けレースを開いた — {money}＋マウントチャーターを賭ける。応じるか？',
  'hud.wager.accept': '賭けに応じる',
  'hud.wager.potCharter': '賞金{money}＋チャーター{count}×',
  'hud.wager.racers': 'レーサー（{count}）',
  'hud.wager.launch': 'レース開始',
  'hud.wager.cancel': 'キャンセル',
  'hud.wager.leave': '退出',
  'hud.wager.waiting': '賭けに応じる挑戦者を待っています…',
  'hud.wager.won': '賭けに勝った — {money}！',
  'hud.wager.wonCharter': '賭けに勝った — {money}＋チャーター{count}×！',
  'hud.wager.lost': '賭けに負けた。',
  'hud.wager.refunded': '賭けは取りやめ — あなたの賭け金は返還された。',
  'hud.wager.antePrompt': 'このレースにゴールドをいくら賭けますか？（カッパー単位）',
  'hud.wager.open': '賭けを開く',
  'hud.wager.stakeCharter': 'マウントチャーターも賭ける（勝者が獲得）',
  'hud.wager.errCourse': 'そのコースでは賭けられません。',
  'hud.wager.errFlyer': '賭けるには飛行マウントに乗っていなければなりません。',
  'hud.wager.errBusy': 'あなたはすでに賭けの最中です。',
  'hud.wager.errAnte': '少なくとも1カッパーの賭けを指定してください。',
  'hud.wager.errStake': 'それは賭けに出せません。',
  'hud.wager.errAfford': 'その賭けを賄えません。',
  'hud.wager.errExpired': 'その賭けの申し出は期限切れです。',
  'hud.wager.errGone': 'その賭けはもう開かれていません。',
  'hud.wager.errHost': '賭けを開始できるのはホストのみです。',
  'entities.items.charter_ashmane.name': 'チャーター：灰鬣の駿馬アッシュメイン',
  'entities.items.charter_emberhoof.name': 'チャーター：燃蹄の軍馬エンバーフーフ',
  'entities.items.charter_bronzeflank.name': 'チャーター：青銅脇の戦馬ブロンズフランク',
  'entities.items.charter_silvermane.name': 'チャーター：銀鬣の牡馬シルバーメイン',
  'entities.items.charter_stormhoof.name': 'チャーター：嵐蹄の軍馬ストームフーフ',
  'entities.items.charter_goldcrest.name': 'チャーター：金冠の天駆けゴールドクレスト',
  'entities.items.charter_verdant.name': 'チャーター：翠緑の野翼ヴァーダント',
  'entities.items.charter_voidstrider.name': 'チャーター：虚空翼の闊歩者ヴォイドウィング',
  'entities.items.charter_celestial.name': 'チャーター：天上の熾天セレスティアル',
  'entities.items.charter_worldbearer.name': 'チャーター：世界を背負う大鷲ワールドベアラー',
  'entities.npcs.skytrial_master.name': 'スカイマスター・ヴァエル',
  'entities.npcs.skytrial_master.title': 'スカイトライアルの守護者',
  'entities.npcs.skytrial_master.greeting':
    '空とは、あえて歩もうとする者の少ない道だ、{className}よ。それを勝ち取れば、空がお前を運んでくれる。',
  'entities.quests.q_skyward_first_flight.title': '初飛行',
  'entities.quests.q_skyward_first_flight.text':
    'お前は地上では翼ある駿馬をそれなりに乗りこなしている、{playerName}よ — さあ、それを空へ上げてみせろ。ヴェイル・スカイトライアルを飛ぶのだ。ひと巡りの周回で八つのリングを抜ける。まだタイムを追うな。ただ空に留まり、すべてのリングを糸のように通り抜けよ。',
  'entities.quests.q_skyward_first_flight.completion':
    '落ちなかったな。初めての周回でそれをやり遂げる者はそう多くない。空は、何度も戻ってくる者を覚えている。',
  'entities.quests.q_skyward_first_flight.objectives.0.label': 'ヴェイル・スカイトライアル完走',
  'entities.quests.q_skyward_time_trial.title': '時計を打ち破れ',
  'entities.quests.q_skyward_time_trial.text':
    '今度は意志をもってやり遂げろ。もう一度ヴェイル・スカイトライアルを飛ぶのだ、{playerName}よ。だが砂が尽きる前に飛び終えよ。すべてのリングを貫く一筋の澄んだ軌道、無駄な空気は一切なし。慌てるな、精密にやれ。',
  'entities.quests.q_skyward_time_trial.completion':
    'リングからリングへ、一筋の澄んだ軌道。お前はもう空に乗っているのではない — 空を飛んでいるのだ。',
  'entities.quests.q_skyward_time_trial.objectives.0.label':
    'ヴェイル・スカイトライアルを規定タイム以内で飛行',
  'entities.quests.q_skyward_ascendant.title': '天翔ける者',
  'entities.quests.q_skyward_ascendant.text':
    '残る試練はただ一つ、{playerName}よ。ヴェイル・サーキットだ。長きリングを三周、規定タイム以内で飛び切れ — 運ではなく、ただ技だけで。それを極めれば、果てから果てまで、広き空はお前のものだ。',
  'entities.quests.q_skyward_ascendant.completion':
    '天高く、揺るぎなく。空は今やお前のものだ、{playerName}よ。このチャーターを取れ — 買ったのではなく勝ち取った空の駿馬、お前が目指すどこへでもお前を運ぶだろう。',
  'entities.quests.q_skyward_ascendant.objectives.0.label':
    'ヴェイル・サーキットを規定タイム以内で飛行',

  // Skytrial course + race HUD short labels (par/lap/ring/time/place/pot).
  'hud.mounts.cardAria': '{name}: {flavor}',
  'hud.course.start': '飛ぶ',
  'hud.course.give_up': 'あきらめる',
  'hud.course.par': '基準タイム {time}',
  'hud.course.onePass': '1周',
  'hud.course.gate': 'リング {n}/{total}',
  'hud.course.lap': 'ラップ {n}/{total}',
  'hud.course.time': 'タイム',
  'hud.course.beatPar': '基準タイムを {time}短縮',
  'hud.course.offPar': '基準タイムから {time} 遅れ',
  'hud.course.best': 'ベスト {time}',
  'hud.course.you': '(あなた)',
  'hud.course.race': 'レース',
  'hud.course.go': 'GO!',
  'hud.course.dnf': 'リタイア',
  'hud.course.placeOf': '{total}人中 #{place}位',
  'hud.wager.pot': '賞金 {money}',
  ...
  'character.mintSolHint':
    'プレイヤー所有の‹名前›.worldofclaudecraft.solを{amount} $WOCでミント。オンチェーンであなたのものに。',
  ...
  'woc.finalizeTimeout':
    'ファイナライズ待ちがタイムアウトしました。$WOCがバーン済みの場合は再度開いてやり直してください。支払いはファイナライズ後に確定します。',
  'woc.renameSuccess': '{name}に改名しました。',
  'woc.mintSuccess': '{domain}をミントしました。オンチェーンであなたのものです。',
  'woc.guildRenameSuccess': 'ギルド名を{name}に変更しました。',
  'woc.reserveSuccess': '{name}の名前を予約しました。',
  'walletPanel.title': 'ウォレット',
  'walletPanel.closeAria': '閉じる',
  'walletPanel.notConnected': 'ウォレット未接続',
  'walletPanel.connect': '接続',
  'walletPanel.connectedStatus': '接続済み {address}',
  'walletPanel.linkedBadge': 'リンク済み',
  'walletPanel.tabSend': '送金',
  'walletPanel.tabHire': '雇用',
  'walletPanel.tabJobs': '依頼',
  'walletPanel.sendSection': 'プレイヤーに送金',
  'walletPanel.currency': '通貨',
  'walletPanel.playerName': 'プレイヤー名',
  'walletPanel.recipientPlaceholder': '誰に送りますか？',
  'walletPanel.amount': '金額',
  'walletPanel.max': '最大',
  'walletPanel.balanceEmpty': '残高: -',
  'walletPanel.balanceLoading': '残高: …',
  'walletPanel.balanceUnavailable': '残高: 取得できません',
  'walletPanel.balance': '残高: {amount}',
  'walletPanel.balanceExceeds': '残高: {amount}（残高超過）',
  'walletPanel.connectForBalance': '残高を見るにはウォレットを接続してください。',
  'walletPanel.sendNote':
    'Solana上でウォレット間で直接送金されます。非カストディアル: ゲームが資金を預かることはありません。ネットワーク手数料がかかります。',
  'walletPanel.send': '送金',
  'walletPanel.sending': '送金中…',
  'walletPanel.loginToSend': 'プレイヤーに送金するにはログインしてワールドに入ってください。',
  'walletPanel.lookingUp': 'プレイヤーを検索中…',
  'walletPanel.ownWallet': '（これはあなた自身のウォレットです）',
  'walletPanel.noVerifiedWallet': 'その名前のプレイヤーには認証済みウォレットがありません。',
  'walletPanel.approveTransfer': 'ウォレットで送金を承認してください…',
  'walletPanel.sent': '{name}に{amount} {currency}を送金しました。',
  'walletPanel.viewTransaction': 'トランザクションを見る',
  'walletPanel.sendFailedWith': '送金失敗: {message}',
  'walletPanel.sendFailed': '送金に失敗しました。',
  'walletPanel.hireSection': 'ヘルパーを雇う',
  'walletPanel.hireOffline': 'ヘルパーを雇うにはオンラインでワールドに入ってください。',
  'walletPanel.helperPlaceholder': '誰に手伝ってもらいますか？',
  'walletPanel.rewardCurrency': '報酬通貨',
  'walletPanel.reward': '報酬',
  'walletPanel.goalLabel': '目標、サーバーが確認すると支払われます',
  'walletPanel.goalReachLevel': 'レベル到達',
  'walletPanel.goalClearDungeon': 'レイド攻略',
  'walletPanel.goalQuest': 'クエスト',
  'walletPanel.goalBodyguard': 'ボディガード',
  'walletPanel.goalEscort': '護衛',
  'walletPanel.targetLevel': '目標レベル',
  'walletPanel.targetLevelPlaceholder': '2から20',
  'walletPanel.raidDungeon': 'レイド / ダンジョン',
  'walletPanel.questOwn': 'クエスト（受注中のもの）',
  'walletPanel.noActiveQuests':
    '手伝いを頼める進行中のクエストがありません。まず受注してください。',
  'walletPanel.protectMinutes': '護衛時間（分）',
  'walletPanel.minutesPlaceholder': '例: 10',
  'walletPanel.escortDestination': '護衛の目的地',
  'walletPanel.useCurrentSpot': '現在地を使う',
  'walletPanel.destinationSet': '目的地設定済み: ({x}, {z})',
  'walletPanel.noDestination': '目的地はまだ設定されていません。',
  'walletPanel.destinationHint':
    '目的地 ({x}, {z})、移動した後、ガードにここへ連れ戻してもらいましょう。',
  'walletPanel.hireLogin': 'プレイヤーを雇うにはオンラインでワールドに入ってください。',
  'walletPanel.escrowNote':
    '報酬はオンチェーンのエスクローにロックされ、サーバーが目標を確認すると自動的にヘルパーへ支払われます。期限までに達成されなければあなたに返金されます。',
  'walletPanel.post': '報酬を投稿してロック',
  'walletPanel.posting': '投稿中…',
  'walletPanel.setGoalFirst': 'まず有効な目標を設定してください。',
  'walletPanel.preparingEscrow': 'エスクローを準備中…',
  'walletPanel.approveDeposit': 'ウォレットで報酬の入金を承認してください…',
  'walletPanel.lockingReward': '報酬をオンチェーンでロック中…',
  'walletPanel.waitingFinalization': 'ファイナライズを待機中…',
  'walletPanel.confirmTimeout':
    '入金の確認がタイムアウトしました。報酬がロック済みの場合は、ファイナライズ後に確定します。',
  'walletPanel.jobPosted':
    '依頼を投稿しました: {amount} {currency}を{name}のためにエスクローにロックしました。',
  'walletPanel.postFailed': '依頼の投稿に失敗しました。',
  'walletPanel.failedWith': '失敗: {message}',
  'walletPanel.jobsSection': 'あなたの依頼',
  'walletPanel.loading': '読み込み中…',
  'walletPanel.jobsOffline': '依頼を管理するにはオンラインでワールドに入ってください。',
  'walletPanel.jobsEmpty': 'まだ依頼はありません。雇用タブでプレイヤーに手伝いを依頼しましょう。',
  'walletPanel.youHired': '{name}を雇いました',
  'walletPanel.hiredYou': '{name}があなたを雇いました',
  'walletPanel.acceptJob': '依頼を受ける',
  'walletPanel.cancelRefund': 'キャンセルして返金',
  'walletPanel.viewPayout': '支払いを見る',
  'walletPanel.actionFailed': '操作に失敗しました。',
  'walletPanel.status.awaitingDeposit': 'あなたの入金待ち',
  'walletPanel.status.offered': 'あなたへの依頼、受けると開始します',
  'walletPanel.status.open': '公開中、ヘルパーの承諾待ち',
  'walletPanel.status.active': '進行中',
  'walletPanel.status.completed': '完了、ヘルパーに支払い済み',
  'walletPanel.status.expired': '期限切れ、返金済み',
  'walletPanel.status.failedDied': '失敗（あなたが死亡）、返金済み',
  'walletPanel.status.cancelled': 'キャンセル、返金済み',
  'walletPanel.status.refunded': '返金済み',
};
