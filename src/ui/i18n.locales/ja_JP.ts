...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.limitedRelicSupply': '限定遺物：世界に {count} 個のみ',
  'hudChrome.limitedRelicSerial': '遺物 {serial} / {supply}',
  'hudChrome.limitedRelicClaim': '{name} が {item} を手に入れた。遺物 {serial} / {supply}。',
  ...
  'entities.items.emberfall_edge.name': '燼落の刃',
  'entities.items.crown_of_the_thornpeak_scourge.name': '荊峰の災厄の冠',
  'entities.items.thunzharrs_stormheart.name': 'サンザールの嵐の心臓',
  'entities.items.sealed_vault_signet_crypt.name': '虚ろな地下墓所の封印指輪',
  'entities.items.sealed_vault_signet_bastion.name': '沈んだ砦の封印指輪',
  'entities.items.sealed_vault_signet_temple.name': '水没した神殿の封印指輪',
  'entities.items.sealed_vault_signet_sanctum.name': '墓竜の聖所の封印指輪',
