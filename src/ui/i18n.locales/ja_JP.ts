...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaEnd.victory': '勝利',
  'hudChrome.arenaEnd.defeat': '敗北',
  'hudChrome.arenaEnd.draw': '引き分け',
  'hudChrome.arenaEnd.colName': '名前',
  'hudChrome.arenaEnd.colKills': 'キル',
  'hudChrome.arenaEnd.colDamage': '与ダメージ',
  'hudChrome.arenaEnd.colHealing': '回復量',
  'hudChrome.arenaEnd.colRating': 'レーティング',
  'hudChrome.arenaEnd.colChange': '変動',
  'hudChrome.arenaEnd.yourRating': 'あなたのレーティング：{before} から {after}',
  'hudChrome.arenaEnd.honorEarned': '+{honor} 名誉',
  'hudChrome.arenaEnd.leave': '退出',
  'hudChrome.arenaEnd.close': '閉じる',
