...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.enchantName.enchant_weapon_lucent_might': '武器エンチャント - 光輝の剛力',
  'hudChrome.enchantName.enchant_weapon_lucent_spellpower': '武器エンチャント - 光輝の呪文威力',
  'hudChrome.enchantName.enchant_chest_lucent_stamina': '胸エンチャント - 光輝のスタミナ',
  'hudChrome.enchantName.enchant_feet_lucent_agility': '足エンチャント - 光輝の敏捷性',
  ...
  'hudChrome.materialHint.wyrmfallCore':
    '名匠鍛造の製作触媒。レイドの最終ボスは難易度ごとに1日1回、各プレイヤーに1から3個をドロップする。ヒロイックダンジョンの最終ボスはそれぞれ1日1回、各プレイヤーに1から3個をドロップする。その日最初のリフトレース勝利で、Aランクなら1個、Sランクなら2個を獲得できる。英雄補給係が英雄の証と引き換えに販売している。',
