...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'landing.heroEyebrow': '世界はすでに動いている',
  'landing.heroHeading': 'プレイヤーとAI冒険者が同じ世界に挑む、生きたクラシックMMO。',
  'landing.heroBody':
    'ブラウザで無料プレイ。9つのクラスから英雄を育てることも、実際のゲームでエージェントを訓練することもできます。',
  'landing.heroStatus': 'ワールドオンライン',
  'landing.heroPlayers': '人の登録冒険者',
  'landing.communityLinks': 'コミュニティリンク',
  'landing.followSocials': 'ソーシャルでフォロー',
  'landing.socialDiscord': 'Discordコミュニティ',
  'landing.socialTwitch': 'Twitch配信',
  'landing.socialInstagram': 'Instagram公式アカウント',
  'landing.socialReddit': 'Redditコミュニティ',
  'landing.browserCta': 'ブラウザでプレイ',
  'landing.playNowBody': 'ブラウザですぐにプレイできます。ダウンロードは不要です。',
  'landing.playWayBody': '好きなプラットフォームを選んで冒険に参加しよう。',
  'landing.syncProgress': 'すべてのプラットフォームで進行状況を同期',
  'landing.explore': '世界を探索',
  'landing.platformsEyebrow': 'いつでも冒険へ',
  'landing.appStoreAria': 'App StoreでWorld of ClaudeCraftをダウンロード',
  'landing.googlePlayAria': 'Google PlayでWorld of ClaudeCraftを入手',
  'landing.steamAria': 'World of ClaudeCraftはSteamで近日登場',
  'landing.comingSoon': '近日登場',
  'landing.introEyebrow': 'ひとつの世界、ひとつのルール',
  'landing.introHeading': 'すべての冒険者が本物のゲームをプレイする。',
  'landing.introBody':
    'ブラウザMMO、権威型オンラインワールド、AI訓練は、すべて同じ決定論的シミュレーションで動きます。プレイヤーとエージェントは、同じ戦闘、クエスト、ダンジョン、結果に直面します。',
  'landing.statClasses': '9つのプレイ可能クラス',
  'landing.statModes': 'オンラインとオフラインの世界',
  'landing.statBroadcast': '24時間年中無休のAI配信',
  'landing.statSource': 'オープンソース',
  'landing.worldEyebrow': 'Claudemoonを巡る旅',
  'landing.worldHeading': '長い道と危険な夜のために築かれた世界。',
  'landing.worldBody':
    'Eastbrook Valeの焚き火から始まり、呪われた地下墓地へ降り、嵐のThornpeakを登る。すべての道が、動き続ける世界のさらに奥へと続きます。',
  'landing.eastbrookTitle': 'イーストブルック渓谷',
  'landing.eastbrookBody': '最初のクエスト、さまよう敵、思いがけない仲間が交わる共有の辺境。',
  'landing.eastbrookAlt': '冒険者の一行がイーストブルック渓谷からソーンピーク高地へ続く長い道を旅している',
  'landing.hollowTitle': 'Hollow Crypt',
  'landing.hollowBody': '冷たい青い松明の下、群れ集う死者にパーティで立ち向かいます。',
  'landing.hollowAlt': 'Hollow Cryptで敵に立ち向かうパーティ',
  'landing.thornpeakTitle': 'ソーンピーク高地',
  'landing.thornpeakBody': '雲の上では、雪、古代遺跡、終盤の脅威が待ち受けます。',
  'landing.thornpeakAlt': 'Thornpeak Heightsに降る雪',
  'landing.classesEyebrow': '伝説を選べ',
  'landing.classesHeading': '9つの道、無数の戦い方。',
  'landing.classesBody':
    '盾の壁に立ち、炎と霜を操り、影から忍び寄り、あるいは仲間を守る。英雄を育て、専門分野を極め、その物語を共有世界へ持ち込みましょう。',
  'landing.streamEyebrow': '24時間年中無休で配信',
  'landing.streamNetwork': 'WOC配信ネットワーク',
  'landing.streamFeed': 'YUUMIII // ライブ映像',
  'landing.streamMonogram': 'Y',
  'landing.streamHeading': 'Yuumiiiは決してログアウトしない。',
  'landing.streamBody':
    'World of ClaudeCraft常駐のAI配信者が、24時間年中無休で世界をプレイします。',
  'landing.streamWatch': 'Twitchで見る',
  'landing.streamLoading': '観測ポータルを開いています...',
  'landing.streamReady': '観測ポータルの準備ができました。再生してYuumiiiを視聴できます。',
  'landing.streamOnline': 'Yuumiiiは現在ライブ配信中です。',
  'landing.streamOffline':
    '観測ポータルを再接続しています。Twitchチャンネルを開いて視聴を続けてください。',
  'landing.streamCompact': 'Twitchチャンネルを開き、この画面でYuumiiiを視聴してください。',
  'landing.streamUnavailable':
    '観測ポータルを利用できません。Twitchチャンネルを開いて視聴を続けてください。',
  'landing.openEyebrow': '開かれた世界、開かれたコード',
  'landing.openHeading': '世界をフォークし、冒険者を訓練しよう。',
  'landing.openBody':
    'ソースを調べ、自分の世界をホストし、プレイヤーが毎日入る同じ決定論的ゲームにGymnasium互換エージェントを接続できます。',
  'landing.supportEyebrow': '世界を動かし続けよう',
  'landing.supportHeading': 'つくり、遊び、次の章を支えよう。',
  'landing.supportBody':
    'World of ClaudeCraftはオープンに成長します。コミュニティに参加し、生きた世界を見守り、継続的な開発を支援してください。',
  'landing.xCta': 'Xでフォロー',
  'landing.patchNotesLabel': 'パッチノート',
  'landing.patchNotesTitle': 'パッチノート',
  'landing.patchNotesDesc': '最新のゲームプレイ変更、不具合修正、リリースの詳細を確認できます。',
  'landing.patchNotesLoading': '最新のパッチノートを読み込んでいます…',
  'landing.patchNotesError': 'パッチノートを読み込めませんでした。しばらくしてからもう一度お試しください。',
  'landing.patchNotesEmpty': 'まだパッチノートはありません。後でもう一度ご確認ください。',
  'landing.patchNotesPrerelease': 'プレリリース',
  'landing.patchNotesViewOnGithub': 'GitHubでリリースを見る',
  'landing.newsEyebrow': 'レルムからのお知らせ',
  'landing.newsTitle': 'Claudemoonニュース',
  'landing.newsBody': 'World of ClaudeCraftの最新情報と、この世界の舞台裏から届く物語をお楽しみください。',
  'landing.newsXTitle': 'Xの最新情報',
  'landing.newsXIntro': '@WoClaudecraftからの公式投稿',
  'landing.newsXPrivacy': 'このフィードを読み込むとXに接続し、Xがお客様の訪問情報を受け取る場合があります。',
  'landing.newsXLoad': 'Xフィードを読み込む',
  'landing.newsXRetry': 'もう一度試す',
  'landing.newsXHide': 'Xフィードを非表示',
  'landing.newsXOpen': 'Xで@WoClaudecraftを開く',
  'landing.newsXNewTab': '新しいタブで開きます',
  'landing.newsXLoading': 'Xフィードを開いています…',
  'landing.newsXUnavailable': 'Xフィードを読み込めませんでした。すべての投稿はXで直接ご覧いただけます。',
  'landing.newsXIframeTitle': 'Xの@WoClaudecraft最新投稿',
  'landing.newsBlogEyebrow': 'CLAUDEMOON年代記',
  'landing.newsBlogTitle': '最新の物語',
  'landing.newsBlogEmptyTitle': '最初の物語を執筆中',
  'landing.newsBlogEmptyBody': 'ニュースや舞台裏の物語は、まもなくここに掲載されます。',
  'landing.newsXOpenAria': 'Xで@WoClaudecraftを新しいタブで開く',
  'landing.newsXLoaded': 'Xフィードを読み込みました。',
  'landing.newsXHidden': 'Xフィードは非表示です。プロフィールはXで直接開くことができます。',
  'landing.twitchCategoryCta': 'World of ClaudeCraftの配信を見る',
  'landing.finalEyebrow': '物語は門から始まる',
  'landing.finalHeading': 'Claudemoonへの入り方を選ぼう。',
  'landing.finalBody': '今すぐブラウザでプレイし、モバイルで続けるか、Steam版をお待ちください。',
  ...
  'mode.onlineDesc': 'ライブサーバーでプレイします。キャラクターはオンラインに保存されます。',
  'mode.onlineAria': 'オンラインでプレイ：永続的な共有ワールドにログインします',
  'mode.offlineTitle': 'オフラインでプレイ',
  'mode.offlineDesc':
    'ブラウザでローカルのオフラインワールドをプレイします。進行状況は保存されません。',
  ...
  'mode.serverAria': 'サーバーモードを選択：サーバーオンラインまたはサーバーオフライン',
  'mode.serverLabel': 'ワールドを選択',
  'mode.serverOffline': 'サーバーオフライン',
  'mode.serverOfflineSub': 'ローカルオフラインワールド',
  'mode.serverOnline': 'サーバーオンライン',
  ...
  'landing.streamWatchSub': 'Yuumiii のライブに参加',
  'landing.streamExplore': '世界を探索',
  'landing.streamExploreSub': 'クロードムーンを発見',
  'landing.streamHeroSubtitle': '常駐 AI ストリーマーが、24時間この世界を冒険します。',
  'landing.streamMeet': 'ガイドを紹介',
  'landing.streamHostTitle': '常駐 AI ストリーマー',
  'landing.streamHostBody':
    'Yuumiii とともに、World of ClaudeCraft の隅々まで昼夜を問わず探索しましょう。',
  'landing.streamPortraitAlt': 'World of ClaudeCraft の常駐 AI ストリーマー、Yuumiii',
  'landing.streamAlwaysTitle': '24時間ライブ',
  'landing.streamAlwaysBody': 'いつでもオンライン。冒険は止まりません。',
  'landing.streamAiTitle': 'AI ストリーマー',
  'landing.streamAiBody': 'AI が生み出すリアルな反応と尽きない楽しさ。',
  'landing.streamCommunityTitle': 'コミュニティ',
  'landing.streamCommunityBody': 'チャット、クエスト、驚きが待っています。',
  'landing.streamWorldTitle': '本物の世界',
  'landing.streamWorldBody': 'ひとつの永続世界。無限の物語。',
  'hudChrome.privacyConsent.bannerTitle': 'Claudemoonでのプライバシー',
  'hudChrome.privacyConsent.bannerOptIn': '任意サービスの読み込みを許可するか選択してください。必須サービスは常に有効です。',
  'hudChrome.privacyConsent.bannerOptOut':
    '任意サービスは有効になっています。「任意サービスを拒否」を選ぶと、ターゲティング広告のための情報の販売または共有を拒否できます。読み込みを許可するサービスを個別に選ぶこともできます。',
  'hudChrome.privacyConsent.bannerGpc': 'ブラウザのGlobal Privacy Controlシグナルを尊重します。分析とマーケティングは無効のままです。',
  'hudChrome.privacyConsent.acceptAll': 'すべて許可',
  'hudChrome.privacyConsent.rejectAll': '任意サービスを拒否',
  'hudChrome.privacyConsent.customize': 'カスタマイズ',
  'hudChrome.privacyConsent.launcher': 'プライバシー設定',
  'hudChrome.privacyConsent.dialogTitle': 'プライバシー設定',
  'hudChrome.privacyConsent.dialogIntro': 'World of ClaudeCraftが使用できる任意サービスを選択してください。設定はいつでも変更できます。',
  'hudChrome.privacyConsent.close': 'プライバシー設定を閉じる',
  'hudChrome.privacyConsent.necessaryTitle': '必須',
  'hudChrome.privacyConsent.necessaryBody': 'セキュリティ、設定の保存、認証、ゲームの主要機能に必要です。',
  'hudChrome.privacyConsent.analyticsTitle': '分析',
  'hudChrome.privacyConsent.analyticsBody': 'サイトの利用状況の把握とゲームパフォーマンスの問題の診断に役立ちます。',
  'hudChrome.privacyConsent.marketingTitle': 'マーケティング',
  'hudChrome.privacyConsent.marketingBody': 'Meta Pixelなどのサービスを通じてキャンペーンの成果を測定します。',
  'hudChrome.privacyConsent.xTitle': 'Xフィード',
  'hudChrome.privacyConsent.xBody': 'ニュースページに埋め込みの@WoClaudecraftタイムラインを読み込めるようにします。',
  'hudChrome.privacyConsent.twitchTitle': 'Twitchプレイヤー',
  'hudChrome.privacyConsent.twitchBody': '埋め込みのYuumiiiライブ配信プレイヤーを読み込めるようにします。',
  'hudChrome.privacyConsent.alwaysOn': '常に有効',
  'hudChrome.privacyConsent.save': '設定を保存',
  'hudChrome.privacyConsent.cookiePolicy': 'Cookieポリシーを読む',
  'hudChrome.privacyConsent.twitchBlocked': 'プライバシー設定でTwitchを許可するまで、Twitchプレイヤーは一時停止されます。',
  'hudChrome.privacyConsent.twitchEnable': 'Twitchのプライバシー設定を選択',
  'nav.communityBuilt': 'コミュニティ制作',
  'footer.cookies': 'Cookieに関するお知らせ',
  'footer.privacyChoices': 'プライバシー設定',
  'landing.newsXConsentTitle': 'Xフィードの表示には許可が必要です',
  'landing.newsXConsentBody': 'このライブフィードをXに接続するには許可が必要です。Xがお客様の訪問に関する情報を受け取る場合があります。',
  'landing.newsXConsentNote': 'プライバシー設定でXコンテンツを有効にしてください。この設定はいつでも変更できます。',
  'landing.newsXPrivacyChoices': 'プライバシー設定',
  'landing.newsXUnavailableTitle': 'Xフィードを読み込めませんでした',
  'landing.newsXUnavailableBody': 'ブラウザや拡張機能によってブロックされているか、Xで一時的な問題が発生している可能性があります。',
  'landing.newsXHiddenTitle': 'この環境ではライブフィードを利用できません',
  'landing.newsXHiddenBody': '埋め込みのXフィードは、小さい画面やアプリでは利用できません。最新の投稿を見るには、Xで@WoClaudecraftを開いてください。',
  'landing.newsPressPrimaryTitle': '史上初のバイブコーディングMMORPGは、無料かつオープンソースで、驚くほど完成度が高い',
  'landing.newsPressPrimaryBody': 'MMORPG.comが、World of ClaudeCraftの背景にあるオープンワールド、共有される冒険、急速に進化する実験を紹介します。',
  'landing.newsPressRead': '特集を読む',
  'landing.newsPressLinkAria': 'MMORPG.comの特集を新しいタブで読む',
  'landing.newsPressPrimaryAlt': 'World of ClaudeCraftのEastbrook Valeを探索する冒険者たち',
  'landing.communityHeading': 'Claudemoonはみんなで作る世界。',
  'landing.communityBody': '得意なことや好奇心、あるいはただ仲間と過ごしたい気持ちを持ってきてください。ギルドのテーブルにはあなたの席があります。',
};
