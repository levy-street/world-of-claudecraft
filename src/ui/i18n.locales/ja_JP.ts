...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.character.tabs.equipment': '装備',
  'hudChrome.character.tabs.overview': '概要',
  'hudChrome.character.balances.claudium': 'クラウディウム',
  'hudChrome.character.bagSocket': 'バッグスロット: {name}',
  'hudChrome.character.sections.attributes': '属性',
  'hudChrome.character.sections.combat': '戦闘',
  'hudChrome.character.sections.defense': '防御',
  'hudChrome.character.spec.choose': '選択',
  'hudChrome.character.spec.change': '変更',
  'hudChrome.character.bags.openFull': 'バッグウィンドウを開く',
  'hudChrome.character.bags.container': 'バッグ {n}',
  'hudChrome.character.bags.emptySpaces': '空きスペース',
  'hudChrome.character.bags.emptySummary': '+{count} 空き',
