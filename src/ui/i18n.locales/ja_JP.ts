...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.cosmetics.legend': 'アカウント：全キャラクターで共有。キャラクター：このキャラクターのみ。',
  ...
  'hudChrome.cosmetics.mountsNoMount': 'まずマウントを入手してください。スキンには乗るものが必要です。',
  ...
  'hudChrome.cosmetics.mountsIntro': 'マウントスキンはこのキャラクターが乗るどのマウントにも重ねて描かれます。速度は変わりません。',
  'hudChrome.cosmetics.mechIntro': 'コンバットメカはこのキャラクターの身体を置き換えます。装着できるクロマは一度に一つです。',
};
