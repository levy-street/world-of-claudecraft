...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolSlotStowHint': 'クリックして最高の{type}道具をしまう',
  'hudChrome.bags.toolSlotTakeHint': 'クリックしてこの道具を取り出す',
  'hudChrome.bags.toolSlotNoTool': '{type}の道具を持っていません',
  'hudChrome.bags.toolType.mining': '採掘',
  'hudChrome.bags.toolType.logging': '伐採',
  'hudChrome.bags.toolType.herbalism': '薬草学',
