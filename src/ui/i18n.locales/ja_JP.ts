...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mobileHudEditor.launcher': 'モバイルレイアウトのカスタマイズ',
  'hudChrome.mobileHudEditor.title': 'モバイルレイアウトエディター',
  'hudChrome.mobileHudEditor.dialogLabel': 'モバイルコントロールをカスタマイズする',
  'hudChrome.mobileHudEditor.dragHandleLabel': 'エディターパネルを移動',
  'hudChrome.mobileHudEditor.dragHandleHint':
    'ドラッグまたは矢印キーで移動し、Homeキーで中央に戻します。',
  'hudChrome.mobileHudEditor.locked': 'ロックされています',
  'hudChrome.mobileHudEditor.unlocked': 'ロック解除済み',
  'hudChrome.mobileHudEditor.lock': 'ロックのレイアウト',
  'hudChrome.mobileHudEditor.unlock': 'レイアウトのロックを解除する',
  'hudChrome.mobileHudEditor.sceneLabel': 'プレビューシーン',
  'hudChrome.mobileHudEditor.contextLabel': 'プレビュー状態',
  'hudChrome.mobileHudEditor.profileLabel': 'デバイスプロファイル',
  'hudChrome.mobileHudEditor.profilePhone': 'スマートフォン',
  'hudChrome.mobileHudEditor.profileTablet': 'タブレット',
  'hudChrome.mobileHudEditor.save': '保存',
  'hudChrome.mobileHudEditor.cancel': 'キャンセル',
  'hudChrome.mobileHudEditor.showFailingLayout': '失敗したレイアウトを表示',
  'hudChrome.mobileHudEditor.previousFailure': '前回の失敗',
  'hudChrome.mobileHudEditor.nextFailure': '次の失敗',
  'hudChrome.mobileHudEditor.runtimeFallback':
    '{profile} レイアウトはこのビューポートに適合しません。組み込みのデフォルトは一時的にアクティブになります。',
  'hudChrome.mobileHudEditor.storageError':
    'モバイルレイアウトを保存できませんでした。下書きは開いたままです。',
  'hudChrome.mobileHudEditor.invalidSave':
    '保存する前にレイアウト エラーをすべて修正してください。',
  ...
  'hudChrome.mobileHudEditor.scene.arenaStandard': 'アリーナスタンダード',
  'hudChrome.mobileHudEditor.scene.arenaFiesta': 'アリーナフェスタ',
  'hudChrome.mobileHudEditor.scene.arenaYumi': 'アリーナユミ',
  'hudChrome.mobileHudEditor.scene.valeCupBriefing': 'ヴェイルカップ説明会',
  'hudChrome.mobileHudEditor.scene.valeCupMatch': 'ヴェイルカップ戦',
  'hudChrome.mobileHudEditor.scene.valeCupSpectator': 'ヴェイルカップ観戦者',
  'hudChrome.mobileHudEditor.scene.delve': 'デルヴ',
  'hudChrome.mobileHudEditor.context.worldBase': '世界',
  'hudChrome.mobileHudEditor.context.worldValeCupIndicator': 'ヴェイルカップ表示のあるワールド',
  'hudChrome.mobileHudEditor.context.arenaStandard': 'アリーナスタンダード',
  'hudChrome.mobileHudEditor.context.arenaFiestaBase': 'フィエスタマッチ',
  'hudChrome.mobileHudEditor.context.arenaFiestaPending': 'フィエスタは保留中',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawn': 'フィエスタリスポーン',
  'hudChrome.mobileHudEditor.context.arenaFiestaOffer': 'フィエスタ拡張オファー',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawnOffer': 'フィエスタの復活とオファーの強化',
  'hudChrome.mobileHudEditor.context.arenaYumiBase': 'ユミマッチ',
  'hudChrome.mobileHudEditor.context.arenaYumiRespawn': 'ユミが復活する',
  'hudChrome.mobileHudEditor.context.arenaYumiReturning': 'ユミが帰ってくる',
  'hudChrome.mobileHudEditor.context.valeCupBriefing': 'ヴェイルカップ説明会',
  'hudChrome.mobileHudEditor.context.valeCupMatch': 'ヴェイルカップの試合',
  'hudChrome.mobileHudEditor.context.valeCupMatchCharge': 'ヴェイルカップチャージショット',
  'hudChrome.mobileHudEditor.context.valeCupSpectatorBetting': 'ヴェイルカップの観客の賭け',
  'hudChrome.mobileHudEditor.context.instanceDelve': 'デルヴ',
  'hudChrome.mobileHudEditor.surface.actionA1': 'アクションA1',
  'hudChrome.mobileHudEditor.surface.actionA2': 'アクションA2',
  'hudChrome.mobileHudEditor.surface.actionA3': 'アクションA3',
  'hudChrome.mobileHudEditor.surface.actionA4': 'アクションA4',
  'hudChrome.mobileHudEditor.surface.actionA5': 'アクションA5',
  'hudChrome.mobileHudEditor.surface.actionAttack': '攻撃',
  'hudChrome.mobileHudEditor.surface.actionTarget': 'ターゲット',
  'hudChrome.mobileHudEditor.surface.actionJumpUse': 'ジャンプまたは使用',
  'hudChrome.mobileHudEditor.surface.actionPage': 'アクションページの切り替え',
  'hudChrome.mobileHudEditor.surface.controlMovement': '移動',
  'hudChrome.mobileHudEditor.surface.controlView': '視点',
  'hudChrome.mobileHudEditor.surface.utilityConsumables': '消耗品',
  'hudChrome.mobileHudEditor.surface.petCommands': 'ペットコマンド',
  'hudChrome.mobileHudEditor.surface.party': 'パーティー',
  'hudChrome.mobileHudEditor.surface.menuTop': 'トップメニュー',
  'hudChrome.mobileHudEditor.surface.minimapCluster': 'ミニマップ',
  'hudChrome.mobileHudEditor.surface.frameTarget': 'ターゲットフレーム',
  'hudChrome.mobileHudEditor.surface.framePlayer': 'プレイヤーフレーム',
  'hudChrome.mobileHudEditor.surface.playerBuffs': 'プレイヤーバフ',
  'hudChrome.mobileHudEditor.surface.playerDebuffs': 'プレイヤーのデバフ',
  'hudChrome.mobileHudEditor.surface.statusArenaGeneric': 'アリーナのステータス',
  'hudChrome.mobileHudEditor.surface.statusFiestaScore': 'フィエスタスコア',
  'hudChrome.mobileHudEditor.surface.statusFiestaPending': 'フィエスタ保留ステータス',
  'hudChrome.mobileHudEditor.surface.protectedFiestaRespawn': 'フィエスタのリスポーンプロンプト',
  'hudChrome.mobileHudEditor.surface.protectedFiestaOffer': 'フィエスタ拡張オファー',
  'hudChrome.mobileHudEditor.surface.statusYumi': 'ユミのステータス',
  'hudChrome.mobileHudEditor.surface.protectedYumiRespawn': 'ユミのリスポーンプロンプト',
  'hudChrome.mobileHudEditor.surface.statusValeCupIndicator': 'ヴェイルカップ表示',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBriefing': 'ヴェイルカップ説明会',
  'hudChrome.mobileHudEditor.surface.statusValeCupMatch': 'ヴェイルカップの試合状況',
  'hudChrome.mobileHudEditor.surface.statusValeCupCharge': 'ヴェイルカップショットチャージ',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBetting': 'ヴェイルカップベッティングパネル',
  'hudChrome.mobileHudEditor.surface.trackerDelve': 'デルヴトラッカー',
  'hudChrome.mobileHudEditor.surface.protectedCenterMessage': 'センターメッセージ',
  'hudChrome.mobileHudEditor.control.nudgeUp': '上に移動',
  'hudChrome.mobileHudEditor.control.nudgeDown': '下に移動',
  'hudChrome.mobileHudEditor.control.nudgeLeft': '左に移動',
  'hudChrome.mobileHudEditor.control.nudgeRight': '右に移動',
  'hudChrome.mobileHudEditor.control.decreaseScale': 'サイズを小さくする',
  'hudChrome.mobileHudEditor.control.increaseScale': 'サイズを大きくする',
  'hudChrome.mobileHudEditor.control.orientation': '向き',
  'hudChrome.mobileHudEditor.control.horizontal': '水平',
  'hudChrome.mobileHudEditor.control.vertical': '垂直',
  'hudChrome.mobileHudEditor.control.order': '並び順',
  'hudChrome.mobileHudEditor.control.normalOrder': '通常',
  'hudChrome.mobileHudEditor.control.reverseOrder': '逆順',
  'hudChrome.mobileHudEditor.control.openingDirection': '開き方向',
  'hudChrome.mobileHudEditor.control.openLeft': '左開き',
  'hudChrome.mobileHudEditor.control.openRight': '右開き',
  'hudChrome.mobileHudEditor.control.openUp': '上に開く',
  'hudChrome.mobileHudEditor.control.openDown': '下に開く',
  'hudChrome.mobileHudEditor.control.resetSelected': '選択をリセット',
  'hudChrome.mobileHudEditor.control.resetAll': 'すべてリセット',
  'hudChrome.mobileHudEditor.status.noSelection': 'コントロールを選択して編集します。',
  'hudChrome.mobileHudEditor.status.selected': '選択済み: {surface}',
  'hudChrome.mobileHudEditor.status.scale': 'サイズ: {scale}',
  'hudChrome.mobileHudEditor.status.valid': 'レイアウトを保存する準備ができました。',
  'hudChrome.mobileHudEditor.status.invalid':
    'レイアウトに {count} 個のブロック エラーがあります。',
  'hudChrome.mobileHudEditor.status.failurePosition': '{count} 件中 {index} 件の失敗',
  'hudChrome.mobileHudEditor.failure.invalidPlacement': '{surface} には無効な配置があります。',
  'hudChrome.mobileHudEditor.failure.unsupportedCapability':
    '{surface} はサポートされていないレイアウト オプションを使用しています。',
  'hudChrome.mobileHudEditor.failure.scaleOutOfRange': '{surface} サイズは許容範囲外です。',
  'hudChrome.mobileHudEditor.failure.targetTooSmall':
    '{surface} は小さすぎて安全に使用できません。',
  'hudChrome.mobileHudEditor.failure.outOfBounds': '{surface} は安全領域の外にあります。',
  'hudChrome.mobileHudEditor.failure.overlap': '{surface} は {other} と重なっています。',
  'hudChrome.mobileHudEditor.failure.viewIntrusion': '{surface} はビュー領域と重なっています。',
  'hudChrome.mobileHudEditor.failure.protectedOverlap': '{surface} は {other} と重なっています。',
  'hudChrome.mobileHudEditor.discard.title': 'レイアウトの変更を破棄しますか?',
  'hudChrome.mobileHudEditor.discard.body':
    '保存されていないモバイル レイアウトの変更は失われます。',
  'hudChrome.mobileHudEditor.discard.confirm': '変更の破棄',
  'hudChrome.mobileHudEditor.discard.continueEditing': '編集を続ける',
