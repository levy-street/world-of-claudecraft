...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberforged_hauberk.name': '残り火鍛造のホーバーク',
  'entities.items.emberforged_legguards.name': '残り火鍛造のレッグガード',
  'entities.items.emberforged_girdle.name': '残り火鍛造のガードル',
  'entities.items.cinderhide_vest.name': '燃え殻革のベスト',
  'entities.items.moltencore_maul.name': '溶核のモール',
  'entities.items.brand_of_the_first_flame.name': '最初の炎の烙印',
  'entities.items.emberseal_of_the_covenant.name': '破られし契約の残り火印',
  'entities.items.bloodember_band.name': '血残り火の指輪',
  'entities.items.ashcoil_signet.name': '灰渦の印章指輪',
