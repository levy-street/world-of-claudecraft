...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.meters.loot': '戦利品',
  'hud.meters.lootShort': '戦利品',
  'hud.meters.lootHistory': '履歴',
  'hud.meters.noLoot': 'まだ戦利品は記録されていません。',
  'hud.meters.recentAwards': '最近の獲得 {count} 件',
  'hud.meters.methodReturned': 'パス',
  'hud.meters.methodMaster': 'マスター',
  'hud.meters.methodPersonal': '個人',
  'hud.meters.methodDelve': 'デルヴ',
  'hud.meters.methodLooted': '獲得',
  'hud.meters.noWinner': '勝者なし',
  'hud.meters.rollDetail': 'ロール {roll}',
