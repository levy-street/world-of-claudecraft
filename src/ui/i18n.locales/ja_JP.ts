...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'yumi.log.teamBlue': 'あなたは青チームです！',
  'yumi.log.teamRed': 'あなたは赤チームです！',
  'yumi.log.powerupGrabbed': '{player} が {name} パワーアップを獲得！',
  'yumi.hud.powerupIn': 'パワーアップまで {s}秒',
  'yumi.hud.powerupReady': 'パワーアップ出現！',
  'yumi.banner.powerupSpawn': 'ミステリーパワーアップが出現！',
  'yumi.powerup.invuln.name': '無敵',
  'yumi.powerup.stealth.name': 'ヴェイルステップ',
  'yumi.powerup.endless_mana.name': '無限マナ',
  'yumi.powerup.berserk.name': 'ウォーフィーバー',
