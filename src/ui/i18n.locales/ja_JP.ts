...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  'editor.cinematic.authoredCamera': '演出カメラ',
  'editor.cinematic.capture': 'キーフレームを取得',
  'editor.cinematic.captureCopyOnly': 'コピーしました。開発用ライターは利用できません',
  'editor.cinematic.captureReady': '下にブロックを表示しています',
  'editor.cinematic.captureSaved': '保存しました。下にブロックを表示しています',
  'editor.cinematic.captureSavedCopied': '保存してコピーしました',
  'editor.cinematic.copy': 'ブロックをコピー',
  'editor.cinematic.fade': 'フェード：{percent}%',
  'editor.cinematic.hide': 'パネルを隠す',
  'editor.cinematic.letterboxOff': 'レターボックス：オフ',
  'editor.cinematic.letterboxOn': 'レターボックス：オン',
  'editor.cinematic.noViolations': '現在、違反はありません',
  'editor.cinematic.output': '生成されたカメラ取得データ',
  'editor.cinematic.pause': '一時停止',
  'editor.cinematic.play': '再生',
  'editor.cinematic.scene': 'シーン',
  'editor.cinematic.sceneOption': '{id}（{seconds}秒）',
  'editor.cinematic.seedMismatch': '取得には正式なワールドシードが必要です',
  'editor.cinematic.show': 'パネルを表示',
  'editor.cinematic.time': '時間',
  'editor.cinematic.timeReadout': '{current} / {duration}秒',
  'editor.cinematic.title': 'シネマティック',
  'editor.cinematic.unavailable': '3Dビューポートを読み込み中',
  'editor.cinematic.violationRow': '{check} | 操作 {opIndex} | {measured}',
  'editor.cinematic.violations': '違反項目',
  'entities.dungeons.lb_breach.enterText': '光がおかしく、空はそれ以上におかしい。核心はこの先の開けた地にある。',
  'entities.dungeons.lb_breach.leaveText': '境を越え、いつもの夜気へ戻る。',
  'entities.dungeons.lb_breach.name': '裂け目の内側',
  'entities.dungeons.lb_council.enterText': '評議室には椅子が六脚ある。一脚だけ空いている。',
  'entities.dungeons.lb_council.leaveText': '要塞の外へ出る。',
  'entities.dungeons.lb_council.name': '要塞評議会',
  'entities.dungeons.lb_landing.enterText': '導き火が浜辺を焼く。船団は浅瀬の向こうで待っている。',
  'entities.dungeons.lb_landing.leaveText': '上陸浜を後にする。',
  'entities.dungeons.lb_landing.name': '夜の上陸地',
  'entities.dungeons.lb_lastwatch.enterText': '砦は片付き、人けがない。誰かがこの見張りを終わらせねばならない。',
  'entities.dungeons.lb_lastwatch.leaveText': '背後で要塞の扉を閉じる。',
  'entities.dungeons.lb_lastwatch.name': '最後の見張り',
  'entities.dungeons.lb_riftfields.enterText': '四つの護りの祭場が裂け目を囲む。儀式は十二の世紀にわたりそれを閉ざしてきた。',
  'entities.dungeons.lb_riftfields.leaveText': '裂け野を下って戻る。',
  'entities.dungeons.lb_riftfields.name': '裂け野への道',
  'entities.dungeons.lb_riftline.enterText': '草原の門が巡回隊の背後で閉じる。今夜は防衛線のものだ。',
  'entities.dungeons.lb_riftline.leaveText': '裂け目防衛線を夜明けの見張りに任せる。',
  'entities.dungeons.lb_riftline.name': '黄昏の裂け目防衛線',
  'entities.dungeons.lb_tidemill.enterText': '水車場の扉が開く。中では、闇が耳を澄ませている。',
  'entities.dungeons.lb_tidemill.leaveText': '潮挽き水車場を出て、夕暮れの空気へ戻る。',
  'entities.dungeons.lb_tidemill.name': '潮挽き水車場',
  'entities.dungeons.lb_vault.enterText': '縄が闇へと繰り出されていく。眼下には、崩れ落ちたままの古い砦が横たわる。',
  'entities.dungeons.lb_vault.leaveText': '崖の縄を登り、日の光の中へ戻る。',
  'entities.dungeons.lb_vault.name': '水没した第一要塞',
  ...
  'entities.mobs.lb_actor_coalfast.name': '守将コールファスト',
  'entities.mobs.lb_actor_edda.name': '補給将校エッダ',
  'entities.mobs.lb_actor_ollun.name': '裂け目監視のオルン',
  'entities.mobs.lb_actor_saul.name': '癒し手サウル',
  'entities.mobs.lb_actor_tam.name': '鐘守タム',
  'entities.mobs.tidemill_stalker.name': '潮挽き水車場の追跡者',
  'entities.npcs.ferryman_ewald.greeting': '遠つ岸へ行くのかい？なあ、いまどき漁のために海を渡る者はいない。支度ができたら乗りな。着いたら鐘の音に気をつけろ。町の連中は、あんたが空模様を読むように鐘を聴くんだ。',
  'entities.npcs.ferryman_ewald.name': '渡し守エーヴァルト',
  'entities.npcs.ferryman_ewald.title': '対岸への渡し',
  'entities.npcs.ferryman_ewald_gullhaven.greeting': '遠つ岸へ行くのかい？なあ、いまどき漁のために海を渡る者はいない。支度ができたら乗りな。着いたら鐘の音に気をつけろ。町の連中は、あんたが空模様を読むように鐘を聴くんだ。',
  'entities.npcs.ferryman_ewald_gullhaven.name': '渡し守エーヴァルト',
  'entities.npcs.ferryman_ewald_gullhaven.title': '対岸への渡し',
  'entities.npcs.sergeant_marsh.greeting': '訓練は済んだな？なら今夜の段取りだ。俺の隊列が街道を守る。裂け目が手に負えんものを吐き出したら、俺はお前を指す。水車小屋はお前に任せる。何もお前を追わせるな。何も俺たちを抜けて町へ行かせるな。行け。',
  'entities.npcs.sergeant_marsh.name': 'マーシュ軍曹',
  'entities.npcs.sergeant_marsh.title': '町の民兵',
  'entities.quests.q_lb_q0_ashore.completion': '水車小屋の討伐はお前ひとりの手柄だ。タムの担架の話も誇張ではない。斥候は足りず、守る畑は多すぎる。今夜お前は、守る義理のなかった地を守り抜いた。それがこの仕事のすべてだ。見張り隊へようこそ。',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': '見張り草地のマーシュ軍曹に報告する',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': '裂け目の落とし子を倒す',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': '潮挽き水車場にいる何かを始末する',
  'entities.quests.q_lb_q0_ashore.text': 'カモメ港は昼も夜も裂け目の襲撃に耐え、なお持ちこたえている。共に立つ気なら、町が血を流す場所から始めろ。見張りの草原の民兵線だ。港の石段と古い像の東にある。',
  'entities.quests.q_lb_q0_ashore.title': '上陸',
  ...
  'hudChrome.memorial.close': '記念碑を閉じる',
  'hudChrome.memorial.dedication': '封印を携えて裂け目へ入り、二度と戻らなかったカモメ港の守り手たちへ。町は彼らのためにこの鐘を守り続ける。',
  'hudChrome.memorial.rollHeading': '栄誉の名簿（{count}）',
  'hudChrome.memorial.roomRemaining': '最後の名の下の石面は、まだ空けられたままだ。',
  'hudChrome.memorial.title': '記念碑',
  'hudChrome.mountTraining.buyReinsPrompt': '騎乗を習得した。マーラから10ゴールドでヴァロースティードの手綱を購入し、使用して騎乗しよう。',
  ...
  'lb.q0.coalfast.look': '灰色の男は倒れたストーカーを見つめ、それからあなたを、ほんの少し長く見る。そして崖の方へ歩き去っていく。',
  'lb.q0.scene.harbor': '働く港。網が干され、星硝子のサルベージ箱には本土の買い手の刻印がある。',
  'lb.q0.scene.plinth': '港の石段の上で、青銅の守り手が内陸を向いて立つ。台座のいちばん新しい名は百年前のもの。ウォーデン・ヘイル。その下には、まだ名を刻む余白がある。',
  'lb.q0.scene.toll': '鐘がひとつ鳴る。通りの誰もが足を止め、数をかぞえる。何も続かず、通り全体がいっせいに息をつく。',
