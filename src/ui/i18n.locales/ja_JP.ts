...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.forgefathers_ember.name': '鍛造の父の燠火',
  'entities.items.cruciblewrought_warhelm.name': 'るつぼ鍛造の戦兜',
  'entities.items.emberveil_legguards.name': '燠火纏いのレッグガード',
  'entities.items.vestment_of_the_last_spring.name': '最後の泉のローブ',
  'entities.items.forgefathers_requiem.name': '鍛造の父のレクイエム',
  'entities.items.plans_cruciblewrought_warhelm.name': '設計図：るつぼ鍛造の戦兜',
  'entities.items.pattern_emberveil_legguards.name': '型紙：燠火纏いのレッグガード',
  'entities.items.pattern_vestment_of_the_last_spring.name': '型紙：最後の泉のローブ',
  'entities.items.formula_lastflame_zeal.name': '公式：最後の炎の熱意',
  'entities.quests.q_forgefathers_requiem.title': '鍛造の父のレクイエム',
  'entities.quests.q_forgefathers_requiem.text': 'ヴァルクルの鎚は、彼が胸元に守っていたものに応えていた。今なお燃え続ける、最後の泉の燠火に。その燠火を私のもとへ。技を極めた鍛冶師なら、彼が決して踏み込めなかったものを鍛えられるはずだ。',
  'entities.quests.q_forgefathers_requiem.completion': 'まだ歌っている。鍛冶師よ、これはただの素材ではない。彼が鎖につないだ泉の声そのものだ。鍛え方は私が示そう。彼の手が決して成し得なかったことを、あなたの手が成すのだ。',
  'entities.quests.q_forgefathers_requiem.objectives.0.label': '鍛造の父の燠火を回収する',
  'entities.quests.q_requiem_at_the_forge.title': '炉前のレクイエム',
  'entities.quests.q_requiem_at_the_forge.text': '鍛えるのはあなた一人の仕事だ。最後の炎の核を十五、最上のトリウムとエルダーウッド、そして中心にあの燠火を。その名にふさわしい炉でレクイエムを鍛え上げ、泉に看守への答えを歌わせよ。',
  'entities.quests.q_requiem_at_the_forge.completion': 'かくしてレクイエムは鉄で歌われた。大切に携えよ、鍛冶師よ。これに並ぶものを鍛えられる手は、二度と現れない。',
  'entities.quests.q_requiem_at_the_forge.objectives.0.label': '鍛造の父のレクイエムを鍛え上げる',
  'hudChrome.enchanting.formulaNotLearned': 'その公式はまだ習得していません。',
  'hudChrome.enchantName.enchant_weapon_lastflame_zeal': '武器への付与 - 最後の炎の熱意',
  'hudChrome.itemProc.selfBuff': '{name}（{value}）を{duration}秒間得る',
  'hudChrome.itemProc.selfHeal': 'さらに体力を{total}回復する',
  'itemUi.kind.recipe': 'レシピ',
};
