...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.tin_ore.name': '錫鉱石',
  'entities.items.iron_ore.name': '鉄鉱石',
  'entities.items.copper_bar.name': '銅の延べ棒',
  'entities.items.tin_bar.name': '錫の延べ棒',
  'entities.items.bronze_bar.name': '青銅の延べ棒',
  'entities.items.bronzeclasp_gauntlets.name': '青銅留めの篭手',
  'entities.items.clawspur_dirk.name': '爪棘の短剣',
  'entities.items.iron_bar.name': '鉄の延べ棒',
  'entities.items.thorium_bar.name': 'トリウムの延べ棒',
  ...
  'entities.items.beast_claw.name': '獣の爪',
  'entities.items.boar_tusk.name': '猪の牙',
