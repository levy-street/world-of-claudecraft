...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.professions.deedsBody':
    '功績の書が歩みに寄り添います。初めての調律で技巧に誓いし者、初めての傑作でMasterwrightを獲得し、どちらも称号として身につけられます。九つの製作職はいずれもスキル50で節目の功績、上限125でGrandmaster称号を戴き（宝石細工はさらに最初のレア品でPolished to Brillianceを記します）、釣りは熟練100でOld Salt、200でMaster Angler称号を得ます。初めての採集や製作、野外の幸運な発見、サルベージにも静かなページがあります。すべて装飾のみ。称号と名声だけで、功績が力を与えることはありません。',
