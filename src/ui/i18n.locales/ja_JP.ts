...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.leaderboard.commits': 'コミット数',
  ...
  'hudChrome.devBadge.flavors.tinkerer': '最初のコミットがこの世界に刻まれた。',
  'hudChrome.devBadge.flavors.artificer': '10 のコミットを経て、世界はあなたのコードに従い始める。',
  'hudChrome.devBadge.flavors.runesmith': '50 のコミットが、稼働中のゲームに鍛え込まれた。',
  'hudChrome.devBadge.flavors.architect': 'この世界の設計者：150 のコミットが刻まれた。',
  'hudChrome.devBadge.flavors.worldwright': '世界の造り手：500 のコミットがこのゲームを形づくる。',
  'hudChrome.devBadge.badgeTitle': '開発者：{tier}',
  'hudChrome.devBadge.commitsLanded': '{count} 件のコミットを反映',
