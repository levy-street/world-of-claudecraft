...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.endsInDays.one': '残り{count}日',
  'hudChrome.arenaSeason.endsInDays.few': '残り{count}日',
  'hudChrome.arenaSeason.endsInDays.many': '残り{count}日',
  'hudChrome.arenaSeason.endsInDays.other': '残り{count}日',
  'hudChrome.arenaSeason.endsInHours.one': '残り{count}時間',
  'hudChrome.arenaSeason.endsInHours.few': '残り{count}時間',
  'hudChrome.arenaSeason.endsInHours.many': '残り{count}時間',
  'hudChrome.arenaSeason.endsInHours.other': '残り{count}時間',
  'hudChrome.arenaSeason.endsInMinutes.one': '残り{count}分',
  'hudChrome.arenaSeason.endsInMinutes.few': '残り{count}分',
  'hudChrome.arenaSeason.endsInMinutes.many': '残り{count}分',
  'hudChrome.arenaSeason.endsInMinutes.other': '残り{count}分',
  'hudChrome.arenaSeason.opensInDays.one': '{count}日後に開幕',
  'hudChrome.arenaSeason.opensInDays.few': '{count}日後に開幕',
  'hudChrome.arenaSeason.opensInDays.many': '{count}日後に開幕',
  'hudChrome.arenaSeason.opensInDays.other': '{count}日後に開幕',
  'hudChrome.arenaSeason.opensInHours.one': '{count}時間後に開幕',
  'hudChrome.arenaSeason.opensInHours.few': '{count}時間後に開幕',
  'hudChrome.arenaSeason.opensInHours.many': '{count}時間後に開幕',
  'hudChrome.arenaSeason.opensInHours.other': '{count}時間後に開幕',
  'hudChrome.arenaSeason.opensInMinutes.one': '{count}分後に開幕',
  'hudChrome.arenaSeason.opensInMinutes.few': '{count}分後に開幕',
  'hudChrome.arenaSeason.opensInMinutes.many': '{count}分後に開幕',
  'hudChrome.arenaSeason.opensInMinutes.other': '{count}分後に開幕',
