...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.errors.tradeBusy': 'そのプレイヤーはすでに取引中です。',
  'hud.errors.tradeUsage': '誰と取引しますか？ 使い方: /trade <名前>',
  'hud.errors.claudiumTradeOff': 'Claudium取引は現在利用できません。',
  'hud.errors.wocTradeOff': 'WOC取引は現在利用できません。',
  'hud.errors.wocTradeLink': 'WOCを取引するにはウォレットを連携してください。',
  'hud.errors.wocTradePartnerLink': '取引相手はウォレットを連携していません。',
  'hud.errors.wocTradeOneSide': '取引でWOCを提供できるのは片方のみです。',
  'hud.errors.tradeSettleTimeout':
    '取引はキャンセルされました：支払いの待機時間が終了したため、品物は返却されました。',
  'hud.errors.tradeSettleCancelled': '取引はキャンセルされました。品物は返却されました。',
  'hud.errors.tradeSettleUnavailable': '取引を決済できませんでした。品物は返却されました。',
  ...
  'hud.logs.tradeDeclined': '{name}があなたの取引の申し出を断りました。',
  ...
  'hud.trade.settlingTitle': '取引を決済中…',
  'hud.trade.legYourWoc': 'あなたのWOC支払い',
  'hud.trade.legTheirWoc': '相手のWOC支払い',
  'hud.trade.statusPending': '処理中',
  'hud.trade.wocPayPrompt': '連携したウォレットから{amount} WOCを送って取引を完了してください。',
  'hud.trade.openInWallet': 'ウォレットで開く',
  'hud.trade.copyLink': '支払いリンクをコピー',
  'hud.trade.copiedLink': '支払いリンクをコピーしました。',
  'hud.trade.instanceSignedBy': '署名者: {name}',
  'hud.trade.instanceUnique': '固有の一点物',
  ...
  'itemUi.market.sortLabel': '並び替え',
  'itemUi.market.sortNewest': '新着順',
  'itemUi.market.sortPrice': '価格順',
  'itemUi.market.sortTimeLeft': '残り時間順',
  'itemUi.market.timeLeft': '残り{time}',
  'itemUi.market.yourBidBadge': 'あなたの入札',
  'itemUi.market.currentBidLabel': '入札額：',
  'itemUi.market.noBidsYet': 'まだ入札がありません',
  'itemUi.market.minNextBid': '最低入札額 {money}',
  'itemUi.market.buyoutLabel': '即決価格 {money}',
  'itemUi.market.auctionBadge': 'オークション',
  'itemUi.market.leadingBid': 'あなたがリードしています',
  'itemUi.market.bidInputAria': '{item} への入札額',
  'itemUi.market.bidButton': '入札',
  'itemUi.market.bidAria': '{item} に入札する',
  'itemUi.market.buyoutButton': '即決購入',
  'itemUi.market.buyoutAria': '{item} を {price} で即決購入',
  'itemUi.market.buyQuantityAria': '{item} の購入数量',
  'itemUi.market.listingTypeLabel': '出品形式',
  'itemUi.market.listingTypeFixed': '即売',
  'itemUi.market.listingTypeAuction': 'オークション',
  'itemUi.market.durationLabel': '出品期間',
  'itemUi.market.durationOption': '{hours}時間',
  'itemUi.market.startingBidLabel': '開始価格',
  'itemUi.market.buyoutOptionalLabel': '即決価格（任意）',
  'itemUi.market.totalLabel': '合計',
  'itemUi.market.depositPreviewLabel': '出品保証金',
  'itemUi.market.cancelConfirmTitle': '出品の取り下げ',
  'itemUi.market.cancelConfirmBody':
    '{item} を市場から取り下げますか？保証金 {money} は没収されます。',
  'itemUi.market.cancelConfirmBodyNoDeposit': '{item} を市場から取り下げますか？',
  'itemUi.market.cancelConfirmDismiss': 'キャンセル',
  'itemUi.market.outbidToast':
    '{item} への入札が他の人に上回られました。{money} が回収箱に返却されました。',
  'itemUi.market.wonToast': '{item} のオークションを落札しました！商人のもとで受け取ってください。',
  ...
  'itemUi.errors.minStartingBid': '開始価格は最低でも1銅貨にしてください。',
  'itemUi.errors.buyoutTooLow': '即決価格は開始価格を上回っている必要があります。',
  'itemUi.errors.chooseDuration': '出品期間は12時間、24時間、48時間のいずれかを選んでください。',
  'itemUi.errors.cannotAffordDeposit': '出品保証金を支払えません。',
  'itemUi.errors.bidsOnly': 'このロットは入札のみ受け付けています。',
  'itemUi.errors.notAuction': 'このロットはオークション出品ではありません。',
  ...
  'guide.economy.marketBrowse':
    '閲覧：出品を一覧でスクロールするか、名前で検索して売り物を探します。各出品には品物、出品者、残り時間、そして分割購入できるスタックの単価か、オークション品の現在の入札額が表示されます。',
  ...
  'entities.letters.market_outbid.subject': '入札が上回られました',
  'entities.letters.market_outbid.body':
    '別の買い手があなたの狙っていたロットの入札額を引き上げました。あなたの銅貨はワールドマーケットの回収箱で待っています。取り戻すか、再び入札しに来てください。\n\n- 商人',
  'entities.letters.market_won.sender': '商人',
  'entities.letters.market_won.subject': '落札のお知らせ',
  'entities.letters.market_won.body':
    '槌が下り、このロットはあなたのものになりました。あなたの品はワールドマーケットの回収箱で待っています。受け取りに来てください。\n\n- 商人',
  'entities.letters.market_sold.sender': '商人',
  'entities.letters.market_sold.subject': '出品が売れました',
  'entities.letters.market_sold.body':
    '買い手があなたの品を買い取りました。あなたの収益はワールドマーケットの回収箱で待っています。受け取りに来てください。\n\n- 商人',
  ...
  'entities.letters.trade_delivery.body':
    '取引で得た品が届きました。鞄に入りきらなかった分はワタリガラスが運んでくれました。',
  'entities.letters.trade_refund.sender': 'レイヴンポスト',
  'entities.letters.trade_refund.subject': '取引の品が返却されました',
  'entities.letters.trade_refund.body':
    '取引は成立しませんでした。差し出した品はすべて返却されました。',
