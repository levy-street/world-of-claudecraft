...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.shardpike.braceTooltip': '石突きを地面に突き立て、穂先を上げる。横移動キーがバランス棒だ：ビームは自然に流れ、彼が地面を叩くたびに弾かれる。両端に触れさせず {set} 秒保てば穂先が定まる。固い地面が必要で、騎乗中は不可。',
  'hudChrome.shardpike.thrustLabel': 'ルームシャード・スラスト',
  'hudChrome.shardpike.thrustTooltip': '定まった穂先を眼に突き入れ、{damage} のダメージを与える。レベルも攻撃力もパイク自体も、何一つこの値を伸ばさない。番人を盲目にしバロウハイドを剥ぎ取るので、湿地の他のあらゆる武器がようやく通るようになる。定まったパイクだけが放てる一撃で、射程 {reach} ヤード、猶予は {seconds} 秒。',
  'hudChrome.shardpike.releaseLabel': 'シャードパイクを下ろす',
  'hudChrome.shardpike.releaseTooltip': 'パイクを収める。降りるのに罰則はない：失うのは構えだけで機会そのものではなく、{rest} 秒後に再び構えられる。',
  ...
  'entities.npcs.socketwright_skerrit.greeting': 'あの眼を研いで彼の眼窩に据えてから四十年、一日分の払いももらっていない。番人に痛い目を見せたいのか、{className}？なら俺の仕事を狙え。',
  'entities.quests.q_socketwrights_due.title': '嵌め込み職人の未払い',
  'entities.quests.q_socketwrights_due.text': 'あの眼窩にルームシャードを据えたのは俺だ。レンズを研ぎ、座らせ、楔で正しく固めた。塚の主たちは銅貨一枚も払わず、いま俺の仕事が湿地を踏み均して歩き回っている。俺のシャードパイクを持って行け。石突きを突き立て、穂先を据えて、どれだけかかろうと保て。腕が定まったら、それを眼に通せ。彼のまとう皮はあの欠片に縛られている、{playerName}：盲目にすれば、湿地のあらゆる刃がようやく通る。',
  'entities.quests.q_socketwrights_due.completion': '手応えがあっただろう？四十年分の利息、眼窩を通して払わせた。パイクはあんたのものだ。彼は治る、いつもそうだ。だから気が向いたらまた取り立てに行けばいい。',
