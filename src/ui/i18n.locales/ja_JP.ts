...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.undermount_wing2.name': 'アンダーマウント: 焼き戻し',
  'entities.dungeons.undermount_wing2.enterText': '槌音が焼き戻しの宝物庫に響き渡る。',
  'entities.dungeons.undermount_wing2.leaveText': 'あなたは鳴り響く炉道から退く。',
  'entities.dungeons.undermount_wing3.name': 'アンダーマウント: 目覚め',
  'entities.dungeons.undermount_wing3.enterText': '埋もれた炉が深みで身じろぎする。',
  'entities.dungeons.undermount_wing3.leaveText': 'あなたは目覚めつつある熱から退く。',
  ...
  'entities.quests.q_undermount_heat.text':
    'この裂け目の石は木炭がにじむほど熱い、{playerName}。教団が再び埋める前に、露出した三つのルーン面から拓本を取ってくれ。模様が繰り返すなら、下に何があるか分かる。',
  'entities.quests.q_undermount_heat.completion':
    '線はすべて内側へ向かっている。これは鍛冶師の作業印ではない、{playerName}。結界だ。そして何かが下から切り裂いている。',
  'entities.quests.q_undermount_heat.objectives.0.label': 'ルーンの拓本を採取',
  'entities.quests.q_undermount_ledger.title': '教団が埋めたもの',
  'entities.quests.q_undermount_ledger.text':
    '発掘監督は作業台帳を肌身離さず持ち、野営地の狂信者が守っている。持ってきてくれ、{playerName}。地金も食料も賃金も、どこへ行くのか知りたい。',
  'entities.quests.q_undermount_ledger.completion':
    '下だ。地金ひとつ、残り火ひとつ、すべてが私たちの下で費やされている、{playerName}。鍛炉は地上に何も生み出していない。山が埋めたものに餌を与えている。',
  'entities.quests.q_undermount_ledger.objectives.0.label': 'Wyrmcult の発掘監督を討伐',
  'entities.quests.q_undermount_ledger.objectives.1.label': 'Wyrmcult の護衛を討伐',
  'entities.quests.q_undermount_ledger.objectives.2.label': '監督の台帳を回収',
  'entities.quests.q_undermount_descent.title': 'アンダーマウントへ',
  'entities.quests.q_undermount_descent.text':
    '台帳は発掘場の下に第二の工区があると示し、すべての積荷が下を指している。準備ができたら話しかけてくれ、{playerName}。私も降下に加わる。',
  'entities.quests.q_undermount_descent.completion':
    'この灯を持っていけ。魔力はなく、ただ安定した炎があるだけだが、下では正直な光が必要になる。この連続クエストを終えていなくても、レイド入口は開いている。',
  'entities.quests.q_undermount_descent.objectives.0.label': 'ルーン探しのメイリンと話す',
  ...
  'entities.items.undermount_rune_rubbing.name': 'アンダーマウントのルーン拓本',
  ...
  'entities.mobs.wyrmcult_dig_foreman.name': 'ワームカルト発掘監督',
  'entities.items.cindertoad_signet.name': '熾火蛙の印章',
  'entities.items.coalglow_band.name': '炭火の指輪',
  'entities.items.crownforged_warleggings.name': '王冠鍛造の戦脚甲',
  'entities.items.glassblowers_shiv.name': '玻璃職人のシヴ',
  'entities.items.glasswalker_treads.name': '玻璃歩きの足具',
  'entities.items.nighttalon_prowlers.name': '夜爪の忍び靴',
  'entities.items.quenchsilk_cord.name': '焼入れ絹の紐',
  'entities.items.ring_of_the_first_quench.name': '最初の焼入れの指輪',
  'entities.items.saans_stoking_iron.name': 'サーンの火掻き棒',
  'entities.items.slag_tempered_sabatons.name': '鉱滓焼入れのサバトン',
  'entities.items.slakeleather_belt.name': '冷まし革のベルト',
  'entities.items.sluicebearer.name': '水門担ぎ',
  'entities.items.soulflame_kilt.name': '魂炎のキルト',
  'entities.items.stokebrand_striders.name': '火熾し印の足具',
  'entities.items.stormcallers_legwraps.name': '嵐呼びの脚巻き',
  'entities.items.the_even_temper.name': '平静なる焼き戻し',
  'entities.items.twice_fired_slippers.name': '二度焼きの室内履き',
  'entities.items.twicetempered_girdle.name': '二度焼き戻しの腰帯',
  'entities.items.crownforged_heartplate.name': 'クラウンフォージの心胸甲',
  'entities.items.nighttalon_emberweave.name': 'ナイトタロンの残り火織り',
  'entities.items.soulflame_vestments.name': 'ソウルフレイムの祭服',
  'entities.items.stormcallers_hauberk.name': 'ストームコーラーのホーバーク',
  'entities.items.volzharrs_knucklestone.name': 'ヴォルザールの拳石',
  'entities.items.magmastrider_greaves.name': 'マグマストライダーの脚甲',
  'entities.items.footwraps_of_the_waking_floor.name': '目覚める床の足布',
  'entities.items.forgeheat_cinch.name': 'フォージヒートの帯',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'コアブレイカー、地下山の心臓',
  'entities.items.the_last_restraint.name': '最後の拘束',
  'entities.items.band_of_the_ninth_quench.name': '第九冷却の指輪',
  'entities.items.moltenheart_chroma.name': 'モルテンハート',
  'entities.itemSets.crownforged.bonus5': 'クリティカル率が3%上昇する。',
  'entities.itemSets.nighttalon.bonus5': 'クリティカル率が3%上昇する。',
  'entities.itemSets.soulflame.bonus5': '呪文のクリティカル率が3%上昇する。',
  'entities.itemSets.stormcallers.bonus5': '呪文のクリティカル率が3%上昇する。',
};
