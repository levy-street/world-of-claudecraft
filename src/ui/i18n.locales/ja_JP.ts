...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.itemAccountBound': 'アカウント縛り',
  'hudChrome.mailbox.clickAttachAccountBound': 'クリックで手紙に添付します。アカウント縛り：受け取れるのはあなた自身のキャラクターだけです。',
  'hudChrome.mailbox.result.noMailAccountBound': 'アカウント縛りのアイテムは、あなた自身のキャラクターにしか郵送できません。',
  'hudChrome.trade.woc.ineligibleReasonAccountBound': 'アカウント縛り、クエスト、ロック中のアイテムと、取引所のカテゴリ外のアイテムは $WOC で売却できません。',
  'guide.glossary.accountBoundTerm': 'アカウント縛り',
  'guide.glossary.accountBoundDef': '手に入れた瞬間からあなたのアカウントに結び付くアイテム。取引も商人への売却もマーケットへの出品もできず、手紙で届けられる先はあなた自身の別のキャラクターだけです。',
  'guide.gear.accountBoundTitle': 'アカウント縛り：あなたのどのキャラクターでも、あなたのもの',
  'guide.gear.accountBoundBody': '一部の特別な報酬はアカウント縛りで、手に入れた瞬間からあなたのアカウントに結び付きます。アカウント縛りのアイテムは取引も、商人への売却も、マーケットへの出品も、ギルド銀行への保管もできず、他のプレイヤーへの手紙にも載りません。ただひとつ開いている扉が、あなた自身のキャラクター同士をつなぐワタリガラス便です。あるキャラクターに不要になった縛り装備は、同じアカウントの別のキャラクターへ郵送できます。クラス専用装備も含まれるので、ふさわしいクラスのサブキャラクターが着られます。これは英雄の証のような賞品トークンを守り、名誉で買うウォーフェア装備すべてにも及びます。ワールドで手に入る装備のほとんどは、これまでどおり自由に取引し、売り、分け合えます。',
  ...
  'guide.economy.buyingBodyAccountBound': '商人に話しかけて品物を見せてもらうことを選ぶと、その店がひとつのパネルで開きます。店の在庫がすべてひとつの一覧に並び、お金が足りればクリックひとつで買えます。品物の上の数量バーで、一回のクリックで買う数を一つ、五つ、十、または任意の数に決められますが、乗騎など一部の特別な品はいつでも一つずつしか売られません。コイン価格の重ねられる品には、行の横にもうひとつの申し出があり、手持ちのコインでまかなえるだけの数を、最大ひと山まで一度に買えます。売却も同じくらい直接的です。店が開いている間にバッグのアイテムをクリックすればその場で売れ、商人が受け取らないもの、たとえばクエスト品やアカウント縛りの品は、そのまま手元に残ります。手放して後悔したものがあっても、店は最近の売却品の買い戻し一覧を取り置いており、売ったときと同じコインで買い戻せます。',
  'guide.social.guildBankRulesBodyAccountBound': 'アイテムの蓄えは、最初は閉じています。オフィサーが自腹で開き、あとからギルドが金庫の資金で広げられます。クエストアイテム、アカウント縛りのもの、マーケットが扱わない装備は入れられません。マーケットと同じ扱いで、つまりギルド銀行は、まだプレイヤーの間で人手を渡れる品物のためのものです。',
  'guide.arenaPage.honorFinalNoteAccountBound': '名誉での購入は取り消せません。コインでの買い物なら商人の買い戻し一覧からやり直せますが、名誉での購入がそこに並ぶことは決してなく、ウォーフェア装備は買った瞬間にアカウント縛りになるため、取引にも売り戻しにも二度と回せず、送れる先はあなた自身の別のキャラクターだけです。商店がわざわざ確認を求めるのはそのためです。押す前に、その一点をよく読みましょう。',
};
