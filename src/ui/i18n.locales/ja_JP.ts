...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'character.respec': '再振り分け',
  'character.respecHint':
    '$WOC をバーンしてタレントをリセットするか、追加のロードアウト枠を解放します。',
  'character.respecPaidButton': '{amount} $WOC でタレントをリセット',
  'character.loadoutSlotPaidButton': '{amount} $WOC でロードアウト枠を解放',
  'character.respecCancel': 'キャンセル',
  'character.respecSuccess': 'タレントをリセットしました。',
  'character.loadoutSlotSuccess': 'ロードアウト枠を解放しました。',
