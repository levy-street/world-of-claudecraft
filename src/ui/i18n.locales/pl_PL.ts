...
export const pl_PL: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Sandały Popiołochodu',
  'entities.items.cinderarc_odrenns_rod.name': 'Łuk Żaru, różdżka Odrenna',
  'entities.items.cindertoad_signet.name': 'Sygnet Żarnej Ropuchy',
  'entities.items.coalglow_band.name': 'Pierścień Węglowego Blasku',
  'entities.items.crownforged_warleggings.name': 'Koronokute nogawice bojowe',
  'entities.items.glassblowers_shiv.name': 'Nóż Dmuchacza Szkła',
  'entities.items.glasswalker_treads.name': 'Buty Szkłochodu',
  'entities.items.nighttalon_prowlers.name': 'Buty Nocnego Szpona',
  'entities.items.quenchsilk_cord.name': 'Sznur Hartowanego Jedwabiu',
  'entities.items.ring_of_the_first_quench.name': 'Pierścień Pierwszego Hartowania',
  'entities.items.saans_stoking_iron.name': 'Pogrzebacz Saana',
  'entities.items.slag_tempered_sabatons.name': 'Trzewiki Hartowane Żużlem',
  'entities.items.slakeleather_belt.name': 'Pas z Hartowanej Skóry',
  'entities.items.sluicebearer.name': 'Śluzonośca',
  'entities.items.soulflame_kilt.name': 'Kilt duszopłomienia',
  'entities.items.stokebrand_striders.name': 'Buty Żagwiowego Piętna',
  'entities.items.stormcallers_legwraps.name': 'Owijki Przywoływacza Burz',
  'entities.items.the_even_temper.name': 'Równy Hart',
  'entities.items.twice_fired_slippers.name': 'Dwukrotnie Wypalane Pantofle',
  'entities.items.twicetempered_girdle.name': 'Podwójnie Hartowany Pas',
  'entities.items.crownforged_heartplate.name': 'Napierśnik Serca Koronokutych',
  'entities.items.nighttalon_emberweave.name': 'Żarotkanina Nocnego Szponu',
  'entities.items.soulflame_vestments.name': 'Szaty Płomienia Duszy',
  'entities.items.stormcallers_hauberk.name': 'Kolczuga Wzywającego Burze',
  'entities.items.volzharrs_knucklestone.name': 'Kamień Pięści Volzharra',
  'entities.items.magmastrider_greaves.name': 'Nagolenniki Magmowego Kroku',
  'entities.items.footwraps_of_the_waking_floor.name': 'Owijacze Budzącej się Posadzki',
  'entities.items.forgeheat_cinch.name': 'Pas Żaru Kuźni',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Łamacz Rdzenia, Serce Podgórza',
  'entities.items.the_last_restraint.name': 'Ostatnie Więzy',
  'entities.items.band_of_the_ninth_quench.name': 'Pierścień Dziewiątego Hartowania',
  'entities.items.moltenheart_chroma.name': 'Stopione Serce',
  'entities.itemSets.crownforged.bonus5': 'Zwiększa szansę na trafienie krytyczne o 3%.',
  'entities.itemSets.nighttalon.bonus5': 'Zwiększa szansę na trafienie krytyczne o 3%.',
  'entities.itemSets.soulflame.bonus5': 'Zwiększa szansę na krytyczne trafienie zaklęciem o 3%.',
  'entities.itemSets.stormcallers.bonus5': 'Zwiększa szansę na krytyczne trafienie zaklęciem o 3%.',
};
