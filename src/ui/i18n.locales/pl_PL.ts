...
export const pl_PL: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Jesionowa laska',
  'entities.items.gravecaller_cloth_handwraps.name': 'Płócienne owijacze Grobowego Przywoływacza',
  'entities.items.gravecaller_cloth_hood.name': 'Płócienny kaptur Grobowego Przywoływacza',
  'entities.items.gravecaller_cloth_leggings.name': 'Płócienne nogawice Grobowego Przywoływacza',
  'entities.items.gravecaller_cloth_mantle.name': 'Płócienny płaszcz Grobowego Przywoływacza',
  'entities.items.gravecaller_cloth_raiment.name': 'Płócienna szata Grobowego Przywoływacza',
  'entities.items.gravecaller_cloth_sash.name': 'Płócienna szarfa Grobowego Przywoływacza',
  'entities.items.gravecaller_cloth_slippers.name': 'Płócienne pantofle Grobowego Przywoływacza',
  'entities.items.gravecaller_focus.name': 'Fokus Grobowego Przywoływacza',
  'entities.items.gravecaller_pendant.name': 'Wisiorek Grobowego Przywoływacza',
  'entities.items.gravecaller_ring.name': 'Pierścień Grobowego Przywoływacza',
  'entities.items.gravecaller_wand.name': 'Różdżka Grobowego Przywoływacza',
  'entities.items.iron_broadsword.name': 'Żelazny pałasz',
  'entities.items.iron_flanged_mace.name': 'Żelazna buława kołnierzowa',
  'entities.items.mirefen_dirk.name': 'Sztylet z Mirefen',
  'entities.items.mirefen_hunting_bow.name': 'Łuk myśliwski z Mirefen',
  'entities.items.mirefen_leather_belt.name': 'Skórzany pas z Mirefen',
  'entities.items.mirefen_leather_boots.name': 'Skórzane buty z Mirefen',
  'entities.items.mirefen_leather_gloves.name': 'Skórzane rękawice z Mirefen',
  'entities.items.mirefen_leather_hood.name': 'Skórzany kaptur z Mirefen',
  'entities.items.mirefen_leather_jerkin.name': 'Skórzany kaftan z Mirefen',
  'entities.items.mirefen_leather_leggings.name': 'Skórzane nogawice z Mirefen',
  'entities.items.mirefen_leather_shoulderguards.name': 'Skórzane naramienniki z Mirefen',
  'entities.items.thornpeak_bulwark.name': 'Bastion Thornpeak',
  'entities.items.thornpeak_crossbow.name': 'Kusza Thornpeak',
  'entities.items.thornpeak_mail_chest.name': 'Kolczy napierśnik Thornpeak',
  'entities.items.thornpeak_mail_gauntlets.name': 'Kolcze rękawice Thornpeak',
  'entities.items.thornpeak_mail_girdle.name': 'Kolczy pas Thornpeak',
  'entities.items.thornpeak_mail_helm.name': 'Kolczy hełm Thornpeak',
  'entities.items.thornpeak_mail_legguards.name': 'Kolcze nogawice Thornpeak',
  'entities.items.thornpeak_mail_pauldrons.name': 'Kolcze naramienniki Thornpeak',
  'entities.items.thornpeak_mail_sabatons.name': 'Kolcze sabatony Thornpeak',
  'entities.items.thornpeak_polearm.name': 'Broń drzewcowa Thornpeak',
  'entities.items.thornpeak_war_axe.name': 'Topór bojowy Thornpeak',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Potrzeba jest niedostępna, ponieważ twoja klasa nie może wyposażyć tego przedmiotu.',
  'itemUi.lootRoll.needUnavailablePower':
    'Potrzeba jest niedostępna, ponieważ ta legendarna moc jest przeznaczona dla innej klasy.',
  'itemUi.procedural.advancedDetailsHint':
    'Przytrzymaj {key}, aby wyświetlić możliwe zakresy losowania.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Co czwarty Pocisk mroku oznacza cel, zwiększając otrzymywane przez niego obrażenia Cienia.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Pieczęć Wiążącego Popioły',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Co drugie zaklęcie zadające obrażenia rozbrzmiewa wokół celu.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Dzwon Dziewiątego Uderzenia',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Przebycie 15 jardów zapewnia krótkie zwiększenie szybkości ruchu.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Buty Nieprzerwanej Drogi',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Co trzeci Żarowy pocisk przypala wrogów w pobliżu celu.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Korona Ostatniego Stosu',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Kojące Światło osłania odbiorcę tarczą równą części leczenia.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Sygnet Straży Świtu',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Co trzeci Dziki pocisk odnawia główny zasób.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Klamra Dzikiego Księżyca',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Co trzecie trafienie bronią wywołuje krwawienie celu i odnawia trochę zasobu.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Ostrze Szarej Szczęki',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Długie naciągnięcie lub Plugawy strzał mogą na krótko uciszyć cel.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Długi Łuk Cichego Lasu',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Spadek poniżej 35% zdrowia zapewnia krótką osłonę obronną.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Płaszcz Skradzionych Godzin',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Zabicie zapewnia krótki przypływ pośpiechu.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Kieł Nocnego Szkła',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Co czwarty Łukowy pocisk przeskakuje na pobliskich wrogów.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Idol Przebudzenia Burzy',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Leczenie krytyczne tworzy na krótko odnawiający obszar na ziemi.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Czuwanie Ysolei',
  'itemUi.procedural.legendaryLimit': 'Unikatowe wyposażenie: {count} legendarna moc',
  'itemUi.procedural.legendaryPower': 'Legendarna moc',
  'itemUi.procedural.nameFragment.deft': 'Zręczny',
  'itemUi.procedural.nameFragment.mighty': 'Potężny',
  'itemUi.procedural.nameFragment.of_alacrity': 'Żwawości',
  'itemUi.procedural.nameFragment.of_focus': 'Skupienia',
  'itemUi.procedural.nameFragment.of_precision': 'Precyzji',
  'itemUi.procedural.nameFragment.of_reaping': 'Żniw',
  'itemUi.procedural.nameFragment.of_remembrance': 'Pamięci',
  'itemUi.procedural.nameFragment.of_striking': 'Uderzenia',
  'itemUi.procedural.nameFragment.sages': 'Mędrca',
  'itemUi.procedural.nameFragment.spiritual': 'Duchowy',
  'itemUi.procedural.nameFragment.stalwart': 'Niezłomny',
  'itemUi.procedural.nameFragment.warded': 'Chroniony',
  'itemUi.procedural.powerRollMilliseconds': 'Losowanie mocy: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Losowanie mocy: {value}',
  'itemUi.procedural.powerRollPercent': 'Losowanie mocy: {value}%',
  'itemUi.procedural.powerRollResource': 'Losowanie mocy: {value} zasobu',
  'itemUi.procedural.rareWord.ashen': 'Popielaty',
  'itemUi.procedural.rareWord.bite': 'Ugryzienie',
  'itemUi.procedural.rareWord.blackfen': 'Czarne Mokradło',
  'itemUi.procedural.rareWord.brand': 'Piętno',
  'itemUi.procedural.rareWord.doom': 'Zguba',
  'itemUi.procedural.rareWord.grave': 'Grób',
  'itemUi.procedural.rareWord.mire': 'Trzęsawisko',
  'itemUi.procedural.rareWord.oath': 'Przysięga',
  'itemUi.procedural.rareWord.promise': 'Obietnica',
  'itemUi.procedural.rareWord.storm': 'Burza',
  'itemUi.procedural.rareWord.thorn': 'Cierń',
  'itemUi.procedural.rareWord.thread': 'Nić',
  'itemUi.procedural.rareWord.vigil': 'Czuwanie',
  'itemUi.procedural.rareWord.ward': 'Osłona',
  'itemUi.procedural.rareWord.whisper': 'Szept',
  'itemUi.procedural.rareWord.wyrm': 'Żmij',
  'itemUi.procedural.rarity.common': 'Pospolita',
  'itemUi.procedural.rarity.epic': 'Epicka',
  'itemUi.procedural.rarity.legendary': 'Legendarna',
  'itemUi.procedural.rarity.magic': 'Magiczna',
  'itemUi.procedural.rarity.mythic': 'Mityczna',
  'itemUi.procedural.rarity.rare': 'Rzadka',
  'itemUi.procedural.rollRangeAria': 'Możliwe losowanie od {min} do {max}',
  'itemUi.stats.blockValue': 'Wartość bloku',
  'itemUi.stats.healthOnKill': 'Zdrowie za zabicie',
  'itemUi.stats.manaOnKill': 'Mana za zabicie',
  ...
  'hudChrome.bags.itemAriaProceduralBound':
    '{item}, {rarity}, poziom przedmiotu {level}, liczba {count}, przypisana kopia',
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}, {rarity}, poziom przedmiotu {level}, liczba {count}, zaklęta kopia',
  ...
  'hudChrome.finder.raidItemLevels':
    'Poziom przedmiotu: rzadki {rare} · epicki {epic} · legendarny {legendary}',
  'hudChrome.finder.raidRarityLine': 'Rzadki {rare}% · epicki {epic}% · legendarny {legendary}%',
  'hudChrome.finder.raidRewards': 'Podgląd nagród z Nythraxis',
  'hudChrome.finder.raidSharedDrop':
    'Zwłoki ostatniego bossa dodają jeden wspólny przedmiot proceduralny, o który rajd może rzucić kośćmi.',
  'hudChrome.finder.raidSignatures': 'Charakterystyczne moce legendarne: {signatures}',
  ...
  'hudChrome.enchanting.disenchantedYield': 'Odczarowujesz {item}, uzyskując {material}.',
  'hudChrome.enchanting.disenchantedYieldQty': 'Odczarowujesz {item}, uzyskując {material} x{qty}.',
  'hudChrome.enchanting.plainTag': 'Bez zaklęcia',
  'hudChrome.enchanting.replaceConfirmKeeps': 'Zachowano: {kept}',
  'hudChrome.enchanting.replaceConfirmKeepsBond': 'Więź zlecenia',
  'hudChrome.enchanting.replaceConfirmKeepsMasterwork': 'Premia mistrzowska',
  ...
  'hudChrome.gathering.harvestLine': 'Pozyskujesz: {name}.',
  'hudChrome.gathering.harvestLineQty': 'Pozyskujesz: {name} x{qty}.',
  'hudChrome.gathering.harvestSpecimenLine': 'Odzyskujesz również {name}.',
};
