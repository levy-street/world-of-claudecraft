...
export const cs_CZ: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Jasanová hůl',
  'entities.items.gravecaller_cloth_handwraps.name': 'Látkové oviny Hrobaře',
  'entities.items.gravecaller_cloth_hood.name': 'Látková kápě Hrobaře',
  'entities.items.gravecaller_cloth_leggings.name': 'Látkové nohavice Hrobaře',
  'entities.items.gravecaller_cloth_mantle.name': 'Látkový plášť Hrobaře',
  'entities.items.gravecaller_cloth_raiment.name': 'Látkové roucho Hrobaře',
  'entities.items.gravecaller_cloth_sash.name': 'Látková šerpa Hrobaře',
  'entities.items.gravecaller_cloth_slippers.name': 'Látkové střevíce Hrobaře',
  'entities.items.gravecaller_focus.name': 'Fokus Hrobaře',
  'entities.items.gravecaller_pendant.name': 'Přívěsek Hrobaře',
  'entities.items.gravecaller_ring.name': 'Prsten Hrobaře',
  'entities.items.gravecaller_wand.name': 'Hůlka Hrobaře',
  'entities.items.iron_broadsword.name': 'Železný široký meč',
  'entities.items.iron_flanged_mace.name': 'Železný přírubový palcát',
  'entities.items.mirefen_dirk.name': 'Dýka z Mirefenu',
  'entities.items.mirefen_hunting_bow.name': 'Lovecký luk z Mirefenu',
  'entities.items.mirefen_leather_belt.name': 'Kožený opasek z Mirefenu',
  'entities.items.mirefen_leather_boots.name': 'Kožené boty z Mirefenu',
  'entities.items.mirefen_leather_gloves.name': 'Kožené rukavice z Mirefenu',
  'entities.items.mirefen_leather_hood.name': 'Kožená kápě z Mirefenu',
  'entities.items.mirefen_leather_jerkin.name': 'Kožený kabátec z Mirefenu',
  'entities.items.mirefen_leather_leggings.name': 'Kožené nohavice z Mirefenu',
  'entities.items.mirefen_leather_shoulderguards.name': 'Kožené nárameníky z Mirefenu',
  'entities.items.thornpeak_bulwark.name': 'Bašta Thornpeaku',
  'entities.items.thornpeak_crossbow.name': 'Kuše Thornpeaku',
  'entities.items.thornpeak_mail_chest.name': 'Kroužkový hrudní plát Thornpeaku',
  'entities.items.thornpeak_mail_gauntlets.name': 'Kroužkové rukavice Thornpeaku',
  'entities.items.thornpeak_mail_girdle.name': 'Kroužkový pás Thornpeaku',
  'entities.items.thornpeak_mail_helm.name': 'Kroužková přilba Thornpeaku',
  'entities.items.thornpeak_mail_legguards.name': 'Kroužkové chrániče nohou Thornpeaku',
  'entities.items.thornpeak_mail_pauldrons.name': 'Kroužkové nárameníky Thornpeaku',
  'entities.items.thornpeak_mail_sabatons.name': 'Kroužkové sabatony Thornpeaku',
  'entities.items.thornpeak_polearm.name': 'Dřevcová zbraň Thornpeaku',
  'entities.items.thornpeak_war_axe.name': 'Válečná sekera Thornpeaku',
  ...
  'itemUi.lootRoll.needUnavailable':
    'Potřeba není dostupná, protože tvá třída nemůže tento předmět vybavit.',
  'itemUi.lootRoll.needUnavailablePower':
    'Potřeba není dostupná, protože tato legendární moc je vyhrazena jiné třídě.',
  'itemUi.procedural.advancedDetailsHint': 'Podržením {key} zobrazíš možné rozsahy hodů.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Každý čtvrtý Šíp šera označí cíl, který pak utrpí dodatečné stínové poškození.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Pečeť Poutače popela',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Každé druhé kouzlo způsobující poškození zazní kolem cíle.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Zvon Devátého úderu',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    'Překonání 15 yardů krátce zvýší rychlost pohybu.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Boty Nepřerušené cesty',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Každý třetí Škvárový šíp sežehne nepřátele poblíž cíle.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Koruna Poslední hranice',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Léčivé světlo ochrání příjemce štítem za část vyléčeného zdraví.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Pečetní prsten Úsvitu',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Každý třetí Šíp divočiny obnoví primární zdroj.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Spona Divokého měsíce',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Každý třetí zásah zbraní způsobí cíli krvácení a obnoví trochu zdroje.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Ostří Šedé čelisti',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Dlouhý nátah nebo Prokletý výstřel mohou cíl krátce umlčet.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Dlouhý luk Tichého lesa',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Pokles pod 35% zdraví krátce poskytne obrannou ochranu.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Plášť Ukradených hodin',
  'itemUi.procedural.legendary.nightglass_fang.description': 'Zabití krátce zvýší spěch.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Tesák Nočního skla',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Každý čtvrtý Bleskový šíp přeskočí na blízké nepřátele.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Modla Probuzení bouře',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Kritické léčení krátce vytvoří na zemi obnovující oblast.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Ysoleina stráž',
  'itemUi.procedural.legendaryLimit': 'Unikátní výbava: {count} legendární moc',
  'itemUi.procedural.legendaryPower': 'Legendární moc',
  'itemUi.procedural.nameFragment.deft': 'Obratný',
  'itemUi.procedural.nameFragment.mighty': 'Mocný',
  'itemUi.procedural.nameFragment.of_alacrity': 'Hbitosti',
  'itemUi.procedural.nameFragment.of_focus': 'Soustředění',
  'itemUi.procedural.nameFragment.of_precision': 'Přesnosti',
  'itemUi.procedural.nameFragment.of_reaping': 'Sklizně',
  'itemUi.procedural.nameFragment.of_remembrance': 'Vzpomínání',
  'itemUi.procedural.nameFragment.of_striking': 'Úderu',
  'itemUi.procedural.nameFragment.sages': 'Mudrcův',
  'itemUi.procedural.nameFragment.spiritual': 'Duchovní',
  'itemUi.procedural.nameFragment.stalwart': 'Neochvějný',
  'itemUi.procedural.nameFragment.warded': 'Chráněný',
  'itemUi.procedural.powerRollMilliseconds': 'Hod moci: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Hod moci: {value}',
  'itemUi.procedural.powerRollPercent': 'Hod moci: {value}%',
  'itemUi.procedural.powerRollResource': 'Hod moci: {value} zdroje',
  'itemUi.procedural.rareWord.ashen': 'Popelavý',
  'itemUi.procedural.rareWord.bite': 'Kousnutí',
  'itemUi.procedural.rareWord.blackfen': 'Černá bažina',
  'itemUi.procedural.rareWord.brand': 'Znamení',
  'itemUi.procedural.rareWord.doom': 'Zkáza',
  'itemUi.procedural.rareWord.grave': 'Hrob',
  'itemUi.procedural.rareWord.mire': 'Močál',
  'itemUi.procedural.rareWord.oath': 'Přísaha',
  'itemUi.procedural.rareWord.promise': 'Slib',
  'itemUi.procedural.rareWord.storm': 'Bouře',
  'itemUi.procedural.rareWord.thorn': 'Trn',
  'itemUi.procedural.rareWord.thread': 'Vlákno',
  'itemUi.procedural.rareWord.vigil': 'Stráž',
  'itemUi.procedural.rareWord.ward': 'Ochrana',
  'itemUi.procedural.rareWord.whisper': 'Šepot',
  'itemUi.procedural.rareWord.wyrm': 'Drak',
  'itemUi.procedural.rarity.common': 'Běžná',
  'itemUi.procedural.rarity.epic': 'Epická',
  'itemUi.procedural.rarity.legendary': 'Legendární',
  'itemUi.procedural.rarity.magic': 'Magická',
  'itemUi.procedural.rarity.mythic': 'Mýtická',
  'itemUi.procedural.rarity.rare': 'Vzácná',
  'itemUi.procedural.rollRangeAria': 'Možný hod od {min} do {max}',
  'itemUi.stats.blockValue': 'Hodnota blokování',
  'itemUi.stats.healthOnKill': 'Zdraví za zabití',
  'itemUi.stats.manaOnKill': 'Mana za zabití',
  ...
  'hudChrome.enchanting.disenchantedAlso': 'Také získáš zpět {material}.',
  'hudChrome.enchanting.disenchantedAlsoQty': 'Také získáš zpět {material} x{qty}.',
  'hudChrome.enchanting.disenchantedYield': 'Rozzačarováním {item} získáš {material}.',
  'hudChrome.enchanting.disenchantedYieldQty': 'Rozzačarováním {item} získáš {material} x{qty}.',
  'hudChrome.enchanting.plainTag': 'Bez očarování',
  'hudChrome.enchanting.replaceConfirmKeeps': 'Zachováno: {kept}',
  ...
  'hudChrome.enchanting.salvagedYield': 'Rozebráním {item} získáš {material}.',
  'hudChrome.enchanting.salvagedYieldQty': 'Rozebráním {item} získáš {material} x{qty}.',
  'hudChrome.gathering.harvestLine': 'Sklidíš: {name}.',
  'hudChrome.gathering.harvestLineQty': 'Sklidíš: {name} x{qty}.',
  'hudChrome.gathering.harvestSpecimenLine': 'Navíc získáš {name}.',
};
