...
export const cs_CZ: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Sandály popelochodce',
  'entities.items.cinderarc_odrenns_rod.name': 'Žhavý oblouk, Odrennův prut',
  'entities.items.cindertoad_signet.name': 'Pečetní prsten žhavé ropuchy',
  'entities.items.coalglow_band.name': 'Prsten uhelné záře',
  'entities.items.crownforged_warleggings.name': 'Korunou kované válečné nohavice',
  'entities.items.glassblowers_shiv.name': 'Sklářovo šídlo',
  'entities.items.glasswalker_treads.name': 'Boty sklochodce',
  'entities.items.nighttalon_prowlers.name': 'Boty nočního spáru',
  'entities.items.quenchsilk_cord.name': 'Šňůra z kalicího hedvábí',
  'entities.items.ring_of_the_first_quench.name': 'Prsten prvního zakalení',
  'entities.items.saans_stoking_iron.name': 'Saanův pohrabáč',
  'entities.items.slag_tempered_sabatons.name': 'Struskou kalené sabatony',
  'entities.items.slakeleather_belt.name': 'Opasek z kalicí kůže',
  'entities.items.sluicebearer.name': 'Stavidlonoš',
  'entities.items.soulflame_kilt.name': 'Kilt plamene duše',
  'entities.items.stokebrand_striders.name': 'Boty žhavého cejchu',
  'entities.items.stormcallers_legwraps.name': 'Ovinovačky vyvolávače bouří',
  'entities.items.the_even_temper.name': 'Rovnoměrný popust',
  'entities.items.twice_fired_slippers.name': 'Dvakrát pálené střevíce',
  'entities.items.twicetempered_girdle.name': 'Dvakrát kalený pás',
  'entities.items.crownforged_heartplate.name': 'Korunokovaná hrudní zbroj',
  'entities.items.nighttalon_emberweave.name': 'Žhavotkanina Nočního spáru',
  'entities.items.soulflame_vestments.name': 'Roucha plamene duše',
  'entities.items.stormcallers_hauberk.name': 'Hauberk Volatele bouří',
  'entities.items.volzharrs_knucklestone.name': 'Volzharrův pěstní kámen',
  'entities.items.magmastrider_greaves.name': 'Holenice lávochodce',
  'entities.items.footwraps_of_the_waking_floor.name': 'Ovinutí Probuzené podlahy',
  'entities.items.forgeheat_cinch.name': 'Pás žáru výhně',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Drtič jádra, Srdce Podhory',
  'entities.items.the_last_restraint.name': 'Poslední zábrana',
  'entities.items.band_of_the_ninth_quench.name': 'Prsten devátého zchlazení',
  'entities.items.moltenheart_chroma.name': 'Žhavé srdce',
  'entities.itemSets.crownforged.bonus5': 'Zvyšuje šanci na kritický zásah o 3 %.',
  'entities.itemSets.nighttalon.bonus5': 'Zvyšuje šanci na kritický zásah o 3 %.',
  'entities.itemSets.soulflame.bonus5': 'Zvyšuje šanci na kritický zásah kouzlem o 3 %.',
  'entities.itemSets.stormcallers.bonus5': 'Zvyšuje šanci na kritický zásah kouzlem o 3 %.',
};
