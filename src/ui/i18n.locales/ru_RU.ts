...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.boundstone_bulwark.name': 'Оплот связанного камня',
  'entities.items.drownedmoon_aegis.name': 'Эгида утонувшей луны',
  'entities.items.gravewyrm_bulwark.name': 'Оплот могильного змея',
