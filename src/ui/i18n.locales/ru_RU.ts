...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.mobile.customize": "Настроить",
  "hudChrome.mobile.customizeTitle": "Настройка управления",
  "hudChrome.mobile.customizeSlotAttack": "Обычная атака",
  "hudChrome.mobile.customizeSlotSkill": "Умение {n}",
  "hudChrome.mobile.customizeSlotUtility": "Поддержка",
  "hudChrome.mobile.customizeDefault": "По умолчанию для класса",
  "hudChrome.mobile.customizeResetSlot": "Сбросить эту ячейку",
  "hudChrome.mobile.customizeResetAll": "Сбросить всё к настройкам класса",
  "hudChrome.mobile.customizeUpdated": "{slot} обновлено.",
  "hudChrome.mobile.customizeAllReset": "Управление сброшено к настройкам класса.",
  "hudChrome.options.touchControls": "Сенсорное управление",
  "hudChrome.options.clusterHold": "Задержка удержания для правки",
  "hudChrome.options.clusterHoldNote": "Как долго удерживать экранную кнопку действия, прежде чем откроется редактор привязок. Увеличьте значение, если редактор открывается во время быстрого использования умений.",
  "hudChrome.options.targetPriority": "Приоритет цели атаки",
  "hudChrome.options.targetPriorityNearest": "Ближайший",
  "hudChrome.options.targetPriorityLowestHp": "Наименьшее здоровье",
  "hudChrome.options.targetPriorityCurrent": "Сначала текущая",
  "hudChrome.options.targetPriorityNote": "На кого нацеливается кнопка атаки, когда нет подходящей цели: ближайший враг, враг с наименьшим здоровьем в пределах досягаемости или сохранение текущей цели, пока она остаётся допустимой.",
  "hudChrome.options.aimAssist": "Умное применение умений",
  "hudChrome.options.aimAssistNote": "Нажмите атакующее умение, чтобы применить его к цели или к лучшему врагу поблизости, если цели нет, поворачиваясь к нему. Удерживайте кнопку, чтобы увидеть дальность умения; отпустите, убрав палец с кнопки, чтобы отменить.",
  "hudChrome.options.touchReset": "Сбросить сенсорное управление",
  "hudChrome.options.touchResetDone": "Сенсорное управление сброшено к значениям по умолчанию.",
