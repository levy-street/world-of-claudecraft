...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.errors.tradeBusy': 'Этот игрок уже участвует в обмене.',
  'hud.errors.tradeUsage': 'С кем обменяться? Использование: /trade <имя>.',
  'hud.errors.claudiumTradeOff': 'Обмен Claudium сейчас недоступен.',
  'hud.errors.wocTradeOff': 'Обмен WOC сейчас недоступен.',
  'hud.errors.wocTradeLink': 'Привяжите кошелек, чтобы обмениваться WOC.',
  'hud.errors.wocTradePartnerLink': 'У вашего партнера по обмену нет привязанного кошелька.',
  'hud.errors.wocTradeOneSide': 'Предлагать WOC в обмене может только одна сторона.',
  'hud.errors.tradeSettleTimeout':
    'Обмен отменен: время ожидания платежа истекло. Ваши вещи возвращены.',
  'hud.errors.tradeSettleCancelled': 'Обмен отменен. Ваши вещи возвращены.',
  'hud.errors.tradeSettleUnavailable': 'Не удалось завершить обмен. Ваши вещи возвращены.',
  ...
  'hud.logs.tradeDeclined': '{name} отклонил ваш запрос на обмен.',
  ...
  'hud.trade.settlingTitle': 'Завершение сделки…',
  'hud.trade.legYourWoc': 'Ваш платеж WOC',
  'hud.trade.legTheirWoc': 'Платеж WOC партнера',
  'hud.trade.statusPending': 'В ожидании',
  'hud.trade.wocPayPrompt':
    'Отправьте {amount} WOC с привязанного кошелька, чтобы завершить обмен.',
  'hud.trade.openInWallet': 'Открыть в кошельке',
  'hud.trade.copyLink': 'Скопировать ссылку на платеж',
  'hud.trade.copiedLink': 'Ссылка на платеж скопирована.',
  'hud.trade.instanceSignedBy': 'Подписано: {name}',
  'hud.trade.instanceUnique': 'Уникальная копия',
  ...
  'itemUi.market.sortLabel': 'Сортировка',
  'itemUi.market.sortNewest': 'Новые',
  'itemUi.market.sortPrice': 'Цена',
  'itemUi.market.sortTimeLeft': 'Осталось времени',
  'itemUi.market.timeLeft': 'Осталось {time}',
  'itemUi.market.yourBidBadge': 'Ваша ставка',
  'itemUi.market.currentBidLabel': 'Ставка:',
  'itemUi.market.noBidsYet': 'Ставок пока нет',
  'itemUi.market.minNextBid': 'Мин. ставка {money}',
  'itemUi.market.buyoutLabel': 'Выкуп {money}',
  'itemUi.market.auctionBadge': 'Аукцион',
  'itemUi.market.leadingBid': 'Вы лидируете',
  'itemUi.market.bidInputAria': 'Сумма ставки за {item}',
  'itemUi.market.bidButton': 'Ставка',
  'itemUi.market.bidAria': 'Сделать ставку на {item}',
  'itemUi.market.buyoutButton': 'Выкупить',
  'itemUi.market.buyoutAria': 'Выкупить {item} за {price}',
  'itemUi.market.buyQuantityAria': 'Количество {item} для покупки',
  'itemUi.market.listingTypeLabel': 'Тип продажи',
  'itemUi.market.listingTypeFixed': 'Фиксированная цена',
  'itemUi.market.listingTypeAuction': 'Аукцион',
  'itemUi.market.durationLabel': 'Срок продажи',
  'itemUi.market.durationOption': '{hours} ч',
  'itemUi.market.startingBidLabel': 'Начальная ставка',
  'itemUi.market.buyoutOptionalLabel': 'Выкуп (необязательно)',
  'itemUi.market.totalLabel': 'Итого',
  'itemUi.market.depositPreviewLabel': 'Залог за размещение',
  'itemUi.market.cancelConfirmTitle': 'Забрать лот',
  'itemUi.market.cancelConfirmBody': 'Забрать {item} с рынка? Залог {money} будет утрачен.',
  'itemUi.market.cancelConfirmBodyNoDeposit': 'Забрать {item} с рынка?',
  'itemUi.market.cancelConfirmDismiss': 'Отмена',
  'itemUi.market.outbidToast':
    'Вашу ставку на {item} перебили. {money} возвращены в ваш ящик получения.',
  'itemUi.market.wonToast': 'Вы выиграли аукцион за {item}! Заберите его у Торговца.',
  ...
  'itemUi.errors.minStartingBid': 'Назначьте начальную ставку не менее 1 медяка.',
  'itemUi.errors.buyoutTooLow': 'Цена выкупа должна быть выше начальной ставки.',
  'itemUi.errors.chooseDuration': 'Выберите срок продажи: 12, 24 или 48 часов.',
  'itemUi.errors.cannotAffordDeposit': 'Вам не хватает средств на залог за размещение.',
  'itemUi.errors.bidsOnly': 'Этот лот продается только через ставки.',
  'itemUi.errors.notAuction': 'Этот лот не выставлен на аукцион.',
  ...
  'guide.economy.marketBrowse':
    'Просмотр: листайте объявления или ищите по названию, чтобы найти то, что выставлено на продажу. В каждом объявлении указаны товары, продавец, оставшееся время и либо цена за штуку для стопки, которую можно купить частями, либо текущая ставка для аукционного лота.',
  ...
  'entities.letters.market_outbid.sender': 'Торговец',
  'entities.letters.market_outbid.subject': 'Вашу ставку перебили',
  'entities.letters.market_outbid.body':
    'Другой покупатель поднял ставку на лот, который вы хотели получить. Ваши медяки ждут в ящике получения на Мировом Рынке; приходите забрать их или сделать новую ставку.\n\n- Торговец',
  'entities.letters.market_won.sender': 'Торговец',
  'entities.letters.market_won.subject': 'Ваша выигранная ставка',
  'entities.letters.market_won.body':
    'Молоток упал, и лот теперь ваш. Ваш товар ждет в ящике получения на Мировом Рынке; приходите забрать его.\n\n- Торговец',
  'entities.letters.market_sold.sender': 'Торговец',
  'entities.letters.market_sold.subject': 'Ваш лот продан',
  'entities.letters.market_sold.body':
    'Покупатель забрал ваш товар. Ваша выручка ждет в ящике получения на Мировом Рынке; приходите забрать ее.\n\n- Торговец',
  'entities.letters.market_expired.sender': 'Торговец',
  ...
  'entities.letters.trade_delivery.body':
    'Товары, полученные в результате обмена, прибыли. Ворон принес то, что не поместилось в ваши сумки.',
  'entities.letters.trade_refund.sender': 'Вороновая почта',
  'entities.letters.trade_refund.subject': 'Товары по обмену возвращены',
  'entities.letters.trade_refund.body':
    'Обмен не состоялся. Все, что вы предложили, было возвращено вам.',
