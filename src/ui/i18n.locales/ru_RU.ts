...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.aldrin.entryLabel': 'Клуб Олдрина',
  'hudChrome.aldrin.title': 'Клуб Олдрина',
  'hudChrome.aldrin.intro':
    'Ежемесячное членство. Все привилегии только косметика, удобства или доступ: ничего, что дает силу.',
  'hudChrome.aldrin.loading': 'Загрузка...',
  'hudChrome.aldrin.unavailable': 'Клуб Олдрина недоступен в этом мире.',
  'hudChrome.aldrin.memberBadge': 'Участник',
  'hudChrome.aldrin.notMember': 'Вы пока не участник.',
  'hudChrome.aldrin.memberUntil': 'Членство до {date} (осталось дней: {days})',
  'hudChrome.aldrin.autoRenew': 'Продлевается автоматически по карточной подписке.',
  'hudChrome.aldrin.priceLine': '{amount} USD каждые {days} дней',
  'hudChrome.aldrin.splitLine':
    '{treasuryPct}% идет в открытую казну, {burnPct}% на выкуп и сжигание $WOC.',
  'hudChrome.aldrin.perksTitle': 'Привилегии членства',
  'hudChrome.aldrin.perk.aura': 'Золотая аура участника (только визуально)',
  'hudChrome.aldrin.perk.regalia': 'Трансмогрификация регалий Олдрина (только внешний вид)',
  'hudChrome.aldrin.perk.mount': 'Эксклюзивный клубный облик транспорта',
  'hudChrome.aldrin.perk.title': 'Титул «Член Клуба Олдрина»',
  'hudChrome.aldrin.perk.nameColor': 'Золотой цвет таблички с именем',
  'hudChrome.aldrin.perk.lounge': 'Клубная гостиная и канал чата для участников',
  'hudChrome.aldrin.perk.wardrobe': 'Дополнительные ячейки косметического гардероба',
  'hudChrome.aldrin.perk.queue': 'Приоритетная очередь входа при переполнении',
  'hudChrome.aldrin.perk.stipend': 'Ежемесячное косметическое пособие',
  'hudChrome.aldrin.methodsTitle': 'Способы оплаты',
  'hudChrome.aldrin.method.stripe': 'Карта (Stripe)',
  'hudChrome.aldrin.reason.clubDisabled': 'Недоступно, пока клуб отключен в этом мире.',
  'hudChrome.aldrin.reason.walletCannotSign':
    'Недоступно: привязанный кошелек подписывает только сообщения и не может подписывать транзакции.',
  'hudChrome.aldrin.reason.notConfigured': 'Не настроено в этом мире.',
  'hudChrome.aldrin.quoteTitle': 'Расчет оплаты: {method}',
  'hudChrome.aldrin.quoteAmount': 'Сумма: {amount} {method}',
  'hudChrome.aldrin.quoteMemo': 'Памятка (обязательна при оплате): {memo}',
  'hudChrome.aldrin.quoteExpires': 'Расчет действителен еще около {minutes} мин.',
  'hudChrome.aldrin.quoteExpired': 'Срок расчета истек. Запросите новый.',
  'hudChrome.aldrin.quoteError': 'Не удалось получить расчет. Повторите попытку позже.',
  'hudChrome.aldrin.railsNotice':
    'Платежи в этой сборке отключены до получения ключей оператора и финального одобрения. Из этого окна транзакции не отправляются.',
  'hudChrome.aldrin.stripeNotice':
    'Оплата картой откроется через Stripe, когда платежи будут включены.',
  'hudChrome.aldrin.close': 'Закрыть',
};
