...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.combatTextStyle': 'Стиль боевого текста',
  'hudChrome.options.combatTextClassic': 'Классический',
  'hudChrome.options.combatTextEnhanced': 'Улучшенный',
  ...
  'hud.combat.floatingParry': 'Парирование',
  ...
  'hud.combat.parried': '{target} парирует ваше {ability}.',
