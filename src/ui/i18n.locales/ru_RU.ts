...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.interactPrompt.interact': 'Действие',
  'hudChrome.interactPrompt.gather': 'Собрать',
  'hudChrome.interactPrompt.enter': 'Войти',
  'hudChrome.interactPrompt.leave': 'Выйти',
  'hudChrome.interactPrompt.name.lockedChest': 'Запертый сундук',
  'hudChrome.interactPrompt.name.rewardChest': 'Сундук с наградой',
  'hudChrome.interactPrompt.name.reliquary': 'Затонувший реликварий',
  'hudChrome.interactPrompt.name.bellShrine': 'Алтарь колокола',
  'hudChrome.interactPrompt.name.candleShrine': 'Алтарь свечи',
  'hudChrome.interactPrompt.name.reedShrine': 'Алтарь тростника',
  'hudChrome.interactPrompt.name.skullShrine': 'Алтарь черепа',
  'hudChrome.options.showInteractPrompt': 'Показывать подсказку действия',
  'hudChrome.options.interactHighlight': 'Подсвечивать объекты под курсором',
};
