...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'character.mintSolHint': 'Создайте собственное имя ‹имя›.worldofclaudecraft.sol за {amount} $WOC, оно ваше в блокчейне.',
  ...
  'woc.finalizeTimeout': 'Время ожидания финализации истекло. Если $WOC уже сожжены, откройте окно снова и повторите: платеж зачтется после финализации.',
