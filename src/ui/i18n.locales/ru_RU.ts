...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaEnd.victory': 'Победа',
  'hudChrome.arenaEnd.defeat': 'Поражение',
  'hudChrome.arenaEnd.draw': 'Ничья',
  'hudChrome.arenaEnd.colName': 'Имя',
  'hudChrome.arenaEnd.colKills': 'Добивания',
  'hudChrome.arenaEnd.colDamage': 'Нанесённый урон',
  'hudChrome.arenaEnd.colHealing': 'Исцеление',
  'hudChrome.arenaEnd.colRating': 'Рейтинг',
  'hudChrome.arenaEnd.colChange': 'Изменение',
  'hudChrome.arenaEnd.yourRating': 'Ваш рейтинг: с {before} до {after}',
  'hudChrome.arenaEnd.honorEarned': '+{honor} чести',
  'hudChrome.arenaEnd.leave': 'Выйти',
  'hudChrome.arenaEnd.close': 'Закрыть',
