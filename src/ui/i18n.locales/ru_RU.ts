...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'skinEvent.armored': 'Броня',
  'skinEvent.armoredAria': 'Облик брони 20 уровня',
  'skinEvent.armoredToggleOn': 'Надеть комплект брони',
  'skinEvent.armoredToggleOff': 'Снять комплект брони',
