...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.nythraxis_boss_arena.leaveText':
    'Вы возвращаетесь в холодный воздух Терновых высот.',
  'entities.dungeons.source_cave.name': 'Пещера Истока',
  'entities.dungeons.source_cave.enterText': 'Вы входите в Пещеру Истока.',
  'entities.dungeons.source_cave.leaveText': 'Вы покидаете Пещеру Истока.',
  ...
  'sim.sourceCave.enter': 'Вы входите в Пещеру Истока.',
  'sim.sourceCave.leave': 'Вы покидаете Пещеру Истока.',
  ...
  'sim.sourceCave.killProgress': '{name} повержен. (Побеждено {killed} из {total} в Пещере Истока)',
  'sim.sourceCave.cleared': 'Пещера Истока зачищена.',
