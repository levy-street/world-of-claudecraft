...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'wallet.guardianTierTitle': '{tier}, страж ликвидности',
  'wallet.guardianTiers.wader.name': 'Бродник',
  'wallet.guardianTiers.wader.title': 'Бродник отмелей',
  'wallet.guardianTiers.tidewatcher.name': 'Смотритель приливов',
  'wallet.guardianTiers.tidewatcher.title': 'Смотритель прилива',
  'wallet.guardianTiers.currentkeeper.name': 'Хранитель течений',
  'wallet.guardianTiers.currentkeeper.title': 'Хранитель течения',
  'wallet.guardianTiers.stormwarden.name': 'Штормовой страж',
  'wallet.guardianTiers.stormwarden.title': 'Страж шторма',
  'wallet.guardianTiers.abyssguard.name': 'Страж бездны',
  'wallet.guardianTiers.abyssguard.title': 'Часовой бездны',
  ...
  'hudChrome.wocSeason.noneHint': 'Сезон откроется, когда комиссия арены и выкупы начнут пополнять пул.',
  'hudChrome.wocSeason.statusActive': 'Активен',
  'hudChrome.wocSeason.statusEnded': 'Завершен',
  'hudChrome.wocSeason.ended': 'Этот сезон завершен.',
  'hudChrome.wocSeason.openEnded': 'Без срока',
  'hudChrome.wocSeason.poolLabel': 'Доступный пул наград',
  'hudChrome.wocSeason.emittedLabel': 'Выплачено {pct}% пула',
  'hudChrome.wocSeason.sinkLabel': 'Профинансировано',
  'hudChrome.wocSeason.invariant': 'Выплаты никогда не превысят поступления сезона: покупка > продажа, гарантируется в блокчейне.',
  'hudChrome.wocSeason.standingsTitle': 'Прогноз лучших получателей',
  'hudChrome.wocSeason.colPlayer': 'Игрок',
  'hudChrome.wocSeason.colRating': 'Рейтинг',
  'hudChrome.wocSeason.colReward': 'Награда ($WOC)',
  'hudChrome.wocSeason.projectedNote': 'Прогноз по текущему пулу и рейтингу арены; итоговые выплаты фиксируются при закрытии сезона.',
};
