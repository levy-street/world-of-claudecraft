...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.voice_echo_npc.title': 'Голос из воспоминаний',
  'entities.npcs.voice_echo_npc.greeting': 'Голос из-за костра... да, когда-то я и сам так звучал.',
  'entities.quests.q_echo_of_you.text':
    'Я потерял кое-что неподалеку. Не сходишь ли поискать для меня?',
  ...
  'hudChrome.voiceNpc.consentLabel':
    'Я соглашаюсь на клонирование моего записанного голоса сторонним ИИ-сервисом озвучки.',
  'hudChrome.voiceNpc.displayNameLabel': 'Отображаемое имя NPC',
  'hudChrome.voiceNpc.displayNamePlaceholder': 'Как назвать ваше эхо?',
  'hudChrome.voiceNpc.recordStart': 'Записать образец',
  'hudChrome.voiceNpc.recordStop': 'Остановить запись',
  'hudChrome.voiceNpc.recordingHint': 'Идет запись... говорите естественно до 30 секунд.',
  'hudChrome.voiceNpc.priceLabel': 'Цена: {price} $WOC',
  'hudChrome.voiceNpc.burnLabel': 'Сжечь $WOC и подтвердить',
  'hudChrome.voiceNpc.burnNotWired':
    'Подпись ончейн-сжигания в этой черновой сборке еще не подключена.',
  'hudChrome.voiceNpc.needWallet': 'Сначала подключите кошелек Solana.',
  'hudChrome.voiceNpc.needName': 'Введите отображаемое имя вашего NPC.',
  'hudChrome.voiceNpc.needConsent': 'Перед записью или загрузкой образца необходимо дать согласие.',
  'hudChrome.voiceNpc.micError': 'Не удалось получить доступ к микрофону.',
  'hudChrome.voiceNpc.uploadError': 'Не удалось загрузить образец голоса.',
  'hudChrome.voiceNpc.quoteError': 'Не удалось получить расчет цены.',
  'hudChrome.voiceNpc.confirmError': 'Не удалось подтвердить платеж.',
  'hudChrome.voiceNpc.statusPendingSample': 'Образец записан. Можно получить расчет и сжечь $WOC.',
  'hudChrome.voiceNpc.statusPendingClone':
    'Платеж подтвержден. Ожидаем начала клонирования голоса.',
  'hudChrome.voiceNpc.statusCloning': 'Клонируем ваш голос...',
  'hudChrome.voiceNpc.statusGenerating': 'Генерируем реплики...',
  'hudChrome.voiceNpc.statusReady': 'Ваш голосовой NPC готов!',
  'hudChrome.voiceNpc.statusFailed': 'Что-то пошло не так: {error}',
  'hudChrome.voiceNpc.statusPollFailed': 'Не удалось проверить статус. Откройте эту панель заново.',
};
