...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberfall_edge.name': 'Клинок Углепада',
  'entities.items.crown_of_the_thornpeak_scourge.name': 'Корона Бича Терновой Вершины',
  'entities.items.thunzharrs_stormheart.name': 'Грозовое сердце Тунзарра',
  'entities.items.sealed_vault_signet_crypt.name': 'Запечатанная печатка Полой крипты',
  'entities.items.sealed_vault_signet_bastion.name': 'Запечатанная печатка Затонувшего бастиона',
  'entities.items.sealed_vault_signet_temple.name': 'Запечатанная печатка Утонувшего храма',
  'entities.items.sealed_vault_signet_sanctum.name':
    'Запечатанная печатка Святилища могильного червя',
