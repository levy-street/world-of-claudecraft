...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.governance.disabled': 'Голосование по управлению сейчас недоступно.',
  'apiError.governance.forbidden': 'У вас нет прав на создание предложения.',
  'apiError.governance.not_found': 'Это предложение не найдено.',
  'apiError.governance.invalid_input': 'Проверьте поля предложения и повторите попытку.',
  'apiError.governance.wallet_not_linked': 'Привяжите кошелёк, прежде чем голосовать.',
  'apiError.governance.wallet_mismatch': 'Этот кошелёк не привязан к вашей учётной записи.',
  'apiError.governance.window_closed': 'Голосование по этому предложению закрыто.',
  ...
  'hudChrome.governance.title': 'Управление',
  'hudChrome.governance.close': 'Закрыть управление',
  'hudChrome.governance.subtitle': 'Консультативное голосование держателей $WOC',
  'hudChrome.governance.loading': 'Загрузка предложений…',
  'hudChrome.governance.error': 'Не удалось загрузить предложения.',
  'hudChrome.governance.empty': 'Предложений пока нет.',
  'hudChrome.governance.refresh': 'Обновить',
  'hudChrome.governance.open': 'Открыто',
  'hudChrome.governance.closed': 'Закрыто',
  'hudChrome.governance.closesAt': 'Закрывается {date}',
  'hudChrome.governance.closedAt': 'Закрыто {date}',
  'hudChrome.governance.quorum': 'Кворум: {current} из {needed} $WOC',
  'hudChrome.governance.quorumReached': 'Кворум достигнут',
  'hudChrome.governance.category.content': 'Контент',
  'hudChrome.governance.category.cosmetic': 'Косметика',
  'hudChrome.governance.category.treasury': 'Казна',
  'hudChrome.governance.tally.for': 'За',
  'hudChrome.governance.tally.against': 'Против',
  'hudChrome.governance.tally.abstain': 'Воздержался',
  'hudChrome.governance.tally.voters': 'Голосовавших: {count}',
  'hudChrome.governance.vote.for': 'Голосовать за',
  'hudChrome.governance.vote.against': 'Голосовать против',
  'hudChrome.governance.vote.abstain': 'Воздержаться',
  'hudChrome.governance.vote.needWallet': 'Привяжите кошелёк, чтобы голосовать.',
  'hudChrome.governance.vote.alreadyVoted': 'Вы проголосовали: {choice}',
  'hudChrome.governance.vote.signing': 'Подпишите в кошельке…',
  'hudChrome.governance.vote.submitting': 'Отправка голоса…',
  'hudChrome.governance.vote.success': 'Ваш голос записан.',
  'hudChrome.governance.vote.failed': 'Не удалось записать ваш голос.',
