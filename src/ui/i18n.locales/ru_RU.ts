...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.farshore_isle.welcome':
    'Сойди с парома, и колокол Чаячьей Гавани отыщет тебя раньше, чем сам город. Прорыв разверзается без предупреждения, и редут держит свой берег против всего, что через него хлещет. Они уже давно ждут кого-то вроде тебя.',
  ...
  'entities.zones.farshore_isle.pois.5.label': 'Прорыв',
  'entities.zones.farshore_isle.pois.6.label': 'Поля Крушений',
  'entities.zones.eastbrook_vale.pois.11.label': 'Паром Дальнего Берега',
  ...
  'entities.quests.q_fs_bell_at_the_landing.text':
    'Ты приплыл на пароме, {playerName}? Значит, ты первый за неделю, и Смотритель захочет на тебя взглянуть. Чаячья Гавань выше от пристани, за сушильными рамами, за которыми больше никто не смотрит. Скажи Смотрителю Хладоуглю, что переправа ещё ходит и что Там сегодня не бил тройной набат. Пока.',
  'entities.quests.q_fs_bell_at_the_landing.completion':
    'Переправа держится, а у Тама ещё хватает дыхания шутить про тройной набат. Хорошо. Наш остров в осаде, {playerName}, и каждая пара рук, что привозит паром, станет ещё одной парой, через которую прорывам придётся пробиться, прежде чем они доберутся до моих людей. Добро пожаловать в Чаячью Гавань.',
  ...
  'lb.fixture.ferry': 'Паром Дальнего Берега',
  'lb.fixture.tidemill': 'Приливная мельница',
  'lb.fixture.breach': 'Прорыв',
  'lb.speaker.tam': 'Звонарь Там',
  'lb.speaker.coalfast': 'Страж Коулфаст',
  'lb.speaker.ollun': 'Разломовед Оллун',
  'lb.speaker.edda': 'Интендант Эдда',
  'lb.speaker.saul': 'Целитель Саул',
  'lb.q0.scene.harbor': 'Рабочая гавань: сушатся сети, на ящиках со звездным стеклом клейма материковых покупателей.',
  'lb.q0.scene.plinth': 'Над ступенями гавани бронзовый страж смотрит вглубь острова. Самому новому имени на постаменте сто лет: СТРАЖ ХЕЙЛ. Ниже осталось место.',
  ...
  'entities.mobs.lb_actor_coalfast.name': 'Смотритель Хладоуголь',
  'entities.mobs.lb_actor_ollun.name': 'Стражеразлома Оллун',
  'entities.mobs.lb_actor_edda.name': 'Интендант Эдда',
  'entities.mobs.lb_actor_saul.name': 'Врачеватель Саул',
  'entities.mobs.lb_actor_tam.name': 'Звонарь Там',
  'entities.mobs.tidemill_stalker.name': 'Ловчий Приливной Мельницы',
  'entities.npcs.ferryman_ewald.name': 'Паромщик Эвальд',
  ...
  'entities.npcs.sergeant_marsh.greeting':
    'Обучен? Тогда вот как всё будет сегодня ночью. Моя шеренга держит дорогу. Если прорыв выплюнет нечто, с чем нам не совладать, я укажу на тебя. Мельница твоя: ничто не войдёт туда следом за тобой и ничто не пройдёт мимо нас к городу. Ступай.',
  'entities.quests.q_lb_q0_ashore.title': 'На берегу',
  'entities.quests.q_lb_q0_ashore.text':
    'Чаячья Гавань терпит прорывы днём и ночью, но всё ещё держится. Если хочешь встать рядом с её защитниками, начни там, где город истекает кровью: на линии ополчения у Дозорного Луга, к востоку от портовых ступеней и старой статуи.',
  'entities.quests.q_lb_q0_ashore.completion':
    'Тварь на мельнице ты убил в одиночку, и Там не преувеличивал насчёт носилок. Разведчиков у меня не хватает, зато полей в избытке. Сегодня ты удержал землю, которую не обязан был защищать, и в этом вся наша служба. Добро пожаловать в дозор.',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': 'Доложить сержанту Маршу у Дозорного Луга',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': 'Убить порождений разлома',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': 'Уничтожить то, что скрывается в Приливной Мельнице',
  'entities.dungeons.lb_tidemill.name': 'Приливная Мельница',
  'entities.dungeons.lb_tidemill.enterText': 'Дверь мельницы поддаётся. Внутри тьма прислушивается.',
  'entities.dungeons.lb_tidemill.leaveText': 'Ты выходишь из Приливной Мельницы в вечерний воздух.',
  'entities.dungeons.lb_riftline.name': 'Линия прорыва в сумерках',
  'entities.dungeons.lb_riftline.enterText': 'Ворота луга закрываются за патрулём. Эта ночь принадлежит линии обороны.',
  'entities.dungeons.lb_riftline.leaveText': 'Ты оставляешь линию прорыва рассветному дозору.',
  'entities.dungeons.lb_vault.name': 'Затонувший Первый редут',
  'entities.dungeons.lb_vault.enterText': 'Верёвка уходит во тьму. Внизу старый редут лежит там, куда рухнул.',
  'entities.dungeons.lb_vault.leaveText': 'Ты поднимаешься по утёсной верёвке обратно к дневному свету.',
  'entities.dungeons.lb_council.name': 'Совет редута',
  'entities.dungeons.lb_council.enterText': 'В зале совета стоят шесть кресел. Одно пустует.',
  'entities.dungeons.lb_council.leaveText': 'Ты выходишь из редута.',
  'entities.dungeons.lb_landing.name': 'Ночной плацдарм',
  'entities.dungeons.lb_landing.enterText': 'Сигнальные костры догорают вдоль пляжа. Флот ждёт за отмелями.',
  'entities.dungeons.lb_landing.leaveText': 'Ты оставляешь берег плацдарма позади.',
  'entities.dungeons.lb_riftfields.name': 'Подступы к Полям Разломов',
  'entities.dungeons.lb_riftfields.enterText': 'Четыре места оберегов окружают прорыв. Обряд держал его закрытым двенадцать веков.',
  'entities.dungeons.lb_riftfields.leaveText': 'Ты спускаешься обратно с Полей Разломов.',
  'entities.dungeons.lb_breach.name': 'Внутри Прорыва',
  'entities.dungeons.lb_breach.enterText': 'Свет неправильный, а небо ещё хуже. Сердце лежит впереди на открытом месте.',
  'entities.dungeons.lb_breach.leaveText': 'Ты переступаешь порог и возвращаешься в обычный ночной воздух.',
  'entities.dungeons.lb_lastwatch.name': 'Последний дозор',
  'entities.dungeons.lb_lastwatch.enterText': 'Редут чист и пуст. Кто-то должен завершить этот дозор.',
  'entities.dungeons.lb_lastwatch.leaveText': 'Ты закрываешь за собой дверь редута.',
  ...
  'editor.cinematic.title': 'Кинематографическая сцена',
  'editor.cinematic.show': 'Показать панель',
  'editor.cinematic.hide': 'Скрыть панель',
  'editor.cinematic.scene': 'Сцена',
  'editor.cinematic.sceneOption': '{id} ({seconds} с)',
  'editor.cinematic.time': 'Время',
  'editor.cinematic.timeReadout': '{current} / {duration} с',
  'editor.cinematic.play': 'Воспроизвести',
  'editor.cinematic.pause': 'Пауза',
  'editor.cinematic.authoredCamera': 'Постановочная камера',
  'editor.cinematic.fade': 'Затемнение: {percent}%',
  'editor.cinematic.letterboxOn': 'Широкий формат: включен',
  'editor.cinematic.letterboxOff': 'Широкий формат: выключен',
  'editor.cinematic.violations': 'Нарушения',
  'editor.cinematic.noViolations': 'Сейчас нарушений нет',
  'editor.cinematic.violationRow': '{check} | операция {opIndex} | {measured}',
  'editor.cinematic.capture': 'Захватить ключевой кадр',
  'editor.cinematic.copy': 'Копировать блок',
  'editor.cinematic.output': 'Созданный снимок камеры',
  'editor.cinematic.unavailable': 'Загрузка области просмотра 3D',
  'editor.cinematic.seedMismatch': 'Для захвата нужен рабочий ключ мира',
  'editor.cinematic.captureSavedCopied': 'Сохранено и скопировано',
  'editor.cinematic.captureSaved': 'Сохранено, блок готов ниже',
  'editor.cinematic.captureCopyOnly': 'Скопировано, средство записи разработки недоступно',
  'editor.cinematic.captureReady': 'Блок готов ниже',
};
