...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  "abilityUi.cast.rift_arcane_execution": "Разлом Бездны",
  "abilityUi.cast.rift_arcane_strike": "Чародейское уничтожение",
  "abilityUi.cast.rift_brute_execution": "Землетрясение",
  "abilityUi.cast.rift_brute_strike": "Окончательное решение",
  "abilityUi.cast.rift_ember_execution": "Колодец магмы",
  "abilityUi.cast.rift_ember_strike": "Распад ядра",
  "abilityUi.cast.rift_frost_execution": "Ледниковая могила",
  "abilityUi.cast.rift_frost_strike": "Абсолютный ноль",
  "abilityUi.cast.rift_necro_execution": "Могила души",
  "abilityUi.cast.rift_necro_strike": "Смертный приговор",
  "abilityUi.cast.rift_storm_execution": "Громоотвод",
  "abilityUi.cast.rift_storm_strike": "Гнев Призывателя Бури",
  "abilityUi.cast.rift_tide_execution": "Бездонная пасть",
  "abilityUi.cast.rift_tide_strike": "Глубина дробления",
  "abilityUi.cast.rift_venom_execution": "Бассейн яда",
  "abilityUi.cast.rift_venom_strike": "Знак Праматери",
  "hud.core.riftLabel": "{имя} {name}",
  "hud.core.riftLabelRanked": "{имя} ({ранг}) {name} {rank}",
  "fiesta.augment.cardAria": "{имя} ({категория}) – {описание} {name} {category} {description}",
  "hudChrome.continentMap.toZone": "Карта зоны",
  "hudChrome.meters.breakdownRow": "{значение} ({процент}) {value} {percent}",
  "hudChrome.meters.breakdownSummary": "{tab}: {значение} {value}",
  "hudChrome.meters.percent": "{значение}% {value}",
  "hudChrome.meters.petAbility": "{питомец}: {способность} {pet} {ability}",
  "hudChrome.mountRace.go": "ВПЕРЕД!",
  "hudChrome.mountRace.timeLeft": "{секунды} с {seconds}",
};
