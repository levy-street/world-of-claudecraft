...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mobileHudEditor.launcher': 'Настройте мобильный макет',
  'hudChrome.mobileHudEditor.title': 'Редактор мобильного макета',
  'hudChrome.mobileHudEditor.dialogLabel': 'Настройте мобильные элементы управления',
  'hudChrome.mobileHudEditor.dragHandleLabel': 'Переместить панель редактора',
  'hudChrome.mobileHudEditor.dragHandleHint':
    'Перетаскивайте панель или используйте клавиши со стрелками; Home возвращает её в центр.',
  'hudChrome.mobileHudEditor.locked': 'Заблокировано',
  'hudChrome.mobileHudEditor.unlocked': 'Разблокировано',
  'hudChrome.mobileHudEditor.lock': 'Расположение блокировки',
  'hudChrome.mobileHudEditor.unlock': 'Разблокировать макет',
  'hudChrome.mobileHudEditor.sceneLabel': 'Предварительный просмотр сцены',
  'hudChrome.mobileHudEditor.contextLabel': 'Состояние предварительного просмотра',
  'hudChrome.mobileHudEditor.profileLabel': 'Профиль устройства',
  'hudChrome.mobileHudEditor.profilePhone': 'Телефон',
  'hudChrome.mobileHudEditor.profileTablet': 'Планшет',
  'hudChrome.mobileHudEditor.save': 'Сохранить',
  'hudChrome.mobileHudEditor.cancel': 'Отмена',
  'hudChrome.mobileHudEditor.showFailingLayout': 'Показать неудачный макет',
  'hudChrome.mobileHudEditor.previousFailure': 'Предыдущая неудача',
  'hudChrome.mobileHudEditor.nextFailure': 'Следующая неудача',
  'hudChrome.mobileHudEditor.runtimeFallback':
    'Макет {profile} не подходит для этой области просмотра. Встроенные настройки по умолчанию активны временно.',
  'hudChrome.mobileHudEditor.storageError':
    'Не удалось сохранить мобильную раскладку. Ваш черновик всё ещё открыт.',
  'hudChrome.mobileHudEditor.invalidSave': 'Исправьте каждую ошибку макета перед сохранением.',
  ...
  'hudChrome.mobileHudEditor.scene.world': 'Мир',
  'hudChrome.mobileHudEditor.scene.arenaStandard': 'Стандарт арены',
  'hudChrome.mobileHudEditor.scene.arenaFiesta': 'Арена Фиеста',
  'hudChrome.mobileHudEditor.scene.arenaYumi': 'Арена Юми',
  'hudChrome.mobileHudEditor.scene.valeCupBriefing': 'Брифинг Кубка Долины',
  'hudChrome.mobileHudEditor.scene.valeCupMatch': 'Матч Кубка Долины',
  'hudChrome.mobileHudEditor.scene.valeCupSpectator': 'Зритель Кубка Долины',
  'hudChrome.mobileHudEditor.scene.delve': 'Вылазки',
  'hudChrome.mobileHudEditor.context.worldBase': 'Мир',
  'hudChrome.mobileHudEditor.context.worldValeCupIndicator': 'Мир с индикатором Кубка Долины',
  'hudChrome.mobileHudEditor.context.arenaStandard': 'Стандарт арены',
  'hudChrome.mobileHudEditor.context.arenaFiestaBase': 'Фиеста-матч',
  'hudChrome.mobileHudEditor.context.arenaFiestaPending': 'Фиеста ожидается',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawn': 'Фиеста возрождается',
  'hudChrome.mobileHudEditor.context.arenaFiestaOffer': 'Предложение по дополнению Fiesta',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawnOffer':
    'Предложение возрождения и улучшения Fiesta',
  'hudChrome.mobileHudEditor.context.arenaYumiBase': 'Юми матч',
  'hudChrome.mobileHudEditor.context.arenaYumiRespawn': 'Юми возрождается',
  'hudChrome.mobileHudEditor.context.arenaYumiReturning': 'Юми возвращается',
  'hudChrome.mobileHudEditor.context.valeCupBriefing': 'Брифинг Кубка Долины',
  'hudChrome.mobileHudEditor.context.valeCupMatch': 'Матч Кубка Долины',
  'hudChrome.mobileHudEditor.context.valeCupMatchCharge': 'Заряженный бросок Кубка Долины',
  'hudChrome.mobileHudEditor.context.valeCupSpectatorBetting': 'Ставки зрителей Кубка Долины',
  'hudChrome.mobileHudEditor.context.instanceDelve': 'Вылазки',
  'hudChrome.mobileHudEditor.surface.actionA1': 'Действие А1',
  'hudChrome.mobileHudEditor.surface.actionA2': 'Действие А2',
  'hudChrome.mobileHudEditor.surface.actionA3': 'Действие А3',
  'hudChrome.mobileHudEditor.surface.actionA4': 'Действие А4',
  'hudChrome.mobileHudEditor.surface.actionA5': 'Действие А5',
  'hudChrome.mobileHudEditor.surface.actionAttack': 'Атака',
  'hudChrome.mobileHudEditor.surface.actionTarget': 'Цель',
  'hudChrome.mobileHudEditor.surface.actionJumpUse': 'Прыжок или действие',
  'hudChrome.mobileHudEditor.surface.actionPage': 'Переключение страниц действий',
  'hudChrome.mobileHudEditor.surface.controlMovement': 'Движение',
  'hudChrome.mobileHudEditor.surface.controlView': 'Обзор',
  'hudChrome.mobileHudEditor.surface.utilityConsumables': 'Расходники',
  'hudChrome.mobileHudEditor.surface.petCommands': 'Команды питомца',
  'hudChrome.mobileHudEditor.surface.party': 'Группа',
  'hudChrome.mobileHudEditor.surface.menuTop': 'Верхнее меню',
  'hudChrome.mobileHudEditor.surface.minimapCluster': 'Миникарта',
  'hudChrome.mobileHudEditor.surface.frameTarget': 'Рамка цели',
  'hudChrome.mobileHudEditor.surface.framePlayer': 'Рамка игрока',
  'hudChrome.mobileHudEditor.surface.playerBuffs': 'Баффы игрока',
  'hudChrome.mobileHudEditor.surface.playerDebuffs': 'Дебаффы игрока',
  'hudChrome.mobileHudEditor.surface.statusArenaGeneric': 'Статус арены',
  'hudChrome.mobileHudEditor.surface.statusFiestaScore': 'Фиеста счет',
  'hudChrome.mobileHudEditor.surface.statusFiestaPending': 'Статус ожидания Fiesta',
  'hudChrome.mobileHudEditor.surface.protectedFiestaRespawn': 'Подсказка о возрождении Фиесты',
  'hudChrome.mobileHudEditor.surface.protectedFiestaOffer': 'Предложение по дополнению Fiesta',
  'hudChrome.mobileHudEditor.surface.statusYumi': 'Статус Юми',
  'hudChrome.mobileHudEditor.surface.protectedYumiRespawn': 'Подсказка о возрождении Юми',
  'hudChrome.mobileHudEditor.surface.statusValeCupIndicator': 'Индикатор Кубка Долины',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBriefing': 'Брифинг Кубка Долины',
  'hudChrome.mobileHudEditor.surface.statusValeCupMatch': 'Статус матча Кубка Долины',
  'hudChrome.mobileHudEditor.surface.statusValeCupCharge': 'Заряд броска Кубка Долины',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBetting': 'Панель ставок Кубка Долины',
  'hudChrome.mobileHudEditor.surface.trackerDelve': 'Трекер вылазок',
  'hudChrome.mobileHudEditor.surface.protectedCenterMessage': 'Центральное сообщение',
  'hudChrome.mobileHudEditor.control.nudgeUp': 'Вверх',
  'hudChrome.mobileHudEditor.control.nudgeDown': 'Двигаться вниз',
  'hudChrome.mobileHudEditor.control.nudgeLeft': 'Двигаться влево',
  'hudChrome.mobileHudEditor.control.nudgeRight': 'Двигайтесь вправо',
  'hudChrome.mobileHudEditor.control.decreaseScale': 'Уменьшить размер',
  'hudChrome.mobileHudEditor.control.increaseScale': 'Увеличить размер',
  'hudChrome.mobileHudEditor.control.orientation': 'Ориентация',
  'hudChrome.mobileHudEditor.control.horizontal': 'Горизонтальный',
  'hudChrome.mobileHudEditor.control.vertical': 'Вертикальный',
  'hudChrome.mobileHudEditor.control.order': 'Порядок',
  'hudChrome.mobileHudEditor.control.normalOrder': 'Обычный порядок',
  'hudChrome.mobileHudEditor.control.reverseOrder': 'Обратный порядок',
  'hudChrome.mobileHudEditor.control.openingDirection': 'Направление открытия',
  'hudChrome.mobileHudEditor.control.openLeft': 'Открыть слева',
  'hudChrome.mobileHudEditor.control.openRight': 'Открыть вправо',
  'hudChrome.mobileHudEditor.control.openUp': 'Открывать вверх',
  'hudChrome.mobileHudEditor.control.openDown': 'Открывать вниз',
  'hudChrome.mobileHudEditor.control.resetSelected': 'Сбросить выбранное',
  'hudChrome.mobileHudEditor.control.resetAll': 'Сбросить все',
  'hudChrome.mobileHudEditor.status.noSelection':
    'Выберите элемент управления, чтобы редактировать его.',
  'hudChrome.mobileHudEditor.status.selected': 'Выбрано: {surface}',
  'hudChrome.mobileHudEditor.status.scale': 'Размер: {scale}',
  'hudChrome.mobileHudEditor.status.valid': 'Макет готов к сохранению.',
  'hudChrome.mobileHudEditor.status.invalid': 'В макете есть ошибки блокировки: {count}.',
  'hudChrome.mobileHudEditor.status.failurePosition': 'Сбой {index} из {count}',
  'hudChrome.mobileHudEditor.failure.invalidPlacement': '{surface} имеет недопустимое размещение.',
  'hudChrome.mobileHudEditor.failure.unsupportedCapability':
    '{surface} использует неподдерживаемый вариант макета.',
  'hudChrome.mobileHudEditor.failure.scaleOutOfRange':
    'Размер {surface} находится за пределами допустимого диапазона.',
  'hudChrome.mobileHudEditor.failure.targetTooSmall':
    '{surface} слишком мал для безопасного использования.',
  'hudChrome.mobileHudEditor.failure.outOfBounds':
    '{surface} находится за пределами безопасной зоны.',
  'hudChrome.mobileHudEditor.failure.overlap': '{surface} перекрывается {other}.',
  'hudChrome.mobileHudEditor.failure.viewIntrusion': '{surface} перекрывает область просмотра.',
  'hudChrome.mobileHudEditor.failure.protectedOverlap': '{surface} перекрывает {other}.',
  'hudChrome.mobileHudEditor.discard.title': 'Отменить изменения макета?',
  'hudChrome.mobileHudEditor.discard.body':
    'Несохраненные изменения мобильного макета будут потеряны.',
  'hudChrome.mobileHudEditor.discard.confirm': 'Отменить изменения',
  'hudChrome.mobileHudEditor.discard.continueEditing': 'Продолжить редактирование',
