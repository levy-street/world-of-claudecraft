...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'yumi.log.teamBlue': 'Вы в синей команде!',
  'yumi.log.teamRed': 'Вы в красной команде!',
  'yumi.log.powerupGrabbed': '{player} подобрал усиление {name}!',
  'yumi.hud.powerupIn': 'Усиление через {s}с',
  'yumi.hud.powerupReady': 'Усиление готово!',
  'yumi.banner.powerupSpawn': 'Появилось таинственное усиление!',
  'yumi.powerup.invuln.name': 'Неуязвимость',
  'yumi.powerup.stealth.name': 'Маскировка',
  'yumi.powerup.endless_mana.name': 'Бесконечная мана',
  'yumi.powerup.berserk.name': 'Берсерк',
  'yumi.grab.channeling': 'Подбор… {s}с',
  'yumi.grab.aria': 'Подбор таинственного усиления',
  'hudChrome.arena.windowTitle': 'Поля сражений',
  'hudChrome.arena.arenaIntro':
    'Рейтинговый колизей: сражайтесь один на один или командой, побеждайте, поднимайтесь в таблице и растите рейтинг.',
  'hudChrome.arena.yumiHeading': 'Защита Юми',
  'hudChrome.arena.yumiIntro':
    'Командный режим в лабиринте, вне колизея. Без рейтинга: играйте ради славы, а не очков.',
  'hudChrome.arena.desc1v1': 'Один на один. Чистое мастерство, без напарников.',
  'hudChrome.arena.desc2v2':
    'Двое на двое. Приведите напарника или встаньте в очередь в одиночку и получите пару.',
  'hudChrome.arena.descFiesta': 'Шумная свалка два на два с усилениями и бонусами.',
  'hudChrome.arena.descYumi3': 'Трое на трое. Защищайте свою кошку Юми и охотьтесь на кошку врага.',
  'hudChrome.arena.descYumi5':
    'Пятеро на пятеро в большем лабиринте, и у вашей кошки гораздо больше здоровья.',
  'hudChrome.arena.yumiRules':
    'Каждая команда охраняет пассивную кошку Юми и охотится на кошку врага. Обе кошки раз в минуту переносятся в новые углы лабиринта. Павший боец возвращается через пятнадцать секунд. На полу появляются таинственные усиления: удерживайте «Взаимодействие», чтобы подобрать. Побеждает команда, первой уничтожившая кошку врага; на десятой минуте внезапная смерть разрешает ничью.',
  'hudChrome.arena.queueCount': '{n} в очереди',
