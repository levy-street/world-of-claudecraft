...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'races.sectionTitle': 'Фракция и раса',
  'races.factionKael': 'Империя Каэль',
  'races.factionVeth': 'Конфедерация Вет',
  'races.factionOssara': 'Владения Оссары',
  'races.human': 'Человек',
  'races.dwarf': 'Дворф',
  'races.gnome': 'Гном',
  'races.elf_exile': 'Изгнанный эльф',
  'races.elf': 'Эльф',
  'races.dark_fae': 'Тёмная фея',
  'races.frost_kin': 'Морозный род',
  'races.shadow_walker': 'Тенеход',
  'races.desert_clan': 'Клан пустыни',
  'races.sand_mage': 'Песчаный маг',
  'races.nomad': 'Кочевник',
  'races.stone_warden': 'Каменный страж',
  'races.humanAria': 'Раса: Человек',
  'races.dwarfAria': 'Раса: Дворф',
  'races.gnomeAria': 'Раса: Гном',
  'races.elf_exileAria': 'Раса: Изгнанный эльф',
  'races.elfAria': 'Раса: Эльф',
  'races.dark_faeAria': 'Раса: Тёмная фея',
  'races.frost_kinAria': 'Раса: Морозный род',
  'races.shadow_walkerAria': 'Раса: Тенеход',
  'races.desert_clanAria': 'Раса: Клан пустыни',
  'races.sand_mageAria': 'Раса: Песчаный маг',
  'races.nomadAria': 'Раса: Кочевник',
  'races.stone_wardenAria': 'Раса: Каменный страж',
  'races.raceLabel': 'Раса',
  'races.racialLabel': 'Расовая особенность',
  'races.levelRaceClass': '{level}-й уровень, {race} {className}',
  'races.racialName_human': 'Обет Высадки',
  'races.racialDesc_human': 'Отдых накапливает опыт на 25% быстрее.',
  'races.racialName_dwarf': 'Каменная кровь',
  'races.racialDesc_dwarf': 'Броня увеличена на 5%.',
  'races.racialName_gnome': 'Шестеренная смекалка',
  'races.racialDesc_gnome': 'Интеллект увеличен на 5%.',
  'races.racialName_elf_exile': 'Дисциплина изгнанника',
  'races.racialDesc_elf_exile': 'Сбой чтения заклинаний снижен на 20%.',
  'races.racialName_elf': 'Сумеречная грация',
  'races.racialDesc_elf': 'Шанс уклонения увеличен на 1%.',
  'races.racialName_dark_fae': 'Хитрость фей',
  'races.racialDesc_dark_fae': 'Шанс критического удара увеличен на 1%.',
  'races.racialName_frost_kin': 'Зимняя шкура',
  'races.racialDesc_frost_kin': 'Выносливость увеличена на 3%.',
  'races.racialName_shadow_walker': 'Бесшумный клинок',
  'races.racialDesc_shadow_walker': 'Ловкость увеличена на 3%.',
  'races.racialName_desert_clan': 'Закаленный солнцем',
  'races.racialDesc_desert_clan': 'Максимальный запас здоровья увеличен на 3%.',
  'races.racialName_sand_mage': 'Стеклянный резонанс',
  'races.racialDesc_sand_mage': 'Сила заклинаний увеличена на 5%.',
  'races.racialName_nomad': 'Бесконечный переход',
  'races.racialDesc_nomad': 'Дух увеличен на 5%.',
  'races.racialName_stone_warden': 'Мощь каменоломни',
  'races.racialDesc_stone_warden': 'Сила увеличена на 3%.',
  // Valdris continent (v0.19): item names
  'entities.items.dune_prowler_pelt.name': 'Шкура рыскателя дюн',
  'entities.items.glasswind_stinger.name': 'Жало стеклянного ветра',
  'entities.items.stolen_relic.name': 'Украденная реликвия',
  'entities.items.nameless_burial_shroud.name': 'Безымянный погребальный саван',
  'entities.items.storm_glass_core.name': 'Ядро грозового стекла',
  'entities.items.verdict_seal.name': 'Печать вердикта',
  'entities.items.glasswind_husk.name': 'Панцирь стеклянного ветра',
  'entities.items.mirage_stalker_eye.name': 'Глаз миражного ловчего',
  'entities.items.dig_manifest.name': 'Раскопочная опись',
  'entities.items.tomb_censer.name': 'Гробничная кадильница',
  'entities.items.sentence_tablet.name': 'Скрижаль приговора',
  'entities.items.duststorm_heart.name': 'Сердце пыльной бури',
  'entities.items.ravager_hide.name': 'Шкура разорителя',
  'entities.items.aqueduct_bronze.name': 'Бронзовая скоба акведука',
  'entities.items.judge_regalia.name': 'Регалии Первого суда',
  'entities.items.sunbleached_fang.name': 'Выбеленный солнцем клык',
  'entities.items.cracked_scarab_shell.name': 'Треснувший панцирь скарабея',
  'entities.items.emberjaw_pelt.name': 'Шкура матриарха Углепастых',
  'entities.items.karns_funeral_mask.name': 'Погребальная маска Карна',
  'entities.items.qesh_flatbread.name': 'Кешская лепешка',
  'entities.items.oasis_waterskin.name': 'Бурдюк из оазиса',
  'entities.items.spiced_scarab_skewer.name': 'Пряный шашлык из скарабея',
  'entities.items.duneweave_robe.name': 'Одеяние дюнного плетения',
  'entities.items.caravan_guard_hauberk.name': 'Кольчуга караванного стража',
  'entities.items.prowlerhide_vest.name': 'Жилет из шкуры рыскателя',
  'entities.items.sandwalker_treads.name': 'Ступни песчаного странника',
  'entities.items.dunewatch_legguards.name': 'Поножи дюнного дозора',
  'entities.items.qesh_khopesh.name': 'Кешский хопеш',
  'entities.items.judgestaff_of_ossara.name': 'Посох судьи Оссары',
  'entities.items.glasswind_talon.name': 'Коготь стеклянного ветра',
  'entities.items.emberjaw_prowlgrips.name': 'Охотничьи хваты Углепастой',
  'entities.items.unburied_gravewraps.name': 'Могильные обмотки Непогребенного',
  'entities.items.sandmaw_scale_cuirass.name': 'Чешуйчатая кираса Песчаной Пасти',
  'entities.items.tyrantfang_edge.name': 'Клинок Клык Тирана',
  'entities.items.palewidow_silk.name': 'Шелк бледной вдовы',
  'entities.items.waterlogged_ledger.name': 'Промокшая учетная книга',
  'entities.items.guildless_sigil.name': 'Знак безгильдейных',
  'entities.items.silent_court_seal.name': 'Печать Безмолвного суда',
  'entities.items.duskmane_pelt_strip.name': 'Полоска шкуры сумеречногривого',
  'entities.items.palewidow_venom_sac.name': 'Ядовитая железа бледной вдовы',
  'entities.items.quay_manifest.name': 'Промокшая опись причала',
  'entities.items.wisplight_essence.name': 'Эссенция блуждающего огонька',
  'entities.items.drowned_toll_coin.name': 'Утопленная дорожная монета',
  'entities.items.cutthroat_contract.name': 'Контракт головореза',
  'entities.items.court_ledger_page.name': 'Страница судовой книги',
  'entities.items.frostpine_war_totem.name': 'Военный тотем Морозной Сосны',
  'entities.items.rimeclaw_pelt.name': 'Шкура инеекогтя',
  'entities.items.duskmane_tuft.name': 'Клок сумеречной гривы',
  'entities.items.guttering_wisp_mote.name': 'Пылинка гаснущего огонька',
  'entities.items.frostpine_charm.name': 'Оберег Морозной Сосны',
  'entities.items.palefang_pelt.name': 'Шкура Бледноклыка Безмолвного',
  'entities.items.grelnoks_frozen_idol.name': 'Замерзший идол Грелнока',
  'entities.items.nighthollow_black_bread.name': 'Черный хлеб Ночной Лощины',
  'entities.items.pinefrost_tea.name': 'Чай сосновой изморози',
  'entities.items.smoked_blackmere_eel.name': 'Копченый угорь Черного озера',
  'entities.items.wispweave_robe.name': 'Одеяние огоньковых нитей',
  'entities.items.quayguard_hauberk.name': 'Кольчуга причального стража',
  'entities.items.duskstalker_vest.name': 'Жилет сумеречного ловчего',
  'entities.items.nightpath_treads.name': 'Ступни ночной тропы',
  'entities.items.blackriver_legguards.name': 'Поножи Черной реки',
  'entities.items.terracewatch_leggings.name': 'Штаны террасного дозора',
  'entities.items.quays_cutlass.name': 'Причальный тесак',
  'entities.items.wispcaller_staff.name': 'Посох зовущего огоньки',
  'entities.items.whispersteel_stiletto.name': 'Стилет шепчущей стали',
  'entities.items.palefang_grips.name': 'Хваты Бледноклыка',
  'entities.items.hoarbound_bindings.name': 'Путы Скованного инеем',
  'entities.items.forsworn_lamellar.name': 'Ламеллярная кираса Клятвопреступника',
  'entities.items.forsworn_edge.name': 'Клинок Клятвопреступника',
  'entities.items.stolen_tithe_ledger.name': 'Украденная десятинная книга',
  'entities.items.granite_core_shard.name': 'Осколок гранитного ядра',
  'entities.items.legion_deserter_insignia.name': 'Знак легионного дезертира',
  'entities.items.chewed_tithe_scrip.name': 'Изжеванная десятинная расписка',
  'entities.items.candle_tax_tally.name': 'Бирка свечного налога',
  'entities.items.assay_office_seal.name': 'Печать пробирной палаты',
  'entities.items.legion_pay_manifest.name': 'Платежная ведомость легиона',
  'entities.items.prime_wolf_pelt.name': 'Отборная волчья шкура',
  'entities.items.wendigo_gallstone.name': 'Желчный камень вендиго',
  'entities.items.icehowler_ruff.name': 'Загривок ледяного ревуна',
  'entities.items.legion_quarrel_bundle.name': 'Связка легионных болтов',
  'entities.items.clipped_imperial_coin.name': 'Обрезанная имперская монета',
  'entities.items.rimewoven_hide.name': 'Инеетканая шкура',
  'entities.items.sellsword_pig_iron.name': 'Наемничий чугун',
  'entities.items.lean_wolf_haunch.name': 'Постный волчий окорок',
  'entities.items.pilfered_ration_pack.name': 'Стянутый паек',
  'entities.items.sellsword_requisition_chit.name': 'Реквизиционная расписка наемника',
  'entities.items.frostbrush_wolf_fang.name': 'Волчий клык Морозной Чащи',
  'entities.items.bent_legion_buckle.name': 'Погнутая легионная пряжка',
  'entities.items.ogre_knuckle_dice.name': 'Кости из огрских костяшек',
  'entities.items.hoarfang_pelt.name': 'Шкура вожака Инееклыков',
  'entities.items.kazriks_brass_whistle.name': 'Латунный свисток Казрика',
  'entities.items.kaelspire_barley_loaf.name': 'Ячменный каравай Шпиля Каэля',
  'entities.items.silverbrook_spring_water.name': 'Родниковая вода Серебряного ручья',
  'entities.items.imperial_field_ration.name': 'Имперский полевой паек',
  'entities.items.imperial_clerks_robe.name': 'Одеяние имперского писаря',
  'entities.items.kael_infantry_hauberk.name': 'Кольчуга каэльской пехоты',
  'entities.items.wolfsward_hunting_jerkin.name': 'Охотничья куртка Волчьей Стражи',
  'entities.items.tithe_road_marchboots.name': 'Походные сапоги Десятинного тракта',
  'entities.items.imperial_marcher_legguards.name': 'Поножи имперского маршевика',
  'entities.items.kael_arming_sword.name': 'Каэльский боевой меч',
  'entities.items.frosthelm_warstaff.name': 'Боевой посох Морозного Шлема',
  'entities.items.wolfsward_skinner.name': 'Свежеватель Волчьей Стражи',
  'entities.items.prefects_sealed_mantle.name': 'Запечатанная мантия префекта',
  'entities.items.huntmasters_winter_hood.name': 'Зимний капюшон ловчего мастера',
  'entities.items.hoarfang_clawgrips.name': 'Когтистые хваты Инееклыка',
  'entities.items.overseers_candlewraps.name': 'Свечные обмотки надзирателя',
  'entities.items.oathbreakers_battleplate.name': 'Боевой доспех Клятволома',
  'entities.items.oathbreakers_greatblade.name': 'Великий клинок Клятволома',
  'entities.items.grey_shale_chip.name': 'Осколок серого сланца',
  'entities.items.smuggled_trinket.name': 'Контрабандная безделушка',
  'entities.items.barbed_thorn_husk.name': 'Шипастая колючая скорлупа',
  'entities.items.thornfen_tusk.name': 'Бивень тролля Терновой Топи',
  'entities.items.torn_caravan_banner.name': 'Разорванное караванное знамя',
  'entities.items.ironpass_rubble_core.name': 'Ядро обломков Железного перевала',
  'entities.items.wyvern_tail_barb.name': 'Шип виверньего хвоста',
  'entities.items.reagent_gland.name': 'Разбухшая от реагентов железа',
  'entities.items.fogged_lantern_glass.name': 'Запотевшее фонарное стекло',
  'entities.items.river_worn_idol.name': 'Обточенный рекой идол',
  'entities.items.gull_picked_bone.name': 'Обклеванная чайками кость',
  'entities.items.underway_hardtack.name': 'Сухарь Подземного пути',
  'entities.items.smugglers_black_brew.name': 'Черное варево контрабандиста',
  'entities.items.thornberry_loaf.name': 'Каравай терновых ягод',
  'entities.items.palisade_pine_tea.name': 'Сосновый чай Частокола',
  'entities.items.tollhouse_stew.name': 'Похлебка Дорожной заставы',
  'entities.items.ironpass_mulled_cider.name': 'Пряный сидр Железного перевала',
  'entities.items.lanternfen_eel_skewer.name': 'Шашлык из угря Фонарной топи',
  'entities.items.fogberry_tonic.name': 'Тоник из туманных ягод',
  'entities.items.bridgewatch_rations.name': 'Пайки Мостового дозора',
  'entities.items.nameless_river_water.name': 'Вода безымянной реки',
  'entities.items.smuggler_kings_softsteps.name': 'Мягкоступы Короля контрабандистов',
  'entities.items.briarfather_bark_mitts.name': 'Коряные рукавицы Тернового Отца',
  'entities.items.skarns_war_harness.name': 'Боевая упряжь Скарна',
  'entities.items.colossus_mireheart_girdle.name': 'Пояс Сердце Трясины',
  'entities.items.bridgekeepers_tollstaff.name': 'Дорожный посох Хранителя моста',
  'entities.items.melted_ration_tin.name': 'Оплавленная жестянка пайка',
  'entities.items.ashcaked_fang.name': 'Пеплом покрытый клык',
  'entities.items.ember_glass_shard.name': 'Осколок уголькового стекла',
  'entities.items.saltglass_shard.name': 'Осколок соляного стекла',
  'entities.items.salt_crusted_chitin.name': 'Соленый хитин',
  'entities.items.bleached_bone_charm.name': 'Оберег из выбеленной кости',
  'entities.items.tarnished_prewar_coin.name': 'Потускневшая довоенная монета',
  'entities.items.sewer_silk_wad.name': 'Моток канализационного шелка',
  'entities.items.gutter_hound_pelt.name': 'Шкура сточного пса',
  'entities.items.cracked_salamander_scale.name': 'Треснувшая чешуя саламандры',
  'entities.items.cooled_magma_bead.name': 'Бусина остывшей магмы',
  'entities.items.slag_nugget.name': 'Шлаковый самородок',
  'entities.items.rusted_deserter_badge.name': 'Ржавый знак дезертира',
  'entities.items.redspire_rock_shard.name': 'Осколок скалы Красного Шпиля',
  'entities.items.spire_stalker_claw.name': 'Коготь шпилевого ловчего',
  'entities.items.cinderrest_ashcake.name': 'Зольный пирог Угольного Привала',
  'entities.items.boiled_cistern_water.name': 'Кипяченая вода из цистерны',
  'entities.items.brinehollow_salt_jerky.name': 'Соленая вяленина Соленой Лощины',
  'entities.items.desalted_waterskin.name': 'Бурдюк опресненной воды',
  'entities.items.gutter_stew.name': 'Сточная похлебка Рынка изгнанников',
  'entities.items.black_market_tea.name': 'Чай с черного рынка',
  'entities.items.forgefall_hardtack.name': 'Сухарь Павшей Кузни',
  'entities.items.coalfire_stout.name': 'Углеогненный стаут',
  'entities.items.waymeet_marching_bread.name': 'Походный хлеб Последней Стоянки',
  'entities.items.bitterroot_brew.name': 'Варево из горького корня',
  'entities.items.revenant_cinderguard.name': 'Пеплостраж восставшего',
  'entities.items.marrowhide_leggings.name': 'Штаны из мозговой шкуры',
  'entities.items.scavenger_kings_shiv.name': 'Заточка Короля мусорщиков',
  'entities.items.forgewyrm_scale_helm.name': 'Чешуйчатый шлем кузнечного змея',
  'entities.items.mantle_of_the_last_muster.name': 'Мантия Последнего Сбора',
  'entities.items.scorched_banner_scrap.name': 'Обгоревший лоскут знамени',
  'entities.items.melted_signet_ring.name': 'Оплавленный перстень',
  'entities.items.cracked_horror_horn.name': 'Треснувший рог ужаса',
  'entities.items.bastion_hardtack.name': 'Бастионный сухарь',
  'entities.items.trucewater_flask.name': 'Фляга перемирной воды',
  'entities.items.ashguard_robe.name': 'Пеплостражное одеяние',
  'entities.items.breachwalker_jerkin.name': 'Куртка ходока Бреши',
  'entities.items.bastion_plated_hauberk.name': 'Бастионная усиленная кольчуга',
  'entities.items.bastion_arming_sword.name': 'Бастионный боевой меч',
  'entities.items.mercenary_greatblade.name': 'Наемничий великий клинок',
  'entities.items.tithe_collectors_grasps.name': 'Хваты сборщика десятины',
  'entities.items.craterheart_mantle.name': 'Мантия Сердце Кратера',
  'entities.items.butchers_chainguard.name': 'Цепной доспех Мясника',
  ...
  'hudChrome.envoys.title': 'Зал Посланников',
  'hudChrome.envoys.prompt': 'Выберите фракцию и народ, с которым встанете плечом к плечу.',
  'hudChrome.envoys.permanent':
    'Эта клятва навсегда. Фракция определяет ваш дом, союзников и врагов в вечной войне.',
  'hudChrome.envoys.confirm': 'Принести клятву',
  'hudChrome.envoys.travelTitle': 'Переправа',
  'hudChrome.envoys.travelBody': 'Отправиться сейчас? Переход мгновенный.',
  'hudChrome.envoys.travelGo': 'В путь',
  'hudChrome.envoys.travelStay': 'Остаться',
  'hudChrome.defense.start': 'Держать строй! Защитники готовятся к натиску.',
  'hudChrome.defense.wave': 'Волна {wave} из {total} отбита!',
  ...
  'entities.items.conjured_water4.name': 'Наколдованная кристальная вода',
  'entities.items.conjured_water5.name': 'Наколдованная ледниковая вода',
  'entities.items.conjured_water6.name': 'Наколдованная горная вода',
  ...
  'entities.items.forged_levy_papers.name': 'Поддельные призывные бумаги',
  'entities.items.amnesty_petition.name': 'Незарегистрированное прошение об амнистии',
  'entities.items.fort_pattern_kettle.name': 'Котелок фортового образца',
  'entities.items.garnished_pay_pouch.name': 'Арестованный кошель с жалованьем',
  'entities.items.fault_line_core.name': 'Ядро разлома',
  'entities.items.unstamped_duel_permit.name': 'Незаверенное дуэльное разрешение',
  'entities.items.rimeclaw_tallow.name': 'Жир инеекогтя',
  'entities.items.rimeclaw_marrowbone.name': 'Мозговая кость инеекогтя',
  'entities.items.oathguard_plate_scrap.name': 'Обломок лат Стража Клятвы',
  'entities.items.ninth_muster_roll.name': 'Спасённый список призыва',
  'entities.items.icehowler_haunch.name': 'Окорок ледового ревуна',
  'entities.items.rimebound_core_ice.name': 'Скованный инеем сердцевинный лёд',
  'entities.items.glacial_quench_ice.name': 'Лёд ледниковой закалки',
  'entities.items.maren_calling_card.name': 'Визитная карточка дома Марен',
  'entities.items.maldreks_route_ledger.name': 'Путевая книга Малдрека',
  'entities.items.grulks_iron_strongbox.name': 'Железный сейф Грулка',
  'entities.items.maren_duelling_mantle.name': 'Дуэльная мантия Марен',
  'entities.items.final_notice_wraps.name': 'Обмотки последнего предупреждения',
  'entities.items.pay_wardens_shoulderguards.name': 'Наплечники смотрителя жалованья',
  'entities.items.rimeshaft_foremans_cap.name': 'Картуз десятника Раймшахты',
  'entities.items.quarter_close_vestments.name': 'Облачение квартального закрытия',
  'entities.items.assessors_lead_greaves.name': 'Свинцовые поножи оценщика',
  'entities.items.purse_wardens_coinbelt.name': 'Монетный пояс смотрителя кошелей',
  'entities.items.mothwing_dust.name': 'Пыльца мотыльковых крыльев',
  'entities.items.silt_eel.name': 'Илистый угорь',
  'entities.items.barge_chit.name': 'Размокший баржевый жетон',
  'entities.items.ferry_lantern_mote.name': 'Искра паромного фонаря',
  'entities.items.smugglers_tally_knot.name': 'Счётный узел контрабандиста',
  'entities.items.forged_weir_pass.name': 'Поддельный пропуск через запруду',
  'entities.items.sunken_ration_tin.name': 'Затонувшая банка пайка',
  'entities.items.hollow_toll_scrip.name': 'Пустой дорожный вексель',
  'entities.items.rimeclaw_haunch.name': 'Окорок инеекогтя',
  'entities.items.rimebound_fetish.name': 'Скованный инеем фетиш',
  'entities.items.frostpine_tallow.name': 'Жир морозной сосны',
  'entities.items.forsworn_oath_knife.name': 'Клятвенный нож Отрёкшихся',
  'entities.items.shadowbound_cipher.name': 'Тенескованный шифр',
  'entities.items.vessiks_little_book.name': 'Книжица Вессика',
  'entities.items.weirwatch_wraps.name': 'Обмотки стражи запруды',
  'entities.items.lodgewalk_boots.name': 'Сапоги Приюта',
  'entities.items.unbroken_wardstone.name': 'Целый охранный камень',
  'entities.items.vault_ward_core.name': 'Охранное ядро хранилища',
  'entities.items.temple_offering_bowl.name': 'Храмовая чаша подношений',
  'entities.items.graven_name_stone.name': 'Камень с высеченными именами',
  'entities.items.stalker_haunch.name': 'Окорок ловчего',
  'entities.items.heretic_creed_page.name': 'Обгоревшая страница символа веры',
  'entities.items.heretic_brand_iron.name': 'Клеймо еретика',
  'entities.items.heretic_writ.name': 'Еретический указ',
  'entities.items.first_court_sigil.name': 'Печать Первого Суда',
  'entities.items.duneglass_heart.name': 'Сердце дюнного стекла',
  'entities.items.unshattered_fulgurite.name': 'Нерасколотый фульгурит',
  'entities.items.flameseer_ash_creed.name': 'Скрижаль Пепельного Символа',
  'entities.items.flameseer_ember_phial.name': 'Склянка углей',
  'entities.items.dawnward_censer.name': 'Кадило Рассветной Стражи',
  'entities.items.stolen_water_cask.name': 'Запечатанная бочка воды',
  'entities.items.duskwater_oathmark.name': 'Клятвенный знак Сумеречных Вод',
  'entities.items.caravan_toll_tally.name': 'Запечатанная пошлинная бирка',
  'entities.items.tyrant_spoor.name': 'Слепок следа Тирана',
  'entities.items.oxbone_toll.name': 'Пошлинная бирка из бычьей кости',
  'entities.items.cartographers_map.name': 'Карта Первого Картографа',
  'entities.items.templestone_shard.name': 'Осколок храмового камня',
  'entities.items.fulgurite_splinter.name': 'Щепка фульгурита',
  'entities.items.charred_censer_chain.name': 'Обугленная цепь кадила',
  'entities.items.wardens_stone_heart.name': 'Каменное сердце Ашкерата',
  'entities.items.first_meridian_compass.name': 'Компас Первого Меридиана',
  'entities.items.seatstone_flatbread.name': 'Лепёшка Престола',
  'entities.items.seatwell_waterskin.name': 'Бурдюк престольного колодца',
  'entities.items.lastwater_jerky.name': 'Вяленое мясо Последней Воды',
  'entities.items.lastwater_skin.name': 'Бурдюк Последней Воды',
  'entities.items.vaultkeepers_handwraps.name': 'Наручи хранителя подвалов',
  'entities.items.sahrs_penitent_leggings.name': 'Покаянные поножи Сахра',
  'entities.items.wardens_granite_edge.name': 'Гранитная кромка Стража',
  'entities.items.staff_of_the_sunken_court.name': 'Посох Затонувшего Суда',
  'entities.items.duneglass_shiv.name': 'Заточка из дюнного стекла',
  'entities.items.lastwater_roadmail.name': 'Дорожная кольчуга Последней Воды',
  'entities.items.duskwatch_robe.name': 'Одеяние Сумеречного Дозора',
  'entities.items.raiders_dust_jerkin.name': 'Пропылённая куртка налётчика',
  'entities.items.ashkerat_greaves.name': 'Поножи Ашкерата',
  'entities.items.cartographers_windwraps.name': 'Ветровые обмотки Картографа',
  'entities.items.unlit_silk_gland.name': 'Беспросветная шёлковая железа',
  'entities.items.veskals_fang.name': 'Клык Вескала',
  'entities.items.broodmother_carapace_guard.name': 'Панцирный нагрудник Матери выводка',
  'entities.items.condensed_mist_heart.name': 'Сгущённое сердце тумана',
  'entities.items.mistfathers_knot.name': 'Узел Отца Туманов',
  'entities.items.fogwalker_treads.name': 'Поступь туманохода',
