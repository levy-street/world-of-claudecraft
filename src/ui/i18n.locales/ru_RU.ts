...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'landing.heroEyebrow': 'МИР УЖЕ ЖИВЕТ',
  'landing.heroHeading':
    'Живая классическая MMO, где игроки и герои под управлением ИИ встречают один и тот же мир.',
  'landing.heroBody':
    'Играйте бесплатно в браузере, создайте героя одного из девяти классов или обучайте агента в настоящей игре.',
  'landing.heroStatus': 'Мир в сети',
  'landing.heroPlayers': 'зарегистрированных искателей приключений',
  'landing.communityLinks': 'Ссылки сообщества',
  'landing.followSocials': 'Следите за нами',
  'landing.socialDiscord': 'Сообщество в Discord',
  'landing.socialTwitch': 'Трансляции на Twitch',
  'landing.socialInstagram': 'Мы в Instagram',
  'landing.socialReddit': 'Сообщество на Reddit',
  'landing.browserCta': 'Играть в браузере',
  'landing.playNowBody': 'Играйте сразу в браузере. Ничего скачивать не нужно.',
  'landing.playWayBody': 'Выберите удобную платформу и присоединяйтесь к приключению.',
  'landing.syncProgress': 'Синхронизация прогресса на всех платформах',
  'landing.explore': 'Исследовать мир',
  'landing.platformsEyebrow': 'ОТПРАВЛЯЙТЕСЬ В ПУТЬ ГДЕ УГОДНО',
  'landing.appStoreAria': 'Скачать World of ClaudeCraft в App Store',
  'landing.googlePlayAria': 'Скачать World of ClaudeCraft в Google Play',
  'landing.steamAria': 'World of ClaudeCraft в Steam, скоро',
  'landing.comingSoon': 'Скоро',
  'landing.introEyebrow': 'ОДИН МИР. ОДНИ ПРАВИЛА.',
  'landing.introHeading': 'Каждый искатель приключений играет в настоящую игру.',
  'landing.introBody':
    'Браузерная MMO, онлайн-мир под управлением сервера и обучение ИИ работают в одной детерминированной симуляции. Игроки и агенты проходят одинаковые бои, задания, подземелья и сталкиваются с одинаковыми последствиями.',
  'landing.statClasses': '9 игровых классов',
  'landing.statModes': 'Онлайн и офлайн миры',
  'landing.statBroadcast': 'ИИ-трансляция 24/7',
  'landing.statSource': 'Открытый исходный код',
  'landing.worldEyebrow': 'ПУТЕШЕСТВИЕ ПО CLAUDEMOON',
  'landing.worldHeading': 'Мир долгих дорог и опасных ночей.',
  'landing.worldBody':
    'Начните у костров Eastbrook Vale, спуститесь в проклятые склепы и поднимитесь сквозь бури Thornpeak. Каждая дорога ведет глубже в мир, который не прекращает жить.',
  'landing.eastbrookTitle': 'Долина Истбрук',
  'landing.eastbrookBody': 'Общий рубеж первых заданий, бродячих врагов и неожиданных союзников.',
  'landing.eastbrookAlt': 'Отряд искателей приключений идёт по долгой дороге из долины Истбрук к высотам Торнпик',
  'landing.hollowTitle': 'Hollow Crypt',
  'landing.hollowBody':
    'Групповые бои под холодным светом синих факелов, где неспокойные мертвецы собираются в орды.',
  'landing.hollowAlt': 'Группа сражается с врагами в Hollow Crypt',
  'landing.thornpeakTitle': 'Высоты Торнпик',
  'landing.thornpeakBody': 'Над облаками ждут снег, древние руины и угрозы финальных испытаний.',
  'landing.thornpeakAlt': 'Снег падает над Thornpeak Heights',
  'landing.classesEyebrow': 'ВЫБЕРИТЕ СВОЮ ЛЕГЕНДУ',
  'landing.classesHeading': 'Девять призваний. Бесчисленные способы сражаться.',
  'landing.classesBody':
    'Стойте в стене щитов, повелевайте огнем и льдом, крадитесь в тенях или спасайте свою группу. Создайте героя, освойте специализацию и продолжите эту историю в общем мире.',
  'landing.streamEyebrow': 'В ЭФИРЕ 24/7',
  'landing.streamNetwork': 'СЕТЬ ТРАНСЛЯЦИЙ WOC',
  'landing.streamFeed': 'YUUMIII // ПРЯМОЙ ЭФИР',
  'landing.streamMonogram': 'Y',
  'landing.streamHeading': 'Yuumiii никогда не выходит из игры.',
  'landing.streamBody':
    'Постоянная ИИ-стримерша World of ClaudeCraft играет в прямом эфире 24 часа в сутки.',
  'landing.streamWatch': 'Смотреть на Twitch',
  'landing.streamLoading': 'Открываем портал наблюдения...',
  'landing.streamReady':
    'Портал наблюдения готов. Нажмите воспроизведение, чтобы смотреть Yuumiii.',
  'landing.streamOnline': 'Yuumiii сейчас в прямом эфире.',
  'landing.streamOffline':
    'Портал наблюдения переподключается. Откройте канал Twitch, чтобы продолжить просмотр.',
  'landing.streamCompact': 'Откройте канал Twitch, чтобы смотреть Yuumiii на этом экране.',
  'landing.streamUnavailable':
    'Портал наблюдения недоступен. Откройте канал Twitch, чтобы продолжить просмотр.',
  'landing.openEyebrow': 'ОТКРЫТЫЙ МИР. ОТКРЫТЫЙ КОД.',
  'landing.openHeading': 'Сделайте форк мира. Обучите искателя приключений.',
  'landing.openBody':
    'Изучайте исходный код, запустите собственный мир или подключите совместимого с Gymnasium агента к той же детерминированной игре, куда каждый день входят игроки.',
  'landing.supportEyebrow': 'ПОМОГИТЕ МИРУ ЖИТЬ',
  'landing.supportHeading': 'Создавайте, играйте и поддержите следующую главу.',
  'landing.supportBody':
    'World of ClaudeCraft развивается открыто. Присоединяйтесь к сообществу, следите за живым миром или поддержите дальнейшую разработку.',
  'landing.xCta': 'Подписаться в X',
  'landing.patchNotesLabel': 'Примечания к обновлению',
  'landing.patchNotesTitle': 'Примечания к обновлению',
  'landing.patchNotesDesc': 'Ознакомьтесь с последними изменениями игрового процесса, исправлениями и подробностями выпуска.',
  'landing.patchNotesLoading': 'Загрузка последних примечаний к обновлению…',
  'landing.patchNotesError': 'Не удалось загрузить примечания к обновлению. Повторите попытку позже.',
  'landing.patchNotesEmpty': 'Примечаний к обновлению пока нет. Загляните позже.',
  'landing.patchNotesPrerelease': 'Предварительная версия',
  'landing.patchNotesViewOnGithub': 'Посмотреть выпуск на GitHub',
  'landing.newsEyebrow': 'НОВОСТИ ИЗ МИРА',
  'landing.newsTitle': 'Новости Claudemoon',
  'landing.newsBody': 'Следите за новостями World of ClaudeCraft и читайте истории о том, как создаётся этот мир.',
  'landing.newsXTitle': 'Последнее в X',
  'landing.newsXIntro': 'Официальные публикации @WoClaudecraft',
  'landing.newsXPrivacy': 'При загрузке этой ленты устанавливается соединение с X, и X может получить сведения о вашем посещении.',
  'landing.newsXLoad': 'Загрузить ленту X',
  'landing.newsXRetry': 'Повторить',
  'landing.newsXHide': 'Скрыть ленту X',
  'landing.newsXOpen': 'Открыть @WoClaudecraft в X',
  'landing.newsXNewTab': 'Откроется в новой вкладке',
  'landing.newsXLoading': 'Открываем ленту X…',
  'landing.newsXUnavailable': 'Не удалось загрузить ленту X. Все публикации можно посмотреть непосредственно в X.',
  'landing.newsXIframeTitle': 'Последние публикации @WoClaudecraft в X',
  'landing.newsBlogEyebrow': 'ХРОНИКИ CLAUDEMOON',
  'landing.newsBlogTitle': 'Последние истории',
  'landing.newsBlogEmptyTitle': 'Первая история уже пишется',
  'landing.newsBlogEmptyBody': 'Новости и истории о создании мира скоро появятся здесь.',
  'landing.newsXOpenAria': 'Открыть @WoClaudecraft в X в новой вкладке',
  'landing.newsXLoaded': 'Лента X загружена.',
  'landing.newsXHidden': 'Лента X скрыта. Профиль по-прежнему можно открыть непосредственно в X.',
  'landing.twitchCategoryCta': 'Смотреть трансляции World of ClaudeCraft',
  'landing.finalEyebrow': 'ВАША ИСТОРИЯ НАЧИНАЕТСЯ У ВРАТ',
  'landing.finalHeading': 'Выберите свой путь в Claudemoon.',
  'landing.finalBody':
    'Играйте в браузере прямо сейчас, продолжайте на мобильном устройстве или ждите выхода в Steam.',
  ...
  'stats.accountsCreated': 'Всего игроков',
  ...
  'mode.onlineDesc': 'Играйте на действующем сервере. Ваши персонажи сохраняются онлайн.',
  'mode.onlineAria': 'Играть по сети: вход в постоянный общий игровой мир',
  'mode.offlineTitle': 'Играть вне сети',
  'mode.offlineDesc': 'Играйте в локальном автономном мире в браузере. Прогресс не сохраняется.',
  ...
  'mode.serverAria': 'Выберите режим сервера: Сервер в сети или Сервер не в сети',
  'mode.serverLabel': 'Выберите свой мир',
  'mode.serverOffline': 'Сервер не в сети',
  'mode.serverOfflineSub': 'Локальный автономный мир',
  'mode.serverOnline': 'Сервер в сети',
  ...
  'landing.streamWatchSub': 'Присоединяйтесь к эфиру Yuumiii',
  'landing.streamExplore': 'Исследовать мир',
  'landing.streamExploreSub': 'Откройте Клодмун',
  'landing.streamHeroSubtitle': 'Ваш постоянный ИИ-стример играет в мире круглые сутки.',
  'landing.streamMeet': 'Знакомьтесь с проводником',
  'landing.streamHostTitle': 'Постоянный ИИ-стример',
  'landing.streamHostBody':
    'Исследуйте каждый уголок World of ClaudeCraft вместе с Yuumiii днём и ночью.',
  'landing.streamPortraitAlt': 'Yuumiii, постоянный ИИ-стример World of ClaudeCraft',
  'landing.streamAlwaysTitle': 'Эфир 24/7',
  'landing.streamAlwaysBody': 'Всегда в сети. Всегда в приключении.',
  'landing.streamAiTitle': 'ИИ-стример',
  'landing.streamAiBody': 'Живые реакции и бесконечное веселье на базе ИИ.',
  'landing.streamCommunityTitle': 'Сообщество',
