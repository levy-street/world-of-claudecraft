...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  "hud.mounts.noWallet": "Держите не менее {amount} $WOC — 0.1% от запаса — на привязанном кошельке, чтобы получить своего первого дорожного скакуна.",
  ...
  "hud.mounts.mintHint": "Отчеканьте торговую грамоту на этого скакуна — продайте ее за золото, чтобы не-держатель смог его заслужить.",
  ...
  "hud.wager.inviteGold": "{name} открывает Гонку на ставку — поставьте {money} для участия. Принять?",
  "hud.wager.inviteCharter": "{name} открывает Гонку на ставку — поставьте {money} + Грамоту на скакуна. Принять?",
  ...
  "entities.npcs.skytrial_master.greeting": "Небо — это дорога, по которой решаются идти немногие, {className}. Заслужи ее, и она понесет тебя.",
  "entities.quests.q_skyward_first_flight.title": "Первый полет",
  "entities.quests.q_skyward_first_flight.text": "Ты неплохо держишься в крылатом седле на земле, {playerName} — теперь подними его ввысь. Пройди Небесное испытание Долины: восемь колец в одном замкнутом круге. Пока не гонись за временем. Просто держись в воздухе и нанижи каждое кольцо.",
  "entities.quests.q_skyward_first_flight.completion": "Ты не упал. Это больше, чем удается многим с первого круга. Небо помнит тех, кто возвращается.",
  ...
  "entities.quests.q_skyward_time_trial.text": "Теперь сделай это с умыслом. Пройди Небесное испытание Долины снова, {playerName}, но успей до того, как иссякнет песок. Чистая линия сквозь каждое кольцо, ни глотка лишнего воздуха. Точность, а не паника.",
  "entities.quests.q_skyward_time_trial.completion": "Чистая линия, от кольца к кольцу. Ты больше не едешь верхом на небе — ты летишь по нему.",
  "entities.quests.q_skyward_time_trial.objectives.0.label": "Небесное испытание Долины пройдено в норму времени",
  "entities.quests.q_skyward_ascendant.title": "Восходящий",
  "entities.quests.q_skyward_ascendant.text": "Остается одно испытание, {playerName}: Долинный круг. Три круга по длинному кольцу, пройденные в норму времени — никакой удачи, только мастерство. Овладей им, и открытое небо станет твоим, от края до края.",
  "entities.quests.q_skyward_ascendant.completion": "Вознесшийся и несломленный. Теперь небо твое, {playerName}. Прими эту грамоту — воздушного скакуна, заслуженного, а не купленного, чтобы он нес тебя всюду, куда задумаешь.",
