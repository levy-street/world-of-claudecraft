...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.itemSets.crownforged.bonus4':
    'Критические удары оружием с вероятностью 50% окружают вас «Костной защитой», поглощающей 150 ед. урона в течение 10 сек.',
  ...
  'entities.itemSets.nighttalon.bonus4':
    'Критические удары оружием с вероятностью 35% даруют «Оскал»: следующая атака наносит критический удар.',
