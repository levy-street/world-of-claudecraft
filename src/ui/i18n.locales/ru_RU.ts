...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.merch.unavailable':
    'Магазин мерча сейчас недоступен. Ваши заказы и платежи не затронуты; загляните позже.',
  'hudChrome.merch.disclosure':
    'Мерч производится и отправляется нашим печатным партнёром под заказ. Claudium, потраченный на мерч, не возвращается в виде Claudium; платежи картой и через Solana подчиняются политике возвратов в Условиях обслуживания.',
  ...
  'hudChrome.merch.totalNote':
    'Доставка и налоги добавляются при оформлении; итоговая сумма подтверждается на сервере.',
  ...
  'hudChrome.merch.checkoutPending':
    'Заказ выполняется. Завершите оплату и не закрывайте эту страницу.',
  ...
  'hudChrome.merch.checkoutNotSettled':
    'Транзакция отправлена, но заказ ещё не подтверждён. Проверьте свои заказы чуть позже.',
  'hudChrome.merch.orderPlaced':
    'Заказ {orderId} оформлен. Отслеживайте его в списке заказов ниже.',
  'hudChrome.merch.paymentPending':
    'Заказ {orderId} ожидает оплаты картой. Он появится в ваших заказах после завершения оплаты.',
