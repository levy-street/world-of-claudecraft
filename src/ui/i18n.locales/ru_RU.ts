...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.object.mining_cracked_wall': 'Треснувшая стена',
  'delveUi.object.herbalism_toxic_growth': 'Ядовитая поросль',
  'delveUi.board.companion.roleLabel': 'Роль спутника',
  'delveUi.companionRole.healer': 'Лекарь',
  'delveUi.companionRole.tank': 'Защитник',
  'delveUi.companionRole.damage': 'Урон',
  'delveUi.tracker.companionRole': 'Роль спутника: {role}',
  'delveUi.shortcut.miningReady': 'Горное дело: открыть треснувшую стену',
  'delveUi.shortcut.miningFallback': 'Короткий путь: пробить треснувшую стену',
  'delveUi.shortcut.herbalismReady': 'Травничество: очистить ядовитую поросль',
  'delveUi.shortcut.herbalismFallback': 'Короткий путь: убрать ядовитую поросль',
  ...
  'sim.delve.miningShortcut': 'Горное дело находит слабое место. Треснувшая стена открывается.',
  'sim.delve.miningShortcutFallback':
    'Вы отбиваете куски треснувшей стены. Горное дело открыло бы ее быстрее.',
  'sim.delve.miningShortcutFallbackComplete': 'После упорных ударов треснувшая стена поддается.',
  'sim.delve.herbalismShortcut': 'Травничество быстро иссушает ядовитую поросль.',
  'sim.delve.herbalismShortcutFallback':
    'Вы оттесняете ядовитую поросль. Травничество очистило бы ее быстрее.',
  'sim.delve.herbalismShortcutFallbackComplete':
    'После упорной расчистки ядовитая поросль осыпается.',
