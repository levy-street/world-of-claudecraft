...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'character.respec': 'Сброс талантов',
  'character.respecHint':
    'Сожгите $WOC, чтобы сбросить таланты или открыть дополнительный слот снаряжения.',
  'character.respecPaidButton': 'Сбросить таланты за {amount} $WOC',
  'character.loadoutSlotPaidButton': 'Открыть слот снаряжения за {amount} $WOC',
  'character.respecCancel': 'Отмена',
  'character.respecSuccess': 'Таланты сброшены.',
  'character.loadoutSlotSuccess': 'Слот снаряжения открыт.',
  'errors.api.linkWalletFirst': 'Сначала подключите и привяжите кошелек Solana.',
  'errors.api.nameReserved': 'Это имя зарезервировано.',
  'errors.api.quoteExpired': 'Срок действия платежной котировки истек. Начните заново.',
  'errors.api.paymentUsed': 'Этот платеж уже был использован.',
