...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.leaderboard.commits': 'Коммиты',
  ...
  'hudChrome.devBadge.flavors.tinkerer': 'Ваш первый коммит закрепился в этом мире.',
  'hudChrome.devBadge.flavors.artificer': 'Десять коммитов спустя мир подчиняется вашему коду.',
  'hudChrome.devBadge.flavors.runesmith': 'Пятьдесят коммитов вкованы в работающую игру.',
  'hudChrome.devBadge.flavors.architect': 'Архитектор этого мира: закреплено 150 коммитов.',
  'hudChrome.devBadge.flavors.worldwright': 'Творец миров: 500 коммитов формируют игру.',
  'hudChrome.devBadge.badgeTitle': 'Разработчик: {tier}',
  'hudChrome.devBadge.commitsLanded': 'Закреплено коммитов: {count}',
