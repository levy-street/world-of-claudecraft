...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.secondBar': 'Вторая панель действий',
  'hudChrome.actionBar.barScale': 'Размер панели действий',
  ...
  'hudChrome.actionBar.bindModeHint': 'Нажмите на ячейку, затем нажмите клавишу для назначения. По завершении нажмите «Готово».',
  'hudChrome.actionBar.bindReset': 'Сбросить',
  'hudChrome.actionBar.bindResetConfirmTitle': 'Сбросить клавиши панели действий?',
  'hudChrome.actionBar.bindResetConfirmBody': 'Первая панель вернётся к клавишам по умолчанию, а вторая станет без назначений. Это действие нельзя отменить.',
