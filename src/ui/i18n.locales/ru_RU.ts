...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.source_cave_mantle.name': 'Мантия Источника',
  'entities.items.conflictbreaker_breastplate.name': 'Кираса разрушителя конфликтов',
  'entities.items.cherry_pickers_gauntlets.name': 'Рукавицы выборщика коммитов',
  'entities.items.maintainers_crown.name': 'Корона мейнтейнера',
  'entities.items.commit_blade.name': 'Клинок коммита',
  'entities.items.bug_squasher.name': 'Багодав',
  'entities.items.mech_keyboard.name': 'Нажатие клавиши',
  ...
  'worldContent.sourceCaveWellName': 'Открытый Исток',
  'worldContent.sourceCaveReboot': 'Не нажимайте эту кнопку',
  'worldContent.sourceCaveRebootYell': 'Что вы наделали?!',
  'worldContent.sourceCaveRebootYellWhatsGoingOn': 'Эй, что происходит?',
  'worldContent.sourceCaveRebootYellServerDown': 'Ребята, сервер упал!',
  'worldContent.sourceCaveBanterIssue': 'Пожалуйста, создайте issue.',
  'worldContent.sourceCaveBanterPullRequest': 'Не стесняйтесь создавать pull request.',
  'worldContent.sourceCaveBanterConflicts': 'Ненавижу конфликты...',
  'worldContent.sourceCaveBanterContribute': 'Да, конечно, вы можете внести вклад в этот проект!',
  'worldContent.sourceCaveBanterFocused': 'Извини, я сейчас сосредоточен',
  'worldContent.sourceCaveBanterNextRelease': 'Следующий релиз будет потрясающим!',
  'worldContent.sourceCaveBanterRefresh': 'Хм? Попробуйте обновить страницу',
  ...
  'entities.dungeons.nythraxis_boss_arena.leaveText':
    'Вы возвращаетесь в холодный воздух Терновых высот.',
  'entities.dungeons.source_cave.name': 'Открытый Исток',
  'entities.dungeons.source_cave.enterText': 'Вы входите в Открытый Исток.',
  'entities.dungeons.source_cave.leaveText': 'Вы покидаете Открытый Исток.',
  ...
  'sim.dungeon.levelRequired': 'Чтобы войти в {name}, нужно достичь уровня {level}.',
  'sim.sourceCave.locked': 'Вход в {name} для вас заблокирован.',
  'sim.sourceCave.enter': 'Вы входите в Открытый Исток.',
  ...
  'sim.sourceCave.killProgress': '{name} снова в исходном коде.',
  'sim.sourceCave.bossDefeated': 'У {name} возникло фатальное исключение.',
  'sim.sourceCave.cleared': 'Открытый Исток теперь закрыт. Поздравляем?',
  ...
  'sim.sourceCave.wellBanter2': 'Почему ты так смотришь на мои кирпичи?',
  'sim.sourceCave.wellBanter3': 'Я самый обычный колодец! Смотри, у меня даже есть ведро!',
  'sim.sourceCave.wellBanter4': 'Всё ещё просто колодец. Никакой магии тут нет.',
  'sim.sourceCave.wellBanter5': 'Кто рассказал тебе об истоке? Уж не Клод ли?',
  'sim.sourceCave.wellBanter6': 'О, тебе точно не захочется спускаться туда.',
  'sim.sourceCave.wellBanter7': 'Охрана! Игрок пытается вломиться в исходный код!',
  'sim.sourceCave.wellBanter8': 'Знаешь, там внизу источник конфликтов.',
  'sim.sourceCave.wellBanter9': 'Если я открою, ты наконец оставишь меня в покое?',
  'sim.sourceCave.wellBanter10': 'Ладно, заходи. Только сначала вытри сапоги.',
