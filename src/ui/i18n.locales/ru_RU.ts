...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.character.tabs.equipment': 'Экипировка',
  'hudChrome.character.tabs.overview': 'Обзор',
  'hudChrome.character.balances.claudium': 'Клаудиум',
  'hudChrome.character.bagSocket': 'Слот сумки: {name}',
  'hudChrome.character.sections.attributes': 'Характеристики',
  'hudChrome.character.sections.combat': 'Бой',
  'hudChrome.character.sections.defense': 'Защита',
  'hudChrome.character.spec.choose': 'Выбрать',
  'hudChrome.character.spec.change': 'Изменить',
  'hudChrome.character.bags.openFull': 'Открыть окно сумок',
  'hudChrome.character.bags.container': 'Сумка {n}',
  'hudChrome.character.bags.emptySpaces': 'Пустые ячейки',
  'hudChrome.character.bags.emptySummary': '+{count} пустых',
