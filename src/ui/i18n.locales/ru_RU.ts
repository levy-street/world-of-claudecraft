...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.undermount_wing2.name': 'Подгорье: Отпуск',
  'entities.dungeons.undermount_wing2.enterText': 'Удары молотов гремят в хранилище отпуска.',
  'entities.dungeons.undermount_wing2.leaveText': 'Вы отступаете из звенящих горновых путей.',
  'entities.dungeons.undermount_wing3.name': 'Подгорье: Пробуждение',
  'entities.dungeons.undermount_wing3.enterText': 'Погребенная печь шевелится в глубине.',
  'entities.dungeons.undermount_wing3.leaveText': 'Вы отходите от пробуждающегося жара.',
  ...
  'entities.items.undermount_rune_rubbing.name': 'Копия руны Подгорья',
  ...
  'entities.mobs.wyrmcult_dig_foreman.name': 'Прораб раскопок культа Змея',
  'entities.items.cindertoad_signet.name': 'Печатка угольной жабы',
  'entities.items.coalglow_band.name': 'Кольцо угольного свечения',
  'entities.items.crownforged_warleggings.name': 'Боевые поножи коронной ковки',
  'entities.items.glassblowers_shiv.name': 'Шив стеклодува',
  'entities.items.glasswalker_treads.name': 'Ботинки стеклохода',
  'entities.items.nighttalon_prowlers.name': 'Крадущиеся сапоги Ночного Когтя',
  'entities.items.quenchsilk_cord.name': 'Шнур закалённого шёлка',
  'entities.items.ring_of_the_first_quench.name': 'Кольцо первой закалки',
  'entities.items.saans_stoking_iron.name': 'Кочерга Саана',
  'entities.items.slag_tempered_sabatons.name': 'Сабатоны шлаковой закалки',
  'entities.items.slakeleather_belt.name': 'Пояс из закалённой кожи',
  'entities.items.sluicebearer.name': 'Шлюзоносец',
  'entities.items.soulflame_kilt.name': 'Килт пламени души',
  'entities.items.stokebrand_striders.name': 'Ботинки клейма кочегара',
  'entities.items.stormcallers_legwraps.name': 'Обмотки призывателя бурь',
