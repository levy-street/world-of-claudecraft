...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.invertX': 'Инверсия камеры (X)',
  'hudChrome.controller.invertMoveX': 'Инверсия движения (X)',
  'hudChrome.controller.invertMoveY': 'Инверсия движения (Y)',
  'hudChrome.controller.cameraAutoFollow': 'Автослежение камеры',
