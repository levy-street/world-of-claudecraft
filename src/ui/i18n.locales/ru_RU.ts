...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.mounts.title': 'Скакуны',
  'hud.mounts.subtitle': 'Дорожные скакуны $WOC',
  'hud.mounts.close': 'Закрыть скакунов',
  'hud.mounts.summon': 'Призвать',
  'hud.mounts.dismount': 'Спешиться',
  'hud.mounts.summoning': 'Призыв {name}…',
  'hud.mounts.riding': 'В седле',
  'hud.mounts.flies': 'Летает',
  'hud.mounts.locked': 'Заблокировано',
  'hud.mounts.speed': '+{percent}% к скорости',
  'hud.mounts.unlockAt': 'Открывается при {amount} $WOC',
  'hud.mounts.supplyShare': '{percent} от запаса',
  'hud.mounts.qualifyHeader': 'Вам доступно {count} из {total} дорожных скакунов.',
  'hud.mounts.holdingHint': 'На руках {amount} $WOC.',
  'hud.mounts.noWallet':
    'Держите не менее {amount} $WOC — 0.1% от запаса — на привязанном кошельке, чтобы получить своего первого дорожного скакуна.',
  'hud.mounts.cantInCombat': 'Нельзя оседлать скакуна в бою.',
  'hud.mounts.cantSwimming': 'Нельзя оседлать скакуна вплавь.',
  'hud.mounts.cantDead': 'Нельзя оседлать скакуна, будучи мертвым.',
  'hud.mounts.notEligible': 'Ваших запасов $WOC пока не хватает на этого скакуна.',
  'hud.mounts.summonedBanner': 'Вы призываете {name}.',
  'hud.mounts.summonAria': 'Призвать {name}',
  'hud.mounts.dismountAria': 'Спешиться с {name}',
  'hud.mounts.lockedAria': '{name} — заблокировано; открывается при {amount} $WOC',
  'hud.mounts.activeAria': '{name} — сейчас активен',
  'hud.mounts.owned': 'В собственности',
  'hud.mounts.mint': 'Отчеканить грамоту',
  'hud.mounts.mintHint':
    'Отчеканьте торговую грамоту на этого скакуна — продайте ее за золото, чтобы не-держатель смог его заслужить.',
  'hud.mounts.mintAria': 'Отчеканить торговую грамоту на {name}',
  'hud.mounts.mintedBanner': 'Вы чеканите грамоту на {name}.',
  'hud.mounts.earnedBanner': 'Вы заслужили {name} — теперь он ваш навсегда.',
  'hud.mounts.alreadyOwnErr': 'Этот скакун уже у вас есть.',
  'hud.mounts.charterVoidErr': 'Эта грамота недействительна.',
  'hud.mounts.noCharterErr': 'На этого скакуна нельзя отчеканить грамоту.',
  'hud.mounts.holdingsShortErr': 'Ваших запасов не хватает на этого скакуна.',
  'hud.course.skytrials': 'Небесные испытания',
  'hud.course.skytrialsHint': 'Пролетите трассу с кольцами на время на крылатом скакуне.',
  'hud.course.needFlyer': 'Призовите крылатого скакуна, чтобы пройти Небесные испытания.',
  'hud.course.laps': '{count} кругов',
  'hud.course.starting': 'Пролетите сквозь первое кольцо, чтобы запустить часы',
  'hud.course.finish': 'Финиш!',
  'hud.course.failed': 'Заезд окончен — вы покинули скакуна',
  'hud.course.aborted': 'Заезд брошен',
  'hud.course.newBest': 'Новый рекорд!',
  'hud.course.board': 'Таблица',
  'hud.course.boardTitle': '{name} — лучшие времена',
  'hud.course.noTimes': 'Времен пока нет — станьте первым.',
  'hud.course.loadingBoard': 'Загрузка…',
  'hud.course.racePartyHint': 'Гонка с вашей группой — побеждает первый, кто пройдет кольца.',
  'hud.course.getReady': 'Приготовьтесь',
  'hud.course.racing': 'Гонка идет',
  'hud.wager.start': 'Гонка на ставку',
  'hud.wager.title': 'Гонка на ставку',
  'hud.wager.inviteGold':
    '{name} открывает Гонку на ставку — поставьте {money} для участия. Принять?',
  'hud.wager.inviteCharter':
    '{name} открывает Гонку на ставку — поставьте {money} + Грамоту на скакуна. Принять?',
  'hud.wager.accept': 'Принять ставку',
  'hud.wager.potCharter': 'Банк {money} + {count}× Грамота',
  'hud.wager.racers': 'Гонщики ({count})',
  'hud.wager.launch': 'Запустить гонку',
  'hud.wager.cancel': 'Отмена',
  'hud.wager.leave': 'Покинуть',
  'hud.wager.waiting': 'Ожидание соперника, готового принять ставку…',
  'hud.wager.won': 'Вы выигрываете ставку — {money}!',
  'hud.wager.wonCharter': 'Вы выигрываете ставку — {money} + {count}× Грамота!',
  'hud.wager.lost': 'Вы проиграли ставку.',
  'hud.wager.refunded': 'Ставка отменена — ваш взнос возвращен.',
  'hud.wager.antePrompt': 'Сколько золота поставить на эту гонку? (в меди)',
  'hud.wager.open': 'Открыть ставку',
  'hud.wager.stakeCharter': 'Также поставить Грамоту на скакуна (достается победителю)',
  'hud.wager.errCourse': 'На эту трассу нельзя сделать ставку.',
  'hud.wager.errFlyer': 'Чтобы делать ставку, нужно быть на крылатом скакуне.',
  'hud.wager.errBusy': 'Вы уже участвуете в ставке.',
  'hud.wager.errAnte': 'Назначьте ставку не менее 1 меди.',
  'hud.wager.errStake': 'Это нельзя поставить на кон.',
  'hud.wager.errAfford': 'Вам не покрыть эту ставку.',
  'hud.wager.errExpired': 'Срок этого предложения ставки истек.',
  'hud.wager.errGone': 'Эта ставка больше не открыта.',
  'hud.wager.errHost': 'Запустить ставку может только устроитель.',
  'entities.items.charter_ashmane.name': 'Грамота: Пепельногривый Скакун',
  'entities.items.charter_emberhoof.name': 'Грамота: Угольнокопытный Боевой Конь',
  'entities.items.charter_bronzeflank.name': 'Грамота: Бронзобокий Дестриэ',
  'entities.items.charter_silvermane.name': 'Грамота: Среброгривый Жеребец',
  'entities.items.charter_stormhoof.name': 'Грамота: Грозокопытный Боевой Конь',
  'entities.items.charter_goldcrest.name': 'Грамота: Златохохлый Небоход',
  'entities.items.charter_verdant.name': 'Грамота: Зеленый Дикокрыл',
  'entities.items.charter_voidstrider.name': 'Грамота: Пустокрылый Странник',
  'entities.items.charter_celestial.name': 'Грамота: Небесный Серафим',
  'entities.items.charter_worldbearer.name': 'Грамота: Рух Мироносца',
  'entities.npcs.skytrial_master.name': 'Небоводец Вэйл',
  'entities.npcs.skytrial_master.title': 'Хранитель Небесных испытаний',
  'entities.npcs.skytrial_master.greeting':
    'Небо — это дорога, по которой решаются идти немногие, {className}. Заслужи ее, и она понесет тебя.',
  'entities.quests.q_skyward_first_flight.title': 'Первый полет',
  'entities.quests.q_skyward_first_flight.text':
    'Ты неплохо держишься в крылатом седле на земле, {playerName} — теперь подними его ввысь. Пройди Небесное испытание Долины: восемь колец в одном замкнутом круге. Пока не гонись за временем. Просто держись в воздухе и нанижи каждое кольцо.',
  'entities.quests.q_skyward_first_flight.completion':
    'Ты не упал. Это больше, чем удается многим с первого круга. Небо помнит тех, кто возвращается.',
  'entities.quests.q_skyward_first_flight.objectives.0.label': 'Небесное испытание Долины пройдено',
  'entities.quests.q_skyward_time_trial.title': 'Обогнать часы',
  'entities.quests.q_skyward_time_trial.text':
    'Теперь сделай это с умыслом. Пройди Небесное испытание Долины снова, {playerName}, но успей до того, как иссякнет песок. Чистая линия сквозь каждое кольцо, ни глотка лишнего воздуха. Точность, а не паника.',
  'entities.quests.q_skyward_time_trial.completion':
    'Чистая линия, от кольца к кольцу. Ты больше не едешь верхом на небе — ты летишь по нему.',
  'entities.quests.q_skyward_time_trial.objectives.0.label':
    'Небесное испытание Долины пройдено в норму времени',
  'entities.quests.q_skyward_ascendant.title': 'Восходящий',
  'entities.quests.q_skyward_ascendant.text':
    'Остается одно испытание, {playerName}: Долинный круг. Три круга по длинному кольцу, пройденные в норму времени — никакой удачи, только мастерство. Овладей им, и открытое небо станет твоим, от края до края.',
  'entities.quests.q_skyward_ascendant.completion':
    'Вознесшийся и несломленный. Теперь небо твое, {playerName}. Прими эту грамоту — воздушного скакуна, заслуженного, а не купленного, чтобы он нес тебя всюду, куда задумаешь.',
  'entities.quests.q_skyward_ascendant.objectives.0.label': 'Долинный круг пройден в норму времени',

  // Skytrial course + race HUD short labels (par/lap/ring/time/place/pot).
  'hud.mounts.cardAria': '{name}: {flavor}',
  'hud.course.start': 'Лететь',
  'hud.course.give_up': 'Сдаться',
  'hud.course.par': 'Норма {time}',
  'hud.course.onePass': '1 круг',
  'hud.course.gate': 'Кольцо {n}/{total}',
  'hud.course.lap': 'Круг {n}/{total}',
  'hud.course.time': 'Время',
  'hud.course.beatPar': 'Опережение нормы на {time}',
  'hud.course.offPar': '{time} сверх нормы',
  'hud.course.best': 'Рекорд {time}',
  'hud.course.you': '(вы)',
  'hud.course.race': 'Гонка',
  'hud.course.go': 'СТАРТ!',
  'hud.course.dnf': 'Сход',
  'hud.course.placeOf': '#{place} из {total}',
  'hud.wager.pot': 'Банк {money}',
  ...
  'character.renamePaidButton': 'Заплатить {amount} $WOC и переименовать',
  'character.renamePriceHint': 'Добровольное переименование сжигает {amount} $WOC.',
  'character.renameCancel': 'Отмена',
  'character.mintSolName': 'Получить имя .sol',
  'character.mintSolButton': 'Сжечь {amount} $WOC и создать',
  'character.mintSolHint':
    'Создайте собственное имя ‹имя›.worldofclaudecraft.sol за {amount} $WOC, оно ваше в блокчейне.',
  'woc.linkWalletFirst': 'Подключите и привяжите кошелек Solana, чтобы платить в $WOC.',
  'woc.quoting': 'Подготовка платежа $WOC…',
  'woc.approveBurn': 'Подтвердите сжигание {amount} $WOC в кошельке…',
  'woc.confirming': 'Подтверждение сжигания в блокчейне…',
  'woc.finalizing': 'Ожидание финализации Solana…',
  'woc.confirmFailed': 'Не удалось проверить платеж $WOC.',
  'woc.finalizeTimeout':
    'Время ожидания финализации истекло. Если $WOC уже сожжены, откройте окно снова и повторите: платеж зачтется после финализации.',
  'woc.renameSuccess': 'Переименовано в {name}.',
  'woc.mintSuccess': 'Создано {domain}, теперь оно ваше в блокчейне.',
  'woc.guildRenameSuccess': 'Гильдия переименована в {name}.',
  'woc.reserveSuccess': 'Имя {name} зарезервировано.',
  'walletPanel.title': 'Кошелек',
  'walletPanel.closeAria': 'Закрыть',
  'walletPanel.notConnected': 'Кошелек не подключен',
  'walletPanel.connect': 'Подключить',
  'walletPanel.connectedStatus': 'Подключен {address}',
  'walletPanel.linkedBadge': 'привязан',
  'walletPanel.tabSend': 'Отправить',
  'walletPanel.tabHire': 'Нанять',
  'walletPanel.tabJobs': 'Заказы',
  'walletPanel.sendSection': 'Отправить игроку',
  'walletPanel.currency': 'Валюта',
  'walletPanel.playerName': 'Имя игрока',
  'walletPanel.recipientPlaceholder': 'Кому вы отправляете?',
  'walletPanel.amount': 'Сумма',
  'walletPanel.max': 'Макс',
  'walletPanel.balanceEmpty': 'Баланс: -',
  'walletPanel.balanceLoading': 'Баланс: …',
  'walletPanel.balanceUnavailable': 'Баланс: недоступен',
  'walletPanel.balance': 'Баланс: {amount}',
  'walletPanel.balanceExceeds': 'Баланс: {amount} (превышает баланс)',
  'walletPanel.connectForBalance': 'Подключите кошелек, чтобы увидеть баланс.',
  'walletPanel.sendNote':
    'Отправляется напрямую с кошелька на кошелек в Solana. Некастодиально: игра никогда не хранит ваши средства. Взимается сетевая комиссия.',
  'walletPanel.send': 'Отправить',
  'walletPanel.sending': 'Отправка…',
  'walletPanel.loginToSend': 'Войдите и зайдите в мир, чтобы отправлять игрокам.',
  'walletPanel.lookingUp': 'Поиск игрока…',
  'walletPanel.ownWallet': '(это ваш собственный кошелек)',
  'walletPanel.noVerifiedWallet': 'У игрока с таким именем нет подтвержденного кошелька.',
  'walletPanel.approveTransfer': 'Подтвердите перевод в кошельке…',
  'walletPanel.sent': 'Отправлено {amount} {currency} игроку {name}.',
  'walletPanel.viewTransaction': 'Посмотреть транзакцию',
  'walletPanel.sendFailedWith': 'Ошибка отправки: {message}',
  'walletPanel.sendFailed': 'Не удалось отправить.',
  'walletPanel.hireSection': 'Нанять помощника',
  'walletPanel.hireOffline': 'Зайдите в мир онлайн, чтобы нанять помощника.',
  'walletPanel.helperPlaceholder': 'Кто вам поможет?',
  'walletPanel.rewardCurrency': 'Валюта награды',
  'walletPanel.reward': 'Награда',
  'walletPanel.goalLabel': 'Цель, оплачивается после подтверждения сервером',
  'walletPanel.goalReachLevel': 'Достичь уровня',
  'walletPanel.goalClearDungeon': 'Пройти рейд',
  'walletPanel.goalQuest': 'Задание',
  'walletPanel.goalBodyguard': 'Телохранитель',
  'walletPanel.goalEscort': 'Сопровождение',
  'walletPanel.targetLevel': 'Целевой уровень',
  'walletPanel.targetLevelPlaceholder': 'от 2 до 20',
  'walletPanel.raidDungeon': 'Рейд / подземелье',
  'walletPanel.questOwn': 'Задание (одно из ваших)',
  'walletPanel.noActiveQuests':
    'У вас нет активных заданий, для которых можно нанять помощь. Сначала возьмите задание.',
  'walletPanel.protectMinutes': 'Защищать меня (минут)',
  'walletPanel.minutesPlaceholder': 'напр. 10',
  'walletPanel.escortDestination': 'Пункт назначения',
  'walletPanel.useCurrentSpot': 'Использовать мое текущее место',
  'walletPanel.destinationSet': 'Пункт назначения задан: ({x}, {z})',
  'walletPanel.noDestination': 'Пункт назначения еще не задан.',
  'walletPanel.destinationHint':
    'Пункт назначения ({x}, {z}), отойдите, а затем пусть охранник приведет вас сюда обратно.',
  'walletPanel.hireLogin': 'Зайдите в мир онлайн, чтобы нанять игрока.',
  'walletPanel.escrowNote':
    'Награда блокируется в ончейн-эскроу и автоматически выплачивается помощнику, когда сервер подтверждает цель, или возвращается вам, если цель не достигнута до срока.',
  'walletPanel.post': 'Опубликовать и заблокировать награду',
  'walletPanel.posting': 'Публикация…',
  'walletPanel.setGoalFirst': 'Сначала задайте корректную цель.',
  'walletPanel.preparingEscrow': 'Подготовка эскроу…',
  'walletPanel.approveDeposit': 'Подтвердите депозит награды в кошельке…',
  'walletPanel.lockingReward': 'Блокировка награды в ончейне…',
  'walletPanel.waitingFinalization': 'Ожидание финализации…',
  'walletPanel.confirmTimeout':
    'Время подтверждения депозита истекло. Если награда была заблокирована, она рассчитается после финализации.',
  'walletPanel.jobPosted':
    'Заказ опубликован: {amount} {currency} заблокировано в эскроу для {name}.',
  'walletPanel.postFailed': 'Не удалось опубликовать заказ.',
  'walletPanel.failedWith': 'Ошибка: {message}',
  'walletPanel.jobsSection': 'Ваши заказы',
  'walletPanel.loading': 'Загрузка…',
  'walletPanel.jobsOffline': 'Зайдите в мир онлайн, чтобы управлять заказами.',
  'walletPanel.jobsEmpty':
    'Заказов пока нет. Используйте вкладку «Нанять», чтобы заплатить игроку за помощь.',
  'walletPanel.youHired': 'Вы наняли {name}',
  'walletPanel.hiredYou': '{name} нанял вас',
  'walletPanel.acceptJob': 'Принять заказ',
  'walletPanel.cancelRefund': 'Отменить и вернуть средства',
  'walletPanel.viewPayout': 'Посмотреть выплату',
  'walletPanel.actionFailed': 'Действие не удалось.',
  'walletPanel.status.awaitingDeposit': 'Ожидается ваш депозит',
  'walletPanel.status.offered': 'Предложено вам, примите, чтобы начать',
  'walletPanel.status.open': 'Открыт, ожидается согласие помощника',
  'walletPanel.status.active': 'В процессе',
  'walletPanel.status.completed': 'Завершен, помощнику выплачено',
  'walletPanel.status.expired': 'Истек, средства возвращены',
  'walletPanel.status.failedDied': 'Провален (вы погибли), средства возвращены',
  'walletPanel.status.cancelled': 'Отменен, средства возвращены',
  'walletPanel.status.refunded': 'Средства возвращены',
};
