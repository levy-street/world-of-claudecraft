...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.showAuraSigils': 'Знаки ауры',
  'hudChrome.options.auraSigilOpacity': 'Прозрачность знаков ауры',
  'hudChrome.options.auraSigilScale': 'Размер знаков ауры',
