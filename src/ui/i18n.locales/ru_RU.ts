...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bg.blurb':
    'Две разрушенные крепости смотрят друг на друга через обнесённую стеной лощину под Терновым пиком: Багровые на юге, Лазурные на севере, а между ними старый Двор Руин, который так и не достался никому. Пятеро на пятеро, по одному знамени, и первый, кто пять раз донесёт чужое знамя домой, забирает поле.',
