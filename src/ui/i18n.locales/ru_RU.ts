...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.gatherIntro.farming':
    'Земледелие растит урожай из семян на возделанных грядках и ограничено 100; грядки, семена и инструменты придут с будущим обновлением, поэтому таблицы ниже пока пусты.',
