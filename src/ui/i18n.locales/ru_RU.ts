...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.talentsPage.howBody':
    'Ряды открываются по мере роста уровня, а специализации доступны с 10 уровня. Выберите специализацию ради ключевой способности и мастерства, затем на вкладке вариантов выберите по одному варианту из каждого открытого ряда.',
  'guide.talentsPage.howHeading': 'Как они работают',
  'guide.talentsPage.intro':
    'Таланты позволяют настроить класс под себя. Они необязательны, гибки и легко меняются, поэтому можно экспериментировать без страха.',
  'guide.talentsPage.resetNote':
    'Вне боя можно в любой момент сбросить выбор, так что раннее решение никогда не станет ловушкой. Пробуйте варианты, находите любимые и свободно меняйте мнение.',
  'guide.talentsPage.resetTitle': 'Ничего не навсегда',
  'guide.talentsPage.shareNote':
    'Готовый билд можно скопировать как короткий код и передать другу, который вставит его прямо в свою панель талантов.',
  'guide.talentsPage.specsBody':
    'У каждого класса есть несколько специализаций, каждая со своей ролью и ключевым фокусом. Здесь показана их общая форма. Откройте класс, чтобы увидеть весь набор.',
  'guide.talentsPage.specsHeading': 'Специализации по классам',
  'guide.talentsPage.whatBody':
    'С повышением уровня открываются ряды талантов с небольшим набором вариантов. Каждый выбор дает постоянное улучшение способностей, характеристик или набора приемов и меняет ощущение класса в бою.',
  ...
  'entities.abilities.ice_lance.description':
    'Метает осколок льда, наносящий {damage} урона от магии льда. Наносит тройной урон обездвиженным целям.',
