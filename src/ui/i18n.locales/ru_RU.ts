...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolbeltTitle': 'Пояс с инструментами',
  'hudChrome.bags.toolbeltNone': 'Пояс с инструментами не надет',
  'hudChrome.bags.toolbeltRemoveHint': 'Нажмите, чтобы снять этот пояс',
  'hudChrome.bags.toolbeltFilled': 'Инструментов: {used}/{total}',
  'hudChrome.bags.toolSlotLabel': 'Ячейка для инструмента {slot}',
  'hudChrome.bags.toolSlotEmpty': 'Пусто',
  'hudChrome.bags.toolSlotStowHint': 'Нажмите, чтобы убрать {name}',
  'hudChrome.bags.toolSlotTakeHint': 'Нажмите, чтобы забрать инструмент',
  'hudChrome.bags.toolSlotNoTool': 'У вас нет инструмента, который можно убрать',
  'itemUi.kind.toolbelt': 'Пояс с инструментами',
  'entities.items.basic_toolbelt.name': 'Простой пояс с инструментами',
  'entities.items.reinforced_toolbelt.name': 'Укреплённый пояс с инструментами',
  'entities.items.artisans_toolbelt.name': 'Пояс ремесленника',
  'itemUi.tooltip.toolbeltSlots': 'Вмещает инструментов: {slots}',
