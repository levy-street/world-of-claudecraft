...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.tin_ore.name': 'Оловянная руда',
  'entities.items.iron_ore.name': 'Железная руда',
  'entities.items.copper_bar.name': 'Медный слиток',
  'entities.items.tin_bar.name': 'Оловянный слиток',
  'entities.items.bronze_bar.name': 'Бронзовый слиток',
  'entities.items.bronzeclasp_gauntlets.name': 'Латные рукавицы с бронзовыми застёжками',
  'entities.items.clawspur_dirk.name': 'Кинжал Когтевой шип',
  'entities.items.iron_bar.name': 'Железный слиток',
  'entities.items.thorium_bar.name': 'Ториевый слиток',
  ...
  'entities.items.beast_claw.name': 'Коготь зверя',
  'entities.items.boar_tusk.name': 'Кабаний клык',
