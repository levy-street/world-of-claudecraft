...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.icefall.description':
    'Выпускает в цель все накопленные сосульки. Каждая наносит {damage} ед. урона от магии льда. Если цель заморожена обездвиживанием или оглушением, урон увеличивается в 2,5 раза. Этот фиксированный урон не может быть критическим. (Криомантия)',
