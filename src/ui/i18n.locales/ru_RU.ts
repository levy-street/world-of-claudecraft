...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'marketplace.title': 'Скины от авторов',
  'marketplace.subtitle':
    'Косметика от игроков, оплата в USDC. 70% — автору; 30% выкупает и сжигает $WOC.',
  'marketplace.loading': 'Загрузка скинов…',
  'marketplace.empty': 'Пока нет скинов от авторов в продаже.',
  'marketplace.connectFirst': 'Подключите кошелёк для покупки.',
  'marketplace.purchasing': 'Покупка…',
  'marketplace.owned': 'Куплено — надето',
  'marketplace.failed': 'Покупка не удалась',
  ...
  'marketplace.tabBrowse': 'Обзор',
  'marketplace.tabCreate': 'Создать и продать',
  'marketplace.search': 'Поиск обликов',
  'marketplace.anyClass': 'Любой класс',
  ...
  'marketplace.designIntro':
    'Перекрасьте модель и добавьте узор: у всех она отображается одинаково, файлы загружать не нужно.',
  'marketplace.modeDesign': 'Дизайн',
  'marketplace.modeUpload': 'Загрузка',
  'marketplace.modeLink': 'Свой хостинг',
  'marketplace.uploadIntro':
    'Загрузите собственный PNG-атлас 1024x1024. Мы закрепим его в IPFS и разместим у себя.',
  'marketplace.linkIntro':
    'Укажите ссылку на PNG-атлас на вашем хостинге. Мы проксируем его, и покупатели не увидят ваш URL. Бесплатно.',
  'marketplace.linkUrl': 'URL атласа',
  'marketplace.quotaMeter': 'Занято слотов хостинга: {used}/{quota}',
  'marketplace.trustedBadge': 'Проверенный автор (публикация без ожидания)',
  'marketplace.selfHostedFreeNote':
    'Свой хостинг бесплатен и не ограничен (в пределах лимита лотов).',
  'marketplace.hostingUnavailable': 'Загрузка на наш хостинг временно недоступна.',
  'marketplace.listedReview': 'Отправлено на проверку: лот появится после одобрения оператором.',
  'marketplace.baseColor': 'Основной цвет',
  'marketplace.patternColor': 'Цвет узора',
  'marketplace.accentColor': 'Акцентный цвет',
  'marketplace.pattern': 'Узор',
  'marketplace.finishLabel': 'Отделка',
  'marketplace.densityLabel': 'Плотность',
  'marketplace.finishes.matte': 'Матовая',
  'marketplace.finishes.satin': 'Атласная',
  'marketplace.finishes.metallic': 'Металлик',
  'marketplace.densities.low': 'Редкий',
  'marketplace.densities.medium': 'Обычный',
  'marketplace.densities.high': 'Плотный',
  'marketplace.glowColor': 'Цвет свечения',
  'marketplace.noGlow': 'Без свечения',
  'marketplace.randomize': 'Случайно',
  'marketplace.namePlaceholder': 'например, Изумрудная драконья чешуя',
  'marketplace.descLabel': 'Описание',
  'marketplace.descPlaceholder': 'Короткое описание, которое увидят покупатели',
  'marketplace.priceLabel': 'Цена (USDC)',
  'marketplace.preview': 'Предпросмотр',
  'marketplace.list': 'Выставить на продажу',
  'marketplace.listing': 'Выставляем…',
  'marketplace.listed': 'Лот выставлен и уже в продаже. Наденьте облик из своей коллекции.',
  'marketplace.listFailed': 'Не удалось выставить лот',
  'marketplace.listConnectFirst': 'Подключите кошелек, чтобы выставить лот (вы получаете 70%).',
  'marketplace.payoutHint': 'Вы получаете 70% • 30% идет на выкуп и сжигание $WOC',
  'marketplace.patterns.solid': 'Однотонный',
  'marketplace.patterns.scales': 'Чешуя',
  'marketplace.patterns.stripes': 'Полосы',
  'marketplace.patterns.diamond': 'Ромбы',
  'marketplace.patterns.spots': 'Пятна',
  'marketplace.patterns.runes': 'Руны',
  'entities.npcs.skin_artisan.name': 'Пип, мастер обликов',
  'entities.npcs.skin_artisan.title': 'Витрина авторских обликов',
  'entities.npcs.skin_artisan.greeting':
    'Хотите сменить образ, {className}? Посмотрите косметические облики от игроков или создайте и продайте собственный. Оплата в USDC; часть выручки идет на выкуп и сжигание $WOC.',
  'hudChrome.nftSkins.intro': 'Докажите владение PFP NFT, чтобы носить его: трейты формируют облик персонажа, а само изображение становится портретом. Скин остается вашим, пока вы держите NFT.',
  'hudChrome.nftSkins.connectEthereum': 'Подключить кошелек Ethereum',
  'hudChrome.nftSkins.connectSolana': 'Подключить кошелек Solana',
  'hudChrome.nftSkins.ethereumLinked': 'Кошелек Ethereum: {address}',
  'hudChrome.nftSkins.solanaLinked': 'Кошелек Solana: {address}',
  'hudChrome.nftSkins.notLinked': 'не привязан',
  'hudChrome.nftSkins.collectionsTitle': 'Поддерживаемые коллекции',
  'hudChrome.nftSkins.noCollections': 'Коллекций пока нет. Загляните позже.',
  'hudChrome.nftSkins.tokenIdPlaceholder': 'ID токена',
  'hudChrome.nftSkins.mintPlaceholder': 'Адрес минта',
  'hudChrome.nftSkins.claim': 'Получить',
  'hudChrome.nftSkins.claiming': 'Получение...',
  'hudChrome.nftSkins.claimed': 'Получено и надето. Скин всегда доступен в браузере скинов.',
  'hudChrome.nftSkins.needWallet': 'Сначала привяжите соответствующий кошелек.',
  'hudChrome.nftSkins.close': 'Закрыть',
  'hudChrome.nftSkins.errorNotOwner': 'Этот кошелек не владеет данным токеном.',
  'hudChrome.nftSkins.errorUnverified': 'Сейчас не удалось проверить владение. Повторите попытку позже.',
  'hudChrome.nftSkins.errorCollection': 'Эта коллекция не поддерживается.',
  'hudChrome.nftSkins.errorTooMany': 'Достигнут лимит NFT-скинов.',
  'hudChrome.nftSkins.errorMetadata': 'Сейчас не удалось прочитать этот NFT. Повторите попытку позже.',
  'hudChrome.nftSkins.errorGeneric': 'Не удалось получить этот NFT-скин.',
  'hudChrome.nftSkins.walletError': 'Не удалось подключить кошелек.',
};
