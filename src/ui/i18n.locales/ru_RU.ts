...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.basic_mining_pick.name': 'Базовая кирка',
  'entities.items.basic_logging_axe.name': 'Базовый топор лесоруба',
  'entities.items.basic_herbalists_sickle.name': 'Базовый серп травника',
