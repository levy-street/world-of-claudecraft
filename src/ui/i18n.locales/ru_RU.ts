...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolSlotStowHint': 'Нажмите, чтобы убрать лучший инструмент ({type})',
  'hudChrome.bags.toolSlotTakeHint': 'Нажмите, чтобы забрать инструмент',
  'hudChrome.bags.toolSlotNoTool': 'У вас нет инструмента ({type})',
  'hudChrome.bags.toolType.mining': 'Горное дело',
  'hudChrome.bags.toolType.logging': 'Лесозаготовка',
  'hudChrome.bags.toolType.herbalism': 'Травничество',
