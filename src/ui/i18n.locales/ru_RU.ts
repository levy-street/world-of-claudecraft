...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.scene.waitingFor': 'Ожидание игрока {name}',
  'hudChrome.mountTraining.buyReinsPrompt':
    'Верховая езда изучена. Купите у Марлы поводья доблестного скакуна за 10 золотых и используйте их, чтобы сесть в седло.',
  'lb.fixture.ferry': 'Паром на Дальний берег',
  'lb.fixture.tidemill': 'Приливная мельница',
  'lb.fixture.breach': 'Разлом',
  'lb.speaker.tam': 'Хранитель колокола Тэм',
  'lb.speaker.coalfast': 'Страж Коулфаст',
  'lb.speaker.ollun': 'Дозорный Разлома Оллун',
  'lb.speaker.edda': 'Квартирмейстер Эдда',
  'lb.speaker.saul': 'Целитель Саул',
  'lb.fare.promptOut': 'Переправа на Дальний берег: {price} медных.',
  'lb.fare.promptBack': 'Переправа обратно на материк: {price} медных.',
  'lb.fare.pay': 'Заплатить за проезд.',
  'lb.fare.decline': 'Не сегодня.',
  'lb.q0.scene.harbor':
    'Рабочая гавань: сушатся сети, ящики со звёздным стеклом помечены для покупателей с материка.',
  'lb.q0.scene.plinth':
    'Над портовыми ступенями бронзовый страж смотрит вглубь острова. Самому новому имени на постаменте уже сто лет: СТРАЖ ХЕЙЛ. Ниже ещё осталось место.',
  'lb.q0.scene.toll':
    'Колокол звонит один раз. Все на улице останавливаются и считают. Больше ничего не звучит, и вся улица разом выдыхает.',
  'lb.q0.tam.stretchers': 'Последняя такая тварь отняла у всей стражи целое утро и две носилки.',
  'lb.q0.coalfast.look':
    'Человек в сером смотрит на мёртвого охотника, затем чуть дольше — на вас. После он уходит обратно к утёсам.',
  ...
  'editor.cinematic.letterboxOn': 'Чёрные полосы: вкл.',
  'editor.cinematic.letterboxOff': 'Чёрные полосы: выкл.',
  'editor.cinematic.violations': 'Нарушения',
  'editor.cinematic.noViolations': 'Сейчас нарушений нет',
  'editor.cinematic.capture': 'Снять ключевой кадр',
  'editor.cinematic.copy': 'Копировать блок',
  'editor.cinematic.output': 'Сгенерированный снимок камеры',
  'editor.cinematic.unavailable': 'Загрузка трёхмерного окна',
  'editor.cinematic.seedMismatch': 'Для снимка нужен рабочий ключ генерации мира',
  'editor.cinematic.captureSavedCopied': 'Сохранено и скопировано',
  'editor.cinematic.captureSaved': 'Сохранено; блок подготовлен ниже',
  'editor.cinematic.captureCopyOnly': 'Скопировано; запись для разработчика недоступна',
  'editor.cinematic.captureReady': 'Блок подготовлен ниже',
  'entities.mobs.lb_actor_coalfast.name': 'Страж Коулфаст',
  'entities.mobs.lb_actor_ollun.name': 'Дозорный Разлома Оллун',
  'entities.mobs.lb_actor_edda.name': 'Квартирмейстер Эдда',
  'entities.mobs.lb_actor_saul.name': 'Целитель Саул',
  'entities.mobs.lb_actor_tam.name': 'Хранитель колокола Тэм',
  'entities.mobs.tidemill_stalker.name': 'Охотник Приливной мельницы',
  ...
  'entities.npcs.ferryman_ewald.greeting':
    'На Дальний берег, значит? Ради рыбалки туда больше никто не ездит, друг. Поднимайтесь на борт, когда будете готовы, и слушайте колокол после высадки: местные следят за ним, как вы следите за погодой.',
  ...
  'entities.npcs.sergeant_marsh.greeting':
    'Обучены? Тогда слушайте, как пройдёт эта ночь. Мой строй держит дорогу. Если Разлом выплюнет что-то нам не по силам, я укажу на вас. Мельница ваша: ничто не должно войти следом за вами и ничто не должно пройти мимо нас в город. Вперёд.',
  'entities.quests.q_lb_q0_ashore.title': 'На берегу',
  'entities.quests.q_lb_q0_ashore.text':
    'Галлхейвен принимает удары днём и ночью, но всё ещё стоит. Если хотите встать рядом с его жителями, начните там, где город истекает кровью: у линии ополчения на Дозорном лугу, к востоку от портовых ступеней и старой статуи.',
  'entities.quests.q_lb_q0_ashore.completion':
    'На мельнице вы справились в одиночку, и Тэм не преувеличивал про носилки. Мне не хватает разведчика, а полей слишком много. Сегодня вы удержали землю, которую не обязаны были защищать, — в этом и состоит вся работа. Добро пожаловать в стражу.',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': 'Явиться к сержанту Маршу на Дозорном лугу',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': 'Уничтожить порождений Разлома',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': 'Покончить с тем, что скрывается на Приливной мельнице',
  'entities.zones.farshore_isle.pois.5.label': 'Разлом',
  'entities.zones.farshore_isle.pois.6.label': 'Поля обломков',
  'entities.dungeons.lb_tidemill.name': 'Приливная мельница',
  'entities.dungeons.lb_tidemill.enterText': 'Дверь мельницы поддаётся. Внутри темнота прислушивается.',
  'entities.dungeons.lb_tidemill.leaveText': 'Вы выходите из Приливной мельницы в вечерний воздух.',
  'entities.dungeons.lb_riftline.enterText': 'Ворота луга закрываются за патрулём. Эта ночь принадлежит рубежу.',
  'entities.dungeons.lb_riftline.leaveText': 'Вы оставляете рубеж у Разлома утренней страже.',
  'entities.dungeons.lb_vault.name': 'Затонувший Первый редут',
  'entities.dungeons.lb_vault.enterText': 'Верёвка уходит во тьму. Внизу древний редут лежит там, куда когда-то рухнул.',
  'entities.dungeons.lb_vault.leaveText': 'Вы поднимаетесь по верёвке на утёс, к дневному свету.',
  'entities.dungeons.lb_council.name': 'Совет редута',
  'entities.dungeons.lb_council.enterText': 'В зале совета шесть стульев. Один пустует.',
  'entities.dungeons.lb_council.leaveText': 'Вы выходите из редута.',
  'entities.dungeons.lb_landing.name': 'Ночная высадка',
  'entities.dungeons.lb_landing.enterText': 'Вдоль берега горят путеводные огни. За отмелью ждёт флот.',
  'entities.dungeons.lb_landing.leaveText': 'Вы оставляете берег высадки позади.',
  'entities.dungeons.lb_riftfields.name': 'Подступы к Полям Разлома',
  'entities.dungeons.lb_riftfields.enterText': 'Четыре места печати окружают Разлом. Обряд удерживал его закрытым двенадцать веков.',
  'entities.dungeons.lb_riftfields.leaveText': 'Вы спускаетесь обратно с Полей Разлома.',
  'entities.dungeons.lb_breach.name': 'Внутри Разлома',
  'entities.dungeons.lb_breach.enterText': 'Свет неправильный, а небо ещё хуже. Сердце лежит впереди на открытом месте.',
  'entities.dungeons.lb_breach.leaveText': 'Вы переступаете порог и возвращаетесь в обычный ночной воздух.',
  'entities.dungeons.lb_lastwatch.name': 'Последняя стража',
  'entities.dungeons.lb_lastwatch.enterText': 'Редут чист и пуст. Кому-то придётся завершить эту стражу.',
  'entities.dungeons.lb_lastwatch.leaveText': 'Вы закрываете за собой дверь редута.',
  'entities.dungeons.lb_willowfen.name': 'Плачущая Ива',
  'entities.dungeons.lb_willowfen.enterText': 'Ива не движется. Вода тоже.',
  'entities.dungeons.lb_willowfen.leaveText': 'Вы оставляете иву в её тишине.',
};
