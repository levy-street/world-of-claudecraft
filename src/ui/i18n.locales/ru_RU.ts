...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.castBar.casting': 'Применение',
  'hudChrome.castBar.channeling': 'Поддержание',
  'hudChrome.castBar.complete': 'Завершено',
  'hudChrome.castBar.interrupted': 'Прервано',
  'hudChrome.castBar.failed': 'Не удалось',
  'hudChrome.castBar.interruptible': 'Можно прервать',
  'hudChrome.castBar.cannotInterrupt': 'Нельзя прервать',
  'hudChrome.castBar.danger': 'Опасно',
  'hudChrome.castBar.pet': 'Питомец',
  'hudChrome.castBar.secondsShort': '{seconds}с',
  'hudChrome.castBar.labelWithCue': '{cue}: {label}',
  'hudChrome.castBar.ariaStatus': '{bar}: {status} {label}, осталось {seconds}',
  'hudChrome.castBar.ariaOutcome': '{bar}: {status} {label}',
  'hudChrome.petAction.auto': 'АВТО',
  'hudChrome.petAction.cooldownTitle': '{action}: осталось {seconds}',
  'hudChrome.petAction.cooldownAutoAria': '{action}: осталось {seconds}, {auto}',
