...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'game.leaderboard.guildCol': 'Гильдия',
  'game.leaderboard.members': 'Участники',
  'game.leaderboard.topLevel': 'Макс. ур.',
  'game.leaderboard.totalXp': 'Всего опыта',
  'game.leaderboard.tabPlayers': 'Игроки',
  'game.leaderboard.tabGuilds': 'Гильдии',
