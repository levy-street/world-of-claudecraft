...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.meters.loot': 'Добыча',
  'hud.meters.lootShort': 'Добыча',
  'hud.meters.lootHistory': 'История',
  'hud.meters.noLoot': 'Добыча еще не записана.',
  'hud.meters.recentAwards': 'Последние награды: {count}',
  'hud.meters.methodReturned': 'Отказ',
  'hud.meters.methodMaster': 'Мастер',
  'hud.meters.methodPersonal': 'Персонально',
  'hud.meters.methodDelve': 'Вылазка',
  'hud.meters.methodLooted': 'Получено',
  'hud.meters.noWinner': 'Нет победителя',
  'hud.meters.rollDetail': 'Бросок {roll}',
