...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.endsInDays.one': 'Остался {count} день',
  'hudChrome.arenaSeason.endsInDays.few': 'Осталось {count} дня',
  'hudChrome.arenaSeason.endsInDays.many': 'Осталось {count} дней',
  'hudChrome.arenaSeason.endsInDays.other': 'Осталось {count} дня',
  'hudChrome.arenaSeason.endsInHours.one': 'Остался {count} час',
  'hudChrome.arenaSeason.endsInHours.few': 'Осталось {count} часа',
  'hudChrome.arenaSeason.endsInHours.many': 'Осталось {count} часов',
  'hudChrome.arenaSeason.endsInHours.other': 'Осталось {count} часа',
  'hudChrome.arenaSeason.endsInMinutes.one': 'Осталась {count} минута',
  'hudChrome.arenaSeason.endsInMinutes.few': 'Осталось {count} минуты',
  'hudChrome.arenaSeason.endsInMinutes.many': 'Осталось {count} минут',
  'hudChrome.arenaSeason.endsInMinutes.other': 'Осталось {count} минуты',
  'hudChrome.arenaSeason.opensInDays.one': 'Откроется через {count} день',
  'hudChrome.arenaSeason.opensInDays.few': 'Откроется через {count} дня',
  'hudChrome.arenaSeason.opensInDays.many': 'Откроется через {count} дней',
  'hudChrome.arenaSeason.opensInDays.other': 'Откроется через {count} дня',
  'hudChrome.arenaSeason.opensInHours.one': 'Откроется через {count} час',
  'hudChrome.arenaSeason.opensInHours.few': 'Откроется через {count} часа',
  'hudChrome.arenaSeason.opensInHours.many': 'Откроется через {count} часов',
  'hudChrome.arenaSeason.opensInHours.other': 'Откроется через {count} часа',
  'hudChrome.arenaSeason.opensInMinutes.one': 'Откроется через {count} минуту',
  'hudChrome.arenaSeason.opensInMinutes.few': 'Откроется через {count} минуты',
  'hudChrome.arenaSeason.opensInMinutes.many': 'Откроется через {count} минут',
  'hudChrome.arenaSeason.opensInMinutes.other': 'Откроется через {count} минуты',
