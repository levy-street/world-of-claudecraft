...
export const tr_TR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwalk_sandals.name': 'Külyürüyen Sandaletleri',
  'entities.items.cinderarc_odrenns_rod.name': 'Kor Yay, Odrenn’in Asası',
  'entities.items.cindertoad_signet.name': 'Köz Kurbağası Mührü',
  'entities.items.coalglow_band.name': 'Kömür Parıltısı Halkası',
  'entities.items.crownforged_warleggings.name': 'Taçdövme Savaş Tozlukları',
  'entities.items.glassblowers_shiv.name': 'Cam Üfleyicinin Hançeri',
  'entities.items.glasswalker_treads.name': 'Camyürüyen Çizmeleri',
  'entities.items.nighttalon_prowlers.name': 'Gecepençesi Sinsi Çizmeleri',
  'entities.items.quenchsilk_cord.name': 'Suverilmiş İpek Kordon',
  'entities.items.ring_of_the_first_quench.name': 'İlk Suvermenin Yüzüğü',
  'entities.items.saans_stoking_iron.name': 'Saan’ın Ateş Demiri',
  'entities.items.slag_tempered_sabatons.name': 'Cürufla Suverilmiş Savaş Çizmeleri',
  'entities.items.slakeleather_belt.name': 'Suverilmiş Deri Kemeri',
  'entities.items.sluicebearer.name': 'Savak Taşıyıcı',
  'entities.items.soulflame_kilt.name': 'Ruhalevi İskoç Eteği',
  'entities.items.stokebrand_striders.name': 'Körük Damgası Çizmeleri',
  'entities.items.stormcallers_legwraps.name': 'Fırtınaçağıranın Bacak Sargıları',
  'entities.items.the_even_temper.name': 'Dengeli Suverme',
  'entities.items.twice_fired_slippers.name': 'İki Kez Pişirilmiş Terlikler',
  'entities.items.twicetempered_girdle.name': 'İki Kez Suverilmiş Kuşak',
  'entities.items.crownforged_heartplate.name': 'Taçdövme Yürek Zırhı',
  'entities.items.nighttalon_emberweave.name': 'Gecepençesi Kor Dokuması',
  'entities.items.soulflame_vestments.name': 'Ruhalevi Cübbeleri',
  'entities.items.stormcallers_hauberk.name': 'Fırtınaçağıranın Zırhlı Gömleği',
  'entities.items.volzharrs_knucklestone.name': 'Volzharr’ın Yumruk Taşı',
  'entities.items.magmastrider_greaves.name': 'Magmayürüyen Baldırlıkları',
  'entities.items.footwraps_of_the_waking_floor.name': 'Uyanan Zeminin Ayak Sargıları',
  'entities.items.forgeheat_cinch.name': 'Ocak Isısı Kuşağı',
  'entities.items.corebreaker_heart_of_the_undermount.name': 'Çekirdekkıran, Alt Dağın Yüreği',
  'entities.items.the_last_restraint.name': 'Son Bağ',
  'entities.items.band_of_the_ninth_quench.name': 'Dokuzuncu Suverme Yüzüğü',
  'entities.items.moltenheart_chroma.name': 'Erimiş Yürek',
  'entities.itemSets.crownforged.bonus5': 'Kritik vuruş şansını %3 artırır.',
