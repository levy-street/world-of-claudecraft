...
export const tr_TR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashwood_staff.name': 'Dişbudak asası',
  'entities.items.gravecaller_cloth_handwraps.name': 'Mezarçağıranın kumaş el sargıları',
  'entities.items.gravecaller_cloth_hood.name': 'Mezarçağıranın kumaş başlığı',
  'entities.items.gravecaller_cloth_leggings.name': 'Mezarçağıranın kumaş bacaklığı',
  'entities.items.gravecaller_cloth_mantle.name': 'Mezarçağıranın kumaş omuzluğu',
  'entities.items.gravecaller_cloth_raiment.name': 'Mezarçağıranın kumaş cübbesi',
  'entities.items.gravecaller_cloth_sash.name': 'Mezarçağıranın kumaş kuşağı',
  'entities.items.gravecaller_cloth_slippers.name': 'Mezarçağıranın kumaş terlikleri',
  'entities.items.gravecaller_focus.name': 'Mezarçağıranın odağı',
  'entities.items.gravecaller_pendant.name': 'Mezarçağıranın kolyesi',
  'entities.items.gravecaller_ring.name': 'Mezarçağıranın yüzüğü',
  'entities.items.gravecaller_wand.name': 'Mezarçağıranın asası',
  'entities.items.iron_broadsword.name': 'Demir geniş kılıç',
  'entities.items.iron_flanged_mace.name': 'Demir flanşlı topuz',
  'entities.items.mirefen_dirk.name': 'Mirefen hançeri',
  'entities.items.mirefen_hunting_bow.name': 'Mirefen av yayı',
  'entities.items.mirefen_leather_belt.name': 'Mirefen deri kemeri',
  'entities.items.mirefen_leather_boots.name': 'Mirefen deri çizmeleri',
  'entities.items.mirefen_leather_gloves.name': 'Mirefen deri eldivenleri',
  'entities.items.mirefen_leather_hood.name': 'Mirefen deri başlığı',
  'entities.items.mirefen_leather_jerkin.name': 'Mirefen deri yeleği',
  'entities.items.mirefen_leather_leggings.name': 'Mirefen deri bacaklığı',
  'entities.items.mirefen_leather_shoulderguards.name': 'Mirefen deri omuzlukları',
  'entities.items.thornpeak_bulwark.name': 'Thornpeak siperi',
  'entities.items.thornpeak_crossbow.name': 'Thornpeak arbaleti',
  'entities.items.thornpeak_mail_chest.name': 'Thornpeak zincir göğüslüğü',
  'entities.items.thornpeak_mail_gauntlets.name': 'Thornpeak zincir eldivenleri',
  'entities.items.thornpeak_mail_girdle.name': 'Thornpeak zincir kuşağı',
  'entities.items.thornpeak_mail_helm.name': 'Thornpeak zincir miğferi',
  'entities.items.thornpeak_mail_legguards.name': 'Thornpeak zincir bacaklığı',
  'entities.items.thornpeak_mail_pauldrons.name': 'Thornpeak zincir omuzlukları',
  ...
  'itemUi.lootRoll.needUnavailable': 'Sınıfın bu eşyayı kuşanamadığı için İhtiyaç kullanılamıyor.',
  'itemUi.lootRoll.needUnavailablePower':
    'Bu efsanevi güç başka bir sınıfa özel olduğu için İhtiyaç kullanılamıyor.',
  'itemUi.procedural.advancedDetailsHint':
    'Olası atış aralıklarını göstermek için {key} tuşunu basılı tut.',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    'Her dördüncü Kasvet Oku hedefini ek Gölge hasarı için işaretler.',
  'itemUi.procedural.legendary.ashbinders_seal.name': 'Külbağlayanın Mührü',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    'Her ikinci hasar büyüsü hedefin çevresinde çınlar.',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': 'Dokuzuncu Çan',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    '15 yarda hareket etmek kısa süreli hareket hızı artışı sağlar.',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': 'Kırılmaz Yolun Çizmeleri',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    'Her üçüncü Köz Oku hedefin yakınındaki düşmanları kavurur.',
  'itemUi.procedural.legendary.crown_last_pyre.name': 'Son Cenaze Ateşinin Tacı',
  'itemUi.procedural.legendary.dawnward_signet.description':
    'Onaran Işık alıcısını iyileştirmenin bir kısmı kadar kalkanla korur.',
  'itemUi.procedural.legendary.dawnward_signet.name': 'Şafak Muhafızı Mührü',
  'itemUi.procedural.legendary.feral_moonclasp.description':
    'Her üçüncü Yaban Oku birincil kaynağı yeniler.',
  'itemUi.procedural.legendary.feral_moonclasp.name': 'Vahşi Ay Tokası',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    'Her üçüncü silah vuruşu hedefi kanatır ve biraz kaynak yeniler.',
  'itemUi.procedural.legendary.greyjaws_edge.name': 'Bozçene’nin Keskin Ucu',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    'Uzun Çekiş veya Uğursuz Atış hedefini kısa süreliğine susturabilir.',
  'itemUi.procedural.legendary.hushwood_longbow.name': 'Sessizorman Uzun Yayı',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    'Sağlık 35% altına düştüğünde kısa süreli savunma koruması kazanırsın.',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': 'Çalınmış Saatlerin Pelerini',
  'itemUi.procedural.legendary.nightglass_fang.description':
    'Bir öldürme kısa süreli hız kazandırır.',
  'itemUi.procedural.legendary.nightglass_fang.name': 'Gececamı Dişi',
  'itemUi.procedural.legendary.stormwake_idol.description':
    'Her dördüncü Ark Oku yakındaki düşmanlara sıçrar.',
  'itemUi.procedural.legendary.stormwake_idol.name': 'Fırtına Uyanışı Putu',
  'itemUi.procedural.legendary.ysoleis_vigil.description':
    'Kritik iyileştirme yerde kısa süreli onarıcı bir alan oluşturur.',
  'itemUi.procedural.legendary.ysoleis_vigil.name': 'Ysolei’nin Nöbeti',
  'itemUi.procedural.legendaryLimit': 'Benzersiz kuşanım: {count} efsanevi güç',
  'itemUi.procedural.legendaryPower': 'Efsanevi güç',
  'itemUi.procedural.nameFragment.deft': 'Becerikli',
  'itemUi.procedural.nameFragment.mighty': 'Kudretli',
  'itemUi.procedural.nameFragment.of_alacrity': 'Atikliğin',
  'itemUi.procedural.nameFragment.of_focus': 'Odağın',
  'itemUi.procedural.nameFragment.of_precision': 'Kesinliğin',
  'itemUi.procedural.nameFragment.of_reaping': 'Hasadın',
  'itemUi.procedural.nameFragment.of_remembrance': 'Hatıranın',
  'itemUi.procedural.nameFragment.of_striking': 'Vuruşun',
  'itemUi.procedural.nameFragment.sages': 'Bilgenin',
  'itemUi.procedural.nameFragment.spiritual': 'Ruhani',
  'itemUi.procedural.nameFragment.stalwart': 'Metin',
  'itemUi.procedural.nameFragment.warded': 'Korunaklı',
  'itemUi.procedural.powerRollMilliseconds': 'Güç atışı: {value} ms',
  'itemUi.procedural.powerRollNumber': 'Güç atışı: {value}',
  'itemUi.procedural.powerRollPercent': 'Güç atışı: {value}%',
  'itemUi.procedural.powerRollResource': 'Güç atışı: {value} kaynak',
  'itemUi.procedural.rareWord.ashen': 'Külrengi',
  'itemUi.procedural.rareWord.bite': 'Isırık',
  'itemUi.procedural.rareWord.blackfen': 'Karakır',
  'itemUi.procedural.rareWord.brand': 'Dağlama',
  'itemUi.procedural.rareWord.doom': 'Felaket',
  'itemUi.procedural.rareWord.grave': 'Mezar',
  'itemUi.procedural.rareWord.mire': 'Bataklık',
  'itemUi.procedural.rareWord.oath': 'Yemin',
  'itemUi.procedural.rareWord.promise': 'Söz',
  'itemUi.procedural.rareWord.storm': 'Fırtına',
  'itemUi.procedural.rareWord.thorn': 'Diken',
  'itemUi.procedural.rareWord.thread': 'İplik',
  'itemUi.procedural.rareWord.vigil': 'Nöbet',
  'itemUi.procedural.rareWord.ward': 'Koruma',
  'itemUi.procedural.rareWord.whisper': 'Fısıltı',
  'itemUi.procedural.rareWord.wyrm': 'Ejder',
  'itemUi.procedural.rarity.common': 'Sıradan',
  'itemUi.procedural.rarity.epic': 'Destansı',
  'itemUi.procedural.rarity.legendary': 'Efsanevi',
  'itemUi.procedural.rarity.magic': 'Büyülü',
  'itemUi.procedural.rarity.mythic': 'Mitik',
  'itemUi.procedural.rarity.rare': 'Nadir',
  'itemUi.procedural.rollRangeAria': '{min} ile {max} arasında olası atış',
  'itemUi.stats.blockValue': 'Engelleme değeri',
  'itemUi.stats.healthOnKill': 'Öldürmede sağlık',
  'itemUi.stats.manaOnKill': 'Öldürmede mana',
