...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.limitedRelicSupply': '限量圣物：全世界仅有 {count} 件',
  'hudChrome.limitedRelicSerial': '圣物 第 {serial} / {supply} 号',
  'hudChrome.limitedRelicClaim': '{name} 获得了 {item}，圣物 第 {serial} / {supply} 号。',
  ...
  'entities.items.emberfall_edge.name': '烬落之刃',
  'entities.items.crown_of_the_thornpeak_scourge.name': '荆峰灾星之冠',
  'entities.items.thunzharrs_stormheart.name': '图恩扎尔的风暴之心',
  'entities.items.sealed_vault_signet_crypt.name': '空冢密库封印戒',
  'entities.items.sealed_vault_signet_bastion.name': '沉没堡垒封印戒',
  'entities.items.sealed_vault_signet_temple.name': '溺亡神庙封印戒',
  'entities.items.sealed_vault_signet_sanctum.name': '墓龙圣所封印戒',
