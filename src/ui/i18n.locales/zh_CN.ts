...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.raidBossGuide.nythraxis.graveEruptionHeroicSummary': '每 {everyHeroic} 秒，森森白骨之手会在队员脚下标记 {countHeroic} 个半径 {radius} 码的圆圈。{warning} 秒后，每个圆圈都会爆裂，造成 {burstHeroic} 最大生命值的暗影伤害，随后化为坟场烈焰持续燃烧至该阶段结束，对站在其中的任何人每秒造成 {tickHeroic} 最大生命值的伤害。烈焰不会自行熄灭：团队若不持续移动，地面终将被完全占满。',
  ...
  'hudChrome.raidBossGuide.nythraxis.soulfireSummary': '每次灵魂撕裂引爆都会在标记所在位置留下一片半径 {radius} 码的红色火池，燃烧 {seconds} 秒，每秒造成 {tickNormal} 最大生命值的伤害。火池不会在护符石 {clearance} 码范围内形成。',
  'hudChrome.raidBossGuide.nythraxis.soulfireHeroicSummary': '每次灵魂撕裂引爆都会在标记所在位置留下一片半径 {radius} 码的红色火池，持续燃烧至该阶段结束，每秒造成 {tickHeroic} 最大生命值的伤害。火池不会在护符石 {clearance} 码范围内形成，且不会自行熄灭。',
  'hudChrome.raidBossGuide.nythraxis.soulfireResponse': '每次施法都应更换灵魂撕裂的集合点，避免团队站在上一次施法留下的火焰中。',
