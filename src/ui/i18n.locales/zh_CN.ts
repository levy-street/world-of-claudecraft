...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.tabHistory': '历史记录',
  'hudChrome.claudium.giftTitle': '赠送礼品卡',
  'hudChrome.claudium.giftDenominationLabel': '面额',
  'hudChrome.claudium.giftRecipientLabel': '收件人',
  'hudChrome.claudium.giftToSelf': '给我自己',
  'hudChrome.claudium.giftToOther': '给其他人',
  'hudChrome.claudium.giftEmailLabel': '收件人邮箱',
  'hudChrome.claudium.giftEmailInvalid': '请输入有效的邮箱地址。',
  'hudChrome.claudium.giftOccasionLabel': '场合',
  'hudChrome.claudium.giftMessageLabel': '个人留言',
  'hudChrome.claudium.giftMessagePlaceholder': '添加简短留言 (可选)',
  'hudChrome.claudium.giftDeliveryLabel': '送达方式',
  'hudChrome.claudium.giftScheduleLabel': '安排送达时间 (可选)',
  'hudChrome.claudium.giftReviewButton': '核对礼品',
  'hudChrome.claudium.giftReviewSelf': '这张礼品卡将由你自己兑换。',
  'hudChrome.claudium.giftReviewEmail': '我们会将这张礼品卡发送到 {email}。',
  'hudChrome.claudium.giftReviewShared': '你将获得一个链接来分享这张礼品卡。',
  'hudChrome.claudium.giftReviewScheduled': '将在你选择的日期送达。',
  'hudChrome.claudium.giftConfirmButton': '确认并支付',
  'hudChrome.claudium.giftAnotherButton': '再赠送一张',
  'hudChrome.claudium.giftPending': '正在开具你的礼品卡。这可能需要一点时间。',
  'hudChrome.claudium.giftIssued': '你的礼品卡已可分享。',
  'hudChrome.claudium.giftFailed': '无法开具该礼品卡。请稍后再试。',
  'hudChrome.claudium.giftDeclined': '支付被拒绝。未开具礼品卡。',
  'hudChrome.claudium.giftLinkLabel': '礼品卡链接',
  'hudChrome.claudium.giftQrAlt': '礼品卡兑换链接的二维码',
  'hudChrome.claudium.giftTerms': '礼品卡仅可兑换克劳迪姆。不可兑换现金，且不可退款。',
  'hudChrome.claudium.deliveryEmail': '电子邮件',
  'hudChrome.claudium.deliveryLink': '分享链接',
  'hudChrome.claudium.deliveryReveal': '立即显示',
  'hudChrome.claudium.occasionBirthday': '生日',
  'hudChrome.claudium.occasionHoliday': '节日',
  'hudChrome.claudium.occasionCongrats': '祝贺',
  'hudChrome.claudium.occasionThankyou': '感谢',
  'hudChrome.claudium.occasionGeneric': '随心赠送',
  'hudChrome.claudium.reasonPurchaseStripe': '购买 (银行卡)',
  'hudChrome.claudium.reasonPurchaseSol': '购买 (SOL)',
  'hudChrome.claudium.reasonPurchaseUsdc': '购买 (USDC)',
  'hudChrome.claudium.reasonPurchaseWoc': '购买 (WOC)',
  'hudChrome.claudium.reasonGiftcardRedeem': '礼品卡已兑换',
  'hudChrome.claudium.reasonSpend': '购买装饰',
  'hudChrome.claudium.reasonRefund': '退款',
  'hudChrome.claudium.reasonChargeback': '拒付',
  'hudChrome.claudium.reasonGiftcardVoid': '礼品卡已作废',
  'hudChrome.claudium.historyTitle': '交易记录',
  'hudChrome.claudium.historyLoading': '正在加载你的记录...',
  'hudChrome.claudium.historyError': '无法加载你的记录。请重试。',
  'hudChrome.claudium.historyEmpty': '你还没有任何克劳迪姆交易。',
  'hudChrome.claudium.historyLoadMore': '加载更多',
  'hudChrome.claudium.historyFilterLabel': '按类型筛选',
  'hudChrome.claudium.historyFilterAll': '所有类型',
  'hudChrome.claudium.historyExplorer': '在 Solana Explorer 上查看',
  'hudChrome.claudium.historyReceipt': '银行卡购买',
  'hudChrome.claudium.historyGiftNote': '礼品卡',
  'hudChrome.claudium.timeJustNow': '刚刚',
  'hudChrome.claudium.discountLabel': '折扣',
  'hudChrome.claudium.discountSummary': '按有效锚定价格立减 {percent}%',
  'hudChrome.claudium.discountBonus': '{base} 增至 {credited} 克劳迪姆 (+{bonus})',
  'hudChrome.claudium.wocIncentive': '使用 $WOC 支付 - 始终至少 15% 折扣',
  'hudChrome.claudium.wocPromoNote': '含限时促销',
  'hudChrome.claudium.inspectButton': '详情',
  'hudChrome.claudium.inspectBack': '返回商店',
  'hudChrome.claudium.inspectArtAlt': '{name} 的预览',
  'hudChrome.claudium.tryOnStopButton': '停止试穿',
  'hudChrome.claudium.tryOnActiveNote': '正在你的角色上预览。这不会授予该物品。',
  'hudChrome.claudium.tabSupply': '供应量',
  'hudChrome.claudium.supplyTitle': '现存克劳迪姆',
  'hudChrome.claudium.supplyLoading': '正在加载供应量...',
  'hudChrome.claudium.supplyError': '无法加载供应量数据。请重试。',
  'hudChrome.claudium.supplyUnavailable': '暂时无法获取供应量数据。',
  'hudChrome.claudium.supplyInExistence': '现存 {amount}',
  'hudChrome.claudium.supplyUsdValue': '价值 {amount}',
  'hudChrome.claudium.supplyIssued': '累计发行总量',
  'hudChrome.claudium.supplySunk': '累计消耗或撤销',
  'hudChrome.claudium.supplyHolders': '由 {n} 个账户持有',
  'hudChrome.claudium.supplyChangeUp': '本期增加 {amount}',
  'hudChrome.claudium.supplyChangeDown': '本期减少 {amount}',
  'hudChrome.claudium.supplyChangeFlat': '本期无变化',
  'hudChrome.claudium.supplyChartLabel': '所选期间的克劳迪姆供应量',
  'hudChrome.claudium.supplyChartEmpty': '本期没有供应量变动。',
  'hudChrome.claudium.supplyRangeLabel': '图表周期',
  'hudChrome.claudium.supplyFootnote': '统计所有账户持有的全部克劳迪姆，实时汇总自账本。',
};
