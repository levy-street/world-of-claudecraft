...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.actionBar.secondBar': '第二动作条',
  'hudChrome.actionBar.barScale': '动作条大小',
  'hudChrome.actionBar.editKeys': '编辑动作条按键',
  'hudChrome.actionBar.bindModeTitle': '动作条按键绑定',
  'hudChrome.actionBar.bindModeHint': '点击一个格子，然后按下要绑定的按键。完成后点击“完成”。',
  'hudChrome.actionBar.bindReset': '重置',
  'hudChrome.actionBar.bindResetConfirmTitle': '重置动作条按键？',
  'hudChrome.actionBar.bindResetConfirmBody': '第一条动作条恢复为默认按键，第二条动作条变为未绑定。此操作无法撤销。',
  'hudChrome.actionBar.bindCancel': '取消',
  'hudChrome.actionBar.bindDone': '完成',
