...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.undermount_wing1.name': '地底山: 下行',
  'entities.dungeons.undermount_wing1.enterText': '你下到荆峰之下，进入玻璃般的黑暗。',
  'entities.dungeons.undermount_wing1.leaveText': '你从地底山的下行路爬回。',
  'entities.dungeons.undermount_wing2.name': '地底山: 回火',
  'entities.dungeons.undermount_wing2.enterText': '锤击声在回火宝库中回荡。',
  'entities.dungeons.undermount_wing2.leaveText': '你从回响的炉道撤退。',
  'entities.dungeons.undermount_wing3.name': '地底山: 苏醒',
  'entities.dungeons.undermount_wing3.enterText': '被埋的熔炉在深处躁动。',
  'entities.dungeons.undermount_wing3.leaveText': '你从苏醒的热浪中撤离。',
  'entities.mobs.vosh_the_glazier.name': '玻匠沃什',
  'entities.mobs.saan_the_stoker.name': '司炉萨安',
  'entities.mobs.odrenn_the_temperer.name': '回火者奥德伦',
  'entities.mobs.volzharr_buried_furnace.name': '沃尔扎尔，埋藏熔炉',
  'entities.mobs.undermount_cinderling.name': '余烬灵',
  'entities.npcs.runeseeker_maerin.name': '寻符者梅林',
  'entities.npcs.runeseeker_maerin.title': '流浪考古学家',
  ...
  'entities.items.undermount_rune_rubbing.name': '地底熔炉符文拓片',
  ...
  'entities.mobs.wyrmcult_dig_foreman.name': '巨龙教团挖掘监工',
  'entities.items.cindertoad_signet.name': '烬蟾徽戒',
  'entities.items.coalglow_band.name': '煤光指环',
  'entities.items.crownforged_warleggings.name': '冠铸战腿甲',
  'entities.items.glassblowers_shiv.name': '玻璃匠短刀',
  'entities.items.glasswalker_treads.name': '踏玻之靴',
  'entities.items.nighttalon_prowlers.name': '夜爪潜行靴',
  'entities.items.quenchsilk_cord.name': '淬火丝绳',
  'entities.items.ring_of_the_first_quench.name': '初淬之戒',
  'entities.items.saans_stoking_iron.name': '萨安拨火棍',
  'entities.items.slag_tempered_sabatons.name': '渣淬护胫',
  'entities.items.slakeleather_belt.name': '淬革腰带',
  'entities.items.sluicebearer.name': '持闸者',
  'entities.items.soulflame_kilt.name': '魂焰战裙',
  'entities.items.stokebrand_striders.name': '炉印行靴',
  'entities.items.stormcallers_legwraps.name': '唤雷者裹腿',
  'entities.items.the_even_temper.name': '平衡之淬',
  'entities.items.twice_fired_slippers.name': '二次烧制便鞋',
  'entities.items.twicetempered_girdle.name': '双淬腰带',
  'entities.items.crownforged_heartplate.name': '冠铸心甲',
  'entities.items.nighttalon_emberweave.name': '夜爪烬织衣',
  'entities.items.soulflame_vestments.name': '魂焰法衣',
  'entities.items.stormcallers_hauberk.name': '唤风者锁甲',
  'entities.items.volzharrs_knucklestone.name': '沃尔扎尔的拳骨石',
  'entities.items.magmastrider_greaves.name': '熔岩行者胫甲',
  'entities.items.footwraps_of_the_waking_floor.name': '苏醒地面的裹足',
  'entities.items.forgeheat_cinch.name': '锻炉热力束带',
  'entities.items.corebreaker_heart_of_the_undermount.name': '碎核者，山下之心',
  'entities.items.the_last_restraint.name': '最后的束缚',
  'entities.items.band_of_the_ninth_quench.name': '第九次淬火之戒',
  'entities.items.moltenheart_chroma.name': '熔火之心',
  'entities.itemSets.crownforged.bonus5': '暴击几率提高3%。',
  'entities.itemSets.nighttalon.bonus5': '暴击几率提高3%。',
  'entities.itemSets.soulflame.bonus5': '法术暴击几率提高3%。',
  'entities.itemSets.stormcallers.bonus5': '法术暴击几率提高3%。',
};
