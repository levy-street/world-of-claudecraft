...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.mobile.customize": "自定义",
  "hudChrome.mobile.customizeTitle": "自定义操作",
  "hudChrome.mobile.customizeSlotAttack": "普通攻击",
  "hudChrome.mobile.customizeSlotSkill": "技能 {n}",
  "hudChrome.mobile.customizeSlotUtility": "辅助",
  "hudChrome.mobile.customizeDefault": "职业默认",
  "hudChrome.mobile.customizeResetSlot": "重置此槽位",
  "hudChrome.mobile.customizeResetAll": "全部重置为职业默认",
  "hudChrome.mobile.customizeUpdated": "已更新{slot}。",
  "hudChrome.mobile.customizeAllReset": "操作已重置为职业默认。",
  "hudChrome.options.touchControls": "触屏操作",
  "hudChrome.options.clusterHold": "编辑长按延迟",
  "hudChrome.options.clusterHoldNote": "长按屏幕上的操作按钮多久后才会打开其绑定编辑器。如果你在连续使用技能时误触发编辑器，请调高此值。",
  "hudChrome.options.targetPriority": "攻击目标优先级",
  "hudChrome.options.targetPriorityNearest": "最近",
  "hudChrome.options.targetPriorityLowestHp": "生命最低",
  "hudChrome.options.targetPriorityCurrent": "优先当前目标",
  "hudChrome.options.targetPriorityNote": "当你没有有效目标时，攻击按钮的锁定对象：最近的敌人、范围内生命最低的敌人，或在当前目标仍有效时保持不变。",
  "hudChrome.options.aimAssist": "智能施法",
  "hudChrome.options.aimAssistNote": "按下攻击技能会对你的目标施放，若没有目标则对附近最合适的敌人施放，并转身面向它。按住按钮可预览技能范围；将手指移开按钮后松开即可取消。",
  "hudChrome.options.touchReset": "重置触屏操作",
  "hudChrome.options.touchResetDone": "触屏操作已恢复为默认设置。",
