...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.shardpike.braceTooltip': '将矛尾插入地面，矛尖朝上。你的横移键就是平衡杆：光束会自行漂移，他每次砸地都会把它踢偏。让它离开两端轨道并保持 {set} 秒即可架稳长矛。需要坚实的地面，且不能在坐骑上。',
  'hudChrome.shardpike.thrustLabel': '织影核心突刺',
  'hudChrome.shardpike.thrustTooltip': '将架稳的长矛刺入眼中，造成 {damage} 点伤害。没有任何东西能加成它：等级、攻击强度、长矛本身都不行。它会使工头失明并剥离石冢之皮，让泥沼中其他所有武器终于能咬进去。只有架稳的长矛才能送出这一击，射程 {reach} 码，窗口持续 {seconds} 秒。',
  'hudChrome.shardpike.releaseLabel': '放下碎晶长矛',
  'hudChrome.shardpike.releaseTooltip': '把长矛收起。中途放弃没有惩罚：你失去的是架势，不是这次机会，{rest} 秒后即可重新架起。',
  ...
  'entities.npcs.socketwright_skerrit.greeting': '四十年前我磨好那颗眼珠，把它嵌进他的眼窝，一天工钱都没拿到。你想让工头吃点苦头，{className}？那就冲着我的手艺去。',
  'entities.quests.q_socketwrights_due.title': '镶嵌匠的欠账',
  'entities.quests.q_socketwrights_due.text': '织影核心是我亲手嵌进那眼窝的：磨好透镜，安放到位，楔紧对齐。冢主们一个铜板都没付过我，如今我的手艺却在泥沼里四处踏平一切。拿走我的碎晶长矛。矛尾插地，稳住矛尖，需要多久就撑多久，等你手臂笃定了，就把它送进那只眼睛。他披的那层皮与那块晶石相连，{playerName}：戳瞎他，泥沼里的每一把刀刃终于都能咬进去。',
  'entities.quests.q_socketwrights_due.completion': '你感觉到它松了，是吧？四十年的利息，从那眼窝里付清了。长矛归你了，朋友。他会复原的，他总是会，所以你什么时候想再来收账都行。',
