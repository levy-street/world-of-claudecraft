...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'sim.delve.mobChannels': '{name}正在引导{mechanic}。',
  ...
  'sim.delve.eggSacBurst': '卵囊破裂了。黑水泼溅过洗礼堂的边缘。',
  'sim.delve.baptistryEggs': '洗礼堂归于寂静。寡妇卵囊沿着边缘膨胀。',
  ...
  'delveRiteUi.mistakes': '允许{count}次错误',
  ...
  'delveUi.object.widow_egg_sac': '寡妇卵囊',
