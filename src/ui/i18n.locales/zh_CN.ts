...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'itemUi.tooltip.flaskThroughDeath': '该效果在死亡后依然保留，但在登出后消失；排位赛开局时一切从零开始。',
