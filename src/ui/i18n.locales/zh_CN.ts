...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.stylist_verena.name': '维蕾娜·阿什洛克',
  'entities.npcs.stylist_verena.title': '造型师',
  'entities.npcs.stylist_verena.greeting':
    '请坐，{className}。一把梳子、一面好镜子，再加上足够的钱币，你就能改头换面地走出去。',
  'apiError.character.no_redesign_credit': '该角色已没有改造次数。前往东溪谷的造型师处购买。',
  'stylist.buyCredit': '购买一次改造（{price}）',
  'stylist.buyCreditAria': '以 {price} 购买一次角色改造',
  'character.editAppearance': '编辑外观',
  'character.editAppearanceAria': '编辑 {name} 的外观',
  'character.editAppearanceHint': '你持有 {count} 次造型师改造。保存时消耗一次。',
  'character.editAppearanceHintOne': '你持有 1 次造型师改造。保存时将消耗它。',
  'cardDuel.title': '纸牌对决',
  'cardDuel.close': '关闭',
  'cardDuel.join': '加入队列',
