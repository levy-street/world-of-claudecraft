...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'itemUi.kind.charm': '护符',
  'itemUi.kind.artifact': '神器',
  ...
  'hudChrome.itemCharmHint': '放在背包中即可获得加成',
  ...
  'entities.items.st_albus_index_finger.name': '圣阿尔布斯的食指',
  'entities.items.st_albus_middle_finger.name': '圣阿尔布斯的中指',
  'entities.items.st_albus_ring_finger.name': '圣阿尔布斯的无名指',
  'entities.items.st_albus_pinkie_finger.name': '圣阿尔布斯的小指',
  'entities.items.st_albus_thumb.name': '圣阿尔布斯的拇指',
  'entities.items.hand_of_st_albus.name': '圣阿尔布斯之手',
  ...
  'hudChrome.itemMenu.assemble': '组合',
