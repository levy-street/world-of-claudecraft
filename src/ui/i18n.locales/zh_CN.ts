...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.leaderboard.commits': '提交数',
  ...
  'hudChrome.devBadge.flavors.tinkerer': '你的第一个提交已落地于这片大陆。',
  'hudChrome.devBadge.flavors.artificer': '十次提交之后，世界开始顺从你的代码。',
  'hudChrome.devBadge.flavors.runesmith': '五十次提交，已熔铸进运行中的游戏。',
  'hudChrome.devBadge.flavors.architect': '这片大陆的架构师：已落地 150 次提交。',
  'hudChrome.devBadge.flavors.worldwright': '世界的铸造者：500 次提交塑造了这款游戏。',
  'hudChrome.devBadge.badgeTitle': '开发者：{tier}',
  'hudChrome.devBadge.commitsLanded': '已落地 {count} 次提交',
