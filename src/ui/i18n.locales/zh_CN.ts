...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.endsInDays.one': '{count} 天后结束',
  'hudChrome.arenaSeason.endsInDays.few': '{count} 天后结束',
  'hudChrome.arenaSeason.endsInDays.many': '{count} 天后结束',
  'hudChrome.arenaSeason.endsInDays.other': '{count} 天后结束',
  'hudChrome.arenaSeason.endsInHours.one': '{count} 小时后结束',
  'hudChrome.arenaSeason.endsInHours.few': '{count} 小时后结束',
  'hudChrome.arenaSeason.endsInHours.many': '{count} 小时后结束',
  'hudChrome.arenaSeason.endsInHours.other': '{count} 小时后结束',
  'hudChrome.arenaSeason.endsInMinutes.one': '{count} 分钟后结束',
  'hudChrome.arenaSeason.endsInMinutes.few': '{count} 分钟后结束',
  'hudChrome.arenaSeason.endsInMinutes.many': '{count} 分钟后结束',
  'hudChrome.arenaSeason.endsInMinutes.other': '{count} 分钟后结束',
  'hudChrome.arenaSeason.opensInDays.one': '{count} 天后开启',
  'hudChrome.arenaSeason.opensInDays.few': '{count} 天后开启',
  'hudChrome.arenaSeason.opensInDays.many': '{count} 天后开启',
  'hudChrome.arenaSeason.opensInDays.other': '{count} 天后开启',
  'hudChrome.arenaSeason.opensInHours.one': '{count} 小时后开启',
  'hudChrome.arenaSeason.opensInHours.few': '{count} 小时后开启',
  'hudChrome.arenaSeason.opensInHours.many': '{count} 小时后开启',
  'hudChrome.arenaSeason.opensInHours.other': '{count} 小时后开启',
  'hudChrome.arenaSeason.opensInMinutes.one': '{count} 分钟后开启',
  'hudChrome.arenaSeason.opensInMinutes.few': '{count} 分钟后开启',
  'hudChrome.arenaSeason.opensInMinutes.many': '{count} 分钟后开启',
  'hudChrome.arenaSeason.opensInMinutes.other': '{count} 分钟后开启',
