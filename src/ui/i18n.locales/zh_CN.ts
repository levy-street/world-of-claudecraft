...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.toolbeltTitle': '工具腰带',
  'hudChrome.bags.toolbeltNone': '未佩戴工具腰带',
  'hudChrome.bags.toolbeltRemoveHint': '点击卸下此工具腰带',
  'hudChrome.bags.toolbeltFilled': '{used}/{total} 件工具',
  'hudChrome.bags.toolSlotLabel': '工具栏位 {slot}',
  'hudChrome.bags.toolSlotEmpty': '空',
  'hudChrome.bags.toolSlotStowHint': '点击收纳{name}',
  'hudChrome.bags.toolSlotTakeHint': '点击取回此工具',
  'hudChrome.bags.toolSlotNoTool': '你没有可收纳的工具',
  'itemUi.kind.toolbelt': '工具腰带',
  'entities.items.basic_toolbelt.name': '基础工具腰带',
  'entities.items.reinforced_toolbelt.name': '强化工具腰带',
  'entities.items.artisans_toolbelt.name': '工匠的工具腰带',
  'itemUi.tooltip.toolbeltSlots': '可容纳 {slots} 件工具',
  'itemUi.tooltip.toolbeltDesc': '一条可以收纳工具的腰带，为你的背包腾出空间。',
