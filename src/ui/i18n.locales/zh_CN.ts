...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  'hudChrome.warfare.arenaDailyTitle': '竞技场每日',
  'hudChrome.warfare.arenaDailyClaim': '领取每日奖励',
  'hudChrome.warfare.arenaDailyReward': '{honor} 荣誉 + {hero} 英雄点数',
  'hudChrome.warfare.arenaDailyClaimed': '你今天已经领取过每日竞技场奖励了。',
  'hudChrome.warfare.arenaDailyNotEntered': '今天进行一场竞技场对战即可领取每日奖励。',
  ...
  'hudChrome.warfare.reasons.arenaDaily': '竞技场每日',
  ...
  'hudChrome.frontier.note': '常驻的开放PvP区域。走出安全枢纽后，所有玩家都是敌人。',
  ...
  'entities.items.frostrend_hauberk.name': '裂霜锁甲',
  'entities.items.frostrend_girdle.name': '裂霜腰带',
  'entities.items.frostrend_legguards.name': '裂霜护腿',
  'entities.items.frostrend_gauntlets.name': '裂霜护手',
  'entities.items.frostrend_sabatons.name': '裂霜战靴',
  'entities.items.frostrend_choker.name': '裂霜项链',
  'entities.items.frostrend_band.name': '裂霜指环',
  'entities.npcs.frostreach_quartermaster.name': '维尔卡·霜卫',
  'entities.npcs.frostreach_quartermaster.title': '霜达军需官',
  'entities.npcs.frostreach_quartermaster.greeting': '边境以鲜血与寒霜为报。好好花你的英雄点数。',
