...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'yumi.log.teamBlue': '你在蓝队！',
  'yumi.log.teamRed': '你在红队！',
  'yumi.log.powerupGrabbed': '{player} 获得了 {name} 强化！',
  'yumi.hud.powerupIn': '强化 {s}秒后出现',
  'yumi.hud.powerupReady': '强化已就绪！',
  'yumi.banner.powerupSpawn': '神秘强化出现了！',
  'yumi.powerup.invuln.name': '无敌',
  'yumi.powerup.stealth.name': '帷影步',
  'yumi.powerup.endless_mana.name': '无尽法力',
  'yumi.powerup.berserk.name': '战争狂热',
  'yumi.grab.channeling': '拾取中… {s}秒',
  'yumi.grab.aria': '正在拾取神秘强化',
