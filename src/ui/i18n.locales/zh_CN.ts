...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.errors.tradeBusy': '该玩家已在进行其他交易。',
  'hud.errors.tradeUsage': '与谁交易？用法：/trade <名字>。',
  'hud.errors.claudiumTradeOff': 'Claudium 交易当前不可用。',
  'hud.errors.wocTradeOff': 'WOC 交易当前不可用。',
  'hud.errors.wocTradeLink': '请先绑定钱包才能交易 WOC。',
  'hud.errors.wocTradePartnerLink': '你的交易对象尚未绑定钱包。',
  'hud.errors.wocTradeOneSide': '一次交易只能由一方提供 WOC。',
  'hud.errors.tradeSettleTimeout': '交易已取消：付款等待超时，你的物品已退还。',
  'hud.errors.tradeSettleCancelled': '交易已取消，你的物品已退还。',
  'hud.errors.tradeSettleUnavailable': '交易无法结算，你的物品已退还。',
  ...
  'hud.logs.tradeDeclined': '{name} 拒绝了你的交易请求。',
  ...
  'hud.trade.cancel': '取消',
  'hud.trade.settlingTitle': '交易结算中…',
  'hud.trade.legYourWoc': '你的 WOC 付款',
  'hud.trade.legTheirWoc': '对方的 WOC 付款',
  'hud.trade.statusPending': '进行中',
  'hud.trade.wocPayPrompt': '请从你已绑定的钱包发送 {amount} WOC 以完成交易。',
  'hud.trade.openInWallet': '在钱包中打开',
  'hud.trade.copyLink': '复制付款链接',
  'hud.trade.copiedLink': '付款链接已复制。',
  'hud.trade.instanceSignedBy': '签名者：{name}',
  'hud.trade.instanceUnique': '独特的副本',
  ...
  'itemUi.market.sortLabel': '排序',
  'itemUi.market.sortNewest': '最新',
  'itemUi.market.sortPrice': '价格',
  'itemUi.market.sortTimeLeft': '剩余时间',
  'itemUi.market.timeLeft': '剩余{time}',
  'itemUi.market.yourBidBadge': '你的出价',
  'itemUi.market.currentBidLabel': '出价：',
  'itemUi.market.noBidsYet': '暂无出价',
  'itemUi.market.minNextBid': '最低出价 {money}',
  'itemUi.market.buyoutLabel': '一口价 {money}',
  'itemUi.market.auctionBadge': '拍卖',
  'itemUi.market.leadingBid': '你正在领先',
  'itemUi.market.bidInputAria': '{item} 的出价金额',
  'itemUi.market.bidButton': '出价',
  'itemUi.market.bidAria': '对 {item} 出价',
  'itemUi.market.buyoutButton': '一口价购买',
  'itemUi.market.buyoutAria': '以 {price} 一口价购买 {item}',
  'itemUi.market.buyQuantityAria': '购买 {item} 的数量',
  'itemUi.market.listingTypeLabel': '上架类型',
  'itemUi.market.listingTypeFixed': '一口价',
  'itemUi.market.listingTypeAuction': '拍卖',
  'itemUi.market.durationLabel': '持续时间',
  'itemUi.market.durationOption': '{hours}小时',
  'itemUi.market.startingBidLabel': '起拍价',
  'itemUi.market.buyoutOptionalLabel': '一口价（可选）',
  'itemUi.market.totalLabel': '总计',
  'itemUi.market.depositPreviewLabel': '上架押金',
  'itemUi.market.cancelConfirmTitle': '取回上架物品',
  'itemUi.market.cancelConfirmBody': '从市场取回 {item}？押金 {money} 将被没收。',
  'itemUi.market.cancelConfirmBodyNoDeposit': '从市场取回 {item}？',
  'itemUi.market.cancelConfirmDismiss': '取消',
  'itemUi.market.outbidToast': '你在 {item} 的出价被超过了。{money} 已退还至你的领取箱。',
  ...
  'itemUi.errors.minStartingBid': '起拍价至少为 1 铜币。',
  'itemUi.errors.buyoutTooLow': '一口价必须高于起拍价。',
  'itemUi.errors.chooseDuration': '请选择 12、24 或 48 小时的上架时长。',
  'itemUi.errors.cannotAffordDeposit': '你无法支付上架押金。',
  'itemUi.errors.bidsOnly': '该拍品仅接受出价。',
  'itemUi.errors.notAuction': '该拍品并非拍卖品。',
  ...
  'guide.economy.marketBrowse':
    '浏览：翻看列表或按名称搜索，找到正在出售的商品。每条挂单都会显示货物、卖家、剩余时间，以及可分批购买的整组货物单价，或是拍卖品的当前出价。',
  ...
  'entities.letters.market_outbid.sender': '商人',
  'entities.letters.market_outbid.subject': '你的出价被超过了',
  'entities.letters.market_outbid.body':
    '另一位买家提高了你所竞拍的一件拍品的出价。你的铜币正等在世界市场的领取箱中；来找我取回，或者重新出价。\n\n- 商人',
  'entities.letters.market_won.sender': '商人',
  'entities.letters.market_won.subject': '你的中标拍品',
  'entities.letters.market_won.body':
    '拍卖槌落下，这件拍品归你所有了。你的货物正等在世界市场的领取箱中；来找我领取吧。\n\n- 商人',
  'entities.letters.market_sold.sender': '商人',
  'entities.letters.market_sold.subject': '你的拍品已售出',
  'entities.letters.market_sold.body':
    '有买家买走了你的货物。你的收益正等在世界市场的领取箱中；来找我领取吧。\n\n- 商人',
  'entities.letters.market_expired.sender': '商人',
  ...
  'entities.letters.trade_delivery.body':
    '你交易所得的货品已经送达。渡鸦帮你捎来了背包装不下的东西。',
  'entities.letters.trade_refund.sender': '渡鸦邮驿',
  'entities.letters.trade_refund.subject': '交易物品已退还',
  'entities.letters.trade_refund.body': '交易未能完成。你提供的一切已经退还给你。',
