...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.close': '关闭挑战之门窗口',
  'hudChrome.hc.zoneName': '霍德里克城堡',
  'hudChrome.hc.offlineNote': '挑战之门尚未同步,请稍候。',
  'hudChrome.hc.joinQueue': '加入试炼',
  'hudChrome.hc.leaveQueue': '离开队列',
  'hudChrome.hc.queuedAt': '排队中,位置 {position}。凑满十人即开赛。',
  'hudChrome.hc.inMatchNote': '比赛进行中,全力冲刺!',
  'hudChrome.hc.practice': '与试炼骑士练习',
  'hudChrome.hc.practiceNote': '挑战霍德里克领主的骑士团:九名对手,无需等待。',
  'hudChrome.hc.record': '夺冠 {wins} / 参赛 {races}',
  'hudChrome.hc.bestTime': '最佳成绩 {seconds}秒',
  'hudChrome.hc.bestNone': '尚无完赛纪录',
  'hudChrome.hc.rank': '排名 {rank} / {total}',
  'hudChrome.hc.finishPlace': '完赛第 {place} 名',
  'hudChrome.hc.overWon': '王冠归你所有!',
  'hudChrome.hc.overPlaced': '比赛结束:第 {place} 名',
  'hudChrome.hc.howto':
    '三个回合,十名选手,一顶王冠。霍德里克大人每回合都会重建他的闯关赛道:每次挺过淘汰(六人晋级,再三人),赢下决赛。跌落只损失时间。',
  'hudChrome.hc.round': '回合 {round}/{rounds}',
  'hudChrome.hc.advance': '{count}人晋级',
  'hudChrome.hc.spectating': '正在看台观战',
  'hudChrome.hc.intermissionRebuild': '霍德里克大人正在重建赛道!',
  'hudChrome.hc.intermissionQualified': '晋级成功,下一回合即将开始。',
  'hudChrome.hc.intermissionEliminated': '被淘汰了!请欣赏看台风景。',
  'hudChrome.hc.section.hammer_bridge': '铁锤桥',
  'hudChrome.hc.section.rotor_court': '旋木庭院',
  'hudChrome.hc.section.boulder_climb': '滚石坡',
  'hudChrome.hc.section.piston_ledge': '活塞窄道',
  'hudChrome.hc.section.spinner_court': '转盘广场',
  'hudChrome.hc.section.landing': '平台',
  'hudChrome.hc.banner.round': '第{round}回合!',
  'hudChrome.hc.banner.qualified': '晋级!',
  'hudChrome.hc.banner.eliminated': '淘汰',
  'hudChrome.hc.log.qualified': '你晋级下一回合。',
  'hudChrome.hc.log.eliminated': '在第{round}回合被淘汰。看台上有小吃。',
  'hudChrome.hc.flavor.rebuild': '霍德里克大人重建了赛道。新赛道,同一顶王冠!',
  'hudChrome.hc.section.start_yard': '起点广场',
  'hudChrome.hc.section.axe_walk': '巨斧回廊',
  'hudChrome.hc.section.drawspan': '升降吊桥',
  'hudChrome.hc.section.red_ascent': '赤红坡道',
  'hudChrome.hc.section.finish_keep': '终点主堡',
  'hudChrome.hc.banner.found': '试炼召唤而来!',
  'hudChrome.hc.banner.go': '出发!',
  'hudChrome.hc.banner.finish': '完赛第 {place} 名!',
  'hudChrome.hc.banner.crown': '你夺得了霍德里克的王冠!',
  'hudChrome.hc.log.queued': '你加入试炼队列(位置 {position})。',
  'hudChrome.hc.log.unqueued': '你离开了试炼队列。',
  'hudChrome.hc.log.fall': '深渊吞没了你,返回检查点。',
  'hudChrome.hc.log.checkpoint': '已通过检查点 {index}。',
  'hudChrome.hc.log.placed': '你以第 {place} 名完成试炼。',
  'hudChrome.hub.enter': '你穿过闪烁的传送门，进入试炼场。',
  'hudChrome.hub.leave': '你回到了东溪谷。',
  'hudChrome.hub.zoneName': '试炼藏书阁',
  'hudChrome.hc.flavor.queueJoin': '你加入试炼队列。霍德里克领主为你上油链锤,以示敬意。',
  'hudChrome.hc.flavor.gatesOpen': '霍德里克城堡的大门缓缓开启,冲向王冠吧!',
  'hudChrome.hc.flavor.go': '出发!试炼之门已开!',
  'hudChrome.hc.err.legsOnly': '试炼中只能靠双腿:禁止使用技能。',
  'hudChrome.hc.err.inMatch': '你已经在参加试炼了。',
  'hudChrome.hc.err.dead': '死亡状态下无法加入试炼队列。',
  'hudChrome.hc.err.arenaConflict': '请先离开竞技场再参加试炼。',
  ...
  'entities.npcs.hodrics_herald.name': '传令官奥斯里克',
  'entities.npcs.hodrics_herald.title': '霍德里克试炼传令官',
  'entities.npcs.hodrics_herald.greeting':
    '霍德里克领主向所有来客敞开通道!参加试炼,躲开链锤,夺得王冠!',
  ...
  'guide.hodricsCastlePage.intro':
    '霍德里克领主向任何挑战者敞开城堡通道。冲过他旧日防线的试炼,夺得王冠,不论你是谁,不论你的等级如何。',
  'guide.hodricsCastlePage.heraldHeading': '传令官',
  'guide.hodricsCastlePage.heraldBody':
    '前往伊斯特布鲁克边缘找传令官奥斯里克,加入试炼队列。凑满十名挑战者(真实玩家与霍德里克宫廷的骑士皆可)即开赛,所以比赛总是很快开始。',
  'guide.hodricsCastlePage.courseHeading': '三个回合,一顶王冠',
  'guide.hodricsCastlePage.courseBody':
    '闯关赛是一场淘汰秀:十名选手开跑,六人挺过首轮,三人进入决赛,一人加冕。霍德里克大人每回合都会重建赛道,所以没有两场相同的比赛:铁锤桥、旋木庭院、斧刃回廊、滑动吊桥、滚石坡、活塞窄道、旋转平台,顺序全凭大人当天的兴致。每个机关都按自己固定的发条节奏摆动、旋转、滚动,绝无随机,细心的眼睛总能找到安全的空当。',
  'guide.hodricsCastlePage.fairnessHeading': '只靠双腿',
  'guide.hodricsCastlePage.fairnessBody':
    '这里没人施法:整场比赛禁止使用技能,每位选手速度相同。试炼胜负只看胆识与时机,与装备或等级无关。',
  'guide.hodricsCastlePage.fallsHeading': '摔落只耽误时间,不会丧命',
  'guide.hodricsCastlePage.fallsBody':
    '被机关击中或跌入深渊,只会把你送回上一个检查点。堤道上没有人会死:跌落的唯一代价是追赶的那几秒。回合结束被淘汰的选手会被气派地抛上看台包厢,在那里就着小吃看完剩下的比赛。',
  'guide.hodricsCastlePage.standingsHeading': '王冠',
  'guide.hodricsCastlePage.standingsBody':
    '决赛回合率先冲线者赢得本场霍德里克王冠。你的出场数、夺冠数和决赛最佳成绩,每次排队都在累积。',
  ...
  'hudChrome.gauntlet.title': '试炼回廊',
  'hudChrome.gauntlet.passed': '通过!',
  'hudChrome.gauntlet.boardTitle': '排名',
  'hudChrome.gauntlet.pitch': '熬过每一场试炼,笑到最后的人独得奖金。',
  'hudChrome.gauntlet.join': '加入试炼回廊',
  'hudChrome.gauntlet.withdraw': '退出',
  'hudChrome.gauntlet.joinQueue': '加入队列',
  'hudChrome.gauntlet.leaveQueue': '离开队列',
  'hudChrome.gauntlet.queuePosition': '队列位置：{n}',
  'hudChrome.gauntlet.spectate': '观战',
  'hudChrome.gauntlet.stopSpectating': '停止观战',
  'hudChrome.gauntlet.practice': '练习',
  ...
  'hudChrome.gauntlet.phaseLobby': '召集挑战者',
  'hudChrome.gauntlet.phaseStaging': '各就各位',
  'hudChrome.gauntlet.phaseTrial': '横渡开始',
  'hudChrome.gauntlet.phaseTrialSigils': '蚀刻开始',
  'hudChrome.gauntlet.phaseTrialPull': '握紧长绳',
  'hudChrome.gauntlet.phaseTrialEcho': '看守人的回响开始',
  'hudChrome.gauntlet.phaseTrialSpan': '踏上脆桥',
  'hudChrome.gauntlet.phaseTrialCourt': '终局之场',
  'hudChrome.gauntlet.phaseInterlude': '试炼通过',
  'hudChrome.gauntlet.phasePodium': '试炼回廊已定胜负',
  'hudChrome.gauntlet.greenLight': '绿灯!',
  'hudChrome.gauntlet.redLight': '红灯!',
  'hudChrome.gauntlet.vitalityLost': '你失去了 {amount} 点生命力。',
  'hudChrome.gauntlet.survivorsLeft': '还有 {count} 人存活',
  'hudChrome.gauntlet.spectating': '观战中',
  'hudChrome.gauntlet.leave': '离开',
  'hudChrome.gauntlet.victory': '胜利',
  'hudChrome.gauntlet.podiumTitle': '最终排名',
  ...
  'hudChrome.gauntlet.hint.court': '与对手决斗:抵达尽头的王冠,或将其推出场外。角色会定时轮换。',
  ...
  'entities.npcs.gauntlet_watcher.title': '横渡守护者',
  'entities.npcs.gauntlet_watcher.greeting': '守望者从不眨眼。',
  'entities.npcs.gauntlet_contestant.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant.title': '参赛者',
  'entities.npcs.gauntlet_contestant.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_warrior.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_warrior.title': '参赛者',
  'entities.npcs.gauntlet_contestant_warrior.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_paladin.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_paladin.title': '参赛者',
  'entities.npcs.gauntlet_contestant_paladin.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_hunter.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_hunter.title': '参赛者',
  'entities.npcs.gauntlet_contestant_hunter.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_rogue.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_rogue.title': '参赛者',
  'entities.npcs.gauntlet_contestant_rogue.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_priest.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_priest.title': '参赛者',
  'entities.npcs.gauntlet_contestant_priest.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_mage.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_mage.title': '参赛者',
  'entities.npcs.gauntlet_contestant_mage.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_warlock.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_warlock.title': '参赛者',
  'entities.npcs.gauntlet_contestant_warlock.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_shaman.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_shaman.title': '参赛者',
  'entities.npcs.gauntlet_contestant_shaman.greeting': '目视前方。守望者正盯着你。',
  'entities.npcs.gauntlet_contestant_druid.name': '试炼参赛者',
  'entities.npcs.gauntlet_contestant_druid.title': '参赛者',
  'entities.npcs.gauntlet_contestant_druid.greeting': '目视前方。守望者正盯着你。',
