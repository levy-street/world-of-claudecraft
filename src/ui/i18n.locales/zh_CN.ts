...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  'editor.vfx.raid': '团队副本练习（不会死亡）',
  'editor.vfx.title': '特效工作室',
  'editor.vfx.library': '技能库',
  'editor.vfx.inspector': '特效检查器',
  'editor.vfx.search': '搜索技能',
  'editor.vfx.class': '职业',
  'editor.vfx.scene': '战斗场景',
  'editor.vfx.sandbox': '训练小队',
  'editor.vfx.duel': '玩家对决',
  'editor.vfx.loading': '正在准备游戏世界...',
  'editor.vfx.ready': '游戏引擎运行中',
  'editor.vfx.failed': '工作室无法启动。请重新加载。',
  'editor.vfx.cast': '施放技能',
  'editor.vfx.target': '目标',
  'editor.vfx.pause': '冻结',
  'editor.vfx.resume': '继续',
  'editor.vfx.step': '单步',
  'editor.vfx.reset': '重置场景',
  'editor.vfx.replay': '重放指令',
  'editor.vfx.recover': '恢复资源',
  'editor.vfx.move': '奔跑',
  'editor.vfx.stop': '停止',
  'editor.vfx.speed': '播放速度',
  'editor.vfx.audio': '世界音效',
  'editor.vfx.tint': '主体颜色',
  'editor.vfx.accent': '点缀颜色',
  'editor.vfx.power': '强度',
  'editor.vfx.sparks': '火花',
  'editor.vfx.apply': '应用草稿',
  'editor.vfx.original': '使用原版',
  'editor.vfx.export': '导出草稿',
  'editor.vfx.import': '导入草稿',
  'editor.vfx.exportTake': '导出会话',
  'editor.vfx.invalid': '草稿无效或包含不支持的技能。',
  'editor.vfx.applied': '草稿已应用',
  'editor.vfx.noSpec': '此技能使用独立特效系统。',
  'editor.vfx.castTime': '施法时间',
  'editor.vfx.cooldown': '冷却时间',
  'editor.vfx.seconds': '{value} 秒',
  'editor.vfx.timeline': '战斗时间线',
  'editor.vfx.empty': '施放技能以开始录制。',
  'editor.vfx.current': '时间：{value} 秒',
  'editor.vfx.events': '{count} 个事件',
  'editor.vfx.controls': '镜头控制',
  'editor.vfx.orbitLeft': '向左环绕',
  'editor.vfx.orbitRight': '向右环绕',
  'editor.vfx.closer': '拉近',
  'editor.vfx.farther': '拉远',
  'editor.vfx.hide': '隐藏面板',
  'editor.vfx.show': '显示面板',
  'editor.vfx.status': '生效中的效果',
  'editor.vfx.help': '拖动场景旋转镜头，滚动缩放。冻结会保留当前画面。',
  'editor.vfx.note': '施法遵循正常战斗规则。重放会重复指令，装饰性随机效果可能不同。',
  'editor.vfx.castFailed': '施法被拒绝。请检查目标、距离、资源和冷却时间。',
  'editor.vfx.draftNote': '更改仅保留在本次会话中，请导出以保存。',
  'editor.vfx.snapshot': '截取画面',
  ...
  'editor.vfx.artView': '效果展示模式',
  'editor.vfx.exitArtView': '退出展示模式',
  'editor.vfx.previous': '上一个技能',
  'editor.vfx.next': '下一个技能',
  'editor.vfx.repeat': '重复施放',
  'editor.vfx.favourite': '加入收藏',
  'editor.vfx.unfavourite': '取消收藏',
  'editor.vfx.favourites': '仅显示收藏',
  'editor.vfx.saved': '已保存',
  'editor.vfx.updating': '正在更新预览...',
  'editor.vfx.shortcuts':
    'Space：施放。[ / ]：上一个 / 下一个技能。R：重复施放。F：收藏。A：展示模式。',
  'editor.vfx.buildTools': '天赋、场景与灯光',
  'editor.vfx.noTalent': '未选择天赋',
  'editor.vfx.talentLevel': '等级 {level}',
  'editor.vfx.seed': '场景种子',
  'editor.vfx.graphics': '画面质量',
  'editor.vfx.environment': '预览环境',
  'editor.vfx.studioEnvironment': '工作室舞台',
  'editor.vfx.worldEnvironment': '世界场景',
  'editor.vfx.lighting': '舞台灯光',
  'editor.vfx.neutralLighting': '中性',
  'editor.vfx.brightLighting': '明亮',
  'editor.vfx.savedGraphics': '使用游戏设置',
  'editor.vfx.medium': '中等',
  'editor.vfx.ultra': '极高',
  'editor.vfx.cinematic': '电影级（最高细节）',
  'editor.vfx.reduceMotion': '减少动态效果',
  'editor.vfx.cinematicResponse': '电影感镜头反馈',
  'editor.vfx.darkLighting': '暗调',
  'editor.vfx.low': '低',
  'editor.vfx.high': '高',
};
