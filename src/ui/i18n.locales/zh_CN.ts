...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.governance.disabled': '治理投票当前不可用。',
  'apiError.governance.forbidden': '你没有创建提案的权限。',
  'apiError.governance.not_found': '找不到该提案。',
  'apiError.governance.invalid_input': '请检查提案字段后重试。',
  'apiError.governance.wallet_not_linked': '投票前请先关联钱包。',
  'apiError.governance.wallet_mismatch': '该钱包未关联到你的账户。',
  'apiError.governance.window_closed': '该提案的投票已结束。',
  'apiError.governance.already_voted': '此钱包已对该提案投过票。',
  'apiError.governance.challenge_invalid': '该投票请求已过期，请重试。',
  'apiError.governance.bad_signature': '无法验证钱包签名。',
  'apiError.governance.balance_unavailable': '无法读取你的 $WOC 余额，请重试。',
  ...
  'hudChrome.governance.title': '治理',
  'hudChrome.governance.close': '关闭治理',
  'hudChrome.governance.subtitle': '$WOC 持有者咨询投票',
  'hudChrome.governance.loading': '正在加载提案……',
  'hudChrome.governance.error': '无法加载治理提案。',
  'hudChrome.governance.empty': '暂时没有提案。',
  'hudChrome.governance.refresh': '刷新',
  'hudChrome.governance.open': '进行中',
  'hudChrome.governance.closed': '已结束',
  'hudChrome.governance.closesAt': '{date} 结束',
  'hudChrome.governance.closedAt': '{date} 已结束',
  'hudChrome.governance.quorum': '法定票数：{needed} $WOC 中的 {current}',
  'hudChrome.governance.quorumReached': '已达到法定票数',
  'hudChrome.governance.category.content': '内容',
  'hudChrome.governance.category.cosmetic': '外观',
  'hudChrome.governance.category.treasury': '资金',
  'hudChrome.governance.tally.for': '赞成',
  'hudChrome.governance.tally.against': '反对',
  'hudChrome.governance.tally.abstain': '弃权',
  'hudChrome.governance.tally.voters': '{count} 名投票者',
  'hudChrome.governance.vote.for': '投赞成票',
  'hudChrome.governance.vote.against': '投反对票',
  'hudChrome.governance.vote.abstain': '弃权',
  'hudChrome.governance.vote.needWallet': '关联钱包后即可投票。',
  'hudChrome.governance.vote.alreadyVoted': '你已投票：{choice}',
  'hudChrome.governance.vote.signing': '请在钱包中签名……',
  'hudChrome.governance.vote.submitting': '正在提交投票……',
  'hudChrome.governance.vote.success': '你的投票已记录。',
  'hudChrome.governance.vote.failed': '无法记录你的投票。',
