...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.pokerPlaytest.title': '扑克',
  'hudChrome.pokerPlaytest.close': '关闭扑克',
  'hudChrome.pokerPlaytest.reconnecting': '正在重新连接扑克服务器...',
  'hudChrome.pokerPlaytest.disabled': '扑克当前不可用。',
  'hudChrome.pokerPlaytest.tables': '牌桌',
  'hudChrome.pokerPlaytest.refresh': '刷新',
  'hudChrome.pokerPlaytest.noTables': '没有可用的扑克牌桌。',
  'hudChrome.pokerPlaytest.join': '加入',
  'hudChrome.pokerPlaytest.watch': '观战',
  'hudChrome.pokerPlaytest.stopWatching': '停止观战',
  'hudChrome.pokerPlaytest.rebuy': '补充筹码',
  'hudChrome.pokerPlaytest.leave': '离桌',
  'hudChrome.pokerPlaytest.chooseSeat': '选择座位',
  'hudChrome.pokerPlaytest.seat': '座位 {seat}',
  'hudChrome.pokerPlaytest.seated': '{count}人已入座',
  'hudChrome.pokerPlaytest.watchers': '{count}人观战',
  'hudChrome.pokerPlaytest.watching': '观战中',
  'hudChrome.pokerPlaytest.tableFull': '已满座',
  'hudChrome.pokerPlaytest.inHand': '牌局进行中',
  'hudChrome.pokerPlaytest.betweenHands': '牌局间歇',
  'hudChrome.pokerPlaytest.unknownPlayer': '玩家',
  'hudChrome.pokerPlaytest.waiting': '等待下一局',
  'hudChrome.pokerPlaytest.playerTurn': '{name}正在行动',
  'hudChrome.pokerPlaytest.timeRemaining': '剩余{seconds}秒',
  'hudChrome.pokerPlaytest.wagerAmount': '{action}金额',
  'hudChrome.pokerPlaytest.rake': '抽水: {amount}',
  'hudChrome.pokerPlaytest.error.busy': '牌桌正在处理。请重试。',
  'hudChrome.pokerPlaytest.error.disabled': '扑克当前不可用。',
  'hudChrome.pokerPlaytest.error.invalid_action': '该操作不合法。',
  'hudChrome.pokerPlaytest.error.insufficient_funds': '加入或重新买入需要更多铜币。',
  'hudChrome.pokerPlaytest.error.participation_suspended': '此账号的扑克参与权限已被暂停。',
  'hudChrome.pokerPlaytest.error.invalidAmount': '请输入允许范围内的整数。',
  'hudChrome.pokerPlaytest.error.rebuy_not_allowed': '当前无法补充筹码。',
  'hudChrome.pokerPlaytest.error.seat_conflict': '该座位已被占用。',
  'hudChrome.pokerPlaytest.error.stale_action': '操作到达前牌局已发生变化。',
  'hudChrome.pokerPlaytest.error.table_not_found': '该扑克牌桌已不存在。',
  'hudChrome.pokerPlaytest.error.watch_conflict': '观战其他牌桌前请先离开当前牌桌。',
  'hudChrome.pokerPlaytest.chips': '{amount}筹码',
  'hudChrome.pokerPlaytest.pot': '底池: {amount}',
  'hudChrome.pokerPlaytest.noCards': '无牌',
  'hudChrome.pokerPlaytest.emptySeat': '空座',
  'hudChrome.pokerPlaytest.dealerButton': '庄家按钮',
  'hudChrome.pokerPlaytest.dealerMarker': 'D',
  'hudChrome.pokerPlaytest.smallBlind': '小盲注',
  'hudChrome.pokerPlaytest.smallBlindMarker': 'SB',
  'hudChrome.pokerPlaytest.bigBlind': '大盲注',
  'hudChrome.pokerPlaytest.bigBlindMarker': 'BB',
  'hudChrome.pokerPlaytest.yourTurn': '轮到你了',
  'hudChrome.pokerPlaytest.winner': '{name}赢得{amount}',
  'hudChrome.pokerPlaytest.winnerWithHand': '{name}以{hand}赢得{amount}',
  'hudChrome.pokerPlaytest.highlightedHand': '{name}: {hand}',
  'hudChrome.pokerPlaytest.hand.highCard': '高牌',
  'hudChrome.pokerPlaytest.hand.pair': '一对',
  'hudChrome.pokerPlaytest.hand.twoPair': '两对',
  'hudChrome.pokerPlaytest.hand.threeOfAKind': '三条',
  'hudChrome.pokerPlaytest.hand.straight': '顺子',
  'hudChrome.pokerPlaytest.hand.flush': '同花',
  'hudChrome.pokerPlaytest.hand.fullHouse': '葫芦',
  'hudChrome.pokerPlaytest.hand.fourOfAKind': '四条',
  'hudChrome.pokerPlaytest.hand.straightFlush': '同花顺',
  'hudChrome.pokerPlaytest.actionWithAmount': '{action} {amount}',
  'hudChrome.pokerPlaytest.action.fold': '弃牌',
  'hudChrome.pokerPlaytest.action.check': '过牌',
  'hudChrome.pokerPlaytest.action.call': '跟注',
  'hudChrome.pokerPlaytest.action.bet': '下注',
  'hudChrome.pokerPlaytest.action.raise': '加注',
  'hudChrome.pokerPlaytest.action.all-in': '全下',
  'hudChrome.pokerPlaytest.street.preflop': '翻牌前',
  'hudChrome.pokerPlaytest.street.flop': '翻牌',
  'hudChrome.pokerPlaytest.street.turn': '转牌',
  'hudChrome.pokerPlaytest.street.river': '河牌',
