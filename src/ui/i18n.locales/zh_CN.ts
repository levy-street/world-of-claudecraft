...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.toolsNoteFiveLadders':
    '每处资源点都需要对应行业的工具放在背包里，第 1 级也不例外：没有镐就采不到矿，没有鱼竿就钓不到鱼。商人阶梯覆盖第 1 到 3 级，分布在三处腹地枢纽：第 1 级工具三处都有售，更高的等级则在用得上它们的地形开始的地方出售（Fenbridge 增设第 2 级，Highwatch 增设第 3 级），而它们之外更年轻的聚落根本不备任何工具，所以出发前先备齐。耕作则另有买处：它的第 1 级锄头由打理第一处份地的农夫备货，而非任何枢纽，而它之上的任何一级锄头在任何地方都不用金币出售。每个柜台对自己备货的每一级都自由出售，任何工具也都能通过面对面交易转手；除了三件 20 铜的陆上入门工具之外，每一级还能在市场上架并通过邮件寄送：那三件只能在柜台购买或手手相传，永远不能卖回、寄送或上架。受限制的是使用。第 1 级以上的陆上工具，只有当你在该行业中的熟练度挣到它之后才能使用，第 2 级需要 {tier2Prof}，第 3 级需要 {tier3Prof}，第 4 级需要 85，第 5 级需要 100，而商品行、鼠标提示和下方的表格都会预先注明该要求。在那之前，提前买下的工具只会在背包里等着，不开放任何地形，不带来任何速度，也不产出任何精制品级，等你的计数触到那个数字，它便立刻可用。鱼竿是唯一的例外：没有任何鱼竿带有使用要求，而Eastbrook的Trader Wilkes特意备着第 2 级和第 3 级鱼竿，供提前购买的钓手选购。工具从不占用装备栏，也不会磨损，因此每件都是一次性购买。只有等级会影响限制：同等级中更稀有的工具并不会多开放任何东西。不过稀有度并不只是颜色，它会让镶嵌的工具效果持续更久，装在鱼竿上还会加宽收线时机。\n\n更好的工具带来三样东西，而不是两样。它开放更高等级的地形，缩短采集时间，还会提升产出：用等级高于该区域自身材料的工具开采矿脉，收获的将是精制品级而非普通品级。该矿脉必须是这个区域的完整品级矿脉，因此区域为旅行者保留的简易矿脉依然产出普通材料。精制材料正是制作工具配方所消耗的东西，而且在任何配方或工单要求普通版本的地方，精制品级都可以顶替，所以升级永远不会让你陷入困境：只是你的铜矿石会以精制铜矿石的形式到手。\n\n在商人阶梯之上，三个资源点行业各有两件制作工具，第 4 级和第 5 级，在工具工坊制作（每个角色都会这两份配方，为这类工作攀升的技能是工程学），或在满足溺亡连祷的通关条件后，在其柜台用秘境印记购买：下方的表格列出了印记价格以及每一级所要求的通关次数。任何商人都不会用金币出售它们。耕作的阶梯是最长的一条：20 铜的入门锄头之上的每一把锄头都是制作而成，第 2 级到第 5 级，这四件全都由工具匠传授，而非一开始就会，而最高的两级也在同一个印记柜台备货。钓鱼有自己的三件，而它们同样是学来的而非一开始就会：工具匠教授第 4 级的Stormreel和第 5 级的Tidewrought，第 6 级的Clockreel则改由图纸打造。鱼竿是唯一一条最高几级在水上买到准入资格的阶梯：这三件中的每一件都会开放一个仅凭技能永远无法抵达的渔获区间，因此更好的鱼竿买到的不是舒适。对三个资源点行业而言，目前没有任何资源点需要超过第 3 级，因此它们的第 4 级和第 5 级工具买到的依然是速度和品级而非准入资格，等更高等级的地形出现时，它们将成为入场券。耕作则介于两者之间：需要锄头的是种植，因此第 N 级的田畦要求第 N 级的锄头，一直到第 4 级也就是最后一级作物为止，只有第 5 级锄头不再开放任何新地。',
