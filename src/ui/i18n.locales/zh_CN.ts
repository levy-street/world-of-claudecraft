...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'landing.heroEyebrow': '世界早已开始运转',
  'landing.heroHeading': '一个鲜活的经典 MMO，玩家与 AI 冒险者共同面对同一世界。',
  'landing.heroBody': '在浏览器中免费游玩，从九大职业中塑造英雄，或让智能体在真实游戏中训练。',
  'landing.heroStatus': '世界在线',
  'landing.heroPlayers': '名已注册冒险者',
  'landing.communityLinks': '社区链接',
  'landing.followSocials': '关注我们的社交媒体',
  'landing.socialDiscord': 'Discord 社区',
  'landing.socialTwitch': 'Twitch 直播',
  'landing.socialInstagram': 'Instagram 官方账号',
  'landing.socialReddit': 'Reddit 社区',
  'landing.browserCta': '在浏览器中游玩',
  'landing.playNowBody': '打开浏览器即可畅玩，无需下载。',
  'landing.playWayBody': '选择你的平台，加入这场冒险。',
  'landing.syncProgress': '在所有平台间同步游戏进度',
  'landing.explore': '探索这个世界',
  'landing.platformsEyebrow': '随时随地踏上冒险',
  'landing.appStoreAria': '在 App Store 下载 World of ClaudeCraft',
  'landing.googlePlayAria': '在 Google Play 获取 World of ClaudeCraft',
  'landing.steamAria': 'World of ClaudeCraft 即将登陆 Steam',
  'landing.comingSoon': '即将推出',
  'landing.introEyebrow': '同一个世界，同一套规则',
  'landing.introHeading': '每位冒险者都在真实游戏中战斗。',
  'landing.introBody':
    '浏览器 MMO、权威在线世界和 AI 训练都运行于同一个确定性模拟中。玩家与智能体面对相同的战斗、任务、地下城和后果。',
  'landing.statClasses': '9 个可玩职业',
  'landing.statModes': '在线与离线世界',
  'landing.statBroadcast': '全天候 AI 直播',
  'landing.statSource': '开源',
  'landing.worldEyebrow': '穿越 Claudemoon',
  'landing.worldHeading': '一个为漫漫长路与危机四伏的夜晚而生的世界。',
  'landing.worldBody':
    '从 Eastbrook Vale 的篝火旁启程，深入闹鬼的地穴，再攀上 Thornpeak 的风暴之巅。每条道路都通往这个不断运转的世界深处。',
  'landing.eastbrookTitle': '东溪谷',
  'landing.eastbrookBody': '一片共享的边境，初次任务、游荡敌人与意外盟友都在此相遇。',
  'landing.eastbrookAlt': '冒险者队伍沿着从东溪谷通往荆棘峰高地的漫长道路前行',
  'landing.hollowTitle': 'Hollow Crypt',
  'landing.hollowBody': '在冰冷的蓝色火炬下并肩作战，不安的亡者正成群聚集。',
  'landing.hollowAlt': '一支队伍在 Hollow Crypt 中迎战敌人',
  'landing.thornpeakTitle': '荆棘峰高地',
  'landing.thornpeakBody': '云层之上，白雪、古老废墟与终局威胁正在等待。',
  'landing.thornpeakAlt': '雪花飘落在 Thornpeak Heights',
  'landing.classesEyebrow': '选择你的传奇',
  'landing.classesHeading': '九种道路，无数战斗方式。',
  'landing.classesBody':
    '坚守盾墙，驾驭烈焰与寒霜，潜行于阴影，或守护队友。塑造英雄，精通专精，并把这段故事带入共享世界。',
  'landing.streamEyebrow': '全天候直播',
  'landing.streamNetwork': 'WOC 直播网络',
  'landing.streamFeed': 'YUUMIII // 直播画面',
  'landing.streamMonogram': 'Y',
  'landing.streamHeading': 'Yuumiii 永不下线。',
  'landing.streamBody': 'World of ClaudeCraft 的常驻 AI 主播全天候直播游玩这个世界。',
  'landing.streamWatch': '在 Twitch 观看',
  'landing.streamLoading': '正在开启观景传送门...',
  'landing.streamReady': '观景传送门已就绪。按下播放即可观看 Yuumiii。',
  'landing.streamOnline': 'Yuumiii 正在直播。',
  'landing.streamOffline': '观景传送门正在重新连接。打开 Twitch 频道即可继续观看。',
  'landing.streamCompact': '打开 Twitch 频道，在此屏幕上观看 Yuumiii。',
  'landing.streamUnavailable': '观景传送门暂不可用。打开 Twitch 频道即可继续观看。',
  'landing.openEyebrow': '开放世界，开放代码',
  'landing.openHeading': '复刻这个世界，训练一名冒险者。',
  'landing.openBody':
    '探索源代码，托管自己的世界，或将兼容 Gymnasium 的智能体接入玩家每天进入的同一个确定性游戏。',
  'landing.supportEyebrow': '让这个世界继续运转',
  'landing.supportHeading': '创造、游玩，并支持下一篇章。',
  'landing.supportBody':
    'World of ClaudeCraft 在开放协作中成长。加入社区，关注鲜活世界，或支持持续开发。',
  'landing.xCta': '在 X 上关注',
  'landing.patchNotesLabel': '补丁说明',
  'landing.patchNotesTitle': '补丁说明',
  'landing.patchNotesDesc': '查看最新的玩法改动、问题修复和版本详情。',
  'landing.patchNotesLoading': '正在加载最新补丁说明…',
  'landing.patchNotesError': '无法加载补丁说明，请稍后再试。',
  'landing.patchNotesEmpty': '暂无补丁说明，请稍后再来查看。',
  'landing.patchNotesPrerelease': '预发布版',
  'landing.patchNotesViewOnGithub': '在 GitHub 上查看版本',
  'landing.newsEyebrow': '来自世界的消息',
  'landing.newsTitle': 'Claudemoon 新闻',
  'landing.newsBody': '关注 World of ClaudeCraft 的最新动态，探索这个世界背后的故事。',
  'landing.newsXTitle': 'X 最新动态',
  'landing.newsXIntro': '@WoClaudecraft 的官方帖子',
  'landing.newsXPrivacy': '加载此信息流将连接到 X，X 可能会收到有关您此次访问的信息。',
  'landing.newsXLoad': '加载 X 信息流',
  'landing.newsXRetry': '重试',
  'landing.newsXHide': '隐藏 X 信息流',
  'landing.newsXOpen': '在 X 上打开 @WoClaudecraft',
  'landing.newsXNewTab': '在新标签页中打开',
  'landing.newsXLoading': '正在打开 X 信息流…',
  'landing.newsXUnavailable': '无法加载 X 信息流。您仍可直接前往 X 查看所有帖子。',
  'landing.newsXIframeTitle': 'X 上 @WoClaudecraft 的最新帖子',
  'landing.newsBlogEyebrow': 'CLAUDEMOON 纪事',
  'landing.newsBlogTitle': '最新故事',
  'landing.newsBlogEmptyTitle': '第一篇故事正在撰写',
  'landing.newsBlogEmptyBody': '新闻和幕后故事即将发布在这里。',
  'landing.newsXOpenAria': '在新标签页中打开 X 上的 @WoClaudecraft',
  'landing.newsXLoaded': 'X 信息流已加载。',
  'landing.newsXHidden': 'X 信息流已隐藏。您仍可直接在 X 上打开该账号主页。',
  'landing.twitchCategoryCta': '探索 World of ClaudeCraft 直播',
  'landing.finalEyebrow': '你的故事始于大门',
  'landing.finalHeading': '选择你进入 Claudemoon 的方式。',
  'landing.finalBody': '立即在浏览器中游玩，在移动设备上继续冒险，或等待 Steam 版本。',
  ...
  'mode.onlineDesc': '在实时服务器上游玩。你的角色将在线保存。',
  'mode.onlineAria': '在线游玩：登录持久共享的联机世界',
  'mode.offlineTitle': '单机试玩',
  'mode.offlineDesc': '在浏览器中游玩本地离线世界。进度不会保存。',
  ...
  'mode.serverAria': '选择服务器模式：服务器在线或服务器离线',
  'mode.serverLabel': '选择你的世界',
  'mode.serverOffline': '服务器离线',
  'mode.serverOfflineSub': '本地离线世界',
  'mode.serverOnline': '服务器在线',
  ...
  'landing.streamWatchSub': '加入 Yuumiii 的直播',
  'landing.streamExplore': '探索世界',
  'landing.streamExploreSub': '发现克劳德之月',
  'landing.streamHeroSubtitle': '你的常驻 AI 主播，全天候探索这个世界。',
  'landing.streamMeet': '认识你的向导',
  'landing.streamHostTitle': '常驻 AI 主播',
  'landing.streamHostBody': '与 Yuumiii 一起昼夜探索 World of ClaudeCraft 的每一个角落。',
  'landing.streamPortraitAlt': 'World of ClaudeCraft 的常驻 AI 主播 Yuumiii',
  'landing.streamAlwaysTitle': '24/7 直播',
  'landing.streamAlwaysBody': '始终在线，永不停下冒险。',
  'landing.streamAiTitle': 'AI 主播',
  'landing.streamAiBody': '由 AI 驱动，带来真实反应和无尽乐趣。',
  'landing.streamCommunityTitle': '社区',
