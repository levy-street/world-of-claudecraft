...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  'hudChrome.finder.raidRewards': '尼瑟拉克西斯奖励预览',
  'hudChrome.finder.raidRarityLine': '稀有 {rare}% · 史诗 {epic}% · 传奇 {legendary}%',
  'hudChrome.finder.raidItemLevels': '物品等级：稀有 {rare} · 史诗 {epic} · 传奇 {legendary}',
  'hudChrome.finder.raidCurrenciesNormal': '每位参与者 +{fragments} 个不死碎片',
  'hudChrome.finder.raidCurrenciesHeroic':
    '每位参与者 +{fragments} 个不死碎片和 +{marks} 个英雄徽记',
  'hudChrome.finder.raidSignatures': '专属传奇威能：{signatures}',
  'heroicShop.tabsAria': '军需官服务',
  'heroicShop.fragmentBalance': '不死碎片：{count}',
  'heroicShop.tab.gear': '英雄装备',
  'heroicShop.tab.forge': '不死锻炉',
  'heroicShop.tab.tune': '传奇调校',
  'heroicShop.gearIntro': '使用英雄徽记购买军需官现有库存。',
  'heroicShop.tuneEmpty': '背包中没有可调校的尼瑟拉克西斯传奇物品。',
  'heroicShop.heroicClearReady': '已确认本次每日锁定周期内完成英雄难度尼瑟拉克西斯。',
  'heroicShop.heroicClearNeeded': '英雄目标需要在当前每日锁定周期内完成英雄难度尼瑟拉克西斯。',
  'heroicShop.itemLevel': '物品等级 {level}',
  'heroicShop.cost': '{fragments} 个不死碎片 · {marks} 个英雄徽记',
  'heroicShop.randomAffixes': '随机词缀和数值',
  'heroicShop.deterministicStats': '固定设计奖励',
  'heroicShop.raidForgedGuarantee': '团队锻造威能，保证上半区数值',
  'heroicShop.raidForged': '团队锻造',
  'heroicShop.raidDrop': '尼瑟拉克西斯团队传奇物品',
  'heroicShop.reforgeCount': '调校次数：{count}',
  'heroicShop.forgeKind.normal_procedural': '普通难度随机生成史诗',
  'heroicShop.forgeKind.heroic_procedural': '英雄难度随机生成史诗',
  'heroicShop.forgeKind.signature': '英雄难度专属传奇',
  'heroicShop.forgeKind.authored': '固定设计目标奖励',
  'heroicShop.blocked.class': '与你的职业不兼容',
  'heroicShop.blocked.heroic_clear': '需要当前英雄难度尼瑟拉克西斯通关',
  'heroicShop.blocked.fragments': '不死碎片不足',
  'heroicShop.blocked.marks': '英雄徽记不足',
  'heroicShop.forgeConfirmTitle': '确认锻造',
  'heroicShop.forgeConfirmBody':
    '要花费 {fragments} 个不死碎片和 {marks} 个英雄徽记锻造 {item} 吗？服务器会在验证付款后随机生成该物品。',
  'heroicShop.forgeConfirmAccept': '锻造',
  'heroicShop.tuneConfirmTitle': '确认传奇调校',
  'heroicShop.tuneConfirmAccept': '调校',
  'heroicShop.status.pending': '正在等待服务器……',
  'heroicShop.status.gear': '购买完成，余额已刷新。',
  'heroicShop.status.forge': '锻造完成，新奖励已放入背包。',
  'heroicShop.status.tune': '调校完成，指定物品和余额已刷新。',
  ...
  'heroicShop.tuneConfirmBody':
    '要花费{fragments}个不死碎片和{marks}个英雄徽记调校这件具体的{item}吗？系统会保留两次结果中较好的一次；威能不会降低，但可能保持不变。',
  ...
  'hudChrome.bags.itemAriaProcedural': '{item}，{rarity}，物品等级 {level}，数量 {count}',
  'hudChrome.bags.itemAriaProceduralMasterwork':
    '{item}，{rarity}，物品等级 {level}，数量 {count}，杰作',
  'hudChrome.bags.itemAriaProceduralEnchanted':
    '{item}，{rarity}，物品等级 {level}，数量 {count}，附魔副本',
  'hudChrome.bags.itemAriaProceduralSigned':
    '{item}，{rarity}，物品等级 {level}，数量 {count}，制作者签名副本',
  'hudChrome.bags.itemAriaProceduralBound':
    '{item}，{rarity}，物品等级 {level}，数量 {count}，绑定副本',
  'itemUi.stats.weaponMin': '最低武器伤害',
  'itemUi.stats.weaponMax': '最高武器伤害',
  'itemUi.stats.weaponDps': '武器每秒伤害',
  'itemUi.stats.healthOnKill': '击杀回复生命',
  'itemUi.stats.manaOnKill': '击杀回复法力',
  'itemUi.stats.blockValue': '格挡值',
  'itemUi.procedural.rollRangeAria': '可能的数值范围：{min} 至 {max}',
  'itemUi.procedural.advancedDetailsHint': '按住 {key} 显示可能的数值范围。',
  'itemUi.procedural.powerRollPercent': '威能数值：{value}%',
  'itemUi.procedural.powerRollMilliseconds': '威能数值：{value} 毫秒',
  'itemUi.procedural.powerRollResource': '威能数值：{value} 点资源',
  'itemUi.procedural.powerRollNumber': '威能数值：{value}',
  'itemUi.procedural.legendaryPower': '传奇威能',
  'itemUi.procedural.legendaryLimit': '唯一装备：{count} 个传奇威能',
  'itemUi.procedural.rarity.common': '普通',
  'itemUi.procedural.rarity.magic': '魔法',
  'itemUi.procedural.rarity.rare': '稀有',
  'itemUi.procedural.rarity.epic': '史诗',
  'itemUi.procedural.rarity.legendary': '传奇',
  'itemUi.procedural.rarity.mythic': '神话',
  'itemUi.procedural.nameFragment.mighty': '强力',
  'itemUi.procedural.nameFragment.deft': '灵巧',
  'itemUi.procedural.nameFragment.stalwart': '坚毅',
  'itemUi.procedural.nameFragment.sages': '贤者之',
  'itemUi.procedural.nameFragment.spiritual': '灵性',
  'itemUi.procedural.nameFragment.of_focus': '专注',
  'itemUi.procedural.nameFragment.of_striking': '猛击',
  'itemUi.procedural.nameFragment.of_alacrity': '迅捷',
  'itemUi.procedural.nameFragment.of_precision': '精准',
  'itemUi.procedural.nameFragment.warded': '守护',
  'itemUi.procedural.nameFragment.of_reaping': '收割',
  'itemUi.procedural.nameFragment.of_remembrance': '追忆',
  'itemUi.procedural.rareWord.ashen': '灰烬',
  'itemUi.procedural.rareWord.blackfen': '黑沼',
  'itemUi.procedural.rareWord.doom': '厄运',
  'itemUi.procedural.rareWord.grave': '墓冢',
  'itemUi.procedural.rareWord.mire': '泥沼',
  'itemUi.procedural.rareWord.storm': '风暴',
  'itemUi.procedural.rareWord.thorn': '荆棘',
  'itemUi.procedural.rareWord.wyrm': '巨龙',
  'itemUi.procedural.rareWord.bite': '噬痕',
  'itemUi.procedural.rareWord.brand': '烙印',
  'itemUi.procedural.rareWord.promise': '诺言',
  'itemUi.procedural.rareWord.thread': '丝缕',
  'itemUi.procedural.rareWord.vigil': '守望',
  'itemUi.procedural.rareWord.ward': '护符',
  'itemUi.procedural.rareWord.whisper': '低语',
  'itemUi.procedural.rareWord.oath': '誓言',
  'itemUi.procedural.legendary.crown_last_pyre.name': '末焰之冠',
  'itemUi.procedural.legendary.crown_last_pyre.description':
    '每第三次施放火球术会灼烧目标附近的敌人。',
  'itemUi.procedural.legendary.greyjaws_edge.name': '灰颚之刃',
  'itemUi.procedural.legendary.greyjaws_edge.description':
    '每第三次武器命中会使目标流血，并恢复少量主要资源。',
  'itemUi.procedural.legendary.hushwood_longbow.name': '寂林长弓',
  'itemUi.procedural.legendary.hushwood_longbow.description':
    '瞄准射击或奥术射击可使目标短暂沉默。',
  'itemUi.procedural.legendary.nightglass_fang.name': '夜晶之牙',
  'itemUi.procedural.legendary.nightglass_fang.description': '击杀敌人会短暂提高急速。',
  'itemUi.procedural.legendary.ysoleis_vigil.name': '伊索蕾的守望',
  'itemUi.procedural.legendary.ysoleis_vigil.description': '暴击治疗会短暂生成一片恢复区域。',
  'itemUi.procedural.legendary.stormwake_idol.name': '唤风神像',
  'itemUi.procedural.legendary.stormwake_idol.description': '每第四次闪电箭会弹射至附近的敌人。',
  'itemUi.procedural.legendary.ashbinders_seal.name': '缚灰者之印',
  'itemUi.procedural.legendary.ashbinders_seal.description':
    '每第四次暗影箭会标记目标，使其受到额外暗影伤害。',
  'itemUi.procedural.legendary.dawnward_signet.name': '晨卫玺戒',
  'itemUi.procedural.legendary.dawnward_signet.description':
    '圣光术会为目标施加护盾，吸收相当于部分治疗量的伤害。',
  'itemUi.procedural.legendary.feral_moonclasp.name': '野性月扣',
  'itemUi.procedural.legendary.feral_moonclasp.description': '每第三次月火术会恢复主要资源。',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.name': '九鸣之钟',
  'itemUi.procedural.legendary.bell_of_the_ninth_peal.description':
    '每第二次伤害法术都会在目标周围敲响钟声。',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.name': '窃时披肩',
  'itemUi.procedural.legendary.mantle_of_borrowed_time.description':
    '生命值降至 35% 以下时，会获得一道短暂的防护结界。',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.name': '不息之路长靴',
  'itemUi.procedural.legendary.boots_of_the_unbroken_road.description':
    '移动 15 码后，移动速度会短暂提高。',
  'entities.items.ashwood_staff.name': '灰木法杖',
  'entities.items.gravecaller_cloth_handwraps.name': '唤墓者布质裹手',
  'entities.items.gravecaller_cloth_hood.name': '唤墓者布帽',
  'entities.items.gravecaller_cloth_leggings.name': '唤墓者布质护腿',
  'entities.items.gravecaller_cloth_mantle.name': '唤墓者布质披肩',
  'entities.items.gravecaller_cloth_raiment.name': '唤墓者布袍',
  'entities.items.gravecaller_cloth_sash.name': '唤墓者布质腰带',
  'entities.items.gravecaller_cloth_slippers.name': '唤墓者布鞋',
  'entities.items.gravecaller_focus.name': '唤墓者法器',
  'entities.items.gravecaller_pendant.name': '唤墓者吊坠',
  'entities.items.gravecaller_ring.name': '唤墓者指环',
  'entities.items.gravecaller_wand.name': '唤墓者魔杖',
  'entities.items.iron_broadsword.name': '铁制阔剑',
  'entities.items.iron_flanged_mace.name': '铁制凸缘钉锤',
  'entities.items.mirefen_dirk.name': '泥沼短匕',
  'entities.items.mirefen_hunting_bow.name': '泥沼猎弓',
  'entities.items.mirefen_leather_belt.name': '泥沼皮带',
  'entities.items.mirefen_leather_boots.name': '泥沼皮靴',
  'entities.items.mirefen_leather_gloves.name': '泥沼皮手套',
  'entities.items.mirefen_leather_hood.name': '泥沼皮帽',
  'entities.items.mirefen_leather_jerkin.name': '泥沼皮甲',
  'entities.items.mirefen_leather_leggings.name': '泥沼皮护腿',
  'entities.items.mirefen_leather_shoulderguards.name': '泥沼皮护肩',
  'entities.items.thornpeak_bulwark.name': '荆峰壁垒',
  'entities.items.thornpeak_crossbow.name': '荆峰弩',
  'entities.items.thornpeak_mail_chest.name': '荆峰锁甲胸铠',
  'entities.items.thornpeak_mail_gauntlets.name': '荆峰锁甲手铠',
  'entities.items.thornpeak_mail_girdle.name': '荆峰锁甲腰带',
  'entities.items.thornpeak_mail_helm.name': '荆峰锁甲头盔',
  'entities.items.thornpeak_mail_legguards.name': '荆峰锁甲护腿',
  'entities.items.thornpeak_mail_pauldrons.name': '荆峰锁甲肩铠',
  'entities.items.thornpeak_mail_sabatons.name': '荆峰锁甲战靴',
  'entities.items.thornpeak_polearm.name': '荆峰长柄武器',
  'entities.items.thornpeak_war_axe.name': '荆峰战斧',
