...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.cameraMode.title': '选择你的镜头',
  'hudChrome.cameraMode.body': '你想如何控制镜头？',
  'hudChrome.cameraMode.classicLabel': '经典',
  'hudChrome.cameraMode.classicDesc': '按住鼠标右键转动镜头，松开即可释放光标。',
  'hudChrome.cameraMode.mouseLabel': '鼠标镜头',
  'hudChrome.cameraMode.mouseDesc': '鼠标始终操控镜头，实现流畅的现代自由视角。',
  'hudChrome.cameraMode.recommended': '推荐',
  'hudChrome.cameraMode.note': '稍后可在 Esc 的“按键绑定”中更改。',
  'hudChrome.cameraMode.confirm': '确认',
  'hudChrome.cameraMode.dismiss': '关闭',
