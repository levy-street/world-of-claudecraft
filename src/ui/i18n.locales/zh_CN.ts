...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.voice_echo_npc.title': '被铭记的声音',
  'entities.npcs.voice_echo_npc.greeting':
    '篝火彼端传来的声音......是啊,我记得自己曾经也是这样的嗓音。',
  'entities.quests.q_echo_of_you.text': '我有件东西丢在了附近。你愿意替我去找回来吗?',
  'entities.quests.q_echo_of_you.completion': '你找到了。真心感谢你愿意听我说完。',
  'entities.quests.q_echo_of_you.objectives.0.label': '再次与回声交谈',
  'hudChrome.voiceNpc.title': '语音 NPC (WIP)',
  'hudChrome.voiceNpc.wipBanner': 'WIP 草稿,并非最终 HUD 窗口。',
  'hudChrome.voiceNpc.intro': '燃烧 $WOC,把你的声音克隆成一个小小的游戏内 NPC。',
  'hudChrome.voiceNpc.disabled': '语音 NPC 解锁功能暂未开放。',
  'hudChrome.voiceNpc.consentLabel': '我同意由第三方 AI 语音服务克隆我录制的声音。',
  'hudChrome.voiceNpc.displayNameLabel': 'NPC 显示名称',
  'hudChrome.voiceNpc.displayNamePlaceholder': '给你的回声起个名字吧?',
  'hudChrome.voiceNpc.recordStart': '录制样本',
  'hudChrome.voiceNpc.recordStop': '停止录音',
  'hudChrome.voiceNpc.recordingHint': '录音中......自然地说话,最长 30 秒。',
  'hudChrome.voiceNpc.priceLabel': '价格: {price} $WOC',
  'hudChrome.voiceNpc.burnLabel': '燃烧 $WOC 并确认',
  'hudChrome.voiceNpc.burnNotWired': '此草稿版本尚未接入链上燃烧签名。',
  'hudChrome.voiceNpc.needWallet': '请先连接 Solana 钱包。',
  'hudChrome.voiceNpc.needName': '请输入 NPC 的显示名称。',
  'hudChrome.voiceNpc.needConsent': '录制或上传样本前必须先同意。',
  'hudChrome.voiceNpc.micError': '无法访问你的麦克风。',
  'hudChrome.voiceNpc.uploadError': '无法上传语音样本。',
  'hudChrome.voiceNpc.quoteError': '无法获取报价。',
  'hudChrome.voiceNpc.confirmError': '无法确认付款。',
  'hudChrome.voiceNpc.statusPendingSample': '样本已录制。可以报价并燃烧 $WOC 了。',
  'hudChrome.voiceNpc.statusPendingClone': '付款已确认。等待语音克隆开始。',
  'hudChrome.voiceNpc.statusCloning': '正在克隆你的声音......',
  'hudChrome.voiceNpc.statusGenerating': '正在生成对白......',
  'hudChrome.voiceNpc.statusReady': '你的语音 NPC 已就绪!',
  'hudChrome.voiceNpc.statusFailed': '出了点问题: {error}',
  'hudChrome.voiceNpc.statusPollFailed': '无法查询状态。请重新打开此面板。',
};
