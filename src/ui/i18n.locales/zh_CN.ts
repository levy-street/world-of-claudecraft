...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.tin_ore.name': '锡矿石',
  'entities.items.iron_ore.name': '铁矿石',
  'entities.items.copper_bar.name': '铜锭',
  'entities.items.tin_bar.name': '锡锭',
  'entities.items.bronze_bar.name': '青铜锭',
  'entities.items.bronzeclasp_gauntlets.name': '青铜扣护手',
  'entities.items.clawspur_dirk.name': '爪刺匕首',
  'entities.items.iron_bar.name': '铁锭',
  'entities.items.thorium_bar.name': '钍锭',
  'entities.items.silverleaf_herb.name': '银叶草',
  'entities.items.briarthorn_herb.name': '刺藤草',
  'entities.items.rough_hide.name': '粗糙兽皮',
  'entities.items.thick_hide.name': '密实兽皮',
  'entities.items.silk_gland.name': '丝腺',
  'entities.items.venom_sac.name': '毒囊',
  'entities.items.beast_fang.name': '野兽尖牙',
  'entities.items.beast_claw.name': '野兽利爪',
  'entities.items.boar_tusk.name': '野猪獠牙',
