...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bank.depositAllTooltip':
    '将背包中的所有制作材料（提示中标示为“材料”的所有物品）一次性存入银行。其余物品全部留在背包中，包括采集工具、任务物品、消耗品和灰色物品。',
  ...
  'hudChrome.enchantName.enchant_weapon_lucent_might': '武器附魔 - 莹光威力',
  'hudChrome.enchantName.enchant_weapon_lucent_spellpower': '武器附魔 - 莹光法术强度',
  'hudChrome.enchantName.enchant_chest_lucent_stamina': '胸甲附魔 - 莹光耐力',
  'hudChrome.enchantName.enchant_feet_lucent_agility': '长靴附魔 - 莹光敏捷',
  ...
  'guide.profPages.craftIntro.alchemy': '炼金术在高望的药坊调配治疗与法力药剂、耐力合剂，顶端则是每个职责一瓶的药壶，连你自己的死亡都留得住。',
  ...
  'guide.profPages.craftProse.alchemy.ladderBody':
    'Minor Healing Potion人人初始即会、随处可调，无需工位。真正的梯子由Verane在药坊逐档传授：技能0免费，25档每个25银，50档每个1金；每档都是治疗药剂、法力药剂与耐力强化剂，从普通润光叶瓶（120生命、160法力）经优秀金叶（200、260）到精良日瓣（335、425）；自战利品经济起，25档还传授一瓶以油脂调制的Lesser Healing Potion，比金叶药剂便宜、效力略逊一筹。\n\n强化剂同样攀升：Elixir of the Boar给6耐力10分钟，Vipersear Elixir给9耐力15分钟，Elixir of the Serpent给12耐力15分钟且一次两瓶。旁边还有一个组合配方Elixir of the Bear：炼金达到25时Verane以25银传授，随处可调，但只有炼金术与工程学双技能25的调谐爆破师才能调制。\n\n整条强化剂线之上还有药壶档，无人传授，只能从拾得的配方学会。药壶给15点、持续20分钟，并开出强化剂从未有过的两条轴：攻击强度与智力，与熟悉的耐力并列，每个职责一瓶。它还有自己的规矩：无论属性，同时只能有一瓶药壶生效；该属性更弱的药剂或卷轴无法顶替它；驱散、偷取或手动取消都无法移除它；它能陪你越过自己的死亡，但登出后就会消失。',
  ...
  'guide.profPages.toolsNoteThreeRods':
    '每处资源点都需要对应行业的工具放在背包里，第 1 级也不例外：没有镐就采不到矿，没有鱼竿就钓不到鱼。商人阶梯覆盖第 1 到 3 级，分布在三处腹地枢纽：第 1 级工具三处都有售，更高的等级则在用得上它们的地形开始的地方出售（Fenbridge 增设第 2 级，Highwatch 增设第 3 级），而它们之外更年轻的聚落根本不备任何工具，所以出发前先备齐。每个柜台对自己备货的每一级都自由出售，任何工具也都能通过面对面交易转手；除了三件 20 铜的陆上入门工具之外，每一级还能在市场上架并通过邮件寄送：那三件只能在柜台购买或手手相传，永远不能卖回、寄送或上架。受限制的是使用。第 1 级以上的陆上工具，只有当你在该行业中的熟练度挣到它之后才能使用，第 2 级需要 {tier2Prof}，第 3 级需要 {tier3Prof}，两件制作等级则分别需要 85 和 100，而商品行、鼠标提示和下方的表格都会预先注明该要求。在那之前，提前买下的工具只会在背包里等着，不开放任何地形，不带来任何速度，也不产出任何精制品级，等你的计数触到那个数字，它便立刻可用。鱼竿是唯一的例外：没有任何鱼竿带有使用要求，而Eastbrook的Trader Wilkes特意备着第 2 级和第 3 级鱼竿，供提前购买的钓手选购。工具从不占用装备栏，也不会磨损，因此每件都是一次性购买。只有等级会影响限制：同等级中更稀有的工具并不会多开放任何东西。不过稀有度并不只是颜色，它会让镶嵌的工具效果持续更久，装在鱼竿上还会加宽收线时机。\n\n更好的工具带来三样东西，而不是两样。它开放更高等级的地形，缩短采集时间，还会提升产出：用等级高于该区域自身材料的工具开采矿脉，收获的将是精制品级而非普通品级。该矿脉必须是这个区域的完整品级矿脉，因此区域为旅行者保留的简易矿脉依然产出普通材料。精制材料正是制作工具配方所消耗的东西，而且在任何配方或工单要求普通版本的地方，精制品级都可以顶替，所以升级永远不会让你陷入困境：只是你的铜矿石会以精制铜矿石的形式到手。\n\n在商人阶梯之上，每个陆上行业还有两件制作工具，第 4 级和第 5 级，在工具工坊制作（每个角色都会陆上配方，为这类工作攀升的技能是工程学），或在满足溺亡连祷的通关条件后，在其柜台用秘境印记购买：下方的表格列出了印记价格以及每一级所要求的通关次数。任何商人都不会用金币出售它们。钓鱼有自己的三件，而它们是本段一切说法的例外：工具匠教授第 4 级的Stormreel和第 5 级的Tidewrought，第 6 级的Clockreel则改由图纸打造，而这三件中的每一件都会开放一个仅凭技能永远无法抵达的渔获区间，因此在水上，最高的几级买到的是准入资格而非舒适。对陆上行业而言，目前没有任何资源点需要超过第 3 级，因此它们的第 4 级和第 5 级工具买到的依然是速度和品级而非准入资格，等更高等级的地形出现时，它们将成为入场券。',
  ...
  'guide.profPages.craftProse.engineering.identityBody':
    '这门手艺在Eastbrook广场西南角的工坊操持，主人是Tinker Gizzel，工坊宗师。每条工具线的1到3级都是寻常商店货；再往上的每一级都出自工程师的工作台，或在满足溺亡连祷的通关条件后于其秘境柜台用秘境印记购买，永远不会有柜台用金币出售。陆上的工具线止于5级；鱼竿这条线再往上一级，直到6级的齿轮轮钓竿。\n\n在制作之轮上它与试错类手艺同列，与炼金术及护甲锻造相邻，由此形成两条命途：爆破师（工程学与炼金术，向Gizzel本人宣誓）和齿轮匠（护甲锻造与工程学，已标注但尚无誓约任务）。这里有一条比其他任何行业都更要紧的警告：工程学的每一档配方都高于爱好与未宣誓者的精良层上限，因此技能只为主修包含工程学的人（如今即爆破师）增长。任何人都能制作陆上工具，未调谐者只是学不到东西；而三个鱼竿配方中有两个还要Gizzel传授，6级那一档则改由图纸获得。',
  'guide.profPages.craftProse.engineering.ladderBody':
    '整条梯子共有九个配方，全部绑定工坊工位。其中六个陆上工具配方自动学会、永不收费：技能75的4级镐、斧、镰，与技能150的5级版本。150不是笔误，故意高于当前125上限：技能需求从不阻止制作，只影响成长，材料与前置工具到手当天就能做出5级工具。三根制作鱼竿中有两根是需要拜师的例外：Gizzel在技能75时以4金传授风暴轮钓竿，在技能125时以16金传授潮铸钓竿，两者都在你于这门手艺中的层级够到它自身的那一刻开授。第三根是6级的齿轮轮钓竿，没有任何导师为它开价：它的图纸摆在英雄军需官的柜台上，直接把配方教给你。\n\n每件成品都是精良或史诗品质且出厂署名，于是你的名字会随其他玩家的工具带走遍各个区域。工程学还撑起一件组合配方的一半：Elixir of the Bear，由双技能25的调谐爆破师调制。',
