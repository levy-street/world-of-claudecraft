...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.aldrin.entryLabel': '奥尔德林俱乐部',
  'hudChrome.aldrin.title': '奥尔德林俱乐部',
  'hudChrome.aldrin.intro':
    '按月订阅的会员资格。所有特权仅限外观、便利或准入，绝不提供任何战斗力。',
  'hudChrome.aldrin.loading': '加载中...',
  'hudChrome.aldrin.unavailable': '本服务器暂未开放奥尔德林俱乐部。',
  'hudChrome.aldrin.memberBadge': '会员',
  'hudChrome.aldrin.notMember': '你还不是会员。',
  'hudChrome.aldrin.memberUntil': '会员有效期至{date}（剩余{days}天）',
  'hudChrome.aldrin.autoRenew': '通过银行卡订阅自动续费。',
  'hudChrome.aldrin.priceLine': '每{days}天{amount} USD',
  'hudChrome.aldrin.splitLine': '{treasuryPct}%注入公开金库，{burnPct}%用于回购并销毁$WOC。',
  'hudChrome.aldrin.perksTitle': '会员特权',
  'hudChrome.aldrin.perk.aura': '金色会员光环（仅视觉效果）',
  'hudChrome.aldrin.perk.regalia': '奥尔德林礼服幻化套装（仅外观）',
  'hudChrome.aldrin.perk.mount': '俱乐部专属坐骑外观',
  'hudChrome.aldrin.perk.title': '“奥尔德林俱乐部成员”称号',
  'hudChrome.aldrin.perk.nameColor': '金色姓名板颜色',
  'hudChrome.aldrin.perk.lounge': '会员专属休息室与俱乐部聊天频道',
  'hudChrome.aldrin.perk.wardrobe': '额外的外观衣柜栏位',
  'hudChrome.aldrin.perk.queue': '满员时的优先登录队列',
  'hudChrome.aldrin.perk.stipend': '每月外观专用津贴',
  'hudChrome.aldrin.methodsTitle': '支付方式',
  'hudChrome.aldrin.method.stripe': '银行卡（Stripe）',
  'hudChrome.aldrin.reason.clubDisabled': '俱乐部在本服务器已停用，暂不可用。',
  'hudChrome.aldrin.reason.walletCannotSign': '不可用：绑定的钱包仅支持消息签名，无法签署交易。',
  'hudChrome.aldrin.reason.notConfigured': '本服务器未配置。',
  'hudChrome.aldrin.quoteTitle': '支付报价：{method}',
  'hudChrome.aldrin.quoteAmount': '金额：{amount} {method}',
  'hudChrome.aldrin.quoteMemo': '备注（支付时必须附带）：{memo}',
  'hudChrome.aldrin.quoteExpires': '该报价还有约{minutes}分钟有效。',
  'hudChrome.aldrin.quoteExpired': '该报价已过期，请重新获取。',
  'hudChrome.aldrin.quoteError': '无法获取报价，请稍后再试。',
  'hudChrome.aldrin.railsNotice':
    '在运营密钥与最终审批就绪前，本版本已停用支付功能。此窗口不会发送任何交易。',
  'hudChrome.aldrin.stripeNotice': '支付启用后，银行卡结账将通过Stripe打开。',
  'hudChrome.aldrin.close': '关闭',
};
