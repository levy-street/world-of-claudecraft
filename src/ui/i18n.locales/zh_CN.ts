...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.source_cave_mantle.name': '源之披风',
  'entities.items.conflictbreaker_breastplate.name': '冲突终结者胸甲',
  'entities.items.cherry_pickers_gauntlets.name': '拣选者护手',
  'entities.items.maintainers_crown.name': '维护者之冠',
  'entities.items.commit_blade.name': '提交之刃',
  'entities.items.bug_squasher.name': '除虫大锤',
  'entities.items.mech_keyboard.name': '击键',
  ...
  'worldContent.sourceCaveWellName': '开放之源',
  'worldContent.sourceCaveReboot': '不要按这个按钮',
  'worldContent.sourceCaveRebootYell': '你都干了什么？！',
  'worldContent.sourceCaveRebootYellWhatsGoingOn': '嘿，发生什么事了？',
  'worldContent.sourceCaveRebootYellServerDown': '伙计们，服务器宕机了！',
  'worldContent.sourceCaveBanterIssue': '拜托，提个 issue 吧。',
  'worldContent.sourceCaveBanterPullRequest': '别犹豫，欢迎提交 pull request。',
  'worldContent.sourceCaveBanterConflicts': '我讨厌冲突……',
  'worldContent.sourceCaveBanterContribute': '当然，你完全可以为这个项目做贡献！',
  'worldContent.sourceCaveBanterFocused': '抱歉，我现在得专心干活',
  'worldContent.sourceCaveBanterNextRelease': '下个版本会超棒的！',
  'worldContent.sourceCaveBanterRefresh': '嗯？刷新试试',
  ...
  'entities.dungeons.source_cave.name': '开放之源',
  'entities.dungeons.source_cave.enterText': '你走进开放之源。',
  'entities.dungeons.source_cave.leaveText': '你离开了开放之源。',
  ...
  'sim.dungeon.levelRequired': '你必须达到 {level} 级才能进入{name}。',
  'sim.sourceCave.locked': '你已被锁定，无法进入{name}。',
  'sim.sourceCave.enter': '你走进开放之源。',
  'sim.sourceCave.leave': '你离开了开放之源。',
  'sim.sourceCave.rebootConfirm': '你确定要继续吗？按下之前，确保你已集结好所需的资源。',
  'sim.sourceCave.killProgress': '{name}已回归源代码。',
  'sim.sourceCave.bossDefeated': '{name}遇到了致命异常。',
  'sim.sourceCave.cleared': '开放之源现已关闭。恭喜？',
  'sim.sourceCave.accessDenied': '访问被拒绝。',
  'sim.sourceCave.wellBanter1': '这只是一口井，装水用的。走吧走吧。',
  'sim.sourceCave.wellBanter2': '你干嘛这样盯着我的砖头看？',
  'sim.sourceCave.wellBanter3': '我就是一口普通的井！你看，我还有个水桶呢！',
  'sim.sourceCave.wellBanter4': '还是那句话，就是一口井。没什么好看的魔法。',
  'sim.sourceCave.wellBanter5': '是谁跟你说起"源"的事的？是Claude吗？',
  'sim.sourceCave.wellBanter6': '哦，你绝对不会想下去那里的。',
  'sim.sourceCave.wellBanter7': '保安！这个玩家想闯入源代码！',
  'sim.sourceCave.wellBanter8': '跟你说，那下面可是个争议的源头。',
  'sim.sourceCave.wellBanter9': '如果我打开了，你能不能终于别烦我了？',
  'sim.sourceCave.wellBanter10': '好吧，进来吧。先把靴子擦干净。',
