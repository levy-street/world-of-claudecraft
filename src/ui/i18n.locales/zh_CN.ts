...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.tracker.abandon': '离开探秘',
  'delveUi.abandonConfirm.title': '离开探秘？',
  'delveUi.abandonConfirm.body': '返回探秘入口？你可以再次进入，继续本次探秘。',
  'delveUi.abandonConfirm.confirm': '离开',
  'delveUi.abandonConfirm.cancel': '取消',
