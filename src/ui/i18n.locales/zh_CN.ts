...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'wallet.guardianTierTitle': '{tier}流动性守护者',
  'wallet.guardianTiers.wader.name': '涉水者',
  'wallet.guardianTiers.wader.title': '浅滩涉水者',
  'wallet.guardianTiers.tidewatcher.name': '望潮者',
  'wallet.guardianTiers.tidewatcher.title': '潮汐守望者',
  'wallet.guardianTiers.currentkeeper.name': '守流者',
  'wallet.guardianTiers.currentkeeper.title': '海流看守者',
  'wallet.guardianTiers.stormwarden.name': '风暴守卫',
  'wallet.guardianTiers.stormwarden.title': '风暴守望者',
  'wallet.guardianTiers.abyssguard.name': '深渊卫士',
  'wallet.guardianTiers.abyssguard.title': '深渊守卫者',
  ...
  'hudChrome.wocSeason.subtitle': '由金库出资向顶尖玩家发放',
  'hudChrome.wocSeason.close': '关闭',
  'hudChrome.wocSeason.none': '当前没有进行中的奖励赛季。',
  'hudChrome.wocSeason.noneHint': '当竞技场抽成和回购开始为奖池注资时，赛季即会开启。',
  'hudChrome.wocSeason.statusActive': '进行中',
  'hudChrome.wocSeason.statusEnded': '已结束',
  'hudChrome.wocSeason.ended': '本赛季已结束。',
  'hudChrome.wocSeason.openEnded': '无限期',
  'hudChrome.wocSeason.poolLabel': '可用奖励池',
  'hudChrome.wocSeason.emittedLabel': '迄今已发放奖池的 {pct}%',
  'hudChrome.wocSeason.sinkLabel': '已注资',
  'hudChrome.wocSeason.invariant': '发放永远不会超过赛季收入：买入 > 卖出，链上强制执行。',
  ...
  'hudChrome.wocSeason.projectedNote': '基于当前奖池与竞技场排名的预测；最终发放在赛季结束时结算。',
};
