...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.land_steward.name': '管家芬威克',
  'entities.npcs.land_steward.title': '土地管家',
  'entities.npcs.land_steward.greeting': '梦想拥有自己的炉火吗？家园谷地为每一位备好一块地，只要你带着一百金币，亲手签下地契。',
  'worldContent.homesteadGateName': '家园之门',
  // Player housing (M16 non-Latin fill)
  'hudChrome.housing.buy': '购买家园地契（{price}）',
  'hudChrome.housing.buyAria': '以 {price} 购买家园地契',
  'hudChrome.housing.travel': '前往你的家园',
  'hudChrome.housing.travelAria': '传送到家园谷地中你的家园',
  'hudChrome.housing.confirmTitle': '家园地契',
  'hudChrome.housing.confirmBuy': '花费 {price} 在谷地签下属于你的家园？',
  'hudChrome.housing.confirmOk': '签署地契',
  'hudChrome.housing.confirmCancel': '再想想',
  'hudChrome.housing.purchasedBanner': '家园谷地在等你。',
  'hudChrome.housing.arrivedBanner': '你的家园',
  'hudChrome.housing.leftBanner': '东溪镇',
  'hudChrome.housing.result.purchased': '地契归你了。找管家谈谈即可造访你的家园。',
  'hudChrome.housing.result.alreadyOwned': '你已经持有家园地契。',
  'hudChrome.housing.result.cantAfford': '你买不起这份地契。',
  'hudChrome.housing.result.notOwned': '你还没有家园地契。',
  'hudChrome.housing.result.tooFar': '你必须与土地管家当面交谈。',
  'hudChrome.housing.result.glensFull': '谷地眼下有些拥挤。请稍后再试。',
  'hudChrome.housing.result.notHome': '你不在你的家园。',
};
