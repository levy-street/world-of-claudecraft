...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.scene.skipHint': '跳过过场动画（Esc）',
  'hudChrome.scene.waitingFor': '正在等待 {name}',
  'hudChrome.mountTraining.buyReinsPrompt':
    '骑术已学会。向玛拉购买价值 10 金币的勇武战马缰绳，然后使用它即可骑乘。',
  'lb.fixture.ferry': '远岸渡船',
  'lb.fixture.tidemill': '潮汐磨坊',
  'lb.fixture.breach': '裂隙',
  'lb.speaker.tam': '守钟人塔姆',
  'lb.speaker.coalfast': '守望者科尔法斯特',
  'lb.speaker.ollun': '裂隙守卫奥伦',
  'lb.speaker.edda': '军需官埃达',
  'lb.speaker.saul': '医者索尔',
  'lb.fare.promptOut': '前往远岸的船费：{price} 铜币。',
  'lb.fare.promptBack': '返回大陆的船费：{price} 铜币。',
  'lb.fare.pay': '支付船费。',
  'lb.fare.decline': '今天不了。',
  'lb.q0.scene.harbor': '一座繁忙的港口：渔网正在晾晒，星玻璃打捞箱上印着大陆买家的标记。',
  'lb.q0.scene.plinth':
    '港口台阶上方，一尊青铜守望者面朝内陆。基座上最新的名字已有百年：守望者黑尔。下方还留有刻写更多名字的空位。',
  'lb.q0.scene.toll':
    '钟声响了一下。街上的每个人都停下脚步，默默计数。再无声响，整条街才一同松了口气。',
  'lb.q0.tam.stretchers': '上次那种东西让整支守卫队忙了一上午，还搭上了两副担架。',
  'lb.q0.coalfast.look': '灰衣人看看死去的潜猎者，又稍久地看了你一眼。随后他转身走回悬崖方向。',
  'editor.cinematic.title': '过场动画',
  'editor.cinematic.show': '显示面板',
  'editor.cinematic.hide': '隐藏面板',
  'editor.cinematic.scene': '场景',
  'editor.cinematic.pause': '暂停',
  'editor.cinematic.authoredCamera': '编排镜头',
  'editor.cinematic.letterboxOn': '黑边：开启',
  'editor.cinematic.letterboxOff': '黑边：关闭',
  'editor.cinematic.violations': '违规项',
  'editor.cinematic.noViolations': '当前没有违规项',
  'editor.cinematic.capture': '捕获关键帧',
  'editor.cinematic.copy': '复制代码块',
  'editor.cinematic.output': '生成的镜头捕获',
  'editor.cinematic.unavailable': '三维视口正在加载',
  'editor.cinematic.seedMismatch': '捕获需要使用正式世界种子',
  'editor.cinematic.captureSavedCopied': '已保存并复制',
  'editor.cinematic.captureSaved': '已保存；代码块已在下方准备好',
  'editor.cinematic.captureCopyOnly': '已复制；开发写入器不可用',
  'editor.cinematic.captureReady': '代码块已在下方准备好',
  'entities.mobs.lb_actor_coalfast.name': '守望者科尔法斯特',
  'entities.mobs.lb_actor_ollun.name': '裂隙守卫奥伦',
  'entities.mobs.lb_actor_edda.name': '军需官埃达',
  'entities.mobs.lb_actor_saul.name': '医者索尔',
  'entities.mobs.lb_actor_tam.name': '守钟人塔姆',
  'entities.mobs.tidemill_stalker.name': '潮汐磨坊潜猎者',
  'entities.npcs.ferryman_ewald.name': '船夫埃瓦尔德',
  'entities.npcs.ferryman_ewald.title': '远岸渡口',
  'entities.npcs.ferryman_ewald.greeting':
    '要去远岸吗？如今已经没人是为了钓鱼而过海了，朋友。准备好就上船，抵岸后留心钟声：镇上的人听它，就像你听天气一样。',
  'entities.npcs.ferryman_ewald_gullhaven.name': '船夫埃瓦尔德',
  'entities.npcs.ferryman_ewald_gullhaven.title': '远岸渡口',
  ...
  'entities.npcs.sergeant_marsh.greeting':
    '受过训练？那就听好今晚的安排。我的防线守住道路。若裂隙吐出我们解决不了的东西，我会指向你。磨坊归你管：不许任何东西跟你进去，也不许任何东西越过我们进镇。去吧。',
  'entities.quests.q_lb_q0_ashore.title': '登岸',
  'entities.quests.q_lb_q0_ashore.text':
    '鸥港日夜承受冲击，却始终屹立。若你真想与他们并肩，就从镇上流血的地方开始：越过港口台阶和旧雕像，向东前往守望草地的民兵防线。',
  'entities.quests.q_lb_q0_ashore.completion':
    '磨坊里的猎杀全靠你一人，塔姆也没有夸大担架的事。我缺一个斥候，却有太多田野要守。今晚你守住了一块本不属于你的阵地，而这正是这份工作的全部。欢迎加入守卫队。',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': '前往守望草地向马什中士报到',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': '消灭裂隙生物',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': '解决潮汐磨坊里的东西',
  'entities.zones.farshore_isle.pois.5.label': '裂隙',
  'entities.zones.farshore_isle.pois.6.label': '残骸原',
  'entities.dungeons.lb_tidemill.name': '潮汐磨坊',
  'entities.dungeons.lb_tidemill.enterText': '磨坊的门让开了。里面，黑暗正在倾听。',
  'entities.dungeons.lb_tidemill.leaveText': '你走出潮汐磨坊，回到暮色中的空气里。',
  'entities.dungeons.lb_riftline.enterText': '巡逻队身后的草地大门关闭了。今夜属于这道防线。',
  'entities.dungeons.lb_riftline.leaveText': '你把裂隙防线交给黎明守卫。',
  'entities.dungeons.lb_vault.name': '沉没的第一堡垒',
  'entities.dungeons.lb_vault.enterText': '绳索向黑暗中放下。下方，古老堡垒沉睡在坠落之处。',
  'entities.dungeons.lb_vault.leaveText': '你沿悬崖绳索攀回日光之中。',
  'entities.dungeons.lb_council.name': '堡垒议会',
  'entities.dungeons.lb_council.enterText': '议会厅里摆着六把椅子，其中一把空着。',
  'entities.dungeons.lb_council.leaveText': '你走出堡垒。',
  'entities.dungeons.lb_landing.name': '夜间登陆',
  'entities.dungeons.lb_landing.enterText': '引航火焰沿海滩燃烧。舰队在浅滩外等待。',
  'entities.dungeons.lb_landing.leaveText': '你把登陆海滩留在身后。',
  'entities.dungeons.lb_riftfields.name': '裂隙原入口',
  'entities.dungeons.lb_riftfields.enterText': '四处结界环绕裂口。这场仪式已将它封闭了十二个世纪。',
  'entities.dungeons.lb_riftfields.leaveText': '你从裂隙原走回山下。',
  'entities.dungeons.lb_breach.name': '裂隙之内',
  'entities.dungeons.lb_breach.enterText': '光线不对，天空更糟。核心就位于前方的开阔地。',
  'entities.dungeons.lb_breach.leaveText': '你跨过门槛，回到寻常的夜色空气中。',
  'entities.dungeons.lb_lastwatch.name': '最后守望',
  'entities.dungeons.lb_lastwatch.enterText': '堡垒干净而空旷。总得有人结束这场守望。',
  'entities.dungeons.lb_lastwatch.leaveText': '你在身后关上堡垒大门。',
  'entities.dungeons.lb_willowfen.name': '垂柳泣泽',
  'entities.dungeons.lb_willowfen.enterText': '柳树纹丝不动，水面也是。',
  'entities.dungeons.lb_willowfen.leaveText': '你离开柳树，让它继续沉默。',
