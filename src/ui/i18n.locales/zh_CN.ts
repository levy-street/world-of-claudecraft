...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.unitFrameHealthText': '单位框架生命值文本',
  'hudChrome.options.unitFrameDamageTrail': '延迟伤害轨迹',
  'hudChrome.options.unitFramePortraitEffects': '头像反馈',
  ...
  'hudChrome.unitFrame.targetOfTargetNamedLabel': '目标的目标：{name}',
  'hudChrome.unitFrame.auraOverflowShort': '+{count}',
  'hudChrome.unitFrame.auraOverflowLabel': '另外 {count} 个增益效果',
