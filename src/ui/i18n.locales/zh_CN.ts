...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.rift_arcane_execution': '虚空裂缝',
  'abilityUi.cast.rift_arcane_strike': '奥术歼灭',
  'abilityUi.cast.rift_brute_execution': '碎地者',
  'abilityUi.cast.rift_brute_strike': '最终审判',
  'abilityUi.cast.rift_ember_execution': '岩浆井',
  'abilityUi.cast.rift_ember_strike': '核心熔毁',
  'abilityUi.cast.rift_frost_execution': '冰川坟墓',
  'abilityUi.cast.rift_frost_strike': '绝对零',
  'abilityUi.cast.rift_necro_execution': '灵魂坟墓',
  'abilityUi.cast.rift_necro_strike': '死刑判决',
  'abilityUi.cast.rift_storm_execution': '避雷针',
  'abilityUi.cast.rift_storm_strike': '风暴召唤者之怒',
  'abilityUi.cast.rift_tide_execution': '深渊之口',
  'abilityUi.cast.rift_tide_strike': '破碎深度',
  'abilityUi.cast.rift_venom_execution': '毒液池',
  'abilityUi.cast.rift_venom_strike': '巢母印记',
  'hud.core.riftLabel': '{名称} {name}',
  'hud.core.riftLabelRanked': '{名称}（{排名}） {name} {rank}',
  'fiesta.augment.cardAria': '{名称}（{类别}）- {描述} {name} {category} {description}',
  'hudChrome.continentMap.toZone': '区域地图',
  'hudChrome.meters.breakdownRow': '{值} ({百分比}) {value} {percent}',
  'hudChrome.meters.breakdownSummary': '{选项卡}：{值} {tab} {value}',
  'hudChrome.meters.percent': '{值}% {value}',
  'hudChrome.meters.petAbility': '{宠物}：{能力} {pet} {ability}',
  'hudChrome.mountRace.go': '出发！',
  'hudChrome.mountRace.timeLeft': '{秒}秒 {seconds}',
};
