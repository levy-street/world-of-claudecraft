...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaEnd.victory': '胜利',
  'hudChrome.arenaEnd.defeat': '失败',
  'hudChrome.arenaEnd.draw': '平局',
  'hudChrome.arenaEnd.colName': '名称',
  'hudChrome.arenaEnd.colKills': '击杀',
  'hudChrome.arenaEnd.colDamage': '伤害输出',
  'hudChrome.arenaEnd.colHealing': '治疗量',
  'hudChrome.arenaEnd.colRating': '评分',
  'hudChrome.arenaEnd.colChange': '变化',
  'hudChrome.arenaEnd.yourRating': '你的评分：{before} 至 {after}',
  'hudChrome.arenaEnd.honorEarned': '+{honor} 荣誉',
  'hudChrome.arenaEnd.leave': '离开',
  'hudChrome.arenaEnd.close': '关闭',
