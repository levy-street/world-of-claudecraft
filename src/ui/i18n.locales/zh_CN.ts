...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.interactPrompt.interact': '互动',
  'hudChrome.interactPrompt.gather': '采集',
  'hudChrome.interactPrompt.enter': '进入',
  'hudChrome.interactPrompt.leave': '离开',
  'hudChrome.interactPrompt.name.lockedChest': '上锁的箱子',
  'hudChrome.interactPrompt.name.rewardChest': '战利品箱',
  'hudChrome.interactPrompt.name.reliquary': '沉溺圣匣',
  'hudChrome.interactPrompt.name.bellShrine': '钟之神龛',
  'hudChrome.interactPrompt.name.candleShrine': '烛之神龛',
  'hudChrome.interactPrompt.name.reedShrine': '苇之神龛',
  'hudChrome.interactPrompt.name.skullShrine': '颅之神龛',
  'hudChrome.options.showInteractPrompt': '显示互动提示',
  'hudChrome.options.interactHighlight': '悬停时高亮可互动目标',
};
