...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.playtestBack': '返回编辑器',
  'editor.playtestBackTitle': '返回地图编辑器（试玩开始时地图已保存）',
  'hudChrome.deepglass.bout': '每方{n}人',
  'hudChrome.deepglass.boutAria': '开始一场深球比赛，每方{n}人',
  'hudChrome.deepglass.gossip': '带我下到深玻璃',
  'hudChrome.deepglass.gossipAria': '前往深玻璃并开始一场深球比赛',
  'hudChrome.keybinds.ballMarker': '球标记（深球）',
  'hudChrome.keybinds.boost': '燃烧器（深球）',
  'hudChrome.plotSign.boughtLog': '{name}的地契归你所有。',
  'hudChrome.plotSign.buy': '以{price}购买',
  'hudChrome.plotSign.close': '关闭',
  'hudChrome.plotSign.price': '售价 {price}',
  'hudChrome.plotSign.purse': '你身上有 {purse}。',
  'hudChrome.plotSign.size': '{size}地块，{w}乘{d}码',
  'hudChrome.plotSign.sizes.large': '大',
  'hudChrome.plotSign.sizes.medium': '中',
  'hudChrome.plotSign.sizes.small': '小',
  'hudChrome.plotSign.sold': '已售出。{name}持有这份地契。',
  'hudChrome.plotSign.title': '待售住宅地块',
  'hudChrome.plotSign.yours': '你持有这份地契。',
  'hudChrome.portalWizard.gossipDeepglass': '为我打开通往深玻璃的路',
  'hudChrome.portalWizard.gossipDeepglassAria': '请巴尔德马开启通往深玻璃的传送门',
  'hudChrome.portalWizard.gossipHome': '为我打开回家的路',
  'hudChrome.portalWizard.gossipHomeAria': '请巴尔德马开启回到你所在城镇的传送门',
  'hudChrome.portalWizard.portalOpen': '传送门已开启。走进去吧。',
  'entities.npcs.deepglass_marshal.greeting':
    '钟身温热，水色清澈，{className}。报上你要的赛制，我这就吹哨开赛：想球不离手就打单打，想有人分担责任，就凑一场三对三。',
  'entities.npcs.deepglass_marshal.name': '裁判长伊薇特·珊瑚醒',
  'entities.npcs.deepglass_marshal.title': '哨令守护者',
  'entities.npcs.dg_stallkeeper_favors.greeting':
    '备好钱袋装你的彩头，备好背包装你的疑虑。买钱袋吧，亲爱的，那才是乐观者的选择。',
  'entities.npcs.dg_stallkeeper_favors.name': '旗婆温',
  'entities.npcs.dg_stallkeeper_favors.title': '彩带与旗帜',
  'entities.npcs.dg_stallkeeper_pies.greeting':
    '热馅饼、冰凉水，还有比排队还耐放的肉干。趁哨声响起前吃点东西吧，朋友，下半场可不会等你的肚子。',
  'entities.npcs.dg_stallkeeper_pies.name': '馅饼匠罗尔多',
  'entities.npcs.dg_stallkeeper_pies.title': '赛日给养',
  'entities.npcs.dg_stallkeeper_tonics.greeting':
    '跌打药水、定神药水，还有一口烈酒，专治堤道跌落的惊吓。前两样是选手买的，第三样是观众买的。',
  'entities.npcs.dg_stallkeeper_tonics.name': '塞拉·药瓶',
  'entities.npcs.dg_stallkeeper_tonics.title': '药水与烈酒',
  'entities.npcs.portal_wizard_bridgemere.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_bridgemere.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_bridgemere.title': '光顶大法师',
  'entities.npcs.portal_wizard_deepglass.greeting':
    '早说了我会先到这儿的。光头行走天下最轻便，{className}。好好享受这钟，当心那玻璃，等你想念家乡的青草时，说一声就行：回去的路，只在一念闪光之间。',
  'entities.npcs.portal_wizard_deepglass.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_deepglass.title': '光顶大法师',
  'entities.npcs.portal_wizard_drifthaven.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_drifthaven.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_drifthaven.title': '光顶大法师',
  'entities.npcs.portal_wizard_eastbrook.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_eastbrook.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_eastbrook.title': '光顶大法师',
  'entities.npcs.portal_wizard_eldergleam.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_eldergleam.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_eldergleam.title': '光顶大法师',
  'entities.npcs.portal_wizard_fenbridge.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_fenbridge.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_fenbridge.title': '光顶大法师',
  'entities.npcs.portal_wizard_gallowmere.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_gallowmere.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_gallowmere.title': '光顶大法师',
  'entities.npcs.portal_wizard_gullhaven.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_gullhaven.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_gullhaven.title': '光顶大法师',
  'entities.npcs.portal_wizard_hedgewick.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_hedgewick.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_hedgewick.title': '光顶大法师',
  'entities.npcs.portal_wizard_highwatch.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_highwatch.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_highwatch.title': '光顶大法师',
  'entities.npcs.portal_wizard_icemantle.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_icemantle.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_icemantle.title': '光顶大法师',
  'entities.npcs.portal_wizard_lanternmere.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_lanternmere.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_lanternmere.title': '光顶大法师',
  'entities.npcs.portal_wizard_moonrest.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_moonrest.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_moonrest.title': '光顶大法师',
  'entities.npcs.portal_wizard_wickharbor.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_wickharbor.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_wickharbor.title': '光顶大法师',
  'entities.npcs.portal_wizard_wyrmwatch.greeting':
    '没错，头顶光秃秃的，也不，这可不是山风刮的。头发是锚，{className}：每一根发丝都把灵魂拴在一方土地上。我把我的头发，一根不剩，全都换成了世间的门。开口吧，我就为你打开通往深玻璃的路。我的另一个自己已经在那边了，正摸着自己的光头求好运呢。',
  'entities.npcs.portal_wizard_wyrmwatch.name': '秃头巴尔德马',
  'entities.npcs.portal_wizard_wyrmwatch.title': '光顶大法师',
  'entities.npcs.th_armourer.greeting':
    '巡卫所需的一切都在这儿，还有些他们本该配备却没有的。守护官出钱，你付得更少。',
  'entities.npcs.th_armourer.name': '军需官罗克·艾德林',
  'entities.npcs.th_armourer.title': '大军械库',
  'entities.npcs.th_banker.greeting':
    '把钱放在岩石里，可比揣在口袋里、站在五十码高的悬崖边安全多了，{className}。',
  'entities.npcs.th_banker.name': '库藏官安塞尔·潮',
  'entities.npcs.th_banker.title': '深玻璃金库',
  'entities.npcs.th_clerk.greeting':
    '请愿书放左边，赛程纠纷放右边，凡是堤道栏杆的事，都摆在我桌上。',
  'entities.npcs.th_clerk.name': '文书官奥托琳·恼',
  'entities.npcs.th_clerk.title': '守护官厅',
  'entities.npcs.th_fountain_keeper.greeting':
    '喷泉里流的是钟本身的水，{className}，据历代守护官所说，是顺着堤道底下的管道引上来的。巴尔德马喜欢水花溅在头顶，说这样能让光头保持锃亮。',
  'entities.npcs.th_fountain_keeper.name': '井泉总管布林·卡多克',
  'entities.npcs.th_fountain_keeper.title': '守护官泉看守人',
  'entities.npcs.th_gate_captain.greeting':
    '潮堡守着那口钟，{className}，而我守着潮堡。堤道畅通，市集喧闹，守护官也在城中。下山时留意栏杆。',
  'entities.npcs.th_gate_captain.name': '门卫队长伊索尔德·布拉克',
  'entities.npcs.th_gate_captain.title': '潮门守护者',
  'entities.npcs.th_innkeeper.greeting':
    '床铺、饭食，还有一扇正对钟身的窗。比赛之夜你是睡不着的，不过你也不会想睡。想找伴儿的话，门边贴着告示板。',
  'entities.npcs.th_innkeeper.name': '客栈老板多夫·马罗',
  'entities.npcs.th_innkeeper.title': '镀金海鸥',
  'entities.npcs.th_lamplighter.greeting':
    '从堤道到守护座的每一盏灯，都得赶在天黑前照看一遍。愿意的话就跟我走一趟，这是城里最好的一段路。',
  'entities.npcs.th_lamplighter.name': '点灯人昂德里',
  'entities.npcs.th_lamplighter.title': '水晶灯守护者',
  'entities.npcs.th_market_bags.greeting':
    '你没法把整个玻璃市集用两只手抱回家，{className}。不信问问我是怎么知道的。',
  'entities.npcs.th_market_bags.name': '行囊总管赫斯特',
  'entities.npcs.th_market_bags.title': '行囊与绑带',
  'entities.npcs.th_market_pies.greeting':
    '刚从坊里的炉子出炉，{className}。就在这儿吃吧，出了露台一半都得被风吹跑。',
  'entities.npcs.th_market_pies.name': '玛拉·咸湖',
  'entities.npcs.th_market_pies.title': '面包与卤水',
  'entities.npcs.th_market_reagents.greeting':
    '坊里锻造出的每一件东西，都是靠人背着堤道运上来的。多半是我背的。',
  'entities.npcs.th_market_reagents.name': '矿产商邓恩',
  'entities.npcs.th_market_reagents.title': '石料、锭料与铁坯',
  'entities.npcs.th_market_tonics.greeting':
    '跌打药水、定神药水，还有专治摔落的药。深球选手是我最好的主顾。',
  'entities.npcs.th_market_tonics.name': '药剂师雷恩·菲尔',
  'entities.npcs.th_market_tonics.title': '药水与烈酒',
  'entities.npcs.th_merchant.greeting': '半个王国的货物都为了赛事送到这儿来。买卖随意，排队留神。',
  'entities.npcs.th_merchant.name': '商栈主管伊瑟尔·珊瑚醒',
  'entities.npcs.th_merchant.title': '守护官市场',
  'entities.npcs.th_priest.greeting': '我们在祭坛上供着一钵钟本身的水，它从未浑浊过一次。',
  'entities.npcs.th_priest.name': '潮语者哈洛兰',
  'entities.npcs.th_priest.title': '静水礼拜堂',
  'entities.npcs.th_seneschal.greeting':
    '守护官在沙漏转动之时接见请愿者。而这座城里的沙漏，相当大。',
  'entities.npcs.th_seneschal.name': '总管奥德里克·池',
  'entities.npcs.th_seneschal.title': '守护官座',
  'entities.npcs.th_smith.greeting':
    '玻璃是守护官的营生，钢铁才是我的。玻璃碎的时候，我的钢铁还撑得住。',
  'entities.npcs.th_smith.name': '锻炉守卫耶拉·布莱恩',
  'entities.npcs.th_smith.title': '潮堡锻造坊',
  'entities.npcs.th_stablemaster.greeting':
    '不养带翅膀的，也不养带火焰喷筒的。只有老实的马，从没在堤道上失过蹄。',
  'entities.npcs.th_stablemaster.name': '马厩总管科林·韦恩',
  'entities.npcs.th_stablemaster.title': '潮堡马厩',
  'entities.npcs.th_warden.greeting':
    '你爬了整条堤道就为了看我一眼，{className}？那口钟就在你身后，也是这儿唯一值得爬上来看的东西。去里头玩吧，我们留着它就是为了这个。',
  'entities.npcs.th_warden.name': '守护官卡西娅·深玻璃',
  'entities.npcs.th_warden.title': '钟之守护官',
  'entities.npcs.dg_spectator_pace1.greeting': '据说球打得够狠就会唱歌。我就是来听这个的。',
  'entities.npcs.dg_spectator_pace1.name': '梅莉·萨洛',
  'entities.npcs.dg_spectator_pace1.title': '深玻璃观众',
  'entities.npcs.dg_spectator_pace2.greeting':
    '赛前我坐不住，从来都坐不住。不信问我妻子，她就在看台上头。',
  'entities.npcs.dg_spectator_pace2.name': '乔森·布里尔',
  'entities.npcs.dg_spectator_pace2.title': '深玻璃观众',
  'entities.npcs.dg_spectator_pace3.greeting':
    '沿场边走三个来回，正好耗尽一场比赛前的紧张。我量过的。',
  'entities.npcs.dg_spectator_pace3.name': '佩塔·浪峰',
  'entities.npcs.dg_spectator_pace3.title': '深玻璃观众',
  'entities.npcs.dg_spectator_pace4.greeting':
    '站稳在场边，留神矮墙。踏出看台的第一步，能摔得老远。',
  'entities.npcs.dg_spectator_pace4.name': '谭姆·涌浪',
  'entities.npcs.dg_spectator_pace4.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier1.greeting':
    '这是整个场子里最好的座位。钟身一挨打，你就能看见它整个都在抖。',
  'entities.npcs.dg_spectator_tier1.name': '贝拉·霜玻璃',
  'entities.npcs.dg_spectator_tier1.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier10.greeting':
    '赛前那些塔柱会嗡嗡作响。把手贴上去，你能感觉到比赛要来了。',
  'entities.npcs.dg_spectator_tier10.name': '丹娜·海藻辫',
  'entities.npcs.dg_spectator_tier10.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier11.greeting':
    '十六盏灯，一只飞蛾都没有。我看这是世上最高的灯了。',
  'entities.npcs.dg_spectator_tier11.name': '玛洛·浪沫',
  'entities.npcs.dg_spectator_tier11.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier12.greeting':
    '我是来看游泳的，留下来是因为下山的堤道实在太长了。',
  'entities.npcs.dg_spectator_tier12.name': '温娜·潮蕾丝',
  'entities.npcs.dg_spectator_tier12.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier2.greeting': '我从破晓就占着这排座位，会一直守到终场哨响。',
  'entities.npcs.dg_spectator_tier2.name': '费林·盐桶',
  'entities.npcs.dg_spectator_tier2.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier3.greeting':
    '开球前水面静下来的那一刻，整座场馆都跟着屏住了呼吸。',
  'entities.npcs.dg_spectator_tier3.name': '尼姆·珀洛弗',
  'entities.npcs.dg_spectator_tier3.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier4.greeting': '我丈夫以为我在神殿，神殿那边则以为我跟丈夫在一起。',
  'entities.npcs.dg_spectator_tier4.name': '奥尔德大娘',
  'entities.npcs.dg_spectator_tier4.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier5.greeting':
    '我走遍了天下所有的海，见过最奇怪的水，就悬在头顶那上面。',
  'entities.npcs.dg_spectator_tier5.name': '维尔船长',
  'entities.npcs.dg_spectator_tier5.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier6.greeting':
    '看台越高，空气越稀，视野越好。爬上来也算是门票的一部分。',
  'entities.npcs.dg_spectator_tier6.name': '伊沃·灯笼航迹',
  'entities.npcs.dg_spectator_tier6.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier7.greeting':
    '球权每易手一次，我就织一行。上一场比赛下来，都织完一整条围巾了。',
  'entities.npcs.dg_spectator_tier7.name': '莫德·针线',
  'entities.npcs.dg_spectator_tier7.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier8.greeting': '上一场比赛喊哑了嗓子，值。今天还要再喊一次。',
  'entities.npcs.dg_spectator_tier8.name': '哑嗓佩洛',
  'entities.npcs.dg_spectator_tier8.title': '深玻璃观众',
  'entities.npcs.dg_spectator_tier9.greeting':
    '进球震塌台子的时候，别站在钟下面。前半句你就信我吧。',
  'entities.npcs.dg_spectator_tier9.name': '莉娃·暗流',
  'entities.npcs.dg_spectator_tier9.title': '深玻璃观众',
  'entities.npcs.dg_spectator_yard1.greeting':
    '我们那时候水更冷，球门更小。除此之外，其他的我都还看得过去。',
  'entities.npcs.dg_spectator_yard1.name': '老鸬鹚',
  'entities.npcs.dg_spectator_yard1.title': '深玻璃观众',
  'entities.npcs.dg_spectator_yard2.greeting': '我压了三枚银币在客队身上，现在全靠吃馅饼撑着。',
  'entities.npcs.dg_spectator_yard2.name': '哈罗·芬奇',
  'entities.npcs.dg_spectator_yard2.title': '深玻璃观众',
  'entities.npcs.dg_spectator_yard3.greeting': '一个秃头法师卖了我一程传送门上来，这铜板花得，值。',
  'entities.npcs.dg_spectator_yard3.name': '科尔宾·灰烬风标',
  'entities.npcs.dg_spectator_yard3.title': '深玻璃观众',
  'entities.npcs.dg_spectator_yard4.greeting':
    '唯独比赛日，峡谷的风里飘着炸面包的味道。跟着鼻子走就对了。',
  'entities.npcs.dg_spectator_yard4.name': '塞西·盐水',
  'entities.npcs.dg_spectator_yard4.title': '深玻璃观众',
  'entities.npcs.th_bridge_watch_0.greeting':
    '桥长一百三十码，横跨在黑冰之上，我的差事就是守好那道栏杆。想往下看就看，人人都看过一次。',
  'entities.npcs.th_bridge_watch_0.name': '跨桥守护官凯提尔·沃斯',
  'entities.npcs.th_bridge_watch_1.greeting':
    '桥长一百三十码，横跨在黑冰之上，我的差事就是守好那道栏杆。想往下看就看，人人都看过一次。',
  'entities.npcs.th_bridge_watch_1.name': '跨桥守护官玛拉·霜',
  'entities.npcs.th_dockhand_0.greeting':
    '船只就系在这块岩石上，悬在冰面之上。你要么习惯，要么就顺着堤道回下面去。',
  'entities.npcs.th_dockhand_0.name': '码头总管费罗·凯尔',
  'entities.npcs.th_dockhand_0.title': '系泊处',
  'entities.npcs.th_dockhand_1.greeting':
    '船只就系在这块岩石上，悬在冰面之上。你要么习惯，要么就顺着堤道回下面去。',
  'entities.npcs.th_dockhand_1.name': '索具女工塞娜·图尔',
  'entities.npcs.th_dockhand_1.title': '系泊处',
  'entities.npcs.th_gate_watch_0.greeting': '往前走吧，结界很安静，我希望能一直这样。',
  'entities.npcs.th_gate_watch_0.name': '守护官萨贝尔·奎斯特',
  'entities.npcs.th_gate_watch_0.title': '城门守卫',
  'entities.npcs.th_gate_watch_1.greeting': '往前走吧，结界很安静，我希望能一直这样。',
  'entities.npcs.th_gate_watch_1.name': '守护官托马斯·里尔',
  'entities.npcs.th_gate_watch_1.title': '城门守卫',
  'entities.npcs.th_keep_guard_0.greeting': '城门是凭守护官之命敞开的。钟声一响，留神闸门。',
  'entities.npcs.th_keep_guard_0.name': '卫兵奥塔',
  'entities.npcs.th_keep_guard_0.title': '守护官卫队',
  'entities.npcs.th_keep_guard_1.greeting': '朋友，别出院子。大殿是守护官的，塔楼是我们的。',
  'entities.npcs.th_keep_guard_1.name': '卫兵莉斯贝特',
  'entities.npcs.th_keep_guard_1.title': '守护官卫队',
  'entities.npcs.th_keep_guard_2.greeting':
    '守护官正在殿内理事。擦擦你的靴子，那地毯可是从金冠运来的。',
  'entities.npcs.th_keep_guard_2.name': '卫兵万斯',
  'entities.npcs.th_keep_guard_2.title': '守护官卫队',
  'entities.npcs.th_keep_guard_3.greeting': '求见的去大殿，送货的去厨房那一侧。你是哪一种？',
  'entities.npcs.th_keep_guard_3.name': '卫兵梅琳',
  'entities.npcs.th_keep_guard_3.title': '守护官卫队',
  'entities.npcs.th_market_folk_0.greeting':
    '赛事日，整片看台的人都跑上来采买了。看紧你的钱袋，也当心你的胳膊肘。',
  'entities.npcs.th_market_folk_0.name': '内塔·哈洛威',
  'entities.npcs.th_market_folk_0.title': '玻璃商',
  'entities.npcs.th_market_folk_1.greeting':
    '赛事日，整片看台的人都跑上来采买了。看紧你的钱袋，也当心你的胳膊肘。',
  'entities.npcs.th_market_folk_1.name': '布拉姆·库洛克',
  'entities.npcs.th_market_folk_1.title': '制绳匠',
  'entities.npcs.th_market_folk_2.greeting':
    '赛事日，整片看台的人都跑上来采买了。看紧你的钱袋，也当心你的胳膊肘。',
  'entities.npcs.th_market_folk_2.name': '修女伊沃·玛恩',
  'entities.npcs.th_market_folk_2.title': '潮之施赈者',
  'entities.npcs.th_market_folk_3.greeting':
    '赛事日，整片看台的人都跑上来采买了。看紧你的钱袋，也当心你的胳膊肘。',
  'entities.npcs.th_market_folk_3.name': '萨莉丝·奎伊',
  'entities.npcs.th_market_folk_3.title': '渡船管事',
  'entities.npcs.th_market_folk_4.greeting':
    '赛事日，整片看台的人都跑上来采买了。看紧你的钱袋，也当心你的胳膊肘。',
  'entities.npcs.th_market_folk_4.name': '老佩林',
  'entities.npcs.th_market_folk_4.title': '赛事黄牛',
  'entities.npcs.th_market_folk_5.greeting':
    '赛事日，整片看台的人都跑上来采买了。看紧你的钱袋，也当心你的胳膊肘。',
  'entities.npcs.th_market_folk_5.name': '耶娜·科尔',
  'entities.npcs.th_market_folk_5.title': '补网匠',
  'entities.npcs.th_row_folk_0.greeting': '住在这上头，风一停就能听见钟声，全城最好的地段。',
  'entities.npcs.th_row_folk_0.name': '术士伊尔韦恩·多斯',
  'entities.npcs.th_row_folk_0.title': '守护官家宅',
  'entities.npcs.th_row_folk_1.greeting': '住在这上头，风一停就能听见钟声，全城最好的地段。',
  'entities.npcs.th_row_folk_1.name': '普瑞尔大娘',
  'entities.npcs.th_row_folk_2.greeting': '住在这上头，风一停就能听见钟声，全城最好的地段。',
  'entities.npcs.th_row_folk_2.name': '安塞姆·科伊',
  'entities.npcs.th_row_folk_2.title': '玻璃匠',
  'entities.npcs.th_row_folk_3.greeting': '住在这上头，风一停就能听见钟声，全城最好的地段。',
  'entities.npcs.th_row_folk_3.name': '小鹪鹩',
};
