...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.farshore_isle.welcome':
    '走下渡船，鸥港的警钟会先于这座镇子寻到你。裂隙毫无预兆地撕裂开来，而这座堡垒守着自己的海岸，抵挡从中涌出的一切。他们已经等待像你这样的人很久了。',
  ...
  'entities.zones.eastbrook_vale.pois.11.label': '远岸渡口',
  ...
  'entities.quests.q_fs_bell_at_the_landing.completion':
    '航线还通着，塔姆也还有力气拿三响打趣。很好。我们是一座被围攻的岛，{playerName}，渡船送来的每一双手，都是裂隙要伤到我的人之前必须先闯过的一道关。欢迎来到鸥港。',
  'entities.quests.q_fs_bell_at_the_landing.objectives.0.label': '向守望者煤耐报到',
  'entities.quests.q_fs_bell_at_the_landing.text':
    '你是坐渡船过来的，{playerName}？那你是这一周里的头一个，守望者肯定想亲眼瞧瞧你。鸥港就在码头再往上，过了那排如今没人打理的晒网架。告诉守望者煤耐，航线还通着，塔姆今天也还没敲过三响。暂时还没有。',
  ...
  'lb.q0.scene.plinth':
    '港口石阶之上，青铜守望者面向内陆。基座上最新的名字已有百年：守望者黑尔。名字下面，还留着空位。',
  ...
  'entities.npcs.ferryman_ewald.greeting':
    '要去远岸，是吗？如今已经没人为了捕鱼过海了，朋友。准备好就上船；抵岸后留心钟声，镇上的人听钟，就像你听风辨天气一样。',
  'entities.npcs.ferrykeeper_odda.name': '渡船守·奥达',
  'entities.npcs.ferrykeeper_odda.title': '远岸航线',
  'entities.npcs.ferrykeeper_odda.greeting':
    '要回大陆？你上船，我们才启航，绝不会提前。如果解缆时钟声开始计数，别求我掉头：没人会朝三响钟划去。',
  'entities.npcs.sergeant_marsh.name': '马什中士',
  'entities.npcs.sergeant_marsh.title': '城镇民兵',
  'entities.npcs.sergeant_marsh.greeting':
    '受过训练？那就听好今晚的规矩。我的防线守住道路。裂隙要是吐出我们解决不了的东西，我就指给你。磨坊归你：什么都不许跟你进去，也什么都不许越过我们进镇。去吧。',
  'entities.quests.q_lb_q0_ashore.title': '上岸',
  'entities.quests.q_lb_q0_ashore.text':
    '鸥港日夜承受裂隙侵袭，却依然坚守。若你真想与他们并肩，就从城镇流血之处开始：穿过港口台阶和老雕像，向东去守望草甸的民兵防线。',
  'entities.quests.q_lb_q0_ashore.completion':
    '磨坊里的怪物是你独自杀掉的，塔姆对担架的事也没有夸大。我缺一个斥候，却有守不完的田野。今晚你守住了本不属于你的阵地，而这就是这份差事的全部。欢迎加入守望。',
