...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.dex_swap.disabled': '游戏内购买 $WOC 目前不可用。',
  'apiError.dex_swap.input_not_allowed': '不支持该支付代币。',
  'apiError.dex_swap.invalid_amount': '请输入有效的数量。',
  'apiError.dex_swap.invalid_slippage': '不允许该滑点设置。',
  ...
  'hudChrome.dexSwap.close': '关闭购买 $WOC',
  'hudChrome.dexSwap.launcher': '购买',
  'hudChrome.dexSwap.launcherAria': '用 SOL 或 USDC 购买 $WOC',
  'hudChrome.dexSwap.nonCustodial':
    '兑换通过 Jupiter DEX 聚合器路由，由你自己的钱包签名并发送。游戏绝不保管你的密钥或资金。',
  'hudChrome.dexSwap.amountLabel': '你支付',
  'hudChrome.dexSwap.tokenAria': '支付代币',
  'hudChrome.dexSwap.quoteButton': '获取报价',
  'hudChrome.dexSwap.quoting': '正在寻找最佳路径...',
  'hudChrome.dexSwap.amountInvalid': '请输入有效的数量。',
  'hudChrome.dexSwap.slippage': '最大滑点：{percent}%',
  'hudChrome.dexSwap.receiveLine': '你将获得约 {amount} $WOC',
  'hudChrome.dexSwap.payLine': '你支付 {amount} {symbol}',
  'hudChrome.dexSwap.priceImpact': '价格影响：{percent}%',
  ...
  'hudChrome.dexSwap.sentBody': '你的钱包已签名并发送兑换。网络确认后你的 $WOC 余额将更新。',
  'hudChrome.dexSwap.signatureLabel': '交易签名：{signature}',
  'hudChrome.dexSwap.viewOnExplorer': '在 Solana Explorer 上查看',
  'hudChrome.dexSwap.buyMore': '再购买 $WOC',
  'hudChrome.dexSwap.errWalletFeature':
    '你连接的钱包无法从游戏内发送交易。请尝试其他 Solana 钱包。',
  'hudChrome.dexSwap.errSignFailed': '交易未发送。可能已在你的钱包中被拒绝。',
  'hudChrome.dexSwap.errNoWallet': '请先连接 Solana 钱包。',
  // The rentable trading bots (M16 non-Latin fill)
  'apiError.trading_bots.disabled': '交易机器人目前不可用。',
  'apiError.trading_bots.unknown_sku': '目录中没有该机器人。',
  'apiError.trading_bots.invalid_pay_currency': '不支持该支付货币。',
  'apiError.trading_bots.already_subscribed': '你已经租用了一个交易机器人。',
  'apiError.trading_bots.subscription_required': '请先租用一个交易机器人。',
  'apiError.trading_bots.subscription_expired': '你的机器人租期已到期。请续租或提取资金。',
  'apiError.trading_bots.insufficient_claudium': 'Claudium 不足。',
  'apiError.trading_bots.invalid_amount': '请输入有效的数量。',
  'apiError.trading_bots.deposit_out_of_bounds': '该存入金额超出此机器人允许的范围。',
  'apiError.trading_bots.invalid_public_key': '请先连接 Solana 钱包。',
  'apiError.trading_bots.invalid_params': '不允许这些机器人设置。',
  'apiError.trading_bots.payment_not_found': '找不到该笔付款。请重新开始。',
  'apiError.trading_bots.payment_unverified': '该笔付款尚未确认。请稍候再试。',
  'apiError.trading_bots.vault_busy': '机器人金库正忙。请稍候再试。',
  'apiError.trading_bots.rate_limited': '请求过于频繁。请稍候再试。',
  'apiError.trading_bots.upstream_error': '交易机器人服务暂不可用，请稍后再试。',
  'hudChrome.tradingBots.title': '交易机器人',
  'hudChrome.tradingBots.close': '关闭交易机器人',
  'hudChrome.tradingBots.launcher': '机器人',
  'hudChrome.tradingBots.launcherAria': '租用 SOL 与 $WOC 交易机器人',
  'hudChrome.tradingBots.loading': '正在加载交易机器人...',
  'hudChrome.tradingBots.custody':
    '存款将进入由交易服务代你管理、设有上限的金库。提款只能发送到你已绑定的钱包，且你随时可以提取。',
  'hudChrome.tradingBots.riskNote': '自动交易可能造成亏损。租金不予退还。这不是投资建议。',
  'hudChrome.tradingBots.catalogIntro':
    '按月租用机器人，用 SOL 和 $WOC 组成的资金对注入金库，它就会在 DEX 上替你交易。',
  'hudChrome.tradingBots.skuGridName': '网格魔像',
  'hudChrome.tradingBots.skuGridBlurb': '在市场价格上下交替挂出买单和卖单，在价格波动时赚取价差。',
  'hudChrome.tradingBots.skuDcaName': '滴流精灵',
  'hudChrome.tradingBots.skuDcaBlurb': '按固定计划把 SOL 稳步兑换成 $WOC，分散你的买入时机。',
  'hudChrome.tradingBots.skuMomentumName': '动量幽光',
  'hudChrome.tradingBots.skuMomentumBlurb': '将资金对倾向趋势更强的一侧，趋势减弱时再调回平衡。',
  'hudChrome.tradingBots.priceWoc': '每月 {amount} $WOC',
  'hudChrome.tradingBots.priceClaudium': '每月 {amount} Claudium',
  'hudChrome.tradingBots.rentButton': '租用',
  'hudChrome.tradingBots.payWithLabel': '支付方式',
  'hudChrome.tradingBots.payWoc': '$WOC',
  'hudChrome.tradingBots.payClaudium': 'Claudium',
  'hudChrome.tradingBots.claudiumBalance': 'Claudium 余额：{amount}',
  'hudChrome.tradingBots.approvePayment': '请在钱包中批准租金支付...',
  'hudChrome.tradingBots.confirmingPayment': '正在网络上确认你的付款...',
  'hudChrome.tradingBots.subscribedBody': '机器人已租用。为金库注资即可开始交易。',
  'hudChrome.tradingBots.activeUntil': '有效期至 {date}',
  'hudChrome.tradingBots.fundTitle': '为金库注资',
  'hudChrome.tradingBots.solAmountLabel': '存入的 SOL',
  'hudChrome.tradingBots.wocAmountLabel': '存入的 $WOC',
  'hudChrome.tradingBots.depositBounds': '介于 {min} 与 {max} 之间',
  'hudChrome.tradingBots.depositButton': '存入',
  'hudChrome.tradingBots.approveDeposit': '请在钱包中批准该笔存款...',
  'hudChrome.tradingBots.confirmingDeposit': '正在网络上确认你的存款...',
  'hudChrome.tradingBots.amountInvalid': '请输入有效的数量。',
  'hudChrome.tradingBots.vaultLine': '金库：{sol} SOL，{woc} $WOC',
  'hudChrome.tradingBots.stateRunning': '运行中',
  'hudChrome.tradingBots.statePaused': '已暂停',
  'hudChrome.tradingBots.startButton': '启动',
  'hudChrome.tradingBots.pauseButton': '暂停',
  'hudChrome.tradingBots.paramsTitle': '策略设置',
  'hudChrome.tradingBots.paramGridSpacingBps': '网格间距（{percent}%）',
  'hudChrome.tradingBots.paramOrderSizeBps': '订单规模（{percent}%）',
  'hudChrome.tradingBots.paramDcaIntervalMinutes': '买入间隔（分钟）',
  'hudChrome.tradingBots.paramMomentumLookbackMinutes': '趋势回看（分钟）',
  'hudChrome.tradingBots.saveParams': '保存设置',
  'hudChrome.tradingBots.recentTrades': '最近交易',
  'hudChrome.tradingBots.noTrades': '暂无交易。',
  'hudChrome.tradingBots.tradeBuy': '买入',
  'hudChrome.tradingBots.tradeSell': '卖出',
  'hudChrome.tradingBots.pnlLine': '盈亏（{days} 天）：{amount} $WOC（{percent}%）',
  'hudChrome.tradingBots.withdrawButton': '全部提取',
  'hudChrome.tradingBots.withdrawTitle': '提取金库资金',
  'hudChrome.tradingBots.withdrawBody': '提取会暂停机器人，并将金库余额返还到你绑定的钱包。',
  'hudChrome.tradingBots.approveWithdraw': '请在钱包中批准该笔提款...',
  'hudChrome.tradingBots.withdrawPending': '提款正在进行中。网络确认后余额将更新。',
  'hudChrome.tradingBots.cooldown': '请求过于频繁。{seconds}秒后可重试。',
  'hudChrome.tradingBots.errWalletFeature':
    '你连接的钱包无法从游戏内发送交易。请尝试其他 Solana 钱包。',
  'hudChrome.tradingBots.errSignFailed': '交易未发送。可能已在你的钱包中被拒绝。',
  'hudChrome.tradingBots.errNoWallet': '请先连接 Solana 钱包。',
