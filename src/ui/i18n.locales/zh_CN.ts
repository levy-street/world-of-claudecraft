...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.source_cave.name': '源初洞穴',
  'entities.dungeons.source_cave.enterText': '你走进源初洞穴。',
  'entities.dungeons.source_cave.leaveText': '你离开了源初洞穴。',
  ...
  'sim.sourceCave.enter': '你走进源初洞穴。',
  'sim.sourceCave.leave': '你离开了源初洞穴。',
  'sim.sourceCave.rebootConfirm': '你确定要继续吗？按下之前，确保你已集结好所需的资源。',
  'sim.sourceCave.killProgress': '{name}倒下了。（已在源初洞穴击败 {killed}/{total}）',
  'sim.sourceCave.cleared': '源初洞穴已被清空。',
