...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  'editor.cinematic.authoredCamera': '使用编排镜头',
  'editor.cinematic.capture': '捕获关键帧',
  'editor.cinematic.captureCopyOnly': '已复制，开发写入器不可用',
  'editor.cinematic.captureReady': '区块已在下方生成',
  'editor.cinematic.captureSaved': '已保存，区块已在下方生成',
  'editor.cinematic.captureSavedCopied': '已保存并复制',
  'editor.cinematic.copy': '复制区块',
  'editor.cinematic.fade': '淡出：{percent}%',
  'editor.cinematic.hide': '隐藏面板',
  'editor.cinematic.letterboxOff': '宽银幕：关闭',
  'editor.cinematic.letterboxOn': '宽银幕：开启',
  'editor.cinematic.noViolations': '当前没有违规项',
  'editor.cinematic.output': '已生成的镜头捕获',
  'editor.cinematic.pause': '暂停',
  'editor.cinematic.play': '播放',
  'editor.cinematic.scene': '场景',
  'editor.cinematic.sceneOption': '{id}（{seconds} 秒）',
  'editor.cinematic.seedMismatch': '捕获需要正式世界种子',
  'editor.cinematic.show': '显示面板',
  'editor.cinematic.time': '时间',
  'editor.cinematic.timeReadout': '{current} / {duration} 秒',
  'editor.cinematic.title': '电影场景',
  'editor.cinematic.unavailable': '3D 视口加载中',
  'editor.cinematic.violationRow': '{check} | 操作 {opIndex} | {measured}',
  'editor.cinematic.violations': '违规项',
  'entities.dungeons.lb_breach.enterText': '光线不对，天空更糟。那颗核心就在前方的开阔地上。',
  'entities.dungeons.lb_breach.leaveText': '你跨过门槛，回到寻常的夜空之下。',
  'entities.dungeons.lb_breach.name': '裂隙之内',
  'entities.dungeons.lb_council.enterText': '议事厅里摆着六把椅子。其中一把空着。',
  'entities.dungeons.lb_council.leaveText': '你走出堡垒。',
  'entities.dungeons.lb_council.name': '堡垒议会',
  'entities.dungeons.lb_landing.enterText': '引航火沿海滩渐次燃烧。舰队在浅滩之外等待。',
  'entities.dungeons.lb_landing.leaveText': '你把登陆海滩留在身后。',
  'entities.dungeons.lb_landing.name': '夜间登陆场',
  'entities.dungeons.lb_lastwatch.enterText': '堡垒干净而空荡。总得有人结束这场守望。',
  'entities.dungeons.lb_lastwatch.leaveText': '你在身后关上堡垒大门。',
  'entities.dungeons.lb_lastwatch.name': '最后守望',
  'entities.dungeons.lb_riftfields.enterText': '四座守卫祭坛环绕着裂口。封裂仪式已经维系了十二个世纪。',
  'entities.dungeons.lb_riftfields.leaveText': '你从裂隙原向山下走去。',
  'entities.dungeons.lb_riftfields.name': '裂隙原进路',
  'entities.dungeons.lb_riftline.enterText': '草甸大门在巡逻队身后关闭。今夜属于这道防线。',
  'entities.dungeons.lb_riftline.leaveText': '你把裂隙防线留给黎明守卫。',
  'entities.dungeons.lb_riftline.name': '暮色裂隙防线',
  'entities.dungeons.lb_tidemill.enterText': '磨坊的门让开了。里面，黑暗正在聆听。',
  'entities.dungeons.lb_tidemill.leaveText': '你走出潮汐磨坊，回到傍晚的空气中。',
  'entities.dungeons.lb_tidemill.name': '潮汐磨坊',
  'entities.dungeons.lb_vault.enterText': '绳索向黑暗中放下。下方，旧堡垒躺在它坠落之处。',
  'entities.dungeons.lb_vault.leaveText': '你沿悬崖绳索爬回日光之下。',
  'entities.dungeons.lb_vault.name': '沉没的第一堡垒',
  ...
  'entities.mobs.lb_actor_coalfast.name': '守望者·煤耐',
  'entities.mobs.lb_actor_edda.name': '军需官·艾达',
  'entities.mobs.lb_actor_ollun.name': '裂察·奥伦',
  'entities.mobs.lb_actor_saul.name': '疗愈者·索尔',
  'entities.mobs.lb_actor_tam.name': '守钟人·塔姆',
  'entities.mobs.tidemill_stalker.name': '潮汐磨坊潜猎者',
  'entities.npcs.ferryman_ewald.greeting': '去远岸，是吗？朋友，如今没人为了打渔渡海了。准备好了就上船。上岸时留意钟声：镇上的人听钟，就像你看天色一样。',
  'entities.npcs.ferryman_ewald.name': '摆渡人·埃瓦尔德',
  'entities.npcs.ferryman_ewald.title': '远岸航线',
  'entities.npcs.ferryman_ewald_gullhaven.greeting': '去远岸，是吗？朋友，如今没人为了打渔渡海了。准备好了就上船。上岸时留意钟声：镇上的人听钟，就像你看天色一样。',
  'entities.npcs.ferryman_ewald_gullhaven.name': '摆渡人·埃瓦尔德',
  'entities.npcs.ferryman_ewald_gullhaven.title': '远岸航线',
  'entities.npcs.sergeant_marsh.greeting': '受过训练？那今晚就这么办。我的防线守住大路。要是裂隙吐出我们压不住的东西，我就指向你。磨坊交给你：别让任何东西跟着你进去，也别让任何东西越过我们进镇。去吧。',
  'entities.npcs.sergeant_marsh.name': '马什中士',
  'entities.npcs.sergeant_marsh.title': '城镇民兵',
  'entities.quests.q_lb_q0_ashore.completion': '磨坊那一战是你独自打下的，塔姆说的担架也毫不夸张。我缺一名斥候，田野却嫌太多。今晚你守住了本不属于你的阵地，而这正是这份职责的全部。欢迎加入守望队。',
  'entities.quests.q_lb_q0_ashore.objectives.0.label': '向守望草甸的马什中士报到',
  'entities.quests.q_lb_q0_ashore.objectives.1.label': '消灭裂隙孽生体',
  'entities.quests.q_lb_q0_ashore.objectives.2.label': '解决潮汐磨坊里的东西',
  'entities.quests.q_lb_q0_ashore.text': '鸥港日夜承受着裂口的冲击，却始终坚守。若你想与他们并肩，就从小镇流血的地方开始：守望草甸的民兵防线，在港口台阶和旧雕像以东。',
  'entities.quests.q_lb_q0_ashore.title': '上岸',
  'entities.zones.farshore_isle.pois.5.label': '裂口',
  'entities.zones.farshore_isle.pois.6.label': '沉船滩',
  ...
  'hudChrome.memorial.close': '关闭纪念碑',
  'hudChrome.memorial.dedication': '献给那些带着封印走进裂口、再未归来的鸥港守望者。小镇为他们守着这口钟。',
  'hudChrome.memorial.rollHeading': '英灵名录（{count}）',
  'hudChrome.memorial.roomRemaining': '最后一个名字下方的石面仍然空着。',
  'hudChrome.memorial.title': '纪念碑',
  'hudChrome.mountTraining.buyReinsPrompt': '骑术已学会。花10金币向玛拉购买英勇战马缰绳，使用后即可骑乘。',
  ...
  'hudChrome.scene.skipHint': '跳过场景（Esc）',
  'hudChrome.scene.waitingFor': '等待{name}',
  ...
  'lb.fare.decline': '今天不去。',
  'lb.fare.pay': '付船钱。',
  'lb.fare.promptBack': '渡海回大陆：{price} 铜币。',
  'lb.fare.promptOut': '渡海去远岸：{price} 铜币。',
  'lb.fixture.breach': '裂口',
  'lb.fixture.ferry': '远岸渡船',
  'lb.fixture.tidemill': '潮汐磨坊',
  'lb.q0.coalfast.look': '灰发男人看了看死去的怪物，又看了看你，目光略久。然后他朝崖边走了回去。',
  'lb.q0.scene.harbor': '一座劳作中的港口：渔网晾晒着，星璃打捞箱上印着大陆买家的戳记。',
  'lb.q0.scene.plinth': '港口台阶上方，一尊青铜守望者面朝内陆。基座上最新的名字已有百年：守望者海尔。名字下方还留有余位。',
  'lb.q0.scene.toll': '钟声响了一下。街上所有人都停下脚步，数着。没有后续，整条街同时松了口气。',
  'lb.q0.tam.stretchers': '上次出这么一个，搭进去全体守望一个上午，外加两副担架。',
  'lb.speaker.coalfast': '守望者科尔法斯特',
  'lb.speaker.edda': '军需官艾达',
  'lb.speaker.ollun': '裂隙观察者奥伦',
  'lb.speaker.saul': '医者扫罗',
  'lb.speaker.tam': '钟守塔姆',
