...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.castBar.casting': '施法中',
  'hudChrome.castBar.channeling': '引导中',
  'hudChrome.castBar.complete': '完成',
  'hudChrome.castBar.interrupted': '已打断',
  'hudChrome.castBar.failed': '失败',
  'hudChrome.castBar.interruptible': '可打断',
  'hudChrome.castBar.cannotInterrupt': '不可打断',
  'hudChrome.castBar.danger': '危险',
  'hudChrome.castBar.pet': '宠物',
  'hudChrome.castBar.secondsShort': '{seconds}秒',
  'hudChrome.castBar.labelWithCue': '{cue}：{label}',
  'hudChrome.castBar.ariaStatus': '{bar}：{status}{label}，剩余 {seconds}',
  'hudChrome.castBar.ariaOutcome': '{bar}：{status}{label}',
  'hudChrome.petAction.auto': '自动',
  'hudChrome.petAction.cooldownTitle': '{action}：剩余 {seconds}',
  'hudChrome.petAction.cooldownAutoAria': '{action}：剩余 {seconds}，{auto}',
  ...
  'abilityUi.cast.nythraxisWardChannel': '守卫引导',
