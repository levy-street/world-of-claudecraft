...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.emberforged_hauberk.name': '余烬锻造锁子甲',
  'entities.items.emberforged_legguards.name': '余烬锻造护腿',
  'entities.items.emberforged_girdle.name': '余烬锻造腰带',
  'entities.items.cinderhide_vest.name': '煤烬皮背心',
  'entities.items.moltencore_maul.name': '熔核巨锤',
  'entities.items.brand_of_the_first_flame.name': '初焰烙印',
  'entities.items.emberseal_of_the_covenant.name': '破碎誓约的余烬封印',
  'entities.items.bloodember_band.name': '血烬指环',
  'entities.items.ashcoil_signet.name': '灰烬盘绕印戒',
  ...
  'guide.dungeonsPage.abyssBody':
    '风暴峭壁之下的灼热裂隙，被锁链束缚的军团在此为炼狱之主鼓动熔炉。唯一的出路是向下：越过熔岩与深渊巨口，直抵深渊之心。',
  ...
  'entities.items.infernal_slag.name': '炼狱熔渣',
  'entities.items.charred_legion_tablet.name': '焦黑军团石板',
  'entities.items.brands_of_the_first_flame.name': '第一烈焰的烙印',
  'entities.items.forgekeepers_ledger.name': '铸炉守卫的账簿',
  'entities.items.azazels_broken_covenant.name': '阿撒兹勒的破碎契约',
  'entities.items.emberforged_vambraces.name': '烬铸臂甲',
  'entities.items.cinderthread_mantle.name': '灰线披肩',
  'entities.items.hellstalker_boots.name': '地狱猎手之靴',
  'entities.items.forgekeepers_warhammer.name': '铸炉守卫的战锤',
  'entities.items.forgekeepers_runestaff.name': '铸炉守卫的符文杖',
  'entities.items.forgekeepers_fang.name': '铸炉守卫之牙',
  'entities.items.azazels_ruinblade.name': '阿撒兹勒的毁灭之刃',
  'entities.items.azazels_soulstaff.name': '阿撒兹勒的灵魂法杖',
  'entities.items.azazels_emberfang.name': '阿撒兹勒的余烬之牙',
  'entities.items.hellforged_bulwark.name': '狱火壁垒',
  'entities.items.cinderseer_raiment.name': '烬视者法衣',
  'entities.items.abysswalker_harness.name': '深渊行者甲胄',
  'entities.mobs.abyssal_legionnaire.name': '深渊军团士兵',
  'entities.mobs.cinder_magus.name': '灰烬法师',
  'entities.mobs.molten_hellhound.name': '熔火地狱犬',
  'entities.mobs.flamebound_smith.name': '缚焰铁匠',
  'entities.mobs.abyssal_gladiator.name': '深渊角斗士',
  'entities.mobs.infernal_cinderling.name': '炼狱烬灵',
  'entities.mobs.forgekeeper.name': '铸炉守卫',
  'entities.mobs.pyre_golem.name': '火葬魔像',
  'entities.mobs.azazel_infernal_lord.name': '炼狱之主阿撒兹勒',
  'entities.quests.q_infernal_abyss_echoes.title': '风暴峭壁之下的回响',
  'entities.quests.q_infernal_abyss_echoes.text':
    '风暴峭壁并非诞生于风暴，{playerName}。最古老的石板称它为一只盖子，锤打在一团从世界之外坠落的烈火之上。东部峭壁下方裂开了一道新缝隙。与四名盟友一同进入，找回军团石板，以及刻在第一团烈焰旁的烙印。',
  'entities.quests.q_infernal_abyss_echoes.completion':
    '石板记载着一支自愿踏入烈火的大军。烙印则揭示了他们侍奉的力量：阿撒兹勒。这从来不是为了把恶魔挡在外面的监牢，{playerName}。这是一扇让他们的领主进入此世的大门。',
  'entities.quests.q_infernal_abyss_echoes.objectives.0.label': '已解读焦黑军团石板',
  'entities.quests.q_infernal_abyss_echoes.objectives.1.label': '已研究第一烈焰的烙印',
  'entities.quests.q_infernal_abyss_covenant.title': '破碎的契约',
  'entities.quests.q_infernal_abyss_covenant.text':
    '军团的誓言许诺为阿撒兹勒打开一条通往我们世界的道路，但每份契约都有代价，也有破绽。返回炼狱深渊。找到铸炉守卫的账簿，以及深渊巨口附近的破碎契约。若能弄清束缚他的力量，我们或许就能知道如何杀死他。',
  'entities.quests.q_infernal_abyss_covenant.completion':
    '破绽就在这里：阿撒兹勒以自己军团成员的名字为大门供能。每吞噬一名仆从，他都会变得更强，却也将自己的性命系在了下方的熔炉上。在那座熔炉的核心击溃领主，大门也必将随他一同消亡。',
  'entities.quests.q_infernal_abyss_covenant.objectives.0.label': '已找回铸炉守卫的账簿',
  'entities.quests.q_infernal_abyss_covenant.objectives.1.label': '已阅读阿撒兹勒的破碎契约',
  'entities.quests.q_infernal_abyss_azazel.title': '炼狱深渊之主',
  'entities.quests.q_infernal_abyss_azazel.text':
    '这份契约只给了我们一次机会，{playerName}。与值得信赖的同伴一同越过熔炉和深渊巨口，继续向下。在第一烈焰触及我们世界之处直面阿撒兹勒，抵挡他的军团，并在风暴峭壁成为他敞开的大门之前熄灭这位炼狱之主。',
  'entities.quests.q_infernal_abyss_azazel.completion':
    '山中寂静无声。不是沉睡，不是等待，只是彻底安静。阿撒兹勒用偷来的名字铸成永恒，而你用自己的一个凡人名字终结了它。高岗城会记住这个名字，{playerName}。',
  'entities.quests.q_infernal_abyss_azazel.objectives.0.label': '已击杀炼狱之主阿撒兹勒',
  'entities.dungeons.infernal_abyss.name': '炼狱深渊',
  'entities.dungeons.infernal_abyss.enterText': '你深入风暴峭壁之下，进入炼狱深渊。',
  'entities.dungeons.infernal_abyss.leaveText': '你从炉火般的黑暗中攀出，回到山风之中。',
