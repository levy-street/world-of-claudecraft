...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.mounts.title': '坐骑',
  'hud.mounts.subtitle': '$WOC 旅行坐骑',
  'hud.mounts.close': '关闭坐骑',
  'hud.mounts.summon': '召唤',
  'hud.mounts.dismount': '下骑',
  'hud.mounts.summoning': '正在召唤 {name}…',
  'hud.mounts.riding': '骑乘中',
  'hud.mounts.flies': '可飞行',
  'hud.mounts.locked': '已锁定',
  'hud.mounts.speed': '速度 +{percent}%',
  'hud.mounts.unlockAt': '持有 {amount} $WOC 即可解锁',
  'hud.mounts.supplyShare': '供应量的 {percent}',
  'hud.mounts.qualifyHeader': '你已符合 {total} 种旅行坐骑中的 {count} 种。',
  'hud.mounts.holdingHint': '持有 {amount} $WOC。',
  'hud.mounts.noWallet':
    '在已绑定的钱包中持有至少 {amount} $WOC（供应量的 0.1%），即可赢得你的第一匹旅行坐骑。',
  'hud.mounts.cantInCombat': '战斗中无法上骑。',
  'hud.mounts.cantSwimming': '游泳时无法上骑。',
  'hud.mounts.cantDead': '死亡时无法上骑。',
  'hud.mounts.notEligible': '你的 $WOC 持有量尚不足以驾驭那匹坐骑。',
  'hud.mounts.summonedBanner': '你召唤了 {name}。',
  'hud.mounts.summonAria': '召唤 {name}',
  'hud.mounts.dismountAria': '从 {name} 上下骑',
  'hud.mounts.lockedAria': '{name} — 已锁定；持有 {amount} $WOC 即可解锁',
  'hud.mounts.activeAria': '{name} — 当前已激活',
  'hud.mounts.owned': '已拥有',
  'hud.mounts.mint': '铸造凭证',
  'hud.mounts.mintHint': '为这匹坐骑铸造一张可交易的凭证——卖出换取金币，让未持有者也能赢得它。',
  'hud.mounts.mintAria': '为 {name} 铸造一张可交易的凭证',
  'hud.mounts.mintedBanner': '你为 {name} 铸造了一张凭证。',
  'hud.mounts.earnedBanner': '你已赢得 {name} — 它将永远归你所有。',
  'hud.mounts.alreadyOwnErr': '你已经拥有那匹坐骑。',
  'hud.mounts.charterVoidErr': '那张凭证已作废。',
  'hud.mounts.noCharterErr': '那匹坐骑无法铸造凭证。',
  'hud.mounts.holdingsShortErr': '你的持有量不足以驾驭那匹坐骑。',
  'hud.course.skytrials': '天试',
  'hud.course.skytrialsHint': '骑乘飞行坐骑飞过限时圆环赛道。',
  'hud.course.needFlyer': '召唤一匹飞行坐骑来飞越天试。',
  'hud.course.laps': '{count} 圈',
  'hud.course.starting': '穿过第一个圆环开始计时',
  'hud.course.finish': '完成！',
  'hud.course.failed': '本轮结束 — 你离开了坐骑',
  'hud.course.aborted': '本轮已放弃',
  'hud.course.newBest': '新纪录！',
  'hud.course.board': '榜单',
  'hud.course.boardTitle': '{name} — 最快用时',
  'hud.course.noTimes': '暂无成绩 — 来当第一个。',
  'hud.course.loadingBoard': '正在加载…',
  'hud.course.racePartyHint': '与你的队伍竞速 — 最先穿过圆环者获胜。',
  'hud.course.getReady': '准备就绪',
  'hud.course.racing': '竞速中',
  'hud.wager.start': '赌注竞速',
  'hud.wager.title': '赌注竞速',
  'hud.wager.inviteGold': '{name} 发起了一场赌注竞速 — 押 {money} 入场。要应战吗？',
  'hud.wager.inviteCharter': '{name} 发起了一场赌注竞速 — 押 {money} + 一张坐骑凭证。要应战吗？',
  'hud.wager.accept': '应下赌注',
  'hud.wager.potCharter': '彩池 {money} + {count}× 凭证',
  'hud.wager.racers': '参赛者（{count}）',
  'hud.wager.launch': '开赛',
  'hud.wager.cancel': '取消',
  'hud.wager.leave': '离开',
  'hud.wager.waiting': '正在等待挑战者应下赌注…',
  'hud.wager.won': '你赢得了赌注 — {money}！',
  'hud.wager.wonCharter': '你赢得了赌注 — {money} + {count}× 凭证！',
  'hud.wager.lost': '你输掉了赌注。',
  'hud.wager.refunded': '赌注已取消 — 你的押注已退回。',
  'hud.wager.antePrompt': '为这场竞速押多少金币？（以铜币计）',
  'hud.wager.open': '开设赌注',
  'hud.wager.stakeCharter': '同时押上一张坐骑凭证（胜者通吃）',
  'hud.wager.errCourse': '那条赛道不可用于赌注。',
  'hud.wager.errFlyer': '你必须骑乘飞行坐骑才能下注。',
  'hud.wager.errBusy': '你已经身处一场赌注之中。',
  'hud.wager.errAnte': '至少要押 1 铜币的赌注。',
  'hud.wager.errStake': '那无法作为赌注押上。',
  'hud.wager.errAfford': '你无力支付那笔赌注。',
  'hud.wager.errExpired': '那份赌注邀约已过期。',
  'hud.wager.errGone': '那场赌注已不再开放。',
  'hud.wager.errHost': '只有房主才能开赛。',
  'entities.items.charter_ashmane.name': '凭证：灰鬃疾行驹',
  'entities.items.charter_emberhoof.name': '凭证：烬蹄战驹',
  'entities.items.charter_bronzeflank.name': '凭证：铜胁战马',
  'entities.items.charter_silvermane.name': '凭证：银鬃骏马',
  'entities.items.charter_stormhoof.name': '凭证：风暴蹄战驹',
  'entities.items.charter_goldcrest.name': '凭证：金冠掠空者',
  'entities.items.charter_verdant.name': '凭证：苍翠野翼',
  'entities.items.charter_voidstrider.name': '凭证：虚空翼行者',
  'entities.items.charter_celestial.name': '凭证：天界炽天使',
  'entities.items.charter_worldbearer.name': '凭证：负世巨鹏',
  'entities.npcs.skytrial_master.name': '天空大师维尔',
  'entities.npcs.skytrial_master.title': '天试守望者',
  'entities.npcs.skytrial_master.greeting':
    '天空是一条少有人敢踏足的道路，{className}。赢得它，它便会载你而行。',
  'entities.quests.q_skyward_first_flight.title': '初次飞行',
  'entities.quests.q_skyward_first_flight.text':
    '你在地面上已能稳稳驾驭一匹有翼坐骑了，{playerName} — 现在带它升空吧。飞越溪谷天试：一次环形飞行穿过八个圆环。先别去追逐时间。只管留在空中，穿过每一个圆环。',
  'entities.quests.q_skyward_first_flight.completion':
    '你没有坠落。这已胜过大多数人初次环飞的表现。天空会记得那些不断归来的人。',
  'entities.quests.q_skyward_first_flight.objectives.0.label': '完成溪谷天试',
  'entities.quests.q_skyward_time_trial.title': '与时间赛跑',
  'entities.quests.q_skyward_time_trial.text':
    '现在带着心意去做。再飞一次溪谷天试，{playerName}，但要在沙漏漏尽之前完成。每个圆环走一条干净的线，不浪费一寸空气。要精准，不要慌乱。',
  'entities.quests.q_skyward_time_trial.completion':
    '一条干净的线，环环相扣。你不再只是骑着天空 — 你已在飞翔。',
  'entities.quests.q_skyward_time_trial.objectives.0.label': '在标准用时内飞完溪谷天试',
  'entities.quests.q_skyward_ascendant.title': '登天者',
  'entities.quests.q_skyward_ascendant.text':
    '只剩一场试炼了，{playerName}：溪谷环道。在标准用时内飞完长环三圈 — 不靠运气，只凭技艺。征服它，开阔的天空便从此岸到彼岸尽归你所有。',
  'entities.quests.q_skyward_ascendant.completion':
    '扶摇直上，无可阻挡。天空如今属于你了，{playerName}。收下这张凭证 — 一匹空中坐骑，是赢来的而非买来的，载你前往任何你心之所向之处。',
  'entities.quests.q_skyward_ascendant.objectives.0.label': '在标准用时内飞完溪谷环道',

  // Skytrial course + race HUD short labels (par/lap/ring/time/place/pot).
  'hud.mounts.cardAria': '{name}: {flavor}',
  'hud.course.start': '起飞',
  'hud.course.give_up': '放弃',
  'hud.course.par': '基准 {time}',
  'hud.course.onePass': '1 圈',
  'hud.course.gate': '圆环 {n}/{total}',
  'hud.course.lap': '第 {n}/{total} 圈',
  'hud.course.time': '时间',
  'hud.course.beatPar': '快出基准 {time}',
  'hud.course.offPar': '慢于基准 {time}',
  'hud.course.best': '最佳 {time}',
  'hud.course.you': '（你）',
  'hud.course.race': '比赛',
  'hud.course.go': '开始！',
  'hud.course.dnf': '未完成',
  'hud.course.placeOf': '第 {place} 名 / 共 {total}',
  'hud.wager.pot': '奖池 {money}',
  ...
  'character.renamePaidButton': '支付 {amount} $WOC 并改名',
  'character.renamePriceHint': '自愿改名将销毁 {amount} $WOC。',
  'character.renameCancel': '取消',
  'character.mintSolName': '获取 .sol 名称',
  'character.mintSolButton': '销毁 {amount} $WOC 并铸造',
  'character.mintSolHint':
    '以 {amount} $WOC 铸造玩家自有的‹名称›.worldofclaudecraft.sol，链上归你所有。',
  'woc.linkWalletFirst': '连接并绑定 Solana 钱包后即可用 $WOC 支付。',
  'woc.quoting': '正在准备 $WOC 支付…',
  'woc.approveBurn': '请在钱包中批准销毁 {amount} $WOC…',
  'woc.confirming': '正在链上确认销毁…',
  'woc.finalizing': '等待 Solana 最终确认…',
  'woc.confirmFailed': '无法验证 $WOC 支付。',
  'woc.finalizeTimeout':
    '等待最终确认超时。如果 $WOC 已销毁，请重新打开并重试：支付将在最终确认后结算。',
  'woc.renameSuccess': '已改名为 {name}。',
  'woc.mintSuccess': '已铸造 {domain}，链上归你所有。',
  'woc.guildRenameSuccess': '公会已改名为 {name}。',
  'woc.reserveSuccess': '已预留名称 {name}。',
  'walletPanel.title': '钱包',
  'walletPanel.closeAria': '关闭',
  'walletPanel.notConnected': '钱包未连接',
  'walletPanel.connect': '连接',
  'walletPanel.connectedStatus': '已连接 {address}',
  'walletPanel.linkedBadge': '已链接',
  'walletPanel.tabSend': '转账',
  'walletPanel.tabHire': '雇佣',
  'walletPanel.tabJobs': '委托',
  'walletPanel.sendSection': '转账给玩家',
  'walletPanel.currency': '货币',
  'walletPanel.playerName': '玩家名称',
  'walletPanel.recipientPlaceholder': '你要转给谁？',
  'walletPanel.amount': '金额',
  'walletPanel.max': '最大',
  'walletPanel.balanceEmpty': '余额: -',
  'walletPanel.balanceLoading': '余额: …',
  'walletPanel.balanceUnavailable': '余额: 不可用',
  'walletPanel.balance': '余额: {amount}',
  'walletPanel.balanceExceeds': '余额: {amount}（超出余额）',
  'walletPanel.connectForBalance': '连接钱包以查看余额。',
  'walletPanel.sendNote':
    '在 Solana 上钱包对钱包直接转账。非托管: 游戏绝不保管你的资金。需支付网络费用。',
  'walletPanel.send': '发送',
  'walletPanel.sending': '发送中…',
  'walletPanel.loginToSend': '登录并进入世界后才能给玩家转账。',
  'walletPanel.lookingUp': '正在查找玩家…',
  'walletPanel.ownWallet': '（这是你自己的钱包）',
  'walletPanel.noVerifiedWallet': '没有该名称的玩家拥有已验证的钱包。',
  'walletPanel.approveTransfer': '请在钱包中批准转账…',
  'walletPanel.sent': '已向{name}发送 {amount} {currency}。',
  'walletPanel.viewTransaction': '查看交易',
  'walletPanel.sendFailedWith': '发送失败: {message}',
  'walletPanel.sendFailed': '发送失败。',
  'walletPanel.hireSection': '雇佣帮手',
  'walletPanel.hireOffline': '在线进入世界后才能雇佣帮手。',
  'walletPanel.helperPlaceholder': '谁来帮你？',
  'walletPanel.rewardCurrency': '报酬货币',
  'walletPanel.reward': '报酬',
  'walletPanel.goalLabel': '目标，服务器确认后付款',
  'walletPanel.goalReachLevel': '达到等级',
  'walletPanel.goalClearDungeon': '通关团本',
  'walletPanel.goalQuest': '任务',
  'walletPanel.goalBodyguard': '保镖',
  'walletPanel.goalEscort': '护送',
  'walletPanel.targetLevel': '目标等级',
  'walletPanel.targetLevelPlaceholder': '2至20',
  'walletPanel.raidDungeon': '团本 / 地下城',
  'walletPanel.questOwn': '任务（你正在进行的）',
  'walletPanel.noActiveQuests': '你没有可以雇人帮忙的进行中任务，请先接一个任务。',
  'walletPanel.protectMinutes': '保护我（分钟）',
  'walletPanel.minutesPlaceholder': '例如 10',
  'walletPanel.escortDestination': '护送目的地',
  'walletPanel.useCurrentSpot': '使用我的当前位置',
  'walletPanel.destinationSet': '目的地已设置: ({x}, {z})',
  'walletPanel.noDestination': '尚未设置目的地。',
  'walletPanel.destinationHint': '目的地 ({x}, {z})，先离开，然后让你的护卫把你带回这里。',
  'walletPanel.hireLogin': '在线进入世界后才能雇佣玩家。',
  'walletPanel.escrowNote':
    '报酬会锁定在链上托管中，服务器确认目标后自动发放给帮手，若期限前未达成则退还给你。',
  'walletPanel.post': '发布并锁定报酬',
  'walletPanel.posting': '发布中…',
  'walletPanel.setGoalFirst': '请先设置有效的目标。',
  'walletPanel.preparingEscrow': '正在准备托管…',
  'walletPanel.approveDeposit': '请在钱包中批准报酬存入…',
  'walletPanel.lockingReward': '正在链上锁定报酬…',
  'walletPanel.waitingFinalization': '等待最终确认…',
  'walletPanel.confirmTimeout': '确认存款超时。如果报酬已锁定，最终确认后将自动结算。',
  'walletPanel.jobPosted': '委托已发布: {amount} {currency} 已为{name}锁定在托管中。',
  'walletPanel.postFailed': '发布委托失败。',
  'walletPanel.failedWith': '失败: {message}',
  'walletPanel.jobsSection': '你的委托',
  'walletPanel.loading': '加载中…',
  'walletPanel.jobsOffline': '在线进入世界后才能管理委托。',
  'walletPanel.jobsEmpty': '还没有委托。使用雇佣标签页付钱请玩家帮忙。',
  'walletPanel.youHired': '你雇佣了{name}',
  'walletPanel.hiredYou': '{name}雇佣了你',
  'walletPanel.acceptJob': '接受委托',
  'walletPanel.cancelRefund': '取消并退款',
  'walletPanel.viewPayout': '查看支付',
  'walletPanel.actionFailed': '操作失败。',
  'walletPanel.status.awaitingDeposit': '等待你的存款',
  'walletPanel.status.offered': '已向你发出，接受即可开始',
  'walletPanel.status.open': '开放中，等待帮手接受',
  'walletPanel.status.active': '进行中',
  'walletPanel.status.completed': '已完成，帮手已获付款',
  'walletPanel.status.expired': '已过期，已退款',
  'walletPanel.status.failedDied': '失败（你死亡了），已退款',
  'walletPanel.status.cancelled': '已取消，已退款',
  'walletPanel.status.refunded': '已退款',
};
