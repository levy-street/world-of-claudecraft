...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'itemUi.vendor.repairAll': '全部修理',
  'itemUi.vendor.repairAllAria': '花费{price}修理全部装备',
  'itemUi.vendor.repairAllHint': '将所有穿戴中的武器和护甲修理至满耐久。戒指和项链不会磨损。',
  'itemUi.vendor.repairAllUnaffordable': '你付不起这笔修理费。',
