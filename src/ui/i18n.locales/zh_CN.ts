...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.dungeons.undermount_wing2.name': '地底山: 淬火',
  'entities.dungeons.undermount_wing2.enterText': '蒸汽从前方被水淹没的锻炉中卷起。',
  'entities.dungeons.undermount_wing2.leaveText': '你把淬火大厅抛在身后。',
  'entities.dungeons.undermount_wing3.name': '地底山: 回火',
  'entities.dungeons.undermount_wing3.enterText': '锤击声在回火宝库中回荡。',
  'entities.dungeons.undermount_wing3.leaveText': '你从回响的炉道撤退。',
  'entities.dungeons.undermount_wing4.name': '地底山: 苏醒',
  'entities.dungeons.undermount_wing4.enterText': '被埋的熔炉在深处躁动。',
  'entities.dungeons.undermount_wing4.leaveText': '你从苏醒的热浪中撤离。',
  'entities.mobs.vosh_the_glazier.name': '玻匠沃什',
  'entities.mobs.saan_the_stoker.name': '司炉萨安',
  'entities.mobs.the_forge_heart.name': '锻炉之心',
