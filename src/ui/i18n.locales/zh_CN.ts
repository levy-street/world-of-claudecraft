...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'character.respec': '重置天赋',
  'character.respecHint': '燃烧 $WOC 以重置天赋或解锁额外的配装栏位。',
  'character.respecPaidButton': '花费 {amount} $WOC 重置天赋',
  'character.loadoutSlotPaidButton': '花费 {amount} $WOC 解锁配装栏位',
  'character.respecCancel': '取消',
  'character.respecSuccess': '天赋已重置。',
  'character.loadoutSlotSuccess': '配装栏位已解锁。',
  'errors.api.linkWalletFirst': '请先连接并绑定 Solana 钱包。',
  'errors.api.nameReserved': '该名字已被预订。',
  'errors.api.quoteExpired': '支付报价已过期，请重新开始。',
  'errors.api.paymentUsed': '该笔支付已被使用。',
