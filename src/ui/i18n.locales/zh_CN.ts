...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.character.tabs.equipment': '装备',
  'hudChrome.character.tabs.overview': '总览',
  'hudChrome.character.balances.claudium': '克劳迪姆',
  'hudChrome.character.bagSocket': '背包槽：{name}',
  'hudChrome.character.sections.attributes': '属性',
  'hudChrome.character.sections.combat': '战斗',
  'hudChrome.character.sections.defense': '防御',
  'hudChrome.character.spec.choose': '选择',
  'hudChrome.character.spec.change': '更改',
  'hudChrome.character.bags.openFull': '打开背包窗口',
  'hudChrome.character.bags.container': '背包 {n}',
  'hudChrome.character.bags.emptySpaces': '空位',
  'hudChrome.character.bags.emptySummary': '+{count} 个空位',
  'character.sortBy': '排序',
