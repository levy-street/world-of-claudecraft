...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mobileHudEditor.launcher': '自定义移动布局',
  'hudChrome.mobileHudEditor.title': '移动布局编辑器',
  'hudChrome.mobileHudEditor.dialogLabel': '自定义移动控件',
  'hudChrome.mobileHudEditor.dragHandleLabel': '移动编辑器面板',
  'hudChrome.mobileHudEditor.dragHandleHint': '拖动或使用方向键移动，按 Home 键可恢复居中。',
  'hudChrome.mobileHudEditor.locked': '锁定',
  'hudChrome.mobileHudEditor.unlocked': '解锁',
  'hudChrome.mobileHudEditor.lock': '锁布局',
  'hudChrome.mobileHudEditor.unlock': '解锁布局',
  'hudChrome.mobileHudEditor.sceneLabel': '预览场景',
  'hudChrome.mobileHudEditor.contextLabel': '预览状态',
  'hudChrome.mobileHudEditor.profileLabel': '设备简介',
  'hudChrome.mobileHudEditor.profilePhone': '手机',
  'hudChrome.mobileHudEditor.profileTablet': '平板电脑',
  'hudChrome.mobileHudEditor.save': '保存',
  'hudChrome.mobileHudEditor.cancel': '取消',
  'hudChrome.mobileHudEditor.showFailingLayout': '显示失败的布局',
  'hudChrome.mobileHudEditor.previousFailure': '以前的失败',
  'hudChrome.mobileHudEditor.nextFailure': '下一次失败',
  'hudChrome.mobileHudEditor.runtimeFallback':
    '{profile} 布局不适合此视口。内置默认值暂时处于活动状态。',
  'hudChrome.mobileHudEditor.storageError': '无法保存移动布局。您的草稿仍处于开放状态。',
  'hudChrome.mobileHudEditor.invalidSave': '保存之前修复每个布局错误。',
  ...
  'hudChrome.mobileHudEditor.scene.world': '世界',
  'hudChrome.mobileHudEditor.scene.arenaStandard': '竞技场标准',
  'hudChrome.mobileHudEditor.scene.arenaFiesta': '竞技场嘉年华',
  'hudChrome.mobileHudEditor.scene.arenaYumi': '竞技场由美',
  'hudChrome.mobileHudEditor.scene.valeCupBriefing': '溪谷杯简报',
  'hudChrome.mobileHudEditor.scene.valeCupMatch': '溪谷杯比赛',
  'hudChrome.mobileHudEditor.scene.valeCupSpectator': '溪谷杯观战',
  'hudChrome.mobileHudEditor.scene.delve': '探秘',
  'hudChrome.mobileHudEditor.context.worldBase': '世界',
  'hudChrome.mobileHudEditor.context.worldValeCupIndicator': '显示溪谷杯提示的世界',
  'hudChrome.mobileHudEditor.context.arenaStandard': '竞技场标准',
  'hudChrome.mobileHudEditor.context.arenaFiestaBase': '嘉年华比赛',
  'hudChrome.mobileHudEditor.context.arenaFiestaPending': '嘉年华待定',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawn': '嘉年华重生',
  'hudChrome.mobileHudEditor.context.arenaFiestaOffer': '嘉年华增加优惠',
  'hudChrome.mobileHudEditor.context.arenaFiestaRespawnOffer': '嘉年华重生并增强优惠',
  'hudChrome.mobileHudEditor.context.arenaYumiBase': '由美比赛',
  'hudChrome.mobileHudEditor.context.arenaYumiRespawn': '由美重生',
  'hudChrome.mobileHudEditor.context.arenaYumiReturning': '由美归来',
  'hudChrome.mobileHudEditor.context.valeCupBriefing': '溪谷杯简报',
  'hudChrome.mobileHudEditor.context.valeCupMatch': '溪谷杯比赛',
  'hudChrome.mobileHudEditor.context.valeCupMatchCharge': '溪谷杯蓄力射击',
  'hudChrome.mobileHudEditor.context.valeCupSpectatorBetting': '溪谷杯观战投注',
  'hudChrome.mobileHudEditor.context.instanceDelve': '探秘',
  'hudChrome.mobileHudEditor.surface.actionA1': '动作A1',
  'hudChrome.mobileHudEditor.surface.actionA2': '动作A2',
  'hudChrome.mobileHudEditor.surface.actionA3': '动作A3',
  'hudChrome.mobileHudEditor.surface.actionA4': '行动A4',
  'hudChrome.mobileHudEditor.surface.actionA5': '行动A5',
  'hudChrome.mobileHudEditor.surface.actionAttack': '攻击',
  'hudChrome.mobileHudEditor.surface.actionTarget': '目标',
  'hudChrome.mobileHudEditor.surface.actionJumpUse': '跳跃或使用',
  'hudChrome.mobileHudEditor.surface.actionPage': '动作页面切换',
  'hudChrome.mobileHudEditor.surface.controlMovement': '移动',
  'hudChrome.mobileHudEditor.surface.controlView': '视角',
  'hudChrome.mobileHudEditor.surface.utilityConsumables': '消耗品',
  'hudChrome.mobileHudEditor.surface.petCommands': '宠物命令',
  'hudChrome.mobileHudEditor.surface.party': '队伍',
  'hudChrome.mobileHudEditor.surface.menuTop': '顶部菜单',
  'hudChrome.mobileHudEditor.surface.minimapCluster': '小地图',
  'hudChrome.mobileHudEditor.surface.frameTarget': '目标框',
  'hudChrome.mobileHudEditor.surface.framePlayer': '玩家框',
  'hudChrome.mobileHudEditor.surface.playerBuffs': '玩家增益',
  'hudChrome.mobileHudEditor.surface.playerDebuffs': '玩家减益效果',
  'hudChrome.mobileHudEditor.surface.statusArenaGeneric': '竞技场状态',
  'hudChrome.mobileHudEditor.surface.statusFiestaScore': '嘉年华分数',
  'hudChrome.mobileHudEditor.surface.statusFiestaPending': '嘉年华待定状态',
  'hudChrome.mobileHudEditor.surface.protectedFiestaRespawn': '嘉年华重生提示',
  'hudChrome.mobileHudEditor.surface.protectedFiestaOffer': '嘉年华增加优惠',
  'hudChrome.mobileHudEditor.surface.statusYumi': '由美状态',
  'hudChrome.mobileHudEditor.surface.protectedYumiRespawn': 'Yumi重生提示',
  'hudChrome.mobileHudEditor.surface.statusValeCupIndicator': '溪谷杯提示',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBriefing': '溪谷杯简报',
  'hudChrome.mobileHudEditor.surface.statusValeCupMatch': '溪谷杯比赛状态',
  'hudChrome.mobileHudEditor.surface.statusValeCupCharge': '溪谷杯射击蓄力',
  'hudChrome.mobileHudEditor.surface.protectedValeCupBetting': '溪谷杯投注面板',
  'hudChrome.mobileHudEditor.surface.trackerDelve': '探秘追踪器',
  'hudChrome.mobileHudEditor.surface.protectedCenterMessage': '中央提示',
  'hudChrome.mobileHudEditor.control.nudgeUp': '向上移动',
  'hudChrome.mobileHudEditor.control.nudgeDown': '下移',
  'hudChrome.mobileHudEditor.control.nudgeLeft': '向左移动',
  'hudChrome.mobileHudEditor.control.nudgeRight': '向右移动',
  'hudChrome.mobileHudEditor.control.decreaseScale': '减小尺寸',
  'hudChrome.mobileHudEditor.control.increaseScale': '增加尺寸',
  'hudChrome.mobileHudEditor.control.orientation': '方向',
  'hudChrome.mobileHudEditor.control.horizontal': '水平的',
  'hudChrome.mobileHudEditor.control.vertical': '垂直的',
  'hudChrome.mobileHudEditor.control.order': '顺序',
  'hudChrome.mobileHudEditor.control.normalOrder': '正常顺序',
  'hudChrome.mobileHudEditor.control.reverseOrder': '反向顺序',
  'hudChrome.mobileHudEditor.control.openingDirection': '展开方向',
  'hudChrome.mobileHudEditor.control.openLeft': '向左展开',
  'hudChrome.mobileHudEditor.control.openRight': '向右展开',
  'hudChrome.mobileHudEditor.control.openUp': '向上展开',
  'hudChrome.mobileHudEditor.control.openDown': '向下展开',
  'hudChrome.mobileHudEditor.control.resetSelected': '重置所选内容',
  'hudChrome.mobileHudEditor.control.resetAll': '全部重置',
  'hudChrome.mobileHudEditor.status.noSelection': '选择一个控件进行编辑。',
  'hudChrome.mobileHudEditor.status.selected': '已选择：{surface}',
  'hudChrome.mobileHudEditor.status.scale': '尺寸：{scale}',
  'hudChrome.mobileHudEditor.status.valid': '布局准备保存。',
  'hudChrome.mobileHudEditor.status.invalid': '布局有 {count} 个阻塞错误。',
  'hudChrome.mobileHudEditor.status.failurePosition': '失败 {index}，共 {count} 个',
  'hudChrome.mobileHudEditor.failure.invalidPlacement': '{surface} 的展示位置无效。',
  'hudChrome.mobileHudEditor.failure.unsupportedCapability': '{surface} 使用不受支持的布局选项。',
  'hudChrome.mobileHudEditor.failure.scaleOutOfRange': '{surface} 尺寸超出其允许范围。',
  'hudChrome.mobileHudEditor.failure.targetTooSmall': '{surface} 太小，无法安全使用。',
  'hudChrome.mobileHudEditor.failure.outOfBounds': '{surface} 位于安全区域之外。',
  'hudChrome.mobileHudEditor.failure.overlap': '{surface} 与 {other} 重叠。',
  'hudChrome.mobileHudEditor.failure.viewIntrusion': '{surface} 与视图区域重叠。',
  'hudChrome.mobileHudEditor.failure.protectedOverlap': '{surface} 与 {other} 重叠。',
  'hudChrome.mobileHudEditor.discard.title': '放弃布局更改？',
  'hudChrome.mobileHudEditor.discard.body': '您未保存的移动布局更改将会丢失。',
  'hudChrome.mobileHudEditor.discard.confirm': '放弃更改',
  'hudChrome.mobileHudEditor.discard.continueEditing': '继续编辑',
  'hudChrome.mobile.nameplatesOff': '名称关闭',
  'hudChrome.mobile.musicOff': '音乐关闭',
  'hudChrome.mobile.showMenuButtons': '显示菜单按钮',
  'hudChrome.mobile.hideMenuButtons': '隐藏菜单按钮',
  'hudChrome.options.mobileActionPages': '最少动作页数',
  'hudChrome.options.mobileActionPagesTwo': '2 页',
  'hudChrome.options.mobileActionPagesThree': '3 页',
  'hudChrome.options.mobileActionPagesFour': '4 页',
  'hudChrome.bags.itemActionsTitle': '{item}操作',
  'hudChrome.bags.itemActionEquip': '装备',
  'hudChrome.bags.itemActionEquipBag': '装备背包',
  'hudChrome.bags.itemActionUse': '使用',
  'hudChrome.bags.itemActionConsume': '食用',
  'hudChrome.bags.itemActionLinkToChat': '链接到聊天',
  'hudChrome.bags.itemActionDestroy': '摧毁',
  'hudChrome.bags.itemActionDetails': '物品详情',
  'hudChrome.bags.itemActionAssignTitle': '分配到消耗品栏',
  'hudChrome.bags.itemActionAssignSlot': '分配到栏位{slot}',
  'hudChrome.bags.itemActionRemoveSlot': '从栏位{slot}移除',
  'hudChrome.bags.itemActionSlotCurrent': '栏位{slot}：{item}',
  'hudChrome.bags.itemActionSlotEmpty': '栏位{slot}：空',
  'hudChrome.bags.itemActionResetAutomatic': '恢复自动排列',
  'hudChrome.bags.itemActionClose': '关闭物品操作',
  'hudChrome.bags.itemActionAssigned': '已将{item}分配到栏位{slot}。',
  'hudChrome.bags.itemActionRemoved': '已将{item}从栏位{slot}移除。',
  'hudChrome.bags.itemActionInvalid': '该物品无法分配。',
  'hudChrome.bags.itemActionFailed': '无法完成该操作。',
  'hudChrome.spellbook.add': '添加',
  'hudChrome.spellbook.remove': '移除',
  'hudChrome.spellbook.mobileChip': '{page} - A{position}',
  'hudChrome.spellbook.desktopChip': '桌面端',
  'hudChrome.spellbook.moveAssignmentAria': '将 {name} 从 {slot} 移动',
  'hudChrome.spellbook.pickerPages': '动作页',
  'hudChrome.spellbook.pickerDestinations': '动作栏位',
  'hudChrome.spellbook.destinationAria': '第{page}页，A{position}，{state}',
  'hudChrome.spellbook.empty': '空',
  'hudChrome.spellbook.closePicker': '关闭栏位',
  'hudChrome.spellbook.assignedStatus': '{name} 已分配到第{page}页 A{position}',
  'hudChrome.itemTooltip.duration': '持续时间：{duration}',
  'mobilePreflight.androidSamsungInstallStep':
    '在 Samsung Internet 中点击菜单，然后选择安装应用或添加到主屏幕。',
};
