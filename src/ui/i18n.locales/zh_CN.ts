...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  "hud.mounts.noWallet": "在已绑定的钱包中持有至少 {amount} $WOC（供应量的 0.1%），即可赢得你的第一匹旅行坐骑。",
  ...
  "entities.npcs.skytrial_master.greeting": "天空是一条少有人敢踏足的道路，{className}。赢得它，它便会载你而行。",
  "entities.quests.q_skyward_first_flight.title": "初次飞行",
  "entities.quests.q_skyward_first_flight.text": "你在地面上已能稳稳驾驭一匹有翼坐骑了，{playerName} — 现在带它升空吧。飞越溪谷天试：一次环形飞行穿过八个圆环。先别去追逐时间。只管留在空中，穿过每一个圆环。",
  "entities.quests.q_skyward_first_flight.completion": "你没有坠落。这已胜过大多数人初次环飞的表现。天空会记得那些不断归来的人。",
  "entities.quests.q_skyward_first_flight.objectives.0.label": "完成溪谷天试",
  "entities.quests.q_skyward_time_trial.title": "与时间赛跑",
  "entities.quests.q_skyward_time_trial.text": "现在带着心意去做。再飞一次溪谷天试，{playerName}，但要在沙漏漏尽之前完成。每个圆环走一条干净的线，不浪费一寸空气。要精准，不要慌乱。",
  "entities.quests.q_skyward_time_trial.completion": "一条干净的线，环环相扣。你不再只是骑着天空 — 你已在飞翔。",
  "entities.quests.q_skyward_time_trial.objectives.0.label": "在标准用时内飞完溪谷天试",
  "entities.quests.q_skyward_ascendant.title": "登天者",
  "entities.quests.q_skyward_ascendant.text": "只剩一场试炼了，{playerName}：溪谷环道。在标准用时内飞完长环三圈 — 不靠运气，只凭技艺。征服它，开阔的天空便从此岸到彼岸尽归你所有。",
  "entities.quests.q_skyward_ascendant.completion": "扶摇直上，无可阻挡。天空如今属于你了，{playerName}。收下这张凭证 — 一匹空中坐骑，是赢来的而非买来的，载你前往任何你心之所向之处。",
