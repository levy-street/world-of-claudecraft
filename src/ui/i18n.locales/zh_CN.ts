...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.cruciblewrought_warhelm.name': '熔炉铸造战盔',
  'entities.items.emberveil_legguards.name': '烬幕护腿',
  'entities.items.vestment_of_the_last_spring.name': '最后泉源法袍',
  'entities.items.forgefathers_requiem.name': '锻父的安魂曲',
  'entities.items.plans_cruciblewrought_warhelm.name': '设计图：熔炉铸造战盔',
  'entities.items.pattern_emberveil_legguards.name': '图样：烬幕护腿',
  'entities.items.pattern_vestment_of_the_last_spring.name': '图样：最后泉源法袍',
  'entities.items.formula_lastflame_zeal.name': '公式：末焰狂热',
  'entities.quests.q_forgefathers_requiem.title': '锻父的安魂曲',
  'entities.quests.q_forgefathers_requiem.text': '瓦尔库尔的锻锤听命于他心口守着的东西：一块仍在燃烧的最后泉源余烬。把那块余烬带给我。技艺登峰造极的铁匠，能锻出他从不敢锻造之物。',
  'entities.quests.q_forgefathers_requiem.completion': '它仍在歌唱。铁匠，这不是寻常材料：这是他所囚禁的泉源之声。我会教你锻造之法，你的双手将完成他永远无法完成之事。',
  'entities.quests.q_forgefathers_requiem.objectives.0.label': '取回锻父的余烬',
  'entities.quests.q_requiem_at_the_forge.title': '炉边安魂曲',
  'entities.quests.q_requiem_at_the_forge.text': '锻造由你独自完成：十五颗末焰之核，最上等的瑟银与古木，再以那块余烬为心。在名副其实的熔炉旁锻出安魂曲，让泉源回应它的狱卒。',
  'entities.quests.q_requiem_at_the_forge.completion': '安魂曲就此以铁铸成。好好携带它，铁匠：再无他人之手能锻出与之比肩之物。',
  'entities.quests.q_requiem_at_the_forge.objectives.0.label': '锻造锻父的安魂曲',
  'hudChrome.enchanting.formulaNotLearned': '你尚未学会该公式。',
  'hudChrome.enchantName.enchant_weapon_lastflame_zeal': '附魔武器 - 末焰狂热',
  'hudChrome.itemProc.selfBuff': '为你附上{name}（{value}），持续{duration}秒',
  'hudChrome.itemProc.selfHeal': '并为你恢复{total}点生命值',
  'itemUi.kind.recipe': '配方',
};
