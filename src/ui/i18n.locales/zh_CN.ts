...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.invertX': '反转镜头（X轴）',
  'hudChrome.controller.invertMoveX': '反转移动（X轴）',
  'hudChrome.controller.invertMoveY': '反转移动（Y轴）',
  'hudChrome.controller.cameraAutoFollow': '镜头自动跟随',
