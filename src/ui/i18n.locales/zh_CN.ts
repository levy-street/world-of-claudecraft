...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bg.doubleHonorLine': '双倍荣誉日:今日荆谷原野荣誉奖励均为{mult}倍',
  ...
  'hudChrome.calendar.events.doubleHonor.title': '双倍荣誉日',
  'hudChrome.calendar.events.doubleHonor.note': '战营吹响集结号：每日重置前，荆谷原野荣誉奖励翻倍。',
