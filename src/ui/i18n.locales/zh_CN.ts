...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'marketplace.title': '创作者皮肤',
  'marketplace.subtitle': '玩家制作的外观，使用 USDC 购买。70% 归创作者；30% 用于买入并销毁 $WOC。',
  'marketplace.loading': '正在加载皮肤…',
  'marketplace.empty': '暂无在售的创作者皮肤。',
  'marketplace.connectFirst': '请先连接钱包以购买。',
  'marketplace.purchasing': '购买中…',
  'marketplace.owned': '已拥有 — 已装备',
  'marketplace.failed': '购买失败',
  ...
  'marketplace.tabCreate': '创作与出售',
  'marketplace.search': '搜索皮肤',
  'marketplace.anyClass': '任意职业',
  ...
  'marketplace.modeDesign': '设计',
  'marketplace.modeUpload': '上传',
  'marketplace.modeLink': '自托管',
  'marketplace.uploadIntro': '上传你自己的 1024x1024 PNG 图集。我们会将其固定到 IPFS 并为你托管。',
  'marketplace.linkIntro':
    '链接你自己托管的 PNG 图集。我们会代理访问,买家永远不会看到你的网址。免费。',
  'marketplace.linkUrl': '图集网址',
  'marketplace.quotaMeter': '已托管 {used}/{quota} 个位置',
  'marketplace.trustedBadge': '可信创作者(即时上架)',
  'marketplace.selfHostedFreeNote': '自托管免费且不限数量(在上架数量上限内)。',
  'marketplace.hostingUnavailable': '托管上传暂时不可用。',
  'marketplace.listedReview': '已提交审核,待运营人员批准后即会上架。',
  'marketplace.baseColor': '底色',
  'marketplace.patternColor': '图案颜色',
  'marketplace.accentColor': '点缀色',
  'marketplace.pattern': '图案',
  'marketplace.finishLabel': '质感',
  'marketplace.densityLabel': '密度',
  'marketplace.finishes.matte': '哑光',
  'marketplace.finishes.satin': '缎面',
  'marketplace.finishes.metallic': '金属',
  'marketplace.densities.low': '稀疏',
  'marketplace.densities.medium': '正常',
  'marketplace.densities.high': '密集',
  'marketplace.glowColor': '发光颜色',
  'marketplace.noGlow': '无发光',
  'marketplace.randomize': '随机',
  'marketplace.namePlaceholder': '例如:翡翠龙鳞',
  'marketplace.descLabel': '描述',
  'marketplace.descPlaceholder': '买家将看到的简短描述',
  'marketplace.priceLabel': '价格(USDC)',
  'marketplace.preview': '实时预览',
  'marketplace.list': '上架出售',
  'marketplace.listing': '上架中…',
  'marketplace.listed': '已上架,现已生效。可从你拥有的皮肤中装备它。',
  'marketplace.listFailed': '无法上架',
  'marketplace.listConnectFirst': '连接钱包后即可上架(你在此获得 70% 收益)。',
  'marketplace.payoutHint': '你获得 70% • 30% 用于回购并销毁 $WOC',
  'marketplace.patterns.solid': '纯色',
  'marketplace.patterns.scales': '鳞片',
  'marketplace.patterns.stripes': '条纹',
  'marketplace.patterns.diamond': '菱形',
  'marketplace.patterns.spots': '斑点',
  'marketplace.patterns.runes': '符文',
  'entities.npcs.skin_artisan.name': '皮肤工匠皮普',
  'entities.npcs.skin_artisan.title': '创作者皮肤公告板',
  'entities.npcs.skin_artisan.greeting':
    '想换个新造型吗,{className}?来逛逛玩家打造的外观皮肤,或者自己设计一款出售。以 USDC 结算;其中一部分用于回购并销毁 $WOC。',
  'hudChrome.nftSkins.intro': '证明你拥有 PFP NFT 即可穿戴：其特征塑造你的角色外观，原作则成为你的头像。持有该 NFT 期间一直有效。',
  'hudChrome.nftSkins.connectEthereum': '连接 Ethereum 钱包',
  'hudChrome.nftSkins.connectSolana': '连接 Solana 钱包',
  'hudChrome.nftSkins.ethereumLinked': 'Ethereum 钱包: {address}',
  'hudChrome.nftSkins.solanaLinked': 'Solana 钱包: {address}',
  'hudChrome.nftSkins.notLinked': '未绑定',
  'hudChrome.nftSkins.collectionsTitle': '支持的收藏集',
  'hudChrome.nftSkins.noCollections': '暂无可用的收藏集，请稍后再来查看。',
  'hudChrome.nftSkins.tokenIdPlaceholder': '代币 ID',
  'hudChrome.nftSkins.mintPlaceholder': '铸造地址',
  'hudChrome.nftSkins.claim': '认领',
  'hudChrome.nftSkins.claiming': '认领中...',
  'hudChrome.nftSkins.claimed': '已认领并装备。可随时在皮肤浏览器中查看。',
  'hudChrome.nftSkins.needWallet': '请先绑定对应的钱包。',
  'hudChrome.nftSkins.close': '关闭',
  'hudChrome.nftSkins.errorNotOwner': '该钱包不拥有此代币。',
  'hudChrome.nftSkins.errorUnverified': '暂时无法验证所有权，请稍后重试。',
  'hudChrome.nftSkins.errorCollection': '不支持该收藏集。',
  'hudChrome.nftSkins.errorTooMany': '已达到 NFT 皮肤上限。',
  'hudChrome.nftSkins.errorMetadata': '暂时无法读取此 NFT，请稍后重试。',
  'hudChrome.nftSkins.errorGeneric': '无法认领此 NFT 皮肤。',
  'hudChrome.nftSkins.walletError': '钱包连接失败。',
};
