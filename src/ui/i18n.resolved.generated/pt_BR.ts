...
export const pt_BR: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Escolha WOC Wallet, Phantom ou Solflare. Seu app de carteira pedirá aprovação. Mantenha o jogo aberto e retorne a ele quando terminar.",
    "standaloneAppHelp": "As conexões de carteira ainda não estão disponíveis no aplicativo da Tela Inicial. Abra o World of ClaudeCraft no Safari ou Chrome para usar WOC Wallet, Phantom ou Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "Nenhuma extensão de carteira compatível foi encontrada. Instale ou desbloqueie WOC Wallet, Phantom, Solflare ou outra carteira Solana para navegador e tente novamente.",
