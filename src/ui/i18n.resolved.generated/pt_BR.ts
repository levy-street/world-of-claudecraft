...
export const pt_BR: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "lootHistory": "Histórico",
      "title": "{tab} - {view}",
      "noCombat": "Nenhum combate registrado ainda.",
      "noLoot": "Nenhum saque registrado ainda.",
      "recentAwards": "{count} premiações recentes",
      "target": "Alvo: {name}",
      "noTargetEngaged": "Nenhum alvo engajado.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Passou",
      "methodMaster": "Mestre",
      "methodPersonal": "Pessoal",
      "methodDelve": "Exploração",
      "methodLooted": "Saqueado",
      "noWinner": "Sem vencedor",
      "rollDetail": "Rolagem {roll}",
