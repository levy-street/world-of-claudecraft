...
export const pt_BR: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "dune_prowler_pelt": {
        "name": "Pele de rondador das dunas"
      },
      "glasswind_stinger": {
        "name": "Ferrão de vento de vidro"
      },
      "stolen_relic": {
        "name": "Relíquia roubada"
      },
      "nameless_burial_shroud": {
        "name": "Mortalha funerária sem nome"
      },
      "storm_glass_core": {
        "name": "Núcleo de vidro de tempestade"
      },
      "verdict_seal": {
        "name": "Selo de veredito"
      },
      "glasswind_husk": {
        "name": "Casca de vento de vidro"
      },
      "mirage_stalker_eye": {
        "name": "Olho de espreitador de miragens"
      },
      "dig_manifest": {
        "name": "Manifesto de escavação"
      },
      "tomb_censer": {
        "name": "Incensário tumular"
      },
      "sentence_tablet": {
        "name": "Tabuleta de sentença"
      },
      "duststorm_heart": {
        "name": "Coração de tempestade de poeira"
      },
      "ravager_hide": {
        "name": "Pele de devastador"
      },
      "aqueduct_bronze": {
        "name": "Encaixe de bronze do aqueduto"
      },
      "judge_regalia": {
        "name": "Paramentos da Primeira Corte"
      },
      "sunbleached_fang": {
        "name": "Presa alvejada pelo sol"
      },
      "cracked_scarab_shell": {
        "name": "Casco de escaravelho rachado"
      },
      "emberjaw_pelt": {
        "name": "Pele da matriarca Mandíbula de Brasa"
      },
      "karns_funeral_mask": {
        "name": "Máscara funerária de Karn"
      },
      "qesh_flatbread": {
        "name": "Pão achatado de Qesh"
      },
      "oasis_waterskin": {
        "name": "Cantil do oásis"
      },
      "spiced_scarab_skewer": {
        "name": "Espetinho de escaravelho apimentado"
      },
      "duneweave_robe": {
        "name": "Manto de trama das dunas"
      },
      "caravan_guard_hauberk": {
        "name": "Cota de guarda de caravana"
      },
      "prowlerhide_vest": {
        "name": "Colete de pele de rondador"
      },
      "sandwalker_treads": {
        "name": "Passadas do andarilho das areias"
      },
      "dunewatch_legguards": {
        "name": "Perneiras da vigia das dunas"
      },
      "qesh_khopesh": {
        "name": "Khopesh de Qesh"
      },
      "judgestaff_of_ossara": {
        "name": "Cajado de juiz de Ossara"
      },
      "glasswind_talon": {
        "name": "Garra de vento de vidro"
      },
      "emberjaw_prowlgrips": {
        "name": "Manoplas de caça da Mandíbula de Brasa"
      },
      "unburied_gravewraps": {
        "name": "Ataduras sepulcrais do Insepulto"
      },
      "sandmaw_scale_cuirass": {
        "name": "Couraça de escamas de Goela de Areia"
      },
      "tyrantfang_edge": {
        "name": "Lâmina Presa de Tirano"
      },
      "palewidow_silk": {
        "name": "Seda de viúva pálida"
      },
      "waterlogged_ledger": {
        "name": "Livro-razão encharcado"
      },
      "guildless_sigil": {
        "name": "Sígilo dos sem guilda"
      },
      "silent_court_seal": {
        "name": "Selo da Corte Silenciosa"
      },
      "duskmane_pelt_strip": {
        "name": "Tira de pele de crina crepuscular"
      },
      "palewidow_venom_sac": {
        "name": "Bolsa de veneno de viúva pálida"
      },
      "quay_manifest": {
        "name": "Manifesto encharcado do cais"
      },
      "wisplight_essence": {
        "name": "Essência de fogo-fátuo"
      },
      "drowned_toll_coin": {
        "name": "Moeda de pedágio afogada"
      },
      "cutthroat_contract": {
        "name": "Contrato de degolador"
      },
      "court_ledger_page": {
        "name": "Página do livro da Corte"
      },
      "frostpine_war_totem": {
        "name": "Totem de guerra do Pinho da Geada"
      },
      "rimeclaw_pelt": {
        "name": "Pele de garra de geada"
      },
      "duskmane_tuft": {
        "name": "Tufo de crina crepuscular"
      },
      "guttering_wisp_mote": {
        "name": "Fagulha de fogo-fátuo tremulante"
      },
      "frostpine_charm": {
        "name": "Amuleto do Pinho da Geada"
      },
      "palefang_pelt": {
        "name": "Pele de Presa Pálida, o Silencioso"
      },
      "grelnoks_frozen_idol": {
        "name": "Ídolo congelado de Grelnok"
      },
      "nighthollow_black_bread": {
        "name": "Pão preto de Grotanoite"
      },
      "pinefrost_tea": {
        "name": "Chá de geada de pinho"
      },
      "smoked_blackmere_eel": {
        "name": "Enguia defumada do Lago Negro"
      },
      "wispweave_robe": {
        "name": "Manto de trama de fogo-fátuo"
      },
      "quayguard_hauberk": {
        "name": "Cota de guarda do cais"
      },
      "duskstalker_vest": {
        "name": "Colete de espreitador do crepúsculo"
      },
      "nightpath_treads": {
        "name": "Passadas da trilha noturna"
      },
      "blackriver_legguards": {
        "name": "Perneiras do Rio Negro"
      },
      "terracewatch_leggings": {
        "name": "Calças da vigia dos terraços"
      },
      "quays_cutlass": {
        "name": "Cutelo dos cais"
      },
      "wispcaller_staff": {
        "name": "Cajado do chama-fátuos"
      },
      "whispersteel_stiletto": {
        "name": "Estilete de aço sussurrante"
      },
      "palefang_grips": {
        "name": "Manoplas de Presa Pálida"
      },
      "hoarbound_bindings": {
        "name": "Amarras do Preso à Geada"
      },
      "forsworn_lamellar": {
        "name": "Couraça lamelar do Perjuro"
      },
      "forsworn_edge": {
        "name": "Lâmina do Perjuro"
      },
      "stolen_tithe_ledger": {
        "name": "Livro de dízimos roubado"
      },
      "granite_core_shard": {
        "name": "Estilhaço de núcleo de granito"
      },
      "legion_deserter_insignia": {
        "name": "Insígnia de desertor da Legião"
      },
      "chewed_tithe_scrip": {
        "name": "Vale de dízimo mastigado"
      },
      "candle_tax_tally": {
        "name": "Registro do imposto das velas"
      },
      "assay_office_seal": {
        "name": "Selo do gabinete de ensaio"
      },
      "legion_pay_manifest": {
        "name": "Manifesto de soldo da Legião"
      },
      "prime_wolf_pelt": {
        "name": "Pele de lobo de primeira"
      },
      "wendigo_gallstone": {
        "name": "Cálculo biliar de wendigo"
      },
      "icehowler_ruff": {
        "name": "Golilha de uivador do gelo"
      },
      "legion_quarrel_bundle": {
        "name": "Feixe de virotes da Legião"
      },
      "clipped_imperial_coin": {
        "name": "Moeda imperial cerceada"
      },
      "rimewoven_hide": {
        "name": "Pele tecida de geada"
      },
      "sellsword_pig_iron": {
        "name": "Ferro-gusa de mercenário"
      },
      "lean_wolf_haunch": {
        "name": "Perna magra de lobo"
      },
      "pilfered_ration_pack": {
        "name": "Pacote de rações surrupiado"
      },
      "sellsword_requisition_chit": {
        "name": "Vale de requisição de mercenário"
      },
      "frostbrush_wolf_fang": {
        "name": "Presa de lobo de Matagelo"
      },
      "bent_legion_buckle": {
        "name": "Fivela entortada da Legião"
      },
      "ogre_knuckle_dice": {
        "name": "Dados de junta de ogro"
      },
      "hoarfang_pelt": {
        "name": "Pele do alfa Presa de Geada"
      },
      "kazriks_brass_whistle": {
        "name": "Apito de latão de Kazrik"
      },
      "kaelspire_barley_loaf": {
        "name": "Pão de cevada de Agulha de Kael"
      },
      "silverbrook_spring_water": {
        "name": "Água de nascente do Riacho de Prata"
      },
      "imperial_field_ration": {
        "name": "Ração imperial de campanha"
      },
      "imperial_clerks_robe": {
        "name": "Manto de escrivão imperial"
      },
      "kael_infantry_hauberk": {
        "name": "Cota de infantaria de Kael"
      },
      "wolfsward_hunting_jerkin": {
        "name": "Gibão de caça de Guarda-Lobos"
      },
      "tithe_road_marchboots": {
        "name": "Botas de marcha da Estrada do Dízimo"
      },
      "imperial_marcher_legguards": {
        "name": "Perneiras de marchador imperial"
      },
      "kael_arming_sword": {
        "name": "Espada de armar de Kael"
      },
      "frosthelm_warstaff": {
        "name": "Cajado de guerra de Elmo da Geada"
      },
      "wolfsward_skinner": {
        "name": "Esfolador de Guarda-Lobos"
      },
      "prefects_sealed_mantle": {
        "name": "Manto selado do prefeito"
      },
      "huntmasters_winter_hood": {
        "name": "Capuz de inverno do mestre de caça"
      },
      "hoarfang_clawgrips": {
        "name": "Manoplas de garra de Presa de Geada"
      },
      "overseers_candlewraps": {
        "name": "Ataduras de velas do capataz"
      },
      "oathbreakers_battleplate": {
        "name": "Placas de batalha do Quebra-Juramentos"
      },
      "oathbreakers_greatblade": {
        "name": "Montante do Quebra-Juramentos"
      },
      "grey_shale_chip": {
        "name": "Lasca de xisto cinzento"
      },
      "smuggled_trinket": {
        "name": "Bugiganga contrabandeada"
      },
      "barbed_thorn_husk": {
        "name": "Vagem de espinhos farpados"
      },
      "thornfen_tusk": {
        "name": "Presa de trol do Brejo Espinhoso"
      },
      "torn_caravan_banner": {
        "name": "Estandarte de caravana rasgado"
      },
      "ironpass_rubble_core": {
        "name": "Núcleo de entulho do Passo de Ferro"
      },
      "wyvern_tail_barb": {
        "name": "Farpa de cauda de serpe"
      },
      "reagent_gland": {
        "name": "Glândula inchada de reagentes"
      },
      "fogged_lantern_glass": {
        "name": "Vidro de lampião embaçado"
      },
      "river_worn_idol": {
        "name": "Ídolo polido pelo rio"
      },
      "gull_picked_bone": {
        "name": "Osso bicado por gaivotas"
      },
      "underway_hardtack": {
        "name": "Biscoito da Passagem Baixa"
      },
      "smugglers_black_brew": {
        "name": "Beberagem negra de contrabandista"
      },
      "thornberry_loaf": {
        "name": "Pão de bagas espinhosas"
      },
      "palisade_pine_tea": {
        "name": "Chá de pinho da Paliçada"
      },
      "tollhouse_stew": {
        "name": "Ensopado da Casa do Pedágio"
      },
      "ironpass_mulled_cider": {
        "name": "Sidra quente do Passo de Ferro"
      },
      "lanternfen_eel_skewer": {
        "name": "Espetinho de enguia do Brejo do Lampião"
      },
      "fogberry_tonic": {
        "name": "Tônico de bagas de névoa"
      },
      "bridgewatch_rations": {
        "name": "Rações da Vigia da Ponte"
      },
      "nameless_river_water": {
        "name": "Água do rio sem nome"
      },
      "smuggler_kings_softsteps": {
        "name": "Passos macios do Rei Contrabandista"
      },
      "briarfather_bark_mitts": {
        "name": "Luvas de casca do Pai dos Espinheiros"
      },
      "skarns_war_harness": {
        "name": "Arreios de guerra de Skarn"
      },
      "colossus_mireheart_girdle": {
        "name": "Cinturão Coração do Lodo"
      },
      "bridgekeepers_tollstaff": {
        "name": "Cajado de pedágio do Guardião da Ponte"
      },
      "melted_ration_tin": {
        "name": "Lata de rações derretida"
      },
      "ashcaked_fang": {
        "name": "Presa encrostada de cinzas"
      },
      "ember_glass_shard": {
        "name": "Estilhaço de vidro de brasa"
      },
      "saltglass_shard": {
        "name": "Estilhaço de vidro de sal"
      },
      "salt_crusted_chitin": {
        "name": "Quitina encrostada de sal"
      },
      "bleached_bone_charm": {
        "name": "Amuleto de osso alvejado"
      },
      "tarnished_prewar_coin": {
        "name": "Moeda manchada de antes da guerra"
      },
      "sewer_silk_wad": {
        "name": "Novelo de seda de esgoto"
      },
      "gutter_hound_pelt": {
        "name": "Pele de cão de sarjeta"
      },
      "cracked_salamander_scale": {
        "name": "Escama de salamandra rachada"
      },
      "cooled_magma_bead": {
        "name": "Conta de magma resfriado"
      },
      "slag_nugget": {
        "name": "Pepita de escória"
      },
      "rusted_deserter_badge": {
        "name": "Distintivo enferrujado de desertor"
      },
      "redspire_rock_shard": {
        "name": "Estilhaço de rocha da Agulha Rubra"
      },
      "spire_stalker_claw": {
        "name": "Garra de espreitador das agulhas"
      },
      "cinderrest_ashcake": {
        "name": "Bolo de cinzas de Pouso das Brasas"
      },
      "boiled_cistern_water": {
        "name": "Água de cisterna fervida"
      },
      "brinehollow_salt_jerky": {
        "name": "Charque salgado de Grota Salobra"
      },
      "desalted_waterskin": {
        "name": "Cantil de água dessalinizada"
      },
      "gutter_stew": {
        "name": "Ensopado de sarjeta do Mercado do Exílio"
      },
      "black_market_tea": {
        "name": "Chá de mercado negro"
      },
      "forgefall_hardtack": {
        "name": "Biscoito de Forja Caída"
      },
      "coalfire_stout": {
        "name": "Cerveja preta de fogo de carvão"
      },
      "waymeet_marching_bread": {
        "name": "Pão de marcha do Último Encontro"
      },
      "bitterroot_brew": {
        "name": "Beberagem de raiz amarga"
      },
      "revenant_cinderguard": {
        "name": "Guarda-cinzas do renascido"
      },
      "marrowhide_leggings": {
        "name": "Perneiras de pele de tutano"
      },
      "scavenger_kings_shiv": {
        "name": "Estilete do Rei Carniceiro"
      },
      "forgewyrm_scale_helm": {
        "name": "Elmo de escamas do verme da forja"
      },
      "mantle_of_the_last_muster": {
        "name": "Manto da Última Convocação"
      },
      "scorched_banner_scrap": {
        "name": "Farrapo de estandarte chamuscado"
      },
      "melted_signet_ring": {
        "name": "Anel de sinete derretido"
      },
      "cracked_horror_horn": {
        "name": "Chifre de horror rachado"
      },
      "bastion_hardtack": {
        "name": "Biscoito do Bastião"
      },
      "trucewater_flask": {
        "name": "Frasco de água de trégua"
      },
      "ashguard_robe": {
        "name": "Manto guarda-cinzas"
      },
      "breachwalker_jerkin": {
        "name": "Gibão do andarilho da Brecha"
      },
      "bastion_plated_hauberk": {
        "name": "Cota chapeada do Bastião"
      },
      "bastion_arming_sword": {
        "name": "Espada de armar do Bastião"
      },
      "mercenary_greatblade": {
        "name": "Montante de mercenário"
      },
      "tithe_collectors_grasps": {
        "name": "Manoplas do coletor de dízimos"
      },
      "craterheart_mantle": {
        "name": "Manto Coração da Cratera"
      },
      "butchers_chainguard": {
        "name": "Cota do Açougueiro"
      },
      "vhorlans_flensing_blade": {
        "name": "Lâmina esfoladora de Vhorlan"
      },
      "warbringers_hellforged_cuirass": {
        "name": "Couraça forjada no inferno do Belicoso"
      },
      "khorvax_warcleaver": {
        "name": "Rachador de guerra de Khorvax"
      },
      "conjured_bread4": {
        "name": "Rolo de canela conjurado"
      },
      "conjured_bread5": {
        "name": "Pão de fermentação natural conjurado"
      },
      "conjured_bread6": {
        "name": "Bolo doce conjurado"
      },
      "conjured_water4": {
        "name": "Água cristalina conjurada"
      },
      "conjured_water5": {
        "name": "Água glacial conjurada"
      },
      "conjured_water6": {
        "name": "Água da montanha conjurada"
      },
      "linen_pouch": {
        "name": "Bolsa de linho"
      },
      ...
      "forged_levy_papers": {
        "name": "Papéis de recrutamento falsificados"
      },
      "amnesty_petition": {
        "name": "Petição de anistia não protocolada"
      },
      "fort_pattern_kettle": {
        "name": "Chaleira padrão do forte"
      },
      "garnished_pay_pouch": {
        "name": "Bolsa de soldo penhorada"
      },
      "fault_line_core": {
        "name": "Núcleo de falha"
      },
      "unstamped_duel_permit": {
        "name": "Licença de duelo sem carimbo"
      },
      "rimeclaw_tallow": {
        "name": "Sebo de garra-gelada"
      },
      "rimeclaw_marrowbone": {
        "name": "Osso medular de garra-gelada"
      },
      "oathguard_plate_scrap": {
        "name": "Fragmento de placa do Guarda-juramento"
      },
      "ninth_muster_roll": {
        "name": "Rol de convocação resgatado"
      },
      "icehowler_haunch": {
        "name": "Pernil de uivador do gelo"
      },
      "rimebound_core_ice": {
        "name": "Gelo nuclear crestado"
      },
      "glacial_quench_ice": {
        "name": "Gelo de têmpera glacial"
      },
      "maren_calling_card": {
        "name": "Cartão de visita da Casa Maren"
      },
      "maldreks_route_ledger": {
        "name": "Livro de rotas de Maldrek"
      },
      "grulks_iron_strongbox": {
        "name": "Cofre de ferro de Grulk"
      },
      "maren_duelling_mantle": {
        "name": "Manto de duelo Maren"
      },
      "final_notice_wraps": {
        "name": "Faixas do último aviso"
      },
      "pay_wardens_shoulderguards": {
        "name": "Ombreiras do guardião do soldo"
      },
      "rimeshaft_foremans_cap": {
        "name": "Boné do capataz de Rimeshaft"
      },
      "quarter_close_vestments": {
        "name": "Vestes de fechamento de trimestre"
      },
      "assessors_lead_greaves": {
        "name": "Grevas de chumbo do avaliador"
      },
      "purse_wardens_coinbelt": {
        "name": "Cinto de moedas do guardião das bolsas"
      },
      "mothwing_dust": {
        "name": "Pó de asa de mariposa"
      },
      "silt_eel": {
        "name": "Enguia do lodo"
      },
      "barge_chit": {
        "name": "Ficha de balsa encharcada"
      },
      "ferry_lantern_mote": {
        "name": "Fagulha de lanterna da balsa"
      },
      "smugglers_tally_knot": {
        "name": "Nó de contagem do contrabandista"
      },
      "forged_weir_pass": {
        "name": "Salvo-conduto do dique falsificado"
      },
      "sunken_ration_tin": {
        "name": "Lata de rações afundada"
      },
      "hollow_toll_scrip": {
        "name": "Vale de pedágio vazio"
      },
      "rimeclaw_haunch": {
        "name": "Pernil de garra-gelada"
      },
      "rimebound_fetish": {
        "name": "Fetiche crestado"
      },
      "frostpine_tallow": {
        "name": "Sebo de pinheiro gelado"
      },
      "forsworn_oath_knife": {
        "name": "Faca de juramento Perjura"
      },
      "shadowbound_cipher": {
        "name": "Cifra presa às sombras"
      },
      "vessiks_little_book": {
        "name": "Livrinho de Vessik"
      },
      "weirwatch_wraps": {
        "name": "Faixas da Guarda do dique"
      },
      "lodgewalk_boots": {
        "name": "Botas do Alojamento"
      },
      "unbroken_wardstone": {
        "name": "Pedra de guarda intacta"
      },
      "vault_ward_core": {
        "name": "Núcleo de guarda da cripta"
      },
      "temple_offering_bowl": {
        "name": "Tigela de oferendas do templo"
      },
      "graven_name_stone": {
        "name": "Pedra de nomes gravada"
      },
      "stalker_haunch": {
        "name": "Pernil de espreitador"
      },
      "heretic_creed_page": {
        "name": "Página de credo queimada"
      },
      "heretic_brand_iron": {
        "name": "Ferro de marcar herege"
      },
      "heretic_writ": {
        "name": "Escrito herege"
      },
      "first_court_sigil": {
        "name": "Sigilo da Primeira Corte"
      },
      "duneglass_heart": {
        "name": "Coração de vidro das dunas"
      },
      "unshattered_fulgurite": {
        "name": "Fulgurita intacta"
      },
      "flameseer_ash_creed": {
        "name": "Tabuleta do Credo das Cinzas"
      },
      "flameseer_ember_phial": {
        "name": "Frasco de brasas"
      },
      "dawnward_censer": {
        "name": "Turíbulo da Aurora"
      },
      "stolen_water_cask": {
        "name": "Barril de água lacrado"
      },
      "duskwater_oathmark": {
        "name": "Marca de juramento de Água-crepúsculo"
      },
      "caravan_toll_tally": {
        "name": "Talha de pedágio lacrada"
      },
      "tyrant_spoor": {
        "name": "Molde de rastro do Tirano"
      },
      "oxbone_toll": {
        "name": "Talha de osso de boi"
      },
      "cartographers_map": {
        "name": "O mapa do Primeiro Cartógrafo"
      },
      "templestone_shard": {
        "name": "Lasca de pedra do templo"
      },
      "fulgurite_splinter": {
        "name": "Estilhaço de fulgurita"
      },
      "charred_censer_chain": {
        "name": "Corrente de turíbulo carbonizada"
      },
      "wardens_stone_heart": {
        "name": "Coração de pedra de Ashkerat"
      },
      "first_meridian_compass": {
        "name": "Bússola do Primeiro Meridiano"
      },
      "seatstone_flatbread": {
        "name": "Pão achatado da Sede"
      },
      "seatwell_waterskin": {
        "name": "Odre do poço da Sede"
      },
      "lastwater_jerky": {
        "name": "Charque de Última Água"
      },
      "lastwater_skin": {
        "name": "Odre de Última Água"
      },
      "vaultkeepers_handwraps": {
        "name": "Faixas de mão do guardião da cripta"
      },
      "sahrs_penitent_leggings": {
        "name": "Perneiras penitentes de Sahr"
      },
      "wardens_granite_edge": {
        "name": "Gume de granito do Guardião"
      },
      "staff_of_the_sunken_court": {
        "name": "Cajado da Corte Submersa"
      },
      "duneglass_shiv": {
        "name": "Estilete de vidro das dunas"
      },
      "lastwater_roadmail": {
        "name": "Cota de estrada de Última Água"
      },
      "duskwatch_robe": {
        "name": "Túnica da Vigília do Crepúsculo"
      },
      "raiders_dust_jerkin": {
        "name": "Gibão empoeirado do saqueador"
      },
      "ashkerat_greaves": {
        "name": "Grevas de Ashkerat"
      },
      "cartographers_windwraps": {
        "name": "Faixas de vento do Cartógrafo"
      },
      "unlit_silk_gland": {
        "name": "Glândula de seda apagada"
      },
      "veskals_fang": {
        "name": "Presa de Veskal"
      },
      "broodmother_carapace_guard": {
        "name": "Guarda de carapaça da Matriarca da ninhada"
      },
      "condensed_mist_heart": {
        "name": "Coração de névoa condensada"
      },
      "mistfathers_knot": {
        "name": "O nó do Pai da Névoa"
      },
      "fogwalker_treads": {
        "name": "Pisadas do andarilho da névoa"
      },
      "bristleback_maul": {
