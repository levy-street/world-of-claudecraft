...
export const pt_BR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customizeSlotSkill": "Habilidade {n}",
      "customizeSlotUtility": "Utilidade",
      "customizeDefault": "Padrão da classe",
      "customizeResetSlot": "Redefinir este espaço",
      "customizeResetAll": "Redefinir tudo para os padrões da classe",
      "customizeUpdated": "{slot} atualizado.",
      "customizeAllReset": "Controles redefinidos para os padrões da classe."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Atraso de toque para editar",
      "clusterHoldNote": "Por quanto tempo segurar um botão de ação na tela antes de abrir o editor de atribuição. Aumente se o editor abrir enquanto você usa habilidades rapidamente.",
      "targetPriority": "Prioridade de alvo de ataque",
      "targetPriorityNearest": "Mais próximo",
      "targetPriorityLowestHp": "Menor vida",
      "targetPriorityCurrent": "Atual primeiro",
      "targetPriorityNote": "O que o botão de Ataque mira quando você não tem um alvo válido: o inimigo mais próximo, o inimigo com menor vida ao alcance, ou mantém seu alvo atual enquanto ele continuar válido.",
      "aimAssist": "Conjuração inteligente",
      "aimAssistNote": "Pressione uma habilidade ofensiva para conjurá-la no seu alvo, ou no melhor inimigo próximo se você não tiver nenhum, virando-se para ele. Segure o botão para ver o alcance da habilidade; solte com o dedo fora do botão para cancelar.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Redefinir controles de toque",
      "touchResetDone": "Controles de toque restaurados para o padrão.",
