...
export const da_DK: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "Tilpas",
      "customizeTitle": "Tilpas kontroller",
      "customizeSlotAttack": "Grundangreb",
      "customizeSlotSkill": "Evne {n}",
      "customizeSlotUtility": "Nytte",
      "customizeDefault": "Klassestandard",
      "customizeResetSlot": "Nulstil denne plads",
      "customizeResetAll": "Nulstil alt til klassestandard",
      "customizeUpdated": "{slot} opdateret.",
      "customizeAllReset": "Kontroller nulstillet til klassestandard."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "touchControls": "Berøringsstyring",
      "clusterHold": "Redigér holdetid",
      "clusterHoldNote": "Hvor længe du skal holde en handlingsknap på skærmen, før dens bindingsredigering åbnes. Øg den, hvis du udløser redigeringen, mens du spammer evner.",
      "targetPriority": "Angrebsmålprioritet",
      "targetPriorityNearest": "Nærmeste",
      "targetPriorityLowestHp": "Lavest liv",
      "targetPriorityCurrent": "Nuværende først",
      "targetPriorityNote": "Hvad Angreb-knappen målretter, når du ikke har et gyldigt mål: den nærmeste fjende, fjenden med lavest liv inden for rækkevidde, eller behold dit nuværende mål, så længe det er gyldigt.",
      "aimAssist": "Smart evnekast",
      "aimAssistNote": "Tryk på en offensiv evne for at bruge den mod dit mål, eller den bedste fjende i nærheden, hvis du ingen har, og vend dig mod den. Hold knappen for at se evnens rækkevidde; slip med fingeren væk fra knappen for at annullere.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Nulstil berøringsstyring",
      "touchResetDone": "Berøringsstyring gendannet til standard.",
