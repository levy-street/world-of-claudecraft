...
export const da_DK: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      "editKeys": "Rediger handlingslinjetaster",
      "editKeysHint": "Klik på en plads på handlingslinjen, og tryk derefter på en tast for at binde den.",
      "bannerHint": "Klik på en plads, og tryk derefter på en tast for at binde den. Klik på Udført, når du er færdig.",
      "bannerCapturing": "Tryk på en tast for at binde denne plads...",
      "boundToKey": "Bundet til {key}.",
      "reset": "Nulstil",
      "done": "Færdig",
      "cancel": "Ophæve",
      "resetConfirmTitle": "Nulstille handlingslinjetasterne?",
      "resetConfirmBody": "Den første bjælke vender tilbage til standardtasterne. Anden og tredje takt bliver ubundet. Dette kan ikke fortrydes."
    },
    "mounts": {
      "title": "Ridedyr",
      "close": "Luk",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "I 1v1 og 2v2 parentes spiller hver fighter All-Rounder kittet. Skøder, der kræver 3v3-beslaget eller større, kan ikke optjenes her.",
      "role": {
        "allrounder": {
          "name": "Allrounder",
      ...
      "practiceUnratedNote": "Øvelseskampe er ikke bedømte: stillinger og fremskridt i Bog of Deeds tæller ikke.",
      ...
      "briefing": {
        ...
        "unratedNote": "Bots er på banen, så denne kamp er ikke vurderet: Stillingen flytter sig ikke, og målsager, redninger og clean sheets tæller ikke.",
        "practiceUnratedNote": "Dette er en træningskamp, ​​så den er ikke bedømt: Stillingen flytter sig ikke, og fremskridt i gerningsbogen tæller ikke.",
    ...
    "materialHint": {
      "fineGrade": "Fin karakter. Samlet fra en hel-tier vene med et værktøj rangeret over materialet, og tæller som den almindelige version, hvor end det er nødvendigt.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Du skal bruge en tier {tier} fiskestang for at fiske disse farvande."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Du har brug for Mining {skill} for at svinge picken allerede i dine tasker.",
        "logging": "Du skal bruge Logging {skill} for at svinge øksen allerede i dine tasker.",
        "herbalism": "Du har brug for Herbalism {skill} for at bearbejde seglen allerede i dine tasker."
      },
      "wieldUnmetCorpse": "Du har brug for at samle færdigheder {skill} for at få dit bedste værktøj til at fungere.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Påkrævet for at fiske vand op til niveau {tier}."
        },
        "use": {
      ...
      "stateCooldownTimed": "Genopretter i {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Dit værktøj forfiner dette udbytte til finkvalitet."
    },
    "archetypeTitle": {
      "label": "Titel",
      "none": "Ingen",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} af {max} debiteringer",
      "toolEffectSpent": "Brugt, trænger til genopladning",
      "toolEffectDepleted": "Værktøjseffekt brugt",
      "toolEffectRechargePrice": "Genopladning: {count} x {material}",
      "toolEffectModeAsk": "Spørg hver brug",
      "toolEffectModePrompt": "Spørger hver brug",
      "toolEffectConfirmTitle": "Vil du bruge {effect}?",
      "toolEffectConfirmBody": "Brug en afgift på denne høst? Faldende samler stadig, uden bonus. Afgifter tilbage: {charges}.",
      "toolEffectConfirmAccept": "Brug en Charge",
      "toolEffectConfirmDecline": "Saml uden",
      "toolEffectName": {
        "gatherersCache": "Samlers cache",
        "artisansEye": "Håndværkerens øje",
        "quickeningCharm": "Springback charme"
      },
      "toolEffectSlotButton": "Slot {effect}",
      "toolEffectRechargeButton": "Genoplad",
      "toolEffectSlotted": "{effect} indsat på {profession}.",
      "toolEffectSlotInvalid": "{effect} kan ikke placeres der.",
      "toolEffectNoTool": "Du skal først have et rigtigt {profession} værktøj.",
      "toolEffectNoCharm": "Du skal bruge en udformet {effect} charm i dine tasker.",
      "toolEffectNoGain": "{effect} er allerede spaltet og fuldt opladet.",
      "toolEffectRecharged": "{effect} genopladet: {material} x{count} forbrugt.",
      "toolEffectRechargeNoSlot": "Der er ingen effekt på {profession}.",
      "toolEffectRechargeFull": "{effect} er allerede fuldt opladet.",
      "toolEffectRechargeToolCapped": "Medbring et bedre {profession}-værktøj for at oplade {effect} yderligere.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(bruger {count} fine karakter)",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Del skødoplåsninger med guildmates og følgere og skøde- og mesterværkskort med Discord-feedet",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "archetypeSwitchBody": "En erklæring er heller ikke en livstidsdom. Et par, du aldrig har holdt, er simpelthen en frisk afstemningsmission, mens at vende tilbage til et par, du gik væk fra, beder dig om at gøre det godt igen først: Fem opgaver første gang, og yderligere tre tilføjet for hver tilbagevenden, du allerede har foretaget (at tage et helt nyt par hæver aldrig tallet). Valget forbliver meningsfuldt uden nogensinde at låse en dør for altid.",
      "whatHeading": "Et håndværk ved siden af sværdet",
      "whatBody": "Professioner er verdens arbejdsliv: Fire samlende fag, der trækker råvarer direkte ud af landet, og en ring af ti håndværk, der gør det til grej, måltider, eliksirer og værktøj. Alt nærer noget andet her. Den malm, du miner, bliver til en klinge, klingen tager en fortryllelse, og fortrylleren har brug for støv, der er brudt ud af gammelt gear, så en samler, en håndværker og en pillemager er alle led i én kæde.\n\nDer er ingen faglig grænse at pine sig over. Hver karakter kan opdrage syv af de otte håndværk, der har indhold i dag, og alle fire samlende erhverv side om side (teknik er det eneste holdout: dens opskrifter starter alle over det frie loft, så dens stige venter på Bombardierens ed); det eneste eksklusive valg er din arketype, den identitet du til sidst sværger til, men når du først tilpasser de håndværk, der falder i dvale bag det, klatrer kun på deres almindelige opskrifter, og tidligere færdigheder 75 slet ikke. Færdighed falder aldrig, og intet du lærer bliver nogensinde taget væk.",
      ...
      "archetypesBody": "De ti håndværk sidder på et fast hjul, og geografi på det hjul betyder noget. Hver to naboer danner et navngivet par: Smith for våben- og panserarbejde, outfitter for læderbearbejdning og skræddersyet, Apothecary for Alchemy and Cooking, Bombardier for Engineering and Alchemy, og seks mere omkring ringen.\n\nTilpasning til et par er en søgen, ikke et menuklik. Fire par kan samles i dag (Smith, Outfitter, Apothecary og Bombardier), som hver er forankret af en bosiddende mester i Eastbrook, hvis accept-quest angiver hele købet på forhånd, før du tager det. Indtil du erklærer, går hvert håndværk frit videre på opskrifter op gennem det sjældne niveau (enhver opskrift, der kræver færdighed 74 eller mindre), så du kan prøve næsten alt, før du vælger (Engineering alene har ingen opskrift så lav, så antallet venter).\n\nNår du først er indstillet, bliver dine to par håndværk dine hovedfag, uden at der er et loft under hætten. Resten af ​​hjulet bliver ikke mørkt: Et fartøj modsat dine majors bliver ved som en hobby, der bliver ved med at klatre gennem det sjældne niveau (en gentagelig mission i Smith Haldrens smedje giver dig mulighed for at bytte hvilket), og hvert andet fartøj går i dvale. Et slumrende håndværk bevarer sine færdigheder og sine almindelige opskrifter, som bliver ved med at lære det på den normale kurve, indtil de gråner ved 75; alt over almindeligt holder op med at betale med det samme, og et slumrende håndværk bliver aldrig et mesterværk, mens det hviler.",
      "pairFmt": "{a} og {b}",
      ...
      "startBody": "Frisk fra vejen i Eastbrook? Find Foreman Odell og tag A Trade for Every Hand: Han vil pege dig mod malmårerne omkring Copper Dig sydøst for byen og give dig dine første hård hud. Pas på selve udgravningen: Deeprock Diggers, der slog lejr på den, står et par niveauer over en frisk ankomst, så arbejd de afsidesliggende årer først og gem lejrens hjerte til, når du har jævnet lidt. Fra da af skal du høste alle årer, træbevoksninger og urter, du passerer, mens du søger; færdigheder kommer naturligt for rejsende.\n\nTilbage i byen skal du trykke på T for at åbne håndværksvinduet og arbejde med de almindelige opskrifter, som hver karakter kender fra starten. Besøg mestrene i smedjen, køkkenerne, væven og værktøjsværkerne for at se, hvad de underviser i, og tag deres arbejdsordrer til fast mønt. På det tidspunkt, hvor laugets brev finder dig, vil du allerede vide, hvilket par der føles som hjemme.",
      "colStation": "Station",
      "colHub": "Knudepunkt",
      "colMaster": "Mester",
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Engineering bygger de redskaber, som enhver seriøs samler ender med at have brug for: tier 4 og tier 5 hakker, økser, segl og fiskestænger, som ingen tæller nogensinde vil sælge for mønt, og hver enkelt forbruger værktøjet under sig.",
        "enchanting": "Fortryllende skiller gear fra hinanden og sætter kræfterne i igen: Bryd uønskede stykker i mystiske materialer, og brug dem derefter på en permanent stat-bonus for en brik, du vil beholde. Brydende og fortryllende behøver ingen station og ingen træner, og alle kan starte på dag ét; kun de to charmeopskrifter spørger mere, undervist på værktøjsværket."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "Minedrift er rygraden. Kobbermalm kommer fra tier 1-årerne i Eastbrook Vale, jernmalm fra Mirefen Marsh og osmiummalm fra Thornpeak Heights, og hvert trin på stigen træder op på samme måde. Træhugst betyder mere, end du måske forventer: Jernbark griber ornespydet, asketræ står på maulen, og en enkelt træstamme udgør kampstaven.\n\nResten kommer fra jagten og disken. Groft skjul til greb høstes direkte af ulv- og orne-lig, knoglefragmenter kommer af de urolige døde eller ud af reddet fælles udstyr, og smedestigen brænder Smithing Flux, 20 kobber en krukke fra Darva selv. Hvis din egen minedrift sakker bagud, vil ingen tæller spare dig på selve malmen: osmium kommer fra Thornpeak-årerne, fra startårerne i hver yngre zone undtagen Farshore (hvis årer graver jern), eller ud af en anden spillers stak, ved handel eller verdensmarkedet. Kun Glyphsteel Bar er købt for mønt, fra Tinker Gizzel på værktøjsværket eller Quartermaster Bree i Highwatch.",
          ...
          "routeBody": "Ethvert stykke med en ægte stat-linje, som på denne stige betyder jerntrinnet og op, kan komme af ambolten som et mesterværk, så længe den finere kvalitet passer inde i dit etageloft; den statløse kobberalmue proc aldrig, for der er intet i dem at forbedre. Jern og osmium tæller som tier 1-materialer til mesterværksbonussen, highpine og glyphsteel som tier 2, og færdigheder, der sidder over en opskrifts egen tier, tilføjer sit eget point pr. tier, så blandt osmium tre er det krigsøksen og kampstaven, der bærer materialets kant, og et trin bliver ved med at skride bedre frem, efter du er vokset fra det.\n\nKør kobbertrinnet til 25, træn jerntrinnet den dag, det åbner, og kør det til 50, så gik osmiumtrinnet til 75. Sidst 75 er der intet højere skibe endnu, så osmium-opskrifterne falmer til det halve og derefter en kvart gevinst: budgetter med cirka 150 håndværk mere for at nå de 125 håndværk, når 125-fartøjet går ned, og husk, at aktionen går ned, når 10. batch.\n\nFinansier opstigningen, mens du går: Darvas smedearbejde tager otte kobbermalm fra dine hænder hvert 30. minut for en lille mønt og XP, og jern- og osmiumtrinene sælger ærligt til udjævning af nærkampe. The Book of Deeds markerer Edge and Temper ved færdighed 50 og kroner Grandmaster Weaponcrafting til 125."
        },
        "armorcrafting": {
          "identityHeading": "Ringbrynje til frontlinjen",
          "identityBody": "Armorcrafting's stige lyder som en soldats karriere: det almindeligt nittede kobberbælte, sabatoner og handskerne til at starte, jernleds-hauberk, benbeskyttere og spaulder med deres første rigtige statistiske linjer, og den sjældne osmiumskala stormhjelm, cuirass og leggings, Styrke og Udholdenhed i stykker af våben og nummer-kunstværker.\n\nDen har også en mere rolig side: Eastbrook Warded Leggings, en caster-stated felt almindelig, og Kilnscale Mantle, en sjælden Intellect and Spirit postskulder på færdighed 75, holder de tryllelystne postbærere på kundelisten. På ringen sidder den mellem Weaponcrafting og Engineering; Smith-parret med Weaponcrafting er svoret før forgemistress Darva, mens Gearwright-parret med Engineering er navngivet, men har endnu ingen edsmission.",
          "materialsHeading": "Malm i sækkevis",
          "materialsBody": "Intet håndværk spiser malm hurtigere. Alene ironlink-hauberken tager fem jernmalm, og hvert stykke osmiumskala vil have tre eller fire osmium plus en glyphsteel-stang, så en seriøs panserfartøjer udvinder Mirefen Marsh og Thornpeak Heights eller betaler en, der gør. Kobber fodrer det første trin lige fra årerne ved kobbergraven.\n\nOmkring metallet går de bløde dele: groft hud, der er høstet af ulv- og orne-lig, knoglerester fra de rastløse døde (eller reddet ud af almindeligt udstyr) og Smithing Flux-krukker (20 kobber hver i smedjen) i næsten alle opskrifter. Ingen tæller sælger osmium: de utålmodige køber det af andre spillere eller mine det selv, på Thornpeak eller startårerne i ti af de elleve yngre zoner (Alene Farshore graver jern).",
          "ladderHeading": "At lære ved Darvas smedje",
          "ladderBody": "To markfælles, Eastbrook Chainmail Vest og Warded Leggings, er kendt fra starten og håndværker overalt. Trænerstigen er ni opskrifter i tre trin i Eastbrook-smedjen: kobbertrinnet er gratis ved færdighed 0, ironlink-trinnet koster 25 sølv, en opskrift på færdighed 25, og osmiumskalatrinet koster 1 guld hver ved færdighed 50, hvor hvert trin kan læres i det øjeblik, dit niveau når det.\n\nUd over stigen sidder to specials. Boundstone-hjelmen er en af ​​de to Smith-kombinationsopskrifter (Gravewyrm-handskerne er dens søskende på våbenhåndværkssiden), træner-undervist, stationsfri og kun brugbar af en tilpasset Smith med begge håndværk på færdighed 25. Kilnscale Mantle behøver ingen lærer overhovedet: alle kender den fra starten, og intet andet end smeden, der arbejder den og. Dens angivne færdighed på 75 handler om gevinst, ikke tilladelse: med Armorcrafting som hovedfag betaler den fuld færdighedsforøgelse fra det allerførste hammerslag til 99, så en Smith med osmium til overs kan læne sig op af det tidligt. Under en majors loft lærer tier 3-opskriften intet, så en sort- eller hobbypanserarbejder arbejder med det for stykket, ikke pointene.",
        ...
        "leatherworking": {
          ...
          "materialsBody": "Læderbearbejdning er håndværket, hvor din nivelleringsrute og din forsyningslinje er den samme ting: groft skind høstes lige fra hudbærende lig, ulve og orner frem for alt, og hvert lig serverer kun én høstmaskine, først til mølle. En sjælden eller bedre høstrulle giver også et uberørt skjul, et signeret eksemplar, som Mirewarden Jerkin efterlyser, så bank hver eneste du finder.\n\nStøtten er lille: edderkoppeben og silke, hjemmespundet stof af humanoider, en enkelt osmiummalm i hvert mirewarden sjældent stykke (seks i Duskhide Wraps kappestenen) og et garvemiddel på 16 kobber fra garveriets disk. Osmium i sig selv er aldrig modkøbt: min det selv, på Thornpeak eller næsten enhver yngre zones startårer (Farshore alene graver jern), eller køb det af en anden spiller.",
          "ladderHeading": "Undervist i Fenbro",
          "ladderBody": "Her er rynken: garveriet står i Fenbridge, på Mirefen Marsh-vejen, hvilket gør Leatherworking til det ene dybe fartøj, der er trænet i marsken. Tanner Hesk underviser i stigen ved sine kar: Fenbridge-skjulet runget fri ved færdighed 0, marshstalker-trinnet på 25 sølv en opskrift fra færdighed 25, og mirewarden-trinnet på 1 guld hver fra færdighed 50, hvert trin åbner, når dit niveau når det.\n\nTre opskrifter springer træneren over: Field commons (den Garvede Leather Jerkin og Eastbrook Druid's Hide) laver overalt fra starten, og Duskhide Wraps er kendt af alle, men sidder på færdighed 75, garveri-bundet. Bemærk, at selve Outfitter-eden er svoret tilbage i Eastbrook med Ottilie; kun undervisningen sker i marsken.",
          "routeHeading": "Mesterværker, og en praktisk vej til 125",
          "routeBody": "Ethvert stykke med ægte statistik giver mesterværkschancen, så længe den finere kvalitet passer ind i dit niveauloft, den staterede Eastbrook Druid's Hide inkluderet, og en signeret Pristine Hide in a Mirewarden Jerkin giver automatisk den signerede reagensbonus; osmium tæller som et tier 1-materiale til proc. Den statløse skjul-almue kan ikke proc.\n\nUdjævn det på den naturlige måde: høst hver ulv og orne, du dræber fra niveau et, lad de to markfælles føre dig til 25, uanset hvor du står, og træn derefter gemmetrinnet ved karene, når missionerne alligevel trækker dig ind i marsken. Marshstalker fører dig til 50 og mirewarden til 75; tidligere, at Duskhide Wraps, en niveau 3-opskrift på seks osmiummalm, tre uberørte huder, to ru hud og et garvningsmiddel, betaler en afstemt Outfitter fuld gevinst til 99 og en halv efter, omkring 75 håndværk for de sidste halvtreds point til 125 cap; under en majors loft lærer niveau 3-opskriften intet.\n\nDet mobile garveri betyder mere for dette håndværk end noget andet: specialiser dig på 75, og en sadeltaske med huder bliver færdigt udstyr ved lejrbålet i stedet for en gåtur tilbage til Fenbridge. Hesks garveri-arbejdsordre køber otte ru huder hvert 30. minut, et pænt afkast på skind, du var ved at indsamle uanset, og gerningsbogen markerer Tanner's Trade på færdighed 50 med Grandmaster Leatherworking på kasketten."
        },
        "cooking": {
          "identityHeading": "Gryden der mætter gruppen",
          "identityBody": "Spis et tilberedt måltid, og det helbreder dig over 18 sekunders hvile, hvilket mellem trækkene er den billigste healing i spillet. Stigen løber fra en 90-sunds Pan-Seared River Perch hele vejen til Marlow's Grand Roast ved 980, en sit-heal, som intet i spillet slår.\n\nPå ringen Cooking sidder mellem Alchemy og Leatherworking. Dets levende par er Apothecary, Alchemy and Cooking, der er svoret før Cook Marlow i Eastbrook-køkkenerne efter at have jagtet fire vildsvin til gryden; Trapper-parret med Leatherworking er navngivet på ringen, men har endnu ingen edsmission.",
          "materialsHeading": "Et spisekammer forsynet af stang og kniv",
          "materialsBody": "Fiskeri lagerfører signaturingredienserne, zone for zone: spejlørreder og flodaborrer fra farvandet i Eastbrook Vale, sumpgedder og moseål fra Mirefen Marsh, frostørred og skiferkarper fra Thornpeak Heights. Trinene blander zonerne frit (det frie trin vil allerede have sumpgedder, det midterste trin Thornpeaks frostgær, og den sjældne aftensmad folder Vales spejlørreder ind igen), så en kok, der fisker, hvor vejen end går, løber aldrig tør.\n\nSlagterens side kommer af høstede lig: vildtkød fra orner og deres pårørende, og på en sjælden eller bedre høstrulle, en signeret Prime Cut, midtpunktet i den store stege. Urter krydrer de bedre retter, en asketræsstamme ryger ålen, og Cooking Salt løber 8 kobber en pose fra Marlows egen stall.",
        ...
        "alchemy": {
          ...
          "identityBody": "Håndværket arbejdes på apoteket i Highwatch, hjemsted for alkymisten Verane, Apothekermesteren, som underviser i opskriftsstigen, sælger glasflasker til 12 kobber og betaler mønt for urter gennem sin arbejdsordre.\n\nPå håndværksringen sidder Alchemy med trial-and-error-handlerne, ved siden af ​​Engineering på den ene side og Cooking på den anden. Det giver den to par identiteter: Bombardier (teknik og alkymi, taget op før Tinker Gizzel i Eastbrook) og apotekeren (alkymi og madlavning, svoret før Cook Marlow). Afstem dig på begge par for at gøre Alkymi til et hovedfag, og lad dit eget signerede arbejde lære dig tilbage; Bombardier-parret åbner også sit kombinationsbryg, Bjørnens Elixir, mens Apothecary-parret endnu ikke sender nogen kombinationsopskrift. Selve stigen venter dog aldrig, for hver alkymiopskrift ligger inden for det sjældne niveau, som sort håndværk arbejder under, så hele stigningen til hætten er åben før enhver ed.",
          ...
          "ladderBody": "Alle kender Minor Healing Potion fra starten og kan blande den hvor som helst, ingen station nødvendig. Den rigtige stige er ni opskrifter undervist af Verane på apoteket, tre på hvert trin: færdighed 0 opskrifterne er gratis, færdighed 25 trin koster 25 sølv per opskrift, og færdighed 50 trin koster 1 guld per opskrift. Hvert trin er et helbredende træk, et mana-træk og en stamina-eliksir, der går fra almindelige sheenleaf-flasker (120 sundhed, 160 mana) gennem ualmindelige guldblade (200 sundhed, 260 mana) til sjældne solblade (280 sundhed, 360 mana).\n\nEliksirerne klatrer på samme måde: Ornes eliksir giver 6 stamina i 10 minutter, Vipersear eliksir 9 i 15 minutter og eliksir af slange 12 i 15 minutter, hvor slangen alene brygger to flasker pr. Endnu en opskrift ligger ved siden af: Bjørnens Elixir, en kombinationsbryg Verane lærer for 25 sølv, når din Alkymi når 25, kan blandes hvor som helst, men kun af en afstemt Bombardier med både Alchemy og Engineering på 25.",
          "routeHeading": "En bryggermands vej til 125",
          "routeBody": "Udkast og eliksirer ruller aldrig mesterværker; at proc tilhører stat-bærende gear. Dit navn rejser dog stadig: de sjældne solbladsudkast ankommer signeret med et fabriksmærke, og det samme gør hver flaske af den dobbelte batch Elixir of the Serpent, så intet sjældent i dette håndværk forlader bænken usigneret. Ved færdighed 75 specialiserer du dig, og hver Alkymi-opskrift koster 20 procent færre materialer fra da af.\n\nTag Herbalism tidligt og vælg efterhånden som du udjævner: Sheenleaf er overalt i Vale, og når du når Veranes bænk, vil det frie trin føre dig rent til færdighed 25 på urter, du ville have plukket alligevel. Lær de 25 trin i det øjeblik, det tænder, flyt dit plukning til mosen efter bladguld, og lad Veranes arbejdsordre (seks guldbladsurter for 45 kobber, gentages hvert 30. minut) give en lille mønt tilbage, mens du går.\n\nFra 50 af, brygg solbladstræk og slangepartier ud af Thornpeak solblad, med lidt Vale og marskgrønt stadig i blandingen. Den sidste strækning fra 100 til 125 er en bevidst trickle, så bryg det, der faktisk sælger i stedet for at brænde urter for antallet, og husk, at forbrugsvarer er det, der er lavet godt, alle genkøber for altid. The Book of Deeds markerer Strange Brews på færdighed 50 og Grandmaster Alchemy på toppen."
        },
        "engineering": {
          "identityHeading": "Redskabsmagerens monopol",
          "identityBody": "Håndværket arbejdes på værktøjsværket i det sydvestlige hjørne af Eastbrook Square, hjemsted for Tinker Gizzel, Master of the Toolworks. Niveau 1 til 3 af hver værktøjslinje er almindeligt leverandørlager; niveau 4 og 5 kommer fra en ingeniørbænk, eller ud af den druknede litanys dykkedisk for Delve Marks bag dens clearing-porte, og aldrig ud af nogen kassen for mønt.\n\nPå ringen sidder den med trial-and-error-handlerne, ved siden af ​​Alchemy and Armorcrafting, hvilket giver den to par identiteter: Bombardier (Engineering og Alchemy, taget op før Gizzel selv) og Gearwright (Armorcrafting and Engineering, navngivet, men endnu ikke sværget). Én advarsel betyder mere her end noget andet sted: Hvert eneste af Engineerings opskriftstrin sidder over det sjældne loft, som hobbyer og sorte håndværkere arbejder under, så færdighedstallet flytter sig kun for en håndværker, hvis hovedfag omfatter Engineering, hvilket i dag betyder Bombardier. Enhver kan stadig bygge landredskaberne; en uafstemt håndværker lærer bare intet af at gøre det, og de to stangopskrifter beder desuden om Gizzels undervisning.",
          "materialsHeading": "Reagenser og forudgående redskaber",
          "materialsBody": "Hver landværktøjsopskrift bruger værktøjet et niveau under det plus et FIN-materiale, og denne parring er hele landstigen: fire fine jernmalm og en Skysilver minedrift bliver Osmium Mining Pick, derefter to Glyphsteel Bars, to Fine Osmium Ore og den osmium pick bliver Glyphsteel Mining Pick. Økse- og segllinjerne afspejler værktøjets fine-plus-forud-form med Fine Ashwood og Fine Highpine Logs, Fine Goldleaf og Fine Sunpetal Urter, selvom deres tier 5-trin ikke beder om Glyphsteel Bars: valget er den ene linje, der bliver dyrere i toppen. De to stangopskrifter bryder mønsteret med vilje: Stormreel tager fire Sunlint Koi og en Silverstream stang, Tidewrought to Koi, otte Raw Slatefin Carp og den Stormreel, så toppen af ​​lystfiskerens stige betales på vandet i stedet for ved en vene.\n\nEt fint materiale sælges ikke nogen steder og falder ikke fra en almindelig høst: du får det ved at bearbejde en af ​​en zones fuldkvalitetsårer med et værktøj, der er placeret over selve materialet, hvilket i praksis betyder, at værktøjet går under det, du forsøger at bygge (jo nemmere årer en zone holder for rejsende, giver det almindelige materiale, uanset hvad du svinger). Det er bevidst. På håndværksruten kommer et trin 5-værktøj fra faktisk at svinge tier 4-en, ikke fra en indkøbstur; Delve Marks-tælleren er den ene vej udenom. Den enkelte undtagelse er Glyphsteel Bar, raffineret og kun sælger, 1 sølv 60 kobber en bar fra Quartermaster Bree i Highwatch eller fra Gizzels egen disk, så Glyphsteel Mining Pick alene bærer et fast møntgulv indbygget i prisen.",
          "ladderHeading": "Redskabsstigen",
          "ladderBody": "Stigen er otte opskrifter, alle bundet til værktøjsværksstationen. De seks landværktøjsopskrifter kendes automatisk, ingen trænergebyr nogensinde: niveau 4-hakker, økse og segl ved færdighed 75, og niveau 5-versioner ved færdighed 150. Det andet tal er ikke en tastefejl, og det sidder over den nuværende 125-grænse med vilje: færdighedskrav aldrig gate et håndværk her, så dets form kan bygge en dag reagenser og dens tier 4-forgænger. De to udformede stænger er den lærte undtagelse: Gizzel underviser i Stormreel ved færdighed 75 for 4 guld og Tidewrought ved færdighed 125 for 16 guld, hver i det øjeblik dit niveau i håndværket når sit eget.\n\nHvert færdigt værktøj er sjældent eller i episk kvalitet og kommer ud signeret, så dit navn kører i zonerne på andre spilleres værktøjsbælter. Engineering holder også halvdelen af ​​en kombinationsopskrift: Bjørnens Elixir, brygget af en afstemt Bombardier med både Engineering og Alchemy på 25.",
        ...
        "enchanting": {
          ...
          "identityBody": "Enhver fortryllelse er kendt fra starten, enhver kan fortrylle fra dag ét, og ingen af ​​dem har nogensinde brug for en station; færdighedsgrænserne på 125 som ethvert håndværk. Det ene hjørne af branchen er dets par charmeopskrifter: Tinker Gizzel underviser i Gatherer's Cache og Artisan's Eye på værktøjsværket i det sydvestlige hjørne af Eastbrook Square, for det almindelige niveaugebyr, når din Enchanting når 25, og charmen selv er bearbejdet på hans station.\n\nPå ringen sidder den mellem Inscription og Jewelcrafting, så dens to par identiteter er Arcanist (Inscription and Enchanting) og Gembinder (Enchanting and Jewelcrafting). Ingen af ​​dem kan sværges endnu, da begge naboer venter på deres første opskrifter, så i dag er fortryllende klatring som alles håndværk: fri til det sjældne niveau før enhver ed, og et naturligt hobbyvalg for en Bombardier eller en Apotheker. Enchanter holder også samlingsverdenen kørende: De to spillebords-værktøjseffekter er Enchanter-værk, og en original håndværker genoplader deres egne effekter med rabat, endnu dybere, når de først har specialiseret sig.",
          "levelingHeading": "Sådan avancerer fortryllelse",
          "levelingBody": "Tre handlinger flytter færdigheden: at fortrylle et stykke, anvende en fortryllelse og lave de to charms, som klatrer op på den almindelige håndværkskurve. Hver succes er værd op til et point, skaleret efter hvor seriøst arbejdet er: sjældenheden af ​​det stykke, du knækker, eller reagensniveauet for den fortryllelse, du anvender. Almindelige fortryllere og kun støvtryllere scorer som almindeligt arbejde; ualmindelige fortryllelser og essens fortryller som ualmindelige; sjældne affortryllere og hver runed eller større fortryllelse som sjælden; Episke og legendariske affortryllere rangerer stadig højere på bordet, selvom ingen fortryllende identitet i dag når forbi det sjældne trin, så de betaler det samme som sjældent arbejde i praksis. Én ærlighed styrer den knækkende bænk: et stykke, der kom fra en spillerbænk (lavet, signeret eller mesterarbejdet) fræser stadig til materialer, men lærer ingenting, så en craft-and-break-løkke niveauerer ingen, og lektionerne er i verdenskendte gear.\n\nDen velkendte beherskelsesfade gælder på 25-punkts niveauer, så almindeligt arbejde bliver gråt ved færdighed 75, ualmindeligt arbejde ved 100 og sjældent arbejde præcist ved 125 cap. Fortryllende har også en godhed for sig: input over dit arketypeloft rundes ned til det loft i stedet for nulstillet, så før du indstiller dig, scorer en episk defortryller simpelthen som sjælden i stedet for at lære ingenting. Hvis Enchanting ender med at slumre bag en anden identitet, bryder og anvender score som almindeligt arbejde, og klatringen går i stå ved 75, mens de to charme, der rider på håndværkskurven over det fælles loft, lærer en slumrende fortryller intet som helst; behold det som din hobby og sjældent arbejde stadig betaler sig, bare langsommere efter 75.",
          "marketHeading": "Fortryldte kopier, oprindelse og markedet",
          "marketBody": "Anvendelse af en fortryllelse bruger reagenserne og markerer én specifik kopi af varen. Peg den på en kopi i posen, og du får en tydelig fortryllet kopi tilbage; peg den mod et stykke, du allerede har på, og det er fortryllet på plads, lige hvor det sidder, uden at udruste og genopruste dans. Uanset hvad, så følger bonussen det stykke for evigt, gennem udrustning, bankrejser og handler. En fortryllelse pr. styk: Anvendelse af en anden fortryllelse på en fortryllet kopi beder om bekræftelse, og erstatter derefter den gamle fortryllelse direkte og ødelægger den uden tilbagebetaling af dets materialer. Sælger, kasserer og affortryller alle foretrækker almindelige kopier først, så dit færdige stykke ikke bliver spist ved et uheld.\n\nMesterværksudstyr og fortryllende er venner: Et mesterværksværk forbliver fuldt ud fortryllende, og fortrylleren tilføjer oven på mesterværksbonussen uden at forstyrre den eller producentens signatur. At stable hver kilde, er et signeret mesterværk, der bærer en større fortryllelse, det bedste, et udformet stykke får, og det ligger stadig under raid-byttet.\n\nPå markedet lister et fortryllet eller signeret stykke som alt andet: det går op som sin egen enkeltkopi, værktøjstippet viser fortryllelsen og skaberens mærke, og Ravnposten bærer det lige så trofast. Materialerne forbliver den stabile halvdel af håndværket: Dust, Essence og Shards listes frit, notering koster ingenting, og købmanden tager kun 5 procent af et gennemført salg. Det gør de to klassiske enchanter-indkomster til at sælge materialer og sælge færdigt arbejde: over markedet, med ravn eller ansigt til ansigt i et handelsvindue."
        }
      },
      "howHeading": "Sådan fungerer håndværk",
      "howBody": "Åbn håndværksvinduet (standardtast T), og hver opskrift, du kender, er angivet med, hvad den har brug for, og hvad du har ved hånden. Stationsbundne opskrifter beder dig om at stå inden for 20 yards fra den rigtige station i byen, markopskrifter lave hvor som helst, og Enchantings brydende og fortryllende behøver ingen station overhovedet (kun dens to charmeopskrifter er stationsarbejde, ved værktøjsværket). Der er ingen fejlrulle: et håndværk med materialerne i hånden lykkes altid.\n\nTo små friktioner holder økonomien ærlig. Hvert vellykket håndværk betaler et gebyr på 2 kobber pr. point af emnets statistiske budget, og håndværkslignende handlinger deler et tempo: højst 10 håndværk, affortryllere, fortryllelser, bjærgninger eller genopladninger af værktøj i hvert 60-sekunders vindue. Heller ikke vil genere en normal session; begge forhindrer en maksimal specialist i at oversvømme markedet.",
      ...
      "masterworkBody": "Ethvert vellykket håndværk er præcis, hvad opskriften lover, og nogle gange lidt mere: Et mesterværk afslutter det samme stykke et kvalitetsniveau finere, med bonusstatistikken indbagt på håndværkstiden. Det er kun tilføjelse, aldrig en nedgradering, og det forbliver under raid-gulvet, så udformet gear kan være fremragende uden at erstatte et raid-drop.\n\nChancen er offentliggjort, ikke mystisk: {base}% base, plus {perTier}% pr. niveau, din færdighed ligger over opskriften, plus {signed}%, når et hvilket som helst signeret reagens går ind, plus {spec}%, når du er specialiseret, med materialer på højere niveau, der tilføjer 1 til 2% mere, alt sammen begrænset til {cap}%. Kun et stykke med ægte statistik kan forbedres, så statløse commons, værktøjer og forbrugsmaterialer proc aldrig; et slumrende håndværk producerer aldrig et, og et hobbyhåndværk kan ikke mestre dets sjældne loft.\n\nFint arbejde bærer sin skaber. Sjældne og bedre output er signeret, hvert eksemplar (Udarbejdet af; indsamlet materiale bæres Samlet af), et mesterværk er altid signeret uanset dets kvalitet. En signatur er herkomst, ikke en lås: underskrevet varehandel, post og liste på verdensmarkedet frit.",
      "trainingHeading": "Træning",
      "trainingBody": "Træneropskrifter kommer fra de fastboende mestre, undervist på deres stationer. Reglen er én linje: en mester lærer en opskrift, når dit niveau i håndværket har nået opskriftens eget niveau, og intet andet indebærer det, ikke dit niveau, ikke din arketype. Gear- og forbrugsstigerne kører deres trin ved færdighed 0, 25 og 50; Engineerings to stanglektioner fortsætter stigen ved 75 og 125, og Enchantings to charmeopskrifter sidder på 25 trin, så et frisk trin åbner sig, mens dine etager klatrer.\n\nGebyrer er engangs og faste for trin: Starttrinnet er gratis, færdighed 25 trin koster {tier1} en opskrift, færdighed 50 trin {tier2}, og stavtimerne over dem bærer deres egne gebyrer, anført ved siden af ​​hver opskrift i tabellen. Du skal stå ved mesterens faktiske station for at træne, og en mobil station tæller aldrig. De almindelige markopskrifter og de seks udformede landværktøjsopskrifter behøver ingen træning overhovedet; hver karakter kender dem fra starten.",
      ...
      "ench": {
        ...
        "enchantsNote": "Enchants kommer i tre niveauer. Basisniveauet kører på Chime Dust (med lidt Essence i den høje ende) og dækker våbensloten plus alle rustningsslots undtagen off-handen, med nok stat-akse muligheder til at hver build finder noget til hver slot. The Greater tier koster én Chime Shard plus Essence: stærkere bonusser på de slots med størst effekt. Shards fodrer yderligere to dræn foruden, de to charmeopskrifter til fem stykker og det øverste trin af genopladninger med værktøjseffekt, så bank et par stykker, før du bruger.\n\nMellem dem sidder de fem Runed enchants, en forbruger pr. maskinskrevet sekundær, så intet du fræser er nogensinde en blindgyde: Runed Edge (våben, Styrke, forbruger Resonant Steel), Runed Sigil (våben, Intellekt, Resonant Timber), Runed Weave (bryst, Spirit, Resonant Thread), Runed Hide, Hjelm, og Runed Hide (ben, Resonant, Resonant), Udholdenhed, resonansforbindelser). Hver tager også to Chime Essence; hvor en slot og stat har både en base og en større fortryllelse, lander Runed-bonussen mellem dem, mens Runed Weave er den stærkeste kiste Spirit fortryller direkte, og Runed Hide er de eneste ben, som Agility fortryller overhovedet. De nøjagtige bonusser er alle i tabellen nedenfor.",
      ...
      "gatherIntro": {
        "mining": "Minedrift trækker malm lige ud af verdens klippe: kobber i Eastbrook Vale, jern i Mirefen Marsh og osmium oppe i Thornpeak Heights, med startårer spredt gennem hver yngre zone ud over dem, og fodrer smedjehåndværket. Åbent for alle fra niveau 1: et 20 kobberminevalg fra en Eastbrook-, Fenbridge- eller Highwatch-tæller åbner hver startåre, og de højere trin på pickstigen vågner, efterhånden som din egen tæller tjener dem. Sporet på sin egen tæller til et loft på 100.",
        "logging": "Træfældning fælder tømmer fra bevoksninger af træer over hele verden: jernbark i Eastbrook Vale, asketræ i Mirefen Marsh, højfyr i Thornpeak Heights og startbevoksninger i hver yngre zone, råmaterialet til skafter, stave og ingeniørbænken. Åben for alle fra niveau 1 med en tømmerøkse i tasken (20 kobber ved Eastbrook, Fenbridge og Highwatch tællere), sporet på sin egen tæller til et maksimum på 100.",
        "herbalism": "Urtemedicin samler det, der vokser vildt: sheenleaf i Eastbrook Vale, guldblade i Mirefen Marsh, solkronblade i Thornpeak Heights og starterpletter i hver yngre zone, bladet og stilken, der holder apotekerfaget i gang. Åben for alle fra niveau 1 med en urte-segl i tasken (20 kobber ved Eastbrook, Fenbridge og Highwatch skranker), sporet på sin egen tæller til et loft på 100.",
        "fishing": "Fiskeri er det sære blandt de samlende erhverv, og det dybeste: et rigtigt bid-og-hjul-minispil, dets egne fangstborde i hver af de tre hjertezoner (de unge farvande ud over dem tjener alle til Vales bord indtil videre), og et færdighedsloft på 200, det dobbelte af de andre. Køb en stang, mød åbent vand og kast."
      },
      "rhythmHeading": "Indsamlingsrytmen",
      "rhythmBody": "En høst er et kort synligt kast, ikke et øjeblikkeligt greb: {base} sekunder base, aldrig under en {floor} anden sal. Hvis du bærer et værktøj over nodens niveau, et af dine færdigheder giver dig mulighed for at bruge, fremskynder dig med {tool} sekunder pr. niveau over det, og hvert færdighedsbånd, du krydser, trimmer yderligere {band} sekunder; blot at matche nodens niveau får dig ind ad døren, det er niveauerne over det, der gør dig hurtig.\n\nEn fuld pose afviser høfligt rollebesætningen, før den starter, så intet går til spilde midt i svinget, og hver høst betaler et lille stykke karakter XP, skaleret efter nodens niveau i forhold til dit eget måde at dræbe XP-skalaer på: en triviel grå node lærer en afgrænset karakter ingenting.",
      "gainBody": "Gevinst er deterministisk, aldrig et færdighedsløft: en node på eller over dit gevinstniveau lærer et fuldt point pr. høst, og hver {step} færdighed er et niveau, der scores mod noden. Tier 1 noder betaler fuldt ud under 25, halvdelen til 49, en fjerdedel til 74 og intet fra 75 og frem; tier 2 noder betaler fuldt ud til 49; de to niveau 3-noder i hver handel betaler fuldt ud til 74 og halvdelen lige op til grænsen på {cap}.\n\nDen påtænkte rute er almindelig: lær om startknudepunkterne i Vale, flyt til marsken, og afslut stigningen på Thornpeak Heights høje grund. Ved loftet stopper læringen, men udbyttet gør det ikke: en samler med et loft bliver ved med at rulle de bedste odds, handelen tilbyder for evigt.",
      ...
      "toolsNote": "Hver node har brug for sit fagværktøj i dine tasker, niveau 1 inkluderet: ingen hakke, ingen malm og ingen stang, ingen fisk. Sælgerstigen dækker trin 1 til 3 på tværs af de tre heartland-hubs: tier-1-værktøjet sælges på alle tre, trinene over det, hvor jorden, der bruger dem, begynder (Fenbridge tilføjer tier 2, Highwatch tier 3), og de yngre bebyggelser ud over dem har slet ikke noget værktøj, så sæt dig op inden du rejser. Hver tæller sælger frit hvert trin, den har på lager, og ethvert værktøj går forbi direkte handel; hvert trin vises også på markedet og rejser med posten undtagen de tre 20-kobber land startere: dem købes ved en skranke eller sendes hånd i hånd, og aldrig solgt tilbage, postet eller opført. Det, der er gated, er wieldingen. Et landværktøj over niveau 1 virker kun, når din færdighed i sin egen branche har opnået det, {tier2Prof} for niveau 2, {tier3Prof} for niveau 3 og 85 og 100 for de to udformede trin, og leverandørrækken, værktøjstip og tabellen nedenfor angiver alle kravet foran. Indtil da venter et værktøj, der er købt på forhånd, i dine kufferter, åbner ingen jord, køber ingen hastighed og slår ingen fine karakterer, og bruger derefter det øjeblik, din tæller rører sit nummer. Fiskestænger er den eneste undtagelse: ingen stang har brugskrav, og Trader Wilkes i Eastbrook lagerfører bevidst tier 2 og tier 3 stængerne til lystfiskere, der køber forud. Et værktøj optager aldrig et udstyrsslot og bliver aldrig slidt, så hvert værktøj er et engangskøb, og kun niveauet betyder noget for porten: Et sjældnere værktøj af samme niveau åbner intet ekstra. Sjældenhed er dog ikke kun farve. Det får en slidset værktøjseffekt til at holde længere, og på en stang udvider den rullevinduet.\n\nEt bedre værktøj køber tre ting, ikke to. Det åbner højere terræn, det forkorter kastet, og det forbedrer det, der kommer ud: Arbejd en åre med et værktøj, der er placeret OVER zonens eget materiale, og høsten giver den fine karakter af det i stedet for det almindelige. Venen skal være en af ​​zonens fuld-grade, så jo lettere årer en zone holder for rejsende, giver stadig det almindelige materiale. Fine materialer er, hvad de udformede værktøjsopskrifter bruger, og en fin karakter tæller som dens almindelige version overalt, hvor en opskrift eller en arbejdsordre beder om en, så opgradering sætter dig aldrig i stykker: det betyder bare, at din kobbermalm ankommer som fin kobbermalm.\n\nOver leverandørstigen har hver handel to håndværksmæssige værktøjer, tier 4 og tier 5, fremstillet på værktøjsværket (hver karakter kender landopskrifterne; færdigheden, der klatrer for arbejdet, er Engineerings), eller købt med Delve Marks ved Drowned Litany-disken, når dens rydningsporte er opfyldt: tabellen nedenfor viser Marks-prisen, og spørgeren klarer hver. Ingen købmand sælger dem nogensinde for mønt. Fiskeri har sit eget par, og de læres af værktøjsmageren frem for kendt fra starten. Ingen node og intet vand i dag har brug for mere end niveau 3, så de to øverste trin køber hastighed, grad og et mere venligt rullevindue frem for adgang, og de vil være adgangsbilletten, når højere niveauer ankommer.",
      "toolCrafted": "Fremstillet ({craft})",
      "toolCraftedOrMarks": "Lavet ({craft}) eller {marks} Delve Marks efter tre Drowned Litany clears",
      "toolCraftedOrMarksHeroic": "Lavet ({craft}) eller {marks} Delve Marks efter en heroisk druknet litani klar",
      "toolVendor": "{name} ({hub})",
      ...
      "bandsBody": "Faglighedsbånd er den delte 0/100/200-stige over en handels disk. For landhandlerne krydsede båndet ved 100 barberinger samlestøbningen, og deres kasket gør bånd 1 til loftet. Fishing's bands barberer ingenting: de udvælger fangstbordene (med en stang der passer til), kun fiskeri når bånd 2, og selve stigningen er det, der trækker en lystfisker til dybere vand, hvor de bedre borde og de videre lektioner både lever.",
      ...
      "specimenBody": "Hold en lille poseplads til overs, når du dyrker: en underskrevet vindfald har brug for sin egen plads eller en matchende signeret stak til at lande i, og hvis intet passer, kommer udbyttet stadig, men signaturen er tabt. Lighøst har også sin egen jackpotarm: omkring {pct}% af hver høstede komponent kommer sjældent eller bedre. En familie med et perfekt eksemplar at give (skind, silke, gift, kød) holder sit almindelige udbytte almindeligt og præger det signerede eksemplar ved siden af; hver anden familie underskriver selv udbyttet.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "De 100 milepæle indskriver Old Salt og 200 indskriver Master Angler med sin titel, toppen af ​​lystfiskerens kunst; Fiskeri tæller også med Master Gatherer, optjent med 100 i tre samlingshandler. En første fisk fra hver af seks zoners farvande fylder sin egen side, de tre hjertezoner og Willowfen, Galecrest og Farshore bag dem, og Sunlint Koi registrerer Glimmer of Hope, så rejsende med en stang i pakken fylder deres bog hurtigere, end de forventer."
      },
      "fish": {
        "startHeading": "Kom i gang",
        "startBody": "En simpel fiskestang koster 20 kobber fra Fisherman Brandt i Eastbrook (se efter Old Salt ved byens østkant, ved vejen til Mirror Lake); Tinker Gizzel, Provisioner Hale i Fenbridge, og Quartermaster Bree i Highwatch stock poles. Brug stangen, mens du vender mod vandet, der er dybt nok til at holde fisk, op til omkring 24 yards foran dig, og din bobber sejler ud.\n\nDu kan ikke kaste, mens du er i kamp, ​​mens du svømmer, eller mens du er død: at kaste fra land er den tilsigtede holdning. Vand bliver dog sværere, som landet gør: marsken vil i det mindste have tier 2 Ironreel og toppene tier 3 Silverstream, og en line kastet uden den stang, som vandet tager, forlader aldrig din hånd. To stænger sidder over dem, Stormreel og Tidewrought: Ingeniører laver dem ved værktøjsværket ud af hvad en line trækker op, og den druknede litanys dykkertæller sælger dem for Delve Marks bag dens ryddeporte, dog aldrig for mønt. Intet vand beder om dem, så de køber en kortere ventetid og et bredere rullevindue i stedet for adgang, hvilket på det øverste trin betyder en bid på flade tre sekunder.",
        "biteHeading": "Bid og indhivning",
        "biteBody": "Efter kastet kommer der et bid i et skjult øjeblik mellem {min} og {max} sekunder; forsinkelsen afgøres, når linjen lander, så ingen kast føles helt ens. Når bobberen bider, har du et {reel} sekunders vindue til at trykke på stangen igen og rulle ind: rulle ind i den og fangsten lander, tøv forbi den og fisken slipper uden noget at vise. En hel session begrænser sig til {cap} sekunder, så selv en stille rollebesætning løser sig hurtigt.\n\nBedre stænger skærper begge ender af minispillet: hvert stanglag over det første trimmer {rod} sekunder fra den længst mulige ventetid, aldrig under tre-sekunders etage græsser den øverste stang allerede, og tilføjer {reelRod} sekunder til rullevinduet, så Ironreel trækker den værste ventetid ned til 6,5 sekunder over et vindue med 3,25 sekunder over et vindue og 3,25 sekunder over et vindue. 4, dens sjældenhed udvider hjulet lidt ud over, hvad niveauet alene betaler. De hurtigste bid ændrer sig aldrig, hvad end du holder, og en stang behøver kun at være i din taske for at tælle.",
        "scheduleHeading": "Færdighedspoint-optjening",
        "scheduleNote": "Fiskeforøgelse følger et fast skema uden terninger: et helt point pr. fangst under 50-færdighed, et halvt point under 100, en tiendedel under 150 og en langsom 0,02 trickle fra 150 til 200. Det sidste stykke er en rejse med tusindvis af fangster med vilje: 200 er et udsagn, ikke et stop på vejen til noget andet.\n\nJunk holder helt op med at undervise på {cutoff}: derfra er ukrudt og støvler bare ukrudt og støvler. Selve vandet dækker også lektionen: Vales tier 1-vande (og alle unge kyster ud over hjertelandet) lærer intet over 100, marskens stop ved 150, og kun Thornpeaks skole er en lystfisker hele vejen til 200. Hver landede fangst vinder ellers til den planlagte sats, så når tælleren går i stå, så er tidsplanen for vandet.",
        "colProficiency": "Færdighed",
        "colGain": "Gevinst pr. fangst",
        "belowFmt": "Under {below}",
        "tablesHeading": "Fangsttabeller",
        "tablesNote": "Dine færdigheder vælger et af tre fangstbånd: bånd 0 fra starten, bånd 1 ved 100, bånd 2 ved 200, hver skiftende vægt ud af skrammel og tomme kroge til rigtige fisk, zone for zone. Hvert bånd over det første kræver også en stang: bånd 1 vil have tier 2 Ironreel, bånd 2 tier 3 Silverstream. Dit effektive bånd er det laveste af, hvad din færdighed har tjent, og hvad din stang understøtter, og hætten er lydløs: Med en mindre stang fanger du stadig, lige ved det nederste bånds bord, så hvis dine fangster føles fastlåste, mens dine evner klatrer, så tjek først din stang.\n\nHver zones farvande rummer deres eget par madfisk, der heler mere, jo dybere zonen er, alle sammen tilberedningsinput og perfekt sidde-og-spise mad, rå fra linjen. Resten af ​​bordet er lystfiskerens afgift: ukrudt, en enkelt støvle og den tomme krog, som aldrig helt forsvinder. Hvor meget du betaler afhænger af vandet, din bobber lander i, ikke hvor du står: et kast når op til 24 yards, og stangen vandet kræver, bordet det trækker fra, skødet det krediterer, og hvor langt det lærer alt svar til den zone, som vandet hører til, afgjorde det øjeblik, hvor linjen lander. Hver zones vand er skrevet for sit eget bånd, Vale for bånd 0, marsken for bånd 1, toppene for bånd 2, og fiskeri et bånd under, der forvandler omkring en tredjedel af dine kast til tomme kroge, to bånd under det mere end halvdelen. Stangen får dig til vandet; dygtigheden er det, der får det til at betale sig, og stigningen er det, der trækker en lystfisker dybere, for bedre bånd er ikke bare bedre løn: forbi Vale er de de eneste farvande, der bliver ved med at undervise. {rare} er den ene række, der svarer til dit fangstbånd og intet andet: de samme odds i hver zone og seks gange mere sandsynligt ved bånd 2 end ved bånd 0, så den sjældneste ting på kajen er den, en Master Angler virkelig er bedre til.",
        ...
        "koiBody": "Hvert vandområde i spillet skjuler den samme præmie: Sunglint Koi, et usædvanligt glimt på linjen til en værdi af 75 kobber til en sælger og mere til din stolthed. Dens odds svarer til dit fangstbånd og til intet andet, det samme i hver zone: en række på 1 procent af fangstbordet ved bånd 0, 3 ved bånd 1 og 6 ved bånd 2, trukket på hvert indrullede kast, så koi'en kommer til lystfiskeren, der tjente de dybe borde. Landing one registrerer Glimmer of Hope i din gerningsbog, et nulberømt samlermærke. Når det sker, sørger loggen for, at du ved det."
      },
      "econ": {
        ...
        "trainingNote": "Ét fast gebyr pr. opskriftstrin, opkrævet én gang, når en mester underviser i det; hvert trin i tabellen nedenfor er i live brug i dag, lige fra de gratis starteropskrifter til værktøjsmagerens stanglektioner øverst.",
        ...
        "provenanceBody": "Nogle varer bærer et navn. Hold musen over en, og værktøjstippet siger Samlet af sådan-og-så på et råmateriale, eller Lavet af sådan-og-så på et færdigt stykke: det samme mærke, formuleret for, hvordan varen blev til. En signatur er en del af selve varen, rejser med den gennem handler, banken, posten, verdensmarkedet og endda et købstilbagekøb, og falmer aldrig.\n\nIndsamling tegner automatisk sit bedste arbejde: enhver høst, der ruller sjældent eller bedre, ankommer underskrevet, og sjældne fund tegner hele deres femdobbelte vindfald. En lighøsts heldige rulle tegner sit udbytte, hvor familien ikke har noget eksemplar at give, og hvor det gør, holder udbyttet almindeligt og præger det signerede uberørte eksemplar ved siden af. Udarbejdelse af skilte på samme linje: Hver kopi af et sjældent eller bedre output er mintsigneret, og et mesterværk underskriver altid uanset dets kvalitet, så den fineste version af ethvert stykke navngiver altid sin maker. Den ene ting, der kan koste dig en signatur, er en fuld taske: en signeret enhed har brug for sin egen plads eller en matchende signeret stak for at lande i.\n\nEn stak genstande deler én identitet, så to kopier smelter kun sammen, når hvert mærke matcher nøjagtigt: samme emne, samme underskriver, samme mesterværksstatistik, samme fortryllelse, samme binding. En signeret log slutter sig aldrig til en almindelig bunke i nogen af ​​retningerne (sammenlægning ville slette nogens navn), men identiske nyttelaster smelter lykkeligt sammen, så tyve malm signeret af den samme samler sidder i én stak, og et vindfald slår ikke dine tasker i stykker.\n\nSignaturer betaler håndværkere tilbage: Hvis du holder enhver underskrevet kopi af et nødvendigt reagens på bænken, uanset hvem der har underskrevet det, tilføjer du 2 procentpoint af mesterværkschance, og hvis du holder et reagens, der er underskrevet af din egen hånd, skærer det reagens påkrævede mængde med én (aldrig under én). Dit eget underskrevne sjældne-eller-bedre arbejde bliver endda ved med at lære dig, i dag gennem kolben alene: drik en drik, du har skrevet under, og et lille dryp af færdigheder flyder tilbage til det håndværk, der bryggede det, så længe det håndværk er en af ​​dine aktive hovedfag.",
        ...
        "throttleBody": "Output har et loft: Udarbejdelse, fortryllende, fortryllende, bjergning og genopladning af værktøjseffekt deler et budget på {actions} vellykkede handlinger i hvert {seconds}-sekundsvindue. Et afvist forsøg koster ingenting og bruger intet budget. Du vil aldrig mærke det i normal leg; det eksisterer, så en maksimal specialist med en fuld bank kan ikke oversvømme markedet, uanset deres færdigheder eller lager.",
      ...
      "faq": {
        ...
        "a4": "Du ramte et vindfald. Omtrent 1 høst ud af 90 udløser en sjælden indsamlingsbegivenhed (gammelt kerneved på et træ, en uberørt åre på malm, en måneskin opblomstring på urter): den multiplicerer udbyttet fem gange, signerer hver enhed med dit navn og annoncerer fundet for hele zonen. En sjælden eller bedre sjældenhed rulle på en almindelig høst tegner også udbyttet.\n\nUnderskrevne materialer er værd at beholde eller sælge dyrt: At have en signeret kopi af et nødvendigt reagens ved bænken tilføjer 2 procentpoint til mesterværkschancen. Bare husk, at de kun stables med identisk signerede kopier, så de beholder deres egen taskeplads.",
        ...
        "a6": "De ni almindelige markopskrifter og de seks udformede landværktøjsopskrifter er kendt af alle fra starten, og det samme er tre stationsbundne topstene (Kildeskala Mantle, Wardweave Cowl og Duskhide Wraps), som ikke behøver nogen træner, kun deres station. Alt andet bliver undervist af de fastboende mestre på deres stationer på tværs af de tre hovedbyer: De fleste står i Eastbrook, garveren holder garveriet i Fenbridge, og alkymisten holder apoteket i Highwatch.\n\nTræneropskrifter kører i trin: færdighed 0, 25 og 50 for redskaber og forbrugsvarer, gratis, 25 sølv og 1 guld som engangsgebyrer; Enchantings to charmeopskrifter sidder på 25-trinet, og værktøjsmageren lærer de to udformede fiskestænger på 75 og 125 for 4 og 16 guld. En mester lærer en opskrift, når dit beslag i det håndværk har nået opskriftens eget beslag, og du skal stå ved deres station for at lære: en mobilstation tæller ikke.",
        "q7": "Hvorfor gik min indsamling pludselig langsommere?",
        "a7": "Samlingen starter ved 2,5 sekunder og barberes ned på to måder: 0,4 sekunder for hvert værktøjsniveau, du bærer og kan svinge over nodens eget niveau, og 0,15 sekunder, når din branches tæller krydser sit 100-bånd, med en bund på 1,5 sekunder. Flyt fra niveau 1 noder op til niveau 3 noder, og dit overskud forsvinder, så det samme valg svinger langsommere igen. At holde præcis det nødvendige niveau køber ingen hastighed; det åbner kun noden.\n\nFærdighedsforstærkning forsvinder på samme måde, som håndværk gør: en node gråner, når dine færdigheder klatrer forbi dens niveau (tier 1 noder lærer intet fra færdighed 75 og frem), så svaret på langsomme gevinster er højere niveau noder. De har brug for et værktøj af mindst deres niveau i dine tasker (ingen node arbejdes nogensinde med bare hænder, niveau 1 inkluderet), og et landværktøj over niveau 1 vil også have sit svingemærke først, 40/70/85/100 i sin egen handel for niveauer 2 til 5. Fiskeri følger sin egen taper: fuld gevinst under 50 under 10, 10, 10. og 0,02 under 200, skrammelfangster lærer slet ikke noget fra 100 af, og selve vandet dækker lektionen (trin 1-vande stopper undervisningen ved 100, marsken ved 150), så en tæller, der går i stå, kan også betyde, at du er vokset fra vandet.",
        "q8": "Kan jeg lave håndværk væk fra byen?",
        "a8": "Dels. De ni almindelige feltopskrifter (startvåben, rustning, mad og potion-hæfteklammer) laver hvor som helst, når som helst, og det samme gør de tre kombinationsopskrifter af de svorne par. Alt andet over dem er bundet til en stationstype: smedje, køkkener, apoteker, garveri, væve eller værktøjsværker, og du skal være inden for 20 yards fra stationen for at fartøjet kan gå igennem.\n\nVed 75 færdigheder i et håndværk specialiserer du dig, og sammen med 20 procent materialerabat får du en mobilstation: Placer den i marken, og den står i 10 minutter, og serverer håndværkets opskrifter, som om du var ved den ægte vare. Mobilstationen er kun til håndværk: At lære opskrifter og uforpligtende kommissioner kræver altid den rigtige station i byen."
      }
    },
    "economy": {
  ...
  "questUi": {
    "tracker": {
      ...
      "unknownQuest": "Ukendt mission ({id})"
    },
    "log": {
      "title": "Quest-log",
      "close": "Luk quest-log",
      ...
      "cooldownStatus": "Snart tilgængelig igen",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItem": "Ukendt vare",
      "unknownItemAria": "Ukendt vare {id}, antal {count}",
      "unknownItemAriaMasterwork": "Ukendt vare {id}, antal {count}, mesterværk",
      "unknownItemAriaEnchanted": "Ukendt vare {id}, antal {count}, fortryllet kopi",
      "unknownItemAriaBound": "Ukendt vare {id}, antal {count}, indbundet kopi",
      "unknownItemAriaInstanced": "Ukendt vare {id}, antal {count}, producent-mærket kopi"
    },
    "equipment": {
      "empty": "Tom",
      "levelClass": "Niveau {level} {className}"
    ...
    "vendor": {
      ...
      "qtyRowAria": "Købsmængde",
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Køb {count} ad gangen",
      "qtyCustom": "Skik",
      "qtyCustomAria": "Vælg et brugerdefineret beløb for at købe",
      "buyCountAria": "Køb {count} af {item} for {price}",
      "buyCountAriaWithRequirement": "Køb {count} af {item} for {price}. {requirement}",
      "buyQuantityTitle": "Køb hvor mange {item}? Op til {max}.",
      "buyQuantityInput": "Mængde at købe",
      "buyQuantityConfirm": "Købe",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_ironbark_log": {
        "name": "Fin Ironbark Log"
      },
      "fine_ashwood_log": {
        "name": "Fin Ashwood Log"
      },
      "fine_elderwood_log": {
        "name": "Fin Highpine Log"
      },
      "fine_silverleaf_herb": {
        "name": "Fin sheenleaf urt"
      },
      "fine_goldleaf_herb": {
        "name": "Fin bladguld urt"
      },
      "fine_sunpetal_herb": {
        "name": "Fin solbladsurt"
      },
      "stormreel_fishing_rod": {
        "name": "Stormreel fiskestang"
      },
      "tidewrought_fishing_rod": {
        "name": "Tidewrought fiskestang"
      },
      "duskwisp_essence": {
    ...
    "quests": {
      ...
      "q_the_codfather": {
        "title": "Torskefaren",
        "text": "Torskefaderen er ikke bare en fisk, {playerName}, han er en koldblodig morder. Oldtimere sværger, at han spiser Mire Prowlers til morgenmad, og selv Mirefen Widows vil ikke spinde deres spind i nærheden af ​​Deepfen Shallows af ren skræk. Han hersker over disse farvande, og marskvand tager en jernhjuls fiskestang, intet mindre; min disk sælger dem. Få en i hånden, slæb den gamle djævel op af hans vande, og jeg vil indrømme, at du er kommet med i familien.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "Jeg har set disse mærker før, på tre gamle grave omkring den nordlige slagmark. Kaptajn Aldren ligger på den vestlige stigning, Ypperstepræsten Malric længere mod syd langs den vestlige kant og Royal Assassin Voss ved den østlige klippe. Rør ved hver grav og lyt, {playerName}. De døde kan huske, hvad de levende glemte.",
