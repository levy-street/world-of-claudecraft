...
export const da_DK: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "merch": {
      "title": "Merch Store",
      "subtitle": "Official World of ClaudeCraft merchandise, shipped worldwide.",
      "loading": "Loading the store...",
      "unavailable": "The merch store is unavailable right now. No orders or payments are affected; please check back shortly.",
      "disclosure": "Merch is produced and shipped on demand by our print partner. Claudium spent on merch is not refundable as Claudium; card and Solana payments follow the refund policy in the Terms of Service.",
      "catalogTitle": "Catalog",
      "catalogEmpty": "No merch is available right now.",
      "variantLabel": "Style and size",
      ...
      "totalLabel": "Total",
      "totalNote": "Shipping and tax are added at checkout; the final total is confirmed server-side.",
      "claudiumPrice": "{amount} Claudium",
      "checkoutTitle": "Checkout",
      "loginRequired": "Log in to your account to check out.",
      "shipping": {
        "name": "Full name",
        "address1": "Address",
      ...
      "shippingIncomplete": "Please fill in every required shipping field.",
      "railLabel": "Payment method",
      "railStripe": "Card",
      "railSol": "SOL",
      "railClaudium": "Claudium",
      "payNow": "Place Order",
      "checkoutPending": "Order in progress. Complete the payment and keep this page open.",
      "checkoutFailed": "Checkout could not be started. Please try again.",
      "checkoutUnavailable": "That order is not available right now.",
      "checkoutNotSettled": "The transaction was sent but the order is not confirmed yet. Check your orders shortly.",
      "orderPlaced": "Order {orderId} placed. Track it in your orders below.",
      "paymentPending": "Order {orderId} is awaiting card payment. It appears in your orders once the payment completes.",
