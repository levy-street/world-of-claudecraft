...
export const da_DK: EnTranslations = {
  ...
  "landing": {
    "heroEyebrow": "THE WORLD IS ALREADY RUNNING",
    "heroHeading": "A living classic MMO where players and AI adventurers face the same world.",
    "heroBody": "Play free in your browser, build a hero across nine classes, or train an agent against the real game.",
    "heroStatus": "World online",
    "heroPlayers": "registered adventurers",
    "communityLinks": "Community links",
    "followSocials": "Follow us on our socials",
    "socialX": "X",
    ...
    "patchNotesDesc": "Review the latest gameplay changes, fixes, and release details.",
    "patchNotesLoading": "Loading the latest patch notes...",
    "patchNotesError": "Couldn't load the patch notes. Please try again later.",
    "patchNotesEmpty": "No patch notes yet. Check back soon.",
    "patchNotesPrerelease": "Pre-release",
    "patchNotesViewOnGithub": "View release on GitHub",
    "newsEyebrow": "NEWS FROM THE REALM",
    "newsTitle": "News from Claudemoon",
    "newsBody": "Follow the latest from World of ClaudeCraft and discover stories from behind the world.",
    "newsXTitle": "Latest on X",
    "newsXIntro": "Official posts from @WoClaudecraft",
    ...
    "newsXPrivacy": "Loading this feed connects to X and may allow X to receive information about your visit.",
    "newsXLoad": "Load X feed",
    "newsXRetry": "Try again",
    "newsXHide": "Hide X feed",
    "newsXOpen": "Open @WoClaudecraft on X",
    "newsXOpenAria": "Open @WoClaudecraft on X in a new tab",
    "newsXNewTab": "Opens in a new tab",
    "newsXLoading": "Opening the X feed...",
    "newsXLoaded": "X feed loaded.",
    "newsXUnavailable": "The X feed could not be loaded. You can still view every post directly on X.",
    "newsXHidden": "The X feed is hidden. You can still open the profile directly on X.",
    "newsXIframeTitle": "Latest posts from @WoClaudecraft on X",
    "newsBlogEyebrow": "THE CLAUDEMOON CHRONICLE",
    "newsBlogTitle": "Latest stories",
    "newsBlogEmptyTitle": "The first story is being written",
    "newsBlogEmptyBody": "News and behind-the-scenes stories will appear here soon.",
    ...
    "playNowBody": "Play instantly in your browser. No download required.",
    "playNowButton": "Play Now",
    "playWayTitle": "Play Your Way",
    "playWayBody": "Choose your platform and join the adventure.",
    "syncProgress": "Sync progression across all platforms",
    "googlePlayEyebrow": "GET IT ON",
    "appStoreEyebrow": "DOWNLOAD ON THE",
    "steamEyebrow": "AVAILABLE ON",
    "explore": "Explore the realm",
    "platformsEyebrow": "PLAY WHERE YOU ADVENTURE",
    "appStoreAria": "Download World of ClaudeCraft on the App Store",
    "googlePlayAria": "Get World of ClaudeCraft on Google Play",
    "steamAria": "World of ClaudeCraft on Steam, coming soon",
    "comingSoon": "Coming Soon",
    "introEyebrow": "ONE WORLD. ONE RULESET.",
    "introHeading": "Every adventurer plays the real game.",
    "introBody": "The browser MMO, the authoritative online world, and AI training all run on the same deterministic simulation. Players and agents face the same combat, quests, dungeons, and consequences.",
    "statClasses": "9 playable classes",
    "statModes": "Online and offline worlds",
    "statBroadcast": "24/7 AI broadcast",
    "statSource": "Open source",
    "worldEyebrow": "JOURNEY THROUGH CLAUDEMOON",
    "worldHeading": "A realm built for long roads and dangerous nights.",
    "worldBody": "Begin among Eastbrook Vale campfires, descend into haunted crypts, and climb through the storms of Thornpeak. Every road leads deeper into a world that keeps moving.",
    "eastbrookTitle": "Eastbrook Vale",
    "eastbrookBody": "A shared frontier of first quests, roaming enemies, and unlikely allies.",
    "eastbrookAlt": "A party of adventurers travels the long road from Eastbrook Vale toward Thornpeak",
    "hollowTitle": "The Hollow Crypt",
    "hollowBody": "Party combat beneath cold blue torches, where the restless dead gather in force.",
    "hollowAlt": "A party confronting enemies inside the Hollow Crypt",
    "thornpeakTitle": "Thornpeak Heights",
    "thornpeakBody": "Snow, ancient ruins, and endgame threats wait above the cloud line.",
    "thornpeakAlt": "Snow falling across Thornpeak Heights",
    "classesEyebrow": "CHOOSE YOUR LEGEND",
    "classesHeading": "Nine callings. Countless ways to fight.",
    "classesBody": "Stand in the shield wall, command fire and frost, stalk from the shadows, or keep your party alive. Build a hero, master a specialization, and carry that story into the shared world.",
    "streamEyebrow": "LIVE 24/7",
    "streamNetwork": "WOC BROADCAST NETWORK",
    "streamFeed": "YUUMIII // LIVE FEED",
    "streamMonogram": "Y",
    "streamHeading": "Yuumiii never logs off.",
    "streamBody": "World of ClaudeCraft's resident AI streamer plays the world live, 24 hours a day.",
    "streamWatch": "Watch on Twitch",
    "streamWatchSub": "Join Yuumiii live",
    "streamExplore": "Explore the world",
    "streamExploreSub": "Discover Claudemoon",
    "streamHeroSubtitle": "Your resident AI streamer, playing the world around the clock.",
    "streamMeet": "Meet your guide",
    "streamHostTitle": "Resident AI streamer",
    "streamHostBody": "Join Yuumiii as she explores every corner of World of ClaudeCraft, day and night.",
    "streamPortraitAlt": "Yuumiii, the resident AI streamer of World of ClaudeCraft",
    "streamAlwaysTitle": "24/7 live",
    "streamAlwaysBody": "Always on. Always adventuring.",
    "streamAiTitle": "AI streamer",
    "streamAiBody": "Powered by AI for real reactions and endless fun.",
    "streamCommunityTitle": "Community",
    "streamCommunityBody": "Chat, quests, and surprises await.",
    "streamWorldTitle": "Real world",
    "streamWorldBody": "One persistent world. Infinite stories.",
    "streamLoading": "Opening the viewing portal...",
    "streamReady": "The viewing portal is ready. Press play to watch Yuumiii.",
    "streamOnline": "Yuumiii is live now.",
    "streamOffline": "The viewing portal is reconnecting. Open the Twitch channel to keep watching.",
    "streamCompact": "Open the Twitch channel to watch Yuumiii on this screen.",
    "streamUnavailable": "The viewing portal is unavailable. Open the Twitch channel to keep watching.",
    ...
    "openEyebrow": "OPEN WORLD. OPEN CODE.",
    "openHeading": "Host your own world. Bring your friends.",
    "openBody": "Explore the source, host your own private world, and invite your friends to adventure together on a server you control.",
    "supportEyebrow": "KEEP THE REALM RUNNING",
    "supportHeading": "Build, play, and support the next chapter.",
    "supportBody": "World of ClaudeCraft grows in the open. Join the community, follow the living world, or support ongoing development.",
    "xCta": "Follow on X",
    "twitchCategoryCta": "Explore World of ClaudeCraft streams",
    "finalEyebrow": "YOUR STORY STARTS AT THE GATE",
    "finalHeading": "Choose your way into Claudemoon.",
    "finalBody": "Play in your browser now, continue on mobile, or watch for the Steam release."
  },
  "a11y": {
