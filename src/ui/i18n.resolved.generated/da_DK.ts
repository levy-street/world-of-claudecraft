...
export const da_DK: EnTranslations = {
  ...
  "character": {
    ...
    "renameCancel": "Cancel",
    "respec": "Respec",
    "respecHint": "Reset talents or unlock an extra loadout slot by burning $WOC.",
    "respecPaidButton": "Reset Talents for {amount} $WOC",
    "loadoutSlotPaidButton": "Unlock a Loadout Slot for {amount} $WOC",
    "respecCancel": "Cancel",
    "respecSuccess": "Talents reset.",
    "loadoutSlotSuccess": "Loadout slot unlocked.",
