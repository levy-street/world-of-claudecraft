...
export const da_DK: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "lootHistory": "Historik",
      "title": "{tab} - {view}",
      "noCombat": "Ingen kamp registreret endnu.",
      "noLoot": "Intet bytte registreret endnu.",
      "recentAwards": "{count} seneste tildelinger",
      "target": "Mål: {name}",
      "noTargetEngaged": "Intet mål engageret.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Sprunget over",
      "methodMaster": "Mester",
      "methodPersonal": "Personlig",
      "methodDelve": "Delve",
      "methodLooted": "Plyndret",
      "noWinner": "Ingen vinder",
      "rollDetail": "Kast {roll}",
