...
export const da_DK: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tradingBots": {
      "title": "Trading Bots",
      "close": "Close trading bots",
      "launcher": "Bots",
      "launcherAria": "Rent a SOL and $WOC trading bot",
      "loading": "Loading trading bots...",
      "custody": "Deposits go to a capped vault the trading service manages for you. Only your linked wallet can receive withdrawals, and you can withdraw at any time.",
      "riskNote": "Automated trading can lose value. Rental fees are not refunded. This is not financial advice.",
      "catalogIntro": "Rent a bot by the month, fund it with a SOL and $WOC pair, and it trades for you on the DEX.",
      "skuGridName": "Grid Golem",
      "skuGridBlurb": "Places alternating buys and sells around the market price, earning the spread while prices wander.",
      "skuDcaName": "Drip Sprite",
      "skuDcaBlurb": "Steadily converts SOL into $WOC on a fixed schedule, spreading your entries over time.",
      "skuMomentumName": "Momentum Wisp",
      "skuMomentumBlurb": "Leans the pair toward the trending side and rotates back when the trend fades.",
      "priceWoc": "{amount} $WOC / month",
      "priceClaudium": "{amount} Claudium / month",
      "rentButton": "Rent",
      "payWithLabel": "Pay with",
      "payWoc": "$WOC",
      "payClaudium": "Claudium",
      "claudiumBalance": "Claudium balance: {amount}",
      "approvePayment": "Approve the rental payment in your wallet...",
      "confirmingPayment": "Confirming your payment on the network...",
      "subscribedBody": "Your bot is rented. Fund its vault to start trading.",
      "activeUntil": "Active until {date}",
      "fundTitle": "Fund the vault",
      "solAmountLabel": "SOL to deposit",
      "wocAmountLabel": "$WOC to deposit",
      "depositBounds": "Between {min} and {max}",
      "depositButton": "Deposit",
      "approveDeposit": "Approve the deposit in your wallet...",
      "confirmingDeposit": "Confirming your deposit on the network...",
      "amountInvalid": "Enter a valid amount.",
      "vaultLine": "Vault: {sol} SOL, {woc} $WOC",
      "stateRunning": "Running",
      "statePaused": "Paused",
      "startButton": "Start",
      "pauseButton": "Pause",
      "paramsTitle": "Strategy settings",
      "paramGridSpacingBps": "Grid spacing ({percent}%)",
      "paramOrderSizeBps": "Order size ({percent}%)",
      "paramDcaIntervalMinutes": "Buy interval (minutes)",
      "paramMomentumLookbackMinutes": "Trend lookback (minutes)",
      "saveParams": "Save settings",
      "recentTrades": "Recent trades",
      "noTrades": "No trades yet.",
      "tradeBuy": "Buy",
      "tradeSell": "Sell",
      "pnlLine": "Profit and loss ({days}d): {amount} $WOC ({percent}%)",
      "withdrawButton": "Withdraw all",
      "withdrawTitle": "Withdraw the vault",
      "withdrawBody": "Withdrawing pauses the bot and returns the vault balances to your linked wallet.",
      "approveWithdraw": "Approve the withdrawal in your wallet...",
      "withdrawPending": "Your withdrawal is on its way. Balances update once the network confirms it.",
      "cooldown": "Too many requests. You can try again in {seconds}s.",
      "errWalletFeature": "Your connected wallet cannot send transactions from the game. Try a different Solana wallet.",
      "errSignFailed": "The transaction was not sent. It may have been declined in your wallet.",
      "errNoWallet": "Connect a Solana wallet first."
