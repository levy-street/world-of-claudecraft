...
export const ja_JP: EnTranslations = {
  ...
  "character": {
    ...
    "renameCancel": "キャンセル",
    "respec": "再振り分け",
    "respecHint": "$WOC をバーンしてタレントをリセットするか、追加のロードアウト枠を解放します。",
    "respecPaidButton": "{amount} $WOC でタレントをリセット",
    "loadoutSlotPaidButton": "{amount} $WOC でロードアウト枠を解放",
    "respecCancel": "キャンセル",
    "respecSuccess": "タレントをリセットしました。",
    "loadoutSlotSuccess": "ロードアウト枠を解放しました。",
