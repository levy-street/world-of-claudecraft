...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "cosmetics": {
      ...
      "raidIntro": "Full-body armor skins from the Inner Crucible raid. Complete any full five-piece Crucible set for your class, then claim its skin in the Reliquary (Armor Cosmetics page). Each skin is restricted to its class.",
      "raidLocked": "Locked",
    ...
    "reliquary": {
      ...
      "sourceActivityCrucibleSetClaim": "Claimed after completing a full Inner Crucible set for your class",
      "armorHowTitle": "How to unlock",
      "armorHow": "Complete any full five-piece Inner Crucible tier set for your class (the sets sold by the Crucible Quartermaster for raid sigils). Then press Claim to unlock your class armor skin. Wear it from the Cosmetics window, Raid Cosmetics tab.",
