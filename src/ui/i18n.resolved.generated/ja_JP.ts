  ...
  "hudChrome": {
    ...
    "raidBossGuide": {
      ...
      "nythraxis": {
        ...
        "phaseThroneName": "玉座",
        "phaseThroneSummary": "ナイスラクシスは玉座の間を、溜めた前方クリーブ、ドレッドカースによるタンク交代、レイドを串刺しにする骨の棘、燃える地面を残す墓所の噴出、そして蘇った王家の衛兵の波で守り抜く。",
        ...
        "graveEruptionHeroicSummary": "{everyHeroic}秒ごとに、骸骨の手がレイドメンバーの足元に{radius}ヤードの円を{countHeroic}個描く。{warning}秒後、各円は最大体力の{burstHeroic}を闇ダメージとして噴出させ、その後はフェーズが終わるまで墓炎として燃え続け、中に立つ者へ毎秒最大体力の{tickHeroic}を与える。この炎は自然には消えない：レイドが動き続けなければ床は炎で埋め尽くされる。",
        ...
        "soulfireSummary": "ソウルレンドが発動するたびに、印があった場所に幅{radius}ヤードの赤い炎の水たまりが残り、{seconds}秒間、毎秒最大体力の{tickNormal}のダメージを与えながら燃え続ける。水たまりはウォードストーンから{clearance}ヤード以内には出現しない。",
        "soulfireHeroicSummary": "ソウルレンドが発動するたびに、印があった場所に幅{radius}ヤードの赤い炎の水たまりが残り、フェーズが終わるまで毎秒最大体力の{tickHeroic}のダメージを与えながら燃え続ける。水たまりはウォードストーンから{clearance}ヤード以内には出現せず、自然に消えることもない。",
        "soulfireResponse": "詠唱のたびにソウルレンドの集合地点を変え、レイドが前回の炎の中に集まらないようにする。",
        "gravefireName": "紫炎",
