...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "deepglass": {
      "gossip": "ディープグラスへ連れて行ってくれ",
      "gossipAria": "ディープグラスへ移動してディープボールの試合を始める",
      "bout": "各チーム{n}人",
      "boutAria": "ディープボールの試合を開始（各チーム{n}人）"
    },
    "portalWizard": {
      "gossipDeepglass": "ディープグラスへの道を開いてくれ",
      "gossipDeepglassAria": "バルデマールにディープグラスへのポータルを開いてもらう",
      "gossipHome": "帰り道を開いてくれ",
      "gossipHomeAria": "バルデマールに町へ戻るポータルを開いてもらう",
      "portalOpen": "ポータルが開いた。くぐって進もう。"
    },
    "plotSign": {
      "title": "売り出し中の住宅区画",
      "size": "{size}区画、{w}×{d}ヤード",
      "sizes": {
        "small": "小",
        "medium": "中",
        "large": "大"
      ...
      "price": "希望価格 {price}",
      "purse": "所持金：{purse}",
      "yours": "この権利書はあなたが所有しています。",
      "sold": "売却済み。{name}がこの権利書を所有しています。",
      "buy": "{price}で購入",
      "close": "閉じる",
      "boughtLog": "{name}の権利書はあなたのものです。"
    },
    "realmBuilder": {
      "title": "今月の王国建設者",
      "currentLabel": "今月の受賞者",
  ...
  "editor": {
    ...
    "playtestBack": "エディターに戻る",
    "playtestBackTitle": "マップエディターに戻る（プレイテスト開始時にマップは保存済みです）",
    "topbar": {
      "label": "エディター操作",
      "mapNameLabel": "マップ名",
      "dirty": "未保存の変更があります",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "deepglass_marshal": {
        "name": "試合長イヴェット・コーラルウェイク",
        "title": "笛の番人",
        "greeting": "鐘は温かく、水は澄んでいる、{className}。組み合わせを言えば笛を鳴らそう。ボールを独り占めしたいなら一対一、誰かのせいにしたいなら三対三の本戦だ。"
      },
      "portal_wizard_eastbrook": {
        "name": "禿頭のバルデマール",
        "title": "輝く頭の大魔導師",
        "greeting": "ああ、頭は禿げている。山の風のせいではない。髪とは錨なのだ、{className}：一本一本が魂をひとつの土地に繋ぎ止める。わしはそれを、髪をすべて、世界に通じる扉と引き換えた。頼めば、ディープグラスへの道を開いてやろう。もう一人のわしはすでに向こうにいて、幸運を祈って頭を磨いているところだ。"
      },
      ...
      "portal_wizard_deepglass": {
        "name": "禿頭のバルデマール",
        "title": "輝く頭の大魔導師",
        "greeting": "先に着いていると言っただろう。禿頭は身軽に旅ができるのでな、{className}。鐘を楽しみ、ガラスに気をつけて、故郷の草地が恋しくなったら一言言うがいい。帰り道は輝く思いひとつの先にある。"
      },
      "dg_spectator_pace1": {
        "name": "メリー・サロウ",
        "title": "ディープグラスの観客",
        "greeting": "強く打てばボールが歌うと言うじゃないか。それを聞きに来たのさ。"
      },
      "dg_spectator_pace2": {
        "name": "ジョソン・ブリル",
        "title": "ディープグラスの観客",
        "greeting": "試合の前はじっと座っていられないんだ。昔からそうさ。妻に聞いてみるといい、上の段にいるから。"
      },
      "dg_spectator_pace3": {
        "name": "ペタ・ウェイブクレスト",
        "title": "ディープグラスの観客",
        "greeting": "縁を三往復すれば、ちょうど一試合分の緊張が収まる。計ったことがあるんだ。"
      },
      "dg_spectator_pace4": {
        "name": "タム・グラウンズウェル",
        "title": "ディープグラスの観客",
        "greeting": "縁の内側にいて、欄干に気をつけな。テラスから足を踏み外したら、長い落下になるぞ。"
      },
      "dg_spectator_yard1": {
        "name": "老いたコーモラント",
        "title": "ディープグラスの観客",
        "greeting": "わしの時代は水はもっと冷たく、ゴールはもっと小さかった。それ以外は、まあ認めてやろう。"
      },
      "dg_spectator_yard2": {
        "name": "ハロウ・フィンチ",
        "title": "ディープグラスの観客",
        "greeting": "銀貨三枚をアウェー側に賭けちまってね。パイでも食べて気を紛らわせてるところさ。"
      },
      "dg_spectator_yard3": {
        "name": "コービン・アッシュヴェイン",
        "title": "ディープグラスの観客",
        "greeting": "禿げた魔導師がここまでのポータルを売ってくれたのさ。あれほど使い出のある銅貨はなかったね。"
      },
      "dg_spectator_yard4": {
        "name": "セシ・ブライン",
        "title": "ディープグラスの観客",
        "greeting": "試合の日だけは、裂け目の風が揚げパンの匂いになる。鼻を頼りについて行くといい。"
      },
      "dg_spectator_tier1": {
        "name": "ベラ・ライムグラス",
        "title": "ディープグラスの観客",
        "greeting": "観客席の中でも一番の席だよ。一撃を受けるたびに鐘全体が震えるのが見えるんだ。"
      },
      "dg_spectator_tier2": {
        "name": "フェリン・ソルトカスク",
        "title": "ディープグラスの観客",
        "greeting": "夜明けからこの列を守っている。笛が鳴るまで手放しはしないよ。"
      },
      "dg_spectator_tier3": {
        "name": "ニム・パールオーバー",
        "title": "ディープグラスの観客",
        "greeting": "試合開始の直前に水が静まる瞬間、競技場全体もそれと一緒に息を呑むんだ。"
      },
      "dg_spectator_tier4": {
        "name": "女房オルダー",
        "title": "ディープグラスの観客",
        "greeting": "夫はわたしが神殿にいると思っている。神殿はわたしが夫といると思っている。"
      },
      "dg_spectator_tier5": {
        "name": "船長ヴェル",
        "title": "ディープグラスの観客",
        "greeting": "あらゆる海を渡ってきたが、これまで見た中でいちばん奇妙な水は、あそこに浮かんでいるやつさ。"
      },
      "dg_spectator_tier6": {
        "name": "イヴォ・ランタンウェイク",
        "title": "ディープグラスの観客",
        "greeting": "段が高いほど空気は薄く、眺めは良くなる。この上りも入場料のうちさ。"
      },
      "dg_spectator_tier7": {
        "name": "モード・スレッドニードル",
        "title": "ディープグラスの観客",
        "greeting": "ボールが手を変えるたびに一段編むんだ。前の試合ではマフラーを丸ごと一本仕上げたよ。"
      },
      "dg_spectator_tier8": {
        "name": "しわがれ声のペロ",
        "title": "ディープグラスの観客",
        "greeting": "前の試合で声を潰しちまった。でも悔いはない。今日もまたやるさ。"
      },
      "dg_spectator_tier9": {
        "name": "リヴァ・アンダートウ",
        "title": "ディープグラスの観客",
        "greeting": "ゴールが崩れる時は鐘の真下に立つな。せめて最初の忠告だけは信じてくれ。"
      },
      "dg_spectator_tier10": {
        "name": "ダナ・ケルプブレイド",
        "title": "ディープグラスの観客",
        "greeting": "試合の前になると支柱がうなるんだ。手を当てれば、試合が近づいているのを感じられるよ。"
      },
      "dg_spectator_tier11": {
        "name": "マーロ・スピューム",
        "title": "ディープグラスの観客",
        "greeting": "灯りは十六個、なのに蛾は一匹もいない。世界一高い場所にある灯りだからだろうな。"
      },
      "dg_spectator_tier12": {
        "name": "ウェナ・タイドレース",
        "title": "ディープグラスの観客",
        "greeting": "泳ぎを見に来たんだが、居座っているのは堤道を下るのがあまりに長いからさ。"
      },
      "dg_stallkeeper_pies": {
        "name": "パイ売りロルド",
        "title": "試合の日の糧食",
        "greeting": "熱々のパイに冷たい水、行列より長持ちする干し肉もあるよ。笛が鳴る前に食べときな、友よ、後半はどんな腹の都合も待っちゃくれないからね。"
      },
      "dg_stallkeeper_tonics": {
        "name": "セラ・フィアル",
        "title": "薬と酒",
        "greeting": "打ち身の薬に、神経の薬、それと堤道から落ちた時のための一杯もあるよ。選手が買うのは最初の二つ、観客が買うのは三つ目さ。"
      },
      "dg_stallkeeper_favors": {
        "name": "旗婆ウィン",
        "title": "お守りと旗",
        "greeting": "勝ち分を入れる巾着に、迷いをしまう袋。買うなら巾着にしときな、そっちの方が縁起がいいよ。"
      },
      "th_gate_captain": {
        "name": "門衛隊長イゾルデ・ブラック",
        "title": "潮の門の番人",
        "greeting": "タイドホールドは鐘を守り、{className}、わたしはタイドホールドを守る。堤道は開き、市場は賑やかで、ウォーデンもいる。帰りは欄干に気をつけな。"
      },
      "th_gate_watch_0": {
        "name": "ウォーデン・セーブル・クィスト",
        "title": "門衛",
        "greeting": "通り過ぎな。結界は静かだ、このまま静かでいてほしいのでね。"
      },
      "th_gate_watch_1": {
        "name": "ウォーデン・トーマス・リール",
        "title": "門衛",
      ...
      "th_lamplighter": {
        "name": "点灯夫オンドリー",
        "title": "水晶灯の番人",
        "greeting": "堤道からウォーデンの座まで、灯りは残らずこの手にかかっている。日が落ちる前に、どれも世話をしてやらねばな。よければついておいで、この街いちばんの散歩道だよ。"
      },
      "th_stablemaster": {
        "name": "厩舎長コリン・ヴェイン",
        "title": "タイドホールド厩舎",
        "greeting": "翼のあるものは断る、噴射装置つきも断る。堤道から落ちたことのない、まっとうな馬だけを扱っている。"
      },
      "th_market_pies": {
        "name": "マーラ・ソルトミア",
        "title": "パンと塩水",
        "greeting": "通りの窯から出来立てだよ、{className}。ここで食べときな、外のテラスじゃ半分は風に飛ばされちまうから。"
      },
      "th_market_tonics": {
        "name": "薬師レン・フェル",
        "title": "薬と酒",
        "greeting": "打ち身の薬に、神経の薬、それと落下した時の薬もある。ディープボールの選手が一番の得意客さ。"
      },
      "th_market_bags": {
        "name": "荷物頭ヘスト",
        "title": "鞄と紐",
        "greeting": "ガラス市場の品を、素手で家まで運べるものか、{className}。どうしてそれを知っているか、聞いてみるといい。"
      },
      "th_market_reagents": {
        "name": "鉱石商ダン",
        "title": "鉱石と延べ棒と鉄塊",
        "greeting": "通りの鍛冶場で作られる物は何でも、誰かの背に担がれて堤道を上ってくる。たいていはわたしの背だがな。"
      },
      "th_smith": {
        "name": "鍛冶頭イェラ・ブライン",
        "title": "タイドホールド鍛冶場",
        "greeting": "ガラスはウォーデンの領分、鋼はわたしの領分だ。ガラスが持ちこたえぬ時も、わたしの鋼は持ちこたえる。"
      },
      "th_banker": {
        "name": "金庫番アンセル・タイド",
        "title": "ディープグラス金庫",
        "greeting": "お前の懐より岩の中の方が安全だ、{className}。何しろ五十ヤードの崖っぷちだからな。"
      },
      "th_merchant": {
        "name": "仲買人イゼル・コーラルウェイク",
        "title": "ウォーデン市場",
        "greeting": "この国の半分が、試合目当てに品物をここへ送ってくる。売り買いはご自由に、ただし行列には気をつけて。"
      },
      "th_innkeeper": {
        "name": "宿屋の主人ドヴ・マロウ",
        "title": "金色のカモメ亭",
        "greeting": "寝台に食事、鐘を望む窓つきだ。試合の夜は眠れやしないが、眠りたいとも思わんだろうよ。連れが欲しいなら、掲示板が戸口のそばにある。"
      },
      "th_market_folk_0": {
        "name": "ネッタ・ハロウェイ",
        "title": "ガラス商人",
        "greeting": "試合の日で、テラス中の人がここへ買い物に来ている。財布と肘に気をつけな。"
      },
      "th_market_folk_1": {
        "name": "ブラム・カロック",
        "title": "縄職人",
      ...
      "th_dockhand_0": {
        "name": "波止場長フェロウ・ケル",
        "title": "繋留場",
        "greeting": "船はここで岩に繋がれ、氷の上に浮かぶようにぶら下がる。慣れるか、さもなくば堤道を戻るしかない。"
      },
      "th_dockhand_1": {
        "name": "索具師セナ・タル",
        "title": "繋留場",
      ...
      "th_clerk": {
        "name": "書記オットリン・ヴェックス",
        "title": "ウォーデンの館",
        "greeting": "陳情は左、試合の異議申し立ては右、堤道の欄干にまつわることは何でもこの机へ。"
      },
      "th_priest": {
        "name": "潮語りハロラン",
        "title": "静水の礼拝堂",
        "greeting": "祭壇には鐘そのものの水を湛えた鉢を置いている。一度たりとも濁ったことはない。"
      },
      "th_armourer": {
        "name": "需品官ルーク・アドリン",
        "title": "大武具庫",
        "greeting": "衛兵が持つもの一式と、本来持つべきものも少々。ウォーデンが金を出す分、お前の払いは安くなる。"
      },
      "th_row_folk_0": {
        "name": "マギステル・イルヴェイン・ドス",
        "title": "ウォーデンの家中",
        "greeting": "ここまで上がれば、風が止んだ時に鐘の音が聞こえる。街で一番の住まいだよ。"
      },
      "th_row_folk_1": {
        "name": "女房プレル",
        "title": "Of the Row",
      ...
      "th_warden": {
        "name": "ウォーデン・カッシア・ディープグラス",
        "title": "鐘のウォーデン",
        "greeting": "堤道をまるまる登って、わたしを見に来たのか、{className}？鐘はお前の後ろにある、それがこの町で登る価値のある唯一のものだ。行って遊んでくるといい、そのために我々はあれを守っているのだからな。"
      },
      "th_seneschal": {
        "name": "家宰アルドリック・プール",
        "title": "ウォーデンの座",
        "greeting": "ウォーデンは砂時計が返るごとに陳情人と会う。もっとも、この街の砂時計はずいぶん大きいがね。"
      },
      "th_keep_guard_0": {
        "name": "衛兵オッター",
        "title": "ウォーデンの衛兵",
        "greeting": "この門はウォーデンの言葉により開かれている。鐘が鳴ったら落とし格子に気をつけろ。"
      },
      "th_keep_guard_1": {
        "name": "衛兵リズベット",
        "title": "ウォーデンの衛兵",
        "greeting": "中庭にとどまってくれ、友よ。広間はウォーデンのもの、塔はわれらのものだ。"
      },
      "th_keep_guard_2": {
        "name": "衛兵ヴァンス",
        "title": "ウォーデンの衛兵",
        "greeting": "中ではウォーデンが謁見を行っている。靴の泥を落とせ、その絨毯はゴールドクレストから来たものだ。"
      },
      "th_keep_guard_3": {
        "name": "衛兵メリン",
        "title": "ウォーデンの衛兵",
        "greeting": "陳情人は広間へ、配達は厨房棟へ。お前はどちらだ？"
      },
      "th_fountain_keeper": {
        "name": "泉守ブリン・カドック",
        "title": "ウォーデンたちの泉の番人",
        "greeting": "この泉は鐘そのものの水で満ちている、{className}。ウォーデンたちの言葉を信じるなら、堤道の下を通して汲み上げているそうだ。バルデマールは頭に水しぶきを浴びるのがお気に入りでな。禿頭が輝き続けると言っている。"
      },
      "th_bridge_watch_0": {
        "name": "橋番ケティル・ヴォス",
        "title": "The West Span",
        "greeting": "黒い氷の上に架かる百三十ヤードの石橋、わたしの仕事はその欄干を守ることだ。見下ろしたいなら見るといい、誰もが一度はそうするからな。"
      },
      "th_bridge_watch_1": {
        "name": "橋番マーラ・フロスト",
        "title": "The East Span",
