...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "gauntlet": {
      ...
      "phaseStaging": "位置につけ",
      "phaseTrial": "横断開始",
      "phaseTrialSigils": "刻印開始",
      "phaseTrialPull": "綱を取れ",
      "phaseTrialEcho": "番人の残響が始まる",
      "phaseTrialSpan": "脆き橋を渡れ",
      "phaseTrialCourt": "最終決戦の場",
      ...
      "placeSecond": "2nd",
      "placeThird": "3rd",
      "sigilsShattered": "飴細工が砕けた!",
      "echoRound": "ラウンド {n} / {total}",
      ...
      "hint": {
        ...
        "court": "相手と決闘だ。奥の王冠にたどり着くか、相手をリング外へ突き飛ばせ。役割は一定時間で入れ替わる。"
      }
    },
    "hub": {
      "enter": "揺らめく門をくぐり、試練場へと足を踏み入れる。",
      "leave": "あなたはイーストブルック渓谷へと戻る。",
      "zoneName": "試練の書院"
    },
    "hc": {
      "title": "ホドリック城",
      "close": "ガントレットウィンドウを閉じる",
      "zoneName": "ホドリック城",
      "offlineNote": "ガントレット受付がまだ同期していません。少々お待ちください。",
      "howto": "3ラウンド、10人のレーサー、栄冠はひとつ。ホドリック卿は毎ラウンド、ガントレットを作り替える。各ラウンドの脱落を生き延び(6人通過、次は3人)、決勝を制せ。落下は時間のロスだけだ。",
      "joinQueue": "ガントレットに参加",
      "leaveQueue": "列を離れる",
      "queuedAt": "待機中、順位 {position}。十人揃うとレース開始。",
      "inMatchNote": "レース中だ。前だけを見ろ!",
      "practice": "宮廷と練習する",
      "practiceNote": "ホドリック卿の宮廷と対戦:九人の挑戦者、待ち時間なし。",
      "record": "優勝 {wins} / 出走 {races}",
      "bestTime": "自己ベスト {seconds}秒",
      "bestNone": "まだ完走記録がありません",
      "rank": "順位 {rank} / {total}",
      "finishPlace": "{place}位でゴール",
      "timeLeft": "{seconds}s",
      "overWon": "王冠はあなたのものだ!",
      "overPlaced": "レース終了:{place}位",
      "round": "ラウンド {round}/{rounds}",
      "advance": "{count}人通過",
      "spectating": "ギャラリーから観戦中",
      "intermissionRebuild": "ホドリック卿がガントレットを作り替える!",
      "intermissionQualified": "通過!まもなく次のラウンド。",
      "intermissionEliminated": "脱落!ギャラリーからの眺めをどうぞ。",
      "section": {
        "start_yard": "スタート広場",
        "hammer_bridge": "ハンマー橋",
        "rotor_court": "回転丸太の中庭",
        ...
        "drawspan": "跳ね橋",
        "boulder_climb": "大岩の坂",
        "piston_ledge": "ピストンの棚道",
        "spinner_court": "回転盤の広場",
        "landing": "踊り場",
        "red_ascent": "紅の坂道",
        "finish_keep": "ゴールの主塔"
      },
      ...
      "log": {
        "queued": "ガントレットの列に並んだ(順位 {position})。",
        "unqueued": "ガントレットの列を離れた。",
        "fall": "深淵に落ちた。チェックポイントへ戻る。",
        "checkpoint": "チェックポイント {index} を通過。",
        "qualified": "次のラウンドへ進出した。",
        "eliminated": "ラウンド{round}で脱落。ギャラリーには軽食があるらしい。",
        "placed": "ガントレットを{place}位で完走した。"
      },
      "flavor": {
        "queueJoin": "ガントレットの列に並んだ。ホドリック卿があなたに敬意を表しフレイルに油を差す。",
        "gatesOpen": "ホドリック城の門がきしみながら開く。王冠へ向かって走れ!",
        "go": "スタート!ガントレットが開いた!",
        "rebuild": "ホドリック卿がガントレットを作り替えた。コースは新しく、栄冠はひとつ!"
      },
      "err": {
        "legsOnly": "ガントレット中は脚のみ:スキル使用は禁止されている。",
        "inMatch": "すでにガントレットに参加中です。",
        "dead": "死亡中はガントレットに参加できません。",
        "arenaConflict": "ガントレットに参加する前に闘技場を離れてください。"
      }
    },
    "death": {
  ...
  "guide": {
    ...
    "hodricsCastlePage": {
      "heading": "ホドリック城",
      "intro": "ホドリック卿は城の道をあらゆる挑戦者に開放している。彼の旧防衛線の試練を駆け抜け、王冠を勝ち取れ。あなたが誰であろうと、レベルが何であろうと関係ない。",
      "heraldHeading": "伝令",
      "heraldBody": "イーストブルックの端にいる伝令オズリックを訪ねてガントレットの列に並ぼう。十人の挑戦者(実際のプレイヤーとホドリック卿の宮廷の騎士の両方)が揃うとレースが始まるので、レースはいつもすぐに始まる。",
      "courseHeading": "3ラウンド、栄冠はひとつ",
      "courseBody": "ガントレットは勝ち抜きショーだ。第1ラウンドは10人で始まり、6人が生き残り、3人が決勝へ進み、1人が王冠を戴く。ホドリック卿はラウンドごとにコースを作り替えるため、同じ走りは二度とない。ハンマー橋、回転丸太の中庭、斧の回廊、跳ね橋、大岩の坂、ピストンの棚道、回転盤など、その日の卿の気分次第の順番だ。どの仕掛けも決まった時計仕掛けのリズムで揺れ、回り、転がる。乱数は一切ないので、注意深い目は必ず安全な間合いを見つけられる。",
      "fairnessHeading": "脚だけが頼り",
      "fairnessBody": "ここでは誰も呪文を唱えない。レース中はスキルの使用が全面的に禁止され、全選手が同じ速度で走る。ガントレットを決めるのは度胸とタイミングだけで、装備やレベルは関係ない。",
      "fallsHeading": "転落は時間を失うだけ",
      "fallsBody": "仕掛けの一撃や深淵への転落は、最後のチェックポイントへ戻されるだけ。この城で死ぬ者はいない。転落の代償は、追いつくまでの数秒だけだ。ラウンド終了で脱落した者は華麗にギャラリーへ打ち上げられ、軽食とともに残りのショーを観戦する。",
      "standingsHeading": "王冠",
      "standingsBody": "決勝ラウンドのゴールを最初に駆け抜けた者が、そのショーのホドリックの王冠を手にする。出走数、優勝数、決勝ベストタイムは、並ぶたびに積み上がっていく。"
    },
    "valeCupPage": {
      "heading": "ヴェイルカップ",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "hodrics_herald": {
        ...
        "greeting": "ホドリック卿はすべての挑戦者に道を開く!ガントレットに挑み、フレイルをかわし、王冠を勝ち取れ!"
      },
      "groundskeeper_bram": {
        "name": "整備人ブラム",
        "title": "ソウフィールドの番人",
