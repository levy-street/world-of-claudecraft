...
export const ja_JP: EnTranslations = {
  ...
  "races": {
    ...
    "dwarfAria": "種族: ドワーフ",
    "gnomeAria": "種族: ノーム",
    "elf_exileAria": "種族: 追放エルフ",
    "elfAria": "種族: エルフ",
    "dark_faeAria": "種族: ダークフェイ",
    "frost_kinAria": "種族: フロストキン",
    "shadow_walkerAria": "種族: シャドウウォーカー",
    "desert_clanAria": "種族: 砂漠の氏族",
    "sand_mageAria": "種族: 砂の魔導士",
    "nomadAria": "種族: 遊牧民",
    "stone_wardenAria": "種族: 石の守護者",
    "raceLabel": "種族",
    "racialLabel": "種族特性",
    "levelRaceClass": "レベル{level} {race}{className}",
    "racialName_human": "上陸の誓い",
    "racialDesc_human": "休息経験値の蓄積が25%速くなる。",
    "racialName_dwarf": "石の血",
    "racialDesc_dwarf": "防御力が5%上昇する。",
    "racialName_gnome": "歯車の知恵",
    "racialDesc_gnome": "知力が5%上昇する。",
    "racialName_elf_exile": "流刑者の規律",
    "racialDesc_elf_exile": "詠唱の後退が20%軽減される。",
    "racialName_elf": "黄昏の優雅",
    "racialDesc_elf": "回避率が1%上昇する。",
    "racialName_dark_fae": "妖精の狡知",
    "racialDesc_dark_fae": "クリティカル率が1%上昇する。",
    "racialName_frost_kin": "冬の皮膚",
    "racialDesc_frost_kin": "スタミナが3%上昇する。",
    "racialName_shadow_walker": "静かなる刃",
    "racialDesc_shadow_walker": "敏捷性が3%上昇する。",
    "racialName_desert_clan": "陽鍛えの体",
    "racialDesc_desert_clan": "最大体力が3%上昇する。",
    "racialName_sand_mage": "硝子の調律",
    "racialDesc_sand_mage": "呪文威力が5%上昇する。",
    "racialName_nomad": "果てなき行進",
    "racialDesc_nomad": "精神が5%上昇する。",
    "racialName_stone_warden": "石切りの膂力",
    "racialDesc_stone_warden": "筋力が3%上昇する。"
  },
  "controls": {
    "title": "操作ガイド",
    "movement": "移動",
