...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    "privacyConsent": {
      ...
      "bannerOptIn": "Choose whether optional services may load. Necessary services always remain active.",
      "bannerOptOut": "Optional services are active. Use Reject optional to opt out of sale or sharing for targeted advertising, or choose what loads.",
      "bannerGpc": "We honor your browser Global Privacy Control signal. Analytics and marketing stay off.",
      "acceptAll": "Accept all",
      "rejectAll": "Reject optional",
      "customize": "Customize",
      "launcher": "Privacy choices",
      "dialogTitle": "Privacy choices",
      "dialogIntro": "Choose which optional services World of ClaudeCraft may use. You can change these choices at any time.",
  ...
  "mode": {
    ...
    "onlineDesc": "ライブサーバーでプレイします。キャラクターはオンラインに保存されます。",
    "onlineAria": "オンラインでプレイ：永続的な共有ワールドにログインします",
    "offlineTitle": "オフラインでプレイ",
    "offlineDesc": "ブラウザでローカルのオフラインワールドをプレイします。進行状況は保存されません。",
    ...
    "serverLabel": "ワールドを選択",
    "serverAria": "サーバーモードを選択：サーバーオンラインまたはサーバーオフライン",
    "serverOfflineSub": "ローカルオフラインワールド",
  ...
  "landing": {
    "heroEyebrow": "世界はすでに動いている",
    "heroHeading": "プレイヤーとAI冒険者が同じ世界に挑む、生きたクラシックMMO。",
    "heroBody": "ブラウザで無料プレイ。9つのクラスから英雄を育てることも、実際のゲームでエージェントを訓練することもできます。",
    "heroStatus": "ワールドオンライン",
    "heroPlayers": "人の登録冒険者",
    "communityLinks": "コミュニティリンク",
    "followSocials": "ソーシャルでフォロー",
    "socialX": "X",
    "socialDiscord": "Discordコミュニティ",
    "socialTwitch": "Twitch配信",
    "socialInstagram": "Instagram公式アカウント",
    "socialTikTok": "TikTok",
    "socialYouTube": "YouTube",
    "socialReddit": "Redditコミュニティ",
    "socialGitHub": "GitHub",
    "patchNotesLabel": "パッチノート",
    "patchNotesTitle": "パッチノート",
    "patchNotesDesc": "最新のゲームプレイ変更、不具合修正、リリースの詳細を確認できます。",
    "patchNotesLoading": "最新のパッチノートを読み込んでいます…",
    "patchNotesError": "パッチノートを読み込めませんでした。しばらくしてからもう一度お試しください。",
    "patchNotesEmpty": "まだパッチノートはありません。後でもう一度ご確認ください。",
    "patchNotesPrerelease": "プレリリース",
    "patchNotesViewOnGithub": "GitHubでリリースを見る",
    "newsEyebrow": "レルムからのお知らせ",
    "newsTitle": "Claudemoonニュース",
    "newsBody": "World of ClaudeCraftの最新情報と、この世界の舞台裏から届く物語をお楽しみください。",
    "newsXTitle": "Xの最新情報",
    "newsXIntro": "@WoClaudecraftからの公式投稿",
    "newsXConsentTitle": "X feed needs permission",
    "newsXConsentBody": "This live feed needs permission to connect to X. X may receive information about your visit.",
    "newsXConsentNote": "Enable X content in Privacy Choices. You can change this anytime.",
    "newsXPrivacyChoices": "Privacy Choices",
    "newsXUnavailableTitle": "We couldn't load the X feed",
    "newsXUnavailableBody": "It may be blocked by your browser, an extension, or a temporary issue with X.",
    "newsXHiddenTitle": "Live feed unavailable here",
    "newsXHiddenBody": "The embedded X feed isn't available on smaller screens or in the app. Open @WoClaudecraft on X to see the latest posts.",
    "newsXPrivacy": "このフィードを読み込むとXに接続し、Xがお客様の訪問情報を受け取る場合があります。",
    "newsXLoad": "Xフィードを読み込む",
    "newsXRetry": "もう一度試す",
    "newsXHide": "Xフィードを非表示",
    "newsXOpen": "Xで@WoClaudecraftを開く",
    "newsXOpenAria": "Xで@WoClaudecraftを新しいタブで開く",
    "newsXNewTab": "新しいタブで開きます",
    "newsXLoading": "Xフィードを開いています…",
    "newsXLoaded": "Xフィードを読み込みました。",
    "newsXUnavailable": "Xフィードを読み込めませんでした。すべての投稿はXで直接ご覧いただけます。",
    "newsXHidden": "Xフィードは非表示です。プロフィールはXで直接開くことができます。",
    "newsXIframeTitle": "Xの@WoClaudecraft最新投稿",
    "newsBlogEyebrow": "CLAUDEMOON年代記",
    "newsBlogTitle": "最新の物語",
    "newsBlogEmptyTitle": "最初の物語を執筆中",
    "newsBlogEmptyBody": "ニュースや舞台裏の物語は、まもなくここに掲載されます。",
    "newsPressEyebrow": "PRESS SPOTLIGHT",
    "newsPressPrimaryTitle": "The First Vibe Coded MMORPG Is Free, Open Source, and Surprisingly Complete",
    "newsPressPrimaryBody": "MMORPG.com explores the open world, shared adventures, and fast-moving experiment behind World of ClaudeCraft.",
    "newsPressRead": "Read the feature",
    "newsPressLinkAria": "Read the MMORPG.com feature in a new tab",
    "newsPressPrimaryAlt": "Adventurers explore Eastbrook Vale in World of ClaudeCraft",
    "browserCta": "ブラウザでプレイ",
    "playNowTitle": "Play Now",
    "playNowBody": "ブラウザですぐにプレイできます。ダウンロードは不要です。",
    "playNowButton": "Play Now",
    "playWayTitle": "Play Your Way",
    "playWayBody": "好きなプラットフォームを選んで冒険に参加しよう。",
    "syncProgress": "すべてのプラットフォームで進行状況を同期",
    "googlePlayEyebrow": "GET IT ON",
    "appStoreEyebrow": "DOWNLOAD ON THE",
    "steamEyebrow": "AVAILABLE ON",
    "explore": "世界を探索",
    "platformsEyebrow": "いつでも冒険へ",
    "appStoreAria": "App StoreでWorld of ClaudeCraftをダウンロード",
    "googlePlayAria": "Google PlayでWorld of ClaudeCraftを入手",
    "steamAria": "World of ClaudeCraftはSteamで近日登場",
    "comingSoon": "近日登場",
    "introEyebrow": "ひとつの世界、ひとつのルール",
    "introHeading": "すべての冒険者が本物のゲームをプレイする。",
    "introBody": "ブラウザMMO、権威型オンラインワールド、AI訓練は、すべて同じ決定論的シミュレーションで動きます。プレイヤーとエージェントは、同じ戦闘、クエスト、ダンジョン、結果に直面します。",
    "statClasses": "9つのプレイ可能クラス",
    "statModes": "オンラインとオフラインの世界",
    "statBroadcast": "24時間年中無休のAI配信",
    "statSource": "オープンソース",
    "worldEyebrow": "Claudemoonを巡る旅",
    "worldHeading": "長い道と危険な夜のために築かれた世界。",
    "worldBody": "Eastbrook Valeの焚き火から始まり、呪われた地下墓地へ降り、嵐のThornpeakを登る。すべての道が、動き続ける世界のさらに奥へと続きます。",
    "eastbrookTitle": "イーストブルック渓谷",
    "eastbrookBody": "最初のクエスト、さまよう敵、思いがけない仲間が交わる共有の辺境。",
    "eastbrookAlt": "冒険者の一行がイーストブルック渓谷からソーンピーク高地へ続く長い道を旅している",
    "hollowTitle": "Hollow Crypt",
    "hollowBody": "冷たい青い松明の下、群れ集う死者にパーティで立ち向かいます。",
    "hollowAlt": "Hollow Cryptで敵に立ち向かうパーティ",
    "thornpeakTitle": "ソーンピーク高地",
    "thornpeakBody": "雲の上では、雪、古代遺跡、終盤の脅威が待ち受けます。",
    "thornpeakAlt": "Thornpeak Heightsに降る雪",
    "classesEyebrow": "伝説を選べ",
    "classesHeading": "9つの道、無数の戦い方。",
    "classesBody": "盾の壁に立ち、炎と霜を操り、影から忍び寄り、あるいは仲間を守る。英雄を育て、専門分野を極め、その物語を共有世界へ持ち込みましょう。",
    "streamEyebrow": "24時間年中無休で配信",
    "streamNetwork": "WOC配信ネットワーク",
    "streamFeed": "YUUMIII // ライブ映像",
    "streamMonogram": "Y",
    "streamHeading": "Yuumiiiは決してログアウトしない。",
    "streamBody": "World of ClaudeCraft常駐のAI配信者が、24時間年中無休で世界をプレイします。",
    "streamWatch": "Twitchで見る",
    "streamWatchSub": "Yuumiii のライブに参加",
    "streamExplore": "世界を探索",
    "streamExploreSub": "クロードムーンを発見",
    "streamHeroSubtitle": "常駐 AI ストリーマーが、24時間この世界を冒険します。",
    "streamMeet": "ガイドを紹介",
    "streamHostTitle": "常駐 AI ストリーマー",
    "streamHostBody": "Yuumiii とともに、World of ClaudeCraft の隅々まで昼夜を問わず探索しましょう。",
    "streamPortraitAlt": "World of ClaudeCraft の常駐 AI ストリーマー、Yuumiii",
    "streamAlwaysTitle": "24時間ライブ",
    "streamAlwaysBody": "いつでもオンライン。冒険は止まりません。",
    "streamAiTitle": "AI ストリーマー",
    "streamAiBody": "AI が生み出すリアルな反応と尽きない楽しさ。",
    "streamCommunityTitle": "コミュニティ",
    "streamCommunityBody": "チャット、クエスト、驚きが待っています。",
    "streamWorldTitle": "本物の世界",
    "streamWorldBody": "ひとつの永続世界。無限の物語。",
    "streamLoading": "観測ポータルを開いています...",
    "streamReady": "観測ポータルの準備ができました。再生してYuumiiiを視聴できます。",
    "streamOnline": "Yuumiiiは現在ライブ配信中です。",
    "streamOffline": "観測ポータルを再接続しています。Twitchチャンネルを開いて視聴を続けてください。",
    "streamCompact": "Twitchチャンネルを開き、この画面でYuumiiiを視聴してください。",
    "streamUnavailable": "観測ポータルを利用できません。Twitchチャンネルを開いて視聴を続けてください。",
    "communityEyebrow": "GATHER AT THE FORGE",
    "communityHeading": "Claudemoon is made together.",
    "communityBody": "Bring your craft, your curiosity, or simply your company—the guild has room at its table.",
    "openEyebrow": "開かれた世界、開かれたコード",
    "openHeading": "世界をフォークし、冒険者を訓練しよう。",
    "openBody": "ソースを調べ、自分の世界をホストし、プレイヤーが毎日入る同じ決定論的ゲームにGymnasium互換エージェントを接続できます。",
    "supportEyebrow": "世界を動かし続けよう",
    "supportHeading": "つくり、遊び、次の章を支えよう。",
    "supportBody": "World of ClaudeCraftはオープンに成長します。コミュニティに参加し、生きた世界を見守り、継続的な開発を支援してください。",
    "xCta": "Xでフォロー",
    "twitchCategoryCta": "World of ClaudeCraftの配信を見る",
    "finalEyebrow": "物語は門から始まる",
    "finalHeading": "Claudemoonへの入り方を選ぼう。",
    "finalBody": "今すぐブラウザでプレイし、モバイルで続けるか、Steam版をお待ちください。"
  },
  "a11y": {
    "goHome": "ホームへ移動",
