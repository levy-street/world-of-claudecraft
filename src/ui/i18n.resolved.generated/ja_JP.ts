...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "professions": {
      ...
      "deedsBody": "功績の書が歩みに寄り添います。初めての調律で技巧に誓いし者、初めての傑作でMasterwrightを獲得し、どちらも称号として身につけられます。九つの製作職のうち八つはスキル50で節目の功績、上限125でGrandmaster称号を戴き（宝石細工は代わりに最初のレア品でPolished to Brillianceを記し、節目のページは対とともに待ちます）、釣りは熟練100でOld Salt、200でMaster Angler称号を得ます。初めての採集や製作、野外の幸運な発見、サルベージにも静かなページがあります。すべて装飾のみ。称号と名声だけで、功績が力を与えることはありません。",
  ...
  "entities": {
    "abilities": {
      ...
      "summon_voidwalker": {
        "name": "ダスクマークの召喚",
        "description": "ウォーロックの命令に従うダスクマークを召喚します。ダスクマークは敵を挑発し攻撃を受け止める頑強な悪魔です。新たな悪魔を召喚すると現在の悪魔は解放されます。悪魔は一度に1体しか従えられません。"
      },
      "summon_succubus": {
        "name": "ダスクボーンの召喚",
