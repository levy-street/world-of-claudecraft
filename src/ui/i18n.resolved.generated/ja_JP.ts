...
export const ja_JP: EnTranslations = {
  ...
  "game": {
    ...
    "talents": {
      ...
      "available": "使用可能",
      "spent": "使用済み",
      "pointSource": "選択行はレベル{first}から{cap}まで解放されます。解放済みの各行から1つ選びます。",
      "apply": "変更を適用",
      "clear": "選択をリセット",
      "reset": "リセット",
      "chooseSpec": "専門化を選択",
      ...
      "createBuildHint": "新規ビルドは現在の選択を別ビルドとして保存します。インポートは共有文字列を貼り付けます。",
      ...
      "unlockBanner": "タレント解除!",
      "unlockHint": "タレント選択が利用可能です。Nでタレントを開きます。",
      "copy": "コピー",
      "close": "閉じる",
      "cancel": "キャンセル",
      "noBuilds": "保存ビルドなし",
      ...
      "readout": {
        ...
        "specLocked": " 専門化はレベル {level} で解放されます。",
  ...
  "guide": {
    ...
    "talentsPage": {
      ...
      "intro": "タレントはクラスを自分らしくする仕組みです。任意で、やり直しやすく、簡単に変更できるので安心して試せます。",
      "whatHeading": "タレントの役割",
      "whatBody": "レベルが上がると、いくつかの選択肢を持つタレント行が解放されます。各選択はアビリティ、ステータス、道具立てに恒久的な強化を加え、戦闘でのクラスの感触を形作ります。",
      "howHeading": "仕組み",
      "howBody": "行はレベルに応じて解放され、専門化はレベル10で開きます。シグネチャ能力と熟達を見て専門化を選び、選択タブで解放済みの各行から1つずつ選びます。",
      "shareNote": "完成したビルドは短い共有コードとしてコピーして友人に渡せます。友人は自分のタレントパネルに貼り付けて読み込めます。",
      "resetTitle": "決定的なものは何もない",
      "resetNote": "戦闘中でなければいつでも選択をリセットできるため、序盤の選択が罠になることはありません。試して、好みを見つけ、自由に変えられます。",
      "specsHeading": "クラス別のスペシャライゼーション",
      "specsBody": "各クラスには複数の専門化があり、それぞれ役割とシグネチャの方向性があります。ここで全体像を確認できます。完全なキットはクラスを開いて見てください。"
    },
    "arenaPage": {
      "heading": "アリーナとPvP",
  ...
  "entities": {
    "abilities": {
      ...
      "heroic_leap": {
        "name": "ヒロイックリープ",
        "description": "対象地点へ跳躍し、周囲の敵に {damage} の物理ダメージを与えます。（ウォリアーのタレント）"
      },
      "pummel": {
        "name": "パメル",
        "description": "呪文の詠唱を中断し、4秒間その系統の呪文を唱えられなくします。（ウォリアーのタレント）"
      },
      "shield_wall": {
        "name": "シールドウォール",
        "description": "盾を構え、10秒間アーマーを大きく増加させます。（ウォリアーのタレント）"
      },
      "last_stand": {
        "name": "ラストスタンド",
        "description": "15秒間一時的にスタミナを増加させ、最大体力を増やします。（ウォリアーのタレント）"
      },
      "bladestorm": {
        "name": "ブレードストーム",
        "description": "鋼の嵐となり、毎秒周囲の敵に {damage} のダメージを与えます。（ウォリアーのタレント）"
      },
      "avatar": {
        "name": "アバター",
        "description": "巨像に変身し、20秒間攻撃力を増加させます。（ウォリアーのタレント）"
      },
      "rallying_cry": {
        "name": "ラリイングクライ",
        "description": "ラリイングクライを放ち、10秒間周囲の味方の攻撃力を増加させます。（ウォリアーのタレント）"
      },
      "counterspell": {
        "name": "カウンタースペル",
        "description": "敵の呪文詠唱を妨害し、6秒間その系統の呪文を唱えられなくします。（メイジのタレント）"
      },
      "ice_lance": {
        "name": "アイスランス",
      ...
      "presence_of_mind": {
        "name": "プレゼンスオブマインド",
        "description": "次の詠唱時間のある呪文を即時発動にします。60秒間持続します。（メイジのタレント）"
      },
      "blink": {
        "name": "ブリンク",
        "description": "15メートル前方へ瞬間移動し、移動不能効果を解除します。（メイジのタレント）"
      },
      "ice_block": {
        "name": "アイスブロック",
        "description": "氷に身を包み、8秒間大量のダメージを吸収します。（メイジのタレント）"
      },
      "deep_freeze": {
        "name": "ディープフリーズ",
        "description": "対象を深く凍結させ、{damage} のフロストダメージを与えて4秒間スタンさせます。（メイジのタレント）"
      },
      "meteor": {
        "name": "メテオ",
        "description": "対象地点に隕石を落とし、{damage} の火炎ダメージを与えて地面を燃やします。（メイジのタレント）"
      },
      "evocation": {
        "name": "エヴォケーション",
      ...
      "repentance": {
        "name": "悔悟",
        "description": "敵を最大6秒間瞑想状態にします。ダメージを受けると効果は解除されます。（リトリビューション特性のシグネチャ）"
      },
      "bestial_wrath": {
        "name": "野獣の怒り",
      ...
      "shamanistic_rage": {
        "name": "シャーマニスティックレイジ",
        "description": "シャーマンの怒りを解放し、マナを160回復します。（エンハンスメント特性のシグネチャ）"
      },
      "natures_swiftness": {
        "name": "自然の迅速さ",
        "description": "自然に呼びかけ、次の呪文を即時発動にします。（レストレーション特性のシグネチャ）"
      },
      "siphon_life": {
        "name": "サイフォンライフ",
      ...
      "fel_domination": {
        "name": "フェルドミネーション",
        "description": "邪悪な力を支配し、次の呪文を即時発動にします。（デモノロジー特性のシグネチャ）"
      },
      "conflagrate": {
        "name": "コンフラグレート",
