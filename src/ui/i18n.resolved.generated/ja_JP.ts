...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nftSkins": {
      "title": "Wear an NFT",
      "intro": "PFP NFTの所有を証明して着用しましょう。トレイトが体の見た目を形作り、そのアートがポートレートになります。NFTを保有している間は使用できます。",
      "connectEthereum": "Ethereumウォレットを接続",
      "connectSolana": "Solanaウォレットを接続",
      "ethereumLinked": "Ethereumウォレット: {address}",
      "solanaLinked": "Solanaウォレット: {address}",
      "notLinked": "未リンク",
      "collectionsTitle": "対応コレクション",
      "noCollections": "利用可能なコレクションはまだありません。しばらくしてからご確認ください。",
      "tokenIdPlaceholder": "トークンID",
      "mintPlaceholder": "ミントアドレス",
      "claim": "申請",
      "claiming": "申請中...",
      "claimed": "申請して装備しました。スキンブラウザからいつでも確認できます。",
      "needWallet": "先に対応するウォレットをリンクしてください。",
      "close": "閉じる",
      "errorNotOwner": "そのウォレットはこのトークンを所有していません。",
      "errorUnverified": "現在、所有権を確認できません。しばらくしてからもう一度お試しください。",
      "errorCollection": "そのコレクションには対応していません。",
      "errorTooMany": "NFTスキンの上限に達しました。",
      "errorMetadata": "現在、このNFTを読み取れません。しばらくしてからもう一度お試しください。",
      "errorGeneric": "このNFTスキンを申請できませんでした。",
  ...
  "marketplace": {
    ...
    "modeUpload": "アップロード",
    "modeLink": "セルフホスト",
    "uploadIntro": "自作の 1024x1024 PNG アトラスをアップロード。IPFS にピン留めし、こちらでホストします。",
    "linkIntro": "自分でホストする PNG アトラスをリンク。プロキシ経由なので購入者に URL は見えません。無料です。",
    "uploadFile": "Skin PNG (1024x1024)",
    "linkUrl": "アトラス URL",
    "quotaMeter": "ホスト枠 {used}/{quota} 使用中",
    "trustedBadge": "信頼済みクリエイター(即時公開)",
    "selfHostedFreeNote": "セルフホストは無料かつ無制限です(出品数の上限内)。",
    "hostingUnavailable": "ホスト型アップロードは一時的に利用できません。",
    "listedReview": "審査に提出しました。運営者が承認すると出品されます。",
    "baseColor": "ベースカラー",
    ...
    "randomize": "ランダム",
    "nameLabel": "Name",
    "namePlaceholder": "例:エメラルドドラゴンスケイル",
    "descLabel": "説明",
    "descPlaceholder": "購入者に表示される短い説明",
    "priceLabel": "価格(USDC)",
    "preview": "ライブプレビュー",
    "list": "出品する",
    "listing": "出品中…",
    "listed": "出品しました。すぐに購入可能です。所持スキンから装備できます。",
    "listFailed": "出品できませんでした",
    "listConnectFirst": "出品するにはウォレットを接続してください(収益の 70% を受け取れます)。",
    "payoutHint": "受け取りは 70% • 30% は $WOC の買い戻しと焼却に",
    "patterns": {
      "solid": "単色",
      "scales": "鱗",
      "stripes": "ストライプ",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "skin_artisan": {
        "name": "スキン職人ピップ",
        "title": "クリエイタースキン掲示板",
        "greeting": "新しい見た目はいかがですか、{className}?プレイヤーが作ったコスメティックスキンを眺めるもよし、自分でデザインして販売するもよし。支払いは USDC で、その一部が $WOC の買い戻しと焼却に充てられます。"
      },
      "marshal_redbrook": {
        "name": "レッドブルック元帥",
        "title": "町の元帥",
