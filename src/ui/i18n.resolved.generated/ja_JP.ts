  ...
  "entities": {
    ...
    "npcs": {
      ...
      "forgewright_brenna": {
        "name": "ブレンナ・コールライト",
        "title": "鍛冶匠",
        "greeting": "南西の岩崖に煙が上がっている、{className}。あの炉は祖母が自らの手で封じ、冷たく眠らせると誓ったものだ。冷えた炉は煙を吐かない。"
      },
      "tidewatcher_ondrel": {
        "name": "オンドレル・ヴェイン",
        "title": "潮見の番人",
    ...
    "quests": {
      ...
      "q_foundry_smoke": {
        "title": "岩崖に立つ煙",
        "text": "エンバーディープは元々わたしたちの鍛冶場だったのだ、{playerName}。氏族たちがそれを埋め、冷たく眠らせると誓う前はな。それが今また煙を上げている。ドログマールのオーガどもは、まるで叩かれた犬のように鍛冶場の外に座り込んでいる。何かが奴らを外へ追い出したのだ。戦線を越え、野営地の先にある包囲線まで行き、カルト信者たちが標柱に打ちつけている急使便を一枚持ち帰ってくれ。わたしの祖母の炉を再び灯した者が誰なのか、知っておかねばならない。",
        "completion": "「エンバーパクト」……熾火に祈りを捧げるカルトか。そして、{playerName}、この下端にある印章。これはエンバーディープそのものの古い鍛冶紋だ。奴らはただ鍛冶場に居座っているのではない。鍛冶場を稼働させているのだ。",
        "objectives": {
          "0": {
            "label": "エンバーパクトの急使便を入手"
          }
        }
      },
      "q_foundry_pickets": {
        "title": "包囲線を薄くせよ",
        "text": "エンバーパクトは狂信者の哨戒隊で岩崖への道を押さえており、奴らが立っている限り誰も鍛冶場の扉には辿り着けない。{playerName}、奴らはオーガを追い出したのだぞ。オーガをだ。狂信者を十体狩れば、その戦列は崩れる。",
        "completion": "熾火に祈る声がまた十だけ静まった。包囲線は薄くなり、扉はもう手の届くところにある。",
        "objectives": {
          "0": {
            "label": "エンバーパクトの狂信者を討伐"
          }
        }
      },
      "q_foundry_hounds": {
        "title": "窯の猟犬",
        "text": "カルトは岩崖の小道に猟犬を放っている、鉱滓がその毛皮の下で冷え固まった獣どもだ。八体を殺し、その体内で脈打つ鉱滓の心臓を六つ切り出してくれ。あんなものを生み出せるほど鍛冶場が熱いのなら、祖母がかつて灯していた炉よりもずっと熱いということだ。",
        "completion": "まだ温かい。{playerName}、鉱滓の心臓が鍛冶場の熱を保てるのはせいぜい一日だ。エンバーディープはただ灯っているのではない。燃え盛っているのだ。",
        "objectives": {
          "0": {
            "label": "燠火の猟犬を仕留める"
          },
      ...
      "q_foundry_sigils": {
        "title": "エンバーパクトの印章",
        "text": "あの戦線に立つ狂信者は皆、焼き固めた粘土の印章を身につけている。扉の結界を通り抜けるための鍵だ。六枚持ってきてくれ。焼き印の跡が読めれば、奴らが何基のるつぼを稼働させているか分かるはずだ。",
        "completion": "六枚の印章、そして六つの異なるるつぼの焼き印。{playerName}、エンバーディープにはるつぼが七基ある。奴らは鍛冶場を全稼働させているのだ。そして七つ目の焼き印は、大るつぼ、鉱滓心臓のものだ。",
        "objectives": {
          "0": {
            "label": "エンバーパクトの印章"
          }
      ...
      "q_foundry_ashmaw": {
        "title": "窯生まれのアッシュマウ",
        "text": "あの戦線にいる一体だけは、カルト信者でも猟犬でもない。冷え固まりゆく鉱滓の姿をしたものが高い小道を歩き、それは再び灯された鍛冶場が最初に鋳込んだものだ。哨戒隊はまるで軍旗のようにそれに従っている。窯生まれのアッシュマウを討ち、その核を持ち帰ってくれ、{playerName}。あれが歩いている限り、戦線は何度でも立て直される。",
        "completion": "核はまだ光を放っている。{playerName}、鋳込まれた鉱滓が生きているはずはない。あの鍛冶場を世話する者は、氏族たちがわざと埋めた何かを学び直したのだ。",
        "objectives": {
          "0": {
            "label": "アッシュマウの核"
          }
      ...
      "q_foundry_kilnmaster": {
        "title": "窯師",
        "text": "印章がその主の名を告げている。窯師ヴォール、エンバーディープが冷えているのを見出し、熾火に祈り返すことを教えた者だ。奴は組立場の先にある鋳造の間を占拠している。仲間を連れて扉をくぐり、奴を仕留めてくれ、{playerName}。これは一人でこなせる依頼ではない。",
        "completion": "ヴォールは自らの広間で灰と化した。だが、{playerName}、その法衣に残る焼き印を見るに……奴は鍛冶場の主ではなかった。奴はただの「ふいご」だったのだ。もっと深いところで、まだ何かが息をしている。",
        "objectives": {
          "0": {
            "label": "窯師ヴォールを討伐"
          }
      ...
      "q_foundry_slagheart": {
        "title": "鉱滓心臓の巨像",
        "text": "最後の焼き印を読み解いた、{playerName}。ようやくエンバーパクトが何を鍛えているのか分かった。何もない、というのが答えだ。鍛冶場は自分自身の体を鍛えているのだ。大るつぼはひと季節をかけて一つの鋳造を注ぎ続け、今や鍛冶場の中心にある鉄床の壇上に立ち、最後の焼き入れを待っている。それが壇を降りて歩き出せば、この先どんな戦が来ようと山はそれに抗えない。最強の仲間を集め、鉱滓心臓の巨像が完全に目覚める前に打ち砕いてくれ。",
        "completion": "ついに冷えた。そして今度こそ冷えたままにしてやる。祖母がわたしに教えたやり方で、この炉は自らの手で封じよう。山は、あと少しで自分の足元から何が歩き出そうとしていたか、決して知ることはないだろう、{playerName}。だがわたしは知っている。そしてお前もだ。",
        "objectives": {
          "0": {
            "label": "鉱滓心臓の巨像を打ち砕く"
          }
    ...
    "dungeons": {
      ...
      "emberdeep_foundry": {
        "name": "エンバーディープ鋳造場",
        "enterText": "鍛冶場の扉をくぐります。山が頭上で閉じ、再び灯されたエンバーディープの熱が通路を這い上がってきます。",
        "leaveText": "鍛冶場の扉を出て、岩崖の冷気の中へ戻ります。"
      },
      "drowned_temple": {
        "name": "溺れし神殿",
