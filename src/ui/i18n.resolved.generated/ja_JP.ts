...
export const ja_JP: EnTranslations = {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "skin_artisan": {
        "name": "Pip the Skin Artisan",
        "title": "Creator Skins Billboard",
        "greeting": "Fancy a new look, {className}? Browse cosmetic skins crafted by players - or design your own and sell it. Paid in USDC; a slice buys and burns $WOC."
      },
      "marshal_redbrook": {
        "name": "レッドブルック元帥",
        "title": "町の元帥",
