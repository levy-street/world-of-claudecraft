...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "amountWithUsd": "{amount} クラウジウム（{usd}）",
      "usdAmount": "${usd}",
      ...
      "railSol": "SOL",
      "railUsdc": "USDC",
      "railDisabled": "この支払い方法は現在利用できません。",
      "oracleUnavailable": "ライブ価格は現在利用できません。しばらくしてから再度お試しください。",
      "quoteButton": "見積もりを取得",
      "amountRow": "{usd} で {claudium} クラウジウム",
      "sendExactly": "正確に {amount} {rail} を送金",
      "addressLabel": "送金先",
      "memoLabel": "メモ (必須)",
      "splitLabel": "内訳",
      "splitBurn": "{amount} {rail} をバーン",
      "splitTreasury": "{amount} {rail} を財務庫へ",
      "splitSummary": "{burn} {rail} をバーン、{treasury} {rail} をトレジャリーへ",
      "reviewLabel": "確認",
      "reviewLine": "{pay} {rail} をお支払いいただき、{claudium} クラウジウム（{usd}）を受け取ります。",
      "reviewLineCard": "{usd} をお支払いいただき、{claudium} クラウジウムを受け取ります。",
      "discountLabel": "割引",
      "discountSummary": "実効ペッグ価格から {percent}% 割引",
      "discountBonus": "{base} から {credited} クラウジウムへ (+{bonus})",
      "wocIncentive": "$WOC で支払うと常に 15% 以上割引",
      "wocPromoNote": "期間限定プロモーションを含む",
      ...
      "signatureLabel": "取引の署名",
      "signaturePlaceholder": "署名を貼り付け",
      "confirmButton": "支払いを確認",
      "confirmCredited": "{amount} クラウジウムを付与しました。",
      "confirmFailed": "この支払いはまだ確認できませんでした。しばらくしてから再度お試しください。",
      "confirmPending": "オンチェーンの確認を待っています。少し時間がかかることがあります。",
      "confirmNotFinalized": "お支払いはまだオンチェーンで確認されていません。これは正常です。少し待ってからもう一度確認してください。",
      "confirmRequote": "価格が変動しました。新しい見積もりを取得して再試行してください。",
      "retryButton": "再試行",
      "requoteButton": "新しい見積もりを取得",
      "insufficientBalance": "クラウジウムが不足しています",
      "topUpButton": "Top up",
      "redeemTitle": "ギフトカードを引き換え",
      "enterCode": "ギフトカードのコードを入力",
      "codePlaceholder": "XXXXX-XXXXX-XXXXX-XXXXX-XXXXX",
      "redeemButton": "引き換え",
      "redeemed": "{amount} クラウジウムを引き換えました。新しい残高: {balance}。",
      "redeemFailed": "このコードは引き換えできませんでした。コードを確認して再度お試しください。",
      "back": "戻る",
      "historyExplorer": "Solana Explorer で表示",
      "historyReceipt": "カード購入",
      "historyGiftNote": "ギフトカード",
      "timeJustNow": "たった今",
      "timeMinutes": "{n}m ago",
      "timeHours": "{n}h ago",
      "timeDays": "{n}d ago",
      ...
      "tabHistory": "履歴",
      "giftTitle": "ギフトカードを贈る",
      "giftDenominationLabel": "額面",
      "giftRecipientLabel": "受取人",
      "giftToSelf": "自分用",
      "giftToOther": "他の人へ",
      "giftEmailLabel": "受取人のメール",
      "giftEmailPlaceholder": "name@example.com",
      "giftEmailInvalid": "有効なメールアドレスを入力してください。",
      "giftOccasionLabel": "シーン",
      "giftMessageLabel": "メッセージ",
      "giftMessagePlaceholder": "短いメッセージを追加 (任意)",
      "giftDeliveryLabel": "受け渡し方法",
      "giftScheduleLabel": "受け渡しを予約 (任意)",
      "giftReviewButton": "ギフトを確認",
      "giftReviewSelf": "このギフトカードはあなた自身が引き換えできます。",
      "giftReviewEmail": "このギフトカードを {email} に送信します。",
      "giftReviewShared": "このギフトカードを共有するためのリンクが発行されます。",
      "giftReviewScheduled": "選択した日付に受け渡されます。",
      "giftConfirmButton": "確認して支払う",
      "giftAnotherButton": "もう一枚贈る",
      "giftPending": "ギフトカードを発行しています。少々お待ちください。",
      "giftIssued": "ギフトカードを共有できます。",
      "giftFailed": "ギフトカードを発行できませんでした。しばらくしてから再度お試しください。",
      "giftDeclined": "支払いが拒否されました。ギフトカードは発行されていません。",
      "giftLinkLabel": "ギフトカードのリンク",
      "giftQrAlt": "ギフトカード引き換えリンクのQRコード",
      "giftTerms": "ギフトカードはクラウジウムとの引き換えのみ可能です。現金との交換や返金はできません。",
      "deliveryEmail": "メール",
      "deliveryLink": "リンクを共有",
      "deliveryReveal": "今すぐ表示",
      "occasionBirthday": "誕生日",
      "occasionHoliday": "祝日",
      "occasionCongrats": "お祝い",
      "occasionThankyou": "感謝",
      "occasionGeneric": "気軽に",
      "reasonPurchaseStripe": "購入 (カード)",
      "reasonPurchaseSol": "購入 (SOL)",
      "reasonPurchaseUsdc": "購入 (USDC)",
      "reasonPurchaseWoc": "購入 (WOC)",
      "reasonGiftcardRedeem": "ギフトカード引き換え",
      "reasonSpend": "装飾の購入",
      "reasonRefund": "返金",
      "reasonChargeback": "チャージバック",
      "reasonGiftcardVoid": "ギフトカード無効化",
      "historyTitle": "取引履歴",
      "historyLoading": "履歴を読み込んでいます...",
      "historyError": "履歴を読み込めませんでした。もう一度お試しください。",
      "historyEmpty": "クラウジウムの取引はまだありません。",
      ...
      "historyDebit": "-{amount}",
      "tabSupply": "供給量",
      "supplyTitle": "現存するクラウジウム",
      "supplyLoading": "供給量を読み込んでいます...",
      "supplyError": "供給量を読み込めませんでした。もう一度お試しください。",
      "supplyUnavailable": "現在、供給量を取得できません。",
      "supplyInExistence": "現存 {amount}",
      "supplyUsdValue": "価値 {amount}",
      "supplyIssued": "累計発行量",
      "supplySunk": "累計消費および取消量",
      "supplyHolders": "{n} アカウントが保有",
      "supplyChangeUp": "この期間で {amount} 増加",
      "supplyChangeDown": "この期間で {amount} 減少",
      "supplyChangeFlat": "この期間で変動なし",
      "supplyChartLabel": "選択した期間のクラウジウム供給量",
      "supplyChartEmpty": "この期間に供給量の変動はありません。",
      "supplyRangeLabel": "グラフ期間",
      "supplyRange24h": "24h",
      "supplyRange7d": "7d",
      "supplyRange30d": "30d",
      "supplyFootnote": "全アカウントが保有するクラウジウムの総量を、台帳からリアルタイムに集計しています。",
      "inspectButton": "詳細",
      "inspectBack": "ストアに戻る",
