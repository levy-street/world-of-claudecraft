...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "plugins": {
      ...
      "byAuthor": "作者: {author}",
      "byTeam": "World of ClaudeCraft チーム製",
      "loading": "プラグインストアを読み込み中...",
      "offline": "オンラインレルムにサインインするとプラグインを閲覧、インストールできます。",
      "empty": "まだプラグインがありません。最初の公開者になりましょう。",
      "filteredOut": "検索に一致するプラグインはありません。",
      "installedEmpty": "まだプラグインをインストールしていません。",
      "developIntro": "プラグインはクライアント側のMODです。すべての投稿はストアに掲載される前にチームの審査を受け、更新も再審査されてからプレイヤーに届きます。",
      "docsHint": "API: woc.on(event, handler), イベントは combat, chat, loot, xp, levelup, quest, death, respawn, deed, tick, さらに woc.player(), woc.ui.panel(), woc.ui.toast(), woc.ui.sound(), woc.storage と woc.util フォーマッタ。",
      "formName": "プラグイン名",
      "formAuthor": "作者名",
      "formCategory": "カテゴリ",
      "formSummary": "1行の概要",
      "formDescription": "説明",
      "formSource": "プラグインソース (JavaScript)",
      "formNotes": "審査担当者へのメモ",
      "submitNew": "審査に提出",
      "submitUpdate": "更新を審査に提出",
      "newPlugin": "代わりに新しいプラグインを作成",
      "editPlugin": "更新",
      "deletePlugin": "引退させる",
      "mineTitle": "マイプラグイン",
      "statusPending": "審査待ち",
      ...
      "statusListed": "掲載中",
      "statusDelisted": "掲載停止",
      "latestLine": "最新の提出 v{version}: {status}",
      "reviewNote": "審査メモ: {note}",
      "submitted": "審査に提出しました。プレイを続けてください。チームが確認します。",
      "autoDisabled": "{name} でエラーが繰り返されたため無効にしました。"
    }
  },
  "gatherEvent": {
  ...
  "apiError": {
    ...
    "plugins": {
      "invalid_name": "プラグイン名は3から40文字の英数字、スペース、アポストロフィ、ハイフンで入力してください。",
      "name_not_allowed": "そのプラグイン名は使用できません。",
      "invalid_handle": "作者名は2から24文字の英数字、スペース、アポストロフィ、ハイフンで入力してください。",
      "invalid_summary": "概要は1行で140文字以内にしてください。",
      "invalid_description": "説明が長すぎるか、使用できない文字が含まれています。",
      "invalid_category": "一覧にあるカテゴリから選んでください。",
      "invalid_source": "プラグインのソースが空です。",
      "source_too_large": "プラグインのソースが大きすぎます。",
      "source_syntax": "プラグインのソースに構文エラーがあります。",
      "limit_reached": "このアカウントのプラグイン数が上限に達しました。",
      "install_limit": "インストール済みプラグイン数が上限に達しました。",
      "not_found": "プラグインが見つかりません。",
      "not_listed": "このプラグインは現在利用できません。",
      "not_installed": "このプラグインはインストールされていません。",
      "slug_unavailable": "このプラグインのリンク名を確保できませんでした。別の名前を試してください。",
      "review_invalid": "そのレビュー操作は無効です。"
    }
  },
  "guide": {
