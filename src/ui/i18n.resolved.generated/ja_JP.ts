...
export const ja_JP: EnTranslations = {
  ...
  "questUi": {
    ...
    "dialog": {
      ...
      "brewDraught": "深き夢の妙薬を醸してくれ。",
      "brewDraughtAria": "{name}に深き夢の妙薬を醸すよう頼む",
      "gargoyleBow": "お辞儀する。",
      "gargoyleBowAria": "{name}にお辞儀する",
      "gargoyleAttack": "攻撃する。",
      "gargoyleAttackAria": "{name}を攻撃する",
      "gargoyleShimmer": "石像がエネルギーに揺らめく……",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "keeper_nerissa": {
        "name": "眠らざるネリッサ",
        "title": "ルーメンの冠の亡霊守り",
        "greeting": "私は生前ルーメンの冠を守り、冠はこの硝子を正直に保つ――この谷のどの鏡も真実を映す、ただ一枚を除いて。死をもってしても私はこの務めを解かれぬ、{playerName}、あの一枚がなお押し続けているゆえに。冠の光は衰え、それが尽きるところで谷が滲み出す。硝子のどちら側を歩いているか、心せよ。近ごろは、それすら見分けがつきにくいのだ。"
      },
      "veilwright_ollo": {
        "name": "帳織りオロ",
        "title": "帳の市の商人",
        "greeting": "死者の外套、瓶詰めのため息、正直な値——帳は与えてくれる。この台の品はみな、今や何も持たぬ者が置いていったもの。肝要なのは、死者が済ませたものと、なお握りしめているものを見分けることだ。取り違えれば、真夜中に露店へやって来る。悲しい話が聞きたければ、井戸の光のことを守番に問え。おれはただ外套を売るだけさ。"
      },
      "mistwitch_morwen": {
        "name": "霧の魔女モルウェン",
        "title": "窪地の夢醸し",
        "greeting": "霧はお前たちをなかなか眠らせない。あたしはもう一つの眠りを醸せる――答えを返す眠りをね。"
      },
      "gargoyle_sentinel_south": {
        "name": "ガーゴイルの番人",
        "title": "鏡の守護者",
        "greeting": "石の眼が軋みながらこちらを向く。聞いている。"
      },
      ...
      "dread_sentinel_b": {
        "name": "戦慄の番人",
        "title": "仄暗い鏡の見守り手",
        "greeting": "生前、我らは堤道を守った。今もなお守っている。"
      },
      "dread_sentinel_c": {
        "name": "戦慄の番人",
        "title": "仄暗い鏡の見守り手",
        "greeting": "引き返せ。黒硝子は生者のためのものではない——我らのためでも、ついぞなかった。"
      },
      "tidewatcher_ondrel": {
        "name": "オンドレル・ヴェイン",
        "title": "潮見の番人",
    ...
    "quests": {
      ...
      "q_deepdream_recipe": {
        "title": "深い眠りの調合",
        "text": "妙薬には三つの声がいる、{playerName}。それしか持たぬ貧しき亡霊から白い敷布を二枚、薄闇に草を食む精霊ユニコーンの角を二本、環帯を見張る死神から刈り取った頭巾を二つ。持ってくれば、牙のある眠りを醸してやろう。",
        "completion": "敷布、角、頭巾——貧しき者、輝く者、耐える者。釜はお前を気に入ったようだ。柔らかい場所で飲むといい、放浪者よ。ずっと背負ってきた者に会えるだろう。",
        "objectives": {
          "0": {
            "label": "白い敷布"
          },
      ...
      "q_face_your_echo": {
        "title": "己のエコーと向き合え",
        "text": "薬を飲めば、夢がお前の前に鏡を立てる――お前のエコー、お前の傷跡も手癖も全部、鏡の向こう側だ。己というものを打ち倒して、{playerName}、その時の顔をあたしに見せに戻っておいで。",
        "completion": "お前は帰ってきて、鏡は帰らなかった。その手に残されたものはお前のものだ――夢がその代価を払うのは一度きりだよ。",
        "objectives": {
          "0": {
            "label": "己のエコーを討伐"
          }
      ...
      "q_gargoyle_south": {
        "title": "見守り手の通行料",
        "text": "揺らめきがお前の目の奥で言葉になる——死神どもがわが硝子に群がっている、{playerName}。間引け、さればHighwatchへの道はお前のものだ。",
        "completion": "石が一度、満ち足りて鳴る。その後ろで、鏡が、ようやく放たれた抑えた息のように澄んでいく。",
        "objectives": {
          "0": {
            "label": "死神を討伐"
          }
      ...
      "q_gargoyle_west": {
        "title": "敷布の通行料",
        "text": "揺らめきがお前の目の奥で言葉になる——哀れな死者から白い敷布を四枚持ってこい、{playerName}。布で払う者にEastbrookへの道が開かれる。",
        "completion": "敷布が石に沈み、消える。その後ろの鏡が光とともに目覚める。",
        "objectives": {
          "0": {
            "label": "白い敷布"
          }
      ...
      "q_gargoyle_north": {
        "title": "刈られた輝き",
        "text": "揺らめきがお前の目の奥で言葉になる——精霊の群れは硝子には眩しすぎる、{playerName}。五体を間引け、さればFenbridgeは一歩の先だ。",
        "completion": "石がお前のこぼした光を飲む。その後ろの鏡が眼のように開く。",
        "objectives": {
          "0": {
            "label": "精霊ユニコーンを討伐"
          }
      ...
      "q_the_failing_radiance": {
        "title": "衰えゆく光輝",
        "text": "わたしの冷たさに触れ、あなたはわたしを昔語りだと思う。わたしは一つの持ち場だ、{playerName}。守り続けたルーメンの冠は金の輪ではない――ここのどの鏡にも宿る光、生者と死者を別々の像に保ち、互いに溺れさせぬための継ぎ目だ。その光が衰え、それは鏡縛の番兵に見てとれる。かつては冠の光輝そのものが見張りに立っていたが、今や盗まれた光に満ちた硝子にすぎず、継ぎ目がもはや立つ場所を告げぬゆえ北の廃墟にひしめいている。八体を砕け。あなたが散らす欠片の一つひとつが、返された僅かな光であり、残りを託せるという僅かな証しなのだ。",
        "completion": "欠片は上へ降る雪のように井戸へと漂い戻り、ひと息のあいだ谷全体が一段明るくなる。長くは続くまい。だがあなたは継ぎ目を断つのではなく繕う、{playerName}――それはここでは思うより稀なことだ。あなたはもう一つの冠も砕いたのだろう？ソーンピークの下の、鉄の冠を。ならば三百年で初めて、この光は戻るやもしれぬ。留まれ。この谷は、傷を閉じる手を長く待っていたのだ。",
        "objectives": {
          "0": {
            "label": "鏡縛の番兵を砕く"
          }
      ...
      "q_what_the_poor_keep": {
        "title": "貧しき者がなお抱くもの",
        "text": "南の岸の貧しき亡霊たちは、生前なにも持たなかった、{playerName}――教区が棺を賄えず、包まれて葬られた経帷子のほかは何も。今や冠の光は細りすぎて彼らの握りをほどけず、かつて確かに己のものであった唯ひとつを抱いてさまよう。これを残酷と思うな。行き場のない愛なのだ。彼らの経帷子を五枚持ってきておくれ。一枚ずつ井戸に横たえ、刻まれるにも貧しすぎた名を唱えよう。儀式のすべてはこれに尽きる――貧しく、死してなお、名で呼ばれること。",
        "completion": "経帷子が五枚、名が五つ。それを井戸へ唱えると、水は眠る子から母が外套を持ち上げるようにそれを受け取る。岸の亡霊は今宵、数を減らした、{playerName}――討たれたのではなく、解き放たれたのだ。冠が満ちていた頃はこうしていた――手放せるほどに死者を近くに抱いていた。今はこの手でやる、あなたとわたしとで、一度に五つの名を。遅い。だが、無ではない。",
        "objectives": {
          "0": {
            "label": "白い経帷子"
          }
      ...
      "q_the_wardens_names": {
        "title": "守番たちの名",
        "text": "黒峡谷を行き来する三体を、逃げる者たちは畏怖の番兵と呼ぶ。かつてわたしは彼らを名で呼んだ――彼らはわたしの騎士団だ、{playerName}、生前、黒貂の鏡の堤道を守り抜いた最後の者たち。心の臓が止まってなお、持ち場を退かなかった。もはやいかなる刃も彼らを解けぬ。黒硝子が深く乗りすぎて、倒れることさえできぬのだ。だがその硝子は番兵から、堤道にひしめく死神たちへと移り、長い歳月のうちに死神たちは番兵の紋章をもぎ取ってきた。峡谷の死神から切り取った三つを持ってきておくれ。三つの名を、いま一度だけ声に出して言えるように。",
        "completion": "コーウィン。アルダス。ブレナ。これで――言われた。そして言うことは、抱え続けることよりずっと軽い。じきに彼らは止まれる。わたしが取り計らおう。だが近づくものに気をつけよ、{playerName}。紋章がもぎ取られたということは、あの堤道の硝子が薄れているということ、その果ての傷は、まさにこれを待っていた。向こう側の何かが扉が無防備だと気づく前に、わたしは冠を灯し直し、黒貂の鏡を支えねばならぬ。あと一つだけ要るものがある――それは黒い水の底にある。",
        "objectives": {
          "0": {
            "label": "守番の紋章"
          }
      ...
      "q_what_the_glass_wants": {
        "title": "硝子の望むもの",
        "text": "あなたは己のエコーを打ち破り、それを自らの試練だと思った、{playerName}。そうではない。わたしは経帷子と角と頭巾から深き夢を醸すが、あなたの夢が鏡を突きつけた相手、あなたの顔をまとって入り込んだあれは、わたしが醸したものではない。あれは峡谷の黒硝子から滲み込むのだ。峡谷の口にひしめく死神たちは、同じ滲みで濃くなっている。八体を討ち、その影がどちらへ這うかを見よ。さらばわたしは、ネリッサ自身の目に、彼女の傷がまことにどこで血を流しているかを示そう。",
        "completion": "北東へ。つねに北東へ、つねに黒貂の鏡の方へ——見たか? あなたのエコーはあなたではなかった、旅の者よ。あれはあの扉の奥に棲む何かの欠片、盗みうるかぎり最も近い映し身、すなわちあなたの姿をまとっていた。夢とは、その滲みが見つけた最も薄い場所にすぎぬ。峡谷こそが最も広い。ネリッサに伝えよ。彼女はその真実を受け取るに値する、そしてあなたもだ。",
        "objectives": {
          "0": {
            "label": "峡谷の口で死神を討つ"
          }
    ...
    "zones": {
      ...
      "mirror_world": {
        "name": "鏡の世界",
        "welcome": "ガラスはお前を覚えている。その、どちら側を歩くかに気をつけよ。",
        "pois": {
          "0": {
            "label": "鏡の世界"
          },
