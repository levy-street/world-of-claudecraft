...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bg": {
      ...
      "indicator": {
        "queued": "グレイヴマーチ待機中",
        "queuedDetail": "{position} 番目、待ち時間 {time}",
        "queuedAria": "グレイヴマーチ待機中：{position} 番目、待ち時間 {time}。バトルグラウンドを開く。",
        "live": "グレイヴマーチで戦闘進行中",
        "liveDetail": "{time}、{killsA} 対 {killsB}",
        "liveAria": "グレイヴマーチで戦闘が進行中：{time}、{killsA} 対 {killsB}。バトルグラウンドを開いて観戦。",
        "watch": "観戦"
      },
      "window": {
        "title": "バトルグラウンド",
        "subtitle": "グレイヴマーチ：二本の道、四つの防塁、一つのウォーストーン。",
        "close": "バトルグラウンドを閉じる",
        "offlineNote": "陣営はまだ集結中。レルムに接続するとバトルグラウンドが開きます。",
        "enterQueue": "グレイヴマーチに参加",
        "leaveQueue": "キューを離れる",
        "queued": "{position} 番目、待ち時間 {time}（{count} 名集結）",
        "queueNote": "すべての戦士は戦場標準のレベルとクラス既定ビルドで戦います。ソロで並ぶか、最大五人のパーティをリーダーが率いて並びます。",
        "partyNote": "{count} 人のパーティがまとめてキューに入ります。",
        "leaderNote": "パーティをキューに入れられるのはリーダーだけです。",
        "deserter": "脱走者の弔鐘があなたに鳴っています。{time} 後に再び並べます。",
        "inMatch": "戦いは始まっている。",
        "liveHeading": "進行中の戦い",
        "matchLine": "{teamA} {killsA} 対 {teamB} {killsB}、{time}、{players} 名交戦中",
        "watch": "観戦",
        "watchAria": "進行中の戦いを観戦（{time}）",
        "noLive": "今は戦いがありません。",
        "practice": "グレイヴマーチで練習",
        "practiceNote": "訓練されたボットの全隊を集め、道を覚えましょう。練習戦はレートに影響しません。"
      },
      "spectate": {
        "stop": "観戦をやめる"
      },
      "hud": {
        "knellUp": "弔鐘の番人が立っている",
        "knellSpawns": "弔鐘の番人まで {time}",
        "knellSilenced": "{team}が弔鐘を沈黙させた、{seconds}秒",
        "stripAria": "{teamA} {killsA}、{teamB} {killsB}、残り {time}",
        "countdownTitle": "死者が隊列を組む",
        "respawnTitle": "あなたは倒れた。",
        "respawnSub": "戦場はまだあなたを離さない。",
        "returning": "{seconds} 秒後に世界へ帰還"
      },
      "banner": {
        "found": "グレイヴマーチに戦いが集う！",
        "countdown": "戦闘開始まで {seconds} 秒…",
        "start": "軍旗が揚がる。戦え！",
        "bulwarkWestOuter": "{team}の西路外側の防塁が落ちた。",
        "bulwarkWestInner": "{team}の西路内側の防塁が落ちた。",
        "bulwarkEastOuter": "{team}の東路外側の防塁が落ちた。",
        "bulwarkEastInner": "{team}の東路内側の防塁が落ちた。",
        "warstoneDown": "{team}のウォーストーンが砕かれた！",
        "knell": "{team}が弔鐘を沈黙させた！",
        "warstoneThreat": "味方のウォーストーンが攻撃されている！"
      },
      "log": {
        "queued": "グレイヴマーチのキューに入りました（{position} 番目）。",
        "unqueued": "グレイヴマーチのキューを離れました。",
        "roster": "{team}が集結：{allies} 対 {enemies}。",
        "kill": "{killer} が {victim} を討ち取った！",
        "down": "あなたは倒れた。{seconds} 秒後にウォーストーンへ送り返されます。"
      },
      "end": {
        "win": "勝利！敵のウォーストーンは砕かれた。",
        "loss": "敗北。味方のウォーストーンは砕かれた。",
        "draw": "戦場は静まり返った。引き分け。",
        "rating": "レート {rating}（{delta}）。"
      },
      "err": {
        "level10": "グレイヴマーチに参加するにはレベル 10 以上が必要です。",
  ...
  "guide": {
    ...
    "bgPage": {
      "heading": "グレイヴマーチ",
      "intro": "グレイヴマーチは五対五のバトルグラウンド。二つの中隊が蘇った兵の縦隊を二本の古道に進ませ、敵の塔を砕き、敵軍を歩ませ続けるウォーストーンを打ち砕きます。どこからでも並べて、あとは戦場が整えてくれます。",
      "storyHeading": "眠らぬ戦場",
      "storyBody": "墓ワームの聖所の下に広がるレヴナントの野には、ソーンピークを攻めた最後の軍の先鋒が眠っています。夕暮れごとに古い戦が目を覚まし、灰燼の闘技場の守り手たちは、軍旗を掲げた者がその死者を統べることを見出しました。こうして闘技場は戦争遊戯を認可したのです：グレイヴマーチでは誰も本当には死なない。戦場そのものがそれを拒むのだから。",
      "companiesHeading": "二つの中隊、それぞれの旗",
      "companiesBody": "戦士はエンバー中隊かペイル中隊の旗を掲げます。ソロでもパーティでも並べば、戦場が五人の中隊に編成します。陣営は闘技場と同じく一時的なもの：恒久的な勢力はなく、対人戦は常に自分で選ぶものです。",
      "fairNote": "グレイヴマーチは設計から公平です。すべての戦士が戦場標準のレベルとクラス既定ビルドで戦うため、勝負を決めるのは装備やレベルではなく腕前です。",
      "fieldHeading": "戦場を読む",
      "fieldBody": "二つの本拠の間には、西の盾の道、東の槍の道、その間に崩れた塚地が広がり、中心には壊れた鐘の礼拝堂が立ちます。図式マップには道、塔、味方、そして弔鐘が示されます。",
      "roadsTitle": "二本の道",
      "roadsBody": "骨まといの亡霊の縦隊が各道を敵本拠へと進みます。立ちはだかる者と戦い、防備を叩く。縦隊とともに進むことが、地を取るということです。",
      "bulwarksTitle": "防塁",
      "bulwarksBody": "それぞれの道は重厚な塔の守り手が見張り、各中隊に外側と内側の一基ずつ。守るべき者をいじめる戦士を罰し、外側が落ちるまで内側には触れられません。道を一本こじ開ければ、敵のウォーストーンは裸になります。",
      "knellTitle": "弔鐘",
      "knellBody": "礼拝堂にはこの軍を起こした鐘、弔鐘と、その番人たる弔鐘の番人が待ちます。番人を討った中隊は弔鐘をしばし沈黙させ、その縦隊はいっそう猛く進軍します。",
      "deathHeading": "グレイヴマーチに倒れる",
      "deathBody": "戦場は死を拒みます。倒れた戦士はしばし退場し、やがて自軍のウォーストーンで目覚めます。目覚めは少しずつ遅くなりますが、死体回収はなく、失うものもありません。代価は戦場を離れる時間だけです。",
      "watchHeading": "戦いを観る",
      "watchBody": "レルムで進行中の戦いはどれでも観戦できます。ミニマップ脇のバッジが戦いを知らせ、バトルグラウンドウィンドウには各試合と観戦ボタンが並びます。観戦者は中隊とともに移動し、試合表示を見ながら、いつでも観戦をやめられます。",
      "ladderHeading": "ラダー",
      "ladderBody": "レート戦のグレイヴマーチは闘技場と同じく独自の順位を持ちます。バトルグラウンドウィンドウにはレート、戦績、オンラインのレート戦士のラダーが表示されます。ボットが補充した試合はレート対象外で、オフライン練習も同様です。"
    },
    "wishPage": {
      "heading": "知っておきたかったこと",
