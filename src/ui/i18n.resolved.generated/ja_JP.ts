...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "pokerPlaytest": {
      "title": "ポーカー",
      "close": "ポーカーを閉じる",
      "reconnecting": "ポーカーサーバーに再接続しています...",
      ...
      "betweenHands": "ハンド間",
      "unknownPlayer": "プレイヤー",
      "waiting": "次のハンドを待っています",
      "playerTurn": "{name}がアクション中",
      "timeRemaining": "残り{seconds}秒",
      "wagerAmount": "{action}額",
      "rake": "レーキ: {amount}",
      "error": {
        ...
        "rebuy_not_allowed": "現在はリバイできません。",
        "seat_conflict": "その席はすでに使用されています。",
        "stale_action": "アクション到着前にハンドが更新されました。",
        "table_not_found": "そのポーカーテーブルは存在しません。",
        "watch_conflict": "別のテーブルを観戦する前に現在のテーブルから退出してください。"
      },
      "chips": "{amount}チップ",
      "pot": "ポット: {amount}",
      "noCards": "カードなし",
