...
export const ja_JP: EnTranslations = {
  ...
  "editor": {
    "vfx": {
      ...
      "saved": "保存済み",
      "updating": "プレビューを更新中...",
      "shortcuts": "Space：スキルを使用。[ / ]：前 / 次のスキル。R：繰り返す。F：お気に入り。A：鑑賞モード。",
      "buildTools": "タレント・シーン・照明",
      "noTalent": "タレント未選択",
      "talentLevel": "レベル {level}",
      "seed": "シーンのシード値",
      "graphics": "画質",
      "environment": "プレビュー環境",
      "studioEnvironment": "スタジオステージ",
      "worldEnvironment": "ワールドの風景",
      "lighting": "ステージ照明",
      "neutralLighting": "ニュートラル",
      "brightLighting": "明るい",
      "darkLighting": "暗い",
      "savedGraphics": "ゲーム設定を使用",
      "low": "低",
      "medium": "中",
      "high": "高",
      "ultra": "ウルトラ",
      "cinematic": "シネマティック（最高精細）",
      "reduceMotion": "動きを抑える",
      "cinematicResponse": "映画風のカメラ演出",
      "raid": "レイド練習（死亡なし）",
      "library": "スキル一覧",
      "inspector": "エフェクト設定",
      "search": "スキルを検索",
      ...
      "loading": "ゲーム世界を準備中...",
      "ready": "ゲームエンジン実行中",
      "failed": "スタジオを起動できませんでした。再読み込みしてください。",
      "cast": "スキルを使用",
      "target": "対象",
      "pause": "静止",
      "resume": "再開",
      ...
      "export": "下書きを書き出す",
      "import": "下書きを読み込む",
      "exportTake": "セッションを書き出す",
      "invalid": "下書きが無効か、未対応のスキルが含まれています。",
      "applied": "下書きを適用しました",
      "noSpec": "このスキルは別のエフェクトシステムを使用します。",
      "castTime": "詠唱時間",
      "cooldown": "クールダウン",
      "seconds": "{value} 秒",
      "timeline": "戦闘タイムライン",
      "empty": "スキルを使用すると記録を開始します。",
      "current": "時間：{value} 秒",
      "events": "{count} 件のイベント",
      "controls": "カメラ操作",
      "orbitLeft": "左に回転",
      ...
      "show": "パネルを表示",
      "status": "有効な効果",
      "help": "画面をドラッグして回転、スクロールして拡大縮小します。静止すると現在の描画を保持します。",
      "note": "通常の戦闘ルールでスキルを使用します。再生は操作を繰り返しますが、装飾のランダムな動きは変わる場合があります。",
      "castFailed": "スキルを使用できません。対象、距離、リソース、クールダウンを確認してください。",
      "draftNote": "変更はこのセッションでのみ保持されます。保存するには書き出してください。",
      "snapshot": "フレームを保存"
    },
    "appTitle": "マップエディター",
