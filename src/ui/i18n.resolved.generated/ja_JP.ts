...
export const ja_JP: EnTranslations = {
    ...
    "profPages": {
      ...
      "craftProse": {
        ...
        "cooking": {
          ...
          "identityBody": "料理を食べると18秒の休憩で回復します。戦闘の合間には最安の回復です。梯子は回復90のPan-Seared River Perchから、Marlow's Grand Roast（980）を経て、その上に立つ三種の頂点料理（1392）まで届きます。ゲーム中で最大の座り回復であり、皿を食べ終えると満腹の効果を残す唯一の食べ物です。環では錬金術と皮革加工の間。生きた対は薬師（錬金術と料理）で、Eastbrook厨房のCook Marlowの前で猪を四頭狩って誓います。皮革加工との対Trapperには誓いのクエストがまだありません。",
  ...
  "itemUi": {
    ...
    "tooltip": {
      ...
      "flaskThroughDeath": "この効果は死亡しても残りますが、ログアウトすると失われます。ランクマッチは白紙の状態から始まります。",
