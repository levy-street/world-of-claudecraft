  ...
  "hudChrome": {
    ...
    "raidBossGuide": {
      ...
      "nythraxis": {
        ...
        "phaseKingsWrathSummary": "At {health} health, Nythraxis roars in The King's Wrath and gains {bonusNormal} damage on Normal or {bonusHeroic} on Heroic for the rest of the fight. Grave Eruption tightens to every {eruptionEvery} sec and Gravefire to every {gravefireEvery} sec. Every other mechanic keeps its cadence.",
        ...
        "soulfireSummary": "Every Soul Rend detonation leaves a pool of red fire {radius} yd wide where the mark stood, burning for {seconds} sec at {tickNormal} of maximum health every second. Pools never form within {clearance} yd of a wardstone.",
        "soulfireHeroicSummary": "Every Soul Rend detonation leaves a pool of red fire {radius} yd wide where the mark stood, burning for {seconds} sec at {tickHeroic} of maximum health every second. Pools never form within {clearance} yd of a wardstone.",
        "soulfireResponse": "Rotate the Soul Rend stack point every cast so the raid never stacks in the last cast's fire.",
        ...
        "kingsWrathSummary": "Nythraxis deals {bonusNormal} more damage on Normal or {bonusHeroic} on Heroic for the rest of the fight. Grave Eruption occurs every {eruptionEvery} sec and Gravefire every {gravefireEvery} sec.",
        ...
        "crownEnduresSummary": "At {enrageNormal} sec from the pull, The Crown Endures triggers as a hard enrage. Nythraxis gains {damage} more damage and {haste} faster attacks, then another {rampStep} damage every {rampEvery} sec. There is no timer bar. Warnings come as yells at {warn60}, {warn30}, and {warn10} sec remaining.",
        "crownEnduresHeroicSummary": "At {enrageHeroic} sec from the pull, The Crown Endures triggers as a hard enrage. Nythraxis gains {damage} more damage and {haste} faster attacks, then another {rampStep} damage every {rampEvery} sec. There is no timer bar. Warnings come as yells at {warn60}, {warn30}, and {warn10} sec remaining.",
