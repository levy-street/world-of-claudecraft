...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "riftsPage": {
      "heading": "リフト",
      "intro": "リフトは世界そのものに走った裂け目であり、歩いて訪れる扉ではありません。くぐった先には、誰ひとり踏破したことのない下降が待っています。フロアとその住人はリフトごとに変わりますが、最後の戦いにはいつも同じ君主が待ち構えています。同じランクでも、毎回異なる下降をたどることがあります。",
      "whatHeading": "リフトとは何か",
      ...
      "floorsBody": "リフトはいくつかのフロアで構成され、そのどれもがその場で新しく組み上げられます。下への道は、そのフロアがあなたを解放するまで開きません。フロアに居座るものを片づけ、行く手をふさぐ仕掛けを解いてはじめて、下りの道が裂け開きます。最後のフロアにはいつも同じ君主が待ち構え、その力はリフトとともに増していきます。彼の蟲の群れはさまざまな環境へついてくるので、最後の戦いでは取り巻きにも備えましょう。フロアごとに固有の性格があるので、ひとつの挑戦の中で霜の世界から燃え殻の世界へ移ることもあり、到着するたびにチャットがそのフロアの名を告げます。今回のリフトが何フロアあるのかは、画面のトラッカーでわかります。なお、一部のリフトは生成された下降のかわりに、手作りの舞台を開きます。こちらは決まった長さで進みます。",
  ...
  "sim": {
    "rift": {
      "roachKing": {
        ...
        "tributeFeast": "貢物の饗宴",
        "crown": "ゴキブリ王の王冠",
        "crownWarning": "隠者が立ち上がる。ゴキブリ王が王冠を戴く！",
        "filthWarning": "汚穢の山：地面の印から離れろ！",
        "tributeWarning": "貢物の饗宴：チャネリングを中断するか、貢物の甲虫を倒せ！",
        "ringWarning": "ゴキブリ王が力を溜めている。円の外へ逃げろ！",
        "filthDetonate": "汚穢の山が噴き出す！",
        "swarmDetonate": "王家の蟲群が噴き出す！",
        "deskSlam": "Desk Slam",
        "mountainOfFilth": "汚穢の山",
        "royalSwarm": "王家の蟲群"
      },
