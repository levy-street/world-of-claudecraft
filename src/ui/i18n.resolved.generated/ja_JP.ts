...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    "privacyConsent": {
      "bannerTitle": "Claudemoonでのプライバシー",
      "bannerOptIn": "任意サービスの読み込みを許可するか選択してください。必須サービスは常に有効です。",
      "bannerOptOut": "任意サービスは有効になっています。「任意サービスを拒否」を選ぶと、ターゲティング広告のための情報の販売または共有を拒否できます。読み込みを許可するサービスを個別に選ぶこともできます。",
      "bannerGpc": "ブラウザのGlobal Privacy Controlシグナルを尊重します。分析とマーケティングは無効のままです。",
      "acceptAll": "すべて許可",
      "rejectAll": "任意サービスを拒否",
      "customize": "カスタマイズ",
      "launcher": "プライバシー設定",
      "dialogTitle": "プライバシー設定",
      "dialogIntro": "World of ClaudeCraftが使用できる任意サービスを選択してください。設定はいつでも変更できます。",
      "close": "プライバシー設定を閉じる",
      "necessaryTitle": "必須",
      "necessaryBody": "セキュリティ、設定の保存、認証、ゲームの主要機能に必要です。",
      "analyticsTitle": "分析",
      "analyticsBody": "サイトの利用状況の把握とゲームパフォーマンスの問題の診断に役立ちます。",
      "marketingTitle": "マーケティング",
      "marketingBody": "Meta Pixelなどのサービスを通じてキャンペーンの成果を測定します。",
      "xTitle": "Xフィード",
      "xBody": "ニュースページに埋め込みの@WoClaudecraftタイムラインを読み込めるようにします。",
      "twitchTitle": "Twitchプレイヤー",
      "twitchBody": "埋め込みのYuumiiiライブ配信プレイヤーを読み込めるようにします。",
      "alwaysOn": "常に有効",
      "save": "設定を保存",
      "cookiePolicy": "Cookieポリシーを読む",
      "twitchBlocked": "プライバシー設定でTwitchを許可するまで、Twitchプレイヤーは一時停止されます。",
      "twitchEnable": "Twitchのプライバシー設定を選択"
    },
    "spectate": {
      "banner": "{name}を観戦中"
    },
  ...
  "landing": {
    ...
    "newsXConsentTitle": "Xフィードの表示には許可が必要です",
    "newsXConsentBody": "このライブフィードをXに接続するには許可が必要です。Xがお客様の訪問に関する情報を受け取る場合があります。",
    "newsXConsentNote": "プライバシー設定でXコンテンツを有効にしてください。この設定はいつでも変更できます。",
    "newsXPrivacyChoices": "プライバシー設定",
    "newsXUnavailableTitle": "Xフィードを読み込めませんでした",
    "newsXUnavailableBody": "ブラウザや拡張機能によってブロックされているか、Xで一時的な問題が発生している可能性があります。",
    "newsXHiddenTitle": "この環境ではライブフィードを利用できません",
    "newsXHiddenBody": "埋め込みのXフィードは、小さい画面やアプリでは利用できません。最新の投稿を見るには、Xで@WoClaudecraftを開いてください。",
    ...
    "newsPressPrimaryTitle": "史上初のバイブコーディングMMORPGは、無料かつオープンソースで、驚くほど完成度が高い",
    "newsPressPrimaryBody": "MMORPG.comが、World of ClaudeCraftの背景にあるオープンワールド、共有される冒険、急速に進化する実験を紹介します。",
    "newsPressRead": "特集を読む",
    "newsPressLinkAria": "MMORPG.comの特集を新しいタブで読む",
    "newsPressPrimaryAlt": "World of ClaudeCraftのEastbrook Valeを探索する冒険者たち",
    "browserCta": "ブラウザでプレイ",
    ...
    "communityHeading": "Claudemoonはみんなで作る世界。",
    "communityBody": "得意なことや好奇心、あるいはただ仲間と過ごしたい気持ちを持ってきてください。ギルドのテーブルにはあなたの席があります。",
