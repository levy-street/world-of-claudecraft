...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bg": {
      "title": "レイヴンリフト",
      "blurb": "ソーンピークの麓、壁に囲まれた窪地を挟んで二つの廃城が向かい合う。南に真紅、北に蒼藍、その間には未だどちらの手にも落ちていない古い廃墟の中庭が横たわる。五対五、旗は各一本。相手の旗を五度持ち帰った側が戦場を制する。",
  ...
  "guide": {
    ...
    "ravenriftPage": {
      "heading": "レイヴンリフト",
      "intro": "ランク制5v5キャプチャー・ザ・フラッグの戦場。5人ずつの2チーム、2つの砦、目標はひとつ。敵の軍旗を奪い、奪われる前に持ち帰れ。",
