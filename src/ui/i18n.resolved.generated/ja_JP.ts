...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "merch": {
      "title": "グッズストア",
      "subtitle": "公式『World of ClaudeCraft』グッズを世界中へお届けします。",
      "loading": "ストアを読み込み中…",
      "unavailable": "グッズストアは現在ご利用いただけません。ご注文とお支払いに影響はありません。しばらくしてからもう一度お試しください。",
      "disclosure": "グッズは印刷パートナーが受注生産で製作・発送します。グッズ購入に使用した Claudium は Claudium として返金できません。カードおよび Solana でのお支払いは利用規約の返金ポリシーに従います。",
      "catalogTitle": "カタログ",
      "catalogEmpty": "現在購入できるグッズはありません。",
      "variantLabel": "スタイルとサイズ",
      "addToCart": "カートに追加",
      "outOfStock": "在庫切れ",
      "cartTitle": "カート",
      "cartEmpty": "カートは空です。",
      ...
      "totalLabel": "合計",
      "totalNote": "送料と税金はチェックアウト時に加算されます。最終金額はサーバー側で確定します。",
      "claudiumPrice": "{amount} Claudium",
      "checkoutTitle": "チェックアウト",
      "loginRequired": "チェックアウトにはアカウントへのログインが必要です。",
      "shipping": {
        "name": "氏名",
        "address1": "住所",
        "address2": "住所2行目（任意）",
      ...
      "shippingIncomplete": "必須の配送先項目をすべて入力してください。",
      "railLabel": "支払い方法",
      "railStripe": "カード",
      "railSol": "SOL",
      "railClaudium": "Claudium",
      "payNow": "注文を確定",
      "checkoutPending": "注文処理中です。支払いを完了し、このページを開いたままにしてください。",
      "checkoutFailed": "チェックアウトを開始できませんでした。もう一度お試しください。",
      "checkoutUnavailable": "その注文は現在ご利用いただけません。",
      "checkoutNotSettled": "トランザクションは送信されましたが、注文はまだ確認されていません。しばらくしてから注文をご確認ください。",
      "orderPlaced": "注文 {orderId} を受け付けました。下の注文一覧で追跡できます。",
      "paymentPending": "注文 {orderId} はカード決済の完了待ちです。決済が完了するとご注文一覧に表示されます。",
      "ordersTitle": "注文履歴",
      "orderItem": "{name} x{qty}",
      "orderItemSeparator": ", ",
      "trackOrder": "追跡",
      "status": {
