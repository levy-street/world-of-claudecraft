...
export const ja_JP: EnTranslations = {
    ...
    "profPages": {
      ...
      "craftProse": {
        ...
        "cooking": {
          ...
          "routeBody": "料理は傑作物語の正直な例外です。皿に伸ばす能力値がないので傑作は決して発動せず、追う必要もありません。この職の極みは75の特化です。全食材が2割引きになり（まとめ料理では加速度的に効きます）、移動式の野外厨房でダンジョンの扉の前で宴が炊けます。釣った物を料理し、二つの技能を互いに養いましょう。干し肉と無料段で25、中段で50、レア段で75。レア段の上には頂点の厨房、三種の役割別料理とThe Laden Hearthがあります。誰も教えず、拾った製法書から覚えるもので、それを持つ料理人は上限まで満額で伸ばせます。製法書が出るまではレア段が最後の道のりを担い、半減から四分の一へ薄れ、およそ150回。作り置きと考えれば無駄がなく、ギルドは全皿を平らげます。Marlowの依頼は30分ごとに獣肉8個。スキル50でSeasoned Chef、125でGrandmaster Cooking称号です。"
        },
        "alchemy": {
  ...
  "itemUi": {
    ...
    "tooltip": {
      ...
      "flaskThroughDeath": "この効果は死亡しても残りますが、ログアウトすると失われます。",
      "wellFed": "満腹：食べ終えると{stat}が {value} 上昇し、{minutes} 分間持続します。",
      "wellFedAura": "満腹：食べ終えると{aura}を得て、{minutes} 分間持続します。",
      "questItem": "クエストアイテム",
