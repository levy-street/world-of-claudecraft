...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "カスタマイズ",
      "customizeTitle": "操作をカスタマイズ",
      "customizeSlotAttack": "通常攻撃",
      "customizeSlotSkill": "スキル{n}",
      "customizeSlotUtility": "補助",
      "customizeDefault": "クラス既定",
      "customizeResetSlot": "このスロットをリセット",
      "customizeResetAll": "すべてクラス既定にリセット",
      "customizeUpdated": "{slot}を更新しました。",
      "customizeAllReset": "操作をクラス既定にリセットしました。"
    },
    "tutorial": {
    ...
    "options": {
      ...
      "touchControls": "タッチ操作",
      "clusterHold": "編集ホールド時間",
      "clusterHoldNote": "画面上のアクションボタンを長押ししてから割り当てエディターが開くまでの時間。スキルを連打中にエディターが開いてしまう場合は長くしてください。",
      "targetPriority": "攻撃対象の優先度",
      "targetPriorityNearest": "最も近い",
      "targetPriorityLowestHp": "体力が最も低い",
      "targetPriorityCurrent": "現在の対象を優先",
      "targetPriorityNote": "有効な対象がいないときに攻撃ボタンが狙う相手：最も近い敵、射程内で体力が最も低い敵、または有効な間は現在の対象を維持します。",
      "aimAssist": "スマートスキル発動",
      "aimAssistNote": "攻撃スキルを押すと、対象（いない場合は近くの最適な敵）に向き直って発動します。ボタンを長押しするとスキルの射程をプレビューし、ボタンから指を外して離すとキャンセルします。",
      "millisecondsValue": "{value} ms",
      "touchReset": "タッチ操作をリセット",
      "touchResetDone": "タッチ操作を既定値に戻しました。",
      "footstepSounds": "足音",
