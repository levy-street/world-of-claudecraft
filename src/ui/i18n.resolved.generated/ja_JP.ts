...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocMarket": {
      ...
      "vaultTitle": "取引所ボールト",
      "vaultBody": "ウォレットを連携しなくても出品でき、売上は $WOC としてここに保管されます。即決出品の購入に使うか、いつでもウォレットを連携して引き出せます。",
      "vaultBalance": "ボールト残高: {tokens} $WOC",
      "vaultBalanceUsd": "現在の価格でおよそ {usd}。あくまで概算です。ボールトが保持するのは $WOC で、そのドル価値は市場とともに変動します。",
      "vaultEmpty": "ボールトは空です。",
      "vaultWithdraw": "ウォレットへ引き出す",
      "vaultWithdrawAria": "{tokens} $WOC を連携済みウォレットへ引き出す",
      "vaultNeedsWallet": "ボールト残高を引き出すにはウォレットを連携してください。",
      "vaultWithdrawn": "{tokens} $WOC をウォレットへ引き出しました。",
      "vaultSellHint": "ウォレット未連携: この売上は取引所ボールトに保管されます。",
      "vaultBuyWith": "ボールト残高で購入",
      "vaultPaysNote": "この購入は取引所ボールトの残高から支払われます。",
      "quoteSignVault": "ボールトから支払う"
    }
  },
  "gatherEvent": {
  ...
  "apiError": {
    ...
    "woc_market": {
      ...
      "held_disabled": "このレルムでは取引所ボールトを利用できません。",
      "held_insufficient": "ボールト残高がこの購入額に足りません。",
      "held_empty": "ボールトは空です。",
      "held_withdraw_failed": "引き出しを完了できませんでした。残高はボールトに残っています。後でもう一度お試しください。",
      "account_proof_required": "この出品を承認するにはアカウントのパスワードを入力してください。",
      "account_proof_two_factor": "アカウントで二段階認証が有効です。この出品を承認するにはコードを入力してください。",
      "account_proof_no_password": "このアカウントにはパスワードがありません。先にアカウント設定で設定してください。",
      "account_proof_invalid": "パスワードまたはコードが受け付けられませんでした。もう一度お試しください。",
      "account_proof_throttled": "失敗が多すぎます。後でもう一度お試しください。",
  ...
  "wallet": {
    ...
    "reauthListTitle": "出品の確認",
    "reauthListHelp": "ウォレットが連携されていないため、ウォレット署名の代わりにアカウントのパスワードでこの出品を承認します。",
