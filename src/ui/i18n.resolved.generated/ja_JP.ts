...
export const ja_JP: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "earth_shield": {
        "name": "石の守護",
        "description": "生きた石で身を包み、次の6回の攻撃で受けるダメージを20%軽減します。再詠唱で盾を張り直します。"
      },
      "earthbound_weapon": {
        "name": "大地結びの武器",
        "description": "武器を大地に結びつけ、5分間、生み出す脅威度をすべて100%増加させます。他の武器エンチャントを置き換えます。"
      },
      "elemental_demand": {
        "name": "エレメンタルの命令",
        "description": "エレメンタルに命じて対象を捉え、3秒間、自分を攻撃するように挑発します。射程15ヤード。"
      },
      "unleash_weapon": {
        "name": "エレメンタル解放",
