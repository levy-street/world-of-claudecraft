...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "starterTutorial": {
      ...
      "leave": "本土へ船出する",
      "doneTitle": "守人はご満悦だ",
      "doneBody": "突っ立ったまま教えられることは、これで全部だ。あとは下手を打ちながら覚えるしかない。行け、本土が待っている。あそこは私ほど優しくはないぞ。",
      "objectiveDone": "{label}: 完了",
      "objectiveCount": "{label}: {current} of {total}",
      "scenes": {
        "wardenReveal": "祠の石にさす光の中からひとりの女が歩み出て、朝からずっとおまえを待っていたとでもいうように、上着の潮を払い落とす。",
        "yardReveal": "訓練場だ。藁人形が3体、聖人のように辛抱強く、そして同じくらい無害だ。",
        "wolfReveal": "茂みが動く。あれがモブだ。おまえを殺したくてたまらない生き物のことだ。体力バーがある。こちらのが空になる前に、あちらを空にしろ。"
      },
      "steps": {
        "land": "潮がまたひとり運んできたか。砂浜から道が伸びていて、その上の丘に祠がある。歩いて登ってこい。私は誰のためにも大声など出さん。",
        "enlist": "こちらには仕事があり、おまえの手は空いている。近くに立って話しかけ、任務を受けろ。",
        "target": "この島で、おまえのためにじっとしていてくれるのは私の人形だけだ。訓練場は東。1体選んでターゲットにしろ。",
        "strike": "さあ叩け。近づいて武器を振り始めろ。自動攻撃は一度始まれば勝手に続く。眺めて突っ立っているな。",
        "hunt": "潮に乗って浜辺の狼が3頭上がってきて、私の山羊を狙っている。西へ、窪地へ下りろ。さっさと行け。",
        "spoils": "仕留めた獲物を調べもせずに立ち去るな。狼をルートして、牙を抜き取ってこい。",
        "report": "私のところへ戻れ。任務は殺し終えたときではなく、報告して初めて終わる。"
      },
      "objective": {
        "land": "守人のもとへたどり着く",
        "enlist": "任務を受ける",
        ...
        "spoils": "Take a {item}",
        "report": "守人に報告する",
        "abilityHit": "{ability}の命中回数",
        "auraUp": "{ability}が有効",
        "healSelf": "自分自身を回復する",
        "rangedHit": "遠距離からの自動射撃の命中回数",
        "petSummoned": "デーモンを召喚"
      },
      "class": {
        "warrior": {
          "signature": "武器を振ればレイジが溜まる。そしてレイジは使うためにある。人形に{ability}を2回当てろ。",
          "mastery": "戦士は承知のうえで騒がしい。{ability}を上げて、島じゅうに聞かせてやれ。"
        },
        "paladin": {
          "signature": "おまえの力は借り物だ。借りるものは、まず請わねばならん。{ability}で武器に刻印しろ。",
          "mastery": "光は何かを焼く前に、まず身内を癒やす。一度自分を回復して、パラディンを立たせているものを感じてみろ。"
        },
        "hunter": {
          "signature": "ハンターとて追い詰められる。そのとき刃の使い道を知らんようでは困る。人形に{ability}を2回叩き込め。",
          "mastery": "次はまともにやれ。相手の届かないところまで下がって撃つ。そこから自動射撃を3発だ。"
        },
        "rogue": {
          "signature": "斬れ、斬り続けろ。{ability}を3回当てて、コンボポイントが積み上がるのを見ておけ。",
          "mastery": "ポイントは抱え込んでいても何の値打ちもない。使え。{ability}で人形にとどめを刺せ。"
        },
        "priest": {
          "signature": "牙を持った信仰だ。{ability}で人形を2回打て。",
          "mastery": "そして癒やす信仰だ。一度自分を回復しろ。その習慣は必ず要る。"
        },
        "mage": {
          "signature": "まず火を放て、問いは後回しどころか無用だ。人形に{ability}を2回当てろ。",
          "mastery": "布はよく燃える。だから布よりましなものを身に纏え。{ability}を張っておけ。"
        },
        "warlock": {
          "signature": "闇に手を突っ込み、ひとつかみ取って、何かに投げつける。人形に{ability}を2回当てろ。",
          "mastery": "誰が何と言おうと、ウォーロックは一人で歩くものではない。デーモンを召喚しろ。"
        },
        "druid": {
          "signature": "野生は、礼を尽くして頼めば応えてくれる。人形に{ability}を2回当てろ。",
          "mastery": "今度は自分自身のために頼んでみろ。{ability}を自分にかけるんだ。"
        },
        "shaman": {
          "signature": "今日は嵐がおまえの味方だ。人形に{ability}を2回当てろ。",
          "mastery": "嵐の前に、まず石だ。{ability}を武器に付与しろ。"
        }
      }
    }
  },
  ...
  "starterTutorial": {
    "title": "少し寄り道しませんか",
    "body": "あなたにとって初めての{className}です。新米の冒険者のための訓練の島があり、そこにいる守人が、このクラスに実際に何ができるのかを順を追って教えてくれます。数分で終わりますし、受けるかどうかは完全に自由です。",
    "note": "キャラクターは作成したときのままです。島で手に入れたものは何ひとつ持ち帰りません。",
    "accept": "ドーンヘイヴンへ渡る",
    "decline": "スキップする、道は心得ています"
  },
  "deleteCharacter": {
    "title": "キャラクターを削除",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "dawnhaven_warden": {
        "name": "守人フェンナ・ロック",
        "title": "ドーンヘイヴンの守り手",
        "greeting": "立って息をしているな、{className}か。結構。島は気長だが、狼はそうではない。"
      },
      "tidewatcher_ondrel": {
        "name": "オンドレル・ヴェイン",
        "title": "潮見の番人",
    ...
    "quests": {
      ...
      "q_dawnhaven_wolves": {
        "title": "守人の試練",
        "text": "潮に乗って浜辺の狼が3頭上がってきて、それからずっと私の山羊を狙っている。西の道から窪地へ下りて、{playerName}、訓練場で覚えたものを見せてみろ。",
        "completion": "見事な手際だ。おまえはもう、私の島より大きな島へ出てよい。",
        "objectives": {
          "0": {
            "label": "浜辺の狼を討伐"
          }
    ...
    "zones": {
      ...
      "dawnhaven_isle": {
        "name": "ドーンヘイヴン島",
        "welcome": "道を上がったところで、守人ロックが待っています。",
        "pois": {
          "0": {
            "label": "船着き場"
          },
