...
export const ja_JP: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "WOC Wallet、Phantom または Solflare を選択してください。ウォレットアプリで承認を求められます。ゲームを開いたままにし、完了後に戻ってください。",
    "standaloneAppHelp": "ホーム画面アプリでは、まだウォレットに接続できません。WOC Wallet、Phantom または Solflare を使用するには、Safari か Chrome で World of ClaudeCraft を開いてください。",
