...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tradingBots": {
      "title": "トレーディングボット",
      "close": "トレーディングボットを閉じる",
      "launcher": "ボット",
      "launcherAria": "SOLと$WOCのトレーディングボットをレンタル",
      "loading": "トレーディングボットを読み込み中...",
      "custody": "入金はトレーディングサービスが管理する上限付き金庫に入ります。出金を受け取れるのは連携済みウォレットだけで、いつでも引き出せます。",
      "riskNote": "自動売買では損失が生じることがあります。レンタル料金は返金されません。これは投資助言ではありません。",
      "catalogIntro": "ボットを月単位でレンタルし、SOLと$WOCのペアで資金を入れると、DEXであなたの代わりに取引します。",
      "skuGridName": "グリッドゴーレム",
      "skuGridBlurb": "市場価格の上下に買い注文と売り注文を交互に置き、価格が揺れる間にスプレッドを稼ぎます。",
      "skuDcaName": "しずくの精",
      "skuDcaBlurb": "決まったスケジュールでSOLを$WOCへ着実に交換し、購入タイミングを分散します。",
      "skuMomentumName": "モメンタムウィスプ",
      "skuMomentumBlurb": "トレンドの強い側にペアを傾け、勢いが衰えると元の配分に戻します。",
      "priceWoc": "月額 {amount} $WOC",
      "priceClaudium": "月額 {amount} Claudium",
      "rentButton": "レンタル",
      "payWithLabel": "支払い方法",
      "payWoc": "$WOC",
      "payClaudium": "Claudium",
      "claudiumBalance": "Claudium残高：{amount}",
      "approvePayment": "ウォレットでレンタル料金の支払いを承認してください...",
      "confirmingPayment": "ネットワークで支払いを確認中...",
      "subscribedBody": "ボットをレンタルしました。金庫に資金を入れると取引が始められます。",
      "activeUntil": "{date}まで有効",
      "fundTitle": "金庫に資金を入れる",
      "solAmountLabel": "入金するSOL",
      "wocAmountLabel": "入金する$WOC",
      "depositBounds": "{min}から{max}まで",
      "depositButton": "入金",
      "approveDeposit": "ウォレットで入金を承認してください...",
      "confirmingDeposit": "ネットワークで入金を確認中...",
      "amountInvalid": "有効な数量を入力してください。",
      "vaultLine": "金庫：{sol} SOL、{woc} $WOC",
      "stateRunning": "稼働中",
      "statePaused": "停止中",
      "startButton": "開始",
      "pauseButton": "停止",
      "paramsTitle": "戦略設定",
      "paramGridSpacingBps": "グリッド間隔（{percent}%）",
      "paramOrderSizeBps": "注文サイズ（{percent}%）",
      "paramDcaIntervalMinutes": "購入間隔（分）",
      "paramMomentumLookbackMinutes": "トレンド参照期間（分）",
      "saveParams": "設定を保存",
      "recentTrades": "最近の取引",
      "noTrades": "まだ取引はありません。",
      "tradeBuy": "買い",
      "tradeSell": "売り",
      "pnlLine": "損益（{days}日）：{amount} $WOC（{percent}%）",
      "withdrawButton": "すべて出金",
      "withdrawTitle": "金庫から出金",
      "withdrawBody": "出金するとボットが停止し、金庫の残高が連携済みウォレットに返されます。",
      "approveWithdraw": "ウォレットで出金を承認してください...",
      "withdrawPending": "出金を処理しています。ネットワークが確認すると残高が更新されます。",
      "cooldown": "リクエストが多すぎます。あと{seconds}秒で再試行できます。",
      "errWalletFeature": "接続中のウォレットはゲームからトランザクションを送信できません。別のSolanaウォレットをお試しください。",
      "errSignFailed": "トランザクションは送信されませんでした。ウォレットで拒否された可能性があります。",
      "errNoWallet": "まずSolanaウォレットを接続してください。"
  ...
  "apiError": {
    ...
    "trading_bots": {
      "disabled": "トレーディングボットは現在利用できません。",
      "unknown_sku": "そのボットはカタログにありません。",
      "invalid_pay_currency": "その支払い通貨には対応していません。",
      "already_subscribed": "すでにトレーディングボットをレンタル中です。",
      "subscription_required": "まずトレーディングボットをレンタルしてください。",
      "subscription_expired": "ボットのレンタル期間が終了しました。更新するか資金を引き出してください。",
      "insufficient_claudium": "Claudiumが不足しています。",
      "invalid_amount": "有効な数量を入力してください。",
      "deposit_out_of_bounds": "その入金額はこのボットで許可された範囲外です。",
      "invalid_public_key": "まずSolanaウォレットを接続してください。",
      "invalid_params": "そのボット設定は許可されていません。",
      "payment_not_found": "その支払いが見つかりませんでした。最初からやり直してください。",
      "payment_unverified": "その支払いはまだ確認できませんでした。しばらくしてからもう一度お試しください。",
      "vault_busy": "ボットの金庫は処理中です。しばらくしてからもう一度お試しください。",
      "rate_limited": "リクエストが多すぎます。しばらく待ってからもう一度お試しください。",
      "upstream_error": "トレーディングボットサービスは利用できません。後でもう一度お試しください。"
    }
  },
  "guide": {
