...
export const ja_JP: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "noLoot": "No loot recorded yet.",
      "target": "対象: {name}",
      "noTargetEngaged": "交戦中の対象がいません。",
      "segmentSummary": "{label} - {duration}",
      "lootWinner": "Winner: {name}",
      "lootReturned": "Returned to corpse",
      "lootRollLabel": "Roll",
      "lootMethodNeed": "Need",
      "lootMethodGreed": "Greed",
      "lootMethodMaster": "Master",
      "lootMethodFfa": "FFA",
      "lootMethodPersonal": "Personal",
      "lootMethodPass": "Pass",
      "olderSegment": "前の区間",
      "newerSegment": "次の区間",
      "close": "メーターを閉じる"
