...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "enchantName": {
      "enchant_weapon_might": "武器刻印：剛力",
      "enchant_weapon_intellect": "武器刻印：呪文威力",
      "enchant_offhand_stamina": "オフハンド刻印：スタミナ",
      "enchant_helmet_fortitude": "頭刻印：堅牢",
      "enchant_neck_spirit": "首刻印：精神力",
      "enchant_shoulder_agility": "肩刻印：敏捷性",
      "enchant_chest_stamina": "胸刻印：スタミナ",
      "enchant_waist_stamina": "腰刻印：スタミナ",
      "enchant_legs_stamina": "脚刻印：スタミナ",
      "enchant_gloves_agility": "手刻印：敏捷性",
      "enchant_gloves_intellect": "手刻印：呪文威力",
      "enchant_feet_agility": "足刻印：敏捷性",
      "enchant_ring_spirit": "指刻印：精神力",
      "enchant_weapon_agility": "武器刻印：敏捷性",
      "enchant_helmet_intellect": "頭刻印：知力",
      "enchant_helmet_armor": "頭刻印：強化",
      "enchant_neck_intellect": "首刻印：知力",
      "enchant_neck_agility": "首刻印：敏捷性",
      "enchant_shoulder_strength": "肩刻印：筋力",
      "enchant_shoulder_intellect": "肩刻印：知力",
      "enchant_chest_spirit": "胸刻印：精神力",
      "enchant_chest_armor": "胸刻印：強化",
      "enchant_waist_strength": "腰刻印：筋力",
      "enchant_waist_agility": "腰刻印：敏捷性",
      "enchant_legs_intellect": "脚刻印：知力",
      "enchant_gloves_strength": "手刻印：筋力",
      "enchant_feet_strength": "足刻印：筋力",
      "enchant_feet_stamina": "足刻印：スタミナ",
      "enchant_ring_strength": "指刻印：筋力",
      "enchant_ring_agility": "指刻印：敏捷性",
      "enchant_ring_intellect": "指刻印：知力",
      "enchant_weapon_greater_might": "武器刻印：上級剛力",
      "enchant_weapon_greater_spellpower": "武器刻印：上級呪文威力",
      "enchant_helmet_greater_fortitude": "頭刻印：上級堅牢",
      "enchant_chest_greater_stamina": "胸刻印：上級スタミナ",
      "enchant_legs_greater_stamina": "脚刻印：上級スタミナ",
      "enchant_gloves_greater_agility": "手刻印：上級敏捷性",
      "enchant_weapon_runed_edge": "武器刻印：ルーンの刃",
      "enchant_weapon_runed_focus": "武器刻印：ルーンの印章",
      "enchant_chest_runeweave": "胸刻印：ルーン織り",
      "enchant_legs_runed_hide": "脚刻印：ルーンの獣皮",
      "enchant_helmet_runed_links": "頭刻印：ルーンの鎖",
      "enchant_weapon_lucent_might": "武器刻印：光輝の剛力",
      "enchant_weapon_lucent_spellpower": "武器刻印：光輝の呪文威力",
      "enchant_chest_lucent_stamina": "胸刻印：光輝のスタミナ",
      "enchant_feet_lucent_agility": "足刻印：光輝の敏捷性",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "harvestBodyFamilies": "採集はノードで終わらない。倒した獣の多くは、通常の戦利品と並んで、死体から直接素材を採取できる：毛皮、牙、爪、大牙、角、えら、絹糸、毒、布、そして肉。各死体は早い者勝ちで一度だけ採取でき、ひと押しで戦利品と採取の両方が開く。加工できる素材をふたつ以上持つ獣なら、選択はあなたのものだ：その獣が差し出せるすべてを取るか、より少ない素材に集中して、実際に取る分だけはっきりと上のグレードで受け取るか。\n\n標本を宿す系統の獣でレア以上の採取を引き当てると、通常の産出に加えて署名入りの完璧な標本（極上の獣皮、極上の蜘蛛の糸、極上の毒腺、極上の爪、極上の肉のいずれか）も手に入り、功績の書に「申し分なき標本」が刻まれる。採取はどのキャラクターにもでき、訓練も要らない。手持ちの採集道具はどの職のものであれ、このレア以上の判定を後押しする。",
    ...
    "profPages": {
      ...
      "toolsHeading": "道具",
      "toolsNoteThreeRods": "どの採集ポイントにも、その専門の道具をバッグに入れておく必要があります。ティア1も例外ではありません。つるはしがなければ鉱石は採れず、釣り竿がなければ魚も釣れません。商人のはしごは中核の三つの拠点でティア1から3までを扱い、ティア1の道具はその三つすべてで売られていますが、その上の段は、それを使う土地が始まる場所で売られます（Fenbridgeがティア2を、Highwatchがティア3を加えます）。その先の若い集落は道具をまったく置いていないので、旅立つ前に買い揃えてください。どのカウンターも、置いている段は制限なく売ってくれますし、道具はどれも直接取引で渡せます。どの段も市場に出品でき郵送もできますが、20銅の陸の入門道具三つだけは例外です。これらはカウンターで買うか手渡しで受け取るしかなく、売り戻すことも、郵送することも、出品することもできません。制限がかかるのは、扱えるかどうかです。ティア1より上の陸の道具は、その専門の熟練度が届いてはじめて働きます。ティア2には {tier2Prof}、ティア3には {tier3Prof}、製作品の二段にはそれぞれ85と100が必要で、商品欄も、ツールチップも、下の表も、その条件を最初から示します。それまでは、先回りして買った道具はバッグでただ待つだけで、土地を開くことも、速さを買うことも、上質級を生むこともありません。そしてカウンターがその数字に触れた瞬間から扱えるようになります。釣り竿だけは例外です。どの竿にも使用条件はなく、EastbrookのTrader Wilkesは先回りして買う釣り人のために、ティア2とティア3の竿をあえて置いています。道具はバッグに入っていればよく、装備枠も耐久度もありません。ですから購入は一度きりで、すでに持っている道具はそのまま使えます。条件に関わるのはティアだけです。同じティアでレアリティが高い道具でも、開けるものが増えるわけではありません。ただしレアリティは色だけのものではありません。差し込んだ道具効果の持ちが長くなり、釣り竿ならリールの猶予も広がります。\n\n良い道具が買うものは二つではなく三つです。より高いティアの土地を開き、採集時間を縮め、採れるものを良くします。その地域の素材より上のティアの道具で鉱脈を掘ると、通常の素材ではなく上質級が手に入ります。対象はその地域の完全品級の鉱脈に限られるため、旅人向けに残された易しい鉱脈からは通常の素材が出ます。上質素材は道具のレシピが消費するものであり、レシピや依頼が通常版を求めるところではどこでも上質級がその代わりになります。ですから強化して行き詰まることはありません。銅鉱石が上質な銅鉱石として手に入るようになるだけです。\n\n商人のはしごの上には、陸の各専門にティア4とティア5の製作道具が二つあります。道具工房で作るか（陸のレシピは誰もが最初から知っていて、その作業で伸びるスキルは工作のものです）、溺れし連祷のカウンターで、その攻略条件を満たしたうえで探索の印を使って購入します。印の値段と各段が求める攻略回数は下の表にあります。硬貨でこれらを売る商人はいません。釣りには専用の三本があり、この段落のすべてに対する例外です。道具職人が教えるのはティア4のStormreelとティア5のTidewroughtで、ティア6のClockreelは代わりに設計図から組み上げます。そして三本のいずれもが、熟練度だけでは決して届かない釣果バンドを開きます。ですから水の上では、最上位の段が買うのは快適さではなく入場条件です。陸の専門では、今のところティア3を超えて必要とする採集ポイントはないため、ティア4とティア5の道具が買うのは入場条件ではなく速さと品級のままで、より高いティアの土地が現れたとき、それらが入場券になります。",
