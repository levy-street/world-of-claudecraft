  ...
  "entities": {
    ...
    "npcs": {
      ...
      "waystone_warden_ilse": {
        "name": "道標石の番人イルゼ",
        "title": "ワームゲートの守り手",
        "greeting": "銀貨五十枚で、ワームゲートがハイウォッチまで運んでくれる。竜より安く、自分の足より高い。"
      },
      "provisioner_dunmore": {
        "name": "糧食係ダンモア",
        "title": "最後の砦の従軍商人",
        "greeting": "山羊は焼けた、水は冷えている、トロルは今週まだ倉庫を燃やしていない。買えるうちに買いな。"
      },
      "sergeant_varga": {
        "name": "軍曹ヴァルガ",
        "title": "外郭の番人",
        "greeting": "この砦を守った守備隊は帰ってこなかった。今は我々が彼らの代わりに守っている。東の城壁の裂け目に気をつけろ。"
      },
      "chaplain_ondrey": {
        "name": "司祭オンドレイ",
        "title": "静かなる広間の声",
        "greeting": "鍛冶父が何を盗もうと、最後の泉は今もこの壁のそばを流れている。しばらく座っていくといい。広間は静かだが、空ではない。"
      },
      "reeve_ottoline": {
        "name": "代官オトリーヌ",
        "title": "ランタンミアの代官",
