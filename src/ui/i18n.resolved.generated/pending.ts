...
export const pending: Record<string, readonly string[]> = {
  "es": [
    "apiError.woc_market.account_proof_invalid",
    "apiError.woc_market.account_proof_no_password",
    "apiError.woc_market.account_proof_required",
    "apiError.woc_market.account_proof_throttled",
    "apiError.woc_market.account_proof_two_factor",
    "apiError.woc_market.held_disabled",
    "apiError.woc_market.held_empty",
    "apiError.woc_market.held_insufficient",
    "apiError.woc_market.held_withdraw_failed",
    ...
    "hudChrome.wocMarket.quoteSignVault",
    "hudChrome.wocMarket.vaultBalance",
    "hudChrome.wocMarket.vaultBalanceUsd",
    "hudChrome.wocMarket.vaultBody",
    "hudChrome.wocMarket.vaultBuyWith",
    "hudChrome.wocMarket.vaultEmpty",
    "hudChrome.wocMarket.vaultNeedsWallet",
    "hudChrome.wocMarket.vaultPaysNote",
    "hudChrome.wocMarket.vaultSellHint",
    "hudChrome.wocMarket.vaultTitle",
    "hudChrome.wocMarket.vaultWithdraw",
    "hudChrome.wocMarket.vaultWithdrawAria",
    "hudChrome.wocMarket.vaultWithdrawn",
    "hudChrome.wocStore.mountBuyAria",
    "hudChrome.wocStore.mountsEyebrow",
    "hudChrome.wocStore.mountsTitle",
    "sim.rift.forgeGemReplaced",
    "wallet.reauthListHelp",
    "wallet.reauthListTitle",
