...
export const pending: Record<string, readonly string[]> = {
  "es": [
    ...
    "hudChrome.arena.queueCount",
    "hudChrome.arena.windowTitle",
    "hudChrome.arena.yumiHeading",
    ...
    "yumi.log.teamBlue",
    "yumi.log.teamRed",
    "yumi.powerup.berserk.name",
    "yumi.powerup.endless_mana.name",
    "yumi.powerup.invuln.name",
    "yumi.powerup.stealth.name"
  ],
  "es_ES": [
    "apiError.welcome.invalid_input",
    "devCommand.actions.attune.description",
