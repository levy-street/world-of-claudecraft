...
export const pl_PL: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "lootHistory": "Historia",
      "title": "{tab} - {view}",
      "noCombat": "Nie zarejestrowano jeszcze walki.",
      "noLoot": "Nie zarejestrowano jeszcze łupu.",
      "recentAwards": "{count} ostatnich nagród",
      "target": "Cel: {name}",
      "noTargetEngaged": "Nie zaatakowano żadnego celu.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Spasowano",
      "methodMaster": "Mistrz",
      "methodPersonal": "Osobiste",
      "methodDelve": "Wyprawa",
      "methodLooted": "Złupione",
      "noWinner": "Brak zwycięzcy",
      "rollDetail": "Rzut {roll}",
