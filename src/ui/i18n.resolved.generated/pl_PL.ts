...
export const pl_PL: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Wybierz WOC Wallet, Phantom lub Solflare. Aplikacja portfela poprosi o zatwierdzenie. Pozostaw tę grę otwartą i wróć do niej po zakończeniu.",
    "standaloneAppHelp": "Połączenia z portfelami nie są jeszcze dostępne w aplikacji z ekranu głównego. Otwórz World of ClaudeCraft w Safari lub Chrome, aby używać WOC Wallet, Phantom lub Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "Nie znaleziono zgodnego rozszerzenia portfela. Zainstaluj lub odblokuj WOC Wallet, Phantom, Solflare lub inny portfel Solana w przeglądarce, a następnie spróbuj ponownie.",
