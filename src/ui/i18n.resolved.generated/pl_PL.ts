...
export const pl_PL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "Dostosuj",
      "customizeTitle": "Dostosuj sterowanie",
      "customizeSlotAttack": "Atak podstawowy",
      "customizeSlotSkill": "Umiejętność {n}",
      "customizeSlotUtility": "Wsparcie",
      "customizeDefault": "Domyślne dla klasy",
      "customizeResetSlot": "Zresetuj ten slot",
      "customizeResetAll": "Przywróć wszystko do domyślnych dla klasy",
      "customizeUpdated": "Zaktualizowano: {slot}.",
      "customizeAllReset": "Przywrócono sterowanie do domyślnych dla klasy."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "touchControls": "Sterowanie dotykowe",
      "clusterHold": "Opóźnienie przytrzymania edycji",
      "clusterHoldNote": "Jak długo przytrzymać ekranowy przycisk akcji, zanim otworzy się edytor przypisań. Zwiększ, jeśli edytor otwiera się podczas szybkiego używania umiejętności.",
      "targetPriority": "Priorytet celu ataku",
      "targetPriorityNearest": "Najbliższy",
      "targetPriorityLowestHp": "Najniższe zdrowie",
      "targetPriorityCurrent": "Najpierw obecny",
      "targetPriorityNote": "W co celuje przycisk Atak, gdy nie masz prawidłowego celu: najbliższy wróg, wróg o najniższym zdrowiu w zasięgu lub zachowaj obecny cel, dopóki pozostaje prawidłowy.",
      "aimAssist": "Inteligentne rzucanie",
      "aimAssistNote": "Naciśnij umiejętność zaczepną, aby użyć jej na celu, lub na najlepszym pobliskim wrogu, jeśli nie masz celu, obracając się w jego stronę. Przytrzymaj przycisk, aby podejrzeć zasięg umiejętności; puść z palcem poza przyciskiem, aby anulować.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Zresetuj sterowanie dotykowe",
      "touchResetDone": "Przywrócono domyślne sterowanie dotykowe.",
