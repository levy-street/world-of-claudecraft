...
export const en_XA: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "noLoot": "[Ñó ļóóţ ŕéçóŕðéð ýéţ.]",
      "target": "[Ţáŕĝéţ: {name}]",
      "noTargetEngaged": "[Ñó ţáŕĝéţ éñĝáĝéð.]",
      "segmentSummary": "[{label} - {duration}]",
      "lootWinner": "[Ŵíññéŕ: {name}]",
      "lootReturned": "[Ŕéţúŕñéð ţó çóŕþšé]",
      "lootRollLabel": "[Ŕóļļ]",
      "lootMethodNeed": "[Ñééð]",
      "lootMethodGreed": "[Ĝŕééð]",
      "lootMethodMaster": "[Ɱášţéŕ]",
      "lootMethodFfa": "[ƑƑÁ]",
      "lootMethodPersonal": "[Þéŕšóñáļ]",
      "lootMethodPass": "[Þášš]",
