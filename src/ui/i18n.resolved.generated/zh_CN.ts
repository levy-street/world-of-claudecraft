...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "pokerPlaytest": {
      ...
      "unknownPlayer": "玩家",
      "waiting": "等待下一局",
      "playerTurn": "{name}正在行动",
      "timeRemaining": "剩余{seconds}秒",
      "wagerAmount": "{action}金额",
      "rake": "抽水: {amount}",
      "error": {
        "busy": "牌桌正在处理。请重试。",
        "disabled": "扑克当前不可用。",
        ...
        "rebuy_not_allowed": "当前无法补充筹码。",
        "seat_conflict": "该座位已被占用。",
        "stale_action": "操作到达前牌局已发生变化。",
        "table_not_found": "该扑克牌桌已不存在。",
        "watch_conflict": "观战其他牌桌前请先离开当前牌桌。"
      },
      "chips": "{amount}筹码",
      "pot": "底池: {amount}",
      "noCards": "无牌",
