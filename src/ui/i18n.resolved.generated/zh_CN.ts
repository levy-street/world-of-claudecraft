...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocMarket": {
      ...
      "vaultTitle": "交易所金库",
      "vaultBody": "未关联钱包也能出售：所得会以 $WOC 形式保存在这里。可用于购买一口价商品，也可以随时关联钱包后提现。",
      "vaultBalance": "金库中有 {tokens} $WOC",
      "vaultBalanceUsd": "按当前价格约合 {usd}。仅为估算：金库保存的是 $WOC，其美元价值随市场波动。",
      "vaultEmpty": "你的金库是空的。",
      "vaultWithdraw": "提现到钱包",
      "vaultWithdrawAria": "将 {tokens} $WOC 提现到已关联的钱包",
      "vaultNeedsWallet": "关联钱包后即可提现金库余额。",
      "vaultWithdrawn": "已将 {tokens} $WOC 提现到你的钱包。",
      "vaultSellHint": "未关联钱包：本次出售的所得将保存在你的交易所金库中。",
      "vaultBuyWith": "用金库余额购买",
      "vaultPaysNote": "本次购买将从你的交易所金库余额中支付。",
      "quoteSignVault": "从金库支付"
    }
  },
  "gatherEvent": {
  ...
  "apiError": {
    ...
    "woc_market": {
      ...
      "held_disabled": "本服务器未开放交易所金库。",
      "held_insufficient": "你的金库余额不足以支付本次购买。",
      "held_empty": "你的金库是空的。",
      "held_withdraw_failed": "提现未能完成。余额仍保留在你的金库中，请稍后再试。",
      "account_proof_required": "请输入账户密码以授权本次上架。",
      "account_proof_two_factor": "你的账户已启用两步验证，请输入验证码以授权本次上架。",
      "account_proof_no_password": "此账户尚未设置密码，请先在账户设置中设置。",
      "account_proof_invalid": "密码或验证码未被接受，请重试。",
      "account_proof_throttled": "失败次数过多，请稍后再试。",
  ...
  "wallet": {
    ...
    "reauthListTitle": "确认上架",
    "reauthListHelp": "未关联钱包，因此由你的账户密码代替钱包签名来授权本次上架。",
