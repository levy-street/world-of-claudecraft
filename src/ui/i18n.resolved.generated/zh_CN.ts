...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "trade": {
      ...
      "woc": {
        ...
        "ineligibleReasonAccountBound": "账号绑定物品、任务物品、已锁定物品以及交易所类别之外的物品都无法出售换取 $WOC。",
    ...
    "mailbox": {
      ...
      "clickAttachAccountBound": "点击以附到信件上。账号绑定：只有你自己的角色才能收到它。",
      "cannotMail": "该物品无法邮寄。",
      "result": {
        ...
        "noMailAccountBound": "账号绑定的物品只能邮寄给你自己的角色。",
  ...
  "guide": {
    ...
    "glossary": {
      ...
      "accountBoundTerm": "账号绑定",
      "accountBoundDef": "自你获得之时起便与你的账号绑定的物品。它无法交易、卖给商人或在市场上架，而信件只能把它送到你自己的另一个角色手中。",
    ...
    "arenaPage": {
      ...
      "honorFinalNoteAccountBound": "荣誉购买是最终的。用钱币买下的东西还能从商人的回购列表里买回来，但荣誉购买永远不会出现在那里，而战争装备在你买下的那一刻便已账号绑定，因此它再也无法交易或以任何形式退回，只能寄给你自己的另一个角色。商店正因如此才要你确认一次：按下之前，请把那件装备看清楚。",
      "warfareHeading": "战争套装",
    ...
    "gear": {
      ...
      "accountBoundTitle": "账号绑定：在你的任何角色身上都属于你",
      "accountBoundBody": "少数特殊奖励是账号绑定的，从你赢得它们的那一刻起便与你的账号相连。账号绑定的物品无法交易、卖给商人、在市场上架或存入公会银行，寄给其他玩家的信件也不会带上它。唯一敞开的门是你自己角色之间的渡鸦邮驿：一个角色不再需要的绑定装备可以寄给同一账号下的另一个角色，职业专属装备也包括在内，这样合适职业的小号就能穿上它。这守护着英雄印记之类的奖励代币，也覆盖了用荣誉购买的每一件战争装备。你在世界中赢得的大多数装备仍然可以自由交易、出售或分享。"
    },
    "professions": {
    ...
    "economy": {
      ...
      "buyingBodyAccountBound": "与商人交谈并选择浏览他的货物，他的商店便会以单个面板打开：他的全部存货列在一处，只要付得起钱，点一下就归你。货物上方的数量条决定每次点击买多少，一件、五件或十件，也可以自定义数量，不过少数特殊商品（坐骑便是其中之一）一次只卖一件。可堆叠的钱币标价商品在行旁还有第二个选项，可以一次买下你的钱币所能负担的数量，最多一整叠。出售同样直接：商店开着时，点击背包中的物品即可当场卖出，而商人不收的东西，例如任务物品和账号绑定的物品，会原地留下。若你卖掉了让自己后悔的东西，商店会保留你近期售出物的买回列表，让你能按当初卖出的价钱把它们买回来。",
      "junkTitle": "清理废品",
      ...
      "mailHowAccountBound": "领取则是同样的流程反过来：站在任意石柱旁阅读你的信件，把信中所附收入钱袋与背包。普通信件过一段时间便会消失，但仍附有钱币或货物的信件会一直等着你，无论你多久才来。有几样东西邮驿一概拒收：任务物品、已绑定或将随交易绑定的物品，以及独一无二的外观代币，它们只随你本人同行；而账号绑定的物品，渡鸦只会把它送到你自己的另一个角色那里。另外，漂亮地交还一个任务之后，记得留意石柱；有些任务发布者是会写信的。",
      "dailyTitle": "每日奖励",
    ...
    "social": {
      ...
      "guildBankRulesBodyAccountBound": "物品仓储一开始是关着的。由一名官员自掏腰包把它开出来，之后公会可以用金库里的钱把它扩大。任务物品、一切账号绑定的东西，以及市场不收的装备都进不去，规则与市场一致，所以公会银行装的是那些仍然可以在玩家之间易手的货物。",
