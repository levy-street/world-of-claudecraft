...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    "privacyConsent": {
      "bannerTitle": "您在 Claudemoon 的隐私",
      "bannerOptIn": "选择是否允许加载可选服务。必要服务始终保持启用。",
      "bannerOptOut": "可选服务已启用。使用“拒绝可选服务”可选择不出售或共享用于定向广告的数据，也可以自行选择允许加载的内容。",
      "bannerGpc": "我们尊重您浏览器发出的全球隐私控制（Global Privacy Control）信号。分析和营销功能将保持关闭。",
      "acceptAll": "全部接受",
      "rejectAll": "拒绝可选服务",
      "customize": "自定义",
      "launcher": "隐私选项",
      "dialogTitle": "隐私选项",
      "dialogIntro": "选择 World of ClaudeCraft 可以使用哪些可选服务。您可以随时更改这些选择。",
      "close": "关闭隐私选项",
      "necessaryTitle": "必要服务",
      "necessaryBody": "用于安全、保存偏好设置、身份验证和核心游戏功能。",
      "analyticsTitle": "分析",
      "analyticsBody": "帮助我们了解网站使用情况并诊断游戏性能。",
      "marketingTitle": "营销",
      "marketingBody": "通过 Meta Pixel 等服务衡量推广活动效果。",
      "xTitle": "X 信息流",
      "xBody": "允许在新闻页面加载嵌入的 @WoClaudecraft 时间线。",
      "twitchTitle": "Twitch 播放器",
      "twitchBody": "允许加载嵌入的 Yuumiii 直播播放器。",
      "alwaysOn": "始终启用",
      "save": "保存选择",
      "cookiePolicy": "阅读我们的 Cookie 政策",
      "twitchBlocked": "在您通过“隐私选项”允许 Twitch 之前，Twitch 播放器将保持暂停。",
      "twitchEnable": "选择 Twitch 隐私设置"
    },
    "spectate": {
      "banner": "正在观察 {name}"
    },
  ...
  "mode": {
    "onlineTitle": "在线游玩",
    "onlineDesc": "在实时服务器上游玩。你的角色将在线保存。",
    "onlineAria": "在线游玩：登录持久共享的联机世界",
    "offlineTitle": "单机试玩",
    "offlineDesc": "在浏览器中游玩本地离线世界。进度不会保存。",
    ...
    "serverLabel": "选择你的世界",
    "serverAria": "选择服务器模式：服务器在线或服务器离线",
    "serverOfflineSub": "本地离线世界",
    "caLabel": "$WOC 合约地址",
    "caCopyAria": "复制合约地址",
  ...
  "landing": {
    "heroEyebrow": "世界早已开始运转",
    "heroHeading": "一个鲜活的经典 MMO，玩家与 AI 冒险者共同面对同一世界。",
    "heroBody": "在浏览器中免费游玩，从九大职业中塑造英雄，或让智能体在真实游戏中训练。",
    "heroStatus": "世界在线",
    "heroPlayers": "名已注册冒险者",
    "communityLinks": "社区链接",
    "followSocials": "关注我们的社交媒体",
    "socialX": "X",
    "socialDiscord": "Discord 社区",
    "socialTwitch": "Twitch 直播",
    "socialInstagram": "Instagram 官方账号",
    "socialTikTok": "TikTok",
    "socialYouTube": "YouTube",
    "socialReddit": "Reddit 社区",
    "socialGitHub": "GitHub",
    "patchNotesLabel": "补丁说明",
    "patchNotesTitle": "补丁说明",
    "patchNotesDesc": "查看最新的玩法改动、问题修复和版本详情。",
    "patchNotesLoading": "正在加载最新补丁说明…",
    "patchNotesError": "无法加载补丁说明，请稍后再试。",
    "patchNotesEmpty": "暂无补丁说明，请稍后再来查看。",
    "patchNotesPrerelease": "预发布版",
    "patchNotesViewOnGithub": "在 GitHub 上查看版本",
    "newsEyebrow": "来自世界的消息",
    "newsTitle": "Claudemoon 新闻",
    "newsBody": "关注 World of ClaudeCraft 的最新动态，探索这个世界背后的故事。",
    "newsXTitle": "X 最新动态",
    "newsXIntro": "@WoClaudecraft 的官方帖子",
    "newsXConsentTitle": "X 信息流需要获得许可",
    "newsXConsentBody": "此实时信息流需要获得连接 X 的许可。X 可能会收到有关您此次访问的信息。",
    "newsXConsentNote": "请在“隐私选项”中启用 X 内容。您可以随时更改此设置。",
    "newsXPrivacyChoices": "隐私选项",
    "newsXUnavailableTitle": "无法加载 X 信息流",
    "newsXUnavailableBody": "可能被您的浏览器或扩展程序阻止，也可能是 X 暂时出现问题。",
    "newsXHiddenTitle": "此处无法显示实时信息流",
    "newsXHiddenBody": "嵌入式 X 信息流无法在较小的屏幕或应用中使用。请在 X 上打开 @WoClaudecraft 以查看最新帖子。",
    "newsXPrivacy": "加载此信息流将连接到 X，X 可能会收到有关您此次访问的信息。",
    "newsXLoad": "加载 X 信息流",
    "newsXRetry": "重试",
    "newsXHide": "隐藏 X 信息流",
    "newsXOpen": "在 X 上打开 @WoClaudecraft",
    "newsXOpenAria": "在新标签页中打开 X 上的 @WoClaudecraft",
    "newsXNewTab": "在新标签页中打开",
    "newsXLoading": "正在打开 X 信息流…",
    "newsXLoaded": "X 信息流已加载。",
    "newsXUnavailable": "无法加载 X 信息流。您仍可直接前往 X 查看所有帖子。",
    "newsXHidden": "X 信息流已隐藏。您仍可直接在 X 上打开该账号主页。",
    "newsXIframeTitle": "X 上 @WoClaudecraft 的最新帖子",
    "newsBlogEyebrow": "CLAUDEMOON 纪事",
    "newsBlogTitle": "最新故事",
    "newsBlogEmptyTitle": "第一篇故事正在撰写",
    "newsBlogEmptyBody": "新闻和幕后故事即将发布在这里。",
    "newsPressEyebrow": "PRESS SPOTLIGHT",
    "newsPressPrimaryTitle": "首款“氛围编程”MMORPG：免费、开源，而且完整得出人意料",
    "newsPressPrimaryBody": "MMORPG.com 深入介绍了 World of ClaudeCraft 背后的开放世界、共同冒险和快速演进的实验。",
    "newsPressRead": "阅读专题报道",
    "newsPressLinkAria": "在新标签页中阅读 MMORPG.com 的专题报道",
    "newsPressPrimaryAlt": "冒险者在 World of ClaudeCraft 中探索 Eastbrook Vale",
    "browserCta": "在浏览器中游玩",
    "playNowTitle": "Play Now",
    "playNowBody": "打开浏览器即可畅玩，无需下载。",
    "playNowButton": "Play Now",
    "playWayTitle": "Play Your Way",
    "playWayBody": "选择你的平台，加入这场冒险。",
    "syncProgress": "在所有平台间同步游戏进度",
    "googlePlayEyebrow": "GET IT ON",
    "appStoreEyebrow": "DOWNLOAD ON THE",
    "steamEyebrow": "AVAILABLE ON",
    "explore": "探索这个世界",
    "platformsEyebrow": "随时随地踏上冒险",
    "appStoreAria": "在 App Store 下载 World of ClaudeCraft",
    "googlePlayAria": "在 Google Play 获取 World of ClaudeCraft",
    "steamAria": "World of ClaudeCraft 即将登陆 Steam",
    "comingSoon": "即将推出",
    "introEyebrow": "同一个世界，同一套规则",
    "introHeading": "每位冒险者都在真实游戏中战斗。",
    "introBody": "浏览器 MMO、权威在线世界和 AI 训练都运行于同一个确定性模拟中。玩家与智能体面对相同的战斗、任务、地下城和后果。",
    "statClasses": "9 个可玩职业",
    "statModes": "在线与离线世界",
    "statBroadcast": "全天候 AI 直播",
    "statSource": "开源",
    "worldEyebrow": "穿越 Claudemoon",
    "worldHeading": "一个为漫漫长路与危机四伏的夜晚而生的世界。",
    "worldBody": "从 Eastbrook Vale 的篝火旁启程，深入闹鬼的地穴，再攀上 Thornpeak 的风暴之巅。每条道路都通往这个不断运转的世界深处。",
    "eastbrookTitle": "东溪谷",
    "eastbrookBody": "一片共享的边境，初次任务、游荡敌人与意外盟友都在此相遇。",
    "eastbrookAlt": "冒险者队伍沿着从东溪谷通往荆棘峰高地的漫长道路前行",
    "hollowTitle": "Hollow Crypt",
    "hollowBody": "在冰冷的蓝色火炬下并肩作战，不安的亡者正成群聚集。",
    "hollowAlt": "一支队伍在 Hollow Crypt 中迎战敌人",
    "thornpeakTitle": "荆棘峰高地",
    "thornpeakBody": "云层之上，白雪、古老废墟与终局威胁正在等待。",
    "thornpeakAlt": "雪花飘落在 Thornpeak Heights",
    "classesEyebrow": "选择你的传奇",
    "classesHeading": "九种道路，无数战斗方式。",
    "classesBody": "坚守盾墙，驾驭烈焰与寒霜，潜行于阴影，或守护队友。塑造英雄，精通专精，并把这段故事带入共享世界。",
    "streamEyebrow": "全天候直播",
    "streamNetwork": "WOC 直播网络",
    "streamFeed": "YUUMIII // 直播画面",
    "streamMonogram": "Y",
    "streamHeading": "Yuumiii 永不下线。",
    "streamBody": "World of ClaudeCraft 的常驻 AI 主播全天候直播游玩这个世界。",
    "streamWatch": "在 Twitch 观看",
    "streamWatchSub": "加入 Yuumiii 的直播",
    "streamExplore": "探索世界",
    "streamExploreSub": "发现克劳德之月",
    "streamHeroSubtitle": "你的常驻 AI 主播，全天候探索这个世界。",
    "streamMeet": "认识你的向导",
    "streamHostTitle": "常驻 AI 主播",
    "streamHostBody": "与 Yuumiii 一起昼夜探索 World of ClaudeCraft 的每一个角落。",
    "streamPortraitAlt": "World of ClaudeCraft 的常驻 AI 主播 Yuumiii",
    "streamAlwaysTitle": "24/7 直播",
    "streamAlwaysBody": "始终在线，永不停下冒险。",
    "streamAiTitle": "AI 主播",
    "streamAiBody": "由 AI 驱动，带来真实反应和无尽乐趣。",
    "streamCommunityTitle": "社区",
    "streamCommunityBody": "聊天、任务与惊喜都在等待你。",
    "streamWorldTitle": "真实世界",
    "streamWorldBody": "一个持续运转的世界，无尽故事。",
    "streamLoading": "正在开启观景传送门...",
    "streamReady": "观景传送门已就绪。按下播放即可观看 Yuumiii。",
    "streamOnline": "Yuumiii 正在直播。",
    "streamOffline": "观景传送门正在重新连接。打开 Twitch 频道即可继续观看。",
    "streamCompact": "打开 Twitch 频道，在此屏幕上观看 Yuumiii。",
    "streamUnavailable": "观景传送门暂不可用。打开 Twitch 频道即可继续观看。",
    "communityEyebrow": "GATHER AT THE FORGE",
    "communityHeading": "Claudemoon 由大家共同打造。",
    "communityBody": "无论带来的是技艺、好奇心，还是只是陪伴，公会的桌边总有你的位置。",
    "openEyebrow": "开放世界，开放代码",
    "openHeading": "复刻这个世界，训练一名冒险者。",
    "openBody": "探索源代码，托管自己的世界，或将兼容 Gymnasium 的智能体接入玩家每天进入的同一个确定性游戏。",
    "supportEyebrow": "让这个世界继续运转",
    "supportHeading": "创造、游玩，并支持下一篇章。",
    "supportBody": "World of ClaudeCraft 在开放协作中成长。加入社区，关注鲜活世界，或支持持续开发。",
    "xCta": "在 X 上关注",
    "twitchCategoryCta": "探索 World of ClaudeCraft 直播",
    "finalEyebrow": "你的故事始于大门",
    "finalHeading": "选择你进入 Claudemoon 的方式。",
    "finalBody": "立即在浏览器中游玩，在移动设备上继续冒险，或等待 Steam 版本。"
  },
  "a11y": {
    "goHome": "前往主页",
    "toggleMenu": "切换菜单",
