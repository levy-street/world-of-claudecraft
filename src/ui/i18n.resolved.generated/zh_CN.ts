...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "gauntlet": {
      "title": "试炼回廊",
      "pitch": "熬过每一场试炼,笑到最后的人独得奖金。",
      "join": "加入试炼回廊",
      "withdraw": "退出",
      "joinQueue": "加入队列",
      "leaveQueue": "离开队列",
      "queuePosition": "队列位置：{n}",
      "spectate": "观战",
      "stopSpectating": "停止观战",
      "practice": "练习",
      ...
      "phaseStaging": "各就各位",
      "phaseTrial": "横渡开始",
      "phaseTrialSigils": "蚀刻开始",
      "phaseTrialPull": "握紧长绳",
      "phaseTrialEcho": "看守人的回响开始",
      "phaseTrialSpan": "踏上脆桥",
      "phaseTrialCourt": "终局之场",
      "phaseInterlude": "试炼通过",
      "phasePodium": "试炼回廊已定胜负",
      "greenLight": "绿灯!",
      "redLight": "红灯!",
      "vitalityLost": "你失去了 {amount} 点生命力。",
      ...
      "hint": {
        ...
        "span": "横渡玻璃桥。每对板中藏着一块脆板。",
        "court": "与对手决斗:抵达尽头的王冠,或将其推出场外。角色会定时轮换。"
      }
    },
    "hub": {
      "enter": "你穿过闪烁的传送门，进入试炼场。",
      "leave": "你回到了东溪谷。",
      "zoneName": "试炼藏书阁"
    },
    "hc": {
      ...
      "howto": "三个回合,十名选手,一顶王冠。霍德里克大人每回合都会重建他的闯关赛道:每次挺过淘汰(六人晋级,再三人),赢下决赛。跌落只损失时间。",
      "joinQueue": "加入试炼",
      "leaveQueue": "离开队列",
      ...
      "advance": "{count}人晋级",
      "spectating": "正在看台观战",
      "intermissionRebuild": "霍德里克大人正在重建赛道!",
      "intermissionQualified": "晋级成功,下一回合即将开始。",
      "intermissionEliminated": "被淘汰了!请欣赏看台风景。",
      "section": {
        "start_yard": "起点广场",
        "hammer_bridge": "铁锤桥",
        "rotor_court": "旋木庭院",
  ...
  "guide": {
    ...
    "hodricsCastlePage": {
      ...
      "courseHeading": "三个回合,一顶王冠",
      "courseBody": "闯关赛是一场淘汰秀:十名选手开跑,六人挺过首轮,三人进入决赛,一人加冕。霍德里克大人每回合都会重建赛道,所以没有两场相同的比赛:铁锤桥、旋木庭院、斧刃回廊、滑动吊桥、滚石坡、活塞窄道、旋转平台,顺序全凭大人当天的兴致。每个机关都按自己固定的发条节奏摆动、旋转、滚动,绝无随机,细心的眼睛总能找到安全的空当。",
      "fairnessHeading": "只靠双腿",
      "fairnessBody": "这里没人施法:整场比赛禁止使用技能,每位选手速度相同。试炼胜负只看胆识与时机,与装备或等级无关。",
      "fallsHeading": "摔落只耽误时间,不会丧命",
      "fallsBody": "被机关击中或跌入深渊,只会把你送回上一个检查点。堤道上没有人会死:跌落的唯一代价是追赶的那几秒。回合结束被淘汰的选手会被气派地抛上看台包厢,在那里就着小吃看完剩下的比赛。",
      "standingsHeading": "王冠",
      "standingsBody": "决赛回合率先冲线者赢得本场霍德里克王冠。你的出场数、夺冠数和决赛最佳成绩,每次排队都在累积。"
    },
    "valeCupPage": {
      "heading": "溪谷杯",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "gauntlet_recruiter": {
        "name": "Maro Half-Mask",
        "title": "试炼回廊传令官",
        "greeting": "和其他人一起踏上沙场吧,{className}。熬过每一场试炼,领奖台就是你的。"
      },
      "gauntlet_watcher": {
        "name": "石之守望者",
        "title": "横渡守护者",
