...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "unitFrame": {
      ...
      "targetOfTargetNamedLabel": "目标的目标：{name}",
      "partyLabel": "你的队伍",
      "partyChip": "小队",
      "partyGroup": "小队 {n}",
      ...
      "auraOverflowLabel": "另外 {count} 个增益效果"
    },
    "character": {
      "modelPreview": "角色模型预览"
    },
    ...
    "options": {
      ...
      "unitFrameHealthText": "单位框架生命值文本",
      "unitFrameDamageTrail": "延迟伤害轨迹",
      "unitFramePortraitEffects": "头像反馈",
