...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "discountLabel": "折扣",
      "discountSummary": "按有效锚定价格立减 {percent}%",
      "discountBonus": "{base} 增至 {credited} 克劳迪姆 (+{bonus})",
      "wocIncentive": "使用 $WOC 支付 - 始终至少 15% 折扣",
      "wocPromoNote": "含限时促销",
      ...
      "back": "返回",
      "historyExplorer": "在 Solana Explorer 上查看",
      "historyReceipt": "银行卡购买",
      "historyGiftNote": "礼品卡",
      "timeJustNow": "刚刚",
      "timeMinutes": "{n}m ago",
      "timeHours": "{n}h ago",
      ...
      "tabHistory": "历史记录",
      "giftTitle": "赠送礼品卡",
      "giftDenominationLabel": "面额",
      "giftRecipientLabel": "收件人",
      "giftToSelf": "给我自己",
      "giftToOther": "给其他人",
      "giftEmailLabel": "收件人邮箱",
      "giftEmailPlaceholder": "name@example.com",
      "giftEmailInvalid": "请输入有效的邮箱地址。",
      "giftOccasionLabel": "场合",
      "giftMessageLabel": "个人留言",
      "giftMessagePlaceholder": "添加简短留言 (可选)",
      "giftDeliveryLabel": "送达方式",
      "giftScheduleLabel": "安排送达时间 (可选)",
      "giftReviewButton": "核对礼品",
      "giftReviewSelf": "这张礼品卡将由你自己兑换。",
      "giftReviewEmail": "我们会将这张礼品卡发送到 {email}。",
      "giftReviewShared": "你将获得一个链接来分享这张礼品卡。",
      "giftReviewScheduled": "将在你选择的日期送达。",
      "giftConfirmButton": "确认并支付",
      "giftAnotherButton": "再赠送一张",
      "giftPending": "正在开具你的礼品卡。这可能需要一点时间。",
      "giftIssued": "你的礼品卡已可分享。",
      "giftFailed": "无法开具该礼品卡。请稍后再试。",
      "giftDeclined": "支付被拒绝。未开具礼品卡。",
      "giftLinkLabel": "礼品卡链接",
      "giftQrAlt": "礼品卡兑换链接的二维码",
      "giftTerms": "礼品卡仅可兑换克劳迪姆。不可兑换现金，且不可退款。",
      "deliveryEmail": "电子邮件",
      "deliveryLink": "分享链接",
      "deliveryReveal": "立即显示",
      "occasionBirthday": "生日",
      ...
      "occasionCongrats": "祝贺",
      "occasionThankyou": "感谢",
      "occasionGeneric": "随心赠送",
      "reasonPurchaseStripe": "购买 (银行卡)",
      "reasonPurchaseSol": "购买 (SOL)",
      "reasonPurchaseUsdc": "购买 (USDC)",
      "reasonPurchaseWoc": "购买 (WOC)",
      "reasonGiftcardRedeem": "礼品卡已兑换",
      "reasonSpend": "购买装饰",
      "reasonRefund": "退款",
      "reasonChargeback": "拒付",
      "reasonGiftcardVoid": "礼品卡已作废",
      "historyTitle": "交易记录",
      "historyLoading": "正在加载你的记录...",
      "historyError": "无法加载你的记录。请重试。",
      "historyEmpty": "你还没有任何克劳迪姆交易。",
      ...
      "tabSupply": "供应量",
      "supplyTitle": "现存克劳迪姆",
      "supplyLoading": "正在加载供应量...",
      "supplyError": "无法加载供应量数据。请重试。",
      "supplyUnavailable": "暂时无法获取供应量数据。",
      "supplyInExistence": "现存 {amount}",
      "supplyUsdValue": "价值 {amount}",
      "supplyIssued": "累计发行总量",
      "supplySunk": "累计消耗或撤销",
      "supplyHolders": "由 {n} 个账户持有",
      "supplyChangeUp": "本期增加 {amount}",
      "supplyChangeDown": "本期减少 {amount}",
      "supplyChangeFlat": "本期无变化",
      "supplyChartLabel": "所选期间的克劳迪姆供应量",
      "supplyChartEmpty": "本期没有供应量变动。",
      "supplyRangeLabel": "图表周期",
      "supplyRange24h": "24h",
      "supplyRange7d": "7d",
      "supplyRange30d": "30d",
      "supplyFootnote": "统计所有账户持有的全部克劳迪姆，实时汇总自账本。",
      "inspectButton": "详情",
      "inspectBack": "返回商店",
