...
export const zh_CN: EnTranslations = {
  ...
  "questUi": {
    ...
    "dialog": {
      ...
      "brewDraught": "给我酿一瓶深梦药剂。",
      "brewDraughtAria": "请求 {name} 酿造深梦药剂",
      "gargoyleBow": "俯首行礼。",
      "gargoyleBowAria": "向 {name} 俯首行礼",
      "gargoyleAttack": "攻击。",
      "gargoyleAttackAria": "攻击 {name}",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "keeper_nerissa": {
        "name": "不眠者奈瑞莎",
        "title": "流明之冠的幽灵守护者",
        "greeting": "生前我守着流明冠，而冠使这镜面诚实——这谷中每一面镜子都映出真实之物，唯有一面例外。死亡并未免去我的岗位，{playerName}，因为那一面仍未停止逼压。冠的光在衰竭，光所失守之处，山谷便渗透而出。留意你走在镜子的哪一侧。近来，它已难以分辨。"
      },
      "veilwright_ollo": {
        "name": "织帷者奥洛",
        "title": "帷幕市场商人",
        "greeting": "死者的外衣、瓶装的叹息、公道的价钱——帷幕自会供给。我摊上的每件东西，都是如今一无所有之人放下的；诀窍在于分清死者已了断的与仍紧攥不放的。分错了，他们午夜便来摊前寻你。想听那伤心的说法，就去问守护者井中的光。我只管卖外衣。"
      },
      "mistwitch_morwen": {
        "name": "雾巫莫温",
        "title": "洼地酿梦者",
        "greeting": "雾让你们大多数人睡不着。我能给你酿另一种睡眠——会回应你的那种。"
      },
      "gargoyle_sentinel_south": {
        "name": "石像鬼哨卫",
        "title": "镜之守卫",
        "greeting": "石头的眼睛吱嘎作响地转向你。它在听。"
      },
      ...
      "dread_sentinel_b": {
        "name": "恐惧哨卫",
        "title": "幽暗之镜的守望者",
        "greeting": "生前我们守着堤道。如今仍守着。"
      },
      "dread_sentinel_c": {
        "name": "恐惧哨卫",
        "title": "幽暗之镜的守望者",
        "greeting": "回头吧。黑镜不为生者而设……也从来不为我们。"
      },
      "tidewatcher_ondrel": {
        "name": "翁德雷尔·凡恩",
        "title": "守潮者",
    ...
    "quests": {
      ...
      "q_deepdream_recipe": {
        "title": "深眠的配方",
        "text": "药剂需要三种声音，{playerName}：从一无所有的贫穷之魂那里取两条白床单，从暗色草地上吃草的灵魂独角兽那里取两支角，再从看守环带的收割者身上割下两顶兜帽。带来给我，我就给你熬一剂带牙齿的睡眠。",
        "completion": "床单、角、兜帽——贫者、光者、忍者。锅子喜欢你。找个柔软的地方喝下吧，流浪者：你会遇见一直背负着的那个自己。",
        "objectives": {
          "0": {
            "label": "白床单"
          },
      ...
      "q_face_your_echo": {
        "title": "直面你的回响",
        "text": "喝下药剂，梦会在你面前立起一面镜子——你的回响，你的每道伤疤和每个招数都在镜子另一侧。战胜你自己，{playerName}，再把你那时的表情带回来给我。",
        "completion": "你回来了，镜子没有。它留在你手里的东西归你——梦只付这一次代价。",
        "objectives": {
          "0": {
            "label": "击败你的回响"
          }
      ...
      "q_gargoyle_south": {
        "title": "守望者的通行代价",
        "text": "微光在你眼后化作话语：收割者挤满了我的镜面，{playerName}。将他们清疏，通往Highwatch之路便是你的。",
        "completion": "石头满意地嗡鸣一声。它身后，镜面澄澈起来，如同一口终于释放的屏息。",
        "objectives": {
          "0": {
            "label": "已清剿收割者"
          }
      ...
      "q_gargoyle_west": {
        "title": "床单的通行代价",
        "text": "微光在你眼后化作话语：从可怜的死者身上取来四条白床单，{playerName}。以布支付者，通往Eastbrook之路为其敞开。",
        "completion": "床单沉入石中，消失无踪。它身后的镜面以光苏醒。",
        "objectives": {
          "0": {
            "label": "白床单"
          }
      ...
      "q_gargoyle_north": {
        "title": "被收割的光辉",
        "text": "微光在你眼后化作话语：灵魂之群对镜面而言燃得太亮，{playerName}。剿灭五只，Fenbridge便近在一步。",
        "completion": "石头饮下你泼洒的光。它身后的镜面如眼睛般睁开。",
        "objectives": {
          "0": {
            "label": "已清剿灵魂独角兽"
          }
      ...
      "q_the_failing_radiance": {
        "title": "衰竭的光辉",
        "text": "你感到我的寒意，便当我是个传说。我是一处岗位，{playerName}。我守着的流明冠并非金环——它是这里每一面镜中的光，是把生者与死者维系于各自倒影、令彼此不至相溺的接缝。那光在衰竭，你能从镜缚哨兵身上看出：昔日是冠的光辉亲自巡守，如今不过是盛满窃来之光的镜玻璃，因接缝再不指示它们该立于何处，便挤在北方的废墟里。击碎八个。你所驱散的每一片碎屑，都是一分归还的光，也是一分可以将其余托付于你的凭证。",
        "completion": "碎屑如向上飘落的雪，漂回井中，一息之间整座山谷都明亮了一分。不会长久。可你缝合接缝，而非斩断它，{playerName}——这在此地比你所想的更为稀罕。你也砸碎了那另一顶冠，是不是？桑坡之下，那顶铁的。那么三百年来头一回，这光或许会回来。留下吧。这山谷等能弥合伤口的手，已经等了很久。",
        "objectives": {
          "0": {
            "label": "镜缚哨兵已碎"
          }
      ...
      "q_what_the_poor_keep": {
        "title": "穷者仍守之物",
        "text": "南岸的贫魂生前一无所有，{playerName}——除了裹葬他们的那方布，因为教区连口棺材都出不起。如今冠光太薄，松不开他们的手，他们便游荡着，紧攥那唯一曾属于自己的东西。别当这是残忍；这是无处安放的爱。给我带来五方他们的裹布。我会把每一方放入井中，念出那贫得无法刻碑的名字。整个仪式便是如此：贫穷，死去，却仍被人以名相唤。",
        "completion": "五方裹布，五个名字。我把它们念进井里，水便接了去，像母亲替熟睡的孩子掀开外衣。今夜岸边的鬼魂少了些，{playerName}——不是被杀，是被放。这正是完整的冠所做的：把死者抱得够近，才好放手。如今我们用手来做，你我，一次五个名字。慢些。却不是徒然。",
        "objectives": {
          "0": {
            "label": "白色裹尸布"
          }
      ...
      "q_the_wardens_names": {
        "title": "守卫者之名",
        "text": "在黑峡谷中来回踱步的那三个，逃者称之为惊惧哨兵。我曾以名相唤：他们是我的骑士团，{playerName}，是生前守着黑貂镜堤道到最后的人，纵使心脏停了也不曾退岗。如今再无刀刃能解脱他们；黑镜骑得太深，连倒下都不能。可那黑镜已从守卫者蔓延到挤满堤道的收割者身上，长年累月里，收割者把守卫者的徽记撕扯松脱。给我带三枚来，从峡谷的收割者身上割下的，好让我把那三个名字最后一次高声念出。",
        "completion": "科温。奥尔德斯。布蕾娜。这就——念了；念出口，竟比这许多年的紧握都轻。他们不久便能停歇了；这我来料理。可要留意逼近之物，{playerName}：徽记被撕扯松脱，意味着那堤道上的镜面正在变薄，而尽头的伤口，等的正是此刻。趁对面之物尚未察觉门户已然赤裸，我必须重燃流明冠，撑住那黑貂之镜。我还需最后一样东西——它就沉在黑水之下。",
        "objectives": {
          "0": {
            "label": "守卫者徽记"
          }
      ...
      "q_what_the_glass_wants": {
        "title": "镜面所欲",
        "text": "你击败了自己的回响，便以为那是对自身的试炼，{playerName}。不是的。我以裹布、角与兜帽蒸馏出深梦，可你的梦所对峙的那面镜子，那顶着你的脸走进来的东西，却非我所酿。它是渗进来的——从峡谷的黑镜。挤在峡谷口的收割者，浸满同一股渗漏；斩杀八个，看它们的影子往哪一侧爬。那时，我便让内莉莎亲眼看清，她的伤口究竟在何处淌血。",
        "completion": "往东北。总是往东北，总是朝着黑貂之镜——你看见了吗？你的回响并不是你，旅人。它是那门后所居之物的一片碎屑，披着它所能窃得的最近的倒影：你的。梦不过是那渗漏所寻见的最薄之处；峡谷才是最宽的。去告诉内莉莎。她当得起这真相，你也一样。",
        "objectives": {
          "0": {
            "label": "峡谷口斩杀收割者"
          }
      ...
      "q_relight_the_lumen_crown": {
        "title": "重燃流明冠",
        "text": "守卫者已得名，堤道也在变薄，所以我必须做那自我死后便一再推迟之事：将流明冠最后一次点燃，从这一侧把黑貂之镜按合。冠的最后一点真火，是那幽暝巨口坠入池中时吞下的——那东西之所以从内里发光，正因如此。把那光重新割出来，{playerName}。黑镜会遣它的幽郁巨块前来阻止此仪；打倒四个。趁我还记得如何托住一点火花，给我带来一枚溺没的火种。守护者最后的职责，是成为一个不再需要守护的人。",
        "completion": "它燃着了。历经这一切黑暗，它仍认得我的手。看：镜面又是真的了——水下再无心跳，一个世界与其倒影之间，再无迷失的魂。那重担，也终于从我身上卸下。我不是消散，{playerName}；我是被换岗了。这并非打破黑貂之镜，只是撑住它；我无力打破那门后所待之物，也断不敢试。可再撑住一个纪元，便是撑住了。待有朝一日，一支比我们更勇的队伍终于走进那扇门，他们会发现另一侧已然就绪。去高塔堡传话：他们的守护者守夜守到了最后，而后被换了岗。镜子会记得你。你要留意，给它一些值得映照的东西。",
        "objectives": {
          "0": {
            "label": "幽暝巨口已亡"
          },
