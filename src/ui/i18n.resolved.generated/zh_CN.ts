  ...
  "hudChrome": {
    ...
    "raidBossGuide": {
      ...
      "nythraxis": {
        ...
        "phaseThroneName": "王座",
        "phaseThroneSummary": "尼思拉克西斯据守王座厅，反复施放蓄力正面劈砍、恐惧诅咒坦克轮换、穿刺队员的骨刺、留下燃烧地面的坟场爆裂，以及一波波复苏王室卫兵。",
        ...
        "graveEruptionHeroicSummary": "每 {everyHeroic} 秒，森森白骨之手会在队员脚下标记 {countHeroic} 个半径 {radius} 码的圆圈。{warning} 秒后，每个圆圈都会爆裂，造成 {burstHeroic} 最大生命值的暗影伤害，随后化为坟场烈焰持续燃烧至该阶段结束，对站在其中的任何人每秒造成 {tickHeroic} 最大生命值的伤害。烈焰不会自行熄灭：团队若不持续移动，地面终将被完全占满。",
        ...
        "soulfireName": "魂火",
        "soulfireSummary": "每次灵魂撕裂引爆都会在标记所在位置留下一片半径 {radius} 码的红色火池，燃烧 {seconds} 秒，每秒造成 {tickNormal} 最大生命值的伤害。火池不会在护符石 {clearance} 码范围内形成。",
        "soulfireHeroicSummary": "每次灵魂撕裂引爆都会在标记所在位置留下一片半径 {radius} 码的红色火池，持续燃烧至该阶段结束，每秒造成 {tickHeroic} 最大生命值的伤害。火池不会在护符石 {clearance} 码范围内形成，且不会自行熄灭。",
        "soulfireResponse": "每次施法都应更换灵魂撕裂的集合点，避免团队站在上一次施法留下的火焰中。",
        "gravefireName": "墓火",
