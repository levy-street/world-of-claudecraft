...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "自定义",
      "customizeTitle": "自定义操作",
      "customizeSlotAttack": "普通攻击",
      "customizeSlotSkill": "技能 {n}",
      "customizeSlotUtility": "辅助",
      "customizeDefault": "职业默认",
      "customizeResetSlot": "重置此槽位",
      "customizeResetAll": "全部重置为职业默认",
      "customizeUpdated": "已更新{slot}。",
      "customizeAllReset": "操作已重置为职业默认。"
    },
    "tutorial": {
    ...
    "options": {
      ...
      "touchControls": "触屏操作",
      "clusterHold": "编辑长按延迟",
      "clusterHoldNote": "长按屏幕上的操作按钮多久后才会打开其绑定编辑器。如果你在连续使用技能时误触发编辑器，请调高此值。",
      "targetPriority": "攻击目标优先级",
      "targetPriorityNearest": "最近",
      "targetPriorityLowestHp": "生命最低",
      "targetPriorityCurrent": "优先当前目标",
      "targetPriorityNote": "当你没有有效目标时，攻击按钮的锁定对象：最近的敌人、范围内生命最低的敌人，或在当前目标仍有效时保持不变。",
      "aimAssist": "智能施法",
      "aimAssistNote": "按下攻击技能会对你的目标施放，若没有目标则对附近最合适的敌人施放，并转身面向它。按住按钮可预览技能范围；将手指移开按钮后松开即可取消。",
      "millisecondsValue": "{value} ms",
      "touchReset": "重置触屏操作",
      "touchResetDone": "触屏操作已恢复为默认设置。",
      "footstepSounds": "脚步声",
      "clickFeedback": "点击标记",
