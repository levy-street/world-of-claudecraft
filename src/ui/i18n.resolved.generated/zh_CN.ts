  ...
  "guide": {
    ...
    "profPages": {
      ...
      "gatherDeeds": {
        ...
        "farmingSown": "耕作如今在功业之书里有了自己的一栏。Sow It Begins标记你种下的第一株作物，四页编年记则标记你在每处田畦所在地的第一次成活收成，从Eastbrook Vale直到Evergarden。熟练达到100铭刻Harvestmaster，可佩戴为头衔；一次金色的丰收会记下自己的零声望收藏印记，而耕作的熟练同样计入Master Gatherer（任意三项采集行业达到100）。功业只有头衔与声望，永不赋予力量。"
      },
      "fish": {
        "startHeading": "入门",
      ...
      "farm": {
        ...
        "tableHeading": "从田畦到餐桌",
        "tableBody": "厨房是一季收成得到回报的地方。在日常农家菜之外，每一阶作物都有一道更丰盛的菜肴，吃了能获得饱足：吃完这一餐，一份持久的恩泽便留在你身上，正是队伍在地下城门前想先吃下的那份底气。压轴的是Harvest Feast，厨师直接摆进世界里的一桌盛宴：在场的每个人各取一份，每人一次，而每一顿吃完的餐食都给出同样的饱足恩泽，于是一位农夫的一季收成能让整支队伍坐上餐桌。\n\n这张餐桌上也留着运气的位置。你收进的每一次收成都掷出与其他采集行业相同的横财几率，作物偶尔会结出金色的一茬：产量远超寻常，整个区域都会听到这项发现连着你的名字一同宣告，Golden Harvest也会记入你的功业之书。"
      },
      "econ": {
        "title": "制作经济",
