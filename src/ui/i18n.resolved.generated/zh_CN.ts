    ...
    "profPages": {
      ...
      "craftProse": {
        ...
        "cooking": {
          ...
          "identityBody": "吃下熟食会在18秒的休息中治疗你，这是拉怪间隙最便宜的治疗。梯子从90点治疗的Pan-Seared River Perch经980点的Marlow's Grand Roast，一路做到其上的三道顶级分职佳肴（1392点），这是游戏中最大的坐地回复，也是唯一在吃完整盘后留下精神饱满效果的食物。烹饪位于炼金术与制皮之间；药剂师（炼金术与烹饪）在Eastbrook厨房的Cook Marlow处宣誓（先为锅猎四头野猪），与制皮组成的Trapper暂无誓约任务。",
          ...
          "routeBody": "烹饪是杰作故事里诚实的例外：菜肴没有属性可提升，永不触发，也不必追。这门手艺的精通在于75的专精：每样食材省五分之一（批量菜上叠加极快），外加移动野外厨房，让宴席在副本门口出锅。边钓边做，两门技能互相供养：免费档到25，中档到50，精良档到75。精良档之上还有顶级厨房：三道分职佳肴与The Laden Hearth，没有导师传授，只能从拾得的配方学会，握有配方的厨师可以一路满速练到上限。配方到手之前，最后一段由精良菜承担，衰减为半速与四分之一，约再做150次。Marlow的订单每30分钟收八块野味肉。技能50记下Seasoned Chef，125是Grandmaster Cooking头衔。"
        },
        "alchemy": {
        ...
        "jewelcrafting": {
          ...
          "ladderBody": "珠宝加工没有自己的工位：整套目录都在Eastbrook锻造坊制作，与武器锻造和护甲锻造共用同一座铁砧，Forgemistress Darva也在那里授艺。梯子是三档九个训练师配方：铜档（指环、环、颈环）技能0免费，铁档（徽戒、环、颈圈）技能25每个25银，锇档（指环、环、护符）技能50每个1金，你在该行业的档位一达到配方档位便可学习。\n\n这里没有野外配方，也还没有组合件：每一档都是绑定锻造坊的训练师手艺，所以这门手艺就在铁匠们站立的地方学、也在那里练。",
          "routeHeading": "杰作与通往125之路",
