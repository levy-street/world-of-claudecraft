...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocSeason": {
      "menu": "$WOC 赛季",
      "title": "$WOC 奖励赛季",
      "subtitle": "由金库出资向顶尖玩家发放",
      "close": "关闭",
      "none": "当前没有进行中的奖励赛季。",
      "noneHint": "当竞技场抽成和回购开始为奖池注资时，赛季即会开启。",
      "statusActive": "进行中",
      "statusEnded": "已结束",
      "endsIn": "Ends in",
      ...
      "poolLabel": "可用奖励池",
      "wocUnit": "$WOC",
      "emittedLabel": "迄今已发放奖池的 {pct}%",
      "sinkLabel": "已注资",
      "emissionLabel": "Paid out",
      "invariant": "发放永远不会超过赛季收入：买入 > 卖出，链上强制执行。",
      "standingsTitle": "预计最高收益者",
      "colRank": "#",
      "colPlayer": "玩家",
      "colRating": "评分",
      "colReward": "奖励（$WOC）",
      "projectedNote": "基于当前奖池与竞技场排名的预测；最终发放在赛季结束时结算。"
    },
    "mobTooltip": {
