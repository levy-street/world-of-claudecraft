...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "materialHint": {
      ...
      "wyrmfallCore": "大师锻造制作催化剂。团队副本与英雄地下城的最终首领每个难度每日各掉落一次，每次1到3个；每日首次在A级或S级裂隙竞速中获胜可获得1或2个；英雄军需官以英雄徽记出售。"
    },
    "discord": {
      "title": "Discord",
    ...
    "perfecting": {
      ...
      "bindWarnDetail": "完美化永不降阶：失败的尝试只会消耗材料。已有完美化进度的装备无法解绑，晋升亦不可撤销。",
