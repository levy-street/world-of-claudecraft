...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nftSkins": {
      "title": "Wear an NFT",
      "intro": "证明你拥有 PFP NFT 即可穿戴：其特征塑造你的角色外观，原作则成为你的头像。持有该 NFT 期间一直有效。",
      "connectEthereum": "连接 Ethereum 钱包",
      "connectSolana": "连接 Solana 钱包",
      "ethereumLinked": "Ethereum 钱包: {address}",
      "solanaLinked": "Solana 钱包: {address}",
      "notLinked": "未绑定",
      "collectionsTitle": "支持的收藏集",
      "noCollections": "暂无可用的收藏集，请稍后再来查看。",
      "tokenIdPlaceholder": "代币 ID",
      "mintPlaceholder": "铸造地址",
      "claim": "认领",
      "claiming": "认领中...",
      "claimed": "已认领并装备。可随时在皮肤浏览器中查看。",
      "needWallet": "请先绑定对应的钱包。",
      "close": "关闭",
      "errorNotOwner": "该钱包不拥有此代币。",
      "errorUnverified": "暂时无法验证所有权，请稍后重试。",
      "errorCollection": "不支持该收藏集。",
      "errorTooMany": "已达到 NFT 皮肤上限。",
      "errorMetadata": "暂时无法读取此 NFT，请稍后重试。",
      "errorGeneric": "无法认领此 NFT 皮肤。",
      "walletError": "钱包连接失败。"
    },
    "mobTooltip": {
  ...
  "marketplace": {
    ...
    "modeUpload": "上传",
    "modeLink": "自托管",
    "uploadIntro": "上传你自己的 1024x1024 PNG 图集。我们会将其固定到 IPFS 并为你托管。",
    "linkIntro": "链接你自己托管的 PNG 图集。我们会代理访问,买家永远不会看到你的网址。免费。",
    "uploadFile": "Skin PNG (1024x1024)",
    "linkUrl": "图集网址",
    "quotaMeter": "已托管 {used}/{quota} 个位置",
    "trustedBadge": "可信创作者(即时上架)",
    "selfHostedFreeNote": "自托管免费且不限数量(在上架数量上限内)。",
    "hostingUnavailable": "托管上传暂时不可用。",
    "listedReview": "已提交审核,待运营人员批准后即会上架。",
    "baseColor": "底色",
    "patternColor": "图案颜色",
    "accentColor": "点缀色",
    "pattern": "图案",
    ...
    "randomize": "随机",
    "nameLabel": "Name",
    "namePlaceholder": "例如:翡翠龙鳞",
    "descLabel": "描述",
    "descPlaceholder": "买家将看到的简短描述",
    "priceLabel": "价格(USDC)",
    "preview": "实时预览",
    "list": "上架出售",
    "listing": "上架中…",
    "listed": "已上架,现已生效。可从你拥有的皮肤中装备它。",
    "listFailed": "无法上架",
    "listConnectFirst": "连接钱包后即可上架(你在此获得 70% 收益)。",
    "payoutHint": "你获得 70% • 30% 用于回购并销毁 $WOC",
    "patterns": {
      "solid": "纯色",
      "scales": "鳞片",
      "stripes": "条纹",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "skin_artisan": {
        "name": "皮肤工匠皮普",
        "title": "创作者皮肤公告板",
        "greeting": "想换个新造型吗,{className}?来逛逛玩家打造的外观皮肤,或者自己设计一款出售。以 USDC 结算;其中一部分用于回购并销毁 $WOC。"
      },
      "marshal_redbrook": {
        "name": "雷德布鲁克元帅",
        "title": "城镇元帅",
