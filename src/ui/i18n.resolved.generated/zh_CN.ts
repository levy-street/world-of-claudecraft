...
export const zh_CN: EnTranslations = {
  ...
  "game": {
    ...
    "talents": {
      ...
      "available": "可用",
      "spent": "已用",
      "pointSource": "选项行会从 {first} 级到 {cap} 级解锁。每个已解锁的行中选择一个选项。",
      "apply": "应用更改",
      "clear": "重置选项",
      "reset": "重置",
      "chooseSpec": "选择一个专精",
      ...
      "createBuildHint": "新配置会把当前选项另存为一个配置。导入可粘贴分享字符串。",
  ...
  "guide": {
    ...
    "talentsPage": {
      "heading": "天赋与专精",
      "intro": "天赋让职业更符合你的玩法。它们是可选的、宽容的，也很容易更改，所以你可以放心尝试。",
      "whatHeading": "天赋的作用",
      "whatBody": "随着升级，天赋行会逐步解锁，每行提供少量选择。每个选择都会为你的技能、属性或工具箱加入永久强化，塑造职业在战斗中的手感。",
      "howHeading": "它们如何运作",
      "howBody": "天赋行会随等级解锁，专精在 10 级开放。先选择一个专精，获得它的标志技能和精通，然后在抉择标签页中，从每个已解锁的行里选择一个选项。",
      "shareNote": "完成后的配置可以复制成简短分享码交给朋友，对方可直接粘贴到自己的天赋面板中载入。",
      "resetTitle": "一切都不是永久的",
      "resetNote": "只要不在战斗中，你随时可以重置选择，所以早期选择不会变成陷阱。多试几种，看看喜欢什么，再自由调整。",
      "specsHeading": "各职业的专精",
      "specsBody": "每个职业都有数个专精，各自拥有职责和标志重点。这里列出它们的整体形态。打开职业页面可查看完整技能套组。"
    },
    "arenaPage": {
      "heading": "竞技场与 PvP",
