...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tradingBots": {
      ...
      "close": "关闭交易机器人",
      "launcher": "机器人",
      "launcherAria": "租用 SOL 与 $WOC 交易机器人",
      "loading": "正在加载交易机器人...",
      "custody": "存款将进入由交易服务代你管理、设有上限的金库。提款只能发送到你已绑定的钱包，且你随时可以提取。",
      "riskNote": "自动交易可能造成亏损。租金不予退还。这不是投资建议。",
      "catalogIntro": "按月租用机器人，用 SOL 和 $WOC 组成的资金对注入金库，它就会在 DEX 上替你交易。",
      "skuGridName": "网格魔像",
      "skuGridBlurb": "在市场价格上下交替挂出买单和卖单，在价格波动时赚取价差。",
      "skuDcaName": "滴流精灵",
      "skuDcaBlurb": "按固定计划把 SOL 稳步兑换成 $WOC，分散你的买入时机。",
      "skuMomentumName": "动量幽光",
      "skuMomentumBlurb": "将资金对倾向趋势更强的一侧，趋势减弱时再调回平衡。",
      ...
      "claudiumBalance": "Claudium 余额：{amount}",
      "approvePayment": "请在钱包中批准租金支付...",
      "confirmingPayment": "正在网络上确认你的付款...",
      "subscribedBody": "机器人已租用。为金库注资即可开始交易。",
      "activeUntil": "有效期至 {date}",
      "fundTitle": "为金库注资",
      "solAmountLabel": "存入的 SOL",
      "wocAmountLabel": "存入的 $WOC",
      "depositBounds": "介于 {min} 与 {max} 之间",
      "depositButton": "存入",
      "approveDeposit": "请在钱包中批准该笔存款...",
      "confirmingDeposit": "正在网络上确认你的存款...",
      "amountInvalid": "请输入有效的数量。",
      "vaultLine": "金库：{sol} SOL，{woc} $WOC",
      "stateRunning": "运行中",
      "statePaused": "已暂停",
      "startButton": "启动",
      "pauseButton": "暂停",
      "paramsTitle": "策略设置",
      "paramGridSpacingBps": "网格间距（{percent}%）",
      "paramOrderSizeBps": "订单规模（{percent}%）",
      "paramDcaIntervalMinutes": "买入间隔（分钟）",
      "paramMomentumLookbackMinutes": "趋势回看（分钟）",
      "saveParams": "保存设置",
      "recentTrades": "最近交易",
      "noTrades": "暂无交易。",
      "tradeBuy": "买入",
      "tradeSell": "卖出",
      "pnlLine": "盈亏（{days} 天）：{amount} $WOC（{percent}%）",
      "withdrawButton": "全部提取",
      "withdrawTitle": "提取金库资金",
      "withdrawBody": "提取会暂停机器人，并将金库余额返还到你绑定的钱包。",
      "approveWithdraw": "请在钱包中批准该笔提款...",
      "withdrawPending": "提款正在进行中。网络确认后余额将更新。",
      "cooldown": "请求过于频繁。{seconds}秒后可重试。",
      "errWalletFeature": "你连接的钱包无法从游戏内发送交易。请尝试其他 Solana 钱包。",
      "errSignFailed": "交易未发送。可能已在你的钱包中被拒绝。",
      "errNoWallet": "请先连接 Solana 钱包。"
  ...
  "apiError": {
    ...
    "trading_bots": {
      "disabled": "交易机器人目前不可用。",
      "unknown_sku": "目录中没有该机器人。",
      "invalid_pay_currency": "不支持该支付货币。",
      "already_subscribed": "你已经租用了一个交易机器人。",
      "subscription_required": "请先租用一个交易机器人。",
      "subscription_expired": "你的机器人租期已到期。请续租或提取资金。",
      "insufficient_claudium": "Claudium 不足。",
      "invalid_amount": "请输入有效的数量。",
      "deposit_out_of_bounds": "该存入金额超出此机器人允许的范围。",
      "invalid_public_key": "请先连接 Solana 钱包。",
      "invalid_params": "不允许这些机器人设置。",
      "payment_not_found": "找不到该笔付款。请重新开始。",
      "payment_unverified": "该笔付款尚未确认。请稍候再试。",
      "vault_busy": "机器人金库正忙。请稍候再试。",
      "rate_limited": "请求过于频繁。请稍候再试。",
      "upstream_error": "交易机器人服务暂不可用，请稍后再试。"
    }
  },
  "guide": {
