...
export const zh_CN: EnTranslations = {
  ...
  "sim": {
    "rift": {
      ...
      "ascendFloor": "你向上进入{name}。",
      "stepBack": "你退回裂隙，返回原地。",
      "pylonLit": "一座符文尖塔亮起（{lit}/{total}）。",
      "wayDownOpens": "通往下层的裂口被撕开了。",
      "towerWave": "恶魔核心发出嚎叫。第{wave}波，共{total}波。",
      "towerBossWave": "核心裂开，一个更加可怕的存在从中走出。",
      "towerFloorClear": "恶魔核心破裂。向上的道路已经开启。",
      "towerCleared": "恶魔核心黯灭。高塔属于你了。",
  ...
  "worldContent": {
    ...
    "noticeboardName": "告示板",
    "demonTowerName": "恶魔之塔",
    "demonTowerBloodforgeName": "恶魔之塔：血铸熔炉",
    "demonTowerOssuaryName": "恶魔之塔：锁链骨堂",
    "demonTowerVoidCrownName": "恶魔之塔：虚空之冠",
    "demonTowerCoreName": "恶魔核心",
