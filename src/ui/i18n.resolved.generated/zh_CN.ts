...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "bandsHeading": "熟练度区间",
      "bandsBodySplitLadder": "熟练度区间是陆上行业计数之上共享的 0/100/200 阶梯：在 100 跨过的那一档会缩短采集施法，而陆上上限让区间 1 成为天花板。钓鱼保留自己的一套阶梯，共六档，分别在 0、100、150，以及 200 上的另外三档。它的区间不会缩短任何东西；它们选择渔获表，每一档都有与之相配的鱼竿，而过了第三档，技能门槛便不再移动，只剩鱼竿决定这张表能走多远。这段攀升正是把钓手拉向更深水域的东西，更好的渔获表和更远的教导都在那里。",
