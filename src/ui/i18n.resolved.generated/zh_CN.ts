...
export const zh_CN: EnTranslations = {
  ...
  "editor": {
    "vfx": {
      ...
      "saved": "已保存",
      "updating": "正在更新预览...",
      "shortcuts": "Space：施放。[ / ]：上一个 / 下一个技能。R：重复施放。F：收藏。A：展示模式。",
      "buildTools": "天赋、场景与灯光",
      "noTalent": "未选择天赋",
      "talentLevel": "等级 {level}",
      "seed": "场景种子",
      "graphics": "画面质量",
      "environment": "预览环境",
      "studioEnvironment": "工作室舞台",
      "worldEnvironment": "世界场景",
      "lighting": "舞台灯光",
      "neutralLighting": "中性",
      "brightLighting": "明亮",
      "darkLighting": "暗调",
      "savedGraphics": "使用游戏设置",
      "low": "低",
      "medium": "中等",
      "high": "高",
      "ultra": "极高",
      ...
      "show": "显示面板",
      "status": "生效中的效果",
      "help": "拖动场景旋转镜头，滚动缩放。冻结会保留当前画面。",
      "note": "施法遵循正常战斗规则。重放会重复指令，装饰性随机效果可能不同。",
      "castFailed": "施法被拒绝。请检查目标、距离、资源和冷却时间。",
      "draftNote": "更改仅保留在本次会话中，请导出以保存。",
      "snapshot": "截取画面"
    },
    "appTitle": "地图编辑器",
