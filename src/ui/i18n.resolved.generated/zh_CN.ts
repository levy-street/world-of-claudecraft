...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "crafting": {
      ...
      "tierTutorial": {
        "title": "你的第一个阶级",
        "tierCap": "一项专业在技能 {skill} 时达到第一个阶级，每提升一个阶级都会改善其产出或制作能力。不过，具体到你的技艺类专业，只有当某门技艺成为你两门主修之一时，才能制作超越稀有品质的作品。",
        "radar": "你的技艺类专业构成一个环轮。调谐到相邻的一对，这两门技艺便成为无上限的主修；环轮对面的一门技艺成为上限为稀有的爱好；其余技艺则进入休眠：知识仍会保留，但在你重新拾起之前上限为普通。",
