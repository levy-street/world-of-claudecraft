...
export const de_DE: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      "editKeys": "Bearbeiten Sie die Tasten der Aktionsleiste",
      "editKeysHint": "Klicken Sie auf einen Slot in der Aktionsleiste und drücken Sie dann eine Taste, um ihn zu binden.",
      "bannerHint": "Klicken Sie auf einen Steckplatz und drücken Sie dann eine Taste, um ihn zu binden. Klicken Sie auf Fertig, wenn Sie fertig sind.",
      "bannerCapturing": "Drücken Sie eine Taste, um diesen Slot zu binden ...",
      "boundToKey": "Gebunden an {key}.",
      "reset": "Zurücksetzen",
      "done": "Erledigt",
      "cancel": "Stornieren",
      "resetConfirmTitle": "Aktionsleistentasten zurücksetzen?",
      "resetConfirmBody": "Der erste Takt kehrt zu seinen Standardtonarten zurück. Der zweite und dritte Balken werden ungebunden. Dies kann nicht rückgängig gemacht werden."
    },
    "mounts": {
      "title": "Reittiere",
      "close": "Schließen",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "In den Klassen 1v1 und 2v2 spielt jeder Kämpfer das Allrounder-Kit. Taten, die die Stufe 3 gegen 3 oder höher erfordern, können hier nicht verdient werden.",
      "role": {
        "allrounder": {
          "name": "Allrounder",
      ...
      "practiceUnratedNote": "Übungskämpfe werden nicht gewertet: Platzierungen und Fortschritte im Book of Deeds zählen nicht.",
      ...
      "briefing": {
        ...
        "unratedNote": "Bots sind auf dem Spielfeld, daher wird dieser Kampf nicht gewertet: Die Rangliste ändert sich nicht und Taten für Tore, Paraden und Gegentreffer zählen nicht.",
        "practiceUnratedNote": "Dies ist ein Übungskampf, daher wird er nicht gewertet: Die Rangliste ändert sich nicht und der Fortschritt im Buch der Taten zählt nicht.",
    ...
    "materialHint": {
      "fineGrade": "Feine Note. Wird aus einer vollstufigen Ader mit einem Werkzeug gewonnen, das über dem Material liegt, und gilt als die gewöhnliche Version, wo immer eine benötigt wird.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Zum Angeln in diesen Gewässern benötigen Sie eine Angelrute der Stufe {tier}."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Sie benötigen Mining {skill}, um die Spitzhacke bereits in Ihren Taschen zu schwingen.",
        "logging": "Sie benötigen Logging {skill}, um die Axt bereits in Ihren Taschen zu schwingen.",
        "herbalism": "Sie benötigen Herbalism {skill}, um die Sichel bereits in Ihren Taschen zu bearbeiten."
      },
      "wieldUnmetCorpse": "Sie benötigen die Fähigkeit {skill}, Ihr bestes Werkzeug zum Einsatz zu bringen.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Erforderlich zum Fischen in Gewässern bis Stufe {tier}."
        },
        "use": {
      ...
      "stateCooldownTimed": "Respawnt in {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Ihr Werkzeug verfeinert diese Ausbeute zu einer feinen Qualität."
    },
    "archetypeTitle": {
      "label": "Titel",
      "none": "Keiner",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} von {max} Gebühren",
      ...
      "toolEffectModeAsk": "Fragen Sie jeden Einsatz",
      "toolEffectModePrompt": "Fragt jeden Einsatz",
      "toolEffectConfirmTitle": "{effect} verwenden?",
      "toolEffectConfirmBody": "Für diese Ernte eine Gebühr ausgeben? Ablehnend sammelt sich immer noch, ohne den Bonus. Verbleibende Gebühren: {charges}.",
      "toolEffectConfirmAccept": "Benutze eine Ladung",
      "toolEffectConfirmDecline": "Ohne sammeln",
      "toolEffectName": {
        "gatherersCache": "Vorrat des Sammlers",
        "artisansEye": "Auge des Handwerkers",
        "quickeningCharm": "Rückfederungs-Charme"
      },
      "toolEffectSlotButton": "Steckplatz {effect}",
      "toolEffectRechargeButton": "Aufladen",
      "toolEffectSlotted": "{effect} geschlitzt auf {profession}.",
      "toolEffectSlotInvalid": "{effect} kann dort nicht geslotet werden.",
      "toolEffectNoTool": "Sie benötigen zunächst ein echtes {profession}-Tool.",
      "toolEffectNoCharm": "Sie benötigen einen handgefertigten {effect}-Anhänger in Ihren Taschen.",
      "toolEffectNoGain": "{effect} ist bereits eingesteckt und vollständig aufgeladen.",
      "toolEffectRecharged": "{effect} aufgeladen: {material} x{count} verbraucht.",
      "toolEffectRechargeNoSlot": "Auf {profession} ist kein Effekt geslotet.",
      "toolEffectRechargeFull": "{effect} ist bereits vollständig aufgeladen.",
      "toolEffectRechargeToolCapped": "Nehmen Sie ein besseres {profession}-Werkzeug mit, um {effect} weiter aufzuladen.",
      "toolEffectRechargeMaterials": "Das Aufladen von {effect} erfordert {material} x{count}.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(gibt {count} Feinstufe aus)",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Teilen Sie freigeschaltete Taten mit Gildenmitgliedern und Anhängern sowie Taten- und Meisterwerkskarten mit dem Discord-Feed",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Die Ingenieurskunst stellt die Werkzeuge her, die sich jeder ernsthafte Sammler am Ende wünscht: die Spitzhacken der Stufen 4 und 5, Äxte, Sicheln und Angelruten, die kein Laden jemals für Münzen verkaufen kann, wobei jedes einzelne das Werkzeug darunter verbraucht.",
      ...
      "toolCraftedOrMarks": "Hergestellt ({craft}) oder {marks} Tiefenmarken nach drei Ertrunkene Litanei-Abschlüssen",
      "toolCraftedOrMarksHeroic": "Hergestellt ({craft}) oder {marks} Tiefenmarken nach einem heroischen Ertrunkene Litanei klar",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Nicht erhältlich",
      "priceNone": "Nicht gegen Münze verkauft",
      "toolTierReq": "Werkzeug der Stufe {tier}",
      "colWield": "Verwendung bei",
      "wieldNone": "Beliebig",
      ...
      "econ": {
        ...
        "trainingNote": "Eine Pauschalgebühr pro Rezeptsprosse, die einmal erhoben wird, wenn ein Meister es lehrt; Jeder Abschnitt der folgenden Tabelle wird heute live verwendet, von den kostenlosen Starterrezepten bis zu den Rutenlektionen für den Werkzeugmacher oben.",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Unbekannter Artikel {id}, Menge {count}",
      "unknownItemAriaMasterwork": "Unbekannter Artikel {id}, Menge {count}, Meisterwerk",
      "unknownItemAriaEnchanted": "Unbekannter Artikel {id}, Menge {count}, verzauberte Kopie",
      "unknownItemAriaBound": "Unbekannter Artikel {id}, Menge {count}, gebundenes Exemplar",
      "unknownItemAriaInstanced": "Unbekannter Artikel {id}, Menge {count}, vom Hersteller gekennzeichnetes Exemplar"
    },
    "equipment": {
      "empty": "Leer",
      "levelClass": "Stufe {level} {className}"
    ...
    "vendor": {
      ...
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Kaufen Sie jeweils {count}",
      "qtyCustom": "Brauch",
      "qtyCustomAria": "Wählen Sie einen benutzerdefinierten Kaufbetrag",
      "buyCountAria": "Kaufen Sie {count} von {item} für {price}",
      "buyCountAriaWithRequirement": "Kaufen Sie {count} von {item} für {price}. {requirement}",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_thorium_ore": {
        "name": "Feines Osmiumerz"
      },
      "fine_ironbark_log": {
        "name": "Feiner Eisenrindenscheit"
      },
      "fine_ashwood_log": {
        "name": "Feiner Eschenholzscheit"
      },
      "fine_elderwood_log": {
        "name": "Feiner Hochkiefernstamm"
      },
      "fine_silverleaf_herb": {
        "name": "Feines Sheenleaf-Kraut"
      },
      "fine_goldleaf_herb": {
        "name": "Feines Blattgoldkraut"
      },
      "fine_sunpetal_herb": {
        "name": "Feines Sonnenblütenkraut"
      },
      "stormreel_fishing_rod": {
        "name": "Sturmspulen-Angelrute"
      },
      "tidewrought_fishing_rod": {
        "name": "Gezeitengeformte Angelrute"
      },
      "duskwisp_essence": {
