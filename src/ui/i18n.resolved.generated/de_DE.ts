...
export const de_DE: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "noLoot": "Noch keine Beute aufgezeichnet.",
      "recentAwards": "{count} neue Beutevergaben",
      "target": "Ziel: {name}",
      "noTargetEngaged": "Kein Ziel im Kampf.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Gepasst",
      "methodMaster": "Meister",
      "methodPersonal": "Persönlich",
      "methodDelve": "Erkundung",
      "methodLooted": "Erbeutet",
      "noWinner": "Kein Gewinner",
      "rollDetail": "Wurf {roll}",
