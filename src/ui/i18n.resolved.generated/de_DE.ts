...
export const de_DE: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "Anpassen",
      "customizeTitle": "Steuerung anpassen",
      "customizeSlotAttack": "Standardangriff",
      "customizeSlotSkill": "Fähigkeit {n}",
      "customizeSlotUtility": "Unterstützung",
      "customizeDefault": "Klassenstandard",
      "customizeResetSlot": "Diesen Platz zurücksetzen",
      "customizeResetAll": "Alles auf Klassenstandard zurücksetzen",
      "customizeUpdated": "{slot} aktualisiert.",
      "customizeAllReset": "Steuerung auf Klassenstandard zurückgesetzt."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Haltedauer zum Bearbeiten",
      "clusterHoldNote": "Wie lange eine Aktionsschaltfläche auf dem Bildschirm gehalten werden muss, bevor der Belegungs-Editor öffnet. Erhöhe den Wert, wenn der Editor beim schnellen Wirken von Fähigkeiten aufgeht.",
      "targetPriority": "Angriffsziel-Priorität",
      "targetPriorityNearest": "Nächstes",
      "targetPriorityLowestHp": "Niedrigste Gesundheit",
      "targetPriorityCurrent": "Aktuelles zuerst",
      "targetPriorityNote": "Was die Angriffs-Schaltfläche anvisiert, wenn du kein gültiges Ziel hast: den nächsten Gegner, den Gegner mit der niedrigsten Gesundheit in Reichweite oder behalte dein aktuelles Ziel, solange es gültig bleibt.",
      "aimAssist": "Intelligentes Wirken",
      "aimAssistNote": "Drücke eine offensive Fähigkeit, um sie auf dein Ziel zu wirken – oder auf den besten Gegner in der Nähe, falls du keins hast – und drehe dich zu ihm. Halte die Schaltfläche, um die Reichweite anzuzeigen; lass mit dem Finger neben der Schaltfläche los, um abzubrechen.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Touch-Steuerung zurücksetzen",
      "touchResetDone": "Touch-Steuerung auf Standard zurückgesetzt.",
