...
export const zh_TW: EnTranslations = {
  ...
  "game": {
    ...
    "talents": {
      ...
      "available": "可用",
      "spent": "已用",
      "pointSource": "選項列會從 {first} 級到 {cap} 級解鎖。每個已解鎖的列中選擇一個選項。",
      "apply": "套用變更",
      "clear": "重置選項",
      "reset": "重置",
      "chooseSpec": "選擇一個專精",
      ...
      "createBuildHint": "新配置會把目前選項另存為一個配置。匯入可貼上分享字串。",
  ...
  "guide": {
    ...
    "talentsPage": {
      "heading": "天賦與專精",
      "intro": "天賦讓職業更符合你的玩法。它們是可選、寬容且容易更改的，所以你可以放心嘗試。",
      "whatHeading": "天賦的作用",
      "whatBody": "隨著升級，天賦列會逐步解鎖，每列提供少量選擇。每個選擇都會為你的技能、屬性或工具箱加入永久強化，塑造職業在戰鬥中的手感。",
      "howHeading": "運作方式",
      "howBody": "天賦列會隨等級解鎖，專精在 10 級開放。先選擇一個專精，取得它的代表技能與精通，然後在抉擇分頁中，從每個已解鎖的列裡選擇一個選項。",
      "shareNote": "完成後的配置可以複製成簡短分享碼交給朋友，對方可直接貼到自己的天賦面板中載入。",
      "resetTitle": "沒有什麼是永久的",
      "resetNote": "只要不在戰鬥中，你隨時可以重置選擇，所以早期選擇不會成為陷阱。多試幾種，看看喜歡什麼，再自由調整。",
      "specsHeading": "各職業的專精",
      "specsBody": "每個職業都有數個專精，各自擁有職責和代表重點。這裡列出它們的整體形態。打開職業頁面可查看完整技能套組。"
    },
    "arenaPage": {
      "heading": "競技場與PvP",
  ...
  "entities": {
    "abilities": {
      ...
      "repentance": {
        "name": "懺悔",
        "description": "使敵人進入冥想狀態，最多持續6秒。受到任何傷害都會打破效果。（懲戒專精招牌）"
      },
      "bestial_wrath": {
        "name": "狂野怒火",
      ...
      "shamanistic_rage": {
        "name": "薩滿之怒",
        "description": "釋放薩滿之怒，恢復160點法力值。（增強專精招牌）"
      },
      "natures_swiftness": {
        "name": "自然迅捷",
        "description": "呼喚自然之力，使你的下一個法術變為瞬發。（恢復專精招牌）"
      },
      "siphon_life": {
        "name": "生命虹吸",
      ...
      "fel_domination": {
        "name": "惡魔支配",
        "description": "支配魔能，使你的下一個法術變為瞬發。（惡魔學識專精招牌）"
      },
      "conflagrate": {
        "name": "燃盡",
