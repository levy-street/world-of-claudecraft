...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "shaderWarmOff": "關閉",
      "shaderWarmOn": "開啟",
      "shaderWarmNote": "自動：在圖形後端支援時（Direct3D 11、Vulkan）由背景工作執行緒提前連結著色器；在無法發揮作用的 OpenGL 上保持關閉。開啟會在所有環境中強制使用工作執行緒，包括會讓畫面更卡的環境；關閉則完全不使用。下次啟動遊戲時生效。",
      "gpuBackend": "圖形後端（Linux）",
      "gpuBackendAuto": "自動（嘗試一次 Vulkan）",
      "gpuBackendVulkan": "Vulkan",
      "gpuBackendOpenGL": "OpenGL",
      "gpuBackendNote": "自動：啟動時嘗試一次 Vulkan，可用則保留，此時著色器載入造成的卡頓會大幅減少。驅動程式不支援時退回 OpenGL。選過 Vulkan 或 OpenGL 之後再選回「自動」，會重新嘗試一次。下次啟動遊戲時生效。",
