...
export const zh_TW: EnTranslations = {
  ...
  "guide": {
    ...
    "riftsPage": {
      "heading": "裂隙",
      "intro": "裂隙是世界本身被撕開的一道口子，而不是一扇你走過去的門。踏進去，你會得到一趟從沒有人跑過的下潛之路：每道裂隙的樓層與居民都會變化，但每場最終戰鬥都由同一位君王佔據。即使等級相同，每次也仍可能走過不同的下潛之路。",
      "whatHeading": "何謂裂隙",
      ...
      "floorsHeading": "一層層向下",
      "floorsBody": "一道裂隙有數層樓，每一層都是現場生成的，而通往下層的路要等這一層放你走才會開啟：清掉層上還活著的東西，解開它橫在你路上的一切封鎖，向下的通道便會撕裂開來。最後一層都由同一位君王鎮守，他的力量隨裂隙等級提升。他的蟲害大軍會跟隨他穿越不同場景，因此最終戰鬥中還要應付他的隨從。每一層都有自己的性格，因此單單一趟旅程就可能帶你從嚴霜走進餘燼，而每當你抵達新的一層，聊天視窗都會念出它的名字。你螢幕上的追蹤條，正是你得知這一道有幾層的地方。有少數裂隙開啟的不是生成出來的下潛之路，而是一座手工打造的場景，它自有一段固定的長度。",
      "boundHeading": "一旦見血",
  ...
  "sim": {
    "rift": {
      "roachKing": {
        ...
        "tributeFeast": "貢品盛宴",
        "crown": "蟑螂王之冠",
        "crownWarning": "隱士起身。蟑螂王戴上了王冠！",
        "filthWarning": "污穢之山：離開標記區域！",
        "tributeWarning": "貢品盛宴：中斷引導，或擊殺貢品甲蟲！",
        "ringWarning": "蟑螂王正在蓄力：快到圓環外！",
        "filthDetonate": "污穢之山爆發了！",
        "swarmDetonate": "王室蟲群爆發了！",
        "deskSlam": "Desk Slam",
        "mountainOfFilth": "污穢之山",
        "royalSwarm": "王室蟲群"
      },
