...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "gauntlet": {
      ...
      "joinQueue": "加入佇列",
      "leaveQueue": "離開佇列",
      "queuePosition": "佇列位置：{n}",
      "spectate": "觀戰",
      "stopSpectating": "停止觀戰",
      "practice": "練習",
      "practiceNote": "立即開始一場只對抗電腦對手的單人試煉。",
      "rejoinQueue": "重新加入佇列",
      ...
      "phaseStaging": "各就各位",
      "phaseTrial": "橫渡開始",
      "phaseTrialSigils": "蝕刻開始",
      "phaseTrialPull": "握緊長繩",
      "phaseTrialEcho": "看守人的回響開始",
      "phaseTrialSpan": "踏上脆橋",
      "phaseTrialCourt": "終局之場",
      "phaseInterlude": "試煉通過",
      ...
      "placeSecond": "2nd",
      "placeThird": "3rd",
      "sigilsShattered": "糖玻璃碎了!",
      "echoRound": "第 {n} / {total} 輪",
      ...
      "hint": {
        ...
        "court": "與對手決鬥:抵達盡頭的王冠,或將其推出場外。角色會定時輪換。"
      }
    },
    "hub": {
      "enter": "你穿過閃爍的傳送門，進入試煉場。",
      "leave": "你回到了東溪谷。",
      "zoneName": "試煉藏書閣"
    },
    "hc": {
