...
export const zh_TW: EnTranslations = {
  ...
  "questUi": {
    ...
    "dialog": {
      ...
      "brewDraught": "給我釀一瓶深夢藥劑。",
      "brewDraughtAria": "請求 {name} 釀造深夢藥劑",
      "gargoyleBow": "俯首行禮。",
      "gargoyleBowAria": "向 {name} 俯首行禮",
      "gargoyleAttack": "攻擊。",
      "gargoyleAttackAria": "攻擊 {name}",
      "gargoyleShimmer": "石像泛起能量的微光……",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "keeper_nerissa": {
        "name": "不眠者奈瑞莎",
        "title": "流明之冠的幽靈守護者",
        "greeting": "生前我守著流明冠，而冠使這鏡面誠實——這谷中每一面鏡子都映出真實之物，唯有一面例外。死亡並未免去我的崗位，{playerName}，因為那一面仍未停止逼壓。冠的光在衰竭，光所失守之處，山谷便滲透而出。留意你走在鏡子的哪一側。近來，它已難以分辨。"
      },
      "veilwright_ollo": {
        "name": "織帷者奧洛",
        "title": "帷幕市場商人",
        "greeting": "死者的外衣、瓶裝的嘆息、公道的價錢——帷幕自會供給。我攤上的每件東西，都是如今一無所有之人放下的；訣竅在於分清死者已了斷的與仍緊攥不放的。分錯了，他們午夜便來攤前尋你。想聽那傷心的說法，就去問守護者井中的光。我只管賣外衣。"
      },
      "mistwitch_morwen": {
        "name": "霧巫莫溫",
        "title": "窪地釀夢者",
        "greeting": "霧讓你們大多數人睡不著。我能為你釀另一種睡眠——會回應你的那種。"
      },
      "gargoyle_sentinel_south": {
        "name": "石像鬼哨衛",
        "title": "鏡之守衛",
        "greeting": "石頭的眼睛嘎吱作響地轉向你。它在聽。"
      },
      ...
      "dread_sentinel_b": {
        "name": "恐懼哨衛",
        "title": "幽暗之鏡的守望者",
        "greeting": "生前我們守著堤道。如今仍守著。"
      },
      "dread_sentinel_c": {
        "name": "恐懼哨衛",
        "title": "幽暗之鏡的守望者",
        "greeting": "回頭吧。黑鏡不為生者而設……也從來不為我們。"
      },
      "tidewatcher_ondrel": {
        "name": "翁德瑞爾·韋恩",
        "title": "守潮者",
    ...
    "quests": {
      ...
      "q_deepdream_recipe": {
        "title": "深眠的配方",
        "text": "藥劑需要三種聲音，{playerName}：從一無所有的貧窮之魂那裡取兩條白床單，從暗色草地上吃草的靈魂獨角獸那裡取兩支角，再從看守環帶的收割者身上割下兩頂兜帽。帶來給我，我就給你熬一劑帶牙齒的睡眠。",
        "completion": "床單、角、兜帽——貧者、光者、忍者。鍋子喜歡你。找個柔軟的地方喝下吧，流浪者：你會遇見一直背負著的那個自己。",
        "objectives": {
          "0": {
            "label": "白床單"
          },
      ...
      "q_face_your_echo": {
        "title": "直面你的回響",
        "text": "喝下藥劑，夢會在你面前立起一面鏡子——你的回響，你的每道傷疤和每個招數都在鏡子另一側。戰勝你自己，{playerName}，再把你那時的表情帶回來給我。",
        "completion": "你回來了，鏡子沒有。它留在你手裡的東西歸你——夢只付這一次代價。",
        "objectives": {
          "0": {
            "label": "擊敗你的回響"
          }
      ...
      "q_gargoyle_south": {
        "title": "守望者的通行代價",
        "text": "微光在你眼後化作話語：收割者擠滿了我的鏡面，{playerName}。將他們清疏，通往Highwatch之路便是你的。",
        "completion": "石頭滿意地嗡鳴一聲。它身後，鏡面澄澈起來，如同一口終於釋放的屏息。",
        "objectives": {
          "0": {
            "label": "已清剿收割者"
          }
      ...
      "q_gargoyle_west": {
        "title": "床單的通行代價",
        "text": "微光在你眼後化作話語：從可憐的死者身上取來四條白床單，{playerName}。以布支付者，通往Eastbrook之路為其敞開。",
        "completion": "床單沉入石中，消失無蹤。它身後的鏡面以光甦醒。",
        "objectives": {
          "0": {
            "label": "白床單"
          }
      ...
      "q_gargoyle_north": {
        "title": "被收割的光輝",
        "text": "微光在你眼後化作話語：靈魂之群對鏡面而言燃得太亮，{playerName}。剿滅五隻，Fenbridge便近在一步。",
        "completion": "石頭飲下你潑灑的光。它身後的鏡面如眼睛般睜開。",
        "objectives": {
          "0": {
            "label": "已清剿靈魂獨角獸"
          }
      ...
      "q_the_failing_radiance": {
        "title": "衰竭的光輝",
        "text": "你感到我的寒意，便當我是個傳說。我是一處崗位，{playerName}。我守著的流明冠並非金環——它是這裡每一面鏡中的光，是把生者與死者維繫於各自倒影、令彼此不至相溺的接縫。那光在衰竭，你能從鏡縛哨兵身上看出：昔日是冠的光輝親自巡守，如今不過是盛滿竊來之光的鏡玻璃，因接縫再不指示它們該立於何處，便擠在北方的廢墟裡。擊碎八個。你所驅散的每一片碎屑，都是一分歸還的光，也是一分可以將其餘託付於你的憑證。",
        "completion": "碎屑如向上飄落的雪，漂回井中，一息之間整座山谷都明亮了一分。不會長久。可你縫合接縫，而非斬斷它，{playerName}——這在此地比你所想的更為稀罕。你也砸碎了那另一頂冠，是不是？桑坡之下，那頂鐵的。那麼三百年來頭一回，這光或許會回來。留下吧。這山谷等能彌合傷口的手，已經等了很久。",
        "objectives": {
          "0": {
            "label": "鏡縛哨兵已碎"
          }
      ...
      "q_what_the_poor_keep": {
        "title": "窮者仍守之物",
        "text": "南岸的貧魂生前一無所有，{playerName}——除了裹葬他們的那方布，因為教區連口棺材都出不起。如今冠光太薄，鬆不開他們的手，他們便遊蕩著，緊攥那唯一曾屬於自己的東西。別當這是殘忍；這是無處安放的愛。給我帶來五方他們的裹布。我會把每一方放入井中，念出那貧得無法刻碑的名字。整個儀式便是如此：貧窮，死去，卻仍被人以名相喚。",
        "completion": "五方裹布，五個名字。我把它們念進井裡，水便接了去，像母親替熟睡的孩子掀開外衣。今夜岸邊的鬼魂少了些，{playerName}——不是被殺，是被放。這正是完整的冠所做的：把死者抱得夠近，才好放手。如今我們用手來做，你我，一次五個名字。慢些。卻不是徒然。",
        "objectives": {
          "0": {
            "label": "白色裹屍布"
          }
      ...
      "q_the_wardens_names": {
        "title": "守衛者之名",
        "text": "在黑峽谷中來回踱步的那三個，逃者稱之為驚懼哨兵。我曾以名相喚：他們是我的騎士團，{playerName}，是生前守著黑貂鏡堤道到最後的人，縱使心臟停了也不曾退崗。如今再無刀刃能解脫他們；黑鏡騎得太深，連倒下都不能。可那黑鏡已從守衛者蔓延到擠滿堤道的收割者身上，長年累月裡，收割者把守衛者的徽記撕扯鬆脫。給我帶三枚來，從峽谷的收割者身上割下的，好讓我把那三個名字最後一次高聲念出。",
        "completion": "科溫。奧爾德斯。布蕾娜。這就——念了；念出口，竟比這許多年的緊握都輕。他們不久便能停歇了；這我來料理。可要留意逼近之物，{playerName}：徽記被撕扯鬆脫，意味著那堤道上的鏡面正在變薄，而盡頭的傷口，等的正是此刻。趁對面之物尚未察覺門戶已然赤裸，我必須重燃流明冠，撐住那黑貂之鏡。我還需最後一樣東西——它就沉在黑水之下。",
        "objectives": {
          "0": {
            "label": "守衛者徽記"
          }
      ...
      "q_what_the_glass_wants": {
        "title": "鏡面所欲",
        "text": "你擊敗了自己的回響，便以為那是對自身的試煉，{playerName}。不是的。我以裹布、角與兜帽蒸餾出深夢，可你的夢所對峙的那面鏡子，那頂著你的臉走進來的東西，卻非我所釀。它是滲進來的——從峽谷的黑鏡。擠在峽谷口的收割者，浸滿同一股滲漏；斬殺八個，看它們的影子往哪一側爬。那時，我便讓內莉莎親眼看清，她的傷口究竟在何處淌血。",
        "completion": "往東北。總是往東北，總是朝著黑貂之鏡——你看見了嗎？你的回響並不是你，旅人。它是那門後所居之物的一片碎屑，披著它所能竊得的最近的倒影：你的。夢不過是那滲漏所尋見的最薄之處；峽谷才是最寬的。去告訴內莉莎。她當得起這真相，你也一樣。",
        "objectives": {
          "0": {
            "label": "峽谷口斬殺收割者"
          }
      ...
      "q_relight_the_lumen_crown": {
        "title": "重燃流明冠",
        "text": "守衛者已得名，堤道也在變薄，所以我必須做那自我死後便一再推遲之事：將流明冠最後一次點燃，從這一側把黑貂之鏡按合。冠的最後一點真火，是那幽暝巨口墜入池中時吞下的——那東西之所以從內裡發光，正因如此。把那光重新割出來，{playerName}。黑鏡會遣它的幽鬱巨塊前來阻止此儀；打倒四個。趁我還記得如何托住一點火花，給我帶來一枚溺沒的火種。守護者最後的職責，是成為一個不再需要守護的人。",
        "completion": "它燃著了。歷經這一切黑暗，它仍認得我的手。看：鏡面又是真的了——水下再無心跳，一個世界與其倒影之間，再無迷失的魂。那重擔，也終於從我身上卸下。我不是消散，{playerName}；我是被換崗了。這並非打破黑貂之鏡，只是撐住它；我無力打破那門後所待之物，也斷不敢試。可再撐住一個紀元，便是撐住了。待有朝一日，一支比我們更勇的隊伍終於走進那扇門，他們會發現另一側已然就緒。去高塔堡傳話：他們的守護者守夜守到了最後，而後被換了崗。鏡子會記得你。你要留意，給它一些值得映照的東西。",
        "objectives": {
          "0": {
            "label": "幽暝巨口已亡"
          },
