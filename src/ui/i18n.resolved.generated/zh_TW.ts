...
export const zh_TW: EnTranslations = {
  ...
  "guide": {
    ...
    "professions": {
      ...
      "whatBody": "專業是這個世界的營生：四種採集行業從大地中獲取原料，十種製作行業把它們變成裝備、飯菜、藥水與工具。萬物環環相扣：你挖出的礦石成為刀劍，刀劍接受附魔，而附魔又需要從舊裝備中分解出的粉塵。這裡沒有專業數量限制：如今九種製作行業已有內容，每個角色都能同時修習其中八種與全部四種採集行業（工程學是唯一的例外：它的配方全部始於自由上限之上，要等爆破師的誓言），唯一的排他選擇是你最終宣誓的命途，而一旦宣誓，落入休眠的製作行業便不再上升。技能永不下降，學會的東西也永遠不會被奪走。",
      "ringHeading": "製作之輪",
      "ringBody": "十種製作行業排列在一個輪環上，各自獨立記錄技能；點開一張卡片即可查看完整的配方表與數值。",
      "ringWaveNote": "輪環上還有一門手藝，銘文學，佔著席位卻尚未提供任何配方；這是刻意為之而非疏漏：它的內容將隨後續的區域擴充一同到來。",
      "capFmt": "上限{cap}",
      "comingSoon": "暫無配方",
      "gatherHubHeading": "採集",
      ...
      "deedsBody": "功業之書伴隨這一切：首次調諧獲得Craftsworn，首次傑作獲得Masterwright，均可作為頭銜佩戴。九種可修行業各在技能50設有里程碑功業，並在上限125加冕Grandmaster頭銜；釣魚在100熟練獲得Old Salt，200獲得Master Angler頭銜。此外還有首次採集、首次製作、野外奇遇與拆解回收的功業。這一切皆為裝飾：只有頭銜與聲望，功業永不賦予力量。",
      "startHeading": "從哪裡開始",
    ...
    "profPages": {
      ...
      "craftProse": {
        ...
        "enchanting": {
          ...
          "identityBody": "沒有工位、沒有訓練師、沒有要買的配方書：所有附魔初始即會，誰都能從第一天開始分解，技能與各行業一樣以125為上限。它位於銘文學與珠寶設計之間，兩條命途是Arcanist與Gembinder，均暫不可宣誓：銘文學仍在等待第一批配方，而珠寶設計雖已在鍛造坊錘打自己的梯子，Gembinder卻還沒有宣誓任務；因此附魔今天是所有人的手藝：宣誓前自由練到精良層，也是爆破師或藥劑師天然的愛好選擇。附魔師還維繫著採集世界：三種可鑲嵌的工具效果都是附魔師的作品，原作者為自己的作品充能享有折扣，專精後更深。",
