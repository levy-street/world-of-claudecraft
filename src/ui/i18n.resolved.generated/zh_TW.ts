...
export const zh_TW: EnTranslations = {
  ...
  "editor": {
    "vfx": {
      ...
      "saved": "已儲存",
      "updating": "正在更新預覽...",
      "shortcuts": "Space：施放。[ / ]：上一個 / 下一個技能。R：重複施放。F：收藏。A：展示模式。",
      "buildTools": "天賦、場景與燈光",
      "noTalent": "未選擇天賦",
      "talentLevel": "等級 {level}",
      "seed": "場景種子",
      "graphics": "畫面品質",
      "environment": "預覽環境",
      "studioEnvironment": "工作室舞台",
      "worldEnvironment": "世界場景",
      "lighting": "舞台燈光",
      "neutralLighting": "中性",
      "brightLighting": "明亮",
      "darkLighting": "暗調",
      "savedGraphics": "使用遊戲設定",
      "low": "低",
      "medium": "中等",
      "high": "高",
      "ultra": "極高",
      ...
      "show": "顯示面板",
      "status": "生效中的效果",
      "help": "拖動場景旋轉鏡頭，捲動縮放。凍結會保留目前畫面。",
      "note": "施法遵循正常戰鬥規則。重播會重複指令，裝飾性隨機效果可能不同。",
      "castFailed": "施法遭拒。請檢查目標、距離、資源與冷卻時間。",
      "draftNote": "變更僅保留於本次工作階段，請匯出以儲存。",
      "snapshot": "擷取畫面"
    },
    "appTitle": "地圖編輯器",
