...
export const zh_TW: EnTranslations = {
  ...
  "itemUi": {
    ...
    "tooltip": {
      ...
      "flaskThroughDeath": "該效果在死亡後依然保留，但在登出後消失；評級比賽開始時會清空所有效果。",
