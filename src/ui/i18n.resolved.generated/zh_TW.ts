...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "dexSwap": {
      ...
      "close": "關閉購買 $WOC",
      "launcher": "購買",
      "launcherAria": "用 SOL 或 USDC 購買 $WOC",
      "nonCustodial": "兌換透過 Jupiter DEX 聚合器路由，由你自己的錢包簽署並送出。遊戲絕不保管你的金鑰或資金。",
      "amountLabel": "你支付",
      "tokenAria": "支付代幣",
      "quoteButton": "取得報價",
      "quoting": "正在尋找最佳路徑...",
      "amountInvalid": "請輸入有效的數量。",
      "slippage": "最大滑價：{percent}%",
      "receiveLine": "你將獲得約 {amount} $WOC",
      "payLine": "你支付 {amount} {symbol}",
      "priceImpact": "價格影響：{percent}%",
      "minReceived": "最少獲得：{amount} $WOC",
      "buyButton": "購買 $WOC",
      "quoteStale": "報價已過期。購買前請重新取得報價。",
      "feeLine": "包含 {percent}% 平台手續費",
      "cooldown": "請求過於頻繁。{seconds}秒後可重試。",
      "requoted": "該報價已過期，已為你取得新報價。請確認後再次點擊購買。",
      "signing": "請在錢包中核准該交易...",
      "sentTitle": "兌換已送出",
      "sentBody": "你的錢包已簽署並送出兌換。網路確認後你的 $WOC 餘額將更新。",
      "signatureLabel": "交易簽章：{signature}",
      "viewOnExplorer": "在 Solana Explorer 上檢視",
      "buyMore": "再購買 $WOC",
      "errWalletFeature": "你連接的錢包無法從遊戲內送出交易。請嘗試其他 Solana 錢包。",
      "errSignFailed": "交易未送出。可能已在你的錢包中被拒絕。",
      "errNoWallet": "請先連接 Solana 錢包。"
    },
    "tradingBots": {
      "title": "交易機器人",
      "close": "關閉交易機器人",
      "launcher": "機器人",
      "launcherAria": "租用 SOL 與 $WOC 交易機器人",
      "loading": "正在載入交易機器人...",
      "custody": "存款將進入由交易服務代你管理、設有上限的金庫。提領只能發送到你已綁定的錢包，且你隨時可以提領。",
      "riskNote": "自動交易可能造成虧損。租金不予退還。這不是投資建議。",
      "catalogIntro": "按月租用機器人，用 SOL 和 $WOC 組成的資金對注入金庫，它就會在 DEX 上替你交易。",
      "skuGridName": "網格魔像",
      "skuGridBlurb": "在市場價格上下交替掛出買單和賣單，在價格波動時賺取價差。",
      "skuDcaName": "滴流精靈",
      "skuDcaBlurb": "按固定排程把 SOL 穩步兌換成 $WOC，分散你的買入時機。",
      "skuMomentumName": "動量幽光",
      "skuMomentumBlurb": "將資金對傾向趨勢較強的一側，趨勢減弱時再調回平衡。",
      "priceWoc": "每月 {amount} $WOC",
      "priceClaudium": "每月 {amount} Claudium",
      "rentButton": "租用",
      "payWithLabel": "支付方式",
      "payWoc": "$WOC",
      "payClaudium": "Claudium",
      "claudiumBalance": "Claudium 餘額：{amount}",
      "approvePayment": "請在錢包中核准租金支付...",
      "confirmingPayment": "正在網路上確認你的付款...",
      "subscribedBody": "機器人已租用。為金庫注資即可開始交易。",
      "activeUntil": "有效期至 {date}",
      "fundTitle": "為金庫注資",
      "solAmountLabel": "存入的 SOL",
      "wocAmountLabel": "存入的 $WOC",
      "depositBounds": "介於 {min} 與 {max} 之間",
      "depositButton": "存入",
      "approveDeposit": "請在錢包中核准該筆存款...",
      "confirmingDeposit": "正在網路上確認你的存款...",
      "amountInvalid": "請輸入有效的數量。",
      ...
      "pauseButton": "暫停",
      "paramsTitle": "策略設定",
      "paramGridSpacingBps": "網格間距（{percent}%）",
      "paramOrderSizeBps": "訂單規模（{percent}%）",
      "paramDcaIntervalMinutes": "買入間隔（分鐘）",
      "paramMomentumLookbackMinutes": "趨勢回看（分鐘）",
      "saveParams": "儲存設定",
      "recentTrades": "最近交易",
      "noTrades": "暫無交易。",
      "tradeBuy": "買入",
      "tradeSell": "賣出",
      "pnlLine": "損益（{days} 天）：{amount} $WOC（{percent}%）",
      "withdrawButton": "全部提領",
      "withdrawTitle": "提領金庫資金",
      "withdrawBody": "提領會暫停機器人，並將金庫餘額返還到你綁定的錢包。",
      "approveWithdraw": "請在錢包中核准該筆提領...",
      "withdrawPending": "提領正在進行中。網路確認後餘額將更新。",
      "cooldown": "請求過於頻繁。{seconds}秒後可重試。",
      "errWalletFeature": "你連接的錢包無法從遊戲內送出交易。請嘗試其他 Solana 錢包。",
      "errSignFailed": "交易未送出。可能已在你的錢包中被拒絕。",
      "errNoWallet": "請先連接 Solana 錢包。"
  ...
  "apiError": {
    ...
    "dex_swap": {
      "disabled": "目前無法在遊戲內購買 $WOC。",
      "input_not_allowed": "不支援該支付代幣。",
      "invalid_amount": "請輸入有效的數量。",
      "invalid_slippage": "不允許該滑價設定。",
      "invalid_public_key": "請先連接 Solana 錢包。",
      "quote_tampered": "該報價與本次兌換不符，請重新取得報價。",
      "no_route": "目前沒有適用於該數量的交易路徑。",
      "rate_limited": "請求過於頻繁。請稍候再試。",
      "upstream_error": "兌換服務暫時無法使用，請稍後再試。"
    },
    "trading_bots": {
      "disabled": "交易機器人目前無法使用。",
      "unknown_sku": "目錄中沒有該機器人。",
      "invalid_pay_currency": "不支援該支付貨幣。",
      "already_subscribed": "你已經租用了一個交易機器人。",
      "subscription_required": "請先租用一個交易機器人。",
      "subscription_expired": "你的機器人租期已到期。請續租或提領資金。",
      "insufficient_claudium": "Claudium 不足。",
      "invalid_amount": "請輸入有效的數量。",
      "deposit_out_of_bounds": "該存入金額超出此機器人允許的範圍。",
      "invalid_public_key": "請先連接 Solana 錢包。",
      "invalid_params": "不允許這些機器人設定。",
      "payment_not_found": "找不到該筆付款。請重新開始。",
      "payment_unverified": "該筆付款尚未確認。請稍候再試。",
      "vault_busy": "機器人金庫正忙。請稍候再試。",
      "rate_limited": "請求過於頻繁。請稍候再試。",
      "upstream_error": "交易機器人服務暫時無法使用，請稍後再試。"
    }
  },
  "guide": {
