...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "pokerPlaytest": {
      ...
      "unknownPlayer": "玩家",
      "waiting": "等待下一局",
      "playerTurn": "{name}正在行動",
      "timeRemaining": "剩餘{seconds}秒",
      "wagerAmount": "{action}金額",
      "rake": "抽水: {amount}",
      "error": {
        "busy": "牌桌正在處理。請重試。",
        "disabled": "目前無法使用撲克。",
        "insufficient_funds": "加入或重新買入需要更多銅幣。",
        "invalid_action": "此操作不合法。",
        "participation_suspended": "此帳號的撲克參與權限已被暫停。",
        "invalidAmount": "請輸入允許範圍內的整數。",
        "rebuy_not_allowed": "目前無法補充籌碼。",
        "seat_conflict": "此座位已被占用。",
        "stale_action": "操作到達前牌局已發生變化。",
        "table_not_found": "此撲克牌桌已不存在。",
        "watch_conflict": "觀戰其他牌桌前請先離開目前牌桌。"
      },
      "chips": "{amount}籌碼",
      "pot": "底池: {amount}",
      "noCards": "無牌",
      ...
      "winnerWithHand": "{name}以{hand}贏得{amount}",
      "hand": {
        "highCard": "高牌",
        "pair": "一對",
        "twoPair": "兩對",
