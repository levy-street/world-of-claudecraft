...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "crafting": {
      ...
      "tierTutorial": {
        "title": "你的第一個階級",
        "tierCap": "一項專業在技能 {skill} 時達到第一個階級，每提升一個階級都會改善其產出或製作能力。不過，具體到你的技藝類專業，只有當某門技藝成為你兩門主修之一時，才能製作超越稀有品質的作品。",
        "radar": "你的技藝類專業構成一個環輪。調諧到相鄰的一對，這兩門技藝便成為無上限的主修；環輪對面的一門技藝成為上限為稀有的嗜好；其餘技藝則進入休眠：知識仍會保留，但在你重新拾起之前上限為普通。",
