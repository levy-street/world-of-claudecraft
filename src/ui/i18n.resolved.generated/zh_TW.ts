...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    "privacyConsent": {
      "bannerTitle": "您在 Claudemoon 的隱私",
      "bannerOptIn": "選擇是否允許載入選用服務。必要服務一律保持啟用。",
      "bannerOptOut": "選用服務已啟用。使用「拒絕選用服務」可選擇不出售或分享用於目標式廣告的資料，也可以自行選擇允許載入的內容。",
      "bannerGpc": "我們尊重您瀏覽器發出的全球隱私控制（Global Privacy Control）訊號。分析與行銷功能將保持關閉。",
      "acceptAll": "全部接受",
      "rejectAll": "拒絕選用服務",
      "customize": "自訂",
      "launcher": "隱私選項",
      "dialogTitle": "隱私選項",
      "dialogIntro": "選擇 World of ClaudeCraft 可以使用哪些選用服務。您可以隨時變更這些選擇。",
      "close": "關閉隱私選項",
      "necessaryTitle": "必要服務",
      "necessaryBody": "用於安全、儲存偏好設定、身分驗證和核心遊戲功能。",
      "analyticsTitle": "分析",
      "analyticsBody": "協助我們瞭解網站使用情況並診斷遊戲效能。",
      "marketingTitle": "行銷",
      "marketingBody": "透過 Meta Pixel 等服務衡量行銷活動成效。",
      "xTitle": "X 動態消息",
      "xBody": "允許在新聞頁面載入嵌入的 @WoClaudecraft 時間軸。",
      "twitchTitle": "Twitch 播放器",
      "twitchBody": "允許載入嵌入的 Yuumiii 直播播放器。",
      "alwaysOn": "一律啟用",
      "save": "儲存選擇",
      "cookiePolicy": "閱讀我們的 Cookie 政策",
      "twitchBlocked": "在您透過「隱私選項」允許 Twitch 之前，Twitch 播放器將保持暫停。",
      "twitchEnable": "選擇 Twitch 隱私設定"
    },
    "spectate": {
      "banner": "正在觀察 {name}"
    },
  ...
  "mode": {
    "onlineTitle": "線上遊玩",
    "onlineDesc": "在即時伺服器上遊玩。你的角色將在線上保存。",
    "onlineAria": "線上遊玩：登入持久共享的世界",
    "offlineTitle": "單機試玩",
    "offlineDesc": "在瀏覽器中遊玩本機離線世界。進度不會保存。",
    ...
    "serverLabel": "選擇你的世界",
    "serverAria": "選擇伺服器模式：伺服器線上或伺服器離線",
    "serverOfflineSub": "本機離線世界",
    "caLabel": "$WOC 合約地址",
    "caCopyAria": "複製合約地址",
  ...
  "landing": {
    "heroEyebrow": "世界早已開始運轉",
    "heroHeading": "一個鮮活的經典 MMO，玩家與 AI 冒險者共同面對同一世界。",
    "heroBody": "在瀏覽器中免費遊玩，從九大職業中塑造英雄，或讓代理在真實遊戲中訓練。",
    "heroStatus": "世界在線",
    "heroPlayers": "名已註冊冒險者",
    "communityLinks": "社群連結",
    "followSocials": "關注我們的社群媒體",
    "socialX": "X",
    "socialDiscord": "Discord 社群",
    "socialTwitch": "Twitch 實況",
    "socialInstagram": "Instagram 官方帳號",
    "socialTikTok": "TikTok",
    "socialYouTube": "YouTube",
    "socialReddit": "Reddit 社群",
    "socialGitHub": "GitHub",
    "patchNotesLabel": "更新說明",
    "patchNotesTitle": "更新說明",
    "patchNotesDesc": "查看最新的玩法變更、問題修正和版本詳情。",
    "patchNotesLoading": "正在載入最新更新說明…",
    "patchNotesError": "無法載入更新說明，請稍後再試。",
    "patchNotesEmpty": "目前沒有更新說明，請稍後再回來查看。",
    "patchNotesPrerelease": "預先發佈版",
    "patchNotesViewOnGithub": "在 GitHub 上查看版本",
    "newsEyebrow": "來自世界的消息",
    "newsTitle": "Claudemoon 新聞",
    "newsBody": "關注 World of ClaudeCraft 的最新動態，探索這個世界背後的故事。",
    "newsXTitle": "X 最新動態",
    "newsXIntro": "@WoClaudecraft 的官方貼文",
    "newsXConsentTitle": "X 動態消息需要取得許可",
    "newsXConsentBody": "此即時動態消息需要取得連線至 X 的許可。X 可能會收到與您此次造訪相關的資訊。",
    "newsXConsentNote": "請在「隱私選項」中啟用 X 內容。您可以隨時變更此設定。",
    "newsXPrivacyChoices": "隱私選項",
    "newsXUnavailableTitle": "無法載入 X 動態消息",
    "newsXUnavailableBody": "可能遭到您的瀏覽器或擴充功能封鎖，也可能是 X 暫時發生問題。",
    "newsXHiddenTitle": "此處無法顯示即時動態消息",
    "newsXHiddenBody": "嵌入式 X 動態消息無法在較小的螢幕或應用程式中使用。請在 X 上開啟 @WoClaudecraft 以查看最新貼文。",
    "newsXPrivacy": "載入此動態消息將連線至 X，X 可能會收到與你此次瀏覽相關的資訊。",
    "newsXLoad": "載入 X 動態消息",
    "newsXRetry": "再試一次",
    "newsXHide": "隱藏 X 動態消息",
    "newsXOpen": "在 X 上開啟 @WoClaudecraft",
    "newsXOpenAria": "在新分頁中開啟 X 上的 @WoClaudecraft",
    "newsXNewTab": "在新分頁中開啟",
    "newsXLoading": "正在開啟 X 動態消息…",
    "newsXLoaded": "X 動態消息已載入。",
    "newsXUnavailable": "無法載入 X 動態消息。你仍可直接前往 X 查看所有貼文。",
    "newsXHidden": "X 動態消息已隱藏。你仍可直接在 X 上開啟該帳號頁面。",
    "newsXIframeTitle": "X 上 @WoClaudecraft 的最新貼文",
    "newsBlogEyebrow": "CLAUDEMOON 紀事",
    "newsBlogTitle": "最新故事",
    "newsBlogEmptyTitle": "第一篇故事正在撰寫",
    "newsBlogEmptyBody": "新聞和幕後故事即將發佈在這裡。",
    "newsPressEyebrow": "PRESS SPOTLIGHT",
    "newsPressPrimaryTitle": "首款以 Vibe Coding 打造的 MMORPG：免費、開源，而且完整得令人驚喜",
    "newsPressPrimaryBody": "MMORPG.com 深入介紹了 World of ClaudeCraft 背後的開放世界、共同冒險和快速演進的實驗。",
    "newsPressRead": "閱讀專題報導",
    "newsPressLinkAria": "在新分頁中閱讀 MMORPG.com 的專題報導",
    "newsPressPrimaryAlt": "冒險者在 World of ClaudeCraft 中探索 Eastbrook Vale",
    "browserCta": "在瀏覽器中遊玩",
    "playNowTitle": "Play Now",
    "playNowBody": "開啟瀏覽器即可遊玩，無需下載。",
    "playNowButton": "Play Now",
    "playWayTitle": "Play Your Way",
    "playWayBody": "選擇你的平台，加入這場冒險。",
    "syncProgress": "在所有平台間同步遊戲進度",
    "googlePlayEyebrow": "GET IT ON",
    "appStoreEyebrow": "DOWNLOAD ON THE",
    "steamEyebrow": "AVAILABLE ON",
    "explore": "探索這個世界",
    "platformsEyebrow": "隨時隨地踏上冒險",
    "appStoreAria": "在 App Store 下載 World of ClaudeCraft",
    "googlePlayAria": "在 Google Play 取得 World of ClaudeCraft",
    "steamAria": "World of ClaudeCraft 即將登上 Steam",
    "comingSoon": "即將推出",
    "introEyebrow": "同一個世界，同一套規則",
    "introHeading": "每位冒險者都在真實遊戲中戰鬥。",
    "introBody": "瀏覽器 MMO、權威線上世界和 AI 訓練都運行於同一個確定性模擬中。玩家與代理面對相同的戰鬥、任務、地城和後果。",
    "statClasses": "9 個可玩職業",
    "statModes": "線上與離線世界",
    "statBroadcast": "全天候 AI 直播",
    "statSource": "開放原始碼",
    "worldEyebrow": "穿越 Claudemoon",
    "worldHeading": "一個為漫漫長路與危機四伏的夜晚而生的世界。",
    "worldBody": "從 Eastbrook Vale 的營火旁啟程，深入鬧鬼的地穴，再攀上 Thornpeak 的風暴之巔。每條道路都通往這個不斷運轉的世界深處。",
    "eastbrookTitle": "東溪谷",
    "eastbrookBody": "一片共享的邊境，初次任務、遊蕩敵人與意外盟友都在此相遇。",
    "eastbrookAlt": "冒險者隊伍沿著從東溪谷通往荊棘峰高地的漫長道路前行",
    "hollowTitle": "Hollow Crypt",
    "hollowBody": "在冰冷的藍色火炬下並肩作戰，不安的亡者正成群聚集。",
    "hollowAlt": "一支隊伍在 Hollow Crypt 中迎戰敵人",
    "thornpeakTitle": "荊棘峰高地",
    "thornpeakBody": "雲層之上，白雪、古老廢墟與終局威脅正在等待。",
    "thornpeakAlt": "雪花飄落在 Thornpeak Heights",
    "classesEyebrow": "選擇你的傳奇",
    "classesHeading": "九種道路，無數戰鬥方式。",
    "classesBody": "堅守盾牆，駕馭烈焰與寒霜，潛行於陰影，或守護隊友。塑造英雄，精通專精，並把這段故事帶入共享世界。",
    "streamEyebrow": "全天候直播",
    "streamNetwork": "WOC 直播網路",
    "streamFeed": "YUUMIII // 直播畫面",
    "streamMonogram": "Y",
    "streamHeading": "Yuumiii 永不下線。",
    "streamBody": "World of ClaudeCraft 的常駐 AI 實況主全天候直播遊玩這個世界。",
    "streamWatch": "在 Twitch 觀看",
    "streamWatchSub": "加入 Yuumiii 的直播",
    "streamExplore": "探索世界",
    "streamExploreSub": "探索克勞德之月",
    "streamHeroSubtitle": "你的常駐 AI 主播，全天候探索這個世界。",
    "streamMeet": "認識你的嚮導",
    "streamHostTitle": "常駐 AI 主播",
    "streamHostBody": "與 Yuumiii 一起日夜探索 World of ClaudeCraft 的每一個角落。",
    "streamPortraitAlt": "World of ClaudeCraft 的常駐 AI 主播 Yuumiii",
    "streamAlwaysTitle": "24/7 直播",
    "streamAlwaysBody": "始終在線，永不停下冒險。",
    "streamAiTitle": "AI 主播",
    "streamAiBody": "由 AI 驅動，帶來真實反應和無盡樂趣。",
    "streamCommunityTitle": "社群",
    "streamCommunityBody": "聊天、任務與驚喜都在等著你。",
    "streamWorldTitle": "真實世界",
    "streamWorldBody": "一個持續運轉的世界，無盡故事。",
    "streamLoading": "正在開啟觀景傳送門...",
    "streamReady": "觀景傳送門已就緒。按下播放即可觀看 Yuumiii。",
    "streamOnline": "Yuumiii 正在直播。",
    "streamOffline": "觀景傳送門正在重新連線。開啟 Twitch 頻道即可繼續觀看。",
    "streamCompact": "開啟 Twitch 頻道，在此螢幕上觀看 Yuumiii。",
    "streamUnavailable": "觀景傳送門暫時無法使用。開啟 Twitch 頻道即可繼續觀看。",
    "communityEyebrow": "GATHER AT THE FORGE",
    "communityHeading": "Claudemoon 由大家共同打造。",
    "communityBody": "無論帶來的是技藝、好奇心，還是只是陪伴，公會的桌邊總有你的位置。",
    "openEyebrow": "開放世界，開放程式碼",
    "openHeading": "複製這個世界，訓練一名冒險者。",
    "openBody": "探索原始碼，託管自己的世界，或將相容 Gymnasium 的代理接入玩家每天進入的同一個確定性遊戲。",
    "supportEyebrow": "讓這個世界繼續運轉",
    "supportHeading": "創造、遊玩，並支持下一篇章。",
    "supportBody": "World of ClaudeCraft 在開放協作中成長。加入社群，關注鮮活世界，或支持持續開發。",
    "xCta": "在 X 上關注",
    "twitchCategoryCta": "探索 World of ClaudeCraft 實況",
    "finalEyebrow": "你的故事始於大門",
    "finalHeading": "選擇你進入 Claudemoon 的方式。",
    "finalBody": "立即在瀏覽器中遊玩，在行動裝置上繼續冒險，或等待 Steam 版本。"
  },
  "a11y": {
    "goHome": "前往首頁",
    "toggleMenu": "切換選單",
