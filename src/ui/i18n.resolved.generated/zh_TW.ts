...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "merch": {
      "title": "周邊商店",
      "subtitle": "官方《World of ClaudeCraft》周邊商品，全球配送。",
      "loading": "正在載入商店…",
      "unavailable": "周邊商店暫時無法使用。您的訂單和付款不會受到影響，請稍後再試。",
      "disclosure": "周邊商品由我們的印刷合作夥伴按需製作並出貨。用於購買周邊的 Claudium 無法退還為 Claudium；銀行卡與 Solana 付款依服務條款中的退款政策辦理。",
      "catalogTitle": "商品目錄",
      "catalogEmpty": "目前沒有可用的周邊商品。",
      "variantLabel": "款式與尺寸",
      "addToCart": "加入購物車",
      "outOfStock": "缺貨",
      "cartTitle": "購物車",
      ...
      "totalLabel": "總計",
      "totalNote": "運費與稅金將於結帳時加入；最終金額以伺服器確認為準。",
      "claudiumPrice": "{amount} Claudium",
      "checkoutTitle": "結帳",
      "loginRequired": "請登入帳號後再結帳。",
      "shipping": {
        "name": "姓名",
        "address1": "地址",
        "address2": "地址第二行（選填）",
      ...
      "shippingIncomplete": "請填寫所有必填的收件資訊。",
      "railLabel": "付款方式",
      "railStripe": "銀行卡",
      "railSol": "SOL",
      "railClaudium": "Claudium",
      "payNow": "送出訂單",
      "checkoutPending": "訂單處理中。請完成付款，並保持此頁面開啟。",
      "checkoutFailed": "無法開始結帳，請重試。",
      "checkoutUnavailable": "該訂單暫時無法使用。",
      "checkoutNotSettled": "交易已送出，但訂單尚未確認。請稍後查看您的訂單。",
      "orderPlaced": "訂單 {orderId} 已送出。可在下方的訂單中追蹤。",
      "paymentPending": "訂單 {orderId} 正在等待信用卡付款。付款完成後將顯示在您的訂單中。",
      "ordersTitle": "我的訂單",
