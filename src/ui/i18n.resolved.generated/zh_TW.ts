...
export const zh_TW: EnTranslations = {
    ...
    "profPages": {
      ...
      "craftProse": {
        "weaponcrafting": {
          ...
          "routeBody": "有屬性的成品（鐵檔及以上）才可能出傑作；無屬性的銅檔普通件永遠不會觸發。鐵算一級材料（加成1%），高松與銘鋼算二級（2%）。路線：銅檔到25，鐵檔到50，鋨檔到75。鋨檔三件之上還有一個Darva不教的頂級檔位：它的配方靠拾取，握有配方的鐵匠可以一路滿速練到上限。配方到手之前，剩下的路由鋨檔承擔，衰減為半速再到四分之一，到125上限約需再做150次，注意每分鐘十次的共享節流。Darva的工作訂單每30分鐘收八塊銅礦。功業之書在技能50記下Edge and Temper，125加冕Grandmaster Weaponcrafting。"
        },
        "armorcrafting": {
        ...
        "cooking": {
          ...
          "routeBody": "烹飪是傑作故事裡誠實的例外：菜餚沒有屬性可提升，永不觸發，也不必追。這門手藝的精通在於75的專精：每樣食材省五分之一（批量菜上疊加極快），外加移動野外廚房，讓宴席在副本門口出鍋。邊釣邊做，兩門技能互相供養：免費檔到25，中檔到50，精良檔到75。精良檔之上還有頂級廚房：三道分職佳餚與The Laden Hearth，沒有導師傳授，只能從拾得的配方學會，握有配方的廚師可以一路滿速練到上限。配方到手之前，最後一段由精良菜承擔，衰減為半速與四分之一，約再做150次。Marlow的訂單每30分鐘收八塊野味肉。技能50記下Seasoned Chef，125是Grandmaster Cooking頭銜。"
        },
        "alchemy": {
  ...
  "itemUi": {
    ...
    "tooltip": {
      ...
      "flaskOutranks": "更弱的藥劑或卷軸無法取代它。",
      "flaskThroughDeath": "該效果在死亡後依然保留，但在登出後消失。",
