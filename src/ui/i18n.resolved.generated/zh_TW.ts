  ...
  "entities": {
    ...
    "npcs": {
      ...
      "runeseeker_maerin": {
        "name": "尋符者梅林",
        "title": "流浪考古學家",
        "greeting": "他們告訴我這是一個死去邪教的鍛爐，{className}。死物不會燒得這麼熱。下面一定有什麼值得吞下這些煙塵。"
      },
      "captain_thessaly": {
        "name": "瑟薩莉隊長",
        "title": "高望隊長",
    ...
    "dungeons": {
      ...
      "undermount_wing1": {
        "name": "地底山: 下行",
        "enterText": "你下到荊峰之下，進入玻璃般的黑暗。",
        "leaveText": "你從地底山的下行路爬回。"
      },
      "undermount_wing2": {
        "name": "地底山: 淬火",
        "enterText": "蒸汽從前方被水淹沒的鍛爐中捲起。",
        "leaveText": "你把淬火大廳拋在身後。"
      },
      "undermount_wing3": {
        "name": "地底山: 回火",
        "enterText": "錘擊聲在回火寶庫中迴盪。",
        "leaveText": "你從鳴響的爐道撤退。"
      },
      "undermount_wing4": {
        "name": "地底山: 甦醒",
        "enterText": "被埋的熔爐在深處躁動。",
        "leaveText": "你從甦醒的熱浪中撤離。"
      },
      "drowned_temple": {
        "name": "溺亡神殿",
