...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nftSkins": {
      "title": "Wear an NFT",
      "intro": "證明你擁有 PFP NFT 即可穿戴：其特徵塑造你的角色外觀，原作則成為你的頭像。持有該 NFT 期間一直有效。",
      "connectEthereum": "連接 Ethereum 錢包",
      "connectSolana": "連接 Solana 錢包",
      "ethereumLinked": "Ethereum 錢包: {address}",
      "solanaLinked": "Solana 錢包: {address}",
      "notLinked": "未綁定",
      "collectionsTitle": "支援的收藏集",
      "noCollections": "暫無可用的收藏集，請稍後再來查看。",
      "tokenIdPlaceholder": "代幣 ID",
      "mintPlaceholder": "鑄造地址",
      "claim": "領取",
      "claiming": "領取中...",
      "claimed": "已領取並裝備。可隨時在皮膚瀏覽器中查看。",
      "needWallet": "請先綁定對應的錢包。",
      "close": "關閉",
      "errorNotOwner": "該錢包不擁有此代幣。",
      "errorUnverified": "暫時無法驗證所有權，請稍後重試。",
      "errorCollection": "不支援該收藏集。",
      "errorTooMany": "已達到 NFT 皮膚上限。",
      "errorMetadata": "暫時無法讀取此 NFT，請稍後重試。",
      "errorGeneric": "無法領取此 NFT 皮膚。",
      "walletError": "錢包連接失敗。"
    },
    "mobTooltip": {
  ...
  "marketplace": {
    "title": "創作者外觀",
    "subtitle": "玩家製作的外觀，使用 USDC 購買。70% 歸創作者；30% 用於買入並銷毀 $WOC。",
    "loading": "正在載入外觀…",
    "empty": "目前沒有在售的創作者外觀。",
    "buy": "Buy",
    "price": "{price}",
    "connectFirst": "請先連接錢包以購買。",
    "purchasing": "購買中…",
    "owned": "已擁有 — 已裝備",
    "failed": "購買失敗",
    "close": "關閉",
    ...
    "modeUpload": "上傳",
    "modeLink": "自行託管",
    "uploadIntro": "上傳你自己的 1024x1024 PNG 圖集。我們會將其固定到 IPFS 並為你託管。",
    "linkIntro": "連結你自行託管的 PNG 圖集。我們會代理存取,買家永遠不會看到你的網址。免費。",
    "uploadFile": "Skin PNG (1024x1024)",
    "linkUrl": "圖集網址",
    "quotaMeter": "已託管 {used}/{quota} 個欄位",
    "trustedBadge": "可信賴創作者(即時上架)",
    "selfHostedFreeNote": "自行託管免費且不限數量(在上架數量上限內)。",
    "hostingUnavailable": "託管上傳暫時無法使用。",
    "listedReview": "已送交審核,待營運人員核准後即會上架。",
    "baseColor": "底色",
    "patternColor": "圖案顏色",
    "accentColor": "點綴色",
    "pattern": "圖案",
    ...
    "randomize": "隨機",
    "nameLabel": "Name",
    "namePlaceholder": "例如:翡翠龍鱗",
    "descLabel": "描述",
    "descPlaceholder": "買家將看到的簡短描述",
    "priceLabel": "價格(USDC)",
    "preview": "即時預覽",
    "list": "上架出售",
    "listing": "上架中…",
    "listed": "已上架,現已生效。可從你擁有的造型中裝備它。",
    "listFailed": "無法上架",
    "listConnectFirst": "連接錢包後即可上架(你在此獲得 70% 收益)。",
    "payoutHint": "你獲得 70% • 30% 用於回購並銷毀 $WOC",
    "patterns": {
      "solid": "純色",
      "scales": "鱗片",
      "stripes": "條紋",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "skin_artisan": {
        "name": "造型工匠皮普",
        "title": "創作者造型看板",
        "greeting": "想換個新造型嗎,{className}?來逛逛玩家打造的外觀造型,或自己設計一款出售。以 USDC 結算;其中一部分用於回購並銷毀 $WOC。"
      },
      "marshal_redbrook": {
        "name": "雷德布魯克元帥",
        "title": "城鎮元帥",
