...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "amountWithUsd": "{amount} 克勞迪姆（{usd}）",
      "usdAmount": "${usd}",
      "unavailable": "克勞迪姆商店目前無法使用。您的餘額和購買不受影響，請稍後再試。",
      "disclosure": "克勞迪姆是一種單向軟通貨：用錢購買，用於外觀裝飾。不可贖回、轉讓或兌現。",
      "buyTitle": "購買克勞迪姆",
      "railLabel": "付款方式",
      "railStripe": "信用卡",
      "railWoc": "WOC",
      "railWocUnavailable": "WOC 價格目前無法使用。",
      "amountLabel": "金額",
      "skuRow": "{usd} 兌換 {claudium} 克勞迪姆",
      "buyButton": "購買",
      "buyUnavailable": "購買目前無法使用。",
      "storeTitle": "外觀商店",
      "storeEmpty": "目前沒有可用的外觀裝飾。",
      ...
      "railSol": "SOL",
      "railUsdc": "USDC",
      "railDisabled": "此付款方式目前無法使用。",
      "oracleUnavailable": "即時價格目前無法使用。請稍後再試。",
      "quoteButton": "取得報價",
      "amountRow": "{usd} 兌換 {claudium} 克勞迪姆",
      "sendExactly": "精確傳送 {amount} {rail}",
      "addressLabel": "傳送至",
      "memoLabel": "備註 (必填)",
      "splitLabel": "拆分",
      "splitBurn": "銷毀 {amount} {rail}",
      "splitTreasury": "{amount} {rail} 進入金庫",
      "splitSummary": "銷毀 {burn} {rail}，{treasury} {rail} 轉入金庫",
      "reviewLabel": "確認",
      "reviewLine": "您支付 {pay} {rail}，獲得 {claudium} 克勞迪姆（{usd}）。",
      "reviewLineCard": "您支付 {usd}，獲得 {claudium} 克勞迪姆。",
      "discountLabel": "折扣",
      "discountSummary": "按有效錨定價格立減 {percent}%",
      "discountBonus": "{base} 增至 {credited} 克勞迪姆 (+{bonus})",
      "wocIncentive": "使用 $WOC 付款 - 始終至少 15% 折扣",
      "wocPromoNote": "含限時促銷",
      "expiresIn": "報價將在 {time} 後過期",
      "quoteExpired": "此報價已過期。請重新取得。",
      "copyAddress": "複製地址",
      "copied": "已複製",
      "payNote": "從你自己的錢包傳送帶備註的精確金額，然後貼上交易簽章以確認。服務會在鏈上驗證後才入帳。",
      "signatureLabel": "交易簽章",
      "signaturePlaceholder": "貼上簽章",
      "confirmButton": "確認付款",
      "confirmCredited": "已入帳 {amount} 克勞迪姆。",
      "confirmFailed": "暫時無法確認此筆付款。請稍後再試。",
      "confirmPending": "正在等待鏈上確認，這可能需要一點時間。",
      "confirmNotFinalized": "您的付款尚未在鏈上確認。這是正常現象，請稍等片刻後再次確認。",
      "confirmRequote": "價格已變動。請重新取得報價後再試。",
      "retryButton": "重試",
      "requoteButton": "重新取得報價",
      "insufficientBalance": "克勞迪姆不足",
      "topUpButton": "Top up",
      "redeemTitle": "兌換禮品卡",
      "enterCode": "輸入你的禮品卡代碼",
      "codePlaceholder": "XXXXX-XXXXX-XXXXX-XXXXX-XXXXX",
      "redeemButton": "兌換",
      "redeemed": "已兌換 {amount} 克勞迪姆。新餘額：{balance}。",
      "redeemFailed": "無法兌換此代碼。請檢查代碼後重試。",
      "back": "返回",
      "historyExplorer": "在 Solana Explorer 上檢視",
      "historyReceipt": "信用卡購買",
      "historyGiftNote": "禮品卡",
      "timeJustNow": "剛剛",
      "timeMinutes": "{n}m ago",
      "timeHours": "{n}h ago",
      ...
      "tabHistory": "歷史記錄",
      "giftTitle": "贈送禮品卡",
      "giftDenominationLabel": "面額",
      "giftRecipientLabel": "收件人",
      "giftToSelf": "給我自己",
      "giftToOther": "給其他人",
      "giftEmailLabel": "收件人電子郵件",
      "giftEmailPlaceholder": "name@example.com",
      "giftEmailInvalid": "請輸入有效的電子郵件地址。",
      "giftOccasionLabel": "場合",
      "giftMessageLabel": "個人留言",
      "giftMessagePlaceholder": "新增簡短留言 (選填)",
      "giftDeliveryLabel": "送達方式",
      "giftScheduleLabel": "安排送達時間 (選填)",
      "giftReviewButton": "核對禮品",
      "giftReviewSelf": "這張禮品卡將由你自己兌換。",
      "giftReviewEmail": "我們會將這張禮品卡寄送至 {email}。",
      "giftReviewShared": "你將取得一個連結來分享這張禮品卡。",
      "giftReviewScheduled": "將於你選擇的日期送達。",
      "giftConfirmButton": "確認並付款",
      "giftAnotherButton": "再贈送一張",
      "giftPending": "正在開立你的禮品卡。這可能需要一點時間。",
      "giftIssued": "你的禮品卡已可分享。",
      "giftFailed": "無法開立該禮品卡。請稍後再試。",
      "giftDeclined": "付款遭拒。未開立禮品卡。",
      "giftLinkLabel": "禮品卡連結",
      "giftQrAlt": "禮品卡兌換連結的 QR code",
      "giftTerms": "禮品卡僅可兌換克勞迪姆。不可兌換現金，且不可退款。",
      "deliveryEmail": "電子郵件",
      "deliveryLink": "分享連結",
      "deliveryReveal": "立即顯示",
      "occasionBirthday": "生日",
      ...
      "occasionCongrats": "祝賀",
      "occasionThankyou": "感謝",
      "occasionGeneric": "隨心贈送",
      "reasonPurchaseStripe": "購買 (信用卡)",
      "reasonPurchaseSol": "購買 (SOL)",
      "reasonPurchaseUsdc": "購買 (USDC)",
      "reasonPurchaseWoc": "購買 (WOC)",
      "reasonGiftcardRedeem": "禮品卡已兌換",
      "reasonSpend": "購買裝飾",
      "reasonRefund": "退款",
      "reasonChargeback": "拒付",
      "reasonGiftcardVoid": "禮品卡已作廢",
      "historyTitle": "交易記錄",
      "historyLoading": "正在載入你的記錄...",
      "historyError": "無法載入你的記錄。請重試。",
      "historyEmpty": "你還沒有任何克勞迪姆交易。",
      "historyLoadMore": "載入更多",
      "historyFilterLabel": "依類型篩選",
      "historyFilterAll": "所有類型",
      "historyCredit": "+{amount}",
      "historyDebit": "-{amount}",
      "tabSupply": "供應量",
      "supplyTitle": "現存克勞迪姆",
      "supplyLoading": "正在載入供應量...",
      "supplyError": "無法載入供應量資料。請重試。",
      "supplyUnavailable": "暫時無法取得供應量資料。",
      "supplyInExistence": "現存 {amount}",
      "supplyUsdValue": "價值 {amount}",
      "supplyIssued": "累計發行總量",
      "supplySunk": "累計消耗或撤銷",
      "supplyHolders": "由 {n} 個帳戶持有",
      "supplyChangeUp": "本期增加 {amount}",
      "supplyChangeDown": "本期減少 {amount}",
      "supplyChangeFlat": "本期無變化",
      "supplyChartLabel": "所選期間的克勞迪姆供應量",
      "supplyChartEmpty": "本期沒有供應量變動。",
      "supplyRangeLabel": "圖表週期",
      "supplyRange24h": "24h",
      "supplyRange7d": "7d",
      "supplyRange30d": "30d",
      "supplyFootnote": "統計所有帳戶持有的全部克勞迪姆，即時彙總自帳本。",
      "inspectButton": "詳情",
      "inspectBack": "返回商店",
      "inspectArtAlt": "{name} 的預覽",
      "tryOnButton": "Try on",
      "tryOnStopButton": "停止試穿",
      "tryOnActiveNote": "正在你的角色上預覽。這不會授予該物品。"
    },
    "theme": {
      "preset": "介面主題",
      "customColors": "自訂顏色",
