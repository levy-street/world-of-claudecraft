...
export const zh_TW: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "選擇 WOC Wallet、WOC Wallet、Phantom 或 Solflare。錢包應用程式會要求核准。請保持遊戲開啟，完成後返回遊戲。",
    "standaloneAppHelp": "主畫面應用程式目前尚不支援連接錢包。若要使用 WOC Wallet、WOC Wallet、Phantom 或 Solflare，請在 Safari 或 Chrome 中開啟 World of ClaudeCraft。",
