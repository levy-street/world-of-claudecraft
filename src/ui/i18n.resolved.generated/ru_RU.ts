...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "materialHint": {
      ...
      "growthTonic": "Принадлежность для фермерства. Используется при посадке и дает шанс собрать больший урожай."
    },
    "discord": {
      "title": "Discord",
