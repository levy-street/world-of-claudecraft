...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "governance": {
      "title": "Управление",
      "close": "Закрыть управление",
      "subtitle": "Консультативное голосование держателей $WOC",
      ...
      "open": "Открыто",
      "closed": "Закрыто",
      "closesAt": "Закрывается {date}",
      "closedAt": "Закрыто {date}",
      "quorum": "Кворум: {current} из {needed} $WOC",
      ...
      "tally": {
        ...
        "against": "Против",
        "abstain": "Воздержался",
        "voters": "Голосовавших: {count}"
      },
      "vote": {
        "for": "Голосовать за",
        "against": "Голосовать против",
        "abstain": "Воздержаться",
        "needWallet": "Привяжите кошелёк, чтобы голосовать.",
        "alreadyVoted": "Вы проголосовали: {choice}",
        "signing": "Подпишите в кошельке…",
        "submitting": "Отправка голоса…",
        "success": "Ваш голос записан.",
        "failed": "Не удалось записать ваш голос."
      }
    }
  },
  "apiError": {
    ...
    "governance": {
      "disabled": "Голосование по управлению сейчас недоступно.",
      "forbidden": "У вас нет прав на создание предложения.",
      "not_found": "Это предложение не найдено.",
      "invalid_input": "Проверьте поля предложения и повторите попытку.",
      "wallet_not_linked": "Привяжите кошелёк, прежде чем голосовать.",
      "wallet_mismatch": "Этот кошелёк не привязан к вашей учётной записи.",
      "window_closed": "Голосование по этому предложению закрыто.",
      "already_voted": "Этот кошелёк уже голосовал по этому предложению.",
      "challenge_invalid": "Срок запроса на голосование истёк. Повторите попытку.",
      "bad_signature": "Не удалось проверить подпись кошелька.",
      "balance_unavailable": "Не удалось прочитать ваш баланс $WOC. Повторите попытку."
    }
  },
  "guide": {
