...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "auraEffect": {
      ...
      "stormcharge": "Призыватель бури {stacks}/{max}: каждый заряд сокращает время применения Дуговой стрелы на {castPct}% и повышает её урон на {damagePct}%",
      "aethericFlux": "Тайная нестабильность {stacks}/{max}: каждый заряд сокращает время восстановления Мощи тайной магии на {cooldown} сек.; Мощь тайной магии поглощает все заряды и восстанавливает {manaPct}% максимального запаса маны за каждый",
      "nextAbilityDamage": "Урон следующей подходящей способности повышен на {pct}%",
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "blink": "Телепортирует вперед и снимает обездвиживание, давая каждому магу надежный способ отступить.",
  ...
  "entities": {
    "abilities": {
      ...
      "fireball": {
        ...
        "description": "Бросает огненный шар, наносящий {damage} ед. урона от огня и еще {overTime} ед. периодического урона от огня."
      },
      "frost_armor": {
        "name": "Мантия инея",
      ...
      "icefall": {
        "name": "Ледопад",
        "description": "Выпускает в цель все накопленные сосульки. Каждая наносит {damage} ед. урона от магии льда. Если цель обездвижена или оглушена либо действует «Обморожение», урон увеличивается в 2,5 раза, а «Обморожение» расходуется. Этот фиксированный урон не может быть критическим. (Криомантия)"
      },
      "conjure_water": {
      ...
      "pyroblast": {
        "name": "Огненное копьё",
        "description": "Обрушивает на врага громадный пылающий камень, наносящий {damage} ед. урона от огня и еще {overTime} ед. урона от огня за 12 сек."
      },
      "ice_barrier": {
      ...
      "mind_flay": {
        "name": "Литания скорби",
        "description": "Терзает разум цели темной энергией в течение 3 сек. С каждым тиком урон увеличивается на 30% от урона первого тика."
      },
      "flash_heal": {
      ...
      "wyvern_sting": {
        "name": "Терновая ловушка",
        "description": "Устанавливает в выбранной области терновую ловушку, обездвиживая врагов в радиусе 5 м на 4 сек. (знаковое умение Полевого ремесла)"
      },
      "arcane_power": {
      ...
      "hemorrhage": {
        "name": "Падение маски",
        "description": "Бьет врага оружием, нанося урон оружием плюс {damage}. Дает 1 прием. (знаковое умение Тайных приемов)"
      },
      "power_infusion": {
        "name": "Придание сил",
