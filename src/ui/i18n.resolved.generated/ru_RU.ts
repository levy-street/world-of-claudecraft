...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "earth_shield": {
        "name": "Каменный заслон",
        "description": "Снижает урон от следующих 6 прямых атак на 20%. Время действия 20 сек. (талант шамана)"
      },
      "elemental_demand": {
        "name": "Зов стихий",
        "description": "Приказывает стихиям захватить цель и заставить ее атаковать вас в течение 3 сек. (Дух войны)"
      },
      "evocation": {
      ...
      "healing_stream": {
        "name": "Источник",
        "description": "Восстанавливает союзной цели 180 ед. здоровья за 12 сек. (талант шамана)"
      },
      "holy_wrath": {
        "name": "Гнев святого",
      ...
      "unleash_weapon": {
        ...
        "description": "Высвобождает чары оружия, нанося {damage} ед. урона и создавая зависящий от чар эффект: Каменная связь дает угрозу, Огненное клеймо поджигает, а Ледяная связь замедляет. (талант шамана)"
      },
      "innervate": {
        "name": "Живой сок",
