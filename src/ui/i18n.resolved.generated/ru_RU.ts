...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "auraEffect": {
      ...
      "victoryRush": "«Порыв победителя» готов",
  ...
  "guide": {
    ...
    "home": {
      ...
      "world": {
        ...
        "hauntBlurb": "Лес с призраками под исполинскими кронами, где фонари Гиббетмира — единственный честный свет на дороге.",
    ...
    "worldPage": {
      ...
      "duskBlurb": "Долина вечных сумерек под великим древом Элдершайна, где светятся хрустальные руины, а воздух гудит от древней магии.",
      ...
      "hauntBlurb": "Населённый призраками лес под исполинскими кронами, где фонари Гиббетмира, единственный честный свет на дороге.",
      ...
      "duskGreeter": "Хранительница Сэльвин, Элдершайн",
      ...
      "hauntGreeter": "Фонарщик, Гиббетмир",
      ...
      "duskPlaceNotes": "Элдершайн собрался под великим древом. Сумеречная пещера и её смотровая площадка служат входом и первым видом на долину; Древняя роща и Котловина Звездопада хранят тихий юг; Затонувший двор скрывает заросшие руины на востоке; а Мерцающая глубь и Хрустальные отмели светятся на севере.",
      ...
      "nightPlaceNotes": "Лунный Приют несёт дозор. Ночные Врата, это путь в полуночный край; Лунный Родник хранит звёздный свет, рядом с которым можно постоять; Сумеречное Поле цветёт в темноте; Стоячий Дозор наблюдает, не шевелясь; а Курган Неспящего, единственное место здесь, которому не снятся сны.",
      "hauntPlaceNotes": "Гиббетмир жмётся к своим фонарям. Вороньи Врата, это мрачная парадная дверь леса; Вдовья Чаща густо оплетена паутиной; Висельная Поляна и Часовня Скорбного Камня хранят самые старые скорби этого леса; а Поляна Ловчего принадлежит тому, что до сих пор там охотится.",
  ...
  "delveUi": {
    ...
    "boss": {
      "varric": {
        "bell": {
          "emote": "Дьякон Вандрик хватает погребённый колокол обеими руками!",
          "log": "Дьякон Вандрик начинает звонить в погребальный колокол.",
          "warning": "Отойдите от Дьякона Вандрика!",
        ...
        "raise": {
          "emote": "Дьякон Вандрик призывает имена из разрытых могил!",
          "log": "Дьякон Вандрик начинает Поднятие мёртвых.",
          ...
          "interrupt_fail": "Мёртвые отзываются на зов Дьякона Вандрика!",
        ...
        "mid60": "Дьякон Вандрик читает имена из книги с дрожащим торжеством.",
  ...
  "entities": {
    "abilities": {
      ...
      "cold_snap": {
        "name": "Зов зимы",
        "description": "Мгновенно завершает восстановление «Порхающего шага», «Морозной завесы» и «Великой невидимости». (талант мага)"
      },
      ...
      "blizzard": {
        "name": "Снежная буря",
        "description": "Обрушивает на выбранную область ледяную бурю на 6 сек., ежесекундно нанося {damage} ед. урона от магии льда и замедляя врагов на 40%. Каждый поражённый враг сокращает восстановление «Морозного шара» на 0,5 сек., но не более чем на 3 сек. за одно применение. (ветка «Лёд»)"
      },
      "glacial_spike": {
        "name": "Инеевая игла",
      ...
      "summon_voidwalker": {
        "name": "Призыв Сумрачной мглы",
        "description": "Призывает Мрачную тень под командование чернокнижника. Сумрачная мгла, крепкий демон, который провоцирует ваших врагов и принимает удары на себя. Призыв нового демона отпускает текущего. Одновременно у вас может быть только один демон."
      },
      "summon_succubus": {
      ...
      "preparation": {
        "name": "Запасной план",
        "description": "Завершает восстановление «Спринта», «Уклонения» и «Ухода в дым». (талант разбойника)"
      },
      "presence_of_mind": {
        "name": "Быстрый разум",
    ...
    "items": {
      ...
      "wyrmcult_grand_robe": {
        "name": "Великая роба Клятвы Выводка"
      },
      "wyrmscale_jerkin": {
      ...
      "wyrmcult_spellgrips": {
        "name": "Перчатки заклинаний Клятвы Выводка"
      },
      "thornpeak_wildwraps": {
      ...
      "cryptbloom_shoulderguards": {
        "name": "Наплечники могильного лепестка"
      },
      "gravewyrm_thornmaul": {
    ...
    "mobs": {
      ...
      "wyrmcult_zealot": {
        "name": "Фанатик Клятвы Выводка"
      },
      "wyrmcult_necromancer": {
        "name": "Некромант Клятвы Выводка"
      },
      "boneclad_revenant": {
      ...
      "nightkin_stargazer": {
        "name": "Сумеречнорождённый звездочёт"
      },
      "barrow_king": {
    ...
    "quests": {
      ...
      "q_drogmar": {
        ...
        "text": "Дрогмар взял монету Клятвы Выводка и присягнул кланы пробуждению горы. И когда он бьет по земле, {playerName}, не стойте рядом. Войдите в лагерь и убейте его ради Хайвотча.",
      ...
      "q_zealots": {
        ...
        "objectives": {
          "0": {
            "label": "Фанатик Клятвы Выводка: убито"
          }
        }
      },
      "q_cult_orders": {
      ...
      "q_voice_below": {
        ...
        "objectives": {
          ...
          "1": {
            "label": "Некромант Клятвы Выводка: убито"
          }
        }
      },
      "q_sanctum_gate": {
      ...
      "q_hollow_old_marrowshell": {
        ...
        "text": "Первое имя — Старый Костнопанцирь, краб размером с повозку, что охотится в восточных отмелях с тех пор, когда у Элдершайна ещё не было ворот. Он бродит, {playerName}, так что придётся идти вдоль берега, пока не пересечёшь его след. Не ходи в одиночку и не верь его неподвижности.",
      ...
      "q_fv_frostmane_tyrant": {
        "title": "Тиран Инеистая Грива",
        "text": "Ревуны не охотились, когда спускались по террасам. Они бежали. Высоты забрал себе йети — горный люд зовёт его Инеистой Гривой, — и даже стаи не делят с ним склона. С этим надо покончить, {playerName}, пока зима не согнала его к моим стенам. Возьми друга. А лучше двух.",
        "completion": "Когда этой ночью стих ветер, вся деревня услышала тишину там, где раньше была Инеистая Грива. Предел в долгу перед тобой, и платить его будут годами, {playerName}. Носи это — и каждая дверь в Ледяной Мантии открыта для тебя.",
        "objectives": {
          "0": {
            "label": "Инеистая Грива убита"
          }
        }
      },
      ...
      "q_nb_eyes_on_the_vigil": {
        ...
        "text": "Что-то сделало бегунов дерзкими, а стада — беспокойными, {playerName}, и по цветам мне этого не прочесть. Кассиан прочтёт по небу. Его обсерваторный лагерь стоит у Стоячего Дозора к востоку отсюда, там, где среди камней бродят сумеречнорождённые. Найди его и спроси, что говорят звёзды.",
      ...
      "q_nb_charts_of_the_stones": {
        ...
        "text": "Камни Дозора старше Лунного Приюта, старше сумеречнорождённых, что за ними ухаживают, и на их гранях высечены звёздные карты, которые я учился читать всю жизнь. Небо сдвинулось, {playerName}, и я должен знать, насколько. Прочти карты на трёх камнях и принеси мне их пеленги.",
      ...
      "q_nb_the_barrow_king": {
        ...
        "completion": "Звёзды улеглись впервые за сезон, {playerName}. Могильники закрыты, сумеречнорождённые замерли у своих камней, и король снова спит внизу. Носи эту мантию: Лунный Приют скроил её для того, кому ночь наконец доверилась.",
        "objectives": {
          "0": {
      ...
      "q_ww_bells_of_gallowmere": {
        "title": "Колокола Гиббетмира",
        "text": "Слышишь звон, {playerName}? Это Гиббетмир, вверх по северной дороге, убаюкивает своих мёртвых. Пономарь Марроу ведёт счёт каждой душе под этими кронами — и живой, и погребённой. Иди и будь сосчитан, пока лес не сосчитал тебя сам.",
        "completion": "Кобб отправил тебя по дороге целым, вот как? Хороший человек. Тридцать лет он держит те привратные фонари зажжёнными, и лес ни разу его не обошёл. Добро пожаловать в Гиббетмир, {playerName}. Слушайся колоколов.",
        "objectives": {
          "0": {
      ...
      "q_ww_candles_at_the_bounds": {
        ...
        "text": "Гиббетмир окружают четыре пограничных камня, {playerName}, по одному на каждой дороге из города, и на каждом камне горит могильная свеча. Пока они горят, погребённые остаются погребёнными. Морось затопила их — все четыре, а я слишком стара, чтобы обходить рубежи одна. Возьми мою лучину и зажги их снова, скорее.",
      ...
      "q_ww_what_the_bark_holds": {
        ...
        "text": "На Висельной Поляне к востоку от Гиббетмира шелкопряды развешивают по ветвям своих спелёнутых шёлком мертвецов, а гробокорые шатуны стоят на страже внизу, как терпеливые носильщики гроба. Там, наверху, наши люди, {playerName}. Свали пятерых шатунов, срежь троих спелёнутых мёртвых и верни их домой, в землю.",
      ...
      "q_ww_walking_mosley_home": {
        ...
        "completion": "Он вошёл в ворота на своих двоих, божась, что отныне не выкопает ничего глубже грядки под репу. К воскресенью вернётся на двор — они всегда возвращаются. Спасибо, {playerName}. Гиббетмир бережёт своих — вот и весь наш закон.",
        "objectives": {
          "0": {
            "label": "Могильщик Мозли благополучно доведён до Гиббетмира"
          }
        }
      },
      "q_ww_horn_of_the_huntsman": {
        ...
        "completion": "Рог оборвался на полуноте. Каждый колокол в Гиббетмире ударил по разу, сам по себе, а потом лес затих так, как не затихал на моей памяти тридцать лет. Ты совершил обряд, который был мне не по силам, {playerName}. Носи это — и ходи под кронами без страха.",
        "objectives": {
          "0": {
      ...
      "q_pr_the_man_who_went_in": {
        "title": "Тот, кто вошёл в чащу",
        "text": "Ныряльщицы не ступят за кромку деревьев, {playerName}, и я не стану их просить. Барабаны ты уже слышал: их слышат все — ко второй ночи. Лишь один человек на этом острове пошёл на этот звук и вернулся. Окрим. Он живёт под великими баньянами у Лианопада, в глубине дороги через Заросли. Найди его и спроси, что прячет зелень.",
        ...
        "objectives": {
          "0": {
            "label": "Найдите Окрим у Лианопада"
          }
        }
      },
      "q_pr_canopy_silk": {
    ...
    "zones": {
      ...
      "veiled_hollow": {
        ...
        "welcome": "Воздух гудит от древней магии. Найдите хранительницу Сэльвин под великим древом Элдершайна.",
        "pois": {
          "0": {
            "label": "Элдершайн"
          },
      ...
      "wraithwood": {
        ...
        "welcome": "Кроны смыкаются над дорогой, как крышка гроба. Держись фонарей Гиббетмира, и если лес позовёт тебя по имени, не отвечай.",
        "pois": {
          "0": {
            "label": "Гиббетмир"
          },
    ...
    "letters": {
      ...
      "wyrmfall_core_reward": {
        "sender": "Героический интендант",
        "subject": "Ваши ядра драконопада",
        "body": "Зверь пал, пока вы сражались в тылу или лежали в пыли. Ваша доля ядер драконопада прилетела к вам сюда, а не досталась мародёрам. Пустите их в дело у верстака.\n\n- Героический интендант"
      },
