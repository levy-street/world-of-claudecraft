...
export const ru_RU: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Выберите WOC Wallet, Phantom или Solflare. Приложение кошелька запросит подтверждение. Не закрывайте игру и вернитесь в нее после завершения.",
    "standaloneAppHelp": "Подключение кошелька пока недоступно в приложении с главного экрана. Для WOC Wallet, Phantom или Solflare откройте World of ClaudeCraft в Safari или Chrome.",
    ...
    "browser": {
      ...
      "extensionHelp": "Совместимое расширение кошелька не найдено. Установите или разблокируйте WOC Wallet, Phantom, Solflare либо другой браузерный кошелек Solana и повторите попытку.",
