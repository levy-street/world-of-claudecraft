...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "dexSwap": {
      "title": "Купить $WOC",
      "close": "Закрыть покупку $WOC",
      "launcher": "Купить",
      "launcherAria": "Купить $WOC за SOL или USDC",
      "nonCustodial": "Обмены проходят через DEX-агрегатор Jupiter, а подписывает и отправляет их ваш собственный кошелек. Игра никогда не хранит ваши ключи или средства.",
      "amountLabel": "Вы платите",
      "tokenAria": "Платежный токен",
      "quoteButton": "Получить котировку",
      "quoting": "Поиск лучшего маршрута...",
      "amountInvalid": "Введите корректное количество.",
      "slippage": "Максимальное проскальзывание: {percent}%",
      "receiveLine": "Вы получите около {amount} $WOC",
      "payLine": "Вы платите {amount} {symbol}",
      "priceImpact": "Влияние на цену: {percent}%",
      "minReceived": "Минимум к получению: {amount} $WOC",
      "buyButton": "Купить $WOC",
      "quoteStale": "Срок действия котировки истек. Получите новую котировку перед покупкой.",
      "feeLine": "Включает платформенную комиссию {percent}%",
      "cooldown": "Слишком много запросов. Повторите попытку через {seconds} с.",
      "requoted": "Срок действия котировки истек, поэтому получена новая. Проверьте ее и нажмите «Купить» еще раз.",
      "signing": "Подтвердите транзакцию в кошельке...",
      "sentTitle": "Обмен отправлен",
      "sentBody": "Ваш кошелек подписал и отправил обмен. Баланс $WOC обновится после подтверждения сетью.",
      "signatureLabel": "Подпись транзакции: {signature}",
      "viewOnExplorer": "Открыть в Solana Explorer",
      "buyMore": "Купить еще $WOC",
      "errWalletFeature": "Подключенный кошелек не может отправлять транзакции из игры. Попробуйте другой кошелек Solana.",
      "errSignFailed": "Транзакция не была отправлена. Возможно, она была отклонена в вашем кошельке.",
      "errNoWallet": "Сначала подключите кошелек Solana."
    },
    "tradingBots": {
      "title": "Торговые боты",
      "close": "Закрыть торговых ботов",
      "launcher": "Боты",
      "launcherAria": "Арендовать торгового бота для SOL и $WOC",
      "loading": "Загрузка торговых ботов...",
      "custody": "Депозиты поступают в хранилище с лимитом, которым за вас управляет торговый сервис. Вывод возможен только на привязанный кошелек, и вывести средства можно в любой момент.",
      "riskNote": "Автоматическая торговля может приводить к убыткам. Плата за аренду не возвращается. Это не финансовый совет.",
      "catalogIntro": "Арендуйте бота на месяц, пополните его парой SOL и $WOC, и он будет торговать за вас на DEX.",
      "skuGridName": "Сеточный голем",
      "skuGridBlurb": "Расставляет попеременные заявки на покупку и продажу вокруг рыночной цены и зарабатывает на спреде, пока цена колеблется.",
      "skuDcaName": "Капельный дух",
      "skuDcaBlurb": "Планомерно обменивает SOL на $WOC по фиксированному расписанию, распределяя входы во времени.",
      "skuMomentumName": "Огонек импульса",
      "skuMomentumBlurb": "Смещает пару в сторону тренда и возвращает баланс, когда тренд ослабевает.",
      "priceWoc": "{amount} $WOC в месяц",
      "priceClaudium": "{amount} Claudium в месяц",
      "rentButton": "Арендовать",
      "payWithLabel": "Способ оплаты",
      "payWoc": "$WOC",
      "payClaudium": "Claudium",
      "claudiumBalance": "Баланс Claudium: {amount}",
      "approvePayment": "Подтвердите оплату аренды в кошельке...",
      "confirmingPayment": "Подтверждение платежа в сети...",
      "subscribedBody": "Бот арендован. Пополните его хранилище, чтобы начать торговлю.",
      "activeUntil": "Действует до {date}",
      "fundTitle": "Пополнить хранилище",
      "solAmountLabel": "SOL для депозита",
      "wocAmountLabel": "$WOC для депозита",
      "depositBounds": "От {min} до {max}",
      "depositButton": "Внести",
      "approveDeposit": "Подтвердите депозит в кошельке...",
      "confirmingDeposit": "Подтверждение депозита в сети...",
      "amountInvalid": "Введите корректное количество.",
      "vaultLine": "Хранилище: {sol} SOL, {woc} $WOC",
      "stateRunning": "Работает",
      "statePaused": "Приостановлен",
      "startButton": "Запустить",
      "pauseButton": "Пауза",
      "paramsTitle": "Настройки стратегии",
      "paramGridSpacingBps": "Шаг сетки ({percent}%)",
      "paramOrderSizeBps": "Размер заявки ({percent}%)",
      "paramDcaIntervalMinutes": "Интервал покупки (минуты)",
      "paramMomentumLookbackMinutes": "Окно тренда (минуты)",
      "saveParams": "Сохранить настройки",
      "recentTrades": "Недавние сделки",
      "noTrades": "Сделок пока нет.",
      "tradeBuy": "Покупка",
      "tradeSell": "Продажа",
      "pnlLine": "Прибыль и убыток ({days} дн.): {amount} $WOC ({percent}%)",
      "withdrawButton": "Вывести все",
      "withdrawTitle": "Вывод из хранилища",
      "withdrawBody": "Вывод приостанавливает бота и возвращает средства хранилища на ваш привязанный кошелек.",
      "approveWithdraw": "Подтвердите вывод в кошельке...",
      "withdrawPending": "Вывод отправлен. Баланс обновится после подтверждения сетью.",
      "cooldown": "Слишком много запросов. Повторите попытку через {seconds} с.",
      "errWalletFeature": "Подключенный кошелек не может отправлять транзакции из игры. Попробуйте другой кошелек Solana.",
      "errSignFailed": "Транзакция не была отправлена. Возможно, она была отклонена в вашем кошельке.",
      "errNoWallet": "Сначала подключите кошелек Solana."
  ...
  "apiError": {
    ...
    "dex_swap": {
      "disabled": "Покупка $WOC в игре сейчас недоступна.",
      "input_not_allowed": "Этот платежный токен не поддерживается.",
      "invalid_amount": "Введите корректное количество.",
      "invalid_slippage": "Такое значение проскальзывания не допускается.",
      "invalid_public_key": "Сначала подключите кошелек Solana.",
      "quote_tampered": "Эта котировка не соответствует данному обмену. Запросите новую котировку.",
      "no_route": "Для этого количества сейчас нет доступного торгового маршрута.",
      "rate_limited": "Слишком много запросов. Подождите немного и попробуйте снова.",
      "upstream_error": "Сервис обмена недоступен. Повторите попытку позже."
    },
    "trading_bots": {
      "disabled": "Торговые боты сейчас недоступны.",
      "unknown_sku": "Этого бота нет в каталоге.",
      "invalid_pay_currency": "Эта валюта оплаты не поддерживается.",
      "already_subscribed": "Вы уже арендуете торгового бота.",
      "subscription_required": "Сначала арендуйте торгового бота.",
      "subscription_expired": "Аренда бота истекла. Продлите ее или выведите свои средства.",
      "insufficient_claudium": "Недостаточно Claudium.",
      "invalid_amount": "Введите корректное количество.",
      "deposit_out_of_bounds": "Этот депозит выходит за допустимые пределы для данного бота.",
      "invalid_public_key": "Сначала подключите кошелек Solana.",
      "invalid_params": "Такие настройки бота не допускаются.",
      "payment_not_found": "Платеж не найден. Начните заново.",
      "payment_unverified": "Платеж пока не удалось подтвердить. Повторите попытку чуть позже.",
      "vault_busy": "Хранилище бота занято. Повторите попытку чуть позже.",
      "rate_limited": "Слишком много запросов. Подождите немного и попробуйте снова.",
      "upstream_error": "Сервис торговых ботов недоступен. Повторите попытку позже."
    }
  },
  "guide": {
