...
export const ru_RU: EnTranslations = {
  ...
  "sim": {
    ...
    "sourceCave": {
      ...
      "enter": "Вы входите в Открытый Исток.",
      "leave": "Вы покидаете Открытый Исток.",
      "rebootConfirm": "Вы уверены, что хотите продолжить? Прежде чем нажать, убедитесь, что собрали все необходимые ресурсы.",
      "killProgress": "{name} повержен. (Побеждено {killed} из {total} в Открытом Истоке)",
      "cleared": "Открытый Исток зачищен.",
  ...
  "entities": {
    ...
    "dungeons": {
      ...
      "source_cave": {
        "name": "Открытый Исток",
        "enterText": "Вы входите в Открытый Исток.",
        "leaveText": "Вы покидаете Открытый Исток."
      },
      "drowned_temple": {
        "name": "Утонувший храм",
