...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "hammer_of_wrath": {
        "name": "Молот гнева",
        "description": "Бросает в противника священный молот, нанося {damage} ед. урона от Света. (талант паладина)"
      },
      "counter_shot": {
      ...
      "mind_sear": {
        ...
        "description": "Направляет темную энергию, каждую секунду нанося ближайшим врагам {damage} ед. урона. (талант жреца)"
      },
      "earthbind": {
        "name": "Оковы земли",
      ...
      "death_coil": {
        "name": "Лик смерти",
        "description": "Ужасает врага и за короткое время возвращает вам часть жизни. (талант чернокнижника)"
      },
      "chaos_bolt": {
        "name": "Стрела хаоса",
      ...
      "innervate": {
        "name": "Озарение",
        "description": "Мгновенно восстанавливает большой запас маны. (талант друида)"
      },
