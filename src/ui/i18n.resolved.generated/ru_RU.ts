...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "aura_surge": {
        "name": "Рикошет рассветного щита",
        "description": "Бросает выкованный рассветом щит, наносящий {damage} ед. урона от Света и лишающий основную цель возможности колдовать на 2 сек. Затем щит отскакивает еще к {jumps} противникам в радиусе {radius} м, нанося при каждом отскоке {falloff} от предыдущего урона. (талант паладина)"
      },
      "holy_shock": {
        "name": "Шок небес",
      ...
      "lingering_dread": {
        "name": "Неугасающий ужас",
        "description": "Боевой клич обращает врагов в радиусе 10 м в бегство на 4 сек. Каждый эффект страха выдерживает урон в размере 20% от максимального здоровья цели. (талант воина)"
      },
      "stormthrow": {
      ...
      "cleansing_verdict": {
        "name": "Очищающий вердикт",
        "description": "Снимает вредный магический эффект с союзника и исцеляет его на {damage} Свят."
      },
      "voidfeast": {
        "name": "Пир Бездны",
        "description": "Пожирает магический эффект (полезный у врага или вредный у союзника) и исцеляет вас на 6% максимального здоровья."
      },
      "spellsteal": {
        "name": "Кража заклинаний",
        "description": "Похищает у врага полезный магический эффект и переносит его на вас."
      },
      "startle_shot": {
        "name": "Пугающий выстрел",
        "description": "Шальной выстрел, дезориентирующий цель. Любой урон снимает эффект."
      },
      "bear_charge": {
        "name": "Натиск бурого",
