...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "Настроить",
      "customizeTitle": "Настройка управления",
      "customizeSlotAttack": "Обычная атака",
      "customizeSlotSkill": "Умение {n}",
      "customizeSlotUtility": "Поддержка",
      "customizeDefault": "По умолчанию для класса",
      "customizeResetSlot": "Сбросить эту ячейку",
      "customizeResetAll": "Сбросить всё к настройкам класса",
      "customizeUpdated": "{slot} обновлено.",
      "customizeAllReset": "Управление сброшено к настройкам класса."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Задержка удержания для правки",
      "clusterHoldNote": "Как долго удерживать экранную кнопку действия, прежде чем откроется редактор привязок. Увеличьте значение, если редактор открывается во время быстрого использования умений.",
      "targetPriority": "Приоритет цели атаки",
      "targetPriorityNearest": "Ближайший",
      "targetPriorityLowestHp": "Наименьшее здоровье",
      "targetPriorityCurrent": "Сначала текущая",
      "targetPriorityNote": "На кого нацеливается кнопка атаки, когда нет подходящей цели: ближайший враг, враг с наименьшим здоровьем в пределах досягаемости или сохранение текущей цели, пока она остаётся допустимой.",
      "aimAssist": "Умное применение умений",
      "aimAssistNote": "Нажмите атакующее умение, чтобы применить его к цели или к лучшему врагу поблизости, если цели нет, поворачиваясь к нему. Удерживайте кнопку, чтобы увидеть дальность умения; отпустите, убрав палец с кнопки, чтобы отменить.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Сбросить сенсорное управление",
      "touchResetDone": "Сенсорное управление сброшено к значениям по умолчанию.",
