...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "icefall": {
        "name": "Ледопад",
        "description": "Выпускает в цель все накопленные сосульки. Каждая наносит {damage} ед. урона от магии льда. Урон удваивается по обездвиженным или охлажденным целям. (Криомантия)"
      },
      "conjure_water": {
