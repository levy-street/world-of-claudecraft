...
export const ru_RU: EnTranslations = {
  ...
  "character": {
    ...
    "renameCancel": "Отмена",
    "respec": "Сброс талантов",
    "respecHint": "Сожгите $WOC, чтобы сбросить таланты или открыть дополнительный слот снаряжения.",
    "respecPaidButton": "Сбросить таланты за {amount} $WOC",
    "loadoutSlotPaidButton": "Открыть слот снаряжения за {amount} $WOC",
    "respecCancel": "Отмена",
    "respecSuccess": "Таланты сброшены.",
    "loadoutSlotSuccess": "Слот снаряжения открыт.",
