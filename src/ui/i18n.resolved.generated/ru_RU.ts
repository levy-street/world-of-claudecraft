  ...
  "entities": {
    ...
    "npcs": {
      ...
      "logol": {
        "name": "Логол",
        "title": "{{,,,}}",
        "greeting": "Значит, ты меня видишь. Немногим дано. Я несу то, что не купить золотом, странник, только за $WOC."
      },
      "logol_harbinger": {
        "name": "Предвестник Безымянного ордена",
        "title": "{{,,,}}",
        "greeting": "Некто в плаще бродит по этому краю, видимый лишь глазам, что научились смотреть. Хочешь научиться?"
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "quests": {
      ...
      "q_logol_rumor": {
        "title": "Слух о Логоле",
        "text": "Говорят, некий торговец ходит между мгновениями. Присядь, и я расскажу, как его увидеть.",
        "completion": "Хорошо. Теперь слух в тебе. Он не уйдёт.",
        "objectives": {
          "0": {
            "label": "Выслушать Предвестника"
          }
        }
      },
      "q_logol_sign": {
        "title": "The Sign in the Eye",
        "text": "Чтобы увидеть незримое, сперва вглядись в обыденное. Истребляй лесных волков долины, пока твой взор не прояснится, затем вернись ко мне.",
        "completion": "Метка поставлена. Твой взор готов.",
        "objectives": {
          "0": {
            "label": "Истребить лесных волков"
          }
        }
      },
      "q_logol_seen": {
        "title": "Зримое и незримое",
        "text": "Ты готов. Тот, кто в плаще, держится перекрёстка, когда вообще ходит по этому краю. Найди его, поговори с ним и вернись ко мне.",
        "completion": "Теперь ты видишь его. Его книга открыта тебе. Трать с умом.",
        "objectives": {
          "0": {
            "label": "Найти Логола и поговорить с ним"
          }
        }
      },
      "q_drowned_choir": {
