...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "ironhold": {
        "name": "Железная стена",
        "description": "Укрывшись за щитом, вы снижаете весь получаемый урон на 50% на 8 сек."
      },
      "sacred_bulwark": {
        "name": "Священный оплот",
        "description": "Призывает оплот веры, снижая весь получаемый урон на 50% на 8 сек."
      },
      "ancestral_resolve": {
        "name": "Воля предков",
        "description": "Духи предков защищают вас, снижая весь получаемый урон на 50% на 8 сек."
      },
      "shadow_bolt": {
