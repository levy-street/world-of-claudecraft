...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "aldrin": {
      "entryLabel": "Клуб Олдрина",
      "title": "Клуб Олдрина",
      "intro": "Ежемесячное членство. Все привилегии только косметика, удобства или доступ: ничего, что дает силу.",
      "loading": "Загрузка...",
      "unavailable": "Клуб Олдрина недоступен в этом мире.",
      "memberBadge": "Участник",
      "notMember": "Вы пока не участник.",
      "memberUntil": "Членство до {date} (осталось дней: {days})",
      "autoRenew": "Продлевается автоматически по карточной подписке.",
      "priceLine": "{amount} USD каждые {days} дней",
      "splitLine": "{treasuryPct}% идет в открытую казну, {burnPct}% на выкуп и сжигание $WOC.",
      "perksTitle": "Привилегии членства",
      "perk": {
        "aura": "Золотая аура участника (только визуально)",
        "regalia": "Трансмогрификация регалий Олдрина (только внешний вид)",
        "mount": "Эксклюзивный клубный облик транспорта",
        "title": "Титул «Член Клуба Олдрина»",
        "nameColor": "Золотой цвет таблички с именем",
        "lounge": "Клубная гостиная и канал чата для участников",
        "wardrobe": "Дополнительные ячейки косметического гардероба",
        "queue": "Приоритетная очередь входа при переполнении",
        "stipend": "Ежемесячное косметическое пособие"
      },
      ...
      "reason": {
        "clubDisabled": "Недоступно, пока клуб отключен в этом мире.",
        "walletCannotSign": "Недоступно: привязанный кошелек подписывает только сообщения и не может подписывать транзакции.",
        "notConfigured": "Не настроено в этом мире."
      },
      "quoteTitle": "Расчет оплаты: {method}",
      "quoteAmount": "Сумма: {amount} {method}",
      "quoteMemo": "Памятка (обязательна при оплате): {memo}",
      "quoteExpires": "Расчет действителен еще около {minutes} мин.",
      "quoteExpired": "Срок расчета истек. Запросите новый.",
      "quoteError": "Не удалось получить расчет. Повторите попытку позже.",
      "railsNotice": "Платежи в этой сборке отключены до получения ключей оператора и финального одобрения. Из этого окна транзакции не отправляются.",
      "stripeNotice": "Оплата картой откроется через Stripe, когда платежи будут включены.",
      "close": "Закрыть"
    }
  },
  "guide": {
