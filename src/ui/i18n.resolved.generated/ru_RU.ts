...
export const ru_RU: EnTranslations = {
  ...
  "walletPanel": {
    ...
    "connect": "Подключить",
    "connectedStatus": "Подключен {address}",
    "linkedBadge": "привязан",
    "tabSend": "Отправить",
    "tabHire": "Нанять",
    "tabJobs": "Заказы",
    "sendSection": "Отправить игроку",
    "currency": "Валюта",
    "playerName": "Имя игрока",
    "recipientPlaceholder": "Кому вы отправляете?",
    "amount": "Сумма",
    ...
    "balanceExceeds": "Баланс: {amount} (превышает баланс)",
    "connectForBalance": "Подключите кошелек, чтобы увидеть баланс.",
    "sendNote": "Отправляется напрямую с кошелька на кошелек в Solana. Некастодиально: игра никогда не хранит ваши средства. Взимается сетевая комиссия.",
    "send": "Отправить",
    "sending": "Отправка…",
    "loginToSend": "Войдите и зайдите в мир, чтобы отправлять игрокам.",
    "lookingUp": "Поиск игрока…",
    "ownWallet": "(это ваш собственный кошелек)",
    "noVerifiedWallet": "У игрока с таким именем нет подтвержденного кошелька.",
    "approveTransfer": "Подтвердите перевод в кошельке…",
    "sent": "Отправлено {amount} {currency} игроку {name}.",
    "viewTransaction": "Посмотреть транзакцию",
    "sendFailedWith": "Ошибка отправки: {message}",
    "sendFailed": "Не удалось отправить.",
    "hireSection": "Нанять помощника",
    "hireOffline": "Зайдите в мир онлайн, чтобы нанять помощника.",
    "helperPlaceholder": "Кто вам поможет?",
    "rewardCurrency": "Валюта награды",
    "reward": "Награда",
    "goalLabel": "Цель, оплачивается после подтверждения сервером",
    "goalReachLevel": "Достичь уровня",
    "goalClearDungeon": "Пройти рейд",
    "goalQuest": "Задание",
    "goalBodyguard": "Телохранитель",
    "goalEscort": "Сопровождение",
    "targetLevel": "Целевой уровень",
    "targetLevelPlaceholder": "от 2 до 20",
    "raidDungeon": "Рейд / подземелье",
    "questOwn": "Задание (одно из ваших)",
    "noActiveQuests": "У вас нет активных заданий, для которых можно нанять помощь. Сначала возьмите задание.",
    "protectMinutes": "Защищать меня (минут)",
    "minutesPlaceholder": "напр. 10",
    "escortDestination": "Пункт назначения",
    "useCurrentSpot": "Использовать мое текущее место",
    "destinationSet": "Пункт назначения задан: ({x}, {z})",
    "noDestination": "Пункт назначения еще не задан.",
    "destinationHint": "Пункт назначения ({x}, {z}), отойдите, а затем пусть охранник приведет вас сюда обратно.",
    "hireLogin": "Зайдите в мир онлайн, чтобы нанять игрока.",
    "escrowNote": "Награда блокируется в ончейн-эскроу и автоматически выплачивается помощнику, когда сервер подтверждает цель, или возвращается вам, если цель не достигнута до срока.",
    "post": "Опубликовать и заблокировать награду",
    "posting": "Публикация…",
    "setGoalFirst": "Сначала задайте корректную цель.",
    "preparingEscrow": "Подготовка эскроу…",
    "approveDeposit": "Подтвердите депозит награды в кошельке…",
    "lockingReward": "Блокировка награды в ончейне…",
    "waitingFinalization": "Ожидание финализации…",
    "confirmTimeout": "Время подтверждения депозита истекло. Если награда была заблокирована, она рассчитается после финализации.",
    "jobPosted": "Заказ опубликован: {amount} {currency} заблокировано в эскроу для {name}.",
    "postFailed": "Не удалось опубликовать заказ.",
    "failedWith": "Ошибка: {message}",
    "jobsSection": "Ваши заказы",
    "loading": "Загрузка…",
    "jobsOffline": "Зайдите в мир онлайн, чтобы управлять заказами.",
    "jobsEmpty": "Заказов пока нет. Используйте вкладку «Нанять», чтобы заплатить игроку за помощь.",
    "youHired": "Вы наняли {name}",
    "hiredYou": "{name} нанял вас",
    "acceptJob": "Принять заказ",
    "cancelRefund": "Отменить и вернуть средства",
    "viewPayout": "Посмотреть выплату",
    "actionFailed": "Действие не удалось.",
    "status": {
      "awaitingDeposit": "Ожидается ваш депозит",
      "offered": "Предложено вам, примите, чтобы начать",
      "open": "Открыт, ожидается согласие помощника",
      "active": "В процессе",
      "completed": "Завершен, помощнику выплачено",
      "expired": "Истек, средства возвращены",
      "failedDied": "Провален (вы погибли), средства возвращены",
      "cancelled": "Отменен, средства возвращены",
  ...
  "character": {
    ...
    "mintSolButton": "Сжечь {amount} $WOC и создать",
    "mintSolHint": "Создайте собственное имя ‹имя›.worldofclaudecraft.sol за {amount} $WOC, оно ваше в блокчейне.",
  ...
  "woc": {
    ...
    "finalizeTimeout": "Время ожидания финализации истекло. Если $WOC уже сожжены, откройте окно снова и повторите: платеж зачтется после финализации.",
    "renameSuccess": "Переименовано в {name}.",
    "mintSuccess": "Создано {domain}, теперь оно ваше в блокчейне.",
    "guildRenameSuccess": "Гильдия переименована в {name}.",
    "reserveSuccess": "Имя {name} зарезервировано."
  },
  "deleteCharacter": {
