...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketBrowse": "Просмотр: листайте объявления или ищите по названию, чтобы найти то, что выставлено на продажу. В каждом объявлении указаны товары, продавец, оставшееся время и либо цена за штуку для стопки, которую можно купить частями, либо текущая ставка для аукционного лота.",
      "marketPost": "Размещение: выберите стопку из своих сумок, укажите срок продажи (12, 24 или 48 часов) и назначьте цену за штуку, либо переключитесь на аукцион и укажите начальную ставку и необязательную цену выкупа. За размещение берется залог, зависящий от срока; он возвращается по мере продажи товара, а теряется только та часть, что осталась непроданной. Товары хранятся у Торговца, пока их не купят или пока не закончится аукцион, а забрать лот можно и раньше, если вы передумали.",
      "marketBidding": "Аукционы: некоторые лоты продаются через ставки, а не по фиксированной цене. Ставка должна быть не ниже указанного минимума, и если вашу ставку перебивают, она возвращается полностью. Если продавец назначил цену выкупа, ставка, достигшая этой суммы, сразу забирает лот.",
      ...
      "marketCurrencies": "Там, где это включено, лот можно оценить также в Claudium или WOC: покупатель платит вам напрямую, со счёта на счёт или из кошелька в кошелёк, Торговец держит товар до подтверждения оплаты, а залог за лот остаётся обычным золотом."
    },
    "social": {
  ...
  "itemUi": {
    ...
    "market": {
      ...
      "yourBidBadge": "Ваша ставка",
      "currentBidLabel": "Ставка:",
      "noBidsYet": "Ставок пока нет",
      "minNextBid": "Мин. ставка {money}",
      "buyoutLabel": "Выкуп {money}",
      "auctionBadge": "Аукцион",
      "leadingBid": "Вы лидируете",
      "bidInputAria": "Сумма ставки за {item}",
      "bidButton": "Ставка",
      "bidAria": "Сделать ставку на {item}",
      "buyoutButton": "Выкупить",
      "buyoutAria": "Выкупить {item} за {price}",
      "buyQuantityAria": "Количество {item} для покупки",
      ...
      "listingTypeLabel": "Тип продажи",
      "listingTypeFixed": "Фиксированная цена",
      "listingTypeAuction": "Аукцион",
      "durationLabel": "Срок продажи",
      "durationOption": "{hours} ч",
      "startingBidLabel": "Начальная ставка",
      "buyoutOptionalLabel": "Выкуп (необязательно)",
      "totalLabel": "Итого",
      "depositPreviewLabel": "Залог за размещение",
      "listButton": "Выставить на мировой рынок",
      "minPriceError": "Назовите цену не меньше 1 меди.",
      "cancelConfirmTitle": "Забрать лот",
      "cancelConfirmBody": "Забрать {item} с рынка? Залог {money} будет утрачен.",
      "cancelConfirmBodyNoDeposit": "Забрать {item} с рынка?",
      "cancelConfirmDismiss": "Отмена",
      ...
      "outbidToast": "Вашу ставку на {item} перебили. {money} возвращены в ваш ящик получения.",
      "wonToast": "Вы выиграли аукцион за {item}! Заберите его у Торговца.",
      "soldToast": "Ваш лот {item} продан за {money}. Заберите средства у Торговца.",
      "expiredToast": "Срок продажи {item} истек без покупателя. Заберите его у Торговца.",
      "denomLabel": "Валюта",
      "denomGold": "Золото",
      "denomClaudium": "Claudium",
      "denomWoc": "WOC",
      "auctionGoldOnly": "Ставки принимаются только золотом.",
      "claudiumPriceEach": "Цена за штуку (Claudium)",
      "wocPriceLot": "Цена лота (WOC)",
      "claudiumAmount": "{amount} Claudium",
      "claudiumEach": "По {amount} Claudium за штуку",
      "claudiumMinError": "Укажите цену не менее 1 Claudium.",
      "awaitingPayment": "Ожидание оплаты",
      "buyExternalTitle": "Подтверждение покупки",
      "buyClaudiumConfirmBody": "Купить {item} за {amount} Claudium? Оплата спишется с вашего баланса Claudium.",
      "buyWocConfirmBody": "Купить {item} за {amount} WOC? Вы платите из привязанного кошелька; товар будет выдан после подтверждения платежа.",
      "buyClaudiumAria": "Купить {item} за Claudium",
      "buyWocAria": "Купить {item} за WOC",
      "pendingClaudium": "Завершаем покупку {item}.",
      "pendingPreparing": "Готовим запрос на оплату {item}.",
      "wocPayPrompt": "Отправьте {amount} WOC из привязанного кошелька, чтобы завершить покупку {item}.",
      "paymentExpiredToast": "Время оплаты {item} истекло. Лот снова доступен.",
      "soldWalletToast": "Ваш {item} продан за {amount} WOC. Оплата поступила в ваш привязанный кошелёк; залог заберите у Торговца.",
      "soldAccountToast": "Ваш {item} продан за {amount} Claudium. Оплата зачислена на ваш баланс Claudium; залог заберите у Торговца."
    },
    "logs": {
      ...
      "postedAuction": "Лот {item} выставлен на аукцион (начальная ставка {money}).",
      "bidPlaced": "Сделана ставка: {money} за {item}.",
      "listedClaudium": "{item} выставлен на Мировом Рынке за {amount} Claudium.",
      "listedWoc": "{item} выставлен на Мировом Рынке за {amount} WOC.",
    ...
    "errors": {
      ...
      "minStartingBid": "Назначьте начальную ставку не менее 1 медяка.",
      "buyoutTooLow": "Цена выкупа должна быть выше начальной ставки.",
      "chooseDuration": "Выберите срок продажи: 12, 24 или 48 часов.",
      "cannotAffordDeposit": "Вам не хватает средств на залог за размещение.",
      "bidsOnly": "Этот лот продается только через ставки.",
      "notAuction": "Этот лот не выставлен на аукцион.",
      "cannotBidOwnLot": "Нельзя делать ставку на собственный лот.",
      "alreadyHighBidder": "Вы уже лидируете по ставке.",
      "bidTooLow": "Ставка должна быть не менее {min}.",
      "bidsGoldOnly": "Ставки принимаются только золотом.",
      "claudiumUnavailable": "Лоты за Claudium недоступны.",
      "wocUnavailable": "Лоты за WOC недоступны.",
  ...
  "entities": {
    ...
    "letters": {
      ...
      "market_outbid": {
        ...
        "body": "Другой покупатель поднял ставку на лот, который вы хотели получить. Ваши медяки ждут в ящике получения на Мировом Рынке; приходите забрать их или сделать новую ставку.\n\n- Торговец"
      },
      "market_won": {
        "sender": "Торговец",
        "subject": "Ваша выигранная ставка",
        "body": "Молоток упал, и лот теперь ваш. Ваш товар ждет в ящике получения на Мировом Рынке; приходите забрать его.\n\n- Торговец"
      },
      "market_sold": {
        "sender": "Торговец",
        "subject": "Ваш лот продан",
        "body": "Покупатель забрал ваш товар. Ваша выручка ждет в ящике получения на Мировом Рынке; приходите забрать ее.\n\n- Торговец"
      },
      "market_sold_wallet": {
        "sender": "Торговец",
        "subject": "Ваш лот продан",
        "body": "Покупатель забрал ваш товар. Оплата ушла прямо в ваш привязанный кошелёк, как вы и просили; в ящике получения на Мировом Рынке ждёт только залог за лот. Приходите забрать его.\n\n- Торговец"
      },
      "market_sold_account": {
        "sender": "Торговец",
        "subject": "Ваш лот продан",
        "body": "Покупатель забрал ваш товар. Оплата зачислена прямо на ваш баланс Claudium; в ящике получения на Мировом Рынке ждёт только залог за лот. Приходите забрать его.\n\n- Торговец"
      },
      "market_expired": {
        "sender": "Торговец",
