...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "historyDebit": "-{amount}",
      "tabSupply": "Предложение",
      "supplyTitle": "Клаудиум в обращении",
      "supplyLoading": "Загрузка данных о предложении...",
      "supplyError": "Не удалось загрузить данные о предложении. Попробуйте ещё раз.",
      "supplyUnavailable": "Данные о предложении сейчас недоступны.",
      "supplyInExistence": "В обращении {amount}",
      "supplyUsdValue": "Стоимость {amount}",
      "supplyIssued": "Всего выпущено",
      "supplySunk": "Всего потрачено или отменено",
      "supplyHolders": "Держат {n} аккаунтов",
      "supplyChangeUp": "Рост на {amount} за период",
      "supplyChangeDown": "Снижение на {amount} за период",
      "supplyChangeFlat": "Без изменений за период",
      "supplyChartLabel": "Предложение Клаудиума за выбранный период",
      "supplyChartEmpty": "За этот период изменений не было.",
      "supplyRangeLabel": "Период графика",
      "supplyRange24h": "24h",
      "supplyRange7d": "7d",
      "supplyRange30d": "30d",
      "supplyFootnote": "Учитывает весь Клаудиум на всех аккаунтах, суммируется из реестра в реальном времени.",
