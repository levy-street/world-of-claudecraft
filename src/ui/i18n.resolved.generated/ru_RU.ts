...
export const ru_RU: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "noLoot": "Добыча еще не записана.",
      "recentAwards": "Последние награды: {count}",
      "target": "Цель: {name}",
      "noTargetEngaged": "Нет цели в бою.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Отказ",
      "methodMaster": "Мастер",
      "methodPersonal": "Персонально",
      "methodDelve": "Вылазка",
      "methodLooted": "Получено",
      "noWinner": "Нет победителя",
      "rollDetail": "Бросок {roll}",
