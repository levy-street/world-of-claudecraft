...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "housing": {
      "buy": "Купить купчую на усадьбу ({price})",
      "buyAria": "Купить купчую на усадьбу за {price}",
      "travel": "Отправиться в свою усадьбу",
      "travelAria": "Телепорт к вашему участку в Усадебных долах",
      "confirmTitle": "Купчая на усадьбу",
      "confirmBuy": "Подписать купчую на собственную усадьбу в долах за {price}?",
      "confirmOk": "Подписать купчую",
      "confirmCancel": "Пока нет",
      "purchasedBanner": "Усадебные долы ждут вас.",
      "arrivedBanner": "Ваша усадьба",
      "leftBanner": "Истбрук",
      "result": {
        "purchased": "Купчая ваша. Поговорите с управляющим, чтобы посетить усадьбу.",
        "alreadyOwned": "У вас уже есть купчая на усадьбу.",
        "cantAfford": "Вам не по карману эта купчая.",
        "notOwned": "У вас ещё нет купчей на усадьбу.",
        "tooFar": "Нужно говорить с земельным управляющим лично.",
        "glensFull": "В долах сейчас тесновато. Попробуйте чуть позже.",
        "notHome": "Вы не в своей усадьбе."
      }
    }
  },
  "guide": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "land_steward": {
        "name": "Управляющий Фенвик",
        "title": "Земельный управляющий",
        "greeting": "Мечтаете о собственном очаге? В Усадебных долах найдётся участок для всякого, у кого есть сто золотых и рука, чтобы подписать купчую."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
  ...
  "worldContent": {
    ...
    "homesteadGateName": "Усадебные врата"
  }
};
