...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "warcamp_dispatch": {
        "name": "Донесение Пылающего Завета"
      },
      "slag_heart": {
        "name": "Шлаковое Сердце"
      },
      "emberpact_sigil": {
        "name": "Сигил Пылающего Завета"
      },
      "kilnborn_core": {
        "name": "Сердцевина Пепложуя"
      },
      "forgehand_gauntlets": {
        "name": "Кузнечные Рукавицы"
      },
      "forgehand_handwraps": {
        "name": "Кузнечные Обмотки"
      },
      "forgehand_grips": {
        "name": "Кузнечные Захваты"
      },
      "emberstep_warboots": {
        "name": "Огнеступные Боевые Сапоги"
      },
      "emberstep_slippers": {
        "name": "Огнеступные Туфли"
      },
      "emberstep_treads": {
        "name": "Огнеступная Поступь"
      },
      "slagrend_cleaver": {
        "name": "Шлакорвущий Тесак"
      },
      "slagfire_scepter": {
        "name": "Шлакопламенный Скипетр"
      },
      "slagglass_shiv": {
        "name": "Шлакостеклянный Шив"
      },
      "vorrs_kilnplates": {
        "name": "Печные Латы Ворра"
      },
      "slagforged_legguards": {
        "name": "Шлакокованые Поножи"
      },
      "forgelord_warhelm": {
        "name": "Боевой Шлем Кузнечного Лорда"
      },
      "emberweave_cowl": {
        "name": "Капюшон Огненного Плетения"
      },
      "slagstalker_hood": {
        "name": "Капюшон Шлакового Ловчего"
      },
      "slag_chunk": {
        "name": "Кусок Шлака"
      },
      "ember_grit": {
        "name": "Пепельная Крошка"
      },
      "cult_brand": {
        "name": "Клеймо Пылающего Завета"
      }
    },
    "mobs": {
      "forest_wolf": {
      ...
      "emberpact_zealot": {
        "name": "Зелот Пылающего Завета"
      },
      "cinderhound": {
        "name": "Пепложар"
      },
      "ashmaw_kilnborn": {
        "name": "Пепложуй Печерожденный"
      },
      "emberpact_cinderpriest": {
        "name": "Пепложрец Пылающего Завета"
      },
      "emberpact_kiln_acolyte": {
        "name": "Послушник Печи Пылающего Завета"
      },
      "slag_hound": {
        "name": "Шлаковый Пес"
      },
      ...
      "emberbound_custodian": {
        "name": "Хранитель, Скованный Углями"
      },
      "forgeguard_sentinel": {
        "name": "Страж Кузни"
      },
      "molten_crucible_tender": {
        "name": "Смотритель Расплавленного Тигля"
      },
      "cinder_wisp": {
        "name": "Пепельный Дух"
      },
      "kilnmaster_vorr": {
        "name": "Печемастер Ворр"
      },
      "slagheart_colossus": {
        "name": "Колосс Шлаковое Сердце"
      },
      "ironvein_foreman": {
    ...
    "npcs": {
      ...
      "forgewright_brenna": {
        "name": "Бренна Углекузнец",
        "title": "Кузнечных дел мастер",
        "greeting": "Дым над юго-западными скалами, {className}. Моя бабка сама запечатала ту печь и поклялась, что она остыла навсегда. Остывшие печи не дымят."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "quests": {
      ...
      "q_foundry_smoke": {
        "title": "Дым над кручами",
        "text": "Пылающая Бездна была НАШЕЙ кузней, {playerName}, прежде чем кланы завалили ее и поклялись, что она остыла. Теперь она снова дымит, а огры Дрогмара сидят у входа, поджав хвосты, точно битые псы. Что-то выгнало их ВОН. Иди к осадной линии за военным лагерем и принеси мне одно из донесений, что культисты прибивают к своим кольям. Хочу знать, кто разжег огонь моей бабки заново.",
        "completion": "\"Пылающий Завет\". Культ, что молится тлеющему угольку. А эта печать внизу, {playerName}: старое клеймо самой Пылающей Бездны. Они не просто засели в кузне. Они ею УПРАВЛЯЮТ.",
        "objectives": {
          "0": {
            "label": "Донесение Пылающего Завета изъято"
          }
        }
      },
      "q_foundry_pickets": {
        "title": "Проредить осадную линию",
        "text": "Пылающий Завет держит подступы к кручам заслонами зелотов, и пока они стоят, никто не подойдет к дверям кузни. Они выгнали огров, {playerName}. ОГРОВ. Убей десятерых зелотов, и линия рухнет.",
        "completion": "Десятью голосами меньше молится тлеющему угольку. Заслоны редеют, и дверь почти в пределах досягаемости.",
        "objectives": {
          "0": {
            "label": "Зелот Пылающего Завета убит"
          }
        }
      },
      "q_foundry_hounds": {
        "title": "Псы Печи",
        "text": "Культ пускает по горным тропам псов - тварей, в чьих шкурах стынет шлак. Убей восьмерых и вырежи шесть шлаковых сердец, что бьются в них. Если печь достаточно горяча, чтобы породить ТАКОЕ, значит она горячее, чем моя бабка когда-либо смела ее разжигать.",
        "completion": "Все еще теплое. {playerName}, шлаковое сердце держит жар печи от силы день. Пылающая Бездна не просто разожжена. Она полыхает вовсю.",
        "objectives": {
          "0": {
            "label": "Пепложар повержен"
          },
          "1": {
            "label": "Шлаковое сердце"
          }
        }
      },
      "q_foundry_sigils": {
        "title": "Печати Пылающего Завета",
        "text": "Каждый зелот на той линии носит обожженную глиняную печать - свой ключ мимо дверных оберегов. Принеси мне шесть. Я умею читать клейма обжига, и они скажут мне, сколько тиглей у них работает.",
        "completion": "Шесть печатей, шесть разных клейм тигля. {playerName}, в Пылающей Бездне СЕМЬ тиглей. Они разожгли всю кузню целиком, а седьмое клеймо принадлежит великому тиглю: Шлаковому Сердцу.",
        "objectives": {
          "0": {
            "label": "Печать Пылающего Завета"
          }
        }
      },
      "q_foundry_ashmaw": {
        "title": "Пепложуй Печерожденный",
        "text": "Одно существо на той линии - не культист и не пес. Фигура из стынущего шлака бродит по верхней тропе, первое, что когда-либо отлила вновь разожженная печь, и заслоны идут за ней, точно за знаменем. Убей Пепложуя Печерожденного и принеси мне его сердцевину, {playerName}. Пока он ходит, линия будет восстанавливаться снова и снова.",
        "completion": "Сердцевина все еще светится. Отлитый шлак не должен ЖИТЬ, {playerName}. Кто бы ни поддерживал эту печь, он узнал то, что кланы похоронили намеренно.",
        "objectives": {
          "0": {
            "label": "Сердцевина Пепложуя"
          }
        }
      },
      "q_foundry_kilnmaster": {
        "title": "Печемастер",
        "text": "Печати называют своего хозяина: Печемастер Ворр, что нашел Пылающую Бездну остывшей и научил уголь молиться в ответ. Он держит литейные залы за сборочным двором. Возьми спутников и войди в те двери, чтобы покончить с ним, {playerName}. Это не дело для одинокого клинка.",
        "completion": "Ворр - пепел в собственных залах. Но клейма обжига на его робах... он не был кузнечным мастером, {playerName}. Он был МЕХАМИ. Что-то более глубокое все еще переводит дух.",
        "objectives": {
          "0": {
            "label": "Печемастер Ворр убит"
          }
        }
      },
      "q_foundry_slagheart": {
        "title": "Колосс Шлаковое Сердце",
        "text": "Я прочла последние из клейм обжига, {playerName}, и наконец поняла, что кует Пылающий Завет: ничего. Печь кует ТЕЛО для самой себя. Великий тигль уже сезон выливает одну-единственную отливку, и теперь она стоит на наковальном помосте в сердце кузни, ожидая последней закалки. Если она сойдет с этого помоста, гора проиграет любую войну, что грянет следом. Собери сильнейших, кого сможешь найти, и разбей Колосса Шлаковое Сердце прежде, чем он пробудится полностью.",
        "completion": "Наконец остыла, и на этот раз она ОСТАНЕТСЯ холодной: я запечатаю эту печь сама, так, как учила меня бабка. Гора никогда не узнает, что чуть не вышло у нее из-под ног, {playerName}. Но я буду знать. И ты тоже.",
        "objectives": {
          "0": {
            "label": "Колосс Шлаковое Сердце повержен"
          }
        }
      },
      "q_drowned_choir": {
    ...
    "dungeons": {
      ...
      "emberdeep_foundry": {
        "name": "Кузня Пылающей Бездны",
        "enterText": "Вы переступаете порог кузнечных врат. Гора смыкается над головой, и жар вновь разожженной Пылающей Бездны поднимается вам навстречу по проходу.",
        "leaveText": "Вы выходите из кузнечных врат на холод скалистых круч."
      },
      "drowned_temple": {
        "name": "Утонувший храм",
