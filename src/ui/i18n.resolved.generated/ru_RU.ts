...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nftSkins": {
      "title": "Wear an NFT",
      "intro": "Докажите владение PFP NFT, чтобы носить его: трейты формируют облик персонажа, а само изображение становится портретом. Скин остается вашим, пока вы держите NFT.",
      "connectEthereum": "Подключить кошелек Ethereum",
      "connectSolana": "Подключить кошелек Solana",
      "ethereumLinked": "Кошелек Ethereum: {address}",
      "solanaLinked": "Кошелек Solana: {address}",
      "notLinked": "не привязан",
      "collectionsTitle": "Поддерживаемые коллекции",
      "noCollections": "Коллекций пока нет. Загляните позже.",
      "tokenIdPlaceholder": "ID токена",
      "mintPlaceholder": "Адрес минта",
      "claim": "Получить",
      "claiming": "Получение...",
      "claimed": "Получено и надето. Скин всегда доступен в браузере скинов.",
      "needWallet": "Сначала привяжите соответствующий кошелек.",
      "close": "Закрыть",
      "errorNotOwner": "Этот кошелек не владеет данным токеном.",
      "errorUnverified": "Сейчас не удалось проверить владение. Повторите попытку позже.",
      "errorCollection": "Эта коллекция не поддерживается.",
      "errorTooMany": "Достигнут лимит NFT-скинов.",
      "errorMetadata": "Сейчас не удалось прочитать этот NFT. Повторите попытку позже.",
      "errorGeneric": "Не удалось получить этот NFT-скин.",
      "walletError": "Не удалось подключить кошелек."
    },
    "mobTooltip": {
  ...
  "marketplace": {
    ...
    "close": "Закрыть",
    "tabBrowse": "Обзор",
    "tabCreate": "Создать и продать",
    "search": "Поиск обликов",
    "by": "by {creator}",
    "anyClass": "Любой класс",
    "equip": "Надеть",
    "equipped": "Надето",
    "ownedBadge": "В коллекции",
    "noResults": "По вашему запросу облики не найдены.",
    "designTitle": "Создайте свой облик",
    "designIntro": "Перекрасьте модель и добавьте узор: у всех она отображается одинаково, файлы загружать не нужно.",
    "modeDesign": "Дизайн",
    "modeUpload": "Загрузка",
    "modeLink": "Свой хостинг",
    "uploadIntro": "Загрузите собственный PNG-атлас 1024x1024. Мы закрепим его в IPFS и разместим у себя.",
    "linkIntro": "Укажите ссылку на PNG-атлас на вашем хостинге. Мы проксируем его, и покупатели не увидят ваш URL. Бесплатно.",
    "uploadFile": "Skin PNG (1024x1024)",
    "linkUrl": "URL атласа",
    "quotaMeter": "Занято слотов хостинга: {used}/{quota}",
    "trustedBadge": "Проверенный автор (публикация без ожидания)",
    "selfHostedFreeNote": "Свой хостинг бесплатен и не ограничен (в пределах лимита лотов).",
    "hostingUnavailable": "Загрузка на наш хостинг временно недоступна.",
    "listedReview": "Отправлено на проверку: лот появится после одобрения оператором.",
    ...
    "randomize": "Случайно",
    "nameLabel": "Name",
    "namePlaceholder": "например, Изумрудная драконья чешуя",
    "descLabel": "Описание",
    "descPlaceholder": "Короткое описание, которое увидят покупатели",
    "priceLabel": "Цена (USDC)",
    "preview": "Предпросмотр",
    "list": "Выставить на продажу",
    "listing": "Выставляем…",
    "listed": "Лот выставлен и уже в продаже. Наденьте облик из своей коллекции.",
    "listFailed": "Не удалось выставить лот",
    "listConnectFirst": "Подключите кошелек, чтобы выставить лот (вы получаете 70%).",
    "payoutHint": "Вы получаете 70% • 30% идет на выкуп и сжигание $WOC",
    "patterns": {
      "solid": "Однотонный",
      "scales": "Чешуя",
      "stripes": "Полосы",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "skin_artisan": {
        "name": "Пип, мастер обликов",
        "title": "Витрина авторских обликов",
        "greeting": "Хотите сменить образ, {className}? Посмотрите косметические облики от игроков или создайте и продайте собственный. Оплата в USDC; часть выручки идет на выкуп и сжигание $WOC."
      },
      "marshal_redbrook": {
        "name": "Маршал Редбрук",
