...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "finder": {
      ...
      "raidCurrenciesNormal": "+{fragments} Фрагмент Бессмертия каждому участнику",
      "raidCurrenciesHeroic": "+{fragments} Фрагмента Бессмертия и +{marks} Героических знака каждому участнику",
  ...
  "heroicShop": {
    ...
    "tabsAria": "Услуги интенданта",
    "fragmentBalance": "Фрагменты Бессмертия: {count}",
    "tab": {
      "gear": "Героическое снаряжение",
      "forge": "Кузня Бессмертия",
      "tune": "Настройка легендарного"
    },
    "gearIntro": "Тратьте Героические знаки на обычный ассортимент интенданта.",
    ...
    "tuneEmpty": "В сумках нет подходящей легендарной вещи Никсраксиса.",
    "heroicClearReady": "Героическое убийство Никсраксиса подтверждено для текущей суточной блокировки.",
    "heroicClearNeeded": "Для героических целей требуется убийство Никсраксиса в текущей суточной блокировке.",
    "itemLevel": "Уровень предмета {level}",
    "cost": "{fragments} Фрагментов Бессмертия · {marks} Героических знаков",
    "randomAffixes": "Случайные свойства и значения",
    "deterministicStats": "Фиксированная авторская награда",
    "raidForgedGuarantee": "Рейдовая ковка, гарантирован бросок из верхней половины",
    "raidForged": "Рейдовая ковка",
    "raidDrop": "Рейдовая легендарная награда Никсраксиса",
    "reforgeCount": "Настроек: {count}",
    "forgeKind": {
      "normal_procedural": "Обычный процедурный эпический предмет",
      "heroic_procedural": "Героический процедурный эпический предмет",
      "signature": "Особая героическая легендарная награда",
      "authored": "Авторская целевая награда"
    },
    "blocked": {
      "class": "Не подходит вашему классу",
      "heroic_clear": "Требуется текущее героическое убийство Никсраксиса",
      "fragments": "Недостаточно Фрагментов Бессмертия",
      "marks": "Недостаточно Героических знаков"
    },
    "forgeConfirmTitle": "Подтвердить ковку",
    "forgeConfirmBody": "Выковать {item} за {fragments} Фрагментов Бессмертия и {marks} Героических знаков? Сервер создаст предмет после проверки оплаты.",
    "forgeConfirmAccept": "Выковать",
    "tuneConfirmTitle": "Подтвердить настройку легендарного",
    "tuneConfirmBody": "Настроить именно этот экземпляр {item} за {fragments} Фрагментов Бессмертия и {marks} Героических знаков? Сохранится лучший из двух бросков; сила не снизится, но может остаться прежней.",
    "tuneConfirmAccept": "Настроить",
    "status": {
      "pending": "Ожидание ответа сервера…",
      "gear": "Покупка завершена. Баланс обновлён.",
      "forge": "Ковка завершена. Новая награда уже в сумках.",
      "tune": "Настройка завершена. Выбранный предмет и баланс обновлены."
    }
  },
  "cardDuel": {
