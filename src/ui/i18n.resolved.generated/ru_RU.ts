...
export const ru_RU: EnTranslations = {
  ...
  "game": {
    ...
    "talents": {
      ...
      "available": "Доступно",
      "spent": "Потрачено",
      "pointSource": "Ряды выбора открываются с {first} по {cap} уровень. Выберите один вариант в каждом открытом ряду.",
      ...
      "createBuildHint": "Новый билд сохраняет текущий выбор отдельно. Импорт вставляет общую строку.",
      ...
      "unlockHint": "Варианты талантов доступны: нажмите N, чтобы открыть Таланты.",
      "copy": "Копировать",
      "close": "Закрыть",
      "cancel": "Отмена",
      ...
      "readout": {
        ...
        "specLocked": " Специализации открываются на {level} уровне.",
  ...
  "guide": {
    ...
    "talentsPage": {
      ...
      "intro": "Таланты позволяют настроить класс под себя. Они необязательны, гибки и легко меняются, поэтому можно экспериментировать без страха.",
      "whatHeading": "Что дают таланты",
      "whatBody": "С повышением уровня открываются ряды талантов с небольшим набором вариантов. Каждый выбор дает постоянное улучшение способностей, характеристик или набора приемов и меняет ощущение класса в бою.",
      "howHeading": "Как они работают",
      "howBody": "Ряды открываются по мере роста уровня, а специализации доступны с 10 уровня. Выберите специализацию ради ключевой способности и мастерства, затем на вкладке вариантов выберите по одному варианту из каждого открытого ряда.",
      "shareNote": "Готовый билд можно скопировать как короткий код и передать другу, который вставит его прямо в свою панель талантов.",
      "resetTitle": "Ничего не навсегда",
      "resetNote": "Вне боя можно в любой момент сбросить выбор, так что раннее решение никогда не станет ловушкой. Пробуйте варианты, находите любимые и свободно меняйте мнение.",
      "specsHeading": "Специализации по классам",
      "specsBody": "У каждого класса есть несколько специализаций, каждая со своей ролью и ключевым фокусом. Здесь показана их общая форма. Откройте класс, чтобы увидеть весь набор."
    },
    "arenaPage": {
      "heading": "Арена и PvP",
  ...
  "entities": {
    "abilities": {
      ...
      "heroic_leap": {
        ...
        "description": "Прыжок в выбранную область, наносящий {damage} физического урона ближайшим врагам. (Талант воина)"
      },
      "pummel": {
        "name": "Зуботычина",
        "description": "Прерывает произнесение заклинания и не дает применять заклинания этой школы 4 сек. (Талант воина)"
      },
      "shield_wall": {
        "name": "Глухая оборона",
        "description": "Вы поднимаете щитовую стену, значительно повышая броню на 10 сек. (Талант воина)"
      },
      "last_stand": {
        "name": "Ни шагу назад",
      ...
      "bladestorm": {
        "name": "Вихрь клинков",
        "description": "Вы становитесь бурей стали и каждую секунду поражаете ближайших врагов на {damage}. (Талант воина)"
      },
      "avatar": {
        "name": "Аватара",
      ...
      "rallying_cry": {
        ...
        "description": "Вы издаете ободряющий клич, повышая силу атаки ближайших союзников на 10 сек. (Талант воина)"
      },
      "counterspell": {
        "name": "Антимагия",
        "description": "Прерывает вражеское заклинание и не дает применять заклинания этой школы 6 сек. (Талант мага)"
      },
      "ice_lance": {
        "name": "Ледяное копье",
        "description": "Метает осколок льда, наносящий {damage} урона от магии льда. Наносит тройной урон обездвиженным целям."
      },
      "presence_of_mind": {
        "name": "Величие разума",
        "description": "Ваше следующее заклинание со временем произнесения становится мгновенным. Длится 60 сек. (Талант мага)"
      },
      "blink": {
        "name": "Скачок",
        "description": "Телепортирует вас на 15 м вперед и снимает эффекты корней. (Талант мага)"
      },
      "ice_block": {
        "name": "Ледяная глыба",
        "description": "Заключает вас в лед, поглощая огромное количество урона в течение 8 сек. (Талант мага)"
      },
      "deep_freeze": {
        "name": "Глубокая заморозка",
        "description": "Глубоко замораживает цель, наносит {damage} урона от магии льда и оглушает на 4 сек. (Талант мага)"
      },
      "meteor": {
        "name": "Метеор",
        "description": "Обрушивает метеор на выбранную область, наносит {damage} урона от огня и поджигает землю. (Талант мага)"
      },
      "evocation": {
        "name": "Прилив сил",
        "description": "Быстро восстанавливает ману. (Талант мага)"
      },
      "rebuke": {
        "name": "Укор",
        "description": "Прерывает произнесение заклинания и не дает применять заклинания этой школы 4 сек. (талант паладина)"
      },
      "crusader_strike": {
      ...
      "holy_wrath": {
        "name": "Гнев Света",
        "description": "Высвобождает силу Света, нанося ближайшим врагам {damage} ед. урона. (талант паладина)"
      },
      "divine_shield": {
        "name": "Божественный щит",
        "description": "Окутывает вас силой Света и поглощает огромный урон в течение 8 сек. (талант паладина)"
      },
      "avenging_wrath": {
        "name": "Гнев карателя",
      ...
      "hammer_of_wrath": {
        "name": "Молот гнева",
        "description": "Метает священный молот в раненого противника, нанося {damage} ед. урона от светлой магии. Можно использовать только против целей с менее чем 20% здоровья. (талант паладина)"
      },
      "counter_shot": {
        "name": "Ответный выстрел",
        "description": "Прерывает произнесение заклинания и не дает применять заклинания этой школы 4 сек. (талант охотника)"
      },
      "frost_trap": {
        "name": "Ледяная ловушка",
        "description": "Сковывает врагов в указанной области на 3 сек. (талант охотника)"
      },
      "mend_pet": {
        "name": "Лечение питомца",
        "description": "Исцеляет дружественную цель на {damage} ед. за 15 сек. (талант охотника)"
      },
      "multi_shot": {
        "name": "Залп",
        "description": "Выпускает несколько стрел, нанося ближайшим врагам {damage} ед. урона. (талант охотника)"
      },
      "deterrence": {
        "name": "Сдерживание",
        "description": "Повышает вероятность уклонения на 50% на 10 сек. (талант охотника)"
      },
      "aspect_of_the_wild": {
        "name": "Дух дикой природы",
        "description": "Вдохновляет ближайших союзников дикой силой, повышая силу атаки на 5 мин. (талант охотника)"
      },
      "kick": {
        "name": "Пинок",
        "description": "Прерывает произнесение заклинания и не дает применять заклинания этой школы 4 сек. (талант разбойника)"
      },
      "preparation": {
        "name": "Подготовка",
        "description": "Завершает восстановление Спринта, Ускользания и Исчезновения. (талант разбойника)"
      },
      "ghostly_strike": {
        "name": "Призрачный удар",
        "description": "Бьет врага, нанося урон оружием плюс {damage} ед. урона, и ненадолго повышает уклонение. Дает 1 прием серии. (талант разбойника)"
      },
      "cloak_of_shadows": {
        "name": "Плащ теней",
      ...
      "shadowstep": {
        ...
        "description": "Позволяет шагнуть сквозь тени к цели. (талант разбойника)"
      },
      "silence": {
        "name": "Безмолвие",
        "description": "Накладывает на цель немоту на 4 сек. (талант жреца)"
      },
      "psychic_scream": {
        "name": "Ментальный крик",
        "description": "Пугает ближайших врагов на время до 4 сек. Урон может развеять эффект. (талант жреца)"
      },
      "inner_focus": {
        "name": "Внутреннее сосредоточение",
        "description": "Следующее заклинание не требует ресурса. Длится 60 сек. (талант жреца)"
      },
      "desperate_prayer": {
        "name": "Молитва отчаяния",
        "description": "Мгновенно исцеляет вас на {damage}. (талант жреца)"
      },
      "prayer_of_healing": {
        "name": "Молитва исцеления",
        "description": "Исцеляет ближайших союзников на {damage}. (талант жреца)"
      },
      "mind_sear": {
        "name": "Иссушение разума",
        "description": "Направляет энергию Тьмы в выбранную область, каждую секунду нанося ближайшим противникам {damage} ед. урона. (талант жреца)"
      },
      "earthbind": {
        "name": "Оковы земли",
        "description": "Сковывает ближайших врагов землей, обездвиживая их на 2 сек. (талант шамана)"
      },
      "healing_stream": {
        "name": "Целительный поток",
        "description": "Восстанавливает здоровье дружественной цели в течение 12 сек. (талант шамана)"
      },
      "chain_lightning": {
        "name": "Цепная молния",
        "description": "Бросает молнию в выбранную область, нанося ближайшим врагам {damage} ед. урона от сил природы. (талант шамана)"
      },
      "bloodlust": {
        "name": "Жажда крови",
        "description": "Вводит ближайших союзников в боевой раж, повышая скорость атаки на 15 сек. (талант шамана)"
      },
      "spell_lock": {
        "name": "Запрет чар",
        "description": "Прерывает применение заклинания и запрещает эту школу магии на 5 сек. (талант чернокнижника)"
      },
      "howl_of_terror": {
        "name": "Вой ужаса",
        "description": "Повергает ближайших врагов в страх на срок до 3 сек. Урон может прервать эффект. (талант чернокнижника)"
      },
      "curse_of_exhaustion": {
      ...
      "death_coil": {
        "name": "Лик смерти",
        "description": "Поражает противника, нанося {damage} ед. урона от темной магии, затем повергает его в ужас на 3 сек. Эта версия не исцеляет заклинателя. (талант чернокнижника)"
      },
      "chaos_bolt": {
        "name": "Стрела хаоса",
        "description": "Запускает стрелу хаотического огня, нанося {damage} ед. урона от огня. (талант чернокнижника)"
      },
      "metamorphosis": {
        "name": "Метаморфоза",
      ...
      "skull_bash": {
        "name": "Удар черепом",
        "description": "Прерывает применение заклинания и запрещает эту школу магии на 4 сек. (талант друида)"
      },
      "innervate": {
        "name": "Озарение",
      ...
      "frenzied_regeneration": {
        ...
        "description": "Восстанавливает здоровье в течение 10 сек. Только в облике медведя. (талант друида)"
      },
      "berserk": {
        "name": "Берсерк",
      ...
      "cone_of_cold": {
        "name": "Конус холода",
        "description": "Поражает ближайших врагов холодом, нанося {damage} ед. урона от магии льда. (талант мага)"
      },
      "cold_blood": {
        "name": "Хладнокровие",
