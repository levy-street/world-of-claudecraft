...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "defense": {
      "start": "Держать строй! Защитники готовятся к натиску.",
      "wave": "Волна {wave} из {total} отбита!",
      "won": "Позиция удержана. Отличный бой.",
      "lost": "Защитники пали. Соберитесь и попробуйте снова."
    },
    "escort": {
      "start": "Сопровождение выступило. Держитесь рядом.",
      "paused": "Ваш подопечный ждёт: рядом некому охранять дорогу.",
      "resumed": "Сопровождение снова в пути.",
      "failed": "Ваш подопечный пал. Дорога забрала ещё одного.",
      "done": "Благополучное прибытие. Подопечный благодарит вас."
    },
    "envoys": {
      "title": "Зал Посланников",
      "prompt": "Выберите фракцию и народ, с которым встанете плечом к плечу.",
      "permanent": "Эта клятва навсегда. Фракция определяет ваш дом, союзников и врагов в вечной войне.",
      "confirm": "Принести клятву",
      "travelTitle": "Переправа",
      "travelBody": "Отправиться сейчас? Переход мгновенный.",
      "travelGo": "В путь",
      "travelStay": "Остаться"
    },
    "map": {
      "worldTitle": "Валдрис: известный мир",
      "theLanding": "Пристань",
    ...
    "worldBoss": {
      ...
      "rises": "{name} поднимается: {location}!"
    },
    "loot": {
      "chestTitle": "Сундук"
    },
  ...
  "guide": {
    ...
    "family": {
      "demon": {
        "name": "Демоны",
        "desc": "Порождения ужаса, связанные Разломом и искусством призыва. Большинство служит чернокнижнику, свободные служат чему-то похуже."
      },
      "beast": {
        "name": "Звери",
    ...
    "viewer": {
      ...
      "playClip": "Воспроизвести анимацию {name}",
  ...
  "races": {
    "sectionTitle": "Фракция и раса",
    "factionKael": "Империя Каэль",
    "factionVeth": "Конфедерация Вет",
    "factionOssara": "Владения Оссары",
    "human": "Человек",
    "dwarf": "Дворф",
    "gnome": "Гном",
    "elf_exile": "Изгнанный эльф",
    "elf": "Эльф",
    "dark_fae": "Тёмная фея",
    "frost_kin": "Морозный род",
    "shadow_walker": "Тенеход",
    "desert_clan": "Клан пустыни",
    "sand_mage": "Песчаный маг",
    "nomad": "Кочевник",
    "stone_warden": "Каменный страж",
    "humanAria": "Раса: Человек",
    "dwarfAria": "Раса: Дворф",
    "gnomeAria": "Раса: Гном",
    "elf_exileAria": "Раса: Изгнанный эльф",
    "elfAria": "Раса: Эльф",
    "dark_faeAria": "Раса: Тёмная фея",
    "frost_kinAria": "Раса: Морозный род",
    "shadow_walkerAria": "Раса: Тенеход",
    "desert_clanAria": "Раса: Клан пустыни",
    "sand_mageAria": "Раса: Песчаный маг",
    "nomadAria": "Раса: Кочевник",
    "stone_wardenAria": "Раса: Каменный страж",
    "raceLabel": "Раса",
    "racialLabel": "Расовая особенность",
    "levelRaceClass": "{level}-й уровень, {race} {className}",
    "racialName_human": "Обет Высадки",
    "racialDesc_human": "Отдых накапливает опыт на 25% быстрее.",
    "racialName_dwarf": "Каменная кровь",
    "racialDesc_dwarf": "Броня увеличена на 5%.",
    "racialName_gnome": "Шестеренная смекалка",
    "racialDesc_gnome": "Интеллект увеличен на 5%.",
    "racialName_elf_exile": "Дисциплина изгнанника",
    "racialDesc_elf_exile": "Сбой чтения заклинаний снижен на 20%.",
    "racialName_elf": "Сумеречная грация",
    "racialDesc_elf": "Шанс уклонения увеличен на 1%.",
    "racialName_dark_fae": "Хитрость фей",
    "racialDesc_dark_fae": "Шанс критического удара увеличен на 1%.",
    "racialName_frost_kin": "Зимняя шкура",
    "racialDesc_frost_kin": "Выносливость увеличена на 3%.",
    "racialName_shadow_walker": "Бесшумный клинок",
    "racialDesc_shadow_walker": "Ловкость увеличена на 3%.",
    "racialName_desert_clan": "Закаленный солнцем",
    "racialDesc_desert_clan": "Максимальный запас здоровья увеличен на 3%.",
    "racialName_sand_mage": "Стеклянный резонанс",
    "racialDesc_sand_mage": "Сила заклинаний увеличена на 5%.",
    "racialName_nomad": "Бесконечный переход",
    "racialDesc_nomad": "Дух увеличен на 5%.",
    "racialName_stone_warden": "Мощь каменоломни",
    "racialDesc_stone_warden": "Сила увеличена на 3%."
  },
  "controls": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "dune_prowler_pelt": {
        "name": "Шкура рыскателя дюн"
      },
      "glasswind_stinger": {
        "name": "Жало стеклянного ветра"
      },
      "stolen_relic": {
        "name": "Украденная реликвия"
      },
      "nameless_burial_shroud": {
        "name": "Безымянный погребальный саван"
      },
      "storm_glass_core": {
        "name": "Ядро грозового стекла"
      },
      "verdict_seal": {
        "name": "Печать вердикта"
      },
      "glasswind_husk": {
        "name": "Панцирь стеклянного ветра"
      },
      "mirage_stalker_eye": {
        "name": "Глаз миражного ловчего"
      },
      "dig_manifest": {
        "name": "Раскопочная опись"
      },
      "tomb_censer": {
        "name": "Гробничная кадильница"
      },
      "sentence_tablet": {
        "name": "Скрижаль приговора"
      },
      "duststorm_heart": {
        "name": "Сердце пыльной бури"
      },
      "ravager_hide": {
        "name": "Шкура разорителя"
      },
      "aqueduct_bronze": {
        "name": "Бронзовая скоба акведука"
      },
      "judge_regalia": {
        "name": "Регалии Первого суда"
      },
      "sunbleached_fang": {
        "name": "Выбеленный солнцем клык"
      },
      "cracked_scarab_shell": {
        "name": "Треснувший панцирь скарабея"
      },
      "emberjaw_pelt": {
        "name": "Шкура матриарха Углепастых"
      },
      "karns_funeral_mask": {
        "name": "Погребальная маска Карна"
      },
      "qesh_flatbread": {
        "name": "Кешская лепешка"
      },
      "oasis_waterskin": {
        "name": "Бурдюк из оазиса"
      },
      "spiced_scarab_skewer": {
        "name": "Пряный шашлык из скарабея"
      },
      "duneweave_robe": {
        "name": "Одеяние дюнного плетения"
      },
      "caravan_guard_hauberk": {
        "name": "Кольчуга караванного стража"
      },
      "prowlerhide_vest": {
        "name": "Жилет из шкуры рыскателя"
      },
      "sandwalker_treads": {
        "name": "Ступни песчаного странника"
      },
      "dunewatch_legguards": {
        "name": "Поножи дюнного дозора"
      },
      "qesh_khopesh": {
        "name": "Кешский хопеш"
      },
      "judgestaff_of_ossara": {
        "name": "Посох судьи Оссары"
      },
      "glasswind_talon": {
        "name": "Коготь стеклянного ветра"
      },
      "emberjaw_prowlgrips": {
        "name": "Охотничьи хваты Углепастой"
      },
      "unburied_gravewraps": {
        "name": "Могильные обмотки Непогребенного"
      },
      "sandmaw_scale_cuirass": {
        "name": "Чешуйчатая кираса Песчаной Пасти"
      },
      "tyrantfang_edge": {
        "name": "Клинок Клык Тирана"
      },
      "palewidow_silk": {
        "name": "Шелк бледной вдовы"
      },
      "waterlogged_ledger": {
        "name": "Промокшая учетная книга"
      },
      "guildless_sigil": {
        "name": "Знак безгильдейных"
      },
      "silent_court_seal": {
        "name": "Печать Безмолвного суда"
      },
      "duskmane_pelt_strip": {
        "name": "Полоска шкуры сумеречногривого"
      },
      "palewidow_venom_sac": {
        "name": "Ядовитая железа бледной вдовы"
      },
      "quay_manifest": {
        "name": "Промокшая опись причала"
      },
      "wisplight_essence": {
        "name": "Эссенция блуждающего огонька"
      },
      "drowned_toll_coin": {
        "name": "Утопленная дорожная монета"
      },
      "cutthroat_contract": {
        "name": "Контракт головореза"
      },
      "court_ledger_page": {
        "name": "Страница судовой книги"
      },
      "frostpine_war_totem": {
        "name": "Военный тотем Морозной Сосны"
      },
      "rimeclaw_pelt": {
        "name": "Шкура инеекогтя"
      },
      "duskmane_tuft": {
        "name": "Клок сумеречной гривы"
      },
      "guttering_wisp_mote": {
        "name": "Пылинка гаснущего огонька"
      },
      "frostpine_charm": {
        "name": "Оберег Морозной Сосны"
      },
      "palefang_pelt": {
        "name": "Шкура Бледноклыка Безмолвного"
      },
      "grelnoks_frozen_idol": {
        "name": "Замерзший идол Грелнока"
      },
      "nighthollow_black_bread": {
        "name": "Черный хлеб Ночной Лощины"
      },
      "pinefrost_tea": {
        "name": "Чай сосновой изморози"
      },
      "smoked_blackmere_eel": {
        "name": "Копченый угорь Черного озера"
      },
      "wispweave_robe": {
        "name": "Одеяние огоньковых нитей"
      },
      "quayguard_hauberk": {
        "name": "Кольчуга причального стража"
      },
      "duskstalker_vest": {
        "name": "Жилет сумеречного ловчего"
      },
      "nightpath_treads": {
        "name": "Ступни ночной тропы"
      },
      "blackriver_legguards": {
        "name": "Поножи Черной реки"
      },
      "terracewatch_leggings": {
        "name": "Штаны террасного дозора"
      },
      "quays_cutlass": {
        "name": "Причальный тесак"
      },
      "wispcaller_staff": {
        "name": "Посох зовущего огоньки"
      },
      "whispersteel_stiletto": {
        "name": "Стилет шепчущей стали"
      },
      "palefang_grips": {
        "name": "Хваты Бледноклыка"
      },
      "hoarbound_bindings": {
        "name": "Путы Скованного инеем"
      },
      "forsworn_lamellar": {
        "name": "Ламеллярная кираса Клятвопреступника"
      },
      "forsworn_edge": {
        "name": "Клинок Клятвопреступника"
      },
      "stolen_tithe_ledger": {
        "name": "Украденная десятинная книга"
      },
      "granite_core_shard": {
        "name": "Осколок гранитного ядра"
      },
      "legion_deserter_insignia": {
        "name": "Знак легионного дезертира"
      },
      "chewed_tithe_scrip": {
        "name": "Изжеванная десятинная расписка"
      },
      "candle_tax_tally": {
        "name": "Бирка свечного налога"
      },
      "assay_office_seal": {
        "name": "Печать пробирной палаты"
      },
      "legion_pay_manifest": {
        "name": "Платежная ведомость легиона"
      },
      "prime_wolf_pelt": {
        "name": "Отборная волчья шкура"
      },
      "wendigo_gallstone": {
        "name": "Желчный камень вендиго"
      },
      "icehowler_ruff": {
        "name": "Загривок ледяного ревуна"
      },
      "legion_quarrel_bundle": {
        "name": "Связка легионных болтов"
      },
      "clipped_imperial_coin": {
        "name": "Обрезанная имперская монета"
      },
      "rimewoven_hide": {
        "name": "Инеетканая шкура"
      },
      "sellsword_pig_iron": {
        "name": "Наемничий чугун"
      },
      "lean_wolf_haunch": {
        "name": "Постный волчий окорок"
      },
      "pilfered_ration_pack": {
        "name": "Стянутый паек"
      },
      "sellsword_requisition_chit": {
        "name": "Реквизиционная расписка наемника"
      },
      "frostbrush_wolf_fang": {
        "name": "Волчий клык Морозной Чащи"
      },
      "bent_legion_buckle": {
        "name": "Погнутая легионная пряжка"
      },
      "ogre_knuckle_dice": {
        "name": "Кости из огрских костяшек"
      },
      "hoarfang_pelt": {
        "name": "Шкура вожака Инееклыков"
      },
      "kazriks_brass_whistle": {
        "name": "Латунный свисток Казрика"
      },
      "kaelspire_barley_loaf": {
        "name": "Ячменный каравай Шпиля Каэля"
      },
      "silverbrook_spring_water": {
        "name": "Родниковая вода Серебряного ручья"
      },
      "imperial_field_ration": {
        "name": "Имперский полевой паек"
      },
      "imperial_clerks_robe": {
        "name": "Одеяние имперского писаря"
      },
      "kael_infantry_hauberk": {
        "name": "Кольчуга каэльской пехоты"
      },
      "wolfsward_hunting_jerkin": {
        "name": "Охотничья куртка Волчьей Стражи"
      },
      "tithe_road_marchboots": {
        "name": "Походные сапоги Десятинного тракта"
      },
      "imperial_marcher_legguards": {
        "name": "Поножи имперского маршевика"
      },
      "kael_arming_sword": {
        "name": "Каэльский боевой меч"
      },
      "frosthelm_warstaff": {
        "name": "Боевой посох Морозного Шлема"
      },
      "wolfsward_skinner": {
        "name": "Свежеватель Волчьей Стражи"
      },
      "prefects_sealed_mantle": {
        "name": "Запечатанная мантия префекта"
      },
      "huntmasters_winter_hood": {
        "name": "Зимний капюшон ловчего мастера"
      },
      "hoarfang_clawgrips": {
        "name": "Когтистые хваты Инееклыка"
      },
      "overseers_candlewraps": {
        "name": "Свечные обмотки надзирателя"
      },
      "oathbreakers_battleplate": {
        "name": "Боевой доспех Клятволома"
      },
      "oathbreakers_greatblade": {
        "name": "Великий клинок Клятволома"
      },
      "grey_shale_chip": {
        "name": "Осколок серого сланца"
      },
      "smuggled_trinket": {
        "name": "Контрабандная безделушка"
      },
      "barbed_thorn_husk": {
        "name": "Шипастая колючая скорлупа"
      },
      "thornfen_tusk": {
        "name": "Бивень тролля Терновой Топи"
      },
      "torn_caravan_banner": {
        "name": "Разорванное караванное знамя"
      },
      "ironpass_rubble_core": {
        "name": "Ядро обломков Железного перевала"
      },
      "wyvern_tail_barb": {
        "name": "Шип виверньего хвоста"
      },
      "reagent_gland": {
        "name": "Разбухшая от реагентов железа"
      },
      "fogged_lantern_glass": {
        "name": "Запотевшее фонарное стекло"
      },
      "river_worn_idol": {
        "name": "Обточенный рекой идол"
      },
      "gull_picked_bone": {
        "name": "Обклеванная чайками кость"
      },
      "underway_hardtack": {
        "name": "Сухарь Подземного пути"
      },
      "smugglers_black_brew": {
        "name": "Черное варево контрабандиста"
      },
      "thornberry_loaf": {
        "name": "Каравай терновых ягод"
      },
      "palisade_pine_tea": {
        "name": "Сосновый чай Частокола"
      },
      "tollhouse_stew": {
        "name": "Похлебка Дорожной заставы"
      },
      "ironpass_mulled_cider": {
        "name": "Пряный сидр Железного перевала"
      },
      "lanternfen_eel_skewer": {
        "name": "Шашлык из угря Фонарной топи"
      },
      "fogberry_tonic": {
        "name": "Тоник из туманных ягод"
      },
      "bridgewatch_rations": {
        "name": "Пайки Мостового дозора"
      },
      "nameless_river_water": {
        "name": "Вода безымянной реки"
      },
      "smuggler_kings_softsteps": {
        "name": "Мягкоступы Короля контрабандистов"
      },
      "briarfather_bark_mitts": {
        "name": "Коряные рукавицы Тернового Отца"
      },
      "skarns_war_harness": {
        "name": "Боевая упряжь Скарна"
      },
      "colossus_mireheart_girdle": {
        "name": "Пояс Сердце Трясины"
      },
      "bridgekeepers_tollstaff": {
        "name": "Дорожный посох Хранителя моста"
      },
      "melted_ration_tin": {
        "name": "Оплавленная жестянка пайка"
      },
      "ashcaked_fang": {
        "name": "Пеплом покрытый клык"
      },
      "ember_glass_shard": {
        "name": "Осколок уголькового стекла"
      },
      "saltglass_shard": {
        "name": "Осколок соляного стекла"
      },
      "salt_crusted_chitin": {
        "name": "Соленый хитин"
      },
      "bleached_bone_charm": {
        "name": "Оберег из выбеленной кости"
      },
      "tarnished_prewar_coin": {
        "name": "Потускневшая довоенная монета"
      },
      "sewer_silk_wad": {
        "name": "Моток канализационного шелка"
      },
      "gutter_hound_pelt": {
        "name": "Шкура сточного пса"
      },
      "cracked_salamander_scale": {
        "name": "Треснувшая чешуя саламандры"
      },
      "cooled_magma_bead": {
        "name": "Бусина остывшей магмы"
      },
      "slag_nugget": {
        "name": "Шлаковый самородок"
      },
      "rusted_deserter_badge": {
        "name": "Ржавый знак дезертира"
      },
      "redspire_rock_shard": {
        "name": "Осколок скалы Красного Шпиля"
      },
      "spire_stalker_claw": {
        "name": "Коготь шпилевого ловчего"
      },
      "cinderrest_ashcake": {
        "name": "Зольный пирог Угольного Привала"
      },
      "boiled_cistern_water": {
        "name": "Кипяченая вода из цистерны"
      },
      "brinehollow_salt_jerky": {
        "name": "Соленая вяленина Соленой Лощины"
      },
      "desalted_waterskin": {
        "name": "Бурдюк опресненной воды"
      },
      "gutter_stew": {
        "name": "Сточная похлебка Рынка изгнанников"
      },
      "black_market_tea": {
        "name": "Чай с черного рынка"
      },
      "forgefall_hardtack": {
        "name": "Сухарь Павшей Кузни"
      },
      "coalfire_stout": {
        "name": "Углеогненный стаут"
      },
      "waymeet_marching_bread": {
        "name": "Походный хлеб Последней Стоянки"
      },
      "bitterroot_brew": {
        "name": "Варево из горького корня"
      },
      "revenant_cinderguard": {
        "name": "Пеплостраж восставшего"
      },
      "marrowhide_leggings": {
        "name": "Штаны из мозговой шкуры"
      },
      "scavenger_kings_shiv": {
        "name": "Заточка Короля мусорщиков"
      },
      "forgewyrm_scale_helm": {
        "name": "Чешуйчатый шлем кузнечного змея"
      },
      "mantle_of_the_last_muster": {
        "name": "Мантия Последнего Сбора"
      },
      "scorched_banner_scrap": {
        "name": "Обгоревший лоскут знамени"
      },
      "melted_signet_ring": {
        "name": "Оплавленный перстень"
      },
      "cracked_horror_horn": {
        "name": "Треснувший рог ужаса"
      },
      "bastion_hardtack": {
        "name": "Бастионный сухарь"
      },
      "trucewater_flask": {
        "name": "Фляга перемирной воды"
      },
      "ashguard_robe": {
        "name": "Пеплостражное одеяние"
      },
      "breachwalker_jerkin": {
        "name": "Куртка ходока Бреши"
      },
      "bastion_plated_hauberk": {
        "name": "Бастионная усиленная кольчуга"
      },
      "bastion_arming_sword": {
        "name": "Бастионный боевой меч"
      },
      "mercenary_greatblade": {
        "name": "Наемничий великий клинок"
      },
      "tithe_collectors_grasps": {
        "name": "Хваты сборщика десятины"
      },
      "craterheart_mantle": {
        "name": "Мантия Сердце Кратера"
      },
      "butchers_chainguard": {
        "name": "Цепной доспех Мясника"
      },
      "vhorlans_flensing_blade": {
        "name": "Свежевальный клинок Ворлана"
      },
      "warbringers_hellforged_cuirass": {
        "name": "Адски кованная кираса Вестника войны"
      },
      "khorvax_warcleaver": {
      ...
      "forged_levy_papers": {
        "name": "Поддельные призывные бумаги"
      },
      "amnesty_petition": {
        "name": "Незарегистрированное прошение об амнистии"
      },
      "fort_pattern_kettle": {
        "name": "Котелок фортового образца"
      },
      "garnished_pay_pouch": {
        "name": "Арестованный кошель с жалованьем"
      },
      "fault_line_core": {
        "name": "Ядро разлома"
      },
      "unstamped_duel_permit": {
        "name": "Незаверенное дуэльное разрешение"
      },
      "rimeclaw_tallow": {
        "name": "Жир инеекогтя"
      },
      "rimeclaw_marrowbone": {
        "name": "Мозговая кость инеекогтя"
      },
      "oathguard_plate_scrap": {
        "name": "Обломок лат Стража Клятвы"
      },
      "ninth_muster_roll": {
        "name": "Спасённый список призыва"
      },
      "icehowler_haunch": {
        "name": "Окорок ледового ревуна"
      },
      "rimebound_core_ice": {
        "name": "Скованный инеем сердцевинный лёд"
      },
      "glacial_quench_ice": {
        "name": "Лёд ледниковой закалки"
      },
      "maren_calling_card": {
        "name": "Визитная карточка дома Марен"
      },
      "maldreks_route_ledger": {
        "name": "Путевая книга Малдрека"
      },
      "grulks_iron_strongbox": {
        "name": "Железный сейф Грулка"
      },
      "maren_duelling_mantle": {
        "name": "Дуэльная мантия Марен"
      },
      "final_notice_wraps": {
        "name": "Обмотки последнего предупреждения"
      },
      "pay_wardens_shoulderguards": {
        "name": "Наплечники смотрителя жалованья"
      },
      "rimeshaft_foremans_cap": {
        "name": "Картуз десятника Раймшахты"
      },
      "quarter_close_vestments": {
        "name": "Облачение квартального закрытия"
      },
      "assessors_lead_greaves": {
        "name": "Свинцовые поножи оценщика"
      },
      "purse_wardens_coinbelt": {
        "name": "Монетный пояс смотрителя кошелей"
      },
      "mothwing_dust": {
        "name": "Пыльца мотыльковых крыльев"
      },
      "silt_eel": {
        "name": "Илистый угорь"
      },
      "barge_chit": {
        "name": "Размокший баржевый жетон"
      },
      "ferry_lantern_mote": {
        "name": "Искра паромного фонаря"
      },
      "smugglers_tally_knot": {
        "name": "Счётный узел контрабандиста"
      },
      "forged_weir_pass": {
        "name": "Поддельный пропуск через запруду"
      },
      "sunken_ration_tin": {
        "name": "Затонувшая банка пайка"
      },
      "hollow_toll_scrip": {
        "name": "Пустой дорожный вексель"
      },
      "rimeclaw_haunch": {
        "name": "Окорок инеекогтя"
      },
      "rimebound_fetish": {
        "name": "Скованный инеем фетиш"
      },
      "frostpine_tallow": {
        "name": "Жир морозной сосны"
      },
      "forsworn_oath_knife": {
        "name": "Клятвенный нож Отрёкшихся"
      },
      "shadowbound_cipher": {
        "name": "Тенескованный шифр"
      },
      "vessiks_little_book": {
        "name": "Книжица Вессика"
      },
      "weirwatch_wraps": {
        "name": "Обмотки стражи запруды"
      },
      "lodgewalk_boots": {
        "name": "Сапоги Приюта"
      },
      "unbroken_wardstone": {
        "name": "Целый охранный камень"
      },
      "vault_ward_core": {
        "name": "Охранное ядро хранилища"
      },
      "temple_offering_bowl": {
        "name": "Храмовая чаша подношений"
      },
      "graven_name_stone": {
        "name": "Камень с высеченными именами"
      },
      "stalker_haunch": {
        "name": "Окорок ловчего"
      },
      "heretic_creed_page": {
        "name": "Обгоревшая страница символа веры"
      },
      "heretic_brand_iron": {
        "name": "Клеймо еретика"
      },
      "heretic_writ": {
        "name": "Еретический указ"
      },
      "first_court_sigil": {
        "name": "Печать Первого Суда"
      },
      "duneglass_heart": {
        "name": "Сердце дюнного стекла"
      },
      "unshattered_fulgurite": {
        "name": "Нерасколотый фульгурит"
      },
      "flameseer_ash_creed": {
        "name": "Скрижаль Пепельного Символа"
      },
      "flameseer_ember_phial": {
        "name": "Склянка углей"
      },
      "dawnward_censer": {
        "name": "Кадило Рассветной Стражи"
      },
      "stolen_water_cask": {
        "name": "Запечатанная бочка воды"
      },
      "duskwater_oathmark": {
        "name": "Клятвенный знак Сумеречных Вод"
      },
      "caravan_toll_tally": {
        "name": "Запечатанная пошлинная бирка"
      },
      "tyrant_spoor": {
        "name": "Слепок следа Тирана"
      },
      "oxbone_toll": {
        "name": "Пошлинная бирка из бычьей кости"
      },
      "cartographers_map": {
        "name": "Карта Первого Картографа"
      },
      "templestone_shard": {
        "name": "Осколок храмового камня"
      },
      "fulgurite_splinter": {
        "name": "Щепка фульгурита"
      },
      "charred_censer_chain": {
        "name": "Обугленная цепь кадила"
      },
      "wardens_stone_heart": {
        "name": "Каменное сердце Ашкерата"
      },
      "first_meridian_compass": {
        "name": "Компас Первого Меридиана"
      },
      "seatstone_flatbread": {
        "name": "Лепёшка Престола"
      },
      "seatwell_waterskin": {
        "name": "Бурдюк престольного колодца"
      },
      "lastwater_jerky": {
        "name": "Вяленое мясо Последней Воды"
      },
      "lastwater_skin": {
        "name": "Бурдюк Последней Воды"
      },
      "vaultkeepers_handwraps": {
        "name": "Наручи хранителя подвалов"
      },
      "sahrs_penitent_leggings": {
        "name": "Покаянные поножи Сахра"
      },
      "wardens_granite_edge": {
        "name": "Гранитная кромка Стража"
      },
      "staff_of_the_sunken_court": {
        "name": "Посох Затонувшего Суда"
      },
      "duneglass_shiv": {
        "name": "Заточка из дюнного стекла"
      },
      "lastwater_roadmail": {
        "name": "Дорожная кольчуга Последней Воды"
      },
      "duskwatch_robe": {
        "name": "Одеяние Сумеречного Дозора"
      },
      "raiders_dust_jerkin": {
        "name": "Пропылённая куртка налётчика"
      },
      "ashkerat_greaves": {
        "name": "Поножи Ашкерата"
      },
      "cartographers_windwraps": {
        "name": "Ветровые обмотки Картографа"
      },
      "unlit_silk_gland": {
        "name": "Беспросветная шёлковая железа"
      },
      "veskals_fang": {
        "name": "Клык Вескала"
      },
      "broodmother_carapace_guard": {
        "name": "Панцирный нагрудник Матери выводка"
      },
      "condensed_mist_heart": {
        "name": "Сгущённое сердце тумана"
      },
      "mistfathers_knot": {
        "name": "Узел Отца Туманов"
      },
      "fogwalker_treads": {
        "name": "Поступь туманохода"
      },
      "bristleback_maul": {
