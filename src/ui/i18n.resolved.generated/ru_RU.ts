...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bg": {
      ...
      "blurb": "Две разрушенные крепости смотрят друг на друга через обнесённую стеной лощину в тени Тернового пика: Багровые на юге, Лазурные на севере, а между ними старый Двор Руин, который так и не достался никому. Пятеро на пятеро, по одному знамени, и первый, кто пять раз донесёт чужое знамя домой, забирает поле.",
