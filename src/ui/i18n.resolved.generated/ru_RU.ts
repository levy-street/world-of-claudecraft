...
export const ru_RU: EnTranslations = {
  ...
  "sim": {
    "delve": {
      ...
      "eggSacBurst": "Яйцевой мешок лопается. Чёрная вода расплёскивается по краю крестильни.",
      "baptistryEggs": "Крестильня затихает. Яйцевые мешки вдов вздуваются вдоль края.",
  ...
  "delveUi": {
    ...
    "npc": {
      ...
      "aldric": {
        "greeting": "Фенбридж теперь слышит колокола под водой, {playerName}. Могилопризыватели учат утопленников петь. Выбери свой уровень, и я буду держать верёвку, пока ты не вернёшься."
      }
    },
    "intro": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "brother_aldric_watch": {
        ...
        "greeting": "Фенбридж теперь слышит колокола под водой. Могилопризыватели учат утопленников петь. Выбери свой уровень, и я буду держать верёвку, пока ты не вернёшься."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "delves": {
      ...
      "drowned_litany": {
        ...
        "enterText": "Вы спускаетесь под Фенбридж, в утонувшее святилище.",
        "leaveText": "Вы поднимаетесь обратно на дамбу Фенбриджа, к брату Алдрику."
      }
    },
    "itemSets": {
      "crownforged": {
