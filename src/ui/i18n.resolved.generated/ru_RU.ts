  ...
  "entities": {
    ...
    "items": {
      ...
      "frostveil_cairn_tarn": {
        "name": "Озёрный защитный курган"
      },
      "frostveil_cairn_fen": {
        "name": "Болотный защитный курган"
      },
      "frostveil_cairn_terrace": {
        "name": "Защитный курган террас"
      },
      "amberfall_lantern_orchard": {
        "name": "Садовый фонарь урожая"
      },
      "amberfall_lantern_mere": {
        "name": "Болотный фонарь урожая"
      },
      "amberfall_lantern_monolith": {
        "name": "Фонарь урожая у монолита"
      },
      "willowfen_marker_bogshine": {
        "name": "Тростниковая метка Светлых Луж"
      },
      "willowfen_marker_willowweep": {
        "name": "Тростниковая метка Плачущих Ив"
      },
      "willowfen_marker_drowsy": {
        "name": "Тростниковая метка Сонных Отмелей"
      },
      "nightbloom_anchor_moonwell": {
        "name": "Якорь сна Лунного Колодца"
      },
      "nightbloom_anchor_gloamfield": {
        "name": "Якорь сна Сумеречного Поля"
      },
      "nightbloom_anchor_barrow": {
        "name": "Якорь сна Кургана"
      },
      "galecrest_signal_downs": {
        "name": "Грозовой столб холмов"
      },
      "galecrest_signal_tarn": {
        "name": "Грозовой столб озера"
      },
      "galecrest_signal_wrecks": {
        "name": "Грозовой столб обломков"
      },
      "palmreach_waymark_strand": {
        "name": "Указатель Пальмового Берега"
      },
      "palmreach_waymark_vinefall": {
        "name": "Указатель Водопада Лоз"
      },
      "palmreach_waymark_lagoon": {
        "name": "Указатель Лагуны"
      },
      "conjured_water4": {
    ...
    "npcs": {
      ...
      "captain_kaelra": {
        "name": "Капитан Каэлра",
        "title": "Командир Драконьего Дозора",
        "greeting": "У Драконьего Дозора одна дорога и слишком много врагов, {className}. Пусть каждый шаг на север будет не напрасен."
      },
      "scout_vaela": {
        "name": "Разведчица Ваэла",
        "title": "Следопыт кальдеры",
        "greeting": "Дюны движутся, тролли нет, а драконы следят за всеми. Держись рядом, если хочешь пройти безопасно."
      },
      "matriarch_eira": {
        "name": "Матриарх Эйра",
        "title": "Голос Ледяной Мантии",
        "greeting": "Лёд помнит каждый след, {className}. Иди легко, слушай внимательно, и Морозная Завеса пропустит тебя."
      },
      "watcher_senn": {
        "name": "Дозорный Сенн",
        "title": "Страж сияния",
        "greeting": "Сияние прекрасно, потому что ты не слышишь его крика. Я слышу, и сегодня оно нас предупреждает."
      },
      "reeve_elowen": {
        "name": "Староста Элоуэн",
        "title": "Хранительница Фонарной Топи",
        "greeting": "Янтарная Долина щедра, пока кто-то не забудет поблагодарить. В этом сезоне старые долги ожили."
      },
      "orchard_keeper_bram": {
        "name": "Садовник Брам",
        "title": "Хранитель золотых ветвей",
        "greeting": "Берегись упавших плодов. У духов есть зубы, у лис манеры, и оба вида обчистят тебя."
      },
      "mayor_alda": {
        "name": "Мэр Альда",
        "title": "Голос Мостовой Топи",
        "greeting": "Топь дружелюбна, если знаешь, где она спит. Но теперь она просыпается не там, где надо, {className}."
      },
      "fenward_oli": {
        "name": "Болотный страж Оли",
        "title": "Хранитель тростниковых меток",
        "greeting": "Ступай туда, куда гнётся камыш, а не куда указывает. Одна тропа ведёт домой, другая кормит жаб."
      },
      "dreamkeeper_luma": {
        "name": "Хранительница снов Лума",
        "title": "Страж Лунного Покоя",
        "greeting": "Ночноцвет не спит, {className}. Он видит сон, и сегодня этот сон обнажил клыки."
      },
      "stargazer_oril": {
        "name": "Звездочёт Орил",
        "title": "Хранитель Вечного Дозора",
        "greeting": "Над Дозором не хватает одной звезды. Я считал сотню раз, и пропавший свет у нас под ногами."
      },
      "reeve_mara": {
        "name": "Староста Мара",
        "title": "Хранительница Висельной Заводи",
        "greeting": "Держи фонарь близко, а имя ещё ближе, {className}. Лес любит красть и то и другое."
      },
      "lantern_iven": {
        "name": "Фонарщик Ивен",
        "title": "Зажигатель Скорбного Камня",
        "greeting": "Фонарь сдерживает обычную тьму. Для прочего у меня есть соль, колокольцы и быстрые ноги."
      },
      "harbormaster_pell": {
        "name": "Начальник порта Пелл",
        "title": "Хозяин Фитильной Гавани",
        "greeting": "Если ветер унёс шляпу, забудь о ней. Если корабль, {className}, тогда у нас работа."
      },
      "beacon_keeper_ada": {
        "name": "Смотрительница Ада",
        "title": "Хранительница Старого Огня",
        "greeting": "Старый огонь больше не ведёт корабли. Он показывает, какие обломки пытаются уползти обратно в море."
      },
      "tidecaller_miri": {
        "name": "Заклинательница приливов Мири",
        "title": "Голос Дрейфующей Гавани",
        "greeting": "Прилив возвращает всё взятое. Джунгли, {className}, так и не научились вежливости."
      },
      "trailblazer_cas": {
        "name": "Первопроходец Кас",
        "title": "Проводник Изумрудной Чащи",
        "greeting": "Каждая тропа зарастает к завтраку. Я отмечаю их на рассвете и начинаю снова до ужина."
      },
      "steward_elian": {
        "name": "Управляющий Элиан",
        "title": "Хранитель Изгородника",
        "greeting": "В Вечном Саду всё стоит на своём месте, {className}. Если изгородь движется, значит, так задумано."
      },
      "maze_scholar_pip": {
        "name": "Исследователь лабиринта Пип",
        "title": "Картограф живых изгородей",
        "greeting": "Я рисую этот лабиринт каждое утро двенадцать лет. Он ни разу не остался на карте."
      },
      "statue_keeper_bram": {
        "name": "Смотритель статуй Брам",
        "title": "Страж Мраморной Аллеи",
        "greeting": "Сегодня статуи смотрят на юг, вчера на фонтан. Не хочу гадать, куда они повернутся завтра."
      },
      "rose_keeper_una": {
        "name": "Садовница Уна",
        "title": "Хранительница Диких Роз",
        "greeting": "Пока розы поют, они безвредны. Если замолчат, уходи, пока шипы не заинтересовались тобой."
      },
      "pond_keeper_sol": {
        "name": "Смотритель пруда Сол",
        "title": "Страж Лепесткового Пруда",
        "greeting": "Пруд отражает все пути лабиринта. Сегодня в нём лишняя тропа к Фонтанному Двору."
      },
      "warden_coalfast": {
    ...
    "quests": {
      ...
      "q_drakewatch_dispatch": {
        "title": "Дым над северной дорогой",
        "text": "Ваэла не вернулась с Пепельных Дюн, а дальние костры погасли. Иди на север, найди её и узнай, что приближается к Дозору.",
        "completion": "Каэлра прислала тебя? Хорошо. Здесь налётчики, тролли и крылатая тень над кальдерой. На подъёме пригодится клинок.",
        "objectives": {
          "0": {
            "label": "Найти разведчицу Ваэлу"
          }
        }
      },
      "q_drakewatch_long_climb": {
        "title": "Долгий подъём",
        "text": "Я отмечу безопасный путь к кальдере, но за мной идут Пеплокостные и тролли. Проводи меня, {playerName}, и не подпускай их.",
        "completion": "Ты вернул Ваэлу с картой пути и перечнем угроз. Это ценнее ещё одного отряда за стенами.",
        "objectives": {
          "0": {
            "label": "Проводить Ваэлу к краю кальдеры"
          }
        }
      },
      "q_drakewatch_wings": {
        "title": "Крылья над Драконьей Пастью",
        "text": "Пламенное Крыло изгнало малых драконов и скоро нападёт на стены. Поднимись к гнезду и убей его первым.",
        "completion": "Тень ушла с наших крыш. Сегодня Дозор уснёт, не глядя в небо. Это твоя победа, {playerName}.",
        "objectives": {
          "0": {
            "label": "Убить Пламенного Дракона"
          }
        }
      },
      "q_frostveil_aurora_call": {
        "title": "Где сияние касается земли",
        "text": "Сенн наблюдает сияние на северных ступенях. Перед бурей он послал три синих огня. Найди его и принеси предупреждение.",
        "completion": "Ты пересёк бурю ради предупреждения. Теперь увидь его причину своими глазами.",
        "objectives": {
          "0": {
            "label": "Найти дозорного Сенна"
          }
        }
      },
      "q_frostveil_three_cairns": {
        "title": "Три кургана в снегу",
        "text": "Осмотри защитные камни у Ледникового Озера, Дрожащей Топи и Воющих Террас. Погасший свет покажет путь бури.",
        "completion": "Последний камень тёмен. Буря пришла не с неба: нечто огромное спустилось с террас и привело холод.",
        "objectives": {
          "0": {
            "label": "Осмотреть озёрный курган"
          },
          "1": {
            "label": "Осмотреть болотный курган"
          },
          "2": {
            "label": "Осмотреть курган на террасах"
          }
        }
      },
      "q_frostveil_shield_tracks": {
        "title": "Следы шириной со щит",
        "text": "Морозногривый йети занял террасы и разбил защитные камни. Убей его среди льдов, пока он не пошёл на их свет.",
        "completion": "Курганы восстановят, но их свет привёл бы зверя к нам. Ты подарил Ледяной Мантии ещё одну зиму.",
        "objectives": {
          "0": {
            "label": "Победить Морозногривого йети"
          }
        }
      },
      "q_amberfall_orchard_road": {
        "title": "Дорога в сад",
        "text": "Брам должен был зажечь фонари западного сада. Найди его под золотыми ветвями и спроси, почему Фонарная Топь темна.",
        "completion": "Элоуэн заметила тьму? Времени нет. Нужно пройти путь фонарей, пока старые древни не проснулись.",
        "objectives": {
          "0": {
            "label": "Найти садовника Брама"
          }
        }
      },
      "q_amberfall_lantern_round": {
        "title": "Обход фонарей",
        "text": "Три фонаря сдерживают древние корни. Зажги огни в саду, у Великой Топи и под Наклонным Монолитом.",
        "completion": "Два огня золотые, а огонь у монолита зелёный. Углеветвь укоренилась на холме и пьёт их пламя.",
        "objectives": {
          "0": {
            "label": "Зажечь фонарь в саду"
          },
          "1": {
            "label": "Зажечь фонарь у топи"
          },
          "2": {
            "label": "Зажечь фонарь у монолита"
          }
        }
      },
      "q_amberfall_cinderbough": {
        "title": "Пробуждение Углеветви",
        "text": "Древень Углеветвь поглотил защитный огонь. Сломи его, пока корни не достигли остальных фонарей.",
        "completion": "Фонари снова горят ровно. На месте Углеветви мы посадим три дерева и дадим им добрые имена.",
        "objectives": {
          "0": {
            "label": "Победить Углеветвь"
          }
        }
      },
      "q_willowfen_fenward": {
        "title": "Пропавший болотный страж",
        "text": "Оли ушёл переставлять тростниковые метки и не вернулся. Найди его у Лилейных Пустошей и узнай, почему тропы ведут в воду.",
        "completion": "Альда прислала помощь. Кто-то повернул все метки, а я едва успевал уворачиваться от голодных пастей.",
        "objectives": {
          "0": {
            "label": "Найти болотного стража Оли"
          }
        }
      },
      "q_willowfen_marker_round": {
        "title": "Камыш ведёт домой",
        "text": "Верни метки у Светлых Луж, Плачущих Ив и Сонных Отмелей. Ночью нечто большое сдвинуло их с безопасных мест.",
        "completion": "На столбах грязь и круглые царапины. Старая жаба не спит, а загоняет путников в своё логово.",
        "objectives": {
          "0": {
            "label": "Исправить метку у Светлых Луж"
          },
          "1": {
            "label": "Исправить метку у Плачущих Ив"
          },
          "2": {
            "label": "Исправить метку на Сонных Отмелях"
          }
        }
      },
      "q_willowfen_croaker": {
        "title": "Топь больше не храпит",
        "text": "Сонный Квакун поворачивает метки и заманивает пищу. Найди огромную жабу на отмелях и снова усыпи её.",
        "completion": "Последний квак слышали даже в посёлке. Мосты снова наши, и Оли перестанет кричать на камыши.",
        "objectives": {
          "0": {
            "label": "Победить Сонного Квакуна"
          }
        }
      },
      "q_nightbloom_vigil": {
        "title": "Пропавшая звезда",
        "text": "Орил не передавал счёт звёзд три ночи. Найди его среди древних камней Вечного Дозора и узнай, что заглушило сигнал.",
        "completion": "Лума верит моему счёту. Помоги проследить пропавшую звезду по якорям сна.",
        "objectives": {
          "0": {
            "label": "Найти звездочёта Орила"
          }
        }
      },
      "q_nightbloom_dream_anchors": {
        "title": "Якоря сна",
        "text": "Прочти лунные руны у Лунного Колодца, Сумеречного Поля и Бессонного Кургана. Тёмное отражение укажет на звезду.",
        "completion": "Руна кургана показала корону. Старый король украл свет и пробудил свой двор.",
        "objectives": {
          "0": {
            "label": "Прочесть якорь у Лунного Колодца"
          },
          "1": {
            "label": "Прочесть якорь Сумеречного Поля"
          },
          "2": {
            "label": "Прочесть якорь Бессонного Кургана"
          }
        }
      },
      "q_nightbloom_barrow_crown": {
        "title": "Корона под землёй",
        "text": "Король Кургана украл звезду из сна и вставил её в корону. Победи его и позволь Ночноцвету забыть это имя.",
        "completion": "Пропавший свет вернулся в небо. Ночноцвет снова спит спокойно благодаря твоей смелости.",
        "objectives": {
          "0": {
            "label": "Победить Короля Кургана"
          }
        }
      },
      "q_wraithwood_lost_lantern": {
        "title": "Пропавший фонарь",
        "text": "Ивен шёл зажечь часовню, но не прошёл Вдовью Чащу. Найди его на западной тропе и не отвечай деревьям.",
        "completion": "Мара послала тебя за мной? Смело. Часовня темна, и лес уже это заметил.",
        "objectives": {
          "0": {
            "label": "Найти фонарщика Ивена"
          }
        }
      },
      "q_wraithwood_lantern_walk": {
        "title": "Путь фонаря",
        "text": "В этом фонаре огонь часовни, и весь лес чует его. Проводи меня к Скорбному Камню, {playerName}, и защити свет.",
        "completion": "Огни часовни снова горят. Теперь у каждого заблудившегося путника есть дорога домой.",
        "objectives": {
          "0": {
            "label": "Проводить Ивена к часовне"
          }
        }
      },
      "q_wraithwood_last_hunt": {
        "title": "Охота на охотника",
        "text": "Свет выманил Бледного Охотника. Иди по следу на север и сделай эту охоту последней.",
        "completion": "Из рощи больше не отвечает рог. Теперь в Призрачном Лесу лишь обычные мертвецы.",
        "objectives": {
          "0": {
            "label": "Победить Бледного Охотника"
          }
        }
      },
      "q_galecrest_beacon_orders": {
        "title": "Приказ Старому Маяку",
        "text": "Старый Маяк вспыхнул в полдень без смотрителя. Найди Аду и узнай, какая тень разбудила древний огонь.",
        "completion": "Пелл тоже видел вспышку. Грозовые столбы скажут, пришла угроза с моря, неба или снизу.",
        "objectives": {
          "0": {
            "label": "Найти смотрительницу Аду"
          }
        }
      },
      "q_galecrest_storm_signals": {
        "title": "Сигналы в буре",
        "text": "Ударь в столбы на Воющих Холмах, у Зеркального Озера и среди Обломков. Три ноты найдут зовущего корабли.",
        "completion": "Холмы и озеро ответили чисто. Обломки дали четвёртую ноту, глубокую, как треск корпуса. Страж проснулся.",
        "objectives": {
          "0": {
            "label": "Подать сигнал на Воющих Холмах"
          },
          "1": {
            "label": "Подать сигнал у Зеркального Озера"
          },
          "2": {
            "label": "Подать сигнал среди Обломков"
          }
        }
      },
      "q_galecrest_wreck_warden": {
        "title": "Четвёртая нота",
        "text": "Страж Обломков звонит в утонувшие колокола. Найди его среди разбитых судов и заглуши четвёртую ноту.",
        "completion": "Портовые колокола снова звучат нормально. Моряки ещё боятся мыса, но мертвецы больше не указывают путь.",
        "objectives": {
          "0": {
            "label": "Победить Стража Обломков"
          }
        }
      },
      "q_palmreach_green_trail": {
        "title": "Зелёная тропа",
        "text": "Кас ушёл открывать путь к Водопаду Лоз. Следуй по ракушкам, найди его и узнай, почему джунгли поглотили дорогу.",
        "completion": "Мири прислала тебя? Гавани нужна дорога. Помоги разбудить старые указатели, пока лозы их не похоронили.",
        "objectives": {
          "0": {
            "label": "Найти первопроходца Каса"
          }
        }
      },
      "q_palmreach_waymarks": {
        "title": "Дорога, которую помнят джунгли",
        "text": "Освободи указатели у Пальмового Берега, Водопада Лоз и Сапфировой Лагуны. Три пробуждённых камня откроют путь.",
        "completion": "Путь открыт, но все камни повернулись к Затонувшему Идолу. Его страж зовёт резной камень домой.",
        "objectives": {
          "0": {
            "label": "Открыть указатель на берегу"
          },
          "1": {
            "label": "Открыть указатель у водопада"
          },
          "2": {
            "label": "Открыть указатель у лагуны"
          }
        }
      },
      "q_palmreach_idol_guardian": {
        "title": "Идол зовёт их домой",
        "text": "Страж Идола вырывает путевые камни и закрывает тропы. Победи его в затонувшем святилище.",
        "completion": "Ракушки сияют до самого водопада. У Пальмового Предела снова есть дорога благодаря тебе.",
        "objectives": {
          "0": {
            "label": "Победить Стража Идола"
          }
        }
      },
      "q_evergarden_maze_mouth": {
        "title": "Лабиринт сдвинулся",
        "text": "Пип ушёл наносить лабиринт на карту и не вернулся. Найди его у входа и узнай, почему изгороди клонятся к фонтану.",
        "completion": "Элиан тоже заметил? Значит, карта ни при чём. Нужны три свидетеля из разных уголков сада.",
        "objectives": {
          "0": {
            "label": "Найти исследователя Пипа"
          }
        }
      },
      "q_evergarden_living_map": {
        "title": "Карта с тремя голосами",
        "text": "Поговори с Брамом у статуй, Уной среди роз и Солом у пруда. Их наблюдения покажут движение под садом.",
        "completion": "Статуи повернулись, розы молчат, в пруду новая тропа. Все линии ведут к Топиарному Быку во дворе.",
        "objectives": {
          "0": {
            "label": "Расспросить смотрителя Брама"
          },
          "1": {
            "label": "Расспросить садовницу Уну"
          },
          "2": {
            "label": "Расспросить смотрителя Сола"
          }
        }
      },
      "q_evergarden_bull": {
        "title": "Бык во дворе фонтана",
        "text": "Топиарный Бык стягивает лабиринт живыми корнями. Войди во двор, отсеки зверя от сада и освободи пути.",
        "completion": "Изгороди вернулись на места, по крайней мере сегодня. Вечный Сад обязан тебе тихим утром.",
        "objectives": {
          "0": {
            "label": "Победить Топиарного Быка"
          }
        }
      },
      "q_farshore_watch_meadow": {
        "title": "Дозор за лугом",
        "text": "Оллун слышит три разлома сразу. Перейди старую дорогу от причала, найди его и узнай, какой откроется первым.",
        "completion": "Коулфаст прислал ещё пару ушей. Ближайший разлом идёт на звук колокола, и Тэм отнесёт его в ловушку.",
        "objectives": {
          "0": {
            "label": "Найти дозорного Оллуна"
          }
        }
      },
      "q_farshore_ferrywalk": {
        "title": "Путь тревожного колокола",
        "text": "Тэм понесёт колокол к луговому посту. Разломы нападут на звук. Проводи звонаря и удержи дорогу.",
        "completion": "Колокол на месте, и разлом показал зубы. Теперь я знаю, какую рану закрыть и кто её охраняет.",
        "objectives": {
          "0": {
            "label": "Проводить звонаря Тэма к посту"
          }
        }
      },
      "q_farshore_horror": {
        "title": "Расколотый ужас",
        "text": "Колокол выманил хозяина утёса, сшитого из жертв разлома. Убей его у Расколотых Скал и доложи Коулфасту.",
        "completion": "Мы слышали, как разлом закрылся. Дальний Берег ещё ранен, но сегодня кровь остановилась. Спасибо, {playerName}.",
        "objectives": {
          "0": {
            "label": "Победить Расколотый Ужас"
          }
        }
      },
      "q_prof_hobby_switch": {
