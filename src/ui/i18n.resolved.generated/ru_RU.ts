...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "earth_shield": {
        "name": "Каменная эгида",
        "description": "Окутывает вас живым камнем, снижая получаемый урон на 20% в течение следующих 6 атак. Повторное применение обновляет щит."
      },
      "earthbound_weapon": {
        "name": "Оружие земной привязи",
        "description": "Привязывает ваше оружие к земле, увеличивая всю создаваемую вами угрозу на 100% на 5 мин. Заменяет любое другое усиление оружия."
      },
      "elemental_demand": {
        "name": "Веление стихий",
        "description": "Приказывает стихиям завладеть целью, провоцируя ее атаковать вас в течение 3 сек. Дальность 15 м."
      },
      "unleash_weapon": {
        "name": "Стихийный разряд",
        "description": "Высвобождает энергию активного усиления оружия по цели, нанося {damage} ед. урона и добавляя эффект в зависимости от усиления: всплеск угрозы (земная привязь), огненный ожог (пламя) или замедление (лед)."
      },
      "ironhold": {
        "name": "Железная стена",
      ...
      "sacred_bulwark": {
        ...
        "description": "Защищает вас верой на 1 мин. Смертельный удар не убьет вас, а восстановит здоровье до 35% от максимума."
      },
      "tidal_ward": {
        "name": "Приливный оберег",
        "description": "Нарастающий прилив омывает вас, исцеляя каждые 2 сек и повышая все получаемое вами исцеление на 40% на 8 сек."
      },
      "shadow_bolt": {
