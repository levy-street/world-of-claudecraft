  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_logol_sign": {
        ...
        "text": "Чтобы увидеть незримое, настрой свой взор. Пройдись немного, затем вернись, и я отмечу тебя.",
        "completion": "Метка поставлена. Твой взор готов.",
        "objectives": {
          "0": {
            "label": "Вернуться к Предвестнику за меткой"
          }
        }
      },
      "q_logol_seen": {
        "title": "Зримое и незримое",
        "text": "Свершилось. Когда снова встретишь того, кто в плаще, он будет торговать с тобой. Ступай и смотри на края мира.",
        "completion": "Теперь ты видишь его. Его книга открыта тебе. Трать с умом.",
        "objectives": {
          "0": {
            "label": "Принять взор Безымянного ордена"
          }
        }
      },
      "q_drowned_choir": {
