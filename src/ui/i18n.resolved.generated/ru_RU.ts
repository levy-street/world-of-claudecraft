...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bank": {
      ...
      "depositAllTooltip": "Кладёт в банк все материалы для ремесла и инструменты профессий, которые поместятся. Экипировка, расходники и предметы заданий останутся в сумках.",
