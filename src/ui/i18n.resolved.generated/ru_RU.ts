...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "cameraMode": {
      ...
      "body": "Как вы хотите управлять камерой?",
      "classicLabel": "Классическая",
      "classicDesc": "Удерживайте правую кнопку мыши, чтобы поворачивать камеру, отпустите, чтобы освободить курсор.",
      "mouseLabel": "Камера мышью",
      "mouseDesc": "Мышь всегда управляет камерой для плавного современного свободного обзора.",
      "recommended": "Рекомендуется",
      "note": "Вы можете изменить это позже в разделе Esc, Привязка клавиш.",
      "confirm": "Подтвердить",
      "dismiss": "Закрыть"
    },
    "deeds": {
