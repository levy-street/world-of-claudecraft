...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "combatTextStyle": "Стиль боевого текста",
      "combatTextClassic": "Классический",
      "combatTextEnhanced": "Улучшенный",
  ...
  "hud": {
    ...
    "combat": {
      ...
      "parried": "{target} парирует ваше {ability}.",
