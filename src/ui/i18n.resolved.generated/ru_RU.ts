...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "scene": {
      ...
      "waitingFor": "Ожидание игрока {name}",
      "timer": "{seconds}s"
    },
    "fct": {
    ...
    "mountTraining": {
      ...
      "buyReinsPrompt": "Верховая езда изучена. Купите у Марлы поводья доблестного скакуна за 10 золотых и используйте их, чтобы сесть в седло.",
  ...
  "lb": {
    "fixture": {
      "ferry": "Паром на Дальний берег",
      "tidemill": "Приливная мельница",
      "breach": "Разлом"
    },
    "speaker": {
      "tam": "Хранитель колокола Тэм",
      "coalfast": "Страж Коулфаст",
      "ollun": "Дозорный Разлома Оллун",
      "edda": "Квартирмейстер Эдда",
      "saul": "Целитель Саул"
    },
    "fare": {
      "promptOut": "Переправа на Дальний берег: {price} медных.",
      "promptBack": "Переправа обратно на материк: {price} медных.",
      "pay": "Заплатить за проезд.",
      "decline": "Не сегодня."
    },
    "q0": {
      "scene": {
        "harbor": "Рабочая гавань: сушатся сети, ящики со звёздным стеклом помечены для покупателей с материка.",
        "plinth": "Над портовыми ступенями бронзовый страж смотрит вглубь острова. Самому новому имени на постаменте уже сто лет: СТРАЖ ХЕЙЛ. Ниже ещё осталось место.",
        "toll": "Колокол звонит один раз. Все на улице останавливаются и считают. Больше ничего не звучит, и вся улица разом выдыхает."
      },
      "tam": {
        "stretchers": "Последняя такая тварь отняла у всей стражи целое утро и две носилки."
      },
      "coalfast": {
        "look": "Человек в сером смотрит на мёртвого охотника, затем чуть дольше — на вас. После он уходит обратно к утёсам."
      }
    }
  },
  "gatherEvent": {
  ...
  "editor": {
    ...
    "cinematic": {
      ...
      "fade": "Fade: {percent}%",
      "letterboxOn": "Чёрные полосы: вкл.",
      "letterboxOff": "Чёрные полосы: выкл.",
      "violations": "Нарушения",
      "noViolations": "Сейчас нарушений нет",
      "violationRow": "{check} | op {opIndex} | {measured}",
      "capture": "Снять ключевой кадр",
      "copy": "Копировать блок",
      "output": "Сгенерированный снимок камеры",
      "unavailable": "Загрузка трёхмерного окна",
      "seedMismatch": "Для снимка нужен рабочий ключ генерации мира",
      "captureSavedCopied": "Сохранено и скопировано",
      "captureSaved": "Сохранено; блок подготовлен ниже",
      "captureCopyOnly": "Скопировано; запись для разработчика недоступна",
      "captureReady": "Блок подготовлен ниже"
    },
    "brush": {
      "title": "Кисть",
      "size": "Размер кисти",
  ...
  "entities": {
    ...
    "mobs": {
      ...
      "lb_actor_ollun": {
        "name": "Дозорный Разлома Оллун"
      },
      "lb_actor_edda": {
        "name": "Квартирмейстер Эдда"
      },
      "lb_actor_saul": {
        "name": "Целитель Саул"
      },
      "lb_actor_tam": {
        "name": "Хранитель колокола Тэм"
      },
      "tidemill_stalker": {
        "name": "Охотник Приливной мельницы"
      },
      "rift_hellguard": {
        "name": "Адский страж"
      },
    ...
    "npcs": {
      ...
      "ferryman_ewald": {
        ...
        "greeting": "На Дальний берег, значит? Ради рыбалки туда больше никто не ездит, друг. Поднимайтесь на борт, когда будете готовы, и слушайте колокол после высадки: местные следят за ним, как вы следите за погодой."
      },
      ...
      "sergeant_marsh": {
        ...
        "greeting": "Обучены? Тогда слушайте, как пройдёт эта ночь. Мой строй держит дорогу. Если Разлом выплюнет что-то нам не по силам, я укажу на вас. Мельница ваша: ничто не должно войти следом за вами и ничто не должно пройти мимо нас в город. Вперёд."
      },
      "forgemistress_darva": {
    ...
    "quests": {
      ...
      "q_lb_q0_ashore": {
        "title": "На берегу",
        "text": "Галлхейвен принимает удары днём и ночью, но всё ещё стоит. Если хотите встать рядом с его жителями, начните там, где город истекает кровью: у линии ополчения на Дозорном лугу, к востоку от портовых ступеней и старой статуи.",
        "completion": "На мельнице вы справились в одиночку, и Тэм не преувеличивал про носилки. Мне не хватает разведчика, а полей слишком много. Сегодня вы удержали землю, которую не обязаны были защищать, — в этом и состоит вся работа. Добро пожаловать в стражу.",
        "objectives": {
          "0": {
            "label": "Явиться к сержанту Маршу на Дозорном лугу"
          },
          "1": {
            "label": "Уничтожить порождений Разлома"
          },
          "2": {
            "label": "Покончить с тем, что скрывается на Приливной мельнице"
          }
        }
      },
    ...
    "dungeons": {
      ...
      "lb_tidemill": {
        ...
        "enterText": "Дверь мельницы поддаётся. Внутри темнота прислушивается.",
        "leaveText": "Вы выходите из Приливной мельницы в вечерний воздух."
      },
      "lb_riftline": {
        "name": "The Rift-Line at Dusk",
        "enterText": "Ворота луга закрываются за патрулём. Эта ночь принадлежит рубежу.",
        "leaveText": "Вы оставляете рубеж у Разлома утренней страже."
      },
      "lb_vault": {
        "name": "Затонувший Первый редут",
        "enterText": "Верёвка уходит во тьму. Внизу древний редут лежит там, куда когда-то рухнул.",
        "leaveText": "Вы поднимаетесь по верёвке на утёс, к дневному свету."
      },
      "lb_council": {
        "name": "Совет редута",
        "enterText": "В зале совета шесть стульев. Один пустует.",
        "leaveText": "Вы выходите из редута."
      },
      "lb_landing": {
        "name": "Ночная высадка",
        "enterText": "Вдоль берега горят путеводные огни. За отмелью ждёт флот.",
        "leaveText": "Вы оставляете берег высадки позади."
      },
      "lb_riftfields": {
        "name": "Подступы к Полям Разлома",
        "enterText": "Четыре места печати окружают Разлом. Обряд удерживал его закрытым двенадцать веков.",
        "leaveText": "Вы спускаетесь обратно с Полей Разлома."
      },
      "lb_breach": {
        "name": "Внутри Разлома",
        "enterText": "Свет неправильный, а небо ещё хуже. Сердце лежит впереди на открытом месте.",
        "leaveText": "Вы переступаете порог и возвращаетесь в обычный ночной воздух."
      },
      "lb_lastwatch": {
        "name": "Последняя стража",
        "enterText": "Редут чист и пуст. Кому-то придётся завершить эту стражу.",
        "leaveText": "Вы закрываете за собой дверь редута."
      },
      "lb_willowfen": {
        "name": "Плачущая Ива",
        "enterText": "Ива не движется. Вода тоже.",
        "leaveText": "Вы оставляете иву в её тишине."
      },
      "drowned_temple": {
        "name": "Утонувший храм",
