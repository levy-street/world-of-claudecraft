...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocSeason": {
      ...
      "noneHint": "Сезон откроется, когда комиссия арены и выкупы начнут пополнять пул.",
      "statusActive": "Активен",
      "statusEnded": "Завершен",
      "endsIn": "Ends in",
      "endsInValue": "{days}d {hours}h {minutes}m",
      "ended": "Этот сезон завершен.",
      "openEnded": "Без срока",
      "poolLabel": "Доступный пул наград",
      "wocUnit": "$WOC",
      "emittedLabel": "Выплачено {pct}% пула",
      "sinkLabel": "Профинансировано",
      "emissionLabel": "Paid out",
      "invariant": "Выплаты никогда не превысят поступления сезона: покупка > продажа, гарантируется в блокчейне.",
      "standingsTitle": "Прогноз лучших получателей",
      "colRank": "#",
      "colPlayer": "Игрок",
      "colRating": "Рейтинг",
      "colReward": "Награда ($WOC)",
      "projectedNote": "Прогноз по текущему пулу и рейтингу арены; итоговые выплаты фиксируются при закрытии сезона."
    },
    "mobTooltip": {
