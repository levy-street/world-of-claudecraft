...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "starterTutorial": {
      ...
      "skip": "Покинуть остров",
      "leave": "Отплыть на материк",
      "doneTitle": "Страж одобряет",
      "doneBody": "Это всё, чему я могу научить, стоя на месте. Остальному вы выучитесь, сперва сделав это скверно. Ступайте, материк ждёт, и он не будет так же мягок, как я.",
      "objectiveDone": "{label}: выполнено",
      "objectiveCount": "{label}: {current} of {total}",
      "scenes": {
        "wardenReveal": "Из света над камнем святилища выходит женщина и стряхивает соль с плаща так, будто ждала вас всё утро.",
        "yardReveal": "Учебный двор. Три соломенных манекена, терпеливые, как святые, и примерно столь же опасные.",
        "wolfReveal": "Кусты зашевелились. Вот ЭТО и есть моб: живая тварь, которой очень хочется вас убить. У него есть полоска здоровья. Опустошите её раньше, чем он опустошит вашу."
      },
      "steps": {
        "land": "Прилив принёс мне ещё одного. По песку наверх идёт тропа, а над ней, на пригорке, стоит святилище. Поднимайтесь. Я ни для кого не кричу.",
        "enlist": "У меня есть работа, а у вас пустые руки. Подойдите ближе и заговорите со мной, чтобы взять задание.",
        "target": "На этом острове ради вас никто смирно не стоит, кроме моих манекенов. Двор к востоку. Выберите один и возьмите его в цель.",
        "strike": "А теперь бейте. Подойдите вплотную и начинайте махать оружием. Автоатака, если уж пошла, идёт сама, так что не стойте и не любуйтесь ею.",
        "hunt": "С приливом пришли три прибрежных волка, и они уже поглядывают на моих коз. На запад, вниз, в лощину. Ступайте.",
        "spoils": "Никогда не уходите от убитого, которого не обыскали. Обыщите волка и заберите у него клык.",
        "report": "Возвращайтесь ко мне. Задание кончается не тогда, когда кончается драка, а тогда, когда о нём доложили."
      },
      "objective": {
        "land": "Дойти до стража",
        "enlist": "Принять задание",
        "target": "Выбрать целью «{mob}»",
        "strike": "Удары автоатакой",
        "hunt": "Убитые прибрежные волки",
        "spoils": "Take a {item}",
        "report": "Доложить стражу",
        "abilityHit": "Удары способностью «{ability}»",
        "auraUp": "Способность «{ability}» активна",
        "healSelf": "Исцелить себя",
        "rangedHit": "Автовыстрелы с дистанции",
        "petSummoned": "Призвать демона"
      },
      "class": {
        "warrior": {
          "signature": "Удары копят ярость, а ярость на то и нужна, чтобы её тратить. Дважды попадите по манекену способностью «{ability}».",
          "mastery": "Воин шумит нарочно. Поднимите «{ability}» и пусть услышит весь остров."
        },
        "paladin": {
          "signature": "Ваша сила взята взаймы, а о такой силе положено просить. Заклеймите своё оружие способностью «{ability}».",
          "mastery": "Свет сперва врачует своих и только потом жжёт всё остальное. Исцелите себя один раз и почувствуйте, на чём держится паладин."
        },
        "hunter": {
          "signature": "Даже охотника загоняют в угол, и загнанному охотнику лучше бы знать, зачем нужен клинок. Дважды всадите в манекен «{ability}».",
          "mastery": "А теперь сделайте это как надо. Отойдите так, чтобы до вас не дотянулись, и стреляйте: три автовыстрела, вот оттуда."
        },
        "rogue": {
          "signature": "Режьте и не останавливайтесь. Трижды попадите способностью «{ability}» и смотрите, как на цели копятся очки серии.",
          "mastery": "Копить очки бессмысленно. Тратьте их: добейте манекен способностью «{ability}»."
        },
        "priest": {
          "signature": "Вера, у которой есть зубы. Дважды ударьте манекен способностью «{ability}».",
          "mastery": "И вера, которая врачует. Исцелите себя один раз. Эта привычка вам ещё пригодится."
        },
        "mage": {
          "signature": "Сначала огонь, а вопросов не будет вовсе. Дважды попадите по манекену способностью «{ability}».",
          "mastery": "Ткань горит быстро, так что носите на себе кое-что получше ткани. Поставьте «{ability}»."
        },
        "warlock": {
          "signature": "Запустите руку во тьму, зачерпните горсть, швырните в кого-нибудь. Дважды попадите по манекену способностью «{ability}».",
          "mastery": "Ни один чернокнижник не ходит один, что бы вам ни говорили. Призовите своего демона."
        },
        "druid": {
          "signature": "Дикая природа отвечает тем, кто просит вежливо. Дважды попадите по манекену способностью «{ability}».",
          "mastery": "А теперь попросите её кое о чём для себя. Наложите «{ability}» на себя."
        },
        "shaman": {
          "signature": "Сегодня буря на вашей стороне. Дважды попадите по манекену способностью «{ability}».",
          "mastery": "Сперва камень, потом буря. Наделите своё оружие силой «{ability}»."
        }
      }
    }
  },
  ...
  "starterTutorial": {
    "title": "Небольшой крюк?",
    "body": "Это ваш первый персонаж класса {className}. Для новых искателей приключений есть учебный остров, а на нём страж, которая покажет, что на деле умеет ваш класс. Это займёт несколько минут и совершенно не обязательно.",
    "note": "Ваш персонаж останется ровно таким, каким вы его создали. Ничто из добытого на острове не последует за вами обратно.",
    "accept": "Отплыть в Рассветную Гавань",
    "decline": "Пропустить, я знаю дорогу"
  },
  "deleteCharacter": {
  ...
  "entities": {
    ...
    "mobs": {
      ...
      "dawnhaven_dummy": {
        "name": "Учебный манекен"
      },
      "dawnhaven_strandwolf": {
        "name": "Прибрежный волк"
      },
      "ironvein_foreman": {
    ...
    "npcs": {
      ...
      "dawnhaven_warden": {
        "name": "Страж Фенна Локк",
        "title": "Хранительница Рассветной Гавани",
        "greeting": "На ногах и дышите, {className}? Хорошо. Остров терпелив, а волки нет."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "quests": {
      ...
      "q_dawnhaven_wolves": {
        "title": "Испытание стража",
        "text": "С приливом пришли три прибрежных волка, и с тех пор они поглядывают на моих коз. Спуститесь по западной тропе в лощину, {playerName}, и покажите мне, чему вы научились во дворе.",
        "completion": "Чисто сработано. Вы готовы к острову побольше моего.",
        "objectives": {
          "0": {
            "label": "Прибрежный волк: убито"
          }
        }
      },
      "q_drowned_choir": {
    ...
    "zones": {
      ...
      "dawnhaven_isle": {
        "name": "Остров Рассветной Гавани",
        "welcome": "Страж Локк ждёт выше по тропе.",
        "pois": {
          "0": {
            "label": "Пристань"
          },
