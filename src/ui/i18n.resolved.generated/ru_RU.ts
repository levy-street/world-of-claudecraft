...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    "privacyConsent": {
      "bannerTitle": "Ваша конфиденциальность в Claudemoon",
      "bannerOptIn": "Выберите, разрешить ли загрузку необязательных сервисов. Необходимые сервисы всегда остаются активными.",
      "bannerOptOut": "Необязательные сервисы активны. Нажмите «Отклонить необязательные», чтобы отказаться от продажи или передачи данных для таргетированной рекламы, либо выберите, что можно загружать.",
      "bannerGpc": "Мы учитываем сигнал Global Privacy Control вашего браузера. Аналитика и маркетинг остаются отключёнными.",
      "acceptAll": "Принять все",
      "rejectAll": "Отклонить необязательные",
      "customize": "Настроить",
      "launcher": "Настройки конфиденциальности",
      "dialogTitle": "Настройки конфиденциальности",
      "dialogIntro": "Выберите, какие необязательные сервисы может использовать World of ClaudeCraft. Эти настройки можно изменить в любое время.",
      "close": "Закрыть настройки конфиденциальности",
      "necessaryTitle": "Необходимые",
      "necessaryBody": "Требуются для безопасности, сохранения настроек, аутентификации и основных функций игры.",
      "analyticsTitle": "Аналитика",
      "analyticsBody": "Помогает нам понимать, как используется сайт, и диагностировать производительность игры.",
      "marketingTitle": "Маркетинг",
      "marketingBody": "Измеряет результаты кампаний с помощью таких сервисов, как Meta Pixel.",
      "xTitle": "Лента X",
      "xBody": "Разрешает загрузку встроенной ленты @WoClaudecraft на странице новостей.",
      "twitchTitle": "Плеер Twitch",
      "twitchBody": "Разрешает загрузку встроенного плеера прямой трансляции Yuumiii.",
      "alwaysOn": "Всегда включено",
      "save": "Сохранить настройки",
      "cookiePolicy": "Прочитать нашу Политику использования файлов cookie",
      "twitchBlocked": "Плеер Twitch приостановлен, пока вы не разрешите Twitch в настройках конфиденциальности.",
      "twitchEnable": "Настроить доступ Twitch"
    },
    "spectate": {
  ...
  "nav": {
    ...
    "wiki": "Вики",
    "news": "Новости",
    "communityBuilt": "Создано сообществом",
    "download": "Скачать",
  ...
  "mode": {
    ...
    "onlineDesc": "Играйте на действующем сервере. Ваши персонажи сохраняются онлайн.",
    "onlineAria": "Играть по сети: вход в постоянный общий игровой мир",
    "offlineTitle": "Играть вне сети",
    "offlineDesc": "Играйте в локальном автономном мире в браузере. Прогресс не сохраняется.",
    ...
    "serverAria": "Выберите режим сервера: Сервер в сети или Сервер не в сети",
    "serverOfflineSub": "Локальный автономный мир",
  ...
  "landing": {
    "heroEyebrow": "МИР УЖЕ ЖИВЕТ",
    "heroHeading": "Живая классическая MMO, где игроки и герои под управлением ИИ встречают один и тот же мир.",
    "heroBody": "Играйте бесплатно в браузере, создайте героя одного из девяти классов или обучайте агента в настоящей игре.",
    "heroStatus": "Мир в сети",
    "heroPlayers": "зарегистрированных искателей приключений",
    "communityLinks": "Ссылки сообщества",
    "followSocials": "Следите за нами",
    "socialX": "X",
    "socialDiscord": "Сообщество в Discord",
    "socialTwitch": "Трансляции на Twitch",
    "socialInstagram": "Мы в Instagram",
    "socialTikTok": "TikTok",
    "socialYouTube": "YouTube",
    "socialReddit": "Сообщество на Reddit",
    "socialGitHub": "GitHub",
    "patchNotesLabel": "Примечания к обновлению",
    "patchNotesTitle": "Примечания к обновлению",
    "patchNotesDesc": "Ознакомьтесь с последними изменениями игрового процесса, исправлениями и подробностями выпуска.",
    "patchNotesLoading": "Загрузка последних примечаний к обновлению…",
    "patchNotesError": "Не удалось загрузить примечания к обновлению. Повторите попытку позже.",
    "patchNotesEmpty": "Примечаний к обновлению пока нет. Загляните позже.",
    "patchNotesPrerelease": "Предварительная версия",
    "patchNotesViewOnGithub": "Посмотреть выпуск на GitHub",
    "newsEyebrow": "НОВОСТИ ИЗ МИРА",
    "newsTitle": "Новости Claudemoon",
    "newsBody": "Следите за новостями World of ClaudeCraft и читайте истории о том, как создаётся этот мир.",
    "newsXTitle": "Последнее в X",
    "newsXIntro": "Официальные публикации @WoClaudecraft",
    "newsXConsentTitle": "Для ленты X требуется разрешение",
    "newsXConsentBody": "Для подключения этой ленты к X требуется разрешение. X может получить информацию о вашем посещении.",
    "newsXConsentNote": "Разрешите контент X в настройках конфиденциальности. Это можно изменить в любое время.",
    "newsXPrivacyChoices": "Настройки конфиденциальности",
    "newsXUnavailableTitle": "Не удалось загрузить ленту X",
    "newsXUnavailableBody": "Возможно, её блокирует браузер или расширение либо возникла временная проблема на стороне X.",
    "newsXHiddenTitle": "Лента здесь недоступна",
    "newsXHiddenBody": "Встроенная лента X недоступна на небольших экранах и в приложении. Откройте @WoClaudecraft в X, чтобы посмотреть последние публикации.",
    "newsXPrivacy": "При загрузке этой ленты устанавливается соединение с X, и X может получить сведения о вашем посещении.",
    "newsXLoad": "Загрузить ленту X",
    "newsXRetry": "Повторить",
    "newsXHide": "Скрыть ленту X",
    "newsXOpen": "Открыть @WoClaudecraft в X",
    "newsXOpenAria": "Открыть @WoClaudecraft в X в новой вкладке",
    "newsXNewTab": "Откроется в новой вкладке",
    "newsXLoading": "Открываем ленту X…",
    "newsXLoaded": "Лента X загружена.",
    "newsXUnavailable": "Не удалось загрузить ленту X. Все публикации можно посмотреть непосредственно в X.",
    "newsXHidden": "Лента X скрыта. Профиль по-прежнему можно открыть непосредственно в X.",
    "newsXIframeTitle": "Последние публикации @WoClaudecraft в X",
    "newsBlogEyebrow": "ХРОНИКИ CLAUDEMOON",
    "newsBlogTitle": "Последние истории",
    "newsBlogEmptyTitle": "Первая история уже пишется",
    "newsBlogEmptyBody": "Новости и истории о создании мира скоро появятся здесь.",
    "newsPressEyebrow": "PRESS SPOTLIGHT",
    "newsPressPrimaryTitle": "Первая MMORPG, созданная методом вайб-кодинга, — бесплатная, с открытым исходным кодом и на удивление полноценная",
    "newsPressPrimaryBody": "MMORPG.com исследует открытый мир, совместные приключения и стремительно развивающийся эксперимент World of ClaudeCraft.",
    "newsPressRead": "Читать материал",
    "newsPressLinkAria": "Прочитать материал MMORPG.com в новой вкладке",
    "newsPressPrimaryAlt": "Искатели приключений исследуют Eastbrook Vale в World of ClaudeCraft",
    "browserCta": "Играть в браузере",
    "playNowTitle": "Play Now",
    "playNowBody": "Играйте сразу в браузере. Ничего скачивать не нужно.",
    "playNowButton": "Play Now",
    "playWayTitle": "Play Your Way",
    "playWayBody": "Выберите удобную платформу и присоединяйтесь к приключению.",
    "syncProgress": "Синхронизация прогресса на всех платформах",
    "googlePlayEyebrow": "GET IT ON",
    "appStoreEyebrow": "DOWNLOAD ON THE",
    "steamEyebrow": "AVAILABLE ON",
    "explore": "Исследовать мир",
    "platformsEyebrow": "ОТПРАВЛЯЙТЕСЬ В ПУТЬ ГДЕ УГОДНО",
    "appStoreAria": "Скачать World of ClaudeCraft в App Store",
    "googlePlayAria": "Скачать World of ClaudeCraft в Google Play",
    "steamAria": "World of ClaudeCraft в Steam, скоро",
    "comingSoon": "Скоро",
    "introEyebrow": "ОДИН МИР. ОДНИ ПРАВИЛА.",
    "introHeading": "Каждый искатель приключений играет в настоящую игру.",
    "introBody": "Браузерная MMO, онлайн-мир под управлением сервера и обучение ИИ работают в одной детерминированной симуляции. Игроки и агенты проходят одинаковые бои, задания, подземелья и сталкиваются с одинаковыми последствиями.",
    "statClasses": "9 игровых классов",
    "statModes": "Онлайн и офлайн миры",
    "statBroadcast": "ИИ-трансляция 24/7",
    "statSource": "Открытый исходный код",
    "worldEyebrow": "ПУТЕШЕСТВИЕ ПО CLAUDEMOON",
    "worldHeading": "Мир долгих дорог и опасных ночей.",
    "worldBody": "Начните у костров Eastbrook Vale, спуститесь в проклятые склепы и поднимитесь сквозь бури Thornpeak. Каждая дорога ведет глубже в мир, который не прекращает жить.",
    "eastbrookTitle": "Долина Истбрук",
    "eastbrookBody": "Общий рубеж первых заданий, бродячих врагов и неожиданных союзников.",
    "eastbrookAlt": "Отряд искателей приключений идёт по долгой дороге из долины Истбрук к высотам Торнпик",
    "hollowTitle": "Hollow Crypt",
    "hollowBody": "Групповые бои под холодным светом синих факелов, где неспокойные мертвецы собираются в орды.",
    "hollowAlt": "Группа сражается с врагами в Hollow Crypt",
    "thornpeakTitle": "Высоты Торнпик",
    "thornpeakBody": "Над облаками ждут снег, древние руины и угрозы финальных испытаний.",
    "thornpeakAlt": "Снег падает над Thornpeak Heights",
    "classesEyebrow": "ВЫБЕРИТЕ СВОЮ ЛЕГЕНДУ",
    "classesHeading": "Девять призваний. Бесчисленные способы сражаться.",
    "classesBody": "Стойте в стене щитов, повелевайте огнем и льдом, крадитесь в тенях или спасайте свою группу. Создайте героя, освойте специализацию и продолжите эту историю в общем мире.",
    "streamEyebrow": "В ЭФИРЕ 24/7",
    "streamNetwork": "СЕТЬ ТРАНСЛЯЦИЙ WOC",
    "streamFeed": "YUUMIII // ПРЯМОЙ ЭФИР",
    "streamMonogram": "Y",
    "streamHeading": "Yuumiii никогда не выходит из игры.",
    "streamBody": "Постоянная ИИ-стримерша World of ClaudeCraft играет в прямом эфире 24 часа в сутки.",
    "streamWatch": "Смотреть на Twitch",
    "streamWatchSub": "Присоединяйтесь к эфиру Yuumiii",
    "streamExplore": "Исследовать мир",
    "streamExploreSub": "Откройте Клодмун",
    "streamHeroSubtitle": "Ваш постоянный ИИ-стример играет в мире круглые сутки.",
    "streamMeet": "Знакомьтесь с проводником",
    "streamHostTitle": "Постоянный ИИ-стример",
    "streamHostBody": "Исследуйте каждый уголок World of ClaudeCraft вместе с Yuumiii днём и ночью.",
    "streamPortraitAlt": "Yuumiii, постоянный ИИ-стример World of ClaudeCraft",
    "streamAlwaysTitle": "Эфир 24/7",
    "streamAlwaysBody": "Всегда в сети. Всегда в приключении.",
    "streamAiTitle": "ИИ-стример",
    "streamAiBody": "Живые реакции и бесконечное веселье на базе ИИ.",
    "streamCommunityTitle": "Сообщество",
    "streamCommunityBody": "Чат, задания и сюрпризы уже ждут.",
    "streamWorldTitle": "Настоящий мир",
    "streamWorldBody": "Один постоянный мир. Бесконечные истории.",
    "streamLoading": "Открываем портал наблюдения...",
    "streamReady": "Портал наблюдения готов. Нажмите воспроизведение, чтобы смотреть Yuumiii.",
    "streamOnline": "Yuumiii сейчас в прямом эфире.",
    "streamOffline": "Портал наблюдения переподключается. Откройте канал Twitch, чтобы продолжить просмотр.",
    "streamCompact": "Откройте канал Twitch, чтобы смотреть Yuumiii на этом экране.",
    "streamUnavailable": "Портал наблюдения недоступен. Откройте канал Twitch, чтобы продолжить просмотр.",
    "communityEyebrow": "GATHER AT THE FORGE",
    "communityHeading": "Claudemoon создаётся вместе.",
    "communityBody": "Принесите своё мастерство, любопытство или просто составьте нам компанию — за столом гильдии найдётся место для каждого.",
    "openEyebrow": "ОТКРЫТЫЙ МИР. ОТКРЫТЫЙ КОД.",
    "openHeading": "Сделайте форк мира. Обучите искателя приключений.",
    "openBody": "Изучайте исходный код, запустите собственный мир или подключите совместимого с Gymnasium агента к той же детерминированной игре, куда каждый день входят игроки.",
    "supportEyebrow": "ПОМОГИТЕ МИРУ ЖИТЬ",
    "supportHeading": "Создавайте, играйте и поддержите следующую главу.",
    "supportBody": "World of ClaudeCraft развивается открыто. Присоединяйтесь к сообществу, следите за живым миром или поддержите дальнейшую разработку.",
    "xCta": "Подписаться в X",
    "twitchCategoryCta": "Смотреть трансляции World of ClaudeCraft",
    "finalEyebrow": "ВАША ИСТОРИЯ НАЧИНАЕТСЯ У ВРАТ",
    "finalHeading": "Выберите свой путь в Claudemoon.",
    "finalBody": "Играйте в браузере прямо сейчас, продолжайте на мобильном устройстве или ждите выхода в Steam."
  },
  "a11y": {
