...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "farming": "Чтобы возделать эту грядку, нужна мотыга земледельца {tier} уровня."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        ...
        "farming": "Чтобы махать мотыгой, которая уже лежит в ваших сумках, нужен навык земледелия {skill}."
      },
      ...
      "toolTooltip": {
        "kind": {
          ...
          "farming": "Земледельческий инструмент ({tier} уровень)"
        },
        "unlocks": {
          ...
          "farming": "Нужна для посадки культур до {tier} уровня."
        },
        "use": {
          ...
          "farming": "Действует из ваших сумок, когда вы сажаете культуру на грядке."
        },
    ...
    "professions": {
      ...
      "toolEffectTooltip": {
        ...
        "howToSlot": "Устанавливается на инструмент для горного дела, лесозаготовки, травничества или земледелия в окне профессий. Расходуется при установке.",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "whatBody": "Профессии составляют трудовую жизнь мира: собирательские ремесла, что добывают сырье прямо из земли, и кольцо из десяти ремесел, которые превращают его в снаряжение, еду, зелья и инструменты. Здесь все питает что-то другое. Добытая руда становится клинком, клинок принимает чары, а для чар нужна пыль, разобранная из старого снаряжения, так что собиратель, ремесленник и мастеровой оказываются звеньями одной цепи.\n\nНад числом профессий мучиться не нужно. Любой персонаж может поднимать все восемь ремесел, у которых сегодня есть содержание, и все собирательские профессии разом; единственный исключающий выбор, это ваш архетип, призвание, которому вы в итоге присягнете, хотя после настройки ремесла, ушедшие в спячку, перестают расти. Навык никогда не падает, и ничто из выученного у вас не отнимается.",
      ...
      "gatherHubBody": "Ремесла сбора кормят производство: горное дело, лесозаготовка и травничество ограничены 100, земледелие растит урожай из семян на ухоженных грядках и тоже ограничено 100, рыбная ловля 200.",
    ...
    "profPages": {
      ...
      "gatherIntro": {
        ...
        "farming": "Земледелие растит урожай из семян на возделанных грядках и ограничено 100; грядки, семена и инструменты придут с будущим обновлением, поэтому таблицы ниже пока пусты."
      },
      ...
      "gatherDeeds": {
        ...
        "farming": "У земледелия пока нет собственных деяний: грядки еще впереди, а вехи и деяния предела, что отмечают другие ремесла, придут вместе с ними. Его мастерство уже засчитывается в Master Gatherer, зарабатываемый при 100 в любых трех собирательских ремеслах. Деяния дают только титулы и известность, но никогда не силу."
      },
      "fish": {
        "startHeading": "С чего начать",
  ...
  "entities": {
    ...
    "items": {
      ...
      "bronze_hoe": {
        "name": "Бронзовая мотыга"
      },
      "skysilver_hoe": {
        "name": "Небосеребряная мотыга"
      },
      "osmium_hoe": {
