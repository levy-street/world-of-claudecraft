...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobileHudEditor": {
      "launcher": "Настройте мобильный макет",
      "title": "Редактор мобильного макета",
      "dialogLabel": "Настройте мобильные элементы управления",
      "dragHandleLabel": "Переместить панель редактора",
      "dragHandleHint": "Перетаскивайте панель или используйте клавиши со стрелками; Home возвращает её в центр.",
      "locked": "Заблокировано",
      "unlocked": "Разблокировано",
      "lock": "Расположение блокировки",
      "unlock": "Разблокировать макет",
      "sceneLabel": "Предварительный просмотр сцены",
      "contextLabel": "Состояние предварительного просмотра",
      "profileLabel": "Профиль устройства",
      "profilePhone": "Телефон",
      "profileTablet": "Планшет",
      "save": "Сохранить",
      "cancel": "Отмена",
      "showFailingLayout": "Показать неудачный макет",
      "previousFailure": "Предыдущая неудача",
      "nextFailure": "Следующая неудача",
      "runtimeFallback": "Макет {profile} не подходит для этой области просмотра. Встроенные настройки по умолчанию активны временно.",
      "storageError": "Не удалось сохранить мобильную раскладку. Ваш черновик всё ещё открыт.",
      "invalidSave": "Исправьте каждую ошибку макета перед сохранением.",
      "failureWithContext": "{message} ({context})",
      "failureWithFixture": "{message} ({context}; {profile}; {viewport})",
      "scene": {
        "world": "Мир",
        "arenaStandard": "Стандарт арены",
        "arenaFiesta": "Арена Фиеста",
        "arenaYumi": "Арена Юми",
        "valeCupBriefing": "Брифинг Кубка Долины",
        "valeCupMatch": "Матч Кубка Долины",
        "valeCupSpectator": "Зритель Кубка Долины",
        "delve": "Вылазки"
      },
      "context": {
        "worldBase": "Мир",
        "worldValeCupIndicator": "Мир с индикатором Кубка Долины",
        "arenaStandard": "Стандарт арены",
        "arenaFiestaBase": "Фиеста-матч",
        "arenaFiestaPending": "Фиеста ожидается",
        "arenaFiestaRespawn": "Фиеста возрождается",
        "arenaFiestaOffer": "Предложение по дополнению Fiesta",
        "arenaFiestaRespawnOffer": "Предложение возрождения и улучшения Fiesta",
        "arenaYumiBase": "Юми матч",
        "arenaYumiRespawn": "Юми возрождается",
        "arenaYumiReturning": "Юми возвращается",
        "valeCupBriefing": "Брифинг Кубка Долины",
        "valeCupMatch": "Матч Кубка Долины",
        "valeCupMatchCharge": "Заряженный бросок Кубка Долины",
        "valeCupSpectatorBetting": "Ставки зрителей Кубка Долины",
        "instanceDelve": "Вылазки"
      },
      "surface": {
        "actionA1": "Действие А1",
        "actionA2": "Действие А2",
        "actionA3": "Действие А3",
        "actionA4": "Действие А4",
        "actionA5": "Действие А5",
        "actionAttack": "Атака",
        "actionTarget": "Цель",
        "actionJumpUse": "Прыжок или действие",
        "actionPage": "Переключение страниц действий",
        "controlMovement": "Движение",
        "controlView": "Обзор",
        "utilityConsumables": "Расходники",
        "petCommands": "Команды питомца",
        "party": "Группа",
        "menuTop": "Верхнее меню",
        "minimapCluster": "Миникарта",
        "frameTarget": "Рамка цели",
        "framePlayer": "Рамка игрока",
        "playerBuffs": "Баффы игрока",
        "playerDebuffs": "Дебаффы игрока",
        "statusArenaGeneric": "Статус арены",
        "statusFiestaScore": "Фиеста счет",
        "statusFiestaPending": "Статус ожидания Fiesta",
        "protectedFiestaRespawn": "Подсказка о возрождении Фиесты",
        "protectedFiestaOffer": "Предложение по дополнению Fiesta",
        "statusYumi": "Статус Юми",
        "protectedYumiRespawn": "Подсказка о возрождении Юми",
        "statusValeCupIndicator": "Индикатор Кубка Долины",
        "protectedValeCupBriefing": "Брифинг Кубка Долины",
        "statusValeCupMatch": "Статус матча Кубка Долины",
        "statusValeCupCharge": "Заряд броска Кубка Долины",
        "protectedValeCupBetting": "Панель ставок Кубка Долины",
        "trackerDelve": "Трекер вылазок",
        "protectedCenterMessage": "Центральное сообщение"
      },
      "control": {
        "nudgeUp": "Вверх",
        "nudgeDown": "Двигаться вниз",
        "nudgeLeft": "Двигаться влево",
        "nudgeRight": "Двигайтесь вправо",
        "decreaseScale": "Уменьшить размер",
        "increaseScale": "Увеличить размер",
        "orientation": "Ориентация",
        "horizontal": "Горизонтальный",
        "vertical": "Вертикальный",
        "order": "Порядок",
        "normalOrder": "Обычный порядок",
        "reverseOrder": "Обратный порядок",
        "openingDirection": "Направление открытия",
        "openLeft": "Открыть слева",
        "openRight": "Открыть вправо",
        "openUp": "Открывать вверх",
        "openDown": "Открывать вниз",
        "resetSelected": "Сбросить выбранное",
        "resetAll": "Сбросить все"
      },
      "status": {
        "noSelection": "Выберите элемент управления, чтобы редактировать его.",
        "selected": "Выбрано: {surface}",
        "scale": "Размер: {scale}",
        "valid": "Макет готов к сохранению.",
        "invalid": "В макете есть ошибки блокировки: {count}.",
        "failurePosition": "Сбой {index} из {count}"
      },
      "failure": {
        "invalidPlacement": "{surface} имеет недопустимое размещение.",
        "unsupportedCapability": "{surface} использует неподдерживаемый вариант макета.",
        "scaleOutOfRange": "Размер {surface} находится за пределами допустимого диапазона.",
        "targetTooSmall": "{surface} слишком мал для безопасного использования.",
        "outOfBounds": "{surface} находится за пределами безопасной зоны.",
        "overlap": "{surface} перекрывается {other}.",
        "viewIntrusion": "{surface} перекрывает область просмотра.",
        "protectedOverlap": "{surface} перекрывает {other}."
      },
      "discard": {
        "title": "Отменить изменения макета?",
        "body": "Несохраненные изменения мобильного макета будут потеряны.",
