...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "discountSummary": "Скидка {percent}% от эффективной привязочной цены",
      "discountBonus": "{base} Клаудиум до {credited} Клаудиум (+{bonus})",
      "wocIncentive": "Оплата через $WOC - всегда скидка от 15%",
      "wocPromoNote": "Включает акцию с ограниченным сроком",
