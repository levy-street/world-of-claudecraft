...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "arena": {
      "windowTitle": "Поля сражений",
      "arenaIntro": "Рейтинговый колизей: сражайтесь один на один или командой, побеждайте, поднимайтесь в таблице и растите рейтинг.",
      "yumiHeading": "Защита Юми",
      "yumiIntro": "Командный режим в лабиринте, вне колизея. Без рейтинга: играйте ради славы, а не очков.",
      "desc1v1": "Один на один. Чистое мастерство, без напарников.",
      "desc2v2": "Двое на двое. Приведите напарника или встаньте в очередь в одиночку и получите пару.",
      "descFiesta": "Шумная свалка два на два с усилениями и бонусами.",
      "descYumi3": "Трое на трое. Защищайте свою кошку Юми и охотьтесь на кошку врага.",
      "descYumi5": "Пятеро на пятеро в большем лабиринте, и у вашей кошки гораздо больше здоровья.",
      "yumiRules": "Каждая команда охраняет пассивную кошку Юми и охотится на кошку врага. Обе кошки раз в минуту переносятся в новые углы лабиринта. Павший боец возвращается через {respawn} секунд. На полу появляются таинственные усиления: удерживайте «Взаимодействие», чтобы подобрать. Побеждает команда, первой уничтожившая кошку врага; на {sudden}-й минуте внезапная смерть разрешает ничью.",
      "queueCount": "{n} в очереди"
    },
    "death": {
