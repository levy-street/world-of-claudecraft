  ...
  "entities": {
    ...
    "mobs": {
      ...
      "nythraxis_heroic_fallen_captain_aldren": {
        "name": "Героический павший капитан Алдрен"
      },
      "nythraxis_heroic_corrupted_priest_malric": {
        "name": "Героический оскверненный жрец Малрик"
      },
      "nythraxis_heroic_deathstalker_voss": {
        "name": "Героический ловчий смерти Восс"
      },
      "nythraxis_scourge_of_thornpeak": {
        "name": "Нитраксис, Бич Торнпика"
      },
      "nythraxis_scourge_of_thornpeak_heroic": {
        "name": "Нитраксис, Бич Тернового пика (героический)"
      },
    ...
    "quests": {
      ...
      "q_nythraxis_heroic_unlock": {
        "title": "Корона разбита вновь",
        "text": "Нитраксис пал, но склеп все еще отвечает, когда произносят его имя. За королевской дверью я нашел вторую печать, предназначенную для героев, которые уже однажды сломали его корону. Поговорите со мной, когда будете готовы, и я отмечу ваш перстень для более трудного пути.",
        "completion": "Метка поставлена. Героическая королевская дверь теперь узнает вас, но король под ней не будет сражаться как воспоминание. Соберите полный рейд, прежде чем перейти этот порог.",
        "objectives": {
          "0": {
            "label": "Поговорите с братом Олдриком о героическом Нитраксисе"
          }
        }
      },
      "q_mogger": {
    ...
    "dungeons": {
      ...
      "nythraxis_heroic_boss_arena": {
        "name": "Героическая рейдовая арена Нитраксиса",
        "enterText": "Вы проходите через героическую королевскую дверь.",
        "leaveText": "Вы возвращаетесь в холодный воздух Тернового пика."
      },
      "drowned_temple": {
        "name": "Утонувший храм",
