  ...
  "entities": {
    ...
    "items": {
      ...
      "crownforged_heartplate": {
        "name": "Коронокованная кираса сердца"
      },
      "nighttalon_emberweave": {
        "name": "Углеткань Ночного Когтя"
      },
      "soulflame_vestments": {
        "name": "Облачения Пламени Души"
      },
      "stormcallers_hauberk": {
        "name": "Хауберк Зовущего Бури"
      },
      "volzharrs_knucklestone": {
        "name": "Костяшечник Волжарра"
      },
      "magmastrider_greaves": {
        "name": "Наголенники Магмохода"
      },
      "footwraps_of_the_waking_floor": {
        "name": "Обмотки Пробуждающегося Пола"
      },
      "forgeheat_cinch": {
        "name": "Пояс Жара Горна"
      },
      "corebreaker_heart_of_the_undermount": {
        "name": "Крушитель Ядра, Сердце Подгорья"
      },
      "the_last_restraint": {
        "name": "Последняя Окова"
      },
      "band_of_the_ninth_quench": {
        "name": "Кольцо Девятой Закалки"
      },
      "moltenheart_chroma": {
        "name": "Расплавленное Сердце"
      },
      "conjured_water4": {
    ...
    "mobs": {
      ...
      "wyrmcult_dig_foreman": {
        "name": "Прораб раскопок культа Змея"
      },
    ...
    "quests": {
      ...
      "q_undermount_heat": {
        ...
        "text": "Камни вокруг этой расселины так горячи, что уголь расплывается, {playerName}. Снимите оттиски с трех открытых рунных граней, пока культ снова их не закопал. Повтор узора покажет, что лежит внизу.",
        "completion": "Все линии поворачивают внутрь. Это не метки кузнеца, {playerName}. Это обереги, и нечто разрезает их снизу.",
        "objectives": {
          "0": {
            "label": "Сняты оттиски рун"
          }
        }
      },
      "q_undermount_ledger": {
        "title": "Что культ похоронил",
        "text": "Прораб держит рабочую книгу при себе, а фанатики охраняют его лагерь. Принесите ее мне, {playerName}. Я хочу знать, куда уходят каждый слиток, паек и монета жалованья.",
        "completion": "Вниз. Каждый слиток и каждый уголек потрачены под нами, {playerName}. Горн ничего не производит для поверхности. Он кормит то, что погребла гора.",
        "objectives": {
          "0": {
            "label": "Прораб Wyrmcult убит"
          },
          "1": {
            "label": "Стражи Wyrmcult убиты"
          },
          "2": {
            "label": "Книга прораба найдена"
          }
        }
      },
      "q_undermount_descent": {
        "title": "В Подгорье",
        "text": "Книга подтверждает, что под раскопом есть вторые работы, и каждый груз направлен вниз. Поговорите со мной, когда будете готовы, {playerName}. Я иду с вами.",
        "completion": "Возьмите фонарь. В нем нет чар, только ровное пламя, но внизу нам нужен честный свет. Вход в рейд открыт независимо от этой цепочки заданий.",
        "objectives": {
          "0": {
            "label": "Поговорить с руноискательницей Мейрин"
          }
        }
      },
      "q_highwatch_summons": {
    ...
    "itemSets": {
      ...
      "crownforged": {
        ...
        "bonus5": "Повышает вероятность критического удара на 3%."
      },
      "deathlord": {
      ...
      "soulflame": {
        ...
        "bonus5": "Повышает вероятность критического эффекта заклинаний на 3%."
      },
      "stormcallers": {
