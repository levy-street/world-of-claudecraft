...
export const tr_TR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customizeTitle": "Kontrolleri Özelleştir",
      "customizeSlotAttack": "Temel Saldırı",
      "customizeSlotSkill": "Yetenek {n}",
      "customizeSlotUtility": "Yardımcı",
      "customizeDefault": "Sınıf varsayılanı",
      "customizeResetSlot": "Bu yuvayı sıfırla",
      "customizeResetAll": "Tümünü sınıf varsayılanlarına sıfırla",
      "customizeUpdated": "{slot} güncellendi.",
      "customizeAllReset": "Kontroller sınıf varsayılanlarına sıfırlandı."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Düzenleme için Basılı Tutma Gecikmesi",
      "clusterHoldNote": "Ekrandaki bir eylem düğmesine, atama düzenleyicisi açılmadan önce ne kadar basılı tutulacağı. Yetenekleri hızlıca kullanırken düzenleyici açılıyorsa değeri artırın.",
      "targetPriority": "Saldırı Hedefi Önceliği",
      "targetPriorityNearest": "En Yakın",
      "targetPriorityLowestHp": "En Düşük Can",
      "targetPriorityCurrent": "Önce Mevcut",
      "targetPriorityNote": "Geçerli bir hedefin yokken Saldırı düğmesinin hedeflediği şey: en yakın düşman, menzildeki en düşük canlı düşman ya da geçerli kaldığı sürece mevcut hedefini korur.",
      "aimAssist": "Akıllı Yetenek Kullanımı",
      "aimAssistNote": "Saldırı yeteneğine basınca hedefine, hedefin yoksa yakındaki en uygun düşmana ona dönerek uygulanır. Yeteneğin menzilini önizlemek için düğmeyi basılı tutun; iptal etmek için parmağınızı düğmenin dışına alıp bırakın.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Dokunmatik Kontrolleri Sıfırla",
      "touchResetDone": "Dokunmatik kontroller varsayılana döndürüldü.",
