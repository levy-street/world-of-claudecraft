...
export const tr_TR: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "WOC Wallet, Phantom veya Solflare'i seç. Cüzdan uygulan onay isteyecek. Bu oyunu açık bırak ve bittiğinde geri dön.",
    "standaloneAppHelp": "Ana Ekran uygulamasında cüzdan bağlantıları henüz mevcut değil. WOC Wallet, Phantom veya Solflare kullanmak için World of ClaudeCraft'ı Safari veya Chrome'da aç.",
    ...
    "browser": {
      ...
      "extensionHelp": "Uyumlu cüzdan uzantısı bulunamadı. WOC Wallet, Phantom, Solflare veya başka bir Solana tarayıcı cüzdanını yükle ya da kilidini aç, ardından tekrar dene.",
