...
export const tr_TR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "dailyRewards": {
      ...
      "spinButton": "Çevir",
      "tasks": "Görevler",
      "taskMultiplier": "x{multiplier} çarpanı",
      "pointsGained": "{points} günlük ödül puanı kazanıldı.",
      "leaderboard": "Günlük Lider Tablosu",
      "totalPlayer": "{count} oyuncu bugün",
      "totalPlayers": "{count} oyuncu bugün",
  ...
  "wallet": {
    ...
    "extensionHelp": "Burada bir cüzdan görmek için Solflare Wallet gibi bir tarayıcı cüzdan uzantısını etkin tut.",
