...
export const vi_VN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "Tùy chỉnh",
      "customizeTitle": "Tùy chỉnh điều khiển",
      "customizeSlotAttack": "Đòn đánh cơ bản",
      "customizeSlotSkill": "Kỹ năng {n}",
      "customizeSlotUtility": "Hỗ trợ",
      "customizeDefault": "Mặc định của lớp",
      "customizeResetSlot": "Đặt lại ô này",
      "customizeResetAll": "Đặt lại tất cả về mặc định của lớp",
      "customizeUpdated": "Đã cập nhật {slot}.",
      "customizeAllReset": "Đã đặt lại điều khiển về mặc định của lớp."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Độ trễ giữ để chỉnh sửa",
      "clusterHoldNote": "Thời gian giữ một nút hành động trên màn hình trước khi trình chỉnh sửa gán mở ra. Tăng lên nếu trình chỉnh sửa bật lên khi bạn bấm liên tục kỹ năng.",
      "targetPriority": "Ưu tiên mục tiêu tấn công",
      "targetPriorityNearest": "Gần nhất",
      "targetPriorityLowestHp": "Máu thấp nhất",
      "targetPriorityCurrent": "Mục tiêu hiện tại trước",
      "targetPriorityNote": "Nút Tấn công sẽ nhắm vào đâu khi bạn không có mục tiêu hợp lệ: kẻ địch gần nhất, kẻ địch có máu thấp nhất trong tầm, hoặc giữ mục tiêu hiện tại khi nó còn hợp lệ.",
      "aimAssist": "Tung kỹ năng thông minh",
      "aimAssistNote": "Nhấn một kỹ năng tấn công để tung vào mục tiêu, hoặc kẻ địch phù hợp nhất ở gần nếu bạn không có mục tiêu, đồng thời xoay mặt về phía nó. Giữ nút để xem trước tầm kỹ năng; nhả tay ra ngoài nút để hủy.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Đặt lại điều khiển cảm ứng",
      "touchResetDone": "Đã khôi phục điều khiển cảm ứng về mặc định.",
