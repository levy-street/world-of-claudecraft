...
export const vi_VN: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "noLoot": "Chưa ghi nhận chiến lợi phẩm nào.",
      "recentAwards": "{count} phần thưởng gần đây",
      "target": "Mục tiêu: {name}",
      "noTargetEngaged": "Chưa giao chiến với mục tiêu nào.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Bỏ qua",
      "methodMaster": "Chủ nhóm",
      "methodPersonal": "Cá nhân",
      "methodDelve": "Delve",
      "methodLooted": "Đã nhặt",
      "noWinner": "Không có người thắng",
      "rollDetail": "Tung {roll}",
