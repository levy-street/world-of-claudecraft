...
export const vi_VN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      "editKeys": "Chỉnh sửa phím thanh hành động",
      "editKeysHint": "Bấm vào một vị trí trên thanh tác vụ, sau đó nhấn một phím để liên kết vị trí đó.",
      "bannerHint": "Bấm vào một ô, sau đó nhấn một phím để liên kết ô đó. Bấm vào Xong khi hoàn tất.",
      "bannerCapturing": "Nhấn một phím để liên kết khe này...",
      "boundToKey": "Bị ràng buộc với {key}.",
      "reset": "Cài lại",
      "done": "Xong",
      "cancel": "Hủy bỏ",
      "resetConfirmTitle": "Đặt lại phím thanh hành động?",
      "resetConfirmBody": "Thanh đầu tiên trở về các phím mặc định của nó. Thanh thứ hai và thứ ba trở nên không bị ràng buộc. Điều này không thể hoàn tác được."
    },
    "mounts": {
      "title": "Thú Cưỡi",
      "close": "Đóng",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "Trong khung 1v1 và 2v2, mỗi võ sĩ đều chơi bộ All-Rounder. Không thể kiếm được các hành động yêu cầu khung 3v3 hoặc lớn hơn ở đây.",
      "role": {
        "allrounder": {
          "name": "Toàn Năng",
      ...
      "practiceUnratedNote": "Các trận đấu tập không được xếp hạng: bảng xếp hạng và tiến trình trong Sách Chứng thư không được tính.",
      ...
      "briefing": {
        ...
        "unratedNote": "Robot đang ở trên sân, vì vậy trận đấu này không được xếp hạng: thứ hạng không thay đổi và số lần ghi bàn, cứu thua và giữ sạch lưới không được tính.",
        "practiceUnratedNote": "Đây là một trận đấu tập nên nó không được xếp hạng: thứ hạng không thay đổi và tiến trình của Sách Chứng thư không được tính.",
    ...
    "materialHint": {
      "fineGrade": "Lớp tốt. Được tập hợp từ một mạch đầy đủ các tầng bằng một công cụ được xếp hạng phía trên vật liệu và được tính là phiên bản thông thường ở bất cứ nơi nào được yêu cầu.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Bạn cần cần câu cấp {tier} để câu ở những vùng nước này."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Bạn cần Khai thác {skill} để vung lựa chọn đã có trong túi của bạn.",
        "logging": "Bạn cần Ghi nhật ký {skill} để vung chiếc rìu đã có sẵn trong túi của mình.",
        "herbalism": "Bạn cần Herbalism {skill} để làm việc với chiếc liềm đã có sẵn trong túi của bạn."
      },
      "wieldUnmetCorpse": "Bạn cần có kỹ năng thu thập {skill} để sử dụng công cụ tốt nhất của mình.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Cần thiết để câu cá ở vùng nước có cấp độ {tier}."
        },
        "use": {
      ...
      "emptyHookNote": "Không có gì đáng lo ngại",
      "stateReady": "Sẵn Sàng",
      "stateCooldown": "Đang Hồi Sinh",
      "stateCooldownTimed": "Hồi sinh sau {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Công cụ của bạn sẽ tinh chỉnh sản lượng này thành cấp độ tốt."
    },
    "archetypeTitle": {
      "label": "Danh hiệu",
      "none": "Không có",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} trong tổng số {max} khoản phí",
      "toolEffectSpent": "Đã sử dụng, cần sạc lại",
      "toolEffectDepleted": "Hiệu ứng công cụ chi tiêu",
      "toolEffectRechargePrice": "Nạp tiền: {count} x {material}",
      "toolEffectModeAsk": "Hỏi mỗi lần sử dụng",
      "toolEffectModePrompt": "Yêu cầu mỗi lần sử dụng",
      "toolEffectConfirmTitle": "Sử dụng {effect}?",
      "toolEffectConfirmBody": "Chi phí cho vụ thu hoạch này? Giảm vẫn gom, không có thưởng. Số tiền còn lại: {charges}.",
      "toolEffectConfirmAccept": "Sử dụng một khoản phí",
      "toolEffectConfirmDecline": "Tập hợp mà không có",
      "toolEffectName": {
        "gatherersCache": "Bộ nhớ đệm của người thu thập",
        "artisansEye": "Mắt nghệ nhân",
        "quickeningCharm": "Bùa xuân"
      },
      "toolEffectSlotButton": "Khe {effect}",
      "toolEffectRechargeButton": "nạp tiền",
      "toolEffectSlotted": "{effect} được đặt trên {profession}.",
      "toolEffectSlotInvalid": "{effect} không thể được đặt ở đó.",
      "toolEffectNoTool": "Trước tiên, bạn cần một công cụ {profession} thực sự.",
      "toolEffectNoCharm": "Bạn cần một chiếc bùa {effect} được chế tác thủ công trong túi xách của mình.",
      "toolEffectNoGain": "{effect} đã được cắm vào rãnh và được sạc đầy.",
      "toolEffectRecharged": "{effect} đã sạc lại: {material} x{count} đã tiêu thụ.",
      "toolEffectRechargeNoSlot": "Không có hiệu ứng nào được áp dụng cho {profession}.",
      "toolEffectRechargeFull": "{effect} đã được sạc đầy.",
      "toolEffectRechargeToolCapped": "Mang theo dụng cụ {profession} tốt hơn để sạc thêm {effect}.",
      "toolEffectRechargeMaterials": "Sạc lại {effect} cần {material} x{count}.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(chi tiêu {count} điểm tốt)",
      ...
      "identity": {
        ...
        "colRole": "Vai Trò",
        "colCap": "Giới Hạn",
        "allCrafts": "Tất cả hàng thủ công",
        "skillListAria": "Kỹ năng thủ công",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Chia sẻ việc mở khóa chứng thư với bạn cùng hội và những người theo dõi cũng như thẻ chứng thư và tác phẩm kiệt tác với nguồn cấp dữ liệu Discord",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "archetypeSwitchBody": "Một lời tuyên bố cũng không phải là một bản án chung thân. Một cặp bạn chưa bao giờ nắm giữ chỉ đơn giản là một nhiệm vụ hòa hợp mới, trong khi quay trở lại cặp mà bạn đã bỏ đi sẽ yêu cầu bạn sửa đổi trước: năm nhiệm vụ trong lần đầu tiên và thêm ba nhiệm vụ nữa cho mỗi lần bạn quay lại (nhận một cặp hoàn toàn mới không bao giờ tăng số lượng). Sự lựa chọn vẫn có ý nghĩa mà không bao giờ khóa cửa mãi mãi.",
      "whatHeading": "Một nghề bên cạnh thanh kiếm",
      "whatBody": "Nghề nghiệp là cuộc sống lao động của thế giới: bốn nghề thu thập nguyên liệu thô thẳng ra khỏi đất và một nhóm gồm mười nghề thủ công biến chúng thành thiết bị, bữa ăn, thuốc độc và công cụ. Mọi thứ đều nuôi dưỡng thứ gì đó khác ở đây. Quặng bạn khai thác sẽ trở thành một lưỡi kiếm, lưỡi kiếm cần bùa mê và bùa mê cần bụi được lấy ra từ thiết bị cũ, vì vậy người thu thập, thợ chế tạo và thợ hàn đều là những mắt xích trong một chuỗi.\n\nKhông có giới hạn nghề nghiệp để phải đau khổ. Mỗi nhân vật có thể nâng cao bảy trong số tám nghề thủ công có nội dung ngày nay và tất cả bốn ngành nghề tập hợp cạnh nhau (Kỹ thuật là một ngành duy nhất: tất cả các công thức nấu ăn của nó đều bắt đầu trên trần tự do, vì vậy bậc thang của nó chờ đợi lời thề của Bombardier); sự lựa chọn độc quyền duy nhất là nguyên mẫu của bạn, danh tính mà cuối cùng bạn thề, mặc dù một khi bạn điều chỉnh được các nghề thủ công không hoạt động đằng sau nó, bạn chỉ có thể leo lên các công thức chung của chúng và không vượt qua kỹ năng 75. Kỹ năng không bao giờ suy giảm và không có gì bạn học được sẽ bị mất đi.",
      ...
      "archetypesBody": "Mười nghề thủ công nằm trên một bánh xe cố định và địa lý trên bánh xe đó rất quan trọng. Cứ hai người hàng xóm lại tạo thành một cặp có tên: Smith về Chế tạo vũ khí và Chế tạo áo giáp, Thợ may thời trang về Da và May mặc, Dược sĩ về Thuật giả kim và Nấu ăn, Bombardier về Kỹ thuật và Giả kim thuật, và sáu người nữa xung quanh võ đài.\n\nHòa hợp với một cặp là một nhiệm vụ chứ không phải là một cú nhấp chuột vào menu. Bạn có thể tham gia bốn cặp ngay hôm nay (Smith, Outfitter, Apothecary và Bombardier), mỗi cặp được neo đậu bởi một bậc thầy thường trú ở Eastbrook, người có nhiệm vụ chấp nhận nêu rõ toàn bộ món hời trước khi bạn nhận nó. Cho đến khi bạn tuyên bố, mọi nghề thủ công đều có thể tự do tiến bộ đối với các công thức nấu ăn từ cấp độ hiếm (bất kỳ công thức nào yêu cầu kỹ năng 74 trở xuống), vì vậy bạn có thể thử gần như mọi thứ trước khi chọn (Chỉ riêng kỹ thuật không có công thức nào thấp đến mức đó, vì vậy số lượng của nó phải chờ).\n\nMột khi bạn đã hòa hợp, hai cặp thủ công của bạn sẽ trở thành chuyên ngành của bạn, không có giới hạn nào cả. Phần còn lại của bánh xe không tắt: một nghề thủ công đối diện với chuyên ngành của bạn vẫn tiếp tục như một sở thích tiếp tục leo qua cấp độ hiếm (một nhiệm vụ lặp lại tại lò rèn của Smith Haldren cho phép bạn đổi nghề nào) và mọi nghề thủ công khác sẽ không hoạt động. Một nghề thủ công không hoạt động vẫn giữ được kỹ năng và các công thức nấu ăn chung của nó, tiếp tục dạy nó theo đường cong bình thường cho đến khi chúng xám xịt ở tuổi 75; mọi thứ trên mức thông thường sẽ ngừng thanh toán ngay lập tức và một nghề thủ công không hoạt động sẽ không bao giờ trở thành một kiệt tác khi nó đang nghỉ ngơi.",
      "pairFmt": "{a} và {b}",
      ...
      "startBody": "Mới lên đường ở Eastbrook? Tìm Foreman Odell và thực hiện Giao dịch cho mọi bàn tay: anh ta sẽ chỉ cho bạn các mạch quặng xung quanh Copper Dig về phía đông nam thị trấn và trao cho bạn những vết chai sạn đầu tiên. Hãy chú ý đến việc đào: Những người đào Deeprock cắm trại trên đó cao hơn một vài cấp độ so với những người mới đến, vì vậy hãy xử lý các mạch bên ngoài trước và để dành trái tim của trại khi bạn đã lên cấp một chút. Từ đó trở đi, hãy thu hoạch mọi mạch máu, cây gỗ và mảng thảo mộc mà bạn đi qua trong khi tìm kiếm; sự thành thạo đến một cách tự nhiên với du khách.\n\nTrở lại thị trấn, nhấn T để mở cửa sổ chế tạo và thực hiện các công thức nấu ăn phổ biến mà mọi nhân vật đều biết ngay từ đầu. Hãy đến thăm các bậc thầy tại lò rèn, nhà bếp, khung dệt và xưởng chế tạo công cụ để xem họ dạy những gì và nhận đơn đặt hàng công việc của họ để kiếm được đồng xu ổn định. Vào thời điểm lá thư của Hiệp hội tìm thấy bạn, bạn sẽ biết cặp đôi nào giống như ở nhà vậy.",
      "colStation": "Trạm",
      "colHub": "Thị trấn",
      "colMaster": "Bậc thầy",
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Kỹ thuật xây dựng các công cụ mà mọi người thu thập nghiêm túc đều mong muốn: cuốc, rìu, liềm và cần câu cấp 4 và cấp 5 mà không quầy bán nào sẽ bán lấy tiền xu, mỗi người sẽ tiêu thụ công cụ bên dưới nó.",
        "enchanting": "Bùa mê tách rời các trang bị và đưa sức mạnh trở lại: chia các mảnh không mong muốn thành các vật liệu phức tạp, sau đó sử dụng chúng để nhận phần thưởng chỉ số vĩnh viễn cho mảnh bạn muốn giữ. Đột phá và mê hoặc không cần trạm và không cần huấn luyện viên, và bất kỳ ai cũng có thể bắt đầu ngay ngày đầu tiên; chỉ có hai bùa yêu cầu thêm, dạy ở các xưởng dụng cụ."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "Khai thác là xương sống. Quặng đồng xuất phát từ các mạch cấp 1 của Eastbrook Vale, quặng sắt từ Mirefen Marsh và quặng osmium từ Thornpeak Heights, và mỗi bậc thang đều bước lên theo cùng một cách. Việc khai thác gỗ quan trọng hơn bạn có thể mong đợi: vỏ cây sắt làm đôi ngọn giáo lợn rừng, gỗ tần bì đóng vai vồ và một khúc gỗ thông cao duy nhất tạo thành trượng chiến đấu.\n\nPhần còn lại đến từ việc săn lùng và truy cập. Da thô để làm chuôi kiếm được thu hoạch ngay từ xác sói và lợn rừng, các mảnh xương rơi ra từ những người chết bồn chồn hoặc từ những thiết bị thông thường được vớt lên, và thang rèn đốt cháy Smithing Flux, 20 đồng một lọ từ chính Darva. Nếu hoạt động khai thác của bạn bị chậm lại, sẽ không có máy đếm nào giúp bạn tiết kiệm được chính quặng: osmium thoát ra từ các mạch Thornpeak, từ các mạch ban đầu của mọi khu vực trẻ hơn ngoại trừ Farshore (có mạch đào sắt) hoặc từ ngăn xếp của người chơi khác, thông qua giao dịch hoặc Thị trường Thế giới. Chỉ Thanh Glyphsteel được mua bằng xu, từ Tinker Gizzel tại xưởng chế tạo công cụ hoặc Quartermaster Bree ở Highwatch.",
          ...
          "routeBody": "Bất kỳ mảnh nào có dòng chỉ số thực, trên thang này có nghĩa là nấc sắt trở lên, đều có thể rời khỏi đe như một tác phẩm kiệt tác miễn là chất lượng tốt hơn phù hợp với trần cấp của bạn; những đồng tiền chung không có trạng thái không bao giờ mua được vì chẳng có gì để cải thiện ở đó. Sắt và osmium được tính là nguyên liệu cấp 1 cho phần thưởng kiệt tác, highpine và glyphsteel là cấp 2 và kỹ năng nằm trên cấp riêng của công thức sẽ thêm điểm riêng cho mỗi cấp, do đó, trong số osmium ba, rìu chiến và trượng chiến mang theo lợi thế vật chất và một nấc tiếp tục phát triển tốt hơn sau khi bạn đã phát triển vượt trội.\n\nĐi nấc thang đồng đến 25, huấn luyện nấc thang sắt vào ngày nó mở ra và cưỡi nó lên 50, sau đó leo lên osmium lên 75. Quá 75 chưa có tàu nào cao hơn, do đó, công thức nấu ăn osmium giảm dần xuống còn một nửa và sau đó tăng theo quý: lập ngân sách cho khoảng 150 nghề thủ công nữa để đạt giới hạn 125 và ghi nhớ mức tăng chung là mười hành động thủ công mỗi phút khi bạn ngồi xuống theo đợt.\n\nHỗ trợ tài chính cho quá trình leo núi khi bạn tiếp tục: Lệnh công việc rèn của Darva sẽ lấy đi tám quặng đồng trong tay bạn cứ sau 30 phút để đổi lấy một ít xu và XP, đồng thời các bậc thang sắt và osmium được bán một cách trung thực để thăng cấp trong trận cận chiến. Book of Deeds đánh dấu Edge và Temper ở kỹ năng 50 và trao vương miện cho Kỹ năng chế tạo vũ khí của Grandmaster ở mức 125."
        },
        "armorcrafting": {
          "identityHeading": "Giáp xích cho tuyến đầu",
          "identityBody": "Bậc thang của ngành chế tạo áo giáp giống như sự nghiệp của một người lính: bắt đầu bằng đai đồng có đinh tán đơn giản, sabaton và găng tay, giáp sắt, giáp bảo vệ và khiên chắn với các dòng chỉ số thực đầu tiên của chúng, cũng như mũ giáp, giáp cuiras và xà cạp cỡ osmium hiếm có, các mảnh Sức mạnh và Sức chịu đựng với số áo giáp ở đỉnh cao của nghệ thuật chế tạo.\n\nNó cũng có một khía cạnh yên tĩnh hơn: Eastbrook Warded Leggings, một loại phổ biến trong lĩnh vực do caster quy định, và Kilnscale Mantle, một chiếc vai thư Trí tuệ và Tinh thần hiếm có ở kỹ năng 75, giữ những người đeo thư có đầu óc chú ý trong danh sách khách hàng. Trên võ đài, nó nằm giữa Chế tạo vũ khí và Kỹ thuật; cặp Smith với Chế tạo vũ khí được tuyên thệ trước Forgemistress Darva, trong khi cặp Gearwright với Kỹ thuật được đặt tên nhưng chưa có nhiệm vụ tuyên thệ.",
          "materialsHeading": "Quặng theo từng bao",
          "materialsBody": "Không có nghề nào ăn quặng nhanh hơn. Chỉ riêng chiếc áo giáp sắt đã cần năm quặng sắt và mỗi mảnh có kích thước osmium cần ba hoặc bốn osmium cộng với một thanh glyphsteel, vì vậy, một thợ chế tạo áo giáp nghiêm túc sẽ khai thác Mirefen Marsh và Thornpeak Heights hoặc trả tiền cho ai đó làm được điều đó. Đồng cấp dưỡng cho bậc thang đầu tiên, trực tiếp từ các tĩnh mạch bằng Copper Dig.\n\nXung quanh kim loại là các bộ phận mềm: da thô được thu hoạch từ xác sói và lợn rừng, các mảnh xương của những người chết không yên (hoặc được vớt ra từ những thiết bị thông thường) và các lọ Smithing Flux (mỗi lọ 20 đồng tại lò rèn) trong hầu hết mọi công thức. Không có quầy bán osmium: những người thiếu kiên nhẫn mua nó từ những người chơi khác hoặc tự khai thác nó, trên Thornpeak hoặc các mạch khởi đầu của mười trong số mười một khu vực trẻ hơn (chỉ riêng Farshore đào sắt).",
          "ladderHeading": "Học tại lò rèn của Darva",
          "ladderBody": "Hai sản phẩm phổ biến hiện nay, Eastbrook Chainmail Vest và Warded Leggings, đã được biết đến ngay từ đầu và chế tạo ở bất cứ đâu. Thang dành cho huấn luyện viên gồm có chín công thức chia thành ba bậc tại lò rèn Eastbrook: bậc đồng được miễn phí ở kỹ năng 0, bậc thang sắt có giá 25 bạc một công thức ở kỹ năng 25 và bậc thang osmium có giá 1 vàng mỗi bậc ở kỹ năng 50, với mỗi bậc thang có thể dạy được ngay thời điểm cấp độ của bạn đạt đến nó.\n\nNgoài bậc thang còn có hai món đặc biệt. Mũ bảo hiểm Boundstone là một trong hai công thức kết hợp của Smith (Gravewyrm Gauntlets là anh em của nó trong lĩnh vực chế tạo vũ khí), do người huấn luyện dạy, không cần trạm và chỉ có thể sử dụng được bởi một Smith đã hòa hợp với cả hai kỹ năng ở kỹ năng 25. Kilnscale Mantle không cần giáo viên nào cả: mọi người đều biết nó ngay từ đầu, và không có gì ngoài lò rèn và cổng nguyên liệu vận hành nó. Kỹ năng được liệt kê là 75 của nó là về lợi ích chứ không phải sự cho phép: với Armorcrafting là chuyên ngành, nó trả toàn bộ kỹ năng đạt được từ cú đánh búa đầu tiên đến 99, vì vậy một Smith có osmium dự phòng có thể dựa vào nó sớm. Dưới mức trần của chuyên ngành, công thức cấp 3 không dạy gì cả, vì vậy một thợ chế tạo áo giáp không được công bố hoặc có sở thích sẽ làm việc đó để lấy tác phẩm chứ không phải điểm.",
        ...
        "leatherworking": {
          ...
          "materialsBody": "Chế biến da là nghề thủ công trong đó lộ trình thăng cấp và đường cung cấp của bạn giống nhau: da thô được thu hoạch ngay từ những xác chết có da, trên hết là chó sói và lợn rừng, và mỗi xác chết chỉ phục vụ một người thu hoạch, ai đến trước được phục vụ trước. Một cuộn thu hoạch hiếm hoặc tốt hơn cũng cấp cho Pristine Hide, một mẫu vật có chữ ký mà Mirewarden Jerkin yêu cầu, vì vậy hãy gửi ngân hàng mọi thứ bạn tìm thấy.\n\nDàn diễn viên phụ rất nhỏ: chân nhện và tơ, vải dệt từ hình người, một quặng osmium duy nhất trong mỗi mảnh quý hiếm của mirewarden (sáu trong viên đá quý Duskhide Wraps) và một Chất thuộc da ở mức 16 đồng từ quầy thuộc da. Bản thân Osmium không bao giờ bị mua ngược lại: hãy tự khai thác nó, trên Thornpeak hoặc gần như bất kỳ mạch khởi đầu nào của khu vực trẻ hơn (chỉ riêng Farshore đào sắt) hoặc mua nó từ người chơi khác.",
          "ladderHeading": "Được đào tạo ở Fenbridge",
          "ladderBody": "Đây là vấn đề: xưởng thuộc da nằm ở Fenbridge, trên con đường Mirefen Marsh, khiến cho ngành Da trở thành một nghề thủ công chuyên sâu được đào tạo trong đầm lầy. Tanner Hesk dạy thang trong thùng của mình: con Fenbridge có bậc thang tự do ở kỹ năng 0, người thống trị bậc thang ở mức 25 bạc theo công thức từ kỹ năng 25, và mirewarden ở bậc thang 1 vàng mỗi người từ kỹ năng 50, mỗi bậc thang sẽ mở ra khi cấp độ của bạn đạt đến cấp độ đó.\n\nBa công thức nấu ăn bỏ qua người huấn luyện: sản phẩm thông dụng ngoài hiện trường (Da thuộc rám nắng và Giấu da của Eastbrook Druid) ở bất cứ đâu ngay từ đầu, và Duskhide Wraps được mọi người biết đến nhưng lại ở kỹ năng 75, thuộc da. Lưu ý rằng bản thân lời thề của Outfitter đã được tuyên thệ trở lại ở Eastbrook với Ottilie; chỉ có việc giảng dạy xảy ra trong đầm lầy.",
          "routeHeading": "Kiệt tác, và con đường thực tế lên 125",
          "routeBody": "Bất kỳ tác phẩm nào có số liệu thống kê thực sẽ mang lại cơ hội tạo ra tác phẩm kiệt tác miễn là chất lượng tốt hơn phù hợp với trần cấp độ của bạn, bao gồm Eastbrook Druid's Hide được thống kê và Pristine Hide đã ký trong Mirewarden Jerkin sẽ tự động cung cấp phần thưởng thuốc thử đã ký; osmium được tính là vật liệu cấp 1 cho quá trình sản xuất. Các tài nguyên ẩn không có trạng thái không thể sản xuất được.\n\nTăng cấp theo cách tự nhiên: thu hoạch mọi con sói và lợn rừng mà bạn giết từ cấp độ một, để hai con vật chung trên đồng ruộng đưa bạn lên cấp 25 dù bạn đứng ở đâu, sau đó huấn luyện thang ẩn náu tại các thùng khi nhiệm vụ vẫn kéo bạn vào đầm lầy. Marshstalker đưa bạn lên 50 và mirewarden lên 75; trước đó, Duskhide Wraps, một công thức cấp 3 với sáu quặng osmium, ba Pristine Hide, hai da thô và một Đại lý thuộc da, trả cho Outfitter mức tăng đầy đủ đến 99 rưỡi sau đó, khoảng 75 hàng thủ công cho 50 điểm cuối cùng đến giới hạn 125; dưới mức trần của chuyên ngành, công thức cấp 3 không dạy gì cả.\n\nXưởng thuộc da di động quan trọng đối với nghề thủ công này hơn bất kỳ xưởng nào khác: chuyên về 75 và một túi da sống sẽ trở thành thiết bị hoàn thiện tại lửa trại thay vì phải đi bộ trở lại Fenbridge. Lệnh sản xuất thuộc da của Hesk mua tám tấm da thô cứ sau 30 phút, trả lại một cách gọn gàng cho những tấm da mà bạn đã thu thập bất kể, và Sách Chứng thư đánh dấu Giao dịch của Tanner ở kỹ năng 50 với Grandmaster Leatherworking ở mức cao nhất."
        },
        "cooking": {
          "identityHeading": "Nồi nuôi sống cả đội",
          "identityBody": "Ăn một bữa ăn đã nấu chín và nó sẽ giúp bạn hồi phục sau 18 giây nghỉ ngơi, đây là cách chữa lành rẻ nhất trong trò chơi. Bậc thang chạy từ Pan-Seared River Perch 90 máu cho đến Marlow's Grand Roast ở mức 980, không có gì hồi máu trong trò chơi.\n\nTrên võ đài Nấu ăn nằm giữa Thuật giả kim và Nghề thuộc da. Cặp đôi còn sống của nó là Dược sĩ, Giả kim thuật và Nấu ăn, đã tuyên thệ trước Cook Marlow tại nhà bếp Eastbrook sau khi săn bốn con lợn rừng để lấy nồi; cặp Trapper với Leatherworking có tên trên võ đài nhưng chưa có nhiệm vụ tuyên thệ.",
          "materialsHeading": "Kho thực phẩm được nuôi bằng cần câu và dao",
          "materialsBody": "Nghề câu cá cung cấp các nguyên liệu đặc trưng, ​​​​theo từng khu vực: cá hồi gương và cá rô sông từ vùng biển Eastbrook Vale, cá pike và lươn đầm lầy từ Mirefen Marsh, cá hồi sương giá và cá chép vây đá phiến từ Thornpeak Heights. Các bậc thang kết hợp các khu vực một cách tự do (các bậc thang tự do đã có cá pike đầm lầy, bậc thang giữa của Thornpeak, và bữa tối hiếm hoi sẽ gấp con cá hồi gương của Vale trở lại), vì vậy một đầu bếp câu cá ở bất cứ nơi nào trên đường đi không bao giờ cạn kiệt.\n\nPhía người bán thịt lấy ra những xác chết đã thu hoạch: thịt thú săn từ lợn lòi và họ hàng của chúng, và trên một cuộn thu hoạch hiếm hoặc ngon hơn, một Prime Cut có chữ ký, phần trung tâm của món nướng hoành tráng. Các loại thảo mộc làm nên món ăn ngon hơn, một khúc gỗ tần bì hun khói con lươn và Muối nấu ăn có giá 8 đồng một túi từ gian hàng riêng của Marlow.",
        ...
        "alchemy": {
          ...
          "identityBody": "Nghề thủ công này được thực hiện tại tiệm bào chế thuốc ở Highwatch, quê hương của Nhà giả kim Verane, Bậc thầy bào chế thuốc, người dạy thang công thức, bán Lọ thủy tinh với giá 12 đồng và trả xu cho các loại thảo mộc thông qua đơn đặt hàng công việc của cô ấy.\n\nTrên võ đài thủ công, Alchemy ngồi với các giao dịch thử và sai, bên cạnh là Kỹ thuật ở một bên và bên kia là Nấu ăn. Điều đó mang lại cho nó hai danh tính cặp: Bombardier (Kỹ thuật và Giả kim thuật, được đảm nhiệm trước Tinker Gizzel ở Eastbrook) và Apothecary (Giả kim thuật và Nấu ăn, tuyên thệ trước Cook Marlow). Hòa hợp với một trong hai cặp để biến Alchemy thành chuyên ngành và để tác phẩm đã ký của chính bạn dạy lại cho bạn; cặp Bombardier cũng mở loại bia kết hợp của mình, Elixir of the Bear, trong khi cặp Apothecary chưa cung cấp công thức kết hợp nào. Tuy nhiên, bản thân chiếc thang không bao giờ chờ đợi vì mọi công thức Giả kim thuật đều nằm trong cấp độ hiếm mà các nghề thủ công không được khai báo hoạt động, vì vậy toàn bộ quá trình leo lên đỉnh đều mở trước bất kỳ lời thề nào.",
          ...
          "ladderBody": "Mọi người đều biết Thuốc chữa bệnh nhỏ ngay từ đầu và có thể trộn nó ở bất cứ đâu, không cần trạm. Bậc thang thực sự là chín công thức nấu ăn do Verane dạy tại tiệm bào chế, ba công thức ở mỗi bậc: công thức kỹ năng 0 là miễn phí, kỹ năng 25 bậc có giá 25 bạc cho mỗi công thức và kỹ năng 50 bậc có giá 1 vàng cho mỗi công thức. Mỗi bậc thang là một loại thuốc chữa bệnh, một loại năng lượng và một loại thuốc tiên cho sức chịu đựng, từ chai lá kim loại thông thường (120 máu, 160 năng lượng) đến lá vàng quý hiếm (200 máu, 260 năng lượng) đến cánh hoa mặt trời hiếm (280 máu, 360 năng lượng).\n\nThuốc tiên tăng theo cách tương tự: Thuốc tiên của lợn rừng cấp 6 sức chịu đựng trong 10 phút, thuốc tiên Vipersear cấp 9 trong 15 phút và thuốc tiên của rắn 12 trong 15 phút, riêng Serpent pha chế hai chai mỗi lần chế tạo. Một công thức nữa nằm ở bên cạnh: Elixir of the Bear, một loại bia kết hợp mà Verane dạy với giá 25 bạc khi Thuật giả kim của bạn đạt 25, có thể trộn ở bất cứ đâu, nhưng chỉ bởi một Bombardier hòa hợp với cả Thuật giả kim và Kỹ thuật ở mức 25.",
          "routeHeading": "Con đường của nhà pha chế lên 125",
          "routeBody": "Thuốc nháp và thuốc tiên không bao giờ tạo nên kiệt tác; Proc đó thuộc về thiết bị chịu lực. Tuy nhiên, tên của bạn vẫn còn được lưu truyền: những bản thảo mặt trời hiếm hoi được giao có ký tên của nhà sản xuất và mỗi chai Elixir of the Serpent hai mẻ cũng vậy, vì vậy không có gì hiếm trong món đồ thủ công này khiến băng ghế không có dấu hiệu. Ở kỹ năng 75, bạn chuyên môn hóa và mọi công thức Giả kim thuật đều tốn nguyên liệu ít hơn 20% kể từ đó trở đi.\n\nHãy tham gia Herbalism sớm và chọn khi bạn lên cấp: sheenleaf có ở khắp mọi nơi ở Vale, và khi bạn đến được băng ghế của Verane, bậc thang tự do sẽ đưa bạn đến kỹ năng 25 về các loại thảo mộc mà bạn đã chọn. Tìm hiểu nấc thứ 25 ngay khi nó bật, di chuyển chiếc hái của bạn đến đầm lầy để lấy lá vàng và để công việc của Verane ra lệnh (sáu Thảo dược lá vàng cho 45 đồng, có thể lặp lại sau mỗi 30 phút) trao lại một ít đồng xu khi bạn đi.\n\nTừ năm 50 trở đi, hãy pha chế các loại thảo dược mặt trời và các mẻ Serpent từ cánh hoa mặt trời Thornpeak, với một ít cây cỏ Vale và đầm lầy vẫn được trộn lẫn. Đoạn cuối cùng từ 100 đến 125 là một sự nhỏ giọt có chủ ý, vì vậy hãy pha những gì thực sự bán được thay vì đốt các loại thảo mộc để lấy số và hãy nhớ rằng hàng tiêu dùng là thứ được chế tạo tốt mà mọi người sẽ mua lại mãi mãi. Sách Chứng thư đánh dấu Strange Brews ở kỹ năng 50 và Grandmaster Alchemy ở mức cao nhất."
        },
        "engineering": {
          "identityHeading": "Độc quyền của người chế tạo công cụ",
          "identityBody": "Nghề thủ công này được thực hiện tại xưởng chế tạo công cụ ở góc tây nam của Quảng trường Eastbrook, quê hương của Tinker Gizzel, Bậc thầy về chế tạo công cụ. Cấp 1 đến cấp 3 của mỗi dòng công cụ đều là hàng thông thường của nhà cung cấp; bậc 4 và 5 xuất phát từ băng ghế của một kỹ sư, hoặc từ quầy khám phá của Drowned Litany để lấy Delve Marks đằng sau cánh cổng trống trải của nó và không bao giờ hết tiền để kiếm xu.\n\nTrên võ đài, nó nằm với các giao dịch thử và sai, bên cạnh Giả kim thuật và Chế tạo áo giáp, mang lại cho nó hai danh tính cặp: Bombardier (Kỹ thuật và Giả kim thuật, được đưa ra trước chính Gizzel) và Gearwright (Chế tạo áo giáp và Kỹ thuật, được đặt tên nhưng chưa có thể thề được). Một cảnh báo quan trọng ở đây hơn bất kỳ nơi nào khác: mọi nấc thang công thức của Kỹ thuật đều nằm trên mức trần cấp hiếm mà các sở thích và thợ thủ công không được công bố làm việc theo, vì vậy số kỹ năng chỉ thay đổi đối với thợ thủ công có chuyên ngành bao gồm Kỹ thuật, ngày nay có nghĩa là Bombardier. Bất kỳ ai cũng có thể chế tạo các công cụ trên đất liền; một người thợ thủ công không được đào tạo sẽ không học được gì từ việc làm đó, và hai công thức chế tạo que cũng yêu cầu sự dạy dỗ của Gizzel.",
          "materialsHeading": "Nguyên liệu và công cụ tiền thân",
          "materialsBody": "Mỗi công thức công cụ trên đất đều yêu cầu công cụ đó ở cấp dưới nó cộng với vật liệu FINE và sự kết hợp đó là toàn bộ bậc thang trên đất: bốn Quặng sắt mịn và một Cuốc khai thác Skysilver trở thành Cuốc khai thác Osmium, sau đó là hai Thanh Glyphsteel, hai Quặng Osmium mịn và cuốc osmium đó trở thành Cuốc khai thác Glyphsteel. Các đường rìu và liềm phản ánh hình dạng của công cụ tốt hơn trước với Gỗ tần bì tốt và Gỗ thông cao nguyên chất, Lá vàng tốt và Thảo mộc Sunpetal tốt, mặc dù các bậc 5 của chúng không yêu cầu Thanh Glyphsteel: lựa chọn là dòng có giá cao hơn ở trên cùng. Hai công thức câu cá có mục đích phá vỡ khuôn mẫu: Stormreel lấy bốn con Sunglint Koi và một con Silverstream, Tidewrought hai con Koi, tám con Cá chép Slatefin thô và con Stormreel đó, vì vậy đỉnh thang của người câu cá được trả bằng tiền trên mặt nước chứ không phải bằng tĩnh mạch.\n\nMột vật liệu tốt không được bán ở bất cứ đâu và không bị rơi ra từ một vụ thu hoạch thông thường: bạn có được nó bằng cách xử lý một trong các mạch cấp độ cao nhất của khu vực bằng một công cụ được xếp trên chính vật liệu đó, trong thực tế có nghĩa là công cụ đó thấp hơn một bậc so với công cụ bạn đang cố gắng xây dựng (một vùng càng dễ dàng giữ cho khách du lịch sẽ mang lại vật liệu đơn giản bất kể bạn xoay). Đó là cố ý. Trên con đường thủ công, công cụ cấp 5 đến từ việc thực sự sử dụng công cụ cấp 4 chứ không phải từ một chuyến đi mua sắm; bộ đếm Delve Marks là một cách giải quyết vấn đề đó. Ngoại lệ duy nhất là Thanh Glyphsteel, được tinh chế và chỉ dành cho nhà cung cấp, 1 bạc 60 đồng một thanh từ Quartermaster Bree ở Highwatch hoặc từ quầy riêng của Gizzel, vì vậy riêng Glyphsteel Mining Pick đã mang một sàn xu cố định được tích hợp vào giá thành của nó.",
          "ladderHeading": "Thang công cụ",
          "ladderBody": "Thang có tám công thức nấu ăn, tất cả đều được gắn vào trạm chế tạo công cụ. Sáu công thức công cụ đất được biết tự động, không bao giờ tính phí huấn luyện: cuốc, rìu và liềm cấp 4 ở kỹ năng 75 và phiên bản cấp 5 ở kỹ năng 150. Số thứ hai đó không phải là lỗi đánh máy và nó nằm trên giới hạn 125 hiện tại có mục đích: yêu cầu kỹ năng không bao giờ giới hạn một nghề ở đây, chúng chỉ định hình mức tăng kỹ năng, vì vậy bạn có thể chế tạo công cụ cấp 5 vào ngày bạn giữ thuốc thử và công cụ tiền nhiệm cấp 4 của nó. Hai cây gậy được chế tạo là ngoại lệ được dạy: Gizzel dạy Stormreel ở kỹ năng 75 với giá 4 vàng và Tidewrought ở kỹ năng 125 với giá 16 vàng, mỗi chiếc đều vào thời điểm cấp độ thủ công của bạn đạt đến cấp độ riêng.\n\nMọi công cụ hoàn thiện đều có chất lượng hiếm hoặc hoành tráng và được ký tên, vì vậy tên của bạn sẽ xuất hiện trên các vùng trên đai công cụ của những người chơi khác. Kỹ thuật cũng nắm giữ một nửa công thức kết hợp: Elixir of the Bear, được pha chế bởi một Bombardier hòa hợp với cả Kỹ thuật và Giả kim thuật ở tuổi 25.",
        ...
        "enchanting": {
          ...
          "identityBody": "Mọi bùa mê đều được biết ngay từ đầu, bất kỳ ai cũng có thể giải bùa ngay từ ngày đầu tiên và không bao giờ cần đến trạm; giới hạn kỹ năng ở mức 125 giống như mọi nghề. Góc được dạy duy nhất của giao dịch là cặp công thức làm bùa: Tinker Gizzel dạy về Bộ nhớ đệm của Người thu thập và Con mắt của Nghệ nhân tại các xưởng chế tạo công cụ ở góc phía tây nam của Quảng trường Eastbrook, với mức phí cấp bậc thông thường khi bùa mê của bạn đạt đến 25 và bản thân các bùa được gia công tại trạm của anh ta.\n\nTrên chiếc nhẫn, nó nằm giữa Khắc chữ và Chế tác trang sức, vì vậy hai cặp danh tính của nó là Arcanist (Dòng chữ và Bùa mê) và Gembinder (Bùa mê và Chế tác trang sức). Cả hai đều chưa thể tuyên thệ, vì cả hai người hàng xóm đều đang chờ công thức nấu ăn đầu tiên của họ, vì vậy hôm nay Enchanting leo lên như một nghề thủ công của mọi người: miễn phí lên cấp độ hiếm trước bất kỳ lời thề nào và một lựa chọn theo sở thích tự nhiên dành cho Bombardier hoặc Apothecary. Enchanters cũng giúp thế giới thu thập tiếp tục hoạt động: hai hiệu ứng công cụ có thể đánh dấu là tác phẩm của Enchanter và một người chế tạo ban đầu sẽ sạc lại các hiệu ứng của chính họ với mức chiết khấu, sâu hơn nữa khi được chuyên dụng hóa.",
          "levelingHeading": "Cách pháp khắc lên cấp",
          "levelingBody": "Ba hành động để di chuyển kỹ năng: giải mã một mảnh, áp dụng bùa mê và chế tạo hai lá bùa, leo lên đường cong chế tạo thông thường. Mỗi thành công có giá trị tối đa một điểm, được tính theo mức độ nghiêm trọng của công việc: độ hiếm của mảnh bạn phá vỡ hoặc cấp thuốc thử của bùa chú bạn áp dụng. Thuốc giải bùa thông thường và bùa chỉ có bụi được tính là công việc phổ biến; những bùa mê không phổ biến và những bùa mê bản chất là không phổ biến; các bùa mê hiếm có và mọi bùa mê Runed hoặc Greater đều hiếm; những kẻ bất mãn sử thi và huyền thoại vẫn được xếp hạng cao hơn trên bảng, mặc dù ngày nay không có danh tính mê hoặc nào vượt qua được bậc thang hiếm có, vì vậy họ phải trả mức lương tương đương với công việc hiếm hoi trong thực tế. Một sự trung thực cai trị băng ghế dự bị: một tác phẩm được lấy ra từ băng ghế của người chơi (được chế tạo, có chữ ký hoặc chế tác thành thạo) vẫn được nghiền thành tài liệu nhưng không dạy gì, do đó, vòng lặp thủ công và phá vỡ không cấp cho ai và các bài học đều có trong thiết bị được tìm thấy trên thế giới.\n\nMức độ mờ dần của thành thạo quen thuộc áp dụng cho cấp 25 điểm, vì vậy công việc cấp thông thường sẽ chuyển sang màu xám ở kỹ năng 75, công việc thông thường ở cấp 100 và công việc cấp hiếm chính xác ở giới hạn 125. Bùa mê cũng có một điểm thú vị riêng: thông tin đầu vào phía trên trần nguyên mẫu của bạn được làm tròn xuống mức trần đó thay vì bằng 0, vì vậy trước khi bạn hòa hợp, một sự bất mãn sử thi chỉ đơn giản là hiếm thay vì không dạy gì cả. Nếu Enchanting kết thúc ở trạng thái không hoạt động đằng sau một danh tính khác, phá vỡ và áp dụng điểm số như một công việc thông thường và việc leo lên dừng ở mức 75, trong khi hai lá bùa, đi theo đường cong chế tạo phía trên trần chung, không dạy gì cho một người mê hoặc không hoạt động; hãy giữ nó như sở thích của bạn và công việc cấp hiếm vẫn được trả lương, chỉ cần vượt qua 75 là chậm hơn.",
          "marketHeading": "Bản sao pháp khắc, nguồn gốc, và thị trường",
          "marketBody": "Áp dụng bùa mê sẽ tiêu tốn thuốc thử và đánh dấu một bản sao cụ thể của vật phẩm. Trỏ nó vào một bản sao được đóng túi và bạn sẽ nhận được một bản sao khác biệt; chỉ nó vào món đồ bạn đang mặc và nó được phù phép tại chỗ, ngay tại chỗ, không có điệu nhảy không trang bị và trang bị lại. Dù thế nào đi nữa, phần thưởng sẽ theo mảnh đó mãi mãi, thông qua việc hủy trang bị, các chuyến đi ngân hàng và giao dịch. Mỗi bùa một mảnh: áp dụng một bùa mê khác cho một bản sao bị phù phép yêu cầu xác nhận, sau đó thay thế hoàn toàn bùa mê cũ, phá hủy nó mà không hoàn lại nguyên liệu của nó. Bán, loại bỏ và loại bỏ tất cả đều ưu tiên các bản sao đơn giản trước tiên, vì vậy tác phẩm hoàn thiện của bạn sẽ không bị ăn mất một cách tình cờ.\n\nThiết bị kiệt tác và bùa mê là bạn bè: một tác phẩm kiệt tác vẫn hoàn toàn có thể mê hoặc và bùa mê sẽ bổ sung thêm phần thưởng cho kiệt tác mà không làm phiền nó hoặc chữ ký của nhà sản xuất. Xếp chồng mọi nguồn, một kiệt tác có chữ ký mang theo Bùa mê lớn hơn là tác phẩm tốt nhất mà một tác phẩm được chế tạo có được và nó vẫn nằm dưới chiến lợi phẩm đột kích theo thiết kế.\n\nTrên thị trường, một tác phẩm được phù phép hoặc có chữ ký được liệt kê giống như bất kỳ thứ gì khác: nó xuất hiện dưới dạng danh sách một bản sao của riêng nó, chú giải công cụ hiển thị bùa mê và nhãn hiệu của nhà sản xuất, và Ravenpost cũng thể hiện điều đó một cách trung thực. Nguyên liệu vẫn là một nửa ổn định của thủ công: Bụi, Tinh chất và Mảnh vỡ được liệt kê tự do, việc liệt kê không mất phí và Người bán chỉ mất 5% của một giao dịch mua đã hoàn thành. Điều đó làm cho hai nhà phù thủy cổ điển có thu nhập từ việc bán nguyên liệu và bán tác phẩm đã hoàn thành: qua chợ, bằng quạ hoặc trực tiếp trong cửa sổ giao dịch."
        }
      },
      "howHeading": "Cách chế tác hoạt động",
      "howBody": "Mở cửa sổ chế tạo (phím mặc định T) và mọi công thức bạn biết đều được liệt kê những gì nó cần và những gì bạn có trong tay. Các công thức nấu ăn liên quan đến trạm yêu cầu bạn đứng trong phạm vi 20 thước tính từ trạm bên phải trong thị trấn, các công thức nấu ăn hiện trường được chế tạo ở bất cứ đâu, và việc phá vỡ và mê hoặc của Enchanting hoàn toàn không cần đến trạm (chỉ có hai công thức quyến rũ của nó là công việc tại trạm, tại xưởng chế tạo công cụ). Không có thất bại: một nghề thủ công với vật liệu trong tay luôn thành công.\n\nHai xích mích nhỏ giữ cho nền kinh tế trung thực. Mỗi chế tạo thành công đều phải trả một khoản phí 2 đồng cho mỗi điểm trong ngân sách chỉ số của vật phẩm và các hành động thuộc loại thủ công có chung một tốc độ: tối đa 10 thủ công, giải mã, bùa mê, cứu hộ hoặc sạc lại công cụ trong mỗi cửa sổ 60 giây. Một phiên họp bình thường cũng sẽ không gặp rắc rối; cả hai đều ngăn chặn một chuyên gia tối đa tràn ngập thị trường.",
      ...
      "masterworkBody": "Mỗi sản phẩm thủ công thành công đều chính xác như những gì công thức hứa hẹn và đôi khi nhiều hơn một chút: một tác phẩm kiệt tác hoàn thiện cùng một tác phẩm với chất lượng tốt hơn một bậc, với các chỉ số thưởng được đưa vào tại thời điểm chế tạo. Nó chỉ là phần bổ sung, không bao giờ hạ cấp và nằm dưới sàn đột kích, vì vậy thiết bị được chế tạo có thể hoạt động tuyệt vời mà không cần thay thế vật phẩm đột kích.\n\nCơ hội được công bố, không có gì thần bí: {base}% cơ bản, cộng với {perTier}% mỗi cấp, kỹ năng của bạn nằm phía trên công thức, cộng với {signed}% khi có bất kỳ thuốc thử đã ký nào được đưa vào, cộng thêm {spec}% khi bạn chuyên biệt, với các nguyên liệu cấp cao hơn sẽ được thêm từ 1 đến 2%, tất cả đều được giới hạn ở mức {cap}%. Chỉ một phần có số liệu thống kê thực sự mới có thể cải thiện, vì vậy, các công cụ, vật phẩm và vật tư tiêu hao không có trạng thái không bao giờ được sản xuất; một nghề thủ công không hoạt động không bao giờ tạo ra một nghề thủ công và một nghề thủ công theo sở thích không thể tạo ra tác phẩm vượt quá mức trần hiếm có của nó.\n\nCông việc tốt đẹp mang theo người tạo ra nó. Các đầu ra hiếm và tốt hơn đều được ký, mỗi bản sao (Được chế tạo bởi; tài liệu được thu thập mang theo Được thu thập bởi), một tác phẩm kiệt tác luôn được ký bất kể chất lượng của nó. Chữ ký là xuất xứ, không phải là khóa: giao dịch hàng hóa đã ký, gửi thư và niêm yết trên Thị trường Thế giới một cách tự do.",
      "trainingHeading": "Học nghề",
      "trainingBody": "Công thức nấu ăn của huấn luyện viên đến từ các bậc thầy thường trú, được dạy tại trạm của họ. Quy tắc là một dòng: một bậc thầy dạy một công thức khi cấp độ trong nghề của bạn đã đạt đến cấp độ riêng của công thức đó và không có gì khác kiểm soát nó, không phải cấp độ của bạn, không phải nguyên mẫu của bạn. Thang trang bị và vật phẩm tiêu hao chạy ở cấp độ kỹ năng 0, 25 và 50; Bài học về hai cây gậy của Kỹ thuật tiếp tục leo lên bậc thang ở mức 75 và 125, đồng thời hai công thức quyến rũ của Bùa mê nằm ở bậc 25, do đó, một bậc thang mới sẽ mở ra khi bậc của bạn leo lên.\n\nPhí được tính một lần và cố định theo từng bậc: bậc bắt đầu là miễn phí, kỹ năng 25 bậc có giá {tier1} một công thức, kỹ năng 50 bậc {tier2} và các bài học về gậy ở trên sẽ có phí riêng, được liệt kê bên cạnh mỗi công thức trong bảng. Bạn phải đứng ở trạm thực tế của chủ nhân để luyện tập, và trạm di động không bao giờ được tính. Các công thức nấu ăn thông thường trên đồng ruộng và sáu công thức chế tạo công cụ trên đất liền không cần đào tạo gì cả; mọi nhân vật đều biết họ ngay từ đầu.",
      ...
      "ench": {
        ...
        "enchantsNote": "Bùa mê có ba tầng. Cấp cơ sở chạy trên Chime Dust (với một ít Tinh chất ở cấp cao nhất) và bao gồm khe vũ khí cộng với mọi khe áo giáp ngoại trừ tay không, với đủ tùy chọn trục chỉ số mà mọi bản dựng đều tìm thấy thứ gì đó cho mỗi khe. Cấp Cao hơn có giá một Mảnh Chime cộng với Tinh chất: phần thưởng mạnh hơn trên các vị trí có tác động cao nhất. Ngoài ra, các mảnh còn cung cấp thêm hai bồn rửa nữa, hai công thức nấu ăn quyến rũ với giá năm mỗi chiếc và mức nạp lại hiệu ứng công cụ cao nhất, vì vậy hãy tích trữ một ít trước khi bạn chi tiêu.\n\nGiữa chúng có năm bùa Runed, một người tiêu dùng cho mỗi loại thứ cấp được nhập, vì vậy không có gì bạn nghiền là ngõ cụt: Runed Edge (vũ khí, Sức mạnh, tiêu thụ Thép cộng hưởng), Runed Sigil (vũ khí, Trí tuệ, Gỗ cộng hưởng), Runed Weave (ngực, Tinh thần, Sợi cộng hưởng), Runed Hide (chân, Nhanh nhẹn, Ẩn cộng hưởng) và Runed Links (mũ bảo hiểm, Sức chịu đựng, Liên kết cộng hưởng). Mỗi người cũng cần hai Tinh chất Chime; trong đó một vị trí và chỉ số có cả cơ sở và bùa mê Lớn hơn, phần thưởng Runed nằm giữa chúng, trong khi Runed Weave hoàn toàn là bùa mê rương mạnh nhất và Runed Hide là bùa mê Agility chân duy nhất. Các phần thưởng chính xác đều có trong bảng dưới đây.",
      ...
      "gatherIntro": {
        "mining": "Hoạt động khai thác kéo quặng thẳng ra khỏi đá trên thế giới: đồng ở Eastbrook Vale, sắt ở Mirefen Marsh, và osmium lên ở Thornpeak Heights, với các mạch khởi động rải rác khắp mọi khu vực trẻ hơn ngoài chúng, nuôi sống các thợ rèn thủ công. Dành cho tất cả mọi người từ cấp 1: một lựa chọn khai thác đồng trị giá 20 đô la từ quầy Eastbrook, Fenbridge hoặc Highwatch sẽ mở ra mọi mạch khởi đầu và các bậc cao hơn của thang chọn sẽ thức dậy khi quầy của chính bạn kiếm được chúng. Được theo dõi trên quầy riêng của mình tới giới hạn 100.",
        "logging": "Việc khai thác gỗ sẽ đốn hạ gỗ từ các cây trên khắp thế giới: vỏ cây sắt ở Eastbrook Vale, gỗ tần bì ở Mirefen Marsh, cây thông cao ở Thornpeak Heights, và các cây mới khai thác ở mọi khu vực trẻ hơn, nguồn nguyên liệu thô cho các trục, cọc và ghế kỹ sư. Dành cho tất cả mọi người từ cấp 1 với rìu khai thác gỗ trong túi của bạn (20 đồng tại các quầy Eastbrook, Fenbridge và Highwatch), được theo dõi trên quầy riêng của mình với giới hạn 100.",
        "herbalism": "Thảo dược thu thập những thứ mọc hoang: lá kim ở Eastbrook Vale, lá vàng ở Mirefen Marsh, cánh hoa mặt trời ở Thornpeak Heights, và những mảng khởi đầu ở mọi khu vực trẻ hơn, lá và thân giữ cho nghề bào chế thuốc phát triển. Dành cho tất cả mọi người từ cấp 1 với liềm thảo dược trong túi của bạn (20 đồng tại các quầy Eastbrook, Fenbridge và Highwatch), được theo dõi trên quầy riêng của mình tới giới hạn 100.",
        "fishing": "Câu cá là một trò chơi kỳ lạ trong số các giao dịch thu thập và sâu sắc nhất: một trò chơi nhỏ thực sự hấp dẫn, các bàn câu cá riêng ở mỗi khu vực trong số ba khu vực trung tâm (các vùng nước trẻ ngoài chúng hiện đều phục vụ bàn của Vale) và giới hạn thành thạo là 200, gấp đôi những vùng khác. Mua một cây sào, đối diện với mặt nước và ném bóng."
      },
      "rhythmHeading": "Nhịp thu hoạch",
      "rhythmBody": "Thu hoạch là một đợt thu hoạch ngắn có thể nhìn thấy được, không phải là thu hoạch ngay lập tức: cơ sở {base} giây, không bao giờ ở dưới tầng hai {floor}. Mang một công cụ lên trên cấp của nút, một công cụ mà mức độ thành thạo của bạn sẽ cho phép bạn sử dụng, tăng tốc độ {tool} giây cho mỗi cấp trên nó và mỗi mức thành thạo bạn vượt qua sẽ cắt giảm {band} giây khác; chỉ cần phù hợp với cấp của nút sẽ đưa bạn vào cửa, chính các cấp phía trên nó sẽ giúp bạn nhanh chóng.\n\nMột chiếc túi đầy sẽ lịch sự từ chối sử dụng trước khi nó bắt đầu, do đó, không có gì bị lãng phí giữa chừng và mỗi vụ thu hoạch sẽ trả một phần nhỏ XP của nhân vật, được chia theo cấp độ của nút so với cấp độ của riêng bạn theo cách tiêu diệt thang XP: một nút màu xám tầm thường không dạy gì về nhân vật bị giới hạn.",
      "gainBody": "Đạt được là mang tính quyết định, không bao giờ là kết quả nâng cao kỹ năng: một nút bằng hoặc cao hơn bậc đạt được của bạn sẽ dạy toàn bộ điểm cho mỗi lần thu hoạch và mỗi mức độ thành thạo {step} là một điểm được tính cho nút đó. Các nút Cấp 1 thanh toán đầy đủ dưới 25, một nửa đến 49, một phần tư đến 74 và không trả gì từ 75 trở đi; các nút cấp 2 thanh toán đầy đủ tới 49; hai nút cấp 3 của mỗi giao dịch thanh toán đầy đủ tới 74 rưỡi cho đến giới hạn {cap}.\n\nLộ trình dự định rất đơn giản: tìm hiểu tại các nút khởi đầu của Vale, di chuyển đến đầm lầy và kết thúc chuyến leo lên vùng đất cao của Thornpeak Heights. Ở mức giới hạn, việc học dừng lại nhưng lợi nhuận thì không: một người thu thập có giới hạn tiếp tục đưa ra tỷ lệ cược tốt nhất mà giao dịch đưa ra mãi mãi.",
      ...
      "toolsNote": "Mỗi nút đều cần có công cụ giao dịch trong túi của bạn, bao gồm cấp 1: không nhặt, không quặng và không cần sào, không cá. Thang của nhà cung cấp bao gồm các tầng từ 1 đến 3 trên ba trung tâm trung tâm: công cụ cấp 1 được bán ở cả ba trung tâm, các bậc phía trên nơi bắt đầu sử dụng chúng (Fenbridge bổ sung cấp 2, Highwatch cấp 3) và các khu định cư trẻ hơn ngoài chúng không có công cụ nào cả, vì vậy hãy chuẩn bị sẵn sàng trước khi bạn đi du lịch. Mọi quầy đều bán miễn phí mọi thứ mà nó dự trữ và mọi công cụ đều được giao dịch trực tiếp; mọi bậc thang cũng được liệt kê trên Thị trường và di chuyển qua đường bưu điện ngoại trừ ba chiếc đất khởi đầu bằng 20 đồng: chúng được mua tại quầy hoặc được truyền tay và không bao giờ bán lại, gửi qua đường bưu điện hoặc niêm yết. Những gì được kiểm soát là việc sử dụng. Một công cụ đất đai trên cấp 1 chỉ hoạt động khi bạn đã đạt được trình độ thông thạo trong giao dịch của chính nó, {tier2Prof} cho cấp 2, {tier3Prof} cho cấp 3, 85 và 100 cho hai bậc được chế tạo, đồng thời hàng nhà cung cấp, chú giải công cụ và bảng bên dưới đều nêu yêu cầu ở phía trước. Cho đến lúc đó, một công cụ được mua trước chỉ cần đợi trong túi của bạn, không cần mở mặt đất, không cần mua tốc độ và không tạo ra các loại tốt, sau đó sử dụng ngay khi bộ đếm của bạn chạm vào số của nó. Cần câu là một ngoại lệ: không có cần câu nào yêu cầu về cách sử dụng và Trader Wilkes ở Eastbrook cố tình dự trữ cần câu cấp 2 và cấp 3 cho những người câu cá mua trước. Một công cụ không bao giờ chiếm một ô trang bị và không bao giờ bị hao mòn, vì vậy mỗi công cụ chỉ được mua một lần và chỉ cấp bậc mới quan trọng đối với cổng: một công cụ hiếm hơn cùng cấp sẽ không mở thêm gì. Tuy nhiên, sự hiếm có không chỉ ở màu sắc. Nó làm cho hiệu ứng công cụ có rãnh tồn tại lâu hơn và trên một thanh, nó sẽ mở rộng cửa sổ cuộn.\n\nMột công cụ tốt hơn mua được ba thứ chứ không phải hai. Nó mở ra mặt đất ở tầng cao hơn, rút ​​ngắn thời gian đúc và cải thiện những gì thu được: xử lý mạch bằng một công cụ được xếp hạng TRÊN vật liệu của chính vùng và thu hoạch mang lại loại tốt thay vì loại đơn giản. Tĩnh mạch phải là một trong những loại cao cấp nhất của khu vực, vì vậy, những tĩnh mạch dễ dàng hơn mà khu vực giữ lại cho khách du lịch vẫn mang lại vật liệu thông thường. Vật liệu tốt là thứ mà các công thức chế tạo công cụ tiêu thụ và cấp tốt được tính là phiên bản thông thường của nó ở bất kỳ nơi nào mà công thức hoặc lệnh sản xuất yêu cầu, vì vậy việc nâng cấp không bao giờ khiến bạn mắc kẹt: điều đó chỉ có nghĩa là quặng đồng của bạn xuất hiện dưới dạng Quặng đồng mịn.\n\nPhía trên bậc thang của nhà cung cấp, mỗi giao dịch có hai công cụ được chế tạo, cấp 4 và cấp 5, được thực hiện tại các xưởng chế tạo công cụ (mọi nhân vật đều biết công thức nấu ăn trên đất liền; kỹ năng leo lên để làm việc là của Kỹ thuật) hoặc được mua bằng Delve Marks tại quầy Drowned Litany sau khi đáp ứng được các cổng thông suốt của nó: bảng bên dưới chứa giá Marks và số lần xóa mà mỗi bậc thang yêu cầu. Không có thương gia nào từng bán chúng để lấy tiền xu. Câu cá có cặp riêng của nó và chúng được học từ người chế tạo công cụ chứ không phải được biết đến ngay từ đầu. Ngày nay, không có nút nào và không có nước nào cần nhiều hơn cấp 3, do đó, hai bậc trên cùng mua tốc độ, cấp độ và cửa sổ cuộn tốt hơn thay vì quyền truy cập và chúng sẽ là tấm vé vào cửa khi cấp cao hơn xuất hiện.",
      "toolCrafted": "Chế tạo ({craft})",
      "toolCraftedOrMarks": "Đã chế tạo ({craft}) hoặc {marks} Dấu Delve sau ba lần xóa Kinh cầu chết đuối",
      "toolCraftedOrMarksHeroic": "Chế tạo ({craft}) hoặc {marks} Dấu ấn xóa sau khi hoàn thành Kinh cầu anh hùng chết đuối",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Không bán",
      "priceNone": "Không bán lấy xu",
      "toolTierReq": "Công cụ bậc {tier}",
      "colWield": "Sử dụng tại",
      "wieldNone": "Bất kì",
      ...
      "bandsBody": "Mức độ thành thạo là thang 0/100/200 được chia sẻ trên quầy giao dịch. Đối với các giao dịch đất đai, dải vượt qua ở mức 100 cạo các khuôn tập hợp và nắp của chúng làm cho dải 1 trở thành trần nhà. Các ban câu cá không cạo gì: họ chọn bàn câu (có cần câu phù hợp), chỉ câu cá đạt đến dải 2, và chính việc leo núi là thứ kéo người câu cá đến vùng nước sâu hơn, nơi cả những chiếc bàn tốt hơn và những bài học xa hơn đều tồn tại.",
      ...
      "specimenBody": "Giữ một ít chỗ trống trong túi khi bạn canh tác: một khoản tiền bất ngờ đã ký cần có chỗ riêng hoặc một ngăn xếp đã ký phù hợp để đưa vào và nếu không có gì phù hợp thì sản lượng vẫn đến nhưng chữ ký sẽ bị mất. Việc thu hoạch xác chết cũng có nhánh độc đắc riêng: khoảng {pct}% mỗi thành phần được thu hoạch là hiếm hoặc tốt hơn. Một gia đình có một mẫu vật hoàn hảo để cung cấp (da, lụa, nọc độc, thịt) giữ nguyên sản lượng thông thường của mình và đúc mẫu vật có chữ ký bên cạnh nó; mọi gia đình khác đều tự mình ký vào giấy sản lượng.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "Cột mốc 100 ghi tên Old Salt và cột mốc 200 ghi danh hiệu Master Angler, đỉnh cao của nghệ thuật câu cá; Câu cá cũng được tính vào Master Gatherer, kiếm được 100 điểm trong cả ba giao dịch thu thập. Con cá đầu tiên từ mỗi vùng nước trong số sáu khu vực sẽ điền vào trang riêng của nó, ba khu vực trung tâm và Willowfen, Galecrest và Farshore phía sau chúng, và Sunglint Koi ghi lại Glimmer of Hope, vì vậy những du khách mang theo một cây sào trong gói sẽ điền vào sổ của họ nhanh hơn họ mong đợi."
      },
      "fish": {
        "startHeading": "Bắt đầu",
        "startBody": "Một cần câu đơn giản có giá 20 đồng từ Fisherman Brandt ở Eastbrook (tìm Old Salt ở rìa phía đông của thị trấn, cạnh con đường đến Mirror Lake); Tinker Gizzel, Provideer Hale ở Fenbridge, và Quartermaster Bree ở cột chứng khoán Highwatch nữa. Sử dụng cần trong khi hướng mặt nước đủ sâu để giữ cá, cách bạn khoảng 24 thước phía trước và phao câu của bạn sẽ căng buồm ra ngoài.\n\nBạn không thể thi triển khi đang chiến đấu, khi đang bơi hoặc khi đã chết: thi triển từ bờ là tư thế dự định. Tuy nhiên, nước trở nên cứng hơn như đất: đầm lầy muốn ít nhất là Ironreel cấp 2 và đỉnh cao là Silverstream cấp 3, và một sợi dây được thả mà không cần thanh mà nước lấy đi sẽ không bao giờ rời khỏi tay bạn. Hai thanh nằm phía trên những cái đó, Stormreel và Tidewrought: các kỹ sư chế tạo chúng tại xưởng công cụ từ những gì một sợi dây kéo lên, và quầy đào sâu của Drowned Litany bán chúng với giá Delve Marks đằng sau cánh cổng trống của nó, mặc dù không bao giờ lấy tiền xu. Không có nước yêu cầu họ, vì vậy họ mua thời gian chờ ngắn hơn và cửa sổ cuộn rộng hơn thay vì quyền truy cập, điều này ở bậc trên cùng có nghĩa là một miếng cắn trong ba giây phẳng.",
        "biteHeading": "Cắn mồi và giật cá",
        "biteBody": "Sau khi bó bột, vết cắn xuất hiện vào thời điểm ẩn giữa {min} và {max} giây; độ trễ được quyết định khi câu thoại hạ cánh, vì vậy không có hai diễn viên nào có cảm giác giống nhau. Khi cần câu câu, bạn có cửa sổ thứ hai {reel} để ấn lại cần câu và cuốn dây: cuộn dây bên trong cần câu và con mồi rơi xuống đất, ngần ngại vượt qua nó và con cá bỏ chạy mà không có gì để lộ. Toàn bộ phiên giới hạn ở {cap} giây, do đó, ngay cả diễn viên im lặng cũng được giải quyết nhanh chóng.\n\nCần tốt hơn sẽ mài sắc cả hai đầu của trò chơi nhỏ: mỗi cấp cần phía trên vòng cắt đầu tiên {rod} giây trong thời gian chờ lâu nhất có thể, không bao giờ ở dưới tầng ba giây, thanh trên cùng đã sượt qua và thêm {reelRod} giây vào cửa sổ cuộn, do đó, Ironreel kéo thời gian chờ tệ nhất xuống 6,5 giây với thời gian chờ 3,25 giây và Silverstream lên 5 với thời gian trên 4, độ hiếm của nó mở rộng cuộn vượt quá một chút so với số tiền mà chỉ riêng cấp đó trả. Những cú cắn nhanh nhất không bao giờ thay đổi bất cứ thứ gì bạn cầm và một cây gậy chỉ cần có trong túi của bạn để đếm.",
        "scheduleHeading": "Tích lũy thành thạo",
        "scheduleNote": "Việc câu cá đạt được theo một lịch trình cố định không có xúc xắc: toàn bộ điểm cho mỗi lần đánh bắt dưới 50, nửa điểm dưới 100, một phần mười dưới 150 và 0,02 nhỏ giọt chậm từ 150 đến 200. Đoạn cuối cùng đó là hành trình hàng nghìn lần đánh bắt có mục đích: 200 là một lời tuyên bố, không phải là điểm dừng trên con đường hướng tới điều gì khác.\n\nJunk ngừng dạy hoàn toàn ở {cutoff}: từ đó cỏ dại và ủng chỉ là cỏ dại và ủng. Bản thân nước cũng đưa ra bài học: vùng nước cấp 1 của Vale (và mọi bờ biển non trẻ ngoài khu vực trung tâm) không dạy gì quá 100, điểm dừng của đầm lầy ở 150, và chỉ có trường học của Thornpeak là người câu cá cho đến tận 200. Mỗi lần đánh bắt được trên bờ đều tăng theo tốc độ đã định, vì vậy khi quầy tính tiền dừng lại, lịch trình sẽ yêu cầu bạn tìm kiếm vùng nước sâu hơn.",
        "colProficiency": "Thành thạo",
        "colGain": "Điểm nhận mỗi lần câu",
        "belowFmt": "Dưới {below}",
        "tablesHeading": "Bảng loại cá câu được",
        "tablesNote": "Trình độ của bạn chọn một trong ba dải bắt: dải 0 ngay từ đầu, dải 1 ở mức 100, dải 2 ở mức 200, mỗi dải chuyển trọng lượng ra khỏi rác và lưỡi câu trống thành cá thật, từng khu vực. Mỗi dải phía trên dải đầu tiên cũng yêu cầu một cây gậy: dải 1 muốn Ironreel cấp 2, dải 2 muốn Silverstream cấp 3. Dải hiệu quả của bạn là mức thấp hơn so với những gì kỹ năng của bạn đã kiếm được và những gì cần câu của bạn hỗ trợ, đồng thời nắp không có tiếng ồn: bạn vẫn bắt được cần câu nhỏ hơn, ngay ngoài bảng của dải dưới, vì vậy nếu số lần bắt của bạn cảm thấy bị kẹt trong khi kỹ năng của bạn tăng lên, hãy kiểm tra cần câu của bạn trước.\n\nVùng nước của mỗi khu vực có cặp cá thức ăn riêng, vùng càng sâu sẽ chữa lành vết thương nhiều hơn, tất cả đều là đầu vào nấu ăn và thức ăn sống hoàn toàn ngon để ngồi ăn ngay trên dây chuyền. Phần còn lại của bảng là thuế của người câu cá: cỏ dại, chiếc ủng thỉnh thoảng và chiếc móc trống, những thứ không bao giờ biến mất hoàn toàn. Số tiền bạn trả tùy thuộc vào vùng nước mà chiếc phao của bạn đáp xuống, chứ không phải nơi bạn đứng: một vật đúc dài tới 24 thước Anh, và cần nước yêu cầu, chiếc bàn mà nó lấy ra, chứng thư mà nó ghi nhận và khoảng cách mà nó dạy tất cả câu trả lời cho khu vực có nước, được quyết định vào thời điểm dây tiếp đất. Nước của mỗi khu vực được viết cho một dải riêng, Vale dành cho dải 0, đầm lầy dành cho dải 1, các đỉnh dành cho dải 2 và câu cá ở một dải dưới đó sẽ biến khoảng một phần ba số phôi của bạn thành những chiếc móc trống, hai dải dưới đó hơn một nửa. Cây gậy sẽ đưa bạn xuống nước; kỹ năng là thứ khiến nó phải trả giá, và việc leo lên là thứ kéo người câu cá vào sâu hơn, bởi vì dây tốt hơn không chỉ được trả lương cao hơn: qua Vale, chúng là những vùng nước duy nhất tiếp tục giảng dạy. {rare} là một hàng trả lời cho dải bắt của bạn và không có gì khác: tỷ lệ cược giống nhau ở mọi khu vực và khả năng xảy ra ở dải 2 cao gấp sáu lần so với ở dải 0, vì vậy điều hiếm nhất trên bến tàu là thứ mà một Bậc thầy câu cá thực sự giỏi hơn.",
        ...
        "koiBody": "Mỗi vùng nước trong trò chơi đều ẩn chứa một giải thưởng giống nhau: Sunglint Koi, một tia sáng hiếm có trên dây có giá trị 75 đồng cho người bán và hơn thế nữa là niềm tự hào của bạn. Tỷ lệ cược của nó trả lời cho dải bắt của bạn và không có gì khác, giống nhau ở mọi khu vực: một hàng 1 phần trăm của bảng bắt ở dải 0, 3 ở dải 1 và 6 ở dải 2, được rút ra trên mỗi cuộn dây, vì vậy cá koi sẽ đến với người câu cá kiếm được bàn sâu. Hạ cánh một bản ghi Tia hy vọng trong Sách việc làm của bạn, một nhà sưu tập không có danh tiếng. Khi điều đó xảy ra, nhật ký sẽ đảm bảo rằng bạn biết."
      },
      "econ": {
        ...
        "trainingNote": "Một khoản phí cố định cho mỗi bậc công thức, được tính một lần khi thầy dạy nó; mọi bậc của bảng dưới đây đều được sử dụng trực tiếp ngày nay, từ các công thức khởi đầu miễn phí cho đến các bài học chế tạo dụng cụ ở trên cùng.",
        ...
        "provenanceBody": "Một số mặt hàng mang một cái tên. Di chuột qua một và chú giải công cụ cho biết Được thu thập bởi người nào đó trên một nguyên liệu thô, hoặc Được chế tạo bởi người nào đó trên một sản phẩm đã hoàn thiện: cùng một nhãn hiệu, được diễn đạt về cách sản phẩm đó ra đời. Chữ ký là một phần của chính vật phẩm đó, đi cùng với nó qua các giao dịch, ngân hàng, thư tín, Thị trường Thế giới và thậm chí cả việc mua lại của nhà cung cấp và không bao giờ phai mờ.\n\nViệc thu thập các dấu hiệu hoạt động tốt nhất một cách tự động: bất kỳ vụ thu hoạch nào hiếm hoặc tốt hơn đều được ký kết và các phát hiện hiếm sẽ báo hiệu toàn bộ vận may gấp năm lần của chúng. Vòng quay may mắn của một vụ thu hoạch xác chết sẽ ký tên vào sản lượng của nó khi gia đình không có mẫu vật nào để đưa, và ở những nơi đó, họ giữ nguyên sản lượng và đúc mẫu vật nguyên sơ đã có chữ ký bên cạnh nó. Việc tạo ra các dấu hiệu theo cùng một quy trình: mọi bản sao của một loại đúc hiếm hoặc tốt hơn đều được ký tên và một tác phẩm kiệt tác luôn ký bất kể chất lượng của nó, vì vậy phiên bản tốt nhất của bất kỳ tác phẩm nào luôn ghi tên người tạo ra nó. Một thứ có thể khiến bạn mất chữ ký là một túi đầy: một đơn vị đã ký cần có chỗ riêng hoặc một ngăn xếp có chữ ký phù hợp để đưa vào.\n\nMột chồng vật phẩm có chung một danh tính, vì vậy hai bản sao chỉ hợp nhất khi mọi nhãn hiệu khớp chính xác: cùng một vật phẩm, cùng người ký, cùng chỉ số kiệt tác, cùng bùa mê, cùng mối liên kết. Một nhật ký đã ký không bao giờ kết hợp với một đống đơn giản theo một trong hai hướng (việc hợp nhất sẽ xóa tên của ai đó), nhưng các trọng tải giống hệt nhau sẽ hợp nhất một cách vui vẻ, vì vậy hai mươi quặng được ký bởi cùng một người thu thập sẽ nằm trong một chồng và một cơn gió bất ngờ sẽ không làm rách túi của bạn.\n\nChữ ký trả lại tiền cho những người chế tạo: giữ bất kỳ bản sao có chữ ký nào của thuốc thử cần thiết trên bàn làm việc, bất kỳ ai đã ký vào đó, sẽ tăng thêm 2 điểm phần trăm cơ hội thành công và giữ thuốc thử do chính tay bạn ký sẽ cắt giảm một lượng yêu cầu của thuốc thử đó (không bao giờ thấp hơn một). Tác phẩm hiếm hoặc tốt hơn có chữ ký của chính bạn thậm chí còn tiếp tục dạy bạn, hôm nay chỉ thông qua chiếc bình: uống một lọ thuốc mà bạn đã ký và một chút kỹ năng nhỏ sẽ quay trở lại với nghề đã pha chế ra nó, miễn là nghề đó là một trong những chuyên ngành đang hoạt động của bạn.",
        ...
        "throttleBody": "Đầu ra có mức trần: việc chế tạo, giải bùa, mê hoặc, cứu vãn và nạp lại hiệu ứng công cụ chia sẻ một ngân sách gồm {actions} hành động thành công trong mỗi cửa sổ {seconds} giây. Một nỗ lực bị từ chối không tốn kém gì và không tiêu tốn ngân sách. Bạn sẽ không bao giờ cảm nhận được điều đó khi chơi bình thường; nó tồn tại nên một chuyên gia tối đa với ngân hàng đầy đủ không thể tràn ngập Thị trường, bất kể kỹ năng hay kho dự trữ của họ.",
      ...
      "faq": {
        ...
        "a4": "Bạn đã trúng một điều may mắn. Khoảng 1 vụ thu hoạch vào năm 90 đã gây ra một sự kiện thu thập hiếm hoi (tâm gỗ cổ xưa trên cây, mạch nguyên sơ trên quặng, hoa nở dưới ánh trăng trên các loại thảo mộc): nó nhân sản lượng lên gấp năm lần, ký tên vào mỗi đơn vị và thông báo phát hiện cho toàn bộ khu vực. Một cuộn hiếm hoặc tốt hơn trong một vụ thu hoạch thông thường cũng báo hiệu sản lượng.\n\nCác tài liệu đã ký rất đáng được lưu giữ hoặc bán với giá đắt: giữ bất kỳ bản sao có chữ ký nào của thuốc thử cần thiết ở bàn làm việc sẽ tăng thêm 2 điểm phần trăm cho cơ hội tạo ra tác phẩm kiệt tác. Chỉ cần nhớ rằng họ chỉ xếp chồng các bản sao có chữ ký giống hệt nhau, vì vậy họ giữ một khe túi riêng.",
        ...
        "a6": "Chín công thức nấu ăn phổ biến trên đồng ruộng và sáu công thức chế tạo công cụ làm đất đã được mọi người biết đến ngay từ đầu, cùng với đó là ba viên đá chụp ở trạm (Kilnscale Mantle, Wardweave Cowl và Duskhide Wraps), không cần người huấn luyện, chỉ cần trạm của họ. Mọi thứ khác đều được giảng dạy bởi các bậc thầy thường trú tại các trạm của họ trên khắp ba thị trấn trung tâm: hầu hết đều làm việc ở Eastbrook, thợ thuộc da giữ xưởng thuộc da ở Fenbridge, và nhà giả kim giữ hiệu thuốc ở Highwatch.\n\nCông thức nấu ăn của huấn luyện viên chạy theo các bậc: kỹ năng 0, 25 và 50 cho trang bị và đồ thủ công tiêu hao, miễn phí, 25 bạc và 1 vàng tính phí một lần; Hai công thức quyến rũ của Enchanting nằm ở bậc 25 và người chế tạo công cụ dạy hai cần câu được chế tạo ở mức 75 và 125 với giá 4 và 16 vàng. Bậc thầy dạy một công thức khi khung của bạn trong nghề đó đã đạt đến khung riêng của công thức đó và bạn phải đứng ở trạm của họ để học: trạm di động không được tính.",
        "q7": "Tại sao việc thu hoạch của tôi đột nhiên chậm lại?",
        "a7": "Quá trình thu thập bắt đầu ở mức 2,5 giây và được giảm xuống theo hai cách: 0,4 giây cho mỗi cấp công cụ bạn mang theo và có thể sử dụng phía trên cấp của nút đó và 0,15 giây khi bộ đếm giao dịch của bạn vượt qua dải 100, với thời gian sàn là 1,5 giây. Di chuyển từ các nút cấp 1 lên các nút cấp 3 và phần dư thừa của bạn sẽ biến mất, do đó, lượt chọn tương tự lại dao động chậm hơn. Giữ chính xác cấp độ yêu cầu sẽ không mua được tốc độ; nó chỉ mở nút.\n\nViệc đạt được kỹ năng sẽ mờ dần giống như cách chế tạo: một nút chuyển sang màu xám khi trình độ của bạn vượt qua cấp độ của nó (các nút cấp 1 không dạy gì từ mức độ thành thạo 75 trở đi), vì vậy câu trả lời cho việc tăng chậm là các nút cấp cao hơn. Những người đó cần một công cụ ít nhất ở cấp độ của họ trong túi của bạn (không có nút nào được sử dụng bằng tay không, bao gồm cả cấp 1) và một công cụ trên cạn ở cấp 1 cũng muốn có điểm sử dụng trước tiên, 40/70/85/100 trong giao dịch riêng của nó đối với cấp 2 đến cấp 5. Câu cá tuân theo mức độ giảm dần của riêng nó: mức tăng tối đa dưới 50, dưới 100, một nửa dưới 100, nhỏ giọt 0,1 dưới 150 và 0,02 dưới 200, việc đánh bắt rác chẳng dạy được điều gì từ 100 trở đi, và bản thân nước đã giới thiệu bài học (các vùng nước cấp 1 ngừng dạy ở 100, đầm lầy ở 150), do đó, quầy đếm bị đình trệ cũng có thể có nghĩa là bạn đã vượt quá mức nước.",
        "q8": "Tôi có thể chế tác khi không ở trong thị trấn không?",
        "a8": "Một phần. Chín công thức nấu ăn phổ biến (vũ khí khởi đầu, áo giáp, thực phẩm và thuốc chủ yếu) được chế tạo ở mọi nơi, mọi lúc và ba công thức kết hợp của các cặp tuyên thệ cũng vậy. Mọi thứ khác phía trên chúng đều được ràng buộc với một loại trạm: lò rèn, nhà bếp, tiệm bào chế thuốc, xưởng thuộc da, khung dệt hoặc xưởng chế tạo dụng cụ và bạn phải ở trong phạm vi 20 thước tính từ trạm để nghề thủ công có thể đi qua.\n\nỞ mức 75 kỹ năng trong một nghề thủ công mà bạn chuyên môn hóa, và cùng với việc giảm giá 20% nguyên liệu, bạn sẽ có được một trạm di động: đặt nó trên cánh đồng và nó tồn tại trong 10 phút, phục vụ các công thức nấu ăn của nghề thủ công đó như thể bạn đang ở thực tế. Trạm di động chỉ dành cho việc chế tạo: việc học các công thức nấu ăn và hoa hồng không ràng buộc luôn yêu cầu trạm thực sự trong thị trấn."
      }
    },
    "economy": {
  ...
  "questUi": {
    "tracker": {
      ...
      "unknownQuest": "Nhiệm vụ không xác định ({id})"
    },
    "log": {
      ...
      "repeatableStatus": "Có thể lặp lại",
      "cooldownStatus": "Sẽ sớm có lại",
    ...
    "dialog": {
      ...
      "repeatableQuestAria": "Nhiệm vụ có thể lặp lại: {name}",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "destroyCancel": "Hủy",
      "unknownItem": "Mục không xác định",
      "unknownItemAria": "Mặt hàng không xác định {id}, số lượng {count}",
      "unknownItemAriaMasterwork": "Mặt hàng không xác định {id}, số lượng {count}, kiệt tác",
      "unknownItemAriaEnchanted": "Vật phẩm không xác định {id}, số lượng {count}, bản sao mê hoặc",
      "unknownItemAriaBound": "Mục không xác định {id}, số lượng {count}, bản đóng bìa",
      "unknownItemAriaInstanced": "Mặt hàng không xác định {id}, số lượng {count}, bản sao do nhà sản xuất đánh dấu"
    },
    "equipment": {
      "empty": "Trống",
    ...
    "vendor": {
      ...
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Mua {count} một lần",
      "qtyCustom": "Phong tục",
      "qtyCustomAria": "Chọn số lượng tùy chỉnh để mua",
      "buyCountAria": "Mua {count} của {item} với giá {price}",
      "buyCountAriaWithRequirement": "Mua {count} của {item} với giá {price}. {requirement}",
      "buyQuantityTitle": "Mua bao nhiêu {item}? Lên tới {max}.",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_thorium_ore": {
        "name": "Quặng Osmium mịn"
      },
      "fine_ironbark_log": {
        "name": "Nhật ký vỏ sắt tốt"
      },
      "fine_ashwood_log": {
        "name": "Gỗ tần bì mịn"
      },
      "fine_elderwood_log": {
        "name": "Nhật ký Highpine tốt"
      },
      "fine_silverleaf_herb": {
        "name": "Thảo mộc Sheenleaf tốt"
      },
      "fine_goldleaf_herb": {
        "name": "Thảo dược lá vàng tốt"
      },
      "fine_sunpetal_herb": {
        "name": "Thảo mộc Sunpetal tốt"
      },
      "stormreel_fishing_rod": {
        "name": "Cần câu Stormreel"
      },
      "tidewrought_fishing_rod": {
        "name": "Cần câu thủy triều"
      },
      "duskwisp_essence": {
      ...
      "gatherers_cache": {
        "name": "Bộ nhớ đệm của người thu thập"
      },
      "artisans_eye": {
        "name": "Mắt nghệ nhân"
      },
    ...
    "quests": {
      ...
      "q_the_codfather": {
        "title": "The Codfather",
        "text": "Codfather không chỉ là một con cá, {playerName}, hắn còn là một kẻ giết người máu lạnh. Những người xưa thề rằng anh ta ăn Mire Prowlers vào bữa sáng, và ngay cả những Góa phụ Mirefen cũng sẽ không giăng mạng gần Deepfen Shallows vì quá kinh hãi. Anh ta cai trị những vùng nước đó, và vùng nước đầm lầy cần có Cần câu Ironreel, không hơn không kém; quầy của tôi bán chúng. Hãy cầm lấy một chiếc, kéo con quỷ già đó ra khỏi vùng nước của hắn, và tôi sẽ thừa nhận bạn đã gia nhập gia đình.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "Tôi đã từng nhìn thấy những dấu vết này trước đây, trên ba ngôi mộ cổ xung quanh chiến trường phía Bắc. Thuyền trưởng Aldren nằm trên đỉnh núi phía tây, High Priest Malric xa hơn về phía nam dọc theo rìa phía tây, và Royal Assassin Voss ở vách đá phía đông. Chạm vào từng ngôi mộ và lắng nghe, {playerName}. Người chết có thể nhớ những gì người sống đã quên.",
