...
export const vi_VN: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Hãy chọn WOC Wallet, Phantom hoặc Solflare. Ứng dụng ví của bạn sẽ yêu cầu phê duyệt. Giữ trò chơi này mở và quay lại khi hoàn thành.",
    "standaloneAppHelp": "Kết nối ví chưa có sẵn trong ứng dụng Màn hình chính. Hãy mở World of ClaudeCraft trong Safari hoặc Chrome để sử dụng WOC Wallet, Phantom hoặc Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "Không tìm thấy tiện ích mở rộng ví tương thích nào. Hãy cài đặt hoặc mở khóa WOC Wallet, Phantom, Solflare hoặc ví trình duyệt Solana khác, rồi thử lại.",
