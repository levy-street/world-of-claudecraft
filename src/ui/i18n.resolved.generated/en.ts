...
export const en: EnTranslations = {
  ...
  "game": {
    ...
    "talents": {
      ...
      "available": "Available",
      "spent": "Spent",
      "pointSource": "Choice rows unlock from level {first} to {cap}. Pick one option from each unlocked row.",
      "apply": "Apply changes",
      "clear": "Reset choices",
      "reset": "Reset",
      ...
      "createBuildHint": "New build saves your current choices as a separate build. Import pastes a shared build string.",
      ...
      "unlockHint": "Talent choices are available: press N to open Talents.",
      "copy": "Copy",
      "close": "Close",
      "cancel": "Cancel",
  ...
  "guide": {
    ...
    "talentsPage": {
      ...
      "whatBody": "As you level, talent rows unlock with a small set of choices. Each pick adds a permanent upgrade to your abilities, stats, or toolkit, shaping how your class feels in combat.",
      "howHeading": "How they work",
      "howBody": "Rows unlock as you level, and specializations open at level 10. Choose a specialization for its signature ability and mastery, then use the Choices tab to pick one option from each unlocked row.",
      ...
      "resetNote": "You can reset your choices any time you are out of combat, so an early pick is never a trap. Try things, see what you like, and change your mind freely.",
