...
export const en: EnTranslations = {
  ...
  "guide": {
    ...
    "combat": {
      ...
      "hitBody": "Attacks can miss, be dodged, or be parried, and so can the enemy's, while spells can be resisted outright. Fighting close to your own level is what keeps your hits connecting; the wider the level gap, the more you swing at air.",
