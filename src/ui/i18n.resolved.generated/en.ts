...
export const en: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Choose WOC Wallet, Phantom, or Solflare. Your wallet app will ask for approval. Keep this game open and return to it when finished.",
    "standaloneAppHelp": "Wallet connections are not available in the Home Screen app yet. Open World of ClaudeCraft in Safari or Chrome to use WOC Wallet, Phantom, or Solflare.",
