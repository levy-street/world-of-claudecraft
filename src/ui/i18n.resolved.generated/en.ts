...
export const en: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "clusterHoldNote": "How long to hold an on-screen action button before its binding editor opens. Raise it if you trigger the editor while spamming skills.",
      ...
      "targetPriorityNote": "What the Attack button targets when you have no valid target: the nearest enemy, the lowest-health enemy in range, or keep your current target while it stays valid.",
      "aimAssist": "Smart Skill Cast",
      "aimAssistNote": "Press an offensive skill to cast on your target, or the best nearby enemy if you have none, turning to face it. Hold the button to preview the skill range; release with your finger off the button to cancel.",
