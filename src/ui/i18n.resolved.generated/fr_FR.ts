...
export const fr_FR: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "lootHistory": "Historique",
      "title": "{tab} - {view}",
      "noCombat": "Aucun combat enregistré.",
      "noLoot": "Aucun butin enregistré.",
      "recentAwards": "{count} attributions récentes",
      "target": "Cible : {name}",
      "noTargetEngaged": "Aucune cible engagée.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Passé",
      "methodMaster": "Maître",
      "methodPersonal": "Personnel",
      "methodDelve": "Gouffre",
      "methodLooted": "Ramassé",
