...
export const fr_FR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customizeTitle": "Personnaliser les commandes",
      "customizeSlotAttack": "Attaque de base",
      "customizeSlotSkill": "Compétence {n}",
      "customizeSlotUtility": "Utilitaire",
      "customizeDefault": "Défaut de classe",
      "customizeResetSlot": "Réinitialiser cet emplacement",
      "customizeResetAll": "Tout réinitialiser aux défauts de classe",
      "customizeUpdated": "{slot} mis à jour.",
      "customizeAllReset": "Commandes réinitialisées aux défauts de classe."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Délai de maintien pour éditer",
      "clusterHoldNote": "Durée de maintien d’un bouton d’action à l’écran avant l’ouverture de l’éditeur d’assignation. Augmentez-la si vous ouvrez l’éditeur en enchaînant les compétences.",
      "targetPriority": "Priorité de cible d’attaque",
      "targetPriorityNearest": "Le plus proche",
      "targetPriorityLowestHp": "Vie la plus faible",
      "targetPriorityCurrent": "Cible actuelle d’abord",
      "targetPriorityNote": "Ce que le bouton Attaque cible quand vous n’avez aucune cible valide : l’ennemi le plus proche, l’ennemi à la plus faible vie à portée, ou conservez votre cible actuelle tant qu’elle reste valide.",
      "aimAssist": "Lancement intelligent",
      "aimAssistNote": "Appuyez sur une compétence offensive pour la lancer sur votre cible, ou sur le meilleur ennemi à proximité si vous n’en avez pas, en vous tournant vers lui. Maintenez le bouton pour prévisualiser la portée; relâchez le doigt hors du bouton pour annuler.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Réinitialiser les commandes tactiles",
      "touchResetDone": "Commandes tactiles rétablies aux valeurs par défaut.",
