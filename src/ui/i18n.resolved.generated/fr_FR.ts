...
export const fr_FR: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Choisissez WOC Wallet, Phantom ou Solflare. Votre application de portefeuille demandera une approbation. Gardez ce jeu ouvert et revenez-y une fois terminé.",
    "standaloneAppHelp": "Les connexions de portefeuille ne sont pas encore disponibles dans l'application de l'écran d'accueil. Ouvrez World of ClaudeCraft dans Safari ou Chrome pour utiliser WOC Wallet, Phantom ou Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "Aucune extension de portefeuille compatible n'a été trouvée. Installez ou déverrouillez WOC Wallet, Phantom, Solflare ou un autre portefeuille Solana pour navigateur, puis réessayez.",
