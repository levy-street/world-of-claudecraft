...
export const it_IT: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "dune_prowler_pelt": {
        "name": "Pelle di predatore delle dune"
      },
      "glasswind_stinger": {
        "name": "Pungiglione di vento di vetro"
      },
      "stolen_relic": {
        "name": "Reliquia rubata"
      },
      "nameless_burial_shroud": {
        "name": "Sudario funebre senza nome"
      },
      "storm_glass_core": {
        "name": "Nucleo di vetro di tempesta"
      },
      "verdict_seal": {
        "name": "Sigillo di verdetto"
      },
      "glasswind_husk": {
        "name": "Guscio di vento di vetro"
      },
      "mirage_stalker_eye": {
        "name": "Occhio di predatore dei miraggi"
      },
      "dig_manifest": {
        "name": "Manifesto di scavo"
      },
      "tomb_censer": {
        "name": "Incensiere tombale"
      },
      "sentence_tablet": {
        "name": "Tavoletta di sentenza"
      },
      "duststorm_heart": {
        "name": "Cuore di tempesta di polvere"
      },
      "ravager_hide": {
        "name": "Pelle di devastatore"
      },
      "aqueduct_bronze": {
        "name": "Raccordo di bronzo dell'acquedotto"
      },
      "judge_regalia": {
        "name": "Paramenti della Prima Corte"
      },
      "sunbleached_fang": {
        "name": "Zanna sbiancata dal sole"
      },
      "cracked_scarab_shell": {
        "name": "Guscio di scarabeo incrinato"
      },
      "emberjaw_pelt": {
        "name": "Pelle della matriarca Fauce di Brace"
      },
      "karns_funeral_mask": {
        "name": "Maschera funebre di Karn"
      },
      "qesh_flatbread": {
        "name": "Focaccia di Qesh"
      },
      "oasis_waterskin": {
        "name": "Otre dell'oasi"
      },
      "spiced_scarab_skewer": {
        "name": "Spiedino di scarabeo speziato"
      },
      "duneweave_robe": {
        "name": "Veste di trama delle dune"
      },
      "caravan_guard_hauberk": {
        "name": "Usbergo di guardia carovaniera"
      },
      "prowlerhide_vest": {
        "name": "Corpetto in pelle di predatore"
      },
      "sandwalker_treads": {
        "name": "Calzari del viandante delle sabbie"
      },
      "dunewatch_legguards": {
        "name": "Cosciali della vedetta delle dune"
      },
      "qesh_khopesh": {
        "name": "Khopesh di Qesh"
      },
      "judgestaff_of_ossara": {
        "name": "Bastone del giudice di Ossara"
      },
      "glasswind_talon": {
        "name": "Artiglio di vento di vetro"
      },
      "emberjaw_prowlgrips": {
        "name": "Prese da caccia di Fauce di Brace"
      },
      "unburied_gravewraps": {
        "name": "Bende sepolcrali dell'Insepolto"
      },
      "sandmaw_scale_cuirass": {
        "name": "Corazza di scaglie di Fauce di Sabbia"
      },
      "tyrantfang_edge": {
        "name": "Filo Zanna di Tiranno"
      },
      "palewidow_silk": {
        "name": "Seta di vedova pallida"
      },
      "waterlogged_ledger": {
        "name": "Registro fradicio"
      },
      "guildless_sigil": {
        "name": "Sigillo dei senza gilda"
      },
      "silent_court_seal": {
        "name": "Sigillo della Corte Silenziosa"
      },
      "duskmane_pelt_strip": {
        "name": "Striscia di pelle di criniera crepuscolare"
      },
      "palewidow_venom_sac": {
        "name": "Sacca velenifera di vedova pallida"
      },
      "quay_manifest": {
        "name": "Manifesto fradicio del molo"
      },
      "wisplight_essence": {
        "name": "Essenza di fuoco fatuo"
      },
      "drowned_toll_coin": {
        "name": "Moneta di pedaggio annegata"
      },
      "cutthroat_contract": {
        "name": "Contratto da tagliagole"
      },
      "court_ledger_page": {
        "name": "Pagina del registro della Corte"
      },
      "frostpine_war_totem": {
        "name": "Totem di guerra di Pino Brinato"
      },
      "rimeclaw_pelt": {
        "name": "Pelle di artiglio di brina"
      },
      "duskmane_tuft": {
        "name": "Ciuffo di criniera crepuscolare"
      },
      "guttering_wisp_mote": {
        "name": "Favilla di fuoco fatuo tremolante"
      },
      "frostpine_charm": {
        "name": "Talismano di Pino Brinato"
      },
      "palefang_pelt": {
        "name": "Pelle di Zanna Pallida il Silenzioso"
      },
      "grelnoks_frozen_idol": {
        "name": "Idolo ghiacciato di Grelnok"
      },
      "nighthollow_black_bread": {
        "name": "Pane nero di Cavanotte"
      },
      "pinefrost_tea": {
        "name": "Tè di brina di pino"
      },
      "smoked_blackmere_eel": {
        "name": "Anguilla affumicata del Lago Nero"
      },
      "wispweave_robe": {
        "name": "Veste di trama di fuoco fatuo"
      },
      "quayguard_hauberk": {
        "name": "Usbergo di guardia del molo"
      },
      "duskstalker_vest": {
        "name": "Corpetto di predatore del crepuscolo"
      },
      "nightpath_treads": {
        "name": "Calzari del sentiero notturno"
      },
      "blackriver_legguards": {
        "name": "Cosciali del Fiume Nero"
      },
      "terracewatch_leggings": {
        "name": "Gambali della vedetta delle terrazze"
      },
      "quays_cutlass": {
        "name": "Storta dei moli"
      },
      "wispcaller_staff": {
        "name": "Bastone del richiama-fuochi"
      },
      "whispersteel_stiletto": {
        "name": "Stiletto d'acciaio sussurrante"
      },
      "palefang_grips": {
        "name": "Prese di Zanna Pallida"
      },
      "hoarbound_bindings": {
        "name": "Legami del Vincolato alla Brina"
      },
      "forsworn_lamellar": {
        "name": "Corazza lamellare dello Spergiuro"
      },
      "forsworn_edge": {
        "name": "Filo dello Spergiuro"
      },
      "stolen_tithe_ledger": {
        "name": "Registro delle decime rubato"
      },
      "granite_core_shard": {
        "name": "Scheggia di nucleo di granito"
      },
      "legion_deserter_insignia": {
        "name": "Insegna di disertore della Legione"
      },
      "chewed_tithe_scrip": {
        "name": "Buono di decima masticato"
      },
      "candle_tax_tally": {
        "name": "Conteggio della tassa sulle candele"
      },
      "assay_office_seal": {
        "name": "Sigillo dell'ufficio di saggio"
      },
      "legion_pay_manifest": {
        "name": "Manifesto delle paghe della Legione"
      },
      "prime_wolf_pelt": {
        "name": "Pelle di lupo di prima scelta"
      },
      "wendigo_gallstone": {
        "name": "Calcolo biliare di wendigo"
      },
      "icehowler_ruff": {
        "name": "Collare di ululatore dei ghiacci"
      },
      "legion_quarrel_bundle": {
        "name": "Fascio di quadrelli della Legione"
      },
      "clipped_imperial_coin": {
        "name": "Moneta imperiale tosata"
      },
      "rimewoven_hide": {
        "name": "Pelle intessuta di brina"
      },
      "sellsword_pig_iron": {
        "name": "Ghisa da mercenario"
      },
      "lean_wolf_haunch": {
        "name": "Coscia magra di lupo"
      },
      "pilfered_ration_pack": {
        "name": "Sacca di razioni trafugata"
      },
      "sellsword_requisition_chit": {
        "name": "Buono di requisizione da mercenario"
      },
      "frostbrush_wolf_fang": {
        "name": "Zanna di lupo di Sterpabrina"
      },
      "bent_legion_buckle": {
        "name": "Fibbia piegata della Legione"
      },
      "ogre_knuckle_dice": {
        "name": "Dadi di nocca d'ogre"
      },
      "hoarfang_pelt": {
        "name": "Pelle dell'alfa Zanna di Brina"
      },
      "kazriks_brass_whistle": {
        "name": "Fischietto d'ottone di Kazrik"
      },
      "kaelspire_barley_loaf": {
        "name": "Pagnotta d'orzo di Guglia di Kael"
      },
      "silverbrook_spring_water": {
        "name": "Acqua sorgiva di Rio d'Argento"
      },
      "imperial_field_ration": {
        "name": "Razione imperiale da campo"
      },
      "imperial_clerks_robe": {
        "name": "Veste da scrivano imperiale"
      },
      "kael_infantry_hauberk": {
        "name": "Usbergo di fanteria di Kael"
      },
      "wolfsward_hunting_jerkin": {
        "name": "Farsetto da caccia di Guardialupi"
      },
      "tithe_road_marchboots": {
        "name": "Stivali da marcia della Via delle Decime"
      },
      "imperial_marcher_legguards": {
        "name": "Cosciali del marciatore imperiale"
      },
      "kael_arming_sword": {
        "name": "Spada da armi di Kael"
      },
      "frosthelm_warstaff": {
        "name": "Bastone da guerra di Elmo di Brina"
      },
      "wolfsward_skinner": {
        "name": "Scuoiatore di Guardialupi"
      },
      "prefects_sealed_mantle": {
        "name": "Mantello sigillato del prefetto"
      },
      "huntmasters_winter_hood": {
        "name": "Cappuccio invernale del capocaccia"
      },
      "hoarfang_clawgrips": {
        "name": "Prese artigliate di Zanna di Brina"
      },
      "overseers_candlewraps": {
        "name": "Bende di candele del sovrintendente"
      },
      "oathbreakers_battleplate": {
        "name": "Corazza da battaglia dello Spezzagiuramenti"
      },
      "oathbreakers_greatblade": {
        "name": "Spadone dello Spezzagiuramenti"
      },
      "grey_shale_chip": {
        "name": "Scaglia di scisto grigio"
      },
      "smuggled_trinket": {
        "name": "Ninnolo di contrabbando"
      },
      "barbed_thorn_husk": {
        "name": "Baccello di spine uncinate"
      },
      "thornfen_tusk": {
        "name": "Zanna di troll del Roveto"
      },
      "torn_caravan_banner": {
        "name": "Stendardo di carovana strappato"
      },
      "ironpass_rubble_core": {
        "name": "Nucleo di macerie di Passoferro"
      },
      "wyvern_tail_barb": {
        "name": "Aculeo di coda di viverna"
      },
      "reagent_gland": {
        "name": "Ghiandola gonfia di reagenti"
      },
      "fogged_lantern_glass": {
        "name": "Vetro di lanterna appannato"
      },
      "river_worn_idol": {
        "name": "Idolo levigato dal fiume"
      },
      "gull_picked_bone": {
        "name": "Osso beccato dai gabbiani"
      },
      "underway_hardtack": {
        "name": "Galletta del Sottopasso"
      },
      "smugglers_black_brew": {
        "name": "Intruglio nero del contrabbandiere"
      },
      "thornberry_loaf": {
        "name": "Pagnotta di bacche spinose"
      },
      "palisade_pine_tea": {
        "name": "Tè di pino della Palizzata"
      },
      "tollhouse_stew": {
        "name": "Stufato della Casa del Pedaggio"
      },
      "ironpass_mulled_cider": {
        "name": "Sidro caldo di Passoferro"
      },
      "lanternfen_eel_skewer": {
        "name": "Spiedino di anguilla di Palude Lanterna"
      },
      "fogberry_tonic": {
        "name": "Tonico di bacche di nebbia"
      },
      "bridgewatch_rations": {
        "name": "Razioni di Guardaponte"
      },
      "nameless_river_water": {
        "name": "Acqua del fiume senza nome"
      },
      "smuggler_kings_softsteps": {
        "name": "Passi felpati del Re dei Contrabbandieri"
      },
      "briarfather_bark_mitts": {
        "name": "Muffole di corteccia del Padre dei Rovi"
      },
      "skarns_war_harness": {
        "name": "Bardatura da guerra di Skarn"
      },
      "colossus_mireheart_girdle": {
        "name": "Cintura Cuore di Melma"
      },
      "bridgekeepers_tollstaff": {
        "name": "Bastone da pedaggio del Custode del Ponte"
      },
      "melted_ration_tin": {
        "name": "Lattina di razioni fusa"
      },
      "ashcaked_fang": {
        "name": "Zanna incrostata di cenere"
      },
      "ember_glass_shard": {
        "name": "Scheggia di vetro di brace"
      },
      "saltglass_shard": {
        "name": "Scheggia di vetro di sale"
      },
      "salt_crusted_chitin": {
        "name": "Chitina incrostata di sale"
      },
      "bleached_bone_charm": {
        "name": "Talismano d'osso sbiancato"
      },
      "tarnished_prewar_coin": {
        "name": "Moneta ossidata d'anteguerra"
      },
      "sewer_silk_wad": {
        "name": "Matassa di seta di fogna"
      },
      "gutter_hound_pelt": {
        "name": "Pelle di segugio dei bassifondi"
      },
      "cracked_salamander_scale": {
        "name": "Scaglia di salamandra incrinata"
      },
      "cooled_magma_bead": {
        "name": "Perla di magma raffreddato"
      },
      "slag_nugget": {
        "name": "Pepita di scoria"
      },
      "rusted_deserter_badge": {
        "name": "Distintivo arrugginito di disertore"
      },
      "redspire_rock_shard": {
        "name": "Scheggia di roccia di Guglia Rossa"
      },
      "spire_stalker_claw": {
        "name": "Artiglio di predatore delle guglie"
      },
      "cinderrest_ashcake": {
        "name": "Focaccia di cenere di Posa di Brace"
      },
      "boiled_cistern_water": {
        "name": "Acqua di cisterna bollita"
      },
      "brinehollow_salt_jerky": {
        "name": "Carne salata essiccata di Cavosalso"
      },
      "desalted_waterskin": {
        "name": "Otre d'acqua dissalata"
      },
      "gutter_stew": {
        "name": "Stufato dei bassifondi del Mercato dell'Esilio"
      },
      "black_market_tea": {
        "name": "Tè di mercato nero"
      },
      "forgefall_hardtack": {
        "name": "Galletta di Fucina Caduta"
      },
      "coalfire_stout": {
        "name": "Birra scura al fuoco di carbone"
      },
      "waymeet_marching_bread": {
        "name": "Pane da marcia dell'Ultimo Crocevia"
      },
      "bitterroot_brew": {
        "name": "Intruglio di radice amara"
      },
      "revenant_cinderguard": {
        "name": "Guardacenere del redivivo"
      },
      "marrowhide_leggings": {
        "name": "Gambali in pelle di midollo"
      },
      "scavenger_kings_shiv": {
        "name": "Punteruolo del Re degli Sciacalli"
      },
      "forgewyrm_scale_helm": {
        "name": "Elmo di scaglie del verme di forgia"
      },
      "mantle_of_the_last_muster": {
        "name": "Mantello dell'Ultima Leva"
      },
      "scorched_banner_scrap": {
        "name": "Brandello di stendardo bruciacchiato"
      },
      "melted_signet_ring": {
        "name": "Anello con sigillo fuso"
      },
      "cracked_horror_horn": {
        "name": "Corno d'orrore incrinato"
      },
      "bastion_hardtack": {
        "name": "Galletta del Bastione"
      },
      "trucewater_flask": {
        "name": "Fiaschetta d'acqua di tregua"
      },
      "ashguard_robe": {
        "name": "Veste guardacenere"
      },
      "breachwalker_jerkin": {
        "name": "Farsetto del viandante della Breccia"
      },
      "bastion_plated_hauberk": {
        "name": "Usbergo placcato del Bastione"
      },
      "bastion_arming_sword": {
        "name": "Spada da armi del Bastione"
      },
      "mercenary_greatblade": {
        "name": "Spadone da mercenario"
      },
      "tithe_collectors_grasps": {
        "name": "Prese dell'esattore delle decime"
      },
      "craterheart_mantle": {
        "name": "Mantello Cuore di Cratere"
      },
      "butchers_chainguard": {
        "name": "Cotta del Macellaio"
      },
      "vhorlans_flensing_blade": {
        "name": "Lama scuoiatrice di Vhorlan"
      },
      "warbringers_hellforged_cuirass": {
        "name": "Corazza forgiata agli inferi del Portaguerra"
      },
      "khorvax_warcleaver": {
      ...
      "forged_levy_papers": {
        "name": "Documenti di leva falsificati"
      },
      "amnesty_petition": {
        "name": "Petizione di amnistia non registrata"
      },
      "fort_pattern_kettle": {
        "name": "Bollitore regolamentare del forte"
      },
      "garnished_pay_pouch": {
        "name": "Borsa paga pignorata"
      },
      "fault_line_core": {
        "name": "Nucleo di faglia"
      },
      "unstamped_duel_permit": {
        "name": "Permesso di duello non timbrato"
      },
      "rimeclaw_tallow": {
        "name": "Sego di artigelo"
      },
      "rimeclaw_marrowbone": {
        "name": "Osso midollare di artigelo"
      },
      "oathguard_plate_scrap": {
        "name": "Frammento di piastra del Guardagiuramento"
      },
      "ninth_muster_roll": {
        "name": "Ruolo di adunata recuperato"
      },
      "icehowler_haunch": {
        "name": "Coscio di ululaghiaccio"
      },
      "rimebound_core_ice": {
        "name": "Ghiaccio del nucleo brinato"
      },
      "glacial_quench_ice": {
        "name": "Ghiaccio di tempra glaciale"
      },
      "maren_calling_card": {
        "name": "Biglietto da visita di Casa Maren"
      },
      "maldreks_route_ledger": {
        "name": "Registro delle rotte di Maldrek"
      },
      "grulks_iron_strongbox": {
        "name": "Forziere di ferro di Grulk"
      },
      "maren_duelling_mantle": {
        "name": "Mantellina da duello Maren"
      },
      "final_notice_wraps": {
        "name": "Fasce dell'ultimo avviso"
      },
      "pay_wardens_shoulderguards": {
        "name": "Spallacci del custode delle paghe"
      },
      "rimeshaft_foremans_cap": {
        "name": "Berretto del caposquadra di Rimeshaft"
      },
      "quarter_close_vestments": {
        "name": "Paramenti di chiusura trimestre"
      },
      "assessors_lead_greaves": {
        "name": "Gambali di piombo dell'assessore"
      },
      "purse_wardens_coinbelt": {
        "name": "Cintura portamonete del custode delle borse"
      },
      "mothwing_dust": {
        "name": "Polvere d'ala di falena"
      },
      "silt_eel": {
        "name": "Anguilla di limo"
      },
      "barge_chit": {
        "name": "Gettone di chiatta fradicio"
      },
      "ferry_lantern_mote": {
        "name": "Bagliore di lanterna del traghetto"
      },
      "smugglers_tally_knot": {
        "name": "Nodo di conteggio del contrabbandiere"
      },
      "forged_weir_pass": {
        "name": "Lasciapassare della diga falsificato"
      },
      "sunken_ration_tin": {
        "name": "Scatoletta di razioni sommersa"
      },
      "hollow_toll_scrip": {
        "name": "Buono di pedaggio vuoto"
      },
      "rimeclaw_haunch": {
        "name": "Coscio di artigelo"
      },
      "rimebound_fetish": {
        "name": "Feticcio brinato"
      },
      "frostpine_tallow": {
        "name": "Sego di pino brinato"
      },
      "forsworn_oath_knife": {
        "name": "Coltello del giuramento Spergiuro"
      },
      "shadowbound_cipher": {
        "name": "Cifrario legato all'ombra"
      },
      "vessiks_little_book": {
        "name": "Libretto di Vessik"
      },
      "weirwatch_wraps": {
        "name": "Fasce della Guardia della diga"
      },
      "lodgewalk_boots": {
        "name": "Stivali della Loggia"
      },
      "unbroken_wardstone": {
        "name": "Pietra di guardia integra"
      },
      "vault_ward_core": {
        "name": "Nucleo di guardia della cripta"
      },
      "temple_offering_bowl": {
        "name": "Ciotola delle offerte del tempio"
      },
      "graven_name_stone": {
        "name": "Pietra dei nomi incisa"
      },
      "stalker_haunch": {
        "name": "Coscio di predatore"
      },
      "heretic_creed_page": {
        "name": "Pagina di credo bruciata"
      },
      "heretic_brand_iron": {
        "name": "Ferro da marchio eretico"
      },
      "heretic_writ": {
        "name": "Scritto eretico"
      },
      "first_court_sigil": {
        "name": "Sigillo della Prima Corte"
      },
      "duneglass_heart": {
        "name": "Cuore di vetro delle dune"
      },
      "unshattered_fulgurite": {
        "name": "Fulgurite intatta"
      },
      "flameseer_ash_creed": {
        "name": "Tavoletta del Credo di Cenere"
      },
      "flameseer_ember_phial": {
        "name": "Fiala di braci"
      },
      "dawnward_censer": {
        "name": "Turibolo dell'Alba"
      },
      "stolen_water_cask": {
        "name": "Botte d'acqua sigillata"
      },
      "duskwater_oathmark": {
        "name": "Marchio di giuramento di Acquabruna"
      },
      "caravan_toll_tally": {
        "name": "Conteggio di pedaggio sigillato"
      },
      "tyrant_spoor": {
        "name": "Calco di pista del Tiranno"
      },
      "oxbone_toll": {
        "name": "Conteggio in osso di bue"
      },
      "cartographers_map": {
        "name": "La mappa del Primo Cartografo"
      },
      "templestone_shard": {
        "name": "Scheggia di pietra del tempio"
      },
      "fulgurite_splinter": {
        "name": "Scheggia di fulgurite"
      },
      "charred_censer_chain": {
        "name": "Catena di turibolo carbonizzata"
      },
      "wardens_stone_heart": {
        "name": "Cuore di pietra di Ashkerat"
      },
      "first_meridian_compass": {
        "name": "Bussola del Primo Meridiano"
      },
      "seatstone_flatbread": {
        "name": "Focaccia della Sede"
      },
      "seatwell_waterskin": {
        "name": "Otre del pozzo della Sede"
      },
      "lastwater_jerky": {
        "name": "Carne secca di Ultima Acqua"
      },
      "lastwater_skin": {
        "name": "Otre di Ultima Acqua"
      },
      "vaultkeepers_handwraps": {
        "name": "Manopole del custode della cripta"
      },
      "sahrs_penitent_leggings": {
        "name": "Gambali penitenti di Sahr"
      },
      "wardens_granite_edge": {
        "name": "Filo di granito del Guardiano"
      },
      "staff_of_the_sunken_court": {
        "name": "Bastone della Corte Sommersa"
      },
      "duneglass_shiv": {
        "name": "Punteruolo di vetro delle dune"
      },
      "lastwater_roadmail": {
        "name": "Maglia da strada di Ultima Acqua"
      },
      "duskwatch_robe": {
        "name": "Tunica della Guardia del Crepuscolo"
      },
      "raiders_dust_jerkin": {
        "name": "Farsetto impolverato del razziatore"
      },
      "ashkerat_greaves": {
        "name": "Schinieri di Ashkerat"
      },
      "cartographers_windwraps": {
        "name": "Fasce di vento del Cartografo"
      },
      "unlit_silk_gland": {
        "name": "Ghiandola di seta spenta"
      },
      "veskals_fang": {
        "name": "Zanna di Veskal"
      },
      "broodmother_carapace_guard": {
        "name": "Guardia di carapace della Madre di covata"
      },
      "condensed_mist_heart": {
        "name": "Cuore di nebbia condensata"
      },
      "mistfathers_knot": {
        "name": "Il nodo del Padre delle Nebbie"
      },
      "fogwalker_treads": {
        "name": "Calzari del camminanebbia"
      },
      "bristleback_maul": {
