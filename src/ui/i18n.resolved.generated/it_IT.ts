...
export const it_IT: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      ...
      "editKeysHint": "Fai clic su uno slot nella barra delle azioni, quindi premi un tasto per vincolarlo.",
      "bannerHint": "Fai clic su uno slot, quindi premi un tasto per vincolarlo. Al termine, fare clic su Fine.",
      "bannerCapturing": "Premi un tasto per vincolare questo slot...",
      "boundToKey": "Associazione a {key}.",
      "reset": "Reset",
      "done": "Fatto",
      "cancel": "Cancellare",
      "resetConfirmTitle": "Reimpostare i tasti della barra delle azioni?",
      "resetConfirmBody": "La prima barra ritorna ai tasti predefiniti. La seconda e la terza battuta diventano sciolte. Questa operazione non può essere annullata."
    },
    "mounts": {
      "title": "Cavalcature",
      "close": "Chiudi",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "Nei gironi 1v1 e 2v2 ogni combattente gioca con il kit All-Rounder. Le imprese che richiedono la fascia 3v3 o superiore non possono essere guadagnate qui.",
      "role": {
        "allrounder": {
          "name": "Tuttocampista",
      ...
      "practiceUnratedNote": "Gli incontri di pratica non sono valutati: le classifiche e i progressi nel Libro delle gesta non contano.",
      ...
      "briefing": {
        ...
        "unratedNote": "I robot sono in campo, quindi questo incontro non è classificato: la classifica non cambia e le azioni per i gol, le parate e la porta inviolata non contano.",
        "practiceUnratedNote": "Questo è un incontro di pratica, quindi non è classificato: la classifica non cambia e i progressi nel Libro delle gesta non contano.",
    ...
    "materialHint": {
      "fineGrade": "Grado eccellente. Raccolto da una vena a livello completo con uno strumento classificato al di sopra del materiale e conta come la versione ordinaria ovunque sia richiesto.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Per pescare in queste acque è necessaria una canna da pesca di livello {tier}."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Hai bisogno dell'estrazione {skill} per far oscillare il piccone già nelle tue borse.",
        "logging": "Hai bisogno della registrazione {skill} per far oscillare l'ascia già nelle tue borse.",
        "herbalism": "Hai bisogno di Erboristeria {skill} per far funzionare la falce già nelle tue borse."
      },
      "wieldUnmetCorpse": "Hai bisogno di acquisire abilità {skill} per mettere in funzione il tuo strumento migliore.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Necessario per pescare in acque fino al livello {tier}."
        },
        "use": {
      ...
      "emptyHookNote": "Niente in sospeso",
      "stateReady": "Pronto",
      "stateCooldown": "In rigenerazione",
      "stateCooldownTimed": "Riapparirà tra {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Il tuo strumento perfeziona questa resa a un grado fine."
    },
    "archetypeTitle": {
      "label": "Titolo",
      "none": "Nessuno",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} di {max} addebiti",
      "toolEffectSpent": "Esaurito, necessita di essere ricaricato",
      "toolEffectDepleted": "Effetto dello strumento speso",
      "toolEffectRechargePrice": "Ricarica: {count} x {material}",
      "toolEffectModeAsk": "Chiedi ogni utilizzo",
      "toolEffectModePrompt": "Chiede ogni utilizzo",
      "toolEffectConfirmTitle": "Utilizzare {effect}?",
      "toolEffectConfirmBody": "Spendere una somma per questo raccolto? In calo si accumula ancora, senza il bonus. Spese rimaste: {charges}.",
      "toolEffectConfirmAccept": "Usa una carica",
      "toolEffectConfirmDecline": "Riunirsi senza",
      "toolEffectName": {
        "gatherersCache": "Cassa del raccoglitore",
        "artisansEye": "L'occhio dell'artigiano",
        "quickeningCharm": "Fascino del ritorno elastico"
      },
      "toolEffectSlotButton": "Slot {effect}",
      "toolEffectRechargeButton": "Ricaricare",
      "toolEffectSlotted": "{effect} inserito su {profession}.",
      "toolEffectSlotInvalid": "{effect} non può essere inserito lì.",
      "toolEffectNoTool": "Prima hai bisogno di un vero strumento {profession}.",
      "toolEffectNoCharm": "Hai bisogno di un ciondolo {effect} artigianale nelle tue borse.",
      "toolEffectNoGain": "{effect} è già inserito e completamente carico.",
      "toolEffectRecharged": "{effect} ricaricato: {material} x{count} consumato.",
      "toolEffectRechargeNoSlot": "Nessun effetto è inserito su {profession}.",
      "toolEffectRechargeFull": "{effect} è già completamente carico.",
      "toolEffectRechargeToolCapped": "Porta con te uno strumento {profession} migliore per caricare ulteriormente {effect}.",
      "toolEffectRechargeMaterials": "La ricarica di {effect} richiede {material} x{count}.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(spende {count} per il voto buono)",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Condividi gli sblocchi delle azioni con i compagni di gilda e i seguaci, e le carte delle imprese e dei capolavori con il feed Discord",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "archetypeSwitchBody": "Una dichiarazione non è nemmeno una condanna all’ergastolo. Una coppia che non hai mai tenuto è semplicemente una nuova ricerca di sintonizzazione, mentre tornare a una coppia da cui ti sei allontanato ti chiede prima di fare ammenda: cinque compiti la prima volta e altri tre aggiunti per ogni ritorno che hai già fatto (prendere una coppia nuova di zecca non aumenta mai il conteggio). La scelta rimane significativa senza mai chiudere una porta per sempre.",
      "whatHeading": "Un mestiere accanto alla spada",
      "whatBody": "Le professioni sono la vita lavorativa del mondo: quattro mestieri di raccolta che estraggono la materia prima direttamente dalla terra e un anello di dieci mestieri che la trasformano in attrezzi, pasti, pozioni e strumenti. Qui tutto alimenta qualcos'altro. Il minerale che estrai diventa una lama, la lama prende un incantesimo e l'incantesimo ha bisogno della polvere rimossa dai vecchi attrezzi, quindi un raccoglitore, un artigiano e un armeggiatore sono tutti anelli di un'unica catena.\n\nNon esiste un limite professionale su cui tormentarsi. Ogni personaggio può sviluppare sette degli otto mestieri che hanno contenuti oggi e tutte e quattro le professioni affiancate (l'Ingegneria è l'unica che resiste: le sue ricette iniziano tutte al di sopra del soffitto libero, quindi la sua scala attende il giuramento del Bombardiere); l'unica scelta esclusiva è il tuo archetipo, l'identità su cui alla fine giuri, anche se una volta sintonizzati i mestieri che rimangono dormienti dietro di esso si arrampicano solo sulle loro ricette comuni, e l'abilità passata 75 per niente. L'abilità non diminuisce mai e nulla di ciò che impari ti viene mai portato via.",
      ...
      "archetypesBody": "Le dieci imbarcazioni poggiano su una ruota fissa e la geografia su quella ruota è importante. Ogni due vicini formano una coppia con nome: Fabbro per artigianato di armi e armature, fornitore di lavorazione della pelle e sartoria, farmacista per alchimia e cucina, bombardiere per ingegneria e alchimia e altri sei sul ring.\n\nSintonizzarsi con una coppia è una ricerca, non un clic sul menu. Oggi è possibile unirsi a quattro coppie (Smith, Outfitter, Apothecary e Bombardier), ciascuna guidata da un maestro residente a Eastbrook la cui ricerca di accettazione stabilisce l'intero accordo in anticipo prima che tu lo accetti. Finché non lo dichiari, ogni mestiere avanza liberamente con le ricette fino al livello raro (qualsiasi ricetta che richiede abilità 74 o meno), quindi puoi provare quasi tutto prima di scegliere (l'Ingegneria da sola non ha ricette così basse, quindi il suo numero attende).\n\nUna volta che ti sei sintonizzato, le tue abilità a doppia coppia diventeranno le tue major, senza alcun limite inferiore al limite. Il resto della ruota non si oscura: un mestiere opposto alle tue major rimane un hobby che continua a salire attraverso il livello raro (una missione ripetibile alla fucina di Smith Haldren ti consente di scambiare quale), e ogni altro mestiere diventa dormiente. Un mestiere dormiente mantiene la sua abilità e le sue ricette comuni, che continuano ad insegnarlo sulla curva normale finché non diventa grigio a 75; tutto ciò che è al di sopra del comune smette di essere redditizio all'istante, e un'imbarcazione dormiente non si rivela mai un capolavoro mentre riposa.",
      "pairFmt": "{a} e {b}",
      ...
      "startBody": "Appena uscito dalla strada a Eastbrook? Trova Foreman Odell e accetta A Trade for Every Hand: ti indicherà le vene minerarie attorno al Copper Dig a sud-est della città e ti consegnerà i primi calli. Fai attenzione allo scavo stesso: i Deeprock Diggers accampati lì si trovano alcuni livelli sopra un nuovo arrivo, quindi lavora prima sulle vene periferiche e conserva il cuore dell'accampamento per quando avrai livellato un po'. Da quel momento in poi, raccogli ogni vena, bancarella di legname e orto di erbe che incontri durante la missione; la competenza è naturale per i viaggiatori.\n\nTornato in città, premi T per aprire la finestra di creazione e lavorare sulle ricette comuni che ogni personaggio conosce dall'inizio. Visita i maestri alla fucina, alle cucine, al telaio e al laboratorio di utensili per vedere cosa insegnano e accetta i loro ordini di lavoro in cambio di denaro costante. Quando la lettera della Gilda ti troverà, saprai già con quale paio ti senti come a casa.",
      "colStation": "Stazione",
      "colHub": "Hub",
      "colMaster": "Maestro",
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Engineering costruisce gli strumenti che ogni collezionista serio finisce per desiderare: picconi, asce, falci e canne da pesca di livello 4 e 5 che nessun banco venderà mai per moneta, ognuno dei quali consuma lo strumento sottostante.",
        "enchanting": "L'incantesimo smonta l'equipaggiamento e ripristina il potere: rompi i pezzi indesiderati in materiali arcani, quindi spendili per un bonus stat permanente per un pezzo che intendi conservare. Il breaking e l'incanto non hanno bisogno di stazione né di allenatore, e chiunque può iniziare dal primo giorno; solo le due ricette di incanto chiedono di più, insegnate all'officina."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "L’attività mineraria è la spina dorsale. Il minerale di rame esce dalle vene di livello 1 di Eastbrook Vale, il minerale di ferro da Mirefen Marsh e il minerale di osmio da Thornpeak Heights, e ogni gradino della scala sale allo stesso modo. Il disboscamento è più importante di quanto potresti aspettarti: la corteccia di ferro impugna la lancia del cinghiale, il legno di frassino sostiene la mazza e un singolo tronco di pino alto costituisce il bastone da battaglia.\n\nIl resto viene dalla caccia e dal contropiede. La pelle ruvida per le impugnature viene raccolta direttamente dai cadaveri di lupi e cinghiali, i frammenti di ossa provengono dai morti irrequieti o da attrezzi comuni recuperati, e la scala della forgia brucia Smithing Flux, 20 rame un vaso dalla stessa Darva. Se la tua estrazione è in ritardo, nessun segnalino ti salverà sul minerale stesso: l'osmio esce dalle vene di Thornpeak, dalle vene iniziali di ogni zona più giovane tranne la Riva Lunga (le cui vene scavano il ferro), o dalla pila di un altro giocatore, tramite commercio o Mercato Mondiale. Solo il Lingotto di Glifo-acciaio viene acquistato in cambio di monete, da Tinker Gizzel presso l'officina o dal Quartiermastro Bree a Highwatch.",
          ...
          "routeBody": "Qualsiasi pezzo con una vera linea delle statistiche, che su questa scala significa il piolo di ferro in su, può staccarsi dall'incudine come un capolavoro purché la qualità più fine si adatti al soffitto del tuo livello; i beni comuni in rame senza stato non si attivano mai, perché non c'è nulla da migliorare in essi. Ferro e osmio contano come materiali di livello 1 per il bonus capolavoro, highpine e glifoacciaio come livello 2, e l'abilità che si trova sopra il livello di una ricetta aggiunge il proprio punto per livello, quindi tra i tre osmio sono l'ascia da guerra e il bastone da battaglia che portano il vantaggio materiale, e un piolo continua a progredire meglio dopo che lo hai superato.\n\nSali sul gradino di rame fino a 25, addestra il gradino di ferro il giorno in cui si apre e portalo a 50, poi il gradino di osmio a 75. Oltre il 75 non viene ancora spedito nulla di più alto, quindi le ricette di osmio svaniscono a metà e poi guadagnano un quarto: budget circa 150 imbarcazioni in più per raggiungere il limite di 125, e ricorda l'acceleratore condiviso di dieci azioni di creazione al minuto quando ti siedi per batch.\n\nFinanzia la scalata mentre procedi: l'ordine di lavoro della fucina di Darva ti toglie dalle mani otto minerali di rame ogni 30 minuti per una piccola moneta e XP, e i pioli di ferro e osmio si vendono onestamente per livellare il corpo a corpo. Il Libro delle gesta segna Edge and Temper all'abilità 50 e incorona Grandmaster Weaponcrafting a 125."
        },
        "armorcrafting": {
          "identityHeading": "Maglia per la prima linea",
          "identityBody": "La scala di creazione di armature si presenta come la carriera di un soldato: la semplice cintura di rame rivettata, i sabaton e i guanti per iniziare, l'usbergo, i gambali e gli spallacci di ferro con le loro prime vere statistiche, e il raro grande elmo, corazza e gambali di scaglie di osmio, pezzi di Forza e Resistenza con numeri di armatura al vertice dell'arte di un artigiano.\n\nHa anche un lato più tranquillo: gli Eastbrook Warded Leggings, un campo comune con l'incantatore, e il Kilnscale Mantle, una rara spalla di maglia di Intelletto e Spirito all'abilità 75, mantengono i portatori di maglia con una mente magica nella lista dei clienti. Sul ring si trova tra Weaponcrafting e Engineering; la coppia Smith con Weaponcrafting presta giuramento davanti alla Forgemistress Darva, mentre la coppia Gearwright con Engineering viene nominata ma non ha ancora una missione di giuramento.",
          "materialsHeading": "Minerale a sacchi",
          "materialsBody": "Nessuna imbarcazione mangia il minerale più velocemente. Solo l'usbergo di collegamento di ferro richiede cinque minerali di ferro, e ogni pezzo di scaglia di osmio richiede tre o quattro osmio più una barra di glifoacciaio, quindi un serio artigiano di armature estrae Mirefen Marsh e Thornpeak Heights o paga qualcuno che lo fa. Il rame alimenta il primo piolo, direttamente dalle vene del Copper Dig.\n\nIntorno al metallo si trovano le parti morbide: pelle ruvida raccolta dai cadaveri di lupi e cinghiali, frammenti di ossa di morti irrequieti (o recuperati da attrezzi comuni) e barattoli di Smithing Flux (20 rame ciascuno alla fucina) in quasi tutte le ricette. Nessun contatore vende osmio: gli impazienti lo comprano da altri giocatori o lo estraggono da soli, su Thornpeak o nelle vene iniziali di dieci delle undici zone più giovani (solo la Riva Lunga scava il ferro).",
          "ladderHeading": "Imparare alla fucina di Darva",
          "ladderBody": "Due comuni sul campo, l'Eastbrook Chainmail Vest e i Warded Gambiere, sono conosciuti fin dall'inizio e possono essere realizzati ovunque. La scala dell'allenatore è composta da nove ricette in tre gradini alla fucina di Eastbrook: il gradino di rame è gratuito all'abilità 0, il gradino di ferro costa 25 argento per una ricetta all'abilità 25 e il gradino di scaglia di osmio costa 1 oro ciascuno all'abilità 50, con ogni gradino insegnabile nel momento in cui il tuo livello lo raggiunge.\n\nOltre la scala si trovano due offerte speciali. L'Elmo di Boundstone è una delle due ricette combinate di Smith (i Guanti del Gravewyrm sono suoi fratelli dal lato della creazione di armi), insegnato da un allenatore, senza postazione e utilizzabile solo da un Fabbro in sintonia con entrambe le abilità all'abilità 25. Il Mantello di scaglia di forno non ha bisogno di alcun insegnante: tutti lo sanno dall'inizio, e nient'altro che la forgia e i cancelli dei materiali che lo gestiscono. La sua abilità elencata di 75 riguarda il guadagno, non il permesso: con Armorcrafting come maggiore paga l'intero guadagno di abilità dal primissimo colpo di martello a 99, quindi un Fabbro con osmio in eccesso può appoggiarsi presto. Al di sotto del tetto di un maggiore, la ricetta del livello 3 non insegna nulla, quindi un armaiolo non dichiarato o per hobby la lavora per il pezzo, non per i punti.",
        ...
        "leatherworking": {
          ...
          "materialsBody": "La lavorazione della pelle è l'arte in cui il percorso di livellamento e la linea di rifornimento sono la stessa cosa: la pelle grezza viene raccolta direttamente dai cadaveri che portano la pelle, lupi e cinghiali soprattutto, e ogni cadavere serve un solo mietitore, primo arrivato, primo servito. Un tiro di raccolta raro o migliore garantisce anche una pelle incontaminata, un esemplare firmato richiesto dal Mirewarden Jerkin, quindi accumula tutti quelli che trovi.\n\nIl cast di supporto è piccolo: zampe di ragno e seta, stoffa tessuta in casa da umanoidi, un singolo minerale di osmio in ogni pezzo raro dei mirewarden (sei nella pietra di copertura di Duskhide Wraps) e un agente abbronzante a 16 rame dal bancone della conceria. L'osmio in sé non viene mai contro-comprato: estrailo tu stesso, su Thornpeak o nelle vene iniziali di quasi tutte le zone più giovani (solo Farshore scava il ferro), o compralo da un altro giocatore.",
          "ladderHeading": "Addestrato a Fenbridge",
          "ladderBody": "Ecco il problema: la conceria si trova a Fenbridge, sulla strada per Mirefen Marsh, rendendo la lavorazione del cuoio l'unico mestiere profondo addestrato nella palude. Tanner Hesk insegna la scala nelle sue vasche: il livello della pelle di Fenbridge è gratuito all'abilità 0, il livello del cacciatore di paludi a 25 argento, una ricetta dall'abilità 25 e il livello del mirewarden a 1 oro ciascuno dall'abilità 50, ogni livello si apre quando il tuo livello lo raggiunge.\n\nTre ricette saltano il trainer: i beni comuni sul campo (il Tanned Leather Jerkin e Eastbrook Druid's Hide) si creano ovunque fin dall'inizio, e i Duskhide Wraps sono noti a tutti ma si trovano all'abilità 75, legati alla conceria. Nota che il giuramento stesso di Outfitter viene prestato a Eastbrook con Ottilie; solo l'insegnamento avviene nella palude.",
          "routeHeading": "Capolavori e un percorso pratico fino a 125",
          "routeBody": "Qualsiasi pezzo con statistiche reali offre la possibilità di capolavoro purché la qualità più fine rientri nel limite massimo del tuo livello, inclusa la pelle del druido di Eastbrook dichiarata, e una pelle incontaminata firmata in un Mirewarden Jerkin fornisce automaticamente il bonus del reagente firmato; l'osmio conta come materiale di livello 1 per il proc. Le comuni hide senza stato non possono attivarsi.\n\nLivellalo in modo naturale: raccogli tutti i lupi e i cinghiali che uccidi dal livello uno, lascia che i due campi comuni ti portino a 25 ovunque ti trovi, quindi addestra il gradino della pelle nelle vasche quando le missioni ti trascinano comunque nella palude. Marshstalker ti porta a 50 e Mirewarden a 75; oltre a ciò, i Duskhide Wraps, una ricetta di livello 3 con sei minerali di osmio, tre pelle incontaminata, due pelle ruvida e un agente abbronzante, paga un fornitore sintonizzato con un guadagno completo a 99 e mezzo dopo, circa 75 imbarcazioni per gli ultimi cinquanta punti fino al limite di 125; al di sotto del tetto di una specializzazione, la ricetta del livello 3 non insegna nulla.\n\nLa conceria mobile è più importante per questo mestiere che per qualsiasi altro: specializzatevi a 75 anni e una bisaccia di pelli diventa un equipaggiamento finito accanto al fuoco invece di una passeggiata di ritorno a Fenbridge. L'ordine di lavoro della conceria di Hesk consente di acquistare otto pelli grezze ogni 30 minuti, un buon rendimento sulle pelli che stavi raccogliendo a prescindere, e il Libro delle gesta segna Commercio di conciatore all'abilità 50 con Gran maestro della lavorazione della pelle al limite."
        },
        "cooking": {
          "identityHeading": "La pentola che sfama il gruppo",
          "identityBody": "Mangia un pasto cotto e ti guarisce in 18 secondi di riposo, che tra un tiro e l'altro è la guarigione più economica del gioco. La scala va da un Pan-Seared River Perch con 90 punti salute fino al Marlow's Grand Roast a 980, un sit-heal che niente batte nel gioco.\n\nSul ring La cucina si trova tra l'alchimia e la lavorazione della pelle. La sua coppia vivente è il Farmacista, l'Alchimia e la Cucina, che ha prestato giuramento davanti al cuoco Marlow nelle cucine di Eastbrook dopo aver cacciato quattro cinghiali per la pentola; la coppia Trapper con Leatherworking è nominata sull'anello ma non ha ancora una missione di giuramento.",
          "materialsHeading": "Una dispensa alimentata da canna e coltello",
          "materialsBody": "La pesca offre gli ingredienti caratteristici, zona per zona: trote specchio e persici di fiume dalle acque di Eastbrook Vale, lucci di palude e anguille di palude di Mirefen Marsh, trote gelide e carpe slatefin di Thornpeak Heights. I pioli mescolano liberamente le zone (il piolo libero vuole già il luccio di palude, il piolo intermedio la branchia gelata di Piccospino e la cena rara ripiega dentro la trota specchio della Valle), quindi un cuoco che pesca ovunque vada la strada non rimane mai a secco.\n\nIl lato del macellaio proviene da cadaveri mietuti: carne di selvaggina di cinghiali e dei loro parenti e, su un rotolo di raccolta raro o migliore, un Prime Cut firmato, il fulcro del grande arrosto. Le erbe condiscono i piatti migliori, un ceppo di frassino affumica l'anguilla e il sale da cucina contiene 8 rame per sacchetto dalla bancarella di Marlow.",
        ...
        "alchemy": {
          ...
          "identityBody": "L'artigianato viene lavorato presso il farmacista di Highwatch, casa dell'alchimista Verane, maestro del farmacista, che insegna la scala delle ricette, vende fiale di vetro a 12 rame e paga monete per le erbe attraverso il suo ordine di lavoro.\n\nSul ring dell'artigianato, l'Alchimia si occupa dei mestieri per tentativi ed errori, accanto a Ingegneria da un lato e Cucina dall'altro. Ciò gli conferisce due identità di coppia: il Bombardier (Ingegneria e Alchimia, affrontate prima di Tinker Gizzel in Eastbrook) e il Farmacista (Alchimia e Cucina, prestate giuramento davanti a Cook Marlow). Sintonizzati su entrambe le coppie per rendere l'Alchimia una specializzazione e lasciare che il tuo lavoro firmato ti insegni; la coppia Bombardier apre anche la sua miscela combinata, l'Elisir dell'Orso, mentre la coppia Apothecary non fornisce ancora alcuna ricetta combinata. La scala in sé non aspetta mai, però, perché ogni ricetta dell'Alchimia si trova all'interno del raro livello in cui lavora l'artigianato non dichiarato, quindi l'intera scalata al limite è aperta prima di qualsiasi giuramento.",
          ...
          "ladderBody": "Tutti conoscono la Pozione Curativa Minore fin dall'inizio e possono mescolarla ovunque, senza bisogno di una stazione. La vera scala è composta da nove ricette insegnate da Verane al farmacista, tre per ogni gradino: le ricette dell'abilità 0 sono gratuite, l'abilità 25 gradino costa 25 argento per ricetta e l'abilità 50 gradino costa 1 oro per ricetta. Ogni gradino è una bevanda curativa, una bevanda di mana e un elisir di resistenza, che va dalle comuni bottiglie di foglie di sheen (120 salute, 160 mana) alla non comune foglia d'oro (200 salute, 260 mana) fino al raro petalo di sole (280 salute, 360 mana).\n\nGli elisir salgono allo stesso modo: l'Elisir del Cinghiale garantisce 6 Resistenza per 10 minuti, l'Elisir Vipersear 9 per 15 minuti e l'Elisir del Serpente 12 per 15 minuti, il Serpente da solo produce due bottiglie per nave. Un'altra ricetta è messa da parte: l'Elisir dell'Orso, una combinazione di infusi insegnata da Verane per 25 argento una volta che la tua Alchimia raggiunge 25, miscelabile ovunque, ma solo da un Bombardier in sintonia con sia Alchimia che Ingegneria a 25.",
          "routeHeading": "Il percorso di un produttore fino a 125",
          "routeBody": "Le pozioni e gli elisir non producono mai capolavori; quell'attivazione appartiene all'equipaggiamento con statistiche. Il tuo nome viaggia ancora, però: le rare bozze di petali di sole arrivano firmate con il marchio del produttore, così come ogni bottiglia dell'Elisir del Serpente a doppio lotto, quindi nulla di raro in questo mestiere lascia la panchina senza firma. All'abilità 75 ti specializzi e da quel momento in poi ogni ricetta di Alchimia costa il 20% in meno di materiali.\n\nPrendi Herbalism presto e raccogli man mano che sali di livello: Sheenleaf è ovunque nella Valle, e una volta raggiunta la panchina di Verane il gradino libero ti porterà in modo pulito all'abilità 25 su erbe che avresti raccolto comunque. Impara i 25 gradini nel momento in cui si accende, sposta la tua raccolta nella palude per la foglia d'oro e lascia che l'ordine di lavoro di Verane (sei erbe foglia d'oro per 45 rame, ripetibili ogni 30 minuti) restituisca una piccola moneta mentre procedi.\n\nDa 50 in poi, prepara bozze di petali di sole e lotti di serpenti dal petalo di sole di Picco Spinoso, con un po' di verde della Valle e della palude ancora nella miscela. L'ultimo tratto da 100 a 125 è un rivolo intenzionale, quindi prepara ciò che effettivamente vende piuttosto che bruciare erbe per il numero, e ricorda che i materiali di consumo sono quelli realizzati bene che tutti riacquistano per sempre. Il Libro delle gesta segna Strange Brews all'abilità 50 e Grandmaster Alchemy al limite."
        },
        "engineering": {
          "identityHeading": "Il monopolio del fabbricante di attrezzi",
          "identityBody": "L'imbarcazione viene lavorata presso l'officina degli attrezzi nell'angolo sud-ovest di Eastbrook Square, casa di Tinker Gizzel, maestro dell'officina. I livelli da 1 a 3 di ogni linea di utensili sono scorte ordinarie del fornitore; i livelli 4 e 5 escono dal banco dell'ingegnere, o dal contatore di esplorazione di Drowned Litany per Delve Marks dietro i suoi cancelli di sgombero, e mai da qualsiasi cassa per monete.\n\nSul ring si trova con i mestieri di prova ed errore, accanto ad Alchimia e Armatura, dandogli due identità di coppia: il Bombardier (Ingegneria e Alchimia, intraprese prima dello stesso Gizzel) e il Gearwright (Armatura e Ingegneria, nominato ma non ancora giurabile). Un avvertimento conta più qui che altrove: ogni livello di ricetta di Ingegneria si trova al di sopra del livello raro sotto il quale lavorano hobby e artigiani non dichiarati, quindi il numero di abilità si sposta solo per un artigiano le cui specializzazioni includono Ingegneria, che oggi significa Bombardier. Chiunque può ancora costruire gli attrezzi terrestri; un artigiano non in sintonia non impara nulla dal farlo, e le due ricette delle canne richiedono inoltre l'insegnamento di Gizzel.",
          "materialsHeading": "Reagenti e strumenti precedenti",
          "materialsBody": "Ogni ricetta per uno strumento terrestre consuma lo strumento un livello inferiore più un materiale FINE, e quell'abbinamento costituisce l'intera scala del terreno: quattro Minerale di ferro fine e un piccone da estrazione Skysilver diventano il piccone da estrazione di osmio, poi due lingotti di glifoacciaio, due minerali di osmio fine e quel piccone di osmio diventano il piccone da estrazione di glifoacciaio. Le linee dell'ascia e della falce rispecchiano la forma dell'utensile fine più precedente con Fine Ashwood e Fine Highpine Logs, Fine Goldleaf e Fine Sunpetal Herbs, sebbene i loro pioli di livello 5 non richiedano barre di glifoacciaio: il piccone è l'unica linea che diventa più cara in alto. Le due ricette di canne rompono di proposito lo schema: la Stormreel prende quattro Sunglint Koi e una canna Silverstream, la Tidewrought due Koi, otto Raw Slatefin Carp e quella Stormreel, quindi la parte superiore della scala del pescatore viene pagata sull'acqua anziché in una vena.\n\nUn materiale pregiato non viene venduto da nessuna parte e non cade da un raccolto ordinario: lo ottieni lavorando una delle vene a pieno grado di una zona con uno strumento classificato sopra il materiale stesso, che in pratica significa lo strumento un gradino sotto quello che stai cercando di costruire (le vene più facili che una zona mantiene per i viaggiatori producono il materiale semplice qualunque cosa tu agiti). Questo è intenzionale. Sul percorso artigianale, uno strumento di livello 5 deriva effettivamente dall'oscillazione di quello di livello 4, non da un giro di shopping; il contatore dei marchi di esplorazione è l'unico modo per aggirare il problema. L'unica eccezione è il Lingotto di Glifoacciaio, raffinato e disponibile solo per i venditori, 1 lingotto d'argento 60 rame per un lingotto dal Quartiermastro Bree in Highwatch o dal bancone di Gizzel, quindi il Piccone da Estrazione di Glifoacciaio da solo comporta un livello di monete fisso incorporato nel suo costo.",
          "ladderHeading": "La scala degli strumenti",
          "ladderBody": "La scala è composta da otto ricette, tutte legate alla stazione degli utensili. Le sei ricette per gli strumenti terrestri sono conosciute automaticamente, senza alcun costo per l'allenatore: il piccone, l'ascia e la falce di livello 4 all'abilità 75 e le versioni di livello 5 all'abilità 150. Quel secondo numero non è un errore di battitura, e si trova apposta sopra l'attuale limite di 125: i requisiti di abilità non bloccano mai un velivolo qui, modellano solo il guadagno di abilità, quindi puoi costruire uno strumento di livello 5 il giorno in cui tieni i suoi reagenti e il suo predecessore di livello 4. Le due verghe artigianali sono l'eccezione insegnata: Gizzel insegna lo Stormreel all'abilità 75 per 4 oro e il Tidewrought all'abilità 125 per 16 oro, ciascuno nel momento in cui il tuo livello nell'imbarcazione raggiunge il proprio.\n\nOgni strumento finito è di qualità rara o epica e viene firmato, quindi il tuo nome cavalca le zone sulle cinture degli strumenti degli altri giocatori. Ingegneria contiene anche metà di una ricetta combinata: l'Elisir dell'Orso, preparato da un Bombardier in sintonia con Ingegneria e Alchimia a 25.",
        ...
        "enchanting": {
          ...
          "identityBody": "Ogni incantamento è noto fin dall'inizio, chiunque può disincantare fin dal primo giorno, e nessuno dei due ha mai bisogno di una stazione; il limite di abilità è 125 come ogni mestiere. L'unico angolo del mestiere insegnato è la sua coppia di ricette di incantesimi: Tinker Gizzel insegna la Gatherer's Cache e l'Artigiano's Eye presso gli utensili nell'angolo sud-ovest di Eastbrook Square, per la tariffa di livello ordinario una volta che il tuo Incantamento raggiunge 25, e gli incantesimi stessi vengono lavorati nella sua stazione.\n\nSull'anello si trova tra Iscrizione e Oreficeria, quindi le sue due identità di coppia sono l'Arcanista (Iscrizione e Incantamento) e il Gembinder (Incantamento e Oreficeria). Nessuno dei due può ancora fare giuramento, dal momento che entrambi i vicini attendono le loro prime ricette, quindi oggi Incantare diventa un mestiere per tutti: gratuito al livello raro prima di qualsiasi giuramento e una scelta naturale per un hobby per un Bombardiere o un Farmacista. Gli incantatori mantengono anche attivo il mondo della raccolta: i due effetti degli strumenti slottable sono lavoro dell'Incantatore e un creatore originale ricarica i propri effetti con uno sconto, ancora più in profondità una volta specializzato.",
          "levelingHeading": "Come avanza l'incantamento",
          "levelingBody": "Tre azioni muovono l'abilità: disincantare un pezzo, applicare un incantesimo e creare i due ciondoli, che scalano la normale curva di creazione. Ogni successo vale fino a un punto, in base alla serietà del lavoro: alla rarità del pezzo che rompi o al livello di reagente dell'incantesimo che applichi. I disincantamenti comuni e gli incantamenti basati solo sulla polvere vengono considerati lavori comuni; il non comune disincanta e l'essenza incanta come non comune; raro disincanta e ogni runo o superiore incanta come raro; i disincanti epici e leggendari occupano ancora un posto più alto sul tavolo, anche se oggi nessuna identità incantevole va oltre il gradino raro, quindi in pratica pagano come un lavoro raro. Un'onestà governa la panchina di rottura: un pezzo che è uscito dalla panchina di un giocatore (realizzato, firmato o perfezionato) continua a trasformarsi in materiali ma non insegna nulla, quindi un ciclo di creazione e rottura non livella nessuno e le lezioni sono in attrezzi trovati in tutto il mondo.\n\nLa familiare dissolvenza della maestria si applica ai livelli da 25 punti, quindi il lavoro di livello comune diventa grigio all'abilità 75, il lavoro non comune a 100 e il lavoro di livello raro esattamente al limite di 125. Incantare ha anche una sua caratteristica: l'input al di sopra del limite del tuo archetipo viene arrotondato per difetto a quel limite invece che azzerato, quindi prima che ti sintonizzi, un disincanto epico viene semplicemente considerato raro anziché insegnare nulla. Se Incantamento finisce in letargo dietro un'altra identità, rompendo e applicando il punteggio come lavoro comune e la scalata si ferma a 75, mentre i due incantesimi, cavalcando la curva di creazione sopra il soffitto comune, non insegnano assolutamente nulla a un incantatore dormiente; mantienilo come il tuo hobby e il lavoro di livello raro paga ancora, solo più lentamente dopo i 75.",
          "marketHeading": "Copie incantate, provenienza e il mercato",
          "marketBody": "L'applicazione di un incantesimo consuma i reagenti e marchia una copia specifica dell'oggetto. Puntalo su una copia imballata e otterrai una copia incantata distinta; puntalo verso un capo che stai già indossando e resterà incantato al suo posto, proprio dove si trova, senza alcuna danza di disequipaggiamento e riequipaggiamento. In ogni caso, il bonus segue quel pezzo per sempre, attraverso disequipaggiamenti, viaggi in banca e scambi. Un incantesimo per pezzo: applicare un incantesimo diverso a una copia incantata richiede conferma, quindi sostituisce definitivamente il vecchio incantesimo, distruggendolo senza alcun rimborso dei suoi materiali. Vendere, scartare e disincantare tutti preferiscono prima le copie semplici, in modo che il pezzo finito non venga mangiato per sbaglio.\n\nL'equipaggiamento perfetto e l'incantamento sono amici: un pezzo capolavoro rimane completamente incantabile e l'incantesimo si aggiunge al bonus capolavoro senza disturbarlo o la firma del creatore. Considerando tutte le fonti, un capolavoro firmato che trasporta un incantamento superiore è il meglio che un pezzo artigianale ottiene, e si trova ancora sotto il bottino del raid in base alla progettazione.\n\nSul mercato, un pezzo incantato o firmato viene elencato come qualsiasi altra cosa: appare come un elenco a copia singola, il tooltip mostra l'incantesimo e il marchio del creatore, e Ravenpost lo trasporta altrettanto fedelmente. I materiali rimangono la metà fissa dell'imbarcazione: polvere, essenza e frammenti vengono elencati liberamente, l'elenco non costa nulla e il commerciante prende solo il 5% di una vendita completata. Ciò rende i due classici guadagni dell'incantatore vendendo materiali e vendendo il lavoro finito: sul mercato, tramite corvo o faccia a faccia in una finestra commerciale."
        }
      },
      "howHeading": "Come funziona la fabbricazione",
      "howBody": "Apri la finestra di creazione (tasto predefinito T) e ogni ricetta che conosci viene elencata con ciò di cui ha bisogno e ciò che hai a portata di mano. Le ricette legate alla stazione ti chiedono di stare entro 20 metri dalla stazione giusta in città, le ricette sul campo vengono create ovunque e la rottura e l'incantamento di Incantamento non necessitano di alcuna stazione (solo le sue due ricette di incanto sono lavoro di stazione, presso gli utensili). Non è previsto alcun tiro per il fallimento: un mestiere con i materiali in mano ha sempre successo.\n\nDue piccoli attriti mantengono l’economia onesta. Ogni creazione riuscita paga una tariffa di 2 rame per punto del budget delle statistiche dell'oggetto e le azioni di tipo creazione condividono un ritmo: al massimo 10 creazioni, disincantamenti, incantamenti, recuperi o ricariche di strumenti in ogni finestra di 60 secondi. Nessuno dei due disturberà una sessione normale; entrambi impediscono a uno specialista al massimo di inondare il mercato.",
      ...
      "masterworkBody": "Ogni creazione di successo è esattamente ciò che promette la ricetta, e talvolta qualcosa di più: un capolavoro rifinisce lo stesso pezzo con un livello di qualità più fine, con le statistiche bonus integrate al momento della creazione. È un componente aggiuntivo, non comporta mai un downgrade e rimane al di sotto del livello del raid, quindi l'equipaggiamento creato può essere eccellente senza sostituire il drop del raid.\n\nLa possibilità è pubblicata, non mistica: {base}% base, più {perTier}% per livello in cui la tua abilità si trova sopra la ricetta, più {signed}% quando entra qualsiasi reagente firmato, più {spec}% una volta che sei specializzato, con materiali di livello superiore che aggiungono dall'1 al 2% in più, il tutto limitato a {cap}%. Solo un pezzo con statistiche reali può migliorare, quindi comuni, strumenti e materiali di consumo senza stato non si attivano mai; un mestiere dormiente non ne produce mai uno, e un mestiere per hobby non può creare capolavori oltre il suo raro limite.\n\nL’opera eccellente porta con sé il suo creatore. I prodotti rari e migliori vengono firmati, ogni copia (Created by; i materiali raccolti portano Gathered by), un capolavoro è sempre firmato qualunque sia la sua qualità. Una firma è provenienza, non un lucchetto: i beni firmati possono essere scambiati, spediti ed elencati liberamente sul Mercato Mondiale.",
      "trainingHeading": "Addestramento",
      "trainingBody": "Le ricette degli allenatori provengono dai maestri residenti, insegnate nelle loro postazioni. La regola è una sola riga: un maestro insegna una ricetta una volta che il tuo livello nell'artigianato ha raggiunto il livello della ricetta, e nient'altro la blocca, né il tuo livello, né il tuo archetipo. Le scale dell'equipaggiamento e dei consumabili raggiungono i livelli di abilità 0, 25 e 50; Le due lezioni con le aste di Ingegneria continuano la scala a 75 e 125, mentre le due ricette di incantesimi di Incantesimo si trovano sul gradino 25, quindi un nuovo gradino si apre man mano che i tuoi livelli salgono.\n\nLe tariffe sono una tantum e fisse per livello: il livello iniziale è gratuito, l'abilità 25 livello costa {tier1} una ricetta, l'abilità 50 livello {tier2} e le lezioni con l'asta sopra di esse hanno le proprie tariffe, elencate accanto a ciascuna ricetta nella tabella. Per allenarti devi stare nella stazione effettiva del maestro e una stazione mobile non conta mai. Le ricette comuni sul campo e le sei ricette realizzate con gli attrezzi terrestri non necessitano di alcuna formazione; ogni personaggio li conosce dall'inizio.",
      ...
      "ench": {
        ...
        "enchantsNote": "Gli incantesimi sono disponibili in tre livelli. Il livello base funziona con Chime Dust (con un po' di Essenza nella fascia alta) e copre lo slot dell'arma più ogni slot dell'armatura tranne la mano secondaria, con abbastanza opzioni sull'asse delle statistiche che ogni build trova qualcosa per ogni slot. Il livello Superiore costa un Frammento di Campana più Essenza: bonus più forti negli slot di maggiore impatto. I frammenti alimentano inoltre altri due lavandini, le due ricette di fascino a cinque ciascuno e il gradino più alto delle ricariche degli effetti degli strumenti, quindi accumulane alcuni prima di spendere.\n\nTra di loro si trovano i cinque incantesimi runici, un consumatore per secondario digitato, quindi nulla di ciò che macini è mai un vicolo cieco: Runed Edge (arma, Forza, consuma acciaio risonante), Sigillo runico (arma, Intelletto, legname risonante), Trama runica (petto, Spirito, Filo risonante), Pelle runica (gambe, Agilità, Pelle risonante) e Collegamenti runici (elmo, Resistenza, Collegamenti risonanti). Ognuno prende anche due Chime Essence; dove uno slot e una statistica hanno sia un incantesimo base che un incantesimo superiore, il bonus Rune si trova tra di loro, mentre Runed Weave è l'incantesimo Spirito sul petto più forte in assoluto e Runed Hide è l'unico incantamento dell'Agilità sulle gambe. I bonus esatti sono tutti nella tabella seguente.",
        "colEnchant": "Incanto",
        "colSlot": "Slot",
        "colTier": "Livello",
        "colBonus": "Bonus",
      ...
      "gatherIntro": {
        "mining": "L'estrazione mineraria estrae il minerale direttamente dalle rocce del mondo: il rame a Eastbrook Vale, il ferro a Mirefen Marsh e l'osmio a Thornpeak Heights, con vene iniziali sparse in ogni zona più giovane al di là di esse, alimentando le fucine. Aperto a tutti dal livello 1: un piccone da estrazione di rame da 20 da un contatore Eastbrook, Fenbridge o Highwatch apre ogni vena iniziale e i gradini più alti della scala del piccone si risvegliano man mano che il tuo contatore li guadagna. Tracciato sul proprio contatore fino a un limite di 100.",
        "logging": "Il disboscamento abbatte il legname da gruppi di alberi in tutto il mondo: corteccia di ferro a Eastbrook Vale, frassino a Mirefen Marsh, pino alto a Thornpeak Heights e tronchi di avviamento in ogni zona più giovane, il materiale grezzo per manici, doghe e banco dell'ingegnere. Aperto a tutti dal livello 1 con un'ascia da taglio nelle borse (20 rame ai contatori Eastbrook, Fenbridge e Highwatch), tracciato sul proprio contatore fino a un limite di 100.",
        "herbalism": "L'erboristeria raccoglie ciò che cresce selvatico: foglie di lucentezza a Eastbrook Vale, foglie d'oro a Mirefen Marsh, petali di sole a Thornpeak Heights e macchie iniziali in ogni zona più giovane, la foglia e lo stelo che mantengono in fermento i mestieri dello speziale. Aperto a tutti dal livello 1 con una falce da erboristeria nelle borse (20 rame ai contatori Eastbrook, Fenbridge e Highwatch), tracciato sul proprio contatore fino a un limite di 100.",
        "fishing": "La pesca è quella più strana tra i mestieri di raccolta, e la più profonda: un vero minigioco mordi e mulinelli, le sue tabelle di cattura in ciascuna delle tre zone centrali (le acque giovani al di là di esse servono tutte la tavola della Valle per ora) e un limite di competenza di 200, il doppio degli altri. Compra un palo, affronta il mare aperto e lancia."
      },
      "rhythmHeading": "Il ritmo del raccolto",
      "rhythmBody": "Un raccolto è un breve lancio visibile, non una cattura istantanea: base di {base} secondi, mai al di sotto di un secondo piano di {floor}. Portare uno strumento sopra il livello del nodo, uno che la tua competenza ti consente di maneggiare, ti accelera di {tool} secondi per livello sopra di esso e ogni fascia di competenza che attraversi riduce altri {band} secondi; semplicemente abbinare il livello del nodo ti fa entrare nella porta, sono i livelli sopra di esso che ti rendono veloce.\n\nUna borsa piena rifiuta educatamente il lancio prima che inizi, quindi nulla viene sprecato nel bel mezzo dello swing, e ogni raccolto paga una piccola fetta di XP del personaggio, scalata in base al livello del nodo rispetto al tuo nel modo in cui si ridimensiona l'XP di uccisione: un banale nodo grigio non insegna nulla a un personaggio con limite.",
      "gainBody": "Il guadagno è deterministico, mai un tiro di potenziamento: un nodo pari o superiore al tuo livello di guadagno insegna un punto intero per raccolto e ogni competenza {step} è un livello ottenuto rispetto al nodo. I nodi di livello 1 pagano per intero sotto 25, metà a 49, un quarto a 74 e niente da 75 in poi; i nodi di livello 2 pagano per intero a 49; i due nodi di livello 3 di ciascuna operazione pagano per intero fino a 74 e metà fino al limite di {cap}.\n\nIl percorso previsto è semplice: impara sui nodi iniziali della Valle, spostati nella palude e termina la salita sulle alture di Thornpeak Heights. Al raggiungimento del limite l'apprendimento si ferma ma i rendimenti no: un raccoglitore con limite continua a lanciare le migliori quote offerte dal commercio per sempre.",
      ...
      "toolsNote": "Ogni nodo ha bisogno del suo strumento commerciale nelle tue borse, livello 1 incluso: niente piccone, niente minerale, niente asta, niente pesce. La scala dei venditori copre i livelli da 1 a 3 nei tre hub del cuore: lo strumento di livello 1 viene venduto in tutti e tre, i pioli sopra di esso dove inizia il terreno che li utilizza (Fenbridge aggiunge il livello 2, Highwatch il livello 3) e gli insediamenti più giovani al di là di loro non hanno alcuno strumento, quindi preparati prima di partire. Ogni contatore vende liberamente ogni gradino che immagazzina e qualsiasi strumento passa attraverso il commercio diretto; ogni gradino è inoltre elencato sul Mercato e viaggia per posta tranne i tre terreni iniziali da 20 rame: quelli vengono acquistati allo sportello o passati di mano in mano, e mai rivenduti, spediti o elencati. Ciò che è recintato è il maneggio. Uno strumento di terra superiore al livello 1 funziona solo una volta che la tua competenza nel proprio mestiere lo ha guadagnato, {tier2Prof} per il livello 2, {tier3Prof} per il livello 3 e 85 e 100 per i due pioli realizzati, e la riga del venditore, il suggerimento e la tabella sottostante nominano tutti i requisiti in anticipo. Fino ad allora, uno strumento acquistato in anticipo aspetta semplicemente nelle tue borse, senza aprire il terreno, senza acquistare velocità e senza coniare qualità fini, quindi si brandisce nel momento in cui il tuo contatore tocca il suo numero. Le canne da pesca sono l'unica eccezione: nessuna canna ha requisiti di impugnatura e il commerciante Wilkes di Eastbrook rifornisce deliberatamente le canne di livello 2 e 3 per i pescatori che acquistano in anticipo. Uno strumento non occupa mai uno slot di equipaggiamento e non si consuma mai, quindi ognuno di essi è un acquisto una tantum e per il cancello conta solo il livello: uno strumento più raro dello stesso livello non apre nulla in più. La rarità non è solo colore, però. Fa durare più a lungo l'effetto dell'utensile a fessura e su una canna allarga la finestra del mulinello.\n\nUno strumento migliore consente di acquistare tre cose, non due. Apre un terreno di livello superiore, accorcia il getto e migliora ciò che ne esce: lavora una vena con uno strumento classificato SOPRA il materiale proprio della zona e il raccolto ne produce la grana fine invece di quella semplice. La vena deve essere una di quelle a pieno grado della zona, quindi le vene più facili che una zona conserva per i viaggiatori producono comunque materiale ordinario. I materiali pregiati sono ciò che consumano le ricette degli strumenti artigianali, e una qualità fine conta come la sua versione ordinaria ovunque una ricetta o un ordine di lavoro ne richieda uno, quindi il miglioramento non ti blocca mai: significa semplicemente che il tuo minerale di rame arriva come minerale di rame fine.\n\nSopra la scala del venditore ogni commercio ha due strumenti artigianali, livello 4 e livello 5, realizzati presso l'officina (ogni personaggio conosce le ricette della terra; l'abilità che sale per il lavoro è di Ingegneria), o acquistati con Delve Marks al contatore Drowned Litany una volta raggiunti i cancelli di sgombero: la tabella sottostante riporta il prezzo in Marks e gli sgomberi richiesti da ciascun livello. Nessun commerciante li vende mai per moneta. La pesca ha le sue coppie, e queste vengono apprese dal creatore di attrezzi piuttosto che conosciute fin dall'inizio. Nessun nodo e nessuna acqua oggi hanno bisogno di più del livello 3, quindi i due pioli superiori acquistano velocità, pendenza e una finestra di bobina più gentile piuttosto che accesso, e saranno il biglietto d'ingresso quando arriverà il terreno di livello superiore.",
      "toolCrafted": "Fabbricato ({craft})",
      "toolCraftedOrMarks": "Creato ({craft}) o {marks} Espansione marchi dopo aver completato tre Litanie annegate",
      "toolCraftedOrMarksHeroic": "Creato ({craft}) o {marks} Segni di approfondimento dopo aver completato una litania eroica sugli annegati",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Non in vendita",
      "priceNone": "Non venduto per moneta",
      "toolTierReq": "Strumento di livello {tier}",
      "colWield": "Utilizzare a",
      "wieldNone": "Qualunque",
      ...
      "bandsBody": "Le fasce di competenza sono la scala condivisa 0/100/200 sul bancone di un'operazione. Per i commerci fondiari, la fascia incrociata a 100 rasa il getto di raccolta, e il loro limite costituisce la fascia 1 del soffitto. Le bande di pesca non risparmiano nulla: scelgono i tavoli di cattura (con una canna adatta), solo la pesca arriva alla banda 2, e la salita stessa è ciò che spinge un pescatore in acque più profonde, dove vivono i tavoli migliori e le lezioni ulteriori.",
      ...
      "specimenBody": "Tieni un po' di spazio di riserva nella borsa quando coltivi: una manna firmata ha bisogno di spazio tutto suo o di una pila firmata corrispondente in cui atterrare, e se non c'è nulla che si adatti, la resa arriva comunque ma la firma è persa. Anche la raccolta dei cadaveri ha il suo jackpot: circa il {pct}% di ogni componente raccolto risulta raro o migliore. Una famiglia con un esemplare perfetto da donare (pelle, seta, veleno, carne) mantiene normale la sua resa ordinaria e conia accanto ad esso l'esemplare firmato; ogni altra famiglia firma essa stessa la rendita.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "La pietra miliare 100 inscrive Old Salt e 200 inscrive Master Angler con il suo titolo, il massimo dell'arte del pescatore; Anche la pesca conta per Master Gatherer, guadagnata a 100 in tre operazioni di raccolta qualsiasi. Un primo pesce da ciascuna delle acque di sei zone riempie la propria pagina, le tre zone centrali e il Willowfen, il Galecrest e il Farshore al di là di esse, e Sunglint Koi registra Barlume di speranza, così i viaggiatori con una canna nello zaino riempiono il loro libro più velocemente di quanto si aspettino."
      },
      "fish": {
        "startHeading": "Come iniziare",
        "startBody": "Una canna da pesca semplice costa 20 rame dal Pescatore Brandt a Eastbrook (cerca l'Old Salt al confine est della città, vicino alla strada per Mirror Lake); Anche il Tinker Gizzel, il Provisioner Hale a Fenbridge e il Quartiermastro Bree nei pali di Highwatch. Usa il palo mentre sei rivolto verso l'acqua abbastanza profonda da contenere i pesci, fino a circa 24 metri davanti a te, e il tuo galleggiante salpa.\n\nNon puoi lanciare mentre sei in combattimento, mentre nuoti o mentre sei morto: lanciare dalla riva è la postura prevista. L'acqua diventa più dura come la terra, però: la palude vuole almeno l'Ironreel di livello 2 e le cime il Silverstream di livello 3, e una lenza lanciata senza la canna che l'acqua prende non ti lascia mai la mano. Sopra di essi si trovano due aste, lo Stormreel e il Tidewrought: gli ingegneri li fabbricano presso l'officina con ciò che tira su una linea, e il contatore di esplorazione del Drowned Litany li vende per Delve Marks dietro i suoi cancelli di sgombero, anche se mai in cambio di monete. Non c'è acqua che li richieda, quindi acquistano un'attesa più breve e una finestra di bobina più ampia invece dell'accesso, che al gradino più alto significa un boccone in tre secondi netti.",
        "biteHeading": "Abboccata e salpata",
        "biteBody": "Dopo il lancio, il morso arriva in un momento nascosto tra {min} e {max} secondi; il ritardo viene deciso quando la linea si ferma, quindi non esistono due cast uguali. Quando il galleggiante abbocca hai una seconda finestra di {reel} per premere nuovamente la canna e riavvolgere: mulinello al suo interno e la preda atterra, esita oltre e il pesce se ne va senza nulla da mostrare. Un'intera sessione termina in {cap} secondi, quindi anche un cast silenzioso si risolve rapidamente.\n\nLe canne migliori affilano entrambe le estremità del minigioco: ogni livello di canna sopra i primi trim {rod} secondi dall'attesa più lunga possibile, mai sotto i tre secondi, l'asta superiore già sfiora e aggiunge {reelRod} secondi alla finestra del rullo, quindi l'Ironreel riduce l'attesa peggiore a 6,5 secondi con una finestra di 3,25 secondi, e il Silverstream a 5 con una finestra oltre 4, la sua rarità allargando il rullo un po' oltre quello che il paga solo il livello. I morsi più veloci non cambiano mai ciò che hai in mano, e basta avere una canna nella borsa per contare.",
        "scheduleHeading": "Guadagno di competenza",
        "scheduleNote": "Il guadagno di pesca segue un programma fisso senza dadi: un punto intero per cattura al di sotto di 50 di competenza, mezzo punto sotto 100, un decimo sotto 150 e un lento rivolo di 0,02 da 150 a 200. Quest'ultimo tratto è un viaggio di migliaia di catture apposta: 200 è un'affermazione, non una fermata sulla strada verso qualcos'altro.\n\nJunk smette di insegnare del tutto a {cutoff}: da lì in poi, erbacce e stivali sono solo erbacce e stivali. Anche l'acqua stessa conclude la lezione: le acque di livello 1 della Valle (e ogni giovane costa oltre il cuore) non insegnano nulla oltre i 100, la palude si ferma a 150 e solo la scuola di Thornpeak un pescatore arriva fino a 200. Per il resto ogni pesca sbarcata guadagna al ritmo previsto, quindi quando il contatore si ferma, il programma ti dice di cercare acque più profonde.",
        "colProficiency": "Competenza",
        "colGain": "Guadagno per cattura",
        "belowFmt": "Sotto {below}",
        "tablesHeading": "Tabelle delle catture",
        "tablesNote": "La tua abilità seleziona una delle tre fasce di cattura: fascia 0 dall'inizio, fascia 1 a 100, fascia 2 a 200, ciascuna spostando il peso dalla spazzatura e dagli ami vuoti al pesce vero, zona per zona. Ogni banda sopra la prima richiede anche una canna: la banda 1 vuole l'Ironreel di livello 2, la banda 2 la Silverstream di livello 3. La tua fascia effettiva è quella inferiore tra ciò che la tua abilità ha guadagnato e ciò che la tua canna supporta, e il tappo è silenzioso: con una canna minore prendi comunque, appena fuori dal tavolo della fascia inferiore, quindi se le tue prese sembrano bloccate mentre la tua abilità sale, controlla prima la tua canna.\n\nLe acque di ciascuna zona contengono la propria coppia di pesci da cibo, che guariscono tanto più quanto più è profonda la zona, tutti con input di cottura e cibo crudo perfettamente buono da sedersi e mangiare. Il resto della tabella è la tassa del pescatore: erba, qualche stivale occasionale e l'amo vuoto, che non scompare mai del tutto. Quanto paghi dipende dall'acqua in cui atterra il tuo bobber, non da dove ti trovi: un lancio arriva fino a 24 metri, e la canna che l'acqua richiede, il tavolo da cui attinge, l'atto che attribuisce e quanto insegna, tutto risponde alla zona a cui appartiene l'acqua, deciso nel momento in cui la lenza atterra. L'acqua di ogni zona è scritta per una fascia a sé stante, la Valle per la fascia 0, la palude per la fascia 1, i picchi per la fascia 2, e pescare una fascia sotto trasforma circa un terzo dei tuoi lanci in ami vuoti, due fasce sotto più della metà. La canna ti porta in acqua; l'abilità è ciò che fa guadagnare, e la salita è ciò che spinge un pescatore più in profondità, perché le bande migliori non sono solo una paga migliore: oltre la Valle sono le uniche acque che continuano a insegnare. Il {rare} è l'unica riga che risponde alla tua banda di cattura e nient'altro: le stesse probabilità in ogni zona, e sei volte più probabili nella banda 2 che nella banda 0, quindi la cosa più rara sul molo è quella in cui un Master Angler è davvero migliore.",
        ...
        "koiBody": "Ogni specchio d'acqua nel gioco nasconde lo stesso premio: il Sunglint Koi, un luccichio insolito sulla linea che vale 75 rame per un venditore e molto di più per il tuo orgoglio. Le sue probabilità rispondono alla tua fascia di cattura e a nient'altro, le stesse in ogni zona: una riga dell'1% della tabella di cattura nella fascia 0, 3 nella fascia 1 e 6 nella fascia 2, disegnata su ogni lancio riavvolto, quindi il koi arriva al pescatore che ha guadagnato le tabelle profonde. Ottenere uno registra Barlume di speranza nel tuo Libro delle gesta, un marchio da collezione con Fama zero. Quando ciò accade, il registro si assicura che tu lo sappia."
      },
      "econ": {
        ...
        "trainingNote": "Una tariffa fissa per ogni livello di ricetta, addebitata una volta quando un maestro la insegna; ogni gradino della tabella sottostante è in uso oggi, dalle ricette iniziali gratuite alle lezioni sulle canne del fabbricante di utensili in alto.",
        ...
        "provenanceBody": "Alcuni elementi portano un nome. Passa il mouse su uno e la descrizione comando dice Raccolto da così e così su una materia prima, o Realizzato da così e così su un pezzo finito: lo stesso marchio, formulato per indicare come è nato l'oggetto. Una firma è parte dell'oggetto stesso, viaggia con esso attraverso le transazioni, la banca, la posta, il mercato mondiale e persino il riacquisto da parte di un venditore, e non svanisce mai.\n\nLa raccolta dei segni funziona automaticamente: ogni raccolto che risulta raro o migliore arriva firmato, e i reperti rari firmano il loro intero guadagno di cinque volte. Il rotolo fortunato del raccolto di un cadavere segna la sua resa laddove la famiglia non ha esemplari da donare e, dove lo fa, mantiene la resa semplice e conia l'esemplare incontaminato firmato accanto ad esso. Creare segni sulla stessa linea: ogni copia di un prodotto raro o migliore è firmata, e un capolavoro firma sempre qualunque sia la sua qualità, quindi la versione migliore di qualsiasi pezzo nomina sempre il suo creatore. L'unica cosa che può costarti una firma è una borsa piena: un'unità firmata ha bisogno di spazio proprio, o di una pila firmata corrispondente, per atterrare.\n\nUna pila di oggetti condivide un'identità, quindi due copie si fondono solo quando ogni marchio corrisponde esattamente: stesso oggetto, stesso firmatario, stesse statistiche di capolavoro, stesso incantamento, stesso legame. Un tronco firmato non si unisce mai a una pila semplice in entrambe le direzioni (la fusione cancellerebbe il nome di qualcuno), ma carichi utili identici si uniscono felicemente, quindi venti minerali firmati dallo stesso raccoglitore si trovano in una pila e una manna non distrugge le tue borse.\n\nLe firme ripagano gli artigiani: tenere qualsiasi copia firmata di un reagente necessario al banco, chiunque l'abbia firmata, aggiunge 2 punti percentuali di possibilità di capolavoro e tenere un reagente firmato con la propria mano riduce la quantità richiesta di quel reagente di uno (mai sotto uno). La tua opera rara o migliore firmata continua a insegnarti, oggi solo attraverso la fiaschetta: bevi una pozione che hai firmato e un piccolo rivolo di abilità ritorna all'arte che l'ha prodotta, purché quell'arte sia una delle tue specializzazioni attive.",
        ...
        "throttleBody": "L'output ha un tetto: le ricariche di creazione, disincantamento, incantamento, recupero e effetti degli strumenti condividono un budget di {actions} azioni riuscite in ogni finestra di {seconds} secondi. Un tentativo negato non costa nulla e non spende alcun budget. Non lo sentirai mai durante il gioco normale; esiste in modo che uno specialista al massimo con una banca piena non possa inondare il mercato, qualunque sia la sua abilità o riserva.",
      ...
      "faq": {
        ...
        "a4": "Hai avuto una fortuna. Circa 1 raccolto su 90 innesca un raro evento di raccolta (durame antico su un albero, una vena incontaminata sul minerale, una fioritura illuminata dalla luna sulle erbe): moltiplica la resa cinque volte, firma ogni unità con il tuo nome e annuncia il ritrovamento a tutta la zona. Anche un tiro di rarità raro o migliore su un raccolto ordinario indica il rendimento.\n\nVale la pena conservare o vendere a caro prezzo i materiali firmati: tenere al banco qualsiasi copia firmata di un reagente necessario aggiunge 2 punti percentuali alla possibilità di creare un capolavoro. Ricorda solo che si accumulano solo con copie firmate identiche, quindi mantengono il proprio spazio nella borsa.",
        ...
        "a6": "Le nove ricette comuni sul campo e le sei ricette create per gli strumenti terrestri sono note a tutti fin dall'inizio, così come tre pietre di copertura legate alle stazioni (il Kilnscale Mantle, il Wardweave Cowl e le Duskhide Wraps), che non necessitano di allenatore, ma solo della loro stazione. Tutto il resto viene insegnato dai maestri residenti nelle loro stazioni nelle tre città hub: la maggior parte si trova a Eastbrook, il conciatore ha la conceria a Fenbridge e l'alchimista ha il farmacista a Highwatch.\n\nLe ricette dell'allenatore vengono eseguite in livelli: abilità 0, 25 e 50 per l'equipaggiamento e i materiali di consumo, a prezzo gratuito, 25 argento e 1 oro come tariffe una tantum; Le due ricette di incantesimi di Incantesimo si trovano sul gradino 25 e il fabbricante di utensili insegna le due canne da pesca artigianali a 75 e 125 per 4 e 16 oro. Un maestro insegna una ricetta una volta che la tua fascia in quell'imbarcazione ha raggiunto la fascia della ricetta, e devi trovarti alla loro postazione per imparare: una stazione mobile non conta.",
        "q7": "Perche la mia raccolta e improvvisamente rallentata?",
        "a7": "Il lancio di raccolta inizia a 2,5 secondi e viene ridotto in due modi: 0,4 secondi per ogni livello di strumento che porti e puoi impugnare al di sopra del livello del nodo e 0,15 secondi una volta che il contatore del tuo scambio supera la sua fascia di 100, con un minimo di 1,5 secondi. Passa dai nodi di livello 1 fino ai nodi di livello 3 e il tuo surplus svanisce, quindi la stessa scelta oscilla di nuovo più lentamente. Mantenere esattamente il livello richiesto non aumenta la velocità; apre solo il nodo.\n\nIl guadagno di abilità svanisce allo stesso modo del crafting: un nodo diventa grigio man mano che la tua competenza supera il suo livello (i nodi di livello 1 non insegnano nulla dalla competenza 75 in poi), quindi la risposta ai guadagni lenti sono i nodi di livello più alto. Quelli hanno bisogno di uno strumento almeno del loro livello nelle tue borse (nessun nodo viene mai lavorato a mani nude, livello 1 incluso), e uno strumento di terra sopra il livello 1 vuole anche prima il suo marchio di impugnatura, 40/70/85/100 nel proprio commercio per i livelli da 2 a 5. La pesca segue la sua riduzione: pieno guadagno sotto 50 competenza, metà sotto 100, un rivolo di 0,1 sotto 150 e 0,02 sotto 200, le catture spazzatura non insegnano nulla da 100 in poi, e l'acqua stessa conclude la lezione (le acque di livello 1 smettono di insegnare a 100, la palude a 150), quindi un contatore bloccato può anche significare che hai superato l'acqua.",
        "q8": "Posso lavorare lontano dalla citta?",
        "a8": "In parte. Le nove ricette da campo comuni (l'arma iniziale, l'armatura, il cibo e le pozioni base) possono essere realizzate ovunque e in qualsiasi momento, così come le tre ricette combinate delle coppie giurate. Tutto il resto sopra di loro è legato a un tipo di stazione: fucina, cucine, farmacia, conceria, telaio o fabbrica di utensili, e devi trovarti entro 20 metri dalla stazione affinché l'imbarcazione possa attraversarla.\n\nCon 75 abilità in un mestiere ti specializzi e, insieme a uno sconto sul materiale del 20%, ottieni una stazione mobile: posizionala sul campo e rimarrà ferma per 10 minuti, servendo le ricette di quell'artigianato come se fossi nel mestiere reale. La stazione mobile serve solo per il crafting: imparare ricette e commissioni non vincolanti richiede sempre la vera stazione in città."
      }
    },
    "economy": {
  ...
  "questUi": {
    ...
    "log": {
      ...
      "cooldownStatus": "Di nuovo disponibile presto",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Articolo sconosciuto {id}, quantità {count}",
      "unknownItemAriaMasterwork": "Articolo sconosciuto {id}, quantità {count}, capolavoro",
      "unknownItemAriaEnchanted": "Articolo sconosciuto {id}, quantità {count}, copia incantata",
      "unknownItemAriaBound": "Articolo sconosciuto {id}, quantità {count}, copia rilegata",
      "unknownItemAriaInstanced": "Articolo sconosciuto {id}, quantità {count}, copia con marchio del produttore"
    },
    "equipment": {
      "empty": "Vuoto",
      "levelClass": "Livello {level} {className}"
    ...
    "vendor": {
      ...
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Acquista {count} alla volta",
      "qtyCustom": "Costume",
      "qtyCustomAria": "Scegli un importo personalizzato da acquistare",
      "buyCountAria": "Acquista {count} di {item} per {price}",
      "buyCountAriaWithRequirement": "Acquista {count} di {item} per {price}. {requirement}",
      "buyQuantityTitle": "Acquistane quanti {item}? Fino a {max}.",
      "buyQuantityInput": "Quantità da acquistare",
      "buyQuantityConfirm": "Acquistare",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_thorium_ore": {
        "name": "Minerale di osmio fine"
      },
      "fine_ironbark_log": {
        "name": "Tronco di corteccia di ferro pregiato"
      },
      "fine_ashwood_log": {
        "name": "Ceppo di frassino pregiato"
      },
      "fine_elderwood_log": {
        "name": "Bel registro Highpine"
      },
      "fine_silverleaf_herb": {
        "name": "Erba di Sheenleaf fine"
      },
      "fine_goldleaf_herb": {
        "name": "Erba fine a foglia d'oro"
      },
      "fine_sunpetal_herb": {
        "name": "Fine erba di Sunpetal"
      },
      "stormreel_fishing_rod": {
        "name": "Canna da pesca Stormreel"
      },
      "tidewrought_fishing_rod": {
        "name": "Canna da pesca realizzata in marea"
      },
      "duskwisp_essence": {
      ...
      "gatherers_cache": {
        "name": "Cassa del raccoglitore"
      },
      "artisans_eye": {
        "name": "L'occhio dell'artigiano"
      },
    ...
    "quests": {
      ...
      "q_the_codfather": {
        "title": "Il Pescadrino",
        "text": "Il Codfather non è solo un pesce, {playerName}, è un assassino a sangue freddo. I veterani giurano che mangia i Predoni delle Paludi a colazione, e perfino le Vedove di Mirefen non tesseranno le loro tele vicino alle Secche di Deepfen per puro terrore. Lui governa quelle acque, e l'acqua paludosa richiede nientemeno che una canna da pesca Ironreel; il mio contatore li vende. Prendine uno in mano, trascina quel vecchio diavolo fuori dalle sue acque e ammetterò che ti sei unito alla famiglia.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "Ho già visto questi segni su tre vecchie tombe attorno al campo di battaglia settentrionale. Il Capitano Aldren si trova sull'altura occidentale, il Sommo Sacerdote Malric più a sud lungo il confine occidentale e l'Assassino Reale Voss sulla scogliera orientale. Tocca ogni tomba e ascolta, {playerName}. I morti potrebbero ricordare ciò che i vivi hanno dimenticato.",
