...
export const it_IT: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customizeTitle": "Personalizza comandi",
      "customizeSlotAttack": "Attacco base",
      "customizeSlotSkill": "Abilità {n}",
      "customizeSlotUtility": "Utilità",
      "customizeDefault": "Predefinito classe",
      "customizeResetSlot": "Reimposta questo slot",
      "customizeResetAll": "Reimposta tutto ai valori della classe",
      "customizeUpdated": "{slot} aggiornato.",
      "customizeAllReset": "Comandi reimpostati ai valori della classe."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "touchControls": "Comandi touch",
      "clusterHold": "Ritardo pressione per modifica",
      "clusterHoldNote": "Per quanto tempo tenere premuto un pulsante d’azione a schermo prima che si apra l’editor di assegnazione. Aumentalo se apri l’editor mentre lanci abilità in rapida successione.",
      "targetPriority": "Priorità bersaglio d’attacco",
      "targetPriorityNearest": "Più vicino",
      "targetPriorityLowestHp": "Salute più bassa",
      "targetPriorityCurrent": "Prima l’attuale",
      "targetPriorityNote": "Cosa bersaglia il pulsante Attacco quando non hai un bersaglio valido: il nemico più vicino, il nemico con meno salute a portata, oppure mantieni il bersaglio attuale finché resta valido.",
      "aimAssist": "Lancio intelligente",
      "aimAssistNote": "Premi un’abilità offensiva per lanciarla sul tuo bersaglio, o sul miglior nemico vicino se non ne hai, girandoti verso di esso. Tieni premuto il pulsante per vedere la portata dell’abilità; rilascia con il dito fuori dal pulsante per annullare.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Reimposta comandi touch",
      "touchResetDone": "Comandi touch ripristinati ai valori predefiniti.",
