...
export const it_IT: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Scegli WOC Wallet, Phantom o Solflare. La tua app portafoglio chiederà approvazione. Tieni aperto questo gioco e tornaci quando hai finito.",
    "standaloneAppHelp": "Le connessioni portafoglio non sono ancora disponibili nell'app dalla Schermata Home. Apri World of ClaudeCraft in Safari o Chrome per usare WOC Wallet, Phantom o Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "Nessuna estensione portafoglio compatibile trovata. Installa o sblocca WOC Wallet, Phantom, Solflare o un altro portafoglio Solana per browser, poi riprova.",
