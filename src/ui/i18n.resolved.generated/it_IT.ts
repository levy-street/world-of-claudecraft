...
export const it_IT: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "lootHistory": "Cronologia",
      "title": "{tab} - {view}",
      "noCombat": "Nessun combattimento registrato.",
      "noLoot": "Nessun bottino registrato.",
      "recentAwards": "{count} assegnazioni recenti",
      "target": "Bersaglio: {name}",
      "noTargetEngaged": "Nessun bersaglio ingaggiato.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Passato",
      "methodMaster": "Maestro",
      "methodPersonal": "Personale",
      "methodDelve": "Scavo",
      "methodLooted": "Raccolto",
      "noWinner": "Nessun vincitore",
      "rollDetail": "Tiro {roll}",
