...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "shaderWarmOff": "끄기",
      "shaderWarmOn": "켜기",
      "shaderWarmNote": "자동: 그래픽 백엔드가 지원하는 경우(Direct3D 11, Vulkan) 백그라운드 워커에서 셰이더를 미리 링크합니다. 도움이 되지 않는 OpenGL에서는 꺼진 상태로 유지됩니다. 켜기는 프레임이 나빠지는 환경을 포함해 모든 곳에서 워커를 강제하고, 끄기는 워커를 전혀 사용하지 않습니다. 다음에 게임을 시작할 때 적용됩니다.",
      "gpuBackend": "그래픽 백엔드(Linux)",
