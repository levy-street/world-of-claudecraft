...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    "privacyConsent": {
      "bannerTitle": "Claudemoon에서의 개인정보 보호",
      "bannerOptIn": "선택 서비스를 불러올지 선택하세요. 필수 서비스는 항상 활성화됩니다.",
      "bannerOptOut": "선택 서비스가 활성화되어 있습니다. 「선택 서비스 거부」를 눌러 타겟 광고를 위한 정보 판매 또는 공유를 거부하거나, 불러올 항목을 직접 선택하세요.",
      "bannerGpc": "브라우저의 Global Privacy Control 신호를 존중합니다. 분석 및 마케팅 기능은 비활성 상태로 유지됩니다.",
      "acceptAll": "모두 허용",
      "rejectAll": "선택 서비스 거부",
      "customize": "직접 설정",
      "launcher": "개인정보 설정",
      "dialogTitle": "개인정보 설정",
      "dialogIntro": "World of ClaudeCraft에서 사용할 수 있는 선택 서비스를 고르세요. 이 설정은 언제든지 변경할 수 있습니다.",
      "close": "개인정보 설정 닫기",
      "necessaryTitle": "필수",
      "necessaryBody": "보안, 환경 설정 저장, 인증 및 핵심 게임 기능에 필요합니다.",
      "analyticsTitle": "분석",
      "analyticsBody": "사이트 이용 현황을 파악하고 게임 성능 문제를 진단하는 데 도움이 됩니다.",
      "marketingTitle": "마케팅",
      "marketingBody": "Meta Pixel 등의 서비스를 통해 캠페인 성과를 측정합니다.",
      "xTitle": "X 피드",
      "xBody": "뉴스 페이지에 삽입된 @WoClaudecraft 타임라인을 불러올 수 있게 합니다.",
      "twitchTitle": "Twitch 플레이어",
      "twitchBody": "삽입된 Yuumiii 라이브 방송 플레이어를 불러올 수 있게 합니다.",
      "alwaysOn": "항상 사용",
      "save": "설정 저장",
      "cookiePolicy": "Cookie 정책 읽기",
      "twitchBlocked": "개인정보 설정에서 Twitch를 허용할 때까지 Twitch 플레이어가 일시 중지됩니다.",
      "twitchEnable": "Twitch 개인정보 설정 선택"
    },
    "spectate": {
      "banner": "{name} 관전 중"
    },
  ...
  "mode": {
    "onlineTitle": "온라인 플레이",
    "onlineDesc": "라이브 서버에서 플레이합니다. 캐릭터는 온라인에 저장됩니다.",
    "onlineAria": "온라인 플레이: 지속적으로 공유되는 월드에 로그인합니다",
    "offlineTitle": "오프라인 플레이",
    "offlineDesc": "브라우저에서 로컬 오프라인 월드를 플레이합니다. 진행 상황은 저장되지 않습니다.",
    ...
    "serverAria": "서버 모드 선택: 서버 온라인 또는 서버 오프라인",
    "serverOfflineSub": "로컬 오프라인 월드",
    "caLabel": "$WOC 계약 주소",
    "caCopyAria": "계약 주소 복사",
  ...
  "landing": {
    "heroEyebrow": "세계는 이미 움직이고 있습니다",
    "heroHeading": "플레이어와 AI 모험가가 같은 세계에 맞서는 살아 있는 클래식 MMO입니다.",
    "heroBody": "브라우저에서 무료로 플레이하고, 아홉 직업 중 하나로 영웅을 키우거나 실제 게임에서 에이전트를 훈련하세요.",
    "heroStatus": "월드 온라인",
    "heroPlayers": "명의 등록 모험가",
    "communityLinks": "커뮤니티 링크",
    "followSocials": "소셜에서 팔로우",
    "socialX": "X",
    "socialDiscord": "Discord 커뮤니티",
    "socialTwitch": "Twitch 방송",
    "socialInstagram": "Instagram 공식 계정",
    "socialTikTok": "TikTok",
    "socialYouTube": "YouTube",
    "socialReddit": "Reddit 커뮤니티",
    "socialGitHub": "GitHub",
    "patchNotesLabel": "패치 노트",
    "patchNotesTitle": "패치 노트",
    "patchNotesDesc": "최신 게임플레이 변경 사항, 수정 사항 및 릴리스 세부 정보를 확인하세요.",
    "patchNotesLoading": "최신 패치 노트를 불러오는 중…",
    "patchNotesError": "패치 노트를 불러오지 못했습니다. 나중에 다시 시도해 주세요.",
    "patchNotesEmpty": "아직 패치 노트가 없습니다. 곧 다시 확인해 주세요.",
    "patchNotesPrerelease": "사전 출시",
    "patchNotesViewOnGithub": "GitHub에서 릴리스 보기",
    "newsEyebrow": "세계의 소식",
    "newsTitle": "Claudemoon 소식",
    "newsBody": "World of ClaudeCraft의 최신 소식과 이 세계 뒤편의 이야기를 만나보세요.",
    "newsXTitle": "X 최신 소식",
    "newsXIntro": "@WoClaudecraft의 공식 게시물",
    "newsXConsentTitle": "X 피드를 불러오려면 허가가 필요합니다",
    "newsXConsentBody": "이 라이브 피드를 X에 연결하려면 허가가 필요합니다. X에서 방문 관련 정보를 받을 수 있습니다.",
    "newsXConsentNote": "개인정보 설정에서 X 콘텐츠를 활성화하세요. 이 설정은 언제든지 변경할 수 있습니다.",
    "newsXPrivacyChoices": "개인정보 설정",
    "newsXUnavailableTitle": "X 피드를 불러오지 못했습니다",
    "newsXUnavailableBody": "브라우저나 확장 프로그램에서 차단했거나 X에 일시적인 문제가 발생했을 수 있습니다.",
    "newsXHiddenTitle": "여기서는 라이브 피드를 이용할 수 없습니다",
    "newsXHiddenBody": "삽입된 X 피드는 작은 화면이나 앱에서 이용할 수 없습니다. 최신 게시물을 보려면 X에서 @WoClaudecraft를 여세요.",
    "newsXPrivacy": "이 피드를 불러오면 X에 연결되며 X가 방문 정보를 받을 수 있습니다.",
    "newsXLoad": "X 피드 불러오기",
    "newsXRetry": "다시 시도",
    "newsXHide": "X 피드 숨기기",
    "newsXOpen": "X에서 @WoClaudecraft 열기",
    "newsXOpenAria": "X에서 @WoClaudecraft를 새 탭으로 열기",
    "newsXNewTab": "새 탭에서 열립니다",
    "newsXLoading": "X 피드를 여는 중…",
    "newsXLoaded": "X 피드를 불러왔습니다.",
    "newsXUnavailable": "X 피드를 불러오지 못했습니다. 모든 게시물은 X에서 직접 볼 수 있습니다.",
    "newsXHidden": "X 피드가 숨겨져 있습니다. 프로필은 X에서 직접 열 수 있습니다.",
    "newsXIframeTitle": "X의 @WoClaudecraft 최신 게시물",
    "newsBlogEyebrow": "CLAUDEMOON 연대기",
    "newsBlogTitle": "최신 이야기",
    "newsBlogEmptyTitle": "첫 번째 이야기를 쓰고 있습니다",
    "newsBlogEmptyBody": "뉴스와 비하인드 스토리가 곧 여기에 게시됩니다.",
    "newsPressEyebrow": "PRESS SPOTLIGHT",
    "newsPressPrimaryTitle": "최초의 바이브 코딩 MMORPG는 무료·오픈 소스이며 놀랄 만큼 완성도 높다",
    "newsPressPrimaryBody": "MMORPG.com은 World of ClaudeCraft의 오픈 월드와 함께하는 모험, 빠르게 발전하는 실험을 살펴봅니다.",
    "newsPressRead": "기사 읽기",
    "newsPressLinkAria": "새 탭에서 MMORPG.com 기사 읽기",
    "newsPressPrimaryAlt": "World of ClaudeCraft의 Eastbrook Vale을 탐험하는 모험가들",
    "browserCta": "브라우저에서 플레이",
    "playNowTitle": "Play Now",
    "playNowBody": "브라우저에서 바로 플레이하세요. 다운로드할 필요가 없습니다.",
    "playNowButton": "Play Now",
    "playWayTitle": "Play Your Way",
    "playWayBody": "원하는 플랫폼을 선택하고 모험에 참여하세요.",
    "syncProgress": "모든 플랫폼에서 진행 상황 동기화",
    "googlePlayEyebrow": "GET IT ON",
    "appStoreEyebrow": "DOWNLOAD ON THE",
    "steamEyebrow": "AVAILABLE ON",
    "explore": "세계 탐험",
    "platformsEyebrow": "어디서든 모험을 시작하세요",
    "appStoreAria": "App Store에서 World of ClaudeCraft 다운로드",
    "googlePlayAria": "Google Play에서 World of ClaudeCraft 받기",
    "steamAria": "World of ClaudeCraft Steam 버전 출시 예정",
    "comingSoon": "출시 예정",
    "introEyebrow": "하나의 세계, 하나의 규칙",
    "introHeading": "모든 모험가가 실제 게임을 플레이합니다.",
    "introBody": "브라우저 MMO, 권한형 온라인 월드, AI 훈련은 모두 같은 결정론적 시뮬레이션에서 실행됩니다. 플레이어와 에이전트는 같은 전투, 퀘스트, 던전, 결과를 마주합니다.",
    "statClasses": "플레이 가능한 9개 직업",
    "statModes": "온라인 및 오프라인 월드",
    "statBroadcast": "연중무휴 AI 방송",
    "statSource": "오픈 소스",
    "worldEyebrow": "Claudemoon을 가로지르는 여정",
    "worldHeading": "긴 여정과 위험한 밤을 위해 만들어진 세계.",
    "worldBody": "Eastbrook Vale의 모닥불에서 시작해 유령이 깃든 지하묘지로 내려가고, 폭풍 치는 Thornpeak을 오르세요. 모든 길은 계속 움직이는 세계의 더 깊은 곳으로 이어집니다.",
    "eastbrookTitle": "이스트브룩 골짜기",
    "eastbrookBody": "첫 퀘스트와 떠도는 적, 뜻밖의 동료가 만나는 공동의 변경입니다.",
    "eastbrookAlt": "모험가 일행이 이스트브룩 골짜기에서 쏜피크 고원으로 이어지는 긴 길을 여행하는 모습",
    "hollowTitle": "Hollow Crypt",
    "hollowBody": "차가운 푸른 횃불 아래에서 무리 지어 모이는 언데드와 파티 전투를 벌이세요.",
    "hollowAlt": "Hollow Crypt 안에서 적과 맞서는 파티",
    "thornpeakTitle": "쏜피크 고원",
    "thornpeakBody": "구름 위에서 눈과 고대 유적, 최종 단계의 위협이 기다립니다.",
    "thornpeakAlt": "Thornpeak Heights에 내리는 눈",
    "classesEyebrow": "당신의 전설을 선택하세요",
    "classesHeading": "아홉 개의 길, 끝없는 전투 방식.",
    "classesBody": "방패벽을 지키고, 불과 서리를 다루고, 그림자 속에서 기습하거나 파티를 살려 내세요. 영웅을 키우고 전문화를 숙달해 그 이야기를 공동 세계로 이어 가세요.",
    "streamEyebrow": "연중무휴 생방송",
    "streamNetwork": "WOC 방송 네트워크",
    "streamFeed": "YUUMIII // 라이브 피드",
    "streamMonogram": "Y",
    "streamHeading": "Yuumiii는 절대 로그아웃하지 않습니다.",
    "streamBody": "World of ClaudeCraft의 상주 AI 스트리머가 연중무휴로 이 세계를 플레이하며 생방송합니다.",
    "streamWatch": "Twitch에서 시청",
    "streamWatchSub": "Yuumiii 라이브에 참여",
    "streamExplore": "세계 탐험",
    "streamExploreSub": "클로드문 발견하기",
    "streamHeroSubtitle": "상주 AI 스트리머가 24시간 세계를 모험합니다.",
    "streamMeet": "가이드 소개",
    "streamHostTitle": "상주 AI 스트리머",
    "streamHostBody": "Yuumiii와 함께 밤낮없이 World of ClaudeCraft의 모든 곳을 탐험하세요.",
    "streamPortraitAlt": "World of ClaudeCraft의 상주 AI 스트리머 Yuumiii",
    "streamAlwaysTitle": "24시간 라이브",
    "streamAlwaysBody": "언제나 접속 중. 모험은 멈추지 않습니다.",
    "streamAiTitle": "AI 스트리머",
    "streamAiBody": "AI가 선사하는 생생한 반응과 끝없는 재미.",
    "streamCommunityTitle": "커뮤니티",
    "streamCommunityBody": "채팅과 퀘스트, 놀라움이 기다립니다.",
    "streamWorldTitle": "진짜 세계",
    "streamWorldBody": "하나의 지속적인 세계. 무한한 이야기.",
    "streamLoading": "관측 포털을 여는 중...",
    "streamReady": "관측 포털이 준비되었습니다. 재생을 눌러 Yuumiii를 시청하세요.",
    "streamOnline": "Yuumiii가 지금 생방송 중입니다.",
    "streamOffline": "관측 포털을 다시 연결하고 있습니다. Twitch 채널을 열어 계속 시청하세요.",
    "streamCompact": "Twitch 채널을 열어 이 화면에서 Yuumiii를 시청하세요.",
    "streamUnavailable": "관측 포털을 사용할 수 없습니다. Twitch 채널을 열어 계속 시청하세요.",
    "communityEyebrow": "GATHER AT THE FORGE",
    "communityHeading": "Claudemoon은 함께 만들어집니다.",
    "communityBody": "솜씨든 호기심이든, 그저 함께하고 싶은 마음이든 가져오세요. 길드의 식탁에는 여러분을 위한 자리가 있습니다.",
    "openEyebrow": "열린 세계, 열린 코드",
    "openHeading": "세계를 포크하고 모험가를 훈련하세요.",
    "openBody": "소스를 살펴보고, 나만의 세계를 호스팅하거나, 플레이어가 매일 입장하는 같은 결정론적 게임에 Gymnasium 호환 에이전트를 연결하세요.",
    "supportEyebrow": "세계를 계속 움직이게 하세요",
    "supportHeading": "만들고, 플레이하고, 다음 장을 지원하세요.",
    "supportBody": "World of ClaudeCraft는 열린 협업 속에서 성장합니다. 커뮤니티에 참여하고 살아 있는 세계를 지켜보거나 지속적인 개발을 지원하세요.",
    "xCta": "X에서 팔로우",
    "twitchCategoryCta": "World of ClaudeCraft 방송 둘러보기",
    "finalEyebrow": "당신의 이야기는 관문에서 시작됩니다",
    "finalHeading": "Claudemoon으로 들어갈 방법을 선택하세요.",
    "finalBody": "지금 브라우저에서 플레이하고 모바일에서 이어 가거나 Steam 출시를 기다리세요."
  },
  "a11y": {
    "goHome": "홈으로 이동",
    "toggleMenu": "메뉴 전환",
