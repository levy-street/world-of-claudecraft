...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "pokerPlaytest": {
      ...
      "betweenHands": "핸드 사이",
      "unknownPlayer": "플레이어",
      "waiting": "다음 핸드를 기다리는 중",
      "playerTurn": "{name}님이 행동 중",
      "timeRemaining": "{seconds}초 남음",
      "wagerAmount": "{action} 금액",
      "rake": "레이크: {amount}",
      "error": {
        ...
        "rebuy_not_allowed": "지금은 리바이할 수 없습니다.",
        "seat_conflict": "해당 좌석은 이미 사용 중입니다.",
        "stale_action": "행동이 도착하기 전에 핸드가 변경되었습니다.",
        "table_not_found": "해당 포커 테이블이 존재하지 않습니다.",
        "watch_conflict": "다른 테이블을 관전하기 전에 현재 테이블에서 나가세요."
      },
      "chips": "{amount}칩",
      "pot": "팟: {amount}",
      "noCards": "카드 없음",
