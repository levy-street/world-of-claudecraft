...
export const ko_KR: EnTranslations = {
  ...
  "game": {
    ...
    "talents": {
      ...
      "available": "사용 가능",
      "spent": "사용함",
      "pointSource": "선택 줄은 {first}레벨부터 {cap}레벨까지 해제됩니다. 해제된 각 줄에서 하나를 고르세요.",
      "apply": "변경 적용",
      "clear": "선택 초기화",
      "reset": "초기화",
      "chooseSpec": "전문화 선택",
      ...
      "createBuildHint": "새 빌드는 현재 선택을 별도 빌드로 저장합니다. 가져오기는 공유 문자열을 붙여넣습니다.",
      ...
      "unlockBanner": "특성 해제!",
      "unlockHint": "특성 선택을 사용할 수 있습니다. N을 눌러 특성을 여세요.",
      "copy": "복사",
      "close": "닫기",
      "cancel": "취소",
      "noBuilds": "저장한 빌드 없음",
      ...
      "readout": {
        ...
        "specLocked": " 전문화는 {level}레벨에 해제됩니다.",
  ...
  "guide": {
    ...
    "talentsPage": {
      "heading": "특성과 전문화",
      "intro": "특성은 직업을 내 방식으로 다듬는 수단입니다. 선택 사항이고 부담 없이 바꿀 수 있어 마음껏 실험할 수 있습니다.",
      "whatHeading": "특성이 하는 일",
      "whatBody": "레벨을 올리면 몇 가지 선택지가 있는 특성 줄이 열립니다. 각 선택은 능력, 능력치, 도구에 영구적인 강화를 더해 전투에서 직업의 느낌을 바꿉니다.",
      "howHeading": "작동 방식",
      "howBody": "줄은 레벨에 따라 열리고 전문화는 10레벨에 열립니다. 대표 능력과 숙련을 보고 전문화를 고른 뒤, 선택 탭에서 열린 각 줄마다 하나의 선택지를 고르세요.",
      "shareNote": "완성한 빌드는 짧은 공유 코드로 복사해 친구에게 줄 수 있으며, 친구는 자신의 특성 패널에 붙여넣어 바로 불러올 수 있습니다.",
      "resetTitle": "영구적인 것은 없습니다",
      "resetNote": "전투 중이 아닐 때는 언제든 선택을 초기화할 수 있으므로 초반 선택이 함정이 되지 않습니다. 여러 가지를 시험하고 마음에 드는 것을 찾은 뒤 자유롭게 바꾸세요.",
      "specsHeading": "직업별 전문화",
      "specsBody": "각 직업에는 여러 전문화가 있으며, 각각 고유한 역할과 대표 초점이 있습니다. 여기에서 전체 형태를 확인하세요. 전체 기술 구성을 보려면 직업을 여세요."
    },
    "arenaPage": {
      "heading": "투기장과 PvP",
