...
export const ko_KR: EnTranslations = {
  ...
  "character": {
    ...
    "renameCancel": "취소",
    "respec": "특성 초기화",
    "respecHint": "$WOC를 소각하여 특성을 초기화하거나 추가 로드아웃 슬롯을 잠금 해제합니다.",
    "respecPaidButton": "{amount} $WOC로 특성 초기화",
    "loadoutSlotPaidButton": "{amount} $WOC로 로드아웃 슬롯 잠금 해제",
    "respecCancel": "취소",
    "respecSuccess": "특성이 초기화되었습니다.",
    "loadoutSlotSuccess": "로드아웃 슬롯이 잠금 해제되었습니다.",
    "tabCharacters": "캐릭터",
    "tabCreate": "생성",
