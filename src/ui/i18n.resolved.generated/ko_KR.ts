...
export const ko_KR: EnTranslations = {
  ...
  "editor": {
    "vfx": {
      "title": "효과 스튜디오",
      "artView": "감상 모드",
      "exitArtView": "감상 모드 종료",
      "previous": "이전 능력",
      "next": "다음 능력",
      "repeat": "반복 시전",
      "favourite": "즐겨찾기에 추가",
      "unfavourite": "즐겨찾기에서 제거",
      "favourites": "즐겨찾기만 표시",
      "saved": "저장됨",
      "updating": "미리보기 업데이트 중...",
      "shortcuts": "Space: 시전. [ / ]: 이전 / 다음 능력. R: 반복 시전. F: 즐겨찾기. A: 감상 모드.",
      "buildTools": "특성, 장면 및 조명",
      "noTalent": "선택한 특성 없음",
      "talentLevel": "레벨 {level}",
      "seed": "장면 시드",
      "graphics": "그래픽 품질",
      "environment": "미리보기 환경",
      "studioEnvironment": "스튜디오 무대",
      "worldEnvironment": "세계 풍경",
      "lighting": "무대 조명",
      "neutralLighting": "중립",
      "brightLighting": "밝게",
      "darkLighting": "어둡게",
      "savedGraphics": "게임 설정 사용",
      "low": "낮음",
      "medium": "중간",
      "high": "높음",
      "ultra": "울트라",
      "cinematic": "시네마틱 (최고 디테일)",
      "reduceMotion": "움직임 줄이기",
      "cinematicResponse": "영화 같은 카메라 연출",
      "raid": "공격대 연습 (사망하지 않음)",
      "library": "능력 목록",
      "inspector": "효과 설정",
      "search": "능력 검색",
      ...
      "loading": "게임 세계 준비 중...",
      "ready": "게임 엔진 실행 중",
      "failed": "스튜디오를 시작하지 못했습니다. 새로고침해 주세요.",
      "cast": "능력 시전",
      "target": "대상",
      "pause": "정지 화면",
      "resume": "계속",
      ...
      "import": "초안 가져오기",
      "exportTake": "세션 내보내기",
      "invalid": "초안이 잘못되었거나 지원하지 않는 능력이 포함되어 있습니다.",
      "applied": "초안이 적용되었습니다",
      "noSpec": "이 능력은 별도의 효과 시스템을 사용합니다.",
      "castTime": "시전 시간",
      "cooldown": "재사용 대기시간",
      "seconds": "{value}초",
      "timeline": "전투 타임라인",
      "empty": "능력을 시전하면 기록을 시작합니다.",
      "current": "시간: {value}초",
      "events": "이벤트 {count}개",
      "controls": "카메라 조작",
      "orbitLeft": "왼쪽으로 회전",
      ...
      "show": "패널 표시",
      "status": "활성 효과",
      "help": "화면을 드래그해 회전하고 스크롤해 확대하거나 축소하세요. 정지 화면은 현재 프레임을 유지합니다.",
      "note": "시전에는 일반 전투 규칙이 적용됩니다. 재생은 명령을 반복하며 장식용 무작위 효과는 달라질 수 있습니다.",
      "castFailed": "시전이 거부되었습니다. 대상, 거리, 자원과 재사용 대기시간을 확인하세요.",
      "draftNote": "변경 사항은 현재 세션에만 유지됩니다. 저장하려면 내보내세요.",
      "snapshot": "프레임 캡처"
    },
    "appTitle": "맵 편집기",
