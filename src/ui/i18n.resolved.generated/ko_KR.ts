...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "professions": {
      ...
      "deedsBody": "업적의 서가 모든 걸음에 함께한다. 첫 조율은 Craftsworn을, 첫 걸작은 Masterwright를 주며 둘 다 칭호로 착용할 수 있다. 아홉 제작 기술 중 여덟은 기술 50에 이정표 업적을, 상한 125에 Grandmaster 칭호를 두고(보석세공은 대신 첫 희귀 장신구에 Polished to Brilliance를 새기며, 이정표 페이지는 짝과 함께 기다린다), 낚시는 숙련 100에 Old Salt를, 200에 Master Angler 칭호를 준다.\n\n첫 채집과 첫 제작, 야외의 희귀한 발견, 분해 회수의 조용한 페이지도 있다. 전부 장식일 뿐이다. 칭호와 명성만 있을 뿐, 업적은 결코 힘을 주지 않는다.",
    ...
    "profPages": {
      ...
      "faq": {
        ...
        "a1": "모든 캐릭터가 아홉 가지 수련 가능한 제작 전문직과 네 가지 채집 전문직을 전부 올릴 수 있다. 하나만 골라야 하는 것은 원형 정체성뿐이다.",
        "q2": "제조법은 어디서 배우나요?",
