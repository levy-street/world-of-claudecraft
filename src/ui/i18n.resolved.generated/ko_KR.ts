...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "riftsPage": {
      "heading": "균열",
      "intro": "균열은 걸어서 찾아가는 문이 아니라, 세계 그 자체에 난 찢김입니다. 하나를 지나면 아무도 밟아 본 적 없는 하강로가 펼쳐집니다. 층과 그곳의 주민은 균열마다 달라지지만, 마지막 전투에는 언제나 같은 군주가 기다립니다. 같은 등급이라도 매번 다른 하강로를 지나갈 수 있습니다.",
      "whatHeading": "균열이란",
  ...
  "sim": {
    "rift": {
      "roachKing": {
        ...
        "tributeFeast": "공물의 향연",
        "crown": "바퀴벌레 왕의 왕관",
        "crownWarning": "은둔자가 일어납니다. 바퀴벌레 왕이 왕관을 씁니다!",
        "filthWarning": "오물의 산: 표시된 바닥에서 벗어나세요!",
        "tributeWarning": "공물의 향연: 정신 집중을 차단하거나 공물 딱정벌레를 처치하세요!",
        "ringWarning": "바퀴벌레 왕이 힘을 모읍니다. 원 밖으로 나가세요!",
        "filthDetonate": "오물의 산이 폭발합니다!",
        "swarmDetonate": "왕실 벌레 떼가 터져 나옵니다!",
        "deskSlam": "Desk Slam",
        "mountainOfFilth": "오물의 산",
        "royalSwarm": "왕실 벌레 떼"
      },
