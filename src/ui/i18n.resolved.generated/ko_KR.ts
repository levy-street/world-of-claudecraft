  ...
  "hudChrome": {
    ...
    "raidBossGuide": {
      ...
      "nythraxis": {
        ...
        "phaseThroneName": "왕좌",
        "phaseThroneSummary": "나이트락시스는 충전되는 전방 참격, 방어 담당을 교대시키는 공포의 저주, 플레이어를 꿰뚫는 뼈가시, 바닥을 불태우는 무덤 분출, 그리고 되살아난 왕실 근위병의 파도로 왕좌의 방을 지킵니다.",
        ...
        "graveEruptionHeroicSummary": "{everyHeroic}초마다 해골 손이 플레이어 발밑에 반경 {radius}야드의 원 {countHeroic}개를 표시합니다. {warning}초 후 각 원이 폭발해 최대 생명력의 {burstHeroic}만큼 암흑 피해를 입힌 뒤, 남은 단계 내내 무덤 화염으로 타오르며 그 안에 서 있는 대상에게 매초 최대 생명력의 {tickHeroic}만큼 피해를 입힙니다. 불은 저절로 꺼지지 않으므로, 공격대가 계속 움직이지 않으면 바닥이 온통 불로 뒤덮입니다.",
        ...
        "soulfireName": "영혼불길",
        "soulfireSummary": "영혼 가르기가 터질 때마다 표식이 있던 자리에 반경 {radius}야드의 붉은 불웅덩이가 남아 {seconds}초 동안 타오르며 매초 최대 생명력의 {tickNormal}만큼 피해를 입힙니다. 웅덩이는 수호석 {clearance}야드 이내에는 절대 생기지 않습니다.",
        "soulfireHeroicSummary": "영혼 가르기가 터질 때마다 표식이 있던 자리에 반경 {radius}야드의 붉은 불웅덩이가 남아 남은 단계 내내 타오르며 매초 최대 생명력의 {tickHeroic}만큼 피해를 입힙니다. 웅덩이는 수호석 {clearance}야드 이내에는 절대 생기지 않으며, 저절로 꺼지지도 않습니다.",
        "soulfireResponse": "공격대가 이전 시전의 불길 위에 다시 모이지 않도록 영혼 가르기의 집결 지점을 매 시전마다 바꾸세요.",
        "gravefireName": "무덤불길",
