  ...
  "entities": {
    ...
    "npcs": {
      ...
      "waystone_warden_ilse": {
        "name": "길잡이돌 감시자 일제",
        "title": "와이름 관문의 수호자",
        "greeting": "은화 오십 닢이면 와이름 관문이 하이워치까지 데려다줍니다. 용보다 싸고, 두 다리보다는 비싸죠."
      },
      "provisioner_dunmore": {
        "name": "보급관 던모어",
        "title": "마지막 요새의 종군 상인",
        "greeting": "염소는 구워졌고 물은 차갑고, 트롤들은 이번 주엔 아직 창고를 태우지 않았습니다. 살 수 있을 때 사 두세요."
      },
      "sergeant_varga": {
        "name": "병장 바르가",
        "title": "외성의 감시자",
        "greeting": "이 요새를 지키던 수비대는 돌아오지 못했습니다. 이제 우리가 그들을 대신해 지킵니다. 동쪽 성벽의 틈을 조심하세요."
      },
      "chaplain_ondrey": {
        "name": "군목 온드레이",
        "title": "고요한 전당의 목소리",
        "greeting": "대장장이 아버지가 무엇을 훔쳐 갔든, 마지막 샘은 아직 이 성벽 곁에서 흐릅니다. 잠시 앉았다 가세요. 전당은 고요할 뿐, 비어 있지 않습니다."
      },
      "reeve_ottoline": {
        "name": "촌장 오톨린",
        "title": "랜턴미어의 촌장",
