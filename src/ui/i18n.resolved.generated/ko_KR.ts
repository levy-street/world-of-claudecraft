...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bg": {
      "title": "레이븐리프트",
      "blurb": "가시봉 아래 성벽으로 둘러싸인 분지를 사이에 두고 두 폐허가 된 요새가 마주 본다. 남쪽은 크림슨, 북쪽은 애저, 그 사이의 오래된 폐허 안뜰은 아직 누구도 차지하지 못했다. 5대 5, 깃발은 하나씩. 상대의 깃발을 먼저 다섯 번 가져오는 쪽이 전장을 차지한다.",
      "modeTag": "5v5 깃발 뺏기",
      ...
      "queueNote": "5인 2개 팀. 적의 군기를 빼앗아 아군 요새로 가져오세요. 먼저 5회 탈취한 팀이 승리합니다. 최대 5인 파티로 함께 참가할 수 있습니다. 질주 룬을 줍고 엄폐물 사이로 추격자를 따돌리세요.",
  ...
  "guide": {
    ...
    "ravenriftPage": {
      "heading": "레이븐리프트",
      "intro": "등급전 5v5 깃발 뺏기 전장. 5인 2개 팀, 2개의 요새, 목표는 하나. 적의 군기를 빼앗아 빼앗기기 전에 가져오세요.",
      "queueHeading": "대기열 참가",
      ...
      "flagsHeading": "깃발",
      "flagsBody": "각 요새는 자기 팀의 깃발을 지킵니다. 적 깃발을 빼앗아 아군 깃대까지 가져오면 득점하며, 먼저 5회 탈취한 팀이 승리하고 시간이 다 된 전투는 점수로 판가름납니다. 운반자가 쓰러지면 깃발은 그 자리에 떨어집니다. 적은 다시 주울 수 있지만, 깃발 주인 팀은 가까이 가기만 해도 즉시 되찾아옵니다. 또한 깃발은 결코 숨지 않습니다. 깃발을 주우면 은신이 풀리고, 운반자가 어떤 수단으로든 모습을 감추면 깃발은 그 자리에 떨어집니다.",
