...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "social": {
      ...
      "lootRollBodyNeedBeatsGreed": "물품이 입찰에 부쳐지면, 자격 있는 구성원은 저마다 원하면 입찰을, 남는 것만 받겠다면 가치 입찰을, 빠지겠다면 포기를 고릅니다. 입찰이 가치 입찰에 앞섭니다. 누구든 입찰을 골랐다면 물품은 입찰을 고른 사람 가운데 가장 높은 수를 낸 사람에게 가고 가치 입찰의 수는 셈에 들지 않으며, 입찰을 고른 사람이 없을 때에만 가치 입찰을 고른 사람 가운데 가장 높은 수를 낸 사람이 가져갑니다.",
