...
export const ko_KR: EnTranslations = {
  ...
  "sim": {
    "rift": {
      ...
      "towerWave": "악마의 핵이 울부짖습니다. {total}개 중 {wave}번째 공세.",
      "towerBossWave": "핵이 갈라지며 훨씬 끔찍한 존재가 걸어 나옵니다.",
      "towerFloorClear": "악마의 핵이 깨졌습니다. 위로 가는 길이 열렸습니다.",
      "towerCleared": "악마의 핵이 어두워졌습니다. 탑은 이제 당신의 것입니다.",
