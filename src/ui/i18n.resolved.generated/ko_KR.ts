...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "historyDebit": "-{amount}",
      "tabSupply": "공급량",
      "supplyTitle": "현존하는 클라우디움",
      "supplyLoading": "공급량을 불러오는 중...",
      "supplyError": "공급량을 불러오지 못했습니다. 다시 시도해 주세요.",
      "supplyUnavailable": "현재 공급량 정보를 사용할 수 없습니다.",
      "supplyInExistence": "현존 {amount}",
      "supplyUsdValue": "가치 {amount}",
      "supplyIssued": "총 발행량",
      "supplySunk": "총 사용 및 취소량",
      "supplyHolders": "{n}개 계정이 보유",
      "supplyChangeUp": "이 기간 동안 {amount} 증가",
      "supplyChangeDown": "이 기간 동안 {amount} 감소",
      "supplyChangeFlat": "이 기간 동안 변동 없음",
      "supplyChartLabel": "선택한 기간의 클라우디움 공급량",
      "supplyChartEmpty": "이 기간에는 공급량 변동이 없습니다.",
      "supplyRangeLabel": "차트 기간",
      "supplyRange24h": "24h",
      "supplyRange7d": "7d",
      "supplyRange30d": "30d",
      "supplyFootnote": "모든 계정이 보유한 클라우디움 전체를 원장에서 실시간으로 집계합니다.",
      "inspectButton": "상세",
