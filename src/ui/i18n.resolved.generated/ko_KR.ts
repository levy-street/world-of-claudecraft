...
export const ko_KR: EnTranslations = {
    ...
    "profPages": {
      ...
      "craftProse": {
        ...
        "cooking": {
          ...
          "identityBody": "요리를 먹으면 18초의 휴식 동안 회복한다. 전투 사이에는 가장 싼 치유다. 사다리는 회복 90의 Pan-Seared River Perch에서 Marlow's Grand Roast(980)를 지나 그 위의 세 가지 정점 요리(1392)까지 이어진다. 게임에서 가장 큰 앉은 회복이며, 접시를 다 비우면 잘 먹음 효과를 남기는 유일한 음식이다. 연금술과 가죽세공 사이에 있으며, 살아 있는 짝은 약제사(연금술과 요리)로 Eastbrook 주방의 Cook Marlow 앞에서 멧돼지 네 마리를 사냥해 맹세한다. 가죽세공과 이루는 Trapper는 아직 서약 퀘스트가 없다.",
  ...
  "itemUi": {
    ...
    "tooltip": {
      ...
      "flaskThroughDeath": "이 효과는 죽어도 유지되지만, 접속을 종료하면 사라집니다. 등급전은 아무 효과도 없는 상태에서 시작합니다.",
