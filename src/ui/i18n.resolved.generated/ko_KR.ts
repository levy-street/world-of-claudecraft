...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "toggleHaptics": "진동 전환",
      "customize": "사용자 지정",
      "customizeTitle": "컨트롤 사용자 지정",
      "customizeSlotAttack": "기본 공격",
      "customizeSlotSkill": "스킬 {n}",
      "customizeSlotUtility": "유틸리티",
      "customizeDefault": "직업 기본값",
      "customizeResetSlot": "이 슬롯 초기화",
      "customizeResetAll": "모두 직업 기본값으로 초기화",
      "customizeUpdated": "{slot} 업데이트됨.",
      "customizeAllReset": "조작을 직업 기본값으로 초기화했습니다."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "touchControls": "터치 조작",
      "clusterHold": "편집 홀드 지연",
      "clusterHoldNote": "화면의 액션 버튼을 길게 눌러 바인딩 편집기가 열리기까지의 시간입니다. 스킬을 연타하다가 편집기가 열리면 값을 높이세요.",
      "targetPriority": "공격 대상 우선순위",
      "targetPriorityNearest": "가장 가까운",
      "targetPriorityLowestHp": "체력 최저",
      "targetPriorityCurrent": "현재 대상 우선",
      "targetPriorityNote": "유효한 대상이 없을 때 공격 버튼이 겨냥하는 대상: 가장 가까운 적, 사거리 내 체력이 가장 낮은 적, 또는 유효한 동안 현재 대상을 유지합니다.",
      "aimAssist": "스마트 스킬 시전",
      "aimAssistNote": "공격 스킬을 누르면 대상에게, 대상이 없으면 근처의 가장 적합한 적에게 몸을 돌려 시전합니다. 버튼을 누르고 있으면 스킬 사거리를 미리 보고, 버튼에서 손가락을 뗀 채로 놓으면 취소됩니다.",
      "millisecondsValue": "{value} ms",
      "touchReset": "터치 조작 초기화",
      "touchResetDone": "터치 조작을 기본값으로 복원했습니다.",
      "footstepSounds": "발소리",
      "clickFeedback": "클릭 표시",
