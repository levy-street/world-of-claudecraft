...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocSeason": {
      "menu": "$WOC 시즌",
      "title": "$WOC 보상 시즌",
      "subtitle": "트레저리 자금으로 상위 플레이어에게 지급",
      "close": "닫기",
      "none": "현재 진행 중인 보상 시즌이 없습니다.",
      "noneHint": "아레나 레이크와 바이백이 풀에 자금을 공급하기 시작하면 시즌이 열립니다.",
      "statusActive": "진행 중",
      "statusEnded": "종료됨",
      "endsIn": "Ends in",
      ...
      "invariant": "지급액은 시즌 수입을 초과할 수 없습니다. 매수 > 매도, 온체인에서 강제됩니다.",
      "standingsTitle": "예상 상위 획득자",
      "colRank": "#",
      "colPlayer": "플레이어",
      "colRating": "레이팅",
      "colReward": "보상($WOC)",
      "projectedNote": "현재 풀과 아레나 랭킹 기준 예측이며, 최종 지급은 시즌 종료 시 확정됩니다."
    },
    "mobTooltip": {
