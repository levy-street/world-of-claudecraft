...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "materialHint": {
      ...
      "wyrmfallCore": "명장 제작용 촉매. 공격대와 영웅 던전의 최종 우두머리가 난이도마다 하루 한 번씩 1~3개를 떨어뜨립니다. 그날 첫 A 또는 S 등급 균열 경주에서 승리하면 1~2개를 얻으며, 영웅 병참장교가 영웅의 징표를 받고 판매합니다."
    },
    "discord": {
      "title": "Discord",
    ...
    "perfecting": {
      ...
      "bindWarnDetail": "완전화는 결코 단계를 낮추지 않습니다. 실패한 시도는 재료만 소모합니다. 완전화 진행이 있는 장비는 귀속을 해제할 수 없으며, 승급도 되돌릴 수 없습니다.",
