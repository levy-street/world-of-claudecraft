...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "professions": {
      ...
      "deedsBody": "업적의 서가 모든 걸음에 함께한다. 첫 조율은 Craftsworn을, 첫 걸작은 Masterwright를 주며 둘 다 칭호로 착용할 수 있다. 아홉 제작 기술 모두 기술 50에 이정표 업적을, 상한 125에 Grandmaster 칭호를 두고(보석세공은 여기에 더해 첫 희귀 장신구에 Polished to Brilliance를 새긴다), 낚시는 숙련 100에 Old Salt를, 200에 Master Angler 칭호를 준다.\n\n첫 채집과 첫 제작, 야외의 희귀한 발견, 분해 회수의 조용한 페이지도 있다. 전부 장식일 뿐이다. 칭호와 명성만 있을 뿐, 업적은 결코 힘을 주지 않는다.",
