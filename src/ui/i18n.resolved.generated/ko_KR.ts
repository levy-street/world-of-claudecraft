...
export const ko_KR: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "WOC Wallet, Phantom 또는 Solflare를 선택하세요. 지갑 앱에서 승인을 요청합니다. 게임을 열어 둔 채 완료 후 돌아오세요.",
    "standaloneAppHelp": "홈 화면 앱에서는 아직 지갑 연결을 사용할 수 없습니다. WOC Wallet, Phantom 또는 Solflare를 사용하려면 Safari나 Chrome에서 World of ClaudeCraft를 여세요.",
    ...
    "browser": {
      ...
      "extensionHelp": "호환되는 지갑 확장 프로그램을 찾지 못했습니다. WOC Wallet, Phantom, Solflare 또는 다른 Solana 브라우저 지갑을 설치하거나 잠금 해제한 뒤 다시 시도하세요.",
