...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nftSkins": {
      "title": "Wear an NFT",
      "intro": "PFP NFT 소유를 증명하고 착용하세요. 트레잇이 몸의 외형을 결정하고 그 아트가 초상화가 됩니다. NFT를 보유하는 동안 유지됩니다.",
      "connectEthereum": "Ethereum 지갑 연결",
      "connectSolana": "Solana 지갑 연결",
      "ethereumLinked": "Ethereum 지갑: {address}",
      "solanaLinked": "Solana 지갑: {address}",
      "notLinked": "연결 안 됨",
      "collectionsTitle": "지원 컬렉션",
      "noCollections": "아직 이용 가능한 컬렉션이 없습니다. 곧 다시 확인해 주세요.",
      "tokenIdPlaceholder": "토큰 ID",
      "mintPlaceholder": "민트 주소",
      "claim": "신청",
      "claiming": "신청 중...",
      "claimed": "신청하고 장착했습니다. 스킨 브라우저에서 언제든지 확인할 수 있습니다.",
      "needWallet": "먼저 해당 지갑을 연결하세요.",
      "close": "닫기",
      "errorNotOwner": "해당 지갑은 이 토큰을 소유하고 있지 않습니다.",
      "errorUnverified": "지금은 소유권을 확인할 수 없습니다. 잠시 후 다시 시도하세요.",
      "errorCollection": "지원하지 않는 컬렉션입니다.",
      "errorTooMany": "NFT 스킨 한도에 도달했습니다.",
      "errorMetadata": "지금은 이 NFT를 읽을 수 없습니다. 잠시 후 다시 시도하세요.",
      "errorGeneric": "이 NFT 스킨을 신청할 수 없습니다.",
      "walletError": "지갑 연결에 실패했습니다."
    },
    "mobTooltip": {
  ...
  "marketplace": {
    ...
    "modeUpload": "업로드",
    "modeLink": "자체 호스팅",
    "uploadIntro": "직접 만든 1024x1024 PNG 아틀라스를 업로드하세요. IPFS에 고정해 대신 호스팅해 드립니다.",
    "linkIntro": "직접 호스팅하는 PNG 아틀라스를 연결하세요. 프록시를 거치므로 구매자는 URL을 볼 수 없습니다. 무료입니다.",
    "uploadFile": "Skin PNG (1024x1024)",
    "linkUrl": "아틀라스 URL",
    "quotaMeter": "호스팅 슬롯 {used}/{quota} 사용 중",
    "trustedBadge": "신뢰받는 창작자(즉시 게시)",
    "selfHostedFreeNote": "자체 호스팅은 무료이며 제한이 없습니다(등록 상한 내에서).",
    "hostingUnavailable": "호스팅 업로드를 일시적으로 사용할 수 없습니다.",
    "listedReview": "심사에 제출되었습니다. 운영자가 승인하면 등록됩니다.",
    "baseColor": "기본 색상",
    "patternColor": "패턴 색상",
    "accentColor": "강조 색상",
    "pattern": "패턴",
    ...
    "randomize": "무작위",
    "nameLabel": "Name",
    "namePlaceholder": "예: 에메랄드 용비늘",
    "descLabel": "설명",
    "descPlaceholder": "구매자에게 표시될 짧은 설명",
    "priceLabel": "가격(USDC)",
    "preview": "실시간 미리보기",
    "list": "판매 등록",
    "listing": "등록 중…",
    "listed": "등록되었습니다. 바로 판매가 시작됩니다. 보유 스킨에서 장착하세요.",
    "listFailed": "등록할 수 없습니다",
    "listConnectFirst": "등록하려면 지갑을 연결하세요(수익의 70%를 받습니다).",
    "payoutHint": "창작자 몫 70% • 30%는 $WOC 매입 및 소각",
    "patterns": {
      "solid": "단색",
      "scales": "비늘",
      "stripes": "줄무늬",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "skin_artisan": {
        "name": "스킨 장인 핍",
        "title": "창작자 스킨 게시판",
        "greeting": "새로운 모습이 필요하신가요, {className}? 플레이어가 만든 치장용 스킨을 둘러보거나 직접 디자인해 판매해 보세요. 결제는 USDC로 하며, 일부는 $WOC 매입과 소각에 쓰입니다."
      },
      "marshal_redbrook": {
        "name": "레드브룩 원수",
        "title": "마을 원수",
