...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "finder": {
      ...
      "raidCurrenciesNormal": "참가자당 불멸의 파편 +{fragments}개",
      "raidCurrenciesHeroic": "참가자당 불멸의 파편 +{fragments}개와 영웅의 징표 +{marks}개",
  ...
  "heroicShop": {
    ...
    "buyConfirmCancel": "취소",
    "tabsAria": "병참장교 서비스",
    "fragmentBalance": "불멸의 파편: {count}",
    "tab": {
      "gear": "영웅 난이도 장비",
      "forge": "불멸의 대장간",
      "tune": "전설 조율"
    },
    "gearIntro": "영웅의 징표로 병참장교의 기존 물품을 구매합니다.",
    ...
    "tuneEmpty": "가방에 조율할 수 있는 니스락시스 전설 아이템이 없습니다.",
    "heroicClearReady": "현재 일일 잠금에서 영웅 난이도 니스락시스 처치를 확인했습니다.",
    "heroicClearNeeded": "영웅 난이도 대상에는 현재 일일 잠금에서 니스락시스를 처치한 기록이 필요합니다.",
    "itemLevel": "아이템 레벨 {level}",
    "cost": "불멸의 파편 {fragments}개 · 영웅의 징표 {marks}개",
    "randomAffixes": "무작위 속성과 수치",
    "deterministicStats": "고정 설계 보상",
    "raidForgedGuarantee": "공격대 제련 위력, 상위 절반 수치 보장",
    "raidForged": "공격대 제련",
    "raidDrop": "니스락시스 공격대 전설 아이템",
    "reforgeCount": "조율 횟수: {count}",
    "forgeKind": {
      "normal_procedural": "일반 난이도 절차 생성 영웅 아이템",
      "heroic_procedural": "영웅 난이도 절차 생성 영웅 아이템",
      "signature": "영웅 난이도 고유 전설",
      "authored": "고정 설계 대상 보상"
    },
    "blocked": {
      "class": "현재 직업과 호환되지 않습니다",
      "heroic_clear": "현재 영웅 난이도 니스락시스 처치가 필요합니다",
      "fragments": "불멸의 파편이 부족합니다",
      "marks": "영웅의 징표가 부족합니다"
    },
    "forgeConfirmTitle": "제련 확인",
    "forgeConfirmBody": "{item}을(를) 불멸의 파편 {fragments}개와 영웅의 징표 {marks}개로 제련하시겠습니까? 서버가 비용을 검증한 뒤 아이템을 생성합니다.",
    "forgeConfirmAccept": "제련",
    "tuneConfirmTitle": "전설 조율 확인",
    "tuneConfirmBody": "이 {item} 개체를 불멸의 파편 {fragments}개와 영웅의 징표 {marks}개로 조율하시겠습니까? 두 번 중 더 좋은 결과를 유지하며, 위력은 낮아지지 않지만 그대로일 수 있습니다.",
    "tuneConfirmAccept": "조율",
    "status": {
      "pending": "서버 응답을 기다리는 중입니다……",
      "gear": "구매가 완료되어 잔액을 갱신했습니다.",
      "forge": "제련이 완료되어 새 보상이 가방에 들어갔습니다.",
      "tune": "조율이 완료되어 해당 개체와 잔액을 갱신했습니다."
    }
  },
  "cardDuel": {
    "title": "카드 대결",
