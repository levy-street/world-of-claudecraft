...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "materialHint": {
      ...
      "wyrmfallCore": "명장 제작용 촉매. 공격대 최종 우두머리는 난이도마다 하루 한 번 1~3개를 떨어뜨리고, 영웅 던전 최종 우두머리는 하루 한 번 1~3개를 떨어뜨립니다. 그날 처음으로 A 또는 S 등급 균열 경주에서 승리하면 1~2개를 얻으며, 영웅 병참장교가 영웅의 징표를 받고 판매합니다."
    },
    "discord": {
      "title": "Discord",
