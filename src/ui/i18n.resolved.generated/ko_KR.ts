...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tradingBots": {
      ...
      "close": "트레이딩 봇 닫기",
      "launcher": "봇",
      "launcherAria": "SOL과 $WOC 트레이딩 봇 대여",
      "loading": "트레이딩 봇을 불러오는 중...",
      "custody": "입금액은 트레이딩 서비스가 대신 관리하는 한도 제한 금고에 보관됩니다. 출금은 연결된 지갑으로만 받을 수 있으며 언제든지 출금할 수 있습니다.",
      "riskNote": "자동 매매는 손실이 발생할 수 있습니다. 대여 요금은 환불되지 않습니다. 이는 투자 조언이 아닙니다.",
      "catalogIntro": "봇을 월 단위로 대여하고 SOL과 $WOC 페어로 자금을 넣으면 DEX에서 당신을 대신해 거래합니다.",
      "skuGridName": "그리드 골렘",
      "skuGridBlurb": "시장 가격 위아래에 매수와 매도 주문을 번갈아 배치하여 가격이 오르내리는 동안 스프레드를 법니다.",
      "skuDcaName": "물방울 정령",
      "skuDcaBlurb": "정해진 일정에 따라 SOL을 $WOC로 꾸준히 교환하여 매수 시점을 분산합니다.",
      "skuMomentumName": "모멘텀 위습",
      "skuMomentumBlurb": "추세가 강한 쪽으로 페어를 기울이고 추세가 약해지면 원래 배분으로 되돌립니다.",
      "priceWoc": "월 {amount} $WOC",
      "priceClaudium": "월 {amount} Claudium",
      "rentButton": "대여",
      "payWithLabel": "결제 수단",
      "payWoc": "$WOC",
      "payClaudium": "Claudium",
      "claudiumBalance": "Claudium 잔액: {amount}",
      "approvePayment": "지갑에서 대여 결제를 승인하세요...",
      "confirmingPayment": "네트워크에서 결제를 확인하는 중...",
      "subscribedBody": "봇을 대여했습니다. 금고에 자금을 넣으면 거래를 시작할 수 있습니다.",
      "activeUntil": "{date}까지 유효",
      "fundTitle": "금고에 자금 넣기",
      "solAmountLabel": "입금할 SOL",
      "wocAmountLabel": "입금할 $WOC",
      "depositBounds": "{min}에서 {max} 사이",
      "depositButton": "입금",
      "approveDeposit": "지갑에서 입금을 승인하세요...",
      "confirmingDeposit": "네트워크에서 입금을 확인하는 중...",
      "amountInvalid": "유효한 수량을 입력하세요.",
      "vaultLine": "금고: {sol} SOL, {woc} $WOC",
      "stateRunning": "작동 중",
      "statePaused": "일시 정지됨",
      "startButton": "시작",
      "pauseButton": "일시 정지",
      "paramsTitle": "전략 설정",
      "paramGridSpacingBps": "그리드 간격 ({percent}%)",
      "paramOrderSizeBps": "주문 크기 ({percent}%)",
      "paramDcaIntervalMinutes": "매수 간격 (분)",
      "paramMomentumLookbackMinutes": "추세 조회 기간 (분)",
      "saveParams": "설정 저장",
      "recentTrades": "최근 거래",
      "noTrades": "아직 거래가 없습니다.",
      "tradeBuy": "매수",
      "tradeSell": "매도",
      "pnlLine": "손익 ({days}일): {amount} $WOC ({percent}%)",
      "withdrawButton": "전액 출금",
      "withdrawTitle": "금고에서 출금",
      "withdrawBody": "출금하면 봇이 정지되고 금고 잔액이 연결된 지갑으로 반환됩니다.",
      "approveWithdraw": "지갑에서 출금을 승인하세요...",
      "withdrawPending": "출금이 진행 중입니다. 네트워크가 확인하면 잔액이 갱신됩니다.",
      "cooldown": "요청이 너무 많습니다. {seconds}초 후에 다시 시도할 수 있습니다.",
      "errWalletFeature": "연결된 지갑은 게임에서 트랜잭션을 보낼 수 없습니다. 다른 Solana 지갑을 사용해 보세요.",
      "errSignFailed": "트랜잭션이 전송되지 않았습니다. 지갑에서 거절되었을 수 있습니다.",
      "errNoWallet": "먼저 Solana 지갑을 연결하세요."
  ...
  "apiError": {
    ...
    "trading_bots": {
      "disabled": "현재 트레이딩 봇을 이용할 수 없습니다.",
      "unknown_sku": "해당 봇은 카탈로그에 없습니다.",
      "invalid_pay_currency": "지원하지 않는 결제 통화입니다.",
      "already_subscribed": "이미 트레이딩 봇을 대여 중입니다.",
      "subscription_required": "먼저 트레이딩 봇을 대여하세요.",
      "subscription_expired": "봇 대여 기간이 만료되었습니다. 갱신하거나 자금을 출금하세요.",
      "insufficient_claudium": "Claudium이 부족합니다.",
      "invalid_amount": "유효한 수량을 입력하세요.",
      "deposit_out_of_bounds": "해당 입금액은 이 봇의 허용 범위를 벗어납니다.",
      "invalid_public_key": "먼저 Solana 지갑을 연결하세요.",
      "invalid_params": "허용되지 않는 봇 설정입니다.",
      "payment_not_found": "해당 결제를 찾을 수 없습니다. 처음부터 다시 시작하세요.",
      "payment_unverified": "해당 결제를 아직 확인하지 못했습니다. 잠시 후 다시 시도하세요.",
      "vault_busy": "봇 금고가 사용 중입니다. 잠시 후 다시 시도하세요.",
      "rate_limited": "요청이 너무 많습니다. 잠시 후 다시 시도해 주세요.",
      "upstream_error": "트레이딩 봇 서비스를 이용할 수 없습니다. 나중에 다시 시도하세요."
    }
  },
  "guide": {
