...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "trade": {
      ...
      "woc": {
        ...
        "ineligibleReasonAccountBound": "계정 귀속 아이템, 퀘스트 아이템, 잠긴 아이템, 그리고 거래소 범주 밖의 아이템은 $WOC로 판매할 수 없습니다.",
    ...
    "mailbox": {
      ...
      "clickAttachAccountBound": "클릭하면 편지에 첨부됩니다. 계정 귀속: 당신 자신의 캐릭터만 받을 수 있습니다.",
      ...
      "result": {
        ...
        "noMailAccountBound": "계정 귀속 아이템은 당신 자신의 캐릭터에게만 우편으로 보낼 수 있습니다.",
  ...
  "guide": {
    ...
    "glossary": {
      ...
      "accountBoundTerm": "계정 귀속",
      "accountBoundDef": "얻는 순간부터 당신의 계정에 묶이는 아이템입니다. 거래하거나 상인에게 팔거나 시장에 올릴 수 없으며, 편지로는 당신 자신의 다른 캐릭터에게만 보낼 수 있습니다.",
    ...
    "arenaPage": {
      ...
      "honorFinalNoteAccountBound": "명예로 산 물건은 되돌릴 수 없습니다. 동전으로 산 물건은 상인의 되사기 목록에서 되찾을 수 있지만, 명예로 산 물건은 그 목록에 결코 오르지 않습니다. 게다가 워페어 장비는 구매하는 순간 계정 귀속되어 거래도 되팔기도 영영 할 수 없고, 오직 당신 자신의 다른 캐릭터에게 부칠 수만 있습니다. 상점이 굳이 한 번 더 확인을 묻는 이유가 그것이니, 누르기 전에 장비를 찬찬히 읽어 보세요.",
    ...
    "social": {
      ...
      "guildBankRulesBodyAccountBound": "물품 창고는 처음에 닫혀 있습니다. 장교가 자기 주머니를 털어 열고, 이후에는 금고에서 비용을 치러 넓힐 수 있습니다. 퀘스트 물품과 계정 귀속된 물건, 시장이 받지 않는 장비는 시장과 마찬가지로 들어가지 못하므로, 길드 은행은 아직 플레이어 사이에서 주인이 바뀔 수 있는 물건을 위한 곳입니다.",
