...
export const cs_CZ: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Zvol WOC Wallet, Phantom nebo Solflare. Tvoje aplikace peněženky požádá o schválení. Nechej tuto hru otevřenou a po dokončení se do ní vrať.",
    "standaloneAppHelp": "Připojení peněženky není zatím v aplikaci z domovské obrazovky dostupné. Otevři World of ClaudeCraft v Safari nebo Chrome pro použití WOC Wallet, Phantom nebo Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "Nebyla nalezena žádná kompatibilní rozšíření peněženky. Nainstaluj nebo odemkni WOC Wallet, Phantom, Solflare nebo jiný Solana prohlížečový wallet a zkus to znovu.",
