...
export const id_ID: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Pilih WOC Wallet, Phantom, atau Solflare. Aplikasi dompetmu akan meminta persetujuan. Jaga permainan ini tetap terbuka dan kembali ke sana saat selesai.",
    "standaloneAppHelp": "Koneksi dompet belum tersedia di aplikasi Layar Utama. Buka World of ClaudeCraft di Safari atau Chrome untuk menggunakan WOC Wallet, Phantom, atau Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "Tidak ada ekstensi dompet yang kompatibel ditemukan. Instal atau buka WOC Wallet, Phantom, Solflare, atau dompet browser Solana lainnya, lalu coba lagi.",
