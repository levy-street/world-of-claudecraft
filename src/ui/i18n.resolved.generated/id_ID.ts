...
export const id_ID: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "noLoot": "Belum ada jarahan tercatat.",
      "recentAwards": "{count} hadiah terbaru",
      "target": "Sasaran: {name}",
      "noTargetEngaged": "Tidak ada sasaran yang dihadapi.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Lewat",
      "methodMaster": "Master",
      "methodPersonal": "Pribadi",
      "methodDelve": "Delve",
      "methodLooted": "Dijarah",
      "noWinner": "Tidak ada pemenang",
      "rollDetail": "Lemparan {roll}",
