...
export const id_ID: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "Sesuaikan",
      "customizeTitle": "Sesuaikan Kontrol",
      "customizeSlotAttack": "Serangan Dasar",
      "customizeSlotSkill": "Skill {n}",
      "customizeSlotUtility": "Utilitas",
      "customizeDefault": "Bawaan kelas",
      "customizeResetSlot": "Atur ulang slot ini",
      "customizeResetAll": "Atur ulang semua ke bawaan kelas",
      "customizeUpdated": "{slot} diperbarui.",
      "customizeAllReset": "Kontrol diatur ulang ke bawaan kelas."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Tunda Tahan untuk Edit",
      "clusterHoldNote": "Berapa lama menahan tombol aksi di layar sebelum editor pengikatannya terbuka. Naikkan jika editor terpicu saat kamu menekan skill bertubi-tubi.",
      "targetPriority": "Prioritas Target Serangan",
      "targetPriorityNearest": "Terdekat",
      "targetPriorityLowestHp": "Nyawa Terendah",
      "targetPriorityCurrent": "Saat Ini Dulu",
      "targetPriorityNote": "Apa yang menjadi sasaran tombol Serang saat kamu tidak punya target valid: musuh terdekat, musuh dengan nyawa terendah dalam jangkauan, atau pertahankan target saat ini selama masih valid.",
      "aimAssist": "Cast Skill Cerdas",
      "aimAssistNote": "Tekan skill ofensif untuk merapalnya ke targetmu, atau musuh terdekat terbaik jika kamu tidak punya, sambil menghadap ke arahnya. Tahan tombol untuk melihat jangkauan skill; lepaskan dengan jari di luar tombol untuk membatalkan.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Atur ulang Kontrol Sentuh",
      "touchResetDone": "Kontrol sentuh dikembalikan ke bawaan.",
