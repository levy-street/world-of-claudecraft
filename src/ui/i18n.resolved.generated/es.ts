...
export const es: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "statInfo": {
      ...
      "desc": {
        ...
        "haste": "Acelera tus golpes de arma y tus lanzamientos de hechizos. No reduce el tiempo de reutilización global.",
    ...
    "auraEffect": {
      ...
      "dieBySword": "Reduce el daño recibido un {pct}% (un {lowPct}% por debajo del {hpPct}% de salud)",
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "revenge": "Un contraataque amplio que golpea todo lo que tienes delante, y sale más barato justo después de desviar un golpe.",
      ...
      "hamstring": "Corta las piernas del objetivo para ralentizarlo y que no pueda darte caza.",
  ...
  "classDetails": {
    ...
    "lore": {
      ...
      "warriorClassic": "El guerrero exactamente como se jugaba antes de la renovación del combate: el conjunto de habilidades y el ritmo de ira originales, conservados junto al nuevo guerrero para que pruebes los dos y nos digas cuál se siente mejor.",
  ...
  "hud": {
    ...
    "errors": {
      ...
      "needShield": "Debes llevar un escudo equipado.",
  ...
  "entities": {
    "abilities": {
      ...
      "revenge": {
        "name": "Venganza",
        "description": "Atacas en un arco amplio e infliges daño Físico a todos los enemigos frente a ti. Por encima de 5 objetivos el daño se reduce. Cuando esquivas o paras un golpe, tu siguiente Venganza puede no costar ira."
      },
      "battle_shout": {
        "name": "Bramido de Hierro",
        "description": "Aumenta tu poder de ataque en {buff} durante 2 min."
      ...
      "raging_gale": {
        "name": "Golpe Gemelo",
        "description": "Golpeas al instante dos veces con tu arma; cada golpe inflige un 40% de daño de arma más {damage}, y generas {rage} de ira. Almacena hasta 2 cargas. (Furia)"
      },
      "red_harvest": {
        "name": "Cosecha Roja",
        "description": "Gástalo todo: golpeas tres veces en un frenesí por un 65% de daño de arma más {damage} cada uno, y siempre te Enfurece. (Furia)"
      },
      "furious_mending": {
      ...
      "iron_resolve": {
        ...
        "description": "Aprietas los dientes e ignoras el dolor: consume toda tu ira (20 como mínimo) para absorber 4 de daño por punto de ira gastado, hasta 10 s. (Protección)"
      },
      "faultline": {
        "name": "Falla",
      ...
      "aura_surge": {
        ...
        "description": "Lanza un escudo forjado al alba que inflige {damage} de daño Sagrado, silencia al objetivo principal durante 2 s y rebota hasta en {jumps} enemigos adicionales en un radio de {radius} m, infligiendo {falloff} de daño por rebote. (talento de Paladín)"
      },
      "holy_shield": {
        "name": "Escudo Sagrado",
      ...
      "shamanistic_rage": {
        "name": "Ira Chamánica",
        "description": "Libera la ira chamánica y restaura 160 de maná. (habilidad distintiva de Mejora)"
      },
      "natures_swiftness": {
        "name": "Celeridad de la Naturaleza",
      ...
      "fel_domination": {
        "name": "Dominación Vil",
        "description": "Domina las energías viles, haciendo que tu siguiente hechizo sea instantáneo. (habilidad distintiva de Demonología)"
      },
      "conflagrate": {
        "name": "Conflagrar",
