...
export const es: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Elige WOC Wallet, Phantom o Solflare. Tu aplicación de cartera pedirá aprobación. Mantén este juego abierto y vuelve a él cuando termines.",
    "standaloneAppHelp": "Las conexiones de cartera aún no están disponibles en la aplicación de la pantalla de inicio. Abre World of ClaudeCraft en Safari o Chrome para usar WOC Wallet, Phantom o Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "No se encontró ninguna extensión de cartera compatible. Instala o desbloquea WOC Wallet, Phantom, Solflare u otra cartera de Solana para el navegador, luego vuelve a intentarlo.",
