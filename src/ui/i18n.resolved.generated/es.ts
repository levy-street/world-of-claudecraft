...
export const es: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customizeTitle": "Personalizar controles",
      "customizeSlotAttack": "Ataque básico",
      "customizeSlotSkill": "Habilidad {n}",
      "customizeSlotUtility": "Utilidad",
      "customizeDefault": "Predeterminado de clase",
      "customizeResetSlot": "Restablecer esta ranura",
      "customizeResetAll": "Restablecer todos los valores de clase",
      "customizeUpdated": "{slot} actualizado.",
      "customizeAllReset": "Controles restablecidos a los valores de clase."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Retardo de pulsación para editar",
      "clusterHoldNote": "Cuánto tiempo mantener pulsado un botón de acción en pantalla antes de que se abra su editor de asignación. Auméntalo si activas el editor mientras usas habilidades rápidamente.",
      "targetPriority": "Prioridad de objetivo de ataque",
      "targetPriorityNearest": "Más cercano",
      "targetPriorityLowestHp": "Menos vida",
      "targetPriorityCurrent": "Actual primero",
      "targetPriorityNote": "A qué apunta el botón de Ataque cuando no tienes un objetivo válido: al enemigo más cercano, al enemigo con menos vida a tu alcance, o mantén tu objetivo actual mientras siga siendo válido.",
      "aimAssist": "Lanzamiento inteligente",
      "aimAssistNote": "Pulsa una habilidad ofensiva para lanzarla sobre tu objetivo, o sobre el mejor enemigo cercano si no tienes ninguno, girándote hacia él. Mantén pulsado el botón para ver el alcance de la habilidad; suelta con el dedo fuera del botón para cancelar.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Restablecer controles táctiles",
      "touchResetDone": "Controles táctiles restaurados a los valores predeterminados.",
