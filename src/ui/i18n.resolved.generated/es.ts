...
export const es: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "lootHistory": "Historial",
      "title": "{tab} - {view}",
      "noCombat": "Aún no hay combate registrado.",
      "noLoot": "Sin botín registrado.",
      "recentAwards": "{count} premios recientes",
      "target": "Objetivo: {name}",
      "noTargetEngaged": "No hay objetivo enfrentado.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Pasado",
      "methodMaster": "Maestro",
      "methodPersonal": "Personal",
      "methodDelve": "Excavación",
      "methodLooted": "Saqueado",
      "noWinner": "Sin ganador",
      "rollDetail": "Tirada {roll}",
