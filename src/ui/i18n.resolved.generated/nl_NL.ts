...
export const nl_NL: EnTranslations = {
  ...
  "hud": {
    ...
    "meters": {
      ...
      "lootHistory": "Geschiedenis",
      "title": "{tab} - {view}",
      "noCombat": "Nog geen gevecht geregistreerd.",
      "noLoot": "Nog geen buit geregistreerd.",
      "recentAwards": "{count} recente toewijzingen",
      "target": "Doelwit: {name}",
      "noTargetEngaged": "Geen doelwit in gevecht.",
      "segmentSummary": "{label} - {duration}",
      "methodReturned": "Gepast",
      "methodMaster": "Meester",
      "methodPersonal": "Persoonlijk",
      "methodDelve": "Delve",
      "methodLooted": "Geplunderd",
      "noWinner": "Geen winnaar",
      "rollDetail": "Worp {roll}",
