...
export const nl_NL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "Aanpassen",
      "customizeTitle": "Bediening aanpassen",
      "customizeSlotAttack": "Basisaanval",
      "customizeSlotSkill": "Vaardigheid {n}",
      "customizeSlotUtility": "Ondersteuning",
      "customizeDefault": "Klassestandaard",
      "customizeResetSlot": "Dit vak resetten",
      "customizeResetAll": "Alles terugzetten naar klassestandaard",
      "customizeUpdated": "{slot} bijgewerkt.",
      "customizeAllReset": "Bediening teruggezet naar klassestandaard."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Vasthoudvertraging bewerken",
      "clusterHoldNote": "Hoe lang je een actieknop op het scherm moet vasthouden voordat de bindingseditor opent. Verhoog dit als de editor opent terwijl je snel vaardigheden gebruikt.",
      "targetPriority": "Prioriteit aanvalsdoel",
      "targetPriorityNearest": "Dichtstbijzijnd",
      "targetPriorityLowestHp": "Laagste leven",
      "targetPriorityCurrent": "Huidige eerst",
      "targetPriorityNote": "Waar de Aanval-knop op richt als je geen geldig doel hebt: de dichtstbijzijnde vijand, de vijand met het laagste leven binnen bereik, of behoud je huidige doel zolang het geldig blijft.",
      "aimAssist": "Slimme skillcast",
      "aimAssistNote": "Druk op een offensieve vaardigheid om deze op je doel te gebruiken, of op de beste vijand in de buurt als je er geen hebt, terwijl je je ernaartoe draait. Houd de knop vast om het bereik te bekijken; laat los met je vinger van de knop af om te annuleren.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Aanraakbediening resetten",
      "touchResetDone": "Aanraakbediening teruggezet naar standaard.",
