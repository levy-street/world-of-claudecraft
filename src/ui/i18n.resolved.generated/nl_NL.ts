...
export const nl_NL: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Kies WOC Wallet, Phantom of Solflare. Je portemonnee-app vraagt om goedkeuring. Houd dit spel open en keer ernaar terug wanneer je klaar bent.",
    "standaloneAppHelp": "Portemonneeverbindingen zijn nog niet beschikbaar in de beginscherm-app. Open World of ClaudeCraft in Safari of Chrome om WOC Wallet, Phantom of Solflare te gebruiken.",
    ...
    "browser": {
      ...
      "extensionHelp": "Geen compatibele portemonnee-extensie gevonden. Installeer of ontgrendel WOC Wallet, Phantom, Solflare of een andere Solana-browserportemonnee en probeer het opnieuw.",
