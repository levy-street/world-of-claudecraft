...
export const sv_SE: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mobile": {
      ...
      "customize": "Anpassa",
      "customizeTitle": "Anpassa kontroller",
      "customizeSlotAttack": "Grundattack",
      "customizeSlotSkill": "Förmåga {n}",
      "customizeSlotUtility": "Stöd",
      "customizeDefault": "Klassens standard",
      "customizeResetSlot": "Återställ denna plats",
      "customizeResetAll": "Återställ allt till klassens standard",
      "customizeUpdated": "{slot} uppdaterad.",
      "customizeAllReset": "Kontrollerna återställdes till klassens standard."
    },
    "tutorial": {
    ...
    "options": {
      ...
      "clusterHold": "Hålltid för redigering",
      "clusterHoldNote": "Hur länge du håller en åtgärdsknapp på skärmen innan dess bindningsredigerare öppnas. Höj den om redigeraren öppnas när du spammar förmågor.",
      "targetPriority": "Prioritet för attackmål",
      "targetPriorityNearest": "Närmaste",
      "targetPriorityLowestHp": "Lägst hälsa",
      "targetPriorityCurrent": "Nuvarande först",
      "targetPriorityNote": "Vad Attack-knappen siktar på när du saknar ett giltigt mål: närmaste fiende, fienden med lägst hälsa inom räckhåll, eller behåll ditt nuvarande mål så länge det är giltigt.",
      "aimAssist": "Smart förmågekast",
      "aimAssistNote": "Tryck på en offensiv förmåga för att använda den på ditt mål, eller på den bästa fienden i närheten om du saknar mål, och vänd dig mot den. Håll knappen för att förhandsvisa räckvidden; släpp med fingret utanför knappen för att avbryta.",
      "millisecondsValue": "{value} ms",
      "touchReset": "Återställ pekkontroller",
      "touchResetDone": "Pekkontrollerna återställdes till standard.",
