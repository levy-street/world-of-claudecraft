...
export const sv_SE: EnTranslations = {
  ...
  "wallet": {
    ...
    "mobileAppHelp": "Välj WOC Wallet, Phantom eller Solflare. Din plånboksapp ber om godkännande. Håll det här spelet öppet och återgå till det när du är klar.",
    "standaloneAppHelp": "Plånboksanslutningar är ännu inte tillgängliga i hemskärmsappen. Öppna World of ClaudeCraft i Safari eller Chrome för att använda WOC Wallet, Phantom eller Solflare.",
    ...
    "browser": {
      ...
      "extensionHelp": "Inget kompatibelt plånbokstillägg hittades. Installera eller lås upp WOC Wallet, Phantom, Solflare eller en annan Solana-webbläsarplånbok och försök sedan igen.",
