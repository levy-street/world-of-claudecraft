...
const RIDING_RELEASE_FILL: Partial<
  Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>>
> = {
  es: {
    'error.ridingUntrained':
      'Primero debes aprender a montar. Encuentra un entrenador de equitación.',
    'error.mountBuyLevel': 'Debes tener nivel 20 para comprar una montura.',
    'error.mountAlreadyOwned': 'Ya eres dueño de esa montura.',
    'error.ridingQuestUntrained': 'Debes aprender a montar antes de tomar esta lección.',
    'error.ridingAlreadyLearned': 'Ya has aprendido a montar.',
    'error.ridingTrainLevel': 'Debes tener nivel 20 para aprender a montar.',
    'error.ridingWrongNpc': 'Debes hablar con Marla Hitchen para aprender a montar.',
    'error.mountTrainLevel': 'Debes tener el nivel 20 para recibir lecciones de equitación.',
    'error.mountTrainDismountFirst': 'Desmontar primero.',
    'error.mountTrainNeedsQuest': 'Primero debes aceptar la misión de la lección de equitación.',
    'error.mountTrainInProgress': 'Ya se está realizando una lección de equitación.',
  },
  es_ES: {
    'error.ridingUntrained':
      'Primero debes aprender a montar. Encuentra un entrenador de equitación.',
  ...
  fr_FR: {
    'error.ridingUntrained':
      "Vous devez d'abord apprendre à rouler. Trouvez un entraîneur d'équitation.",
    'error.mountBuyLevel': 'Vous devez être niveau 20 pour acheter une monture.',
    'error.mountAlreadyOwned': 'Vous possédez déjà cette monture.',
    'error.ridingQuestUntrained': "Vous devez apprendre l'équitation avant de suivre cette leçon.",
    ...
    'error.mountTrainLevel': "Vous devez être niveau 20 pour prendre des cours d'équitation.",
    'error.mountTrainDismountFirst': 'Démontez d’abord.',
    'error.mountTrainNeedsQuest': 'Vous devez d’abord accepter la quête de la leçon d’équitation.',
    'error.mountTrainInProgress': "Un cours d'équitation est déjà en cours.",
  },
  fr_CA: {
    'error.ridingUntrained':
      "Vous devez d'abord apprendre à rouler. Trouvez un entraîneur d'équitation.",
  ...
  it_IT: {
    'error.ridingUntrained': 'Prima devi imparare a cavalcare. Trova un allenatore di equitazione.',
    'error.mountBuyLevel': 'Devi essere al livello 20 per acquistare una cavalcatura.',
    'error.mountAlreadyOwned': 'Possiedi già quella cavalcatura.',
    'error.ridingQuestUntrained': 'Devi imparare a cavalcare prima di prendere questa lezione.',
    'error.ridingAlreadyLearned': 'Hai già imparato a cavalcare.',
    'error.ridingTrainLevel': 'Devi essere al livello 20 per imparare a cavalcare.',
    'error.ridingWrongNpc': 'Devi parlare con Marla Hitchen per imparare a cavalcare.',
    'error.mountTrainLevel': 'Devi essere al livello 20 per prendere lezioni di equitazione.',
    'error.mountTrainDismountFirst': 'Smontare prima.',
    'error.mountTrainNeedsQuest': 'Devi prima accettare la missione della lezione di equitazione.',
    'error.mountTrainInProgress': 'È già in corso una lezione di equitazione.',
  },
  de_DE: {
    'error.ridingUntrained': 'Zuerst muss man reiten lernen. Finden Sie einen Reittrainer.',
    'error.mountBuyLevel': 'Um ein Reittier zu kaufen, musst du Level 20 erreicht haben.',
    'error.mountAlreadyOwned': 'Du besitzt dieses Reittier bereits.',
    'error.ridingQuestUntrained':
      'Sie müssen Reiten lernen, bevor Sie diese Lektion belegen können.',
    'error.ridingAlreadyLearned': 'Du hast bereits Reiten gelernt.',
    'error.ridingTrainLevel': 'Um Reiten zu lernen, müssen Sie Level 20 erreicht haben.',
    'error.ridingWrongNpc': 'Sie müssen mit Marla Hitchen sprechen, um Reiten zu lernen.',
    'error.mountTrainLevel':
      'Um Reitunterricht nehmen zu können, müssen Sie Stufe 20 erreicht haben.',
    'error.mountTrainDismountFirst': 'Zuerst absteigen.',
    'error.mountTrainNeedsQuest': 'Zuerst müssen Sie die Quest „Reitunterricht“ annehmen.',
    'error.mountTrainInProgress': 'Eine Reitstunde ist bereits im Gange.',
  },
  zh_CN: {
    'error.ridingUntrained': '你必须先学会骑车。找一个骑行教练。',
    'error.mountBuyLevel': '您必须达到 20 级才能购买坐骑。',
    'error.mountAlreadyOwned': '你已经拥有那只坐骑了。',
    'error.ridingQuestUntrained': '在参加本课程之前，您必须先学习骑术。',
    'error.ridingAlreadyLearned': '你已经学会了骑马。',
    'error.ridingTrainLevel': '你必须达到20级才能学习骑术。',
    'error.ridingWrongNpc': '您必须与玛拉·希钦交谈才能学习马术。',
    'error.mountTrainLevel': '您必须达到 20 级才能参加骑术课程。',
    'error.mountTrainDismountFirst': '先下马。',
    'error.mountTrainNeedsQuest': '您需要先接受骑马课程任务。',
    'error.mountTrainInProgress': '骑马课程已经在进行中。',
  },
  zh_TW: {
    'error.ridingUntrained': '你必須先學會騎車。找一個騎行教練。',
    'error.mountBuyLevel': '您必須達到 20 級才能購買坐騎。',
    'error.mountAlreadyOwned': '你已經擁有那隻坐騎了。',
    'error.ridingQuestUntrained': '在參加本課程之前，您必須先學習騎術。',
    'error.ridingAlreadyLearned': '你已經學會騎馬了。',
    'error.ridingTrainLevel': '你必須達到20級才能學習騎術。',
    'error.ridingWrongNpc': '您必須與瑪拉·希欽交談才能學習馬術。',
    'error.mountTrainLevel': '您必須達到 20 級才能參加騎術課程。',
    'error.mountTrainDismountFirst': '先下馬。',
    'error.mountTrainNeedsQuest': '您需要先接受騎馬課程任務。',
    'error.mountTrainInProgress': '騎馬課程已經在進行中。',
  },
  ko_KR: {
    'error.ridingUntrained': '먼저 타는 법을 배워야 합니다. 승마 트레이너를 찾아보세요.',
    'error.mountBuyLevel': '탈것을 구입하려면 레벨 20이 되어야 합니다.',
    'error.mountAlreadyOwned': '당신은 이미 그 탈것을 소유하고 있습니다.',
    'error.ridingQuestUntrained': '이 수업을 듣기 전에 반드시 승마를 배워야 합니다.',
    'error.ridingAlreadyLearned': '당신은 이미 승마를 배웠습니다.',
    'error.ridingTrainLevel': '승마를 배우려면 레벨 20이 되어야 합니다.',
    'error.ridingWrongNpc': '승마를 배우려면 말라 히친과 대화해야 합니다.',
    'error.mountTrainLevel': '승마 강습을 받으려면 레벨 20이 되어야 합니다.',
    'error.mountTrainDismountFirst': '먼저 내리십시오.',
    'error.mountTrainNeedsQuest': '먼저 승마 강습 퀘스트를 수락해야 합니다.',
    'error.mountTrainInProgress': '이미 승마 강습이 진행 중입니다.',
  },
  ja_JP: {
    'error.ridingUntrained':
      'まず乗り方を学ばなければなりません。乗馬トレーナーを見つけてください。',
    'error.mountBuyLevel': 'マウントを購入するにはレベル 20 である必要があります。',
    'error.mountAlreadyOwned': 'あなたはすでにそのマウントを所有しています。',
    'error.ridingQuestUntrained': 'このレッスンを受ける前に、乗馬を学ぶ必要があります。',
    'error.ridingAlreadyLearned': 'あなたはすでに乗馬を学びました。',
    'error.ridingTrainLevel': '乗馬を学ぶにはレベル 20 である必要があります。',
    'error.ridingWrongNpc': '乗馬を学ぶにはマーラ・ヒッチェンと話す必要があります。',
    'error.mountTrainLevel': '乗馬レッスンを受けるにはレベル 20 である必要があります。',
    'error.mountTrainDismountFirst': 'まず降ります。',
    'error.mountTrainNeedsQuest': 'まずは乗馬レッスンクエストを受注する必要があります。',
    'error.mountTrainInProgress': '乗馬レッスンはすでに行われています。',
  },
  pt_BR: {
    'error.ridingUntrained':
      'Você deve aprender a andar primeiro. Encontre um treinador de equitação.',
    'error.mountBuyLevel': 'Você deve estar no nível 20 para comprar uma montaria.',
    'error.mountAlreadyOwned': 'Você já possui essa montaria.',
    'error.ridingQuestUntrained': 'Você deve aprender a equitação antes de fazer esta lição.',
    'error.ridingAlreadyLearned': 'Você já aprendeu equitação.',
    'error.ridingTrainLevel': 'Você deve estar no nível 20 para aprender a equitação.',
    'error.ridingWrongNpc': 'Você deve falar com Marla Hitchen para aprender equitação.',
    'error.mountTrainLevel': 'Você deve estar no nível 20 para ter aulas de equitação.',
    'error.mountTrainDismountFirst': 'Desmonte primeiro.',
    'error.mountTrainNeedsQuest': 'Você precisa primeiro aceitar a missão da aula de equitação.',
    'error.mountTrainInProgress': 'Uma aula de equitação já está em andamento.',
  },
  ru_RU: {
    'error.ridingUntrained':
      'Сначала тебе нужно научиться кататься. Найдите тренера по верховой езде.',
    'error.mountBuyLevel': 'Чтобы купить маунта, вы должны быть 20-го уровня.',
    'error.mountAlreadyOwned': 'У вас уже есть это животное.',
    'error.ridingQuestUntrained': 'Прежде чем пройти этот урок, вы должны научиться верховой езде.',
    'error.ridingAlreadyLearned': 'Вы уже научились верховой езде.',
    'error.ridingTrainLevel': 'Чтобы научиться верховой езде, вам необходимо достичь 20-го уровня.',
    'error.ridingWrongNpc': 'Вы должны поговорить с Марлой Хитчен, чтобы научиться верховой езде.',
    'error.mountTrainLevel':
      'Чтобы брать уроки верховой езды, вам необходимо достичь 20-го уровня.',
    'error.mountTrainDismountFirst': 'Сначала спешитесь.',
    'error.mountTrainNeedsQuest': 'Сначала вам нужно принять квест на урок верховой езды.',
    'error.mountTrainInProgress': 'Урок верховой езды уже идет.',
  },
  cs_CZ: {
    'error.ridingUntrained': 'Nejprve se musíte naučit jezdit. Najděte si trenéra jízdy na koni.',
    'error.mountBuyLevel': 'Abyste si mohli koupit mounta, musíte být na úrovni 20.',
    'error.mountAlreadyOwned': 'Ten držák už vlastníte.',
    'error.ridingQuestUntrained': 'Než absolvujete tuto lekci, musíte se naučit jízdu na koni.',
    'error.ridingAlreadyLearned': 'Už jste se naučili jezdit na koni.',
    'error.ridingTrainLevel': 'Abyste se naučili jezdit na koni, musíte mít úroveň 20.',
    'error.ridingWrongNpc': 'Musíte mluvit s Marlou Hitchenovou, abyste se naučili jezdit.',
    'error.mountTrainLevel':
      'Abyste mohli absolvovat lekce jízdy na koni, musíte být na úrovni 20.',
    'error.mountTrainDismountFirst': 'Nejprve sesedněte.',
    'error.mountTrainNeedsQuest': 'Nejprve musíte přijmout úkol lekce jízdy na koni.',
    'error.mountTrainInProgress': 'Výuka jízdy na koni již probíhá.',
  },
  nl_NL: {
    'error.ridingUntrained': 'Je moet eerst leren rijden. Zoek een rijtrainer.',
    'error.mountBuyLevel': 'Je moet level 20 zijn om een ​​mount te kopen.',
    'error.mountAlreadyOwned': 'Je hebt die houder al.',
    'error.ridingQuestUntrained': 'Je moet leren paardrijden voordat je deze les volgt.',
    'error.ridingAlreadyLearned': 'Je hebt al leren paardrijden.',
    'error.ridingTrainLevel': 'Je moet niveau 20 zijn om te leren paardrijden.',
    'error.ridingWrongNpc': 'Je moet met Marla Hitchen praten om te leren paardrijden.',
    'error.mountTrainLevel': 'Om paardrijlessen te kunnen volgen, moet je niveau 20 zijn.',
    'error.mountTrainDismountFirst': 'Eerst afstappen.',
    'error.mountTrainNeedsQuest': 'Je moet eerst de zoektocht naar rijlessen accepteren.',
    'error.mountTrainInProgress': 'Er is al een paardrijles aan de gang.',
  },
  pl_PL: {
    'error.ridingUntrained': 'Najpierw musisz nauczyć się jeździć. Znajdź trenera jazdy konnej.',
    'error.mountBuyLevel': 'Aby kupić wierzchowca, musisz mieć 20 poziom.',
    'error.mountAlreadyOwned': 'Masz już tego wierzchowca.',
    'error.ridingQuestUntrained':
      'Zanim przystąpisz do tej lekcji, musisz nauczyć się jazdy konnej.',
    'error.ridingAlreadyLearned': 'Nauczyłeś się już jazdy konnej.',
    'error.ridingTrainLevel': 'Aby nauczyć się jazdy konnej, musisz mieć 20 poziom.',
    'error.ridingWrongNpc': 'Aby nauczyć się jazdy konnej, musisz porozmawiać z Marlą Hitchen.',
    'error.mountTrainLevel': 'Aby móc brać lekcje jazdy konnej, musisz mieć poziom 20.',
    'error.mountTrainDismountFirst': 'Najpierw zsiądź.',
    'error.mountTrainNeedsQuest': 'Najpierw musisz zaakceptować zadanie lekcji jazdy konnej.',
    'error.mountTrainInProgress': 'Lekcja jazdy konnej już trwa.',
  },
  id_ID: {
    'error.ridingUntrained':
      'Anda harus belajar berkendara terlebih dahulu. Temukan pelatih berkuda.',
    'error.mountBuyLevel': 'Anda harus berada di level 20 untuk membeli tunggangan.',
    'error.mountAlreadyOwned': 'Anda sudah memiliki tunggangan itu.',
    'error.ridingQuestUntrained': 'Anda harus belajar Berkuda sebelum mengambil pelajaran ini.',
    'error.ridingAlreadyLearned': 'Anda sudah belajar Berkuda.',
    'error.ridingTrainLevel': 'Anda harus berada di level 20 untuk belajar Berkuda.',
    'error.ridingWrongNpc': 'Anda harus berbicara dengan Marla Hitchen untuk belajar Berkuda.',
    'error.mountTrainLevel': 'Anda harus berada di level 20 untuk mengikuti pelajaran berkuda.',
    'error.mountTrainDismountFirst': 'Turun dulu.',
    'error.mountTrainNeedsQuest': 'Anda harus menerima misi pelajaran berkuda terlebih dahulu.',
    'error.mountTrainInProgress': 'Pelajaran berkuda sedang berlangsung.',
  },
  tr_TR: {
    'error.ridingUntrained': 'Önce binmeyi öğrenmelisin. Bir binicilik antrenörü bulun.',
    'error.mountBuyLevel': 'Binek satın alabilmek için 20. seviyede olmanız gerekir.',
    'error.mountAlreadyOwned': 'O bineğe zaten sahipsiniz.',
    'error.ridingQuestUntrained': 'Bu dersi almadan önce Binicilik öğrenmelisiniz.',
    'error.ridingAlreadyLearned': 'Binicilik yapmayı zaten öğrendiniz.',
    'error.ridingTrainLevel': 'Binicilik öğrenmek için 20. seviyede olmanız gerekir.',
    'error.ridingWrongNpc': "Binicilik öğrenmek için Marla Hitchen'la konuşmalısın.",
    'error.mountTrainLevel': 'Binicilik dersi alabilmeniz için 20. seviyede olmanız gerekmektedir.',
    'error.mountTrainDismountFirst': 'Önce inin.',
    'error.mountTrainNeedsQuest': 'Öncelikle binicilik dersi görevini kabul etmeniz gerekiyor.',
    'error.mountTrainInProgress': 'Binicilik dersi zaten devam ediyor.',
  },
  sv_SE: {
    'error.ridingUntrained': 'Du måste lära dig att rida först. Hitta en ridtränare.',
    'error.mountBuyLevel': 'Du måste vara nivå 20 för att köpa ett fäste.',
    'error.mountAlreadyOwned': 'Du äger redan det fästet.',
    ...
    'error.mountTrainDismountFirst': 'Kliv av först.',
    'error.mountTrainNeedsQuest': 'Du måste acceptera ridlektionsuppdraget först.',
    'error.mountTrainInProgress': 'En ridlektion pågår redan.',
  },
  vi_VN: {
    'error.ridingUntrained': 'Bạn phải học lái xe trước. Tìm một huấn luyện viên cưỡi ngựa.',
    'error.mountBuyLevel': 'Bạn phải đạt cấp 20 để mua thú cưỡi.',
    'error.mountAlreadyOwned': 'Bạn đã sở hữu thú cưỡi đó rồi.',
    'error.ridingQuestUntrained': 'Bạn phải học Cưỡi ngựa trước khi học bài học này.',
    ...
    'error.mountTrainLevel': 'Bạn phải đạt cấp độ 20 để học cưỡi ngựa.',
    'error.mountTrainDismountFirst': 'Trước tiên hãy tháo dỡ.',
    'error.mountTrainNeedsQuest': 'Bạn cần phải chấp nhận nhiệm vụ học cưỡi ngựa trước.',
    'error.mountTrainInProgress': 'Một bài học cưỡi ngựa đang được tiến hành.',
  },
  da_DK: {
    'error.ridingUntrained': 'Du skal først lære at ride. Find en ridetræner.',
    'error.mountBuyLevel': 'Du skal være niveau 20 for at købe et beslag.',
    'error.mountAlreadyOwned': 'Du ejer allerede den holder.',
    'error.ridingQuestUntrained': 'Du skal lære Ridning, før du tager denne lektion.',
    'error.ridingAlreadyLearned': 'Du har allerede lært Ridning.',
    'error.ridingTrainLevel': 'Du skal være niveau 20 for at lære Ridning.',
    'error.ridingWrongNpc': 'Du skal tale med Marla Hitchen for at lære Ridning.',
    'error.mountTrainLevel': 'Du skal være niveau 20 for at tage ridetimer.',
    'error.mountTrainDismountFirst': 'Afmonter først.',
    'error.mountTrainNeedsQuest': 'Du skal først acceptere rideopgaven.',
    'error.mountTrainInProgress': 'En ridetime er allerede i gang.',
  },
};
