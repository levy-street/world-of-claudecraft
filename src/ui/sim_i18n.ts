...
const baseEnTable = {
  ...
  'lore.infernal.legionMarch': 'We marched beneath a sun that never rose.',
  'lore.infernal.azazelPromise': 'Azazel promised a kingdom beyond death. He led us only deeper.',
  'lore.infernal.firstFlame': 'The first flame was not worshipped. It was a lock.',
  'lore.infernal.heartCairn': 'Each brand bound one legionary to the Heart Cairn.',
  'lore.infernal.forgedChains': 'I forged their chains and called it duty.',
  'lore.infernal.lastSeal':
    'When the last seal breaks, let my hammer be the first thing the abyss devours.',
  'lore.infernal.guardOath': 'Azazel swore his fire would guard the mortal world.',
  'lore.infernal.trueName': 'The final clause is burned away. Only his true name remains.',
  'mechanic.infernalLava': 'Abyssal Lava',
  'mechanic.burningCleave': 'Burning Cleave',
  'mechanic.cinderburst': 'Cinderburst',
  'mechanic.anvilSlam': 'Anvil Slam',
  'mechanic.pyreNova': 'Pyre Nova',
  'mechanic.moltenQuake': 'Molten Quake',
  'mechanic.apocalypseFlame': 'Apocalypse Flame',
  'mechanic.abyssalFirestorm': 'Abyssal Firestorm',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  zh_CN: {
    ...
    'lore.infernal.legionMarch': '我们在永不升起的太阳下行军。',
    'lore.infernal.azazelPromise': '阿撒兹勒许诺了一个超越死亡的王国。他只带领我们越陷越深。',
    'lore.infernal.firstFlame': '初火并非供人崇拜。它是一道封印。',
    'lore.infernal.heartCairn': '每一道烙印都将一名军团士兵束缚于心之石冢。',
    'lore.infernal.forgedChains': '我锻造了他们的锁链，却称之为职责。',
    'lore.infernal.lastSeal': '当最后一道封印破裂时，愿我的铁锤成为深渊吞噬的第一件东西。',
    'lore.infernal.guardOath': '阿撒兹勒曾发誓，他的烈焰将守护凡人世界。',
    'lore.infernal.trueName': '最后一条契约已被烧毁。只剩下他的真名。',
    'mechanic.infernalLava': '炼狱熔岩',
    'mechanic.burningCleave': '灼烧横扫',
    'mechanic.cinderburst': '烬火爆裂',
    'mechanic.anvilSlam': '铁砧猛击',
    'mechanic.pyreNova': '火葬新星',
    'mechanic.moltenQuake': '熔岩震颤',
    'mechanic.apocalypseFlame': '天启之焰',
    'mechanic.abyssalFirestorm': '深渊火风暴',
    'mechanic.hellbreakerStomp': '破狱践踏',
    'mechanic.gazeOfTheAbyss': '深渊凝视',
    'mechanic.forgekeepersWrath': '铸炉守卫之怒',
  ...
  zh_TW: {
    ...
    'lore.infernal.legionMarch': '我們在永不升起的太陽下行軍。',
    'lore.infernal.azazelPromise': '阿撒茲勒許諾了一個超越死亡的王國。他只帶領我們越陷越深。',
    'lore.infernal.firstFlame': '初火並非供人崇拜。它是一道封印。',
    'lore.infernal.heartCairn': '每一道烙印都將一名軍團士兵束縛於心之石塚。',
    'lore.infernal.forgedChains': '我鍛造了他們的鎖鏈，卻稱之為職責。',
    'lore.infernal.lastSeal': '當最後一道封印破裂時，願我的鐵鎚成為深淵吞噬的第一件東西。',
    'lore.infernal.guardOath': '阿撒茲勒曾發誓，他的烈焰將守護凡人世界。',
    'lore.infernal.trueName': '最後一條契約已被燒毀。只剩下他的真名。',
    'mechanic.infernalLava': '煉獄熔岩',
    'mechanic.burningCleave': '灼燒橫掃',
    'mechanic.cinderburst': '燼火爆裂',
    'mechanic.anvilSlam': '鐵砧猛擊',
    'mechanic.pyreNova': '火葬新星',
    'mechanic.moltenQuake': '熔岩震顫',
    'mechanic.apocalypseFlame': '天啟之焰',
    'mechanic.abyssalFirestorm': '深淵火風暴',
    'mechanic.hellbreakerStomp': '破獄踐踏',
    'mechanic.gazeOfTheAbyss': '深淵凝視',
    'mechanic.forgekeepersWrath': '鑄爐守衛之怒',
    'aura.clearcasting': '清晰施法',
  ...
  ko_KR: {
    ...
    'lore.infernal.legionMarch': '우리는 결코 떠오르지 않는 태양 아래에서 진군했다.',
    'lore.infernal.azazelPromise':
      '아자젤은 죽음 너머의 왕국을 약속했다. 그는 우리를 더 깊은 곳으로 이끌었을 뿐이다.',
    'lore.infernal.firstFlame': '태초의 불꽃은 숭배의 대상이 아니었다. 그것은 자물쇠였다.',
    'lore.infernal.heartCairn': '각 낙인은 군단병 한 명을 심장 돌무덤에 묶었다.',
    'lore.infernal.forgedChains': '나는 그들의 사슬을 벼렸고 그것을 의무라 불렀다.',
    'lore.infernal.lastSeal': '마지막 봉인이 깨질 때, 내 망치가 심연이 삼키는 첫 번째 것이 되기를.',
    'lore.infernal.guardOath': '아자젤은 자신의 불꽃으로 필멸자의 세계를 지키겠다고 맹세했다.',
    'lore.infernal.trueName': '마지막 조항은 불타 사라졌다. 그의 진명만 남았다.',
    'mechanic.infernalLava': '지옥의 용암',
    'mechanic.burningCleave': '불타는 휩쓸기',
    'mechanic.cinderburst': '잿불 폭발',
    'mechanic.anvilSlam': '모루 강타',
    'mechanic.pyreNova': '화장불 신성',
    'mechanic.moltenQuake': '용암 지진',
    'mechanic.apocalypseFlame': '종말의 불꽃',
    'mechanic.abyssalFirestorm': '심연의 화염폭풍',
    'mechanic.hellbreakerStomp': '지옥파쇄 발구르기',
    'mechanic.gazeOfTheAbyss': '심연의 응시',
    'mechanic.forgekeepersWrath': '용광로지기의 분노',
  ...
  ja_JP: {
    ...
    'lore.infernal.legionMarch': '我らは決して昇らぬ太陽の下を進軍した。',
    'lore.infernal.azazelPromise':
      'アザゼルは死を超えた王国を約束した。だが我らをさらに深みへ導いただけだった。',
    'lore.infernal.firstFlame': '最初の炎は崇拝されていたのではない。封印だった。',
    'lore.infernal.heartCairn': '一つの烙印が一人の軍団兵を心臓の石塚に縛りつけた。',
    'lore.infernal.forgedChains': '私は彼らの鎖を鍛え、それを務めと呼んだ。',
    'lore.infernal.lastSeal': '最後の封印が砕ける時、我が槌が深淵に呑まれる最初のものとなれ。',
    'lore.infernal.guardOath': 'アザゼルは、その炎で定命の世界を守ると誓った。',
    'lore.infernal.trueName': '最後の条項は焼き消され、真の名だけが残った。',
    'mechanic.infernalLava': '地獄の溶岩',
    'mechanic.burningCleave': '燃え盛る薙ぎ払い',
    'mechanic.cinderburst': '燼火の爆裂',
    'mechanic.anvilSlam': '金床の一撃',
    'mechanic.pyreNova': '火葬の新星',
    'mechanic.moltenQuake': '溶岩の震動',
    'mechanic.apocalypseFlame': '黙示の炎',
    'mechanic.abyssalFirestorm': '深淵の火嵐',
    'mechanic.hellbreakerStomp': '地獄砕きの踏み鳴らし',
    'mechanic.gazeOfTheAbyss': '深淵の凝視',
    'mechanic.forgekeepersWrath': '炉の番人の怒り',
  ...
  ru_RU: {
    ...
    'lore.infernal.legionMarch': 'Мы шли под солнцем, которое никогда не всходило.',
    'lore.infernal.azazelPromise':
      'Азазель обещал царство за пределами смерти. Он лишь увел нас глубже.',
    'lore.infernal.firstFlame': 'Первому пламени не поклонялись. Оно было замком.',
    'lore.infernal.heartCairn': 'Каждое клеймо привязывало одного легионера к Каирну Сердца.',
    'lore.infernal.forgedChains': 'Я ковал их цепи и называл это долгом.',
    'lore.infernal.lastSeal':
      'Когда падет последняя печать, пусть мой молот станет первым, что поглотит бездна.',
    'lore.infernal.guardOath': 'Азазель поклялся, что его огонь будет хранить мир смертных.',
    'lore.infernal.trueName': 'Последний пункт выжжен. Осталось лишь его истинное имя.',
    'mechanic.infernalLava': 'Адская лава',
    'mechanic.burningCleave': 'Пылающий размах',
    'mechanic.cinderburst': 'Взрыв пепла',
    'mechanic.anvilSlam': 'Удар наковальни',
    'mechanic.pyreNova': 'Вспышка погребального костра',
    'mechanic.moltenQuake': 'Лавовое сотрясение',
    'mechanic.apocalypseFlame': 'Пламя апокалипсиса',
    'mechanic.abyssalFirestorm': 'Огненный шторм бездны',
    'mechanic.hellbreakerStomp': 'Адокрушительный топот',
    'mechanic.gazeOfTheAbyss': 'Взор бездны',
    'mechanic.forgekeepersWrath': 'Гнев Хранителя горна',
...
const AURA_NAME_KEY: Record<string, SimMessageKey> = {
  ...
  'Abyssal Lava': 'mechanic.infernalLava',
  'Burning Cleave': 'mechanic.burningCleave',
  Cinderburst: 'mechanic.cinderburst',
  'Anvil Slam': 'mechanic.anvilSlam',
  'Pyre Nova': 'mechanic.pyreNova',
  'Molten Quake': 'mechanic.moltenQuake',
  'Apocalypse Flame': 'mechanic.apocalypseFlame',
  'Abyssal Firestorm': 'mechanic.abyssalFirestorm',
  'Hellbreaker Stomp': 'mechanic.hellbreakerStomp',
  'Gaze of the Abyss': 'mechanic.gazeOfTheAbyss',
  "Forgekeeper's Wrath": 'mechanic.forgekeepersWrath',
