...
const baseEnTable = {
  ...
  // The broke-first-timer fare waiver (src/sim/last_bell/campaign.ts payFare).
  'log.ferryFareWaived': "Ewald waves the fare away. The first crossing is the town's.",
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'log.ferryFareWaived':
      'Ewald rechaza el pasaje con un gesto. El primer cruce lo paga el pueblo.',
  ...
  fr_FR: {
    ...
    'log.ferryFareWaived':
      "Ewald écarte votre monnaie d'un geste. La première traversée, c'est le bourg qui l'offre.",
  ...
  it_IT: {
    ...
    'log.ferryFareWaived':
      'Ewald rifiuta il prezzo del passaggio con un gesto. La prima traversata la offre il paese.',
  ...
  de_DE: {
    ...
    'log.ferryFareWaived':
      'Ewald winkt das Fahrgeld beiseite. Die erste Überfahrt geht auf die Stadt.',
  ...
  zh_CN: {
    ...
    'log.ferryFareWaived': '艾瓦德摆手不收船钱。第一次渡海由镇上出。',
  ...
  zh_TW: {
    ...
    'log.ferryFareWaived': '艾瓦德擺手不收船錢。第一次渡海由鎮上出。',
  ...
  ko_KR: {
    ...
    'log.ferryFareWaived': '에왈드가 뱃삯을 받지 않겠다며 손을 젓는다. 첫 항해는 마을이 낸다.',
  ...
  ja_JP: {
    ...
    'log.ferryFareWaived': 'エワルドは渡し賃を手で払いのける。最初の渡りは町の持ちだ。',
  ...
  pt_BR: {
    ...
    'log.ferryFareWaived':
      'Ewald dispensa a passagem com um aceno. A primeira travessia é por conta da cidade.',
  ...
  ru_RU: {
    ...
    'log.ferryFareWaived': 'Эвальд отмахивается от платы. Первая переправа за счёт города.',
