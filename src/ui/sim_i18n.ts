...
const baseEnTable = {
  ...
  'error.itemNotReady': '{item} is not ready yet.',
  ...
  'log.activateItem': 'You activate {item}.',
...
const BASE_DICT: Record<SupportedLanguage, Record<BaseSimMessageKey, string>> = {
  ...
  es: {
    ...
    'error.itemNotReady': '{item} a\u00fan no est\u00e1 listo.',
  ...
  fr_FR: {
    ...
    'error.itemNotReady': "{item} n'est pas encore pr\u00eat.",
    ...
    'log.activateItem': 'Vous activez {item}.',
  ...
  it_IT: {
    ...
    'error.itemNotReady': '{item} non \u00e8 ancora pronto.',
  ...
  de_DE: {
    ...
    'error.itemNotReady': '{item} ist noch nicht bereit.',
    ...
    'log.activateItem': 'Ihr aktiviert {item}.',
  ...
  zh_CN: {
    ...
    'error.itemNotReady': '{item}\u5c1a\u672a\u51b7\u5374\u5b8c\u6bd5\u3002',
  ...
  ko_KR: {
    ...
    'error.itemNotReady': '{item}\uc740(\ub294) \uc544\uc9c1 \uc0ac\uc6a9\ud560 \uc218 \uc5c6\uc2b5\ub2c8\ub2e4.',
    ...
    'log.activateItem': '{item}\uc744(\ub97c) \ud65c\uc131\ud654\ud569\ub2c8\ub2e4.',
  ...
  ja_JP: {
    ...
    'error.itemNotReady': '{item}\u306f\u307e\u3060\u4f7f\u7528\u3067\u304d\u307e\u305b\u3093\u3002',
  ...
  pt_BR: {
    ...
    'error.itemNotReady': '{item} ainda n\u00e3o est\u00e1 pronto.',
    ...
    'log.activateItem': 'Voc\u00ea ativa {item}.',
  ...
  ru_RU: {
    ...
    'error.itemNotReady': '{item} \u0435\u0449\u0451 \u043d\u0435 \u0433\u043e\u0442\u043e\u0432 \u043a \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u044e.',
    ...
    'log.activateItem': '\u0412\u044b \u0430\u043a\u0442\u0438\u0432\u0438\u0440\u0443\u0435\u0442\u0435 {item}.',
...
const RULES: Rule[] = [
  ...
  { re: /^You activate (.+)\.$/, build: (m) => tSim('log.activateItem', { item: locItem(m[1]) }) },
  {
    re: /^(.+) is not ready yet\.$/,
    build: (m) => tSim('error.itemNotReady', { item: locItem(m[1]) }),
  },
  {
    re: /^(.+) wins (.+) \((\d+)\)$/,
