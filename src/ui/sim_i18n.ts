...
const baseEnTable = {
  ...
  // src/sim/professions/sundering.ts). The four refusals are placeholder-free
  // EXACT rows; the completion line carries {item} and registers through its
  // RULES regex beside log.quaff's.
  'error.sunderTarget': 'Only raid-won epics can be sundered.',
  'error.sunderHeld': 'You are not holding that item.',
  'error.sunderBusy': 'You are busy.',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'error.sunderBusy': 'Estás ocupado.',
  ...
  fr_FR: {
    ...
    'error.sunderBusy': 'Vous êtes occupé.',
  ...
  de_DE: {
    ...
    'error.sunderBusy': 'Du bist beschäftigt.',
  ...
  ko_KR: {
    ...
    'error.sunderBusy': '지금은 다른 일을 하고 있습니다.',
  ...
  pt_BR: {
    ...
    'error.sunderBusy': 'Você está ocupado.',
