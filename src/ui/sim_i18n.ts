...
const baseEnTable = {
  ...
  'error.itemNotReady': 'That item is not ready yet.',
  ...
  'log.activate': 'You activate {item}.',
...
const BASE_DICT: Record<SupportedLanguage, Record<BaseSimMessageKey, string>> = {
  ...
  es: {
    ...
    'error.itemNotReady': 'Ese objeto aun no esta listo.',
  ...
  fr_FR: {
    ...
    'error.itemNotReady': "Cet objet n'est pas encore pret.",
    ...
    'log.activate': 'Vous activez {item}.',
  ...
  it_IT: {
    ...
    'error.itemNotReady': "Quell'oggetto non e ancora pronto.",
  ...
  de_DE: {
    ...
    'error.itemNotReady': 'Dieser Gegenstand ist noch nicht bereit.',
    ...
    'log.activate': 'Du aktivierst {item}.',
  ...
  zh_CN: {
    ...
    'error.itemNotReady': 'Gai wupin shangwei jiuxu.',
  ...
  zh_TW: {
    ...
    'log.sitDrink': '你坐下來飲水。',
    'log.quaff': '你喝下了 {item}。',
    'log.activate': 'Ni qidong le {item}.',
  ...
  ko_KR: {
    ...
    'error.itemNotReady': 'Geu item-eun ajik junbi-doeji anasseumnida.',
    ...
    'log.activate': '{item}eul hwalseonghwahamnida.',
  ...
  ja_JP: {
    ...
    'error.itemNotReady': 'Sono item wa mada tsukaemasen.',
    ...
    'log.activate': '{item} o kido shimashita.',
  ...
  pt_BR: {
    ...
    'error.itemNotReady': 'Esse item ainda nao esta pronto.',
  ...
  ru_RU: {
    ...
    'error.itemNotReady': 'Etot predmet eshche ne gotov.',
    ...
    'log.activate': 'Vy aktiviruete {item}.',
...
const RULES: Rule[] = [
  ...
  { re: /^You activate (.+)\.$/, build: (m) => tSim('log.activate', { item: locItem(m[1]) }) },
  {
    re: /^(.+) wins (.+) \((\d+)\)$/,
