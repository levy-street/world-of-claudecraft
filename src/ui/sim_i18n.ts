...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  fr_FR: {
    ...
    'error.alreadyEating': 'Vous mangez déjà.',
  ...
  de_DE: {
    ...
    'error.alreadyEating': 'Ihr esst bereits.',
  ...
  ko_KR: {
    ...
    'error.alreadyEating': '이미 음식을 먹고 있습니다.',
