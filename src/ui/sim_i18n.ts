...
const baseEnTable = {
  ...
  'log.slumberTakes': 'Sleep takes hold — the dream pulls you under.',
  'log.echoRises': 'Across the mist, something wearing your face stands up.',
  'log.echoScatters': 'The Echo scatters you like breath on glass.',
  'log.echoShardDrop': 'The Echo shatters — a Mirror Shard is left where it stood.',
  'log.echoNoShard': 'The Echo shatters. It leaves nothing behind this time.',
  'log.dreamWake': 'You wake where sleep took you.',
  ...
  'error.noGargoyleNear': 'There is no gargoyle within reach.',
  'log.shardStr': 'The Mirror Shard sinks in. Your strength grows — permanently.',
  'log.shardAgi': 'The Mirror Shard sinks in. Your reflexes sharpen — permanently.',
  'log.shardInt': 'The Mirror Shard sinks in. Your mind deepens — permanently.',
  'error.dreamCrowded': 'The dream is crowded tonight. Try again soon.',
  'error.brewNotAttuned': 'Morwen has nothing to brew for you yet.',
  'error.brewTooFar': 'Morwen is not close enough to brew.',
  'error.brewMissingParts': 'You are missing ingredients for the draught.',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'log.slumberTakes': 'El sueño te vence: el sopor tira de ti hacia abajo.',
    'log.echoRises': 'Entre la bruma, algo con tu cara se pone en pie.',
    'log.echoScatters': 'El Eco te dispersa como aliento sobre el cristal.',
    'log.echoShardDrop': 'El Eco se hace añicos: una Esquirla de Espejo queda donde estaba.',
    'log.echoNoShard': 'El Eco se hace añicos. Esta vez no deja nada.',
    ...
    'error.noGargoyleNear': 'No hay ninguna gárgola al alcance.',
    'log.shardStr': 'La Esquirla de Espejo se hunde en ti. Tu fuerza crece: para siempre.',
    'log.shardAgi': 'La Esquirla de Espejo se hunde en ti. Tus reflejos se agudizan: para siempre.',
    'log.shardInt': 'La Esquirla de Espejo se hunde en ti. Tu mente se ahonda: para siempre.',
    'error.dreamCrowded': 'El sueño está abarrotado esta noche. Prueba de nuevo pronto.',
    'error.brewNotAttuned': 'Morwen aún no tiene nada que prepararte.',
    'error.brewTooFar': 'Morwen no está lo bastante cerca para preparar nada.',
    'error.brewMissingParts': 'Te faltan ingredientes para el bebedizo.',
  ...
  fr_FR: {
    ...
    'log.slumberTakes': 'Le sommeil te prend — le rêve t’attire vers le fond.',
    'log.echoRises': 'Dans la brume, quelque chose qui porte ton visage se relève.',
    'log.echoScatters': 'L’Écho te disperse comme un souffle sur le verre.',
    'log.echoShardDrop': 'L’Écho vole en éclats — un Éclat de Miroir reste là où il se tenait.',
    'log.echoNoShard': 'L’Écho vole en éclats. Cette fois, il ne laisse rien.',
    ...
    'log.shardInt': 'L’Éclat de Miroir s’enfonce en toi. Ton esprit s’approfondit — pour toujours.',
    'error.dreamCrowded': 'Le rêve est bondé cette nuit. Réessaie bientôt.',
    'error.brewNotAttuned': 'Morwen n’a encore rien à te préparer.',
    'error.brewTooFar': 'Morwen n’est pas assez près pour brasser.',
    'error.brewMissingParts': 'Il te manque des ingrédients pour le philtre.',
  ...
  it_IT: {
    ...
    'log.slumberTakes': 'Il sonno ti prende — il sogno ti trascina giù.',
    'log.echoRises': 'Nella bruma, qualcosa con il tuo volto si alza in piedi.',
    'log.echoScatters': 'L’Eco ti disperde come fiato sul vetro.',
    'log.echoShardDrop': 'L’Eco va in frantumi — una Scheggia di Specchio resta dove stava.',
    'log.echoNoShard': 'L’Eco va in frantumi. Stavolta non lascia nulla.',
    ...
    'error.brewMissingParts': 'Ti mancano ingredienti per l’intruglio.',
  ...
  de_DE: {
    ...
    'log.slumberTakes': 'Der Schlaf greift zu — der Traum zieht dich hinab.',
    'log.echoRises': 'Im Nebel richtet sich etwas auf, das dein Gesicht trägt.',
    'log.echoScatters': 'Das Echo zerstreut dich wie Atem auf Glas.',
    'log.echoShardDrop': 'Das Echo zerspringt — ein Spiegelsplitter bleibt zurück, wo es stand.',
    'log.echoNoShard': 'Das Echo zerspringt. Diesmal lässt es nichts zurück.',
    'log.dreamWake': 'Du erwachst, wo der Schlaf dich nahm.',
    ...
    'error.brewTooFar': 'Morwen ist nicht nah genug zum Brauen.',
    'error.brewMissingParts': 'Dir fehlen Zutaten für den Trank.',
  ...
  zh_CN: {
    ...
    'log.sitDrink': '你坐下来饮水。',
    'log.quaff': '你饮下了{item}。',
    'log.slumberTakes': '睡意攫住了你——梦把你往下拽。',
    'log.echoRises': '雾中，一个长着你的脸的东西站了起来。',
    'log.echoScatters': '回响将你吹散，如同玻璃上的一口气。',
    'log.echoShardDrop': '回响碎裂——一枚镜之碎片留在它站立的地方。',
    'log.echoNoShard': '回响碎裂。这一次它什么也没留下。',
    'log.dreamWake': '你在入睡的地方醒来。',
    'log.brewLadled': '莫温舀了一瓶新酿的深梦药剂放进你的行囊。',
    'log.gargoyleBows': '石像鬼低下头，石头与石头相磨作响。',
    'log.gargoyleWakes': '石头沿着旧缝裂开——哨卫从基座上走了下来。',
    'log.gargoyleRestones': '怒气耗尽，石像鬼爬回基座，重新凝为石头。',
    'error.mirrorSealed': '镜子一片漆黑。它的守卫要先见到你的礼数。',
    'error.blackMirrorSealed': '幽暗之镜还不认识你。暂时。',
    'log.mirrorUnsealed': '过路费已付。石像身后，镜面澄澈起来。',
    'error.noGargoyleNear': '附近没有石像鬼。',
    'log.shardStr': '镜之碎片沉入你的身体。你的力量增长了——永久地。',
    'log.shardAgi': '镜之碎片沉入你的身体。你的反应更敏锐了——永久地。',
    'log.shardInt': '镜之碎片沉入你的身体。你的心智更深邃了——永久地。',
    'error.dreamCrowded': '今晚的梦太拥挤了。请稍后再试。',
    'error.brewNotAttuned': '莫温现在还没有东西可以为你酿制。',
    'error.brewTooFar': '莫温离得太远，无法酿制。',
    'error.brewMissingParts': '你缺少酿制药剂的材料。',
  ...
  zh_TW: {
    ...
    'log.sitDrink': '你坐下來飲水。',
    'log.quaff': '你喝下了 {item}。',
    'log.slumberTakes': '睡意攫住了你——夢把你往下拽。',
    'log.echoRises': '霧中，一個長著你的臉的東西站了起來。',
    'log.echoScatters': '回響將你吹散，如同玻璃上的一口氣。',
    'log.echoShardDrop': '回響碎裂——一枚鏡之碎片留在它站立的地方。',
    'log.echoNoShard': '回響碎裂。這一次它什麼也沒留下。',
    'log.dreamWake': '你在入睡的地方醒來。',
    'log.brewLadled': '莫溫舀了一瓶新釀的深夢藥劑放進你的行囊。',
    'log.gargoyleBows': '石像鬼低下頭，石頭與石頭相磨作響。',
    'log.gargoyleWakes': '石頭沿著舊縫裂開——哨衛從基座上走了下來。',
    'log.gargoyleRestones': '怒氣耗盡，石像鬼爬回基座，重新凝為石頭。',
    'error.mirrorSealed': '鏡子一片漆黑。它的守衛要先見到你的禮數。',
    'error.blackMirrorSealed': '幽暗之鏡還不認識你。暫時。',
    'log.mirrorUnsealed': '過路費已付。石像身後，鏡面澄澈起來。',
    'error.noGargoyleNear': '附近沒有石像鬼。',
    'log.shardStr': '鏡之碎片沉入你的身體。你的力量增長了——永久地。',
    'log.shardAgi': '鏡之碎片沉入你的身體。你的反應更敏銳了——永久地。',
    'log.shardInt': '鏡之碎片沉入你的身體。你的心智更深邃了——永久地。',
    'error.dreamCrowded': '今晚的夢太擁擠了。請稍後再試。',
    'error.brewNotAttuned': '莫溫現在還沒有東西可以為你釀製。',
    'error.brewTooFar': '莫溫離得太遠，無法釀製。',
    'error.brewMissingParts': '你缺少釀製藥劑的材料。',
  ...
  ko_KR: {
    ...
    'log.slumberTakes': '잠이 그대를 붙든다 — 꿈이 그대를 아래로 끌어당긴다.',
    'log.echoRises': '안개 저편에서, 그대의 얼굴을 한 무언가가 일어선다.',
    'log.echoScatters': '메아리가 유리 위의 입김처럼 그대를 흩어 놓는다.',
    'log.echoShardDrop': '메아리가 산산이 부서진다 — 그 자리에 거울 조각이 남는다.',
    'log.echoNoShard': '메아리가 산산이 부서진다. 이번에는 아무것도 남기지 않는다.',
    'log.dreamWake': '잠들었던 자리에서 깨어난다.',
    'log.brewLadled': '모르웬이 갓 빚은 깊은 꿈의 물약을 그대의 짐에 담아 준다.',
    'log.gargoyleBows': '가고일이 고개를 숙이자 돌이 돌에 갈리는 소리가 난다.',
    'log.gargoyleWakes': '오래된 이음매를 따라 돌이 갈라진다 — 파수꾼이 대좌에서 내려선다.',
    'log.gargoyleRestones': '분노를 다 쏟은 가고일이 대좌 위로 기어올라 다시 돌로 굳는다.',
    'error.mirrorSealed': '거울이 어둡다. 그 수호자는 먼저 예를 갖추길 기다린다.',
    'error.blackMirrorSealed': '어둠의 거울은 아직 너를 모른다.',
    'log.mirrorUnsealed': '통행료를 치렀다. 석상 뒤에서 거울이 맑아진다.',
    'error.noGargoyleNear': '가까이에 가고일이 없습니다.',
    'log.shardStr': '거울 조각이 몸에 스며든다. 힘이 자라난다 — 영원히.',
    'log.shardAgi': '거울 조각이 몸에 스며든다. 반응이 날카로워진다 — 영원히.',
    'log.shardInt': '거울 조각이 몸에 스며든다. 정신이 깊어진다 — 영원히.',
    'error.dreamCrowded': '오늘 밤 꿈이 붐빈다. 잠시 후 다시 시도하라.',
    'error.brewNotAttuned': '모르웬이 아직 그대에게 빚어 줄 것이 없다.',
    'error.brewTooFar': '모르웬이 빚기에는 너무 멀리 있다.',
    'error.brewMissingParts': '물약 재료가 부족하다.',
  ...
  ja_JP: {
    ...
    'log.slumberTakes': '眠りが掴みかかる――夢がお前を引きずり込む。',
    'log.echoRises': '霧の向こうで、お前の顔をした何かが立ち上がる。',
    'log.echoScatters': 'エコーがお前を散らす。ガラスに吹きかけた息のように。',
    'log.echoShardDrop': 'エコーが砕け散る――立っていた場所に鏡のかけらが残る。',
    'log.echoNoShard': 'エコーが砕け散る。今度は何も残さない。',
    'log.dreamWake': '眠りに落ちた場所で目を覚ます。',
    'log.brewLadled': 'モルウェンが出来たての深き夢の妙薬をお前の荷袋に注ぐ。',
    'log.gargoyleBows': 'ガーゴイルが頭を垂れ、石が石を擦る音が響く。',
    'log.gargoyleWakes': '古い継ぎ目に沿って石が割れ——番人が台座から降り立つ。',
    'log.gargoyleRestones': '怒りを使い果たしたガーゴイルは台座に這い戻り、再び石と化した。',
    'error.mirrorSealed': '鏡は暗い。番人はまず礼を求めている。',
    'error.blackMirrorSealed': '仄暗い鏡はまだお前を知らない。',
    'log.mirrorUnsealed': '通行の代は払われた。像の後ろで鏡が澄んでいく。',
    'error.noGargoyleNear': '近くにガーゴイルがいない。',
    'log.shardStr': '鏡のかけらが体に沈み込む。力が増す――永遠に。',
    'log.shardAgi': '鏡のかけらが体に沈み込む。反応が研ぎ澄まされる――永遠に。',
    'log.shardInt': '鏡のかけらが体に沈み込む。精神が深まる――永遠に。',
    'error.dreamCrowded': '今夜の夢は混み合っている。しばらくしてまた試せ。',
    'error.brewNotAttuned': 'モルウェンにはまだお前に醸すものがない。',
    'error.brewTooFar': 'モルウェンが醸すには遠すぎる。',
    'error.brewMissingParts': '妙薬の材料が足りない。',
  ...
  pt_BR: {
    ...
    'log.slumberTakes': 'O sono te toma — o sonho te puxa para baixo.',
    'log.echoRises': 'Na bruma, algo com o seu rosto se levanta.',
    'log.echoScatters': 'O Eco te dispersa como um sopro no vidro.',
    'log.echoShardDrop': 'O Eco se estilhaça — um Fragmento de Espelho fica onde ele estava.',
    'log.echoNoShard': 'O Eco se estilhaça. Desta vez não deixa nada.',
    ...
    'error.noGargoyleNear': 'Não há nenhuma gárgula ao alcance.',
    'log.shardStr': 'O Fragmento de Espelho afunda em você. Sua força cresce — para sempre.',
    'log.shardAgi': 'O Fragmento de Espelho afunda em você. Seus reflexos se aguçam — para sempre.',
    'log.shardInt': 'O Fragmento de Espelho afunda em você. Sua mente se aprofunda — para sempre.',
    'error.dreamCrowded': 'O sonho está lotado esta noite. Tente de novo em breve.',
    'error.brewNotAttuned': 'Morwen ainda não tem nada para preparar para você.',
    'error.brewTooFar': 'Morwen não está perto o bastante para preparar.',
    'error.brewMissingParts': 'Faltam ingredientes para a beberagem.',
  ...
  ru_RU: {
    ...
    'log.slumberTakes': 'Сон берёт своё — грёза утягивает тебя вниз.',
    'log.echoRises': 'В тумане поднимается нечто с твоим лицом.',
    'log.echoScatters': 'Эхо развеивает тебя, как дыхание на стекле.',
    'log.echoShardDrop': 'Эхо разбивается — на его месте остаётся Зеркальный осколок.',
    'log.echoNoShard': 'Эхо разбивается. В этот раз оно не оставляет ничего.',
    'log.dreamWake': 'Ты просыпаешься там, где тебя взял сон.',
    ...
    'error.noGargoyleNear': 'Поблизости нет горгульи.',
    'log.shardStr': 'Зеркальный осколок входит в тебя. Твоя сила растёт — навсегда.',
    'log.shardAgi': 'Зеркальный осколок входит в тебя. Твоя реакция обостряется — навсегда.',
    'log.shardInt': 'Зеркальный осколок входит в тебя. Твой разум углубляется — навсегда.',
    'error.dreamCrowded': 'Этой ночью во сне тесно. Попробуй ещё раз позже.',
    'error.brewNotAttuned': 'Морвен пока нечего для тебя варить.',
    'error.brewTooFar': 'Морвен слишком далеко, чтобы варить.',
    'error.brewMissingParts': 'Тебе не хватает ингредиентов для отвара.',
