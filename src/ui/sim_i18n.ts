...
// Professions & crafting sim messages (First Aid, cloth, trainers). Mirrors the
// pet sub-table pattern. {placeholders} are filled by RULES below; non-placeholder
...
// Profession sim strings. English base doubles as the fallback for locales not yet
// translated (zh_CN/zh_TW/ko_KR/ja_JP/ru_RU) — a follow-up translation pass can fill these.
