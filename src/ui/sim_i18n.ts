...
const baseEnTable = {
  ...
  'error.xpAtCap': 'Level {level}: maximum level reached.',
  'log.oathSworn': 'You have sworn your oath to {faction}.',
  'faction.kaelOath': 'the Kael Empire',
  'faction.vethOath': 'the Confederation of Veth',
  'faction.ossaraOath': 'the Domain of Ossara',
  'error.oathSworn': 'Your oath is already sworn.',
  'error.oathUnknownPeople': 'The Envoys do not recognize that people.',
  'error.oathLevel': 'The Envoys will hear your oath at level {level}.',
  'error.oathNoEnvoy': 'You must stand before an Envoy to swear your oath.',
  'error.travelUnsworn': 'Swear your oath first: passage follows allegiance.',
  'error.travelWrongEnvoy': 'Your own Envoy holds your passage.',
  'error.travelNowhere': 'There is no passage from here.',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'error.xpAtCap': 'Nivel {level}: nivel máximo alcanzado.',
    'log.oathSworn': 'Has jurado tu lealtad a {faction}.',
    'faction.kaelOath': 'el Imperio de Kael',
    'faction.vethOath': 'la Confederación de Veth',
    'faction.ossaraOath': 'el Dominio de Ossara',
    'error.oathSworn': 'Tu juramento ya está sellado.',
    'error.oathUnknownPeople': 'Los Emisarios no reconocen a ese pueblo.',
    'error.oathLevel': 'Los Emisarios oirán tu juramento al nivel {level}.',
    'error.oathNoEnvoy': 'Debes estar ante un Emisario para jurar tu lealtad.',
    'error.travelUnsworn': 'Jura primero: el pasaje sigue a la lealtad.',
    'error.travelWrongEnvoy': 'Tu propio Emisario guarda tu pasaje.',
    'error.travelNowhere': 'No hay pasaje desde aquí.',
  ...
  zh_CN: {
    ...
    'error.xpAtCap': '等级{level}：已达到最高等级。',
    'log.oathSworn': '你已向{faction}宣誓效忠。',
    'faction.kaelOath': '凯尔帝国',
    'faction.vethOath': '维斯联盟',
    'faction.ossaraOath': '奥萨拉圣域',
    'error.oathSworn': '你的誓言已立，不可更改。',
    'error.oathUnknownPeople': '使节们不认识这个种族。',
    'error.oathLevel': '达到{level}级后，使节才会聆听你的誓言。',
    'error.oathNoEnvoy': '你必须站在使节面前才能宣誓。',
    'error.travelUnsworn': '先立誓言：通行随忠诚而来。',
    'error.travelWrongEnvoy': '你的通行证在你自己的使节手中。',
    'error.travelNowhere': '此处没有通路。',
  ...
  zh_TW: {
    ...
    'error.xpAtCap': '等級 {level}：已達到最高等級。',
    'log.oathSworn': '你已向{faction}宣誓效忠。',
    'faction.kaelOath': '凱爾帝國',
    'faction.vethOath': '維斯聯盟',
    'faction.ossaraOath': '奧薩拉聖域',
    'error.oathSworn': '你的誓言已立，不可更改。',
    'error.oathUnknownPeople': '使節們不認識這個種族。',
    'error.oathLevel': '達到{level}級後，使節才會聆聽你的誓言。',
    'error.oathNoEnvoy': '你必須站在使節面前才能宣誓。',
    'error.travelUnsworn': '先立誓言：通行隨忠誠而來。',
    'error.travelWrongEnvoy': '你的通行證在你自己的使節手中。',
    'error.travelNowhere': '此處沒有通路。',
  ...
  ko_KR: {
    ...
    'error.xpAtCap': '레벨 {level}: 최고 레벨에 도달했습니다.',
    'log.oathSworn': '당신은 {faction}에 충성을 맹세했습니다.',
    'faction.kaelOath': '카엘 제국',
    'faction.vethOath': '베스 연맹',
    'faction.ossaraOath': '오사라 성역',
    'error.oathSworn': '맹세는 이미 이루어졌습니다.',
    'error.oathUnknownPeople': '사절들은 그 종족을 알지 못합니다.',
    'error.oathLevel': '사절들은 {level}레벨부터 맹세를 받습니다.',
    'error.oathNoEnvoy': '맹세하려면 사절 앞에 서야 합니다.',
    'error.travelUnsworn': '먼저 맹세하십시오. 통행은 충성을 따릅니다.',
    'error.travelWrongEnvoy': '통행은 당신의 사절이 맡고 있습니다.',
    'error.travelNowhere': '여기에서는 통행할 수 없습니다.',
  ...
  ja_JP: {
    ...
    'error.xpAtCap': 'レベル{level}：最高レベルに到達しました。',
    'log.oathSworn': 'あなたは{faction}に忠誠を誓った。',
    'faction.kaelOath': 'ケール帝国',
    'faction.vethOath': 'ヴェス連合',
    'faction.ossaraOath': 'オサラ聖領',
    'error.oathSworn': '誓いはすでに立てられている。',
    'error.oathUnknownPeople': '使節はその民を知らない。',
    'error.oathLevel': '使節が誓いを聞くのはレベル{level}からだ。',
    'error.oathNoEnvoy': '誓いを立てるには使節の前に立つ必要がある。',
    'error.travelUnsworn': 'まず誓いを。渡航は忠誠に従う。',
    'error.travelWrongEnvoy': '渡航はあなた自身の使節が扱っている。',
    'error.travelNowhere': 'ここからの渡航はない。',
  ...
  ru_RU: {
    ...
    'error.xpAtCap': 'Уровень {level}: достигнут максимальный уровень.',
    'log.oathSworn': 'Вы присягнули: {faction}.',
    'faction.kaelOath': 'Империя Каэль',
    'faction.vethOath': 'Конфедерация Вет',
    'faction.ossaraOath': 'Домен Оссары',
    'error.oathSworn': 'Клятва уже принесена.',
    'error.oathUnknownPeople': 'Посланникам неведом этот народ.',
    'error.oathLevel': 'Посланники выслушают клятву с уровня {level}.',
    'error.oathNoEnvoy': 'Чтобы присягнуть, встаньте перед Посланником.',
    'error.travelUnsworn': 'Сначала клятва: путь следует за верностью.',
    'error.travelWrongEnvoy': 'Ваш путь держит ваш собственный Посланник.',
    'error.travelNowhere': 'Отсюда пути нет.',
...
const RULES: Rule[] = [
  ...
  {
    re: /^Level (\d+): maximum level reached\.$/,
  ...
  {
    re: /^The Envoys will hear your oath at level (\d+)\.$/,
    build: (m) => tSim('error.oathLevel', { level: m[1] }),
  },
  {
