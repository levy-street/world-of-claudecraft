...
const baseEnTable = {
  ...
  // The Gauntlet join guards (src/sim/gauntlet/runs.ts). Placeholder-free, so the
  // EXACT auto-build recognizes them; 'Leave the dungeon first.' / 'Leave the arena
  // first.' are shared with the delve guards and localized by their existing RULES.
