...
export const DICT: Record<string, Record<string, string>> = {
  en: {
    ...
    'guild.renamed': 'The guild has been renamed to <{name}>.',
  ...
  es: {
    ...
    'guild.renamed': 'La hermandad ha pasado a llamarse <{name}>.',
  ...
  fr_FR: {
    ...
    'guild.renamed': 'La guilde a été renommée <{name}>.',
  ...
  it_IT: {
    ...
    'guild.renamed': 'La gilda è stata rinominata <{name}>.',
  ...
  de_DE: {
    ...
    'guild.renamed': 'Die Gilde wurde in <{name}> umbenannt.',
  ...
  ko_KR: {
    ...
    'guild.renamed': '길드 이름이 <{name}>(으)로 변경되었습니다.',
  ...
  ja_JP: {
    ...
    'guild.renamed': 'ギルド名は<{name}>に変更されました。',
  ...
  pt_BR: {
    ...
    'guild.renamed': 'A guilda foi renomeada para <{name}>.',
  ...
  ru_RU: {
    ...
    'guild.renamed': 'Гильдия переименована в <{name}>.',
...
const RULES: Rule[] = [
  ...
  {
    re: /^The guild has been renamed to <([^>]+)>\.$/,
    build: (m) => tServer('guild.renamed', { name: m[1] }),
  },
  {
