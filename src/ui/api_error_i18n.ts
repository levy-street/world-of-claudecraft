...
export const API_ERROR_KEYS = {
  ...
  'woc_market.held_disabled': 'apiError.woc_market.held_disabled',
  'woc_market.held_insufficient': 'apiError.woc_market.held_insufficient',
  'woc_market.held_empty': 'apiError.woc_market.held_empty',
  'woc_market.held_withdraw_failed': 'apiError.woc_market.held_withdraw_failed',
  'woc_market.account_proof_required': 'apiError.woc_market.account_proof_required',
  'woc_market.account_proof_two_factor': 'apiError.woc_market.account_proof_two_factor',
  'woc_market.account_proof_no_password': 'apiError.woc_market.account_proof_no_password',
  'woc_market.account_proof_invalid': 'apiError.woc_market.account_proof_invalid',
  'woc_market.account_proof_throttled': 'apiError.woc_market.account_proof_throttled',
