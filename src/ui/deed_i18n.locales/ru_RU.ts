...
export const table: DeedLocaleTable = {
  ...
  exp_harbor_to_harbor: {
    ...
    desc: 'Проплывите на обоих паромах туда и обратно: из Истврука в Лунный Приют и из Викхарбора в Змеиный дозор.',
  },
  exp_forge_helper: {
    name: 'Молот в помощь',
    desc: 'Помогите кузнецу Маре завершить щит в Вирмвотче.',
  },
  exp_last_barricade: {
    name: 'Последняя баррикада',
    desc: 'Удержите лесной перевал против орды нежити.',
  },
  exp_borrowed_face: {
    name: 'Чужое лицо',
    desc: 'Разоблачите и одолейте лазутчика среди стражи Фенбриджа.',
  },
  exp_windrider_slalom: {
    name: 'Слалом на ветрокрыле',
    desc: 'Завершите спуск на механическом планере через каньон Гейлкреста.',
  },
  exp_duskweave_dispatches: {
    name: 'Донесения Сумеречного плетения',
    desc: 'Верните бандитские донесения, надев зачарованный плащ Валери.',
  },
  exp_wisp_maze: {
    name: 'Огонёк в лабиринте',
    desc: 'Верните украденные кошельки и выберитесь из лабиринта Вечного Сада.',
  },
  prog_rift_watch_trusted: {
    name: 'Доверенный у Дозора Разлома',
    desc: 'Достигните ступени «Доверенный» у Дозора Разлома.',
  },
  prog_church_order_trusted: {
    name: 'Доверенный у Церковного ордена',
    desc: 'Достигните ступени «Доверенный» у Церковного ордена.',
  },
  prog_automatons_trusted: {
    name: 'Доверенный у Автоматонов',
    desc: 'Достигните ступени «Доверенный» у Автоматонов.',
  },
  prog_rift_watch_champion: {
    name: 'Чемпион Дозора Разлома',
    desc: 'Достигните ступени «Чемпион» у Дозора Разлома.',
    title: 'Страж Разлома',
  },
  prog_church_order_champion: {
    name: 'Чемпион Церковного ордена',
    desc: 'Достигните ступени «Чемпион» у Церковного ордена.',
    title: 'Хранитель Рассвета',
  },
  prog_automatons_champion: {
    name: 'Чемпион Автоматонов',
    desc: 'Достигните ступени «Чемпион» у Автоматонов.',
    title: 'Кузнец-мастер',
  },
  prog_faction_champion_all: {
    name: 'Чемпион каждого знамени',
    desc: 'Достигните ступени «Чемпион» у Дозора Разлома, Церковного ордена и Автоматонов.',
  },
  exp_clue_first_casket: {
    name: 'Сокровище найдено',
    desc: 'Откройте ларец с сокровищами, выкопанный в конце охоты за сокровищами.',
  },
  exp_clue_ten_caskets: {
    name: 'Охотник за сокровищами',
    desc: 'Откройте 10 ларцов с сокровищами, выкопанных в конце охоты за сокровищами.',
