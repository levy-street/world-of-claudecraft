...
const en: Messages = {
  ...
  'moderation.spectateSelf': 'You cannot spectate yourself.',
  'moderation.spectatePvpOnly':
...
const es: Messages = {
  ...
  'moderation.spectateSelf': 'No puedes observarte a ti mismo.',
  'moderation.spectatePvpOnly':
    'Solo puedes observar a jugadores que esten en un duelo o combate de arena activo.',
...
const fr: Messages = {
  ...
  'moderation.spectateSelf': 'Vous ne pouvez pas vous observer vous-meme.',
  'moderation.spectatePvpOnly':
    'Vous ne pouvez observer que les joueurs dans un duel ou un match d arene actif.',
...
const it: Messages = {
  ...
  'moderation.spectateSelf': 'Non puoi osservare te stesso.',
  'moderation.spectatePvpOnly':
    'Puoi osservare solo giocatori in un duello o in un incontro arena attivo.',
...
const de: Messages = {
  ...
  'moderation.spectateSelf': 'Ihr koennt euch nicht selbst beobachten.',
  'moderation.spectatePvpOnly':
    'Ihr koennt nur Spieler beobachten, die sich in einem aktiven Duell oder Arenamatch befinden.',
...
const zhCN: Messages = {
  ...
  'moderation.spectateSelf': 'Ni bu neng guancha ziji.',
  'moderation.spectatePvpOnly':
    'Ni zhineng guancha zhengzai jue dou huo jing ji chang bisai de wanjia.',
...
const ko: Messages = {
  ...
  'moderation.spectateSelf': 'Jasin-eun gwanjeonhal su eopseumnida.',
  'moderation.spectatePvpOnly':
    'Hwalseong gyeoltu ttoneun arena gyeonggi jungin peulleieoman gwanjeonhal su itseumnida.',
...
const ja: Messages = {
  ...
  'moderation.spectateSelf': 'Jibun jishin wa kansen dekimasen.',
  'moderation.spectatePvpOnly':
    'Shinkochu no ketto matawa arena-sen no player dake wo kansen dekimasu.',
...
const pt: Messages = {
  ...
  'moderation.spectateSelf': 'Voce nao pode observar a si mesmo.',
  'moderation.spectatePvpOnly':
    'Voce so pode observar jogadores em um duelo ou partida de arena ativa.',
...
const ru: Messages = {
  ...
  'moderation.spectateSelf': 'Nelzya nablyudat za samim soboy.',
  'moderation.spectatePvpOnly':
    'Mozhno nablyudat tolko za igrokami v aktivnoy dueli ili matche areny.',
...
const da: Messages = {
  ...
  'moderation.spectateSelf': 'Du kan ikke observere dig selv.',
  'moderation.spectatePvpOnly': 'Du kan kun observere spillere i en aktiv duel eller arenakamp.',
...
const id: Messages = {
  ...
  'moderation.spectateSelf': 'Kamu tidak bisa mengamati diri sendiri.',
  'moderation.spectatePvpOnly':
    'Kamu hanya bisa mengamati pemain yang sedang dalam duel atau pertandingan arena aktif.',
...
const nl: Messages = {
  ...
  'moderation.spectateSelf': 'Je kunt jezelf niet observeren.',
  'moderation.spectatePvpOnly':
    'Je kunt alleen spelers observeren die in een actief duel of arenagevecht zitten.',
...
const pl: Messages = {
  ...
  'moderation.spectateSelf': 'Nie mozesz obserwowac siebie.',
  'moderation.spectatePvpOnly':
    'Mozesz obserwowac tylko graczy w aktywnym pojedynku lub meczu areny.',
...
const sv: Messages = {
  ...
  'moderation.spectateSelf': 'Du kan inte observera dig sjalv.',
  'moderation.spectatePvpOnly': 'Du kan bara observera spelare i en aktiv duell eller arenamatch.',
...
const tr: Messages = {
  ...
  'moderation.spectateSelf': 'Kendini izleyemezsin.',
  'moderation.spectatePvpOnly':
    'Yalnizca aktif bir duello veya arena macindaki oyunculari izleyebilirsin.',
...
const vi: Messages = {
  ...
  'moderation.spectateSelf': 'Ban khong the theo doi chinh minh.',
  'moderation.spectatePvpOnly':
    'Ban chi co the theo doi nguoi choi dang trong mot tran dau tay doi hoac dau truong dang dien ra.',
