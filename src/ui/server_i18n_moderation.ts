...
const en: Messages = {
  ...
  'moderation.freezeConfirm': 'Froze {name}.',
  'moderation.unfreezeConfirm': 'Unfroze {name}.',
  'moderation.frozenNotice': 'You have been frozen by a moderator.',
  'moderation.unfrozenNotice': 'You can move again.',
...
const es: Messages = {
  ...
  'moderation.freezeConfirm': 'Has congelado a {name}.',
  'moderation.unfreezeConfirm': 'Has descongelado a {name}.',
  'moderation.frozenNotice': 'Un moderador te ha congelado.',
  'moderation.unfrozenNotice': 'Ya puedes moverte de nuevo.',
...
const fr: Messages = {
  ...
  'moderation.freezeConfirm': '{name} a été immobilisé.',
  'moderation.unfreezeConfirm': '{name} a été libéré.',
  'moderation.frozenNotice': 'Vous avez été immobilisé par un modérateur.',
  'moderation.unfrozenNotice': 'Vous pouvez de nouveau vous déplacer.',
...
const it: Messages = {
  ...
  'moderation.freezeConfirm': '{name} è stato immobilizzato.',
  'moderation.unfreezeConfirm': '{name} è stato sbloccato.',
  'moderation.frozenNotice': 'Sei stato immobilizzato da un moderatore.',
  'moderation.unfrozenNotice': 'Puoi muoverti di nuovo.',
...
const de: Messages = {
  ...
  'moderation.freezeConfirm': '{name} wurde eingefroren.',
  'moderation.unfreezeConfirm': '{name} wurde wieder freigegeben.',
  'moderation.frozenNotice': 'Ihr wurdet von einem Moderator eingefroren.',
  'moderation.unfrozenNotice': 'Ihr könnt euch wieder bewegen.',
...
const cs: Messages = {
  ...
  'moderation.freezeConfirm': '{name} byl(a) zmrazen(a).',
  'moderation.unfreezeConfirm': '{name} byl(a) rozmrazen(a).',
  'moderation.frozenNotice': 'Moderátor tě zmrazil.',
  'moderation.unfrozenNotice': 'Můžeš se znovu pohybovat.',
...
const zhCN: Messages = {
  ...
  'moderation.freezeConfirm': '已冻结 {name}。',
  'moderation.unfreezeConfirm': '已解冻 {name}。',
  'moderation.frozenNotice': '你已被管理员冻结。',
  'moderation.unfrozenNotice': '你可以再次移动了。',
...
const zhTW: Messages = {
  ...
  'moderation.freezeConfirm': '已凍結 {name}。',
  'moderation.unfreezeConfirm': '已解凍 {name}。',
  'moderation.frozenNotice': '你已被管理員凍結。',
  'moderation.unfrozenNotice': '你可以再次移動了。',
...
const ko: Messages = {
  ...
  'moderation.freezeConfirm': '{name}님을 이동 불가 상태로 만들었습니다.',
  'moderation.unfreezeConfirm': '{name}님의 이동 불가 상태를 해제했습니다.',
  'moderation.frozenNotice': '중재자가 당신을 이동 불가 상태로 만들었습니다.',
  'moderation.unfrozenNotice': '다시 이동할 수 있습니다.',
...
const ja: Messages = {
  ...
  'moderation.freezeConfirm': '{name} をフリーズしました。',
  'moderation.unfreezeConfirm': '{name} のフリーズを解除しました。',
  'moderation.frozenNotice': 'モデレーターによってフリーズされました。',
  'moderation.unfrozenNotice': '再び移動できます。',
...
const pt: Messages = {
  ...
  'moderation.freezeConfirm': '{name} foi congelado.',
  'moderation.unfreezeConfirm': '{name} foi descongelado.',
  'moderation.frozenNotice': 'Você foi congelado por um moderador.',
  'moderation.unfrozenNotice': 'Você pode se mover novamente.',
...
const ru: Messages = {
  ...
  'moderation.freezeConfirm': '{name} заморожен.',
  'moderation.unfreezeConfirm': '{name} разморожен.',
  'moderation.frozenNotice': 'Модератор заморозил вашего персонажа.',
  'moderation.unfrozenNotice': 'Вы снова можете двигаться.',
...
const da: Messages = {
  ...
  'moderation.freezeConfirm': '{name} blev fastfrosset.',
  'moderation.unfreezeConfirm': '{name} blev frigivet.',
  'moderation.frozenNotice': 'Du er blevet fastfrosset af en moderator.',
  'moderation.unfrozenNotice': 'Du kan bevæge dig igen.',
...
const id: Messages = {
  ...
  'moderation.freezeConfirm': '{name} dibekukan.',
  'moderation.unfreezeConfirm': '{name} dicairkan.',
  'moderation.frozenNotice': 'Anda telah dibekukan oleh moderator.',
  'moderation.unfrozenNotice': 'Anda dapat bergerak lagi.',
...
const nl: Messages = {
  ...
  'moderation.freezeConfirm': '{name} is bevroren.',
  'moderation.unfreezeConfirm': '{name} is weer vrijgegeven.',
  'moderation.frozenNotice': 'Je bent bevroren door een moderator.',
  'moderation.unfrozenNotice': 'Je kunt weer bewegen.',
...
const pl: Messages = {
  ...
  'moderation.freezeConfirm': 'Gracz {name} został unieruchomiony.',
  'moderation.unfreezeConfirm': 'Gracz {name} został uwolniony.',
  'moderation.frozenNotice': 'Moderator unieruchomił twoją postać.',
  'moderation.unfrozenNotice': 'Możesz znowu się poruszać.',
...
const sv: Messages = {
  ...
  'moderation.freezeConfirm': '{name} har frysts.',
  'moderation.unfreezeConfirm': '{name} har frigjorts.',
  'moderation.frozenNotice': 'Du har frysts av en moderator.',
  'moderation.unfrozenNotice': 'Du kan röra dig igen.',
...
const tr: Messages = {
  ...
  'moderation.freezeConfirm': '{name} donduruldu.',
  'moderation.unfreezeConfirm': '{name} çözüldü.',
  'moderation.frozenNotice': 'Bir moderatör tarafından donduruldunuz.',
  'moderation.unfrozenNotice': 'Yeniden hareket edebilirsiniz.',
...
const vi: Messages = {
  ...
  'moderation.freezeConfirm': '{name} đã bị đóng băng.',
  'moderation.unfreezeConfirm': '{name} đã được giải phóng.',
  'moderation.frozenNotice': 'Bạn đã bị người kiểm duyệt đóng băng.',
  'moderation.unfrozenNotice': 'Bạn có thể di chuyển trở lại.',
