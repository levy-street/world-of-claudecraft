...
| `weekly_rewards.ts` + `character_storage.ts` | Weekly Vault activity credits, bounded carry-forward rolls, class-filtered loot pools and guarded claims; character storage load/save boundary. Host reset calendar lives in `src/reset_calendar.ts` |
