...
export const MOUNT_LIST: readonly MountDef[] = [
  {
    ...
    flavor: 'The deep parts when you ride — 0.1% of supply.',
    threshold: 1_000_000,
    supplyShare: 0.001,
    speedMult: MOUNT_SPEED_NORMAL,
    flying: false,
    tint: 0x8a7766,
  },
  {
    ...
    flavor: 'Hooves that strike sparks — 1% of supply.',
    threshold: 10_000_000,
    supplyShare: 0.01,
    speedMult: MOUNT_SPEED_EPIC,
    flying: false,
    tint: 0xc2542a,
  },
  {
    ...
    flavor: 'Barded in beaten bronze — 2% of supply.',
  ...
  },
  {
    ...
    flavor: 'A mane like cold moonlight — 3% of supply.',
  ...
  },
  {
    ...
    flavor: 'It runs ahead of the thunder — 4% of supply.',
  ...
  },
  {
    ...
    flavor: 'Winged and gilded — it takes to the air at 5% of supply.',
    threshold: 50_000_000,
    supplyShare: 0.05,
    speedMult: flightSpeedForTier(6),
    flying: true,
    tint: 0xffd24a,
  },
  {
    ...
    flavor: 'A living gale of the deep wood — 6% of supply.',
    threshold: 60_000_000,
    supplyShare: 0.06,
    speedMult: flightSpeedForTier(7),
    flying: true,
    tint: 0x57e0b9,
  },
  {
    ...
    flavor: 'It leaves smoke where the sky was — 7% of supply.',
    threshold: 70_000_000,
    supplyShare: 0.07,
    speedMult: flightSpeedForTier(8),
    flying: true,
    tint: 0x9b6cff,
  },
  {
    ...
    flavor: 'Star-shod, winged in light — 8% of supply.',
    threshold: 80_000_000,
    supplyShare: 0.08,
    speedMult: flightSpeedForTier(9),
    flying: true,
    tint: 0xff5c8a,
  },
  {
    ...
    flavor: 'It carries a piece of the sky — 9% of supply.',
    threshold: 90_000_000,
    supplyShare: 0.09,
    speedMult: flightSpeedForTier(10),
    flying: true,
    tint: 0xff8a4c,
  },
  {
    ...
    flavor: 'The realm bends the knee — the dragon of the 10%.',
    threshold: 100_000_000,
    supplyShare: 0.1,
    speedMult: flightSpeedForTier(11),
    flying: true,
    tint: 0xffe27a,
  },
] as const;
...
export function canSummonMount(
  id: string,
  holderTier: number,
