...
// The Lanternback Troll left this list when the Treasure Casket became its
// player-facing source (src/sim/clue_casket.ts); the Viridian Valestrider
// joined it while its rider fit and locomotion are tuned.
