 ...
 * offhand holds a one-hand WEAPON whose type matches the skin's weaponType (a
 * rogue with two daggers and a dagger skin shows both blades skinned). Shields
 ...
 * are excluded, so the equality check is the whole rule. Pure and
