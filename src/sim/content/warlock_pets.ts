...
export const WARLOCK_PET_MOBS: Record<string, MobTemplate> = {
  imp: {
    ...
    dmgBase: 5, dmgPerLevel: 1.1, attackSpeed: 2.0,
  ...
  voidwalker: {
    ...
    dmgBase: 4, dmgPerLevel: 0.75, attackSpeed: 2.0,
  ...
  succubus: {
    ...
    loot: [], scale: 0.95, color: 0xc6469b,
  },
