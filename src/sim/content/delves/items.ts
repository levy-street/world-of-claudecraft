...
export const DELVE_ITEMS: Record<string, ItemDef> = {
  ...
  reliquary_cloth_chest: {
    ...
    slot: 'chest',
    quality: 'uncommon',
    stats: { armor: 30, int: 2, spi: 1, sta: 1 },
    sellValue: 205,
    requiredClass: MAG,
  },
  reliquary_legs: {
  ...
  varric_shadow_cowl: {
    ...
    slot: 'helmet',
    quality: 'rare',
    stats: { armor: 42, int: 4, spi: 3, sta: 2 },
    sellValue: 540,
    requiredClass: MAG,
  },
  ...
  cantors_drowned_sash: {
    ...
    slot: 'waist',
    quality: 'uncommon',
    stats: { armor: 18, int: 2, spi: 1, sta: 1 },
    sellValue: 205,
    requiredClass: MAG,
  },
  corpse_candle_focus: {
  ...
  litany_cloth_chest: {
    ...
    slot: 'chest',
    quality: 'uncommon',
    stats: { armor: 36, int: 3, spi: 2, sta: 2 },
    sellValue: 250,
    requiredClass: MAG,
  },
  litany_helm: {
    ...
    slot: 'helmet',
    quality: 'uncommon',
    stats: { armor: 32, int: 3, spi: 2, sta: 2 },
    sellValue: 255,
    requiredClass: MAG,
  },
