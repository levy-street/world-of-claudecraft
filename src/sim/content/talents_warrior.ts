...
const SPECS: SpecDef[] = [
  ...
  },
  {
    ...
    mastery: { name: 'Recompense', description: 'Increases all threat you generate by 110% and your armor by 10%. Vanguard: your Stamina is increased by 40% and you gain armor equal to 70% of your Strength.', effect: { global: { threatPct: 1.10 }, stats: { armorPct: 0.10, staPct: 0.40, armorFromStrPct: 0.70 } } },
  },
];
