...
export const GATHER_NODES: GatherNodeDef[] = [
  ...
  },
  {
    ...
    zoneId: 'farshore_isle',
    type: 'wood',
    // Kept inland of the campaign island's real open-sea shallows.
    pos: { x: 1078, z: 58 },
    level: 5,
    tier: 1,
  },
  ...
  },
  {
    ...
    zoneId: 'farshore_isle',
    type: 'herb',
    // Riftfields patch, clear of the Watch Meadow road.
    pos: { x: 995, z: -145 },
    level: 5,
    tier: 1,
  },
  {
    ...
    zoneId: 'farshore_isle',
    type: 'herb',
    // The campaign's Landing meadow is already inland of the open sea.
    pos: { x: 792, z: 22 },
    level: 5,
    tier: 1,
  },
  ...
  // note above for the sweep every spot passed).
  {
    ...
    zoneId: 'farshore_isle',
    type: 'ore',
    // Landing meadow above the ferry harbor.
    pos: { x: 820, z: 0 },
    level: 5,
    tier: 1,
  },
  ...
  },
  {
    ...
    zoneId: 'farshore_isle',
    type: 'wood',
    // Gull Mere's south bank, bundling with the fishing site.
    pos: { x: 886, z: 140 },
    level: 5,
    tier: 1,
  },
  ...
  },
  {
    ...
    zoneId: 'farshore_isle',
    type: 'herb',
    // West meadow off the harbor road.
    pos: { x: 835, z: 75 },
    level: 5,
    tier: 1,
  },
  {
    ...
    zoneId: 'farshore_isle',
    type: 'herb',
    // Gull Mere's north bank, outside its blend footprint.
    pos: { x: 886, z: 90 },
    level: 5,
    tier: 1,
  },
