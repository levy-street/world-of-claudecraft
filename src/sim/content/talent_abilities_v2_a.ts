...
export const TALENT_ABILITIES_V2_A = {
  ...
  healing_stream: {
    ...
    requiresTarget: true,
    targetType: 'friendly',
    effects: [{ type: 'hot', total: 180, duration: 12, interval: 3 }],
  ...
  earth_shield: {
    ...
    requiresTarget: false,
    offGcd: true,
    effects: [{ type: 'selfBuff', kind: 'earth_shield', value: 0.2, duration: 20, charges: 6 }],
    description:
  ...
  unleash_weapon: {
    ...
    school: 'nature',
    requiresTarget: true,
    effects: [{ type: 'unleashWeapon', min: 40, max: 50 }],
    description:
      'Discharges your weapon imbue for $d damage and an effect based on the imbue: threat from Stonebound, a burn from Pyrebrand, or a slow from Rimebound. (Shaman talent)',
  },
  bloodlust: {
    id: 'bloodlust',
    name: 'Storm Chorus',
