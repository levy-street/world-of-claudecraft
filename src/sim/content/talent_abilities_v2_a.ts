...
export const TALENT_ABILITIES_V2_A = {
  ...
  multi_shot: {
    ...
    requiresTarget: true,
    targetType: 'enemy',
    effects: [{ type: 'hunterMultiShot', min: 42, max: 52, radius: 10, softCap: 5 }],
    description:
      'Fires at your target and enemies within 10 yd. Damage is reduced beyond 5 targets. Hitting at least 2 enemies empowers your next Aimed Shot or Rapid Fire to ricochet. (Hunter talent)',
  },
  deterrence: {
    id: 'deterrence',
    name: 'Bristleguard',
