...
// out nothing.
//
// drakemaw_raptor, goblin_rocket_sled, rallycart_rxt, terrorspark_groundshaker,
// and rickshaw_mount are absent, and that absence IS the answer: no live table
// awards any of them (drakemaw_raptor has no acquisition path; the other four
// are dev-grant only). They are the catalog's five SOURCE_PENDING_RULING
// mounts; masterwork:engineering on the professions shelf is a sixth pending
// slot (QA ruling 2026-08-07).
//
...
export const RELIQUARY_PAGES: readonly ReliquaryPageDef[] = freezePageTable([
  ...
  // ---- Horizons shelf (Phase 8): mounts, account weapon skins, deed titles ----
  {
    ...
    // remain (drakemaw_raptor, goblin_rocket_sled, terrorspark_groundshaker)
