...
// out nothing.
//
// drakemaw_raptor, goblin_rocket_sled, and terrorspark_groundshaker are absent,
// and that absence IS the answer: no live table awards any of them. They are
// the catalog's three SOURCE_PENDING_RULING mounts; masterwork:engineering on
// the professions shelf is the fourth pending slot (QA ruling 2026-08-07).
//
