...
export const DUNGEON_MOBS: Record<string, MobTemplate> = {
  ...
  nythraxis_heroic_fallen_captain_aldren: {
    id: 'nythraxis_heroic_fallen_captain_aldren', name: 'Heroic Fallen Captain Aldren', minLevel: 20, maxLevel: 20, family: 'undead',
    elite: true, ccImmune: true,
    hpBase: 520, hpPerLevel: 96, dmgBase: 28, dmgPerLevel: 5.2, attackSpeed: 2.2,
    armorPerLevel: 42, moveSpeed: 7.4, aggroRadius: 18,
    cleave: { radius: 7, mult: 0.75, name: 'Grave-Cleaver' },
    loot: [],
    scale: 1.18, color: 0xbfc7ca,
  },
  nythraxis_heroic_corrupted_priest_malric: {
    id: 'nythraxis_heroic_corrupted_priest_malric', name: 'Heroic Corrupted Priest Malric', minLevel: 20, maxLevel: 20, family: 'undead',
    elite: true, ccImmune: true,
    hpBase: 480, hpPerLevel: 92, dmgBase: 26, dmgPerLevel: 5.0, attackSpeed: 2.3,
    armorPerLevel: 28, moveSpeed: 7.0, aggroRadius: 18,
    ...
    loot: [],
    scale: 1.08, color: 0xd5d0e8,
  },
  nythraxis_heroic_deathstalker_voss: {
    id: 'nythraxis_heroic_deathstalker_voss', name: 'Heroic Deathstalker Voss', minLevel: 20, maxLevel: 20, family: 'undead',
    elite: true, ccImmune: true,
    hpBase: 548, hpPerLevel: 100, dmgBase: 30, dmgPerLevel: 5.4, attackSpeed: 2.1,
    armorPerLevel: 44, moveSpeed: 7.6, aggroRadius: 18,
  ...
  nythraxis_scourge_of_thornpeak_heroic: {
    id: 'nythraxis_scourge_of_thornpeak_heroic', name: 'Nythraxis, Scourge of Thornpeak (Heroic)', minLevel: 20, maxLevel: 20, family: 'undead',
    elite: true, boss: true, ccImmune: true,
    hpBase: (51239 / 2.3) * 3, hpPerLevel: 0, dmgBase: 108, dmgPerLevel: 22.8, attackSpeed: 2.6,
    armorPerLevel: 42, moveSpeed: 10.5, aggroRadius: 22,
    loot: [
      { copper: 150000, chance: 1 },
      { itemId: 'deathless_heartwood', chance: 0.06, rollGroup: 'nythraxis_heroic_drop_1' },
      { itemId: 'crownforged_dreadhelm', chance: 0.164742, rollGroup: 'nythraxis_heroic_drop_1' },
      { itemId: 'nighttalon_crown', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_1' },
      { itemId: 'soulflame_cowl', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_1' },
      { itemId: 'stormcallers_crown', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_1' },
      { itemId: 'nighttalon_shoulderguards', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_1' },
      { itemId: 'soulflame_mantle', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_1' },
      { itemId: 'kingsbane_last_oath', chance: 0.06, rollGroup: 'nythraxis_heroic_drop_2' },
      { itemId: 'crownforged_warspaulders', chance: 0.164742, rollGroup: 'nythraxis_heroic_drop_2' },
      { itemId: 'nighttalon_shoulderguards', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_2' },
      { itemId: 'soulflame_mantle', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_2' },
      { itemId: 'crownforged_dreadhelm', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_2' },
      { itemId: 'nighttalon_crown', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_2' },
      { itemId: 'stormcallers_spaulders', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_2' },
      { itemId: 'crownforged_dreadhelm', chance: 0.17, rollGroup: 'nythraxis_heroic_drop_3' },
      { itemId: 'nighttalon_crown', chance: 0.17, rollGroup: 'nythraxis_heroic_drop_3' },
      { itemId: 'soulflame_cowl', chance: 0.17, rollGroup: 'nythraxis_heroic_drop_3' },
      { itemId: 'stormcallers_crown', chance: 0.17, rollGroup: 'nythraxis_heroic_drop_3' },
      { itemId: 'nighttalon_shoulderguards', chance: 0.16, rollGroup: 'nythraxis_heroic_drop_3' },
      { itemId: 'soulflame_mantle', chance: 0.16, rollGroup: 'nythraxis_heroic_drop_3' },
      { itemId: 'soulflame_mantle', chance: 0.17, rollGroup: 'nythraxis_heroic_drop_4' },
      { itemId: 'crownforged_warspaulders', chance: 0.17, rollGroup: 'nythraxis_heroic_drop_4' },
      { itemId: 'nighttalon_shoulderguards', chance: 0.17, rollGroup: 'nythraxis_heroic_drop_4' },
      { itemId: 'stormcallers_spaulders', chance: 0.17, rollGroup: 'nythraxis_heroic_drop_4' },
      { itemId: 'crownforged_dreadhelm', chance: 0.16, rollGroup: 'nythraxis_heroic_drop_4' },
      { itemId: 'nighttalon_crown', chance: 0.16, rollGroup: 'nythraxis_heroic_drop_4' },
      { itemId: 'deathless_heartwood', chance: 0.06, rollGroup: 'nythraxis_heroic_drop_5' },
      { itemId: 'crownforged_dreadhelm', chance: 0.164742, rollGroup: 'nythraxis_heroic_drop_5' },
      { itemId: 'nighttalon_crown', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_5' },
      { itemId: 'soulflame_cowl', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_5' },
      { itemId: 'stormcallers_crown', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_5' },
      { itemId: 'nighttalon_shoulderguards', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_5' },
      { itemId: 'soulflame_mantle', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_5' },
      { itemId: 'kingsbane_last_oath', chance: 0.06, rollGroup: 'nythraxis_heroic_drop_6' },
      { itemId: 'crownforged_warspaulders', chance: 0.164742, rollGroup: 'nythraxis_heroic_drop_6' },
      { itemId: 'nighttalon_shoulderguards', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_6' },
      { itemId: 'soulflame_mantle', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_6' },
      { itemId: 'crownforged_dreadhelm', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_6' },
      { itemId: 'nighttalon_crown', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_6' },
      { itemId: 'stormcallers_spaulders', chance: 0.155052, rollGroup: 'nythraxis_heroic_drop_6' },
    ],
    scale: 3.1, color: 0x160f24,
  },
};
...
const NYTHRAXIS_HEROIC_RAID_SPAWN_LIST: DungeonSpawn[] = [
  { mobId: 'nythraxis_scourge_of_thornpeak_heroic', x: 0, z: 96 },
];
...
export const DUNGEON_DEFS: Record<string, DungeonDef> = {
  ...
  nythraxis_heroic_boss_arena: {
    id: 'nythraxis_heroic_boss_arena',
    ...
    entry: { x: 0, z: 4 },
    exitOffset: { x: 0, z: -6 },
    spawns: NYTHRAXIS_HEROIC_RAID_SPAWN_LIST,
    objects: [
      { itemId: 'bastion_ward_stone', name: 'North Wardstone', x: 0, z: 124 },
      { itemId: 'bastion_ward_stone', name: 'Northeast Wardstone', x: 23, z: 119 },
      { itemId: 'bastion_ward_stone', name: 'East Wardstone', x: 32, z: 96 },
      { itemId: 'bastion_ward_stone', name: 'Southeast Wardstone', x: 23, z: 73 },
      { itemId: 'bastion_ward_stone', name: 'South Wardstone', x: 0, z: 68 },
      { itemId: 'bastion_ward_stone', name: 'Southwest Wardstone', x: -23, z: 73 },
      { itemId: 'bastion_ward_stone', name: 'West Wardstone', x: -32, z: 96 },
      { itemId: 'bastion_ward_stone', name: 'Northwest Wardstone', x: -23, z: 119 },
    ],
    interior: 'nythraxis',
    suggestedPlayers: 10,
