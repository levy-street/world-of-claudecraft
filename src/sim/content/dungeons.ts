...
export const DUNGEON_DEFS: Record<string, DungeonDef> = {
  ...
  nythraxis_boss_arena: {
    ...
    objects: [
      ...
      // wardstone search radius (see nythraxisWardstones in encounters/nythraxis.ts).
      { itemId: 'nythraxis_wardstone', name: 'Left Wardstone', x: -40, z: 79 },
      { itemId: 'nythraxis_wardstone', name: 'Right Wardstone', x: 40, z: 79 },
      { itemId: 'nythraxis_wardstone', name: 'Threshold Wardstone', x: 0, z: 63 },
    ],
    interior: 'nythraxis',
    suggestedPlayers: 10,
