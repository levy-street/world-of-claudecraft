...
export const DUNGEON_MOBS: Record<string, MobTemplate> = {
  ...
  morthen: {
    ...
    loot: [
      ...
      { itemId: 'crypt_refinement_shard', chance: 0.55 },
    ],
  ...
  knight_commander_olen: {
    ...
    loot: [
      ...
      { itemId: 'crypt_refinement_shard', chance: 0.45 },
  ...
  vael_the_mistcaller: {
    ...
    loot: [
      ...
      { itemId: 'bastion_ward_core', chance: 0.50 },
    ],
  ...
  korgath_the_bound: {
    ...
    loot: [
      ...
      { itemId: 'bastion_ward_core', chance: 0.45 },
    ],
  ...
  grand_necromancer_velkhar: {
    ...
    loot: [
      ...
      { itemId: 'gravewyrm_ember', chance: 0.40 },
    ],
  ...
  korzul_the_gravewyrm: {
    ...
    loot: [
      ...
      { itemId: 'gravewyrm_ember', chance: 0.35 },
    ],
