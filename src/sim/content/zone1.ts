...
export const ZONE1_QUESTS: Record<string, QuestDef> = {
  ...
  q_skyward_first_flight: {
    id: 'q_skyward_first_flight',
    name: 'First Flight',
    giverNpcId: 'skytrial_master',
    turnInNpcId: 'skytrial_master',
    ...
    completionText:
      'You did not fall. That is more than most manage on a first loop. The sky remembers who keeps coming back.',
    objectives: [
      {
        type: 'finish_course',
  ...
  q_skyward_time_trial: {
    ...
    completionText:
      'A clean line, ring to ring. You are not riding the sky any longer — you are flying it.',
    objectives: [
      {
        type: 'finish_course',
        courseId: 'skytrial_vale',
    ...
    copperReward: 2500,
    itemRewards: {},
    requiresQuest: 'q_skyward_first_flight',
    minLevel: 7,
  },
  q_skyward_ascendant: {
    id: 'q_skyward_ascendant',
    name: 'Ascendant',
    giverNpcId: 'skytrial_master',
    turnInNpcId: 'skytrial_master',
    ...
    completionText:
      'Skyward and unbroken. The sky is yours now, $N. Take this charter — a steed of the air, earned and not bought, to carry you wherever you mean to go.',
    objectives: [
      {
        type: 'finish_course',
    ...
    copperReward: 50000,
    itemRewards: {
      warrior: 'charter_goldcrest',
      mage: 'charter_goldcrest',
      rogue: 'charter_goldcrest',
    },
    requiresQuest: 'q_skyward_time_trial',
    minLevel: 8,
  },
};
