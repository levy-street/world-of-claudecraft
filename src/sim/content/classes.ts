...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  holy_fire: {
    ...
    description: 'Consumes the enemy in holy flame for $d Holy damage plus a burn over 8 sec.',
  },
  ...
  lesser_healing_wave: {
    ...
    description: 'A quick surge of water that heals a friendly target for $d.',
  },
  stormstrike: {
    id: 'stormstrike',
    name: 'Stormstrike',
