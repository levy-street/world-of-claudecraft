...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  heroic_leap: {
    ...
    description:
      'Leap to the target area, dealing $d Physical damage to nearby enemies. (Warrior talent)',
  },
  pummel: {
    id: 'pummel',
    name: 'Pummel',
  ...
  // ============== TALENT-GRANTED (Mage) ==============
  // Not in CLASSES.mage.abilities. Unlocked only via choice-row grants.
  counterspell: {
    id: 'counterspell',
    name: 'Counterspell',
    class: 'mage',
  ...
  // ============== TALENT-GRANTED (Choice rows PR5) ==============
  // Not in CLASSES.*.abilities. Unlocked only via choice-row grants.
  rebuke: {
    id: 'rebuke',
    name: 'Rebuke',
    class: 'paladin',
