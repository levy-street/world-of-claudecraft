...
export const COMMON_RECIPES: ProfessionRecipeRecord[] = [
  ...
  {
    id: 'recipe_bronzeclasp_gauntlets',
    professionId: 'armorcrafting',
    resultItemId: 'bronzeclasp_gauntlets',
    resultCount: 1,
    reagents: [
      { itemId: 'bronze_bar', count: 2 },
  ...
  },
  {
    id: 'recipe_tin_bar',
    professionId: 'weaponcrafting',
    resultItemId: 'tin_bar',
    resultCount: 1,
    reagents: [{ itemId: 'tin_ore', count: 2 }],
    skillReq: 0,
    trivialAt: 25,
    itemLevelBudget: 1,
  },
  ...
  {
    id: 'recipe_clawspur_dirk',
    professionId: 'weaponcrafting',
    resultItemId: 'clawspur_dirk',
    resultCount: 1,
    reagents: [
      { itemId: 'bronze_bar', count: 2 },
      { itemId: 'ashwood_log', count: 1 },
      { itemId: 'beast_claw', count: 1 },
    ],
    skillReq: 0,
    trivialAt: 25,
    itemLevelBudget: 9,
