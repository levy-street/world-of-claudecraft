...
export const ZONE2_ITEMS: Record<string, ItemDef> = {
  ...
  fenmist_robe: {
    ...
    slot: 'chest',
    quality: 'uncommon',
    stats: { armor: 45, int: 5, spi: 3, sta: 2 },
    sellValue: 350,
    requiredClass: MAG,
  },
  eelskin_tunic: {
  ...
  broodmother_silk_robe: {
    ...
    slot: 'chest',
    quality: 'uncommon',
    stats: { armor: 42, int: 4, spi: 2, sta: 1 },
    sellValue: 300,
    requiredClass: MAG,
  },
  ...
  nhalias_funeral_wraps: {
    ...
    slot: 'legs',
    quality: 'uncommon',
    stats: { armor: 48, int: 5, spi: 2, sta: 2 },
    sellValue: 480,
    requiredClass: MAG,
  },
  fen_reaver_glaive: {
  ...
  drowned_prayer_leggings: {
    ...
    slot: 'legs',
    quality: 'rare',
    stats: { armor: 48, int: 6, spi: 4, sta: 3 },
    sellValue: 1100,
    requiredClass: MAG,
  },
  drowned_prayer_sandals: {
    ...
    slot: 'feet',
    quality: 'rare',
    stats: { armor: 42, int: 5, spi: 3, sta: 2 },
    sellValue: 1100,
    requiredClass: MAG,
  },
  eelscale_leggings: {
  ...
  fenbark_leggings: {
    ...
    stats: { armor: 48, int: 3, spi: 1, sta: 1 },
    sellValue: 320,
  },
  mirebloom_treads: {
    id: 'mirebloom_treads',
    ...
    stats: { armor: 28, int: 2, spi: 1, sta: 1 },
    sellValue: 300,
  },
  fenwarden_sabatons: {
    ...
    stats: { armor: 42, int: 2, spi: 1, sta: 1 },
    sellValue: 310,
  },
  marshlight_hauberk: {
    ...
    stats: { armor: 110, int: 3, spi: 2, sta: 2 },
    sellValue: 380,
  },
  duskthorn_mantle: {
    id: 'duskthorn_mantle',
    ...
    stats: { armor: 34, int: 3, spi: 1, sta: 1 },
    sellValue: 340,
  },
  fenshadow_maul: {
    id: 'fenshadow_maul',
