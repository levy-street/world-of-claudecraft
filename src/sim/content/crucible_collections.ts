...
export const CRUCIBLE_SIGNATURE_TEXT: Record<CrucibleCollectionRole, string> = {
  ...
  healer:
    "While you and the healed ally are in combat, 20% of your overhealing shields that ally for 6 sec, including healing over time and damage converted into healing. Protection from all wearers is limited to 5% of the ally's maximum health. Additional overhealing fills the shield without extending its duration. This protection does not trigger other healing effects. Your shields end when you or the shielded ally leave combat, or when you stop wearing two pieces of this collection.",
};
