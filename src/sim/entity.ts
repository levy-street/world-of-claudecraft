...
export function recalcPlayerStats(
  ...
  // +25%; a spec mastery's passive haste (#1543) adds on its own channel (meleeHastePct
  // on melee, spellHastePct on spell casts). The cast-time tooltips read the same total.
