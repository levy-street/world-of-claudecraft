...
// undefeated), and send-home (returnFromArena, everyone), and which the
// SimContext seam (ctx.resetForArena) hands to modules that never name
// readyArenaFighter: the Protect Yumi match seat, and the Vale Cup
