 ...
 * unwritable) and the one SOURCE_PENDING_RULING mount (reins_terrorspark_groundshaker
 * is dev-grant only; reins_drakemaw_raptor left the list when it joined the
 * Mirefen world boss's table). Both are owner decisions outside this packet; the
 * capstone becomes earnable with NO code change here once they both land.
