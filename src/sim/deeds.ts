 ...
 *  still own. Sim.addPlayer calls this only while the CharacterState migration
 *  latch is not literal true; every save then stamps the latch, so later
 *  transferred holdings can never be laundered by a relog.
 *
