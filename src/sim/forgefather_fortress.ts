...
export const FORGEFATHER_FORTRESS_PLACEMENTS: readonly IgnivarPropPlacement[] = [
  ...
  // the dune-fork road's terminus. Appended verbatim from the export;
  // every earlier row is byte-identical to the first pass.
  // ---------------------------------------------------------------------
  ...
  { key: 'fortress_wall', x: 441.15, y: 3, z: 2145.1, ry: 180 * DEG, scale: 8 },
  { key: 'tower_pillar', x: 436.3, y: 1.9, z: 2145.35, ry: 135 * DEG, scale: 9 },
  { key: 'fortress_wall', x: 444.65, y: 3, z: 2151.1, ry: 90 * DEG, scale: 8 },
  { key: 'tower_pillar', x: 460.4, y: 1.9, z: 2154.6, ry: 195 * DEG, scale: 9 },
