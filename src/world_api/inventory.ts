...
export interface IWorldInventory {
   ...
   *  window read the worn state off `equipmentInstances` (a damaged copy
   *  carries `durability`; an undamaged one carries no field), so no new data
   *  member rides the wire for this. */
