...
// The action-bar "forms" a character can arrange independently: the base bar,
// the druid Bear/Cat/Cat-stealth kits, the rogue Stealth bar, the retired Vale
// Cup sport bar, and the fork's deepball bar. This is the full sibling set the
// localStorage keys cover. 'sport' stays after upstream retired the Vale Cup
// for the same reason the vcup standings did: an existing character's stored
// layout under that key must still read rather than throw.
