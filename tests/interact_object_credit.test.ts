...
describe('every multi-count interact objective has enough distinct objects to finish', () => {
  ...
  it('places every interact target in the world, a dungeon, or the riding-lesson sentinel', () => {
    ...
    // the ledger. Anything ELSE missing from both placement registries would
    // mean an objective whose object spawns somewhere this reasoning has not checked.
