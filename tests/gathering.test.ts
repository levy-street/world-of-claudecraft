...
describe('isHarvestableCorpse', () => {
  ...
  it('answers for every shipped template, and none is excluded any more', () => {
    ...
    // shoal_scuttler once it gained a mapped tag.) 186 with the Mirefen world boss:
    // Balgath is carved stone, so he has no componentTags and is not skinnable, which
    // is the same reason every other boss sits here.
