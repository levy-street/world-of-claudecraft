...
describe('isHarvestableCorpse', () => {
  ...
  it('answers for every shipped template, and none is excluded any more', () => {
    ...
    // ...and the untagged templates are counted rather than assumed: 191 of
    ...
    // shoal_scuttler once it gained a mapped tag: 185. The Last Bell packet
    // then lands its Farshore breach trash, Fisher Bram and the squad actors
    // untagged, a net of six once the packet's tagged mobs are excluded: 191.)
