...
describe('isHarvestableCorpse', () => {
  ...
  it('answers for every shipped template, and none is excluded any more', () => {
    ...
    // shoal_scuttler once it gained a mapped tag.) 186 with the Mirefen boss: he is carved
    // stone, so he carries no componentTags and is not skinnable, the same reason every
    // other boss sits here. (It was briefly 187 while a second candidate body was in the
    // design bake-off; that one lost and is deleted.)
