...
describe('audited launch totals (literals: update deliberately with the catalog)', () => {
  it('ships exactly 274 deeds worth 3225 total Renown', () => {
    ...
    // The Demon Tower appends three dungeon deeds worth 80 Renown.
  ...
  it('ships the audited per-category counts', () => {
    ...
    expect(byCategory).toEqual({
      progression: 57,
      combat: 10,
      // +2 Rift coverage deeds and +3 Demon Tower deeds.
      dungeon: 34,
      delve: 13,
      chronicle: 49,
...
describe('frozen trigger + renown catalog (design rule 9: never retro-edit a trigger)', () => {
  ...
  const FROZEN_CATALOG_SHA256 = 'c4e00c4fad1156c511bd1e7de7d61c865b275eb6dfdac553f71baee91b117248';
...
describe('table shape', () => {
  it('DEED_ORDER holds the append-only authored order (first and last pinned)', () => {
    ...
    // The Demon Tower deeds append after the release catalog.
