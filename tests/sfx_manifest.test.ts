...
describe('buildManifest', () => {
  ...
  it('keeps the release catalog, all 14 mount cues, and all 62 UI cues in one 269-key inventory', () => {
    ...
    for (const key of [
      ...
      // the Riftbound Boulder: a stone grinding over ground rather than a
      // stride, so it is a roll bed and not a footfall
