...
describe('buildManifest', () => {
  ...
  it('keeps the release catalog, all 10 mount cues, the sled summon call, and all 63 UI cues in one 279-key inventory', () => {
    ...
    expect(SFX_FIXED_CATALOG_KEYS).toHaveLength(279);
  });
});
