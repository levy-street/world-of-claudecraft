...
describe('buildManifest', () => {
  ...
  it('keeps the release catalog, all 10 mount cues, and all 63 UI cues in one 266-key inventory', () => {
    // 266th: mount_run_verdant_valorsteed, the refer-a-friend tier-5 reskin's
    // gallop (a byte copy of the valorsteed clip; docs/prd/refer-a-friend.md).
    ...
    // 266 since mount_run_verdant_valorsteed (the refer-a-friend reskin gallop).
