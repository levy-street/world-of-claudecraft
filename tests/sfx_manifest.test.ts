...
describe('buildManifest', () => {
  ...
  it('keeps the release catalog, mount/UI cues, and signature performances in one 304-key inventory', () => {
    ...
    expect(SFX_FIXED_CATALOG_KEYS).toHaveLength(304);
  });
});
