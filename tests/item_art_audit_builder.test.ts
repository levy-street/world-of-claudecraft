...
describe('item-art audit builder', () => {
  ...
  it('exposes the fresh-checkout rebuild and explicit verdict-refresh CLI', () => {
    ...
    expect(verified).toMatchObject({
      ...
      catalogSha256: '9cf703ca2e6a362b7836aa010eb61c6d4fa8cd0678bba35d6bf3bad328f48fe1',
      catalogBytes: 460927,
      ...
      sheetSetSha256: null,
      shippingCatalogSha256: '240d3a0557bbc85b19127e996151dd8b820af8cd3a70af959984db051fb6b9a4',
