...
describe('item-art audit builder', () => {
  ...
  it('exposes the fresh-checkout rebuild and explicit verdict-refresh CLI', () => {
    ...
    expect(verified).toMatchObject({
      ...
      catalogSha256: '6c3f7975c5425e7f8a69e43c70621a8c6c2a2f4789d76ec46862e76e467ec0f3',
      catalogBytes: 481727,
      ...
      sheetPageCount: 28,
      sheetCount: 224,
      sheetModeCounts: Object.fromEntries(ITEM_ART_AUDIT_MODES.map((mode) => [mode, 28])),
      sheetSetSha256: null,
      shippingCatalogSha256: '83fff3d8685ea8ac1ea6d470773cf16f03c1e8ce44d9903391ba93bcc3e2b227',
