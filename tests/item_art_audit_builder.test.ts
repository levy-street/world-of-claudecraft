...
describe('item-art audit builder', () => {
  ...
  it('exposes the fresh-checkout rebuild and explicit verdict-refresh CLI', () => {
    ...
    expect(verified).toMatchObject({
      ...
      catalogSha256: '18ff863218a06da7dc88fae12fa067e7fbacb7579d1a6e37cd0362c15ff8b0fc',
      catalogBytes: 454391,
      ...
      sheetSetSha256: null,
      shippingCatalogSha256: '87fa60c4a44fef1de789aec555b382851b7cabe304a8befb46449ffd50d06e72',
