...
const EXPECTED_SEND_COUNT = 134; // +Season 1 Armory skin and Book of Deeds title commands
const EXPECTED_DISPATCH_COUNT = 143; // +Season 1 Armory skin and Book of Deeds title commands
