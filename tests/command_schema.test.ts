...
const EXPECTED_SEND_COUNT = 138; // +Season 1 Armory skin and ignore_add/ignore_remove
const EXPECTED_DISPATCH_COUNT = 147; // +Season 1 Armory skin and ignore_add/ignore_remove
