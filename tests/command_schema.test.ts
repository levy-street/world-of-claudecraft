...
const EXPECTED_SEND_COUNT = 145; // +Season 1 Armory skin, ignore_add/ignore_remove, Dungeon Finder
const EXPECTED_DISPATCH_COUNT = 154; // +Season 1 Armory skin, ignore_add/ignore_remove, Dungeon Finder
