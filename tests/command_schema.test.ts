...
const EXPECTED_SEND_COUNT = 152; // +Season 1 Armory skin, ignore_add/ignore_remove, stow_weapon, Dungeon Finder, inv_move, Card Duel minigame (card_queue_join/leave, play_card, card_forfeit), trade_decline
const EXPECTED_DISPATCH_COUNT = 161; // +Season 1 Armory skin, ignore_add/ignore_remove, stow_weapon, Dungeon Finder, inv_move, Card Duel minigame (card_queue_join/leave, play_card, card_forfeit), trade_decline
