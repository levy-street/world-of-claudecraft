...
const EXPECTED_SEND_COUNT = 149; // +Season 1 Armory skin, ignore_add/ignore_remove, stow_weapon, Dungeon Finder, inv_move, market_bid, trade_decline
const EXPECTED_DISPATCH_COUNT = 158; // +Season 1 Armory skin, ignore_add/ignore_remove, stow_weapon, Dungeon Finder, inv_move, market_bid, trade_decline
