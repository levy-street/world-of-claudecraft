...
const EXPECTED_SEND_COUNT = 148; // +Season 1 Armory skin, ignore_add/ignore_remove, stow_weapon, Dungeon Finder, inv_move, trade_decline
const EXPECTED_DISPATCH_COUNT = 157; // +Season 1 Armory skin, ignore_add/ignore_remove, stow_weapon, Dungeon Finder, inv_move, trade_decline
