...
const EXPECTED_SEND_COUNT = 140; // +bank deposit/withdraw/buy-slots, Vale Cup, town focus, Dungeon Finder
const EXPECTED_DISPATCH_COUNT = 149; // +bank deposit/withdraw/buy-slots, Vale Cup, town focus, Dungeon Finder
