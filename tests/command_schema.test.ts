...
const EXPECTED_SEND_COUNT = 137; // +Season 1 Armory skin, ignore_add/ignore_remove, inv_move
const EXPECTED_DISPATCH_COUNT = 146; // +Season 1 Armory skin, ignore_add/ignore_remove, inv_move
