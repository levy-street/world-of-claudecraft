...
const EXPECTED_SEND_COUNT = 178; // +4 toolbelt commands (equip/unequip/store/take)
const EXPECTED_DISPATCH_COUNT = 190; // +4 toolbelt commands (equip/unequip/store/take)
