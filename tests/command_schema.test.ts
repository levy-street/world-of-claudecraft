...
const EXPECTED_SEND_COUNT = 137; // +Season 1 Armory skin and ignore_add/ignore_remove
const EXPECTED_DISPATCH_COUNT = 146; // +Season 1 Armory skin and ignore_add/ignore_remove
