...
describe('item webp icons', () => {
  it('has image-backed item ids wired (guards the fixture)', () => {
    ...
    // 125: the world boss's signature maul, then Skerrit's Shardpike, whose quest tool got
    // its own held model (src/ui/weapon_variants.ts) and therefore its own painted icon.
