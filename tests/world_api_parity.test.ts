...
//
// `IWorld` (src/world_api.ts:341-510, 143 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (143 / 36 / 107)
...
// The 143 members of `interface IWorld`, in interface order (world_api.ts:342-509).
// Partition: 36 `data` + 107 `method` (98 command-void + 6 read-returning + 2 async).
...
//   (4) their union, sorted, equals the pinned 143-name IWORLD_MEMBERS set (a member
