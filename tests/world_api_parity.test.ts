...
// it lands the matching edit here in the SAME commit. The count pins (238 / 63 / 175)
...
// Partition: 63 `data` + 175 `method` (read-returning + command-void + async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 28 facets', () => {
  ...
  it('the union of the 28 facets equals the pinned 238-member IWORLD_MEMBERS set', () => {
