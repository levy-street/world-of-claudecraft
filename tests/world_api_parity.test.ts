...
// it lands the matching edit here in the SAME commit. The count pins (221 / 60 / 161)
...
// Partition: 60 `data` + 161 `method` (read-returning + command-void + async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  it('pins total / data / method counts', () => {
    ...
    expect(METHOD_MEMBERS.length).toBe(161);
  });
  ...
  it('the sorted method-kind set is exactly the pinned 161', () => {
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 26 facets', () => {
  ...
  it('the union of the 26 facets equals the pinned 221-member IWORLD_MEMBERS set', () => {
