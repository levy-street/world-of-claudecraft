...
//
// `IWorld` (src/world_api.ts, 213 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (213 / 58 / 155)
...
// The 213 members of `interface IWorld`, in interface order (world_api.ts).
// Partition: 58 `data` + 155 `method` (read-returning + command-void + async).
...
//   (4) their union, sorted, equals the pinned 213-name IWORLD_MEMBERS set (a member
