...
//
// `IWorld` (src/world_api.ts, 207 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (207 / 56 / 151)
...
// The 207 members of `interface IWorld`, in interface order (world_api.ts).
// Partition: 56 `data` + 151 `method` (read-returning + command-void + async).
...
//   (4) their union, sorted, equals the pinned 207-name IWORLD_MEMBERS set (a member
