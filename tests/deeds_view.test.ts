...
describe('real catalog integration', () => {
  it('pins the fresh-character completion denominator of the live catalog', () => {
    ...
    // 276 deeds - 11 feats - 9 hidden = 256 visible to a fresh character (the
    ...
    // denominator; col_reliquary_complete and the seven pvp_fiesta_* deeds
    ...
    expect(view.summary.visibleTotal).toBe(256);
