...
// @ts-expect-error -- shared zero-dep JS build tool intentionally has no declaration file.
import * as modulepreload from '../scripts/i18n_modulepreload.mjs';
const {
  PLACEHOLDER,
  GENERATED_DIR,
...
describe('i18n modulepreload build hook', () => {
  ...
  describe('templateModulepreload (FS orchestrator the Vite writeBundle plugin calls)', () => {
