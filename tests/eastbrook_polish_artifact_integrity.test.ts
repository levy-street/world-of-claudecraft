...
// renderer.ts into src/render/mount_ride_view.ts. The captures remain unchanged
// and were not retaken.
const ACCEPTED_POLISH_V2_METADATA_SHA256 =
  'f74e03678eea58aa6d94dd03cf22ef473aeaf69f1d495669325979a29147159a';
...
describe('Eastbrook polish performance and contact evidence', () => {
  it('pins the accepted matched performance evidence byte for byte', () => {
    ...
    // Re-minted after the ridden-mount drive moved into
    // src/render/mount_ride_view.ts: the first-order composite follows
    // renderer.ts, then this second-order seal follows the swept evidence
    // bytes. No capture was retaken.
    expect(
      fingerprint.digest('hex'),
      `the second-order performance digest moved; if every input moved legitimately, re-mint with: ${REMINT_COMMAND} (it recomputes this literal LAST, from the swept files)`,
    ).toBe('e6ffab898a13bc0272eb3070c3ae8e91c885eb25705ce0f081d62bb64b1aa05b');
  });
