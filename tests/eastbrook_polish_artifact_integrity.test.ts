...
const ACCEPTED_POLISH_V2_METADATA_SHA256 =
  '6d4c863f175d1617ecd1c1dcee8e2fcf7e25a17c51e6962aa49770d2072a68f5';
...
describe('Eastbrook polish performance and contact evidence', () => {
  it('pins the accepted matched performance evidence byte for byte', () => {
    ...
    expect(
      ...
      // GPU timer probe: recomputed LAST over the swept evidence after the
      // renderer leaf moved. No capture was retaken.
    ).toBe('0535826a896f071e237971c4a76db09e4f1ff780795a3a33e3c76e25e940c4bf');
  });
