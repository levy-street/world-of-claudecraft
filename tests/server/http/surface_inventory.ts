...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  // Gold conservation queue (Economy Watch): registry-only RouteDefs born after
  // the migration, the same new-route rule as the ad-spend rows above.
  {
    dispatcher: DISPATCH.admin,
    method: 'GET',
    path: '/admin/api/economy/alerts',
    handler: 'server/economy_admin.ts openQueueHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/economy_admin.ts characterAlertsHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/economy_admin.ts ledgerHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/economy_admin.ts ackHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
