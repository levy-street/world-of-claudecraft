...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  // Plugin store family (server/plugins_routes.ts): registry-only RouteDefs,
  // the deeds/steam new-route rule. The :param rows carry NO `match` regex (no
  // legacy arm exists); the freshness gate validates them against the
  // registry's own path templates instead.
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/plugins',
    handler: 'server/plugins_routes.ts catalogHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: 'rateLimit(PUBLIC_READ_POLICY)',
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    ...
    handler: 'server/plugins_routes.ts installedHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.bearer,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/plugins_routes.ts mineHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.bearer,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    method: 'GET',
    path: '/api/plugins/:id',
    handler: 'server/plugins_routes.ts detailHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: 'rateLimit(PUBLIC_READ_POLICY)',
    requireOwnedExpected: REQUIRE_OWNED.publicRead,
  },
  {
    ...
    method: 'POST',
    path: '/api/plugins',
    handler: 'server/plugins_routes.ts createHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'pluginMutationRateLimited',
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    ...
    handler: 'server/plugins_routes.ts submitVersionHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'pluginMutationRateLimited',
    requireOwnedExpected: REQUIRE_OWNED.bola404,
  },
  {
    ...
    handler: 'server/plugins_routes.ts installHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'pluginMutationRateLimited',
    requireOwnedExpected: REQUIRE_OWNED.publicRead,
  },
  {
    ...
    method: 'DELETE',
    path: '/api/plugins/:id/install',
    handler: 'server/plugins_routes.ts uninstallHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'pluginMutationRateLimited',
    requireOwnedExpected: REQUIRE_OWNED.publicRead,
  },
  {
    ...
    method: 'DELETE',
    path: '/api/plugins/:id',
    handler: 'server/plugins_routes.ts deleteHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'pluginMutationRateLimited',
    requireOwnedExpected: REQUIRE_OWNED.bola404,
  ...
  // Plugin store moderation (dual-arm like maps/user-assets: ladder arms in
  // handleAdminApi plus RouteDef twins, both calling the shared cores). The
  // (delist|relist) regex arm registers as two literal-suffix RouteDefs, so it
  // carries two rows sharing one match source.
  {
    dispatcher: DISPATCH.admin,
    method: 'GET',
    path: '/admin/api/plugins',
    handler: 'handleAdminApi arm: /admin/api/plugins',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleAdminApi arm: /admin/api/plugins/pending',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'pluginReviewMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/plugins\/versions\/(\d+)\/review$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
    path: '/admin/api/plugins/:id/delist',
    handler: 'pluginListedMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/plugins\/(\d+)\/(delist|relist)$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
