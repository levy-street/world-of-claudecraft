...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  },
  {
    ...
    handler: 'handleInternalApi arm: /internal/onchain-event',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.secretOnchain,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleInternalApi arm: /internal/onchain/feed',
    contentType: PROBLEM_JSON,
