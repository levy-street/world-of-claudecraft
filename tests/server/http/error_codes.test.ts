...
const EXPECTED_CODES = [
  ...
  'governance.already_voted',
  'governance.bad_signature',
  'governance.balance_unavailable',
  'governance.challenge_invalid',
  'governance.disabled',
  'governance.forbidden',
  'governance.invalid_input',
  'governance.not_found',
  'governance.wallet_mismatch',
  'governance.wallet_not_linked',
