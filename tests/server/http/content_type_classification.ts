...
export const API_CONTENT_TYPE: Readonly<Record<string, ContentTypeClass>> = {
  ...
  '/api/plugins': PROBLEM_JSON,
  '/api/plugins/installed': PROBLEM_JSON,
  '/api/plugins/mine': PROBLEM_JSON,
  '/api/plugins/:id': PROBLEM_JSON,
  '/api/plugins/:id/versions': PROBLEM_JSON,
  '/api/plugins/:id/install': PROBLEM_JSON,
  '/api/assets': BINARY,
