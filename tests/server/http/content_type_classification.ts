...
export const API_CONTENT_TYPE: Readonly<Record<string, ContentTypeClass>> = {
  ...
  '/api/dexswap/config': PROBLEM_JSON,
  '/api/dexswap/quote': PROBLEM_JSON,
  '/api/dexswap/swap': PROBLEM_JSON,
  '/api/tradingbots/config': PROBLEM_JSON,
  '/api/tradingbots/status': PROBLEM_JSON,
  '/api/tradingbots/subscribe': PROBLEM_JSON,
  '/api/tradingbots/subscribe/confirm': PROBLEM_JSON,
  '/api/tradingbots/deposit': PROBLEM_JSON,
  '/api/tradingbots/deposit/confirm': PROBLEM_JSON,
  '/api/tradingbots/withdraw': PROBLEM_JSON,
  '/api/tradingbots/control': PROBLEM_JSON,
