...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // Re-pinned at the v0.41.0 sync into the rickshaw branch: the release's
    // arm (the entry-horizon cull and the ground-aim reticle pass-through)
    // and this branch's mount rendering both land in the merged file.
