...
describe('Reliquary Conqueror catalog structure', () => {
  ...
  it('pins the catalog totals through the production completion math', () => {
    ...
    // Wildheart Basin, boneglass_shiv on Spoils): 340, plus the dev-only
    // Cluckwork Mech Bird mount slot (2026-08-21): 341. Catalog growth reverts
  ...
  it('pins the final measured catalog shape: total slots and distinct marks', () => {
    ...
    // three daggers the v0.36.0 release merge added to live content, plus the
    // dev-only Cluckwork Mech Bird mount slot: 376 total.
...
const SOURCE_PENDING_RULING: Readonly<Record<string, readonly string[]>> = {
  ...
  // mech_bird: dev-grant only, the tank's sibling; same deliberate absence.
  horizons_mounts: ['drakemaw_raptor', 'terrorspark_groundshaker', 'mech_bird'],
