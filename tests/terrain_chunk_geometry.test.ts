...
describe('generated chunk geometry is stable', () => {
  ...
  it('pins every vertex attribute of the Eastbrook chunks for seed 20061', async () => {
    ...
    // tree).
    // Re-minted again for the world-quest ground objects: their standard calm
    // anchors seat the Eastbrook freight crate and wagon on workable ground.
    expect(digestOf(inRect)).toBe('034fe8c22a222adac06adbccb42baa2f');
