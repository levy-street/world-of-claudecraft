...
function makeCtx() {
  ...
  const host: SimContextHost = {
    ...
    fiestaDown: vi.fn(),
    allocateProceduralItemUid: vi.fn(() => 'pi1:test:1'),
    registerProceduralLootSource: vi.fn(),
    isProceduralLootSource: vi.fn(() => false),
    nextProceduralLootSourceSequence: vi.fn(() => 0),
    rollLoot: vi.fn(),
    rollWorldBossLoot: vi.fn(),
    applyHeal: vi.fn(),
    triggerEquipmentEffects: vi.fn(),
    refreshEquipmentEffectPower: vi.fn(),
    clearEquipmentEffectState: vi.fn(),
