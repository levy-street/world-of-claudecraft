      ...
      [
        member({
          ...
          auras: [
            ...
            // the live Phase 11 food-buff id: all four farming buff dishes
            // mint it (PartyMemberAura is the projected wire shape, which
            // carries no value field; the predicate-level fixture in
