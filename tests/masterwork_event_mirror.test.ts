...
// Hunted proc seed, pinned (re-hunted 2 -> 8 by the v0.32.1 realm loot-table
// fill: the four new camps spawn 12 mobs, 60 construction draws at 5 per mob
// plus their ongoing per-tick idle-wander draws, shifting the shared rng
// stream): with a fresh warrior (tailoring 0, no archetype, no self-signed
...
// linen_scrap then 1x spider_leg, then the craft); seeds 37, 101, 119, and
// 190 also land, kept on record here as spares.
const PROC_SEED = 8;
