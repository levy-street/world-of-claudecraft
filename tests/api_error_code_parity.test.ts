...
const KNOWN_CODES = [
  ...
  'trading_bots.disabled',
  'trading_bots.unknown_sku',
  'trading_bots.invalid_pay_currency',
  'trading_bots.already_subscribed',
  'trading_bots.subscription_required',
  'trading_bots.subscription_expired',
  'trading_bots.insufficient_claudium',
  'trading_bots.invalid_amount',
  'trading_bots.deposit_out_of_bounds',
  'trading_bots.invalid_public_key',
  'trading_bots.invalid_params',
  'trading_bots.payment_not_found',
  'trading_bots.payment_unverified',
  'trading_bots.vault_busy',
