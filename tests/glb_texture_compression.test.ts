...
//
// Most asset exporter re-runs silently revert their outputs to WebP; this
// suite turns that drift red. Exporters with deterministic rebuild contracts,
// such as the grand ferry, run this compressor as their final pipeline stage.
