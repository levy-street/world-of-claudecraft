...
const POW_SITES_PER_FILE: Record<string, number> = {
  ...
  'src/render/ability_vfx/solid_impact_fragments.ts': 3,
  'src/render/ability_vfx/water_volumes.ts': 5,
  'src/render/ability_vfx/shaman_fire_material.ts': 1,
  'src/render/ability_vfx/shaman_impact_flash.ts': 5,
  'src/render/ability_vfx/shaman_water_material.ts': 13,
  'src/render/characters/shaman_surface_scorch.ts': 1,
