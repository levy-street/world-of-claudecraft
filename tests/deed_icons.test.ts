...
describe('Book of Deeds webp icons', () => {
  ...
  it('an artless deed card resolves to a procedural crest (no committed image)', () => {
    ...
    expect(DEED_ORDER, 'the merged live deed catalog').toHaveLength(237);
    expect(DEED_IMAGE_IDS.size, 'every live deed but the five pending ones is painted').toBe(232);
