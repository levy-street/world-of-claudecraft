...
function chainSetup() {
  ...
  // both hops on the same crit outcome. Re-hunted 2 to 3 for the Last Bell
  // packet's world content (seed 2's hops split crit outcomes after the draw
  // shift). Spares on record: 4, 5.
  const sim = new Sim({ seed: 3, playerClass: 'shaman', noPlayer: true });
