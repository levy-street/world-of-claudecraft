...
describe('i18n Localization Key Coverage', () => {
  ...
  it('should provide every world-content translation in every locale without canonical fallbacks', () => {
    ...
    const expectedWorldCount =
      ...
      // Ravenpost authored letters: welcome + quest letters + G2b trade
      // settlement letters (delivery/refund), 3 fields each.
      (1 + Object.keys(QUEST_LETTERS).length + Object.keys(TRADE_LETTERS).length) * 3;
