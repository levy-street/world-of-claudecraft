...
const CALLBACK_KEYS = [
  ...
  'fiestaTakedown',
  'fiestaDown',
  'allocateProceduralItemUid',
  'registerProceduralLootSource',
  'isProceduralLootSource',
  'nextProceduralLootSourceSequence',
  'rollLoot',
  'rollWorldBossLoot',
  'applyHeal',
  'triggerEquipmentEffects',
  'refreshEquipmentEffectPower',
  'clearEquipmentEffectState',
  'spellCrit',
  'applyAura',
  'applyRootAura',
  'applyKnockback',
